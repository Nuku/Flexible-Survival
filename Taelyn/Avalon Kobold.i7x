...
When Play begins:
	...
	add "Avalon Kobold" to infections of InternalBallsList;
	...
	now cock entry is "[one of]reptilian[or]draconic[or]tapered[or]kobold[at random]";
	...
	now MilkItem entry is "avalon kobold milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "avalon kobold cum"; [ Item to be given to the player if they have this infection and jerk off. ]
