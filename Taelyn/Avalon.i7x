...
a postimport rule: [bugfixing rules for players that import savegames]
	if Fall-O-the-Wisp is resolved and Resolution of Fall-O-the-Wisp > 0 and Resolution of Fall-O-the-Wisp < 99:
...
after going south from Forest Burrow Entrance while PlayerMet of Arcanologist is false:
...
to WispFollow:
	...
	if calcnumber is 1:
		...
		say "[line break]     What will you do? You can wait for the two lovers and their voyeur to finish, or try to interfere, which will likely upset them to no small degree.";
		...
		if Player consents: [Watch]
			...
			say "[line break]     It seems that you have found the magic land of [bold type]Avalon[roman type]. Who knows what you will find in a land of fantasy?";
			WaitLineBreak;
...
understand "Inspect Runestone/Stone" as InspectRunestone.
...
to say AvCrossroads desc:
	...
	say "[bold type](Note: South, West, and Eastern Paths are all a work in progress and will become available once finished.)[roman type][paragraph break]"; [Remove once areas are available]
...
An everyturn rule:
	if (player is in Virgin's Pass or player is in Avalon-Crossroads) and a random chance of 1 in 3 succeeds:
		challenge "[one of]Feral Unicorn[or]Valkyrie[purely at random]";
