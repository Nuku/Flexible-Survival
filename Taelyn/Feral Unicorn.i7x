...
to say LoseToFeralUnicorn:
	if scalevalue of Player < 3:
		...
		if Player is herm: 			  [Yes = HERM Identified!]
			say "     [if HP of Player > 0]Raising your hands, you do your best to try to tell the fantastical beast that you no longer mean to fight. The unicorn stops his charge and pauses as it gives you a thoughtful expression before nudging you with his nose towards the stone table[else]You collapse in defeat as the unicorn stands proudly over you, looking over your [BodyName of Player in lower case] body. With a huff of satisfaction, he forces you towards the stone table against the cliff face, using the prodding of his horn as [']encouragement['] to make you move[end if]. Once standing in front of the stone slab, the unicorn pushes you down against it, leaving you ass up towards him. He slowly mounts you, his body pressing against you while his virile musk invades your senses. As if by magic, any clothing and gear on you is removed and appears in a heap nearby, giving the large equine full access to you. The blunt tip of his massive, drooling erection presses against your sex as he adjusts his aim but doesn't enter just yet. The unicorn's horn starts to glow, and you suddenly feel a tingle as your asshole, cunt and cock[smn] as your rear entrance suddenly tightens up and your hymen regrows. [bold type]You're a virgin again![roman type] But not for long.";
			now Virgin of Player is true;
			say "     Without giving you a chance to react, the feral male thrusts forwards, making you gasp when his equine shaft sinks deep into you. The magical beast begins in earnest, thrusting relentlessly into you time and time again without pause. His breath feels hot and heavy against you, and each thrust is so powerful that it pushes you hard against the table. You can't help but moan as you are bred like his mare, your virgin cunt begging for more, which he is more than happy to give you. With a few more powerful, thrusts, the unicorn's cocktip flares, sealing you up as best as he can before unleashing rope after rope of pearlescent cum deep into your awaiting womb until you feel almost bloated with his virile seed. The pleasure is too much, and you cum soon after; [if Cock Count of Player > 1]all of your own cocks erupt[else]your own cock erupts[end if] as well, spilling your own fluids against the stone, which it strangely seems to absorb into, leaving the surface clean.";
			WaitLineBreak;
			...
			now Virgin of Player is true;
			say "     Without giving you a chance to react, the feral male thrusts forwards, making you gasp when his equine shaft sinks deep into you. The magical beast begins in earnest, thrusting relentlessly into you time and time again without pause. His breath feels hot and heavy against you, and each thrust is so powerful that it pushes you hard against the table. You can't help but moan as you are bred like his mare, your virgin cunt begging for more, which he is more than happy to give you. With a few more powerful, thrusts, the unicorn's cocktip flares, sealing you up as best as he can before unleashing rope after rope of pearlescent cum deep into your awaiting womb until you feel almost bloated with his virile seed.";
			WaitLineBreak;
			say "     Slowly, the unicorn pulls out of you, leaving your freshly used hole quivering in the afterglow while some of the unicorn jizz leaks out of you, only to be absorbed into the table. You take a moment to catch your breath before turning just in time to see the unicorn proudly trotting away into the forest, leaving you to clean yourself up and collect your gear.";
			CreatureSexAftermath "Player" receives "PussyFuck" from "Feral Unicorn";
		else if Player is male: [Yes = MALE Identified!]
			say "     [if HP of Player > 0]Raising your hands, you do your best to try to tell the fantastical beast that you no longer mean to fight. The unicorn stops his charge and pauses as it gives you a thoughtful expression before nudging you with his nose towards the stone table[else]You collapse in defeat as the unicorn stands proudly over you, looking over your [BodyName of Player in lower case] body. With a huff of satisfaction, he forces you towards the stone table against the cliff face, using the prodding of his horn as [']encouragement['] to make you move[end if]. Once standing in front of the stone slab, the unicorn pushes you down against it, leaving you ass up towards him. He slowly mounts you, his body pressing against you while his virile musk invades your senses. As if by magic, any clothing and gear on you is removed and appears in a heap nearby, giving the large equine full access to you. The blunt tip of his massive, drooling erection presses against your asshole as he adjusts his aim but doesn't enter just yet. The unicorn's horn starts to glow, and you suddenly feel a tingle in your asshole and cock[smn] as your rear entrance suddenly starts to tighten up. [bold type]You're a virgin again![roman type] But not for long.";
			...
			say "     You can't help but moan as you are bred like his mare, your virgin tailhole begging for more, which he is more than happy to give you. With a few more powerful thrusts, the unicorn's cocktip flares, sealing you up as best as he can before unleashing rope after rope of pearlescent cum deep into your ass until you feel almost bloated with his virile seed. The pleasure is too much, and you cum soon after; [if Cock Count of Player > 1]all of your own cocks erupt[else]your own cock erupts[end if] as well, spilling your own fluids against the stone, which it strangely seems to absorb into, leaving the surface clean.";
			WaitLineBreak;
			say "     Slowly, the unicorn pulls out of you, leaving your freshly used hole quivering in the afterglow while some of the unicorn jizz leaks out of you, only to be absorbed into the table. You take a moment to catch your breath before turning just in time to see the unicorn proudly trotting away into the forest, leaving you to clean yourself up and collect your gear.";
...
to say BeatTheFeralUnicorn:
	...
	say "[line break]     [bold type]Do you want to have some fun with a Unicorn?[roman type][line break]"; [Fuck Ask]
...
When Play begins:
	...
	now Species Name entry is "Feral Unicorn";
	add "Feral Unicorn" to infections of EquineList;
	add "Feral Unicorn" to infections of FurryList;
	add "Feral Unicorn" to infections of MythologicalList;
	add "Feral Unicorn" to infections of MagicalList;
	add "Feral Unicorn" to infections of MaleList;
	add "Feral Unicorn" to infections of BluntCockList;
	add "Feral Unicorn" to infections of SheathedCockList;
	...
	now tail entry is "Your tail is like a mix between a lion and a horse, similar to unicorns of legend. It's long and flexible and ends with a thick brush of long horsehair.";
	...
	now Breast Size entry is 1; [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
	...
	now MilkItem entry is "feral unicorn milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "feral unicorn cum"; [ Item to be given to the player if they have this infection and jerk off. ]
