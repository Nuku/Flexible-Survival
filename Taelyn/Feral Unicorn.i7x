...
When Play begins:
	...
	now face change entry is "a sensation of vertigo overcomes you and bursts of light dance in front of your eyes. It takes all your effort just to stay on your feet as you face feels like someone is stretching it. It's hard to breath; your forehead feels a sharp pain, and then you start to come around. As your mind clears, you are met with the sight of what looks to be a horse's muzzle. You quickly feel over your forehead to find that a large spiral horn is growing from it. It isn't hard to deduce that you now have a [bold type]Unicorn Face[roman type][line break]";
	...
	now skin change entry is "it starts to shimmer and change. When the process finally stops, you find you are left with short and soft, white [bold type]unicorn fur[roman type][line break]"; [Write to fit into: "Your skin tingles as [skin change entry]." ]
