...
to say LoseToFeralUnicorn:
	if scalevalue of player < 3:
		...
		if player is herm: 			  [Yes = HERM Identified!]
			...
			WaitLineBreak;
			say "     Slowly, the unicorn pulls out of you, leaving your freshly used hole quivering in the afterglow while some of the unicorn jizz leaks out of you, only to be absorbed into the table. You take a moment to catch your breath befor turning just in time to see the unicorn proudly trotting away into the forest, leaving you to clean yourself up and collect your gear.";[Female Submit]
			if facename of player is listed in infections of Equinelist or "They Have Your Eyes" is listed in feats of player or "Breeding True" is listed in feats of player:
				fimpregchance;
			...
			WaitLineBreak;
			say "     Slowly, the unicorn pulls out of you, leaving your freshly used hole quivering in the afterglow while some of the unicorn jizz leaks out of you, only to be absorbed into the table. You take a moment to catch your breath befor turning just in time to see the unicorn proudly trotting away into the forest, leaving you to clean yourself up and collect your gear.";
			if facename of player is listed in infections of Equinelist or "They Have Your Eyes" is listed in feats of player or "Breeding True" is listed in feats of player:
				mimpregchance;
...
When Play begins:
	...
	now face change entry is "a sensation of vertigo overcomes you and bursts of light dance in front of your eyes. It takes all your effort just to stay on your feet as you face feels like someone is stretching it. It's hard to breath; your forehead feels a sharp pain, and then you start to come around. As your mind clears, you are met wtih the sight of what looks to be a horse's muzzle. You quickly feel over your forehead to find that a large spiral horn is growing from it. It isn't hard to deduce that you now have a [bold type]Unicorn Face[roman type]";
