...
When Play begins:
	...
	now defeated entry is "[kangaroo loss] say "'Y...y...yes sir.' She stutters moving into a more submissive position for you to do as you please."; [ Text or say command used when Monster is defeated.]
	now victory entry is  "[kangaroo attack] say"'Mmm you[apostrophe]re mine now.' She moves closer to you, stripping her own clothes off."; [ Text used when monster wins, can be directly entered like combat text or description. or if more complex it can be linked to a 'To Say' block as the demonstration text shows.] 
