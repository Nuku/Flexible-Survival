...
To say kangaroo loss:
	...
	if cocks of player is greater than 0:
		...
		wait for any key;
		say "Grunting deeply, you lean over her upper body rocking her body harder with your thrusts. With a particularly hard thrust, you knock her off her tail both falling to the ground a grunt coming from both of you. The jolt of the fall sends her into climax, the tight spasming cunt around [cock of player] cock send you over the edge, firing off your thick seed into her. Once you have finished, you climb off her panting limp body getting your clothes back on you leave her there and head off.";
	if cock length of player is greater than 10:
		...
		wait for any key;
		say "Whines from the kangaroo girl under you, tips you off that she's getting off from being used like this. Popping off your cock head the hot breath washing over the tip as she looks up to you, her eyes needful. 'Please....' Is all she says, though all the sensations push you over the edge a few more hard thrusts before [cock of player] dick swells up. The thick ropes of your seed fire off splattering the surprised kangaroo in the face, then down along her neck, the last few errant strands landing over her tits. Soft pants from both of you rise up, before you climb off her and walk away, leaving her to whine as she gets up defeated and horny. ";
	otherwise:
...
When Play begins:
	...
	now cock change entry is "it swells adding a more curved, looking like a snake becoming longer and more serpentine."; [ cock change text. format as "Your cock feels funny as (your text)" ]
	now str entry is 14;
	now dex entry is 19;
	now sta entry is 17;					
	now per entry is 15;
