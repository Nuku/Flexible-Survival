...
to say Latex Frog Wins:
	if inasituation is true:
		...
		WaitLineBreak;
		say "     Seemingly satisfied, the frog leaves you wrapped snuggly in your latex cocoon with your own sex juices inside with you. The latex continues to pulsate and massage you, occasionally teasing you toward a second orgasm before relaxing again. After an hour, the latex has absorbed your [if Cock Count of player > 0]seed[else if Cunt Count of player > 0]wet girlcum[else if Player is female and Nipple Count of Player > 0]milk[else]sweat[end if] and releases you. In your exhausted state you watch the strange latex form hop off down int the nearby sewer drain, just starting to take the form of another latex frog...";
