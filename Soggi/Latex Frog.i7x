...
to say Latex Frog Wins:
	say "     [if HP of Player > 0]You stop trying to fight the latex frog and submit to the strange feral creature[else]Too weak to keep resisting, you surrender and accept your fate[end if].";
