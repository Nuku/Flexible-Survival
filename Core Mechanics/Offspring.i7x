...
fuckscene of Offspring is "     For a second, lewd thoughts flare up in your mind and you almost open your mouth to say something to [if number of filled rows in Table of PlayerBunkerChildren > 1]one of your children[else]your child[end if], but then you manage to control yourself and suppress the urge.[line break]".
...
to say offspring present use:
	...
	if RandomChance < 4: [1-3]
		say "     Curious about what your child got you, you carefully open the present and find a soda bottle inside!";
		ItemGain soda by 1;
	else if RandomChance < 8: [4-7]
		say "     Curious about what your child got you, you carefully open the present and find a bag of chips inside!";
		ItemGain chips by 1;
	else if RandomChance < 11: [8-10]
		say "     Curious about what your child got you, you carefully open the present and find a water bottle inside!";
		ItemGain water bottle by 1;
	else if RandomChance < 14: [11-13]
		say "     Curious about what your child got you, you carefully open the present and find a can of food inside!";
		ItemGain food by 1;
	else if RandomChance is 14: [14]
		say "     Curious about what your child got you, you carefully open the present and find a baseball cap inside!";
		ItemGain baseball cap by 1;
	else: [15]
		say "     Curious about what your child got you, you carefully open the present and find a red herring plushie!";
