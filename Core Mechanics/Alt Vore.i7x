...
VoreExclusion is a marker.	[list of infections to not be vored or hard vored]
when play begins:
	add { "Albino Mouse", "Anthro Goat", "Anthro Rabbit", "Badger", "Blacktail Stag", "Blob", "Blue Chaffinch", "Brown Bear Female", "Butterfly", "City Sprite", "Cum Girl", "Doberman Bitch", "Dragon", "Feral Cheetah", "Feral Sea Dragon", "Feral Sea Dragoness", "Flesh Blob", "Football Wolfman", "Gator Herm", "German Shepherd Male", "Giant", "Gypsy Horse Transman", "Hippo", "Hydra Beast", "Hyena Matriarch", "Jackal Guard", "Jaguar Warrior", "Koballoon", "Kobold", "Lamia", "Latex Vixen Herm", "Magic Drake", "Malayan Tiger Male", "Mammoth", "Megakitty", "Mental Mouse", "Monkey", "Mushroom Man", "Mutt Pack", "Nightmare", "Opossum Herm", "Parasitic Plant", "Peacock", "Peculiar Dragon", "Plains Lizard Male", "Pod Person", "Raccoon", "Reindeer", "Royal Tiger", "Sea Horror", "Sea Lion and Orca Toys", "Sea Otter", "Siamese Cat", "Sierrasaur", "Skunkbeast Lord", "Slime Cube", "Smooth Collie Shemale", "Sphinx", "Sugar Ferret", "Tentacle Horror", "Thought Eater", "Triceratops", "Viking Woman", "Wrestling Wolf", "Wyvern", "Xeno Drone", "Yamato Dragon", "Yamato Dragoness", "Yinglet" } to infections of VoreExclusion;
	add infections of VoreExclusion to infections of HardVoreExclusion; [pre-fill hard vore list with base vore exclusions]
...
when play begins:
	add { "Automaton", "Black Wasp", "Blue Gel", "Bottlenose Toy", "Chocolate Lab", "Clockwork Fox", "Cock Cannon", "Goo Girl", "Latex Ermine", "Latex Fox", "Latex Wolf", "Naiad", "Pink Gel", "Plush Lion", "Purple Gel", "Rubber Tigress", "Sand Man", "Teddy Bear", "Werewolf Costume" } to infections of HardVoreExclusion;
...
to say ResolveEvent Inner Predator:
	...
	say "     Inside, there is a single vial of a murky looking fluid, along with some documents and notes. As well, a candy bar - score! The papers have been badly smudged and ruined by the seeping fluids around, including several tear marks that could very well have been made by large claws. Although most of the writing has been rendered unable to decipher, some words manage to stand out enough to read. [']Predator experiment['] and [']test substance['] are the most prominent that catch your eye, along with what appears to be government or corporate insignias along the tops of the pages. Clearly, this vial of fluid was part of some experiment, possibly related to the nanite plague now sweeping the city.";
	WaitLineBreak;
...
to say vorebyplayer04:		[feet first v1]
	choose row MonsterID from the Table of Random Critters;
	say "     With that familiar dark impulse building in your roiling stomach, you lick your lips and grab them by the legs. Wanting to consume this one bottom up, you stuff their feet into your mouth and quickly take those into your stretching throat with a wet gulp. You move quickly up their legs, getting as much in as you can before they realize their predicament. Getting more adept at this, you're almost to their knees before they quite realize what's going on and you've already got a firm grip on their hips. With a cry of surprise, they try to pull themselves out. Failing that, the [EnemyNameOrTitle] starts to claw at the ground, trying to drag themselves free, but with little success.";
	say "     As your maw stretches wider and you're getting ready to take in their hips, they give up at pulling away and instead try to strike at you with their forelimbs. Too weak from the fight, they aren't able to do much damage and only end up giving you a chance to grab their upper limbs and [one of]pin them to their sides[or]pull them across their chest[at random]. This both cuts off their ability to fight back and gets them ready to go down. After a few playful licks across their loins so you might enjoy the taste of your pinned meal, you pull their waist into your mouth while sliding their thighs down your throat.";
	WaitLineBreak;
	say "     Keeping their limbs pinned down, you pull them in further, forcing your throat to stretch around their hips as they're pulled down. Sitting upright to add gravity in your favor, a few more swallows has their wrists snugly trapped by your constricting esophagus. No longer needing your hands to hold the [EnemyNameOrTitle][']s limbs, you place a hand over their mouth to silence their cries as they try to call out. With the other on their shoulder, you pull them relentlessly downwards into your gaping maw as they struggle and shake their head, going inch by inch further towards their fate as your next meal. Already your stomach's gurgling in anticipation, eager to digest the struggling foe. After popping their shoulders in with a muffled grunt, you shove their head into your mouth and close it behind them. They squirm delightfully the whole time they're pulled down into you, pressing their hands, feet and face against your stretched belly as they struggle to push free as you feel the rapid progress of digestion starting up, quickly putting an end to their struggles.";
	say "     In no time, your massively distended belly shrinks down, the prey inside being reduced into fuel for your body. The rush of the consumed creature flashes through your body, giving you a feeling of strength and pride. Gathering your things, you give your slightly rounded stomach a pat, thanking your foe for their contribution to your survival, and you head out into the city once again.";

to say vorebyplayer05:		[feet first v2]
	choose row MonsterID from the Table of Random Critters;
	say "     Feeling that dark hunger well up inside you, you don't hold it back. Licking your lips as you grab your defeated prey, you press them to the ground on their back and stuff their legs into your widening mouth. You move quickly, getting their feet and ankles in your mouth in a few quick gulps before they know what's happening. As the realization of their eventual fate overcomes their initial shock, the [EnemyNameOrTitle] starts to squirm and struggle. You grab their arms as they swing at you, pinning them to their sides. With this grip on them, you pull them in further, getting them down to their hips.";
	...
	WaitLineBreak;
	say "     Keeping their limbs pinned down, you pull them in further, forcing your throat to stretch around their hips as they're pulled down. And with them facing you this time, you get to watch their face as they move inexorably downwards on their journey to your belly. A few more swallows and you press their wrists into your mouth and then into the confines of your gripping throat. No longer needing to hold the [EnemyNameOrTitle][']s limbs, you put a hand over their mouth to silence their cries as you put the other on top of their head to pull them in. They are pulled relentlessly into your gaping maw as they struggle and squirm, inching their way down into your stomach. Your tongue slathers across their back and your drool soaks them as you work to get their shoulders in. A couple more gulps after that and a solid push from your hand stuffs their head into your mouth and down your throat. They squirm delightfully the whole time they're pulled down into you, pressing their hands, feet and face against your stretched belly as they struggle to push free. You let out a long belch as you feel the rapid progress of digestion starting up, quickly putting an end to their struggles.";
...
to say vbp_messypig:		[written by Wolfwing, edited by Stripes]
	if Player is male:
		...
		say "     After a few moments of waiting while she's distracted, you give her pussy one last lick before moving her hooves to your mouth. Opening up wide, you start to slowly press her hooves into your mouth as you lick over them. A confused sound comes from her as you begin, but she's too distracted by your cock and not expecting anything dangerous.";
		WaitLineBreak;
		say "     Licking over her ankles, you begin to carefully slide more of her feet into your mouth while being careful to not let her feel much of your maw. Her snout remains firmly over your cock as she sucks and licks over it, your pre leaking out and giving her a bit of a taste. That along with your scent and musk begins to cloud her mind from much of anything else.";
		say "     Sliding more of her into your mouth, you have to bend your body slightly along with her legs - though thankfully not too much yet - as you move up her thighs. You lick over them as your tongue moves towards her pussy and, in a few moments, you begin to lick over it. Her snout may be sucking heavily on your [cock size desc of Player] cock, but she's starting to realize something is up at the point she feels her hooves press against your throat. She releases a confused squeal and tries to look back, though a hand placed on top of her head keeps her from looking back. She starts to ask 'What's going o...' as you stuff your penis back into her snout.";
		WaitLineBreak;
...
to say hvorebyplayer01:
	...
	if Player consents:
		...
		LineBreak;
		say "     Fighting the urge to use those serrated teeth, you grab the [EnemyNameOrTitle] and open your mouth as wide as you can. Before [ghe] can react, you shove [ghis] head and shoulders into your gaping maw. [gche] starts to squirm, but it's too late now. You keep your mouth wide and raise [ghim] up, letting gravity help you. Thankfully, your pointed teeth go back to normal once you're well on your way to swallowing [ghim], the dark craving passing.";
		say "     You continue your meal at a more leisurely pace now, playing your tongue across your tasty meal's [if currentmonster is cocked and currentmonster is cunted]cock and cunny, savoring the mix of flavors[else if currentmonster is cocked]cock, enjoying teasing them to arousal[else if currentmonster is cunted]cunny, toying with [ghim] via a quick tonguefucking[else]bare groin[end if]. But your hunger won't be delayed for long, so you only tease [ghim] enough to get [ghim] all hot and bothered despite [ghis] precarious situation. Taking a few big gulps, your throat pulls the [EnemyNameOrTitle] down into your belly. You pat the rounded bulge your meal makes in your distended tummy as you feel your opponent's struggles weaken before stopping entirely. Soon afterwards, your belly starts to go down as you consume [ghis] body to satisfy your unnatural hunger.";
		now hvorelevel is 1;
...
to say hvorebyplayer02:
	choose row MonsterID from the Table of Random Critters;
	say "     You feel a violent urge rising and your teeth grow longer and pointier as your dark appetite grows stronger. You slide your slobbery tongue across your lips as you pin your foe down beneath you. Your eyes run over the tasty-looking [EnemyNameOrTitle] with obvious hunger, clearly worrying [ghim]. Before the creature can call out though, you muffle [ghis] cries with one hand while keeping [ghim] pinned by partly sitting on [ghis] lower body. Leaning in, you run your tongue up and down [ghis] chest almost sensually to get a taste of [ghim].";
...
to say hvbp_incubus:
	say "     Defeated, the incubus falls to the ground in a rather sensual sprawl. He lands such that his seductive body [if Player is male]and fuckable ass are[else]is[end if] shown off in a final attempt to lure you into sex. But trying to tempt you with the pleasures of the flesh only accentuates a different hunger for flesh. You lick your lips and eye his alluring body hungrily.";
...
to ubbyplayer:
	...
	say "     Indulging in this perversely twisted act has further weakened your grip on your own humanity even as you feel the nanites from your prey flooding your system [if ovipregnant is true]even as they are being encased in a protective shell[else]as they bond to your imprisoning womb via a rapidly forming placenta[end if]. With the [EnemyNameOrTitle] taking root as your next child, you sigh in satisfaction, your maternal demands satisfied for now. The huge bulge of your belly goes down gradually as they regress somewhat in size, allowing you to eventually get up and continue on your way.";
	decrease humanity of Player by 3;
...
to say ubbyplayer04:		[feet first]
	choose row MonsterID from the Table of Random Critters;
	say "     With the increasingly familiar need building in your heated womb, you pounce atop the dazed [EnemyNameOrTitle], pinning them to the ground. They struggle a little, but are too weak and turned on by this point to truly oppose you. Distracting them by running a hand over their body, groping and caressing them, you guide their feet to your now gaping pussy and its quivering folds. They moan softly as their feet slip into your cunt's warm embrace, little realizing what's happening until you've already got them in up to their knees and you've got a firm grip on their hips. With a cry of surprise, they try to wriggle free (much to your delight) and, failing that, try to drag themselves free with their upper limbs, but with little success.";
