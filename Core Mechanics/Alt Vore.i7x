...
to say hvorebyplayer04:
	...
	if the player consents:
		say "     Pushing the creature over, you get [ghim] into position and drive your hard cock into [ghis] [if currentmonster is cunted]juicy cunt[otherwise]tight asshole[end if] with a satisfied grunt.  You grope and fondle your prey, keeping [ghim] distracted as your jaw unhinges and your teeth elongate into sharp spikes.  You can't help but salivate over your unaware meal as you thrust into that [if currentmonster is cunted]wet cunny[otherwise]clenching butt[end if] of [ghis].  Drool drips from your dangling tongue down onto the back of the [name entry][']s neck and shoulders.";
