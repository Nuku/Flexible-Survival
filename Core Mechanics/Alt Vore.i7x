...
to vorebyplayer:
	...
	if a random chance of powerchance in 20 succeeds:
		...
		if vv is vsta:
			say "     By consuming your foe, you have managed to absorb some of them to empower yourself. You feel your body toughening with [Name entry] [one of]stamina[or]physique[or]endurance[at random].";
...
to say vorebyplayer04:		[feet first v1]
	choose row MonsterID from the Table of Random Critters;
	say "     With that familiar dark impulse building in your roiling stomach, you lick your lips and grab them by the legs. Wanting to consume this one bottom up, you stuff their feet into your mouth and quickly take those into your stretching throat with a wet gulp. You move quickly up their legs, getting as much in as you can before they realize their predicament. Getting more adept at this, you're almost to their knees before they quite realize what's going on and you've already got a firm grip on their hips. With a cry of surprise, they try to pull themselves out. Failing that, the [Name entry] starts to claw at the ground, trying to drag themselves free, but with little success.";
...
to say ubbyplayer03:		[special 1 - first time feet first, involuntary prey]
	...
	say "     Seeing what's happening and knowing full well from your grin the extent of your lustful plans, the [if scale entry is 1]tiny creature[else if scale entry is 2]small creature[else if scale entry is 3][Name entry][else if scale entry is 4]large creature[else if scale entry is 5]huge creature[end if] keeps trying to resist. These struggles only add to your pleasure as its legs squirm around inside your tight passage, pushing you to the point of orgasm. From their reaction as well, you can tell that part of them is enjoying this even if they are still resisting it. Wanting some added fun and feeling a need to reassure your soon-to-be offspring, you grab their other limbs and keep them pinned with one hand while your other gropes their crotch. You fondle them, pleasuring their loins and exciting them further despite their attempts to resist. You keep this up until their hips pass between your juicy folds. You move to reassuring them by stroking their face and cooing softly to them.";
