...
to say grecroom desc:
	project the figure of Library1stfloor_icon;
	say "     The Kidz Zone was at one point the place where parents would dump their kids when they needed a break. Most of the brightly colored decorations have been torn down, leaving the area to have a twisted sort of festive feel to it. A single table is set up in the back corner of the room, while the bookshelves have all been destroyed, talk about a serious tantrum. [if Korvin is booked or Alexandra is booked]Seems that someone found an old pool table and dragged it all the way into the rec-room, while one of the side tables also has a deck of cards. While some may prefer reading to pass the time, others apparently feel that to be too boring. The idea of hustling someone at pool or owning them at poker does have its own merits to be honest. [end if][if Nala is booked]Having set up a balcony like seat out of a broken air vent, Nala may now watch and heckle to her hearts content. [end if]Heading south will return you to the back of the library."
...
to say glargeshed desc:
	project the figure of Library1stfloor_icon;
	say "     Stepping into the shed, it's a little disconcerting how much bigger it appears compared to the outward appearance. Inspecting the interior, the walls are made basic cement, no drywall or anything, which makes sense since this was merely a place to keep gardening equipment. Most of the floor is smooth cement as well[if Philip is booked]. Philip has not just created his own mud sty, but a fun wrestling ring in the back corner, ready for any challengers[else], except for a back corner where the cement has been broken up into jagged balls of rock[end if]. The shed isn't completely without any features, though. Counters and cabinets line the wall on the right hand side of the shed. To the south is the door leading back out to the courtyard.";
...
to say usittingarea desc:
	project the figure of Library2ndfloor_icon;
	say "     Obviously meant for small study groups. The area around you has a few tables and couches spread about. Most of the nearby shelves have been knocked down, leaving their books strewn across the floor. While for the most part it appears to be a disaster area, at the same time it has a very lived in feel to it, leaving you with a relaxed feeling rather than an uneasy one. Heading to the southwest will take you back to the second floor landing, while to the southeast you can head towards the huge window overlooking the back of the library.";
