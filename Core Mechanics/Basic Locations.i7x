...
to say gbreakroom desc:
	say "     The library staff breakroom is nothing more than a remodeled version of the abbeys old kitchen. The walls are still made with the original stone blocks, while the two windows in the room have thankfully been updated. Both are simple horizontal sliders, leaving the room with a simple glow from the natural lighting outside. The tables have been pushed around leaving no semblance of order to them, while the countertops as least are reasonably clean. To the west is the old kitchens walk-in pantry.";
...
to say grecroom desc:
	say "     The Kidz Zone was at one point the place where parents would dump their kids when they needed a break. Most of the brightly colored decorations have been torn down, leaving the area to have a twisted sort of festive feel to it. A single table is set up in the back corner of the room, while the bookshelves have all been destroyed, talk about a serious tantrum. Heading south will return you to the back of the library."
