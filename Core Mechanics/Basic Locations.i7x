...
Maintenance Storeroom is a room. Description of Maintenance Storeroom is "     The maintenance room you have turned into your own private lodgings. Looking around, it isn't very large by most standards, and much of that is filled with cluttered shelving. Along the back wall is a twin size bed that the old janitor probably used to nap during breaks. The walls on the left and right are haphazardly lined with shelves and filing cabinets. There's nothing of any real interest inside of, in or on top of them, but you may find a use for the extra storage space in time.[line break]".
...
The Library Door is east of Main & 7th Street and west of Grey Abbey Library.
...
to say abbey desc:
	...
	if Fang is booked and Fang is in Grey Abbey Library:
		if Alexandra is booked:
			if HP of Fang < 3:
				say "     Fang and Alexandra are on guard here, taking shifts watching by the door. The wolf is tied to a [one of]column[or]desk[or]water fountain[or]metal staircase[or]wall sconce[at random]. The doberwoman paces around, running her paw along her nightstick as if hoping for an opportunity to use it.";
			else:
				say "     Fang and Alexandra are on guard here, taking shifts watching by the door. The powerful [if Fang is Male]male[else]female[end if] wolf watches in stoic silence. The doberwoman paces around, running her paw along her nightstick as if hoping for an opportunity to use it.";
		else:
			if HP of Fang < 3:
...
to say GreyAbbeyLibrary_ObserveMenu:
	...
	say "[line break]     [bold type]Whom do you want to observe?[roman type][line break]";
...
Main & 7th Street is a room. It is fasttravel.
Description of Main & 7th Street is "[7thMainDesc]".
...
Northwest 7th Street is a room.
...
to say gbreakroom desc:
	...
	say "     The only modern day conveniences in the breakroom are a microwave and a small fridge[if library computer is powered], both of which are ready to be used now that you have restored power to the library[else]. Sadly, they are both out of commission at the moment[end if].";

Library Microwave is an object. It is in Breakroom. It is fixed in place. Understand "microwave" as Library Microwave.
Description of Library Microwave is "     A black, mid-sized microwave stands on one of the countertops in the breakroom. [if findwires < 2 or fixedgens < 3]Sadly, without power it doesn't work.[else]Now that you have restored power to the library, you can make use of it. All you need to do is put stuff in and [bold type]microwave[roman type] whatever you want![end if][line break]".
...
Pantry is a room. Description of Pantry is "     The pantry is about the size of a walk-in closet. Inspecting the shelves on all three walls, hoping to find some extra food perhaps, you sadly only find a few leftover folders. After the building became a library, this pantry apparently ended up being turned into a simple storage room. Heading [link]east[end link] from here will lead you back into the breakroom.[line break]".
...
Computer Lab is a room. Description of Computer Lab is "     Stepping into the old computer lab, it appears that someone had some anger management issues judging by all of the smashed monitors and towers. Every computer used to have its own cubicle, each one about four feet wide by three feet long. While not a room you would particularly enjoy staying in, you're sure you can find some use for it. To the west is a locked door. Heading [link]north[end link] will take you back to the library entrance.[line break]".
...
Courtyard is a room. Description of Courtyard is "     The courtyard has an almost peaceful aura about it, which is shocking considering the state of the rest of the city. A few trees have been sporadically planted around a large fountain in the center of the courtyard. While there is no water coming out of the fountain, it is still a nice area to sit and relax. To the [link]north[end link] is a large shed, more than likely filled with gardening tools used for the courtyard. To the [link]south[end link] is the remnants of what was once a garden. Heading [link]west[end link] will take you back into the library.[line break]".
...
Garden View is a room. Description of Garden View is "     The huge windows at the back of the second floor allow sunlight to flood the area. Unfortunately, one of the large windows has been completely shattered. On the bright side, this allows a light breeze to flow through the rest of the library, airing out its musty scent. Looking out the window, you can see the garden and courtyard below. The sprawling city beyond it would make for a fantastic view if it wasn't in a state of ruin. There's a sitting area to the [link]northwest[end link], whereas going [link]southwest[end link] will lead you towards a dark alcove.[line break]".
...
Description of Red Apartment Building is "     Standing in a somewhat out of the way neighborhood, a red-tinted apartment building rises before you, four stories tall. A fire escape clings to the outside of its structure, its retracting lowest set of stairs out of reach due to sturdy springs holding it up. In the area around the building, you can see several groups of partially infected people, mooching around and murmuring as they give you looks.[line break]".
