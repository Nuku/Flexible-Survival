...
carry out tapeing:
	...
	if entry z of tapes of Player is:
		...
		-- "Rat Twin Tape": say "[ErinConsolesViolet]"; [Source: Kernog/Rat Twins.i7x]
		-- "Grocery Store Tape": say "[RomanTransformationFootage]"; [Source: Kernog/Roman.i7x]
		-- "Gorilla Locker-room Tape 1": say "[FootballTeamSlice1]"; [Source: Kernog/Astroslide Field Locker-room.i7x]
		-- "Carter's Tape": say "[CartersRecording]"; [Source: Luneth/Origins.i7x]
		-- "Francis Koenig Observation Video": say "[HikingObservationVid]"; [Source: Wahn/Recordings.i7x]
		-- "Bodycam Tape - L. Nielson": say "[BodycamTape_Nielson]"; [Source: Wahn/Recordings.i7x]
		-- "Pizza Delivery Dash Cam Vid": say "[PizzaCarDashcamVid]";
		-- "Dressing Room Spycam Vid": say "[DressingRoomSpycamVid]";
		-- "Darius's Home Vid 1": say "[DariusHannahVid1]";
		-- "Darius's Home Vid 2": say "[DariusHannahVid2]";
		-- "Traffic Drone #006 Footage": say "[TrafficDrone#006Vid]";
		-- "Urban Explorer Helmet Cam Vid #1": say "[UrbanExplorerVid1]"; [Source: Wahn/Recordings.i7x]
		-- "Fitness Studio Security Vid": say "[FitnessStudioVid]";
		-- "Demonic Ritual Tape": say "[DemonicRitualTape]"; [Source: Gherod/Demonologist.i7x]
		-- "Hyena Breakout Video": say "[Hyena Breakout Video]";
		-- "Canine Hazing Vid": say "[CanineHazingVid]";
		-- "Demented Video Diary": say "[AddictedBreederFucked]"; [Source: Voidsnaps/AddictedBreeder.i7x]
		-- "Firbolg Feral Tape 1": say "[FirbolgFeralTape1]"; [Source: Orangehorned/Firbolg Tapes.i7x]
[ Template to fill for new tapes ]
[
		-- "TAPE NAME": say "[TAPE SCENE]";
]
