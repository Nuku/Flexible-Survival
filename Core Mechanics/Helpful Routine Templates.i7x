...
to malebreedersex: [This is a variation of be above, for monsters who are strictly into reproduction]
	...
	otherwise if anallevel is not 1 and (a random chance of 1 in 2 succeeds or (anallevel is 3 and a random chance of 1 in 3 succeeds) or "Mpreg" is listed in feats of player):
...
to hermmonstersex: [This is a 'robust' version of player loss routines for herm creatures]
	...
	otherwise if cocks of player > 1 and a random chance of 1 in 2 succeeds:
