...
"Trading"	"You can trade with certain denizens of the city. Simply [bold type]give x to y[roman type], like give soda to Bob. If they want it, they'll give you something back for it. Trades are final, but usually worth it."
...
"Socializing"	"You can [bold type]talk (person)[roman type] to chat. If they are of more personal interest to you, you can also [bold type]fuck (person)[roman type] instead."
