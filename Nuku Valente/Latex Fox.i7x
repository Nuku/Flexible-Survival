...
to latexfoxdefeatsex:
	if ( cunts of player > 0 and (cocks of player is 0 or anallevel is 1)) or ( cunts of player > 0 and cocks of player > 0 and a random chance of 1 in 2 succeeds ):
...
when play ends:
	if bodyname of player is "Latex Fox":
		if humanity of player < 10:
			...
			say ". You set up a den at an adult toy manufacturing plant.  The stores of latex are wonderfully tasty and you drink some down every day, making you extra [if cocks of player > 0]virile[else]fertile[end if], increasing the number of other latex foxes you are able to create.  The large collection of unshipped products are quite enjoyable as well, both as snacks and as playthings.  Despite being relatively weak, the surge in numbers help the latex foxes survive and spread.  And while you have little urge to leave your new den, you're quite certain many of your offspring have escaped to spread beyond the city and create dens of their own.";
		else:
