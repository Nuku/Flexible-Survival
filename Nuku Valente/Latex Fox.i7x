...
"Latex Fox"	"[PrepCombat_Latex Fox]"

to say PrepCombat_Latex Fox:
...
When Play begins:
	...
	now MilkItem entry is "latex fox milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "latex fox cum"; [ Item to be given to the player if they have this infection and jerk off. ]
