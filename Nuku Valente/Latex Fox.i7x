...
When Play begins:
	...
	now face entry is "distinctly vulpine, in a perpetual sneer of exposed teeth";		[ Face Description, format as the text "Your face is (your text)." ]
	now body entry is "mostly humanoid, save for a pair of digitigrate paws and sharp claws";	[ Body Description, format as the text "Your body is (your text)." ]
