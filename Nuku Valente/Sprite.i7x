...
When Play begins:
	...
	now Species Name entry is "Sprite"; [name of the overall species of the infection, used for children, ...]
	...
	now skin entry is "flawless human"; [ skin Description, format as "Looking at yourself, your body is covered in (your text) skin"]
