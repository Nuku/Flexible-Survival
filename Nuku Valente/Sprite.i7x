...
to say Sprite attack:
	...
	if a random chance of 1 in 2 succeeds and cocks of player is greater than 0:
		...
		otherwise:
			say "One of the largest sprites there descends in front of you with a disturbing smile, 'You will make such a pretty sprite,' she says as she grabs your [cock of player] cock and strokes it slowly, 'But before then, I don[apostrope]t plan to let this go to waste...'";
			wait for any key;
