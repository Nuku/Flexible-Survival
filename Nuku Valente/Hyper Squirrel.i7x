...
to say ResolveEvent Hyper Squirrel Girl:
	...
	if hsrp is 0:
		...
		say "[line break]     You roll 1d20([diceroll])[if bonus >= 0]+[end if][bonus] = [special-style-1][diceroll + bonus][roman type] vs [special-style-2]21[roman type] (Perception Check): ";
		increase diceroll by bonus;
		say "You [if diceroll > 20]find a great hiding place and hurry to it as quietly as you can[else if diceroll > 12]spot an acceptable hiding place and creep towards it[else]don't see any good hiding places, so you just try to quietly duck down[end if].";
...
a postimport rule: [bugfixing rules for players that import savegames]
	now Cunt Count of Snow is 1;
	now Cunt Depth of Snow is 9;
	now Cunt Tightness of Snow is 3;
	now Clit Size of Snow is 3;
...
Description of Squirrel Den is "     Not a literal squirrel den, a basement actually. It is warm and dark in here. You can see books piled in messy stacks, and a small cot set to the side. It seems whomever lives here is stocked for the long haul, with small bottles of water and packaged food up on a shelf. There is a soft, musky, scent in the air.[line break]".
...
Cunt Count of Snow is 1. [number of cunts]
Cunt Depth of Snow is 9. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
Cunt Tightness of Snow is 3. [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
Clit Size of Snow is 3. [size 1-5, very small/small/average/large/very large]
...
icon of Snow is Figure of Snow_icon.
...
carry out smithing:
	...
	if the noun is armament:
		increase Weapon Damage of the noun by 1;
	else if the noun is nanite collector:
		say "     [if nanitemeter is 0]'Where did you get one of these? Did you swipe it? Hey, I'm not going to get myself into trouble modifying stuff you've stolen.'[else if nanitemeter is 1]Showing Snow the modified nanite collector, she gives it a once-over and a quick tune-up. 'I've still got those parts I took off, if you want me to restore it to how you got it. Or I can even add on that extra pump and the bigger reservoir if you want me to soup it up some more. Which would you like?'[else if nanitemeter is 2]Showing Snow the nanite collector you've obtained, she checks it out with a critical eye. 'This is a pretty fancy piece of tech. I don't quite understand how all of it works, but I certainly see a few ways to mod it. Now, I can bypass a few systems and take them out to make it lighter, but it'll be a little less effective. Otherwise, I can add an extra pump and larger reservoir. That'll make it work a bit better, but it'll be a little heavier too. Otherwise, I can just leave it alone. Which would you like?'[else]Showing Snow the modified nanite collector, she gives it a once-over and a quick tune-up. 'How's that extra pump and bigger tank working out for you? If it's too heavy, I can take them off and restore it to how you got it. Or I can even strip it down some more and make it even lighter still. Which would you like?'[end if]";
		...
		if calcnumber > 0:
			if "nanite collector" is a name listed in Table of Game Objects:
				if nanitemeter is 1:
					now weight entry is 16;
				else if nanitemeter is 2:
					now weight entry is 25;
				else:
					now weight entry is 32;
	...
	if lastfuck of Snow - turns < 8:
		...
		if HP of Snow is 1:		[Met Wild Squirrels once]
			...
			if Player consents:
				...
				say "     After guzzling down her now infectious seed and each getting filled from behind, you become more and more a wild squirrel for your sexy lover and mate. You pull her into your arms and chitter happily as your loins change, becoming better suited to please her and she chitters back as she changes as well. Pulling [if Player is male]her into your lap, you push your cock into her pussy and bounce her in your lap, her large breasts pressed to your chest. The wild squirrels stand to either side of you, letting you both suck squirrel cock while fucking your new mate. This bestial fucking goes on until you cum hard, filling her womb with your cum and each getting another tasty load from the squirrels down your throat. After that, you're mounted again by the wild pair while Snow takes a turn sucking you off[else]you into her lap, Snow slides her cock into your pussy and bounce her in your lap, her large breasts pressed to your chest. The wild squirrels stand to either side of you, letting you both suck squirrel cock while fucking your new mate. This bestial fucking goes on until she cums hard, filling your womb with her cum and each getting another tasty load from the squirrels down your throat. After that, you're mounted again by the wild pair while Snow takes a turn eating out your cum-leaking box[end if]. The romp continues on like this through a myriad of pairings and positions for hours despite the fact you both succumbed long ago. Eventually, you four run off together back to the their nest to rest before going off in search of others to share your addictive lust with.";
...
to say ResolveEvent Wild Squirrels:
	...
	let bonus be ( Perception of Player minus 10 ) divided by 2;
	let diceroll be a random number from 1 to 20;
	say "[line break]You roll 1d20([diceroll])[if bonus >= 0]+[end if][bonus] = [special-style-1][diceroll + bonus][roman type] vs [special-style-2]18[roman type] (Perception Check):[line break]";
	increase diceroll by bonus;
	if diceroll > 17:
	...
	if HP of Snow is even:
		say "     One of the squirrels [if Player is female and Cunt Depth of Player > 8]grabs you at the hips and rubs across your sides and backs with those, oh so soft, paws as she eases up into you. Her thick, pink, shaft buries warmly into your waiting snatch as she pulls you back into her lap, slowly settling to the ground with you, bouncing you up and down in her lap as she grunts and coos with pleasure. Your body tingles with growing delight as her infectious seed already works at your insides, weakening your desire to resist her and filling you with an urge to be filled with her[else]makes a sad sort of noise, almost apologetic, before she shoves you forward, grabs your hips, and plunges her thick cock into your back door, rocking easily into your ass as the thick sprays of her pre lubricate you, both in body and mind. Her rough attentions feel better by the moment as you find yourself moaning with desire, pressing back against her as she claims you[end if].";
		...
		else if Player is female and Cunt Depth of Player > 8:
			if Cunt Count of Player > 1:		[2+ adequate cunts]
...
When Play begins:
	...
	now Species Name entry is "Squirrel"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now Name entry is "Hyper Squirrel";
	...
	now face entry is "topped by a set of two long white squirrel ears twitching above your head, while a long rodent snout with bucked teeth juts out at the front of your head"; [ Face description, format as "Your face is [Face of Player]." ]
	now body entry is "curved but athletic looking, a dancer's body perhaps. Your legs are thick and powerful, built for swift climbing and terminating in paws that have sharp grasping claws"; [ Body Description, format as "Your Body is [Body of Player]." ]
