...
Instead of resolving a wild squirrels:
	...
	if HP of Snow is even:
		if the cunts of the player > 0 and cunt length of the player > 8:
		...
		else if cunts of player is 1 and cunt length of the player > 8:		[1 adequate cunt]
