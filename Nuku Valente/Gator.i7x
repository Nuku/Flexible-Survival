...
to say GatorLoses:
	if gator den is unknown:
		...
		say "[line break]     [bold type]Do you want to service the gator?[roman type][line break]";
...
to say GatorVoreOffer:
	say "[line break]     [bold type]Do you want to offer yourself to the gator?[roman type][line break]";
...
When Play begins:
	...
	now Species Name entry is "Gator"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Gator Herm" to infections of ReptileList;
	add "Gator Herm" to infections of FurryList;
	add "Gator Herm" to infections of NatureList;
	add "Gator Herm" to infections of HermList;
	...
	now Name entry is "Gator Herm";
	now enemy title entry is "Sewer Gator"; [ Name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name. ]
	...
	now face change entry is "it draws forward into a long gator snout";
	...
	now MilkItem entry is "gator herm milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "gator herm cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
Description of Sewer Gator is "     The gator is a formidable sight, covered in green scales and plenty of muscle to back them up. She has no problem showing off her thick cock to you, as well as giving you glimpses of her cunt while she seductively shakes her wide hips. As you continue to look her over, she flashes you a smirk as she eyes you with a hungry gaze.[line break]".
[Conversation of Sewer Gator is { "Gator stuff" }.]
fuckscene of Sewer Gator is "[gator den repeat]".
icon of Sewer Gator is Figure of Sewer_Gator_soft_icon.
The scent of the Sewer Gator is "     The gator smells strongly of sex and the sewers.".

instead of conversing the Sewer Gator:
...
to say GatorDenSex:
	...
	MultiInfect "Gator Herm" repeats 2;
	WaitLineBreak;
	...
	if a random chance of 1 in 3 succeeds: [She just talks]
		...
		if a random chance of 1 in 2 succeeds:
			if Player is male: [She wants to be fucked]
				...
				if Cock Length of Player > 10: [Too large]
					...
					say "     You reach for one of her legs and lift it up, thrusting up into her and making her frame jiggle with every slam into her, feeling yourself sink all the deeper from the new angle. She groans and praises you, tail rubbing against your chest as she flexes powerfully around your [Cock of Player] shaft. All too suddenly, your [Ball Size Adjective of Player] orbs contract, and you can feel your vital fluid rushing up into the scaled female. She hisses as her passage clamps like a vice around you, drawing out the seed towards her hungry womb.";
			else: [She fucks]
				if Player is female:
					...
					say "     Your belly grows warm as she ruts harder, her soft words seeming to make your womb tingle fiercely with a strange, but deliriously wonderful sensation. You are not even sure when she spilled over the top, but you are being filled with thick seed and give out a deep, slutty moan as she clings to you, keeping her shaft plugged tight as the thick gator seed flows.[fimpregchance]";
					...
					say "[line break]     [bold type]Do you let the gator fuck your ass?[roman type][line break]";
...
to GatorBind:
	...
	while Trixieexit is false:
		...
		if humanity of Player < 1:
			...
			say "Sanity: [humanity of Player]/100  Lust: [lustatt]/100  Hunger: [hunger of Player]  Thirst: [thirst of Player]  Struggle: [bracket]-[if struggleatt > 2][bold type]X[roman type][else]-[end if][if struggleatt > 1][bold type]X[roman type][else]-[end if][if struggleatt > 0][bold type]X[roman type][else]-[end if][close bracket][line break]";
...
This is the Gator Herm Vore rule:
	if ending "Gator Herm Vore" is triggered:
		say "     [if gator den is known]Having spent too long in the predator's stomach, you become too tired to do anything. The gator snorts in amusement when she feels your struggles come to an end. 'Oops, looks like I forgot about you being in there,' she says mockingly while she pats her stomach. 'Sucks that I'm down a lover now, but I guess that if you couldn't survive my stomach, you weren't going to be much of a mate down the line.' With you becoming no more than a layer of pudge for the predator[else]Bested by the predator's overwhelming strength, you are too tired to struggle anymore, let alone escape the twisted confines. Your body goes limp as your consciousness fades. The gator chuckles when she feels your struggles come to an end. Patting her stomach, she taunts, 'You might not have been good enough to be my fuckbuddy, but at least you were good for a snack.' With you becoming no more than a layer of pudge for the reptile[end if], the scaly herm goes off to search for her next victim to fuck and likely also devour. Rubbing her stomach, which was less full than it was hours ago, she says, 'Don't worry, I'm sure that you'll make my future lovers happy, with where you settled.' She eyes her breasts, a good cup bigger than they were before.";
		the Player is vored;
...
This is the Gator Herm Infection rule:
	if Player has a body of "Gator Herm":
		...
		if humanity of Player < 10:
			...
			say "     [if gatorconsent is 1]As the military mobilizes into the city, you hurry back to your sweet gator's arms. You embrace as equals, and you begin telling her your plan. She looks doubtful at first, but eventually you talk her out of her sewer home. You are both rescued and whisked away back to civilization. She quickly appreciates to having so many warm bodies around, and she settles in to get a formal education, with you at her side for encouragement, support, and great sex. She becomes a therapist. Her hypnotic voice and her eagerness to meet new people drives her success, and she never leaves your side either. It is a good life, spent together,[else]Life as a gator is somewhat interesting. Most expect you to be rough and cold blooded, and everyone is surprised when they touch you to find soft, almost silky skin that's warm to the touch. You secure a deal with a cosmetics firm, becoming a spokesperson for their [']beat the gator['] campaign that proves wildly[end if] successful.";
