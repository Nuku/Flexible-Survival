	...
	if bodyname of player is "sewer gator":
		if humanity of player is less than 10:
			if gatorconsent is 1:
				...
				if cunts of player is greater than 0:
					say "When her hunting goes poorly, you prove to be a very skilled outlet for her fustration. She rides you in every position over the rest of your life, filling your belly with child after child, squealing snapping beasts that stay only long enough to get a rough meal from your chest before fleeing into the wilds.";
			otherwise:
		...
		otherwise:
			if gatorconsent is 1:
				say "You hurry back to her arms. You embrace as equals, and begin telling her your plan. She looks doubtful at first, but eventually you talk her out of her sewer home. You are both rescued and whisked away back to civilization. She quickly warmed to having so many warm bodies around, and settled in to get a formal education, with you at her side for encouragement, support, and great sex.[line break][line break]She becomes a therapist. Her hypnotic voice and her eagerness to meet new people drives her success, and she never leaves your side either. It is a good life, spent together, successful.";
			otherwise:
