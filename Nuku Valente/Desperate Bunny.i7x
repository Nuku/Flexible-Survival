...
to say ResolveEvent Needy Rabbit Girl:
	if ngrp is 0:
		...
		say "[line break]     You roll 1d20([diceroll])[if bonus >= 0]+[end if][bonus] = [special-style-1][diceroll + bonus][roman type] vs [special-style-2]12[roman type] (Charisma Check): ";
...
Description of Rabbit Den is "     Not a literal rabbit den, a basement actually. It is warm and dark in here. You can see books piled in messy stacks, and a small cot has been set to the side. It seems whoever lives here is stocked for the long haul, with small bottles of water and packaged food up on a shelf. There is a soft, musky scent in the air.[line break]".
...
Description of Sandra is "     A mostly human female, if you don't count the rabbit ears, six breasts, and that cute little white tail that sways behind her. She is usually wearing a yellow blouse, jean jacket, and a long red skirt. Her feet are clad in sneakers, well worn.[line break]".
...
linkaction of Sandra is "Possible Actions: [link]talk[as]talk Sandra[end link], [link]smell[as]smell Sandra[end link], [link]fuck[as]fuck Sandra[end link][if rabbitsibling > 0], [link]request[as]request Sandra[end link][end if][line break]".
lust of Sandra is 555.

instead of conversing the Sandra:
	project Figure of sandy_icon;
	if rabbitsibling is 0 and a random chance of 1 in 2 succeeds:
		...
		if Player consents:
			LineBreak;
			say "     'Oh, thank you!' She seems very giddy over you agreeing to these terms. 'Alright, so... [if Breast Size of Player > 0]Sister[else]Brother[end if] would be most appropriate, right?'";
			if Player consents:
				LineBreak;
		...
		say "     [if rabbitsibling > 0 and a random chance of 1 in 10 succeeds]'[one of]If calling you [sangr] no longer feels right[or]Remember, if you ever want me to stop calling you [sangr][stopping], just make a [bold type]request[roman type].'[else]'[one of]Did I mention my name is Sandra yet? I can sometimes be a ditz about that.'[or]'It's so nice having someone around to talk with.'[or]Do you think someone will come rescue us?'[or]I hope my rabbit is OK. I mean, yeah, he did kind of bite me and turn me into a crazy rabbit lady, but he's still my pet.'[or]You smell nice. God that sounded weird, sorry.'[or]Hello there!'[at random][end if]";

sanreq is an action applying to nothing.
understand "request of/from/-- sandra" as sanreq.

check sanreq:
	if Sandra is not visible, say "That's not a verb I recognize." instead;
	if rabbitsibling is 0, say "You have nothing to request of Sandra." instead;
	...
	if lastfuck of Sandra - turns < 8:
		...
		if HP of Sandra is 3:
			if lastfuck of Colleen - turns < 4:
				say "     Colleen's ears perk up as she notices you heading over to the bunny's bunk. It seems the perceptive puppy's picked up on your intent and has taken an interest in the upcoming show. The husky girl rolls onto her back and slides a paw between her legs, seemingly content to watch what she hopes will be a nice show.";
			else:
				say "     Colleen's ears perk up as she notices you heading over to the bunny's bunk. It seems the perceptive puppy's picked up on your intent and has taken an interest in the upcoming show. The husky girl whines softly and wags her tail, turning to flash her wet pussy at you. It seems like [if ColleenCollared > 0]your slutty pet[else]the stray bitch[end if] would enjoy some time with you as well.";
	...
	if Player is male:
		if Cock Length of Player < 5:
			...
			if Cock Count of Player > 1:
				say "     She salivates a little as she eyes your multiple rods. 'I [if rabbitmulticock is 0]never played with someone like that. I bet it would feel great...' [else]am so happy to see those! And they look happy to see me,' [end if]she says, mostly to herself, her thick musk permeating the room as she wriggles her rump.";
				if rabbitmulticock is 0, now rabbitmulticock is 1;
			say "     [if Cock Length of Player < 8]She reaches to brush her soft fingers across your throbbing member. 'A little on the small side for me, but that looks just delicious,' she purrs at you with a smile, her scent thickening with desire.[else if Cock Length of Player < 12]Her eyes go wide as she measures the length of your cock mentally, then with her lusty fingers. 'Oh, god, you are just perfect. You must get all the ladies, don't you?' She titters softly, rubbing her curvaceous front to you, tail wiggling behind her.[else]She gasps with amazement as your [cock size desc of Player] [Cock of Player] equipment is exposed to her, clapping a hand over her face before she turns deep red. 'Damn! I... I am not sure I can even take that, but I want to try, oh I want to try!'[end if]";
	...
	if rabbitsibling is 1:
		...
		if Player consents:
			...
			if Player consents:
				...
				now tempnum is 0;
				if Player is male:
					say "     'Oh, someone's being very naughty!' Happily, Sandra reaches over to reciprocate your attendance, [if Cock Count of Player > 1]wrapping a hand around one of your dicks to softly stroke[else if Player is male]wrapping a hand around your dick to softly stroke[else if Player is female]moving a hand between your thighs to softly fondle[else]moving a hand to softly fondle[end if] you as you persist, the wet sound of your continued plunging into the lady's eager depths filling the air. You figure you can make better use of your tool[smn] on her still-exposed pussy. Shall you?";
					if Player consents:
						LineBreak;
			...
			say "     'W-...Whew, what a ride! I'm going to keep my hands on this bad boy!' Once everyone's taken care of, she stows the item away with the rest of her possessions[if Sandra is in Bunker], and you go about your business once more[else]. 'You know, I think it's probably best if I move in with you! Makes it easier to find me, and this place isn't nearly as safe as it used to be.' Agreeing with her, the two of you help pack up her stuff and head off to the bunker[end if].";
		else:
			LineBreak;
			...
			say "     'That was fun! I think I'll enjoy using this bad boy on my... [if scalevalue of Player < 4]little[else]'little'[end if] [sangr] again in the future!' Once everyone's taken care of, she stows the item away with the rest of her possessions[if Sandra is in Bunker], and you go about your business once more[else]. 'You know, I think it's probably best if I move in with you! Makes it easier to find me, and this place isn't nearly as safe as it used to be.' Agreeing with her, the two of you help pack up her stuff and head off to the bunker[end if].";
		...
		if ( gestation of Child is not 0 or child is born ) and Sandra is not in Bunker:
			...
			say "     She [if child is born]looks over your [BodyName of child] child and reaches to pet them lightly, then hug them close. 'Hello! My... you grew up fast. I will help take care of you.'[else]rubs over your belly softly, almost purring, 'You will be a parent soon. I'm so excited!'[end if]";
...
to say sandrasex3:
	...
	say "     Sandra moans and pants as her excitement builds, her hands rubbing over your head[if rabbitsibling > 1]. She ends up tugging lightly on your bunny ears, urging you for more[end if]. You [if scalevalue of Player > 3]push several big fingers into her spacious vagina and fingerfuck[else]end up pushing the whole of your hand into her spacious vagina and fist[end if] her to a crashing orgasm.";
	now lastfuck of Sandra is turns;
...
to say sandrasex4:
	...
	if Player is male:
		...
		say "     You're about to get started when she presses her muzzle to your [cunt size desc of Player] puss[yfn] and starts stroking your sensitive petals and licking at them with gusto. [if a random chance of Libido of Player in 100 succeeds]Not wanting to keep the eager rabbit waiting, you press your lips to her wet folds and drag your tongue across them. As eager as the bunny for it, you lavish attention upon her pussy with energetic zeal[else]Rather than dive right into it like the eager rabbit, you instead start gradually with light caresses and brushes of your tongue across her wet folds. After teasing her like this for a while, which only gets her more excited and working her tongue even faster and deeper, you give her clit a kiss and then dive into eating her out as eagerly as she's going down on you[end if].";
...
to say sandrasex5: [Post-transformation toy sex]
	...
	if rabbitsibling is 5:
		say "     '[one of]Oh boy[or]Mmm[or]Yes[or]Great[at random], [one of]let's get to planting this thing[or]time for some fun[or]time to bury the carrot[at random],[if rabbitsibling > 5] little[end if] [sangr]!' Giddy with anticipation, she hands you the thing before laying down to expose the excited, already-slick lips of her oversized cunt before you.";
		...
		say "     '[one of]W-whew[or]Heavens[or]Ahh[at random], [one of]what a rush[or]I'll be walking funny for a while[or]that never stops being fun[at random]!' Once everyone's taken care of, she stows the item away with the rest of her possessions, freeing you to go about your business once more.";
	else:
		say "     '[one of]Oh boy[or]Mmm[or]Yes[or]Great[at random], [one of]let's get to planting this thing[or]time for some fun[or]time to bury the carrot[at random],[if rabbitsibling > 5] little[end if] [sangr]!' Giddy with anticipation, she gently forces you to lay down on your back, softly fondling your[if scalevalue of Player > 3] larger,[end if] [bodytype of Player] form to properly expose yourself before her. Carefully, she feels your crotch up and gets a good gauge for her angle of approach.";
		if Player is not female or (anallevel is 3 and a random chance of 2 in 3 succeeds):
			say "     '[one of]Hmm[or]Tsk[or]Hmpf[at random], [one of]little [sangr] needs a good filling[or]I bet you like getting rammed by your bigger sister[or]I think my little [sangr] enjoys being their sister's plaything[at random]!' the [if scalevalue of Player > 3]smaller [end if]rabbit girl teases you as she begins preparations, forcing a finger past your tight anal ring. She methodically massages your soft inner-flesh, sending jolts of searing pleasure up your spine. You stretch to accommodate her digits [if scalevalue of Player > 3 or player is twistcapped]easily[else]with a little work[end if], anal ring relaxing as she continues to explore your depths. In her second hand, she casually fondles the carrot-shaped tool, tongue moving to caress its substantive length in meager lubrication for its inevitable use.";
			say "     Concluding her preparation, Sandra pulls the carrot-shaped toy out of her mouth again, now coated in a sheen of slick saliva. Her hand withdraws from your rear, only to be replaced by the tip of that exotic rod, gradually shoving its way through your supple hole. A soft moan forced to escape your lips, you're made to take more and more of its distinctive, ridged length, even as its tapered girth becomes increasingly wide.";
			...
			say "     '[one of]Hmm[or]Tsk[or]Hmpf[at random], [one of]little [sangr] needs a good filling[or]I bet you like getting rammed by your bigger sister[or]I think my little [sangr] enjoys being their sister's plaything[at random]!' the [if scalevalue of Player > 3]smaller [end if]rabbit girl teases you as she begins preparations, forcing a finger past the supple folds of[if Cunt Count of Player > 1] one of[end if] your cunt[sfn]. She methodically massages your soft inner-flesh, sending jolts of searing pleasure up your spine. You stretch to accommodate her digits [if Cunt Depth of Player > 11]easily[else]with a little work[end if], the initial tension gradually fading as she explores your needy depths. In her second hand, she casually fondles the carrot-shaped tool, tongue moving to caress its substantive length in meager lubrication for its inevitable use.";
			say "     Concluding her preparation, Sandra pulls the carrot-shaped toy out of her mouth again, now coated in a sheen of slick saliva. Her hand withdraws from your folds, only to be replaced by the tip of that exotic rod, gradually shoving its way through your slick, eager pussy. A soft moan forced to escape your lips, you're made to take more and more of its distinctive, ridged length, even as its tapered girth becomes increasingly wide.";
			...
			say "     Finally, you cry out in bliss[if Player is male], your cock[smn] sputtering your strained, [Cum Load Size of Player] load all over the ground[end if]. Sandra releases her grasp on the toy, allowing your pussy to clench around it for more stimulation while she fondles herself excitedly. With one final push, she forces the large toy [if Cunt Depth of Player > 11]entirely down your cunt, barely able to keep a hold on it[else]as far down as she can[end if], squeezing all the ecstasy she can out of you until you finally collapse, completely spent.";
		say "     Left to wallow briefly in your own lust-addled haze, the rabbit girl is still riding high on her own bliss, clearly getting off on seeing the toy rammed down you as it is. When your lusts eventually simmer down, she reaches over and pulls the toy free of you, the loud, wet sound of its liberation filling the air.";
		say "     '[one of]That was fun[or]Oh, you[or]Silly rabbit[at random]! [one of]I like watching you writhe like that[or]You sure enjoy taking that carrot[or]The thing almost didn't want to come out[at random]!' Once everyone's taken care of, she stows the item away with the rest of her possessions, freeing you to go about your business once more.";
...
to say sandraColleentrio:
	...
	if rabbitsibling > 0:
		if FaceName of Player is "Husky Bitch" or FaceName of Player is "Husky Alpha":
		...
		else if FaceName of Player is not "Rabbit Girl":
			...
			now FaceSpeciesName of Player is "Rabbit";
	if rabbitsibling > 1:
		if TailName of Player is "Husky Bitch" or TailName of Player is "Husky Alpha":
		...
		else if TailName of Player is not "Rabbit Girl":
	...
	if Sandra is in the Bunker:
		...
		if HP of Player > 0:
			...
			if humanity of Player < 10:
				say "     Sandra [if ColleenAlpha > 0]ends up going off with Colleen, the dominant husky taking her to be the pack's bunny slut and to be bred full of adorable husky-bunny hybrid pups. On the rare occasions that her alpha allows her to spend time with you, the bunny tells you how much she is enjoying her new life, falling into her role as a plaything for the horny canines.[else]remains a loyal friend and affectionate lover to you for the rest of your days, remaining at your side despite your loss of humanity. She remains with you, tending to your needs, all of them, as best she is able. She does not permit you to predate on unchanged humans, tackling you to the ground when the urge becomes too strong and fucking you into a cooperative stupor. Could anyone ask for a better friend?[end if]";
			else:
