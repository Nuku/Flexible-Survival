...
carry out sanreq:
	if rabbitsibling is 0:
		...
		say "     'Okay, [sangr], you want me to see you as [if sangenreg is false]male[else]female[end if]?'";
		if player consents:
...
to say sandrasex2:		[become bunny siblings]
	...
	if rabbitsibling is 2:
		...
		if player consents:
			...
			say "     'Oh, this'll be fun~!' [if scalevalue of player < 4]Rabbit girl eager to prepare you[else]An amusing sight to see as the smaller rabbit girl begins to prepare you[end if], she forces a finger past ";
			if cunts of player is 0:
				say "your tight anal ring. Sending jolts up your spine as she methodically massages your soft inner-flesh, you stretch to accommodate her digits [if scalevalue of player > 3 or player is twistcapped]easily[else]with a little work[end if]. In her second hand, she casually fondles the carrot-shaped tool, tongue moving caress its substantive length in meagre lubrication for its inevitable use.";
				...
				say "     'Ha, I think somebody's enjoying themselves!' Teasing you, the lady begins to force the core of the length in and out of your eager hole, causing you to writhe and twitch with each thrust. Easily aroused by being so thoroughly penetrated, [if cocks of player > 1]your [cock size desc of player] dicks bob against the open air, staining the ground and your underside with precum and inviting her to grab one and casually stroke you off[else if cocks of player is 1]your [cock size desc of player] dick bobs against the open air, staining the ground and your underside with precum and inviting her to grab it and casually stroke you off[else]throbbing hole further slicking it with your honey and driving her to fondle herself by the sight[end if]. The wet sound of her continued abuse of your hole filling the air for what seems like a blissful eternity, sweat-slicked body quickly becoming exhausted from all the methodical attention.";
...
to say sandrasex4:
	...
	if cocks of player > 0:
		...
		say "     With an eager lover working hard to please you and earn their delicious reward, soon you're both panting and moaning between licks[if cock length of player > 30].  With a great deal of effort, she's managed to somehow wedge a considerable portion of your [cock size desc of player] manhood into her mouth and down her throat, bulging her out visibly[else if cock length of player > 15].  With some effort, she's managed to stuff the whole of your [cock size desc of player] cock into her mouth and down her throat[else].  By this point, she's taken the whole of your [cock size desc of player] cock into her mouth and is licking and sucking firmly at it[end if][if cocks of player > 1].  Her paws busily stroke and caress your other shaft[smn][end if].";
...
to say sandrasex5: [Post-transformation toy sex]
	...
	if rabbitsibling is 5:
		...
		say "     '[one of]Hmm[or]Tsk[or]Hmpf[at random], [one of]little [sangr] needs a good filling[or]I bet you like getting rammed by your bigger sister[or]I think my little [sangr] enjoys being their sister's plaything[at random]!' [if scalevalue of player < 4]Rabbit girl teasing you as she begins preparations[else]An amusing sight to see as the smaller rabbit girl tease you as she begins preparations[end if], she forces a finger past ";
...
to say sandracoleentrio:
	...
	if rabbitsibling > 0 and ( facename of player is not "Rabbit Girl" or facename of player is not "Female Husky" or facename of player is not "Alpha Husky" ):
		...
		now face of player is "set of two long white rabbit ears twitching above your head, looking odd compared to your normal";
		now facename of player is "Rabbit Girl";
	else if rabbitsibling > 0 and ( facename of player is "Female Husky" or facename of player is "Alpha Husky" ):
		say "     She looks at your husky face and smiles, grinning to Coleen.  'Oh, I guess a husky face is pretty cute, too.  Don't you think, sweety?' she asks [if coleencollared > 0]your slutty pet[else]the horny stray[end if] as she scritches the doggy's ears.";
	if rabbitsibling > 1 and ( tailname of player is not "Rabbit Girl" or tailname of player is not "Female Husky" or tailname of player is not "Alpha Husky" ):
...
to say sctriomale:
	say "     Taking a seat on her bunk, you slide the bunny girl into your lap, rubbing your stiff [if cocks of player > 1]members[else]member[end if] against her ass and fluffy tail.  She moans softly as you tease her nipples while hops up to give her another doggy kiss.  You grind against her softly-furred bottom, leaking precum onto her [if cock length of player > 12]back[else]tail[end if] until you can't wait any longer and want more.";
...
When play ends:
	if Sandra is in the Bunker:
		if Fang is in the Grey Abbey Library and HP of Fang is 3 and coleenalpha is 0 and humanity of player < 10:
			...
			else if humanity of the player < 10:
