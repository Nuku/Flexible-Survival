...
to say sandrasex1: [fuck the bunny]
	...
	if player is male:
		...
		if cock length of player < 5:
			...
			if over-sized is 1 and multicocks is 1:
...
to say sandrasex2: [become bunny siblings]
	if rabbitsibling is 1:
		...
		if player consents:
			...
			say "     You make you intent clear by taking the over-sized rod from Sandra, gesturing for her to lay down. Eagerly, she obliges, laying down to expose the excited, already-slick lips of her over-sized cunt.";
...
to say sandrasex5: [Post-transformation toy sex]
	...
	if rabbitsibling is 5:
		say "hands you the thing before laying down to expose the excited, already-slick lips of her over-sized cunt before you.";
