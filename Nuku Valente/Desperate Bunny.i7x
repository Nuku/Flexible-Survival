...
to say sandrasex1:		[fuck the bunny]
	...
	if the cocks of the player is greater than 0:
		...
		otherwise if cock width of player is less than 10:
			...
			increase lust by 2;
		otherwise:
			now response3 is " She snorts with astonishment as she gapes at your crotch, 'I don't know how I[apostrophe]ll stuff that into me, but let[apostrophe]s get to trying!'";
			increase lust by 2;
			now oversized is 1;
