	...
	if rabbitsibling is 2:
		...
		if player consents:
			...
			if cunts of player is 0:
				say "your tight anal ring. Sending jolts up your spine as she methodically massages your soft inner-flesh, you stretch to accommodate her digits [if scalevalue of player > 3 or player is twistcapped]easily[else]with a little work[end if]. In her second hand, she casually fondles the carrot-shaped tool, tongue moving caress its substantive length in meager lubrication for its inevitable use.";
				...
				say "the supple folds of[if cunts of player > 1] one of[end if] your cunt[sfn]. Sending jolts up your spine as she methodically massages your soft inner-flesh, you stretch to accommodate her digits [if cunt length of player > 11]easily[else]with a little work[end if]. In her second hand, she casually fondles the carrot-shaped tool, tongue moving caress its substantive length in meager lubrication for its inevitable use.";
