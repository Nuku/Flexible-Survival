...
when play ends:
	if bodyname is "black equinoid":
		...
		otherwise:
			say "     There is some confusion at first when your equinoid body is brought in, for there are several strains of equines and proper classification is slow.  It seems ones like you are rare, few leaving the park where they're established.  Once that's resolved, it goes much more smoothly, as you're not considered a dangerous strain.  A movie producer spots you on TV as you are released and hires you immediately to play a minotaur-like creature in his upcoming movie.  It turns out to be [one of]big blockbuster[or]lukewarm summer movie[or]big flop[at random] and provides some cash to start a new, peaceful life.  Eventually becoming a naturalist, you study nature and, using your movie experiece as a hoofhold, you get your own nature show[if intelligence > 15 and charisma > 15] that lasts several seasons.  It does rather well, being insightful and intelligent while also well-presented and entertaining[otherwise] for a brief time[end if].";
