...
When Play begins:
	...
	now face entry is "an equine face, with an elongated snout and broad flat teeth set in your long muzzle";[ Face description, format as the text "You have a (your text) face."]
