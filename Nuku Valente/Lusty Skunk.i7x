...
when play begins:
	add Lusty Skunk to BadSpots of FemaleList;
	add Lusty Skunk to BadSpots of FurryList;
	...
	if skrp is -1:
		...
		if Player is male:
			if Cock Length of Player < 9:
				...
				WaitLineBreak;
				say "     Her lower paws tuck in and grasp at your mighty tool, pulling at it slowly as her hips grind up against you lustfully. [if Cock Count of Player > 1]Your extra male meat is left to run along her sides, stimulated as she ruts against you, stroking with fur even as her dexterous paw works at one. [end if]She makes soft affectionate sounds as her tail flutters in the air, then curls back. You can feel your [Ball Size Adjective of Player] orbs being rubbed against firmly, encouraging them to release their increasingly urgent load.";
				say "     You can hold it no longer. Rising your hips against her, burying your cock into her plush belly fur[if Cock Length of Player > 26] and emerging beyond[end if], you groan, then grasp at the ground as your balls lift and you give her what she wanted, spraying her and yourself with thick gushes of your fertile gift. She begins to vibrate on top of you, rumbling with satisfaction. Even as you pant for breath, she rises from you, and begins to lick you clean, holding you still with one paw. Her gentle touches have you drifting to sleep, soothed with the wonderful presence.";
...
to say doubleskunk:		[separated to edit and remove 'stop the action']
	if Player is male:
		...
		if a random chance of 1 in 3 succeeds:
			...
			now skrp is 1;
			add "Skunkbeast Lord" to infections of TaurList, if absent;
			[scale up the Skunkbeast Lord by 1]
			if "Skunkbeast Lord" is a Name listed in Table of Random Critters:
		...
		say "     She draws you tight against herself, hugging, rubbing slowly along your sides and back quietly a moment before rolling you right onto your back with surprising strength. She slips over you, nuzzling along your [Skin of Player] thighs. Her wet nose presses to your swollen labia, lapping softly with her warm wet tongue. She tastes you, then delves slowly, rough texture pressing into your yielding tunnel as a paw reaches under you, lifting your rump against her snout even as a finger wriggles slowly into your back door, exploring your depths as eagerly as her tongue delves into your sopping wet tunnel. Your body shudders with paralyzing pleasure, a sharp cry of pleasure as she nuzzles firmly against your [cunt size desc of Player] passage, your body yielding painlessly, stretching a little as she seems to bury most of her snout into your body.";
		WaitLineBreak;
