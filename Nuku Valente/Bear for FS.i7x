...
When Play begins:
	...
	now face entry is "bearlike face, with an elongated snout and big bear teeth set in what is definitely not a teddy bear";[ Face description, format as the text "You have a (your text) face."]
