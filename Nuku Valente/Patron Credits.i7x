Patron Credits by Nuku Valente begins here.

to say patroncredits:
	say "Thank you to all of our loyal patrons!";
	say "Some in particular...";
	say "Creative Supporters: John Forrest";
	LineBreak;
	say "Artistic Supporters: Aureas_Gigas, Asurea Skie";
	LineBreak;
	say "Mildly Cheating Supporters: Vikteren, StarcraftJunkie, Sveny, bommie20, Chris A, Searnadrix, MartiniMaker, Ricky, Darquirrin, Lupe Strap, adam deffendall, Lasse T. Stendan, Derek Bryan";
	LineBreak;
	say "Enhanced Supporters: lightningshifter";
	LineBreak;
