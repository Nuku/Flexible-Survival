...
When Play begins:
	...
	now face entry is "furry[if Susan is in primary lab], feminine,[otherwise], antlered,[end if] face of an enchanting stag doe. Your eyes burn with a smoldering lust as they look about from the end of your muzzled face";
