...
to say FangMutualLust:
	...
	if Player is male:
		say "You feel hot splashes of pre pouring from yourself as you grow more lustful by the moment[if ball size of Player > 0], your [ball size] aching with the need to release[end if]. ";
	if Player is female:
	...
	if Player is female:
		...
		if Cock Count of Player > 1:
			say "With multiple [cock size desc of Player], [cock of Player] poles to choose from, Fang licks along each from the base to the tip in slow motions of that wet tongue, tasting each with a nuzzle[if ball size of Player > 0] before dipping beneath to nuzzle at your [ball size] eagerly[end if]. The tongue lashing received there has you arching your back, spit-slick muscle teasing your [skin of Player] sac in long, rapid motions, slathering you with lupine saliva and making your cocks twitch with need. After a little while, he returns attention to one of your lengths, running his tongue up and down it, teasing and stroking it with that wet appendage as he works you higher and higher towards your peak.";
