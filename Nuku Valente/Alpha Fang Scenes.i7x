...
to say fangrapeplayer:
	...
	if cunt length of player is greater than 0 and cunts of player is greater than 0:
		...
		say "You feel warmth seeping through your feminine lips as you moisten with readiness and increasing anticipation. The thought of your alpha taking you was becoming more delicious by the moment. [run pargraph on]";
	...
	if cock length of player is greater than 0 and cocks of player is greater than 0:
		say "With dizzying force, you suddenly spray your own seed out against the desk, splattering its smooth surface with your seed as you groan with pleasure alongside Fang. His hands support you as you go weak kneed from the stimulation. [run paragraph on]";
	say "Satisfied, Fang pants lightly as he relaxes on top of you for a few quiet minutes, gently stroking your sides and back with his hands. 'Next time, come back sooner,' he whispers, then pulls free of you with a wet pop, allowing some of the seed to run free as he goes to clean up.";
