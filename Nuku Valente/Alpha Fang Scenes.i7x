...
to say fangplayerlust:
	...
	if anal is 0:
		...
		say "You raise your hands to his powerful sides, feeling the play of his muscles as he ruts into you with feral intensity. Your sounds of delight mix with his eager growls as his claws scrape against the library floor. His oversized knot is forced into you and he hunches against you. Liquid heat spreads through your body as you[']re filled with his virile thick cream. The sensation is enough to send your cunt into spasms of release, clamping wetly around the twitching member. He sags against you, spent and content, and as the haze lifts, you realise the raging heat inside of you has ebbed a little, leaving you clear headed and thankful to your alpha.";
		say "[impregchance]";
	otherwise:
...
to say fangmutuallust:
	...
	if cunts of player is greater than 0 and cunt length of player is greater than one:
		say "Your nethers grow damp as you begin to feel like a bitch in heat. The large wolf gives you a pointed look as one of your [body of player] hands wander towards your thighs. A light nip wards your hand away. [run paragraph on]";
