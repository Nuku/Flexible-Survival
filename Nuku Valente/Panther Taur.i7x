...
to say panthertaur rape: [panthertaur wins or player gets mounted]
	...
	if Player is puremale and anallevel > 1: [checks that 1.male and 2.not less anal]
		...
		CreatureSexAftermath "Player" receives "OralCock" from "Panther Taur";
		PlayerEat 5;
...
When Play begins:
	...
	now Species Name entry is "Panther Taur"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
