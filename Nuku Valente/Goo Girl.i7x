...
to say goovictory:
	...
	if cocks of player > 0 and (a random chance of 1 in 2 succeeds or (cunts of player is 0 and anallevel is not 3)):
		...
		say "     '[one of]I think somebody likes that[or]We're just getting started here[or]You should see the look on your face[at random]!' Teasing you, [if cunts of player > 1]you feel her malleable mass flood your cunts, further stimulating[otherwise if cunts of player is 1]you feel her malleable mass flood your cunt, further stimulating[otherwise if anallevel is 3]you feel her malleable mass flood your ass, further stimulating[otherwise]she caresses your [bodytype of player] form, offering gentle affection[end if] you. Dark sewers filled with the wet sounds as she writhes against you, you're made to watch on as she grins at you, taking a certain joy in seeing you squirm against her overwhelming touch.";
