...
to say goovictory:
	...
	say "Wrapping her undulating arms around your[if scalevalue of player < 2] smaller,[otherwise if scalevalue of player > 3] larger,[end if] [bodydesc of player] form, her transparent appendages carefully worm around, fondling around lewdly and easily prying away any obstruction in her way.";
	if cocks of player > 0 and (a random chance of 1 in 2 succeeds or (cunts of player is 0 and anallevel is not 3)):
		say "     [if hp of player < 1 and player is not submissive]Forcing[otherwise]Bringing[end if] you to lay on your back, she writhes her way on top of you, crotch enveloped in her amorphous base. Positioned such that her crotch meets yours, your [cock size desc of player] dick[if cocks of player > 1]s are[otherwise] is[end if] visibly trapped within her transparent torso[if cock length of player > 14 and cocks of player is 1], visibly bulging to contain it[otherwise if cock length of player > 10 and cocks of player > 1], visibly bulging to contain them[end if]. Her gelatinous form eagerly kneading the whole of your length[smn], it's no effort for her to drive you to full arousal.";
		say "     '[one of]I think somebody likes that[or]We're just getting started here[or]You should see the look on your face[at random]!' Teasing you, [if cunts of player > 1]you feel her malleable mass flood your cunts, further stimulating[otherwise if cunts of player is 1]you feel her malleable mass flood your cunt, further stimulating[otherwise if anallevel is 3]you feel her malleable mass flood your ass, further stimulating[otherwise]she caresses your [bodytype of player] form, offering gentle affection to[end if] you. Dark sewers filled with the wet sounds of her writhing body against your [bodydesc of player] frame, you're made to watch on as she grins at you, taking a certain joy in seeing you squirm against her overwhelming touch.";
		say "     It doesn't take long before you finally cry out in bliss, firing off your [cum load size of player] load into her torso, where you might see it fill her. [if cock width of player > 19]Moaning weakly, she visibly bulges to contain your load, she's nonetheless stretchy enough to contain your impressive release, milking you completely dry[otherwise]Moaning softly, her body eagerly milks you dry of every last drop you have to offer[end if]. She continues to stimulate you for a while longer until it's clear you can offer her no more.";
		say "     '[one of]Hmm[or]Mm[or]Ah[at random], [if cock width of player > 19][one of]it looks like I'm stuck here for a while[or]I feel a little dizzy after all that[or]this is going to go straight to my hips[at random][otherwise][one of]that was fun[or]that's just what I needed[or]we should play again, soon[at random][end if]!' Giggling at you, you're allowed to pull yourself free of her[if cock width of player > 19] bloated[end if] mass before she disappears into the darkness, taking a while to clear your head and clean up the mess she left behind.";
	otherwise if cunts of player > 0:
		say "     Pinning you to the ground, you feel the creature's gooey digits softly fondle your cunt[sfn]. Not intent on teasing you for too long, you immediately feel them forced past [if cunts of player > 1]the supple lips of one of them[otherwise]your supple lips[end if]. [if cunts of player > 2]Arm becoming formless under the pressure of your [cunt size desc of player] portal, it forces its forces its way into your other holes, soon stimulating them simultaneously[otherwise if cunts of player is 2]Arm becoming formless under the pressure of your [cunt size desc of player] portal, it forces its forces its way into your other hole, soon stimulating them simultaneously[otherwise if anallevel is 3]Arm becoming formless under the pressure of your [cunt size desc of player] hole, it forces its forces its way past your anal ring, soon stimulating them simultaneously[otherwise]Arm becoming formless under the pressure of your [cunt size desc of player] hole, you feel its warm touch coating your ass[end if].";
		say "     '[one of]I like it when they squirm like that[or]I think somebody's enjoying themselves[or]Oh, this is fun[at random]!' Giggling as you writhe against her deeply penetrating touch, she watches on, loud squelching from each motion echoing through the damp sewers. [if cocks of player > 0]Your dick[smn] wave[smv], unattended, against the open air, strings of precum sticking against your lower torso and the ground[otherwise if cunts of player > 1]Your pussies drip against her persisting assault, juices consumed by her malleable touch[otherwise]Your pussy drips against her persisting assault, juices consumed by her malleable touch[end if].";
		say "     After being pounded for a fair while, you finally cry out in bliss, [if cocks of player > 0]spilling your [cum load size of player] load against the earth[otherwise]needy hole[sfn] squeezing against the goo girl's touch[end if]. Giggling, she takes every effort to prolong your bliss, pounding your hole[if cunts of player > 1 or anallevel is 3]s[end if] with a persistent determination until it's clear that her new[if scalevalue of player > 3], big[end if] friend is completely spent. Satisfied with using you so, she pulls her arm free of your [bodytype of player] form, lightly caressing along its abused[if cocks of player > 0] and cum-stained[end if] surface to 'clean' you of any mess -- a veneer of her [if tempnum2 is 1]blue[otherwise if tempnum2 is 2]green[otherwise]purple[end if] slime following in its wake -- before pulling back.";
		say "     '[one of]Hmm[or]Mm[or]Ah[at random], [one of]I made such a mess[or][if hp of player < 0]that'll teach you[otherwise]I think you enjoyed that[end if][or]we should play again, soon[at random]!' Giggling at you, she departs, returning to the darkness once more. It takes you a while to recover from the whole ordeal and dry yourself off.";
	otherwise:
...
To say goodefeat: 
	...
	if libido of player > 30 or "Dominant" is listed in feats of player:
		...
		if player consents:
			if cocks of player is greater than 0 and (cunts of player is 0 or a random chance of 1 in 2 succeeds):
				if cock length of player is greater than 20:
					say "     Slowly approaching the prone, jelly lady, you lower your [cock size desc of player] dick[smn] to her exposed lips. Some resistance is felt, but you press more firmly, and she begins to spread out around [if cocks of player > 1]one of your tools[otherwise]the tool[end if]. You push further, deeper, marveling at the deliciously tight, snug, fit her body offers to your sensitive body. Rearing back, she cries out, lifted entirely from the ground, impaled on your [cock size desc of player] pole.";
...
When Play begins:
	...
	now defeated entry is "[goodefeat]";				[ Text when monster loses.  Change 'template' as above. ]
	now victory entry is "[goovictory]";						[ Description of the creature when you encounter it. ]
	...
	now skin entry is "[one of]jellied[or]gelatin-like[or]translucent[at random] [if goocolour is 1]blue[otherwise if goocolour is 2]purple[otherwise]green[end if]";	[ Skin desc., format as the text "Your body is covered in (your text) skin."  Note: the word 'skin' is automatically included at the end. ]
...
to say googirlskinchange:
	...
	say "a ripple of tingles rushes through your entire body as you sink towards the ground, then rise again, wobbling along the way. A glance at a hand shows that you can see right through your now jello-like flesh, [if goocolour is 1]blue[otherwise if goocolour is 2]purple[otherwise]green[end if] in colour";
