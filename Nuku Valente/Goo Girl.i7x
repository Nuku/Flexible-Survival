...
to say goovictory:
	...
	if Player is male and (a random chance of 1 in 2 succeeds or (player is not female and anallevel < 3)):
		...
		say "     It doesn't take long before you finally cry out in bliss, firing off your [Cum Load Size of Player] load into her torso, where you might see it fill her. [if ball size of Player > 19]Moaning weakly, she visibly bulges to contain your impressive release, her body eagerly milking[else]Moaning softly, her body eagerly milks[end if] you dry of every last drop you have to offer. She continues to stimulate you for a while longer until it's clear you can offer her no more.";
		say "     '[one of]Hmm[or]Mm[or]Ah[at random], [if ball size of Player > 19][one of]it looks like I'm stuck here for a while[or]I feel a little dizzy after all that[or]this is going to go straight to my hips[at random][else][one of]that was fun[or]that's just what I needed[or]we should play again, soon[at random][end if]!' Giggling at you, you're allowed to pull yourself free of her[if ball size of Player > 19] bloated[end if] mass before she disappears into the darkness, taking a while to clear your head and clean up the mess she left behind.";
