		...
		-- 4:
			...
			if difficulty > dice:
				...
				if "Haggler" is listed in feats of Player:
					...
					say "After working out the specifics, you are handed the [y] and stuff it into your backpack[if aa >= bb]. You even manage to haggle a second one from the mutant[end if][if petbonus is true], though having an intimidating guard by your side may have helped a little[end if].";
					if aa >= bb:
						ItemGain y by 2;
					else:
						ItemGain y by 1;
				else:
					say "After working out the specifics, you are handed the [y] and stuff it into your backpack[if petbonus is true], though having an intimidating guard by your side may have helped a little[end if].";
					ItemGain y by 1;
		-- 5:
			if MaleList is banned or a random chance of 1 in 2 succeeds:	[female mutant]
				...
				if Player consents:
					...
					if "Haggler" is listed in feats of Player:
						...
						let bb be difficulty * 2;
						let bb be a random number from 1 to bb;
						say "     When released, you gasp to catch your breath after being smothered against her crotch. Her excess juices run down your chin and neck. You're tossed the [y] by one of her friends[if aa >= bb] and even manage to haggle a second one from them[end if].";
						if aa >= bb:
							ItemGain y by 2;
						else:
							ItemGain y by 1;
					else:
						say "     When released, you gasp to catch your breath after being smothered against her crotch. Her excess juices run down your chin and neck. You're tossed the [y] by one of her friends.";
						ItemGain y by 1;
					if Player is submissive or Player is kinky:
						say "[line break]     Despite (or perhaps even because of) how dirty you feel for what you've done, you can't help but be a little pleased with yourself and quite turned on.";
						raise Player Libido by 10;
						increase morale of Player by 1;
					else:
						say "[line break]     Feeling somewhat dirty for what you've done, you wonder what depths you'll sink to before this is all done. Despite this, you can't help but feel a little turned on as well.";
