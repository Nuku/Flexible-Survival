...
To say Elf loss:
	...
	if libido of player > 29:
		...
		if player consents:
			...
			if elfenc < 4:
				say "     You advance on her, but a sudden breeze of forest air whisks her away in a blur. [if elfenc is 2]You'll probably have to try again next time you run into her[otherwise]You almost managed to grab her that time[end if].";
			otherwise if elfenc is 4 or elfenc is 5:
			...
			otherwise:
				say "     Grabing her wrist, she submits to you this time.  'You have bested me, warrior, time and again.  I must accept my fate,' she says, head bowed.  Grinning and quite pleased, you run your hand through her lovely hair as you guide her head between your legs";
				if cocks of player > 0:
