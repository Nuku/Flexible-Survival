...
to say ResolveEvent Mouse Taur Encounter:
	if mtrp is 0:
		say "     A voice suddenly rises, startling you. Spinning about in alarm, you see a creature approaching you. She has a body that reminds you of a basic house variety mouse, if expanded until it were six feet long. Where its head should be is the belly and upper torso of a humanoid. As she approaches, her two C or D cup breasts sway in counterpoint to her two hips. Her face is mostly human, with fine whiskers, large round rodent ears and just enough snout to know it's there. She smiles at you, showing off bucked teeth. 'Hello,' she says. 'I was watching you roam around and thought you might like some company.' She [if Player is herm]looks you over critically, placing her pawlike hands on her hips and leaning a bit. 'I get the feeling you are what I want and some extra, huh... Life sure has gotten more interesting since the lights went out,' she says with a friendly expression. 'Glad to run into someone who can talk. My name is Lisa. What's your name?'[else if Player is male]looks you over critically, placing her pawlike hands on her hips and leaning a bit. 'I was hoping for something a little more...' she trails off, then shakes her head. 'Never mind that, I am being rude. You will be just fine, I'm sure, with some work.' She smiles brilliantly and offers a hand. 'Lisa. You are?'[else if Player is female]approaches closer, reaching to embrace you. You flinch with worry, but no harm befalls as she hugs you softly to her soft and warm body. Your face is drawn against her soft tits as her hand rubs your back quietly a moment. 'Poor little dear, lost in all this ruin and chaos. I'm Lisa, but you can call me mom if you prefer, or sis, that works.'[else]sniffs the air lightly and looks at you with some confusion. 'You must have had such a hard time of it,' she says with some sympathy. 'I am Lisa, nice to meet you.'";
...
to FindPornStore:
	if mtrp is 0:
		...
		say "[line break]     [bold type]How do you want to proceed?[roman type][line break]";
		...
		while calcnumber < 1 or calcnumber > 3:
			...
			if calcnumber < 1 or calcnumber > 3:
				say "Invalid choice. Type [link]1[end link] to break in, [link]2[end link] to knock or [link]3[end link] to leave.";
		LineBreak;
		if calcnumber is 1:
...
instead of going northwest from Boundary Street West while mtrp < 2 or mtrp is 100:
	if mtrp is 100:
...
Scent of Restrained Desire is "     The porn store smells of scented oils and candles, lube, latex toys, secret desires and backroom sex. There is also the smell of mouse [if HP of Sven > 49 and HP of Sven < 99]and snow leopard from its residents[else]from its resident[end if].".
...
to say pornstoredesc:
	...
	if HP of rubber tigress companion is 8 and rubber tigress companion is listed in companionList of Player:
		...
		now HP of rubber tigress companion is 9;
	...
	if a random chance of 1 in 2 succeeds: [ Aggressive]
		if Player is female: [ vanilla ]
			...
			if Player consents:
				...
				if Player is MalePreferred:
					say "[line break]Your body humms loudly as your innate resistance throws off the sexual change attempting to occur inside your manly body.";
			...
			if Player is not male: [You are not ready]
				say "     Lisa looks you over a moment before lifting her shoulders. 'I live in a porn shop. A little play isn't new, right?' She moves up to you and runs soft hands across your front and sides. 'Come with me into the back, and be naked when you do it.' She saunters off into her private backroom through a curtain of hanging beads that softly clack with the sound of jostled wood behind her. When you push through the curtains, ready, she looks at you a bit oddly. 'No offense,' she starts, 'but you seem to be missing parts to play with.' She brushes alongside you back towards the front. 'You come right back when you feel more... capable.'";
				now lastfuck of Lisa is turns plus 12;
				stop the action;
			say "     Lisa looks you over a moment before lifting her shoulders. 'I live in a porn shop. A little play isn't new, right?' She moves up to you and runs soft hands across your front and sides. 'Come with me into the back, and be naked when you do it.' She saunters off into her private backroom through a curtain of hanging beads that softly clack with the sound of jostled wood behind her. As you push through the curtain, you see she is rubbing over her soft human belly, tail curled behind her as she looks you over. She glances down at your [Cock of Player] dick and cracks a smile. 'I should warn,' she says in an almost musical trill, 'that will not last for long.' She advances on you, her warm front pressing to you as her left hand reaches to encircle your length and pull at it gently. 'The... disease, it tells me to grab you up like a chocolate, but I am not a beast. You sure you want this?'";
			...
			if Player consents:
				...
				if Player consents:
					LineBreak;
					say "     She [if Cock Count of Player > 1]squeezes your cocks together as best she can, licking across the slits of them all in as her hands stroke at a feverish pitch. You are unable to hold back any longer, balls contracting with a loud groan as you spray hotly. She latches onto one of your members and begins to guzzle down the bitter, salty offering as she's being painted with the remaining seed across hair and shoulders, her hands still stroking and pulling, draining you thoroughly[else]rubs along the tip of your member as she opens her snout. She begins to suckle in delicious eagerness as she lets a hand wander, rubbing along your thighs and making your legs quiver with the feel of her light claws pressing to sensitive points. All too abruptly, you feel the pressure explode. She swallows each burst as it comes, guzzling your rich male seed with soft sounds of approval, stroking you until you have no more to give[end if].";
					if Player is MalePreferred:
						say "[line break]Your body humms loudly as your innate resistance throws off the sexual change attempting to occur inside your manly body.";
						increase mousespot by 1;
					else:
						follow the sex change rule;
					say "[line break]     She licks over her lips as she rises back to her feet. '[one of]It is almost a shame I suck the dick right off of things. Almost.' [or]You look really tired. You should work on your stamina.' [or]That was nice. We should play again soon, OK?' [at random]She stretches out slowly. 'I am going to take a shower. Meet you back in front?' While you consider how she could take a shower, she vanishes down a hallway, leaving you to wander back into the front.";
				else:
					LineBreak;
		...
		if Player consents:
			...
			if Player is female: [ Have player eat her out ]
				...
				say "     [if Player is male]The mouse wrinkles her nose a little at the sight of your [Cock of Player] member[smn], but spying the honeypot below, beckons you closer with an outstretched arm[else]'Perfect,' the mouse utters, one paw raised and reaching for your own hand, seeming to draw your own up, meeting it, taking it[end if].";
			...
			if Player is MalePreferred:
				say "[line break]Your body hums loudly as your innate resistance throws off the sexual change attempting to occur inside your manly body.";
				increase mousespot by 1;
			else:
				follow the sex change rule;
		else:
...
This is the Lisa's and Svetlana's Epilogue rule:
	...
	if HP of Sven is 54 and humanity of Player > 9:		[Svetlana endings]
		trigger ending "Lisa's and Svetlana's Epilogue";
		say "     Svetlana keeps in touch with you[if mousefucked > 1] as well[end if], even coming to visit you at times when her mistress permits it. It seems Lisa's quite busy with her duties (which are never really elaborated upon), which keeps her from accompanying her pet. Burly guards keep the pink snowmeow safe on these journeys, making you feel that Lisa has become someone of import. You consider asking the pink kitty at times, but her lustful appetite for your attention during these visits always distracts you. You have long, [if Player is male]energetic breeding sessions with the kitty, making sure she's well and truly knocked up before letting her leave. She and Lisa won't allow anyone else to breed the pink snowmeow but her brave hero, so you always make sure to do your duty as best and as often as you can[else]lustful romps with the kitty, soaking up all the lavish pleasures she's learned on how to please the female body from her mistress[end if] during these rare visits.";
