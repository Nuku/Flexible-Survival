...
[Version 2 - Went over it and expanded the creature (Wahn). Original commissioned by AsureaSkie.]
...
to say LoseToNaga:
	if bodyname of player is "human" or bodyname of player is "herm human" and player is pure:
		say "     Your opponend laughs, like a dry hiss, tongue flicking as he moves over your defeated form, 'You ssshould leave thisss place, human. Your kind is finished in thisss city. Remember it - or you will be punissshed fresh.'";
	let randomnumber be a random number from 1 to 3;
	if anallevel > 1:		[anal ok]
		let randomnumber be a random number from 1 to 4;
	if randomnumber is:
		-- 1: 
			say "     The naga guy prods you with his club to ensure the fight has left you before slithering off, seemingly satisfied with its victory.";
		-- 2: 
			say "     The male naga throws his coils about you in a warm, initially soft, then crushing embrace. Breathing becomes hard as his body constricts. Consciousness fades to black. When you awaken, the snake-man has departed.";
		-- 3: 
			if "submissive" is listed in feats of player:
				say "     The serpentine creature entwines you in his coils, leaving only your head free to gasp for breath. As his tail tightens around you, his scaley hide rubs across your [bodydesc of player] body. Chuckling darkly at your feeble groaning, the male naga then moves his upper body in closer, showing off his twin human-like cocks, erect and dripping with precum. Seeing the guy's intent, you give in to your submissive feelings, parting your lips to gladly serve your ophidian master's pleasure. Without delay, he stuffs his twin erections into your mouth, hissing lustfully as he fucks your face. Being so fully in the power of another arouses you to no end and his precum tastes quite nice, so you suck and lick on his cocks on your own accord too, wanting to make it even better for him. Blowing the naga off eagerly, even enthusiastically, your mouth waters at the taste of the cocks filling your senses.";
			otherwise: 
				say "     The serpentine creature entwines you in his coils, leaving only your head free to gasp for breath. As his tail tightens around you, his scaley hide rubs across your [bodydesc of player] body. Chuckling darkly at your feeble groaning, the male naga then moves his upper body in closer, showing off his twin human-like cocks, erect and dripping with precum. Seeing the guy's intent, you close your mouth tightly, but another crushing constriction causes you to cry out, leaving your mouth wide to be stuffed by the twin erections. The taste of its precum arouses you and you are soon licking and sucking on them despite yourself. At first, this is rather reluctant, but soon you're going at it eagerly, even enthusiastically, your mouth watering at the taste of the cocks filling your senses.";				
...
to say NagaDesc:
	say "     A creature consiting of human and snake blended together in an intimidating mixture slithers into sight ahead of you. It is a naga - a male one, judging from what you see as he raises his human-like upper body to have a good look at you in turn.";
