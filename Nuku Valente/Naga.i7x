...
to say LoseToNaga:
	...
	if Player is purehuman and nagawarning is false:
		...
		say "     The throbbing shafts stuffing your mouth soon throb and pulse, releasing the creature's copious, thick semen into your overflowing mouth, unable to swallow because of his crushing coils around your chest. After chuckling at your plight for a moment, he relaxes his grip, allowing you to gulp down his musky load and gasp for breath. Dropping you to the ground now that he's done with you, the naga slithers off, leaving you weak and coughing as you try to recover from the crushing blowjob you've been made to endure.";
...
to say WinOverNaga:
	...
	if Player consents:
		...
		if Player is male:
			...
			CreatureSexAftermath "Naga" receives "OralCock" from "Player";
		else if Player is female:
			...
			CreatureSexAftermath "Naga" receives "OralPussy" from "Player";
		else:
...
When Play begins:
	...
	now MilkItem entry is "naga milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "naga cum"; [ Item to be given to the player if they have this infection and jerk off. ]
