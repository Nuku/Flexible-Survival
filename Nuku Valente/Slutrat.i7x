...
check ratdarts:
	...
	if visittimes of slutrat den is less than 1:
		...
		if the player consents:
			...
			challenge "Slut Rat";
			if lost is 1:
				move the player to Mall Restroom;
				stop the action;
		otherwise:
