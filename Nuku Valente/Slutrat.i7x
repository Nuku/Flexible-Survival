...
to say slut rat victory:
	setmonster "Slut Rat";
	say "     [if location of Player is Slut Rat Den]The rat grins as she pushes you towards the others, 'Let's remind this one how we treat bad people.' Of course, how they treat bad people and how they treat good people can be a bit foggy at times. At the call, the other rats stop their coupling and stroking and other diversions to instead gather around you with hungry expressions[else]Defeated, she grabs you and hauls you rapidly back towards her den, grinning the whole way like she knows a joke she does not care yet to share. When you arrive, you find many large pillows strewn about comfortably, and almost half a dozen other slut rats, stroking themselves, or each other, or kissing and otherwise engaged. They all pause when you are hauled in, and scramble to their feet, rushing up to enjoy and share the fresh meat[end if].";
	if Player is male:
		...
		if Cock Count of Player > 1:
			say ". Your extra endowment is not put to waste, as a rat girl reaches for each, and you are soon being stroked in increasingly fast motions. Your extra [if Cock Count of Player > 2]cocks are[else]cock is[end if] stroked with loving adoration as they nuzzle into your excited flesh and lap at [if Cock Count of Player > 2]them[else]it[end if] with warm soft tongues";
		say ".";
	if Player is female:
		...
		if Cunt Depth of Player < 12 or Cunt Tightness of Player < 7:
			...
			if Cunt Depth of Player < 12 or Cunt Tightness of Player < 7:
				say "     She humphs, 'You will not fit, but we can fix that,' she assures in a needy whisper in your ear. Soon your head is being tipped back as something sickly sweet is poured down your throat, making your female organs tingle powerfully as they begin to expand. Despite the growth, you remain a bit too small, but the rat only has so much patience. She drives up, stuffing her huge organ into your now sopping wet cunt, the lubrication doing much to ease the passage as she begins to piston against you, slapping your bottom with her huge swaying balls and breeding you with a feral intensity.[fimpregchance]";
			else:
				say "     She humphs, 'You will not fit, but we can fix that,' she assures in a needy whisper in your ear. Soon your head is being tipped back as something sickly sweet is poured down your throat, making your female organs tingle powerfully as they begin to expand. Now large enough, she smoothly pops her cock into your drenched hole, your needy fluids making it quite easy for her to pump lovingly against your wanton sex, grinding her hips against you when she isn't rocking with increasing intensity, her huge balls bumping you, promising a terrific load.[fimpregchance]";
		else:
			say "     Your needy cunt is soon being stuffed and your body rocked as she crashes into you with practiced strokes, tickling at your most sensitive places with her rock hard member. You can feel the tool spurting thick gobs of fluid inside of you with every thrust, even though she hasn't even climaxed yet, your body tingling with pleasure.[fimpregchance]";
	else:
	...
	say "     A rat grabs your head and pulls you off towards a waiting nipple. The milk flows thick and sweet across your tongue as your groin throbs and tingles with new delights. [slut rat growth][line break]";
...
When Play begins:
	...
	now Species Name entry is "Rat"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now Name entry is "Slut Rat";
	now enemy title entry is ""; [ Name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name. ]
	now enemy Name entry is ""; [ Specific name of unique enemy. ]
	now enemy type entry is 0; [ 0 = non unique enemy; 1 = unique (unknown name); 2 = unique (known name) | Used to disqualify unique enemies from Vore/UB and showing the enemy name in encounters. ]
	now attack entry is "[one of]She slices at your face with a sudden swipe of her claws[or]The slut rat makes a grab for you and rubs her body against yours, pressing her throbbing cock and luscious breasts against you[or]The slut rat stomps her heel onto your foot, then knees you in the gut[or]Her tail loops around and tickles at you between the legs even as she shoves you back against the ground[or]She suddenly turns, and a flying furry breast crashes into you painfully, making your head spin[at random]."; [Text used when the monster makes an Attack]
	now defeated entry is "     She gives a final hiss of defiance, then scurries away out of sight, leaving you with an image of her perfect rump and twitching tail to remind her by.[line break]"; [ Text or say command used when Monster is defeated.]
	...
	now face entry is "furry and narrow snout, with quivering black nose set in the middle of a very female, but clearly rodent"; [ Face description, format as "Your face is [Face of Player]." ]
	now body entry is "bent to emphasize fertile signals, with wide hips and narrow waist. You feel like you're putting out a constant ready signal to anyone looking at you"; [ Body Description, format as "Your Body is [Body of Player]." ]
	now skin entry is "[one of]black furred[or]rat furred[or]softly furred[at random]"; [ Skin Description, format as "Looking at yourself, your body is covered in [Skin of Player] skin." ]
	...
	now face change entry is "your face draws forward into a long snout as hair spills to your shoulders"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
	now body change entry is "you can feel your entire body changing configuration to emphasize your fertile signals, ass and hips pushing outwards as waist slims. Short claws forming on your hands, which remain smooth. The rest of you [Skin of Player]"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	now skin change entry is "a wave of erotic satisfaction forces you to your knees, your genitals releasing their fluids across thighs as fur explodes out across your form"; [ Skin change text, format as "Your skin feels funny as [skin change entry]." ]
	now ass change entry is "a long slithering sensation is felt in your pants. A quick check reveals it to be a naked pink rat tail"; [ Ass/tail change text, format as "Your ass feels funny as [ass change entry]." ]
	...
	now CumItem entry is "slut rat cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
Slut Rat Den is a room. "[slutratdenscene]". Slut Rat Den is private. Slut Rat Den is fasttravel.
...
to say slutratdenscene:
	...
	if SlutRatDenVisitTimes is 0:
		...
		if SlutRatDenPoolTable is 2:
			...
			if BodyName of Player is "Slut Rat":
				...
				say "[line break]You roll 1d20([dice])[if bonus >= 0]+[end if][bonus] = [special-style-1][dice + bonus][roman type] vs [special-style-2]16[roman type] (Charisma Check):[line break]";
				if dice plus bonus < 16:
					...
					while fightoutcome < 20 and CougarFightCounter < 4: [runs for 2 times or until the player loses or flees]
						say "     [if CougarFightCounter is 1]With the first cougar down behind you, you look around the room and move to intercept on moving to double-team one of your rat sisters[else if CougarFightCounter is 2]With another feline down, you have a moment to look around the room. Things are starting to go in the rats['] favor, but there are more to deal with. Picking another kitty, you charge in[else]After another successful fight, you look up just in time to see another group of the kitties, drawn by the noise, emerging from the back. They growl loudly and charge, turning the tide of battle for a moment. You leap over a pool table and charge at the one leading the counterattack[end if].";
						challenge "Cougar";
	...
	if HP of Ronda Mallrat is 9 and BodyName of Player is "Slut Rat":
		say "[RondaRescue]";
...
to say ratslutwelcome:
	...
	if player is male and (Player is not female or a random chance of 1 in 2 succeeds):
		if Cock Length of Player > 9:
			say "     She crouches down and reaches to cup your groin, fingers seeking out your [cock size desc of Player] [Cock of Player] tool and give it a few soft pulls, stroking it ever so slowly to erection as she looks up at you. 'And just how big is our little man?' she coos, long tongue flicking out across it in a flicker[if Cock Count of Player > 1]. Her fine whiskers tickle at your extra man meat. She leans back and brushes across all of your painfully erect shafts, tickling from the base to the tips and back down again in slow appraisal[end if]. Seemingly pleased with what she finds, she takes a moment to rub her snout alongside your [Cock of Player] cock[smn]. With the barest flicker of her tongue, she continues her inspection. Her paws roam over the rest of your body, stroking your [if Player is female]cunt[sfn], [end if]thighs and ass, putting you on display for all the other rats as she does. After your lustful introduction to the rat nest, she gives your ass a swat. 'Go have fun now, little bitch.'";
			infect;
		else:
			say "     She crouches down and reaches to cup your groin, fingers seeking out your [cock size desc of Player] [Cock of Player] tool and give it a few soft pulls, stroking it ever so slowly to erection as she looks up at you. 'And just how big is our little man?' she coos, long tongue flicking out across it in a flicker[if Cock Count of Player > 1]. Her fine whiskers tickle at your extra man meat. She leans back and brushes across all of your painfully erect shafts, tickling from the base to the tips and back down again in slow appraisal[end if]. 'This won't do,' she says with a frown on her pointed snout. Warm fingers squeeze at your shaft. 'This won't do at all.' On saying this, another rat hurries forward with a plastic bottle filled with some strange purple syrup that sloshes slowly with the vigorous movement. The first rat raises up and reaches for your mouth. 'Say [']ahhh['],' she beckons with a smile.";
			say "     Allow her?";
			if Player consents:
				LineBreak;
				...
				if lost is 1: [ bad end]
					...
					MultiInfect "Slut Rat" repeats 5;
					wait for any key;
				...
				Challenge "Slut Rat";
				now inasituation is false;
				if lost is 0 and slutratsub > 5:
					say "     You feel more confident about your dealings with the rats after that little battle.";
					decrease slutratsub by 1;
	else if Player is female:		[Female scene, Herm if above did not run]
		say "     Her nimble paws drift down between your legs, slipping between your thighs and parting them easily. Her fingers slide over your pussy, teasing your sensitive folds and getting you wet[if Cunt Count of Player > 1]. Finding more than one pussy tucked down there, she switches between them a few times before settling on one[end if]. She eases a finger into you, probing your pussy and stroking your inner walls. 'And just how accommodating is our new bitch,' she giggles as she slips a second finger into you and then another. She spreads her fingers and stretches you open, seeing how roomy your cunny is. You moan and shiver at this sensual inspection, blushing a little as the other girls are clearly watching.";
		if Cunt Depth of Player < 10 or Cunt Tightness of Player < 6:
			say "     She humphs. 'Still quite tight, but we can fix that,' she assures you with a nibble at your ear. Soon your head is being tipped back as a cup with something sickly sweet is pressed to your lips. The rat grinds her bulging crotch against your thigh as she continues fingering you. 'Drink it down,' she beckons with a smile. Allow her?";
			if Player consents:
				LineBreak;
				...
				CreatureSexAftermath "Player" receives "PussyDildoFuck" from "Slut Rat";
				increase Cunt Depth of Player by 4;
				increase Cunt Tightness of Player by 3;
				infect;
			else:
		...
		say "     [if Breast Size of Player > 0]The rat arrives at the junction of your thighs and seems surprised at what she finds, or does not find. Her teeth are felt, nipping twice at your [Skin of Player] skin before she looks back up. 'How do you live like that?' she says in an almost accusing tone. She rises to her feet and kisses your cheek. 'Poor thing. We will just have to fix that.'[else]She brushes up alongside you, nose twitching lightly as she takes your scent. 'Mmm, something is wrong,' she murmurs, reaching for your flat chest, then grasping your featureless groin openly. 'You have nothing.' She moves around behind you and presses against your back. 'That won't work at all...'[end if]";
		if Player is not FemalePreferred:
			...
			infect;
			WaitLineBreak;
			say "     Another rat hurries forward and seizes one of your hands, hauling you across the room and down a tunnel. Darkness closes in around you as you step quickly along the claustrophobic crawlways. Dim red light comes into view from around the corner. The rat guiding you, now that she slows her steps and gives you a chance to look at her, is a bit more slender than the others. As she looks over her shoulders, you can see glasses balanced on her narrow snout. 'You have to go alone from here,' she says. 'Pay proper respect.'";
...
to ratslutchug:
	...
	if Player consents:
		...
		say "     Desperate for breath, you break the seal of your lips for a gasp. The bottle snaps back to its usual dimensions and a solid object pops out of it, blocking your throat. You collapse to your knees, choking almost silently as you try to dislodge it. You can feel the rats at either side of you, rubbing their curvaceous forms along you and petting as they whisper soft enticements, telling you to swallow, not spit. With a painful gulp, the sphere descends into your belly heavily.";
...
There is a ratdartboard in Slut Rat Den. "The dart board looks like anyone could [link][bold type]throw darts[roman type][end link] if they felt like it.".
...
check ratdarts:
	...
	if SlutRatDenVisitTimes < 1:
		...
		if Player consents:
			...
			LineBreak;
			say "Reconsidering your options, you back away from the dart board." instead;
	else if lastratdartthrow - turns < 8:
		say "The other rats grumble about you hoggin['] the board all the time. Maybe you should wait a while before playing again." instead;
...
carry out ratdarts:
	...
	if total is:
		-- 0:
			...
			if Player consents:
				...
				if lost is 1:
					move player to Mall Foodcourt;
		-- 1:
			say "You missed entirely! The rat bounces lightly off the cement wall behind the board and falls to the ground with a soft clatter. The rats snicker softly at your performance[if a random chance of 1 in 3 succeeds]. A naked pink tail swats across your back end. 'You can do better than that.'[else].[end if]";
		-- 2:
		...
		-- 3:
			say "With pride, you land in the inner section of the board, shy of a bullseye. One of the rats tosses a pack of chips towards you with a thumbs up.";
			ItemGain chips by 1;
		-- 4:
			say "Yes! Your dart lands in the central circle, a bullseye! The rats give a polite cheer at your excellent shot. One of them reaches under herself and pulls out a can of soda and tosses it to you, still warmed from her rump.";
			ItemGain soda by 1;
		-- 5:
...
to say slutratsubsex:
	setmonster "Slut Rat";
	if Player is female:
		say "     The horny rat pins you down, clearly intent on having her way with your body. You moan softly and strip as you submit yourself to her needs. Her paws run over your body, drifting down your chest to your groin. She [if Player is male]wraps her paw around your cock and balls, then lifts them out of the way to expose your waiting pussy[else]slides her fingers across your waiting pussy[end if]. You moan softly as the rat herm teases your pussy with a hungry, lustful grin. She moves into position, lining her cock up with your slit and thrusts into you. Your wet snatch [if Cunt Depth of Player < 10 or Cunt Tightness of Player < 6]is a tight fit for the well-hung rat, but she growls and thrusts all the harder, eventually stuffing your pussy full of rat cock[else]spreads open for the well-hung rat, taking her cock fully into you, making you both moan in pleasure[end if].";
		if SlutratSub > 5:
			say "     'Mmm... you're a good little bitch, aren't you?' she moans in your ear as she fucks you. You can't help but nod in agreement, loving the feel of this powerful, sexy rat dominating you. Her big, thick cock throbs inside you so deliciously with each push it makes into your eager body. You grip her balls and fondle them, longing for her to fill you with her seed. She [if Player is male]takes your cock in hand and starts stroking your meat, making you whimper in pleasure like the horny slut you are[else]slides her paws to your breasts, groping and squeezing them, making you whimper in pleasure like the horny slut you are[end if]. Eventually the rat girl's penis drives into you one last time and unleashes a hot rush of seed deep inside you. You can feel each blast of that powerful rat's cum and longing for more even after the heavy load you've received[if Player is male]. You paint your chest with your own cum as the pleasure of this wild romp pushes you to orgasm hard for dominant rat pumping your shaft[end if]. Satisfied, she withdraws her softening shaft and gives your ass a swat while rat cum leaks from your gaping slit.[fimpregchance]";
		else:
			say "     'Mmm... nice to be bottom for a change, isn't it?' she moans in your ear as she fucks you. You can't help but nod in agreement, loving the feel of this powerful, sexy rat atop you. Her big, thick cock throbs inside you so deliciously with each push it makes into your eager body. You grip her balls and fondle them, eager to help her get off. She [if Player is male]takes your cock in hand and starts stroking your meat, spreading your leaking precum over it[else]slides her paws to your breasts, groping and squeezing them, making your nipples painfully hard[end if]. Eventually the rat girl's penis drives into you one last time and unleashes a hot rush of seed deep inside you. You can feel each blast of that beautiful rat's cum and watch your tummy swell a little from the output of her big balls[if Player is male]. Your paint your chest with your own cum as the pleasure of this wild romp pushes you to orgasm hard for sexy rat pumping your shaft[end if]. Satisfied, she withdraws her softening shaft and gives your ass a swat while rat cum leaks from your gaping slit.[fimpregchance]";
	else:
		say "     The horny rat pins you down, clearly intent on having her way with your body. You moan softly and strip as you submit yourself to her needs. Her paws run over your body, moving up to grab your head and pulling it between her legs. Finding your face pressed against the rat's large cock, you take in her strong, arousing scent. Her strong scent is quite arousing and you find yourself submitting to her desires and begin to lick and kiss her throbbing meat. She moans happily and rubs her paws over your head, scritching your ears.";
		say "     'Mmmm... [if SlutratSub > 5]you're a good little bitch, aren't you?' she moans as you open wide and start sliding your lips over her musky meat. You can't help but nod in agreement, bobbing your head over her cock as you love the taste of this powerful, sexy rat. Her precum leaks into your mouth and down your throat, its delicious taste making you release a muffled moan. Your cock throbs and dribbles pre onto the dirty floor as she rubs her rat foot down onto it. Taking her heavy balls in your hands, you fondle and caress them, eager for the tasty treat they contain. She forces your head forward, sliding her large, dripping glans down your throat as she starts thrusting, fucking your face. Your tongue lavishes attention upon the sexy rat dominating[else]I'm going to enjoy giving you a tasty treat,' she moans as you open wide and start sliding your lips over her musky meat. You can't help but nod in agreement, bobbing your head over her cock as you love the taste of this powerful, sexy rat. Her precum leaks into your mouth and down your throat, its delicious taste making you release a muffled moan. Your cock throbs and dribbles pre onto the dirty floor as she rubs her rat foot down onto it. Taking her heavy balls in your hands, you fondle and caress them, eager for the tasty treat they contain. She guides your head forward, sliding her large, dripping glans down your throat as she starts thrusting as you deep throat her. Your tongue lavishes attention upon the sexy rat before[end if] you until she moans loudly when her pulsing cock shoots her hot seed down your throat. Pulling back after a few spurts, she fills your mouth with the rest, letting you taste her seed before you swallow it down to join the rest warming your belly. As you swallow her musky, virile seed, you cum hard under her footpaw, spraying your semen onto the floor. Satisfied, she withdraws her softening shaft and gives your ass a swat to send you back to the group.";
	infect;
...
Description of Pool Table is "     This is the pool table that you, Eight-ball, Skeeball and the others were able to retrieve for the rat's den. It's picked up a few stains from some [']enthusiastic['] play, but is still in good shape. It's very popular with the girls and makes for another welcome diversion. The table is [if lastpoolgame - turns < 8]currently in use by some of the others[else]free if you'd like a game. Just [bold type]talk pool[roman type] to see if you can convince someone to have a game with you[end if].".
[Conversation of Pool Table is { "Scratch!" }.]
fuckscene of Pool Table is "     I know it's got holes, but those aren't the kind of balls you're supposed to put into them.[line break]".
...
instead of conversing the Pool Table:
	if lastpoolgame - turns < 8:
		...
		if lastpoolgame is 555:
			say "     You ask around for someone to play pool against and Eight-ball pipes up. 'I'd love a game against you to celebrate getting this sweet, big ass pool table for us. And I can't wait to win so I can celebrate by taking that sweet, big ass of yours as well,' she says with a grin. It seems you're up against the best player in the den. Shall you [link]play to win (Y)[as]y[end link] or [link]play to lose (N)[as]n[end link]?";
		else:
			let T be a random number between 1 and 4;
			say "     You ask around for someone to play pool against and [if T is 1]Eight-ball offers to play against you. She's clearly one of the best in the rat den at the game[else if T is 2]Skeeball offers to play against you. She's arguably the worst player among the rats, but still loves a good game[else]one of the other rats offers to play against you[end if]. You rack up the balls and get ready to play. Shall you [link]play to win (Y)[as]y[end link] or [link]play to lose (N)[as]n[end link]?";
		let targetnum be 6;
		if T is:
			-- 1: now targetnum is 16 + ( level of Player / 6 );
			-- 3: now targetnum is 10 + (a random number between 1 and 3) + ( level of Player / 10 );
			-- 4: now targetnum is 12 + (a random number between 1 and 3) + ( level of Player / 10 );
		if Player consents:
			LineBreak;
			let the bonus be ( Dexterity of Player minus 10 ) divided by 2;
			let the dice be a random number from 1 to 20;
			say "     You roll 1d20([dice])[if bonus >= 0]+[end if][bonus] = [special-style-1][dice + bonus][roman type] vs [special-style-2][targetnum][roman type] (Dexterity Check): ";
			...
			let the bonus be -4;
			let the dice be a random number from 1 to 20;
			say "You roll 1d20([dice])[if bonus >= 0]+[end if][bonus] = [special-style-1][dice + bonus][roman type] vs [special-style-2][targetnum][roman type] (Dexterity Check):[line break]";
			if dice plus bonus < targetnum:
				...
				infect "Slut Rat";
				if T is 2:
					say "[line break]     After you're done fucking, Skeeball leans over and kisses the side of your muzzle. 'Thanks for going easy on me,' she whispers. 'Losing's fun too, isn't it?' she adds, making you wonder just how bad of a player she really is. She grinds her sexy body against yours, making you strongly consider losing to her again.";
					SanLoss 5;
					increase morale of Player by 1;
					if slutratsub < 9:
						increase slutratsub by 1;
