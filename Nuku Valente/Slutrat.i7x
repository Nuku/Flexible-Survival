...
this is the rattymilk rule:
	...
	else if cock width of player > 0 and cock width of player < 10:
...
To Say ratslutwelcome:
	...
	else if cunts of player > 0:		[Female scene, Herm if above did not run]
