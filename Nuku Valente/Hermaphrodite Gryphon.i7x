...
When Play begins:
	...
	now defeated entry is "[beatthehgryphon]";				[ Text when monster loses.  Change 'template' as above. ]
	now victory entry is "[losetohgryphon]";					[ Text when monster wins.  Change 'template' as above. ]
