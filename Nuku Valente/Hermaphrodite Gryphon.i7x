...
To say beatthehgryphon:
	...
	otherwise if nohgryphonsex > 2 and ( the remainder after dividing nohgryphonsex by 5 is not 0 ):
	...
	otherwise:
		say "     Driven back by you, the herm gryphon whimpers with unsatisfied need.  She crawls over to a [one of]wall[or]pile of rubble[or]crashed car[at random] and sits against it while masturbating furiously in an attempt to sate her lust.  The sight of her like this is quite a tempting one.  Perhaps you might have some fun now that you've taken the fight out of her[if carried of gryphon cum > 0 and hp of Garrett >= 5].  You're also reminded that you have a bottle of Garrett's special gryphon cum milk.  It probably wouldn't take much coaxing to tempt her into drinking some[end if].";
		...
		while sextablerun is 0:
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if player consents:
					...
					if nam is "Fuck her":
						say "[hgryphon_pw_01]";
					otherwise if nam is "Ride her":
						say "[hgryphon_pw_02]";
[					otherwise if nam is "Anal ride":
						say "[hgryphon_pw_03]";			]
					otherwise if nam is "Titty fuck + ride":
						say "[hgryphon_pw_04]";
[					otherwise if nam is "Blow job":
						say "[hgryphon_pw_05]";			]
[					otherwise if nam is "Blow her":
						say "[hgryphon_pw_06]";			]
					otherwise if nam is "Garrett's special milk":
						say "[hgryphon_TG]";
...
When Play begins:
	...
	now defeated entry is "[losetohgryphon]";				[ Text when monster loses.  Change 'template' as above. ]
	now victory entry is "[beatthehgryphon]";					[ Text when monster wins.  Change 'template' as above. ]
