	...
	otherwise:
		...
		otherwise if cock length of player is less than 8 and cunts of player is greater than 0:
			...
			otherwise:
				...
				say "'It's alright baby, mama's here' the gryphon coos as she softly wraps her furry blue arms around you, placing her leaking nipple back into your mouth. As you resume suckling the gryphon starts to rock her hips back and forth, causing her knot to stretch you to your limits. The pleasure is so intense that you barely notice as you achieve orgasm after orgasm thanks to your lover's exceptional skills. After what seems like seconds (although you realize it's more like half an hour) the Hermaphrodite Gryphon lets out a loud squawk as she climaxes, filling you with cum from one end and milk from the other.";
			if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
			if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
		...
		otherwise if cocks of player is greater than 0 and cunt length of player is less than 6:
			say "Your opponent hits the ground with a loud *thud* and a squawk. Lying defeated and on her back, the gryphon awaits her fate with more than a little anticipation. You move to your knees, positioning your [cock size desc of player] member at your victims quivering slit.";
			if cock length of player is less than 6:
				say "With almost no effort Her massive pussy swallows your entire cock. With what could almost pass for a smirk, the gryphon squawks 'I guess you're just not Man enough...'. Anger and lust getting the better of you, you pull your cock out of her voluminous cunt and repositioning slightly you place the tip at the entrance to her back door. Her eyes going wide with fear, your prey is about to voice her dissent, but too late, your lust won't be denied. With some effort you push past her tightly clenched sphincter, drawing loud pained squawks from your victim. You start slowly fucking her tight asshole, in and out, gradually picking up speed. Eventually the gryphon's squawking changes pitch; however she felt before, she definitely seems to be enjoying this now.";
			otherwise:
...
To say gryphon fuck:
	...
	if cunts of player > 0 and cocks of player > 0:
		if a random chance of 2 in 3 succeeds:	[fucking the player]
			...
			otherwise:
				say "[gryphonfuck5]";
		otherwise if a random chance of analchance in 18 succeeds:
			say "[gryphonfuck7]";
...
When Play begins:
	...
	now attack entry is "[one of]She throws her impressive, and somewhat jiggly, bulk against you.[or]She snaps at you with that razor sharp beak, leaving a thin red line as it cuts your [skin of player] body.[or]She presses up against you suddenly and grinds her huge shaft against your belly. While you are distracted, you can feel her grabbing at your sides, squeezing painfully.[or]She charges at you, wings pulling her free of the ground just moments before she crashes bodily into you.[at random]";	[Text used when the monster succeeds on an attack]
	now defeated entry is "[gryphon lose]";				[ Text when monster loses.  Change 'template' as above. ]
	now victory entry is "[gryphon fuck]";					[ Text when monster wins.  Change 'template' as above. ]
	now desc entry is "She is a tall and striking blue gryphon. She has wide hips and huge blue breasts, implying she leans more on her mammal half than her avian, though her large blue wings are quite a sight to behold. Between her white-furred thighs is a huge, knotted, black cock and tightly drawn balls. From behind, the pinkened folds of her female gender are visible under the lion-like tail she sports. Her feet are digitigrade, and sport huge wicked claws that clack on hard surfaces.";						[ Description of the creature when you encounter it. ]
	now face entry is "powerful beak that protrudes in a clean curve. Above, feline ears twitch and turn above your altered";		[ Face Description, format as the text "Your face is (your text)." ]
	...
	now skin change entry is "a flush of arousal stirs through you as a dense carpet of blue fur engulfs you in its warm, encouraging, presence";	[ Skin TF text, format as "Your skin feels funny as (your text)." ]
	...
	now cock change entry is "pleasure builds in your cock as it deepens to a midnight black, a large swollen knot forming towards the base and a [skin of player] sheath overtaking the very base of it";		[ Cock TF text, format as "Your cock feels funny as (your text)." ]
