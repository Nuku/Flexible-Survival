...
to say gryphonfuck4: [oversized pussy fuck]
	...
	if Player is not MalePreferred and "Modest Organs" is not listed in feats of Player, increase Cunt Depth of Player by 1;
	CreatureSexAftermath "Player" receives "PussyFuck" from "Blue Gryphon Herm";
...
To say beatthehgryphon:
	...
	if Player is neuter:
		...
		[]
		if Player is herm and Cock Length of Player > 7 and Cunt Depth of Player > 5:
			choose a blank row in table of fucking options;
...
"Blue Gryphon Herm"	"[PrepCombat_Blue Gryphon Herm]"

to say PrepCombat_Blue Gryphon Herm:
...
When Play begins:
	...
	add "Blue Gryphon Herm" to infections of HermList;
	add "Blue Gryphon Herm" to infections of TaperedCockList;
	add "Blue Gryphon Herm" to infections of KnottedCockList;
	add "Blue Gryphon Herm" to infections of SheathedCockList;
	...
	now desc entry is "     You encounter a tall and striking blue gryphon. She has wide hips and huge blue breasts, implying she leans more on her mammal half than her avian, though her large blue wings are quite a sight to behold. Between her white-furred thighs is a huge, knotted black cock and tightly drawn balls. From behind, the pinkened folds of her female gender are visible under the lion-like tail she sports. Her feet are digitigrade and sport huge, wicked claws that clack on hard surfaces.[line break]";
	...
	now CumItem entry is "blue gryphon herm cum";
...
When Play begins:
	...
	now Head Description entry is "a sharp-beaked bird of prey with [Head Color of Player] feathers"; [partial sentence that fits in "Your face and head resemble that of [Head Description of Player]. You have [Eye Adjective of Player], [Eye Color of Player] eyes and an overall [Gender Adjective of Player] appearance."]
	...
	now Torso Description entry is "broad, with a shining coat of [Torso Color of Player] feathers"; [partial sentence, fitting in "Looking down at yourself, you appear [Gender Adjective of Player] with a [Body Adjective of Player] build. Your torso is [Torso Description of Player][if Body Hair Length of Player > 1], covered in [Torso Color of Player] skin and [Body Hair Description of Player][else if Body Hair Length of Player is 1], covered in smooth, [Torso Color of Player] skin[end if]."]
	...
	now Arms Description entry is "covered in [Arms Color of Player] feathers down to the elbow, with small, yellow-orange scales from there to your clawed hands"; [partial sentence to fit: "Your [Limbs Adjective of Player] arms are [Arms Description of Player]."]
	now Arms Skin Adjective entry is "scaled"; [one word adjective (feathered/furred/scaly/...); EMPTY "" for creatures with just skin]
	now Arms Color entry is "blue"; [single word color adjective for the dominant color of the skin/fur/feathers/scales]
	...
	now Tail Change entry is "a long tail sprouts from your tailbone, soon covered in blue fur and with an azure tuft at the end"; [partial sentence that fits in: "Your rear [one of]tingles[or]goes flush[or]vibrates with odd pleasure[or]goes cold[or]feels oily[at random] as [if HasTail of Player is true]your existing tail is changed into a [Tail Description entry][else][Tail Change entry][end if]."]
	now Tail Description entry is "long, [Tail Color of Player]-furred tail with an azure tuft of fur at the end"; [partial sentence to fit: "Just below your lower back sprouts a [Tail Description of Player], which you move back and forth with glee."]
	...
	now Cock Change entry is "it takes on a fairly canine-like appearance, complete with a sheath and knot - and all of it in azure blue"; [partial sentence that fits in: "Your cock [one of]tingles[or]goes flush[or]vibrates with odd pleasure[or]goes cold[or]feels oily[at random] as [Cock Change entry]."]
	now Cock Description entry is "is [Cock Color of Player]-colored and looks fairly canine in shape, complete with a sheath and knot"; [partial sentence to fit: "You have a [Cock Girth Adjective of Player], [Cock Length of Player]-inch-long [Cock Adjective of Player] [one of]cock[or]penis[or]shaft[or]maleness[at random] that [cock Description of Player]."]
	...
	now Cunt Description entry is "is [Cunt Color of Player]-colored and fairly human in shape, with delicate nether lips and the clit at the top"; [partial sentence to fit: "You have a [Cunt Tightness Adjective of Player] [one of]cunt[or]pussy[or]vagina[or]cleft[at random] that [Cunt Description of Player]."]
...
to fullBlueGryphonHermTF:
	setmonster "Blue Gryphon Herm" silently;
...
Scent of blue gryphon feather is "The feather has a pleasing, not too strong, animal-like scent.".
...
gryphon milk is a grab object. Understand "milk" as gryphon milk. gryphon milk is infectious. Strain of gryphon milk is "Blue Gryphon Herm". gryphon milk is milky.
...
Scent of gryphon coin is "The coin has an odd, spicy smell to it.".
...
to say gryphon coin use:
	...
	say "     [bold type][one of]Feather[or]Writing[purely at random]![roman type][line break]";
