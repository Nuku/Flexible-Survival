...
To say gryphon lose:
	...
	otherwise:
		...
		otherwise if cocks of player is greater than 0 and cunt length of player is less than 6:
			say "Your opponent hits the ground with a loud *thud* and a squawk. Lying defeated and on her back, the gryphon awaits her fate with more than a little anticipation. You move to your knees, positioning your [cock size desc of player] member at your victim's quivering slit.";
...
When Play begins:
	...
	now attack entry is "She [one of]throws her impressive, and somewhat jiggly, bulk against you[or]snaps at you with that razor sharp beak, leaving a thin red line as it cuts your [skin of player] body[or]presses up against you suddenly and grinds her huge shaft against your belly. While you are distracted, you can feel her grabbing at your sides, squeezing painfully[or]charges at you, wings pulling her free of the ground just moments before she crashes bodily into you[at random].";	[Text used when the monster succeeds on an attack]
