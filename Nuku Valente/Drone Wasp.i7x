...
When Play begins:
	...
	add "Drone Wasp" to infections of InsectList;
	add "Drone Wasp" to infections of FurryList;
	add "Drone Wasp" to infections of NatureList;
	...
	now MilkItem entry is "drone wasp milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "drone wasp cum"; [ Item to be given to the player if they have this infection and jerk off. ]
