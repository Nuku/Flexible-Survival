...
to say Donkeywoman wins:
	say "     The donkeywoman laughs in amusement as you collapse helplessly before her. 'Is that all you have in you? I do so enjoy it when they put up more of a struggle,' she says with a chuckle as she hauls you to your feet before pinning you up against the wall. 'And now for the fun part,' she says with a wicked grin as she traces the tip of her whip over your chest teasingly.";
	if Player is male:
		if BodyName of Player is "Donkeyman" and CockName of Player is "Donkeyman" and a random chance of 3 in 5 succeeds:
			say "     The feel of the supple leather trailing over your skin makes you groan with arousal, and she snickers as she reaches out to stroke your already powerfully erect cock teasingly. 'It seems you're well on your way to becoming a donkey plaything,' she says with an evil chuckle as she rubs her soft leather-clad body up against you teasingly. 'I see you've not been harnessed up properly. So no chosen mistress yet?' she asks teasingly. As she speaks, she uses the handle of her whip to jiggle your [Ball Size Adjective of Player] [Balls] a little, as if examining or weighing them[if Ball Size of Player < 3] disdainfully[else if Ball Size of Player < 5] critically[else if Ball Size of Player > 4] almost longingly[end if]. A shiver of pleasure and fear runs down your spine as you picture yourself trussed up as the playtoy for one of these kinky, dominant donkeywomen. Her hand strokes your [Cock of Player] shaft again teasingly, distracting you from your thoughts as she presses you up against the wall even more eagerly than before.";
			...
			CreatureSexAftermath "Player" receives "Stroking" from "Donkeywoman";
		if MaleList is banned or ( Player is FemalePreferred and Player is not submissive ) or player is dominant:
			setmonster "Donkeywoman";
		else:
			setmonster "Donkeyman";
	else:
		...
		CreatureSexAftermath "Player" receives "Stroking" from "Donkeywoman";
		if MaleList is not banned and ( ( Player is MalePreferred and Player is not dominant ) or Player is submissive ):
			setmonster "Donkeyman";

To say Donkeywoman loses:
	increase donkeywomanbeaten by 1;
	if Player is not male or ( nodonkeywomansex > 2 and the remainder after dividing nodonkeywomansex by 5 is not 0 ) or donkeywomanbeaten < 3:
		say "     The powerful-looking mistress seems somewhat less sure of herself as you drive her back[if donkeywomanbeaten > 1] again[end if] with your blows. 'I think you might just be a bit too stubborn for me to train right now,' she says with a sigh as she backs off down the passageway carefully. 'Though you certainly would make a good jenny from the looks of things. Don't worry though, I'm sure we will bump into each other again soon, and then I can give you that lesson I promised,' she adds with a smirk as she vanishes down the dimly lit corridors, leaving you standing victorious in the middle of the hallway.";
...
When Play begins:
	...
	add "Donkeywoman" to infections of EquineList;
	add "Donkeywoman" to infections of FurryList;
	add "Donkeywoman" to infections of NatureList;
	add "Donkeywoman" to infections of FemaleList;
	add "Donkeywoman" to infections of BluntCockList;
	add "Donkeywoman" to infections of SheathedCockList;
	...
	now face entry is "long, asinine muzzle, with two large equine ears and a short close cropped mane of hair, and a plain leather collar which complements your rather sexy donkey-like face"; [ Face description, format as "Your face is [Face of Player]." ]
	...
	now skin change entry is "it seems to stretch and toughen slightly into a more donkey like hide, silken gray donkey fur pushing out of your changed skin and making you shudder with pleasure as your new coat finishes growing in";
	...
	now MilkItem entry is "donkeywoman milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "donkeywoman cum"; [ Item to be given to the player if they have this infection and jerk off. ]
