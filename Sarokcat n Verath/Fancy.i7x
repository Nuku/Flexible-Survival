...
[ Version 1.3 - Stablemaster blow job ]
...
instead of conversing the Fancy:
	...
	otherwise if fancyquest is 15:
		...
		if player consents:
			say "'Wonderful! I'll send a mare right away to let them know Daisy is ready for her final session.' Fancy says with a smile as she signals one of the other mares to come over, and hands her an obviously prepared message for the mare to deliver. And you find yourself waiting nervously by the door where Fancy indicates for the escort to arrive. You don't have to wait that long before one of the large and powerful horsemen saunters in, looking for his masters new prize, and you waste no time in attacking!";
