	...
	if onyxdma is 0:
		...
		if scalevalue of Player < 4:
			...
			If Libido of Player > 49:
				if Player is male:
					say "     Prostate so thoroughly ravaged by his assault, strained gouts of hot cum spurt from your cock[smn] in a staggered [if ball size of Player > 12]and quite messy[end if] orgasm, forcing Onyx to taunt you.";
					say "     'Aw, my little fucktoy is so sensitive, how adorable!' You can only help but blush in a mix of pleasure and embarrassment as you sully yourself with [if ball size of Player > 12]numerous[end if] strings of your sexual fluids a mess across your [bodydesc of Player] torso.";
			...
			If Libido of Player > 69:
				...
				if Player is male:
					say "[if Cock Count of Player > 1]cocks exploding with their[else if Player is male]cock exploding with its[end if] [if ball size of Player > 24]massive [end if]load over your naked, [bodydesc of Player] torso, much to Onyx's amusement.";
				...
				say "     'Such a big, naughty slut, making all this mess!' He gestures to the [if ball size of Player > 24]considerable [end if]mess of your own sexual fluids before leaving you to handle the matter yourself. A little embarrassed, you tidy up before going about your business.[mimpregchance]";
				decrease Libido of Player by 25;
			else:
...
to femonyxsex1:
	...
	if Player consents:
		...
		say "     Wet sounds of her persistent, deliberate attendance lingering for only a little while longer, it's more than enough to set you off, the equine plummeting the tool down her hole one last time[if Player is knotted], up to the knot[end if]. Your [Cum Load Size of Player] exploding from your dick[smn], [if Cock Count of Player > 2]its brothers staining her torso as [else if Cock Count of Player is 2]its brother staining her torso as [else if ball size of Player > 18]the substantial volume quickly sputtering from her lips as [end if]she swallows your release with slow, deliberate gulps, until your bliss finally dies down and Onyx pulls herself free of your softening organ.";
	...
	if fonyxvagcount is 0 or a random chance of 2 in 3 succeeds:
		...
		if Player consents:
			...
			if Libido of Player > 40:
				say "     You can't hold back for much longer, finally crying out in bliss and [if Player is knotted]tying[else]hilting[end if] yourself as you flood the equine's womb with your [Cum Load Size of Player] load[if ball size of Player > 18 and tempnum is 2] until it starts to sputter from her stuffed holes[else if ball size of Player > 18] until it starts to sputter from her stuffed hole[end if]. More than enough to set her off she whinnies out loudly, [if tempnum is 2]ass[else]pussy[end if] squeezing you sputtering dick[if tempnum > 0]s[end if] tightly";
				...
				say "     It's clear the equine can't hold back any longer, whinnying out loudly as her [if tempnum is 2]ass[else]pussy[end if] tightly squeezes your throbbing dick[if tempnum > 0]s[end if]. More than enough to set your off, you finally cry out in bliss and [if Player is knotted]tying[else]hilting[end if] yourself as you flood the equine's womb with your [Cum Load Size of Player] load[if ball size of Player > 18 and tempnum is 2] until it starts to sputter from her stuffed holes[else if ball size of Player > 18] until it starts to sputter from her stuffed hole[end if]";
				if (tempnum > 0 and Cock Count of Player > 3) or Cock Count of Player > 2:
...
to femonyxsex3:
	if fonyxanalcount is 0 or a random chance of 2 in 3 succeeds:
		...
		if Player consents:
			...
			if Libido of Player > 40:
				say "     You can't hold back for much longer, finally crying out in bliss and [if Player is knotted]tying[else]hilting[end if] yourself as you flood the equine's bowels with your [Cum Load Size of Player] load[if ball size of Player > 18 and tempnum is 2] until it starts to sputter from her stuffed holes[else if ball size of Player > 18] until it starts to sputter from her stuffed hole[end if]. More than enough to set her off she whinnies out loudly, ass squeezing you sputtering dick[if tempnum > 0]s[end if] tightly";
				if (tempnum > 0 and Cock Count of Player > 3) or Cock Count of Player > 2:
					say ", your unattended cocks staining her thighs.";
				else if (tempnum > 0 and Cock Count of Player > 2) or Cock Count of Player > 1:
					say ", your unattended cock staining her thighs.";
			else:
				say "     It's clear the equine can't hold back any longer, whinnying out loudly as her ass tightly squeezes your throbbing dick[if tempnum > 0]s[end if]. More than enough to set your off, you finally cry out in bliss and [if Player is knotted]tying[else]hilting[end if] yourself as you flood the equine's bowels with your [Cum Load Size of Player] load[if ball size of Player > 18 and tempnum is 2] until it starts to sputter from her stuffed holes[else if ball size of Player > 18] until it starts to sputter from her stuffed hole[end if]";
				if (tempnum > 0 and Cock Count of Player > 3) or Cock Count of Player > 2:
					say ", your unattended dicks staining her thighs.";
				else if (tempnum > 0 and Cock Count of Player > 2) or Cock Count of Player > 1:
					say ", your unattended dick staining her thighs.";
