...
to femonyxsex2:
	if fonyxvagcount is 0 or a random chance of 2 in 3 succeeds:
		...
		if Cock Count of Player > 1:
			...
			say ".";
			now tempnum is 0;
		say "     '[one of]Don't hold back[or]Knock yourself out[or]Go crazy[at random], [one of]love[or]stud[or]honey[at random].' Eager to get started, you plunge the[if Player is flared] blunt[end if] head of[if tempnum > 0 and Cock Count of Player > 2] two of[else if tempnum > 0] both of[end if] your dick[if tempnum > 0]s[end if] down her inviting hole[if tempnum is 2]s[end if], causing Onyx to moan out in eager bliss, reveling in being railed by you as you quickly build a tempo of pounding her ass, pinning the equine firmly against a wall.";
