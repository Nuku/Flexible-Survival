...
to say onyxbvag:
	if onyxdmc is 0:
		If scalevalue of player < 4:
			...
			If cunt width of player < 4:
				say ". As he forces the head of his blunt dick into [if cunts of player > 1]one of your cunts[else]your cunt[end if], his struggle elicits a chain of strained grunts. Relegated to contending with your paradoxically small hole, it takes quite a bit of effort for him squeeze it in, wracking you with pangs of sharp pleasure[if player is male] and driving you hard in the process[end if].";
			else if cunt width of player < 7:
...
to say onyxbsubforal1:
	say "     Widening your stance, you present your dripping snatch[esfn] to Onyx. All it then takes is a motion for him to get on his knees and bury his face between your legs. He runs his broad tongue over [itthemf], licking across and into your puss[yfn]. Rubbing his ears and mane, you [if player is male]let your [cock of player] cock[smn] lay across his equine muzzle[else if cunts of player > 1]grind your multiple cunts across his equine muzzle[else]pull him more firmly to your crotch[end if]. He accepts this manhandling happily, his submissive training yielding to your dominant behavior.";
...
to femonyxsex1:
	...
	if player consents:
		...
		say "     Wet sounds of her persistent, deliberate attendance lingering for only a little while longer, it's more than enough to set you off, the equine plummeting the tool down her hole one last time[if player is knotted], up to the knot[end if]. Your [cum load size of player] exploding from your dick[smn], [if cocks of player > 2]its brothers staining her torso as [else if cocks of player is 2]its brother staining her torso as [else if cock width of player > 18]the substantial volume quickly sputtering from her lips as [end if]she swallows your release with slow, deliberate gulps, until your bliss finally dies down and Onyx pulls herself free of your softening organ.";
...
to femonyxsex2:
	if fonyxvagcount is 0 or a random chance of 2 in 3 succeeds:
		...
		if cocks of player > 1:
			...
			say ".";
			now tempnum is 0;
		say "     '[one of]Don't hold back[or]Knock yourself out[or]Go crazy[at random], [one of]love[or]stud[or]honey[at random].' Eager to get started, you plunge the[if player is flared] blunt[end if] head of[if tempnum > 0 and cocks of player > 2] two of[else if tempnum > 0] both of[end if] your dick[if tempnum > 0]s[end if] down her inviting hole[if tempnum is 2]s[end if], causing Onyx to moan out in eager bliss, reveling in being railed by you as you quickly build a tempo of pounding her ass, pinning the equine firmly against a wall.";
		...
		if player consents:
			...
			if libido of player > 40:
				say "     You can't hold back for much longer, finally crying out in bliss and [if player is knotted]tying[else]hilting[end if] yourself as you flood the equine's womb with your [cum load size of player] load[if cock width of player > 18 and tempnum is 2] until it starts to sputter from her stuffed holes[else if cock width of player > 18] until it starts to sputter from her stuffed hole[end if]. More than enough to set her off she whinnies out loudly, [if tempnum is 2]ass[else]pussy[end if] squeezing you sputtering dick[if tempnum > 0]s[end if] tightly";
				...
				say "     It's clear the equine can't hold back any longer, whinnying out loudly as her [if tempnum is 2]ass[else]pussy[end if] tightly squeezes your throbbing dick[if tempnum > 0]s[end if]. More than enough to set your off, you finally cry out in bliss and [if player is knotted]tying[else]hilting[end if] yourself as you flood the equine's womb with your [cum load size of player] load[if cock width of player > 18 and tempnum is 2] until it starts to sputter from her stuffed holes[else if cock width of player > 18] until it starts to sputter from her stuffed hole[end if]";
				if (tempnum > 0 and cocks of player > 3) or cocks of player > 2:
...
to femonyxsex3:
	if fonyxanalcount is 0 or a random chance of 2 in 3 succeeds:
		...
		if player consents:
			...
			if libido of player > 40:
				say "     You can't hold back for much longer, finally crying out in bliss and [if player is knotted]tying[else]hilting[end if] yourself as you flood the equine's bowels with your [cum load size of player] load[if cock width of player > 18 and tempnum is 2] until it starts to sputter from her stuffed holes[else if cock width of player > 18] until it starts to sputter from her stuffed hole[end if]. More than enough to set her off she whinnies out loudly, ass squeezing you sputtering dick[if tempnum > 0]s[end if] tightly";
				if (tempnum > 0 and cocks of player > 3) or cocks of player > 2:
					say ", your unattended cocks staining her thighs.";
				else if (tempnum > 0 and cocks of player > 2) or cocks of player > 1:
					say ", your unattended cock staining her thighs.";
			else:
				say "     It's clear the equine can't hold back any longer, whinnying out loudly as her ass tightly squeezes your throbbing dick[if tempnum > 0]s[end if]. More than enough to set your off, you finally cry out in bliss and [if player is knotted]tying[else]hilting[end if] yourself as you flood the equine's bowels with your [cum load size of player] load[if cock width of player > 18 and tempnum is 2] until it starts to sputter from her stuffed holes[else if cock width of player > 18] until it starts to sputter from her stuffed hole[end if]";
				if (tempnum > 0 and cocks of player > 3) or cocks of player > 2:
					say ", your unattended dicks staining her thighs.";
				else if (tempnum > 0 and cocks of player > 2) or cocks of player > 1:
					say ", your unattended dick staining her thighs.";
