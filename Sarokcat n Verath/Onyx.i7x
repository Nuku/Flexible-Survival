...
to say onyxboral2:
	...
	say "     'Heh, my [if scalevalue of Player > 3]big sexy[else]sexy little[end if] slut wants his favorite slice of meat, yes?' He leans back against the chair, giving you easy access to his impressive equine organ, enticing your tongue to caress along its length. Deep rumbling in approval, you've become quite adept and driving him hard.";
