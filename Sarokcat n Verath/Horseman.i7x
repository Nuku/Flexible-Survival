...
To say Horseman loss:
	...
	otherwise if horsefight is 1:		[fight on Dry Plains]
		say "The powerful horseman shakes his head slightly to clear it, before charging right at you again, obviously not knowing when he is beat. His attack is clumsy and easily avoided, as he is still off balance from the beating you have recently been giving him, and it is easy enough to sidestep and send him crashing to the ground. The powerful beast groans and collapses up, a slightly stupified look on his face as he stares off into space, obviously stunned as he lays flopped out on the grass.";
