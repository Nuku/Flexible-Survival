Version 1 of Time by MinimalBuild begins here.
...
This is the turnpass rule:
	...
	if "Singular" is listed in feats of Player and a random chance of 1 in yy succeeds:
		...
		if CockName of Player is BodyName of Player:
			...
			now z is 1;
		if BodyName of Player is "Human": [blocked for humans and active shifters]
			now z is 0;
		if z is 1:
	...
	pregprotocol; [Moved to pregnancy in MinimalBuild]
