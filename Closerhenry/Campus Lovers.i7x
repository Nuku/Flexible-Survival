...
to say ResolveEvent Campus Lovers:
	if CampusLoversTrackingVariable is 0:
		...
		if calcnumber is 1:
			...
			WaitLineBreak;
			say "     Jadako trembles in anticipation as he turns away from the wall and stands over his former coach. He steadily squats down until his thin bottom reaches the coach's cock, a mixture of canine and human features. The rugged canine places a hand on the anthro student's left thigh and the other on the teenager's side, holding the thin and wiry cat up in the air. The suspended cat turns his head to face Coach Weber, and the two slowly lock tongues as the large anthro gently lowers Jadako onto his cock. The lusty student's rear hungrily consumes the hot rod, until finally it looks as though the colorful feline is simply sitting atop his lover's lap. Coach Weber slowly lifts the altered student, grunting in lust as Jadako's snugly fitting opening squeezes his shaft on the way up. When just the cockhead is left inside his former student, the man humps up against the cat-boy's buttocks, burying his shaft all the way inside with a satisfied bark.";
