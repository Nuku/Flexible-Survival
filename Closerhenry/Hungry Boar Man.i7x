...
To Mudwrestle:
	...
	if lastfuck of Philip - turns < 6:
		...
		if player consents:
			...
			LineBreak;
			say "     [link](1)[as]1[end link] - Charge right af Philip to knock him down[line break]";
			...
			if calcnumber is 1: [grab Philip]
				LineBreak;
				say "     You reach out at Philip as suddenly as you can, wrapping your arms around the fat pig. Philip laughs, as he raises his arms out, easily breaking your grip. He slams into you with his massive gut, sending you sliding back. You fall backwards, hitting the ground and being covered in more mud. Phillip slides foreward on his knees, getting ready to move in for the pin.";
				decrease PhilipMudWrestleCount by 0;
				...
				if diceroll + bonus >= 16:
					say "     You yell to Philip, 'I know you can do better, you fat pig! If you want me, come and get me!' Philip visibily grows enranged, and rushes at you with reckless abandon. It's as easy as sidestepping and extending your leg that he comes crashing down into the mud. However, you misjudged how fast he was running and you fall as well when he hits your leg. Luckily, you're in a much more favorable position as you turn to face Philip, who is only just moving off of his chest.";
					increase PhilipMudWrestleCount by 1;
				else:
			...
			if calcnumber is 1: [stand Philip]
				LineBreak;
				say "     You try as quickly as possible to rise to your feet, slipping and slidding in the mud as you do. Eventually, you manage to find your balance and start to rise up, but just as you begin to stand, you feel Philip's meaty hands shove at your legs, and you come tumling down forward. As you rapidly fall, you can see that the boar has positioned himself perfectly so that your head will land right on his cushiony balls. When you land on them, you inhale deeply, taking in his manly musk. While you're dazed, Philip's fat arm wraps around your neck as he goes for the pin. Before you can do anything, you are wrapped in his arms.";
				decrease PhilipMudWrestleCount by 0;
		...
		if humanity of player < 10:
			if voreloss is true:
				...
				if cunts of player > 0:
					...
					say "     As time wears on, you can't hold back against your growing urges. Your identity falls apart, leaving only your base needs for food and sex. Heading back to the shed, you join Philip in a long and messy romp on the dirty floor, mounting you and taking you like his sow again and again. Your combined sweat and semen add to the muck you both roll around in. The boar gets dirtier, smellier and all the more attractive to you. And more lustful as he joins you in succumbing to the infection. Quite sticky and messy, with your boar's cum leaking from your well-used tail-hole, you head together to the [if restaurantpig is 1]posh restaurant[else]sewers below the mall[end if] to seek out the lovely sow there. Together, the three of you set up a messy sty. Philip is a good boar to you both, filling you with assloads of cum and her with piglets. He adds several other sows to his sty as well, filling them with piglets as he ruts them in the muck.";
				else:
