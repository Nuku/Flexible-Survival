...
a postimport rule: [bugfixing rules for players that import savegames]
	if Resolution of Sunbathing Shark > 97:
		now Resolution of Sunbathing Shark is 0;
...
to say ResolveEvent Sunbathing Shark:
	if Resolution of Sunbathing Shark > 0:	[Subsequent meeting]
		...
		if scalevalue of Player > 5:	[Eva not interested because the player is too big]
			...
			if Resolution of Sunbathing Shark is 97:	[Turned Eva down on previous meeting]
			...
			else if Resolution of Sunbathing Shark < 3:		[Escaped Eva's tail trip or tail bind]
			...
			else if Resolution of Sunbathing Shark < 6:		[Escaped from Eva before actual anal vore]
			...
			else:		[Did Eva's full anal vore or did oral vore]
			...
			get a number;	[Choices for subsequent meetings]
		...
		say "[line break]     [bold type]Do you say hi to the shark woman?[roman type][line break]";
		...
		if Player consents:
			...
			if scalevalue of Player > 4:		[Eva not interested because the player is too big]
				...
				say "[line break]     [bold type]Do you allow Eva to use you?[roman type][line break]";
				...
				if Player consents:		[Leads to anal bound state]
					...
					say "[line break]You roll 1d20([dice])[if bonus >= 0]+[end if][bonus] = [special-style-1][dice + bonus][roman type] vs [special-style-2]12[roman type] (Perception + Dexterity Check):[line break]";
					if dice + bonus > 11:	[Successfully escaped]
...
to EvaOralScenes:	[Random oral vore scenes and scene ending]
	...
	say "[line break]     [bold type]Do you want to stay inside of the horny predator?[roman type][line break]";
...
to EvaAnalBind:
	...
	while Trixieexit is false:
		...
		if lustatt > 99:	[Player orgasm automatically advances to next bound state phase]
			...
			if boundsegment < 4:
				say "     [if boundsegment is 1]Whether it's from exhaustion or just liking the idea of being the shark woman's toy, you eventually cease struggling. Eva's grin grows even wider as she pulls you right into her waiting arms. 'You and I are going to have so much fun. Can't wait to get you into my ass,' she says huskily.[else if boundsegment is 2]After being subjected to the constant facemashing from Eva's squishy ass, you no longer can resist the call of the alluring booty. Eva chuckles when you not only cease your struggles, but you're actually pressing into her rear. 'That's the spirit. Told you that this can be fun for the both of us. Don't get too comfortable though because we're just getting started.'[else]You've already come this far, and you can't deny that some, or maybe even a major, part of you wants to see what Eva will do to you, especially since all of the shark's advances have been stoking the fires of your own lust. Letting yourself go lax, you make it easier for the hungry shark's ass to take you. 'I just knew that you would make a great toy,' Eva cheerfully remarks. 'I think that's enough teasing around. Time for the main event.'[end if]";
				EvaAnalBindProgress;
			else:
		...
		if humanity of Player < 1:		[Losing all sanity automatically plays next bound state phase after every round]
			if boundsegment < 4:
				say "     [if boundsegment is 1]Though Eva has barely started using you for her lusty desires, the experiences you had beforehand has already weakened your mind to the point that you can't think of anything but give yourself to the domineering shark. With you putting up no more than a token struggle, Eva's grin grows even wider over your complete submission, and she pulls you right into her waiting arms. 'You and I are going to have so much fun. Can't wait to get you into my ass,' she says huskily.[else if boundsegment is 2]With your weakened mind, it doesn't take much of Eva's squishy ass against your face to smother any thought of resistance from you. Eva chuckles when you not only cease your struggles, but you're actually pressing into her rear. 'That's the spirit. Told you that this can be fun for the both of us. Don't get too comfortable though because we're just getting started.'[else]The constant anal assault wears down your fragile mind, making you almost beg for the opportunity to sink even further into Eva's captivating ass. Letting yourself go lax, you make it easier for the hungry shark's ass to take you. 'I just knew that you would make a great toy,' Eva cheerfully remarks. 'I think that's enough teasing around. Time for the main event.'[end if]";
				EvaAnalBindProgress;
			else:
			...
			say "     [if boundsegment is 1]Bound tight by Eva's serpentine tail, you're slowly dragged toward the hungry shark. You can try to [bold type]S[roman type]truggle out of the tail hold[else if boundsegment is 2]Smothered by bouncy shark booty, you can feel Eva wearing down your resistance so that she can continue to have her ass play with you. You can try to [bold type]S[roman type]truggle away from the shark's rear[else if boundsegment is 3]Squeezed in and out of the shark's ass, you can feel Eva wearing down your resistance so that she can continue to have her way with you. You can try to [bold type]S[roman type]truggle away from the shark's rear[else]Stuck deep inside of the shark's bowels, you're awash in musk and clenching flesh. You can try to [bold type]S[roman type]truggle out of the shark[end if], or you can [if obliging is true][bold type]O[roman type]blige[else][bold type]A[roman type]bide[end if] Eva or [if boundrecover is true][bold type]R[roman type]ecover from[else][bold type]E[roman type]ndure[end if] these questionable circumstances.";
			...
			say "Sanity: [humanity of Player]/100  Lust: [lustatt]/100  Hunger: [hunger of Player]  Thirst: [thirst of Player]  Struggle: [EvaStruggleBar][line break]";
			...
			if keychar is "s" or keychar is "1" or keychar is "return" or keychar in lower case matches the text "struggle":
				say "     [if boundsegment is 1][one of]'Aww, come on. I just want to play with you,' Eva teases as you try to wriggle out of her tail hold[or]Thrashing around as best as you can, you manage to loosen Eva's grip on you, briefly stopping her from drawing you in[or]'Go ahead and resist, cutie. It'll just make it all the better when I do get to play with you,' Eva says[at random][else if boundsegment is 2][one of]'Oh no you don't. I'm not letting a cutie like you get away now,' Eva states as you try to push away from her ass[or]As you try to push away from Eva, the shark both giggles and moans lustfully as your efforts also squeeze her cushy ass[or]Even though it's distracting to have Eva's ass humping your face, the shark herself is also occupied with her own pleasure, allowing you to loosen her hold on you[at random][else if boundsegment is 3][one of]'Come on. Just stay still and take it,' Eva complains as you try to move away from her ass[or]Even though your movements are limited whenever Eva's ass descends, you wriggle against her tail that is coiled around parts of your body[or]'Oh yeah, keep squirming like that,' Eva says. Your wriggling inside of the shark's ass pleasurably distracts her from your escape attempts[at random][else][one of]There's not much room with Eva's insides mashing right up against you, but you manage to wriggle about in an attempt to free yourself from the musky hold[or]'H-hey, don't you want to stay in me longer?' Eva says before moaning in delight from your squirming[or]You can hear Eva groan as you struggle in your tight confines[at random][end if].";
				increase struggleatt by 1;
				if boundsegment is 1 and struggleatt is 4:
					say "     With one final push, you manage to throw off the tail coils binding you just enough for you to slip out of their hold. You hastily crawl awaya bit to avoid being recaptured before you quickly shift into a combat stance as you whirl back around to Eva. To your surprise, Eva doesn't make a moveto attack and instead holds up her hands in a placating manner. 'Not bad at all, cutie. Don't worry, I won't be doing anymore stuff to you. I might playrough, but not to the point where we have to duke it out. A shame that you're not willing to have some fun, but here's hoping that you'll change yourmind to let loose later on.' You warily step away from Eva, but true to her word, the shark returns to relaxing on the beach, allowing you to resumeyour exploring.";
					cleanboundmemory;
					now resolution of Sunbathing Shark is 2;
					now Trixieexit is true;
					follow the turnpass rule;
				else if boundsegment is 2 and struggleatt is 6:
					say "     Despite Eva's size and strength, she's too busy trying to pleasure herself with you to notice that you have struggled enough to finally freeyourself from her tail. When you quickly slip away, the still-humping shark loses her balance without her toy to mash her butt against, and she fallsbackwards onto the sand. 'Wh-what?! Hey! We were about to get to the best part!' Eva shouts angrily. Before she can get up, you're already bolting downthe beach, leaving the frustrated, horny shark far behind.";
					cleanboundmemory;
					now resolution of Sunbathing Shark is 3;
					now Trixieexit is true;
					follow the turnpass rule;
				else if boundsegment is 3 and struggleatt is 8:
					say "     Despite Eva's size and strength, she's too busy trying to pleasure herself with you to notice that you have struggled enough to finally freeyourself from her tail. When you quickly slip away, the still-humping shark loses her balance without her toy to mash her butt against, and she fallsbackwards onto the sand. 'Wh-what?! Hey! We were about to get to the best part!' Eva shouts angrily. Before she can get up, you're already bolting downthe beach, leaving the frustrated, horny shark far behind.";
					cleanboundmemory;
					now resolution of Sunbathing Shark is 4;
					now Trixieexit is true;
					follow the turnpass rule;
				else if boundsegment is 4 and struggleatt is 10:
					say "     Eva's breathing grows more ragged from your movements. Though you don't seem to be doing much while being stuck inside of the shark's bowels,all of your movements causes you to rub yourself against her inner walls. Still sensitive because of the recent orgasm she had from taking you inside ofher, you quickly stir up Eva's arousal until the shark lady cannot take it anymore. With another groan of pleasure, Eva climaxes again. The domineeringfemale's anal walls clench down on you, but this time, they squeeze you in the opposite direction, and you soon find yourself pushed out of Eva's assand onto the sand. The shark woman herself falls onto her butt in a sitting position, having to use her hands to keep her upright due to her exhaustion.Through her panting, she shoots you a smirk. 'Not bad, cutie. You were a lot of fun to play with, and I got some decent relief from you. A shame thatyou did not let me keep you longer for me to have the full experience. Maybe next time you'll let me use you properly.' You warily step away from Eva,but the shark returns to relaxing on the beach, allowing you to resume your exploring.";
					cleanboundmemory;
				...
				say "     [if boundsegment is 1][one of]'That's it. Just come to me so that the real fun can begin,' Eva says as you just let her reel you in closer[or]Enticed with the thought of being the shark's plaything, you hardly put up a fight as Eva drags you toward her[or]You take a moment to try to rest and gather your strength, but the clenching of Eva's tail coils makes it hard to do so as she pulls you in some more[at random][else if boundsegment is 2][one of]'Enjoying yourself down there?' Eva teases when she feels you not resisting her dominating ass[or]You go slack for a moment, allowing the plushy shark butt to mold around your face[or]Though you were forced into this situation, Eva's bubbly butt is wearing down your resistance and even making you want to go deeper into her ass[at random]else if boundsegment is 3[one of]The clenching walls of Eva's ass sensually hug your body, and a part of you is tempted to feel more of it[or]'You're doing a great job at being my toy,' Eva compliments after you let her take you deep inside of her ass and hold you there for several moments[or]The heady musk emanating from the shark's rear muddles your senses with lust, urging you to submit[at random][else][one of]You relax into the twisted embrace of the shark woman's bowels[or]'Mmm, such a good toy,' Eva hums, enjoying the feeling of you filling her[or]The temptation to fully submit to the overbearing shark grows as your senses are filled with her arousing musk[at random][end if].";
				if obliging is true:
				...
				if boundrecover is true:
					...
					say "     [if boundsegment is 1][one of]'You're not going anywhere but up my ass if that's all you can do,' Eva teases as you try to resist her[or]You try to stop yourself from being pulled in as you wait for an opportunity to escape[or]'Are you even trying, or do you just like being wrapped up in my tail?' Eva teases as you try to hold your ground[at random][else if boundsegment is 2][one of]Distracting as it is, you try and endure the rolls of shark fat and flesh enveloping your head[or]'Are you even trying, or do you just want me to rub my ass all over your face all day?' Eva taunts[or]You do your best to ignore the musky scent and jiggling flesh assaulting your senses[at random][else if boundsegment is 3][one of]'You think that you can outlast my ass?' Eva taunts as you attempt to endure her anal advances[or]Even as her anal walls clamp down on your hapless form, you try to resist succumbing to lust[or]You try to weather the horny shark's assault as she continues to pump you in and out of her butt[at random][else][one of]You try to hold out against the clenching walls pressing in around you[or]'Trying to see if you can endure my ass?' Eva asks in a teasing tone[or]You do your best to resist your rising libido caused by your depraved containment[at random][end if].";
...
to EvaAnalBindProgress:
	...
	now struggleatt is boundsegment + 2;
...
to say EvaStruggleBar:
	if boundsegment is:
		-- 1: say "[bracket]X[if struggleatt > 1]X[else]-[end if][if struggleatt > 2]X[else]-[end if][if struggleatt > 3]X[else]-[end if][close bracket]";
		-- 2: say "[bracket]X[if struggleatt > 1]X[else]-[end if][if struggleatt > 2]X[else]-[end if][if struggleatt > 3]X[else]-[end if][if struggleatt > 4]X[else]-[end if][if struggleatt > 5]X[else]-[end if][close bracket]";
		-- 3: say "[bracket]X[if struggleatt > 1]X[else]-[end if][if struggleatt > 2]X[else]-[end if][if struggleatt > 3]X[else]-[end if][if struggleatt > 4]X[else]-[end if][if struggleatt > 5]X[else]-[end if][if struggleatt > 6]X[else]-[end if][if struggleatt > 7]X[else]-[end if][close bracket]";
		-- 4: say "[bracket]X[if struggleatt > 1]X[else]-[end if][if struggleatt > 2]X[else]-[end if][if struggleatt > 3]X[else]-[end if][if struggleatt > 4]X[else]-[end if][if struggleatt > 5]X[else]-[end if][if struggleatt > 6]X[else]-[end if][if struggleatt > 7]X[else]-[end if][if struggleatt > 8]X[else]-[end if][if struggleatt > 9]X[else]-[end if][close bracket]";
