...
Instead of resolving Sunbathing Shark:
	if Resolution of Sunbathing Shark > 0 and Resolution of Sunbathing Shark < 99:	[Subsequent meeting]
		...
		if scalevalue of player > 5:	[Eva not interested because the player is too big]
			...
			EvaChoice;
		else if Resolution of Sunbathing Shark is 3 or Resolution of Sunbathing Shark is 4:		[Escaped from Eva before actual anal vore]
			...
			EvaChoice;
		else if Resolution of Sunbathing Shark is 5 or Resolution of Sunbathing Shark is 6:		[Did Eva's full anal vore or did oral vore]
...
to EvaChoice:	[Choices for subsequent meetings]
	now calcnumber is 0;
	say "     You can either [link]have the full shark butt experience again (1)[as]1[end link], or you can [link]allow Eva to eat you for fun (2)[as]2[end link]. It seems that Eva will also not stop you if you choose to [link]leave (3)[as]3[end link].";
	get a number;
