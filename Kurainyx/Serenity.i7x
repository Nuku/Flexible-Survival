...
to say ResolveEvent Naga Hybrid:
	if HP of Serenity is 0:			[First encounter]
		...
		say "[line break]     [bold type]Do you stay with the naga?[roman type][line break]";
		...
		say "[line break]     [bold type]Should you try to talk to the snake?[roman type][line break]";
		...
		if Player consents:
			...
			say "[line break]     [bold type]Do you return the naga's lockbox?[roman type][line break]";
			...
			if Player consents:			[Serenity is given lockbox, and player can choose to let her leave the game or invite her back to the bunker]
				...
				say "[line break]     [bold type]Do you tell Serenity about your bunker?[roman type][line break]";
...
to say ResolveEvent Large Cave:
	...
	say "[line break]     [bold type]Should you go inside the cave?[roman type][line break]";
...
ScaleValue of Serenity is 4. [long snek]
Body Weight of Serenity is 3. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Serenity is 6. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
[Body Adjective is generated out of the body weight and body definition and can be used in scenes - one word descriptive adjective depending on weight and definition groups: low weight group: skinny/slender/lithe; mid weight group: average/fit/muscled; high weight group: pudgy/husky/jacked]
Androginity of Serenity is 8. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Serenity is 12. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Serenity is 4. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Serenity is 16. [length in inches]
Breast Size of Serenity is 0. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Serenity is 0. [count of nipples]
Asshole Depth of Serenity is 6. [inches deep for anal fucking]
Asshole Tightness of Serenity is 2. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Serenity is 0. [number of cocks]
Cock Girth of Serenity is 0. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Serenity is 0. [Length in Inches]
Ball Count of Serenity is 0. [allowed numbers: 1 (uniball), 2 or 4]
Ball Size of Serenity is 0. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
Cunt Count of Serenity is 1. [number of cunts]
Cunt Depth of Serenity is 8. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
Cunt Tightness of Serenity is 2. [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
Clit Size of Serenity is 2. [size 1-5, very small/small/average/large/very large]
...
to say SerenitySexMenu:
	if HP of Serenity < 3:		[Try to have snek sex before talking to her]
		...
		say "[line break]     What will you do with Serenity?";
		now sextablerun is 0;
		blank out the whole of table of fucking options;
		[]
		if Player is male:
		...
		while sextablerun is 0:
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if Player consents:
					...
					now sextablerun is 1;
					if title entry is:
						-- "Penetrate Serenity's pussy":
							say "[SerenitySex1]";
						-- "Give cunnilingus":
							say "[SerenitySex2]";
						-- "Get your cock serviced":
							say "[SerenitySex3]";
						-- "Get your cunt serviced":
							say "[SerenitySex4]";
						-- "Feed Serenity":
							say "[SerenityFeeds]";
...
"Naga Hybrid"	"[PrepCombat_Naga Hybrid]"

to say PrepCombat_Naga Hybrid:
	setmongender 4;]
...
When Play begins:
	...
	now Species Name entry is "Naga"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Naga Hybrid" to infections of ReptileList;
	add "Naga Hybrid" to infections of FurryList;
	add "Naga Hybrid" to infections of MythologicalList;
	add "Naga Hybrid" to infections of FemaleList;
	add "Naga Hybrid" to infections of TaperedCockList;
	add "Naga Hybrid" to infections of SheathedCockList;
	add "Naga Hybrid" to infections of NoLegList;
