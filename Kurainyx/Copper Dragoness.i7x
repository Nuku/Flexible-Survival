...
When Play begins:
	...
	now Species Name entry is "Copper Dragon"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	add "Copper Dragoness" to infections of InternalBallsList;
