...
to say SavinaIntroFight:			[Player fights with Gargoyle. Winning creates the Deep Forest Area along with Savina as an npc]
...
Instead of fucking Savina:
	if lust of Savina < 1:
		...
		say "     Her tail shoots forward, swiftly taking you in its embrace. You gasp in both surprise and arousal at the feeling of her marvelous touch as her coils work over you. In a matter of a few seconds, you are completely trapped within her embrace, only your head sticking above her twisting body, and your serpentine mistress easily lifts your helpless form up until you're right in front of her entrancing eyes. Lost in those golden pools, your mind is open to her, and her touch is all the more sensual.";
...
to say SavinaSexMenu:
	...
	now description entry is "Savina sticks her tail into your rear";
	[]
	...
	while sextablerun is 0:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if player consents:
				now sextablerun is 1;
				say "     Despite your muddled senses, you manage to tell the snake that you changed your mind about spending with time with her. Savina gives you an unamused glare and loosens her coils, unceremoniously dropping you to the ground. 'Fine then. Doesn't matter to me either way if my pet wants to play or not,' she says, annoyance clear in her tone. 'But I'm still counting it against you for wasting my time.'";
				wait for any key;
			else:
