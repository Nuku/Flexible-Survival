Version 2 of Savina by Kurainyx begins here.
...
[ Version 2.0 - Added missing scene for running away from Savina, two new sex scenes, and two vore endings - Kurainyx ]
...
to say ResolveEvent Abandoned Camp:
	if HP of Savina is 0:			[First encounter]
		...
		say "[line break]     [bold type]Do you want to search the camp?[roman type][line break]";
	...
	else:			[Repeat encounter if Player doesn't defeat gargoyle]
		...
		say "[line break]     [bold type]Do you want to fight the gargoyle?[roman type][line break]";
...
to say SavinaIntroFight:			[Player fights with Gargoyle. Winning creates the Deep Forest along with Savina as an NPC]
	...
	if fightoutcome >= 10 and fightoutcome <= 19:	[won fight]
		...
		if vorelevel > 1:	[Event continues unless 'Less Vore' is set]
			...
			say "[line break]     [bold type]Do you try to escape?[roman type][line break]";
...
Description of Deep Forest is "     You are in a small clearing deep inside of the Urban Forest. The trees here are massive and tower over you, and the area is shrouded in perpetual gloom from the thick canopy. Resting among the tree branches up above, Savina waits for you to do her bidding.[line break]".
earea of Deep Forest is "Forest".
...
instead of fucking Savina:
	if lastfuck of Savina - turns < 6: [Had sex in the last 18 hours = 6 turns]
		...
		say "     'Oh, does my pet need some attention?' Savina asks in a playful tone when you approach her. '[if lust of Savina > 1]You did just bring me back such a thoughtful gift. It wouldn't be right if I didn't show you my appreciation[else]I suppose that I can indulge you this time, but know that this is our last session before you have to bring me back another morsel. Pampering you is hungry work[end if].'";
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if Player consents:
				...
				if title entry is:
					...
					-- "Get eaten":
						say "[SavinaVore]";
					-- "Get some pet training":
						say "[SavinaPetTrain]";
					-- "Have your cunt licked":
						say "[SavinaSexCunt]";
					-- "Tongue-job for your cock":
						say "[SavinaSexCock]";
					-- "Beg Savina to eat you":
						say "[SavinaFatalBeg]";
					-- "Savina wants to keep you":
						say "[SavinaFatalKeep]";
...
to say SavinaSexCock:
	...
	WaitLineBreak;
	say "     Savina's licking is relentless, sending waves of ecstasy through you, and eventually, her tongue-job becomes too much for your over-pleasured mind as your twitching cock[smn] paint[smv] the insides of her mouth with your cum. You can feel the rumbling of Savina's chuckle while she effortlessly drinks down your cream, a meager offering due to her monstrous size. When the flow of your cum starts to taper off, the serpent's tongue is quick to resume its attack on your tool[smn]. Not having even a moment of respite, it doesn't take much licking over your sensitive rod[smn] to coax out yet another orgasm, and as another load is claimed by the ravenous serpent, she continues her assault. Unable to do anything to break the cycle of pleasure, everything is incomprehensible to your overloaded mind except for the euphoria that your mistress bestows upon you.";
	say "     You lose count of how many orgasms you've had, as well as how much time has passed, but eventually, Savina finally pulls you out of her mouth after having milked every last drop of your delectable cream. Her coils gently release you onto the forest floor, leaving you lying on your back. As you recover from the exhausting ordeal, Savina's head looms over you as she makes a show of dragging her tongue across her smirking lips. 'Another tasty treat from my pet,' she teases. 'Do come back when you want me to milk you dry again.' Despite the tiring experience, you find that Savina's offer is not only enticing, but you're also wondering what other things the dominant snake can do to you.";
	if SavinaTempt < 5:
		increase SavinaTempt by 1;
...
carry out SavinaHunt:		[Player fights an enemy, randomly chosen from a small group. If victorious, the enemy is fed to Savina for sex points]
	...
	challenge "[one of]Elven Hunter[or]Harpy[or]Gargoyle[or]Knight[or]Knight[or]Squire[at random]";
	...
	if fightoutcome >= 10 and fightoutcome <= 19:	[won fight]
		...
		if a random chance of 1 in 2 succeeds:
			say "     The eyes of your victim bulge when they see Savina, but before they can get up and run away, the snake's tail shoots forward, ensnaring them in a cocoon of scales. Savina's prey struggles and whimpers within her grasp, but they promptly go still and silent when they are given a close-up of her hypnotic eyes. 'Hush, little one,' Savina croons. 'You are mine now. Just relax and let me welcome you into my embrace. Soon, you won't have to worry about a thing.' The captive slowly nods, and they barely flinch as Savina closes in on them with her hungry maw wide open. The serpent envelops the entranced prisoner in her mouth, easily slipping her meal inside of her as she hums in satisfaction.";
