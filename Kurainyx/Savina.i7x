		...
		if vorelevel > 1:	[Event continues unless 'Less Vore' is set]
			...
			if Player consents:		[Player is hypnotized, eaten, and then made into Savina's pet/servant]
				...
				if Player is male:
					...
					say "     Your cunt[sfn] rub[sfv] against the sensuous walls, making you all the more aroused. It doesn't take long for you to reach your climax and spray your juices all over the snake's interior. ";
				else:
...
to say SavinaFatalBeg:
	...
	wait for any key;
	now Ending Reason of TheEnd is "Vore by Savina";
