...
to say Feral Wolf Bitch attack:
	if a random chance of 1 in 2 succeeds:
		...
		if Player is female:
			...
			if wslevel is 3 or (wslevel is 2 and (a random chance of 1 in 3 succeeds or (Player is kinky and a random chance of 2 in 5 succeeds))):
			...
			say "     The wolf snarls and growls more, now bucking onto your maw with short, hard strokes, her cunt covering your mouth and making it hard for you to breathe. Her thrusts soon becoming erratic, her breathing and snarling turning into hard panting and soft whining, and her cunt clamps up as the wolf seems to be trying to hold herself back from orgasm.";
...
to say BeatFeralWolfBitch:
	...
	if (HP of Fang is 0 or HP of Fang is 98):		[Checking to add Fang before running the regular wolf scenes]
...
When Play begins:
	...
	now Name entry is "Feral Wolf Bitch";
	...
	now Cross-Infection entry is "Feral Wolf Male"; [ Infection that this infection will give the player when they lose; can be left empty if they infect with the monster's own strain. ]
...
Table of Game Objects (continued)
name	desc	weight	object
"wolf bitch milk"	"A plastic water bottle filled with what is clearly milk. One could think it was a regular cow's milk, if someone hadn't written 'Wolf Bitch Milk' across the label on the bottle. You [italic type]could[roman type] drink it to quench your thirst. Who knows what else it might do to you though..."	1	wolf bitch milk
