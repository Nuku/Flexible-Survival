...
to SylviasCityResearchOneEvent:
	...
	if Player consents: [Intervene]
		...
		if FemaleList is warded or FemaleList is banned or a random chance of 1 in 2 succeeds: [Julian saves her]
			...
			say "     The feline twins engage the two remaining husky-girls, leaving the two canine males to face off. Placing himself between Sylvia and the husky alpha, Julian glares at his adversary, fists clenching and unclenching at his side. With the shock of the wolf's sudden arrival worn off, the husky alpha stalks towards him, determined to reclaim what he views as his prize. Were he not so single-minded, he might see that his subordinates are not faring well against Evelyn and Evenlyn, the two cats working in sync to efficiently incapacitate their larger foes through tactics such as tripping and dodging to exhaust them, only occassionally striking them when the opportunity presents itself. The confrontation comes to a very rapid conclusion when the alpha gets within armsreach of Julian, who swiftly grabs him by the throat in a manner not disimilar to what happened to the collie earlier and whirls around to slam the husky forcefully against the wall, the impact knocking him out cold.";
			WaitLineBreak;
