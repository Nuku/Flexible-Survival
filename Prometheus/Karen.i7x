...
to say ResolveEvent Forgotten Past:
	if HP of Karen is 7 and Retriever Girl is listed in companionList of Player:
		...
		say "     (Note - This quest/character is still a work in progress, this is where it ends for now. Sorry! But there is more to come!- Prometheus)";
