...
"Scorched Mole"	"[PrepCombat_Scorched Mole]"

to say PrepCombat_Scorched Mole:
	say "";
...
When Play begins:
	...
	now Species Name entry is "Mole"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now MilkItem entry is "scorched mole milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "scorched mole cum"; [ Item to be given to the player if they have this infection and jerk off. ]
