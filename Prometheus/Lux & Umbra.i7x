...
to say Luxdesc:
	...
	if HP of Lux is:
		-- 1: [ Pup ]
			say "     Lux looks like a small ball of pale-gray fur, not being particularly mobile. She is most often next to her [FangFatherMother], Fang, who is making sure that [PosPro of Fang] newborn daughter is safe even while protecting the library. Occasionally, you may see her open her eyes, the irises a dark-gray as they absorb her surroundings. Her rare cries for attention bring a smile to your face.";
		-- 2: [ Child ]
		...
		-- 4: [ Young Adult ]
			if Lux is in Grey Abbey Library:
				say "     Lux patiently sits beside the door [if Fang is in Grey Abbey Library]between her brother and [FangFatherMother], the three [else]with her brother, the two [end if]of them snuggling together companionably. Lux is a little smaller than her sibling and her fluffy paler gray fur contrasts with his, helping her to camouflage in the city when she explores. Given that she was born before Umbra, it is little surprise that she is more senior in the pack hierarchy, though the two of them don't often express this.";
				say "     Noticing you watching her, she meets your gaze, her dark-gray eyes inquisitive, expressive, and rarely missing any movement, a trait that helps while she helps Fang keep guard. She demonstrates an intelligence higher than the feral wolves that you have encountered, possibly even her [FangFatherMother], and has used this mental capability to develop capabilities such as fluent speech and the ability to walk on her hind legs for extended periods. As her brother doesn't speak as often as her, she often translates his body language and other non-vocal attempts at communication. Her tail thumps against the floor as she wags at your continued attention.";
				...
				say "     Lux is [if HP of Fang is 3 or HP of Fang is 4]quite a bit [else]only slightly [end if]smaller than Fang and her brother, Umbra, with fluffy, pale-gray fur that helps her camouflage in the city when she explores. She seems higher in the pack order than her brother, which given that she was born first, isn't really surprising. Her dark-gray eyes are inquisitive and expressive, rarely missing any movement. She shows an intelligence above that of the feral wolves, possibly even her [FangFatherMother], and is able to walk on her hind legs for extended periods of time without looking awkward. Her speech is rather fluent, only occasionally making an error. She makes use of her talent, often translating what Umbra wishes to express.";
	...
	if HP of Umbra is:
		...
		-- 4: [ Young Adult ]
			if Umbra is in Grey Abbey Library:
				say "     Umbra vigilantly sits beside the door [if Fang is in Grey Abbey Library]with he and Fang either side of his sister, Lux, the three [else]along with his sister, the two [end if]of them snuggled together companionably. Umbra is[if HP of Fang is 3 or HP of Fang is 4], to your surprise, slightly [else if HP of Fang is 2] noticeably [else] only slightly [end if]larger than his [FangFatherMother], though he submits without hesitation to Fang when expected to. His lush darker gray fur contrasts with that of his sister, helping him to camouflage in the city when he explores and reduces any harm that comes to him should his agility not be enough. Despite his larger size, he is junior in the pack hierarchy compared to Lux, being younger than his twin likely playing into this, viewing himself as a guardian of the library in a similar manner to his [FangFatherMother].";
				...
				say "     Umbra is curled up beside one of the desks with his sister[if Fang is in Computer Lab] and [FangFatherMother], the three [else], the pair [end if]of them snuggled together as they sleep[if Dash is in Computer Lab] along with Dash who is almost buried beneath a cloud of warm and soft wolf fur between them all[end if]. Umbra is[if HP of Fang is 3 or HP of Fang is 4], to your surprise, slightly [else if HP of Fang is 2] noticeably [else] only slightly [end if]larger than his [FangFatherMother], though he submits without hesitation to Fang when expected to. His lush darker gray fur contrasts with that of his sister, helping him to camouflage in the city when he explores and reduces any harm that comes to him should his agility not be enough. Despite his larger size, he is junior in the pack hierarchy compared to Lux, being younger than his twin likely playing into this, viewing himself as a guardian of the library in a similar manner to his [FangFatherMother].";
				...
				say "     Umbra is[if HP of Fang is 3 or HP of Fang is 4], to your surprise, slightly [else if HP of Fang is 2] noticeably [else] only slightly [end if]larger than Fang, though he submits without hesitation to his [if Fang is Male]father [else]mother [end if]when expected to. His lush, dark-gray fur helps him camouflage in the city when he explores and reduces any harm that comes to him should his agility not be enough. He views himself as being below you, Fang, and Lux in the pack, though above everyone else, acting as a guardian in similar fashion to his [FangFatherMother]. His green eyes are keen and expressive, analyzing any adversaries and predicting their actions. He shows an intelligence similar to that of his [FangFatherMother], able to walk on his hind legs when necessary. His speech is still limited, though he seems to be able to get the message across without any confusion when necessary.";
...
instead of going to Grey Abbey Library while hp of Umbra is 4 and Umbra is in Grey Abbey Library and Fang is Male and MaleList is not warded and MaleList is not banned and "LuxUmbra Incest Enabled" is listed in traits of player and Umbra & Player Sexual Interest is not resolved and a random chance of 1 in 2 succeeds:
...
instead of going up from Grey Abbey Library while hp of Umbra is 4 and Umbra is in Grey Abbey Library and hp of Carl is 10 and Fang is Male and MaleList is not warded and MaleList is not banned and Umbra & Carl Sexual Interest is not resolved and a random chance of 1 in 2 succeeds:
...
instead of going to Grey Abbey Library while hp of Lux is 4 and Lux is in Grey Abbey Library and (hp of Amy > 10 and hp of Amy < 13) and Fang is Male and FemaleList is not warded and FemaleList is not banned and Lux & Amy Sexual Interest is not resolved and a random chance of 1 in 2 succeeds:
