	...
	if HP of Lux is:
		...
		-- 4: [ Young Adult ]
			if Lux is in Grey Abbey Library:
				say "     Lux patiently sits beside the door [if Fang is in Grey Abbey Library]between her brother and [if Fang is Male]father[else]mother[end if], the three [else]with her brother, the two [end if]of them snuggling together companionably. Lux is a little smaller than her sibling and her fluffy paler gray fur contrasts with his, helping her to camouflage in the city when she explores. Given that she was born before Umbra, it is little surprise that she is more senior in the pack hierarchy, though the two of them don't often express this.";
	...
	if HP of Umbra is:
		...
		-- 4: [ Young Adult ]
			if Umbra is in Grey Abbey Library:
				...
				say "     Umbra is curled up beside one of the desks with his sister[if Fang is in Computer Lab] and [if Fang is Male]father[else]mother[end if], the three [else], the pair [end if]of them snuggled together as they sleep[if Dash is in Computer Lab] along with Dash who is almost buried beneath a cloud of warm and soft wolf fur between them all[end if]. Umbra is[if HP of Fang is 3 or HP of Fang is 4], to your surprise, slightly [else if HP of Fang is 2] noticeably [else] only slightly [end if]larger than his [if Fang is Male]father[else]mother[end if], though he submits without hesitation to Fang when expected to. His lush darker gray fur contrasts with that of his sister, helping him to camouflage in the city when he explores and reduces any harm that comes to him should his agility not be enough. Despite his larger size, he is junior in the pack hierarchy compared to Lux, being younger than his twin likely playing into this, viewing himself as a guardian of the library in a similar manner to his [if Fang is Male]father[else]mother[end if].";
