...
an everyturn rule:
	if hp of Lux is 4 and hp of Umbra is 4 and Fang is booked and Fang is visible and Lux is visible and Umbra is visible:
		if a random chance of 1 in 10 succeeds:
			if a random number between 1 and 2 is:
				-- 1:
					if Carl is booked and hp of Carl > 9: [ Umbra spending time with Carl ]
...
instead of going to Computer Lab while hp of Lux is 4 and hp of Umbra is 4 and Lux is invisible and Umbra is invisible and a random chance of 1 in 4 succeeds:
