	...
	if HP of Lux > 3:
		...
		[else if TimekeepingVar is 6 or TimekeepingVar is -2:] [mid-morning]
			...
			if Player is in Computer Lab:
				...
				say "     [bold type]Lux and Umbra pad over towards the entrance behind Fang and sit down beside him to resume guard duty.[roman type][line break]";
	...
	if HP of Lux is:
		...
		-- 4: [ Young Adult ]
			if Lux is in Grey Abbey Library:
				...
				say "     Lux is [if HP of Fang is 3 or HP of Fang is 4]quite a bit [else]only slightly [end if]smaller than Fang and her brother, Umbra, with fluffy, pale-gray fur that helps her camouflage in the city when she explores. She seems higher in the pack order than her brother, which given that she was born first, isn't really surprising. Her dark-gray eyes are inquisitive and expressive, rarely missing any movement. She shows an intelligence above that of the feral wolves, possibly even her father, and is able to walk on her hind legs for extended periods of time without looking awkward. Her speech is rather fluent, only occasionally making an error. She makes use of her talent, often translating what Umbra wishes to express.";
	...
	if HP of Umbra is:
		...
		-- 4: [ Young Adult ]
			if Umbra is in Grey Abbey Library:
				say "     Umbra vigilantly sits beside the door [if Fang is in Grey Abbey Library]with he and Fang either side of his sister, Lux, the three [else]along with his sister, the two [end if]of them snuggled together companionably. Umbra is[if HP of Fang is 3 or HP of Fang is 4], to your surprise, slightly [else if HP of Fang is 2] noticeably [else] only slightly [end if]larger than his father, though he submits without hesitation to Fang when expected to. His lush darker gray fur contrasts with that of his sister, helping him to camouflage in the city when he explores and reduces any harm that comes to him should his agility not be enough. Despite his larger size, he is junior in the pack hierarchy compared to Lux, being younger than his twin likely playing into this, viewing himself as a guardian of the library in a similar manner to his father.";
				...
				say "     Umbra is curled up beside one of the desks with his sister[if Fang is in Computer Lab]and father, the three [else], the pair [end if]of them snuggled together as they sleep[if Dash is in Computer Lab]along with Dash who is almost buried beneath a cloud of warm and soft wolf fur between them all[end if]. Umbra is[if HP of Fang is 3 or HP of Fang is 4], to your surprise, slightly [else if HP of Fang is 2] noticeably [else] only slightly [end if]larger than his father, though he submits without hesitation to Fang when expected to. His lush darker gray fur contrasts with that of his sister, helping him to camouflage in the city when he explores and reduces any harm that comes to him should his agility not be enough. Despite his larger size, he is junior in the pack hierarchy compared to Lux, being younger than his twin likely playing into this, viewing himself as a guardian of the library in a similar manner to his father.";
