...
to say Feral Wolf Male attack:
	if a random chance of 1 in 2 succeeds:
		...
		say "     After a few minutes of this treatment, the wolf shifts his stance, lying down on your [bodydesc of Player] chest, his cock resting on your face. Once he is properly situated on top of you, he pulls his hips back, lifting his shaft off of you. The tip of his length slides up your face until it reaches your lips, where it slips between them as he spurts a few good pumps of pre before the wolf slams his shaft down into your mouth, snarling and growling in dominance.";
		WaitLineBreak;
		...
		if Player is female and ((anallevel is 3 and a random chance of 1 in 3 succeeds) or (anallevel < 3 and a random chance of 1 in 2 succeeds)):
			if Cunt Depth of Player < 15 or Cunt Tightness of Player < 10:
				say "     He pushes you over onto your stomach and climbs up on top of you, grinding his quickly hardening shaft against your rump. You whimper as he digs his claws into your hips and presses the tip of his shaft against [if Cunt Count of Player > 1]one of your cunts[else]your cunt[end if]. Wasting no time, he slams it into you, making you gasp out in both pain and pleasure, his grip on you making it easy for him to pound his shaft into you. He growls and bites down on your neck, pulling back slightly in a canine mating bite and you quickly submit to him both in body and mind.";
				say "     Within minutes, you are yipping and barking like a good little breeding bitch, howling out your submission for all to hear. You shiver and moan out, panting harder, as you feel the wolf's thick knot ramming against your cunt's moist lips, begging him to tie you and pump you full of fertile seed. He roars out his dominance and spreads your pussy open with his knot, your back arching in pleasure as you are bred. His knot's soon swollen to three times the size and has locked you to him, his thrusting quickly speeding up.";
				WaitLineBreak;
...
to say BeatFeralWolfMale:
	...
	if (HP of Fang is 0 or HP of Fang is 99):		[Checking to add Fang before running the regular wolf scenes]
				...
				if Player is herm:
					...
					while calcnumber < 1 or calcnumber > 3:
						...
						if calcnumber is 1 or calcnumber is 2 or calcnumber is 3:
							...
							say "Invalid choice. Type [link]1[end link] to fuck the wolf, [link]2[end link] to ride his cock or [link]3[end link] to tame him without sex.";
					if calcnumber is 1:
						LineBreak;
...
to say FeralWolfNonSexTame:
	say "     Moving your hand to his throat, you roll him over onto his back and hold him down, looking firmly into his eyes. He whimpers softly, but tilts his head back, baring his throat submissively, accepting his fate as subservient to you readily enough. You smile at his willing submission and whisper what a good beta he will make. This both elevates him above his previous station and helps cement his place beneath you as his alpha. In a display of power over him, you ignore his arousal and instead focus on grooming twigs, dust, and debris from his fur. If he is going to belong to you, then he is going to look presentable while keeping on guard. He whines for a moment, but a stern glare silences him and the wolf accepts that he won't be getting off at the moment. Seeing his acceptance, you lean up next to his ear and whisper that he's your wolf now and what a good boy he is. He pants excitedly at your praise and the prospect of being a beta in your pack.";
...
to say FeralWolfVictorySex:
	...
	if Player consents:
		if Player is male:
			if Player is female:
				LineBreak;
				say "     Deciding to have some fun with this poor wolf, you stop and think about how exactly you want to use him. Being a herm, you could easily roll him over and ride his thick canine shaft, or you could mount that tight little ass of his. (Y=Ride, N=Fuck)[line break]";
				if Player consents:
					...
					WaitLineBreak;
					say "     You start panting hard and begin slamming down on his length. You feel his knot swelling, slipping in and out of your cunt, steadily gaining size. Soon it's too big to just slip in, so you pull yourself almost completely off his cock before slamming back down and forcing that knot inside you.";
					...
					CreatureSexAftermath "Feral Wolf Male" receives "AssFuck" from "Player";
			else:
				LineBreak;
				say "     The feral creature sinks to the ground, then slumps over, panting and defeated. You look at him and smile, walking over to him to roll him over onto his chest. The wolf looks back at you and whimpers, quickly understanding what you plan to do. He closes his eyes and shivers before raising his rump up into the air, tail up high and showing off his ass. You laugh and climb on top of the wolf, pressing the tip of your shaft against his tight ring and teasing it lightly. The wolf below you groans and claws at the ground, pushing back against your length, obviously eager to be fucked. You waste no time after such an open invitation and spread his tail hole wide open, gasping out and moaning at how tight the wolf is. You take hold of his hips and begin slamming your length into the big canine's ass, his back arching as he moans loudly, enjoying the good fucking you're giving him.";
				say "     Soon you are panting hard and climaxing hard, filling the formerly dominant wolf with your thick cum. Once you finish, you pull out of the wolf and walk around front to present your shaft to him for cleaning[if HP of Fang is 0]. Smiling to yourself, you think of how much fun it would be to have a wolf like this for a pet[end if].";
...
"Feral Wolf Male"	"[PrepCombat_Feral Wolf Male]"

to say PrepCombat_Feral Wolf Male:
	setmongender 3;
...
When Play begins:
	...
	add "Feral Wolf Male" to infections of MaleList;
	add "Feral Wolf Male" to infections of TaperedCockList;
	add "Feral Wolf Male" to infections of KnottedCockList;
	add "Feral Wolf Male" to infections of SheathedCockList;
	add "Feral Wolf Male" to infections of QuadrupedalList;
	...
	now MilkItem entry is "feral wolf male milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
