...
Claude is a person.
ScaleValue of Claude is 3. [human sized5' 6"]
...
Mouth Length of Claude is 9. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Claude is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Claude is 9. [length in inches]
...
Cunt Depth of Claude is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Cunt Depth of Claude is 10. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
