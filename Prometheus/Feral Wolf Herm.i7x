...
to say Feral Wolf Herm attack:
	if a random chance of 1 in 2 succeeds:
		if a random chance of 1 in 2 succeeds:
			...
			WaitLineBreak;
			say "     The wolf snarls and growls more, now bucking into your maw with short, hard strokes, their length deep in your gullet and making it hard for you to breath. Their thrusts soon becoming erratic, their breathing and snarling turning into hard panting and soft whining, and their shaft swelling up as the wolf seems to be trying to hold themselves back from orgasm. The wolf gives one hard thrust and howls out in climax, claws digging deep into your skin, their heavy balls pulling up as their contents come flooding out, being pumped straight down your throat and into your stomach, your belly soon swelling slightly with thick wolf cum. The wolf collapses on top of you, panting hard and wagging their tail happily, the last bit of their seed spurting out of their shaft and down your gullet. You lay there for a good number of minutes before the wolf's knot has deflated enough to be yanked out from between your lips.";
			if wslevel is not 1:
			...
			say "     The wolf snarls and growls more, now bucking onto your maw with short, hard strokes, their cunt covering your mouth and making it hard for you to breathe. Their thrusts soon becoming erratic, their breathing and snarling turning into hard panting and soft whining, and their cunt clamps up as the wolf seems to be trying to hold themselves back from orgasm.";
			...
			if anallevel is 1: [Anal excluded]
				if a random chance of 1 in 2 succeeds: [Vaginal]
					...
					if wslevel is 3 or (wslevel is 2 and (a random chance of 1 in 3 succeeds or (Player is kinky and a random chance of 1 in 3 succeeds))):
						say "soon turning to position themselves over you. Lifting their leg they starts to empty their bladder all over your torso and face, marking you as their before ";
				...
				if randomnumber is:
					-- 1: [Anal]
						...
						if wslevel is 3 or (wslevel is 2 and (a random chance of 1 in 3 succeeds or (Player is kinky and a random chance of 1 in 3 succeeds))):
							say "You look as you see them position themselves above you. You begin to think that they must want your mouth next when they start to empty their bladder all over your torso and face. ";
					...
					-- 2: [Vaginal]
						if Cunt Depth of Player < 15 or Cunt Tightness of Player < 10:
							...
							say "     Your eyes go wide and you scream out in pleasure, shivering all over and orgasming hard and clamping down on the wolf's length. The treatment their shaft is receiving is too much for them and they climax hard, howling out into the empty street. Their cum floods into your womb and begins to overflow around their cock. Once you both come down from orgasm, you wait for the wolf's knot to deflate. The wolf gets up and yanks their shaft out of you, ";
						if wslevel is 3 or (wslevel is 2 and (a random chance of 1 in 3 succeeds or (Player is kinky and a random chance of 1 in 3 succeeds))):
							say "soon turning to position themselves over you. Lifting their leg, they start to empty their bladder all over your torso and face, marking you as their before ";
...
"Feral Wolf Herm"	"[PrepCombat_Feral Wolf Herm]"

to say PrepCombat_Feral Wolf Herm:
	setmongender 3;
...
When Play begins:
	...
	now Name entry is "Feral Wolf Herm";
