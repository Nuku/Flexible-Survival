...
This is the Fang's Epilogue rule:
	if Fang is not in the Grey Abbey Library:
		make no decision;
	if HP of Fang is listed in { 1, 2 }: [ Fang the guard wolf ]
