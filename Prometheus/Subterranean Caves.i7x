...
Cunt Depth of Webber is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Cunt Depth of Lumio is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Cunt Depth of Malkum is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Cunt Depth of Whaife is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Cunt Depth of Celeste is 10. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Cunt Depth of Varenya is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Cunt Depth of Myra is 10. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Cunt Depth of Emmett is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Cunt Depth of Milly is 10. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Cunt Depth of Belliandra is 12. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
	...
	if White Wolf Zero is listed in CompanionList of Player:
		if BelliandraBlancheTrainingCooldown is 0:
			if "Belliandra Initial Training" is listed in traits of Blanche: [Been trained before]
				...
				increase level of White Wolf Zero by 1;
			else: [First Time]
				...
				increase level of White Wolf Zero by 5;
			follow turnpass rule;
		else:
