...
When Play begins:
	...
	now Species Name entry is "Lion"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now MilkItem entry is "nemean lion milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "nemean lion cum"; [ Item to be given to the player if they have this infection and jerk off. ]
