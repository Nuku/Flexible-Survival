...
Androginity of Alexandra is 8. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Alexandra is 6. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Alexandra is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Alexandra is 6. [length in inches]
Breast Size of Alexandra is 3. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Alexandra is 2. [count of nipples]
Asshole Depth of Alexandra is 10. [inches deep for anal fucking]
Asshole Tightness of Alexandra is 2. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Alexandra is 0. [number of cocks]
Cock Girth of Alexandra is 0. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Alexandra is 0. [length in inches]
...
TwistedCapacity of Alexandra is false. [Twisted Characters can take any penetration, no matter the size]
Sterile of Alexandra is false. [steriles can't knock people up]
...
to say alexandratalk_gg1: [Chit-chat]
...
[		if HP of Alexandra > 65, increase lastfuck of Alexandra by 8;]
		...
		now sextablerun is 0; [Chit-chat allows continued conversation]
	else if hunger of Alexandra is 1:
		say "     [one of]'It's kind of you to check up on me from time to time,' she says, her tail wagging.[or]'Grab a seat,' she adds, waving a paw to a stray office chair before pulling another around to sit opposite you.[or]'I've had to drive off a few creatures that've come poking around here. Things have been pretty quiet lately, so it must be helping.'[or]'You've been such a big help, from saving me from going crazy to providing us shelter here. I owe you so much.'[or]'It's been hard to deal with this sex-crazed city at times. The urges you get, you know,' she says. You can see her squeezing her legs together and grinding her thighs against one another, the passing scent of canine arousal in the air.[or]Alexandra gives you a report on recent activity around the library.[or]'You need to be careful out there. There's some people out there who seem sane enough at first, but they've lost their minds and become horny, feral mutants. Just because someone can talk to you doesn't mean they're sane or safe.'[or]'Keep an eye out for more survivors, especially those who might need our help.'[or]'Don't forget that the military's going to be coming in to help us as soon as they can mobilize. We just need to hold out until then. Though sometimes I wonder...'[or]You chat with Alexandra for a while, telling her some of the stuff you've encountered out in the city.[or]'ANy supplies that you find would be a big help. Either to us or someone else in need.'[at random]"; [Chit-chat allows continued conversation]
		now sextablerun is 0;
...
to say alexandratalk_gg_past: [Her Past]
...
to say alexandra_supplies: [Supplies]
...
to say alexandra_gshep: [Tell Alexandra about Buster and the G-Shep Squad]
...
to AlexandraTaskChat:
	...
	if AT_Repair is false and HP of Alexandra >= 56 and policerepair is 0 and hunger of Alexandra is 0:
...
to say A_Task04:
	...
	say "     'While I was patrolling [if hunger of Alexandra is 1]outside the library [else]the city[end if], I ended up getting followed around by a [bold type]squirrel girl[roman type] for a while. She followed me and seemed to be trying to get me to chase her, but I never managed to get her. You'll need to be fast and observant if you want to catch her.";
	now AT_Snow is true;
	now sextablerun is 0; [continued talking allowed]
...
to say A_Task08:
	...
	say "     'While I was searching around in the high rise district[if hunger of Alexandra is 1] a while ago[end if], I ran into another cop. At first, I was really hopeful that we'd be able to work together and do more to help out, but he had other plans. I tried to restrain him, but we were pretty evenly matched and he eventually pulled out some tear gas. If you run into a [bold type]policeman[roman type] down there, don't trust that tiger cop. He may have been a cop once, but he certainly doesn't act that way anymore.'";
...
to say A_Task09:
	...
	say "     '[if hunger of Alexandra is 1]Before I met you, [end if]I ran into the rather... friendly... [bold type]mouse taur[roman type] while in the red light district. It seems she runs a [bold type]porn store[roman type] somewhere down there. I didn't go there myself, not wanting to risk being tempted, but it's probably safe enough if you want to look into it.'";
	now AT_Lisa is true;
	now sextablerun is 0; [continued talking allowed]
...
to say alexandra_patrol:
	...
	if Player consents:
		...
		say "     Alexandra wishes you good luck. 'I'll see you when you get back,' she says. You head out into the area surrounding the [if hunger of Alexandra is 1]library [else]station [end if]on the lookout for trouble";
		if HP of Alexandra >= 63 and a random chance of 1 in 3 succeeds and at_patrol_01 is false:
			...
			if fightoutcome >= 10 and fightoutcome <= 19:
				say "     With your victory, you drive off the crazy harpy. Finding her would-be victim crouched in a nearby doorway, you reassure her that she's safe now. [if hunger of Alexandra is 1]Giving her directions to the mall after she politely refuses any further assistance from you, you watch with trepidation as she staggers off before you make your way back to the library[else]As you lead her back to the police station, she tells you that she'd heard about the police shelter from a mutant friend of hers. With things getting worse in her neighborhood, she took the risk of trekking here. Thankfully, you arrived in time to help her make it the rest of the way[end if].";
				if hunger of Alexandra is 0:
					...
					say "     Upon your return, you're greeted by Alexandra and Jimmy who immediately ask you to give them a report of your patrol. After informing them about the woman that you rescued, they pat you on the back before Jimmy wanders off again and Alexandra returns to her post.";
				...
				say "     After recovering from your loss, you stagger your way back to the [if hunger of Alexandra is 1]library [else]station [end if]and fill Alexandra in on your encounter. Sparing her some of the messier details, you warn her to keep an eye out for harpies the next time she goes out. She's upset that a potential survivor had almost made it to safety to only be caught and carried off.";
			else:
				...
				say "     After taking a circuitous route back to the [if hunger of Alexandra is 1]library [else]station [end if], you fill Alexandra in on your encounter. You warn her to keep an eye out for harpies trying to pick off approaching survivors. You're both upset that someone had almost made it to safety to only be caught and carried off like that.";
			...
			say ". You end up coming across a mutant getting a little too curious about the [if hunger of Alexandra is 1]library [else]Police Station [end if] for your liking. Going over to check it out, your suspicions are confirmed when the aggressive creature notices you and advances.";
			now battleground is "Outside";
			fight;
			if fightoutcome >= 10 and fightoutcome <= 19:
				say "     Your battle over, you complete your patrol and return to the [if hunger of Alexandra is 1]library[else]police station[end if]. You fill Alexandra in on your encounter and she thanks you for dealing with the creature and for taking a turn on patrol for her.";
			else if fightoutcome >= 20 and fightoutcome <= 29:
				say "     After you recover from your loss, you stagger your way back to the [if hunger of Alexandra is 1]library [else]station [end if]and fill Alexandra in on your encounter. Sparing her some of the messier details, you warn her to keep an eye out for the creature the next time she goes out. She thanks you for going out and facing that threat to help protect the [if hunger of Alexandra is 1]library[else]station house[end if].";
			else:
				say "     Making your escape from the creature, you do your best to draw it away from the [if hunger of Alexandra is 1]library [else]station [end if]before losing it. Once you've managed that, you sneak back around and return to the [if hunger of Alexandra is 1]library[else]police station[end if]. You fill Alexandra in on your encounter and tell her to keep an eye out for the creature the next time she goes out. She thanks you for going out and facing that threat to help protect the [if hunger of Alexandra is 1]library[else]station house[end if].";
		else:
			say ". The trip is thankfully uneventful, most of the mutants knowing to steer clear of what they see as [if hunger of Alexandra is 1]your [else]the Doberman cop's [end if]territory. You patrol for a few hours before eventually returning. Alexandra thanks you again for taking a turn on patrol for her.";
	...
	if HP of Alexandra is 61:
		...
		if fightoutcome >= 10 and fightoutcome <= 19:
			...
			if fightoutcome >= 10 and fightoutcome <= 19:
				...
				if hunger of Alexandra < 1: [Police Station still standing]
					move player to Police Station Twelve;
				else: [Police Station gone]
	...
	if autopath is 2:
		...
		if fightoutcome >= 10 and fightoutcome <= 19:
			...
			if fightoutcome >= 10 and fightoutcome <= 19:
				...
				say "     'You are under arrest for attacks upon citizens and willfully spreading the infection with the intent to enslave and cause harm,' the doberwoman growls. 'Come quietly. We've got a nice cell waiting for you at our shelter. You're going to come with us and answer some questions.'";
				say "     The robotized woman looks you both up and down. 'You think to arrest me?' she asks, surprise creeping into her otherwise toneless voice. 'Truly and not as some euphemism for sex either? Intriguing. But how do you intend to accomplish this?' she inquires, only to have Alexandra wave her gun at her again. 'Ah. Yes. Violence.' The lights under her dome do some rapid bursts, as if calculating. 'Very well. As I cannot hope to beat you in combat, I am then to be your prisoner.' She raises her arms into the air, her lights settling into a steady series of pulsing.";
		...
		if fightoutcome >= 20 and fightoutcome <= 29:			[lost]
			...
			turn the Player into an "Automaton" silently; [NOTE: Avoid attributeinfect output in a game over (@Stadler#3007)]
...
ResolveFunction of Overmind's Retaliation is "ResolveEvent Overmind's Retaliation".
...
instead of navigating Police Station Twelve while (HP of Alexandra is 70 and Overmind's Retaliation is unresolved):
	say "[NavCheck Police Station Twelve]";
	if NavCheckReturn is false, stop the action;
	move player to Police Station Twelve;
	say "[ResolveEvent Overmind's Retaliation]";

to say ResolveEvent Overmind's Retaliation:
	if debugactive is 1:
		say "     DEBUG: The Fall of the Police Station[line break]";
	...
	say "     'As such, if you come and submit yourselves to me, I may allow you a bit more autonomy than the majority of my mobile units. I calculate an elevated chance of success with at least a twelve percent increase in conversions of residents if you act as my agents in the city. Discuss it between yourselves if you must, but I can feel my processes slowing down limiting myself in this body. Just the two of you though. If you are accompanied by anyone else, I will not hesitate to remove you from the equation.' With that, the Master Mind slumps to the wet floor, her lights in her head flickering and hidden cogs whirring. As this activity stops, she gets back on her feet and looks placidly at you. 'It would seem that you are being given free will to decide whether you desire to be improved upon. Do not squander the chance that you have been given. If you wish to take advantage of this opportunity, you will find the Overmind at this location.' One of her underlings passes you a printout with an address in the High Rise District.";
	WaitLineBreak;
...
Section 11 - Library Events

Table of GameEventIDs (continued)
Object	Name
Flirty Fitness	"Flirty Fitness"

Table of WalkInEvents (continued)
Priority	Name	EventObject	EventConditions	EventRoom	LastEncounterTurn	CoolDownTurns	EncounterPercentage
3	"Flirty Fitness"	Flirty Fitness	"[EventConditions_FlirtyFitness]"	Grey Abbey Library	2500	2	100

to say EventConditions_FlirtyFitness:
	if Hunger of Alexandra is 1 and Hunger of Jimmy is 1 and Hunger of Paula is 1 and Charisma of Blanche > 3 and Flirty Fitness is not resolved: [list of conditions here]
		now CurrentWalkinEvent_ConditionsMet is true;

Flirty Fitness is a situation.
ResolveFunction of Flirty Fitness is "[ResolveEvent Flirty Fitness]".
Sarea of Flirty Fitness is "Nowhere". [standard walkins that cannot be hunted for are Nowhere, but walkin events can also be made huntable as an alternate access way]
Level of Flirty Fitness is 0. [minimum level to encounter randomly]

to say ResolveEvent Flirty Fitness:
	say "     You walk in on what looks like the start of a group fitness session, Alexandra, Paula, Jimmy, and Penelope standing around stretching. Your daughter, who to your surprise is actually wearing pink shorts and a tank top, albeit perhaps a few sizes too small for her large frame, waves upon seeing you, while the others settle for smiling in greeting as they continue their preparations. The ex-policewoman is currently rotating her trunk, breathing calmly and rhythmically as she loosens her muscles, while Jimmy and Paula seem to be working together on stretching their hamstrings, pressing down on their partner's leg to help each other. Penelope seems to be trying to reach her toes while sitting on the floor, grumbling as the top gets in the way. 'You can do it. You wanted to be a part of this, you have to wear clothes so they don't get uncomfortable,' she mutters to herself, occasionally tugging it down as it rides up over her abdomen. The corgi and the fox seem to chuckle sympathetically at this, while Alexandra gives her a supportive nod.";
	say "     Eventually the doberman calls them to order, apparently the fitness instructor for their group. 'Now that you've all limbered up a bit, we can run a few laps around the library. I say run, but I mean jog. This is not a race and I do not want a repeat of last time. This means you, Paula. You nearly crushed Jimmy, and if a librarian saw how many books you damaged, it would likely be a homicide investigation,' Alexandra warns. Curious, you interject and ask her what happened, instead hearing Jimmy reply, 'Paula tried to lap me and tripped over her own feet, ending up on top of me and knocking several books off some shelves. The pages got a bit folded at the corners, but nothing too major.' 'This time,' the police officer adds with a stern glance at the vixen. 'I wasn't involved,' Penelope cuts in, making Alexandra hide a small smile. 'No, you're a good girl,' the doberman agrees and causing your daughter's tail to wag appreciatively at the praise.";
	WaitLineBreak;
	say "     'Unless you want to join in, stop distracting us. This body doesn't stay this shape without effort,' Paula playfully scolds you, tracing a paw down her side. 'You think you have it tough...' Alexandra murmurs, looking away when the fox turns to her. You decide that you would prefer to merely observe, sinking into a nearby armchair and gesturing for them to continue what they were doing. Though they jog away as a group, Penelope is the first to pass by you again, her longer legs likely giving her an advantage, especially over Jimmy's stubby ones. Next to appear is Alexandra, effortlessly maintaining her pace, with Paula several strides behind, breathing a little more heavily. Bringing up the rear is Jimmy, the corgi puffing but in high spirits as usual. 'Being at the back has its advantages. I have a nice view,' he jokes as he patters past, has familiarity with the pair ahead of him permitting him some leeway with his humor. 'Even if you were in front, we wouldn't be able to ogle you. We'd have to be on all fours, but perhaps you'd like that,' the vixen teases, her wit as sharp as ever. After three laps, the four of them approach you to chat while they catch their breath, some more than others.";
	say "     Alexandra seems the least affected, barely any sweat glistening on her smooth fur as she stands in front of you, a short run of little consequence to an experienced police officer. Penelope is panting slightly beside her, but you would imagine that she could go for much longer if the situation called for it, especially given how taxing her scavenging trips can be. Jimmy is lying on the floor, unconcerned about looking dignified as he loudly huffs, his tongue sliding out of the corner of his mouth. Paula sinks into a chair beside you, clearly puffed, massaging her legs, especially her thighs. 'What's wrong? You aren't usually this exhausted. We're only halfway,' Alexandra asks, folding her arms and eyeing the fox disappointedly. 'I don't think that I stretched enough. Could I do a few more to stretch my thighs?' the vixen replies. 'We... could all... do them together,' Jimmy says between breaths. 'Fine. Tell us what you want to do,' the doberman sighs.";
	WaitLineBreak;
	say "     Upon seeing the glint in Paula's eye, you realize that she may not be as tired and sore as she looks and that it could be a ruse for something. However, Alexandra doesn't notice gesturing for the foxxy nurse to take the lead. Paula lies on her back, tucking her hands behind her head and sticking her legs up straight into the air, proceeding to slowly open them sideways before closing them again with a contented sigh. 'Really... You want to do that?' the ex-policewoman comments skeptically, only for Jimmy and Penelope to lie down and copy the vixen. Without any resistance from the others, Alexandra purses her lips and follows suit, perhaps deducing an ulterior motive. Despite this she makes sure to lie in a way that gives you an amazing view of her as she begins to copy the stretch, the legs of her black shorts riding up her thighs until it looks like she is wearing a thong. Each time she closes her legs, she looks back to ensure that Paula is still following through. However, as she spread of her legs open, she looks you in the eye, not letting her gaze drop as she shows off her toned body and the control that she has over it.";
	say "     When she is sure that no one else is looking, she runs her tongue slowly over her lips and winks at you. It would seem that there is quite the seductress beneath her professional exterior, but then again, you already knew that. Smirking in response, you lean back and drink in the sight in front of you, pleased that your decision to observe is paying off and that you can enjoy this moment. With a simple tilt of her head, Alexandra tacitly gives you permission to allow your attention to wander.";
	say "[G_AlexandraStretchScenes]";

to say G_AlexandraStretchScenes:
	say "     [bold type]Who do you wish to watch?[roman type][line break]";
	let Flirty_Stretch_Choices be a list of text;
	add "Alexandra." to Flirty_Stretch_Choices;
	add "Paula." to Flirty_Stretch_Choices;
	add "Jimmy." to Flirty_Stretch_Choices;
	add "Penelope." to Flirty_Stretch_Choices;
	add "You've watched for long enough." to Flirty_Stretch_Choices;
	let Flirty_Stretch_Choice be what the player chooses from Flirty_Stretch_Choices;
	if Flirty_Stretch_Choice is:
		-- "Alexandra.":
			LineBreak;
			say "     You resume watching Alexandra, admiring her concentration and discipline. A thin sheen of sweat glistens on her short fur and on the pads of her paws, the way that the light catches on her monopolizing your attention. She manages to keep her breathing steady despite the exertion that extended performance of this motion must require, not one to quit despite her suspicion of Paula's less-than-innocent motivation behind the exercise. You can see the strength in her thighs despite the overall slender shape of her legs, no place for surplus muscle here, just like her equally toned arms or trim stomach. Feeling your eyes on her again, she smiles at you but otherwise continues her routine, occasionally flexing her toes when her paws are at their peak. 'Would you look at me like that if my legs were that long?' Jimmy teases you. '[SubjectProCap of Player] probably would, but only because you'd look like you were on stilts,' Paula quips. 'Does everyone small have the same sense of humor?' Penelope asks no-one in particular. After a few more moments of admiring Alexandra, you look away.";
		-- "Paula.":
			LineBreak;
			say "     You direct your attention towards Paula, the sharp-tongued vixen showing little sign of her earlier fatigue. Wearing matching white shorts and sports bra with red trim, the fox-woman doesn't seem to have much difficulty with this particular exercise, allowing her to freely (and unashamedly) gaze at those around her. It doesn't take long for her to notice that she has your attention and she mouths 'voyeur' at you with a wide smile and a glint in her eye. She teasingly begins to position her tail in a manner that obscures her groin from you until Alexandra pointedly clears her throat without interrupting her own movements. With a roll of her eyes, Paula allows her tail to flop back to the floor. You're a little surprised at how well she keeps up with the doberman, but then you suppose that nursing can be a rather intensive occupation too. Catching one last wink from Paula, you allow your attention to wander.";
		-- "Jimmy.":
			LineBreak;
			say "     Casting your eyes towards Jimmy, you content yourself to watch the corgi's stumpy legs open and close. The only male among women, he is not unaffected, a noticeable bulge in his blue shorts. Fortunately, he seems unbothered by his inability to adjust or hide it due to the ongoing exercise, his trademark cheerful expression fixed on his face. Puffing as he determinedly tries to keep up with the much more physically active females around him, he occasionally takes a break and just lies there, taking the opportunity to admire the rest of the group. None of them seem to mind. Penelope smiles when she catches his eye and continues without indignation or embarrassment. Paula's eyes linger on the bulge before she winks at him. Alexandra whispers encouragement, briefly shifting around to demonstrate how he might improve his posture. Overall, the corgi's cheerful demeanor and perseverance is inspiring, though given the good things that seem to have happened to him recently, who can blame him?";
		-- "Penelope.":
			LineBreak;
			say "     Your eyes fall on Penelope and you watch the amazonian wolf stretch her thighs with a lot more grace than you would expect. 'I've had practice at doing this. Bianca is very fond of it. I find it relaxing,' she explains, seemingly having felt your eyes on her and apparently reading your mind. A lot larger than the others in the group and probably more muscular beneath her thick fur, she seems to enjoy being part of it, even if it means that she has to wear clothes. The faded pink tank top and shorts look ready to burst, fluff spilling around the fabric and likely making it uncomfortable. Despite this, she continues, breathing steadily and occasionally rearranging the straps as they slip. Part of you wonders why her siblings aren't here too, but you decide that it might be overwhelming for Alexandra to have that many people requiring her attention simultaneously. Watching your daughter for a few more seconds, you then look away again.";
		-- "You've watched for long enough.":
			LineBreak;
			say "     'Ready to get back to running, or did you want to practice your lap dancing too?' Alexandra asks Paula as she stands up, twitching one of her pointed ears as she does so. 'Are you saying that you didn't enjoy that? I don't hear anyone else complaining, do you?' Paula replies with her usual smugness. She has a point. Everyone seemed to enjoy the break in their own way. 'I suppose so,' the doberman concedes. 'But we're going to work hard for the rest of our session. No more distractions.' 'Um, excuse me,' a voice interjects, and you turn to see Casper politely waiting off to the side. 'Could I have a quick word with my sister before you resume?' he asks. 'Sure. A few more minutes won't hurt,' Alexandra agrees. Curious as to what your son wishes to discuss, you walk towards your children as they converse quietly, the two of them smiling at you as you approach.";
			say "     'Hi [BlancheMomDadTitle]. I was just talking about clothes with Penelope. You can see how poorly fitted what she is wearing is, so I wondered if she would permit me to make her something better,' Casper explains. 'Between the books in the library and some magazines that I've collected, I think that I should be able to make something more comfortable, and I can always get help from someone at the mall if I have any difficulties.' Your daughter gratefully accepts, and you can see how excited your son is at the prospect of making something like this. 'Come meet me later and we can get your measurements. I'll let you get back to your exercising. Better you than me,' he teases his big sister before walking away, thanking Alexandra before he disappears, probably to begin planning. You decide that perhaps you should leave too, not wanting to distract or delay the fitness session any further. After hugging Penelope you take your leave.";
			now Flirty Fitness is resolved;


Section 12 - Pregnancy & Birth
				...
				if HP of Cleo is 0:
					...
					if Alexandra is not visible: [player isn't anywhere near her]
						...
						[else if AlexandraPupDaddy is 2: [Fang's pups]
							say "     Now that the little dogs have grown a little, you do recognize a bit of Fang in them. They are definitely still Dobermans through and through, but there's just something about the way they look and act that makes it more than clear in your mind that the wolf fathered them. Maybe it's something about the shape of their ears and muzzles, or maybe it's the markings of their fur - it's hard to say. Soon having finished with their drinking from Alexandra, first one, then another of the little ones decides to investigate the person who greeted them into the world. You find yourself beset by curious canines, sticking their noses and licking you everywhere they can reach. Even though they are not yours, they seem to have inherited some of the wild spirit of their father, making them happily pad your way without fear.";
						else if AlexandraPupDaddy is 3: [Korvin's pups]
							say "     Now that the little dogs have grown a little, you do recognize a bit of Korvin in them. They are definitely still Dobermans through and through, but there's just something about the way they look and act that makes it more than clear in your mind that the German shepherd fathered them. Maybe it's something about the shape of their ears and muzzles, or maybe it's the markings of their fur - it's hard to say. Soon having finished with their drinking from Alexandra, first one, then another of the little ones decides to investigate the person who greeted them into the world. You find yourself beset by curious canines, sticking their noses and licking you everywhere they can reach. Even though they are not yours, they seem to have inherited some of the cocky spirit of their father, making them happily pad your way without fear.";
						else if AlexandraPupDaddy is 4: [Carl's pups]
							say "     Now that the little dogs have grown a little, you do recognize a bit of Carl in them. They are definitely still Dobermans through and through, but there's just something about the way they look and act that makes it more than clear in your mind that the husky fathered them. Maybe it's something about the shape of their ears and muzzles, or maybe it's the markings of their fur - it's hard to say. Soon having finished with their drinking from Alexandra, first one, then another of the little ones decides to investigate the person who greeted them into the world. You find yourself beset by curious canines, sticking their noses and licking you everywhere they can reach. Even though they are not yours, they seem to have inherited some of the bravery of their father, making them happily pad your way without fear.";
						else if AlexandraPupDaddy is 5: [Brutus's pups]
							say "     Now that the little dogs have grown a little, you do recognize a bit of Brutus in them. They are definitely still Dobermans through and through, but there's just something about the way they look and act that makes it more than clear in your mind that the demon brute fathered them. You could swear one of the puppies['] eyes glowed purple for a moment, and their teeth and claws do seem oddly sharp. Soon having finished with their drinking from Alexandra, first one, then another of the little ones decides to investigate the person who greeted them into the world. You find yourself beset by curious canines, sticking their noses and licking you everywhere they can reach. Even though they are not yours, they seem to have inherited part of the bond between their father and yourself, making them happily pad your way without fear.";]
					if AlexandraPupDaddy is 1: [player's pups]
...
to say CleoBirth:
	...
	increase Libido of Alexandra by 1;
	now HP of Cleo is 1;
	move Cleo to Grey Abbey Library;
	now hunger of Cleo is 120;
	increase score by a random number between 5 and 10;
	now Lust of Alexandra is 0;

Section 14 - Debug and Notes
...
to say goodAlexandra_debug:
	say "DEBUG (Good Girl Alexandra) -> HP: [HP of Alexandra], Hunger: [Hunger of Alexandra], Lust: [lust of Alexandra], Story 1: [if Alexandrastory is true]Y[else]N[end if], Story 2: [if Alexandrastory2 is true]Y[else]N[end if], Story 3: [if Alexandrastory3 is true]Y[else]N[end if], lastAlexandraPast: [lastAlexandraPast], lastfuck: [lastfuck of Alexandra] <- DEBUG[line break]";
...
Section 15 - Debug Testing - Not for release
