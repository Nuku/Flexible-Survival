...
"Lernean Hydra Stage One"	"[PrepCombat_Lernean Hydra Stage One]"

to say PrepCombat_Lernean Hydra Stage One:
	say "";
...
When Play begins:
	...
	now MilkItem entry is "lernean hydra stage one milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "lernean hydra stage one cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
Table of CombatPrep (continued)
name(text)	PrepFunction(text)
"Lernean Hydra Stage Two"	"[PrepCombat_Lernean Hydra Stage Two]"

to say PrepCombat_Lernean Hydra Stage Two:
	say "";
...
When Play begins:
	...
	now loot entry is ""; [ Dropped item, blank for none. Case sensitive. ]
	now lootchance entry is 0; [ Percentage chance of dropping loot, from 0-100. ]
	now MilkItem entry is "lernean hydra stage two milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "lernean hydra stage two cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	now TrophyFunction entry is "-"; [ Function to generate a list of optional loot items, of which the player can choose one after victory. ]
	now scale entry is 5; [ Number 1-5, approx size/height of infected PC body: 1=tiny, 3=avg, 5=huge ]
	now body descriptor entry is "imposing"; [ Ex: "plump" "fat" "muscled" "strong" "slimy" "gelatinous" "slender"   Use [one of] to vary ]
	now type entry is "mythical"; [ one-word creature type. Ex: feline, canine, lupine, robotic, human... Use [one of] to vary ]
...
Table of CombatPrep (continued)
name(text)	PrepFunction(text)
"Lernean Hydra Stage Three"	"[PrepCombat_Lernean Hydra Stage Three]"

to say PrepCombat_Lernean Hydra Stage Three:
	say "";
...
When Play begins:
	...
	now loot entry is ""; [ Dropped item, blank for none. Case sensitive. ]
	now lootchance entry is 0; [ Percentage chance of dropping loot, from 0-100. ]
	now MilkItem entry is "lernean hydra stage three milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "lernean hydra stage three cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	now TrophyFunction entry is "-"; [ Function to generate a list of optional loot items, of which the player can choose one after victory. ]
	now scale entry is 5; [ Number 1-5, approx size/height of infected PC body: 1=tiny, 3=avg, 5=huge ]
	now body descriptor entry is "imposing"; [ Ex: "plump" "fat" "muscled" "strong" "slimy" "gelatinous" "slender"   Use [one of] to vary ]
	now type entry is "mythical"; [ one-word creature type. Ex: feline, canine, lupine, robotic, human... Use [one of] to vary ]
