...
BehaviourandCustoms is a number that varies. BehaviourandCustoms is usually 0.
...
to LectureChoiceEvent: [Choose Lecture to attend]
	...
	[]
	if EnrollmentTokens > 0 and BehaviourandCustoms is 0 and 2 > 3: [disabled for now]
		choose a blank row in table of fucking options;
		now title entry is "Enroll in the Behaviour and Customs Lecture";
		now sortorder entry is 3;
		now description entry is "Spend an enrollment token to join the Sexual Behaviour and Customs Among Sentient Species Lecture";
	[]
	if BehaviourandCustoms > 0 and BehaviourandCustoms < 99:
		choose a blank row in table of fucking options;
		now title entry is "Get current directions to the Behaviour and Customs Lecture";
		now sortorder entry is 4;
		now description entry is "Listen to a Sexual Behaviour and Customs Among Sentient Species Lecture";
	[]
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if player consents:
				...
				if (nam is "Get current directions to the Anatomy Lecture"):
					say "[AnatomyLectures]";
				if (nam is "Enroll in the Behaviour and Customs Lecture"):
					say "[BehaviourLecturesEnrollment]";
				if (nam is "Get current directions to the Behaviour and Customs Lecture"):
					say "[BehaviourLectures]";
...
to say BehaviourLectures:
	if BehaviourandCustoms is 1:
		say "[BehaviourLectureOne]";
	else if BehaviourandCustoms is 2:
		say "[BehaviourLectureTwo]";
	else if BehaviourandCustoms is 3:
		say "[BehaviourLectureThree]";
	else if BehaviourandCustoms is 4:
		say "[BehaviourLectureFour]";
	else if BehaviourandCustoms is 5:
		say "[BehaviourLectureFive]";
...
to say BehaviourLecturesEnrollment:
	say "     <WORK IN PROGRESS. Sorry>";

to say BehaviourLectureOne:
	say "     <WORK IN PROGRESS. Sorry>";
