...
to AWolfsInvitationEvent: [Room invitation from Julian]
	...
	if player consents: [Stay]
		...
		say "     Apologising that you have places to be, you leave the wolf dejected on the bench and return to the path. You don't think that he'll be doing that again.";
