Version 1 of Sidney by Prometheus begins here.
[ Originally by Stripes]
[ Version 1.1 - Pregnancy and children ]
[ Version 1.2 - Minor maintenance and character relocation - Luneth ]
[ Version 1.3 - Stat Block Update and move to Prometheus's folder in preparation for commissioned content - Prometheus ]
...
Sidney is a woman.
ScaleValue of Sidney is 3. [human sized]
SleepRhythm of Sidney is 0. [0 - awake at all times, 1 - day active, 2 - night active]
Body Weight of Sidney is 5. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Sidney is 5. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
[Body Adjective is generated out of the body weight and body definition and can be used in scenes - one word descriptive adjective depending on weight and definition groups: low weight group: skinny/slender/lithe; mid weight group: average/fit/muscled; high weight group: pudgy/husky/jacked]
Androginity of Sidney is 8. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Sidney is 5. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Sidney is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Sidney is 5. [length in inches]
Breast Size of Sidney is 0. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Sidney is 2. [count of nipples]
Asshole Depth of Sidney is 8. [inches deep for anal fucking]
Asshole Tightness of Sidney is 2. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Sidney is 0. [number of cocks]
Cock Girth of Sidney is 0. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Sidney is 0. [Length in Inches]
Ball Count of Sidney is 0. [allowed numbers: 1 (uniball), 2 or 4]
Ball Size of Sidney is 0. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
Cunt Count of Sidney is 1. [number of cunts]
Cunt Depth of Sidney is 6. [penetratable length in inches; some minor stretching allowed, or more with Twisted Capacity]
Cunt Tightness of Sidney is 2. [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
Clit Size of Sidney is 3. [size 1-5, very small/small/average/large/very large]
[Basic Interaction states as of game start]
PlayerMet of Sidney is false.
PlayerRomanced of Sidney is false.
PlayerFriended of Sidney is false.
PlayerControlled of Sidney is false.
PlayerFucked of Sidney is false.
OralVirgin of Sidney is true.
Virgin of Sidney is true.
AnalVirgin of Sidney is true.
PenileVirgin of Sidney is true.
SexuallyExperienced of Sidney is false.
TwistedCapacity of Sidney is false. [Twisted Characters can take any penetration, no matter the size]
Sterile of Sidney is false. [steriles can't knock people up]
MainInfection of Sidney is "".
...
to say sidney_rfv_cap:
	...
	if Playernum >= monsternum:
		...
		now Body Weight of Sidney is 4;
		now Body Definition of Sidney is 4;
		now Mouth Length of Sidney is 6;
		now Mouth Circumference of Sidney is 4;
		now Tongue Length of Sidney is 6;
		now Breast Size of Sidney is 4;
		now Cunt Depth of Sidney is 8;
		now MainInfection of Sidney is "Red Fox";
	...
	if Player consents:
		...
		if bonus + dice >= targetnum:
			...
			if Player consents:
				...
				now Body Weight of Sidney is 3;
				now Body Definition of Sidney is 5;
				now Mouth Length of Sidney is 5;
				now Tongue Length of Sidney is 5;
				now Breast Size of Sidney is 2;
				now Asshole Depth of Sidney is 12;
				now Cunt Depth of Sidney is 12;
				now MainInfection of Sidney is "Sea Otter";
				move Sidney to Breakroom;
				move player to Breakroom;
...
to say sidney_wusky_cap:
	...
	if fightoutcome >= 10 and fightoutcome <= 19:
		...
		now Mouth Circumference of Sidney is 4;
		now Tongue Length of Sidney is 6;
		now Breast Size of Sidney is 1;
		now Nipple Count of Sidney is 6;
		now Cunt Depth of Sidney is 8;
		now MainInfection of Sidney is "Feral Wolf Bitch";
		move Sidney to Breakroom;
		move player to Breakroom;
...
after navigating Grey Abbey Library while ( HP of Sidney >= 6 and Sidney is booked and lastfuck of Sidney > turns ) and ( Fang is booked and (HP of Fang is 2 or HP of Fang is 3 or HP of Fang is 4) and Fang is Male and lastfuck of Fang > turns ) and fangsidney is false:
	...
	if Player consents:
		...
		say "     'That was... something else...' she says with a bit of a forced laugh. 'Definitely a [']new experience['],' she adds. She makes her way slowly back towards the breakroom, trailing drops of wolfcum as she goes.";
	else:
