...
"Draco-Mantis Male"	"[PrepCombat_Draco-Mantis Male]"

to say PrepCombat_Draco-Mantis Male:
	say "";
...
When Play begins:
	...
	now Species Name entry is "Draco-Mantis"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now MilkItem entry is "draco-mantis male milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "draco-mantis male cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
Table of CombatPrep (continued)
name(text)	PrepFunction(text)
"Draco-Mantis Female"	"[PrepCombat_Draco-Mantis Female]"

to say PrepCombat_Draco-Mantis Female:
	say "";
...
When Play begins:
	...
	now Cunt Depth entry is 12; [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
	now Cunt Tightness entry is 2; [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
	now SeductionImmune entry is false;
	now libido entry is 45; [ Target libido the infection will rise towards. ]
	now loot entry is ""; [ Dropped item, blank for none. Case sensitive. ]
	now lootchance entry is 0; [ Percentage chance of dropping loot, from 0-100. ]
	now MilkItem entry is "draco-mantis female milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "draco-mantis female cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	now TrophyFunction entry is "-"; [ Function to generate a list of optional loot items, of which the player can choose one after victory. ]
	now scale entry is 3; [ Number 1-5, approx size/height of infected PC body: 1=tiny, 3=avg, 5=huge ]
	now body descriptor entry is "[one of]angular[or]sleek[or]armored[at random]";
	now type entry is "[one of]insectoid[or]Draco-Mantis[at random]"; [ one-word creature type. Ex: feline, canine, lupine, robotic, human... Use [one of] to vary ]
...
Table of CombatPrep (continued)
name(text)	PrepFunction(text)
"Draco-Mantis Herm"	"[PrepCombat_Draco-Mantis Herm]"

to say PrepCombat_Draco-Mantis Herm:
	say "";
...
When Play begins:
	...
	now loot entry is ""; [ Dropped item, blank for none. Case sensitive. ]
	now lootchance entry is 0; [ Percentage chance of dropping loot, from 0-100. ]
	now MilkItem entry is "draco-mantis herm milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "draco-mantis herm cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	now TrophyFunction entry is "-"; [ Function to generate a list of optional loot items, of which the player can choose one after victory. ]
	now scale entry is 3; [ Number 1-5, approx size/height of infected PC body: 1=tiny, 3=avg, 5=huge ]
	now body descriptor entry is "[one of]angular[or]sleek[or]armored[at random]";
	now type entry is "[one of]insectoid[or]Draco-Mantis[at random]"; [ one-word creature type. Ex: feline, canine, lupine, robotic, human... Use [one of] to vary ]
