	...
	if tailname of player is not "Magic Drake":
		...
		if the remainder after dividing mdmaxlossscene by 3 is 1:
			...
			if HP of player > 0:	[submitted]
				...
				WaitLineBreak;
				say "     After stuffing your insides with her gooey cum, she pulls out of you with a slurping pop. Striding around to your front, she brings her sticky and still leaking shaft to your lips. Like a good pet, you do your best to lick and suck at it[if scalevalue of player < 3] even if you're unable to swallow any more as her cum still drools from your mouth[else if scalevalue of player < 5] even though there's no room left in your belly for the cum you try to swallow[else], barely managing to swallow down a few more mouthfuls of cum into your already overstuffed belly[end if]. The dragoness seems quite pleased with herself and you can't help but be pleased by this. 'Mmm... I'll leave that all [']soak in['],' she says with a rumbling purr. 'If you keep being a good slut like that, you'll be properly ready to be my familiar very soon. Won't that be lovely?' She caresses your overstuffed, leaking butt and fingers your gooey hole, sending shivers of delight through you, making you long a little more to be a good pet for her.";
				increase mdrakeanal by 1;
