...
to say mdrake_bigger_better:
	if mdmaxlossscene > 1: [used to reset the value from previous builds, and to cycle the two scenes.]
	...
	if mdmaxlossscene is 0:
		...
		WaitLineBreak;
		say "     As you lay there, restrained by the incredible weight of your rear, the drake conjures up several more koballoons, and augmenting them just the same as the previous one. You shiver in anticipation as you watch her, eager to be stuffed fuller and fuller. After what feels like far too much time, she releases them, and they immediately begin furiously fucking you, pumping up your ass with more of their magical liquid. As each one finishes and unleashes their enchanted loads, the drake forces them inside, inflating your cheeks even more, while also clearing the way for the next rubber creature. Finally the last koballoon is gone, just another part of your immense cushion, leaving you alone with the drake once again. 'Oh, that worked almost perfectly! You're absolutely magnificent like this, even better than before.' She pauses, and caresses your soft, jiggling flesh, causing you to moan uncontrollably. 'I think I'll let you stay like this for a while, and we'll see how well it keeps. If you don't stay so deliciously oversized, then we'll just have to try again, and that's almost as much fun as seeing you like this.'";
...
[		if Player is female:
		...
		if Player is female and ( Cunt Length of Player > 30 or Cunt Tightness of Player > 18 ):
			choose a blank row in table of fucking options;
						...
						if x is 1:
							...
							if mdstaffaction <= 4:		[ass adjustments]
								...
								if cockname of Player is not "Magic Drake":
									...
									say "     The magic does end up working though, seeping into you with a pleasant tingle that suffuses your transformed testicles. They swell up a little larger, growing until they become a [short ball size] pair of draconic balls. You try to keep going, but the pleasure of this sends you over the edge, moaning loudly. The remaining magical energy gets funneled into your climax and you splatter a considerably larger-than-normal mess of fresh seed onto the ground. Despite being upset with you for using her magic yourself, the sorceress certainly seems pleased with the outcome, at least.";
