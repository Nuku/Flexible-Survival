...
mdrakeover-sized is a number that varies.		[times over-sized own ass]
...
to say magicdrakedesc:
	...
	if debugactive is 1:
		say "DEBUG -> mdasslevel: [mdasslevel], mdrakeloss: [mdrakeloss], mdrakebeaten: [mdrakebeaten], mdrakeover-sized: [mdrakeover-sized], mdrakeanal: [mdrakeanal], mdstaffface: [if mdstaffface is true]Y[else]N[end if] <- DEBUG[line break]";
	if mdasslevel is 0:
...
to say losetomagicdrake:
	...
	if tailname of player is not "Magic Drake":
		...
		say "     As she starts to rock herself overtop of you, your head ends up wedged between her ass and ballsack, the musky scent of the shemale making your already oxygen-deprived brain all the more foggy and muddled. The comes an odd tickle at your back door as something flicks against it a few times, followed by a more firm prodding. As it pushes its way into you, stretching your tight hole open, the way it wriggles brings the realization that its her tail squirming into you to stretch you open. Despite, or perhaps even because of, your helpless situation, you start to grow aroused and moan[if anallevel is 3 or ( anallevel is 2 and the player is submissive)]. With her tight tail-hole before you and a growing lust overtaking you, you start licking at her puckered hole[end if].";
		...
		if the remainder after dividing mdmaxlossscene by 3 is 1:
			say "     'Now, this is just how I like [']em,' the dragoness rumbles as she gropes your ultra-plump ass. 'Mmm... you look good enough to fuck.' And with that, she pushes you over, yanks your tail into the air and slaps that huge pillar of meat across your back. At five feet in length and a foot across, you shudder at what that thing will do to you. Your enchanted ass though wiggles back as your tail-hole relaxes and readies itself of its own accord, as if sensing its mistress at the ready.";
...
to say mdstaff_overgrown:
	...
	if mdrakeanal >= 3 and player is not twistcapped:
		...
		say "     [bracket]You have gained the 'Twisted Capacity' feat and are now stretchy enough to take some astonishingly huge things inside you.[close bracket][line break]";
		add "Twisted Capacity" to feats of player;
	if mdrakeover-sized < 5 or inasituation is true:
		infect "Magic Drake";
	decrease humanity of player by a random number between 2 and 4;
	increase libido of player by a random number from 2 to 4;
	if "Strong Psyche" is listed in feats of player, increase humanity of player by 1;
