...
[		if cunts of player > 0:
		...
		if mdasslevel > 1:
			...
			if tailname of player is "Magic Drake":
				say "     Before you depart, you look over the drake's strange staff. The headpiece is still aglow with eldritch energy that's leaking from its phallic end. You might be able to use to adjust the size of that [if mdasslevel is 2]bubble-butt[else if mdasslevel is 3]plump[else if mdasslevel is 4]large[else if mdasslevel is 5]huge[otherwise]mega-booty[end if] ass she's given you";
				if mdasslevel < 6:
					choose a blank row in table of fucking options;
				...
				say "     Before you depart, you look over the drake's strange staff. The headpiece is still aglow with eldritch energy that's leaking from its phallic end. You feel an odd urge to use it to restore that [if mdasslevel is 2]bubble-butt[else if mdasslevel is 3]plump[else if mdasslevel is 4]large[else if mdasslevel is 5]huge[otherwise]mega-booty[end if] ass she'd given you";
				choose a blank row in table of fucking options;
						...
						if x is 1:
							...
							if mdstaffaction <= 4:		[ass adjustments]
								...
								if mdstaffaction is 1:
									...
									say "     This causes it to swell and inflate, rounding out further until it becomes [if mdasslevel is 3]sexily plump[else if mdasslevel is 4]quite large[else if mdasslevel is 5]rather huge[otherwise]titanically huge[end if]. Despite being upset with you for using her magic yourself, the sorceress certainly seems pleased with the outcome, at least.";
								else if mdstaffaction is 2:
									decrease mdasslevel by 1;
									say "     This comes with a drop in pressure on your hips as your bottom shrinks down. The angry dragoness growls impotently as it loses several inches in size, dropping down to a [if mdasslevel is 2]cute bubble-butt[else if mdasslevel is 3]plump rear[else if mdasslevel is 4]large ass[otherwise]huge bottom[end if] that feels a little more manageable for you to deal with.";
								else if mdstaffaction is 3:
									say "     This power makes your ass quiver and your spine throb. Within a few minutes, the reptilian ass and tail you had before have returned, [if mdasslevel is 2]round[else if mdasslevel is 3]plump[else if mdasslevel is 4]large[else if mdasslevel is 5]huge[otherwise]enormous[end if] and beautiful to the whistling dragoness.";
								else:
									say "[mdstaff_overgrown]";
							else if mdstaffaction <= 10:		[sexual growth/reduction]
								if cockname of player is not "Magic Drake":
									say "     The magic doesn't quite end up working as expected though, spraying all across your groin. It seeps into your crotch with a pleasant tingle that suffuses your [if cocks of player > 0 and cunts of player > 0]cock[smn] and cunt[sfn][else if cocks of player > 0]cock[smn][otherwise]cunt[sfn][end if]. The magical energy clings to your sensitive loins and sinks right into them, causing them to shift and change[if cocks of player > 0 and cunts of player > 0]. The flesh of your loins changes and your manhood and your pussy lips are transformed[else if cocks of player > 0]. The flesh of your loins changes and your manhood is transformed[otherwise]. The flesh of your loins changes and your pussy lips are transformed[end if], taking on a rich, green hue as you become infected, much to the dragoness's amused delight.";
									choose row monster from the table of random critters;
