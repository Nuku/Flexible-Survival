...
to say hdmale_sex04:
	...
	WaitLineBreak;
	if anallevel is 3 or ( cocks of player is 0 and cunts of player is 0 ):
	...
	if cunts of player > 0 and cocks of player > 0:
		...
		say "     Largely dropping the pretense of an exam, he throws himself into stuffing your dripping cunny with one hand and [if breast size of player > 0]groping one of your breasts[otherwise]grabbing your ass[end if] with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon soaking your crotch with your feminine juices as your vagina quivers around his thrusting digits. Your [cunt size desc of player] cunt gushes with juices as you climax. Grabbing his stiff canine dong, he pumps it quickly, splattering a gooey mess of his own seed onto you, making you all the stickier";
	else if cocks of player > 0 and anallevel is 3:
		say "     Largely dropping the pretense of an exam, he throws himself into stroking your [cock of player] cock with one hand and pumping a few fingers into your asshole with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon feeling your [ball size] tighten up even as your anus clutches around his thrusting digits. Your [cock size desc of player] penis throbs in the canine doctor's paw as he watches[if cock width of player < 24], stunned and impressed by[else if cock width of player > 15], definitely impressed by[else if cock width of player > 10], seemingly pleased by[else if cock width of player > 5] with mild disapproval at[otherwise], clearly disappointed with[end if] your [cum load size of player] output. Grabbing his stiff canine dong, he pumps it quickly, splattering a gooey mess of his own seed onto you, making you all the stickier";
	else if cocks of player > 0:
		say "     Largely dropping the pretense of an exam, he throws himself into stroking your [cock of player] cock with one hand and [if breast size of player > 0]groping one of your breasts[otherwise]grabbing your ass[end if] with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon feeling your [ball size] tighten up. Your [cock size desc of player] penis throbs in the canine doctor's paw as he watches[if cock width of player < 24], stunned and impressed by[else if cock width of player > 15], definitely impressed by[else if cock width of player > 10], seemingly pleased by[else if cock width of player > 5] with mild disapproval at[otherwise], clearly disappointed with[end if] your [cum load size of player] output. Grabbing his stiff canine dong, he pumps it quickly, splattering a gooey mess of his own seed onto you, making you all the stickier";
	else if anallevel is 3:
		say "     Largely dropping the pretense of an exam, he throws himself into pumping a few fingers into your asshole with one hand and [if breast size of player > 0]groping one of your breasts[otherwise]grabbing your ass[end if] with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon feeling your [bodydesc of player] body quivering in undirected release even as your anus clutches around his thrusting digits. Clearly disappointed by your lack of genitals, he grabs his stiff canine dong, pumps it quickly and splatters a gooey mess of his own semen across your bare groin";
...
to say hdfemale_sex04:
	...
	if cocks of player > 0:
		say "     Taking [if cocks of player > 1]one of your cocks[otherwise]your cock[end if] in paw, she strokes and over it. Already quite hard from all the teasing, she sizes you up even as she jerks you off[if cock length of player > 20]. She seems quite impressed with[else if cock length of player > 10]. She seems rather pleased with[else if cock length of player > 5]. She seems unimpressed with[otherwise]. She shakes her head and clucks her tongue at[end if] your [cock size desc of player] shaft[smn] and leans in to give [if cocks of player is 1]it[otherwise]them[end if] a quick lick and suck[if cockname of player is not listed in infections of Internallist]. While she does this, her paw moves to your ballsac, rolling around your [ball size] in her palm and appraising their heft[end if]. She gets you to the point of drooling precum, laps some up for a taste test and then moves on.";
	if cunts of player > 0:
		say "     Burying her nose between your thighs, she nuzzles at your pussy before giving it a quick lick. This is then followed by a pair of digits slipping their way into your vagina and rubbing along your inner walls[if cunt width of player > 12]. Eventually two fingers moves up to three and then four before she ends up fisting you to pound away at your gaping cunny. As she stuffs[else if cunt width of player > 8]. Eventually two fingers moves up to three and then four as she continues to pound away at your spacious cunny. As she fingerfucks[else if cunt width of player > 5]. Eventually two fingers moves up to three as she continues to pound away at your widened cunny. As she fingerfucks[otherwise]. As she fingerfucks[end if] your wet pussy, her other paw rubs across your outer folds, both teasing you and allowing her to examine your cunny in detail. There's something embarassingly exciting about her scrutiny, especially when her fingertips move to your clit and start playing with it. You're left dripping with juices by the time she's finished the gynecological exam.";
	WaitLineBreak;
	if cunts of player > 0 and cocks of player > 0:
		say "     Largely dropping the pretense of an exam, she throws herself into stuffing your dripping cunny with one hand and pumping your [cock of player] cock with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon soaking your crotch with your feminine juices as your [ball size] tighten up. Your [cock size desc of player] penis throbs in the canine doctor's paw as she watches[if cock width of player < 24], stunned and impressed by[else if cock width of player > 15], definitely impressed by[else if cock width of player > 10], seemingly pleased by[else if cock width of player > 5] with mild disapproval at[otherwise], clearly disappointed with[end if] your [cum load size of player] output. Stuffing a few fingers into her own cunny, she works herself up to a barking climax and wipes her stick fingers off onto you";
	else if cunts of player > 0 and anallevel is 3:
		...
		say "     Largely dropping the pretense of an exam, she throws herself into stuffing your dripping cunny with one hand and [if breast size of player > 0]groping one of your breasts[otherwise]grabbing your ass[end if] with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon soaking your crotch with your feminine juices as your vagina quivers around her thrusting digits. Your [cunt size desc of player] cunt gushes with juices as you climax. Stuffing a few fingers into her own cunny, she works herself up to a barking climax and wipes her stick fingers off onto you";
	else if cocks of player > 0 and anallevel is 3:
		say "     Largely dropping the pretense of an exam, she throws herself into stroking your [cock of player] cock with one hand and pumping a few fingers into your asshole with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon feeling your [ball size] tighten up even as your anus clutches around her thrusting digits. Your [cock size desc of player] penis throbs in the canine doctor's paw as she watches[if cock width of player < 24], stunned and impressed by[else if cock width of player > 15], definitely impressed by[else if cock width of player > 10], seemingly pleased by[else if cock width of player > 5] with mild disapproval at[otherwise], clearly disappointed with[end if] your [cum load size of player] output. Stuffing a few fingers into her own cunny, she works herself up to a barking climax and wipes her stick fingers off onto you";
	else if cocks of player > 0:
		say "     Largely dropping the pretense of an exam, she throws herself into stroking your [cock of player] cock with one hand and [if breast size of player > 0]groping one of your breasts[otherwise]grabbing your ass[end if] with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon feeling your [ball size] tighten up. Your [cock size desc of player] penis throbs in the canine doctor's paw as she watches[if cock width of player < 24], stunned and impressed by[else if cock width of player > 15], definitely impressed by[else if cock width of player > 10], seemingly pleased by[else if cock width of player > 5] with mild disapproval at[otherwise], clearly disappointed with[end if] your [cum load size of player] output. Stuffing a few fingers into her own cunny, she works herself up to a barking climax and wipes her stick fingers off onto you";
	else if anallevel is 3:
		...
		if humanity of player is less than 10:
			...
			if hospquest > 13:
				...
				if "Expert Medic" is listed in feats of player:
					say "     Once you're cleared, you travel to a small town and establish a private practice. At first, the residents are a little leery of the transformed doctor, but you gradually become accepted after a few residents come see you for their ailments rather than travelling to the city. As word gets around that you're a good doctor, the town starts to accept you and your practice blossoms. And once you've earned their trust, then you start to gradually and secretly infect your patients[if cocks of player > 0 or cunts of player > 0]. With some you have to slip some of your sexual fluids into their treatment, though others you get to fuck outright in your examination room[otherwise]. With most you have to slip some of your nanites into their treatment, though with a few you're able to entice into oral sex in your examination room[end if]. By the time people are starting to show outward signs, almost everyone's been infected, either directly or indirectly by you, and the whole town becomes populated by horny dog patients, eager for [']treatment['] by their favorite doctor.";
				else:
