Version 1 of Fennec For FS by Stripes begins here.

"Adds a Fennec creature to Flexible Survivals Wandering Monsters table"
...
to say losetofennec:
	...
	if cocks of player > 0 and cunts of player > 0:
		...
		if a random chance of 5 in 7 succeeds:
			say "[fennecvag]";
		otherwise if a random chance of 3 in 5 succeeds and scalevalue of player < 4:
			say "[fennec69]";
		otherwise:
			say "[fennecoral]";
...
to say beatthefennec:
	if libido of player > 25:
		...
		otherwise if cunts of player > 0:
			say ".  Spotting his stiff cock, shall you ride that rod (Y) or let him go (N)?";
			if the player consents:
				say "[fennecvicsex1]";
			otherwise:
				say "     Deciding you'd rather find relief elsewhere than from this random fox, you give him a hard push with your foot and send him scrambling away with a yip.";
...
to say fennecvicsex2:
	...
	otherwise if cock length of player < 16:
...
When Play begins:
	...
	now loot entry is "fennec cum";	[ Dropped item, blank for none.  Case sensitive. ]
...
"fennec semen"	"Why were you haning onto this exactly?"	1	fennec semen

fennec semen is a grab object. It is a part of the player. fennec semen is infectious. The strain of fennec semen is "Fennec".
