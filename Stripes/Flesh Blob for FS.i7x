...
to say losetofleshblob:
	...
	otherwise:
		...
		say "     As you're fucked by the mass of sexual delight beneath you, you lick at the cunts, suck on the cocks and nurse from the breasts that form within your reach.  Your hands grope, stroke, pinch and finger whatever they can find from moment to moment.  You lose yourself in the rampant lust, eagerly getting screwed by the strange creature you would otherwise find disturbing.  Several moans and whimpers of ecstacy come from the flesh blob, joining with your own cries of delight until finally it is driven to orgasm.  The cock stuffed inside you continues to change shape and size, cumming over and over again until your belly is bloated and semen overflows from your creamy asshole.[mimpregchance]";
...
[	say "Lvl is [qq].  Variable is [zz].";
	...
	say "     You find yourself being confronted by an oozing, undulating mass of flesh.  It has near-white skin over its shifting mass, probably from its underground existence.  It is a mound of pallid flesh roughly [if lev entry is 5]five[otherwise if lev entry is 6]six[otherwise if lev entry is 7]seven[otherwise if lev entry is 8]eight[otherwise]ten[end if] in diameter that continuously forms disturbing bulges across its surface.  Hands and arms, feet and legs, rise up at times, only to sink back into the mass of flesh.  Eyes form in random places across itself, staring at you before closing and fading back into it.  Transitory cocks, cunts and breasts are also quite common across the creature's body.";
...
When Play begins:
	...
	now face change entry is "it grows soft and malleable, your skull turning to cartilege.  You groan as your head shifts and restructures itself.  You are momentarily relieved when you feel it returning to a human shape, but it doesn't quite seem to finish.  While all the main features are there, they're also indistinct and malleable.  It is as if your face were made of wax or plastic that's been melted a little and is still soft"; 
...
when play ends:
	if bodyname of player is "Flesh Blob":
		if humanity of player is less than 10:
			...
			otherwise:
				say "     Over time, your thoughts become confused and you feel a longing inside your malleable body.  Following it, you end up descending into the depths beneath Trevor Labs.  There you encounter a blob creature made of shifting flesh.  You press yourself to it and rub your sensitive flesh against its.  Over time as you continue having sex with it, your body grows softly and eventually starts to flow into the creature, joining your flesh to its until your absorbed away.  All that remains of you are faint traces of your mind, having been consumed by its great hunger and lust for the pleasures of the flesh.";
		otherwise:
