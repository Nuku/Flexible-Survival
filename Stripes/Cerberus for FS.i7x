...
to say beatthecerberus:
	...
	otherwise if a random number between 25 and 125 < libido of player:
		say ".  You find yourself oddly attracted to the lustful herm beast and the many possibilities for enjoyment hir body offers.  Shall you satisfy your lusts on hir wondrous body?";
