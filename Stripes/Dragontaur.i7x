...
to say losetodragontaur:
	if HP of Sam is 15:
		...
		if Player is female or ( anallevel > 1 and a random chance of 2 in 3 succeeds ):
			...
			CreatureSexAftermath "Player" receives "OralCock" from "Dragontaur";
...
"Dragontaur"	"[PrepCombat_Dragontaur]"

to say PrepCombat_Dragontaur:
...
When Play begins:
	...
	now Species Name entry is "Dragontaur"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	add "Dragontaur" to infections of InternalBallsList;
	...
	now MilkItem entry is "dragontaur milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "dragontaur cum"; [ Item to be given to the player if they have this infection and jerk off. ]
