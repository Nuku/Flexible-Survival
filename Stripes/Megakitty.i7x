...
to say losetomegakitty:
	...
	if the remainder after dividing MKloss by 3 is 0 and anallevel > 1:
		say "     [if HP of Player > 0]Giving up, you are grabbed by the massive feline and smooshed against her chest. 'See. You'll see it's much better when you listen to your Big Momma like a good kitten,' she purrs[else]Crumpling under the assault of the massive feline, you are left weak and panting on the ground. 'See. There is no point in fighting with your Big Momma. And now it's time for you to be punished for being such a troublesome kitten,' she rumbles, grabbing you in her strong paws[end if]. Pressing your face to her super-sized pussy, she mrowls and grinds against you until you start licking at it. Setting aside her giant sextoy for a moment, she grabs you by both shoulders and drives your head forcibly right between her juicy petals. Her spacious cunny grips around you and starts tugging you further in [if HP of Player > 0]once again[else]despite your feeble attempts to resist[end if].";
		...
		say "     [if HP of Player > 0]Giving up, you are grabbed by the massive feline and smooshed against her chest. 'See. You'll see it's much better when you listen to your Big Momma like a good kitten,' she purrs[else]Crumpling under the assault of the massive feline, you are left weak and panting on the ground. 'See. There is no point in fighting with your Big Momma. And now it's time for you to be punished for being such a troublesome kitten,' she rumbles, grabbing you in her strong paws[end if]. You are pushed so your face is wedged between her thighs and pressed right up to her sopping pussy. The scent of it is strong and alluring and you start licking at it. As you do, she places the femcum-slick sextoy into position in front of you.";
		...
		say "     [if HP of Player > 0]Giving up, you are grabbed by the massive feline and smooshed against her chest. 'See. You'll see it's much better when you listen to your Big Momma like a good kitten,' she purrs[else]Crumpling under the assault of the massive feline, you are left weak and panting on the ground. 'See. There is no point in fighting with your Big Momma. And now it's time for you to be punished for being such a troublesome kitten,' she rumbles, grabbing you in her strong paws[end if]. Pressing the still femcum-covered sextoy against your chest, she presses its smooth tip to your face and orders you to start licking it. [if HP of Player > 0]Having submitted to the big kitty, you do as you are instructed and start licking at the toy. The taste of her juices is quite arousing and soon you're going at it with a lustful eagerness[else]Rather than raise her ire further, you relent and start licking at the toy. The taste of her juices is quite arousing and soon you're doing it quite voluntarily[end if].";
...
When Play begins:
	...
	now Species Name entry is "Megakitty"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Megakitty" to infections of FelineList;
	add "Megakitty" to infections of FurryList;
	add "Megakitty" to infections of NatureList;
	add "Megakitty" to infections of FemaleList;
	add "Megakitty" to infections of BarbedCockList;
	add "Megakitty" to infections of SheathedCockList;
	add "Megakitty" to infections of BipedalList;
	add "Megakitty" to infections of TailList;
	now Name entry is "Megakitty";
	...
	now MilkItem entry is "megakitty milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "megakitty cum"; [ Item to be given to the player if they have this infection and jerk off. ]
