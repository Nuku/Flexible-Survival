...
to say losetolatexermine:
	...
	say "     [if HP of Player > 0]Pleased that you've finally relented, she pulls you into a kiss[else]Eventually, the temptation she represents become too much for you and you stop resisting. She pulls you into a kiss with a happy giggle[end if], pressing her soft, smooth body against yours. The latex female runs her hands over you, reaching back to grab your ass firmly and give it a squeeze while pushing her tongue into your mouth. You respond by sucking down on the slick intruder and groping her in return. Soon enough, you're rolling around on the ground together, fondling each other with growing lust.";
	if BodyName of Player is "Latex Ermine" and Player is pure and Player is not neuter:
		if Player is male:
			...
			say "     The pair of you go at it like the lustful mustelids that you are. Her slick, lubricating juices soak both your crotches as she cries out in orgasmic release. This makes her love tunnel quiver around your cock, driving you to plunge your [cock size desc of Player] shaft into her and unleash your [Cum Load Size of Player] load into her. Her [if Ball Size of Player > 6]cunt keeps a tight grip around your cock, ensuring that every last drop of your excessive output remains inside her rapidly swelling tummy. She moans and giggles happily, running her hands over her bulging belly as her latex skin stretches with ease to hold it all[else if Ball Size of Player > 5]cunt forms a tight seal around your cock, keeping every last drop of your large output inside her. She moans and giggles happily as her latex tummy forms a rounded bulge from all the cum you're shooting into her[else]pussy keeps a snug grip around your cock, not letting any of your seed escape from her needy body[end if]. When you're finally done mating the beautiful female, you share some more kisses and groping before finally each heading your own way.";
		else:
...
to say beatthelatexermine:
	if nolatexerminesex > 2 and the remainder after dividing nolatexerminesex by 5 is not 0:
		...
		say "[line break]     [bold type]Shall you have some fun with the latex lovely or send her packing?[roman type][line break]";
		...
		if Player consents:
			...
			if Player is male:
				if a random chance of 2 in 3 succeeds:
					...
					say " is wonderful.";
					if BodyName of Player is "Latex Ermine" and Player is pure:
						say "     The two of you go at it for quite some time, groping and fondling one another as your excitement builds. Finally, her slick, lubricating juices soak both your crotches as she cries out in orgasmic release. As she cums, her latex tunnel quivers around your shaft, driving you to push yourself fully into her and unleash your [Cum Load Size of Player] load. Her [if Ball Size of Player > 6]cunt keeps a tight seal around your cock, ensuring that every last drop of your excessive output remains inside her rapidly swelling tummy. She moans and giggles happily, running her hands over her bulging belly as her latex skin stretches with ease to hold it all[else if Ball Size of Player > 5]cunt forms a tight seal around your cock, keeping every last drop of your large output inside her. She moans and giggles happily as her latex tummy forms a rounded bulge from all the cum you're shooting into her[else]pussy keeps a snug grip around your cock, not letting any of your seed escape from her needy body[end if]. Having had your fun with the beautiful female, you share some more kisses and groping before finally letting her go.";
					else:
						say "     The two of you go at it for quite some time, groping and fondling one another as your excitement builds. Finally, her slick, lubricating juices soak both your crotches as she cries out in orgasmic release. As she cums, her latex tunnel quivers around your shaft, driving you to push yourself fully into her and unleash your [Cum Load Size of Player] load. Her [if Ball Size of Player > 6]cunt relaxes its grip around your [cock size desc of Player] cock, letting your excessive output flow out around your pulsing shaft. In the end, both your lower bodies are drenched by the copious contents of your huge balls[else if Ball Size of Player > 5]cunt relaxes its grip around your [cock size desc of Player] cock, letting your large output flow out around your pulsing shaft. In the end, both your groins are sticky with the considerable contents of your bloated balls[else]cunt relaxes its grip around your [cock size desc of Player] cock, letting your sticky load flow out around your pulsing shaft and run down her thighs[end if]. Having had your fun with the latex female, you pull out and let her up. You can see the glistening streaks of your cum running down her ivory thighs as she giggles and heads off.";
				else:
					...
					say "     The ivory beauty provides a wonderful blowjob, her latex mouth feeling so nice around your shaft that you have trouble holding out for long. You grit your teeth and try to resist, but soon groan in pleasure as you can't hold back any longer and blast your [Cum Load Size of Player] load down her throat. She happily gulps it all down, not letting a single drop go to waste[if Ball Size of Player > 6], her tummy bloating from your excessive output[else if Ball Size of Player > 5], her tummy visibly rounded by your considerable output[end if]. Only once your balls are drained does she release the vacuum grip her muzzle's been keeping on your shaft and lets it slide free. She licks her latex muzzle as she gets up and heads off with a happy giggle[if Ball Size of Player > 6], bloated tummy sloshing with swallowed cum[else if Ball Size of Player > 5], stuffed belly swishing with swallowed cum[end if].";
			else:
...
to say le_libidoup:
	if "Cold Fish" is listed in feats of Player:
		raise Player Libido by a random number between 0 and 3;
	else:
		raise Player Libido by a random number between 0 and 4;
...
to say PrepCombat_Latex Ermine:
	...
	if erminecolor is:
		-- 1: project the figure of LatexErmineBlue_icon;
		-- 2: project the figure of LatexErmineTeal_icon;
		-- 3: project the figure of LatexErmineGreen_icon;
		-- 4: project the figure of LatexErmineRed_icon;
		-- 5: project the figure of LatexErminePink_icon;
...
When Play begins:
	...
	now Species Name entry is "Latex Ermine"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now cock change entry is "it bubbles up with white latex that flows down over your cock. It seals seamlessly over your manhood and sinks into it, leaving you with a smooth dildo of living latex for a penis";
	...
	now MilkItem entry is "latex ermine milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "latex ermine cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	...
	if Player has a body of "Latex Ermine":
		...
		if humanity of Player < 10:
			if Player is pure:
				...
				if Player is male:
					say "     Your latex infection seeps too deeply into your mind and you lose yourself to it. Your thoughts fill with a desire for playful fun and sexual pleasure. You wander the city briefly, having a few flings with those who catch your fancy before eventually ending up in the high rise district. There you come across another sexy ermine. She's got the same indigo markings as yours and is very lovely. And she's quite smitten with you as well. Soon you're kissing, snuggling and giggling happily together while fornicating wildly[if Player is not sterile]. Your mate becomes quite pregnant from your repeated romps, which makes you all the happier[end if].";
				else if Player is female:
					say "     Your latex infection seeps too deeply into your mind and you lose yourself to it. Your thoughts fill with a desire for playful fun and sexual pleasure. You wander the city briefly, having a few flings with those who catch your fancy before eventually ending up in the high rise district. There you come across another sexy ermine. He's got the same indigo markings as yours and is quite pretty. And he's quite smitten with you as well. Soon you're kissing, snuggling and giggling happily together while fornicating wildly[if Player is not sterile]. You become quite pregnant from your repeated romps, which makes you and your mate all the happier[end if].";
				else:
					say "     Your latex infection seeps too deeply into your mind and you lose yourself to it. Your thoughts fill with a desire for playful fun and sexual pleasure. You wander the city briefly, having a few flings with those who catch your fancy before eventually ending up in the high rise district. There you get to know the other latex ermines very well - [']very well[']. You are happy to be playmates with any of them you come across. They're always so nice to you and willing to play despite your own lack of gender. While you never have a mate of your own, you're happy being there for all the others.";
				...
				if Player is female:
					say "     Your latex infection seeps too deeply into your mind and you lose yourself to it. Your thoughts fill with a desire for playful fun and sexual pleasure. You wander the city briefly, having a few flings with those who catch your fancy before eventually being beset by a trio of latex foxes. While not particularly threated by the three weak monsters, the prospect of being the recipient of the attention of three horny males is quite enticing. Allowing them to take you back to their lair, they fuck you repeatedly, pumping latex loads of gooey fox spunk into you. And while you originally intended to leave after the sex, their eagerness endears them to you and you end up staying for a little longer.";
					if SkinName of Player is "Latex Ermine":
						say "     That [']little longer['] never really seems to run out as you become content to stay with your three vulpine lovers. Over time, the indigo color of your hair and tailtip changes, becoming orange instead to match your lovers. You are more than satisfied sexually by them[if Player is impreg_ok], eventually becoming pregnant. You have no way of knowing which of them is the father, but it matters little. You bear these kits and many more for them over the years to come[else] and their eagerness[end if]. Between the three of them, at least one is always available for sex whenever desired.";
					else:
						say "     That [']little longer['] never really seems to run out as you become content to stay with your three vulpine lovers. Over time, your skin becomes orange latex like your vulpine lovers, but you remain an ermine. You are more than satisfied sexually by them[if Player is impreg_ok], eventually becoming pregnant. You have no way of knowing which of them is the father, but it matters little. You bear these kits and many more for them over the years to come[else] and their eagerness[end if]. Between the three of them, at least one is always available for sex whenever desired.";
				else if Player is male:
					say "     Your latex infection seeps too deeply into your mind and you lose yourself to it. Your thoughts fill with a desire for playful fun and sexual pleasure. You wander the city briefly, having a few flings with those who catch your fancy before eventually being taken by surprise by a human survivor.";
					...
					say "     Your latex infection seeps too deeply into your mind and you lose yourself to it. Your thoughts fill with a desire for playful fun and sexual pleasure. You wander the city briefly, having a few flings with those who catch your fancy before eventually getting captured by a lone soldier. He's quite impressed by your blowjob skills and eventually manages to smuggle you out of the city. You're secretly kept in his basement to provide him with sexual satisfaction whenever needed.";
		else:
			if Player is pure:
				if Breast Size of Player > 0:
					project the figure of LatexErmineIndigo_icon;
				if Player is female:
					say "     After being rescued by the military, you bounce around from job to job for a bit at first. Eventually though, you manage to get a bit part in a television show and that goes well. The director certainly remembers you thanks to the great blowjob you gave him after the shooting, and you're called back for another project. After a couple more of these, you're given a spot on a soap opera.";
