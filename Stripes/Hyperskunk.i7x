...
When Play begins:
	...
	now cock change entry is "becomes thick and meat as it pulses with arousal, shooting spurts of semen. As the changes subside, you can see that aside from its new, slate grey color, it looks rather like a normal, if thick, human dick";
