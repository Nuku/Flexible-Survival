...
When Play begins:
	...
	now Species Name entry is "Skunk"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Hyperskunk" to infections of FurryList;
	add "Hyperskunk" to infections of NatureList;
	add "Hyperskunk" to infections of HermList;
	add "Hyperskunk" to infections of BipedalList;
	add "Hyperskunk" to infections of TailList;
	add "Hyperskunk" to infections of TailweaponList;
	...
	now Cunt Depth entry is 30; [ Depth of female sex the infection will attempt to give a player. ]
	...
	now MilkItem entry is "hyperskunk milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "hyperskunk cum"; [ Item to be given to the player if they have this infection and jerk off. ]
