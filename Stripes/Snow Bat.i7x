...
to say losetosnowbat:
	if scalevalue of Player > 0 and ( Player is female or anallevel is 3 or Player is mpreg_ok ) and nightcheck is 4 and a random chance of 2 in 5 succeeds:
