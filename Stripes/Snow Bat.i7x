	...
	if scalevalue of player > 0 and ( player is female or anallevel is 3 or player is mpreg_ok ) and daytimer is night and a random chance of 2 in 5 succeeds:
		...
		if player is female:
			...
			if scalevalue of player > 3:
				say "His endeavor is clearly impeded by your disparate size, and he continues to feed himself for a while longer before he briefly relinquishes you, crawling down to treat you proper. You quickly feel his cock drive into [if cunts of player > 1]one of your cunts[else]your cunt[end if].";
			else:
