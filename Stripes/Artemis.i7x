...
to say ArtemisSexMenu:
	...
	now sortorder entry is 1;
	now description entry is "Make use of Artemis's elastic tail-hole.";
	[]
...
to say artemissf_sex:
	...
	if cocks of player > 0:
		...
		say "     Being a rubber tigress much like her new-found playmate, they know where to rub and grope to get each other worked up. You soon feel a pair of fingers sinking into your cunt while Artemis wraps her lips around one of those puffy nipples and suckles at it. This sends shivers of delight through your both [if artemisstatefairrt is false]as your bonded companion gives a long sigh of relief at being finally accepted by the others[else]as your bonded companion releases a moan of pleasure[end if]. You are both teased to a sticky climax that has hot juices running down your legs.";
