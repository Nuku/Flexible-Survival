...
[ HP of rubber tigress companion                                                ]
[ 0 = no encounter                                                              ]
[ 1 = fed once                                                                  ]
[ 2 = refused                                                                   ]
[ 3 = tamed                                                                     ]
...
[ lust of rubber tigress companion - vagina                                     ]
[ 0 = not placed                                                                ]
[ 1 = pussy                                                                     ]
[ 2 = mouth-pussy                                                               ]

[ thirst of rubber tigress companion - penis                                    ]
[ 0 = not placed                                                                ]
[ 1 = cock                                                                      ]
[ 2 = cock-tongue                                                               ]
[ 3 = tail-cock                                                                 ]

"Adds a neuter rubber tigress companion pet named Artemis."
...
to say ResolveEvent Poor Kitty:
	if HP of rubber tigress companion is 0:
		...
		if Player consents:
			...
			now HP of rubber tigress companion is 1;
		else:
			...
			now HP of rubber tigress companion is 2;
			now Resolution of Poor Kitty is 99; [Refused rubber kitty]
			now Poor Kitty is resolved;
	else if HP of rubber tigress companion is 1:
		...
		if Player consents:
			...
			now rubber tigress companion is tamed;
			add "Tamed" to Traits of rubber tigress companion;
			move Artemis to Courtyard;
			now HP of rubber tigress companion is 3;
			now Resolution of Poor Kitty is 2; [Artemis recruited]
			now Libido of rubber tigress companion is 30;
			say "     (Artemis the rubber tigress companion is now a possible ally!! You can make her your active ally by typing [bold type][link]ally Artemis[end link][roman type] or [bold type][link]ally rubber tigress[end link][roman type] and initiate sex with her while active by typing [bold type][link]fuck Artemis[end link][roman type]. You can see all the allies you have with the [bold type][link]allies[end link][roman type] command. Allies will lower the XP you gain from battle, but can gain levels themselves to be more useful in a scrap. Want to get rid of an ally? Use [bold type][link]ally dismiss[end link][roman type], or just [bold type][link]dismiss[end link][roman type])[line break]";
			now Poor Kitty is resolved;
		else:
		...
		say "ERROR-Artemis-[HP of rubber tigress companion]PK: HP outside of range for the event!";
		ItemGain cup stack by 1;
		now rubber tigress companion is tamed;
...
object	name
rubber tigress companion	"Rubber Tigress"
rubber tigress companion	"rubber tigress"
rubber tigress companion	"rubber tigress companion"

rubber tigress companion is a pet.
NPCObject of rubber tigress companion is Artemis.
understand "Artemis" as rubber tigress companion.
IDList of rubber tigress companion is { "Artemis", "artemis", "rubber tiger", "tigress", "Rubber Tigress", "rubber tigress", "rubber tigress companion"}.
printed name of rubber tigress companion is "Artemis".
Description of rubber tigress companion is "[ArtemisDesc]".
Weapon Damage of rubber tigress companion is 10.
The level of rubber tigress companion is 1.
Dexterity of rubber tigress companion is 15.
The summondesc of rubber tigress companion is "[SummonArtemis]".
The dismissdesc of rubber tigress companion is "[DismissArtemis]".
The assault of rubber tigress companion is "[ArtemisAttack]".
the fuckscene of rubber tigress companion is "[SexWithArtemis]".
...
instead of sniffing rubber tigress companion:
	say "[ArtemisScent]";
...
to say ArtemisDesc:
	if HP of rubber tigress companion < 11:
		...
		if lust of rubber tigress companion is 0 and thirst of rubber tigress companion is 1:
		...
		else if lust of rubber tigress companion is 0 and thirst of rubber tigress companion is 2:
		...
		else if lust of rubber tigress companion is 0 and thirst of rubber tigress companion is 3:
		...
		else if lust of rubber tigress companion is 1 and thirst of rubber tigress companion is 0:
		...
		else if lust of rubber tigress companion is 1 and thirst of rubber tigress companion is 1:
		...
		else if lust of rubber tigress companion is 1 and thirst of rubber tigress companion is 2:
		...
		else if lust of rubber tigress companion is 1 and thirst of rubber tigress companion is 3:
		...
		else if lust of rubber tigress companion is 2 and thirst of rubber tigress companion is 0:
		...
		else if lust of rubber tigress companion is 2 and thirst of rubber tigress companion is 1:
		...
		else if lust of rubber tigress companion is 2 and thirst of rubber tigress companion is 2:
			say "ERROR-Artemis-2L+2T-L: Impossible configuration.";
		else if lust of rubber tigress companion is 2 and thirst of rubber tigress companion is 3:
			...
			say "ERROR-Artemis-[lust of rubber tigress companion]L+[thirst of rubber tigress companion]T-L: Impossible configuration.";
	if HP of rubber tigress companion < 6:
	...
	if HP of rubber tigress companion >= 10 and ( lust of rubber tigress companion is 0 or thirst of rubber tigress companion is 0 ):
		LineBreak;
		say "     Having obtained the set of rubber toys for Artemis, you can now use them to modify her. You have [if lust of rubber tigress companion is 0 and thirst of rubber tigress companion is 0]both the feline cock dildo and the vagina toy[else if lust of rubber tigress companion is 0]the feline cock dildo[else]the vagina toy[end if] available. Shall you use [if lust of rubber tigress companion + thirst of rubber tigress companion is 0]them[else]it[end if] to alter your rubber tigress pet?";
...
to say ArtemisAttack:
	if lust of rubber tigress companion is 1 and a random chance of 1 in 4 succeeds:
	...
	else if thirst of rubber tigress companion is 1 and a random chance of 1 in 4 succeeds:
	...
	else if lust of rubber tigress companion is 2 and a random chance of 1 in 4 succeeds:
	...
	else if thirst of rubber tigress companion is 2 and a random chance of 1 in 4 succeeds:
	...
	else if thirst of rubber tigress companion is 3 and a random chance of 1 in 4 succeeds:
	...
	else if lust of rubber tigress companion is 2 or thirst of rubber tigress companion is 2:
...
instead of conversing rubber tigress companion:
	if rubber tigress companion is not tamed:
		say "     Who?";
	else:
		if Player is in Courtyard and Artemis is in Courtyard:
			say "[ArtemisTalkMenu]";
...
to say ArtemisSexMenu:
	...
	[]
	if lust of rubber tigress companion is 1:
		choose a blank row in table of fucking options;
...
An everyturn rule:
	if rubber tigress companion is listed in companionList of Player and skipturnblocker is 0:
		increase Libido of Player by 3;
		increase Libido of rubber tigress companion by 5;
		if lastfuck of rubber tigress companion - turns >= 4 and Player is not neuter:
			...
			if location of Player is State Fair and HP of rubber tigress companion > 7, now atStateFairbonus is 20;
			if diceroll < ( Libido of Player + Libido of rubber tigress companion + atStateFairbonus):
				...
				if HP of rubber tigress companion <= 10:
					if Player is male:
					...
					if HP of rubber tigress companion > 5:									[Engulf+masturbate]
						add 8 to artemissex;
						repeat with y running from 1 to glompchance:
							add 8 to artemissex;
					if HP of rubber tigress companion > 7:									[Engulf+sex]
					...
					if lust of rubber tigress companion is 2:
						...
						add 12 to artemissex; [pussy-mouth]
					else if thirst of rubber tigress companion is 2:
				...
				now lastfuck of rubber tigress companion is turns;
		if lastArtemisplay - turns >= 4 and lastfuck of rubber tigress companion is not turns:
	...
	else if rubber tigress companion is tamed:
		increase Libido of rubber tigress companion by 5;
		if Libido of rubber tigress companion > 100, now Libido of rubber tigress companion is 100;


Chapter 1 - Sexxxings Scenes

to say artemissex1:	[anal]
	say "     Your rubber tigress companion snuggles up beside you as you take a short break. She nuzzles at your hand, getting you to scritch her. As the scritching continues, Artemis slinks slowly forward, letting your hand rub down her back and eventually across her ass. As you scritch her bottom, she gives a needy mewl and wiggles her rear, tail raised with her sexy bottom on display. It takes you only a moment to realize what your kitty wants. Lacking a pussy of her own[if lust of rubber tigress companion is 2] back there[end if], she still has another hole you can fill.";
	say "     Moving in behind her, you press your stiffening member to her anus and easily spread open that rubbery ring. She mewls in pleasure, her soft, smooth flesh squeezing down around your [cock size desc of Player] [Cock of Player] shaft, milking at it as you fuck her[if thirst of rubber tigress companion is 1]. You reach around for her stiff manhood, stroking that sextoy cock of hers while you screw her in the ass[else if thirst of rubber tigress companion is 2]. You reach forward to her muzzle, scritching it until that sextoy cocktongue of hers emerges for you to stroke[else if thirst of rubber tigress companion is 3]. Running your hand from her ass along her tail, you reach her tail's tip and stroke it, coaxing the black-colored tip to draw back and reveal her tailcock for you to stroke[end if]. You pound away at the needy kitty, doing your best to satisfy her with a good, long fucking before finally cumming, depositing your sticky seed inside the kitty's rubber insides[if Ball Size of Player > 6], rounding her tummy and making her slosh as she moves for quite a while[else if Ball Size of Player > 5], making her slosh a little as she moves around for a while[end if][if thirst of rubber tigress companion > 0]. Even as you're filling her, you pump shot after shot of her lubricating cum from her spurting shaft[end if][if lust of rubber tigress companion is 2]. She stretches slowly and runs her tongue along the lips of her pussy-like muzzle, purring happily in pleasure[else if lastArtemisglomp >= 8 or HP of rubber tigress companion < 6]. She stretches slowly and gives a big yawn, giving you a good view of her smooth, rubber maw[end if].";
	now Libido of Player is ( 2 * Libido of Player ) / 3;
	now Libido of rubber tigress companion is Libido of rubber tigress companion / 3;
...
to say artemissex2:	[M-oral 1]
	...
	say ".";
	now Libido of Player is ( 2 * Libido of Player ) / 3;
	now Libido of rubber tigress companion is ( 2 * Libido of rubber tigress companion ) / 3;
	NPCSexAftermath Artemis receives "OralCock" from Player;

to say artemissex3:	[M-oral 2]
	say "     The rubber tigress nuzzles at your leg, sniffing softly along it as she makes her way to your crotch. She noses at it, licking her lips and mewling softly. With a grin, you rub her head and offer your [cock size desc of Player] [Cock of Player] cock to her. She plunges her muzzle forwards, stuffing it into her mouth[if Cock Length of Player > 9] and down her throat[end if]. She works her muzzle and tongue over your shaft with a lustful eagerness. You pet her head, telling her what a good kitty she is as the feline gives you a fine blowjob. When you finally blow, she eagerly laps up every spurt of your cum she can get[if Ball Size of Player > 6], stuffing her belly with your seed[else if Ball Size of Player > 5], feeding her your ample load[end if]";
	if lastArtemisglomp >= 8 or HP of rubber tigress companion < 6:
		if Ball Size of Player > 5:
			say ". After having been so well fed, she gives a sleepy yawn";
		else:
...
to say artemissex8:	[Engulf and masturbate]
	if location of Player is State Fair and HP of rubber tigress companion > 7 and ( artemisstatefairrt is false or a random chance of 2 in 3 succeeds ):
		say "[artemissex9]"; [Wants sex at State Fair most of the time]
	else if HP of rubber tigress companion > 10:
...
to say artemissex9:	[Engulf and sex]
	let stfairdone be 0;
	if HP of rubber tigress companion is 11:
		say "[artemissex8_mod]"; [first engulf post-mod goes to masturbation]
	else if location of Player is State Fair and HP of rubber tigress companion > 10:
		say "[artemissex9_SF_mod]"; [State Fair version w/modified Artemis]
	else if HP of rubber tigress companion > 11:
		...
		if location of Player is State Fair:
			...
			if lastfuck of rubber tigress companion - turns >= 24:
...
to say artemissex10:	[vagina]
	if Player is male and a random chance of 2 in 3 succeeds:
		...
		if a random chance of 1 in 3 succeeds and thirst of rubber tigress companion is not 0:
			say "[if thirst of rubber tigress companion is 1]. You reach around for her stiff manhood, stroking that sextoy cock of hers while you screw her in the ass[else if thirst of rubber tigress companion is 2][one of]. You reach forward to her muzzle, scritching it until that sextoy cocktongue of hers emerges for you to stroke[or]. Leaning overtop of her, you turn her head towards yours, pulling her into a kiss that soon has her sextoy tongue buried in your mouth[at random][else if thirst of rubber tigress companion is 3][one of]. Running your hand from her ass along her tail, you reach her tail's tip and stroke it, coaxing the black-colored tip to draw back and reveal her tailcock for you to stroke[or]. Pulling her tail to your mouth, you lick and kiss at its tip, coaxing the ebon dildo hidden within to be reveals for you to suck on while fucking her[at random][end if]";
		say ".";
		...
		now Libido of Player is ( 2 * Libido of Player ) / 3;
		now Libido of rubber tigress companion is Libido of rubber tigress companion / 4;
...
to say artemissex12:	[pussy-mouth]
	if Player is male and a random chance of 2 in 3 succeeds:
		...
		if thirst of rubber tigress companion is 3 and a random chance of 1 in 3 succeeds:
			...
			if Player is female:
				NPCSexAftermath Player receives "PussyDildoFuck" from Artemis;
			else:
				NPCSexAftermath Player receives "AssDildoFuck" from Artemis;
...
to say artemisplay1:	[chase cup]
	say "     Artemis comes up to you and mewls softly. She nuzzles at your pack and runs her tongue across her muzzle. Figuring she wants another tasty cup, you pull one out, much to her delight. She purrs happily and weaves around your legs, mewling and purring like a kitty eager to get a treat. You scritch her ears and roll it across the ground. She chases after it, batting it around with her paws before finally pouncing it[if lust of rubber tigress companion is 2]. She rubs her pussy muzzle against it, her altered tongue licking away whole chunks of the cup until it's gone[else if thirst of rubber tigress companion is 2]. She drools precum from her altered tongue onto it, then starts licking away whole chunks of the cup until it's gone[else] and gobbling it down[end if].";

to say artemisplay2:	[slurp cup]
	say "     Deciding your good kitty deserves a treat, you pull out one of the red plastic cups. Hearing the crinkle of it, her ears perk up and she comes bounding over to you, mewling for her treat. You scritch her ears and set it down for her. She runs her [if lust of rubber tigress companion is 2]textured [else if thirst of rubber tigress companion is 2]phallic[end if]tongue slowly along the rim, melting the edge of the cup[if lust of rubber tigress companion is 2] with her juices[else if thirst of rubber tigress companion is 2] with her pre[end if]. She then leans in and seems to almost slurp up the cup, inhaling the flowing red and white plastic as the cup gradually melts down. She smiles up at you, licking her muzzle [if lust of rubber tigress companion is 2 or thirst of rubber tigress companion is 2] with that kinky tongue of hers[end if] as the last of the sticky goo slides down her throat.";

to say artemisplay3:	[juggle cup]
	say "     Artemis comes up to you and mewls softly. She nuzzles at your pack and runs her tongue across her muzzle. Figuring she wants another tasty cup, you pull one out, much to her delight. She purrs happily and weaves around your legs, mewling and purring like a kitty eager to get a treat. You scritch her ears and roll it across the ground. She chases after it, batting it around with her paws before knocking it into the air so she can juggle and bat at it with her paws. Finally getting a grip on it, she eats up the cup [if lust of rubber tigress companion is 2 or thirst of rubber tigress companion is 2]by shoving it into her altered maw to[else]in three fast bites that[end if] consume the red plastic in gooey mouthfuls.";

to say artemisplay4:	[string cup]
	say "     Deciding to have some fun with your overgrown kitty, you pull out one of the plastic cups. Hearing the sound of it coming out, her rubber ears perk up and she comes bounding over, mewling for her treat. When you don't give it right away, she resorts to rolling onto her tummy to look extra cute. It's not until you've tied and knotted some string through a hole you punch in the bottom of it that you put it down. You start dragging the cup across the ground by the string, making a toy for her to bat and chase. She has lots of fun swatting it around and pouncing at it, only eating the cup once you've both tired of the game[if lust of rubber tigress companion is 2 and lastArtemisglomp >= 8]. She makes a show of licking the last few streaks of red from her pussy-muzzle before grooming her paws as well. She comes over to you, purring happily as she nuzzles against your thigh, clearly pleased to have gotten some playtime. You can't help but feel a little cheered up for having played with her a little[else if lastArtemisglomp >= 8 or HP of rubber tigress companion < 6]. After finishing it off, she gives a very wide yawn and licks her paws clean. You can't help but yawn as well, though you feel happier for having taken the time to play with her a little[else]. After having finished it off, Artemis comes over to you, purring happily as she nuzzles against your thigh, clearly pleased to have gotten some playtime. After getting some head scritches, she sits down and licks her paws clean. You can't help but feel a little cheered up for having played with her a little[end if].";
...
instead of using cup stack:
	if rubber tigress companion is listed in companionList of Player:
		if HP of rubber tigress companion >= 7 and a random chance of 1 in 2 succeeds and cuptrick is false:	[cup training]
			...
			say "     You try to be discreet about pulling one of the red cups out of your pack for your tigress pet, but she notices right away and comes bounding over. This leaves you rubbing her ears and pushing her head back with one hand while you struggle to pull out a cup with the other. Once you get it out, she eyes it intently. Tossing it at her, she bumps it around before ending up on her back and batting it around in the air. After tiring of this fun, she smacks it with both paws and [if lust of rubber tigress companion is 2]presses it to her vaginal mouth, sucking down the plastic as it melts on contact with her pussy juices[else]pulls it into her maw[end if]. As it's guided in, it melts and flows down the strange tigress's throat.";
...
after using water bottle while rubber tigress companion is listed in companionList of Player:
	say "     After finishing off your drink, you notice Artemis looking up at you... or, more appropriately, at your empty bottle. You toss it to her and she [one of][if lust of rubber tigress companion is 2]drools her pussy juices onto it[else]chomps onto it[end if], melting the plastic into clear goo and swallowing it down[or]pounces atop it, flattening it down before licking up one end and [if lust of rubber tigress companion is 2]slurping it into her vaginal muzzle as her pussy juices liquefy the plastic[else]sliding it into her mouth whole to melt and slide down her throat[end if][or]bats it around for a bit before eating it[at random].";

after using dirty water while rubber tigress companion is listed in companionList of Player:
	say "     After finishing off your drink, you notice Artemis looking up at you... or, more appropriately, at your empty bottle. You toss it to her and she [one of][if lust of rubber tigress companion is 2]drools her pussy juices onto it[else]chomps onto it[end if], melting the plastic into clear goo and swallowing it down[or]pounces atop it, flattening it down before licking up one end and [if lust of rubber tigress companion is 2]slurping it into her vaginal muzzle as her pussy juices liquefy the plastic[else]sliding it into her mouth whole to melt and slide down her throat[end if][or]bats it around for a bit before eating it[at random].";

after using chips while rubber tigress companion is listed in companionList of Player:
...
to artemisnap:
	...
	if HP of rubber tigress companion >= 11:
		say "[artemisnap_mod]";
	else if HP of rubber tigress companion < 5:
		...
		increase HP of rubber tigress companion by 1;
	else if HP of rubber tigress companion is 5:
		...
		if HP of rubber tigress companion > 7 and location of Player is State Fair and Player is not neuter:
			...
			artemisinfect;
		else if a random chance of 2 in 5 succeeds or HP of rubber tigress companion is 6:	[default masturbation]
			if Player is herm:		[herm]
			...
			if HP of rubber tigress companion < 7, increase HP of rubber tigress companion by 1;
		else:									[HP 7+ for sex]
			if HP of rubber tigress companion is 7:					[first attempt for sex]
...
after resting while rubber tigress companion is listed in companionList of Player:
	now skipturnblocker is 0;
	if HP of rubber tigress companion is 4:
		...
		now Libido of Player is ( Libido of Player * 2 ) / 3;
	else if HP of rubber tigress companion is 6:
...
to say artemissf_sex:
	...
	if Player is male:
		say "     Being a [if Player is female]partially [end if]male tiger, Artemis's cock immediately draws the horny feline's attention and soon she's on her knees licking and sucking at that throbbing rod. This sends shivers of delight through you both [if artemisstatefairrt is false]as your bonded companion gives a long sigh of relief at being finally accepted by the others[else]as your bonded companion releases a moan of pleasure[end if]. You are both treated to a wonderfully sensual blowjob from the eager feline that only ends once she's gotten her tasty treat.";
...
to artemismodding:
	now templust is lust of rubber tigress companion;
	now tempthirst is thirst of rubber tigress companion;
	...
	now calcnumber is -1;
	while sextablerun is 0:
		if lust of rubber tigress companion is 0 or thirst of rubber tigress companion is 0:
			say "[link]0 - examine toys[as]0[end link][line break]";
		if lust of rubber tigress companion is 0:
			say "[link]1 - pussy to crotch[as]1[end link][line break]";
			if thirst of rubber tigress companion is not 2:
				say "[link]2 - pussy to muzzle[as]2[end link][line break]";
		if thirst of rubber tigress companion is 0:
			say "[link]3 - dildo to crotch[as]3[end link][line break]";
			if lust of rubber tigress companion is not 2:
		...
		if calcnumber >= 0 and calcnumber < 10:
			if calcnumber is 0:
				say "[artemistoydesc]";
			else if calcnumber is 1 and lust of rubber tigress companion is 0:
				say "[artemismod1]";
			else if calcnumber is 2 and lust of rubber tigress companion is 0 and thirst of rubber tigress companion is not 2:
				say "[artemismod2]";
			else if calcnumber is 3 and thirst of rubber tigress companion is 0:
				say "[artemismod3]";
			else if calcnumber is 4 and thirst of rubber tigress companion is 0 and lust of rubber tigress companion is not 2:
				say "[artemismod4]";
			else if calcnumber is 5 and thirst of rubber tigress companion is 0:
				say "[artemismod5]";
		...
		wait for any key;
		LineBreak;
	if templust is not lust of rubber tigress companion or tempthirst is not thirst of rubber tigress companion:
		say "[artemispostmod]";
		if HP of rubber tigress companion is 10, now HP of rubber tigress companion is 11;
...
to say artemistoydesc:
	...
	if thirst of rubber tigress companion is not 0 and lust of rubber tigress companion is not 0:
...
to say artemismod1:
	...
	now lust of rubber tigress companion is 1;
...
to say artemismod2:
	...
	now lust of rubber tigress companion is 2;
	now Cunt Count of Artemis is 1;
	now Cunt Depth of Artemis is 12;
	now Cunt Tightness of Artemis is 2;
	now Clit Size of Artemis is 1;
...
to say artemismod3:
	...
	now thirst of rubber tigress companion is 1;
...
to say artemismod4:
	...
	now thirst of rubber tigress companion is 2;
	now Cock Count of Artemis is 1;
	now Cock Girth of Artemis is 3;
	now Cock Length of Artemis is 9;
...
to say artemismod5:
	...
	now thirst of rubber tigress companion is 3;
	now Cock Count of Artemis is 1;
	now Cock Girth of Artemis is 3;
	now Cock Length of Artemis is 9;

to say artemispostmod:
	say "     Artemis seems quite pleased with her new modification[if lust of rubber tigress companion is not templust and thirst of rubber tigress companion is not tempthirst]s[end if], strutting around proudly at her new sexual nature on display. ";
	if ( lust of rubber tigress companion is 1 and templust is not 1 ) and ( thirst of rubber tigress companion is 1 and tempthirst is not 1 ):	[gained both pussy and cock]
		...
		if Player is male:
			...
			say "[artemis_pm2]";
	else if lust of rubber tigress companion is 1 and templust is not 1:		[gained pussy]
		say "[if thirst of rubber tigress companion is 0 or thirst of rubber tigress companion is 1]She gives her new pussy a long, slow lick, rumbling in pleasure as her tongue plays across her wet, rubbery folds. Obviously delighted by having a vagina of her own, she gives it a few more licks[else if thirst of rubber tigress companion is 2]She gives her new pussy a slow, teasing lick with her phallic tongue, rumbling in pleasure as she thrusts her cocktongue into her wet, rubber folds. Obviously delighted by having a vagina of her own for her tongue to fill, she savors several more thrusting licks[else if thirst of rubber tigress companion is 3]After giving her new pussy a long, slow lick, she moves in her tail and sinks her dribbling tailtip into her wet, rubbery folds. Obviously delighted by having a vagina of her own for her tail to fill, she savors several more thrusts[end if] before getting back on her paws and raising her tail, offering for you to partake in the dripping cunt you've given her.";
		if Player is male:
			say "[artemis_pm1]";
		else:
			...
			if thirst of rubber tigress companion is 1:	[possesses a cock]
			...
			else if thirst of rubber tigress companion is 3:
			...
			say "     When you find the swollen button of her clit and suck down on it hard, she mrowls in delight and cums hard, fresh juices running down her thighs. You swap between lapping at these and ravishing her sensitive button to keep her climax going for more[if thirst of rubber tigress companion is 1]. Her latex penis pulses and throbs in your hand, spraying its thick semen across the ground, pumping it even as you work over her new cunt[else if thirst of rubber tigress companion is 2]. Her phallic tongue pulses and throbs inside you, spraying its slick semen inside you as you enjoy this delightfully kinky sixty-nine[else if thirst of rubber tigress companion is 3]. Her phallic tail pulses and throbs inside you, spraying its slick semen inside you as you eat her out[end if]. After moving your head back, you give her rubbery pussy a light fingering, feeling pleased at having been able to help your poor kitty pet.";
	else if thirst of rubber tigress companion is 1 and tempthirst is not 1:		[gained cock]
		if lust of rubber tigress companion is 2:
		...
		if Player consents:
			...
			if lust of rubber tigress companion is 1:	[possesses a pussy]
			...
			else if lust of rubber tigress companion is 2:	[possesses a mouth-pussy]
			...
			say "     The feel of those flexing barbs on her shaft are a delight across your palate. Their touch is soft and stimulating and not at all rough - it makes you eager to try them in a more sensitive hole. The thought is tempting, but you're too eager to get the kitty off at this point to switch positions and instead suck down harder on her newly gained cock. Pushed to climax, the tigress thrusts her penis into your mouth with a mrowl of delight and cums hard. Blast after blast of thick, latex lubricant shoots into your mouth and flows down into your belly, filling you with the warmth of her climax[if lust of rubber tigress companion is 1]. Fresh juices soak your hand and run down her thighs as her pussy quivers around your fingers[else if lust of rubber tigress companion is 2]. Fresh juices soak your hand and run down her neck as her pussy quivers around your fingers[end if]. When she's finally drained, she steps back, popping that wonderful cock of hers from your mouth. You give a slow, parting lick, feeling pleased at having been able to help your poor kitty pet.";
	else if lust of rubber tigress companion is 2 and templust is not 2:		[gained pussy-mouth]
		say "She slides her textured tongue out to tease across the folds of her new pussy-mouth, rumbling in pleasure as her tongue plays across them. [if thirst of rubber tigress companion is 0]Obviously delighted by having a kinky new source of fun, she gives it a few more licks[else if thirst of rubber tigress companion is 1]Obviously delighted by having a kinky new source of fun, she lays on her side and curls around with feline ease, stuffing her cock into her pussy-like muzzle with a deep rumbling of pleasure. The sight of her rocking her hips, fucking her own altered face stirs you back to full arousal. She only stops when she notices you watching her, giving it a few last sucks[else if thirst of rubber tigress companion is 3]Obviously delighted by having a kinky new source of fun, she lays on her side and brings her tail around, stuffing her phallic tailtip into her pussy-like muzzle with a deep rumbling of pleasure. The sight of her pumping her tail, fucking her own altered face stirs you back to full arousal. She only stops when she notices you watching her, giving it a few last sucks[end if] before getting back on her paws and looking up at you, a needy mewl coming from her transformed mouth. She's clearly looking to share her new sexy hole with you, mrowling and nuzzling your side firmly when you don't immediately comply.";
		if Player is male:
	...
	else if thirst of rubber tigress companion is 2 and tempthirst is not 2:		[gained cock-tongue]
		say "She slides her phallic tongue in and out of her lips, rumbling in pleasure as she enjoys the sensation of lightly fellating herself. [if lust of rubber tigress companion is 0]Obviously delighted by having a kinky new source of fun, she gives keeps going until she's leaking lubricating precum from it[else if lust of rubber tigress companion is 1]Obviously delighted by having a kinky new source of fun, she lays on her side and curls around with feline ease, stuffing her cocktongue into her pussy with a deep rumbling of pleasure. The sight of her rocking her hips, fucking herself with her own altered tongue stirs you back to full arousal. She only stops when she notices you watching her, giving it a few last thrusts[end if] before getting back on her paws and looking up at you, a needy mewl coming from her transformed mouth. She's clearly looking to share her new sexy tongue with you, mrowling and nuzzling at your side firmly when you don't immediately comply.";
	...
	else if thirst of rubber tigress companion is 3 and tempthirst is not 3:		[gained tailcock]
		if lust of rubber tigress companion is 0:
		...
		else if lust of rubber tigress companion is 1:
		...
		else if lust of rubber tigress companion is 2:
...
to say artemis_pm1:	[post-mod, fucking the new pussy]
	...
	else if thirst of rubber tigress companion is 2:	[possesses a cocktongue]
	...
	else if thirst of rubber tigress companion is 3:	[possesses a tailcock]
	...
	say "     You do your best to make it last for the needy kitty, but eventually you can't deny your own cascading arousal and cum hard. You pump your sticky, hot load into the mrowling feline as she soaks her thighs in juices from her stuffed cunt[if thirst of rubber tigress companion is 1]. Her latex penis pulses and throbs in your hand, spraying its thick semen across the ground, pumping it even as you pump your own load into her[else if thirst of rubber tigress companion is 2 or thirst of rubber tigress companion is 3]. Her latex penis pulses and throbs in your mouth, spilling her slick load into your mouth for you to greedily swallow down even as you pump your own load into her[end if]. After pulling out, you give her rubbery pussy a light fingering, feeling pleased at having been able to help your poor kitty pet.";
	now lastfuck of rubber tigress companion is turns;
...
to say artemis_pm5:	[post-mod, fucking the new mouth-pussy]
	...
	else if lust of rubber tigress companion is 2:	[possesses a pussy-mouth]
...
to say artemissex8_mod:		[Engulf and masturbate]
	if location of Player is State Fair and ( artemisstatefairrt is false or a random chance of 2 in 3 succeeds ) and HP of rubber tigress companion >= 12:
		...
		if HP of rubber tigress companion is 11, now HP of rubber tigress companion is 12;
		now Libido of rubber tigress companion is Libido of rubber tigress companion / 3;
		now Libido of Player is ( Libido of Player * 3 ) / 4;
		now lastfuck of rubber tigress companion is turns;
		now lastArtemisglomp is turns;
...
to say artemissex9_mod:	[Engulf and sex - Modded Artemis]
	...
	else if HP of rubber tigress companion is 11:
		say "[artemissex8_mod]"; [first engulf post-mod goes to masturbation]
	else if location of Player is State Fair and HP of rubber tigress companion >= 12:
		say "[artemissex9_SF_mod]"; [State Fair version w/modified Artemis]
	else:
		say "[artemis_set_genitals]";
		say "[artemisengulf_mod]";
...
to say artemisengulf_SF_mod:
	...
	if a random chance of 1 in 3 succeeds or artemisstatefairrt is false:
		...
		say "[artemisengulf_mod]";
		say "     Now in control of your body and able to truly strut her stuff, she goes out into the fair with a clear goal in mind. She moves with obvious grace, becoming much more accustomed to her altered form and goes off in search of companionship. And while she draws the attention of a few of the other critters around, she passes them by until she locates one of the feline tigresses. Once found, there is no hesitation before Artemis gives a lustful mrowl and poses in a sexy manner[if lust of rubber tigress companion is 2 and a random chance of 1 in 2 succeeds] while licking across your pussy-like lips of her mouth[else if thirst of rubber tigress companion is 2 and a random chance of 1 in 2 succeeds] while sliding her cocktongue in and out of her muzzle suggestively[else if thirst of rubber tigress companion is 3 and a random chance of 1 in 2 succeeds] while waving her sextoy tail in a come-hither manner[end if]. Intrigued by the feline's offer, she strides over to Artemis and they put their arms around one another, purring and running their paws across their lovely bodies. And what starts initially as stroking and petting soon turns to groping and grinding as the aroused felines kiss.";

to say artemis_set_genitals:
	if lust of rubber tigress companion is 1:				[resetting pre-engulf values]
		now Asshole Depth of Artemis is 0;
		now Asshole Tightness of Artemis is 0;
		now Cunt Count of Artemis is 1;
		now Cunt Depth of Artemis is 12;
	...
	if thirst of rubber tigress companion > 0:
		now Cock Count of Artemis is 1;
		now Cock Girth of Artemis is 3;
		now Cock Length of Artemis is 9;
...
to say artemisengulf_mod:
	...
	else if HP of rubber tigress companion >= 12 and lastfuck of rubber tigress companion - turns >= 24:
...
to say artemisengulf_mod_01:
	if HP of rubber tigress companion is 11:
		say "     Catching sight of the glancing looks the tigress is giving you, you realize that your rubbery kitty's still looking to snuggle extra-close to you despite now having a gender of her own[if lust of rubber tigress companion is not 1 and thirst of rubber tigress companion is not 1], in a manner of speaking[end if]. While feeling a little trepidation, you must admit that you're also quite curious to see what will happen. The lustful possibilities exceed your caution and you find a safe spot to drop your gear and welcome her into your arms.";
	else:
		say "     Catching sight of the glancing looks the tigress is giving you, you realize that your rubbery kitty's looking to snuggle extra-close to you once again. And given how things have been even kinkier now that she's been modified to have a gender of her own as well[if lust of rubber tigress companion is not 1 and thirst of rubber tigress companion is not 1], in a manner of speaking[end if], you have been looking forward to the next opportunity. Deciding like you could use a break for some sexy fun, you set your gear down and welcome her into your arms.";
	...
	if Player is herm:		[herm setup]
		say ". You grind your stiff cock[smn] against her[if lust of rubber tigress companion is 1 and thirst of rubber tigress companion is 1] own manhood and pussy, drawing an appreciative mrowl. But rather than penetrate her, you can feel it pressing to your flesh, her loins coating and lining your own, becoming shared cock[smn] and cunt[sfn][else if lust of rubber tigress companion is 1] pussy, drawing an appreciative mrowl. But rather than penetrate her, you can feel it pressing to your flesh, her rubbery hide coating your cock[smn] while her wet folds flow over yours and join together into shared cunt[sfn] to become a herm[else if thirst of rubber tigress companion is 1]s, drawing an appreciative mrowl. Soon the sensation changes, her dildo shaft melding with yours to become shared cock[smn]. Her flowing latex covering your wet folds and joining with them to become a herm[else] bare crotch, drawing a longing mrowl. Soon enough you feel that familiar touch of her rubber flesh liquefying and coating your own, sliding over your cock[smn] and into your cunt[sfn] to become shared as a herm[end if]";
		if Cock Count of Player > Cock Count of rubber tigress companion, now Cock Count of rubber tigress companion is Cock Count of Player;
		if Cock Length of Player > Cock Length of rubber tigress companion, now Cock Length of rubber tigress companion is Cock Length of Player;
		if Ball Size of Player > Ball Size of rubber tigress companion, now Ball Size of rubber tigress companion is Ball Size of Player;
		if Cunt Count of Player > Cunt Count of rubber tigress companion, now Cunt Count of rubber tigress companion is Cunt Count of Player;
		if Cunt Depth of Player > Cunt Depth of rubber tigress companion, now Cunt Depth of rubber tigress companion is Cunt Depth of Player;
		if Cunt Tightness of Player > Cunt Tightness of rubber tigress companion, now Cunt Tightness of rubber tigress companion is Cunt Tightness of Player;
	else if Player is male:				[male setup]
		say ". You grind your stiff cock[smn] against her[if lust of rubber tigress companion is 1 and thirst of rubber tigress companion is 1] own manhood and pussy, drawing an appreciative mrowl. But rather than penetrate her, you can feel it pressing to your flesh, her dildo shaft melding with yours to become shared cock[smn]. That is then followed by the even stranger and more pleasurable sensation of her cock-sleeve cunny joining with you, giving you a shared pussy that aches to be filled as you become a herm with her[else if lust of rubber tigress companion is 1] pussy, drawing an appreciative mrowl. But rather than penetrate her, you can feel it pressing to your flesh. Moments after her rubbery hide coats your cock[smn], there comes the even stranger and more pleasurable sensation of her cock-sleeve cunny joining with you, giving you a shared pussy that aches to be filled as you become a herm with her[else if thirst of rubber tigress companion is 1]s, drawing an appreciative mrowl. Soon the sensation changes, her dildo shaft melding with yours to become shared cock[smn][else] bare crotch, drawing a longing mrowl. Soon enough you feel that familiar touch of her rubber flesh liquefying and coating your own, sliding over your cock[smn]to become shared[end if]";
		if Cock Count of Player > Cock Count of rubber tigress companion, now Cock Count of rubber tigress companion is Cock Count of Player;
		if Cock Length of Player > Cock Length of rubber tigress companion, now Cock Length of rubber tigress companion is Cock Length of Player;
		if Ball Size of Player > Ball Size of rubber tigress companion, now Ball Size of rubber tigress companion is Ball Size of Player;
	else if Player is female:				[female setup]
		say ". You grind your juicy cunn[yfn] against her, drawing an appreciative mrowl. Your honeyed juices make her smooth flesh slick even before it starts to flow over and into you[if lust of rubber tigress companion is 1 and thirst of rubber tigress companion is 1]. Even as you feel her cock-sleeve cunt flowing and spreading to coat your puss[yfn], you can all feel her throbbing dildo cock taking root as you become a herm with her[else if lust of rubber tigress companion is 1]. You can feel her cock-sleeve cunt flowing and spreading to coat your puss[yfn] to become a shared source of pleasure and heated need[else if thirst of rubber tigress companion is 1]. You can feel her dildo shaft rubbing against your cunt, making you moan in return. But rather than penetrate you with it, you feel her flowing latex flesh entering you instead, coating your vaginal walls. Moments afterwards, there comes the even stranger and more pleasurable sensation of her sextoy cock joining with you, giving you a shared manhood that throbs with a desire to be used as you become a herm together[else] bare crotch, drawing a longing mrowl. Soon enough you feel that familiar touch of her rubber flesh liquefying and coating your own, sliding into your cunt[sfn] to become shared[end if]";
		if Cunt Count of Player > Cunt Count of rubber tigress companion, now Cunt Count of rubber tigress companion is Cunt Count of Player;
		if Cunt Depth of Player > Cunt Depth of rubber tigress companion, now Cunt Depth of rubber tigress companion is Cunt Depth of Player;
		if Cunt Tightness of Player > Cunt Tightness of rubber tigress companion, now Cunt Tightness of rubber tigress companion is Cunt Tightness of Player;
	if thirst of rubber tigress companion is 3:				[tail-cock add-on]
	...
	if lust of rubber tigress companion is 1:					[pussy-mouth]
	...
	else if thirst of rubber tigress companion is 1:		[cock-tongue]
...
to say artemisengulf_mod_02:
	...
	say "     With you pressing so eagerly against her, you soon feel her rubbery skin spreading over you as her melting rubber clings to your loins. Flowing latex spreads out from there over your hips and chest as you can feel the stuff [if Player is herm]wrapping around your stiff manhood and sealing over your puss[yfn] before pushing further into you, coating and sealing your cunt[sfn] in a protective layer of herself[else if Cock Count of Player > 1]wrapping around your stiff cocks and coating them in a snug, squeezing layer of herself[else if Cock Count of Player is 1]wrapping around your stiff cock and coating it in a snug, squeezing layer of herself[else if Player is female]encapsulating your juicy folds before pushing further into you, coating and sealing your cunt[sfn] in a protective layer of herself[end if][if Libido of rubber tigress companion is 1 or thirst of rubber tigress companion is 1]. Her sextoy loins join with yours, melding to increase your mutual pleasure[else if ( Cock Count of Player is 0 and thirst of rubber tigress companion is 1 ) or ( Cunt Count of Player is 0 or lust of rubber tigress companion > 0 )] and combining into a now herm tigress[end if].";
	if anallevel > 1:							[anal (w/tailcock if needed)]
		say "     You end up moaning as a pushing sensation at your anus leads it to opening and allowing more of her to flow into you and coat your back passage as well in herself[if thirst of rubber tigress companion is 3]. As she's rubberizing your rectum, her modified sextoy tail flows into place above it and joins with you, allowing you to share in the pleasure that kinky appendage[end if]. Once your crotch and hips are securely covered, the flow of liquid rubber feline continues onwards.";
	else if thirst of rubber tigress companion is 3:		[tailcock w/o anal]
	...
	if a random chance of 1 in 3 succeeds:
		if lust of rubber tigress companion is 2:			[pussy mouth 'vore']
			...
			say "     After having covered the rest of your [Body Size Adjective of Player], [bodydesc of Player] body, all that remains is your head. With her head still largely intact, but clearly softening in preparation of what's to come, she gives you a playful grin. She then opens her maw very wide, which gives you a close-up view of its gooey interior of flowing rubber moments before her head plunges over yours in one sticky bite. Your vision is a blur of opaque orange while her liquid latex flows into your mouth and down your throat[if thirst of rubber tigress companion is 2]. Her dildo tongue settles into your mouth, fusing with your own tongue and filling your new, feline muzzle with that pulsing, dribbling shaft[end if]. It is a few more seconds before she manages to flow her face back around to the front, settling into place, leaving you with orange-tinted vision as you drift off into the sleepwalking state as her new body. She gives a quick stretch and a playful grope that you share sensation in while she prepares for the next phase of her fun [if daytimer is day]day[else]night[end if] out.";
	else:
		say "     After having covered the rest of your [Body Size Adjective of Player], [bodydesc of Player] body, all that remains is your head. With her head still largely intact, but clearly softening in preparation of what's to come, she [if lust of rubber tigress companion is 2]runs her tongue teasingly across the labial folds of her lips[else if thirst of rubber tigress companion is 2]lets the tip of her dribbling cocktongue poke from her lips[else]gives you a tender smile[end if] and presses her flowing muzzle to your lips in a kiss. As you moan into your kiss, her [if thirst of rubber tigress companion is 2]penile tongue presses into your mouth, drooling flowing rubber goo down your throat, coating your insides. Her cocktongue flows across the rubber coating your tongue and joins with it, giving you a living latex dildo in your forming feline muzzle[else if lust of rubber tigress companion is 2]gooey latex tongue presses into your mouth, playing with your tongue briefly before it continues to stretch out and flow down your throat, coating your insides. Her vaginal maw joins with the feline muzzle you're forming, allow you to share in the delights of her sexualized mouth[else]gooey latex tongue presses into your mouth, playing with your tongue briefly before it continues to stretch out and flow down your throat, coating your insides[end if]. As her features start to settle into place, you start to drift off into the orange-tinted dreamscape that leaves your body hers to control. She gives a quick stretch and a playful grope that you share sensation in while she prepares for the next phase of her fun [if daytimer is day]day[else]night[end if] out.";

to say artemisengulf_mod_03:
	say "     Deciding to take a break, you put down your pack and move to take a seat. But as you're sitting down, you find your seat higher and more padded than you expected. Artemis, having jumped into your seat ahead of you lets her body soften and sag before starting to flow up over you. You [if Player is male]chuckle[else]giggle[end if] as the sneaky kitty's managed to catch you. You try to struggle, but her rubbery coating continues to spread over you[if scalevalue of Player > 3]. It takes some time and extra stretching on her part to be able to cover your [Body Size Adjective of Player], [bodydesc of Player] body, but she perseveres in her plan to hijack you for some fun[end if]. The feel of her flowing rubber [if Player is herm]spreading over your dual genders is particularly pleasing, as always. The squeezing around your maleness and the feel of it flowing past your folds and into you[else if Player is male]spreading over your throbbing cock[smn] is particularly pleasing, as always. The squeezing around your manhood and rubbing you all over[else if Player is female]spreading across your wet folds is particularly pleasing, as always. And the feel of her then pushing into you to flow into your cunt[sfn][end if] is such a perverse delight[if lust of rubber tigress companion is 1 or thirst of rubber tigress companion is 1]. You feel a rush of sexual excitement as her sextoy genitals join with yours[end if][if ( Cock Count of Player is 0 and thirst of rubber tigress companion is 1) or ( Cunt Count of Player is 0 and lust of rubber tigress companion is 1 )], combining your genders[end if][if anallevel > 1]. And more kinky pleasure comes when more flowing rubber presses at your tight pucker, spreading you open with ease so she can flow into your bowels and coat them as well[end if].";
	say "     Once she's at the point of finishing up with your head, you stop your pointless struggles and open your mouth wide, inviting her to finish sealing you inside her. The feel of her flowing into your mouth and throat is a little disconcerting, but you've grown so close to your lovable tigress that you trust her doing it[if lust of rubber tigress companion is 2]. There comes a strange, but arousing, sensation as her pussy-mouth binds with your mouth and throat[else if thirst of rubber tigress companion is 2]. There comes a strange, but arousing, sensation as her cocktongue binds into your mouth[end if]. With you all sealed up and drifting off into the sleepwalking state, her head reforms and your body, as needed, shifts shape a little to let you both become a [if Player is puremale and lust of rubber tigress companion is not 1]girlish tiger[else]sexy tigress[end if][if BodyName of Player is listed in infections of TaurList] taur[end if] made of rubber. And finding herself already in a nice seat, she decides to enjoy the position by having a little fun.";


to say artemisengulf_mod_ext:		[long delay]
	say "     When you pause to get your bearings at a quiet point, Artemis pads up to you and sits down in front of you[if lust of rubber tigress companion is 2]. She gives a soft mewl and flops down on the ground, as if resting, to which you smile and pat her head. She looks a little cross at the condescending patting and gives an indignant mewl. She then yawns her pussy-mouth open surprisingly wide, giving you a fine view of her wet, cunt-like maw and throat[else]. She gives a big yawn, to which you smile and pat her head. She looks a little cross at the condescending patting and opens her muzzle even wider, rubbery maw stretching[end if]. She points at her mouth with one hardened claw, but you just chuckle. Reaching down to pat her head, you promise her to play with her later maybe.";
	say "     Not liking this answer, she pounces towards your outstretched arm, engulfing it in her [if lust of rubber tigress companion is 2]vaginal[else]slick[end if] mouth in one big gulp. Caught by surprise, you stumble back, resulting in the big kitty landing atop you. She quickly starts to deflate and begins to flow over you. Surprised by the feline's aggressive demands for the use of your [bodydesc of Player] body, it seems it's been too long since you've allowed her to use it and she's tired of waiting. You consider trying to struggle, but already having one arm fully trapped in her, it's futile. You instead press at the back of her head, pushing her muzzle to your lips in a deep kiss that grows deeper still as her rubbery flesh flows over your head and down your throat.";
	say "     As you're left looking out through Artemis's orange tinted eyes, you can see her striped hide as it moves to stretch over your crotch. You moan softly inside her as you feel her [if lust of rubber tigress companion is 2]mouth-pussy forming inside your own and replacing it with her sexualized muzzle even as she's[else if thirst of rubber tigress companion is 2]cocktongue melding and replacing your own to fill the reforming muzzle even as she's [end if]sliding over your loins. The feel of her flowing rubber. ";
	if Player is herm:		[herm setup]
		say "spreading across your cock[smn] and puss[yfn] is particularly pleasing, as always. The squeezing around your maleness and the feel of it flowing past your folds and into you is such a perverse delight[if lust of rubber tigress companion is 1 or thirst of rubber tigress companion is 1]. And the pleasure only heightens as her sextoy genitals start fusing with yours, increasing the intimacy of your union[end if]";
		if Cock Count of Player > Cock Count of rubber tigress companion, now Cock Count of rubber tigress companion is Cock Count of Player;
		if Cock Length of Player > Cock Length of rubber tigress companion, now Cock Length of rubber tigress companion is Cock Length of Player;
		if Ball Size of Player > Ball Size of rubber tigress companion, now Ball Size of rubber tigress companion is Ball Size of Player;
		if Cunt Count of Player > Cunt Count of rubber tigress companion, now Cunt Count of rubber tigress companion is Cunt Count of Player;
		...
		say "spreading across your cock[smn] is particularly pleasing, as always. The squeezing around your maleness is such a perverse delight[if lust of rubber tigress companion is 1]. And the pleasure only heightens as her sextoy genitals start fusing with yours, increasing the intimacy of your union. As her cunt reforms underneath your latex-covered shaft[smn], you are joined together as a herm[else if thirst of rubber tigress companion is 1]. And the pleasure only heightens as her sextoy genitals start fusing with yours, increasing the intimacy of your union[end if]";
		if Cock Count of Player > Cock Count of rubber tigress companion, now Cock Count of rubber tigress companion is Cock Count of Player;
		if Cock Length of Player > Cock Length of rubber tigress companion, now Cock Length of rubber tigress companion is Cock Length of Player;
		if Ball Size of Player > Ball Size of rubber tigress companion, now Ball Size of rubber tigress companion is Ball Size of Player;
	else if Player is female:				[female setup]
		say "spreading across your puss[yfn] is particularly pleasing, as always. The feel of it flowing past your folds and into you is such a perverse delight[if thirst of rubber tigress companion is 1]. And the pleasure only heightens as her sextoy genitals start fusing with yours, increasing the intimacy of your union. As her cock reforms above your latex-covered cunn[yfn], you are joined together as a herm[else if lust of rubber tigress companion is 1]. And the pleasure only heightens as her sextoy genitals start fusing with yours, increasing the intimacy of your union[end if]";
		if Cunt Count of Player > Cunt Count of rubber tigress companion, now Cunt Count of rubber tigress companion is Cunt Count of Player;
		if Cunt Depth of Player > Cunt Depth of rubber tigress companion, now Cunt Depth of rubber tigress companion is Cunt Depth of Player;
		if Cunt Tightness of Player > Cunt Tightness of rubber tigress companion, now Cunt Tightness of rubber tigress companion is Cunt Tightness of Player;
	if anallevel is 3:
...
to say artemis_mast_mod:
	say "     Having drifted into that pleasure-filled sleepwalking state you enjoy while engulfed by her, you share sensation with the rubbery tigress now covering and controlling your body. With you reformed into a [if Cock Count of rubber tigress companion > 0 and Cunt Count of rubber tigress companion is 0]girlish tiger[else]sexy tigress[end if] made of rubber, she starts by reacquainting herself with her [if BodyName of Player is listed in infections of TaurList]tauric[else]anthropomorphic[end if] form and delighting in how you share in her modifications in this union.";
	if Cock Count of rubber tigress companion > 0 and Cunt Count of rubber tigress companion > 0:	[herm bridge]
		say "     Being a herm kitty[if thirst of rubber tigress companion is not 1 or lust of rubber tigress companion is not 1] now[end if], her paws are drawn to her crotch to fondle her cock[smn] and tease her puss[yfn] with a happy rumble. Having hands with which to touch herself, she's very eager to do just that, playing with your mutual body to explore its erotic delights. And having borrowed your body for this, you share in these pleasures as well while in the dream-like haze of her control.";
	else if Cock Count of rubber tigress companion > 0:					[male bridge]
		say "     Being a male kitty[if thirst of rubber tigress companion is not 1] now[end if], her paws are drawn to her crotch to fondle her cock[smn]with a happy rumble. Having hands with which to touch herself, she's very eager to do just that, playing with your mutual body to explore its erotic delights. And having borrowed your body for this, you share in these pleasures as well while in the dream-like haze of her control.";
	else if Cunt Count of rubber tigress companion > 0:					[female bridge]
		say "     Being a female kitty[if lust of rubber tigress companion is not 1] now[end if], her paws are drawn to her crotch to tease her puss[yfn] with a happy rumble. Having hands with which to touch herself, she's very eager to do just that, playing with your mutual body to explore its erotic delights. And having borrowed your body for this, you share in these pleasures as well while in the dream-like haze of her control.";
	if thirst of rubber tigress companion is 3 and lust of rubber tigress companion is 2:
		if a random chance of 1 in 2 succeeds:
...
[		else if a random chance of 1 in 4 succeeds and Cunt Count of rubber tigress companion > 0:
		...
		if a random chance of 2 in 5 succeeds:
			...
			say "     She pauses in this briefly to bend her rubber body with exceptional feline flexibility, bringing her muzzle in towards her loins. You release a sleepy moan as her pussy-mouth engulfs [if Cock Count of rubber tigress companion > 1]one of her throbbing cocks[else]her throbbing cock[end if]. Feeling both that meaty cock being sucked and the vaginal hole being penetrated is dizzyingly exciting. She bobs her muzzle up and down about a dozen times while thrusting up into her sextoy mouth before finally uncurling to return to fondling herself.";
	if Cock Count of rubber tigress companion > 0 and Cunt Count of rubber tigress companion > 0:		[herm finale]
		say "     This self-exploration continues on as the pleasure builds and she works her paws faster, growing eager for release. Rubbing over her [if Cock Length of rubber tigress companion < 12]pulsing[else if Cock Length of rubber tigress companion < 24]large[else]huge[end if] [if Player is not male]sextoy[else][Cock of Player][end if] maleness, she dribbles a mix of slick lube and [if Player is male]your [end if]precum, spreading it across [if Player is female]your[else]her[end if] rubber-encased cunny. She teases her clit[sfn] with quick strokes and mrowls in delight, her hips quivering as your mutual orgasm approaches and then rushes through you both. Splatters of gooey semen shoot across the feline's chest and slick juices soak her thighs as she achieves her much-desired release[if lust of rubber tigress companion is 2 and thirst of rubber tigress companion is 3]. Your tailcock throbs and spurts its load as well while excess hot juices run down your throat and drool from your mouth-pussy[else if lust of rubber  companion is 2]. Excess hot juices run down your throat and drool from your mouth-pussy as it orgasms as well[else if thirst of rubber tigress companion is 2]. Your cocktongue throbs and spurts its load as well, adding to the outpouring of sexual release[else if thirst of rubber tigress companion is 3]. Your tailcock throbs and spurts its load as well, adding to the outpouring of sexual release[end if]. With Artemis flopping out to bask in the afterglow, you drift fully into slumber inside her full-bodied embrace, only to be awoken later by the fully reformed tigress nuzzling at your cheek. After some snuggling, you get up and head back on your way.";
	else if Cock Count of rubber tigress companion > 0:						[male finale]
		say "     This self-exploration continues on as the pleasure builds and she works her paws faster, growing eager for release. Rubbing over her [if Cock Length of rubber tigress companion < 12]pulsing[else if Cock Length of rubber tigress companion < 24]large[else]huge[end if] maleness, she dribbles a mix of slick lube and [if Player is male]your [end if]precum, spreading it across [if Player is not male]her sextoy[else]your rubber-encased [Cock of Player][end if] shaft[smn]. Pumping hard and faster, she mrowls in delight and her hips quiver as your mutual orgasm approaches and then rushes through you both. Splatters of gooey semen shoot across the feline's chest as she achieves her much-desired release[if lust of rubber tigress companion is 2 and thirst of rubber tigress companion is 3]. Your tailcock throbs and spurts its load as well while excess hot juices run down your throat and drool from your mouth-pussy[else if lust of rubber tigress companion is 2]. Excess hot juices run down your throat and drool from your mouth-pussy as it orgasms as well[else if thirst of rubber tigress companion is 2]. Your cocktongue throbs and spurts its load as well, adding to the outpouring of sexual release[else if thirst of rubber tigress companion is 3]. Your tailcock throbs and spurts its load as well, adding to the outpouring of sexual release[end if]. With Artemis flopping out to bask in the afterglow, you drift fully into slumber inside her full-bodied embrace, only to be awoken later by the fully reformed tigress nuzzling at your cheek. After some snuggling, you get up and head back on your way.";
	else if Cunt Count of rubber tigress companion > 0:						[female finale]
		say "     This self-exploration continues on as the pleasure builds and she works her paws faster, growing eager for release. Rubbing at your rubber-encased cunny, she's gotten her smooth hide quite slick with [if lust of rubber tigress companion is 1]a mix of pussy juices and lube[else]your pussy juices[end if]. She teases her clit[sfn] with quick strokes and mrowls in delight, her hips quivering as your mutual orgasm approaches and then rushes through you both. A rush of femme-cum soaks her thighs as she achieves her much-desired release[if lust of rubber tigress companion is 2 and thirst of rubber tigress companion is 3]. Your tailcock throbs and spurts its load as well while excess hot juices run down your throat and drool from your mouth-pussy[else if lust of rubber tigress companion is 2]. Excess hot juices run down your throat and drool from your mouth-pussy as it orgasms as well[else if thirst of rubber tigress companion is 2]. Your cocktongue throbs and spurts its load as well, adding to the outpouring of sexual release[else if thirst of rubber tigress companion is 3]. Your tailcock throbs and spurts its load as well, adding to the outpouring of sexual release[end if]. With Artemis flopping out to bask in the afterglow, you drift fully into slumber inside her full-bodied embrace, only to be awoken later by the fully reformed tigress nuzzling at your cheek. After some snuggling, you get up and head back on your way.";
...
[	if thirst of rubber tigress companion is 2 and a random chance of 1 in 5 succeeds:
		say "***cocktongue specific scenes.";
	else if thirst of rubber tigress companion is 3 and a random chance of 1 in 5 succeeds:
		say "***tailcock specific scenes.";
	else if lust of rubber tigress companion is 2 and a random chance of 1 in 5 succeeds:
		say "***cuntmouth specific scenes.";]
[	else if anallevel > 1 and ( Cunt Count of rubber tigress companion is 0 and lust of rubber tigress companion is 0 ) and ( a random chance of anallevel in 12 succeeds or ( Player is mpreg_ok and a random chance of 1 in 12 succeeds ) or ( Player is submissive and a random chance of 1 in 12 succeeds ) ) and MaleList is not banned:	]
	if anallevel > 1 and ( Cunt Count of rubber tigress companion is 0 and lust of rubber tigress companion is 0 ) and ( a random chance of anallevel in 12 succeeds or ( Player is mpreg_ok and a random chance of 1 in 12 succeeds ) or ( Player is submissive and a random chance of 1 in 12 succeeds ) ) and MaleList is not banned:
		say "[randombodypart]"; [yields male 'bodyselector']
		if bodyselector is "tiger":
			while bodyselector is "tiger":
				say "[randombodypart]";
		if a random chance of 3 in 5 succeeds or ( Player is submissive and a random chance of 1 in 5 succeeds ):		[M/M bottom]
			say "male [bodyselector] enticed by the currently male [']tiger['] and [']his['] sultry moves. It seems Artemis would prefer to go for some gay sex with your borrowed body this time to broaden her enjoyment. After [one of][if thirst of rubber tigress companion is 2 and a random chance of 1 in 2 succeeds]some mutual stroking with his current partner which includes stroking that dribbling cocktongue[else if thirst of rubber tigress companion is 3 and a random chance of 1 in 2 succeeds]some mutual stroking with his current partner which includes stroking that dribbling tailcock[else]some mutual stroking with his current partner[end if][or][if thirst of rubber tigress companion is 2]sucking his cock to get him ready using drooling precum from the cocktongue pressed alongside it[else if thirst of rubber tigress companion is 3 and a random chance of 1 in 2 succeeds]licking and sucking his cock to get him ready while the favor is returned by sucking on the tiger's dribbling tailcock[else]licking and sucking his cock to get him ready[end if][or][if thirst of rubber tigress companion is 2 and a random chance of 1 in 2 succeeds]sharing a kiss that quickly turns into sucking the tiger's sextoy tongue for a while[else if anallevel is 3]bending over and getting rimmed by his current partner[else]kissing and making out for a while[end if][as decreasingly likely outcomes], he ends up [one of]on all fours[or]bent over a bench[or]spread across the hood of a car[or]pinned against a wall[at random] with the [bodyselector] forcing his cock into the tiger's yielding asshole (and thereby into you).";
			say "     He moans and mrowls at this treatment, squirming his hips into those thrusts and clenching his stuffed hole around the pulsing meat, your body responding to his lustful desires. He pounds into the horny kitty, sending waves of pleasure through you both. Artemis, having learned a few tricks, wiggles his rear and rocks back into the thrusts to get even more pleasure from his current playmate";
			if thirst of rubber tigress companion is 2 and a random chance of 1 in 2 succeeds:
			...
			else if thirst of rubber tigress companion is 3 and a random chance of 1 in 2 succeeds:
			...
			say "male [bodyselector] enticed by the currently male [']tiger['] and [']his['] sultry moves. It seems Artemis would prefer to go for some gay sex with your borrowed body this time to broaden her enjoyment. After [one of][if thirst of rubber tigress companion is 2 and a random chance of 1 in 2 succeeds]some mutual stroking with his current partner which includes stroking that dribbling cocktongue[else if thirst of rubber tigress companion is 3 and a random chance of 1 in 2 succeeds]some mutual stroking with his current partner which includes stroking that dribbling tailcock[else]some mutual stroking with his current partner[end if][or][if thirst of rubber tigress companion is 3 and a random chance of 1 in 2 succeeds]getting his current partner to lick and suck your shared cock and that kinky tailcock side by side to each other[else]getting his current partner to lick and suck your shared cock[end if][or][if thirst of rubber tigress companion is 2 and anallevel is 3 and a random chance of 1 in 2 succeeds]bending his current partner over and rimming his asshole by plunging the drooling cocktongue into it[else if thirst of rubber tigress companion is 2]sharing a kiss that quickly turns into sucking the tiger's sextoy tongue for a while[else if anallevel is 3 and thirst of rubber tigress companion is not 2]bending over and getting rimmed by his current partner[else]kissing and making out for a while[end if][as decreasingly likely outcomes], the rubber kitty has the [bodyselector] [one of]on the ground beneath him[or]pressed to a wall[or]bent over some rubble[or]spread across the hood of a car[at random].";
			...
			say ". They go at it for a while before the tiger reaches his limit and drives into the [bodyselector] hard, releasing your [Cum Load Size of rubber tigress companion] load into him with a mrowl. As he's emptying his balls, the horny feline reaches around and strokes the other male's cock, getting him to blow his load as well.";
			say "     Satisfied for now, the two part with the tiger sleepwalking you back to your gear and finds a spot to stretch out for a quick nap. You drift off fully into slumber as well, only to be awoken by the fully-reformed tigress nuzzling at your cheek. After some snuggling, you get up and head back on your way.";
	else if Cunt Count of rubber tigress companion > 0 and ( Cock Count of rubber tigress companion is 0 or ( Cock Count of rubber tigress companion > 0 and a random chance of 1 in 2 succeeds ) ):		[M/F bottom]
		say "[randombodypart]"; [yields male 'bodyselector']
		say "male [bodyselector] enticed by the sultry [if Cunt Count of rubber tigress companion > 0 and Cock Count of rubber tigress companion > 0]herm[else]female[end if]. Both eager for the main event, the foreplay is brief and ends with the tigress [one of]on all fours[or]bent over a bench[or]spread across the hood of a car[or]pinned against a wall[at random] with the male driving his cock into her hot, needy cunt (and thereby into you).";
		say "     She moans and mrowls at this treatment, squirming her hips into his thrusts and clenching her needy cunt around his pulsing meat, your body responding to her lustful desires. He pounds into the horny kitty, sending waves of pleasure through you both. Artemis, having learned a few tricks, wiggles her rear and rocks back into the thrusts to get even more pleasure from her current playmate";
		if thirst of rubber tigress companion is 2 and a random chance of 1 in 2 succeeds:
		...
		else if lust of rubber tigress companion is 2 and a random chance of 1 in 2 succeeds:
		...
		if slutname is "tigress":
			while slutname is "tigress":
				say "[randomdesc2]";
		say "female [slutname] enticed by the sultry [if Cunt Count of rubber tigress companion > 0 and Cock Count of rubber tigress companion > 0]herm[else]male[end if]. After some lustful groping and fondling, they are both quite worked up and the rubber kitty has the [slutname] [one of]on the ground beneath her[or]pressed to a wall[or]bent over some rubble[or]spread across the hood of a car[at random].";
		...
		say ".";
		say "     They go at it for a while before the tigress reaches her limit and drives into the [slutname] hard, releasing her [Cum Load Size of rubber tigress companion] load into her with a mrowl. Having emptied her balls, she gives her lover a slow lick [if thirst of rubber tigress companion is 2]with her kinky tongue [end if]and pulls out. Satisfied for now, the two part with the tigress sleepwalking you back to your gear and finds a spot to stretch out for a quick nap. You drift off fully into slumber as well, only to be awoken by the fully-reformed tigress nuzzling at your cheek. After some snuggling, you get up and head back on your way.";
...
to say artemisengulf_SF_mod01:
	...
	if artemisstatefairrt is false:
		...
		say "     While your first response is to get ready to fight, you relax and instead let Artemis continue to engulf you, even pressing your hands into the flowing rubber while smiling at the buxom tigress watching you both";
	say ". The buxom rubber tigress seems quite [one of]startled but[or]intrigued and[or]amazed but[or]nervous but[at random] neither moves towards nor away from the strange events she's witnessing. As Artemis is spreading further over you, you can feel her flowing over your nethers, exposing their rubber-coated state to the feline voyeur. Not even quite aware yet of what she's doing, the feline has begun to finger herself as she witnesses the ongoing transformation and merging of the four-footed tigress with you. You can't help but moan, a little louder than usual for added show as you feel the flowing tigress [if Player is herm]spreading over your dual genders and pushing into you to flow into your cunt[sfn][else if Player is male]spreading over your throbbing cock[smn][else if Player is female]spreading across your wet folds and then pushing into you to flow into your cunt[sfn][end if][if Player is not female and lust of rubber tigress companion is 1]. You end up gaining the tigress's juicy pussy as part of the union, the sudden pleasure of its addition making you pant heavily[else if Player is not male and thirst of rubber tigress companion is 1]. You end up gaining the tigress's dribbling cock as part of the union, the sudden pleasure of its addition making you pant heavily[end if][if anallevel > 1]. And another groan of kinky pleasure comes when more flowing rubber presses at your back entrance, pushing it open with ease so she can coat your inner walls as well[end if].";
	if Cock Count of Player > Cock Count of rubber tigress companion, now Cock Count of rubber tigress companion is Cock Count of Player;
	if Cock Length of Player > Cock Length of rubber tigress companion, now Cock Length of rubber tigress companion is Cock Length of Player;
	if Ball Size of Player > Ball Size of rubber tigress companion, now Ball Size of rubber tigress companion is Ball Size of Player;
	if Cunt Count of Player > Cunt Count of rubber tigress companion, now Cunt Count of rubber tigress companion is Cunt Count of Player;
	if Cunt Depth of Player > Cunt Depth of rubber tigress companion, now Cunt Depth of rubber tigress companion is Cunt Depth of Player;
	if Cunt Tightness of Player > Cunt Tightness of rubber tigress companion, now Cunt Tightness of rubber tigress companion is Cunt Tightness of Player;
	say "     As your companion is sealing up over your head[if lust of rubber tigress companion is 2] and her cunt-mouth flows into yours[else if thirst of rubber tigress companion is 2] and her cocktongue melds into yours[end if], she pulls herself upright in her new, [if BodyName of Player is listed in infections of TaurList]tauric[else]anthropomorphic[end if] form. She gives her [if thirst of rubber tigress companion is 3]sextoy [end if]tail a swish, making a come hither motion to the other tigress. [one of]Intrigued[or]Nervous[or]Cautious[or]Excited[at random], she steps slowly closer, her eyes running over your combined body and the once neuter feline's new gender. Putting their arms around one another, they purr and run their paws over each other. And what starts initially as stroking and petting soon turns to groping and grinding as the aroused felines kiss.";


to say artemisengulf_SF_mod02:
	say "     Noticing Artemis's rather insistent nuzzling and purring for affection, you quickly relent with a smile and a scritch on her head. She gives a squeaky mrowl and heads off with you to a secluded spot where you both can get quite a bit closer. Putting your arms around your loving pet, you give her muzzle a kiss. Soon, the kiss grows slick as her lips grow soft and start to flow over yours. Her tongue presses into your mouth, sliding around inside it briefly before expanding to fill your mouth and flow down your throat. Opening your eyes momentarily during this odd kiss, you can see her lovely eyes moving closer and closer as her face presses up against yours before flowing over it.";
	say "     Even as your head is being engulfed and covered in a mask of rubber, your hands pull at the increasingly flowing tigress, spreading smears of her over your body. One particularly large glob you pull onto your loins and rub it firmly over yourself, [if Cock Count of Player > 1 and Player is female]coating your dual genders, making sure your [cock size desc of Player] cocks are thoroughly coated before stuffing more of her into your juicy cunt[sfn][else if Cock Count of Player is 1 and Player is female]coating your dual genders and making sure your [cock size desc of Player] cock is thoroughly coated before stuffing more of her into your juicy cunt[sfn][else if Cock Count of Player > 1]making sure your [cock size desc of Player] cocks are thoroughly coated[else if Cock Count of Player is 1]making sure your [cock size desc of Player] cock is thoroughly coated[else if Player is female]stuffing more of her into your juicy cunt[sfn][end if][if Player is not female and lust of rubber tigress companion is 1]. You end up gaining the tigress's juicy pussy as part of the union, the sudden pleasure of its addition making you pant heavily[else if Player is not male and thirst of rubber tigress companion is 1]. You end up gaining the tigress's dribbling cock as part of the union, the sudden pleasure of its addition making you pant heavily[end if][if anallevel > 1]. After giving your gender over to her, you reach back between your legs and stuff a pair of fingers into your asshole, fingering yourself eagerly as you push more and more tigress goo into yourself[end if]. Eventually, your arms and hands become too coated themselves for you to maintain control of them, so the tigress takes over, playing with your combined body even as she spreads over the last of your exposed skin[if lust of rubber tigress companion is 2 and thirst of rubber tigress companion is 3]. This culminates with the addition of the rubber tigress's kinky mouth and tail to you, further sexualizing your coated body[else if lust of rubber tigress companion is 2]. This culminates with the addition of the rubber tigress's kinky mouth to you, further sexualizing your coated body[else if thirst of rubber tigress companion is 2]. This culminates with the addition of the rubber tigress's kinky tongue to you, further sexualizing your coated body[else if thirst of rubber tigress companion is 3]. This culminates with the addition of the rubber tigress's kinky tail to you, further sexualizing your coated body[end if].";
	if Cock Count of Player > Cock Count of rubber tigress companion, now Cock Count of rubber tigress companion is Cock Count of Player;
	if Cock Length of Player > Cock Length of rubber tigress companion, now Cock Length of rubber tigress companion is Cock Length of Player;
	if Ball Size of Player > Ball Size of rubber tigress companion, now Ball Size of rubber tigress companion is Ball Size of Player;
	if Cunt Count of Player > Cunt Count of rubber tigress companion, now Cunt Count of rubber tigress companion is Cunt Count of Player;
...
to say artemisnap_mod:
	if HP of rubber tigress companion < 11:
		...
		if HP of rubber tigress companion > 11 and location of Player is State Fair and ( Cock Count of rubber tigress companion > 0 or Cunt Count of rubber tigress companion > 0 ):
			say "     With you nice and sealed up, she wastes no time quickly goes off in search of some companionship. Knowing full well what she wants, she struts around with confidence in her new [if rubber tigress companion is herm]herm[else if rubber tigress companion is male]male[else if Player is female]female[end if] form, sleepwalking your body with considerable grace after all her practice. And while she draws the attention of a few of the other critters around, she passes them by until she locates one of the feline tigresses. Once found, there is no hesitation before Artemis gives a lustful mrowl and strides towards the other feline. Putting their arms around one another, they purr and run their paws over each other. And what starts initially as stroking and petting soon turns to groping and grinding as the aroused felines kiss.";
			say "[artemisSF_sex_mod]";
		else if a random chance of 2 in 5 succeeds or HP of rubber tigress companion is 11:
			say "[artemis_mast_mod]";
		else:
			say "[artemis_sex_mod]";
		if HP of rubber tigress companion is 11, now HP of rubber tigress companion is 12;
...
[	let NN be a random number from 1 to 3;]
	if HP of rubber tigress companion is 11 or NN is 1:
...
to say artemisengulf_nap_mod_01:
	...
	if Cunt Depth of Player > Cunt Depth of rubber tigress companion, now Cunt Depth of rubber tigress companion is Cunt Depth of Player;
	if Cunt Tightness of Player > Cunt Tightness of rubber tigress companion, now Cunt Tightness of rubber tigress companion is Cunt Tightness of Player;
	say "     As you're getting ready to lie down and take a nap, the rubber tigress pads over to you, snuggling up at your feet[if location of Player is State Fair and artemisstatefairrt is false] and seeming more eager than usual about naptime[end if]. Having a pretty good idea what she really has in mind, you pet her head and decide to just go with it. You'll get your rest and even some kinky dreams while she gets her much-needed release. Once again, as you're drifting off into slumber, she starts to spread over you[if scalevalue of Player > 3]. It takes some extra time and stretching to be able to cover your [Body Size Adjective of Player], [bodydesc of Player] body, but the prospect of being bigger as well makes it well worth the effort for her[end if]. By this point, you don't resist, instead letting her flow out and cover you. The feel of her forming tightly around you, even reshaping you a little to make you into a [if Cock Count of rubber tigress companion > 0 and Cunt Count of rubber tigress companion is 0]girlish tiger[else]sexy tigress[end if][if BodyName of Player is listed in infections of TaurList] taur[end if] made of rubber.";
	say "     Adding to this is the increasingly pleasurable sensation of her rubbery goo flowing [if Player is herm]over and into you dual genitals[else if Player is male]over your cock[smn][else if Player is female]into your cunt[sfn][else]into your back passage[end if][if lust of rubber tigress companion is 1 and Cunt Count of Player is 0] as her dripping pussy takes its place at your crotch[else if thirst of rubber tigress companion is 1 and Cock Count of Player is 0] as her throbbing shaft takes its place at your crotch[end if][if thirst of rubber tigress companion is 3]. Added to that comes the addition of the tigress's sextoy tail to your rubberized form[end if]. The final moments with her covering your head and going down your throat is still a little disconcerting, but as that's ending[if lust of rubber tigress companion is 2] and her pussymouth flows into yours[else if thirst of rubber tigress companion is 2]cocktongue settles into place[end if], you drift off into a more passive state, sleepwalking along as she uses your body as her own.";
...
This is the Artemis' Epilogue rule:
	if rubber tigress companion is tamed:
