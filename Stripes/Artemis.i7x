	...
	if HP of rubber tigress is 11:
		...
		if location of player is State Fair:
			...
			if a random chance of 1 in 1 succeeds:				[more variations to come]
				...
				if anallevel > 1 and ( cocks of player > 0 and cunts of player is 0 ) and ( a random chance of anallevel in 12 succeeds or ( player is mpreg_ok and a random chance of 1 in 12 succeeds ) or ( player is submissive and a random chance of 1 in 12 succeeds ) ) and guy is not banned:
				...
				else if ( cocks of player > 0 and cunts of player is 0 ) or ( cocks of player > 0 and cunts of player > 0 and a random chance of 1 in 2 succeeds ):		[M/F bottom]
				...
				else if cunts of player > 0:		[M/F top]
					say "[randombodypart]"; [yields male 'bodyselector']
...
to say artemissex10:	[vagina]
	if cocks of player > 0 and a random chance of 2 in 3 succeeds:
		...
		if a random chance of 1 in 3 succeeds and thirst of rubber tigress is not 0:
			say "[if thirst of rubber tigress is 1]. You reach around for her stiff manhood, stroking that sextoy cock of hers while you screw her in the ass[else if thirst of rubber tigress is 2][one of]. You reach forward to her muzzle, scritching it until that sextoy cocktongue of hers emerges for you to stroke[or]. Leaning overtop of her, you turn her head towards yours, pulling her into a kiss that soon has her sextoy tongue buried in your mouth[at random][else if thirst of rubber tigress is 3][one of]. You run your hand from her ass along her tail, you reach her tail's tip and stroke it, coaxing the black-coloured tip to draw back and reveal her tailcock for you to stroke[or]. Pulling her tail to your mouth, you lick and kiss at its tip, coaxing the ebon dildo hidden within to be reveals for you to suck on while fucking her[at random][end if]";
		say ".";
...
to say artemissex12:	[pussy-mouth]
	if cocks of player > 0 and a random chance of 2 in 3 succeeds:
		...
		if thirst of rubber tigress is 3 and a random chance of 1 in 3 succeeds:
			...
			say ".";
			say "     [one of]Wanting to share in her pleasure, you reach for her tail and bring its phallic tip to your lips. Sliding that black dildo into your mouth, you lick and suck on its living latex. The feel of those stimulating barbs on your tongue is very exciting, making you want to feel them inside [if cunts of player > 0]your cunt[sfn][else if anallevel > 1]your ass[else]a more sensitive hole[end if] sometime soon. Precum dribbles from her ebon tailcock as you work to suck her off even as you fuck her face[or]While you're distracted by fucking her transformed muzzle, she brings her tail around to prod at your [if cunts of player > 0]juicy cunt[else]tight asshole[end if]. You moan in surprise but are unable to stop her as pulling out of her muzzle only pushes you back onto that sneaky tail - not that you particularly want to avoid it, given your state of sexual arousal. That softly barbed member pushes into your needy hole, pistoning and out of you even as you thrust into her. Soon a good rhythm is set, her motions coinciding with yours for the increased pleasure of you both[at random].";
		...
		now libido of player is ( 2 * libido of player ) / 3;
		now libido of rubber tigress is libido of rubber tigress / 4;
[	else if cunts of player > 0 and a random chance of 2 in 5 succeeds:
		say "***frot";]
	else:
...
to artemisnap:
	...
	if HP of rubber tigress >= 11:
		...
		if cocks of player > 0 and cunts of player > 0:		[herm]
			say "     But it's not like she does this for long, having something else she's wanted so much more to enjoy right between her legs. Returning to where you were resting, she takes a seat and reaches down, running her smooth paws over your genitals, hers now as well, mewling softly in pleasure at the sensation. Soon she's masturbating, stroking her [if cocks of player > 1]cocks[else]cock[end if] and fingering her [if cunts of player > 1]pussies[else]pussy[end if]. She plays with herself frantically and with little direction, simply overloading herself on the pleasures of having them. She goes at it for hours, filling your walking dream with the sensation cumming again and again as your juices soak her thighs and your seed is released all across your hijacked body. Eventually, she's finally sated for a time and you pass out fully into sleep.";
			...
			say "     But it's not like she does this for long, having something else she's wanted so much more to enjoy right between her legs. Returning to where you were resting, she takes a seat and reaches down, running her smooth paws over your genitals, hers now as well, mewling softly in pleasure at the sensation. Soon she's masturbating, fingering her [cunt size desc of player] [if cunts of player > 1]pussies[else]pussy[end if] and mrowling happily. She plays with herself frantically and with little direction, simply overloading herself on the pleasures of having them. She goes at it for hours, filling your walking dream with the sensation cumming again and again as she uses your hijacked body to frig you both over and over, letting your juices soak her thighs. Eventually, she's finally sated for a time and you pass out fully into sleep.";
		else:								[neuter]
		...
		if HP of rubber tigress > 7 and location of player is State Fair and ( cocks of player > 0 or cunts of player > 0 ):
			...
			if cocks of player > 0 and cunts of player > 0:		[herm]
				...
				say "     After a bit of time just spent enjoying walking upright and casually feeling up her new body, she settles down to the main event, playing with those wonderful genitals she now possesses. Sliding a paw to [if cunts of player > 1]one of your [cunt size desc of player] cunts[else]your [cunt size desc of player] cunt[end if], she starts running her paw over the wet, sensitive folds. After a little teasing, she pushes a few fingers into the wet cunny and starts pumping away. She finds many a sensitive spot, most delightfully your [if cunts of player > 1]clits[else]clit[end if], and gives particular attention to them. Much less frantic about her masturbation, but just as eager and overjoyed as ever, she plays with herself, and thereby with you, through several orgasms.";
				say "     All this dreamy pleasure has you moan softly, enjoying the feline's control of your body and the delight she takes in enjoying such pleasures you can take for granted at times. She goes at it for quite some time, though time is a difficult concept to hold onto during the erotic dreams of this somnambulistic state. As she's winding down, she delights in running her rubbery paws through the accumulated cum and juices sticking to herself and then licking them up. Eventually, you drift off to a deeper sleep with her still encapsulating you.";
			else:								[neuter]
...
to say artemismod4:
	...
	say "     You kneel beside her, carefully holding the prepped pseudo-cock in one hand and stroking the rubber kitty's belly with the other. She tries to raise up her hips towards you, but you keep your hand on her tummy, keeping her in place. When she turns to look at you and gives another needy mrowl, you push the back end of the toy into her open mouth. She works her rubbery jaw at the sudden intrusion, but the cement has already started to bond and her orange colour begins bleeding into the base of the sex toy.";
...
to say artemisengulf_mod_01:
	...
	if cocks of player > 0 and cunts of player > 0:		[herm setup]
	...
	else if cocks of player > 0:				[male setup]
		...
		if cock length of player > cock length of rubber tigress, now cock length of rubber tigress is cock length of player;
		if cock width of player > cock width of rubber tigress, now cock width of rubber tigress is cock width of player;
	else if cunts of player > 0:				[female setup]
...
to say artemisengulf_SF_mod01:
	...
	if artemisstatefairrt is false:
		...
		say "     While your first response is to get ready to fight, you relax and instead let Artemis continue to engulf you, even pressing your hands into the flowing rubber while smiling at the buxom tigress watching you both. ";
	say "     The buxom rubber tigress seems quite [one of]startled but[or]intrigued and[or]amazed but[or]nervous but[at random] neither move towards nor away from the strange events she's witnessing. As Artemis is spreading further over you, you can feel her flowing over your nethers, exposing their rubber-coated state to the feline voyeur. Not even quite aware yet of what she's doing, the feline has begun to finger herself as she witnesses the ongoing transformation and merging of the four-footed tigress with you. You can't help but moan, a little louder than usual for added show as you feel the flowing tigress [if cocks of player > 0 and cunts of player > 0]spreading over your dual genders and pushing into you to flow into your cunt[sfn][else if cocks of player > 0]spreading over your throbbing cock[smn][else if cunts of player > 0]spreading across your wet folds and then pushing into you to flow into your cunt[sfn][end if][if cunts of player is 0 and lust of rubber tigress is 1]. You end up gaining the tigress's juicy pussy as part of the union, the sudden pleasure of its addition making you pant heavily[else if cocks of player is 0 and thirst of rubber tigress is 1]. You end up gaining the tigress's dribbling cock as part of the union, the sudden pleasure of its addition making you pant heavily[end if][if anallevel > 1]. And another groan of kinky pleasure comes when more flowing rubber presses at your back entrance, pushing it open with ease so she can coat your inner walls as well[end if].";
	if cocks of player > cocks of rubber tigress, now cocks of rubber tigress is cocks of player;
	if cock length of player > cock length of rubber tigress, now cock length of rubber tigress is cock length of player;
	if cock width of player > cock width of rubber tigress, now cock width of rubber tigress is cock width of player;
	if cunts of player > cunts of rubber tigress, now cunts of rubber tigress is cunts of player;
