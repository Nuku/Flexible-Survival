...
to say artemisdesc:
	...
	otherwise:
		...
		otherwise if lust of rubber tigress is 0 and thirst of rubber tigress is 2:
			say "***";
		otherwise if lust of rubber tigress is 0 and thirst of rubber tigress is 3:
			say "***";
		...
		otherwise if lust of rubber tigress is 1 and thirst of rubber tigress is 1:
		...
		otherwise if lust of rubber tigress is 1 and thirst of rubber tigress is 2:
			say "***";
		otherwise if lust of rubber tigress is 1 and thirst of rubber tigress is 3:
			say "***";
		otherwise if lust of rubber tigress is 2 and thirst of rubber tigress is 0:
			say "     Artemis, as you've called the rubber tigress currently at your side, is built like a feral tiger make of smooth rubber, but with faintly feminine curves.  Her skin is a glossy orange with black stripes and flexes and moves as she pads quietly.  Malformed or incomplete for some reason, the rubber tigress cannot stand upright and was even lacking any gender until you changed that.  Having transformed her muzzle by installing the pussy sextoy into it, she has gained a pleasure-giving pussy instead of a mouth at the end of her feline muzzle.  Noticing you looking at her, she [one of]purrs happily[or]rolls onto her back in search of tummy rubs[or]nuzzles your thigh[or]lightly nuzzles your hand and licks your fingertips with her altered tongue[or]gives a cute, slightly squeaking mew[or]makes a show of slowly licking the pussy folds of her mouth while eying your reaction[at random].";
		otherwise if lust of rubber tigress is 2 and thirst of rubber tigress is 1:
			say "     Artemis, as you've called the rubber tigress currently at your side, is built like a feral tiger make of smooth rubber, but with faintly feminine curves.  Her skin is a glossy orange with black stripes and flexes and moves as she pads quietly.  Malformed or incomplete for some reason, the rubber tigress cannot stand upright and was even lacking any gender until you changed that.  Having now gained a sheath-bound cock at her hindquarters that often pokes free, displaying its sextoy nature, she struts around now with greater confidence.  In addition to that, you have transformed her muzzle by installing the pussy sextoy into it, she has gained a pleasure-giving pussy instead of a mouth at the end of her feline muzzle.  Noticing you looking at her, she [one of]purrs happily[or]rolls onto her back in search of tummy rubs[or]nuzzles your thigh[or]lightly nuzzles your hand and licks your fingertips with her altered tongue[or]gives a cute, slightly squeaking mew[or]makes a show of slowly licking the pussy folds of her mouth while eying your reaction[or]makes a show of slowly running textured tongue of her pussy mouth across her cock while eying your reaction[at random].";
		otherwise if lust of rubber tigress is 2 and thirst of rubber tigress is 2:
			say "ERROR-Artemis-2L+2T-L: Impossible configuration.";
		otherwise if lust of rubber tigress is 2 and thirst of rubber tigress is 3:
			say "***";
		otherwise:
...
to say artemisattack:
	...
	otherwise if thirst of rubber tigress is 1 and a random chance of 1 in 4 succeeds:
	...
	otherwise if lust of rubber tigress is 2 and a random chance of 1 in 4 succeeds:
	...
	otherwise if thirst of rubber tigress is 2 and a random chance of 1 in 4 succeeds:
		say "***";
	otherwise if thirst of rubber tigress is 3 and a random chance of 1 in 4 succeeds:
		say "***";
	otherwise if lust of rubber tigress is 2 or thirst of rubber tigress is 2:
		say "[one of]The rubber tigress swipes at your foe with her paws, hard, plastic claws unsheathed.[or]Sneaking around behind your foe, Artemis pounces on them with an angry mrowl![or]The rubber tigress bites at your enemy with hardened plastic teeth.[or]Artemis bashes herself against your foe, partially deflates and wraps her rubbery hide around them, squeezing down hard and slowing them long enough for you to get in an additional quick strike.[or]Winding her tail around your foe's [if a random chance of 1 in 4 succeeds]arm[otherwise if a random chance of 1 in 3 succeeds]leg[otherwise if a random chance of 1 in 2 succeeds]wrist[otherwise]ankle[end if], the rubber tigress holds them long enough to get in some slashes with sharp claws.[at random]";
	otherwise:
...
to say artemissex1:	[anal]
	...
	say "     Moving in behind her, you press your stiffening member to her anus and easily spread open that rubbery ring.  She mewls in pleasure, her soft, smooth flesh squeezing down around your [cock size desc of player] [cock of player] shaft, milking at it as you fuck her[if thirst of rubber tigress is 1].  You reach around for her stiff manhood, stroking that sextoy cock of hers while you screw her in the ass[otherwise if thirst of rubber tigress is 2]***[otherwise if thirst of rubber tigress is 3]***[end if].  You pound away at the needy kitty, doing your best to satisfy her with a good, long fucking before finally cumming, depositing your sticky seed inside the kitty's rubber insides[if cock width of player > 40], rounding her tummy and making her slosh as she moves for quite a while[otherwise if cock width of player > 20], making her slosh a little as she moves around for a while[end if][if lust of rubber tigress is 2].  She stretches slowly and runs her tongue along the lips of her pussy-like muzzle, purring happily in pleasure[otherwise if lastArtemisglomp >= 8 or hp of rubber tigress < 6].  She stretches slowly and gives a big yawn, giving you a good view of her smooth, rubber maw[end if].";
...
instead of using cup stack:
	if companion of player is rubber tigress:
		...
		otherwise if hp of rubber tigress >= 7 and a random chance of 2 in 9 succeeds:			[offer cup]
			say "     Taking out one of the cups, you kneel down and offer it in hand to the rubber tigress.  She mewls happily and starts [if lust of rubber tigress is 2]licking up chunks of it with her textured tongue while feminine juices drip from her pussy-mouth, mingling with the melting red plastic[otherwise]munching up the cup as you hold it out for her[end if].  With the last of it melting and flowing down across your fingers, she licks at your hand, drawing it off your skin.  There's a slight shiver of pleasure that runs through you as she does this as it feels a bit like when she spreads herself over you.";
...
after using water bottle while companion of player is rubber tigress:
	say "     After finishing off your drink, you notice Artemis looking up at you... or, more appropriately, at your empty bottle.  You toss it to her and she [one of][if lust of rubber tigress is 2]drools her pussy juices onto it[otherwise]chomps onto it[end if], melting the plastic into clear goo and swallowing it down[or]pounces atop it, flattening it down before licking up one end and [if lust of rubber tigress is 2]slurping it into her vaginal muzzle as her pussy juices cause liquify the plastic[otherwise]sliding it into her mouth whole to melt and slide down her throat[end if][or]bats it around for a bit before eating it[at random].";
...
[***]
		...
		if calcnumber >= 0 and calcnumber < 10:
			...
			otherwise if calcnumber is 1 and lust of rubber tigress is 0:
				say "[artemismod1]";
			otherwise if calcnumber is 2 and lust of rubber tigress is 0 and thirst of rubber tigress is not 2:
				say "[artemismod2]";
			otherwise if calcnumber is 3 and thirst of rubber tigress is 0:
				say "[artemismod3]";
...
to say artemispostmod:
	...
	otherwise if thirst of rubber tigress is 1 and tempthirst is not 1:		[gained cock]
		...
		otherwise:
			...
			otherwise if lust of rubber tigress is 2:	[possesses a mouth-pussy]
...
to say artemis_pm1:	[post-mod, fucking the new pussy]
	...
	otherwise if thirst of rubber tigress is 3:
		say "***";
	say "     You do your best to make it last for the needy kitty, but eventually you can't deny your own cascading arousal and cum hard.  You pump your sticky, hot load into the mrowling feline as she soaks her thighs in juices from her stuffed cunt[if thirst of rubber tigress is 1].  Her latex penis pulses and throbs in your hand, spraying its thick semen across the ground, pumping it even as you pump your own load into her[otherwise if thirst of rubber tigress is 2]***[otherwise if thirst of rubber tigress is 3]***[end if].  After pulling out, you give her rubbery pussy a light fingering, feeling pleased at having been able to help your poor kitty pet.";
	now lastfuck of rubber tigress is turns;
