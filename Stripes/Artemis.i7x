		...
		if location of player is State Fair:
			...
			if lastfuck of rubber tigress - turns >= 24:
				...
				if a random chance of 1 in 3 succeeds:
					...
					say "     After having covered the rest of your [body size of player], [bodydesc of player] body, all that remains is your head. With her head still largely intact, but clearly softening in preparation of what's to come, she gives you a tender smile and presses her flowing muzzle to your lips in a kiss. As you moan into your kiss, her gooey latex tongue presses into your mouth, playing with your tongue briefly before it continues to stretch out and flow down your throat, coating your insides. As her features start to settle into place, you start to drift off into the orange-tinted dreamscape that leaves your body hers to control. After a quick stretch and a playful grope that you share sensation of, she stashes your gear and heads off in search of someone to play with.";
			if a random chance of 1 in 1 succeeds:				[more variations to come]
...
to say artemisengulf_mod_02:
	...
	if a random chance of 1 in 3 succeeds:
		...
		say "     After having covered the rest of your [body size of player], [bodydesc of player] body, all that remains is your head. With her head still largely intact, but clearly softening in preparation of what's to come, she [if lust of rubber tigress is 2]runs her tongue teasingly across the labial folds of her lips[else if thirst of rubber tigress is 2]lets the tip of her dribbling cocktongue poke from her lips[else]gives you a tender smile[end if] and presses her flowing muzzle to your lips in a kiss. As you moan into your kiss, her [if thirst of rubber tigress is 2]penile tongue presses into your mouth, drooling flowing rubber goo down your throat, coating your insides. Her cocktongue flows across the rubber coating your tongue and joins with it, giving you a living latex dildo in your forming feline muzzle[else if lust of rubber tigress is 2]gooey latex tongue presses into your mouth, playing with your tongue briefly before it continues to stretch out and flow down your throat, coating your insides. Her vaginal maw joins with the feline muzzle you're forming, allow you to share in the delights of her sexualized mouth[else]gooey latex tongue presses into your mouth, playing with your tongue briefly before it continues to stretch out and flow down your throat, coating your insides[end if]. As her features start to settle into place, you start to drift off into the orange-tinted dreamscape that leaves your body hers to control. She gives a quick stretch and a playful grope that you share sensation in while she prepares for the next phase of her fun [if daytimer is day]day[else]night[end if] out.";
