...
to say losetofireelemental:
	if BodyName of Player is "Reindeer":
		...
		say "     [if Player is herm]Her warm, deft hand is soon alternating between your cock[smn] and puss[yfn], her fiery, cracked flesh oddly soothing as she works them over, sending hot waves of pleasure through you, causing you to moan slightly around her nipple as[else if Player is male]Her warm, deft hand is soon stroking your cock[smn], her fiery, cracked flesh oddly soothing as she works you over, sending hot waves of pleasure through you, causing you to moan slightly around her nipple as[else if Player is female]Her warm, deft fingers are soon sinking into your quivering cunt, her fiery, cracked flesh oddly soothing as she gently fingers you, sending hot waves of pleasure through you, causing you to moan slightly around her nipple as[else]As her warm, deft hands continue to tease your body and her heat continues to engulf you, hot waves of pleasure roll through you and[end if] your world descends into a warm, fiery bliss...";
		...
		say "[fireelsex]";
	else if HP of Player > MaxHP of Player / 4:
		...
		say "     [if HP of Player > 0]As you submit, she looks down at your burnt and battered form from having fought so long[else]The fiery woman looks down at your burnt and battered form, clearly displeased that you would oppose her[end if]. She runs a hand gently across your cheek. 'It would be better for you not to fight. Fire is light and warmth, passion and love...' Her lips are a touch searing as they press themselves to your cheeks, but your flesh is unmarred. 'You would find me much more enjoyable if you were to accept that.'";
...
When Play begins:
	...
	now Species Name entry is "Fire Elemental"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now Name entry is "Fire Elemental";
	...
	now MilkItem entry is "fire elemental milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "fire elemental cum"; [ Item to be given to the player if they have this infection and jerk off. ]
