...
after going down from 2F Trevor Labs when the HP of Doctor Matt > 2 and HP of Orthas is 0 and Orthas is visible:
	...
	say "     ([link]N[as]n[end link]) - Not right now, you got things to do. (WIP - you currently can't to this later)";
	if player consents:
		LineBreak;
		...
		say "     ([link]N[as]n[end link]) - Not right now, no. (WIP - you currently can't to this later)";
		if player consents:
			LineBreak;
			...
			if player consents:
				...
				if player is male: [male or herm player]
					...
					say "     ([link]N[as]n[end link]) - You'll pass.";
					if player consents:
						say "     Accompanying Orthas on her way upstairs, you are right with her as the dragoness steps up to the doctor, then slowly tells him about the vagely remembered encounter she had in the sublevels of the lab, as well as the aftermath sex between you and her. Dr. Matt listens attentively, then nods in understanding. He clears his throat and looks from you to Orthas as he says, 'Well, I think I know what's happened. Orthas, the organ you described is an ovipositor in all likelyhood. What that means is, when you are inseminated, you will be able to... implant eggs into willing or unwilling subjects. It's actually something that is most common in insects, but some fish and turtles have them too. As do seahorses.' Brows knitting in concern, Orthas replies sarcastically, 'Oh, that's so much of a relief then. Me being an insect-fish-turtle mutant. But wait - what did I pump out then when we fucked?'";
