...
instead of conversing the Orthas:
	...
	otherwise if hp of Orthas is 3:
	...
	otherwise if hp of doctor matt >= 8 and hp of Orthas is 4:		[finished Main Storyline 1 + Orthas task 1 w/Dragon egg]
		say "[orthas_task2_start]";
		now hp of Orthas is 5;
	otherwise if hp of Orthas is 4:
	...
	otherwise if hp of Orthas is 5 or ( hp of Orthas is 6 and footlocker is not owned ):
	...
	otherwise if hp of Orthas is 6:
		say "[orthas_task2_done]";
		now hp of Orthas is 7;
	otherwise if hp of Orthas is 7:
...
after going down from 2F Trevor Labs when the hp of doctor matt is greater than 2 and hp of Orthas is 0 and orthas is visible:
	...
	say "((This arc written by Khabi))[line break]";
...
to say orthas_task2_done:
	...
	if cocks of player > 0:
		...
		while ( cunts of player is 0 and calcnumber is 1 ) or ( calcnumber < 1 or calcnumber > 3 ):
			say "Choice? ([if cunts of player > 0]1[otherwise]2[end if]-3)>[run paragraph on]";
			get a number;
		if calcnumber is 1:
...
to say orthasfuck:
	if orthas is not visible:
		say "Who?";
	otherwise if hp of Orthas is less than 2:
		say "'I am flattered, really, but no thank you.'";
	otherwise if lastfuck of Orthas - turns is less than 12:
	...
	otherwise:
		...
		otherwise: [ Herm ]
			if hp of Orthas >= 7 and a random chance of 1 in 2 succeeds and bodyname of player is not listed in infections of TaurList:
				...
				say "[link]Vaginal (y)[as]y[end link] or [link]anal (n)[as]n[end link]?";
			otherwise:
			...
			otherwise if "MPreg" is listed in feats of player:
				if hp of Orthas >= 7 and a random chance of 1 in 2 succeeds and bodyname of player is not listed in infections of TaurList:
					say "     Sitting on the edge of her desk, Orthas pulls you up into her lap, readying to drive that phallic tendril of hers into you.  With your hand to guide it, you aim it towards your back door and moan as it wriggles into you.  It worms its way into your rectum with with delightful pulses.  Soon it's squirmed deep inside you and is nudging at that hidden second entrance to your womb.  At this point, your far too lustfully excited by the prospect of what is to come to think better of it.  You start riding that undulating ovipositor for all you're worth while it works to tease that final barrier loose.  With her tentacle [']cock['] rubbing along your sensitive rectal walls and pulsing against your prostate, she's able to drive you to another orgasm just as her egg is nudging its way past your anal ring.  Travelling through her rippling [']member['], it passes through your spasming tunnel and - with a few mind-numbingly pleasurable pushes - pops past your secondary cervix to be deposited in your womb.  This sends a kinky thrill through you and you masturbate yourself, both cock and pussy, until you're fully spent from your orgasm.";
				otherwise:
...
When play ends:
	...
	otherwise if hp of Orthas is 7 and humanity of player is greater than 10 and hp of doctor matt <= 100:
