...
to say losetobluechaffinch:
	...
	if Player is female:
		say "     The victorious male pushes you over roughly and gets his stiff cock lined up with your pussy with little preamble. His taloned hands grip your [if scalevalue of Player > 4]hips[else if scalevalue of Player is 4]sides[else]shoulders[end if] and pull you back onto his avian rod. The slick, tapered cock pushes into you easily, causing you to moan in pleasure despite yourself. Soon the feathered fellow is drilling into you, chirping occasionally as he does.";
		WaitLineBreak;
		say "     You grow increasingly aroused as the mating continues, his soft feathers rubbing against your hips, thighs and pussy lips as he thrusts into you. As you're [if HP of Player > 0]not[else]no longer[end if] resisting his advances, he lets his taloned hands roam over your [bodytype of Player] body and leans gently overtop you, letting his fluffy chest rub against your back. Between the soft feathers rubbing against you and the hard cock pumping inside you finally you both cum loudly[if FaceName of Player is Name entry], your mating song joining in with his[else] with him chirping and moaning[end if] as his hot seed pumps into your cunt and flows into your womb.";
		...
		CreatureSexAftermath "Player" receives "PussyFuck" from "Blue Chaffinch";
	else:
		...
		CreatureSexAftermath "Player" receives "OralCock" from "Blue Chaffinch";
...
to say bluecf_catching:
	...
	say "[line break]You roll 1d20([dice])[if bonus >= 0]+[end if][bonus] = [special-style-1][dice + bonus][roman type] vs [special-style-2][targetnum][roman type] (Dexterity Check):[line break]";
	if dice + bonus >= targetnum:
		if bluechaffrape < 3 or inasituation is true:
			...
			if bluechaffrape < 2:
				...
				say "     The feel of that tight little bird's ass clamping down onto your throbbing shaft as he climaxes feels wonderful. Grabbing the nape of his neck sharply with your beak, you grip him tightly and plow into him one last time, unleashing your hot seed and filling his bowels. Your [Cum Load Size of Player] load [if Ball Size of Player > 5]bloats the poor songbird so much that some of it leaks out of his beak as he becomes rounded like a feathery balloon[else if Ball Size of Player > 4]bloats the poor songbird until rounded like a feathery balloon[else if Ball Size of Player > 3]gives the poor songbird a somewhat chubbier look as his belly is stuffed quite full with your seed[else]makes the poor songbird's ass wet and creamy[end if].";
				WaitLineBreak;
				say "     But you're not done with him this time. After a short break, you resume thrusting, wanting a second go at your prize prey. He releases some moans and chirps, his body again betraying him as he gets hard. 'Oh, you like that, don't you, prey?' you tease, stroking his shaft and nip at his shoulders and neck firmly. 'You're just a tasty little morsel, aren't you?' you taunt. While the more human part of you just wants to scare him into leaving you alone, the [BodySpeciesName of Player in lower case] part of you is excited by the wild, predatory desires and power you're wielding over your appetizing victim. More nips and bites lead to a rush of coppery excitement as you get a bit too rough, the taste of his blood causing you to shriek and cum hard into him as he sings along in lustful release, cumming powerfully as well. [if Ball Size of Player > 5]Already overfull from the last load, there's room for no more and it overflows from his beak until you're drained and he's left coughing and weak from being so bloated. He gives a weak, gurgling chirp when you pull out, but is also in a blissful haze from his two powerful orgasms. Chuckling, you rock the birdie on his rounded belly before leaving him behind to drain and deflate[else if Ball Size of Player > 4]Already overfull from the last load, there's nowhere for the rest of it to go but overflowing out of his beak this time until you're drained and he's left coughing and weak from being so bloated. He gives a weak, gurgling chirp when you pull out, but is also in a blissful haze from his two powerful orgasms. Chuckling, you rock the birdie on his rounded belly before leaving him behind to drain and deflate[else if Ball Size of Player > 3]Already quite full from your previous release, this second one leaves him full and rounded like a feathery balloon. He gives a weak chirp when you pull out, but is also in a blissful haze from his two powerful orgasms. Chuckling, you give the birdie a swat on his leaking ass, leaving him behind to drain and deflate[else]His asshole, already quite messy before your sloppy seconds on him, overflows somewhat with this fresh, creamy load. He gives a weak chirp when you pull out, but is also smiling a little from his two powerful orgasms. Chuckling, you give the birdie a swat on his leaking ass, leaving him behind to drain and recover[end if].";
			...
			WaitLineBreak;
			say "     Steady, hard thrusts into your rather willing victim has him panting and chirping with growing excitement. You make sure to tease him some more when he reaches back to stroke his own cock, calling him your birdie bitch and your songbird slut. He blushes at these names but doesn't stop, if anything, his anus squeezing and milking at your cock all the more. As you feel yourself getting closer, you pick up the pace, digging your talons in harder and taking his thin leg in your beak, pulling him sharply upwards onto your impaling rod. After a few hard tugs that have him moaning and chirping even as red runs down his leg, you feel your balls tighten and your shaft pulse as you start feeding your hot, [Cum Load Size of Player] load into his ass. [if Ball Size of Player > 5]Your [Cum Load Size of Player] output causes the blue passerine's belly to swell and bloat until he's a rounded ball of feathers with excess cum leaking from his beak as he moans and cums[else if Ball Size of Player > 4]Your [Cum Load Size of Player] output causes the blue passerine's belly to swell and bloat until he's a rounded ball of feathers as he moans and cums[else if Ball Size of Player > 3]Your [Cum Load Size of Player] output causes the blue passerine's belly to bulge a little as he moans and cums[else]The feel of your [Cum Load Size of Player] output pumping into him causes the blue passerine to moan and cum[end if] in delight.";
			say "     Releasing his leg from your beak and pulling out, you let him drop to the ground and chuckle at what a fine prey slut he's become and add that you just might want to keep him. [if Ball Size of Player > 4]Rolling[else]Falling[end if] over onto his side, he moans softly and struggles to get up. 'W-were you serious about that? A-about really... keeping me?' he says with a mix of trepidation and anticipation in his voice. How shall you respond?";
			if Player consents:
				LineBreak;
...
to say bluecf_pouncing:	[feline]
	...
	if dice + bonus >= targetnum:
		if bluechaffrape < 3 or inasituation is true:
			...
			WaitLineBreak;
			say "     Pinning the songbird down, you give a harsh snarl that sends a shiver through your prey that excites you. Quite hard from the chase, you push aside his crumpled tailfeathers and shove your cock underneath. Taking the nape of his neck in your jaws, you grip him roughly and drive your [cock size desc of Player] [Cock of Player] shaft into him. He gives a very refreshing warble at being roughly taken, making the corners of your muzzle turn up in a smile[if Cock Length of Player > 24]. Your pulsing rod throbs inside the little guy, stuffing him so delightfully full that you can see a big bulge of ruffled feathers from your oversized phallus plowing into him[else if Cock Length of Player > 12]. Your pulsing rod throbs inside the little guy, stuffing him so full that you can see a small bulge of puffed feathers from your enlarged phallus inside him[end if].";
			if bluechaffrape < 2:
				...
				WaitLineBreak;
				say "     But you're not done with him this time. After a short break, you resume thrusting, wanting a second go at your prize prey. He releases some moans and chirps, his body again betraying him as he gets hard. 'Oh, you like that, don't you, prey?' you tease, stroking his shaft and nip at his shoulders and neck firmly. 'You're just a tasty little morsel, aren't you?' you taunt. While the more human part of you just wants to scare him into leaving you alone, the [BodySpeciesName of Player in lower case] part of you is excited by the wild, predatory desires and power you're wielding over your appetizing victim. More nips and bites lead to a rush of coppery excitement as you get a bit too rough, the taste of his blood causing you to growl and cum hard into him as he sings along in lustful release, cumming powerfully as well. [if Ball Size of Player > 5]Already overfull from the last load, there's room for no more and it overflows from his beak until you're drained and he's left coughing and weak from being so bloated. He gives a weak, gurgling chirp when you pull out, but is also in a blissful haze from his two powerful orgasms. Chuckling, you rock the birdie on his rounded belly before leaving him behind to drain and deflate[else if Ball Size of Player > 4]Already overfull from the last load, there's nowhere for the rest of it to go but overflowing out of his beak this time until you're drained and he's left coughing and weak from being so bloated. He gives a weak, gurgling chirp when you pull out, but is also in a blissful haze from his two powerful orgasms. Chuckling, you rock the birdie on his rounded belly before leaving him behind to drain and deflate[else if Ball Size of Player > 3]Already quite full from your previous release, this second one leaves him full and rounded like a feathery balloon. He gives a weak chirp when you pull out, but is also in a blissful haze from his two powerful orgasms. Chuckling, you give the birdie a clawed swat on his leaking ass, leaving him behind to drain and deflate[else]His asshole, already quite messy before your sloppy seconds on him, overflows somewhat with this fresh, creamy load. He gives a weak chirp when you pull out, but is also smiling a little from his two powerful orgasms. Chuckling, you give the birdie a clawed swat on his leaking ass, leaving him behind to drain and recover[end if].";
			...
			WaitLineBreak;
			say "     Steady, hard thrusts into your rather willing victim has him panting and chirping with growing excitement. You make sure to tease him some more when he reaches back to stroke his own cock, calling him your birdie bitch and your songbird slut. He blushes at these names but doesn't stop, if anything, his anus squeezing and milking at your cock all the more. As you feel yourself getting closer, you pick up the pace, digging your claws in harder and taking his thin leg in your muzzle, pulling him sharply upwards onto your impaling rod. After a few hard tugs that have him moaning and chirping even as red runs down his leg, you feel your balls tighten and your shaft pulse as you start feeding your hot, [Cum Load Size of Player] load into his ass. [if Ball Size of Player > 5]Your [Cum Load Size of Player] output causes the blue passerine's belly to swell and bloat until he's a rounded ball of feathers with excess cum leaking from his beak as he moans and cums[else if Ball Size of Player > 4]Your [Cum Load Size of Player] output causes the blue passerine's belly to swell and bloat until he's a rounded ball of feathers as he moans and cums[else if Ball Size of Player > 3]Your [Cum Load Size of Player] output causes the blue passerine's belly to bulge a little as he moans and cums[else]The feel of your [Cum Load Size of Player] output pumping into him causes the blue passerine to moan and cum[end if] in delight.";
			say "     Releasing his leg from your beak and pulling out, you let him drop to the ground and chuckle at what a fine prey slut he's become and add that you just might want to keep him. [if Ball Size of Player > 4]Rolling[else]Falling[end if] over onto his side, he moans softly and struggles to get up. 'W-were you serious about that? A-about really... keeping me?' he says with a mix of trepidation and anticipation in his voice. How shall you respond?";
			if Player consents:
				LineBreak;
				...
				LineBreak;
				say "     Laughing, you give his ass a slap. Why would you want to keep him now that the fun of breaking him is over, you ask. He blushes at this and clutches at your leg, but you push him away, telling him that surely one of the other big felines around would love to sink their claws into the songbird, if that's all he wants. His shoulders sag and he struggles to his feet, limping away slowly. You smile to yourself; it seems that's finally over with.";
			now area entry is "Nowhere";
			CreatureSexAftermath "Blue Chaffinch" receives "AssFuck" from "Player";
	else:
...
When Play begins:
	...
	now Species Name entry is "Blue Chaffinch"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Blue Chaffinch" to infections of AvianList;
	add "Blue Chaffinch" to infections of FurryList;
	add "Blue Chaffinch" to infections of NatureList;
	add "Blue Chaffinch" to infections of MaleList;
	add "Blue Chaffinch" to infections of TaperedCockList;
	add "Blue Chaffinch" to infections of InternalCockList;
	add "Blue Chaffinch" to infections of InternalBallsList;
	...
	now attack entry is "The [one of]blue chaffinch[or]energetic avian[or]blue songbird[or]passerine male[or]male songbird[at random] [one of]snaps at you with his pointed beak[or]buffets you with his wings[or]flaps up a few feet and slashes at you with his foot claws[or]claws at you with his taloned hand[at random]!";
	...
	now ass change entry is "your hips throb and ache. Your spine pops and your hips shift slightly as a feathery tail forms over your ass";
	now cock change entry is "it pulses and spurts cum. With each throbbing shot, it changes a little more until it's got a decidedly avian shape";
	...
	now MilkItem entry is "blue chaffinch milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "blue chaffinch cum"; [ Item to be given to the player if they have this infection and jerk off. ]
