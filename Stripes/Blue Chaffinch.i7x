...
to say losetobluechaffinch:
	...
	if Player is female:
		...
		WaitLineBreak;
		say "     You grow increasingly aroused as the mating continues, his soft feathers rubbing against your hips, thighs and pussy lips as he thrusts into you[if HP of Player > 0]. As you're not resisting his advances[else]. As you're no longer resisting his advances[end if], he lets his taloned hands roam over your [bodytype of Player] body and leans gently overtop you, letting his fluffy chest rub against your back. Between the soft feathers rubbing against you and the hard cock pumping inside you finally you both cum loudly[if FaceName of Player is Name entry], your mating song joining in with his[else] with him chirping and moaning[end if] as his hot seed pumps into your cunt and flows into your womb.";
...
to say bluecf_ap_sex:
	...
	if bluechaffrape < 2:
		...
		say "     The feel of that tight little bird's ass clamping down onto your throbbing shaft as he climaxes feels wonderful. Grabbing the nape of his neck sharply with your beak, you grip him tightly and plow into him one last time, unleashing your hot seed and filling his bowels[if Ball Size of Player > 5]. Your [Cum Load Size of Player] load bloats the poor songbird so much that some of it leaks out of his beak as he becomes rounded like a feathery balloon[else if Ball Size of Player > 4]. Your [Cum Load Size of Player] load bloats the poor songbird until rounded like a feathery balloon[else if Ball Size of Player > 3]. Your [Cum Load Size of Player] load gives the poor songbird a somewhat chubbier look as his belly is stuffed quite full with your seed[else]. Your [Cum Load Size of Player] load makes the poor songbird's ass wet and creamy[end if].";
		WaitLineBreak;
