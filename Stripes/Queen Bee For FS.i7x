...
When Play begins:
	...
	now body change entry is "you are transformed to once-again become the sexy [if cunts of player is 0][']queen['][otherwise]queen[end if] bee.  Your figure is tall and [if cunts of player > 0]womanly[otherwise]effeminate[end if], with a slender waist and curved hips that draw the eye to your beautiful form.  As the transformation spreads up, you form a furred collar and your shimmering wings to be your regal cloak";
