...
when play begins:
	...
	add Quiet Apartment Building to BadSpots of MindcontrolList;
...
to say mouseapts:
	...
	if Player is male:
		...
		if Player is female:
			...
			say "     Eyeing her eight inch, throbbing manmeat, you can sense her mind, the collective mind, seeking how you'd prefer to enjoy it. Shall you [link]suck her off (Y)[as]y[end link] or stretch out and let her [link]fill your ass (N)[as]n[end link]?";
			if Player consents:
				LineBreak;
	...
	if humanity of Player < 10:
		...
		ForceCompanionJoin "Rachel";
		say "[line break]     (Rachel the mouse girl is now a possible ally! You can make her your active ally by typing [link][bold type]ally Rachel[roman type][end link] or [link][bold type]ally mouse girl[roman type][end link] and initiate sex with her while active by typing [link][bold type]fuck Rachel[roman type][end link]. You can see all the allies you have with the [link][bold type]allies[roman type][end link] command. Allies will lower the XP you gain from battle, but can gain levels themselves to be more useful in a scrap. Want to get rid of an ally? Use [link][bold type]ally dismiss[roman type][end link], or just [link][bold type]dismiss[roman type][end link].), but then the mouse collective will be tracking you again.)";
...
The summondesc of mouse girl is "     [if Rachel is visible]Rachel stands up from where she was meditating. Without a word, she comes to stand by your side[else]Walking up to join you before you even call out for her, Rachel the mouse girl grins up at you[end if].[line break]".
...
Scent of mouse girl is "[RachelScent]".
rachelfuck is a number that varies.
The icon of mouse girl is Figure of Rachel_icon.

to say DismissRachel:
	move Rachel to Pantry;
	say "     [if Player is not in Pantry]Before you can say a word, Rachel comes up behind you. 'Alright, I'll head back to the library then. See you soon.' With that, she makes her way back[else]Rachel goes back to her meditating, saying she will continue to commune with the rest of the collective[end if].";
...
Rachel is a woman.
ScaleValue of Rachel is 2. [small sized]
SleepRhythm of Rachel is 0. [0 - awake at all times, 1 - day active, 2 - night active]
Body Weight of Rachel is 4. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Rachel is 3. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
[Body Adjective is generated out of the body weight and body definition and can be used in scenes - one word descriptive adjective depending on weight and definition groups: low weight group: skinny/slender/lithe; mid weight group: average/fit/muscled; high weight group: pudgy/husky/jacked]
Androginity of Rachel is 8. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Rachel is 4. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Rachel is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Rachel is 4. [length in inches]
Breast Size of Rachel is 5. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Rachel is 2. [count of nipples]
Asshole Depth of Rachel is 8. [inches deep for anal fucking]
Asshole Tightness of Rachel is 2. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Rachel is 1. [number of cocks]
Cock Girth of Rachel is 3. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Rachel is 8. [Length in Inches]
Ball Count of Rachel is 2. [allowed numbers: 1 (uniball), 2 or 4]
Ball Size of Rachel is 3. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
Cunt Count of Rachel is 1. [number of cunts]
Cunt Depth of Rachel is 8. [penetratable length in inches; some minor stretching allowed, or more with Twisted Capacity]
Cunt Tightness of Rachel is 2. [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
Clit Size of Rachel is 2. [size 1-5, very small/small/average/large/very large]
[Basic Interaction states as of game start]
PlayerMet of Rachel is false.
PlayerRomanced of Rachel is false.
PlayerFriended of Rachel is false.
PlayerControlled of Rachel is false.
PlayerFucked of Rachel is false.
OralVirgin of Rachel is false.
Virgin of Rachel is false.
AnalVirgin of Rachel is true.
PenileVirgin of Rachel is false.
SexuallyExperienced of Rachel is true.
TwistedCapacity of Rachel is false. [Twisted Characters can take any penetration, no matter the size]
Sterile of Rachel is false. [steriles can't knock people up]
MainInfection of Rachel is "Mental Mouse".
Description of Rachel is "[RachelDesc]".
fuckscene of Rachel is "[SexWithMousegirl]".
Scent of Rachel is "[RachelScent]".
icon of Rachel is Figure of Rachel_icon.
...
to say RachelTalk1:
	say "     '[one of]Can you feel the others? Even though we are separated, I can feel them everywhere!'[or]I hope that you decide to join the collective soon. Everything is just better once you give yourself fully to the hive-mind.'[at random]";
...
to say sexwithmousegirl:
	...
	if lastfuck of mouse girl - turns < 4:
		...
		if Player is herm:
			...
			if T < 3: [1-2]
				say "[if Player is male][rachelsexmale1][else][rachelsexfemale1][end if]";
			else if T < 5: [3-4]
				say "[if Player is male][rachelsexmale2][else][rachelsexfemale2][end if]";
			else:
				say "[racheloral]";
		now lastfuck of mouse girl is turns;
...
An everyturn rule:
	if mouse girl is listed in companionList of Player and skipturnblocker is 0:
		...
		if a random number from 40 to 200 < Libido of Player and lastfuck of mouse girl - turns >= 4: [lust check vs 200, player libido 40 or less auto-wins]
			say "[sexwithmousegirl]";
		if Libido of Player > 100, now Libido of Player is 100;

to say rachelsexmale1:
	say "     Sensing your growing arousal, Rachel runs her paws over your body, then down to your cock. Your erection throbs in her paw and is soon in the cute mouse's mouth. She licks and sucks on it briefly before moving onto all fours and raising her tail for you. Seeing those wet folds waiting for you, you move atop her small body, lining up your erection before sinking it into her snug, squeezing grip. She squeaks and moans beneath you as you thrust. Your [if Cock Length of Player > 18]huge penis stretches her out considerably, but she takes it all,[else if Cock Length of Player > 12]large penis bulges her slender waist as you fuck her, but she takes it all,[else]penis throbs inside her, taking it all and[end if] happy to share herself with you. You pound into your murine mate until you both cum together, sharing in the sensations of your lovemaking as your minds touch.";
	increase rachelfuck by 1;
	now Libido of Player is ( Libido of Player + 1 ) / 3;
