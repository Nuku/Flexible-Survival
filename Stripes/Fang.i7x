...
to say fangsandramount:
	say "     Moving in behind Fang, you get your throbbing cock lined up with his tail-hole, then drive it into him as he thrusts into the bunny. Fang releases a soft whimper, but takes your cock easily enough in his experienced hole. Sandra, meanwhile, moans loudly as this forces the wolf's knot into her, tying them together. 'Oh yes,' she cries, 'Gimme that knot, you wild wolf!' You can feel Fang's tail-hole clenching around you as his ballsack pulls up and his hot load sprays into the eager rabbit. You pound away at his ass, making sure the wolf cums long and hard to give Sandra every single drop of his thick seed. Imagining the bunny girl stuffed with wolf cum or even better, growing cubs inside her, becomes too much for you to hold back longer and soon enough you're emptying your balls into the wolf as well.";
...
to say fangalphatrio:
	...
	if the remainder after dividing libido of Fang by 3 is 2:
		...
		WaitLineBreak;
		say "     As you watch the strong wolf eating out his bunny prey, you sit there playing with yourself. As if noticing your inattentiveness, Fang pauses in his licking to growl at you, cocking his leg to show his throbbing meat. Needing no further instructions from your alpha, you lower yourself under the wolf. You run your tongue slowly over his engorged, red cock and are rewarded with a spurt of pre across your face. Clearly quite excited from the bunny's juices, you enjoy the rumble of pleasure he releases as you slide your mouth down over his pointed glans. You let your lips slide slowly down his throbbing member, savoring his strong, virile taste. You can hear Sandra's cries growing more excited as she cums loudly and you bring one hand between your legs to [if cocks of player > 0]stroke[else]finger[end if] yourself quickly. Kneading the wolf's over-sized balls with your free hand, you take his full length in and almost choke as he cums, spraying a torrent of thick, rich wolfcum into your mouth and down your throat. You moan wetly around his spurting meat, orgasming as you [if cocks of player > 0]pump at your hard rod[else]rub at your clit[end if] while sucking on your alpha's maleness. Sliding off his spent shaft, you lick your lips for the overflowing cum and rub your belly, enjoying the warmth of your master's semen inside it.";
	else if the remainder after dividing libido of Fang by 3 is 0:
		say "     Spreading the wolf's pre across his cock, she gets it nice and glistening before moving onto all fours and raising her rump to him. 'Come on, you big beast,' she moans quietly. 'Take this poor bunny girl and faaahhh!' Her request turns into a loud, lustful moan as Fang mounts her mid-sentence, sinking his over-sized cock into her wanton pussy. You pat the wolf's back and rub his heavy balls against the bunny's pussy as he thrusts into her again and again, as if to show her what's coming. 'Mmm... yes,' the usually quiet bunny girl cries out as the wolf keeps pounding into her like a wild animal, 'Fuck me hard, you sexy creature. Ravage your bunny prey... mmm...'";
		WaitLineBreak;
...
to say fangwscontent:
	if FangWS is 0:
		...
		if a random chance of 1 in 2 succeeds:
			...
			say "stretch out, moaning softly in anticipation. Moments later, your rewarded by the hot spray of the wolf's urine over your [bodytype of player] body as the large wolf rumbles a firm 'Mine' as he marks you. It is strong and acrid, but rich with his scent. You run your hands over yourself, spreading the hot fluid as it splashes onto your chest and then over your face. You open your mouth, catching a sample on your tongue. After sending the last few spurts over your groin, Fang leaves you like that, thoroughly soaked in his piss, reeking of his strong scent, and quite pleased to have been claimed as his once more.";
...
an everyturn rule:
	if ( HP of Fang is 3 or HP of Fang is 4 ) and Fang is booked and Fang is visible and lastCandyfucked - turns >= 12 and Candy is bunkered and ( libido of Fang is 7 or libido of Fang is 6 or ( lust of Fang >= 2 and girl is banned ) ) and lust of Candy is 0 and coonstatus is 2:
		...
		if the player consents:
			...
			say "     Sliding your gear aside for the moment, you shift in your seat to better view the upcoming show. You watch as Candy chats briefly with the large wolf before sliding down his panties and moving onto all fours. With a flick of his tail, he flashes his bare ass at you, raising his skirt. Fang strides around the coon, sniffing at him with increasing interest, then licks under his tail. He seems to find the coon's cotton candy flavor interesting and lashes his tongue over the proffered tail-hole. The coon releases some girlish moans as the long, broad tongue laps at his asshole and even slips into it a little.";
			...
			if cocks of player > 0:
				say "     Enjoying the impromptu show, you take your cock in hand and slowly stroke yourself, sliding over your [cock of player] dick. As you watch the pair continue to go at it, precum dribbles down your length, allowing you to get nice and slick[if cunts of player > 0]. Your free hand moves down to your pussy, slipping a few fingers into it to pleasure your female sex as well[else]. Your free hand moves down to your balls, rubbing over them for further pleasure[end if]. With such a sexy show, you start to moan softly in pleasure, getting quite excited rather quickly. Your pace settles to match that of the powerful wolf banging away quickly at the girly coon's ass.";
			else:
		...
		say "     'Oh, honey, don't be like that. I think you look simply [italic type]faaahbulous[roman type] in pink,' he laughs. Fang huffs indignantly and keeps scratching at it until his proper gray color is restored. He then storms outside and sniffs the air, clearly searching for a female to mount and dominate to improve his disposition. Candy bounds merrily back into the bunker, swinging past you to run his fluffy tail across your body as he does[if cocks of player > 0]. 'You should come snuggle with me sometime soon, hon. Grumpy there may be well hung, but you're much nicer company,' he says with a smile[end if].";
...
when play ends:
	if Fang is in the Grey Abbey Library and HP of Fang is not 3 and HP of Fang is not 4:			[ Fang the guard wolf ]
		...
		if bodyname of player is "Feral Wolf":
			...
			if humanity of player < 10:
				if HP of Fang is 3:
					say "     Having succumbed to another infection, Fang has lost his slutty bitch and, having no more reason to stay, leaves the bunker. With his new-found confidence, he forms a small pack of his own[if ColeenAlpha is 0]. Taking Sandra with him, he leads her off to be his special bunny fucktoy, a role that she enjoys greatly. She bears him many quick-footed pups who become runners for the pack, chasing down prey so the stronger wolves can catch them and take them down[end if].";
				else if HP of Fang is 4:
					say "     Having succumbed to another infection, Fang has lost his slutty bitch and, having no more reason to stay, leaves the bunker. With his new-found confidence, he forms a small pack of his own.";
			else:
				...
				if bodyname of player is "Felinoid" and felinoid companion is tamed:
					...
					now tempnum is 0;
				else if Felinoid companion is tamed and cunts of player > 0:
