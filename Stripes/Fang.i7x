...
to say fangsandrasex:
	...
	say "     Recalling that you haven't spent time with Sandra in a while, you lead Fang over to one of the side rooms before poking your head in the bunker long enough to call the bunny girl over[if ( number of booked people + number of bunkered people ) > 4 and libido of Fang > 5]. The others smile, having picked up on what's going on, but saying nothing as she heads out to join you[else if ( number of bunkered people + number of booked people ) > 4]. The others inside glance over for a moment, but largely ignore the brief intrusion and the bunny girl's exit[otherwise]. The bunny girl exits the bunker to come join you[end if]. Once in the side room, the bunny girl [if libido of Fang > 5]grins playfully and[otherwise]blushes a little to find Fang there, but[end if] rushes over to hug the big wolf around the neck. You slip off your pack and clothes, smiling to see that Sandra's already got her paw at the wolf's hard cock. Clearly she's been looking forward to this as much as your guard wolf has.";
	WaitLineBreak;
		...
		if bodyname of player is "Feral Wolf":
			...
			if humanity of player < 10:
				...
				if bodyname of player is "Felinoid" and felinoid companion is tamed:
					...
					say "     At the military's camp, Fang and the felinoid are given a quick examination, but somehow manage to avoid closer scrutiny. You suspect the one female aid who left their examination room with a rather musky scent on her played a part in it somehow[if lust of Fang > ( level of Felinoid companion - 6 )]. Fang seems particularly pleased with himself[else if lust of Fang < ( level of Felinoid companion - 6 )]. The felinoid seems particularly pleased with himself[otherwise]. They both seem particularly pleased with themselves[end if] as well, but that may just have been your imagination. Regardless, given how bad things are getting the city, they don't get around to fully testing your seemingly obedient pair of companions, accepting your word that they're loyal guardians you found and nothing more.";
