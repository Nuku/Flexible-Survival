...
an everyturn rule:
	if ( HP of Fang is 3 or HP of Fang is 4 ) and Fang is booked and Fang is visible and lastCandyfucked - turns >= 12 and Candy is bunkered and ( libido of Fang is 7 or libido of Fang is 6 or ( lust of Fang >= 2 and girl is banned ) ) and lust of Candy is 0 and coonstatus is 2:
		...
		say "     'Oh, honey, don't be like that. I think you look simply [italic type]faaahbulous[roman type] in pink,' he laughs. Fang huffs indignantly and keeps scratching at it until his proper grey color is restored. He then storms outside and sniffs the air, clearly searching for a female to mount and dominate to improve his disposition. Candy bounds merrily back into the bunker, swinging past you to run his fluffy tail across your body as he does[if cocks of player > 0]. 'You should come snuggle with me sometime soon, hon. Grumpy there may be well hung, but you're much nicer company,' he says with a smile[end if].";
