...
to say fangsandrasex:
	...
	otherwise if ( lust of Fang is 4 or lust of Fang is 0 ) and hp of Fang is 2 and FangToy is false:
		...
		if cocks of player > 0:
			say ".  Shall you use the toy on Fang while fucking Sandra (Y) or would you prefer to use the toy on Sandra while Fang licks you (N)?";
			if the player consents:
				say "[fangsandratoy1]";
			otherwise:
				say "[fangsandratoy2]";
		otherwise:
			say ".  Shall you use the toy on Fang while playing with Sandra's pussy (Y) or would you prefer to use the toy on Sandra while you get Fang to you (N)?";
			if the player consents:
				say "[fangsandratoy3]";
			otherwise:
				say "[fangsandratoy2]";
...
to say fangsub:
	...
	if the player consents:		[WS with Fang]
		...
		say "     Seeing what's about to happen, Sandra gives you a last lick before moving back to watch as Fang's cock twitches, then unleashes a yellow stream of urine onto your chest.  You moan submissively as the wolf's strong scent fills your nose and washes over you.  'Oh, that is so nasty,' the bunny girl says, all while fingering herself frantically.  Her other paw reaches over to grab Fang's penis, guiding it to spray down your body and over your groin, then back up towards your face.  As she's spraying your face, she tells you to open wide for your master, which you do obdiently.  The wolf's piss is strong and acrid, but tastes deliciously of your new alpha as well, so it pleases you do drink it down for him.";
...
to say fangwscontent:
	...
	otherwise if FangWS is 1 and a random chance of 2 in 5 succeeds:
		...
		otherwise:
			...
			otherwise:
				...
				otherwise if Felinoid companion is tamed and cunts of player > 0:
					say "     At the military's camp, Fang and the felinoid are given a quick examination, but somehow manage to avoid closer scrutiny.  You suspect the one female aid who left their examination room with a rather musky scent on her played a part in it somehow[if lust of Fang > ( level of Felinoid companion - 6 )].  Fang seems particularly pleased with himself[otherwise if lust of Fang < ( level of Felinoid companion - 6 )].  The felinoid seems particularly pleased with himself[otherwise].  They both seem particularly pleased with themselves[end if] as well, but that may just have been your imagination.  Regardless, given how bad things are getting the city, they don't get around to fully testing your seemingly obedient pair of companions, accepting your word that they're loyal guardians you found and nothing more.";
					...
					otherwise if lust of Fang < ( level of Felinoid companion - 6 ):	[felinoid victor]
