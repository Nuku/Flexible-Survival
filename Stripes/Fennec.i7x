...
When Play begins:
	...
	now Species Name entry is "Fennec"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Fennec" to infections of VulpineList;
	add "Fennec" to infections of FurryList;
	add "Fennec" to infections of NatureList;
	add "Fennec" to infections of MaleList;
	add "Fennec" to infections of TaperedCockList;
	add "Fennec" to infections of KnottedCockList;
	add "Fennec" to infections of SheathedCockList;
	add "Fennec" to infections of QuadrupedalList;
	add "Fennec" to infections of TailList;
	...
	now MilkItem entry is "fennec milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "fennec semen"; [ Item to be given to the player if they have this infection and jerk off. ]
