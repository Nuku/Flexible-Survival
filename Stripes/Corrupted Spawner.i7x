...
to say corruptedvicdesc:
	...
	if corrvicchange1 is:
		-- 1: say "the lizard-like tail growing from her ass and ";
		-- 2: say "the canine tail growing from her ass and ";
		-- 3: say "the feline tail growing from her ass and ";
		-- 4: say "the slimy tentacle growing from her ass and ";
		-- 5: say "the thick, mawed tail growing from her ass and ";
		-- 6: say "the short, wriggling tentacles growing from her back and ";
		-- 7: say "the dripping, cunt-like orifices along her back and ";
		-- 8: say "the row of dripping cocks running down her back and ";
		-- 9: say "the long, swaying tentacles growing from her shoulders and ";
		-- 10: say "the spiny ridge running down her back and ";
		-- 11: say "the pair of insectile wings below her shoulders and ";
		-- 12: say "an additional six smaller breasts growing on her back and ";
		-- 13: say "a cybernetic pack fused into her back with blinking lights on it and ";
		-- 14: say "an additional pair of robotic arms growing from her back and ";
		-- 15: say "hardened plates across her back and ";
		-- 16: say "inordinately long legs with an extra joint and three wide toes and ";
		-- 17: say "elongated, webbed feet and ";
		-- 18: say "paw-like hands and feet and ";
		-- 19: say "three-fingered, clawed hands and ";
		-- 20: say "dripping cocks instead of nipples and ";
	if corrvicchange2 is:
		-- 1: say "the patches of scales at her shoulders";
		-- 2: say "the patches of black fur at her shoulders";
		-- 3: say "the unblinking eyes on her shoulders";
		-- 4: say "the spikes extending from her shoulders";
		-- 5: say "the patches of green moss at her shoulders";
		-- 6: say "her pale blue complexion";
		-- 7: say "the green skin tone";
		-- 8: say "the white, featureless skin";
		-- 9: say "the twin rows of horns atop her head";
		-- 10: say "the additional eye in her brow";
		-- 11: say "the leaking cunt in her brow";
		-- 12: say "the additional mouth at her brow";
		-- 13: say "the short, slimy tentacles she has instead of hair";
		-- 14: say "her feline ears";
		-- 15: say "her canine ears";
		-- 16: say "her two foot long, slimy tendril of a tongue";
		-- 17: say "her solidly black eyeballs";
		-- 18: say "her stretched maw filled with sharp teeth";
		-- 19: say "the gray fur running down her thighs";
		-- 20: say "the chitinous plates at her thighs";
...
"Corrupted Spawner"	"[PrepCombat_Corrupted Spawner]"
...
When Play begins:
	...
	now Species Name entry is "Corrupted Spawner"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now defeated entry is "     Victorious over the corrupted woman, you drive her off into the dark to find her sexual relief elsewhere.[line break]"; [ Text when monster loses. ]
	...
	now MilkItem entry is "corrupted spawner milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "corrupted spawner cum"; [ Item to be given to the player if they have this infection and jerk off. ]
