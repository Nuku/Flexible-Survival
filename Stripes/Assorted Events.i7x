...
[		otherwise if "Always Cocky" is listed in feats of player:
			say "***";
		otherwise if "Always A Pussy" is listed in feats of player:
			say "***";
		otherwise if "Single Sexed" is listed in feats of player:
			say "***";										]
		otherwise:				[all open]
