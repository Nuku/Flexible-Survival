...
Instead of resolving a Watering Hole:
	...
	repeat with y running from 1 to number of filled rows in table of random critters:
		...
		if name entry is "Bald Eagle":
			now monster is y;
			break;
	say "     In a depression in the grassy plains, you find a greener spot around a small pond.  But there is an eagle man bathing himself in the water and clearly enjoying it.  The avian creature strokes his hard cock, leaking precum into the water.  Focused on his own fun, he hasn't spotted you yet.  Shall you approach in the the bathing bird (Y) or take this opportunity to leave (N) while you still can?";
	if the player consents:
		...
		otherwise:
			...
			if the player consents:
				if cocks of player > 0:
					...
					increase score by 10;
				otherwise:
					say "     Deciding to have some fun with this pair, you put your arms aorund the nominally smarter one and grop her bosom, making her moan.  You let your hands over over her body, slipping off her loose shirt so you can uncover her breasts and fondle them directly.  Teasing her nipples, you guide her to lay down on the dry grass and move atop her.  Bringing your hips over hers, you grab her sheath and emerging cock, stroking her to full erection before lowering yourself down onto her meat.  Enjoying to soft sound of her moan, you start riding her meat and motion for the other to come up and bring her shaft to your mouth.  Licking and sucking at it, you lustfully savour the pleasure of having two hyena cocks stuffed inside you, licking and sucking at them until you cum loudly in pleasure and are rewarded with two hot loads of hyena cum from the herms.  Finished and satisfied, you push the one back and climb off the other, telling them that they should get back to work.  They nod and grab their stuff, rushing off.";
					increase score by 10;
			otherwise:
