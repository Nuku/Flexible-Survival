	...
	if inasituation is false and bodyname of player is "Chocolate Lab" and a random chance of ( ( labnum * 10 ) + ( labhost * 15 ) ) in 100 succeeds:
		if labhost is 2:
			if a random chance of 1 in 5 succeeds:
				...
				attempttowait;
				say "     However, their attacks are undaunted by your resistance.  They continue putting everything they have against you, focusing all their thoughts on the singular goal of breaking you.  Before long it no longer feels like three individuals pushing against you, but a single combined force as if their thoughts have begun to flow together in a single collective conciousness.  Suddenly, fear. panic. terror.  You feel the emotions of the labs rolling though you as they come to the same realization as you do. In their combined effort their own minds have begun to merge together under the immense pressure.  Caught in the turmoil of the panicking labs your concentration begins slipping, and you find yourself being dragged down with the labs, all four of you melting away into each other as you become one.";
				attempttowait;
...
When Play begins:
   ...
   now body descriptor entry is "[one of]chocolate[or]confectionery[or]flowing[or]malleable[at random]";
...
this is the Choclab piggyback rule:
	...
	otherwise if labnum > playernum:
		...
		if humanity of player < 1 and bodyname of player is "Chocolate Lab":
			say "     Subject to the constant influence of the chocolate lab[if labhost is 2]s[end if] infesting your body, your mind slowly begins to melt away, leaving it and your body to be freely reshaped by the chocolate canine[if labhost is 2]s[end if].  The last of your resistance fades and you slowly sink to the ground, melting into a gooey chocolate mess.  You feel the [if labhost is 2]labs rejoice as they set about finishing their[otherwise]lab rejoice as it sets about finishing its[end if] work.  Sometime later your [if labhost is 2]pack[otherwise]companion[end if] finally separates from your body, waiting eagerly as you pull yourself together, taking the shape of another flowing, chocolate dog.  You happily lick and nuzzle your [if labhost is 2]new pack[otherwise]companion[end if] as they return the love, finally welcoming you into the pack properly.  With a wet bark they bound off into the city, and you follow behind eagerly, marking the beginning of your simple new life as a chocolate lab.";
...
when play ends:
	if bodyname of player is "Chocolate Lab":
		if humanity of player is less than 10:
			if labhost is 4: [lost to three labs; big dog ending]
				say "     You wander the streets, drawn by your nose to seek out chocolate, which you ingest ravenously wherever found and eventually your nose has you cross paths with another of those confectionery canines.  Your mouth fills with thick chocolaty saliva as you eye the smaller dog hungrily but before you can make your move the smaller lab spots you and makes a run for it.";
		...
		otherwise:
			...
			if labhost > 0:
				if humanity of player < 40:
					say "     During your time in the camp you feel compelled to keep the lab[if labhost is 2]s you've been carrying secret, feeling them[otherwise] you've been carrying secret, feeling it[end if] curled up and shivering somewhere deep inside you.  You worry for [if labhost is 2]their[otherwise]its[end if] wellbeing if you were to allow the military to capture [if labhost is 2]them[otherwise]it[end if].  Fortunately the military is unable to distinguish your chocolate form from that of your passenger[if labhost is 2]s[end if], and you easily manage to smuggle [if labhost is 2]them[otherwise]it[end if] out.  After being released you find a secluded private place outside the city to release the lab[if labhost is 2]s[end if].  Once released, the lab[if labhost is 2]s nuzzle you and give[otherwise] nuzzles you and gives[end if] you slobbery doggy kisses before departing in search of new playmates and chocolate outside the quarantined city, but not before pausing and looking back at you with those dark chocolate puppydog eyes, as if giving you one last chance to join them before they leave.";
					if humanity of player >= 25:
						now humanity of player is 20;
				otherwise:
					say "     During your time at the camp, you inform the scientists of the lab[if labhost is 2]s[end if] hidden within your body, and eager for more data on your bizarre infection, they set about finding a way to separate the lab[if labhost is 2]s[end if] from you right away.  When you awaken from the procedure, you no longer feel the lab[if labhost is 2]s['][otherwise]'s[end if] presence within you, but despite being happy to be rid of them, you find yourself concerned for the lab[if labhost is 2]s[end if] now that they're in the military's hands.";
	...
	otherwise:
		if labhost > 0:
			say "     Trapped inside your new [bodyname of player] form, the chocolate lab[if labhost is 2]s[end if] infesting your body are eventually overwhelmed by your own body, slowly absorbed into your form until one day you realize [if labhost is 2]their[otherwise]its[end if] presence has disappeared entirely.  While you show no outward signs of the labs influence, you find you have a powerful craving for chocolate from that day onward.";
