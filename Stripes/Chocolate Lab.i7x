	...
	if inasituation is false and bodyname of player is "Chocolate Lab" and a random chance of ( ( labnum * 10 ) + ( labhost * 15 ) ) in 100 succeeds:
		if labhost is 2:
			if a random chance of 1 in 5 succeeds:
				...
				attempttowait;
				say "     You awaken sometime later, pulling your chocolate body together as you rise to all fours, your flow into the shape of a giant chocolate dog, easily over six feet tall.  With a wet bark your set out into the city, eager to sate your powerful canine appetite for chocolate and sex.";
...
to say beatthelab:
	...
	otherwise:
		...
		otherwise if labhost > 0 and a random chance of 1 in 3 succeeds:
			say "     As you look over the fallen lab, you feel a familiar churning build up inside you, clutching your belly with a groan you fall to your knees as your canine passenger twists around in your belly.  ";
...
this is the Choclab piggyback rule:
	...
	otherwise if labnum > playernum:
		if bodyname of player is "Chocolate Lab":
			say "     As you are traveling you find your body filling with a warm tingling sensation, your [one of]body begins losing cohesion[or] form starts drooping slightly[or]body begins to shift slightly[at random] as you [one of]have have a sudden craving for chocolate[or]find yourself becoming quite aroused[or]have a sudden hunger for chocolate... and sex[at random][if humanity of player > 4].  You quickly lose track of time as your mind continues to wander, but [one of]a sudden sound[or]a loud bang[or]a scream[or]a cry of ecstasy[at random] in the distance breaks the haze, snapping your attention back to reality[one of] just before your increasingly paw-like hand touches the ground[or].  You quickly pull yourself back together, both mentally and physically[or] and you feel the labs disappointment roll through you[at random].  Realizing just how close you came to losing yourself to the influence of your canine piggybacker, you resolve to stay much more focused, but fear how much of yourself you've already lost in this lapse[end if].";
		otherwise:
	...
	if bodyname of player is "Chocolate Lab":
		if humanity of player is less than 10:
			if labhost is 4:						[lost to three labs; big dog ending]
				say "     You wander the streets, drawn by your nose to seek out chocolate, which you ingest ravenously wherever found and eventually your nose has you cross paths with another of those confectionery canines.  Your mouth fills with thick chocolatey saliva as you eye the smaller dog hungrily but before you can make your move the smaller lab spots you and makes a run for it.";
