...
to say badAlexandraSarah0:
	say "     Looking over, you happen to notice Alexandra and Sarah together at the husky girl's cot. You discreetly move a little closer in case the Doberman bad girl is looking for a fight as she'd hinted. When you do, you're pleased to see them talking amiably enough. Your husky pet giggles happily as she pets one of her puppies, in one of her rare, talkative moods instead of wallowing fully in her canine slut nature as she's wont to do.";
		...
		if lust of Alexandra > 0: [Alexandra is pregnant]
			...
			if lust of Alexandra >= 24 and skipturnblocker is 0: [birthing time]
				...
				if Alexandra is not visible: [player isn't anywhere near her]
					...
					WaitLineBreak;
					say "     The tiny humanoid dog lets out a whimper at finding itself in a strange new world outside of the fluid-filled home it came from, then starts to weakly move its limbs as if to try them out for the first time. Focused on the miracle of life in your hands, you are only shaken out of watching the first pup when Alexandra lets out a shout of '[one of]Goddamn!' [or]Motherfucker!' [or]Fuuuck!' [at random]as another really strong follow-up contraction hits. She mutters something about punching 'the next bastard who wants to fuck her' in the balls, then takes a deep gasp of air. You barely have time to gently lower the first pup to catch number two, who is no less cute and innocent than the first. The two of them stretch their tiny limbs and sniff blindly at each other as you put number two down next to its sibling.";
					if NewPups < 3:
...
to say A_Task55:	[Automatons 2]
	...
	if autopath is 2:
		...
		WaitLineBreak;
		say "     Alexandra, by this point, is searching the skylight frantically for a means to open it. Finally, in her frustration and hurry to rescue a victim you know already to be lost, she breaks the glass with her nightstick and jumps in. Dropping from over ten feet, she slams atop one of the automatons, knocking it to the floor. 'Stop! Police!' the doberwoman cop growls. There is a brief moment of surprise on the unusual female's face before her expression returns to the dispassionate norm of the automatons.";
