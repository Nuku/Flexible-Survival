...
to say badAlexandrasex1:		[Bend her over]
	...
	say "     'Oh yes! Do me! Fuck your slutty bitch,' she pants. She [one of]moves her paws to grope her [if lastdobiemess is 6]cum-streaked [end if]breasts and play with her nipples[or]grips the edge of the table, her claws digging into the wood[or]drools onto the table as her breasts are pressed firmly against the cool wooden surface[at random]. Your [cock size desc of player] cock [if cock length of player > 30]has stuffed your bad doggy bitch with a prominent and phallic bulge for your massive meat[else if cock length of player > 20]makes a visible bulge in your bad doggy bitch[else if cock length of player > 10]stuffs your bad doggy bitch such that she feels wonderfully tight and juicy around your shaft[otherwise]fucks your bad doggy bitch's wanton hole[end if]. Her cunt squeezes and clenches around your shaft[if cockname of player is listed in infections of Knotlist] as your knot grinds against her juicy lips[end if], her body clearly needing this proper pounding you're giving her.";
...
to say badAlexandrasex3:		[All fours]
	if lust of Alexandra > 12:		[visibly preggers]
		...
		say "     Keeping a firm grip on that sexy ass of hers, you pound into the Doberwoman with your [cock size desc of player] [cock of player] cock. She pants [one of]and moans about how great it feels[or]and drools onto the floor with her tongue hanging out[or]as her [if hp of Alexandra > 3 and lastdobiemess is 6]plump, cum-streaked [else if hp of Alexandra is 3]plump [end if]breasts sway with every thrust[at random]. Your [cock size desc of player] cock [if cock length of player > 30]stretches her juicy cunt wide and makes a prominent and phallic bulge in your bad doggy bitch[else if cock length of player > 20]stretches her juicy cunt open and produces a visible swelling in your bad doggy bitch[else if cock length of player > 10]stuffs your bad doggy bitch's cunt such that she feels wonderfully tight and juicy around your shaft[otherwise]fucks your bad doggy bitch's juicy hole[end if]. Her cunt squeezes and clenches around your shaft[if cockname of player is listed in infections of Knotlist] as your knot grinds against her juicy lips[end if], her body responding to the much-needed fucking.";
...
to say badAlexandrasex5:		[Blow job]
	...
	if lust of Alexandra > 12:
		say "     [one of]You are quite pleased with your training of the Doberwoman, having made her into a very eager and obedient plaything. The blow job is quite good and shows a lustful eagerness you're pleased to see in the corrupted cop[or]You're quite pleased with how she's doing; for someone with no experience before you started training her, she's coming along very nicely. Definitely an enthusiastic slut, you'll definitely enjoy your hard-earned prize for a good, long time if you have anything to say about it[at random]. Eventually this becomes too much and you pull her forward, burying her nose in your groin as your cock throbs and pulses, blasting your cum [if cock length of player > 20]directly into her belly[else if cock length of player > 10]down her throat[otherwise]into her muzzle[end if]. You drain your [ball size] into her[if cock width of player > 40], leaving her already swollen belly so big she can hardly move at all. She can only lie there, rubbing her overfull tummy while moaning in pleasure[else if cock width of player > 20], leaving her with a bloated bellyful of semen that further inflates her rounded belly. This leaves her so full and plump that she chooses to lie there, rubbing her bulging belly[otherwise], feeding her your cum which she happily swallows down. She happily rubs her paws over her full belly as she heads back to her post[end if].";
	else:
		say "     You are quite pleased with your training of the Doberwoman, having made her into a very eager and obedient plaything. The blow job is quite good and shows a lustful eagerness you're pleased to see in the corrupted cop. Eventually this becomes too much and you pull her forward, burying her nose in your groin as your cock throbs and pulses, blasting your cum [if cock length of player > 20]directly into her belly[else if cock length of player > 10]down her throat[otherwise]into her muzzle[end if]. You drain your [ball size] into her[if cock width of player > 40], leaving her belly so full and bloated that she can only lie there, rubbing her overfull tummy[else if cock width of player > 20], leaving her with a bloated bellyful of semen that she happily rubs with her paws as she wobbles back to her post[otherwise], feeding her your cum which she happily swallows down[end if].";
...
to say badAlexandrasex8:		[69]
	if cocks of player > 0:
		...
		say "     Feeling your orgasm approaching, you pick up the pace, lavishing attention upon her juicy folds and swiping your tongue across her throbbing clit in long licks that make her pussy quiver around the fingers stuffed into it. When she cums, she sucks down hard on your cock, burying her nose in your groin as your penis throbs and pulses, blasting your cum [if cock length of player > 20]directly into her belly[else if cock length of player > 10]down her throat[otherwise]into her muzzle[end if]. You drain your [ball size] into her[if cock width of player > 40], leaving her belly so full and bloated from your [cum load size of player] load that she can only lie there, rubbing her overfull tummy[else if cock width of player > 20], leaving her with a bloated bellyful of semen that she happily rubs with her paws[otherwise], feeding her your cum which she happily swallows down[end if]. When you're done, you push her head back and smile as she licks her muzzle, chasing after as much of your creamy load as she can get. As she's doing this, her paw drifts down to finger finger herself to another powerful climax. With your head right there to watch, this makes for a lovely show as you bask in the afterglow[if cock width of player > 40]. When that's done, she rolls over onto her back, unable to rise quite yet with her belly so full, so you leave here there for now[else if cock width of player > 20]. When that's done, you both get up and she wobbles back to her post, rubbing her full belly[otherwise]. Only when that's done do you both get back up, her heading back to her post[end if].";
	else:
...
to say badAlexandrasex10:		[Threesome with Fang]
	...
	if cocks of player > 0:		[sucks cock]
		...
		if lust of Alexandra > 12:
			say "     Alexandra releases a muffled moan around your cock as her hips quiver and her tonguework becomes more frantic. Grinning and knowing she's cumming from the humiliating fuck she's getting, you scritch her ears and call her your good, bad girl through gritted teeth, cumming moments later [if cock length of player > 20]directly into her belly[else if cock length of player > 10]down her throat[otherwise]into her sucking muzzle[end if]. Fang howls as well as he pumps his hot wolf semen into her, having tied with the doggy bitch. Between your [cum load size of player] load and Fang's, [if cock width of player > 40]her already swollen belly is left so big she can hardly move at all. She can only lie there, rubbing her overfull tummy while moaning in pleasure[else if cock width of player > 20]leaving her with a bloated bellyful of semen that further inflates her rounded belly. She is left her so full and plump that she chooses to lie there, rubbing her bulging belly[otherwise]she happily swallows down all she can get while the wolf's seed fills her womb. She happily rubs her paws over her full belly as she heads back to her post[end if].";
		else:
			say "     Alexandra releases a muffled moan around your cock as her hips quiver and her tonguework becomes more frantic. Grinning and knowing she's cumming from the humiliating fuck she's getting, you scritch her ears and call her your good, bad bitch through gritted teeth, cumming moments later [if cock length of player > 20]directly into her belly[else if cock length of player > 10]down her throat[otherwise]into her sucking muzzle[end if]. Fang howls as well as he pumps his hot wolf semen into her, having tied with the doggy bitch. Between your [cum load size of player] load and Fang's, [if cock width of player > 40]her belly is left so full and bloated that she can only lie there, rubbing her overfull tummy[else if cock width of player > 20]she is left with a bloated bellyful of semen that she happily rubs with her paws as she wobbles back to her post[otherwise]she happily swallows down all she can get while the wolf's seed fills her womb. She happily rubs her paws over her full belly as she heads back to her post[end if].";
...
to say goodAlexandrasex2:
	...
	WaitLineBreak;
	say "     As your mutual excitement grows, you can feel your arousal building towards its peak. Moving your hands to her thighs, you raise her legs to your hips and pound into her harder and faster. Sweet moans and whimpers of delight leave her muzzle as she grips the desk tightly, panting for you to cum in her. Not one to deny the canine beauty her desires, especially when that's just what you want to do, you drive your [cock size desc of player] cock into her and cum hard. Shot after shot of your [cum load size of player] load is pumped into her until [if cock width of player > 40]her belly is bloated overfull with your semen[else if cock width of player > 20]her belly is visibly rounded with your semen[otherwise]you have no more to give, for now[end if]. Her orgasming pussy milks as much as it can [if cock width of player > 40]hold[otherwise]get[end if] out of you.";
	say "     Having satisfied one another, the two of you snuggle together, sharing a few more kisses while caressing one another. Eventually though, this private moment must come to a close. Getting dressed, the two of you exit the office and return to your duties.";
...
to say badAlexandra_debug:
	say "DEBUG (Bad Girl Alexandra) -> HP: [hp of Alexandra], Level: [level of Alexandra], Lust: [lust of Alexandra], Libido: [libido of Alexandra], XP: [xp of Alexandra], Story 1: [if Alexandrastory is true]Y[otherwise]N[end if], Story 2: [if Alexandrastory2 is true]Y[otherwise]N[end if], Story 3: [if Alexandrastory3 is true]Y[otherwise]N[end if], dobieanal = [if dobieanal is true]Y[otherwise]N[end if], lastdobiemess: [lastdobiemess], lastAlexandraPast: [lastAlexandraPast], lastfuck: [lastfuck of Alexandra] <- DEBUG[line break]";
	say "DEBUG (NPC Chat) -> A_Candy: [if A_Candy is true]Y[otherwise]N[end if], A_Sven: [if A_Sven is true]Y[otherwise]N[end if], A_Fang: [if A_Fang is true]Y[otherwise]N[end if], A_Philip: [if A_Philip is true]Y[otherwise]N[end if], A_Mack: [if A_Mack is true]Y[otherwise]N[end if], A_Sam: [if A_Sam is true]Y[otherwise]N[end if], A_Snow: [if A_Snow is true]Y[otherwise]N[end if], A_Sandra: [if A_Sandra is true]Y[otherwise]N[end if], A_Sally: [if A_Sally is true]Y[otherwise]N[end if], A_Sarah: [if A_Sarah is true]Y[otherwise]N[end if], A_Sarah2: [if A_Sarah2 is true]Y[otherwise]N[end if], A_Coleen: [if A_Coleen is true]Y[otherwise]N[end if], A_Solstice: [if A_Solstice is true]Y[otherwise]N[end if], A_David: [if A_David is true]Y[otherwise]N[end if], A_Elijah: [if A_Elijah is true]Y[otherwise]N[end if], A_Onyx: [if A_Onyx is true]Y[otherwise]N[end if], A_Helen: [if A_Helen is true]Y[otherwise]N[end if], A_Xerxes: [if A_Xerxes is true]Y[otherwise]N[end if], A_Icarus: [if A_Icarus is true]Y[otherwise]N[end if], no_AlexandraNPC: [no_AlexandraNPC] <- DEBUG[line break]";

to say goodAlexandra_debug:
	say "DEBUG (Good Girl Alexandra) -> HP: [hp of Alexandra], Story 1: [if Alexandrastory is true]Y[otherwise]N[end if], Story 2: [if Alexandrastory2 is true]Y[otherwise]N[end if], Story 3: [if Alexandrastory3 is true]Y[otherwise]N[end if], lastAlexandraPast: [lastAlexandraPast], lastfuck: [lastfuck of Alexandra] <- DEBUG[line break]";
	say "DEBUG (Tasks) -> AT_Matt: [if AT_Matt is true]Y[otherwise]N[end if], AT_Mouse: [if AT_Mouse is true]Y[otherwise]N[end if], AT_Sandra: [if AT_Sandra is true]Y[otherwise]N[end if], AT_Snow: [if AT_Snow is true]Y[otherwise]N[end if], AT_Philip: [if AT_Philip is true]Y[otherwise]N[end if], AT_RLD: [if AT_RLD is true]Y[otherwise]N[end if], AT_Sven: [if AT_Sven is true]Y[otherwise]N[end if], AT_Marks: [if AT_Marks is true]Y[otherwise]N[end if], AT_Lisa: [if AT_Lisa is true]Y[otherwise]N[end if], AT_Diego: [if AT_Diego is true]Y[otherwise]N[end if], AT_Qytat: [if AT_Qytat is true]Y[otherwise]N[end if], AT_Sarah: [if AT_Sarah is true]Y[otherwise]N[end if], AT_Jimmy: [if AT_Jimmy is true]Y[otherwise]N[end if], AT_Paula: [if AT_Paula is true]Y[otherwise]N[end if], AT_Repair: [if AT_Repair is true]Y[otherwise]N[end if], AT_Stella: [if AT_Stella is true]Y[otherwise]N[end if], AT_Patrol: [if AT_Patrol is true]Y[otherwise]N[end if], no_AlexandraTask: [no_AlexandraTask] <- DEBUG[line break]";
	say "DEBUG (Police Station) -> policerepair: [policerepair], lastpolicerepair: [lastpolicerepair], pr_task01: [if pr_task01 is true]Y[otherwise]N[end if], pr_task02: [if pr_task02 is true]Y[otherwise]N[end if], pr_task03: [if pr_task03 is true]Y[otherwise]N[end if], pr_task04: [if pr_task04 is true]Y[otherwise]N[end if], pr_completion: [pr_completion], population: [population of Police Station], infected population: [infpop of Police Station],  <- DEBUG[line break]";
