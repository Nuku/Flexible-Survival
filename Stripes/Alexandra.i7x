Version 1 of Alexandra by Stripes begins here.
[Version 1 - Bad Alexandra]
...
to say badAlexandrasex:
	say "     You grab Alexandra in your arms and grope the Doberwoman, making her moan with lust.  She pants excitedly and squirms out of her jeans and jacket.  Just what do you feel like doing with your canine bitch this time?";
	now sextablerun is 0;
	blank out the whole of table of fucking options;
	if cocks of player > 0:
		choose a blank row in table of fucking options;
		now title entry is "Fuck Alexandra";
...
to say Alexandrasex1:		[Fuck Alexandra]
...
to say Alexandrasex3:		[Get cunnilingus]
...
to say Alexandrasex4:		[Lick Alexandra]
