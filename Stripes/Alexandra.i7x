...
to say A_Task55:	[Automatons 2]
	...
	if autopath is 2:
		...
		if fightoutcome >= 30:							[fled]
			say "     Finding yourself in a losing battle, you weave and edge backwards, then make a break for the door. You call for Alexandra to fall back as well, but she's too deeply into the fight to get away. You hesitate for a moment, but with automatons moving steadily towards you, you are now cut off from her and have to make a break for it. Running down the hallway, you search for a way out. As you're pulling open one door, then comes a loud, growling snarl that is cut off. There's nothing to be done now but escape. Reaching an emergency exit, you pull open the door, only to be confronted by a patrol group waiting right there. You turn around, but the metal men pursuing you have barred that end of the hall as well. Your attempts to fight are futile, their greater numbers bearing you down. At some point during the orgy centerd upon you, the glass-domed elite comes up, cradling your head even as you're [if cocks of player > 0]fucking a bronze female[else]being fucked by a bronze male[end if]. And then it is over.";
			say "...";
			now humanity of player is 9;
			now tailname of player is "Automaton";
			now facename of player is "Automaton";
