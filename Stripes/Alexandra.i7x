...
to say badAlexandraFang0:
	...
	otherwise:
		if hp of Fang is 3 or hp of Fang is 4: [alpha Fang can't be stopped]
			...
			say "[badAlexandraFang1]";
		otherwise if cocks of player is 0 and cunts of player > 0: [herm player]
			say "[badAlexandraFang3]";
		otherwise if cocks of player is 0: [neuter player]
...
an everyturn rule:
	if Alexandra is booked and hp of Alexandra < 50:
		...
		otherwise if Fang is booked and Alexandra is booked and player is in Grey Abbey Library:
			...
			otherwise if level of Alexandra is 1 and hp of Fang is 3 or hp of Fang is 4: [non-shared bitch and Alpha Fang]
				if lastfuck of Fang - turns >= 8 and lastfuck of Alexandra - turns >= 6 and xp of Alexandra - turns >= 16: [horny wolf, horny dobie, last scene 2 days back]
					...
					say "[badAlexandraFang1]";
			otherwise if level of Alexandra is 2: [shared bitch]
...
to say alexandratalk_gg_menu:
	...
	while sextablerun is 0:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			otherwise if nam is "Her past":
				say "[alexandratalk_gg_past]";
			otherwise if nam is "Supplies":
				say "[alexandra_supplies]";
			otherwise if nam is "Tasks":
				AlexandraTaskChat;
			otherwise if nam is "Repairs":
...
to say alexandratalk_gg_past:
	if Alexandrastory is false:
		...
		now Alexandrastory is true;
	otherwise if Alexandrastory2 is false:
...
to say alexandra_supplies:
	...
	otherwise if hp of Alexandra is 55:	[already gave water]
		...
		otherwise:
			...
			now sextablerun is 0;     [continued talking allowed]
	otherwise if hp of Jimmy > 2 and hp of Alexandra >= 56 and AT_Paula is false and guy is not banned and girl is not banned:
...
to AlexandraTaskChat:
	...
	if hp of Alexandra >= 56:
		...
		otherwise if lastPolicePatrol - turns >= 8:
