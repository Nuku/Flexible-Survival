		...
		if gsd_pet is 0:
			...
			if KorvinSubmitCounter > 4: [new auto submit + fight]
				...
				if a random chance of 2 in 3 succeeds:
					...
					say "      'I thought I smelled you around, pup. How about you come over here and show your alpha what a good [if gsd_slut is true and cunts of player > 0]bitch[else if gsd_slut is true]slut[otherwise]beta[end if] you are?'  Despite how you may normally feel about him and what he's done to you, being in the presence of your alpha dog triggers something inside you. The sound of his voice and his scent in your nose arouses you and makes you submit to him. He is your alpha and you obey, eager to please him.";
...
to say KorvinCentaurFight:
	...
	now fightoutcome is 22; [player submitted]
	if "Korvin's Pet - Spiked Collar" is listed in feats of player:
		say "     Your Alpha looks proudly at your spiked collar, something that sends happiness throughout your body. 'If you win this time, we'll have some fun, but remember what happens if you lose.' He says. You nodd your head before he attaches your black leash to your collar and takes you on a walk for a while. You're rather surprised to see that your Alpha is leading you into the plains just outside the city. The two of you travel for a bit longer before you spot a centaur stallion lazing about on the grass. Your master speaks up, yelling to the horse-man. 'Hey! Do you want to fight my pet here?' He asks, getting the male's attention. The guy perks up and stands on his four legs, causing your attention to be drawn to the hung cock. He huffs before talking as well. 'Sure, why not... but what do I get if I win?' The centaur asks, eyeing you up. 'Simple, you get to fuck my pet.' Your Alpha says. That makes the horse-man grin and agree before quickly readying himself for battle.";
	else if "Korvin's Pet - Pink Collar" is listed in feats of player:
...
to say losetogsd:
	...
	if gsd_special is false:
		...
		if a random chance of 1 in 3 succeeds:
			...
			say "     You continue licking and sucking on his while playing with his balls. Feeling his knot swelling up to full size[if scalevalue of player < 3], you squeeze that bulge with your [body size of player] hand and soon coax him to orgasm[else if scalevalue of player > 3], your large size lets you accept it into your mouth as well readily enough and soon coax him to orgasm[otherwise], you struggle a bit before managing to fit his swollen bulb in your mouth. You coax him to orgasm with your face tied to his crotch, at the small price of an aching jaw[end if]. Once he's spent[if scalevalue of player is 3] and his knot's gone down enough to free you[end if], he slaps his meat across your face again, leaving a final streak of semen across one cheek. He strides away with a confident swagger.";
		else:
	...
	if humanity of player is less than 10:
		if bodyname of player is "German Shepherd":
			if gsd_pet > 0 and gsd_pet < 10:
				...
				else if cunts of player is greater than 0:			[FEMALE]
