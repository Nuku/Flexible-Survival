		...
		if humanity of player is less than 10:
			...
			otherwise if hp of Sam >= 30 and hp of Sam <= 49:
				...
				otherwise if cunts of player > 0:
					say "     As you lose your humanity to your increasingly vixentaur nature, you feel your lustful heat growing stronger.  You and Sam pair up as a couple of increasingly feral vixentaurs.  While Sam does maintain more of her old self than you do in the end, she's more than happy to stay in the city and turn the bunker into her personal den.  You make numerous forays with her out into the city as well, allowing the sexy males and herms you find out there to breed you.  With you both breeding alluring, vulpine offspring, the numbers of vixentaurs in the area quickly grow.";
			...
			otherwise if hp of Sam >= 50 and hp of Sam <= 69:
				...
				otherwise if cunts of player > 0:
					say "     As you lose your humanity to your increasingly vixentaur nature, you feel your lustful heat growing stronger.  You and Sam pair up as a couple of increasingly feral taurs.  While Sam does maintain more of her old self than you do in the end, she's more than happy to stay in the city and turn the bunker into her personal lair.  You are bred by the dracovixentaur often, filling you plump with numerous kits most of the time.  You do make forays with her out into the city often, getting mounted by other males while Sam partakes in the females.  While Sam's offspring are a collection of dragontaurs, vixentaurs and dracovixentaurs, the number of vixentaurs in the area grow to be the most frequent of the three.";
				otherwise if cocks of player > 0:
