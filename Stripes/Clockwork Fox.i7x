...
to say losetocfg:
	if cfgmode is 1:
		say "     [if HP of Player > 0]Enraptured by the unusual nature of this mechanical beauty, you stop resisting and submit to her desires. She runs her cool paws over your body, sliding off your clothes. She presses her cold, metal body to yours and chirrs mechanically in pleasure[else]Unable to continue resisting this mechanical creature, you stumble to your knees. She wraps her arms around you, pressing her cold body to yours and slides off your clothes with her cool paws. She laughs in delight, having soft, music box chimes mixed into the sound[end if]. With soft clicking noises, she moves her paw between your legs and runs her digits over your genitals.";
		if Player is male:
		...
		say "     [if HP of Player > 0]Enraptured by the unusual nature of this mechanical beauty, you stop resisting and submit to his desires. He runs his cool paws over your body, sliding off your clothes. He presses his cold, metal body to yours and chirrs mechanically in pleasure[else]Unable to continue resisting this mechanical creature, you stumble to your knees. He wraps his arms around you, pressing his cold body to yours and slides off your clothes with his cool paws. He laughs in delight, having soft, music box chimes mixed into the sound[end if]. With soft clicking noises, he moves his paw between your legs and runs his digits over your genitals.";
		if Player is female:
...
When Play begins:
	...
	now MilkItem entry is "clockwork fox milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "clockwork fox cum"; [ Item to be given to the player if they have this infection and jerk off. ]
