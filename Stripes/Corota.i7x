...
to say losetocorota:
	...
	if a random chance of 3 in 5 succeeds:
		if Player is male:
			...
			CreatureSexAftermath "Corota" receives "PussyFuck" from "Player";
			...
			CreatureSexAftermath "Corota" receives "OralPussy" from "Player";
		else:
...
When Play begins:
	...
	now Species Name entry is "Corota"; [name of the overall spe<cies of the infection, used for children, ...]
	...
	now MilkItem entry is "corota milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "corota cum"; [ Item to be given to the player if they have this infection and jerk off. ]
