...
"Junkman"	"[PrepCombat_Junkman]"

to say PrepCombat_Junkman:
...
When Play begins:
	...
	now Species Name entry is "Junkman"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Junkman" to infections of MachineList;
	add "Junkman" to infections of MaleList;
	add "Junkman" to infections of BipedalList;
	add "Junkman" to infections of FeralmindList;
	...
	now MilkItem entry is "junkman milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "junkman cum"; [ Item to be given to the player if they have this infection and jerk off. ]
