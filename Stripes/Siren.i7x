...
When Play begins:
	...
	now Species Name entry is "Siren"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Siren" to infections of AvianList;
	add "Siren" to infections of AvianpredList;
	add "Siren" to infections of FurryList;
	add "Siren" to infections of MythologicalList;
	add "Siren" to infections of MaleList;
	...
	now MilkItem entry is "siren milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "siren cum"; [ Item to be given to the player if they have this infection and jerk off. ]
