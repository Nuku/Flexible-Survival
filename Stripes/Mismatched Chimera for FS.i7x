...
to say losetomischim:
	if inasituation is true:
		...
		if cunts of player > 0 and a random chance of 1 in 2 succeeds:
			...
			say "[randomimpreg]";
		else if anallevel is not 1 and ( cunts of player is 0 or anallevel is 3 ) and a random chance of anallevel in 5 succeeds:
