...
to say losetohydrabeast:
	...
	if Player is female:
		if hydraheadcount < Cunt Count of Player:
			...
			if hydraheadcount + 1 is Cunt Count of Player:
...
to say beatthehydrabeast:
	if Player is not neuter:
		...
		now description entry is "Have it fuck your hole[if Player is female]s[end if]";
		[]
		choose a blank row in table of fucking options;
		...
		while sextablerun is 0:
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if Player consents:
					...
					if title entry is:
						-- "Receive oral sex":			[oral]
							say "[beathydrabeast1]";
						-- "Fuck it":	[fuck it]
							say "[beathydrabeast2]";
						-- "Get fucked":	[get fucked]
							say "[beathydrabeast3]";
						-- "Drive it off":	[no sex - leave]
...
to say beathydrabeast2:	[fuck it]
	...
	if anallevel is 3:
		say "     [if a random chance of Libido of Player in 125 succeeds]Leaning in close, you lick your lips before pressing your slick tongue to that dark ring. You slather your tongue across it a few times before starting to prod at the creature's hole. The great beast rumbles in pleasure as you knead its rear and work your slick, meaty flesh into his back passage, opening him up and getting him ready for what's to come. Though you certainly keep going at it longer than is necessary, having switched a[else]You suck down on a pair of your fingers, getting them wet before pressing them to that dark ring. You rub and tease across it a few times before starting to prod at the creature's hole. The great beast rumbles in pleasure as you knead its rear with your free hand while working your slick digits into his back passage, opening him up and getting him ready for what's to come. Though you certainly keep going at it longer than is necessary, having switched your[end if] hand to his huge, heavy ballsack. Each nut feels like a cluster of testicles clumped together to provide enough cum for the creature's many cocks. Only after you've had your fun playing with its balls and hearing it moan and rumble as you do are you ready to get to the main event.";
...
to say beathydrabeast3:	[get fucked]
	...
	if Player is female:
		if hydraheadcount < Cunt Count of Player:
			...
			[multiple cunts all fucked / no anal / excess]
			say "     It rumbles softly and moves eagerly atop you, nuzzling you and licking across your face as it moves into position. It shows some restraint, at least for the moment, gently probing its many cocks against your rear before lining one of them up to each of your pussies. They press against your wet folds, their tapered tips spreading you open and pushing their way into you as the multi-cocked creature mounts you, stuffing your [Cunt Count of Player] cunts with its reptilian cocks. The unused shaft[if hydraheadcount + 1 is Cunt Count of Player] rubs and slaps against your bulging belly as its[else]s rub and slap against your bulging belly as their[end if] brethren fuck you. Their subtle ridges and tapered glans send shivers of pleasure through your body as the powerful creature thrusts into you again and again. Its pace at first is slow, but speeds up rapidly as its wild nature drives it to pound you like a beast, much to your increasing delight.";
			say "     While it fucks you, its main head continues to lick and kiss you, its long tongue diving into your mouth and down your throat. In your growing lust, you welcome it and suck on the meaty flesh eagerly. Its other heads roam across your body, ravishing your [bodydesc of Player] body in search of any sensitive, sexual spot to lick or tease[if Breast Size of Player > 0]. They start by focusing on your nipples, licking and sucking on them, causing you to moan in delight[end if][if Player is male]. Those toothy maws are surprisingly pleasurable as they take turns giving blowjobs to your cock[smn][end if]. Your cock-stuffed vaginae quiver around the hydra's pulsing manhoods, also getting teasing licks across their clits from the hydra's many darting tongues. The hydra's heads even engulf its own unused [if hydraheadcount + 1 is Cunt Count of Player]penis[else]penises[end if], working to suck itself off even as it fucks you.";
			say "     As the beast fucks you thoroughly, its many heads move around often, almost as if each wants to partake in all of you. Subject to such constant, all-encompassing stimulation, you are pushed to great heights of pleasure as they work cooperatively to build you up slowly to one powerful, vision-blurring climax that makes you cry out in ecstasy. As your cunts quiver and clench down upon the ridged shafts filling them, the hydra is driven over the edge and drives its rods deep into you, stuffing you so delightfully full of reptilian cock that your orgasmic delight surges again. The hot rush of its tainted semen from its [if Cunt Count of Player is 2]cocks[else]many cocks[end if], pumped from its heavy ballsack, shoots into your stuffed holes and down the [if hydraheadcount + 1 is Cunt Count of Player]throat of its sucking head[else]throats of its sucking heads[end if]. You are left feeling full and bloated with the beasts torrential load, your womb positively crammed full of its virile seed.[fovichance][if Cunt Count of Player > 2][fovichance][end if][if Cunt Count of Player > 4][fovichance][end if]";
			say "     When its climax finally comes to an end, it pulls its cocks from you one at a time, each emptied cunt releasing a gush of excess semen that pools beneath you. Sticky with the creature's cum, it takes some effort to pull yourself to your feet after that, your knees weak and your body positively tingling with the afterglow of your climax. The creature seems similarly dazed and happy, giving you a deep, tongue-filled kiss before you send it on its way[if hydraheadcount > 6]. As it departs, you can see its extra heads already decaying away, dropping off and melting into fleshy goop until it's down to its original half-dozen[else if hydraheadcount < 6]. As it departs, you can see the bulges of new heads starting to form at the severed stumps, the creature soon to be back up to a half-dozen[end if].";
	else:		[no cunts = anal]
		say "     It rumbles softly and moves eagerly atop you, nuzzling you and licking across your face as it moves into position. It shows some restraint, at least for the moment, gently probing its many cocks against your rear before lining one of them up with your crinkled hole. It grinds the tapered tip against your back door and, after releasing a gush of slick precum, eases your tight hole open to accept it. The unused shafts rub and slap against your bulging belly as their brethren fucks you. Its subtle ridges and tapered glans send shivers of pleasure through your body as the powerful creature thrusts into you again and again. Its pace at first is slow, but speeds up rapidly as its wild nature drives it to pound you like a beast, much to your increasing delight.";
		say "     While it fucks you, its main head continues to lick and kiss you, its long tongue diving into your mouth and down your throat. In your growing lust, you welcome it and suck on the meaty flesh eagerly. Its other heads roam across your body, ravishing your [bodydesc of Player] body in search of any sensitive, sexual spot to lick or tease[if Breast Size of Player > 0]. They start by focusing on your nipples, licking and sucking on them, causing you to moan in delight[end if][if Player is male]. Those toothy maws are surprisingly pleasurable as they take turns giving blowjobs to your cock[smn][end if]. The hydra's heads even engulf its own unused penises, working to suck itself off even as it fucks you.";
...
When Play begins:
	...
	add "Hydra Beast" to infections of InternalBallsList;
	...
	now desc entry is "     Before you is a large, monstrous creature of scales and jaws. The multi-headed hydra has a half-dozen heads on long, serpentine necks. Each head is very reptilian, draconic even, with a thick muzzle filled with sharp fangs and a long, tapered tongue. Its predatory eyes watch the world through its many slitted pupils. It has a wide, stocky body and trundles forward on four legs. The many twining necks of its heads are attached to these widened shoulders and upper back, allowing it to fit them all. These necks are slender and flexible, allowing the hydra to bring them all into position as needed. Its heavy, armored hide is covered in thick, emerald scales to guard its body. There is also a heavy, musky scent of male arousal in the air around the creature as well, telling you that, despite its fearsome appearance, it seeks sex like most other creatures roaming about.[line break]";
	...
	now MilkItem entry is "hydra beast milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "hydra beast cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	...
	if hydramaulcount is 4:				[tries special attack every fourth time]
		...
		repeat with x running from 1 to hydraheadcount:
			...
			if monsterhit is true:
				choose row MonsterID from the Table of Random Critters;
				now hbdmg is ( wdam entry times a random number from ( 80 - ( peppereyes * 4 ) ) to 120 ) / 166; [dmg/hit at 60%]
		...
		if hbdmgtotal > 0:
			...
			decrease HP of Player by hbdmgtotal;
