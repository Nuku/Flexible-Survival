...
to say larissaview:
	if HP of Larissa <= 2:
		...
		say "Manning the counter is Larissa, now a [if Larissa is herm]herm[else if Larissa is male]male[else if Larissa is female]female[else]neuter[end if] [LarissaForm] who seems pretty pleased with [possadj of Larissa] new look. ";
...
[		say "***human form, to be revised later.";]
		say "     She is about five and a half feet, with suntanned flesh. She seems perfectly human - an oddness in this city. Her name badge, worn on her generous chest, reads 'Larissa'. She has brown straight hair that goes down a little past her shoulders. She wears a lab coat, but it seems more like a uniform than any actual dedication to the sciences. It certainly looks cute on her though. Her silver eyes have specks of brown in them, easily seen as she asks how she can help you in a cheerful tone.";
	else:
		say "     Through your assistance, Larissa has become infected to become a [if Larissa is herm]herm[else if Larissa is male]male[else if Larissa is female]female[else]neuter[end if] [LarissaForm]. [subjpro_Cap of Larissa] has taken on the form of [LarissaBody] over which [subjpro of Larissa] wears a modified lab coat as part of [possadj of Larissa] uniform. Hanging from one pocket, [subjpro of Larissa] has an identification badge with [possadj of Larissa] name and current photo on it. [subjpro_Cap of Larissa] has [a LarissaFace] face[if LarissaTailed is true], [LarissaSkin] and [a LarissaTail][else] and [LarissaSkin][end if]. Overall, you think [subjpro of Larissa] looks quite [LarissaGeneralLook] as [subjpro of Larissa] [if LarissaBodycat is 0]sits at [possadj of Larissa] desk and types with [possadj of Larissa] [LarissaHandForm]s[else if LarissaBodycat is 1]sits on a raised mat in front of [possadj of Larissa] keyboard, typing away with [possadj of Larissa] [LarissaHandForm]s[else if LarissaBodycat is 2]tauric body resting on a mat on the floor in front of [possadj of Larissa] keyboard, typing away with [possadj of Larissa] [LarissaHandForm]s[else if LarissaBodycat is 3]lower body resting on a padded mat while [subjpro of Larissa] types away at [possadj of Larissa] keyboard with [possadj of Larissa] [LarissaHandForm]s[end if][if LarissaWinged is true]. [possadj_cap of Larissa] wings rustle occasionally as [subjpro of Larissa] works[end if][if ScaleValue of Larissa is 1]. [possadj_cap of Larissa] small office behind the counter seems quite roomy compared to [possadj of Larissa] tiny body[else if ScaleValue of Larissa is 2]. [possadj_cap of Larissa] office behind the counter seems a little roomier now that [subjpro of Larissa][']s gotten a little smaller[else if ScaleValue of Larissa is 4]. Being rather large, Larissa's small office behind the counter is pretty cramped[else if ScaleValue of Larissa is 5]. Having gotten quite huge, Larissa's poor office has become very cramped and has almost no free space for [objpro of Larissa][end if].";
		if Breast Size of Larissa > 0:	[titties!]
			say "     Poorly obscured by [possadj of Larissa] labcoat, you can see that Larissa has a pair of [Breast Size Desc of Larissa][if Nipple Count of Larissa is 4] with a second smaller pair beneath those[else if Nipple Count of Larissa > 4] with [((Nipple Count of Larissa - 2) / 2) in words] other pairs beneath those[end if]. Also half-hidden, almost as a tantalizing offer, Larissa has [if Larissa is herm]a [Cock Size Desc of Larissa] [LarissaCock] shaft, a pair of [Larissaballs] and a [Cunt Size Desc of Larissa] wet cunt between [possadj of Larissa] legs[else if Larissa is male]a [Cock Size Desc of Larissa] [LarissaCock] shaft with a pair of [Larissaballs] between [possadj of Larissa] legs[else if Larissa is female]a [Cunt Size Desc of Larissa] wet cunt between [possadj of Larissa] legs[else if Larissa is neuter]a plain and featureless groin[end if]. [subjpro_Cap of Larissa] gives you a playful grin and shifts to give you a better view of [possadj of Larissa] crotch while [subjpro of Larissa] works.";
		else:									[no titties :(]
			say "     Poorly obscured by [possadj of Larissa] labcoat, you can see that Larissa has [if Larissa is herm]a [Cock Size Desc of Larissa] [LarissaCock] shaft, a pair of [Larissaballs] and a [Cunt Size Desc of Larissa] wet cunt between [possadj of Larissa] legs[else if Larissa is male]a [Cock Size Desc of Larissa] [LarissaCock] shaft with a pair of [Larissaballs] between [possadj of Larissa] legs[else if Larissa is female]a [Cunt Size Desc of Larissa] wet cunt between [possadj of Larissa] legs[else if Larissa is neuter]a plain and featureless groin[end if]. [subjpro_Cap of Larissa] gives you a playful grin and shifts to give you a better view of [possadj of Larissa] crotch while [subjpro of Larissa] works.";
	if HP of Larissa >= 2:
...
Section 1 - General Conversation Tree
...
instead of conversing Larissa:
	...
	if HP of Doctor Matt is 16:
	...
	else if HP of Doctor Matt is 17 and ndmlist is not empty and a random chance of 1 in 3 succeeds:
		say "[zephyrmatt2]"; [task reminder]
	else if HP of Doctor Matt is 17 and ndmlist is empty:
	...
	else if hospquest is 17 and ndmlist is not empty and a random chance of 1 in 3 succeeds:
		say "[zephyrmouse2]"; [task reminder]
	else if hospquest is 17 and ndmlist is empty:
		say "[zephyrmouse3]"; [task completion]
		if HP of Larissa is 0:
			say "     'So, cute stuff,' Larissa adds, 'what're you up to later?' Cha-ching!";
			now HP of Larissa is 1;
	else if HP of Larissa is 0:
		say "     'We are looking for extracted vial samples. If you obtain some, please bring them to me to ['][bold type]vialsell <name>[roman type]['] for a credited reward.'";
		...
		say "     [one of]'We are still looking for extracted vial samples. If you obtain some, please bring them to me to ['][bold type]vialsell <name>[roman type]['] for a credited reward.' [subjpro_Cap of Larissa] then grins and leans forward. 'Or you can use it to [link]transform[as]transform Larissa[end link] me if it's on my want list.'[or]'At first, I wasn't too keen on coming here and risking getting transformed. But the more I see the sexy creatures, the more I want to give it a try.'[or]'You guys are all lucky that Zephyr's such a great company that we were able come and help out so fast. I'm a little surprised how fast we've come up with a lot of this stuff.'[or]'You should know, this nanite thing isn't just happening here. It's happening all over the country. Sometimes it's just cities, but in a few places, it's whole states.'[or][if vialsnagging is true]'Don't forget to try getting samples from creatures on my want list.'[else]'If you want to [link]transform[as]transform Larissa[end link] me, you'll need to use a nanite collector from the store here. Thankfully we're selling them fairly cheap,' [subjpro of Larissa] says.[end if][or]'Next time I can take a break, we should definitely have a little fun,' [subjpro of Larissa] says with a wink.'[at random]";
	else if HP of Larissa is 3:
		say "     [one of]'We are still looking for extracted vial samples. If you obtain some, please bring them to me to ['][bold type]vialsell <name>[roman type]['] for a credited reward.' [subjpro_Cap of Larissa] then grins and leans forward. 'Or you can use it to [link]transform[as]transform Larissa[end link] me if it's on my want list.'[or]'At first, I wasn't too keen on coming here and risking getting transformed. But the more I see the sexy creatures, the more I want to give it a try.'[or]'You guys are all lucky that Zephyr's such a great company that we were able come and help out so fast. It's quite surprising how fast we've come up with a lot of this stuff.'[or]'You should know, this nanite thing isn't just happening here. It's happening all over the country. Sometimes it's just cities, but in a few places, it's whole states.'[or][if vialsnagging is true]'Don't forget to try getting samples from creatures on my want list so I can [link]transform[as]transform Larissa[end link] again.'[else]'If you want to [link]transform[as]transform Larissa[end link] me, you'll need to use a nanite collector from the store here. Thankfully we're selling them fairly cheap,' [subjpro of Larissa] says.[end if][or]'Next time I can take a break, we should definitely have a little fun,' [subjpro of Larissa] says with a wink.'[or]'I thought I might be happy sticking as a human for a while longer, but I'm already looking forward to changing again.'[at random]";
	else if HP of Larissa is 4:
		say "     [one of]'We are still looking for extracted vial samples. If you obtain some, please bring them to me to ['][bold type]vialsell <name>[roman type]['] for a credited reward.' [subjpro_Cap of Larissa] then grins and leans forward. 'Or you can use it to [link]transform[as]transform Larissa[end link] me if it's on my want list.'[or]'At first, I wasn't too keen on coming here and risking getting transformed. But the more I see the sexy creatures, the more I want to give it a try.'[or]'You guys are all lucky that Zephyr's such a great company that we were able come and help out so fast. I'm a little surprised how fast we've come up with a lot of this stuff.'[or]'You should know, this nanite thing isn't just happening here. It's happening all over the country. Sometimes it's just cities, but in a few places, it's whole states.'[or][if vialsnagging is true]'Don't forget to try getting samples from creatures on my want list so I can [link]transform[as]transform Larissa[end link] again.'[else]'If you want to [link]transform[as]transform Larissa[end link] me, you'll need to use a nanite collector from the store here. Thankfully we're selling them fairly cheap,' [subjpro of Larissa] says.[end if][or]'Next time I can take a break, we should definitely have a little fun,' [subjpro of Larissa] says with a wink.'[or][if LarissaLastTF - turns < 20]'I'm liking this new look for me. Don't you think I look [LarissaGeneralLook]?' [subjpro of Larissa] asks with a happy smile.[else]'I'm getting a little bored with this new form of mine. Maybe we should consider picking a new form I can [link]transform[as]transform Larissa[end link] into,' [subjpro of Larissa] says.[end if][or]'What do you think of my [LarissaGeneralLook] look as a [LarissaForm]?'[at random]";
...
to say sexwithLarissa:
	if lastfuck of Larissa - turns < 8:
		...
		if Player is male:
			...
			NPCSexAftermath Larissa receives "OralPussy" from Player;
			NPCSexAftermath Player receives "OralPussy" from Larissa;
		...
		now lastfuck of Larissa is turns;
		say "     Larissa has a big grin on [possadj of Larissa] [LarissaFace] face at your offer to have a little fun and, [one of]upon conning someone into taking[or]after getting someone to take[or]after making someone take[or]upon finding someone to take[at random] over at [possadj of Larissa] desk for a little while, [subjpro of Larissa] leads you into the back. The [LarissaGeneralLook] [LarissaForm] takes you to the break room and flips a little sign on the door. The room itself is rather sparse but does have a small cot available. Pulling off [possadj of Larissa] lab coat, [subjpro of Larissa] stretches out, showing off [PossPro of Larissa]self as [LarissaBody], thanks to your assistance. [subjpro_Cap of Larissa] tosses the coat and [possadj of Larissa] other clothes over one of the chairs and pulls you into [possadj of Larissa] arms, kissing you firmly while your hands run over each other's bodies.";
		say "[LarissaTFsex]";

to say LarissaTFsex:		[Menu options to be added later as more scenes are composed?]
	if ( ( Player is male and Larissa is female ) or ( Player is female and Larissa is male ) ) and a random chance of 3 in 5 succeeds and BodyName of Player is listed in infections of TaurList and LarissaBodycat is 2:
		if Player is herm and Larissa is herm:			[H/H]
			if a random chance of 1 in 2 succeeds:
				say "[Larissasex_taurMF]"; [player tops]
			else:
				say "[Larissasex_taurFM]"; [Larissa tops]
		else if Player is male and Larissa is female:
			say "[Larissasex_taurMF]"; [player tops]
		else:
			say "[Larissasex_taurFM]"; [Larissa tops]
	...
	else if Player is male and Larissa is female:		[M/F, M/H, H/F]
		say "[Larissasex_MF]";
	else if Player is female and Larissa is male:		[F/M, F/H, H/M]
		say "[Larissasex_FM]";
	else if Larissa is male:						[M/M]
		let larfound be false;
		if there is a Name of LarissaInfName in Table of Random Critters:
			setmonster LarissaInfName silently;
			now larfound is true;
		let baby be false;
		if child is born or gestation of Child is not 0, now baby is true;
		if Cock Length of Larissa > ( scalevalue of Player + 1 ) * 12:	[too big, full body rub + oral]
			say "     He pushes you back onto the cot and presses his [Cock Size Desc of Larissa] [LarissaCock] cock down overtop of you with a wide grin. 'Mmm... I think I might be a little big for you now, which means you'd best get to licking,' he chuckles[if Player is male]. He grinds his cock down overtop of yours[end if][if Cock Length of Larissa > Cock Length of Player] with a smug grin at being better hung than you[end if] and pushes his cock to your face. Presented with his pulsing rod, you run your hands overtop of it and start licking and kissing it, drawing a low moan of delight from him. You slide your tongue all over it, taking long, slow licks that get him spurting precum. You even lick over his gaping cum slit and press your tongue into it, causing him to throw his head back and grip your sides with his [LarissaHandForm]s.";
			say "     Grinding his [LarissaCock] cock down onto your [BodyType of Player] body and having you lick and tease it eventually becomes too much for him, driving him to cum hard, shooting his cum all over your face and into your open mouth. You swallow down [if Ball Size of Larissa > 6]as much of the [LarissaForm][']s excessive load of semen as you can, but much of it ends up covering your face, the head of the bed and even the wall behind it[else if Ball Size of Larissa >= 5]much of the [LarissaForm][']s large load of semen, but there's lots of it left covering your face and the head of the bed[else]as much of the [LarissaForm][']s semen as you can get, but much of it ends up covering your face[end if] by the time he's drained. After having some more fun while helping to get cleaned up[if Player is male], getting you off as well[end if], he heads back out front and returns to his desk.";
			NPCSexAftermath Player receives "OralCock" from Larissa;
		else:
			say "     The [if Larissa is female]herm[else]male[end if] [LarissaForm] guides you down onto all fours, running his hands down your back to grab your ass. 'Mmm... I'm looking forward to being on top for a change,' he says, running a [LarissaHandForm] over [possadj of Larissa] [Cock Size Desc of Larissa] [LarissaCock] manhood. It dribbles some precum down your back and between your ass cheeks as he guides it into position at your back door. His [LarissaHandForm] gives your rear a squeeze before he teases a finger at your asshole, using his leaking pre to lube and loosen you up. Getting increasingly excited, you wiggle your bottom and grind back against him in open invitation to that sexy cock and its now [if Cock Length of Larissa > 24]hugely[else if Cock Length of Larissa > 12]largely[else if Cock Length of Larissa > 7]sizably[else]modestly[end if]-hung owner. Grinning, he leans overtop you, pressing his [LarissaBodyDesc] body against yours[if Breast Size of Larissa > 0], rubbing [possadj of Larissa] [Breast Size Desc of Larissa] bosom against your back[end if] as he prepares to mount you.";
			if Cock Length of Larissa > ( scalevalue of Player + 1 ) * 6:		[large]
				say "     [possadj_cap of Larissa] [Cock Size Desc of Larissa] [LarissaCock] penis is quite large [if ScaleValue of Player > 3]even when [end if]compared to your [Body Size Adjective of Player] body, necessitating that [subjpro of Larissa] start extra-slow as [subjpro of Larissa] thrusts into that tight ass of yours. [possadj_cap of Larissa] [Cock Size Desc of Larissa] prick makes a visibly phallic bump in your belly from having so much meat stuffed into you. You brace yourself as best you can for what's definitely going to be a hell of a ride. His thrusts are slow at first, but gradually pick up the pace as your body grows used to accommodating his [LarissaCock] rod. Soon your inner walls are squeezing and tugging at his pulsing shaft while his [if Breast Size of Larissa > 0][Breast Size Desc of Larissa] breasts press down against your back[else][LarissaBodyDesc] body presses down against your back[end if]. [if ScaleValue of Player is ScaleValue of Larissa]He nuzzles at your shoulders and neck, kissing and nipping along them[else if ScaleValue of Player < ScaleValue of Larissa]Being considerably larger than you, the [Body Size Adjective of Larissa] [LarissaForm] keeps you pinned down so he can pound you even harder[else]The smaller [LarissaForm] grips your ass tightly while pounding you hard and fast with his oversized cock[end if]. You moan and groan beneath him [if Player is male]while reaching around to grope your [Cock Size Desc of Player] [Cock of Player] cock[else]when he gives your ass a swat and drives hard into you[end if] with a chuckle.";
				say "     With his orgasm fast approaching, you work your ass harder over his prick and his [Larissaballs]. He pushes as deep as he can into you, bulging your belly with his cock as he unleashes his hot load. [if Ball Size of Larissa >= ( ScaleValue of Player + 4 )][possadj_cap of Larissa] enormous output causes your [BodyType of Player] belly to swell greatly, becoming bloated with [possadj of Larissa] seed. You are left full and leaking [possadj of Larissa] cum for quite some time after [subjpro of Larissa][']s done. When you finally drain or absorb enough to stagger out to the front lobby, you find [objpro of Larissa] sitting at [possadj of Larissa] desk with a smug look on [possadj of Larissa] [LarissaFace] face[else if Ball Size of Larissa >= ( ScaleValue of Player + 3 )][possadj_cap of Larissa] heavy output causes your [BodyType of Player] belly to swell further, leaving you with a prominent bulge of cum when you stagger back to the front lobby[else if Ball Size of Larissa >= ( ScaleValue of Player + 2 )][possadj_cap of Larissa] large output leaves your [BodyType of Player] belly full and leaking [possadj of Larissa] cum when you head back to the front lobby[else]After [subjpro of Larissa][']s done, Larissa heads back to [possadj of Larissa] desk with a contented smile on [possadj of Larissa] [LarissaFace] face[end if].[if Ball Size of Larissa >= 5 and a random chance of 1 in 2 succeeds][mimpregchance][end if]";
			else:
				say "     [possadj_cap of Larissa] [Cock Size Desc of Larissa] [LarissaCock] penis presses slowly into your [Body Size Adjective of Player] body as the former female mounts you. He thrusts steadily into that tight ass of yours, pushing a little further each time until he's fully sheathed inside you. You brace yourself as best you can and get your rear into a better position to get pounded by the horny [LarissaForm]. His thrusts are slow at first, but gradually pick up the pace as your body grows used to accommodating his [LarissaCock] rod. Soon your inner walls are squeezing and tugging at his pulsing shaft while his [if Breast Size of Larissa > 0][Breast Size Desc of Larissa] breasts press down against your back[else][LarissaBodyDesc] body presses down against your back[end if]. [if ScaleValue of Player is ScaleValue of Larissa]He nuzzles at your shoulders and neck, kissing and nipping along them[else if ScaleValue of Player < ScaleValue of Larissa]. Being considerably larger than you, the [Body Size Adjective of Larissa] [LarissaForm] keeps you pinned down so he can pound you even harder[else]The smaller [LarissaForm] grips your ass tightly while pounding you hard and fast with his cock[end if]. You moan and groan beneath him [if Player is male]while reaching around to grope your [Cock Size Desc of Player] [Cock of Player] cock[else]when he gives your ass a swat and drives hard into you[end if] with a chuckle.";
				say "     With his orgasm fast approaching, you work your ass harder over his prick and his [Larissaballs]. He pushes fully into you, causing you to moan wantonly as he unleashes his hot load. [if Ball Size of Larissa >= ( ScaleValue of Player + 4 )][possadj_cap of Larissa] enormous output causes your [BodyType of Player] belly to swell greatly, becoming bloated with [possadj of Larissa] seed. You are left full and leaking [possadj of Larissa] cum for quite some time after [subjpro of Larissa][']s done. When you finally drain or absorb enough to stagger out to the front lobby, you find [objpro of Larissa] sitting at [possadj of Larissa] desk with a smug look on [possadj of Larissa] [LarissaFace] face[else if Ball Size of Larissa >= ( ScaleValue of Player + 3 )][possadj_cap of Larissa] heavy output causes your [BodyType of Player] belly to swell, leaving you with a prominent bulge of cum when you stagger back to the front lobby[else if Ball Size of Larissa >= ( ScaleValue of Player + 2 )][possadj_cap of Larissa] large output leaves your [BodyType of Player] belly full and leaking [possadj of Larissa] cum when you head back to the front lobby[else]After [subjpro of Larissa][']s done, Larissa heads back to [possadj of Larissa] desk with a contented smile on [possadj of Larissa] [LarissaFace] face[end if].[if Ball Size of Larissa >= 5 and a random chance of 1 in 2 succeeds][mimpregchance][end if]";
			NPCSexAftermath Player receives "AssFuck" from Larissa;
			if baby is false and gestation of Child is not 0 and Larfound is false:
				now FaceName of Child is LarissaInfName;
				now BodyName of Child is LarissaInfName;
				now SkinName of Child is LarissaInfName;
	else if Larissa is female:						[F/F]
		...
		NPCSexAftermath Larissa receives "Stroking" from Player;
		NPCSexAftermath Player receives "Stroking" from Larissa;
	[else:										[?/N]
...
to say Larissasex_MF:
	say "     You guide the [if Larissa is male]herm[else]female[end if] [LarissaForm] down onto the cot and smile down at her as she spreads her legs for you. The [LarissaSkin] covering her [LarissaBodyType] body is quite lovely, making you pause to take in her [LarissaGeneralLook] form. As lovely as the sight is, you can't wait any longer to admire it and hop into bed with her. You spread her legs and slip your hand between her thighs, rubbing at her [if Larissa is male][Cock Size Desc of Larissa] [LarissaCock] maleness and [Cunt Size Desc of Larissa] pussy[else][Cunt Size Desc of Larissa] pussy[end if]. You nuzzle at her chest, [if Breast Size of Larissa > 0]bringing your mouth to her [Breast Size Desc of Larissa] breasts and kissing her nipples[else]then up to her neck to kiss and nibble along it[end if], much to her delight.";
	if Cock Length of Player > ( Cunt Depth of Larissa * 2 ) + Cunt Tightness of Larissa + 2:			[super-big]
		...
		say "     Sensing your orgasm coming, she presses your glans to her pussy and grinds hard against it. You cum with a loud moan. While much of your seed soaks her crotch, some blasts shoot into her[if Ball Size of Player > 6]. This results in still a sizable amount of semen squirted into the woman[else if Ball Size of Player >= 5]. This results in quite a bit of semen still getting squirted into the woman[end if]. The pleasure of you cumming onto and into her pushes her over the edge into orgasm as well, [if Larissa is male]spraying her seed across her [LarissaBodyDesc] body and [end if]adding her pussy juices to the sticky mess at her crotch. You both snuggle together while recovering from powerful climaxes and, after a little more fun while cleaning each other up, head back out front.";
		NPCSexAftermath Player receives "Stroking" from Larissa;
...
to say Larissasex_FM:
	...
	let baby be false;
	if child is born or gestation of Child is not 0, now baby is true;
	say "     The [if Larissa is female]herm[else]male[end if] [LarissaForm] guides you down onto the cot. [subjpro_Cap of Larissa] smiles down at you as [subjpro of Larissa] spreads your legs. 'I'm looking forward to being on top for a change,' [subjpro of Larissa] says, running a [LarissaHandForm] over [possadj of Larissa] [Cock Size Desc of Larissa] [LarissaCock] manhood. It dribbles some precum down onto your waiting crotch while [subjpro of Larissa] rubs [possadj of Larissa] [LarissaBodyDesc] body against yours[if Breast Size of Larissa > 0], pressing [possadj of Larissa] [Breast Size Desc of Larissa] bosom down onto you[end if]. Getting increasingly excited, you slide your hands [if Player is male]past your own maleness [end if]between your thighs and spread your pussy in open invitation to that sexy cock and its now [if Cock Length of Larissa > 24]hugely[else if Cock Length of Larissa > 12]largely[else if Cock Length of Larissa > 7]sizably[else]modestly[end if]-hung owner.";
	if Cock Length of Larissa > ( Cunt Depth of Player * 2 ) + Cunt Tightness of Player + 2:			[super-big]
		say "     [possadj_cap of Larissa] [Cock Size Desc of Larissa] [LarissaCock] penis is too large [if Cunt Depth of Player >= 12]even [end if]for your [Cunt Size Desc of Player] pussy, so [subjpro of Larissa] satisfies [objpro of Larissa]self by rubbing [possadj of Larissa] maleness down against you, grinding it across your juicy folds[if Player is male] and throbbing shaft[end if]. You move your hands up to [possadj of Larissa] lovely [if Breast Size of Larissa > 0][Breast Size Desc of Larissa] breasts, caressing them and teasing [possadj of Larissa] nipples[else][LarissaBodyType] body, caressing [possadj of Larissa] [LarissaBodyType] form[end if]. Pressing [possadj of Larissa] [LarissaMouth] to your lips, [subjpro of Larissa] kisses you with a soft moan of pleasure. When your hands slide further to caress [possadj of Larissa] [LarissaCock] shaft and [Larissaballs], [subjpro of Larissa] spurts precum across your [bodydesc of Player] body and kisses you all the more excitedly.";
		say "     With [possadj of Larissa] orgasm approaching, you press [possadj of Larissa] glans to your pussy and grind hard against it. [subjpro_Cap of Larissa] cums with a loud moan of release. While much of [possadj of Larissa] seed soaks your crotch, some blasts shoot into you[if Ball Size of Larissa > 6]. This results in still a sizable amount of semen squirted into you[else if Ball Size of Larissa >= 5]. This results in quite a bit of semen still getting squirted into you[end if]. Feeling these spurts of [possadj of Larissa] hot semen splashing onto and into your cunt pushes you over the edge into orgasm as well[if Player is male]spraying your seed across your [BodyType of Player] body and [end if]adding your feminine juices to the sticky mess at your crotch. You both snuggle together while recovering from the powerful climax and, after a little more fun while cleaning each other up, head back out front.[if Ball Size of Larissa >= 5 or a random chance of 1 in 2 succeeds][impregchance][end if]";
		NPCSexAftermath Player receives "Stroking" from Larissa;
	else if Cock Length of Larissa > Cunt Depth of Player + Cunt Tightness of Player + 2:			[large]
		say "     [possadj_cap of Larissa] [Cock Size Desc of Larissa] [LarissaCock] penis is quite large compared to your [Cunt Size Desc of Player] pussy, necessitating that [subjpro of Larissa] start slowly as [subjpro of Larissa] thrusts into those wet folds of yours, making a visible bump in your belly from having [possadj of Larissa] [Cock Size Desc of Larissa] rod stuffed in you. You move your hands up to [possadj of Larissa] lovely [if Breast Size of Larissa > 0][Breast Size Desc of Larissa] breasts, caressing them and teasing [possadj of Larissa] nipples[else][LarissaBodyType] body, caressing [possadj of Larissa] [LarissaBodyType] form[end if]. Pressing [possadj of Larissa] [LarissaMouth] to your lips, [subjpro of Larissa] kisses you with a soft moan of pleasure. Once you've loosened up enough, you slide a hand down to rub [possadj of Larissa] [Larissaballs] and urge [objpro of Larissa] to fuck you faster and harder between kisses.";
		say "     With [possadj of Larissa] orgasm approaching, you knead [possadj of Larissa] balls and squeeze your inner walls around [possadj of Larissa] maleness. [subjpro_Cap of Larissa] pushes as deep as [subjpro of Larissa] can into you, bulging your belly with [possadj of Larissa] cock as [subjpro of Larissa] unleashes [possadj of Larissa] hot load. [if Ball Size of Larissa >= ( ScaleValue of Player + 4 )][possadj_cap of Larissa] enormous output causes your [BodyType of Player] belly to swell greatly, becoming bloated with [possadj of Larissa] seed. You are left full and leaking [possadj of Larissa] cum for quite some time after [subjpro of Larissa][']s done. When you finally drain or absorb enough to stagger out to the front lobby, you find [objpro of Larissa] sitting at [possadj of Larissa] desk with a smug look on [possadj of Larissa] [LarissaFace] face[else if Ball Size of Larissa >= ( ScaleValue of Player + 3 )][possadj_cap of Larissa] heavy output causes your [BodyType of Player] belly to swell further, leaving you with a prominent bulge of cum when you stagger back to the front lobby[else if Ball Size of Larissa >= ( ScaleValue of Player + 2 )][possadj_cap of Larissa] large output leaves your [BodyType of Player] belly full and leaking [possadj of Larissa] cum when you head back to the front lobby[else]After [subjpro of Larissa][']s done, Larissa heads back to [possadj of Larissa] desk with a contented smile on [possadj of Larissa] [LarissaFace] face[end if].[if Ball Size of Larissa >= 5 and a random chance of 1 in 2 succeeds][impregchance][end if]";
		NPCSexAftermath Player receives "PussyFuck" from Larissa;
	else if Cock Length of Larissa < ( Cunt Depth of Player + Cunt Tightness of Player + 1 ) / 3:		[small]
		say "     [possadj_cap of Larissa] [Cock Size Desc of Larissa] [LarissaCock] is quite small compared to your [Cunt Size Desc of Player] pussy, letting [objpro of Larissa] thrust into you easily, but provides limited stimulation for you. To make up for this, [subjpro of Larissa] rubs and teases at your wet folds and clit with one [LarissaHandForm], making you quiver in delight. You move your hands up to [possadj of Larissa] lovely [if Breast Size of Larissa > 0][Breast Size Desc of Larissa] breasts, caressing them and teasing [possadj of Larissa] nipples[else][LarissaBodyType] body, caressing [possadj of Larissa] [LarissaBodyType] form[end if]. Pressing [possadj of Larissa] [LarissaMouth] to your lips, [subjpro of Larissa] kisses you with a soft moan of pleasure. As [subjpro of Larissa] fucks you, you slide a hand down to rub [possadj of Larissa] [Larissaballs] and urge [objpro of Larissa] to fuck you faster and harder between kisses.";
		say "     With [possadj of Larissa] orgasm approaching, you knead [possadj of Larissa] balls and squeeze your inner walls around [possadj of Larissa] maleness. [subjpro_Cap of Larissa] pushes fully into you and unleashes [possadj of Larissa] hot load. [if Ball Size of Larissa >= ( ScaleValue of Player + 4 )][possadj_cap of Larissa] enormous output causes your [BodyType of Player] belly to swell greatly, becoming bloated with [possadj of Larissa] seed. You are left full and leaking [possadj of Larissa] cum for quite some time after [subjpro of Larissa][']s done. When you finally drain or absorb enough to stagger out to the front lobby, you find [objpro of Larissa] sitting at [possadj of Larissa] desk with a smug look on [possadj of Larissa] [LarissaFace] face[else if Ball Size of Larissa >= ( ScaleValue of Player + 3 )][possadj_cap of Larissa] heavy output causes your [BodyType of Player] belly to swell, leaving you with a prominent bulge of cum when you stagger back to the front lobby[else if Ball Size of Larissa >= ( ScaleValue of Player + 2 )][possadj_cap of Larissa] large output leaves your [BodyType of Player] belly full and leaking [possadj of Larissa] cum when you head back to the front lobby[else]After [subjpro of Larissa][']s done, Larissa heads back to [possadj of Larissa] desk with a contented smile on [possadj of Larissa] [LarissaFace] face[end if].[if Ball Size of Larissa >= 5 and a random chance of 1 in 2 succeeds][impregchance][end if]";
		NPCSexAftermath Player receives "PussyFuck" from Larissa;
	else:		[compatible size - normal]
		say "     [subjpro_Cap of Larissa] slides [possadj of Larissa] [Cock Size Desc of Larissa] [LarissaCock] penis into your [Cunt Size Desc of Player] pussy, enjoying the wonderful sensation of you squeezing down around [possadj of Larissa] maleness. You move your hands up to [possadj of Larissa] lovely [if Breast Size of Larissa > 0][Breast Size Desc of Larissa] breasts, caressing them and teasing [possadj of Larissa] nipples[else][LarissaBodyType] body, caressing [possadj of Larissa] [LarissaBodyType] form[end if]. Pressing [possadj of Larissa] [LarissaMouth] to your lips, [subjpro of Larissa] kisses you with a soft moan of pleasure. As [subjpro of Larissa] fucks you, you slide a hand down to rub [possadj of Larissa] [Larissaballs] and urge [objpro of Larissa] to fuck you faster and harder between kisses.";
		say "     With [possadj of Larissa] orgasm approaching, you knead [possadj of Larissa] balls and squeeze your inner walls around [possadj of Larissa] maleness. [subjpro_Cap of Larissa] pushes fully into you and unleashes [possadj of Larissa] hot load. [if Ball Size of Larissa >= ( ScaleValue of Player + 4 )][possadj_cap of Larissa] enormous output causes your [BodyType of Player] belly to swell greatly, becoming bloated with her seed. You are left full and leaking [possadj of Larissa] cum for quite some time after [subjpro of Larissa][']s done. When you finally drain or absorb enough to stagger out to the front lobby, you find [objpro of Larissa] sitting at [possadj of Larissa] desk with a smug look on [possadj of Larissa] [LarissaFace] face[else if Ball Size of Larissa >= ( ScaleValue of Player + 3 )][possadj_cap of Larissa] heavy output causes your [BodyType of Player] belly to swell, leaving you with a prominent bulge of cum when you stagger back to the front lobby[else if Ball Size of Larissa >= ( ScaleValue of Player + 2 )][possadj_cap of Larissa] large output leaves your [BodyType of Player] belly full and leaking [possadj of Larissa] cum when you head back to the front lobby[else]After [subjpro of Larissa][']s done, Larissa heads back to [possadj of Larissa] desk with a contented smile on [possadj of Larissa] [LarissaFace] face[end if].[if Ball Size of Larissa >= 5 and a random chance of 1 in 2 succeeds][impregchance][end if]";
		NPCSexAftermath Player receives "PussyFuck" from Larissa;
	if baby is false and gestation of Child is not 0 and Larfound is false:
		now FaceName of Child is LarissaInfName;
		now BodyName of Child is LarissaInfName;
...
to say Larissasex_taurMF:
	...
	if Cock Length of Player > ( Cunt Depth of Larissa * 2 ) + Cunt Tightness of Larissa + 2:			[super-big]
		...
		say "     Sensing your orgasm coming, you shift your position enough to press your glans to her pussy and grind hard against it. You cum with a loud moan. While much of your seed soaks her crotch and your underbelly, some blasts shoot into her[if Ball Size of Player > 6]. This results in still a sizable amount of semen squirted into the transformed woman[else if Ball Size of Player >= 5]. This results in quite a bit of semen still getting squirted into the transformed woman[end if]. The pleasure of you cumming onto and into her pushes her over the edge into orgasm as well, [if Larissa is male]spraying her seed across the floor and [end if]adding her pussy juices to the sticky mess at her crotch. You both snuggle together while recovering from powerful climaxes and, after a little more fun while cleaning each other up, head back out front.";
		NPCSexAftermath Larissa receives "Stroking" from Player;
	else if Cock Length of Player > Cunt Depth of Larissa + Cunt Tightness of Larissa + 2:			[large]
		...
		say "     Sensing your orgasm coming, she braces herself with all her legs and pushes back firmly to help you drive as deep as you can go into her, bulging her belly with your cock as you unleash your hot load. [if Ball Size of Player >= ( ScaleValue of Larissa + 4 )]Your enormous output causes the [LarissaForm][']s belly to swell greatly, becoming bloated with your seed. She is left full and leaking your cum for quite some time after you're done before she's able to get up and return to her desk[else if Ball Size of Player >= ( ScaleValue of Larissa + 3 )]Your heavy output causes the [LarissaForm][']s belly to swell further, leaving her with a prominent bulge of cum when she heads back to her desk[else if Ball Size of Player >= ( ScaleValue of Larissa + 2 )]Your large output leaves the [LarissaForm] full and leaking your cum when she heads back to her desk[else]After you're done, Larissa heads back to her desk with a contented smile on her face[end if].";
		NPCSexAftermath Larissa receives "PussyFuck" from Player;
	else if Cock Length of Player < ( Cunt Depth of Larissa + Cunt Tightness of Larissa + 1 ) / 3:		[small]
		say "     Your [Cock Size Desc of Player] [Cock of Player] penis is quite small compared to her [Cunt Size Desc of Larissa] pussy, letting you thrust into her easily, but providing limited stimulation for her. To alleviate this, you ride her all the harder while manhandling her humanoid upper body, drawing sounds of pleasure from her. She moans and wraps her arms around yours, hugging them to her [if Breast Size of Larissa > 0][Breast Size Desc of Larissa] breasts[else]chest[end if] while you lick and kiss one another, pressing your lips to her [LarissaMouth]. Your tauric form grips hers as you rut her like a beast, much to your mutual delight.";
		say "     Sensing your orgasm coming, she braces herself with all her legs and pushes back firmly while urging you to ride her even harder. You pound away at her with your [Cock of Player] manhood before driving it fully into her and unleash your hot load. [if Ball Size of Player >= ( ScaleValue of Larissa + 4 )]Your enormous output causes the [LarissaForm][']s belly to swell greatly, becoming bloated with your seed. She is left full and leaking your cum for quite some time after you're done before she's able to get up and return to her desk[else if Ball Size of Player >= ( ScaleValue of Larissa + 3 )]Your heavy output causes the [LarissaForm][']s belly to swell, leaving her with a prominent bulge of cum when she heads back to her desk[else if Ball Size of Player >= ( ScaleValue of Larissa + 2 )]Your large output leaves the [LarissaForm] full and leaking your cum when she heads back to her desk[else]After you're done, Larissa heads back to her desk with a contented smile on her face[end if].";
		NPCSexAftermath Larissa receives "PussyFuck" from Player;
	else:		[compatible size - normal]
...
to say Larissasex_taurFM:
	...
	let baby be false;
	if child is born or gestation of Child is not 0, now baby is true;
	say "     The [if Larissa is female]herm[else]male[end if] [LarissaForm] guides you to the open area beside the cot and moves in behind you. [subjpro_Cap of Larissa] grins as you brace your legs and wiggle your rear end tantalizingly at [objpro of Larissa]. 'I'm looking forward to mounting that sexy taur body of yours,' [subjpro of Larissa] says, running a [LarissaHandForm] across your ass. [subjpro_Cap of Larissa] doesn't tary, moving [possadj of Larissa] [LarissaBodyDesc] body over yours. [subjpro_Cap of Larissa] grips you with [possadj of Larissa] forelegs and puts [possadj of Larissa] arms around your humanoid upper body as [subjpro of Larissa] brings [possadj of Larissa] [Cock Size Desc of Larissa] [LarissaCock] into position[if Breast Size of Larissa > 0]. Even as [subjpro of Larissa] grinds [possadj of Larissa] cock against your cunny, you can feel [possadj of Larissa] [Breast Size Desc of Larissa] breasts pressed against your back[end if]. You moan at this and hold your hips steady with your pussy in invitation of that sexy cock and its now [if Cock Length of Larissa > 24]hugely[else if Cock Length of Larissa > 12]largely[else if Cock Length of Larissa > 7]sizably[else]modestly[end if]-hung owner to take you.";
	if Cock Length of Larissa > ( Cunt Depth of Player * 2 ) + Cunt Tightness of Player + 2:			[super-big]
		...
		say "     With [possadj of Larissa] orgasm approaching, [subjpro of Larissa] presses [possadj of Larissa] glans to your pussy and grinds hard against it, causing you to moan. [subjpro_Cap of Larissa] cums with a loud moan of release as [possadj of Larissa] [Larissaballs] send out their payload. While much of [possadj of Larissa] seed soaks your crotch, some blasts shoot into you[if Ball Size of Larissa > 6]. This results in still a sizable amount of semen squirted into you[else if Ball Size of Larissa >= 5]. This results in quite a bit of semen still getting squirted into you[end if]. Feeling these spurts of [possadj of Larissa] hot semen splashing onto and into your cunt pushes you over the edge into orgasm as well[if Player is male]spraying your seed across the floor and [end if]adding your feminine juices to the sticky mess at your crotch. You both snuggle together while recovering from the powerful climax and, after a little more fun while cleaning each other up, head back out front.[if Ball Size of Larissa >= 5 or a random chance of 1 in 2 succeeds][impregchance][end if]";
		NPCSexAftermath Player receives "Stroking" from Larissa;
	else if Cock Length of Larissa > Cunt Depth of Player + Cunt Tightness of Player + 2:			[large]
		say "     [possadj_cap of Larissa] [Cock Size Desc of Larissa] [LarissaCock] penis is quite large compared to your [Cunt Size Desc of Player] pussy, necessitating that [subjpro of Larissa] start slowly as [subjpro of Larissa] thrusts into those wet folds of yours, making a visible bump in your underbelly from having [possadj of Larissa] [Cock Size Desc of Larissa] rod stuffed in you[if Breast Size of Player > 0]. [subjpro_Cap of Larissa] moves [possadj of Larissa] hands to your breasts, cupping your [short Breast Size Desc of Player] bosom, caressing and teasing your breasts and nipples[end if]. Turning your head to the side, you press your lips to [PossPro of Larissa] in a kiss while moaning in pleasure while [subjpro of Larissa] works that [LarissaCock] manhood further into you. Once you've loosened up enough, you push back into [possadj of Larissa] thrusts and urge [objpro of Larissa] to fuck you faster and harder between kisses.";
		say "     With [possadj of Larissa] orgasm approaching, [subjpro of Larissa] picks up the pace and pounds away at you with increasing zeal, [possadj of Larissa] [Larissaballs] slapping against you as you're pounded by the lustful taur. [subjpro_Cap of Larissa] pushes as deep as [subjpro of Larissa] can into you, bulging your belly with [possadj of Larissa] cock as [subjpro of Larissa] unleashes [possadj of Larissa] hot load. [if Ball Size of Larissa >= ( ScaleValue of Player + 4 )][possadj_cap of Larissa] enormous output causes your [BodyType of Player] belly to swell greatly, becoming bloated with [possadj of Larissa] seed. You are left full and leaking [possadj of Larissa] cum for quite some time after [subjpro of Larissa][']s done. When you finally drain or absorb enough to stagger out to the front lobby, you find [objpro of Larissa] sitting at [possadj of Larissa] desk with a smug look on [possadj of Larissa] [LarissaFace] face[else if Ball Size of Larissa >= ( ScaleValue of Player + 3 )][possadj_cap of Larissa] heavy output causes your [BodyType of Player] belly to swell further, leaving you with a prominent bulge of cum when you stagger back to the front lobby[else if Ball Size of Larissa >= ( ScaleValue of Player + 2 )][possadj_cap of Larissa] large output leaves your [BodyType of Player] belly full and leaking [possadj of Larissa] cum when you head back to the front lobby[else]After [subjpro of Larissa][']s done, Larissa heads back to [possadj of Larissa] desk with a contented smile on [possadj of Larissa] [LarissaFace] face[end if].[if Ball Size of Larissa >= 5 and a random chance of 1 in 2 succeeds][impregchance][end if]";
		NPCSexAftermath Player receives "PussyFuck" from Larissa;
	else if Cock Length of Larissa < ( Cunt Depth of Player + Cunt Tightness of Player + 1 ) / 3:		[small]
		say "     [possadj_cap of Larissa] [Cock Size Desc of Larissa] [LarissaCock] is quite small compared to your [Cunt Size Desc of Player] pussy, letting [objpro of Larissa] thrust into you easily, but provides limited stimulation for you. To alleviate this, [subjpro of Larissa] rides you all the harder while manhandling your upper body, getting you to moan in pleasure[if Breast Size of Player > 0]. [subjpro_Cap of Larissa] moves [possadj of Larissa] [LarissaHandForm]s to your breasts, cupping your [short Breast Size Desc of Player] bosom, caressing and teasing your breasts and nipples[end if]. You put your arms around [PossPro of Larissa] and tilt your head back to kiss [possadj of Larissa] lustfully on the [LarissaMouth]. As [subjpro of Larissa] fucks you, you push back into [possadj of Larissa] thrusts and urge [objpro of Larissa] to fuck you faster and harder between kisses.";
		say "     With [possadj of Larissa] orgasm approaching, [subjpro of Larissa] picks up the pace and pounds away at you with increasing zeal, [possadj of Larissa] [Larissaballs] slapping against you as you're pounded by the lustful taur. [subjpro_Cap of Larissa] pushes [possadj of Larissa] [LarissaCock] cock fully into you and unleashes [possadj of Larissa] hot load. [if Ball Size of Larissa >= ( ScaleValue of Player + 4 )][possadj_cap of Larissa] enormous output causes your [BodyType of Player] belly to swell greatly, becoming bloated with [possadj of Larissa] seed. You are left full and leaking [possadj of Larissa] cum for quite some time after [subjpro of Larissa][']s done. When you finally drain or absorb enough to stagger out to the front lobby, you find [objpro of Larissa] sitting at [possadj of Larissa] desk with a smug look on [possadj of Larissa] [LarissaFace] face[else if Ball Size of Larissa >= ( ScaleValue of Player + 3 )][possadj_cap of Larissa] heavy output causes your [BodyType of Player] belly to swell further, leaving you with a prominent bulge of cum when you stagger back to the front lobby[else if Ball Size of Larissa >= ( ScaleValue of Player + 2 )][possadj_cap of Larissa] large output leaves your [BodyType of Player] belly full and leaking [possadj of Larissa] cum when you head back to the front lobby[else]After [subjpro of Larissa][']s done, Larissa heads back to [possadj of Larissa] desk with a contented smile on [possadj of Larissa] [LarissaFace] face[end if].[if Ball Size of Larissa >= 5 and a random chance of 1 in 2 succeeds][impregchance][end if]";
		NPCSexAftermath Player receives "PussyFuck" from Larissa;
	else:		[compatible size - normal]
...
Chapter 5 - Transformation Mechanics
...
Section 2 - Transformation Dialog and Scene
...
carry out Larissatfing:
	...
	if HP of Larissa is 1:
		...
		if scenario is not "Researcher" and nanitemeter is 0:
			...
			if "nanite collector" is a name listed in Table of Zephyr Goods:
	...
	if calcnumber > 0 and calcnumber <= number of entries in Larissa_possible_forms:
		if entry calcnumber in Larissa_possible_forms is:
			-- "Panda":
...
to say Larissa pre-tf:
	say "     Larissa takes the vial and debits the required credits with a grin. [subjpro_Cap of Larissa] seems quite excited at the prospect of transforming[if HP of Larissa > 2] again[end if]. After getting one of [possadj of Larissa] co-workers to cover the front desk for [objpro of Larissa], the [LarissaForm] leads you into the break room. Rather sparse, it does have a small cot available. Pulling off [possadj of Larissa] lab coat, [subjpro of Larissa] stretches out, showing off [possadj of Larissa] [LarissaBodyType] to you one last time before downing the vial in one big gulp.";
	if Larissa is herm:
		now LarissaOldgender is 3;
	else if Larissa is male:
		now LarissaOldgender is 1;
	else if Larissa is female:
		now LarissaOldgender is 2;
	else:
		now LarissaOldgender is 0;

to say Larissa post-tf:
	say "     Larissa moans and licks [if LarissaOldgender > 1]her[else]his[end if] lips and takes a seat on the edge of the cot. As you watch, Larissa's body [LarissaTFText] as the [LarissaInfName] infection kicks in. As you watch, [if LarissaOldgender > 1]she[else]he[end if] gains [LarissaSkin] all over [if LarissaOldgender > 1]her[else]his[end if] new [if LarissaOldgender > 1]her[else]his[end if] [LarissaBodyType] form.";
	if Larissa is male:		[male/herm]
		say "     [subjpro_Cap of Larissa] presses [possadj of Larissa] transformed [LarissaHandForm]s between [possadj of Larissa] legs and gropes [possadj of Larissa] changing crotch as [if LarissaOldgender is 1 or LarissaOldgender is 3][possadj of Larissa] shaft shifts and becomes a [Cock Size Desc of Larissa] [LarissaCock] cock[else][subjpro of Larissa] [one of]grows[or]gains[or]forms[at random] a [Cock Size Desc of Larissa] [LarissaCock] cock[end if][if Larissa is female] with a [Cunt Size Desc of Larissa] pussy waiting behind it[end if]. 'Oh, this feels so good. Mmm... let's have some fun now,' [subjpro of Larissa] says, running [possadj of Larissa] paws over [possadj of Larissa] altered body wantonly while stepping forward to [possadj of Larissa] [LarissaBodyType] form against yours. It seems the excitement of transformation's gotten the [LarissaForm] eager to see just what [possadj of Larissa] new body is like.";
	else if Larissa is female:	[female]
		say "     [subjpro_Cap of Larissa] presses [possadj of Larissa] transformed [LarissaHandForm]s between [possadj of Larissa] legs and gropes [possadj of Larissa] changing crotch as [if LarissaOldgender is 1 or LarissaOldgender is 3][possadj of Larissa] shaft shrinks and eventually disappears entirely as [possadj of Larissa] wet [Cunt Size Desc of Larissa] pussy forms[else if LarissaOldgender is 2][subjpro of Larissa] fingers [possadj of Larissa] wet, dripping snatch as it changes in response to [possadj of Larissa] transformation to become a [Cunt Size Desc of Larissa] pussy[else][possadj of Larissa] bare groin forms a wet [Cunt Size Desc of Larissa] pussy[end if]. 'Oh, this feels so good. Mmm... let's have some fun now,' [subjpro of Larissa] says, running [possadj of Larissa] paws over [possadj of Larissa] altered body wantonly while stepping forward to [possadj of Larissa] [LarissaBodyType] form against yours. It seems the excitement of transformation's gotten the [LarissaForm] eager to see just what [possadj of Larissa] new body is like.";
	else:					[neuter]
		say "     [subjpro_Cap of Larissa] presses [possadj of Larissa] transformed [LarissaHandForm]s between [possadj of Larissa] legs and gropes [possadj of Larissa] changing crotch as all signs of [possadj of Larissa] previous gender fade away, leaving [objpro of Larissa] with a bare, genderless groin. 'Oh, this feels so good. Mmm... let's have some fun now,' [subjpro of Larissa] says, running [possadj of Larissa] paws over [possadj of Larissa] altered body wantonly while stepping forward to [possadj of Larissa] [LarissaBodyType] form against yours. It seems the excitement of transformation's gotten the [LarissaForm] eager to see just what [possadj of Larissa] new body is like.";
	WaitLineBreak;
	if Player is not neuter:
		say "[LarissaTFsex]";
		now lastfuck of Larissa is turns;
	else:
		say "     You get [objpro of Larissa] to lie back on the cot while you run your hands over [possadj of Larissa] new [LarissaForm] body. Still very aroused from [possadj of Larissa] transformation, [subjpro of Larissa][']s soon moaning in pleasure as you help acquaint [objpro of Larissa] with [possadj of Larissa] body's changes. You bring your lips to [possadj of Larissa] [if Breast Size of Larissa > 0 and Nipple Count of Larissa > 2]bosom and start kissing [possadj of Larissa] numerous breasts and sucking on [possadj of Larissa] nipples[else if Breast Size of Larissa > 0]bosom and start kissing [possadj of Larissa] breasts and sucking on [possadj of Larissa] nipples[else][LarissaMouth] and kiss [objpro of Larissa], welcoming [possadj of Larissa] [LarissaForm] tongue into your mouth.";
		if Larissa is herm:	[herm]
			say "     Meanwhile, your hands have made their way down to [possadj of Larissa] [Cock Size Desc of Larissa] [LarissaCock] cock and [Cunt Size Desc of Larissa] pussy. You slide your fingers over them both, stroking, pumping and fingering until [subjpro of Larissa] cums with a loud moan of delight. [possadj_cap of Larissa] [if Ball Size of Larissa > 6]excessive load makes a considerable[else if Ball Size of Larissa >= 5]large load makes a big[else]spurting shaft makes a sticky[end if] mess which you both have fun cleaning up before [subjpro of Larissa] heads back out front to show off [possadj of Larissa] new body to [possadj of Larissa] coworkers before returning to [possadj of Larissa] desk.";
			NPCSexAftermath Larissa receives "Stroking" from Player;
		else if Larissa is female:				[female]
			say "     Meanwhile, your hands make their way down to [possadj of Larissa] [Cunt Size Desc of Larissa] [LarissaBodyType] pussy. You slide your fingers over dripping folds, pumping into them and fingering [objpro of Larissa] until [subjpro of Larissa] cums with a loud moan of delight. [possadj_cap of Larissa] [if Cunt Depth of Larissa + Cunt Tightness of Larissa >= 40]gushing juices soak both of your lower bodies[else if Cunt Depth of Larissa + Cunt Tightness of Larissa >= 20]flowing juices soak [possadj of Larissa] crotch and your arm[else]hot juices soak [possadj of Larissa] crotch and your hand[end if] in a tasty mess which you both have fun cleaning up before [subjpro of Larissa] heads back out front to show off [possadj of Larissa] new body to [possadj of Larissa] coworkers before returning to [possadj of Larissa] desk.";
			NPCSexAftermath Larissa receives "Stroking" from Player;
		else if Larissa is male:				[male]
			say "     Meanwhile, your hands have made their way down to [possadj of Larissa] [Cock Size Desc of Larissa] [LarissaCock] cock. You slide your fingers over it, stroking and pumping until [subjpro of Larissa] cums with a loud moan of delight. [possadj_cap of Larissa] [if Ball Size of Larissa > 6]excessive load makes a considerable[else if Ball Size of Larissa >= 5]large load makes a big[else]spurting shaft makes a sticky[end if] mess which you both have fun cleaning up before [subjpro of Larissa] heads back out front to show off [possadj of Larissa] new body to [possadj of Larissa] coworkers before returning to [possadj of Larissa] desk.";
			NPCSexAftermath Larissa receives "Stroking" from Player;
		[else:								[neuter]
			say "***Neuter Larissa - no content.";]
	now LarissaLastTF is turns;
...
Section 3 - Transformation Mechanics
...
to LarissaData (x - text):
	...
	repeat with y running from 1 to number of filled rows in Table of Random Critters:
		...
		if Name entry exactly matches the text x, case insensitively:
			...
			if Nipple Count of Larissa is 0:
	...
	if goahead is true:
		if there is a name of "Malayan Tiger Herm" in the Table of OwnedVials:
			if freecred < LarissTFcost:
				...
				now LarissaForm is "[if Larissa is female]tigress[else]tiger[end if]";
				...
				now LarissaMouth is "muzzle";
				now LarissaBody is "a sultry [if Larissa is female]tigress[else]tiger[end if]";
				now LarissaTFText is "becomes that of a sexy and alluring [if Larissa is herm]tigress herm[else if Larissa is female]tigress femme[else]tiger[end if]";
	...
	if goahead is true:
		if there is a name of "Teddy Bear" in the Table of OwnedVials:
			if freecred < LarissTFcost:
				...
				now LarissaTFText is "becomes plump with soft stuffing as [subjpro of Larissa] becomes a cute teddy bear";
	...
	if goahead is true:
		if there is a name of "Latex Mistress" in the Table of OwnedVials:
			if freecred < LarissTFcost:
				...
				now LarissaBody is "a latex-bound [if Larissa is female]woman[else]man[end if]";
	...
	if goahead is true:
		if there is a name of "Goo Girl" in the Table of OwnedVials:
			if freecred < LarissTFcost:
				...
				now LarissaTFText is "loses [possadj of Larissa] legs as they fuse into a shifting column of slime";
...
to say Larissaisnow-centaurmare:
	...
	if LarissaInfName is "Centaur Mare":
		say "[subjpro_Cap of Larissa]'s already got that infection. [bold type]Do you wish to continue anyway?[roman type][line break]";
		say "     ([link]Y[as]y[end link]) - Yes.";
		say "     ([link]N[as]n[end link]) - No.";
		if Player consents:
			let goahead be true;
	...
	if goahead is true:
		if there is a name of "Centaur Mare" in the Table of OwnedVials:
			if freecred < LarissTFcost:
				...
				now LarissaTFText is "has [possadj of Larissa] lower body shift and stretch until [subjpro of Larissa] has an equine body below [possadj of Larissa] waist";
...
Section 4 - Size Evaluations

To say Larissaballs:
	if Ball Size of Larissa is:
		-- 1: say "[one of]marble-sized[or]tiny[or]very small[at random] [one of]balls[or]testicles[or]gonads[at random]";
		-- 2: say "[one of]plum-sized[or]golf-ball-sized[or]apricot-sized[or]average[at random] [one of]balls[or]testicles[or]gonads[at random]";
		-- 3: say "[one of]lemon-sized[or]large[at random] [one of]balls[or]testicles[or]gonads[at random]";
		-- 4: say "[one of]baseball-sized[or]orange-sized[or]hand-filling[at random] [one of]balls[or]testicles[or]gonads[at random]";
		-- 5: say "[if a random chance of 2 in 3 succeeds][one of]grapefruit-sized[or]massive[at random][else][one of]cantaloupe-sized[or]giant[or]knee-knocking[at random][end if] [one of]balls[or]testicles[or]gonads[at random]";
		-- 6: say "[one of]basketball-sized[or]ginormous[or]super-inflated[or]watermelon-huge[at random] [one of]balls[or]testicles[or]gonads[at random]";
		-- 7: say "[one of]floor-dragging[or]beachball-sized[or]gargantuan[or]ground-hanging[at random] [one of]balls[or]testicles[or]gonads[at random]";
...
This is the Larissa cockdesc rule:
	...
	else if Cock Length of Larissa < 14:
