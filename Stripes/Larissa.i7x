...
To say Larissaballs:
	...
	else if Ball Size of Larissa < 7:
...
[		say "***human form, to be revised later.";]
		...
		if Breast Size of Larissa > 0:	[titties!]
			...
			say "     Poorly obscured by [possadj of Larissa] labcoat, you can see that Larissa has a pair of [Breast Size Desc of Larissa][if Nipple Count of Larissa is 4] with a second smaller pair beneath those[else if Nipple Count of Larissa > 4] with [extrabreastrows] other pairs beneath those[end if]. Also half-hidden, almost as a tantalizing offer, Larissa has [if Larissa is herm]a [Cock Size Desc of Larissa] [LarissaCock] shaft, a pair of [Larissaballs] and a [Cunt Size Desc of Larissa] wet cunt between [possadj of Larissa] legs[else if Larissa is male]a [Cock Size Desc of Larissa] [LarissaCock] shaft with a pair of [Larissaballs] between [possadj of Larissa] legs[else if Larissa is female]a [Cunt Size Desc of Larissa] wet cunt between [possadj of Larissa] legs[else if Larissa is neuter]a plain and featureless groin[end if]. [subjpro_Cap of Larissa] gives you a playful grin and shifts to give you a better view of [possadj of Larissa] crotch while [subjpro of Larissa] works.";
		else:									[no titties :(]
...
to say Larissasex_FM:
	...
	if Cock Length of Larissa > ( ( Cunt Depth of Player * 2 ) + Cunt Tightness of Player + 2 ):			[super-big]
		...
		say "     With [possadj of Larissa] orgasm approaching, you press [possadj of Larissa] glans to your pussy and grind hard against it. [subjpro_Cap of Larissa] cums with a loud moan of release. While much of [possadj of Larissa] seed soaks your crotch, some blasts shoot into you[if Ball Size of Larissa >= 7]. This results in still a sizable amount of semen squirted into you[else if Ball Size of Larissa >= 5]. This results in quite a bit of semen still getting squirted into you[end if]. Feeling these spurts of [possadj of Larissa] hot semen splashing onto and into your cunt pushes you over the edge into orgasm as well[if Player is male]spraying your seed across your [BodyType of Player] body and [end if]adding your feminine juices to the sticky mess at your crotch. You both snuggle together while recovering from the powerful climax and, after a little more fun while cleaning each other up, head back out front.[if Ball Size of Larissa >= 5 or a random chance of 1 in 2 succeeds][impregchance][end if]";
		NPCSexAftermath Player receives "Stroking" from Larissa;
...
to say Larissasex_MM:
	...
	if Cock Length of Larissa > ( ( scalevalue of Player + 1 ) * 12 ):	[too big, full body rub + oral]
		...
		say "     Grinding his [LarissaCock] cock down onto your [BodyType of Player] body and having you lick and tease it eventually becomes too much for him, driving him to cum hard, shooting his cum all over your face and into your open mouth[if Ball Size of Larissa >= 7]. You swallow down as much of the [LarissaForm][']s excessive load of semen as you can, but much of it ends up covering your face, the head of the bed and even the wall behind it[else if Ball Size of Larissa >= 5]. You swallow down much of the [LarissaForm][']s large load of semen, but there's lots of it left covering your face and the head of the bed[else]. You swallow down as much of the [LarissaForm][']s semen as you can get, but much of it ends up covering your face[end if] by the time he's drained. After having some more fun while helping to get cleaned up[if Player is male], getting you off as well[end if], he heads back out front and returns to his desk.";
...
to say Larissasex_taurFM:
	...
	if Cock Length of Larissa > ( ( Cunt Depth of Player * 2 ) + Cunt Tightness of Player + 2 ):			[super-big]
		...
		say "     With [possadj of Larissa] orgasm approaching, [subjpro of Larissa] presses [possadj of Larissa] glans to your pussy and grinds hard against it, causing you to moan. [subjpro_Cap of Larissa] cums with a loud moan of release as [possadj of Larissa] [Larissaballs] send out their payload. While much of [possadj of Larissa] seed soaks your crotch, some blasts shoot into you[if Ball Size of Larissa >= 7]. This results in still a sizable amount of semen squirted into you[else if Ball Size of Larissa >= 5]. This results in quite a bit of semen still getting squirted into you[end if]. Feeling these spurts of [possadj of Larissa] hot semen splashing onto and into your cunt pushes you over the edge into orgasm as well[if Player is male]spraying your seed across the floor and [end if]adding your feminine juices to the sticky mess at your crotch. You both snuggle together while recovering from the powerful climax and, after a little more fun while cleaning each other up, head back out front.[if Ball Size of Larissa >= 5 or a random chance of 1 in 2 succeeds][impregchance][end if]";
		NPCSexAftermath Player receives "Stroking" from Larissa;
	else if Cock Length of Larissa > ( Cunt Depth of Player + Cunt Tightness of Player + 2 ):			[large]
...
to say Larissa post-tf:
	...
	if Player is not neuter:
		...
		if Cunt Count of Larissa > 0 and Cock Count of Larissa > 0:	[herm]
			say "     Meanwhile, your hands have made their way down to [possadj of Larissa] [Cock Size Desc of Larissa] [LarissaCock] cock and [Cunt Size Desc of Larissa] pussy. You slide your fingers over them both, stroking, pumping and fingering until [subjpro of Larissa] cums with a loud moan of delight[if Ball Size of Larissa >= 7]. [possadj_cap of Larissa] excessive load makes a considerable[else if Ball Size of Larissa >= 5]. [possadj_cap of Larissa] large load makes a big[else]. [possadj_cap of Larissa] spurting shaft makes a sticky[end if] mess which you both have fun cleaning up before [subjpro of Larissa] heads back out front to show off [possadj of Larissa] new body to [possadj of Larissa] coworkers before returning to [possadj of Larissa] desk.";
			NPCSexAftermath Larissa receives "Stroking" from Player;
		else if Cunt Count of Larissa > 0:				[female]
			say "     Meanwhile, your hands make their way down to [possadj of Larissa] [Cunt Size Desc of Larissa] [LarissaBodyType] pussy. You slide your fingers over dripping folds, pumping into them and fingering [objpro of Larissa] until [subjpro of Larissa] cums with a loud moan of delight[if Cunt Depth of Larissa + Cunt Tightness of Larissa >= 40]. [possadj_cap of Larissa] gushing juices soak both of your lower bodies in a tasty[else if Cunt Depth of Larissa + Cunt Tightness of Larissa >= 20]. [possadj_cap of Larissa] flowing juices soak [possadj of Larissa] crotch and your arm in a tasty[else]. [possadj_cap of Larissa] hot juices soak [possadj of Larissa] crotch and your hand in a tasty[end if] mess which you both have fun cleaning up before [subjpro of Larissa] heads back out front to show off [possadj of Larissa] new body to [possadj of Larissa] coworkers before returning to [possadj of Larissa] desk.";
			NPCSexAftermath Larissa receives "Stroking" from Player;
		else if Cock Count of Larissa > 0:				[male]
			say "     Meanwhile, your hands have made their way down to [possadj of Larissa] [Cock Size Desc of Larissa] [LarissaCock] cock. You slide your fingers over it, stroking and pumping until [subjpro of Larissa] cums with a loud moan of delight[if Ball Size of Larissa >= 7]. [possadj_cap of Larissa] excessive load makes a considerable[else if Ball Size of Larissa >= 5]. [possadj_cap of Larissa] large load makes a big[else]. [possadj_cap of Larissa] spurting shaft makes a sticky[end if] mess which you both have fun cleaning up before [subjpro of Larissa] heads back out front to show off [possadj of Larissa] new body to [possadj of Larissa] coworkers before returning to [possadj of Larissa] desk.";
			NPCSexAftermath Larissa receives "Stroking" from Player;
		else:								[neuter]
