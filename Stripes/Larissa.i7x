...
to say Larissasex_MF:
	...
	if Cock Length of Player > ( ( Cunt Length of Larissa * 2 ) + Cunt Tightness of Larissa + 2 ):			[super-big]
	...
	else if Cock Length of Player < ( ( Cunt Length of Larissa + Cunt Tightness of Larissa + 1 ) / 3 ):		[small]
...
to say Larissasex_FM:
	...
	if Cock Length of Larissa > ( ( Cunt Length of Player * 2 ) + Cunt Tightness of Player + 2 ):			[super-big]
		...
		say "     With [possadj of Larissa] orgasm approaching, you press [possadj of Larissa] glans to your pussy and grind hard against it. [subjpro_Cap of Larissa] cums with a loud moan of release. While much of [possadj of Larissa] seed soaks your crotch, some blasts shoot into you[if Ball Size of Larissa >= 40]. This results in still a sizable amount of semen squirted into you[else if ball size of Player >= 20]. This results in quite a bit of semen still getting squirted into you[end if]. Feeling these spurts of [possadj of Larissa] hot semen splashing onto and into your cunt pushes you over the edge into orgasm as well[if Player is male]spraying your seed across your [BodyType of Player] body and [end if]adding your feminine juices to the sticky mess at your crotch. You both snuggle together while recovering from the powerful climax and, after a little more fun while cleaning each other up, head back out front.[if Ball Size of Larissa >= 20 or a random chance of 1 in 2 succeeds][impregchance][end if]";
	else if Cock Length of Larissa > ( Cunt Length of Player + Cunt Tightness of Player + 2 ):			[large]
	...
	else if Cock Length of Larissa < ( ( Cunt Length of Player + Cunt Tightness of Player + 1 ) / 3 ):		[small]
...
to say Larissasex_taurFM:
	...
	if Cock Length of Larissa > ( ( Cunt Length of Player * 2 ) + Cunt Tightness of Player + 2 ):			[super-big]
		...
		say "     With [possadj of Larissa] orgasm approaching, [subjpro of Larissa] presses [possadj of Larissa] glans to your pussy and grinds hard against it, causing you to moan. [subjpro_Cap of Larissa] cums with a loud moan of release as [possadj of Larissa] [Larissaballs] send out their payload. While much of [possadj of Larissa] seed soaks your crotch, some blasts shoot into you[if Ball Size of Larissa >= 40]. This results in still a sizable amount of semen squirted into you[else if ball size of Player >= 20]. This results in quite a bit of semen still getting squirted into you[end if]. Feeling these spurts of [possadj of Larissa] hot semen splashing onto and into your cunt pushes you over the edge into orgasm as well[if Player is male]spraying your seed across the floor and [end if]adding your feminine juices to the sticky mess at your crotch. You both snuggle together while recovering from the powerful climax and, after a little more fun while cleaning each other up, head back out front.[if Ball Size of Larissa >= 20 or a random chance of 1 in 2 succeeds][impregchance][end if]";
	else if Cock Length of Larissa > ( Cunt Length of Player + Cunt Tightness of Player + 2 ):			[large]
...
carry out Larissatesting:
	...
	say "Cunts: [if Cunt Count of Larissa > 0][Cunt Count of Larissa] cunts, [Cunt Length of Larissa] inches deep and [Cunt Tightness of Larissa] inches wide ([Cock Size Desc of Larissa])[else]No cunts: [Cunt Length of Larissa] x [Cunt Tightness of Larissa][end if].";
