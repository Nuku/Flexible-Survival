...
to say losetomegakitty:
	...
	otherwise:
		say ".  Pressing the still femmecum-covered sextoy against your chest, she presses its smooth tip to your face and orders you to start licking it[if hp of player > 0].  Having submitted to the big kitty, you do as you are instructed and start licking at the toy.  The taste of her juices is quite arousing and soon you're going at it with a lustful eagerness[otherwise].  Rather than raise her ire further, you relent and start licking at the toy.  The taste of her juices is quite arousing and soon you're doing it quite voluntarily[end if].";
		say "     When you feel something warm and slick gripping your feet and sliding over them, it takes you a few moments to realize what's happening.  With a wet slurp, your legs are drawn into her cunny up to your ankles and she continues to pull you in further[if hp of player > 0].  Knowing this was your likely fate when you gave up, you see little point in resisting now.  Besides,[otherwise].  A part of you warns you to resist, but you're too weak and[end if] that delicious vibrator in your arms and at your lips is too enticing to release.  The way it rumbles against your chest like a purring kitty makes you feel good all over.";
