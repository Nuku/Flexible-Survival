...
to say losetomegakitty:
	...
	if the remainder after dividing MKloss by 3 is 0 and anallevel > 1:
		...
		say "     Pressing the still femmecum-covered sextoy against your chest, she presses its smooth tip to your face and orders you to start licking it[if HP of player > 0]. Having submitted to the big kitty, you do as you are instructed and start licking at the toy. The taste of her juices is quite arousing and soon you're going at it with a lustful eagerness[else]. Rather than raise her ire further, you relent and start licking at the toy. The taste of her juices is quite arousing and soon you're doing it quite voluntarily[end if].";
