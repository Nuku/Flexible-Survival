Version 1 of Xeno For FS by Stripes begins here.
...
to say losetoxeno:
	...
	otherwise:
		...
		if cocks of player is 0 or a random chance of mchance in 12 succeeds:
			say ".  The xenomorphic creature, as if scenting what it wants, pushes onto all fours with its strong arms and lowers itself down onto you.  Hissing again, it slides its strange, phallic probe into you, pushing into your ass and sliding into your bowels.  The black flesh pulses and shoots a thick, green goo into your ass, making it slick and easy to penetrate.  Its tendrils squirm and rub, teasing your [if cocks of player > 0]prostate[otherwise]inner walls[end if] and exciting you despite the horrifying situation.  But it doesn't thrust into you, instead staying buried deep inside you and stimulating you from within.  As it does so, you feel a much thicker bulge pressing into you as an egg starts to travel up to ovipositor and into you to be deposited into your belly.  More eggs follow after the first as your belly is stuffed with as many of the fleshy orbs as you can take[if cocks of player > 0].  As these push past your prostate, you can't help but cum, moaning loudly as the alien creature violates you[end if].";
			say "     After the ovipositor is withdrawn and you're released, you stumble away as best you can being so laden down with eggs.  Feeling your belly squirm and seeing the eggs already writhing and shifting inside you, you find somewhere secluded and deposit them, hoping you've managed to get them all out.[mimpregchance]";
		otherwise:
...
to say beatthexeno:
	...
	if cockname of player is "Xeno" and cocks of player > 0 and cunts of player > 0:
		...
		infect;
	otherwise if cockname of player is "Xeno" and cocks of player > 0 and "MPreg" is listed in feats of player:
	...
	otherwise if cockname of player is "Xeno" and cocks of player > 0:
		...
		infect;
	otherwise if cunts of player > 0 and cockname of player is "Xeno":
...
When Play begins:
	...
	now body descriptor entry is "[one of]boney[or]twisted[or]unnatural[or]hardened[at random]";
...
to say drinkacidmilk:
	...
	otherwise if bodyname of player is not "Xeno":
...
when play ends:
	if bodyname of player is "Xeno":
		if humanity of player is less than 10:
			...
			otherwise if cocks of player > 0 and "MPreg" is listed in feats of player:
		...
		otherwise:
			...
			say "     You are given a half-hearted offer by some military men to join their forces, but it seems even they are wary of you.  Fearing their control or even worse testing, you turn them down and try to settle down into a more normal life.  Your altered form prevents you from living with most people, but works well in film, earning you a steady income from the entertainment industry, both conventional and erotic for those into the most extreme content and the excitement of horror porn.";
