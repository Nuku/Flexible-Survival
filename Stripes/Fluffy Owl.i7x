...
When Play begins:
	...
	now Species Name entry is "Owl"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now MilkItem entry is "fluffy owl milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "fluffy owl cum"; [ Item to be given to the player if they have this infection and jerk off. ]
