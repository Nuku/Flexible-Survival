...
to say amazoniandesc:
	...
	say "     Raising her weapon, she glares at you[if cunts of player is 0]. 'You are unneeded here, worthless male. You will be shown your place,' she growls[else if cunts of player > 0 and cocks of player > 0]. 'Ahh, another warrior woman to test myself against. Come, prove your might and you may be my mate,' she says with a lustful grin[else if cunts of player > 0]. 'Come here, sweet lass. Let me show you that you don't need a worthless male to please you,' she says with a lustful grin[end if].";
...
to say estosterogen pill use:
	if cunts of player > 0 and cocks of player > 0:		[HERM]
		...
		say "     As this is occurring, a twinge centred at your clit increases rapidly. With a sudden surge of growth, your love button enlarges into a phallic growth, soon becoming separate from the cunt from which it spawned to become a [cock size desc of player] [cock of player] cock with its own set of balls[if cockname of player is listed in infections of internallist] forming inside you[end if]. ";
