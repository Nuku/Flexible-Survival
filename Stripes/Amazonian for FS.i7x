...
to say estosterogen pill use:
	if cunts of player > 0 and cocks of player > 0:		[HERM]
		...
		say "     Even as this is occurring, you watch your puss[if cunts of player > 1]ies['][otherwise]y's[end if] lips puff up as your cunt enlarges and deepens, becoming [descr]. ";
		...
		say "     You watch as your puss[if cunts of player > 1]ies['][otherwise]y's[end if] lips puff up as your cunt enlarges and deepens, becoming [descr] with rapid growth. ";
