...
instead of conversing the Doctor Medea:
	...
	if HP of Doctor Matt is 20:
		...
		if Medeaget < 3:
			say "I'm terribly under-supplied at the moment and thus have only been able to learn a little while assisting the rare patient seeking my help. Were you able to assist me in improving conditions here, I might be able to do and learn more,' she says with a grin.";
		...
		if HP of Doctor Medea is 1:
			if Player is mpreg_ok:
				...
				NPCSexAftermath Player receives "AssDildoFuck" from Doctor Medea;
				...
				say "     'I cannot help you. I specialize in childbirth and minor illnesses. And the latter are not occurring with the nanite plague. Maybe I could help if you were a female?'";
...
to say Medeaadjustments:
	...
	if Medeaget is 3:
		...
		if Player is impreg_ok:
			...
			now description entry is "Talk to her about egg-laying";
		[]
			...
			if Player consents:
				...
				if nam is "Check for pregnancy":
					...
					if lust of Doctor Medea is 0:
						...
						say "     Taking out the requested items, you eagerly await her response while she looks it all over. 'Hmmm... yes... yes, this should be enough. By the time you're ready for your next examination, I should be able to give rough estimates on how long before you'll go into heat or how long you'll stay in your current heat. I should also be able to influence your heat cycle. Perhaps you'd like me to ramp it up? That'd really let you get the most out of those animal urges to breed of yours,' she says with an eager, toothy grin. Noting your reaction to her almost perverse enthusiasm, she sighs. 'Or, I could block you from feeling the effects of heat, if that's what you'd prefer.'";
					...
					say "     Dr. Medea performs the procedure with pleasure, altering your body to be more receptive to heat. 'This should reduce your delay before going into heat as well as prolong your time in heat. Until you're successfully impregnated, that is. Remember, being in heat makes that more likely. There may also be other unforeseen effects, but I wouldn't worry about it - that'll only add to the fun. It will be more difficult for me to get a proper estimate of your heat cycle under these conditions, but I'll try my best to give you a rough estimate. I hope you have a very enjoyable and productive time,' she says, tidying up her instruments.";
					now heatlevel is 3;
					...
					if ovipregalways is false:
						if ovipregMedeatalk is false:
							say "     'Oh, have you witnessed or experienced that before? There are indeed several of the creatures in the city which have responded to their transformation by becoming egg-layers or impregnating their lovers with eggs. It is especially common in reptiles and birds,' the lizard doctor says with a smile, 'though I wouldn't be surprised to find a few others out there doing it. I've had a few egg-laying patients and have had a chance to examine their alterations. With my added equipment, if you'd like, I'd be able to alter your womb to be like theirs and bear eggs whenever you get pregnant.'";
...
to say ResolveEvent Abandoned Truck:
	say "     You come across an abandoned truck, filled with medical supplies. The driver's cab is filled with some sort of goo that covers all the entrances. Maybe some of the supplies can be of use?";
	if Medeaget is 1:
