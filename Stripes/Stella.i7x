...
to say ResolveEvent Eager Dal:
	...
	if HP of Stella is 0:
		...
		say "[line break]     [bold type]Shall you do just that?[roman type][line break]";
		...
		say "[line break][convincestella]";

to say convincestella:
	let bonus be ( charisma of Player minus 10 ) divided by 2;
	let bonus2 be the number of collected people / 2;
	let dice be a random number from 1 to 20;
	say "You roll 1d20([dice])[if bonus + bonus2 >= 0]+[end if][bonus + bonus2] = [special-style-1][dice + bonus + bonus2][roman type] vs [special-style-2]15[roman type] (Charisma Check):[line break]";
	if dice + bonus + bonus2 > 14:
		if Police Station Twelve is known and HP of Alexandra >= 52:
			say "     You tell Stella that you know a couple of safe places that she might stay[if number of collected people > 2], adding that you've got a few other friends there as well[end if]. It takes a little convincing to get her to trust you given your initial impression, but the prospect of somewhere safe (and maybe some sex as well) convinces her to go with you. The Police Station's somewhat closer than the bunker to here.";
			say "[line break]     [bold type]Shall you take her there for now?[roman type][line break]";
			say "     ([link]Y[as]y[end link]) - Yes.";
			say "     ([link]N[as]n[end link]) - No.";
			if Player consents:
				LineBreak;
				say "     You and Stella travel together to the Police Station. She and Alexandra don't really hit it off[if HP of Alexandra < 57] that well, but the Doberwoman does promise to help keep her safe[else], but she finds Jimmy absolutely adorable in his little outfit. Jimmy seems quite captivated by her plump sh... ahhh... cute smile[end if]. Once introductions are done, she flops out on one of the bunks with a happy sigh, paw going to her cock.";
				WaitLineBreak;
				move Stella to Police Lockerroom;
				move player to Police Lockerroom;
			else:
				LineBreak;
				say "     You and Stella travel together back to the bunker. You don't run into any particular difficulties on the trip, allowing you more time to talk to Stella. And while she doesn't really have anything insightful or interesting to say, her ditzy, super-friendly attitude does make for a cheerful enough trip. Once you arrive[if number of collected people > 0] and after quick introductions[end if], she picks out a bunk for herself and flops out onto it with a happy sigh, paw going to her cock.";
				WaitLineBreak;
				move Stella to Bunker;
				move player to Bunker;
				increase morale of Player by 2;
		else:
			say "     You tell Stella that you know [if Police Station Twelve is known]a couple of safe places[else]a safe place[end if] that she might stay[if number of collected people > 2], adding that you've got a few other friends there as well[end if]. It takes a little convincing to get her to trust you given your initial impression, but the prospect of somewhere safe (and maybe some sex as well) convinces her to go with you.";
			say "     You and Stella travel together back to the bunker. You don't run into any particular difficulties on the trip, allowing you more time to talk to Stella. And while she doesn't really have anything insightful or interesting to say, her ditzy, super-friendly attitude does make for a cheerful enough trip. Once you arrive[if number of collected people > 0] and after quick introductions[end if], she picks out a bunk for herself and flops out onto it with a happy sigh, paw going to her cock.";
			move Stella to Bunker;
			move player to Bunker;
			increase morale of Player by 2;
...
Understand "move Stella/Satellizer" as stellamoving.
...
to stellainfect:
	...
	now Nipple Count entry is tempnum;
...
to say stellajimmy01:
	...
	say "     '[one of]We've got a hard problem and figured you'd be just the pup to help us both with it,[or]Less talk, more suck, cutie,[or]You looked hungry, so we thought we'd give you a tasty treat,[or]Got another BJ or two in you, pup?[no line break][at random]' Stella says with a grin. She puts a paw on the happy corgi's head, pushing his muzzle to her doggy dick before he has a chance to properly respond. Not that he'd refuse, his muzzle opening and readily taking her erection into it. He bobs his muzzle over her shaft while sliding his canine tongue across it for several licks. Jimmy starts off with just a short slathering before switching over to you rather than leave you hanging.";
