...
Instead of resolving a Strip Bar:
	if stripbarcounter is 1:
		say "     After a few hours of fruitless searching among the besieged city, you come across another strip bar that[']s in fairly good shape.  You see no obvious signs of trouble and after the last few hours of getting nowhere, you consider searching inside.  Do you enter?";
		if player consents:
			say "[stripbarsearch]";
		otherwise:
	...
	otherwise if stripbarcounter is 2:
		say "     You come to a third strip bar tucked into secluded part of this seedy part of town.  It seems to have fared relatively well, with only minor damage.  After a cautious glance inside, you don[']t see any signs of trouble.  Do you enter?";
		if player consents:
			say "[stripbarsearch]";
		otherwise:
			say "     You go off, deciding to find a safer place to search.";
...
to say orgyoutcome:
	...
	say "     After getting a bellyfull of tasty lionseed and the sated fox[']s knot shrinks enough to pop free, you look over to the cause of this wonderful sexcapade you[']ve found yourself in.  Seeing that the leopard has prevailed against the other prospective lovers, you lick your lips as you watch him plowing into the newly corrupted leopardess beneath him.  They both yowl in feline ecstacy as he pumps his heavy load into her womb, seeking to breed his new mate.  You consider heading over to join them, but spot the herm raccoon who was there earlier.  Being much closer and currently unoccupied, you give hir a kiss, taking hir hard cock in hand.  Shi moans in pleasure and wraps hir arms around you, returning the lustful kiss by sliding hir tongue between your lips.";
