...
when play ends:
	if bodyname of player is "Wildcat":
		...
		otherwise:
			say "     Once out of the infected city, your powerful body makes many people you meet worried at first.  But you are a gentle giant, more interested in tinkering with old junk or working on cars.  You get a job as a mechanic and are quite successful at it.  Your powerful body is an asset at this work, helping you move heavy parts with ease.  Working for a trucking company, you enjoy coming in each day to maintain their fleet of deisel trucks.  Its particularly fun to show off in front of the tough truckers, easily slinging around heavy engine parts with one hand.  Impressed, you even get a few who aren't put off by your feline form and who'll slip off with you to your office for a little break after dropping off their big rig.";
