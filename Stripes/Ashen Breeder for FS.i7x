...
when play ends:
	if bodyname of player is "Ashen Breeder":
		if humanity of player < 10:
			...
			else if cunts of player > 0 and "Sterile" is not listed in feats of player:		[F/H Breeder]
				if T is 1:
			...
			else if cocks of player > 0:		[M Breeder / H non-breedable]
				if T is 1:
			...
			else if cunts of player > 0 and cocks of player > 0 and "Sterile" is not listed in feats of player:		[H Breeder]
			...
			else if cunts of player > 0 and cocks of player is 0 and "Sterile" is not listed in feats of player:		[F Breeder]
			...
			else if cocks of player > 0:		[M Breeder or H non-breedable]
			...
			else if cunts of player > 0:		[F non-breedable]
