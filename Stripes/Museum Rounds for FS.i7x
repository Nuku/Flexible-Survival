Version 1 of Museum Rounds for FS by Stripes begins here.
...
carry out museumrounding:
	...
	otherwise if hp of Valerie - turns < 8:
	...
	otherwise:
		...
		if entry 1 in mrevents is 1:
			say "[mrevent01]";
		otherwise if entry 1 in mrevents is 2:
			say "[mrevent02]";
		otherwise if entry 1 in mrevents is 3:
			say "[mrevent03]";
		otherwise if entry 1 in mrevents is 4:
			say "[mrevent04]";
		otherwise if entry 1 in mrevents is 5:
			say "[mrevent05]";
		otherwise if entry 1 in mrevents is 6:
			say "[mrevent06]";
		otherwise if entry 1 in mrevents is 7:
			say "[mrevent07]";
		otherwise if entry 1 in mrevents is 8:
			say "[mrevent08]";
		otherwise if entry 1 in mrevents is 9:
			say "[mrevent09]";
		otherwise if entry 1 in mrevents is 10:
			say "[mrevent10]";
		otherwise if entry 1 in mrevents is 11:
			say "[mrevent11]";
		otherwise if entry 1 in mrevents is 12:
			say "[mrevent12]";
		otherwise if entry 1 in mrevents is 13:
			say "[mrevent13]";
		otherwise if entry 1 in mrevents is 14:
			say "[mrevent14]";
		otherwise if entry 1 in mrevents is 15:
			say "[mrevent15]";
...
to say mrevent01:
	...
	if mre01 is 1:
		say "     You and Valerie pass through the halls of the museum, checking on several of the exhibits while she talks about them.  You're taken through several of the historical wings and she discusses the significant points of the various societies and events of the era.  You have an enjoyable time with sphinx, the walk through time with her a pleasant break from your current troubles.  Certainly she enjoys your company as well, giving your [bodydesc of player] form the occasional apraising or appreciative glance.";
	otherwise if mre01 is 2:
		say "     You and Valerie pass through the halls of the museum on no discernable path while she discusses the exhibits.  The tour is fairly uneventful except for a group of feline ninjas you spot watching you from the shadows.  Their eyes narrow as they glare at you.  One slips a few inches of his blade from its sheath and narrows its eyes to glare at you.  It seems that were it not for Valerie's presence, you'd be subject to attack.";
	otherwise if mre01 is 3:
...
to say mrevent02:
	...
	if mre02 is 1:
		say "     You and Valerie pass through the halls of the museum, checking on several of the exhibits while she talks about them.  You're taken through several of the art wings and she discusses the significant differences of the various artists and art movements.  You have an enjoyable time with sphinx, the walk through time with her a pleasant break from your current troubles.  Certainly she enjoys your company as well, giving your [bodydesc of player] form the occasional apparaising or appreciative glance.";
	otherwise if mre02 is 2:
		say "     You and Valerie pass through the halls of the museum on no discernable path while she discusses the exhibits.  The tour is fairly uneventful except for a clockwork [one of]fox[or]vixen[at random] who eyes you with its mechanical eyes.  From the leaking lubricant and the way it runs its paws over itself, it seems that were it not for Valerie's presence, you'd be the subject to its lustful advances.";
	otherwise if mre02 is 3:
		say "     You and Valerie pass through the halls of the museum on no discernable path while she discusses the exhibits.  The tour is fairly uneventful except for a brief interruption when some cavorting nymphs dance past with a group of satyrs in hot pursuit";
		...
		otherwise if bodyname of player is "Satyr":
...
to say mrevent05:
	...
	if bodyname of player is "Caveman" or facename of player is "Caveman":
		...
		say "[mre05_hunter]";
	otherwise if bodyname of player is "Sabretooth" or facename of player is "Sabretooth":
		...
		say "[mre05_prey]";
	otherwise:
		say "     Seeing them in such good spirits, you consider going over to join them in their celebration.  It looks like they've got a fun time planned.  Shall you go join the victorious hunting party for some wild, primitive fun?";
		if the player consents:
			...
			if bonus + dice + sexbonus is greater than 14:
				say "     You approach the group in a friendly manner, trying to convince them through soft words and lewd gestures that you would like to join in on the fun.  At first they seem wary, but then huddle together to grunt and hoot at one another quickly.  One gestures to your face, then pokes his own cromagnon features and shakes his head.  [if cunts of player > 0].  Another points back at you and then grunts emphatically while hip-thrusting, to much nodding from the group[otherwise if breast size of player > 3].  Another cups imaginary [breast size desc of player] breasts in front of his chest and whistles, much to the delight of his peers[otherwise if cock length of player > 12].  Glances are made at your [cock size desc of player] cock while they debate your merits[otherwise].  Occasional glances back at you are made as they debate the matter[end if].  Finally, one of them shrugs and motions for you to come along.  Pleased with your success, you follow off after the hunting party while Valerie smiles and tells you to have fun, though you barely notice in your excitement.";
				say "[mre05_hunter]";
			otherwise:
...
to say mrevent08:
	...
	otherwise:
		...
		say "     Having brought them the oil, they're also happy to come over and snuggle up with you, running intricately designed paws over you.  'Thank you for the oil,' one of the vixens says in a voice mixed with a music box song.  'Why don't you stay with us for a good, long winding,' [if cocks of player > 0]she adds, grinding her hips against your thigh[otherwise]a tod adds, grinding his brass cock against your hip[end if].  With their caresses turning to groping, you strongly consider taking them up on their offer for some fun.  Would you like to play with them for a while?  You might consider playing with a [link]tod (1)[as]1[end link] or a [link]vixen (2)[as]2[end link], or simply [link]pass (0)[as]0[end link] on their advances.";
		now calcnumber is -1;
