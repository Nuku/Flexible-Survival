...
to say gilliansex02:	[69]
	...
	if cocks of player > 0:
		say "     She starts by nuzzling and kissing at your manhood before licking from your [if cunts of player > 0]pussy[else if cockname of player is not listed in infections of internallist]balls[otherwise]taint[end if] to your glans. She swirls her tonguetip around it a few times before lowering her muzzle down over your shaft. [if cock length of player > 30]With considerable effort to deal with your exceptional manhood[else if cock length of player > 20]With some effort to deal with your enlarged manhood[otherwise]Taking it slow to savour it[end if], she works her muzzle and throat down over the whole of your [cock size desc of player] cock.";
