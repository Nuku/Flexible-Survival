...
Instead of resolving a Aussie Pub:
	...
	if the bodyname of player is "red kangaroo":
		...
		if player consents:
			...
			wait for any key;
			say "     Eventually, the party winds down, appetites (both carnal and more mundane) are sated and you head off with several of the others.  As you're heading out though, the barmaid pulls you in close for another kiss.  Grabbing your ass, she whispers that you should come back again in a few days and she'll let you in.  You'd heard from the crowd that roos are allowed a visit a week because of the need for supplies and the popularity of the location.  But it seems the serving girl's taken a liking to you and you'll be able to stop by again in sooner.  Part of you feels quite drawn to the rambunctious roos and you look forward to finding more to have fun with in the future and looking forward to another visit to the pub.";
			infect "red kangaroo";
			infect "red kangaroo";
...
to say down under pub scene:
	...
	otherwise if lastpubvisit - turns < 14:
		say "     While you are welcome back at the Down Under Pub, they have limited supplies and have asked that patrons wait a week between visits.  Since the barmaid likes you so much, you can probably get in every few days, but you don't want to push it too much.";
