	...
	if werewolfcostumenosex > 2:
		...
		if Player consents:
			...
			if a random chance of 3 in 5 succeeds:
				say "     When you cum, you thrust fully into the costume creature, letting your cock pulse as it sends your hot seed into its empty insides[if ball size of Player > 40]. Your prodigious output leaves the werewolf suit considerably fuller. It makes wet, sloshing sounds as it shifts around, trying to drag its cum-stuffed body away[else if ball size of Player > 20]. Your considerable output leaves the werewolf suit looking somewhat fuller and more padded than before. It makes wet sounds as it slinks off[else]. You pump your load down at the creature's padded throat before pushing it aside[end if].";
			else:
				say "     Moments before you cum, you push the strange creature's head back and pump your meat frantically, spraying your [if ball size of Player > 40]excessive[else if ball size of Player > 20]large[else]sticky[end if] load across its muzzle. It holds its mouth wide open and slathers its tongue across its muzzle, trying to lap up as much of it as it can get. Once you're done cumming, you wipe your dick across its furry side and toss it aside. The messy costume creature slinks off, wiping and licking itself as it goes.";
		else:
