...
to say ocelotloss_bt_a2:	[sub on dom - anal]
	...
	say "     He turns out to be a very eager and obedient kitty, listening to your every request to go faster or slower, harder or softer as best suits your changing desires as your arousal grows. His slinky body bends and squirms in so many delightful ways[if player is male]. You even have him switch cocks a few times, making sure you'll be completely satisfied[end if][if breasts of player > 0 and breast size of player > 0]. Petting his head and complimenting him for his fine work, you guide his muzzle to your breasts, encouraging him to kiss, lick, nip and suckle them as well[else]. Petting his head and complimenting him on his fine work, you scritch the kitty's ears and eagerly tell him to keep it up[end if]. It makes you wish he was yours, but he's clearly already got an owner who's trained him well. You'll just have to find another to keep, then.";
...
to say ocelotloss_bt_j2:	[sub on dom - jerk]
	...
	say "     He turns out to be a very eager and obedient kitty, listening to your every request and obeying your every whim as you play with him. His cute cock throbs and dribbles with precum, stiff with arousal but never going off early despite his obvious excitement[if breasts of player > 0 and breast size of player > 0]. Petting his head and complimenting him being such an enjoyable plaything, you shift him in your lap and guide his small muzzle to your bosom, letting him lick, kiss and suck at your nipples[else]. Petting his head and complimenting being such an enjoyable plaything, you scritch the kitty's ears and work his cock all the harder[end if]. It makes you wish he was yours, but he's clearly already got an owner who's trained him well. You'll just have to find another to keep, then.";
		...
		if player consents:
			...
			if ocelotchoice is 1:				[sub-ocelot chosen]
				if player is male:
					...
					say "     As you sink down onto his average-sized cock, his paws move to your chest[if breasts of player > 0 and breast size of player > 0] and rub your breasts. His fingers glide over your bosom and move to play with your nipples[end if]. His cock throbs inside you, dribbling precum into your already [cunt size desc of player] pussy. You take your time riding him, finding yourself wanting to make the most of this opportunity now that you've started[if cunts of player > 2]. You even alternate cunts a few times, sliding off his erection briefly before taking it back in another juicy cunt[else if cunts of player is 2]. You even alternate cunts a few times, sliding off his erection briefly before taking it back in your other juicy cunt[end if].";
