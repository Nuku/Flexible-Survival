...
to say ocelotloss_bt_a2:	[sub on dom - anal]
	...
	say "     Eventually you can't hold back any longer and, giving him permission to cum as well, you unleash your hot load into the kitty's bottom[if Player is male] and across his body[end if][if ball size of Player > 45]. You pump so much cum into the small feline that he's so bloated and overfull that some gurgles up and overflows from his mouth[else if ball size of Player > 30]. You pump so much cum into the small feline that he's left bloated and overfull[else if ball size of Player > 15]. You pump so much cum into the small feline that he has a bit of a bulge in his tummy from it all[end if]. When you're drained and [if Cock Length of Player > 24 or ball size of Player > 15]he's managed to pull[else]he's pulled[end if] himself off your spent shaft, you're left worn out, but very fulfilled. You give the kitty a kiss, a pat on the rear and send him on his way. '[one of]I need to get back to my master[or]I'd best hurry back to my master[or]I should go find my master[or]I can't wait to tell my master all about this. I have to go find him[at random],' he purrs. 'Maybe once you've got a kitty fucktoy of your own [one of]we can play again[or]you and my master can share[or]you'd like to meet him[or]you can watch us play together[at random][if ball size of Player > 30].' The overloaded ocelot staggers off slowly[else if ball size of Player > 15].' The stuffed ocelot sloshing slightly as he heads off[else].' The well-fucked ocelot heads off[end if], leaking your semen from his creamy hole.";
...
to say ocelotloss_bt_o2:	[sub on dom - oral]
	if Player is male:
		...
		say "     Eventually you can't hold back any longer and, giving him permission to cum as well, you unleash your hot load into the kitty's muzzle[if Player is male] and across his body[end if][if ball size of Player > 45]. You pump so much cum into the small feline that he's so bloated and overfull that some eventually has to bubble out around your [cock size desc of Player] shaft[else if ball size of Player > 30]. You pump so much cum into the small feline that he's left bloated and overfull[else if ball size of Player > 15]. You pump so much cum into the small feline that he has a bit of a bulge in his tummy from it all[end if]. When you're drained and [if Cock Length of Player > 24 or ball size of Player > 15]he's managed to pull[else]he's pulled[end if] your spent shaft from his throat, you're left worn out, but very fulfilled. You give the kitty a kiss, a pat on the rear and send him on his way. '[one of]I need to get back to my master[or]I'd best hurry back to my master[or]I should go find my master[or]I can't wait to tell my master all about this. I have to go find him[at random],' he purrs. 'Maybe once you've got a kitty fucktoy of your own [one of]we can play again[or]you and my master can share[or]you'd like to meet him[or]you can watch us play together[at random][if ball size of Player > 30].' The overloaded ocelot staggers off slowly[else if ball size of Player > 15].' The stuffed ocelot sloshing slightly as he heads off[else].' The well-fed ocelot heads off[end if], grooming his face with a paw to get any stray cum that leaked out.";
	else:
		...
		say "     Eventually you can't hold back any longer and, giving him permission to cum as well, you arch your back and cry out in orgasm, soaking the kitty's muzzle and paw in your juices[if Cunt Length of Player > 36]. In your throws of passion, you inadvertently end up pushing the kitty's head partway into your giant pussy, but he takes this in stride, licking across your inner walls as they spasm around his face[else if Cunt Length of Player > 24]. In your throws of passion, you inadvertently end up pushing the kitty's muzzle into your enlarge pussy, but he takes this in stride, licking across your inner walls as they spasm around his furry muzzle[else if Cunt Length of Player > 15]. In your throws of passion, you inadvertently end up pushing the kitty's muzzle squarely against your twitching folds, pulling his tongue into you, but he takes this in stride, licking and lapping inside your spasming inner walls[else]. In your throws of passion, you inadvertently end up pushing the kitty's muzzle squarely against your twitching folds, pressing his tongue against it, but he takes this in stride, lavishing attention upon your clit[end if]. When you finally release him and flop back onto the ground, he smiles up at you while licking his wet muzzle[if Cunt Length of Player > 24]. His head is literally soaked in your juices, making a mess of the exotic kitty's fur[else if Cunt Length of Player > 15]. His face is literally soaked in your juices, making a mess of the exotic kitty's fur[else]. His muzzle is quite soaked with your juices, making a mess of the exotic kitty's fur[end if]. You, meanwhile, are left feeling worn out, but very fulfilled. You give the kitty a kiss, a pat on the rear and send him on his way. '[one of]I need to get back to my master[or]I'd best hurry back to my master[or]I should go find my master[or]I can't wait to tell my master all about this. I have to go find him[at random],' he purrs. 'Maybe once you've got a kitty fucktoy of your own [one of]we can play again[or]you and my master can share[or]you'd like to meet him[or]you can watch us play together[at random][if Cunt Length of Player > 24].' The rather damp ocelot pads away slowly, working to groom his face with a paw to both settle his fur and taste more of your juices[else if Cunt Length of Player > 15].' The somewhat damp ocelot pads away slowly, working to groom his face with a paw to both settle his fur and taste more of your juices[else].' The somewhat scruffy ocelot pads away slowly, working to groom his muzzle with a paw to both settle his fur and taste more of your juices[end if].";
		...
		if Player consents:
			...
			if ocelotchoice is 1:				[sub-ocelot chosen]
				if Player is male:
					...
					say "     Eventually you can't hold back any longer and, working your [if bodyname of Player is listed in infections of Felinelist]paw[else]hand[end if] over his cock vigorously, you thrust deep into the kitty's bottom and unleash your [Cum Load Size of Player] load into [if Player is male](and all over) [end if]him. As he cums, [if ball size of Player > 45]you pump so much semen into the small feline that he's so bloated and overfull that some gurgles up and overflows from his mouth[else if ball size of Player > 30]you pump so much semen into the small feline that he's left bloated and overfull[else if ball size of Player > 15]you pump so much semen into the small feline that he has a bit of a bulge in his tummy from it all[end if]you continue fucking him, squeezing out as much as you can for your sexy playmate. When you're drained and [if Cock Length of Player > 24 or ball size of Player > 15]you manage to pull[else]you pull[end if] out of his tight rump, you're left worn out, but very fulfilled. You give the kitty a kiss, a pat on the rear and send him on his way, warning him to be more careful next time[if ball size of Player > 30]. The overloaded ocelot staggers off slowly[else if ball size of Player > 15]. The stuffed ocelot sloshes slightly as he heads off[else]. The well-fucked ocelot heads off[end if], leaking your semen from his creamy hole.";
				else:
				...
				if Player is male:
					...
					say ".";
					say "     Eventually you can't hold back any longer and, giving him permission to cum as well, you unleash your hot load into the kitty's bottom[if Player is male] and across his body[end if][if ball size of Player > 45]. Your [Cum Load Size of Player] load fills him with so much cum that he's so bloated and overfull that some gurgles up and overflows from his mouth[else if ball size of Player > 30]. Your [Cum Load Size of Player] load fills him with so much cum that he's left bloated and overfull[else if ball size of Player > 15]. Your [Cum Load Size of Player] load fills him with so much cum that he has a bit of a bulge in his tummy from it all[end if]. Having emptied your balls into him, [if Cock Length of Player > 24 or ball size of Player > 15]you pull out of his well-fucked hole with some effort[else]you slide your cock from his well-fucked hole[end if], leaving you feeling a little worn out, but very fulfilled. You give the kitty a final swat on the rear and send him on his way with a warning to be more careful next time or you won't go so easy on him[if ball size of Player > 30]. The overloaded ocelot staggers off slowly[else if ball size of Player > 15]. The stuffed ocelot sloshes slightly as he heads off[else]. The well-fucked ocelot heads off[end if], leaking your semen from his creamy hole.";
				else:
					...
					if Player consents:
						...
						say ".";
						say "     Eventually you can't hold back any longer and cum with a loud [if facename of Player is listed in infections of Felinelist]mrowl[else]moan[end if] of ecstasy, soaking the kitty's muzzle with your juices[if Cunt Length of Player > 36]. In your throws of passion, you inadvertently end up pulling the spotted kitty's head partway into your giant pussy. He takes this in stride and licks eagerly across your inner walls as they spasm around his face[else if Cunt Length of Player > 24]. In your throws of passion, you inadvertently end up pulling the spotted kitty's muzzle into your enlarge pussy. He takes this in stride and licks eagerly across your inner walls as they spasm around his furry muzzle[else if Cunt Length of Player > 15]. In your throws of passion, you inadvertently end up pulling the spotted kitty's muzzle squarely against your twitching folds, pressing his tongue into you. He takes this in stride, licking and lapping inside your spasming inner walls[else]. In your throws of passion, you inadvertently end up pulling the spotted kitty's muzzle squarely against your twitching folds, pressing his tongue against it. He takes this in stride and lavishes attention upon your clit[end if]. Once satisfied, you push him away so he lands on his ass, his cock throbbing hard after having been left unattended through all that[if Cunt Length of Player > 24]. His head is literally soaked in your juices, making a mess of the exotic feline's fur[else if Cunt Length of Player > 15]. His face is literally soaked in your juices, making a mess of the exotic feline fur[else]. His muzzle is quite soaked with your juices, making a mess of the exotic feline's fur[end if], which he starts licking up. You pull him to his feet, give his ass a firm swat and send him on his way with a warning to be more careful next time or you won't go so easy on him[if Cunt Length of Player > 24]. The rather damp ocelot pads away slowly, working to groom his face with a paw to both settle his fur and taste more of your juices[else if Cunt Length of Player > 15]. The somewhat damp ocelot pads away slowly, working to groom his face with a paw to both settle his fur and taste more of your juices[else]. The somewhat scruffy ocelot pads away slowly, working to groom his muzzle with a paw to both settle his fur and taste more of your juices[end if] while searching for his proper master (or at least a place to jerk off).";
		else:
			LineBreak;
