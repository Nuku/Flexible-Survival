...
to say losetoocelot:
	...
	if ocelotchoice is 1:				[sub-ocelot chosen]
		if Player is male:
			...
			else if Player is not female and anallevel > 1 and ( ( a random chance of 1 in 4 succeeds ) or ( anallevel is 3 and a random chance of 1 in 4 succeeds ) or ( Player is submissive and a random chance of 1 in 4 succeeds ) or ( "MPreg" is listed in feats of Player and a random chance of 1 in 4 succeeds ) ):	[anal]
			...
			if anallevel > 1 and ( ( a random chance of 1 in 4 succeeds ) or ( anallevel is 3 and a random chance of 1 in 4 succeeds ) or ( BodyName of Player is "Ocelot" and a random chance of 1 in 4 succeeds ) or ( "MPreg" is listed in feats of Player and a random chance of 1 in 4 succeeds ) ):	[anal]
				say "[ocelotloss_bt_a1]";
			else:	[oral]
				say "[ocelotloss_bt_o1]";
		...
		if Player is male:
			...
			if anallevel > 1 and ( ( a random chance of 1 in 4 succeeds ) or ( anallevel is 3 and a random chance of 1 in 4 succeeds ) or ( Player is submissive and a random chance of 1 in 4 succeeds ) or ( "MPreg" is listed in feats of Player and a random chance of 1 in 4 succeeds ) ):	[anal]
...
to say ocelotloss_bt_a2:	[sub on dom - anal]
	say "     The [if scalevalue of Player > 2]smaller[else]small[end if] ocelot, once this foreplay is done, eagerly climbs back into your lap and moves atop your shaft. 'Mmm... You're just in a bad mood because you need some relief. I'll be a good, subby kitty and take care of you... let you fuck me like the big, strong dom you are,' he purrs as he [if scalevalue of Player > 3]kisses at your chest[else]licks along the edge of your ear[end if]. He lets your cock brush against his tight little pucker and starts lowering himself down onto your shaft. His hole, already lubed, spreads easily for you as he sinks down into your lap. [if Cock Length of Player > 24]Even your [cock size desc of Player] [Cock of Player] shaft can make its way into the slender kitty's bottom with little difficulty, though he's deliciously tight around you. Despite, or perhaps even because of, the phallic bulge your meat makes in him, he rumbles and purrs loudly as he rides up and down it[else if Cock Length of Player > 15]Even your [cock size desc of Player] [Cock of Player] shaft can make its way into the slender kitty's bottom with little difficulty, though he's deliciously tight around you. Despite, or perhaps even because, he's so deeply filled, he rumbles and purrs loudly as he rides up and down it[else if Cock Length of Player > 8]Your [cock size desc of Player] [Cock of Player] shaft is no problem for the slender kitty to take, sliding it into his well-trained bottom. He is still somehow deliciously tight around you though[else]Despite his obvious ease at taking your [cock size desc of Player] [Cock of Player] shaft into his rear, he is still somehow deliciously tight around you[end if]. He [if scalevalue of Player > 3]wraps as much of his arms as he can get around your [Body Size Adjective of Player] waist and nuzzles at your big body happily[else]runs his paws over your [bodydesc of Player] body[end if] while riding your cock for all he's worth.";
	say "     He turns out to be a very eager and obedient kitty, listening to your every request to go faster or slower, harder or softer as best suits your changing desires as your arousal grows. His slinky body bends and squirms in so many delightful ways[if Player is male]. You even have him switch cocks a few times, making sure you'll be completely satisfied[end if]. Petting his head and complimenting him [if Nipple Count of Player > 0 and Breast Size of Player > 0]for his fine work, you guide his muzzle to your breasts, encouraging him to kiss, lick, nip and suckle them as well[else]on his fine work, you scritch the kitty's ears and eagerly tell him to keep it up[end if]. It makes you wish he was yours, but he's clearly already got an owner who's trained him well. You'll just have to find another to keep, then.";
	say "     Eventually you can't hold back any longer and, giving him permission to cum as well, you unleash your hot load into the kitty's bottom[if Player is male] and across his body[end if][if Ball Size of Player > 6]. You pump so much cum into the small feline that he's so bloated and overfull that some gurgles up and overflows from his mouth[else if Ball Size of Player > 6]. You pump so much cum into the small feline that he's left bloated and overfull[else if Ball Size of Player > 4]. You pump so much cum into the small feline that he has a bit of a bulge in his tummy from it all[end if]. When you're drained and [if Cock Length of Player > 24 or Ball Size of Player > 4]he's managed to pull[else]he's pulled[end if] himself off your spent shaft, you're left worn out, but very fulfilled. You give the kitty a kiss, a pat on the rear and send him on his way. '[one of]I need to get back to my master[or]I'd best hurry back to my master[or]I should go find my master[or]I can't wait to tell my master all about this. I have to go find him[at random],' he purrs. 'Maybe once you've got a kitty fucktoy of your own [one of]we can play again[or]you and my master can share[or]you'd like to meet him[or]you can watch us play together[at random].' The [if Ball Size of Player > 6]overloaded ocelot staggers off slowly[else if Ball Size of Player > 4]stuffed ocelot sloshing slightly as he heads off[else]well-fucked ocelot heads off[end if], leaking your semen from his creamy hole.";
...
to say ocelotloss_bt_o2:	[sub on dom - oral]
	if Player is male:
		...
		say "     He turns out to be a very eager and obedient kitty, listening to your every request to go faster or slower, to lick or to suck as best suits your changing desires as your arousal grows. His cute muzzle and agile little tongue work hard to please you in so many delightful ways[if Player is male]. You even have him switch cocks a few times, making sure you'll be completely satisfied[end if][if Cunt Count of Player > 1]. You also direct him on how to best finger and tease your pussies, not that he seems to need much encouragement on that score either[else if Player is female]. You also direct him on how to best finger and tease your pussy, not that he seems to need much encouragement on that score either[end if]. Petting his head and complimenting him [if Nipple Count of Player > 0 and Breast Size of Player > 0]for his fine work, you bring your other hand to your breasts, playing with them as you watch the little slave kitty suck you off[else]on his fine work, you scritch the kitty's ears and eagerly tell him to keep it up[end if]. It makes you wish he was yours, but he's clearly already got an owner who's trained him well. You'll just have to find another to keep, then.";
		say "     Eventually you can't hold back any longer and, giving him permission to cum as well, you unleash your hot load into the kitty's muzzle[if Player is male] and across his body[end if][if Ball Size of Player > 6]. You pump so much cum into the small feline that he's so bloated and overfull that some eventually has to bubble out around your [cock size desc of Player] shaft[else if Ball Size of Player > 6]. You pump so much cum into the small feline that he's left bloated and overfull[else if Ball Size of Player > 4]. You pump so much cum into the small feline that he has a bit of a bulge in his tummy from it all[end if]. When you're drained and [if Cock Length of Player > 24 or Ball Size of Player > 4]he's managed to pull[else]he's pulled[end if] your spent shaft from his throat, you're left worn out, but very fulfilled. You give the kitty a kiss, a pat on the rear and send him on his way. '[one of]I need to get back to my master[or]I'd best hurry back to my master[or]I should go find my master[or]I can't wait to tell my master all about this. I have to go find him[at random],' he purrs. 'Maybe once you've got a kitty fucktoy of your own [one of]we can play again[or]you and my master can share[or]you'd like to meet him[or]you can watch us play together[at random].' The [if Ball Size of Player > 6]overloaded ocelot staggers off slowly[else if Ball Size of Player > 4]stuffed ocelot sloshing slightly as he heads off[else]well-fed ocelot heads off[end if], grooming his face with a paw to get any stray cum that leaked out.";
	else:
		say "     The [if scalevalue of Player > 2]smaller[else]small[end if] ocelot keeps this up, lavishing attention upon your [cunt size desc of Player] pussy. 'Mmmm... You're just in a bad mood because you need some relief. Just relax and let the subby kitty take care of this beautiful pussy of yours,' he purrs before kissing your clit again and slowly lapping across your folds. His dainty paws glide across your flesh, rubbing over your [CuntSpeciesName of Player in lower case] pussy with his softly furred fingertips. [if Cunt Depth of Player > 24]Presented with such a huge cunt to please, the attentive kitty dives in eagerly, pushing his whole paw deep inside you while his raspy tongue runs up and down. He rumbles and purrs happily as he works to please you, his purring sending delightful shivers through your bulging[else if Cunt Depth of Player > 15]Presented with such a large cunt to please, the attentive kitty dives in eagerly, pushing several fingers fully inside you while his raspy tongue runs up and down. He rumbles and purrs happily as he works to please you, his purring sending delightful shivers through your swollen[else if Cunt Depth of Player > 8]Presented with your engorged cunt to please, the attentive kitty dives in eagerly, pushing a pair of fingers deep inside you while his raspy tongue runs up and down. He rumbles and purrs happily as he works to please you, his purring sending delightful shivers through your plump[else]The attentive kitty dives in eagerly, pushing a finger deep inside you while his raspy tongue runs up and down. He rumbles and purrs happily as he works to please you, his purring sending delightful shivers through your hot[end if] button.";
...
to say beattheocelot:
	...
	if noocelotbtsex > 2:
		...
		say "[line break]     [bold type]Should you have some fun?[roman type][line break]";
		...
		if Player consents:
			...
			if ocelotchoice is 1:				[sub-ocelot chosen]
				...
				if Player is male:
					...
					say "     The [if scalevalue of Player > 2]smaller[else]small[end if] ocelot slowly laps across your folds before moving to work his rough tongue across your clit. With your [cunt size desc of Player] cunt pressed before him, the attentive kitty works his muzzle up and down with [if Cunt Depth of Player > 15]long licks. He rumbles and purrs happily as he works to please you, his purring sending delightful shivers through your bulging[else if Cunt Depth of Player > 8]firm licks. He rumbles and purrs happily as he works to please you, his purring sending delightful shivers through your plump[else]short licks. He rumbles and purrs happily as he works to please you, his purring sending delightful shivers through your hot[end if] button.";
					...
					say "[line break]     [bold type]Shall you let the kitty fuck you to finish you off?[roman type][line break]";
...
When Play begins:
	...
	now Species Name entry is "Ocelot"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now skin change entry is "the feel of soft fur brushes across your body as you are rapidly covered in a coat of golden brown fur that is resplendent with spots and stripes, much like that of an ocelot[if Player is ocelotbodied]. After this comes cool tingles as some leather gear grows from your skin";
	...
	now MilkItem entry is "ocelot milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "ocelot cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
to say ocelotbodydesc:
	if ocelotchoice is 2:	[big kitty]
		say "heavy-set feline creature. You probably weigh over 300 lbs, but the weight doesn't seem to inconvenience you very much, feeling stronger muscles and a six foot frame below the fat to help support it. Your hands have become pudgy paws that seem eager to grab, grope or swat some asses";
		if SkinName of Player is "Ocelot":
			say ". Your body has also formed a harness, fingerless gloves and [if Player is male or Player is not female]a codpiece[else]panties[end if] all out of black leather for you as well";
	else:			[slender kitty]
		say "slender feline creature. This body, only about five feet tall, is quite lithe, capable of using its flexibility to please your lovers. To help with this, your paws have slender, nimble digits that are very sensitive, almost as if they're able to locate every spot needing attention";
		if SkinName of Player is "Ocelot":
			say ". Your body has also formed a harness, cuffs and [if Player is male or Player is not female]a codpiece[else]panties[end if] all out of black leather for you as well";
...
to say ocelotbodychange:
	say "parts of you start going numb, followed by the pops and snaps of changing bone. As your body changes shape, you becomes increasingly [if ocelotchoice is 2]fat, gaining excess pudginess all over even as your muscles and bones are altered to help deal with this. Your hands become paws with pudgy fingers and your body has a subtle, feline shape to it that you can still make out[else]slender, shrinking down to become quite thin and lithe. Your hands become dainty paws with nimble fingers and your body has a subtle, feline shape to it[end if]";
	if SkinName of Player is "Ocelot":
