			...
			if ocelotchoice is 1:				[sub-ocelot chosen]
				...
				if player is male:
					...
					if player consents:
						...
						LineBreak;
						say "     Given his earlier actions, you decide that might be too much of a reward for the ocelot and let him continue licking you. You do scritch his ears and tell the obedient fucktoy to lick you harder because you want to cum now. At your orders, he dives in, working that well-trained tongue across every sensitive spot it can reach inside and out[if player is breasted]. Bringing your other hand to your breasts, you play with them as you watch the little slave kitty eat you out[end if]";
						if bodyname of player is "Ocelot":
