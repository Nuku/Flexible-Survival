...
Instead of conversing the Joanna:
	...
	otherwise if joannatalk is 0:
		say "     Joanna [if daytimer is day]turns away from stretching herself to the sun to smile at you[otherwise]stretches, a little sluggish at night and turns to smile at you[end if].  'That was quite the little adventure we had, wasn't it?  I had just been getting used to being a kinkajou and spent a lot of my time at night scurrying around or dancing at that club.  Now I've got to switch my schedule around again,' she says with a soft chuckle, trying to put a brave face on what is a very dramatic change.  'At least a plant's calender's pretty simple: get some sunshine.  Should be easy enough to handle,' she adds, smiling weakly.";
