...
to say ResolveEvent Overrun Garden:
	say "     In a courtyard between a cluster of office buildings, you spot a small garden park. It seems the plant-life has overrun the garden, with oversized flowers and numerous vines. You are about the head that way to give it a closer look when you spot some motion at the edge of the park. Stepping into the park from between two buildings comes a slender, female creature. She has short brown fur, long brown hair and a very long tail. [if HP of Joanna is 0]At first you think her perhaps some kind of monkey, but change your mind as you watch her further. After struggling to recall the animal's name, it comes to you. A kinkajou, a South American creature that feeds on honey and nectar. Sounds safe enough. And she still has some clothes on, so she could even be a survivor, though it's hard to tell at the moment[else]You recognize her to be Joanna, the girl from the club[end if].";
	WaitLineBreak;
	say "     You spot some motion in the branches near her as she starts climbing up to get at the flowers for their nectar. Realizing too late that it is the branches themselves which moved, you call out to her in warning. Vines lash out and grab the kinkajou woman, coiling around her and restraining her with ease. This plant creature seems [if plantdefeat > 0]related to the one that put its seed in you, but much larger and stronger. The seed in your belly starts to stir as well so you'd best be careful[else]quite extensive and very strong[end if]. Its tendrils grab at her clothes and pull them apart as if they were paper.";
	WaitLineBreak;
	...
	say "[line break]     [bold type]Shall you charge to her rescue or wait to watch how it ends?[roman type][line break]";
...
to HEquestion1:
	...
	if Player consents:
		...
		if resolution of Hybrid Experimentations < 1:
...
instead of navigating Flower Garden while HP of Joanna is 7 and resolution of Spreading Flowers is 3: [proceeding with the quest]
	say "[NavCheck Flower Garden]";
	if NavCheckReturn is false, stop the action; [can't nav from the player's location, or already there - so we stop this cold]
	move player to Flower Garden, without printing a room description;
...
instead of navigating Flower Garden while HP of Joanna is 8 and JoannaSFTimer - turns > 9: [proceeding with the quest after she formulated a plan]
	...
	if Resolution of Dog Walking is 2: [Quest takes a different route, directly towards the Awesome Trees]
		...
		WaitLineBreak;
		say "     Now, all that is left to do is to look for someone that would do the job... [if HP of Xerxes > 0 or HP of Helen > 0]Wait, you do have a human dog in your library! And you're the owner! Things just got a lot easier, now, because that's just what you needed, given Joanna's description.[end if]";
...
to say flowergardenscent:
	if morale of Player < level of Player or lastflowersmell - turns < 8:
		...
		say "     The flower garden smells wonderful, with an array of beautiful fragrances in the air, much nicer than the smell of the city surrounding it. Stopping to smell the roses cheers you up a little.";
...
to say joannascent:
	if HP of Joanna is not 0 and HP of Joanna < 90:
		if morale of Player > level of Player or lastflowersmell - turns < 6:
			...
			say "     Moving up close to her, you stroke Joanna's hair and bring one of the blossoms to your nose. It has a lovely fragrance, uniquely lovely and perhaps the best flower you've ever smelled. Stopping to smell the roses cheers you up a little.";
			increase morale of Player by 5;
			raise Player Libido by 5;
			now lastflowersmell is turns;
...
instead of conversing the Joanna:
	...
	[Joanna at her garden]
		...
		if HP of Joanna is 6 and a random chance of 1 in 4 succeeds and joannaoffernum is not 4 and lastfuck of joanna - turns >= 5 and daytimer is day:
			...
			say "[line break]     [bold type]Shall you accept her offer?[roman type][line break]";
...
to say plantexam:
	...
	WaitLineBreak;
	say "     Joanna's paws slide over you as she takes in your plant-like features[if Player is plantbodied or player is plantskinned]. Her fingers roam over your altered body, thoroughly enjoying this chance to examine you and you can't help but moan a little in response to her touch[end if][if Player is plantfaced]. She brings a paw up to your feminine face, stroking your cheek before teasing a fingertip along the lips of your pussy-like mouth. She slips a finger into your pussy-mouth and grins as it starts sucking on her digit. Withdrawing the finger, she leans in and gives you a kiss, driving her long, slick tongue in instead. Your pussy-mouth automatically starts squeezing and milking at it, coaxing some of her sweet fluids from it before she pulls away to break the kiss[end if][if Player is planttailed]. Lowering herself down, she moves to examine your vaginal anus, teasing her fingertips around it and slathering her tongue across it until you start to moan and drip with juices[end if]";
...
to say joannasex5:
	...
	if Cunt Count of Player > 2:
		...
		say "     With [if Cunt Count of Player is 1]some[else]one[end if] of her cocks left out, she slides her cocks into your [if Cunt Count of Player is 1]cunt[else]cunts[end if] and [if Player is planttailed]vagina-like anus[else]tight pucker[end if] each in turn. The remaining [if Cunt Count of Player is 1]cock tendrils slide[else]cock tendril slides[end if] around on your body, stroking against your [SkinSpeciesName of Player in lower case] flesh[if Cock Count of Player > 1] and entwining with your cocks[else if Player is male] and entwining around your cock, squeezing and pumping over your throbbing flesh[end if]. Kissing you again, her slick tongue pumps down your throat, filling your taste buds with her sweet flavor once again. You run your hands through her soft fur and stroke her breasts, playing with her nipples and the soft petals which surround them. Joanna keeps her paws locked your hips, gripping you firmly.";
	WaitLineBreak;
...
to say joannasex7:
	...
	WaitLineBreak;
	say "     The plant-kinkajou's [if Cock Count of Player > 1]pussies[else]pussy[end if], causing Joanna to chirr in delight even as she's sliding [if Cunt Count of Player > 3]her tentacle cocks into her lover, having found a wet cunt for each[else if Cunt Count of Player > 1 and player is planttailed]her tentacle cocks into your wet cunts and vaginal asshole[else if Cunt Count of Player > 1]her tentacle cocks into your wet cunts and snug asshole[else if Player is female and player is planttailed]her tentacle cocks into you, one for your wet cunt and one for your vaginal asshole[else if Player is female]her tentacle cocks into you, one for your wet cunt and one for your snug asshole[else if Player is planttailed]a tentacle cock into your dripping, vaginal asshole[else]a tentacle cock into your snug asshole[end if]. Bringing your hands to her bosom, you caress her lovely globes and her flowery areolae and perky, green nipples. She doesn't ride you very hard so she can let her tendrils writhe while she fucks you in return. Instead, her plant body seems to squeeze and suck at your cock[smn] hungrily, milking the precum from you with an apparent hunger for something richer and creamier to satisfy it.";
	WaitLineBreak;
...
to say joannajuice:
	...
	raise Player Libido by 50; [increase before later dropping at climax]
...
an everyturn rule:
	if HP of Joanna is 0 or HP of Joanna >= 90:
		...
		else if Joanna is in PALOMINO Dance Club: [during the day, she's out sleeping or scavenging]
...
instead of using plant-like dildo:
	if Player is female:
		say "[line break]     [bold type]Do you want to pleasure yourself with this plant-like cock in your pussy or ass?[roman type][line break]";
...
This is the Joanna's Epilogue rule: [See Parasitic Plant for player specific endings]
	...
	if HP of Joanna >= 7 and HP of Joanna < 90 and humanity of Player >= 10:
		...
		now JoannasEpilogueShown is true;
		say "     When rescue arrives, you [if humanity of Player < 40 and humanity of Player >= 10]decide to hide the existence of the plant seed resting within you, deciding that it is now a part of what you are. You live a rather normal life, except for the very, very frequent sex, of course. Nymphomania is not really high on the list of mental illnesses you get locked up for and it's certainly a lot more common these days[else]have the seed removed from your belly, glad to have the lust-inducing parasite removed[end if].";
