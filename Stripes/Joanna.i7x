...
Instead of conversing the Joanna:
	...
	otherwise if hp of Joanna is 90:
	...
	otherwise if hp of Joanna is 91:
		...
		say "     The three of you chat for a while until a song change occurs and Joanna gets up.  'Oh, I love this song.  Catch you later, hon,' she says with a wave before dashing back into the crowd to dance.";
		now hp of Joanna is 92;
	otherwise if hp of Joanna is 92:
...
to say joannasex4:
	...
	if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
	if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
	say "     Running your hands along her hips, you caress her as she lowers herself down onto your [if cocks of player > 1]cocks, taking them into her wet pussies[otherwise]cock, taking them into her wet pussy[end if].  She chirrs in delight at the sensation of having you inside her needy body and rides you slowly at first, savouring the pleasure [if player is plantcocked and lust of joanna > 0 and cocks of player > 1]of having your green tendrils inside her[otherwise]of having your green tendril inside her[end if].  From the way she's nibbling her lip and the twitches of her flowery folds and writhing cocks, it's clear it's taking some effort to hold back her urges.  Deciding to help her along, you take a pair of her slick tendrils in each hand and stroke them.  She tilts her head back and moans loudly, spreading her arms wide into the sun and rides you faster.";
	if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
	if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
