...
when play ends:
	if bodyname of player is "Bottlenose Toy":
		if dolinfloss is -100 or dolinfloss is -101:
			say "     Safely stored away in the [if dolinfloss is -100]small storage building[otherwise]floating bouncy castle[end if], you are continuously pleasured by the dolphin suit wrapped around you.  What little remains of your fading mind is vaguely aware that you're being changed by the slick inner walls rubbing against you.  You are unclear on what's happening and don't really care, your thoughts evaporating away as you become as empty and airheaded as those cute girls on the beach.  After some time has passed (probably a few days, though you were unable to count them as you were only dimly aware of the growing and fading light outside), several of the girls return to the [if dolinfloss is -100]building[otherwise]colourful castle[end if] and remove you and the inflatable dolphin suit.  Snuggling and kising it, they slowly open it up and release you.  Their fin-hands run over your new, smooth skin and inflatable body, having been transformed a new feral dolphin toy.  You are happy to be released and merrily play with several of the girls in the water while one of them licks the inside of the suit clean and bundles it up for the next happy victim they can find to put into it.";
			if cocks of player > 0:
