...
When Play begins:
	...
	now face entry is "[if wrcurseactivity is true]animalistic head of a raptor with piercing yellow eyes and[else]a humanoid face with saurian features. It has yellow eyes and is[end if] covered in [if player is herm]dark crimson[else if cunts of player > 0]black[else if cocks of player > 0]green[else]pale gray[end if] scales";
	...
	now skin entry is "deep blue and [if player is herm]dark crimson[else if cunts of player > 0]black[else if cocks of player > 0]green[else]pale gray[end if] scales";
	...
	now skin change entry is "scales spread across your skin, deep blue across your limbs and the front of your torso and [if player is herm]dark crimson[else if cunts of player > 0]black[else if cocks of player > 0]green[else]pale gray[end if] over your head and back";
