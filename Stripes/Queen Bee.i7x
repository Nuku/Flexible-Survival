...
"Queen Bee"	"[PrepCombat_Queen Bee]"

to say PrepCombat_Queen Bee:
	setmongender 4;]
...
When Play begins:
	...
	now Species Name entry is "Bee"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	add "Queen Bee" to infections of InternalBallsList;
	...
	now MilkItem entry is "queen bee milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "queen bee cum"; [ Item to be given to the player if they have this infection and jerk off. ]
