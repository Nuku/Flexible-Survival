...
to say christysex:
	if cocks of player > 0 and cock length of player > 4:		[cock of adequate size]
		...
		increase lust of Christy by 1;
		now lastChristyfucked is turns;
	else if cocks of player > 0:					[cock of inadequate size]
		if bodyname of player is "Horny Dragon" or bodyname of player is "Slutty Dragoness":
	...
	while scenerun is 0:
		...
		if calcnumber < 1 or calcnumber > 3:
			...
			if calcnumber is 1:			[Confess]
				...
				WaitLineBreak;
				say "     'Are you going to be a good [if cunts of player > 0]girl[else]boy[end if] now?' she rumbles, teasing the tip of her tail across your [if cunts of player > 0 and cocks of player > 0]surprisingly wet pussy and your plump balls[else if cunts of player > 0]surprisingly wet pussy[else]plump balls[end if]. You moan at this touch and press back against it before telling her that you'll be good now. 'Mmm... I don't quite know if I believe you yet,' she teases before giving you another swat. Finding yourself getting more and more into it, each blow that comes brings pleasure as well as pain, slowly building your excitement higher.";
...
Instead of resolving Dragon Prey:
	...
	if finale is 1:		[bad end]
		say "     'You've been a very bad [if cunts of player > 0]girl[else]boy[end if] and you need to be punished properly,' she growls. 'You were my hero, but now you'll be nothing but my toy, my pet,' she rumbles, sliding her tongue across you slowly. 'I'll teach you how to treat me right and make sure you don't do anything like that to me ever again.'";
...
to say mchristy_oral0:
	say "     Hungry for another meal of the dragon's thick, spicy cum, you start rubbing your [bodydesc of player] body against that mighty shaft. The feel of those ridges across your chest[if breasts of player > 0 and breast size of player > 4] and between your boobs[end if] excites you all the more. Your hands reach further back, rubbing over the smooth scales of Christy's ballsack. It may just be your excitement, but those orbs feel large, heavy and hot with the semen you crave.";
...
to say mchristy_top1:
	...
	say "     Bracing yourself, you push back harder against the male's cock, urging him to mount you. With a deep rumble, he moves forward, driving close to a foot of his titanic meat into you in one go and then slowing to just a few inches at a time[if cunt length of player < 30]. The size of it makes for slow going at first, the dragon doing his best to hold back despite his obvious desire to rut you[else]. Your over-sized cunt welcomes it in with relative ease, your yawning vagina happy to have a chance to be thoroughly filled[end if]. This does give your [bodytype of player] body a chance to adjust, him being so large that [if scalevalue of player < 3]your torso is eventually stretched completely around it, bulging overfull of dragon meat. You are so filled that your [body size of player] limbs can barely reach the ground to steady yourself for the epic fucking that is to come and he instead has to grip you with one forepaw to be able to fully penetrate you[else if scalevalue of player is 3]your torso is stretched prominently by it, making a massive cock-shaped bulge through your body[else if scalevalue of player is 4]your torso bulges prominently thanks to the phallic intruder[else]your belly has a marked, phallic bulge showing[end if]. By the time he's fully inside you, you can feel every throb of his strong heartbeat pulsing through his shaft and into you.";
...
to say mchristy_bottom0:
	...
	say "     It takes you a while to recover from the powerful orgasm and slip your spent shaft free of the dragon's creamy bottom[if cock width of player < 20]. A trickle of your gooey load leaks from his messy hole and you can't resist giving him a brief fingering to hear him moan[else]. A rivulet of your gooey load flows gradually from his messy hole and you can't resist giving him a brief fingering to hear him moan[end if]. 'Oh, that feels so nice. Such a delightfully naughty surprise. I'm such a bad nun though,' he sighs even as he wiggles his ass to better enjoy the feel of your seed pooled inside his ass.";
...
to say mchristy_cv1:
	...
	say "     Having a little room to maneuver now that you're in warm, wet embrace of his testicle, you curl up in a comfortable position and [if cocks of player > 0 and cunts of player > 0]grab your cock and stuff some fingers into your pussy[else if cocks of player > 0]grab your cock[else]stuff some fingers into your pussy[end if]. You masturbate at a casual pace, enjoying the warmth and scent coming from all around you. Even so, you get off fairly quickly after your long, pleasurable journey to get here. After cumming and [if cocks of player > 0 and cunts of player > 0]spraying your [cum load size of player] load into his sperm factory and adding your feminine juices to the mess soaking your crotch[else if cocks of player > 0]spraying your [cum load size of player] load into his sperm factory[else]adding your feminine juices to the mess soaking your crotch[end if], you drift off into sticky bliss, soaking in a slowly refilling pool of draconic semen. While you do not drown in the sticky fluids, you do get woozy and end up passing out into a bliss-out haze.";
	WaitLineBreak;
