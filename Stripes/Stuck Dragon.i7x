...
to say mchristy_cv0:
	...
	WaitLineBreak;
	say "     You manage to achieve climax shortly before him[if cocks of player > 0 and cunts of player > 0]spraying your [cum load size of player] load into his sperm factory and adding your feminine juices to the mess soaking your crotch[else if cocks of player > 0]spraying your [cum load size of player] load into his sperm factory[else]adding your feminine juices to the mess soaking your crotch[end if]. The dragon's eruption follows soon after, the squeeze and surge of fluid around you catapulting your waning orgasm back into full force even as you're driven back through his seminal plumbing. Pushed along by fluid pressure, you're splattered with a fresh rush of liquid as you pass his prostate, adding to the richness of its flavour and allowing it to carry you more smoothly onwards. You are expelled with eruptive force moments later with eruptive force, shot several feet as part of the dragon's torrential release.";
