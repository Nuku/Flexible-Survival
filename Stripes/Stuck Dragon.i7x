...
to say dragonchange:
	...
	if "Male Preferred" is not listed in feats of player:
		...
		now tail of player is "You have a long, thick, and scaly dragon tail with your ass[if player is herm], gaping pussy lips and pendulous balls[else if cunts of player > 0] and gaping pussy lips[else if cocks of player > 0] and pendulous balls[end if] beneath it.";
