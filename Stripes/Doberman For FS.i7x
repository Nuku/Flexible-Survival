...
to say beattheDoberman:
	...
	if dobielibido < 50:			[low-lust cop]
		say "[beatthedobie1]";
	otherwise if dobielibido < 100 or inasituation is true:	[mid-lust cop]
		say "[beatthedobie2]";
