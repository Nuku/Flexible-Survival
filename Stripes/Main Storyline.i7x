...
ndmlist is a list of text that varies.
...
instead of conversing Larissa while hp of doctor matt is 16:
	...
	say "     She heaves a small suitcase onto the counter and pops it open.  She takes a moment to demonstrate how to activate them, then closes it up and slides the case to you.  Grabbing the heavy case, you sigh and head off, hoping this job will be as easy as she claims, but knowing it won't be somehow.";
...
[	add "nanite density monitor" to invent of player;
	...
	say "((NOTE: This content will be coming soon, so don't bother looking for it yet.))";
...
to say ndmdesc:
	...
	otherwise:
		say "     With [the number of entries in ndmlist] remining to be placed, you recall that Larissa said Zephyr wanted the others placed at the [ndmlist].  You should make your way there and [bold type]hunt[roman type] for a suitable ['][bold type]detector site[roman type]['] in those areas.";
