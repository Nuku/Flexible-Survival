...
to say monstercostumedesc:
	...
	say "     A strange, wobbly creature approaches you.  It seems like the werewolf from a cheap horror movie or a haunted house, but deflated and empty inside.  It is like an empty costume moving on its own.  The limbs flop around some as it moves, the padded, oversized feet dragging against the ground.  The sculpted werewolf face is well-molded and would be quite frightening if it leapt out at you.  But having more life than a mere costume, the expression changes as it snarls at you, moving in to strike at you.";
...
When Play begins:
	...
	now str entry is 10;			[ The player's stats will move towards these values through infection. ]
	...
	if bodyname of player is "Werewolf Costume":
		...
		otherwise:
			...
			if facename of player is "Werewolf Costume" and skinname of player is "Werewolf Costume" and tailname of player is "Werewolf Costume":
				if cunts of player > 0:
					say "     Working through an agency, you manage to land a gig to act as the werewolf in a cheap horror movie.  The actress wearing you makes a good partner and is a competent character actress on her own, but working together, you make an excellent team.  The movie, despite its cheeziness, does well because of the monster scenes and a series of sequels are made.  Some are even an improvement on the first.  While she was nervous with you at first, after a few days of shooting, she becomes good friends and your relationship lasts for years to come.  She even starts to accept your sexual needs, consenting to wearing you for sex.  Together, you make out with your regular lovers, several of the cast and even some fans who want to [']get to know the monster better.['].  These romps are quite enjoyable for you both[if cocks of player > 0], and she confesses one day that the sensation of your dick fucking the girls excites her greatly[otherwise] and she cums hard in your suit, soaking your insides with her juices[end if].  You stick together as a couple after your movie series finally ends and even get a few roles in bigger budget movies to supplement your royalties from the franchise.";
				otherwise:
					say "     Working through an agency, you manage to land a gig to act as the werewolf in a cheap horror movie.  The actor wearing you makes a good partner and is a competent character actor on his own, but working together, you make an excellent team.  The movie, despite its cheesiness, does well because of the monster scenes and a series of sequels are made.  Some are even an improvement on the first.  While he was nervous with you at first, after a few days of shooting, he becomes good friends and your relationship lasts for years to come.  She even starts to accept your sexual needs, consenting to wearing you for sex.  Together, you make out with your regular lovers, several of the cast and even some fans who want to [']get to know the monster better.[']  These romps are quite enjoyable for you both and he cums hard in your suit, soaking your insides with his semen.  You stick together as a couple after your movie series finally ends and even get a few roles in bigger budget movies to supplement your royalties from the franchise.";
			otherwise:
