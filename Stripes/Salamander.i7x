...
to salabind:
	...
	while trixieexit is 0:
		...
		if lustatt > 99:
			if boundsegment is 1:
				...
				if enduring is true and struggleatt > 0:
					...
					say "     [if tempnum2 is 1]She seems eager to return her victim back within her heated prison of flesh[else if scalevalue of player is 3]She doesn't seem to care that you're around her size, apparently stretchy enough to accommodate you[otherwise]It becomes quickly apparent that she's stretchy enough to engulf you within her depths without any difficulty[end if]. Though she seems to be reducing her body heat, she's still terribly hot enough to make you sweat, mixing with her saliva in slicking her motion as she shoves you down, foot by foot, gullet bulging considerably with its contents, until only your legs remain.";
					say "     Forced into the monster's tight, sticky stomach, it's alight with a[if tempnum2 is 1] familiar,[end if] molten glow, radiating an intense against your vulnerable form. As she forces down what little remains of you, you're forced to curl up to fit within these extremely tight confines. Even though she's apparently flexible enough to contain you, these walls nonetheless cling tightly against you, loudly churning as she [if tempnum2 is 1]teases her constantly-struggling meal[otherwise]climbs back to her feet to take her new meal to a safe place[end if].";
		...
		if boundsegment is 1:
			...
			say "     You're tethered to the salamander by her long, adhesive tongue, who doesn't seem intent on letting you go anytime soon! [if struggleatt is 0]She's practically kissing you, she so close to you right now.[else if struggleatt is 1]There's very little distance between you and her.[else if struggleatt is 2]There seems a reasonable amount of distance between you and her.[otherwise]She's straining to keep a hold of you, you're nearly free![end if] You imagine your only active option is to [bold type]S[roman type]truggle enough until they let you go, else you can [if obliging is true][bold type]O[roman type]blige[otherwise][bold type]A[roman type]bide[end if] them, or [if boundrecover is true][bold type]R[roman type]ecover from[otherwise][bold type]E[roman type]ndure[end if] these questionable circumstances.[line break]";
		...
		if humanity of player < 1:
			...
			if keychar in lower case exactly matches the text "s" or keychar in lower case exactly matches the text "1" or keychar in lower case exactly matches the text "return" or keychar in lower case matches the text "struggle":
				...
				if boundsegment is 0:
					if struggleatt < 4 :
						say "     You strain to pull yourself away from the [one of]salamander[or]amphibian[at random], who tries to pull back. You manage to get [if struggleatt is 1]some[else if struggleatt is 2]more[otherwise]a lot of[end if] distance from her.";
				...
				if obliging is true:
					if boundsegment is 0:
						...
						say "     You actively allow the [one of]salamander[or]amphibian[at random] to [if struggleatt is -2]finish you off[otherwise]pull you in close[end if]";
						if struggleatt < 0:
							...
							say ", [if struggleatt is 0]who's practically kissing you by this point[otherwise]who's quickly closing the distance between the two of you[end if].";
					else:
					...
					if boundsegment is 0:
						...
						if struggleatt < 0:
							...
							say ", [if struggleatt is 0]who's practically kissing you by this point[else if struggleatt is 1]who's quickly closing the distance between the two of you[otherwise]who's gradually closing the distance between the two of you[end if].";
					else:
				...
				if boundrecover is true:
					if boundsegment is 0:
						...
						if struggleatt < 0:
							say ". However, this distraction allows her to [if struggleatt is -1]finish you off[otherwise]pull you in close enough[end if], grabbing you between your shoulders and firmly plunging your head[if tempnum2 is 1] back[end if] down her wide maw.";
							say "     [if tempnum2 is 1]She seems eager to return her victim back within her heated prison of flesh[else if scalevalue of player is 3]She doesn't seem to care that you're around her size, apparently stretchy enough to accommodate you[otherwise]It becomes quickly apparent that she's stretchy enough to engulf you within her depths without any difficulty[end if]. Though she seems to be reducing her body heat, she's still terribly hot enough to make you sweat, mixing with her saliva in slicking her motion as she shoves you down, foot by foot, gullet bulging considerably with its contents, until only your legs remain.";
							say "     Forced into the monster's tight, sticky stomach, it's alight with a[if tempnum2 is 1] familiar,[end if] molten glow, radiating an intense against your vulnerable form. As she forces down what little remains of you, you're forced to curl up to fit within these extremely tight confines. Even though she's apparently flexible enough to contain you, these walls nonetheless cling tightly against you, loudly churning as she [if tempnum2 is 1]teases her constantly-struggling meal[otherwise]climbs back to her feet to take her new meal to a safe place[end if].";
							now tempnum2 is 0;
							now struggleatt is 0;
							...
							if tempfixture is 1:
								say ". It doesn't seem to stop the [one of]salamander[or]amphibian[at random] from pulling you closer, though, [if struggleatt is 0]who's practically kissing you by this point[else if struggleatt is 1]who's quickly closing the distance between the two of you[otherwise]who's gradually closing the distance between the two of you[end if].";
							else:
					...
					if boundsegment is 0:
						...
						if struggleatt < 0:
							say ". However, it's not enough to stop her from [if struggleatt is -1]finishing you off[otherwise]pulling you in close enough[end if], grabbing you between your shoulders and firmly plunging your head[if tempnum2 is 1] back[end if] down her wide maw.";
							say "     [if tempnum2 is 1]She seems eager to return her victim back within her heated prison of flesh[else if scalevalue of player is 3]She doesn't seem to care that you're around her size, apparently stretchy enough to accommodate you[otherwise]It becomes quickly apparent that she's stretchy enough to engulf you within her depths without any difficulty[end if]. Though she seems to be reducing her body heat, she's still terribly hot enough to make you sweat, mixing with her saliva in slicking her motion as she shoves you down, foot by foot, gullet bulging considerably with its contents, until only your legs remain.";
							say "     Forced into the monster's tight, sticky stomach, it's alight with a[if tempnum2 is 1] familiar,[end if] molten glow, radiating an intense against your vulnerable form. As she forces down what little remains of you, you're forced to curl up to fit within these extremely tight confines. Even though she's apparently flexible enough to contain you, these walls nonetheless cling tightly against you, loudly churning as she [if tempnum2 is 1]teases her constantly-struggling meal[otherwise]climbs back to her feet to take her new meal to a safe place[end if].";
							now tempnum2 is 0;
							now struggleatt is 0;
							...
							if tempfixture is 1:
								say ". Sadly it does not seem to succeed as you're inched forward, [if struggleatt is 0]to the point that she's practically kissing you by this point[else if struggleatt is 1]quickly closing the distance between the two of you[otherwise]who's gradually closing the distance between the two of you[end if].";
							else:
...
to say salastrugglebar:
	if boundsegment is 0:
		...
		say "< [bracket]-[if struggleatt > 0]X[otherwise]-[end if][close bracket]";
