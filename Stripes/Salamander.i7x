...
to salabind:
	...
	while trixieexit is 0:
		...
		say "Sanity: [humanity of player]/ 100	Lust: [lustatt]/100	Hunger: [hunger of player]	Thirst: [thirst of player]	Struggle: [salastrugglebar][run paragraph on]";
				...
				otherwise:
					if boundsegment is 0:
						...
						if struggleatt < 0:
							...
							now boundsegment is 1;
						otherwise:
							say ", [if struggleatt is 0]who's practically kissing you by this point[otherwise if struggleatt is 1]who's quickly closing the distance between the two of you[otherwise]who's gradually closing the distance between the two of you[end if].";
					otherwise:
			...
			otherwise:
				...
				if boundrecover is true:
					if boundsegment is 0:
						...
						otherwise:
							if tempfixture is 1:
								say ". It doesn't seem to stop the [one of]salamander[or]amphibian[at random] from pulling you closer, though, [if struggleatt is 0]who's practically kissing you by this point[otherwise if struggleatt is 1]who's quickly closing the distance between the two of you[otherwise]who's gradually closing the distance between the two of you[end if].";
							otherwise:
				...
				otherwise:
					if boundsegment is 0:
						...
						otherwise:
							if tempfixture is 1:
								say ". Sadly it does not seem to succeed as you're inched forward, [if struggleatt is 0]to the point that she's practically kissing you by this point[otherwise if struggleatt is 1]quickly closing the distance between the two of you[otherwise]who's gradually closing the distance between the two of you[end if].";
							otherwise:
...
to say salastrugglebar:
	if boundsegment is 0:
		say "[if struggleatt is 3]<< X[end if][if struggleatt is 2]X[otherwise if struggleatt > 2]~[end if][if struggleatt is 1]X[otherwise if struggleatt > 1]~[end if][if struggleatt is 0]X[otherwise if struggleatt > 0]~[end if] [italic type][bracket]--[close bracket][roman type]";
	otherwise:
