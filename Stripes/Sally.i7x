...
to say sexwithSally:
	...
	if lastSallyfucked - turns < 6:
		...
		if Player is male:
			...
			say "[line break]     [bold type]Do you feel like enjoying her pussy or her cock this time?[roman type][line break]";
...
to say sallycock:
	...
	if lust of Sally < 5:
		...
		now lust of Sally is 1;
	if lust of Sally is:
		-- 1:				[big human]
			say "     As you ride her shaft, you can feel it changing inside you. It swells and grows, taking on a more human form, but wonderfully huge and filling, stretching your insides tightly and filling you with pleasure. You ride her swollen meat, finding it just the right size to overstuff you just enough to be wonderfully stimulating, panting and moaning against Strain of containing it. You savor the delight of having such a big cock in you; it is just what your body craves right now. When she finally cums, her seed blasts deep inside you, sending shivers through your body as you orgasm as well. She yips and barks excitedly, husky tail wagging frantically, happy to have pleased her master.[impregchance]";
...
This is the Sally's Epilogue rule:
	if HP of Doctor Matt is 104:						[Sally the slutpet]
		...
		if humanity of Player < 10:
			...
			say "     [if Player is male and Player is not sterile]You pound into her long and hard, somehow able to give her a night of wild sex that doesn't end until the sun is coming up. A few months later, her tummy starts to show, becoming pregnant with the first of many litters of huskybunny herms. These creatures, like their mother[else if Player is impreg_ok]She pounds you long and hard, filling you again and again with her pent-up seed until you can no longer contain any more and it just keeps pouring out, and keeps fucking even after that point. Your long, lustful night of wild sex doesn't end until the sun comes up. A few months later, your tummy starts to show, becoming pregnant with the first of many litters of huskybunny herms. These creatures, like their father[else]She pounds you long and hard, filling you again and again with her pent-up seed until you can no longer contain any more and it just keeps pouring out, and keeps fucking even after that point. Your long, lustful night of wild sex doesn't end until the sun comes up. Being shared around often, you smile happily as her belly starts to swell with the first of many litters of huskybunny herms. These creatures, like their mother[end if], are lustful and obedient, making wonderful fucktoys. After some careful [']training['], these beautiful sexpets fetch a high price from rich buyers.";
