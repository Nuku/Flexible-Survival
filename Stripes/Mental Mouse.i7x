...
to say mousedesc:
	choose row with name of "Mental Mouse" in Table of Random Critters;
	...
	if level of Player > 4:
		say "     As the mice draw nearer, there is a rustling behind you as another of these mice pops up behind you[if lev entry is 6 or lev entry is 7], and another[else if lev entry > 7], and then a few more start popping up from all around[end if]. With reinforcements now, this [if lev entry < 6]quartet of[else if lev entry < 21]group of [ ( lev entry / two ) + one ][else]large group of[end if] mice move in to forcibly welcome you as member of this strange mouse-collective.";
...
to say losetomouse:
	...
	if Player is male:
		if Cock Length of Player > 12:
			say "     [if mouse girl is tamed]Rachel, with her paws already stroking your cock, sets herself to licking and kissing along your large length. After some playful teasing, she moves into position to take your huge member into her small pussy. You run your hands over her, helping her to press down onto it. She groans and squeaks, her belly bulging considerably as your penis is stuffed into the three foot tall mouse[else]Another of the mice, with her paws already stroking your cock, sets herself to licking and kissing along your large length. Too large for her to take in, she instead works her tongue and lips over it, working to please you in that way. Paws, probably hers, grope and stroke your penis and balls, enticing you to greater levels of arousal[end if].";
		else:
	...
	if BodyName of Player is "Mental Mouse" or mousecurse is 1:
		...
		if mouse girl is tamed:
			if mouse girl is not listed in companionList of Player:
				AddCompanionFunction "mouse girl";
				say "[line break]     Rachel is once again at your side, accompanying you through the city as your companion and you feel yourself becoming closer to her and the mouse collective.";
		...
		if HP of Player < 1, decrease humanity of Player by a random number between 1 and 2;
		if "Strong Psyche" is listed in feats of Player, increase humanity of Player by a random number between 0 and 1;
		if "Weak Psyche" is listed in feats of Player, decrease humanity of Player by a random number between 0 and 1;
	else:
...
to say beatthemouse:
	...
	if mousevic > 2 and a random chance of 1 in 3 succeeds:
		if mouse girl is listed in companionList of Player:
			say "     You manage to defeat and drive off the mice. As they leave, they squeak, 'You should not resist us. You have been chosen to be among the mouse collective. None will ever love you as we can.' You rub your aching head, the proximity to these strange mice leaving you a little worn. You do spot a stray mouse dazed from the battle and left behind. Her short, sexy body is spread out across the ground, on display for you. Rachel, moving up beside you, runs her paw over your body. You feel excited at the prospect of playing with the prone mouse and move in to take advantage of the opportunity.";
		else:
			say "     You manage to defeat and drive off the mice. As they leave, they squeak, 'You should not resist us. You have been chosen to be among the mouse collective. None will ever love you as we can.' You rub your aching head, the proximity to these strange mice leaving you a little worn. You do spot a stray mouse dazed from the battle and left behind. Her short, sexy body is spread out across the ground, on display for you.";
			say "[line break]     [bold type]Shall you take advantage of this opportunity?[roman type][line break]";
		...
		say "     You manage to defeat and drive off the mice. As they leave, they squeak, 'You should not resist us. You have been chosen to be among the mouse collective. None will ever love you as we can.' You rub your aching head, the proximity to these strange mice leaving you a little worn. Trying to shield your mind as best you can from the scurrying thoughts of the mice, you head quickly on your way.";
	else:
		say "     You manage to defeat and drive off the mice. As they leave, they squeak, 'You should not resist us. You have been chosen to be among the mouse collective. None will ever love you as we can.' You rub your aching head, the proximity to these strange mice leaving you a little worn. You gather your thoughts and head quickly on your way.";

Section 2 - Creature Insertion

Table of CombatPrep (continued)
name(text)	PrepFunction(text)
"Mental Mouse"	"[PrepCombat_Mental Mouse]"

to say PrepCombat_Mental Mouse:
...
When Play begins:
	...
	now Species Name entry is "Mental Mouse"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now cock change entry is "it becomes human-like in form, with light-pink flesh and sheathless";
	now str entry is 14;
	now dex entry is 15;
	now sta entry is 8;
	now per entry is 10;
	...
	now MilkItem entry is "mental mouse milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "mental mouse cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
this is the mentalmouse rule:
	...
	if a random chance of 5 in 8 succeeds:	[normal]
		...
		if monsterhit is true:
			let rangenum be 120 + lev entry;
			if mousecurse is 1, increase rangenum by 20;
			let dam be ( wdam entry times a random number from ( ( 80 - ( peppereyes * 5 ) ) ) to rangenum ) / 100;
			if HardMode is true and a random chance of 1 in ( 10 + peppereyes ) succeeds:
				now dam is (dam * 150) divided by 100;
				say "The enemy finds a particular vulnerability in your mental defenses - [italic type]Critical Hit![roman type][line break]";
...
An everyturn rule:
	if BodyName of Player is "Mental Mouse" and a random number between -20 and 120 > humanity of Player:
