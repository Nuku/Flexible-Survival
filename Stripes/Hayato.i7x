...
to say onilairassault:
	...
	say "     Hearing you threatened, something snaps in Hayato and he growls. 'No, this is my friend. You will not harm [if cunts of player > 0]her[else]him[end if], or anyone!' And with that, he's charging forward, club raised. You rush to join him in battle, each taking on one of the guards.";
	[***]
	...
	if fightoutcome >= 10 and fightoutcome <= 19:				[WIN]
		...
		say "     Seeing you done with your foe, your companion slaps the oni's ass. 'Nggg. Get over here and [if cocks of player > 0]stuff this fool's mouth[else]put this fool's mouth to use[end if].' The sight of Hayato allowing himself to let loose and take a dominant role is quite arousing.";
		...
		if the player consents:
			if cocks of player > 0:
				...
				say "     This release of Hayato's inner oni leads to quite the powerful release from the big guy, his over-sized balls pulsating as they unleash blast after blast of thick semen into his foe. When this causes the oni between you to cum as well (his load barely half what Hayato can produce), Hayato mocks him again for being a weak slut before grabbing your head and pulling your face forward into a forceful kiss. His tongue delves into your mouth and this last thing is enough to push you over the edge into orgasm, feeding your hot [cum load size of player] load down the demon ogre's throat. When you're all finished, the oni beneath you is left too worn out from his struggles and the buggering and passes out.";
			else:
				LineBreak;
			...
			LineBreak;
			say "     Hayato gives a bit of a growl when you don't come over to join him and focuses his disappointment into fucking him fallen foe all the harder. Grabbing him by one of the horns, the demon ogre's made to look at you. 'You see that, scum. [if cunts of player > 0]She[else]He[end if] doesn't even want to have anything to do with a wretch like you.' The defeated guard growls and snarls back even as he's buggered roughly by the more powerful oni. And from the way he's hard and drooling precum steadily, it's clear the creature is more upset about having lost than about the fucking itself.";
			...
			say "     This release of Hayato's inner oni leads to quite the powerful release from the big guy, his over-sized balls pulsating as they unleash blast after blast of thick semen into his foe. When this causes the oni between you to cum as well (his load barely half what Hayato can produce), Hayato mocks him again for being a weak slut before grabbing your around the waist and pulling you into a forceful kiss. His tongue delves into your mouth even as he floods his foe's ass with his hot load. Once the victorious oni's done and pulled his cock free, the oni beneath him is left too worn out from his struggles and the buggering and passes out.";
