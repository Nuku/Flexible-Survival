...
Instead of conversing the Hayato:
	...
	else if hp of Hayato is 21 and ( cocks of player > 0 or cunts of player > 0 ) and a random chance of 1 in 3 succeeds:
...
to say sexwithHayato:
	if hp of Hayato < 6:
		...
		say "     You take in Hayato's muscular form, your longing to do more than look growing. Unfortunately, until you retrieve the [bold type]noh mask[roman type] that Nermine wants, you won't be able to get at the red-skinned hunk's locked-up junk. You'll need to head over to the College Campus and [if hp of Hayato is 11]try to locate it[otherwise]deal with the creatures in your way[end if].";
...
to say hayatosex4:
	...
	if libido of hayato is even:
		...
		say "     Taking his cock in hand again, you get him lined up and tell him to stick it in you. Having gotten yourself quite worked up for it, when he starts slow, you don't want to wait. Giving his large length a tug while pulling him forward with your legs around his strong sides, you growl that you told him to stick it in you. Obediently, he doesn't hold back and thrusts firmly into you, driving a good portion of his impressive manhood into you. You cry out in delight and grind over his red rod, demanding more - a request he's eager to fulfill, pumping until it all is filling you full.";
		say "     Each thrust of that mighty cock has you [one of]moan[or]groan[or]whimper[or]cry out[at random], your inner walls squeezing around it in over-stretched ecstasy. He has an expression of lustful delight that you can clearly read upon his fearsome face - and you can't help but feel a swell of pride[if cocks of player > 0] (and of your cock[smn])[end if] at the knowledge that you introduced him to such pleasures. These thoughts drive you to push him to orgasm by working your hips and wet hole around his crimson rod while pulling him harder into every thrust.";
		say "     When it all becomes too much for the [if lust of Hayato + libido of Hayato < 5]inexperienced [end if]oni, he grabs the desk with his claws hands. You can hear the scrape of his claws and the cracking of cheap wood along with his climactic growl as he unleashes his hot seed into your stuffed asshole. Liquid heat pours into your rectum and floods your bowels as his hefty balls deliver their heavy load unto you. The constant pulsing throbs of his spurting shaft and the hot flow of his semen [if cocks of player > 0]sends you over the edge and you cum as well, spraying your gooey [cum load size of player] load across your front[otherwise]has you moaning and squirming in delight[end if]. By the time he's drained, your belly feels full and warm with his load. You run a hand over your [if scalevalue of player < 4]stretched[otherwise]full[end if] tummy as you unlock your legs and let your spent lover stumble to the ground with a sigh of sexual satisfaction. You reach down and lightly stroke his thick rod, telling him what a fine job he did.[mimpregchance]";
...
to say onilairassault:
	...
	if fightoutcome >= 10 and fightoutcome <= 19:				[WIN]
		...
		say "     Seeing you done with your foe, your companion slaps the oni's ass. 'Nggg. Get over here and [if cocks of player > 0]stuff this fool's mouth[otherwise]put this fool's mouth to use[end if].' The sight of Hayato allowing himself to let loose and take a dominant role is quite arousing.";
