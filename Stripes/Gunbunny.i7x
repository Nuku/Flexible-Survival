...
When Play begins:
	...
	now face entry is "very human, save for the set of [if HP of doctor matt >= 12 and HP of doctor matt < 100]white[else if hospquest < 14]gray[else]black[end if] bunny ears atop your head. Your face is [if cunts of player > 0]pretty and effeminate[else]girlish[end if] with a cute, if slightly bucktoothed smile";
	...
	now type entry is "[one of]lapine[or]bunny-[if cunts of player > 0]girl[else]boy[end if][as decreasingly likely outcomes]";
		...
		if humanity of player < 10:
			if player is pure:
				if pistol is owned:
					...
					say "     With caution forgotten, you fire several shots, first into the air and then into various targets. You're soon picking off smaller and more distant objects as you quickly get a feel for the rifle and find your aim with it. You giggle again, sling the rifle over your shoulder and start searching the rest of the scattered gear, gathering up a bunch of it[if cunts of player > 0]. You even make yourself a ragged camo bikini from some of the scraps around you[else]. You even pull on a pair of torn camo pants that are now little more than ragged shorts[end if]. Thus equipped, you head off into the city as another crazy, gun-totting bunny.";
			else:
				if pistol is owned:
			...
			if player is pure:
				...
				if HP of doctor matt >= 12 and HP of doctor matt < 100:
					...
					if level of player >= 16:
						...
						say "     A rush of excitement runs through you and you can't help but giggle a little. This gun just feels so right in your paw-hands that intuitively know how you power it up and charge back into the fray with renewed vigor. You end up leading a counterattack by your remaining squadmates and send the centaurs scattering after a few volleys of searing energy take down the lead equines. You and your squad chase down a few stragglers to make sure they know not to mess with Zephyr again before returning to secure the transport. Once it's all said and done, you get a nice bonus out of it as well as the gratitude of the engineer.";
						say "     And while you have to reluctantly return to prototype energy rifle, the tech arranges to get you a new one of your very own a couple months later - the first of the production models. You thank her heartily for it with a big kiss that turns into a romp right there in her lab[if cocks of player > 0], leaving her with a bunny bun in the oven[end if]. Your squad ends up working with her regularly, always getting the newest tech from her division to play with. And your budding relationship with her continues as well, soon becoming a couple and moving in together.";
