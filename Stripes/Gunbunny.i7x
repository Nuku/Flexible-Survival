...
When Play begins:
	...
	now Species Name entry is "Bunny"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now MilkItem entry is "gunbunny milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "gunbunny cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	...
	now Cross-Infection entry is ""; [ Infection that this infection will give the player when they lose; can be left empty if they infect with the monster's own strain. ] [***temporary]
...
this is the gb_gat_down rule:		[odds go down if she hits normally]
	if HP of Player > 0:
		...
		say "[one of]The bunny girl[or]The gunbunny[or]She[or]The gun-toting rabbit[or]The rabbit-eared girl[at random] [one of]cheers at her own success[or]gives a happy 'Yatta!' at having hit you[or]sticks out her tongue and makes a face at you[or]makes the [']V-for-Victory['] sign at her success[or]giggles and taunts you[or]calls you 'Baka!' for getting hit[at random]. By this point, you're too weak to keep going and collapse to the ground.";

this is the gb_gat_up rule:			[miss message and gatling odds go up]
	say "[one of]The bunny girl[or]The gunbunny[or]She[or]The gun-toting rabbit[or]The rabbit-eared girl[at random] [one of]fires a volley of wild shots[or]fires at you with her [if gb_gun > 3]gun[else]guns[end if][or]giggles wildly as she chases after you with a stream of [if gb_gun < 6]bullets[else]laser blasts[end if][or]performs an acrobatic leap that has her flip upside down while ten feet in the air, firing shots all around you before landing with a superfluous jiggle of her breasts[or]dashes from side to side while shooting nearly constantly[at random]. [one of]You barely manage to avoid getting shot by diving to the ground and rolling into cover[or]You narrowly escape getting hit[or]You run in and out of cover as the gun-crazy creature chases you to avoid getting hit[or]You crouch behind some cover as everything around you is [if gb_gun is 6]scorched by her blaster[else]filled with bullet holes[end if][or]You weave and dodge ahead of her shots, [if gb_gun is 6]black burns on the ground from laser fire[else]bullet holes[end if] chasing after you, but never quite catching you[at random].";
...
[	say "DEBUG: Gatling counter = [gb_gatling_counter]."; [***]	]
	if gb_gatling_chance >= 50:
		...
		say "[one of]The bunny girl[or]The gunbunny[or]She[or]The gun-toting rabbit[or]The rabbit-eared girl[at random] eventually has to stop shooting long enough to [if gb_gun is 6]give her space gun a chance to recharge[else]reload[end if], giving you a chance to do something.";
