...
Instead of resolving a Shipping Container:
	...
	say "     Shall you try opening up the container?";
	if the player consents:
		if guy is banned and girl is banned:
			say "     You pull and pry at the handles to the steel container, but you can't get it to open.  Frustrated, you bang the clipboard against the door a few times.  You then notice a note written on next page of the shipping manifest stating: [']Contents locked by simulaneous use of both guy and girl flags.[']  You're not quite sure what that means, but it seems the container's locked.  Maybe some other time.";
		otherwise:
			now latexhuskymode is true;
			say "     It takes a bit of effort to push open the latches locking the overturned container, but eventually manage to do so by banging noisily to force the last one.  When you do so, the doors flap open and several carboard boxes tumble out onto you.  Thankfully the boxes aren't that heavy, but the contents spill out.  Hundreds of little, rubber, dog figurines pour out, inundating you in little latex huskies in various poses.  Realizing too late what the contents are and that the manifest meant 160 boxes of them, you grumble in frustration, trying to pull yourself free of the shifting mass of two inch figurines and half-empty boxes, but struggling to find footing when every move you make seems to send another box of them over you.";
			if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
			if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
			say "     You pause to think of a way out of this before you're completely buried in cheap, kitschy cuteness.  And that is when you spot a black mass sliding across the ground from between two buildings.  Startled, you try to move only to be swamped again with another way of huskies.  The dark goo, probably drawn by the noise of you opening the container, moves closer and eventually flows into the pile of figurines.  Deciding to at least try to escape, you try swimming through the growing mass of huskies as you seek to get away.";
			say "     Finally managing to pull yourself to the edge, you pull your upper body out of the pile but find that the black goo, now streaked with white, has attached itself to you and is climbing up your body.  Tendrils from its form lash out, attaching to your wrists and clinging to your back, keeping you from escaping.  Your lower limbs start to tingle as you can feel them changing, sending you to the pavement.  As the rubbery mass, bloated from consumed figurines continues to spread over you, you can feel a strange, enjoyable, even arousing senstation spreading through your body.";
			if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
			if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
			say "     As it spreads over your hips, you can feel its flowing and rubbing against your groin[if cocks of player > 1].  The cool, latex goo grips your cocks, stroking and squeezing them, making you release a moan of pleasure[otherwise if cocks of player is 1].  The cool, latex goo grips your cocks, stroking and squeezing them, making you release a moan of pleasure[end if][if cunts of player > 1].  The flowing mass rubs against your pussies before slipping thick tendrils into you, stuffing your cunts full and pumping into them in a wonderfully pleasant manner[otherwise if cunts of player is 1].  The flowing mass rubs against your pussy before slipping a thick tendril into you, stuffing your cunt full and pumping into it in a wonderfully pleasant manner[end if].  You can feel the press of the goo at your anus, spreading it open and stuffing your backside with a thrusting, pulsing mass of latex slime that feels increasingly enjoyable.  As it pounds into you, a big, curved tail balloons out from the base of your spine.";
			...
			if ( "Female Preferred" is listed in feats of player and girl is not banned ) or guy is banned:
				choose row monf from table of random critters;				now breasts entry is 6;
				now breast size entry is 3;
				now cunt length entry is 12;
				now cunt width entry is 6;
