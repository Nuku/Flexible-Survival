...
to say ResolveEvent Shipping Container:
	...
	say "[line break]     [bold type]Shall you try opening up the container?[roman type][line break]";
	...
	if Player consents:
		...
		if MaleList is banned and FemaleList is banned:
			...
			say "     Finally managing to pull yourself to the edge, you pull your upper body out of the pile but find that the black goo, now streaked with white and gray, has attached itself to you and is climbing up your body. Tendrils from its form lash out, attaching to your wrists and clinging to your back, keeping you from escaping. Your lower limbs start to tingle as you can feel them changing, sending you to the pavement. As the rubbery mass, bloated from consumed figurines continues to spread over you, you can feel a strange, enjoyable, even arousing sensation spreading through your body.";
			WaitLineBreak;
			say "     As it spreads over your hips, you can feel its flowing and rubbing against your groin[if Cock Count of Player > 1]. The cool, latex goo grips your cocks, stroking and squeezing them, making you release a moan of pleasure[else if Player is male]. The cool, latex goo grips your cock, stroking and squeezing it, making you release a moan of pleasure[end if][if Cunt Count of Player > 1]. The flowing mass rubs against your pussies before slipping thick tendrils into you, stuffing your cunts full and pumping into them in a wonderfully pleasant manner[else if Player is female]. The flowing mass rubs against your pussy before slipping a thick tendril into you, stuffing your cunt full and pumping into it in a wonderfully pleasant manner[end if]. You can feel the press of the goo at your anus, spreading it open and stuffing your backside with a thrusting, pulsing mass of latex slime that feels increasingly enjoyable. As it pounds into you, a big, curved tail balloons out from the base of your spine.";
