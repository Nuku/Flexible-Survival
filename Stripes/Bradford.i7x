...
to say alphaHuskyBounty:
	say "     'Giant huskies have beein goin['] around causin['] havok, forcing people to join their packs whether they like it or not, and after gettin['] infected most do. Puttin['] some in line might help in makin['] em all be less bold in the future.'";
...
to say spidergirlBounty:
	say "     'Mall security's gettin['] tired of losin['] maitenance men down in the sewers. Says they keep gettin['] trapped up by some spiders down there. Might help if you could encourage the creepers to find a new home.";
...
to say sexwithBradfordWall: [fucked in the ass against a wall]
	...
	WaitLineBreak;
	say "     Pinned against the wall with your hands flat on the hard surface, you could only pant softly as Bradford took his time, sawing his ten-inch shaft back and forth until he finally pushes it in with a low grunt. And with a quick thrust he was hilted inside of you, all ten inches throbbing hotly for a moment, before he begins to thrust in earnest. In no position to resist, all you can do is moan as he pounds into your accommidating hole, each push sending a pleasurable shudder through your whole body.";
	say "     Amidst the thorough pounding Bradford was giving you from behind, you suddenly feel a calloused hand brush against your thigh, and making it's way between your legs. [if player is purefemale]Pressed against the wall, you aren't able to look down as his fingers touch your dripping slit, another moan escaping your already lips. It's not long after the initial teasing that he's sunk two fingers inside, casuing another moan to escape your already parted lips, every thrust of his fingers moving in time with that thick cock fucking your ass[else] Shoved against the wall, you aren't able to look down as his fingers touch your your already drooling cock, your own shaft already plastering the wall with sticky pre. Hand firmly wrapped around your leaky length he begins to stroke in time with every thrust, coaxing another moan out of your already parted lips[end if].";
	WaitLineBreak;
