...
Instead of resolving Bounty Hunter:
	...
	say "     Crossing the street, he enters another storefront and leads up into what was formerly a second floor accounting office.  While straining to look professional, the former businessplace is clearly cheap and trashy.  The office furniture is old and mismatched, and the walls are covered in ad posters to have your taxes done and claims about big returns.  Given the neighbourhood, that's unsurprising.";
	attempttowait;
...
to say sexwithBradford01:		[vaginal - lap ride]
	...
	say "     The sight of his bovine shaft gets you all the more excited.  You straddle his lap and grind your [cunt size desc of player] pussy down atop it.  You love the warm feel of it and how it pulses and throbs with need at your touch.  After this little bit of teasing[if breast size of player > 3], during which he bares your chest and starts fondling your boobs[end if], you lower yourself [if cunt length of player < 4]slowly down onto the pulsing rod.  Given the size of his manhood, you really have to take your time to start, enduring the ache of stuffing yourself until that fades and the pleasure rises to replace it[otherwise if cunt length of player < 7]gradually down onto the pulsing rod.  Given the size of his manhood, you have to take your time to start, but it is deliciously satisfying for the added effort[otherwise if cunt length of player > 18]with ease down onto the pulsing rod.  Given the size of your spacious cunt, you have little difficulty taking the bull's thick shaft, letting you jump right into action[otherwise]down onto the pulsing rod.  His enlarged cock stuffs you nice and full for a satisfying fit that has you moan with pleasure as you take it into you[end if].";
	attempttowait;
