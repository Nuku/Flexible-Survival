...
When Play begins:
	...
	now Species Name entry is "Vixentaur"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Vixentaur" to infections of VulpineList;
	...
	now MilkItem entry is "vixentaur milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "vixentaur cum"; [ Item to be given to the player if they have this infection and jerk off. ]
