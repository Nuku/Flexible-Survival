...
to say gunbunnydesc:
	...
	say "     You find yourself confronted by an anime-style bunny girl. She's got the typical human head and body and is dressed in [one of]a tight top, super-short skirt and striped knee-socks[or][if gb_gun is 6]a form-fitting space suit[otherwise]a camo jumpsuit[end if][or]a bikini[or]a navy-blue school outfit[or]a skin-tight black leotard[or]a cute t-shirt skirt[in random order] that shows off her sexy bust. Her hair is [if gb_hair is 1]pink[else if gb_hair is 2]yellow[else if gb_hair is 3]green[else if gb_hair is 4]blue[else if gb_hair is 5]red[else if gb_hair is 6]black[else if gb_hair is 7]white[otherwise]teal[end if] with matching coloured rabbit ears sticking out of it. She's wearing similarly coloured paw-like gloves.";
	say "     Her large, expressive eyes watch you carefully as one hand slips behind her back. From somewhere around her fluffy [if gb_hair is 1]pink[else if gb_hair is 2]yellow[else if gb_hair is 3]green[else if gb_hair is 4]blue[else if gb_hair is 5]red[else if gb_hair is 6]black[else if gb_hair is 7]white[otherwise]teal[end if] bunny tail, she pulls out [if gb_gun is 1]a pair of heavy pistols[else if gb_gun is 2]a pair of SMGs[else if gb_gun is 3]twin six-shooters[else if gb_gun is 4]a shotgun[else if gb_gun is 5]a heavy rifle[otherwise]a sci-fi ray gun[end if]. Now armed and with a [one of]wild look in her eyes[or]crazy laugh[or]girlish giggle[or]untranslatable insult[or]final action pose[at random], she aims and opens fire in a spray of [if gb_gun is 5]laser fire[otherwise]bullets[end if].";
...
When Play begins:
	...
	now tail entry is "You have a cute bunny tail of [if hp of doctor matt >= 12 and hp of doctor matt < 100]white[else if hospquest < 14]grey[otherwise]black[end if] fur attached to your toned bubble butt";
	now cock entry is "[one of][if hospquest < 14]pink[otherwise]black[end if][or]slender[or]human-shaped[as decreasingly likely outcomes]";
	now face change entry is "it shifts and changes. For the most part, you're hopeful you'll come out looking human as your features settle into what becomes a pretty [if cunts of player > 0]and[otherwise]if[end if] girlish face. Your hopes for passing as human are dashed though as you gain a set of tall bunny ears covered in soft [if hp of doctor matt >= 12 and hp of doctor matt < 100]white[else if hospquest < 14]grey[otherwise]black[end if] fur";
...
to gb_gatling_attack:
	...
	if gatling_hit is true:		[hit at least once]
		say "The gun-toting bunny girl empties the last of weapon's clip while laughing happily at your attempts to avoid her fire. Finally, you hear the [if gb_gun is 6][otherwise]whirring and clicking of the gatling having run out of ammo[end if]. She tosses it aside casually and pulls her [if gb_gun is 1]pistols[else if gb_gun is 2]sub-machine guns[else if gb_gun is 3]six-shooters[else if gb_gun is 4]shotgun[else if gb_gun is 5]rifle[otherwise]laser pistol[end if] and [if gb_gun is 6]recharges it[otherwise]reloads[end if].";
		...
		say "The gun-toting bunny girl screams in frustration as she [if gb_gun is 6]drains the blaster completely[otherwise]empties the last of the weapon's clip[end if] and still hasn't managed to hit you. She tosses the heavy weapon and kicks it angrily before pulling her [if gb_gun is 1]pistols[else if gb_gun is 2]sub-machine guns[else if gb_gun is 3]six-shooters[else if gb_gun is 4]shotgun[else if gb_gun is 5]rifle[otherwise]laser pistol[end if] back out and [if gb_gun is 6]recharging it[otherwise]reloading[end if].";
	now gb_gatling_chance is 0;
	now gb_gatling_counter is 0;
	WaitLineBreak;
			...
			if player is pure:
				...
				if hp of doctor matt >= 12 and hp of doctor matt < 100:
					...
					if level of player >= 16:
						...
						say "     A rush of excitement runs through you and you can't help but giggle a little. This gun just feels so right in your paw-hands that intuitively know how you power it up and charge back into the fray with renewed vigour. You end up leading a counterattack by your remaining squadmates and send the centaurs scattering after a few volleys of searing energy take down the lead equines. You and your squad chase down a few stragglers to make sure they know not to mess with Zephyr again before returning to secure the transport. Once it's all said and done, you get a nice bonus out of it as well as the gratitude of the engineer.";
