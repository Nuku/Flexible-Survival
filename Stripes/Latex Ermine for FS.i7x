...
to say losetolatexermine:
	...
	if bodyname of player is "Latex Ermine" and player is pure and (cocks of player > 0 or cunts of player > 0):
		if cocks of player > 0:
			say "     Finding your latex mustelid body to be just what she's looking for, she eventually ends up stretched out on the ground beneath you with her legs spread and her fingers holding her wet folds open.  With such a clear invitation, you grin and line your [cock size desc of player] [cock of player] cock with her pussy and thrust into her.  You both releasing happy moans as her [if cock length of player > 12]latex cunt is stretched wide around your large manhood[otherwise]slick hole takes you easily[end if].  As you pump your [cock of player] penis into her, you are treated to the sexy sight of her [one of]playing with her plump breasts[or]sucking at one of her lovely nipples[or]slowly teasing her clit[at random].  The feel of her slick, squeezing, latex hole around your cock, made for fucking lovely ermines like her, is wonderful.";
