		...
		if the player consents:
			...
			if cocks of player > 0:
				if a random chance of 2 in 3 succeeds:
					...
					say "     In the mood to blow off a little steam after the fight, you stride over to the cute ermine and press her face to your loins. Faced with your [cock size desc of player] [cock of player] cock, she ooos in appreciation and starts licking at it. Her smooth hands stroke your thighs and rub at your ballsac as she takes your [if cock length of player > 24]huge [else if cock length of player > 12]enlarged [end if]shaft into her muzzle[if cock length of player > 12] with ease[end if]. Her slick latex tongue and mouth are a delight as they slide across your [cock of player] manhood, working it with enthusiasm. She grins happily around your meat, sucking you hard while [one of]fingering her juicy cunt[or]playing with her plump breasts[or]teasing her [if erminecolour is 1]blue[else if erminecolour is 2]teal[else if erminecolour is 3]green[else if erminecolour is 4]red[else]pink[end if] nipples[at random].";
