...
to say beatthelatexmistress:
	...
	otherwise:
		...
		if cocks of player is 0:
			say "make her lick your pussy (Y) or let her go (N)?";
...
When Play begins:
	...
	now cock entry is "[if freecred > 1000]gold[otherwise]silver[end if]-studded";
	now face change entry is "black latex starts to bubble up from the base of your neck and flow up over the back of your [one of]skull[or]head[at random]. Though it might seem like it will suffocate you, the black goo that covers over your mouth doesn't seal it shut, but rather becomes fixed around it.  While you can feel that your head is human benath the mask, you cannot, try as you might, manage to pull it off[if player is ltxmskinned], joining itself seamlessly with the latex suit covering your skin[end if]";
	now body change entry is "your body twists and changes, becoming more feminine in form until you have the body of a strong and sexy woman.  Even as these changes spread to your extremities, black goo starts to bubble up from your fingertips and toes, flowing over your hands and feet to coat them in jet black latex.  This latex shapes itself into shapely gloves with [if freecred > 1000]golden studs and clawed fingertips[otherwise if freecred > 50]silver studs and clawed fingertips[otherwise]black clawed fingertips[end if] and similarly decorated boots";
	now skin change entry is "your skin shifts to a more human appearance before being covered in a layer of tight black latex that wells up from your nipples and flows across your skin[if player is ltxmfaced].  As this change spreads up to your neck, it joins with the mask into a united whole[otherwise] and over your shoulders to form a collar at your neck[end if][if player is ltxmtailed].  As it progresses down your body, it blends into and fuses seamlessly with the latex encasing your crotch and ass[end if].  The black goo flows along your limbs, encasing them in the latex skinsuit as well [if player is ltxmbodied]and melding together with your latex gloves and boots into a complete body suit[otherwise] before ending at your ankles and wrists to leave you feet and hands uncovered, the latex sealing into immobile cuffs at your extremities[end if]";
	now ass change entry is "a cold chill runs down your spine as a sudden flow of black latex goo pushes itself out of your [one of]asshole[or]anus[or]pucker[at random] and begins to grow over your [one of]ass[or]cheeks[or]butt[at random]. Wrapping around your hips and loins tightly, it feels as if its replaced you skin.  It forms an opening at your crotch that reveals everything you have to show to the open air and melds into your [one of]asshole[or]anus[or]pucker[at random] to allow access there as well";
	now cock change entry is "your cock shifts, altering back into a more normalized, human shape, covered in black latex. A single [if freecred > 1000]gold[otherwise]silver[end if] stud forms in the middle of your penis, the cool chill of metal quite an interesting sensation[if cunts of player > 0].  Your pussy has a similar coating of black latex that is so form fitting and sensitive that it seems like your own flesh[end if]";
	now str entry is 12;
	now dex entry is 15;
	now sta entry is 14;
	now per entry is 10;
...
Latex Mistress for FS ends here. 