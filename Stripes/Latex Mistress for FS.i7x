...
When Play begins:
	...
	now skin change entry is "your skin shifts to a more human appearance before being covered in a layer of tight black latex that wells up from your nipples and flows across your skin[if player is ltxmfaced]. As this change spreads up to your neck, it joins with the mask into a united whole[else] and over your shoulders to form a collar at your neck[end if][if player is ltxmtailed]. As it progresses down your body, it blends into and fuses seamlessly with the latex encasing your crotch and ass[end if]. The black goo flows along your limbs, encasing them in the latex skinsuit as well [if player is ltxmbodied]and melding together with your latex gloves and boots into a complete body suit[else] before ending at your ankles and wrists to leave you feet and hands uncovered, the latex sealing into immobile cuffs at your extremities[end if]";
