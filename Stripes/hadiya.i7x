...
instead of conversing Hadiya:
	...
	if hp of Hadiya is 0 or hp of Hadiya is 1:
		...
		say "     [one of][if lastfuck of hadiya - turns < 4]'Why are you bothering to stick around when I'm already done with you for now?'[else if lastfuck of hadiya - turns < 12]'How about you come back later and I'll give you what I know you need,' she rumbles, rubbing her crotch.[otherwise]'How about you bring that sexy ass of yours over here and maybe I'll give you what I know you need,' she rumbles, rubbing her crotch.[end if][or]'This pussy and cunt of mine feel nice,' she says, almost teasing you with her touches to them, 'but this new cock of mine is so much better.'[or]'You're turning out to be a fine little fucktoy, aren't you?  Such a good slut.'[or]'You need a good dose of hyena in you, don't you, bitch?' she asks, rubbing her crotch before flopping back onto a padded chair, laughing.[or]She pulls out a bottle of liquor from under a chair and slams down half of it with a satisfied 'Ahhh.'[or]'Turn around and let me see that bitch ass of yours.'[at random]";
	else:
		say "     [one of][if lastfuck of hadiya - turns < 2]'Why are you bothering to stick around when I'm already done with you for now?'[else if lastfuck of hadiya - turns < 6]'How about you come back later and I'll give you what I know you need,' she rumbles, rubbing her crotch.[otherwise]'How about you bring that sexy ass of yours over here and maybe I'll give you what I know you need,' she rumbles, rubbing her crotch.[end if][or]'This pussy and cunt of mine feel nice,' she says, almost teasing you with her touches to them, 'but this new cock of mine is so much better.'[or]'You're turning out to be a fine little fucktoy, aren't you?  Such a good slut.'[or]'You need a good dose of hyena in you, don't you, bitch?' she asks, rubbing her crotch before flopping back onto a padded chair, laughing.[or]She pulls out a bottle of liquor from under a chair and slams down half of it with a satisfied 'Ahhh.'[or]'Turn around and let me see that bitch ass of yours.'[or]Hadiya picks away at her guitar for a bit, playing it tunelessly[if findwires is 2 and fixedgens is 2] with the power off[end if].[or]You try to chat with Hadiya for a bit, but she's not really paying attention to you. She's more interested in having her goblin plaything lick her sheath and balls.[or]'This place sure beats living in a dump. I knew you'd be good for something,' she laughs.[at random]";
...
to say sexwithHadiya:
	...
	else if lastfuck of Hadiya - turns is less than 12 and ( hp of Hadiya < 13 or ( hp of Hadiya >= 50 and hp of Hadiya < 63 ) ):
		say "She just grins at you. 'Eager to be fucked more, are you?  Too bad, I'm busy now. Come back later.'";
	else if lastfuck of Hadiya - turns is less than 6:
		say "She just grins at you. 'Eager to be fucked more, are you?  Too bad, I'm busy now. Come back later.'";
...
to say sexwithGobby:
	...
	if hp of Gobby is 0:
	...
	else if lastfuck of Gobby - turns is less than 6:
		...
		if cocks of player > 0 and hp of Gobby > 1 and lastfuck of Hadiya - turns >= 6 and a random chance of anallevel in 7 succeeds and anallevel > 1:
			...
			say "     Not having forgotten you, he arches his tight little ass into the air as he plunges his mouth over the dribbly pole. You spread those cheeks of his and grind your [cock size desc of player] shaft between them, drawing [if cock length of player > 20]a nervous whimper[otherwise]a soft moan[end if] from the goblin. After smearing some of your pre over his pucker to help ready it, you get lined up and sink into his [if cock length of player > 20]overly tight[else if cock length of player > 10]tight[otherwise]snug[end if] hole with a satisfied moan. You sink into him slowly at first, letting his small bottom adjust to having you in him.";
			WaitLineBreak;
