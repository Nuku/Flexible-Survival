...
"Killer Whale"	"[PrepCombat_Killer Whale]"

to say PrepCombat_Killer Whale:
...
When Play begins:
	...
	now Species Name entry is "Orca"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now Name entry is "Killer Whale";
	...
	now MilkItem entry is "killer whale milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "killer whale cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
This is the Killer Whale Infection rule:
	if Player has a body of "Killer Whale":
		...
		if humanity of Player < 10: [SUCCUMB]
			...
			if hospquest > 13: [ALLIED W/DR MOUSE]
