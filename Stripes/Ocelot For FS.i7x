...
to say losetoocelot_ld:
	...
	if ocelotchoice is 1:				[sub-ocelot chosen]
		if cocks of player > 0:
			say "     'Purrrrr... [if player is ocelotbodied]a cute kitty fucktoy in need of some proper attention from a big, strong kitty[else]There it is. I smell a cute kitty fucktoy inside you, eager for some proper attention from a big, strong kitty[end if].' ...
