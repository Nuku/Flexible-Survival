Version 1 of Equinoid Camp by Stripes begins here.
...
to say equinoidcampinvite:
	...
	if the player consents:
		...
		say "     Amaryllis snarls indignantly. 'This is no stray, Bryony. This is the warrior who has been defeating our patrols. [if cunts of player > 0]She[else]He[end if] is interested in joining the herd,' she says, running a hand almost possessively over you while glaring at the larger herm.";
		...
		say "     'So, Amaryllis, you have found another? Your eagerness to grow the pride is commendable, but is this one truly worthy? Many of the herd are not happy to see [if cunts of player > 0]her[else]him[end if] here after entering our territory and fighting with your herd sisters.'";
...
instead of navigating Equinoid Camp while equinoidstatus is 10:
	...
	if the player is perminfected:
		...
		if the player consents:
			...
			say "     She turns back to those gathered. 'The traveler has assisted us against the wolves and so may leave here in peace.' And with that, and a little grumbling from some, the equinoids disperse, Amaryllis walking sadly away while Bryony watches you go.";
			increase carried of food by 2;
			now equinoidstatus is 100;
			now Equinoid Camp is unknown;
			move player to Park Entrance;
