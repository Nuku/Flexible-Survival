...
to say equinoidcampinvite:
	...
	if the player consents:
		...
		say "     Amaryllis snarls indignantly. 'This is no stray, Bryony. This is the warrior who has been defeating our patrols. [if player is female]She[else]He[end if] is interested in joining the herd,' she says, running a hand almost possessively over you while glaring at the larger herm.";
		...
		say "     'So, Amaryllis, you have found another? Your eagerness to grow the pride is commendable, but is this one truly worthy? Many of the herd are not happy to see [if player is female]her[else]him[end if] here after entering our territory and fighting with your herd sisters.'";
