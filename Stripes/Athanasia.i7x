...
instead of fucking the Athanasia:
	...
	otherwise:
		...
		otherwise if hp of Athanasia is 6:
			...
			otherwise if cocks of player > 0 and a random chance of 3 in 5 succeeds:
		...
		[puts Snow Leopard as lead monster for sex change (appropriate size)]
