...
Instead of conversing the Athanasia:
	...
	otherwise if hp of Athanasia is 10 and a random chance of 2 in 5 succeeds:
		say "[salamanderraid]";
	otherwise:
...
to say sexwithAthanasia:
	...
	otherwise if hp of Athanasia > 10:
		athanasiasexmenu;
	otherwise:
		now lastfuck of Athanasia is turns;
		if hp of Athanasia is 5:
			say "[athanasiasex00]";		[first time]
		otherwise if (cunts of player > 0 or cocks of player > 0) and ( ( hp of Athanasia is 8 or hp of Athanasia is 9 ) and a random chance of 1 in 2 succeeds ) or ( hp of Athanasia > 9 and a random chance of 1 in 4 succeeds ):	[volcano]
			...
			otherwise if a random chance of 1 in 2 succeeds or hp of Athanasia is 8:
		...
		otherwise if ( hp of Athanasia is 7 and a random chance of 1 in 2 succeeds ) or ( hp of Athanasia > 7 and a random chance of 1 in 4 succeeds ):		[basalt dildo]
		...
		otherwise if cocks of player > 0 and a random chance of 3 in 5 succeeds:	[wants cock]
		...
		otherwise if cunts of player > 0 and a random chance of 1 in 2 succeeds:	[wants pussy]
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if player consents:
				...
				if nam is "Birdy blow job":
					say "[athanasiasex01]";
				otherwise if nam is "Mount her":
					say "[athanasiasex02]";
				otherwise if nam is "On her back":
					say "[athanasiasex03]";
				otherwise if nam is "Get cunnilingus":
					say "[athanasiasex04]";
				otherwise if nam is "Basalt dildo":
					if cunts of player > 0:
						say "[athanasiasex05a]";
					otherwise:
						say "[athanasiasex05b]";
				otherwise if nam is "Volcano sex":
					say "[athanasiasex06a]";
					say "[athanasiasex06b]";
				otherwise if nam is "Volcano dildo":
					say "[athanasiasex06a]";
					say "[athanasiasex06c]";
				otherwise if nam is "Volcano 69":
					say "[athanasiasex06a]";
					say "[athanasiasex06d]";
...
to say athanasiasex00:		[first time]
	...
	if cocks of player > 0:
		...
		say "     Deciding to give her the [']more['] she's looking for, you move in behind her, lining up your cock with her feathered vent.  She moans loudly and shivers in delight as your cock sinks into her wonderfully hot hole.  The heat of her loins fills you, filling you with vigour that drives you to pound into her hard and fast.  She takes this with unabashed ecstasy, reveling in the wild rutting.  You run your hands through her soft, downy feathers as you mate her.  Her flames wash over your painlessly, almost as if they are holding you lovingly.";
	...
	otherwise:
		...
		say "     Not equipped to mount the needy bird, you slide several fingers into her instead, giving her a good finger-fucking.  She moans loudly and shivers in delight as your digits sinks into her wonderfully hot hole.  The heat of her loins fills you, filling you with vigour that flows up your arm and drives you to pound into her hard and fast.  She takes this with unabashed ecstasy, reveling in it all the more as you press another finger into her and soon your entire hand.  You stroke your free hand through her soft, downy feathers as you work to please her.  You can feel the heat of her loins flowing into you until finally she can't hold back any longer and cries out in delight, cumming hard with a shriek of pleasure.  Her hot juices wash over you, tasting delicious as you lick up as much as you can get while continuing to thrust through her climax.  After slipping your hand free, you snuggle up with her, enjoying some loving nips from her large beak.";
...
to say salamanderraid:
	say "     Your chat with Athanasia's cut short when the sounds of excited hissing comes from outside the cave.  The phoenix shrieks angrily and rushes out of the cave, wings flapping wildly.  'Thieves!  Egg-stealers!  Slinking lizards!' she cries as she takes wing.  Following her, you find [if hp of Newt > 0]that the salamander girls are back for another frolicking egg raid in the lava pool[otherwise]a group of salamander girls coming over the lip of the volcano and descending into the lava fearlessly[end if].  While some just splash around in it playfully like it's a pond, others start diving, possibly going for the eggs.";
	...
	otherwise if fightoutcome >= 30:
		say "     Forced to withdraw, you are driven back into the volcanic cave.  From there, you're watch as the salamanders are eventually driven off by the phoenix, though you can see several of them carrying off eggs as they make their escape.  Athanasia shrieks angrily and pursues the fleeing amphibians, only to return much latter, tired and saddened by her loss.  You clutch the phoenix tenderly and try to console her.  She eventually returns to her old self, but it takes time.";
