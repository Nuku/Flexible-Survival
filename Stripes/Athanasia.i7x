...
to say salamanderraid:
	say "     Your chat with Athanasia's cut short when the sounds of excited hissing comes from outside the cave.  The pheonix shrieks angrily and rushes out of the cave, wings flapping wildly.  'Thieves!  Egg-stealers!  Slinking lizards!' she cries as she takes wing.  Following her, you find [if hp of Newt > 0]that the salamander girls are back for another frolicking egg raid in the lava pool[otherwise]a group of salamander girls coming over the lip of the volcano and descending into the lava fearlessly[end if].  While some just splash around in it playfully like it's a pond, others start diving, possibly going for the eggs.";
