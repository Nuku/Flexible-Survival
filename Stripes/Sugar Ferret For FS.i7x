...
to say losetosugarferret:
	...
	otherwise:
		...
		if "soda" is listed in invent of player:
			...
			otherwise if bodyname of player is "Sugar Ferret" and caffeinehigh of player > 0:
	...
	otherwise:
		...
		otherwise:
			...
			if sugferretjoke is false:
				...
				say "     'Hey, don't tell 'em that.  They won't give up the goods,' the second says, slapping the third.  The trio are reduced to a slapping fight before coming to their senses, yelling 'Cola!' together and charging, trying to catch up with the rest of the ferrets advancing on you.";
...
this is the sugferret rule:		[continuous temptation]
	...
	if bodyname of player is "Sugar Ferret":
		...
		let targetnum be 100 + humanity of player - libido of player - ( caffeinehigh * 2 );
