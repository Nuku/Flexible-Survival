...
to setrfpdesc:
	...
	if rfpc1 is:
		-- 1: now rfponycolor1 is "sky blue";
		-- 2: now rfponycolor1 is "sapphire blue";
		-- 3: now rfponycolor1 is "powder blue";
		-- 4: now rfponycolor1 is "periwinkle";
		-- 5: now rfponycolor1 is "light yellow";
		-- 6: now rfponycolor1 is "jasmine";
		-- 7: now rfponycolor1 is "citrine";
		-- 8: now rfponycolor1 is "teal";
		-- 9: now rfponycolor1 is "soft pink";
		-- 10: now rfponycolor1 is "salmon";
		-- 11: now rfponycolor1 is "fuchsia";
		-- 12: now rfponycolor1 is "light green";
		-- 13: now rfponycolor1 is "honeydew";
		-- 14: now rfponycolor1 is "forest green";
		-- 15: now rfponycolor1 is "grass green";
		-- 16: now rfponycolor1 is "celadon";
		-- 17: now rfponycolor1 is "orange";
		-- 18: now rfponycolor1 is "pumpkin";
		-- 19: now rfponycolor1 is "light brown";
		-- 20: now rfponycolor1 is "tan";
		-- 21: now rfponycolor1 is "brown";
		-- 22: now rfponycolor1 is "lilac";
		-- 23: now rfponycolor1 is "amethyst";
		-- 24: now rfponycolor1 is "thistle";
		-- 25: now rfponycolor1 is "red";
		-- 26: now rfponycolor1 is "russet";
		-- 27: now rfponycolor1 is "ruby red";
		-- 28: now rfponycolor1 is "burgundy";
		-- 29: now rfponycolor1 is "white";
		-- 30: now rfponycolor1 is "gray";
		-- 31: now rfponycolor1 is "cream";
	if rfpc2 is:
		-- 1: now rfponycolor2 is "blue";
		-- 2: now rfponycolor2 is "cobalt blue";
		-- 3: now rfponycolor2 is "cyan";
		-- 4: now rfponycolor2 is "azure";
		-- 5: now rfponycolor2 is "turquoise";
		-- 6: now rfponycolor2 is "black";
		-- 7: now rfponycolor2 is "golden yellow";
		-- 8: now rfponycolor2 is "neon yellow";
		-- 9: now rfponycolor2 is "sunglow";
		-- 10: now rfponycolor2 is "maroon";
		-- 11: now rfponycolor2 is "pink";
		-- 12: now rfponycolor2 is "hot pink";
		-- 13: now rfponycolor2 is "carnation";
		-- 14: now rfponycolor2 is "cerise";
		-- 15: now rfponycolor2 is "green";
		-- 16: now rfponycolor2 is "emerald green";
		-- 17: now rfponycolor2 is "light orange";
		-- 18: now rfponycolor2 is "apricot";
		-- 19: now rfponycolor2 is "peach";
		-- 20: now rfponycolor2 is "royal purple";
		-- 21: now rfponycolor2 is "deep purple";
		-- 22: now rfponycolor2 is "indigo";
		-- 23: now rfponycolor2 is "carmine";
		-- 24: now rfponycolor2 is "flame red";
		-- 25: now rfponycolor2 is "candy apple red";
		-- 26: now rfponycolor2 is "neon green";
	if rfpbm is:
		-- 1: now rfponybm is "a dildo";
		-- 2: now rfponybm is "a vibrator";
		-- 3: now rfponybm is "an egg vibrator";
		-- 4: now rfponybm is "a horsecock";
		-- 5: now rfponybm is "a mare's pussy";
		-- 6: now rfponybm is "a horsecock being licked";
		-- 7: now rfponybm is "a pussy being licked";
		-- 8: now rfponybm is "a cum-slick cock";
		-- 9: now rfponybm is "an overflowing pussy";
		-- 10: now rfponybm is "an ejaculating cock";
		-- 11: now rfponybm is "a cock stuffing an anus";
		-- 12: now rfponybm is "two dogs humping";
		-- 13: now rfponybm is "a necklace of pearls";
		-- 14: now rfponybm is "a pair of tits";
		-- 15: now rfponybm is "a pair of cum-coated tits";
		-- 16: now rfponybm is "a pony head sucking cock";
		-- 17: now rfponybm is "a swallow";
		-- 18: now rfponybm is "a raised tail";
		-- 19: now rfponybm is "a leather whip";
		-- 20: now rfponybm is "a broken bed";
		-- 21: now rfponybm is "a set of furred handcuffs";
		-- 22: now rfponybm is "a pair of cocks rubbing together";
		-- 23: now rfponybm is "an extra-thick dildo";
		-- 24: now rfponybm is "a pair of nipple clamps";
		-- 25: now rfponybm is "a burst condom";
		-- 26: now rfponybm is "a strap-on";
		-- 27: now rfponybm is "a gimp mask";
		-- 28: now rfponybm is "a leather harness";
		-- 29: now rfponybm is "anal beads";
		-- 30: now rfponybm is "the shocker handsign";
		-- 31: now rfponybm is "a finger-stuffed pussy";
		-- 32: now rfponybm is "a butt plug";
		-- 33: now rfponybm is "a ball gag";
		-- 34: now rfponybm is "a dripping candle";
...
to say PrepCombat_Friendship Pony:
	...
	if a random chance of 1 in 4 succeeds:
		now rfponytype is 1; [basic pony is most common, 50% chance]
	else:
...
When Play begins:
	...
	now Species Name entry is "Pony"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now face change entry is "[ponystatuscheck]a rush of giddy happiness overtakes you. Your vision goes blurry and - with a pop and pop - your eyes grow much larger than normal. As you're adjusting to this, your head changes as well, becoming vaguely equine in shape, in a very simplistic and stylized sort of way. A [if Player is female]mane of long[else]crop of short[end if], [pfphair] hair grows in atop your transformed head[if pfptype is 4]. There is a final pop as a short horn suddenly pushes out of your forehead with a few sparkles of color[end if]"; [ Face TF text. Format as "Your face tingles as [face change entry]." ]
	now body change entry is "[ponystatuscheck]changes rapidly spread through your body, rendering your body into a smooth and equine shape with tube-like limbs ending in flat, featureless hooves[if pfptype is 3]. There is a stretching at your back as a small pair of feathered wings push their way out[end if]"; [ Body TF text, format as "Your body tingles as [body change entry]. ]
	now skin change entry is "[fpskinchange]"; [ Skin TF text, format as "Your skin tingles as [skin change entry]. ]
	now ass change entry is "[ponystatuscheck]a strange sensation vibrates through it. Your spine twitches and, with a sudden push and a burst of color, a lush tail of long, vibrant hair pops out of a hole formed for it. Your tail is [pfphair] in color and made of plastic hair"; [ Ass/Tail TF text, format as "Your ass tingles as [tail change entry]." ]
	...
	now MilkItem entry is "friendship pony milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "friendship pony cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
to selectbootymark:
	...
	if Player is HermPreferred, add 8 to pfpbmList;
	...
	if "Sterile" is listed in feats of Player:
		add 29 to pfpbmList;
	else if "Litter Bearer" is listed in feats of Player:
		add 22 to pfpbmList;
	...
	if entry 1 in pfpbmlist is:
		-- 1: now pfpbootymark is "a black dildo";
		-- 2: now pfpbootymark is "a red vibrator";
		-- 3: now pfpbootymark is "a slice of cream pie";
		-- 4: now pfpbootymark is "a jar of cum";
		-- 5: now pfpbootymark is "a soda can";
		-- 6: now pfpbootymark is "a blue male symbol";
		-- 7: now pfpbootymark is "a pink female symbol";
		-- 8: now pfpbootymark is "a purple herm symbol";
		-- 9: now pfpbootymark is "a leather collar";
		-- 10: now pfpbootymark is "a fish packed in ice";
		-- 11: now pfpbootymark is "a muscly arm";
		-- 12: now pfpbootymark is "a throbbing brain";
		-- 13: now pfpbootymark is "a cuckoo chick in a nest";
		-- 14: now pfpbootymark is "an alert Doberman with a blue ribbon";
		-- 15: now pfpbootymark is "a collection of puppies";
		-- 16: now pfpbootymark is "a gi and black belt";
		-- 17: now pfpbootymark is "a one-way street sign";
		-- 18: now pfpbootymark is "a bottle of lube";
		-- 19: now pfpbootymark is "a whip and chains";
		-- 20: now pfpbootymark is "the all-seeing eye";
		-- 21: now pfpbootymark is "an egg stamped with the male symbol";
		-- 22: now pfpbootymark is "several egg cells surrounded by sperm";
		-- 23: now pfpbootymark is "an egg cell surrounded by sperm";
		-- 24: now pfpbootymark is "a bedroll";
		-- 25: now pfpbootymark is "a pair of coconuts";
		-- 26: now pfpbootymark is "a broken mirror";
		-- 27: now pfpbootymark is "a magnifying glass examining a sticky cumstain";
		-- 28: now pfpbootymark is "a map with pushpins in it";
		-- 29: now pfpbootymark is "a tied-off used condom";
		-- 30: now pfpbootymark is "a caduceus";
		-- 31: now pfpbootymark is "a meaty cock hitting something";
		-- 32: now pfpbootymark is "a hefty set of balls cracking the ground";
		-- 33: now pfpbootymark is "a giant set of tits around the silhouette of a head";
		-- 34: now pfpbootymark is "a microwave oven";
		-- 35: now pfpbootymark is "a pissing horsecock";
		-- 36: now pfpbootymark is "a slice of cherry cheesecake";
...
to say drinkponycider:
	if "Iron Stomach" is not listed in feats of Player:
		choose row with Name of "Friendship Pony" from Table of Random Critters;
		if Player is MalePreferred:
			now sex entry is "Male";
		else if Player is HermPreferred:
			now sex entry is "Both";
