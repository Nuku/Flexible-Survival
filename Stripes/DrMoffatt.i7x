...
to say ResolveEvent Another Doctor:
	...
	say "     'If you're done looking, I'd like to talk to you,' she says in an amused tone and a flick of her large, bushy tail. 'I think you, my friend, are just what I've been looking for,' she adds, looking you over with a sexy smile. 'I [if hospquest is 13]understand you had some kind of professional disagreement with our esteemed Dr. Mouse, but that need not hinder our relationship.' She says the last word[else if hospquest is 0 or hospquest is 1]hope you'll be willing to assist me with a little something.' She says [']assist['][else if hospquest is 2 or hospquest is 3 or hospquest is 4]understand you'll be giving Dr. Mouse some assistance. I hope you'll be able to assist me as well.' She says [']assist['][else]understand you've been giving Dr. Mouse a hand. I hope you'll consider giving me some assistance as well.' She says [']assistance['][end if] with a rather provocative tone, but also a teasing grin. You remain guarded, but do allow yourself to relax a little.";
	...
	if HP of doctor moffatt is 1:
		if XP of Doctor Moffatt is 2: [if the player met Moffatt as a skunk or a permanent infection]
			...
			if skunkbeaststatus is 1:
				...
				say "[line break]     'So... [bold type]How do you want to help me?[roman type]?'";
				say "     ([link]Y[as]y[end link]) - I will help you with the samples.";
				say "     ([link]N[as]n[end link]) - I am curious about this hypnosis thing.";
				if Player consents:
					LineBreak;
...
linkaction of Doctor Moffatt is "Possible Actions: [link]talk[as]talk Doctor Moffatt[end link], [link]smell[as]smell Doctor Moffatt[end link], [link]fuck[as]fuck Doctor Moffatt[end link][if XP of Doctor Moffatt is 2], [link]hypnosis[end link][end if][line break]".
...
to say drmoffattdesc:
	...
	else if level of Doctor Moffatt <= 3:
...
instead of conversing the Doctor Moffatt:
	project the figure of DrMoffatt2_icon;
	if HP of Doctor Moffatt is 0:
		...
		if HP of Doctor Moffatt is 99:
			...
			say "     'It seems you've gone and [if wrcurseMoffatt is 0]become too tainted by some strangely persistent infection since I last saw you. It keeps you from being a suitable candidate at all.' She sighs and teases one of her nipples. 'It's too bad, too. I think we would have had lots of fun together. Now I'll need to start looking for someone else. You may go now,' she says dismissively, giving her tail a meaningful flick[else]disobeyed my instructions and exacerbated this saurian condition of yours. You are no longer a valid candidate for my research and I'll have to find a new candidate and start all over again. I am most disappointed in you and I don't want to see you here again,' she says with a dismissive wave of her fluffy tail[end if].";
			now HP of doctor moffatt is 99;
			...
			if Skunk Goo is owned:
				...
				setmonster "Hyperskunk";
				choose row MonsterID from Table of Random Critters;
				now Body of Player is body entry;
				attributeinfect;
				let cockstemp be Cock Count of Player;
				let cocklengthtemp be Cock Length of Player;
				let cockwidthtemp be Ball Size of Player;
				let breastsizetemp be Breast Size of Player;
				let cuntstemp be Cunt Count of Player;
				let cuntlengthtemp be Cunt Depth of Player;
				let cuntwidthtemp be Cunt Tightness of Player;
				follow the sex change rule;
				follow the breast change rule;
				WaitLineBreak;
				say "     As the transformation progresses down to your hands, they change as well, becoming mostly human in form, with smooth and shapely fingers and again tipped by small, black claws[if breastsizetemp < Breast Size of Player]. The swelling at your chest makes you moan as your bosom expands, making you feel even sexier[end if][if cockstemp < Cock Count of Player]. You can't help but touch your new cock and balls, and (with a little prompting from Dr. Moffatt) you start listing off some of the things you'd like to do with your newfound maleness[else if cocklengthtemp < Cock Length of Player]. Your dainty hands slip down to your growing cock, stroking it to full erection, and (with a little prompting from Dr. Moffatt) you start listing off some of the things you'd like to do with it[end if][if cockstemp is not 0 and cockwidthtemp < Ball Size of Player]. Your expanded balls churn with increased virility and you delight in telling her about how the prospect of even larger orgasms makes you feel[end if][if cuntstemp < Cunt Count of Player]. Your altered hands drift downwards, starting to finger your fresh, new pussy, pleased as you see the doctor's cock twitch when you do so[else if cuntlengthtemp < Cunt Depth of Player or cuntwidthtemp < Cunt Tightness of Player]. Your altered hands drift downwards, starting to finger your expanded cunt, pleased as you see the doctor's cock twitch when you do so[end if]. You take a few moments to let your hands roam over yourself, savoring the changes while Dr. Moffatt continues to ask her questions. Despite the clinical delivery of her questions, you can see she's become quite turned on and touches herself frequently.";
				...
				say "     [one of]'I do need you to obtain a sample of the goo from those skunks from the urban forest. The hospital [if HP of doctor mouse is not 2]director is ignoring my request to get a sample collected for me[else]is in too much disarray now to arrange for an orderly to obtain me one[end if]... and that's why I've got to ask you.'[or]'Please try to find some goo from those skunk girls. I need a proper control sample.'[at random]";
			else:
		...
		if level of Doctor Moffatt is 5:
			say "     'Tut tut,' the doctor interrupts you as you open your mouth. '[italic type]Clothes off and on your knees on the sofa. Now.[roman type]' Your body enters in a trance-like state, and before you know it, you are on Doctor Moffat's leather sofa, showing your [TailSpeciesName of Player in lower case] ass at her.";
...
to say sexwithDrMoffatt:
	...
	if XP of Doctor Moffatt is 1:
		...
		if HP of Doctor Moffatt is 2:
		...
		else if HP of Doctor Moffatt < 2 or HP of Doctor Moffatt is 100:
			say "ERROR-Moffatt-[HP of Doctor Moffatt]T: I shouldn't be talking to you right now!";
			...
			say "     'It seems you've gone and [if wrcurseMoffatt is 0]become too tainted by some strangely persistent infection since I last saw you. It keeps you from being a suitable candidate at all.' She sighs and teases one of her nipples. 'It's too bad, too. I think we would have had lots of fun together. Now I'll need to start looking for someone else. You may go now,' she says dismissively, giving her tail a meaningful flic[else]disobeyed my instructions and exacerbated this saurian condition of yours. You are no longer a valid candidate for my research and I'll have to find a new candidate and start all over again. I am most disappointed in you and I don't want to see you here again,' she says with a dismissive wave of her fluffy tail[end if].";
			now HP of doctor moffatt is 99;
		else if wrcursestatus >= 3 and wrcursestatus < 7 and wrcurseMoffatt is 0:
			...
			if lastfuck of Doctor Moffatt - turns < 8:
				...
				NPCSexAftermath Player receives "Stroking" from Doctor Moffatt;
				if Libido of Player > 50:
					decrease Libido of Player by 10;
				else:
					now Libido of Player is 40;
				now lastfuck of Doctor Moffatt is turns;
			...
			if lastfuck of Doctor Moffatt - turns < 8:
				...
				say "[line break]     [bold type]Shall you take her up on her offer?[roman type][line break]";
		...
		if level of Doctor Moffatt > 4:
			if lastfuck of Doctor Moffatt - turns < 4:
				...
				say "     'Great timing,' the doctor gives you a predatory smile. 'I was starting to miss you, my sweet little toy. [italic type]Clothes off, on the couch. Now.[roman type]' Your body enters in a trance-like state, and before you know it, you are on Doctor Moffat's leather sofa, showing her your [TailSpeciesName of Player in lower case] ass at her.";
				say "[MoffatHypnosisFullSex]";
			...
			if lastfuck of Doctor Moffatt - turns < 4:
				...
				if a random chance of 1 in 2 succeeds:
					...
					say "     'Such a nice [boygirl],' the psychologist giggles. A sense of dread fills you, and you try to get off from the couch. 'Don't move, my sweet toy.' Despite your brain screaming to move, your muscles refuse to budge. Doctor Moffatt circles around the couch while you look down, locked in place. Eventually, she stops near your face. She puts one foot on the couch and guide your face to her ballsack. 'Lick.' You muster all your strength to not obey the command, despite the growing desire to plunge your head between these furry thighs of hers. 'Lick, my dear toy.' As soon as you hear the keyword, you bury your face into the skunk's scrotum and start licking, without pause. Powerless to restrain yourself, you make your tongue travel up and down the doctor's crack, focusing on each of her balls each time she gives the order, adding the keyword to her command if necessary. Your involuntary service goes on for what feels hours, but only lasts for a dozen minutes.";
					NPCSexAftermath Player receives "OralCock" from Doctor Moffatt;
					say "     Moffatt purrs from your relentless efforts. Eventually, she orders you to stop, and puts her foot off the couch. Her cock is rock-hard and rests on your [FaceSpeciesName of Player in lower case] head, wetting the top with her pre, which makes her giggle at the sight. 'Good toy,' she says while petting your head. 'Time to use the other end.'";
				...
				if Player is female and (a random chance of 1 in 2 succeeds or anallevel is 1):
					say "     Doctor Moffatt walks around you, and positions herself behind you. 'Such a good [boygirl]. I did not even have to order you to prepare yourself this time.' To your greatest shame, you realize that you had started to finger yourself, at some point. She slowly guides your right hand fingers out of your pussy, and puts your hand back on the sofa. Your entire body shudder, trying to break out from the paralysis, but you are only able to look behind you, as you watch Moffatt line up her cock with your main orifice. The thick shaft pushes inside you, stretching you nice and good until she bottoms out. 'Hnnn. Yesss.' You let a long moan escape your lips as well. Moffatt begins to pump her hips against your butt. Slap, slap, slap. Each time her balls slam into your groin, a small electric shock runs through your spine. Eventually, as you are about to cum, the trance begins to wear off, and your limbs are able to move on their own again. But then, a flow of sensorial pleasure rushes your brain and has you cum hard.";
					...
					NPCSexAftermath Player receives "PussyFuck" from Doctor Moffatt;
				[Cock, default for males if anal level is 1]
				else if Player is male and (a random chance of 1 in 2 succeeds or anallevel is 1):
					say "     Doctor Moffatt walks around you, and snaps her fingers. 'Turn'. You grit your teeth, this time trying not to move. 'Turn, my sweet toy,' she says, and before you realize it, you are on your back, exposing your erect cock for her, one of your hands relentlessly pumping it. 'Such a good [boygirl]. I did not even have to order you to prepare yourself this time.' Taken aback and confused as to when you had started to masturbate yourself, you fail to react when the skunk psychiatrist softly guides your fingers off your dick, and straddles your pelvis. Heavily paralyzed, you can only stare in distress at the doctor, as she wastes no time slamming her ass down on your shaft. She accommodates your [cock size desc of Player] easily. 'Hnnn. Yesss,' she purrs, massaging her belly before stroking her cock, and rocking on your own shaft. Slap, slap, slap. Each time she bottoms out, a small electric shock runs through your spine. Eventually, as you are about to cum, the trance begins to wear off, and your limbs are able to move on their own again. But then, a flow of sensorial pleasure rushes your brain and has you cum hard.";
					say "     You let out a long, loud bellow as your fists clench the leathery furniture, and your empty your balls into the good doctor in a succession of long, thick ropes of sperm. Doctor Moffatt cums not long after, and while she squeezes your over-sensitive cock with her anal muscles, she faps her cock with fast, powerful strokes until it sprays fresh cum all over your [BodyType of Player] body, up to your face and into your open mouth. You hear her raspy pants behind you as she slides off you slowly, letting her deflating cock flop along your stomach.";
					NPCSexAftermath Doctor Moffatt receives "AssFuck" from Player;
				[Ass]
				else:
					say "     Doctor Moffatt walks around you, and positions herself behind you. 'Such a good girl. I did not even have to order you to prepare yourself this time.' To your greatest shame, you realize that you had started to finger yourself, at some point. She slowly guides your right hand fingers out of your ass, and put your hand back on the sofa. Your entire body shudders, trying to break out from the paralysis, but you are only able to look behind you, as you watch Moffatt line up her cock with your anal orifice. The thick shaft pushes inside you, stretching you nice and good until she bottoms out. 'Hnnn. Yesss.' You let a long moan escape your lips as well. Moffatt begins to pump her hips against your butt. Slap, slap, slap. Each time her balls slam into your groin, a small electric shock runs through your spine. Eventually, as you are about to cum, the trance begins to wear off, and your limbs are able to move on their own again. But then, a flow of sensorial pleasure rushes your brain and has you cum hard.";
					...
					NPCSexAftermath Player receives "AssFuck" from Doctor Moffatt;
				WaitLineBreak;
...
to say MoffatHypnosisFullSex:
	if a random chance of 1 in 2 succeeds:
		say "     'Such a nice [boygirl],' the psychologist giggles. Stuck in a trance state, the skunk's voice feels as if it was inside your head with your own mind. She circles around the couch while you look down, your body locked in place. Eventually, she stops near your face. She slaps her flaccid cock against your cheeks a couple of times, before pressing it against your lips. 'Suck.' As soon as the word escaped her lips, your raise your head and, like an automaton, begin to bob your mouth up and down her shaft. It quickly hardens and thickens, until it stretches your lips and reaches down your throat; but you do not stop a single moment. With your gag reflex suppressed by the hypnosis, your lips slide down to the base of Doctor Moffat's shaft, before going back to its crown, in a metronomic rhythm.";
		...
		say "     'Such a nice [boygirl],' the psychologist giggles. Stuck in a trance state, the skunk's voice feels as if it was inside your head with your own mind. She circles around the couch while you look down, your body locked in place. Eventually, she stops near your face. She puts one foot on the couch and guide your face to her ballsack. 'Lick.' As soon as you hear the single-worded order, you bury your face into the skunk's scrotum and start licking without pause. In an oblivious frenzy, you make your tongue travel up and down the doctor's crack, focusing on each of her huge balls when she gives you the order. Your hazy mind loses the sense of time, and your service goes on for what feels hours, but only lasts for a dozen minutes.";
		say "     Moffatt purrs from your relentless efforts. Eventually, she orders you to stop, and puts her foot off the couch. Her cock is rock-hard and rests on your [FaceSpeciesName of Player in lower case] head, wetting the top with her pre, which makes her giggle at the sight. 'Good toy,' she says while petting your head. 'Time to use the other end.'";
		NPCSexAftermath Player receives "OralCock" from Doctor Moffatt;
	[Priority order: pussy, cock, ass]
	[Pussy, default for females and herms if anal level is 1][bookmark]
	if Player is female and (a random chance of 1 in 2 succeeds or anallevel is 1):
...
an everyturn rule:
	if HP of Doctor Moffatt >= 3 and HP of Doctor Moffatt <= 7 and lust of Doctor Moffatt is not 1:
		if skunkbeaststatus is 1 or JackalManTF > 0 or JackalBoyTF > 0 or nightmaretf > 0 or HellHoundlevel > 0 or ( wrcursestatus >= 7 and wrcursestatus < 100 ):
			...
			raise Player Libido by ( HP of Doctor Moffatt + lastfuck of Doctor Moffatt - turns ) / 3;
			...
			raise Player Libido by a random number between 4 and 8;
			...
			say "     You moan and stumble, leaning against a broken wall for support as a huge rush of arousal fills you. You [if Player is herm]grab your cock and start pumping it while burying several fingers in your dripping pussy, working yourself to a wild and crashing orgasm that somehow leaves you[else if Player is male]grab your cock and start pumping it, working yourself to a wild and sticky orgasm that somehow leaves you[else if Player is female]bury several fingers into your dripping pussy, working yourself to a wild and crashing orgasm that somehow leaves you[else]work your hands all over yourself, trying to find release for this sudden surge of arousal. With a painful twisting inside you, the lust finally breaks and you are left[end if] feeling cleansed. Your mind feels much clearer than it has in the last few days.";
...
an everyturn rule:
	if level of Doctor Moffatt > 0:
		...
		else if lust of Doctor Moffatt is 0:
...
carry out hypnoSession:
	...
	if dexterity of Doctor Moffatt is:
		-- 1:
			say "[line break][bold type]Your strength raises momentarily by [level of Doctor Moffatt]![roman type][line break]";
			increase strength of Player by level of Doctor Moffatt;
		-- 2:
			say "[line break][bold type]Your dexterity raises momentarily by [level of Doctor Moffatt]![roman type][line break]";
			increase dexterity of Player by level of Doctor Moffatt;
		-- 3:
			say "[line break][bold type]Your stamina raises momentarily by [level of Doctor Moffatt]![roman type][line break]";
			increase stamina of Player by level of Doctor Moffatt;
		-- 4:
			say "[line break][bold type]Your perception raises momentarily by [level of Doctor Moffatt]![roman type][line break]";
			increase perception of Player by level of Doctor Moffatt;
		-- 5:
			say "[line break][bold type]Your charisma raises momentarily by [level of Doctor Moffatt]![roman type][line break]";
			increase charisma of Player by level of Doctor Moffatt;
		-- 6:
			say "[line break][bold type]Your intelligence raises momentarily by [level of Doctor Moffatt]![roman type][line break]";
...
to say hypnoCatch4:
	...
	say "     'How do you feel, my sweet toy?' she asks.";
	say "     'Good,' you reply instantly, surprising even yourself. The skunk grins and walks to you, giving your cheek a small kiss. 'Good. Come back soon, then. We will have another session.'";
...
to say hypnoCatch5:
	...
	say "     'How do you feel, my sweet toy?' she asks."; [NOTE: If this looks strange don't worry. It's proper standard formatting to start new paragraphs when a new speaker begins talking]
	say "     'Good, mistress,' you reply instantly, surprising even yourself. The skunk grins and walks to you, giving your cheek a small kiss. 'Good. Come back soon, then. We will have another session.'";
