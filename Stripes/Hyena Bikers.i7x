...
to say ResolveEvent Hyena Bikers:
	...
	WaitLineBreak;
	if hyg is 4 and (BodyName of Player is "Hyena Herm" or FaceName of Player is "Hyena Herm"):
		say "[ridetimecheck]";
	else:
		say "[bikeattack]";
...
to say bikeattack:
	...
	say "     The hyena bikers laugh derisively as they circle around you as you try to find a way out of this mess. Suddenly one veers out and tries to charge you on her bike.";
	[WaitLineBreak]
	let the bonus be ( Dexterity of Player minus 10 ) divided by 2;
	let the dice be a random number from 1 to 20;
	say "[line break]You roll 1d20([dice])[if bonus >= 0]+[end if][bonus] = [special-style-1][dice + bonus][roman type] vs [special-style-2]13[roman type] (Dexterity Check):[line break]";
	if dice plus bonus > 12:
		say "     You roll to the side, narrowly missing a kick as he rides past. You get up quickly, but another one is coming at you, swinging a length of chain over her head.";
	else:
		decrease HP of Player by 10;
		say "     You are too slow to get away before the biker kicks you hard, knocking you down ([special-style-1]10[roman type] dmg). As you try to get up quickly, another one is coming at you, swinging a length of chain over her head.";
	[WaitLineBreak]
	let the dice be a random number from 1 to 20;
	say "[line break]You roll 1d20([dice])[if bonus >= 0]+[end if][bonus] = [special-style-1][dice + bonus][roman type] vs [special-style-2]14[roman type] (Dexterity Check):[line break]";
	if dice plus bonus > 13:
		say "     You dodge to the side just in time and hear the heavy chain whizz past just inches away. You turn to face your assailant, but find another hyena biker almost upon you, tire iron raised high.";
	else:
		decrease HP of Player by 10;
		say "     The hyena strikes you hard on the shoulder with the heavy length of chain, bruising you ([special-style-1]10[roman type] dmg). You turn to face your assailant, but find another hyena biker almost upon you, tire iron raised high.";
	[WaitLineBreak]
	let the dice be a random number from 1 to 20;
	say "[line break]You roll 1d20([dice])[if bonus >= 0]+[end if][bonus] = [special-style-1][dice + bonus][roman type] vs [special-style-2]15[roman type] (Dexterity Check):[line break]";
	if dice plus bonus > 14:
		...
		decrease HP of Player by 10;
		say "     You are clubbed in the head by the hard metal, making you see stars for a moment ([special-style-1]10[roman type] dmg). You turn to face the biker, but she's disappeared back into the whirling group. You growl in frustration and call them cowards. Most of them laugh, but one pulls to a stop and gets off to fight you hand to hand. As you get ready to fight her, you see others getting off their bikes to take you on as well.";
...
to say postridesex:
	if matriarchowned is 1:				[matriarch]
		...
		if Player is female:			[female/herm matriarch]
			...
			WaitLineBreak;
			say "     The strong male pants heavily as he pounds into you vigorously. You can hear the bitch beneath you groan, possibly in pleasure, as each thrust presses the bike against them. Certainly the tongue only gets more frantic in its licking, even diving at your asshole from time to time, making you shiver at this new delight. [if Player is male]Your hard cock leaks precum onto your body as the hyena pounds you. As his knot pops into you, locking you both together, you are driven over the edge. Your pussy quivers around his shaft, milking at it as your cock empties its load across your chest. The well-hung male groans and slams into you hard one last time, releasing his hot load into you in heavy spurts. As the biker[else]As his knot pops into you, locking you both together, you are driven over the edge. Your pussy quivers around his shaft, milking at it eagerly. The well-hung male groans and slams into you hard one last time, releasing his hot load into you in heavy spurts. As the[end if] leader spreads his seed in you, the hyena tongue licking you eagerly laps up what few drops leak out around that thick knot.[impregchance]";
		...
		if Player is female:			[female/herm]
			...
			say "     [if Player is male]Your hard cock leaks precum onto your body as the hyena pounds you. As his knot pops into you, locking you both together, you are driven over the edge. Your pussy quivers around his shaft, milking at it as your cock empties its load across your chest[else]As his knot pops into you, locking you both together, you are driven over the edge. Your pussy quivers around his shaft, milking at it eagerly[end if]. The well-hung male groans and slams into you hard one last time, releasing his hot load into you in heavy spurts. As the leader spreads his seed in you, the hyena tongue licking you eagerly laps up what few drops leak out around that thick knot.[impregchance]";
		else:					[male]
...
to say bikersubsex:
	...
	MultiInfect "Hyena Herm" repeats 2;
	SanLoss 6;
	raise Player Libido by 12;
	now lastfuck of grant is turns;
...
Grant is a man.
ScaleValue of Grant is 3. [human sized]
SleepRhythm of Grant is 0. [0 - awake at all times, 1 - day active, 2 - night active]
Body Weight of Grant is 5. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Grant is 7. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
[Body Adjective is generated out of the body weight and body definition and can be used in scenes - one word descriptive adjective depending on weight and definition groups: low weight group: skinny/slender/lithe; mid weight group: average/fit/muscled; high weight group: pudgy/husky/jacked]
Androginity of Grant is 2. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Grant is 8. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Grant is 4. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Grant is 8. [length in inches]
Breast Size of Grant is 0. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Grant is 2. [count of nipples]
Asshole Depth of Grant is 10. [inches deep for anal fucking]
Asshole Tightness of Grant is 2. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Grant is 1. [number of cocks]
Cock Girth of Grant is 4. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Grant is 10. [Length in Inches]
Ball Count of Grant is 2. [allowed numbers: 1 (uniball), 2 or 4]
Ball Size of Grant is 3. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
Cunt Count of Grant is 0. [number of cunts]
Cunt Depth of Grant is 0. [penetratable length in inches; some minor stretching allowed, or more with Twisted Capacity]
Cunt Tightness of Grant is 0. [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
Clit Size of Grant is 0. [size 1-5, very small/small/average/large/very large]
[Basic Interaction states as of game start]
PlayerMet of Grant is false.
PlayerRomanced of Grant is false.
PlayerFriended of Grant is false.
PlayerControlled of Grant is false.
PlayerFucked of Grant is false.
OralVirgin of Grant is false.
Virgin of Grant is true.
AnalVirgin of Grant is false.
PenileVirgin of Grant is false.
SexuallyExperienced of Grant is true.
TwistedCapacity of Grant is false. [Twisted Characters can take any penetration, no matter the size]
Sterile of Grant is true. [steriles can't knock people up]
MainInfection of Grant is "Hyena Herm". [Grant is male though.]
Description of Grant is "     The leader of the hyena bikers is here, sitting on a wooden crate and watching the others milling about. His pose is casual, but his eyes watch them intently, as if sizing them up and evaluating them. He is a strong, fully male hyena wearing a leather jacket and jeans. He has a pair of sunglasses that have been adjusted to fit on his muzzle.[line break]".
[Conversation of Grant is { "Cool!" }.]
icon of Grant is Figure of Grant_face_icon.
The scent of Grant is "     Grant smells of male hyena, strong and virile. His scent also contains the scent of old leather, grease and motorcycle exhaust[if matriarchdefeated is 2]. His dominant, masculine scent makes you the hyena bitch inside you want to bend over for him[end if].".

instead of conversing the Grant:
	project the Figure of Grant_face_icon;
	if matriarchdefeated is 2:
		if BodyName of Player is not "Hyena Herm":
			say "     The hyena biker glances down at you, looking over your [BodyType of Player] form and shakes his head. 'Now, that just won't do at all. He grabs your shoulder and pushes you to your knees in front of him. With his legs around you, he holds you close. You watch as he pulls out his impressive cock and strokes himself hard.";
...
instead of fucking the grant:
	...
	if lastfuck of grant - turns < 6:
		...
		if BodyName of Player is not "Hyena Herm":
			...
			if grantbitch is 0:
				...
				if Player is female:
					...
					say "[grantstretch]";
					say "     Glancing back, you can see the hangers on are watching again, eyeing you both lustfully and enviously. Let them watch and be jealous all they want, you think. It is too late, you are his special bitch now[if Player is not sterile] and his pups will be yours now[end if].";
					say "     His paws are not idle, playing with your breasts and stroking your pussy even as he tries to work his growing knot into you. 'Ngg... I knew you'd come back, slut. And I'm glad, only a special bitch like you deserves to be my personal [if Player is not sterile]breeder[else]fucktoy[end if].' As he groans out that last word, his knot pops into you, sending you both over the edge.";
					[WaitLineBreak]
		...
		say "     The hyena biker glances down at you, looking over your [BodyType of Player] form and shakes his head. 'Now, that just won't do at all. He motions for you to get onto your knees as he pulls out his impressive cock and strokes himself hard. 'Let's see if we can improve your looks a little.'";
		...
		say "     The biker leader leads to you the garage where his bike is stored. A few of his team are there, working on their bikes or shooting the breeze. They all smarten up as they see [if matriarchowned is 1]you both[else]him[end if] come in, then relax when he nods to them. 'Just [if matriarchowned is 1]giving our matriarch a lift, boys. You guys still have some time for R&R.' They wait respectfully for their matriarch to leave before breaking into a bit of roughhousing[else]a little joyride, boys. No mission yet.' They chuckle a little, grinning as they eye the new member they met out on the road[end if].";
		[WaitLineBreak]
		if Player is herm and matriarchowned is 1:		[herm matriarch]
			say "     You and Grant roar out on his bike, taking a short but scenic ride through the city before riding to the top of a parking structure. There, he stops the bike and takes you into his arms. The biker runs his paws along your body, shifting between your cock and pussy while licking and nibbling along your neck. 'And what can I do to serve my matriarch today?' he rumbles softly in your ear. (Y=Get fucked, N=Fuck him)[line break]";
			if Player consents:
				LineBreak;
				say "[grantfsex]";
			else:
			...
			say "     You and Grant roar out on his bike, taking a short but scenic ride through the city before riding to the top of a parking structure. There, he stops the bike and takes you into his arms. The biker runs his paws along your body, shifting them to your cock while licking and nibbling along your neck. 'And how can I serve my matriarch today?' he rumbles softly in your ear, to which you respond by giving his ass a firm squeeze.";
			WaitLineBreak;
			say "[grantmbottom]";
		else if Player is female:
			say "     You and Grant roar out on his bike, taking a short but scenic ride through the city before riding to the top of a parking structure. There, he stops the bike and takes you into his arms. The biker runs his paws along your body and between your legs to rub your pussy while licking and nibbling along your neck. 'Come, my eager lady, let's get you nice and filled,' he rumbles softly in your ear.";
			WaitLineBreak;
			say "[grantfsex]";
		else:
			say "     You and Grant roar out on his bike, taking a short but scenic ride through the city before riding to the top of a parking structure. There, he stops the bike and takes you into his arms. The biker runs his paws along your body and between your legs to rub your cock while licking and nibbling along your neck. His other paw gives your ass a firm squeeze. 'Come, my eager slut, let's get you nice and filled,' he rumbles softly in your ear.";
			WaitLineBreak;
			...
			[WaitLineBreak]
			say "     You dig your paws at the bedding the big male fucks you hard and fast, leaking a steady flow of precum into your bottom to get you slick. You can feel his muscular chest against your back as he nibbles and nips at your nape and ears. He uses one paw to help support his weight while the other grips your [Cock of Player] cock, squeezing it as he pounds into you.";
		...
		if matriarchowned is not 1 and matriarchdefeated is 1 and a random chance of 1 in 2 succeeds:
			...
			say "     '[if matriarchdefeated is 1]It's a nice day/night for a ride and I'm feeling generous. Where would you like me to drop you off?[else if matriarchowned is 1]Thank you for a very pleasant ride, my matriarch. Where would you like to go now[else]That was a fun ride. Is there anywhere you'd like me to drop you off while we're out[end if]?'";
		increase grantsex by 1;
		now lastfuck of grant is turns;
		say "[gimmearide]";

to say grantstretch:
	if Cunt Depth of Player < 6 and Player is not MalePreferred:
	...
	else if Cunt Depth of Player < 11 and Player is not MalePreferred and "Modest Organs" is not listed in feats of Player:
...
to say grantfsex:
	...
	say "     You can feel his cock throb inside you as it blasts shot after shot of thick semen into your womb, making you swell just little from its amount. The feel of so much virile heat shooting into you sends you over the edge and you climax moments later. Your pussy quivers around [if Player is male]the thick shaft as your cock spurts a sticky mess between you both[else]his thick shaft, milking it for as much as he can give[end if].[impregchance]";
	[WaitLineBreak]
	say "     When his knot finally comes down and he pulls out of you, he wipes himself [if matriarchdefeated is not 1]and you [end if]off with a towel left there for that purpose. He gets up slowly and stretches, showing off his sexy body to you before [if matriarchdefeated is 1]waiting for you to rise[else]helping you up[end if].";
	hyenaify;
