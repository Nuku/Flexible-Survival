...
This is the bikeride rule:
	...
	if title entry is "Gang HQ":
		...
		otherwise:
			now ridemessage is "     You decide you[apostrophe]d like to ride back with the gang as they return to the hideout.  The leader nods, saying he[apostrophe]s looking forward to getting back as well. [line break]";
	...
	otherwise if title entry is "Park":
		...
		otherwise:
			now ridemessage is "     You decide to get dropped off at the city park.  'Sure, I can drop you there if you[apostrophe]d like.  Just be careful, there[apostrophe]s a lot of weird stuff in there and don't take your eyes off the plants.' [line break][postridesex]";
	...
	otherwise if title entry is "Beach":
		...
		otherwise:
			now ridemessage is "     You decide to get dropped off at the beach plaza.  He gives a rough, hyena laugh.  'Planning on getting a tan?  Just be careful, I[apostrophe]ve heard there[apostrophe]s some spooky stuff going on there in the evening.' [line break]";
	...
	otherwise if title entry is "State Fair":
		...
		otherwise:
			now ridemessage is "     You decide to get dropped off at the State Fair.  He gives a rough, hyena laugh.  'Looking for a little fun at the carnival?  I[apostrophe]ve got a fun ride for you right here,' he jokes, giving his ample package a squeeze. [line break]";
	...
	otherwise if title entry is "Power Plant":
		...
		otherwise:
			now ridemessage is "     You decide to get dropped off at the city[apostrophe]s power plant.  If he wonders why you want to go there, he holds his tongue. [line break]";
...
to say postridesex:
	...
	if matriarchowned is 1:				[matriarch]
		...
		if cunts of player > 0:			[female/herm matriarch]
			say "     Eventually, you reach your destination and the gang comes to a stop.  The biker grinds his cock against you a few more times and asks if he may further serve his matriarch.  Having seen him and his group in action, you decide he[apostrophe]s worthy of mating with you.  You turn your head to kiss him lustfully.  His tongue dives into your mouth and soon you[apostrophe]re naked and laying across the bike.  He grabs one of your legs and raises it up as he lines up his cock.";
		...
		otherwise:					[male matriarch]
			say "     Eventually, you reach your destination and the gang comes to a stop.  The biker grinds his cock against you a few more times and asks if he may further serve his matriarch.  Having seen him and his group in action, you decide he[apostrophe]s worthy of enjoying your cock.  You turn your head to kiss him lustfully.  His tongue dives into your mouth and soon you[apostrophe]re both naked.";
			say "     You firmly shove the biker over to a nearby wall, having him spread himself for you.  He moans softly as your hard cock grinds against his rear, probing his tailhole.  He[apostrophe]s quite tight, clearly never having done this before, being a dominant male.  But he wiggles his rump back against you, clearly still eager to be of service his matriarch.";
			if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
