...
to say beatenbyhb:
	...
	say "     He grabs your jaw and stuffs his thick cock into your mouth while another hyena, a herm, lines hirself up behind you. You moan loudly as you feel hir shaft pressing into you, spreading your [if cunts of player > 0][cunt size desc of player] pussy[else]tight asshole[end if]. With a firm grip on your rear, shi pounds you hard and fast, clearly quite pent up and intent on relieving hir need deep inside you.";
	[WaitLineBreak]
...
to say postridesex:
	if matriarchowned is 1:				[matriarch]
		...
		if cunts of player > 0:			[female/herm matriarch]
			...
			say "     You firmly shove the biker over to a nearby wall, having him spread himself for you. He moans softly as your hard cock grinds against his rear, probing his tail-hole. He's quite tight, clearly never having done this before, being a dominant male. But he wiggles his rump back against you, clearly still eager to be of service his matriarch.";
			[WaitLineBreak]
...
to say bikerbitchsex:
	...
	say "     Your subservient instincts make you moan and press your rear back into his touch, making him smile wider. 'Yes, I think you are.' With that, he brings his cock to your [if cunts of player > 0]wet pussy[else]eager ass[end if] and slowly sinks in. You moan even louder in satisfaction. He's larger than the average hyena and fills you so very full, just what your bitch body is craving.";
	[WaitLineBreak]
	...
	if cocks of player > 0:			[male/herm insert]
		say "     Your cock dangles beneath you, spraying its undesirable, submissive seed onto the pavement beneath you as the stronger, more dominant hyenas have their way with you. You are but a [if cunts of player > 0]breedtoy[else]fucktoy[end if] for them and your sex-addled mind wouldn't have it any other way.";
	if cunts of player > 0:			[female/herm second half]
		...
		say "     The pair continue to pound their cocks into you from each end until finally you are given a hot load of hyena cum down your throat and another deep inside your bowels. Your tail-hole grips and squeezes at the thick pole, getting every drop your needy body can from the big, virile male.[mimpregchance]";
	...
	if lastfuck of grant - turns < 8:
		...
		if cocks of player > 0 and cunts of player > 0 and matriarchowned is 1:		[herm matriarch]
			...
			if the player consents:
				...
				say "[grantmbottom]";
		else if cocks of player > 0 and matriarchowned is 1:				[male matriarch]
...
to say grantbitchsex1:
	...
	if cunts of player > 0:
		...
		say "     Your anal walls stretch painfully wide to take the large cock, but the pressure of it against your prostate gives you much more pleasure. As your tail-hole starts to get used to the intruder, the biker starts pounding into you hard and fast. His precum leaks steadily into you, making your back passage slick for him. The feel of that big prick inside you is so good, making you love to be used like the weak, submissive bitch your new instincts say you are.";
	[WaitLineBreak]
...
to say grantbitchsex4:
	...
	if cunts of player > 0:
		...
		[WaitLineBreak]
		say "     Once his knot goes down, he slides you off and sets you back on the floor. You immediately drop to your knees and submissively clean your master's cock before getting your customary swat on the rump and heading off. You wander around the room a little, showing off your sticky rump and leaking his cum for your overfilled tail-hole onto the floor as you go.";
	wait for any key;
...
to say grantbitchsex5:
	...
	say "     You grip the wooden crate tightly and moan that you need his cock. He licks your ear. 'Say it loud. Let them all hear,' he whispers, pressing his large glans slightly into your [if cunts of player > 0]slit[else]tail-hole[end if], just enough to get you really hungry for more.";
	[WaitLineBreak]
...
to say grantmbottom:
	...
	[WaitLineBreak]
	say "     The wet sounds of your sex from your hard, steady thrusts into the hyena's pre-slick tail-hole surround you. The slap of your balls against his makes you long to get this tough biker to cum as you fill his ass. And from the growing wet spot in the blankets under him, that will be soon. His panting grows heavier as you lean over him, whispering what a good pack member he is, such a competent leader, a virile male, a stud. And your little fucktoy right now.";
	say "     'Go on. Show me how much you enjoy being under your matriarch. Cum for me, hon,' you rumble in his ear, licking and nibbling at it as you stroke his cock and pound into him, pushing yourself fully into his rear. He groans loudly and his tail-hole spasms around you as his cock throbs in your paw, unleashing massive spurts of cum onto the blankets.";
	[WaitLineBreak]
	say "     This sets you off and you growl, firing your hot load into him, spraying your dominant seed into your subordinate's tight ass. His tongue hangs out to one side and he grins happily, loving the feel of you claiming [if grantfucked is 0]his virgin tail-hole[else]him again[end if].";
	say "     Once you've both drained your balls, you slowly pull your cock from his slick bottom and give him a playful swat. He rolls over, grabbing a nearby towel left for these times and wipes you clean, then himself[if cunts of player > 0]. You eye the large mess of hyena cum he's left and wonder if you should let him fill you next time[end if]. He gets up slowly and helps you up, taking you back to the bike.";
	increase grantfucked by 1;
	hyenaify;
