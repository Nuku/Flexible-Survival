	...
	if bodyname of player is "Dragontaur":
		if humanity of player is less than 10:
			...
			otherwise if hp of Sam >= 50 and hp of Sam <= 69:
				if cunts of player > 0 and cocks of player > 0:
					say "     As you lose your humanity to your increasingly dragontaur nature, you feel your lustful drive to breed grow stronger.  You and Sam pair up as a couple of increasingly feral, herm taurs.  While Sam does maintain more of her old self than you do in the end, she's more than happy to stay in the city and turn the bunker into her personal lair.  You breed with the dracovixentaur often, swapping roles as top or bottom to ensure you're both well bred.  You do make forays with her out into the city often, siring plenty of offspring of your own in the many sexy females and herms you find out there.  While Sam's offspring are a collection of dragontaurs, vixentaurs and dracovixentaurs, the number of dragontaurs in the area grow to be the most frequent of the three.";
				otherwise if cunts of player > 0:
					say "     As you lose your humanity to your increasingly dragontaur nature, you feel your lustful drive to breed grow stronger.  You and Sam pair up as a couple of increasingly feral taurs.  While Sam does maintain more of her old self than you do in the end, she's more than happy to stay in the city and turn the bunker into her personal lair.  You are bred by the dracovixentaur often, filling you plump with numerous eggs most of the time.  You do make forays with her out into the city often, getting mounted by other males while Sam partakes in the females.  While Sam's offspring are a collection of dragontaurs, vixentaurs and dracovixentaurs, the number of dragontaurs in the area grow to be the most frequent of the three.";
				otherwise if cocks of player > 0:
					say "     As you lose your humanity to your increasingly dragontaur nature, you feel your lustful drive to breed grow stronger.  You and Sam pair up as a couple of increasingly feral taurs.  While Sam does maintain more of his old self than you do in the end, she's more than happy to stay in the city and turn the bunker into her personal lair.  She allows you to mount her and breed her often, keeping her heavy with eggs most of the time.  You do make forays with her out into the city often, enjoying mounting and breeding many of the females you find with her.  While Sam's offspring are a collection of dragontaurs, vixentaurs and dracovixentaurs, the number of dragontaurs in the area grow to be the most frequent of the three.";
				otherwise:
					say "     As you lose your humanity to your increasingly dragontaur nature, you feel your lustful drive to breed grow stronger.  You and Sam pair up as increasingly feral taurs.  While Sam does maintain more of her old self than you do in the end, she's more than happy to stay in the city and turn the bunker into her personal lair.  Lacking any defined gender of your own, you often act at the guardian to the dracovixen's lair.  You also enjoy the role of servicing the powerful herm, particularly enjoying to lick her clean after returning from an expedition into the city, sucking her cock or licking the leaking cum from her well-used pussy.  While Sam's offspring are a collection of dragontaurs, vixentaurs and dracovixentaurs, the number of dragontaurs in the area grow to be the most frequent of the three.";
			otherwise if hp of Sam is 98:
				say "     Shortly after you lose your humanity, you are found by Sam the Dragontaur, who takes you in to be his personal sex toy.  He greatly enjoys using you to satisfy his sexual desires.  His throbbing dragonhood is pounded into you until you're nothing but an obedient slut for dragon cock.  He'll share you often with his offspring or take you with him on his forays into the city, offering you up as a plaything for any creature he desires.  He barters the use of your mouth[if cocks of player > 0], cock[end if][if cunts of player > 0], cunt[end if] or ass at times to bribe a potential new lover at times.  A duty you're more than happy to perform.  With the virile dragontaur's efforts out there, the number of his draconic progeny grow steadily.";
		otherwise:
			if hp of Sam >= 10 and hp of Sam <= 29:
			...
			otherwise if hp of Sam is 98:
				...
				say "     Being a strong and impressive creature, you find work as hired muscle in several capacities.  And while some of these tasks may be a little shady, you intimidating physique keeps you from getting into too much trouble (except when you want to make some of your own).  It also allows you to impress or dominate many a prospective lover into sex with you[if cocks of player > 0], breeding many a clutch of whelps in your wake as you travel the countryside[otherwise], bearing many a clutch of eggs which you leave to hatch and spread in your wake as you travel the countryside[end if].";
