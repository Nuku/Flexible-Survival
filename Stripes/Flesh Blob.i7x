...
to say losetofleshblob:
	...
	if ( Player is female or ( anallevel > 1 and Player is male ) ) and a random chance of 1 in 3 succeeds:
		...
		if Player is female:
			say "     During this bizarrely sensual massage, you feel a hard, throbbing cock grow out from the fleshy mound and into your juicy pussy[if Player is female]. Soon enough, it forms enough cocks to fill each of your needy pussies[end if]. The cock[sfn] shift[sfv] and change[sfv] frequently, sometimes perfectly sized for your [cunt size desc of Player] cunt[sfn], other times feeling much thicker for a thorough stuffing or slender for a fast pounding[if anallevel is 3]. A penis is even formed to fill your crinkled back door to stuff your needy body further[end if]. [if Cunt Count of Player > 1 or anallevel is 3]These sometimes even soften to the point of becoming wriggling tongues or become jointed to as probing fingers in your clenching holes[else]It softens occasionally to the point of becoming a wriggling tongue or become jointed to as probing fingers in your clenching hole[end if] before stiffening up again to resume thrusting.";
...
When Play begins:
	...
	now Species Name entry is "Blob"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	add "Flesh Blob" to infections of NoLegList;
	...
	now MilkItem entry is "flesh blob milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "flesh blob cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
This is the Flesh Blob Infection rule:
	if Player has a body of "Flesh Blob":
		...
		if humanity of Player < 10:
			...
			say "     [if Player is not neuter]And while your changing appearance is generally viewed with suspicion by strangers, you are able to make a place for yourself in the new world. Preferring dark places and having quite the sexual appetite, you get a job working in a sex parlor, manning the gloryhole room where you service the cocks presented to you by the patrons while keeping yourself out of sight. Over time, you get to know some of the other sex workers employed there and some of them are even willing to fool around with you after hours. You learn, with practice, how to use your infected body's talents to partially meld with your lovers, sharing in their pleasure and making them a part of you in orgasmic bliss for a time[else]As your changing appearance is generally viewed with suspicion by strangers, you have trouble finding a place to fit in. You eventually get part-time work running the projectors at a sex parlor, staying out of sight of the patrons. Being genderless, you have less interest in the films being shown, keeping you from being distracted by them. It doesn't pay that much, but it's enough to get by on. Over time, you get to know some of the other sex workers employed there and some of them are even willing to fool around with you after hours. You learn, with practice, how to use your infected body's talents to partially meld with your lovers, allowing you to share in their pleasure and thereby a receive sexual release of your own as you feel orgasmic bliss while making them a part of you[end if]. You can feel an urge to keep them, but always manage to release them, wary of what could happen if you started to consume others and were unable to return to even the vaguely human form you have.";
