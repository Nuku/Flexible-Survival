...
to say sexwithAndrew:
	...
	otherwise if hp of Andrew >= 4 and DBCaptureQuestVar is 7 and ( DemonBruteStatus is 0 or DemonBruteStatus is 1 ) and lust of Andrew is 0 and companion of player is demon brute:
		...
		otherwise:
			...
			now lust of Andrew is 1;			
	otherwise if hp of Andrew is 4 or ( hp of Andrew > 4 and a random chance of 1 in 6 succeeds):	[special - give oral]
...
[		say "TEST:[line break]";
	...
	otherwise if hp of Andrew is 9 or ( hp of Andrew > 9 and a random chance of 1 in 4 succeeds ):
	...
	otherwise:					[standard anal sex w/Andrew]
		...
		if the player consents:
			...
			say "     As you fuck the wolf over the table, a few others around take notice for a little while but clearly aren't surprised or upset by it.  Clearly a regular appearance, especially from the black wolf, they don't interrupt your fun together.  A few other couples around do start up soon after though, adding to the experience.  You pound him vigorously while stroking him off, your hand very slick from the copious amounts of precum running down his dick and pooling on the table.  His inner walls rub over your sensitive shaft, moving and gripping around you to eventually drive you to a powerful orgasm that sends your hot seed deep into the gay wolf's asshole.  Feeling your hot load filling him[if cock width of player > 16] more and more as your oversized balls drain[otherwise if cock width of player > 8] as your large balls drain[end if], he howls in pleasure and cums hard, shooting his sticky load across the table and the back of the booth in another messy display.  As his last shots are firing, he starts lapping up a big puddle of it within reach.  After you pull out, he gives you a slobbery kiss that's rich with the taste of his semen and pats your ass in thanks for the nice fuck.";
			now lastfuck of Andrew is turns;
			andrewinfect;
		otherwise:
