...
to say sexwithAndrew:
	...
	if HP of Andrew is 0:
		...
		let randomcolourchoice be "gray ";
		let male1c be "";
		let male2c be "";
		let male3c be "";
		let male4c be "";
...
randomcolourlist is a list of text that varies. randomcolourlist is usually { "pink ", "red ", "green ", "blue ", "teal ", "yellow ", "white ", "black ", "purple ", "gray ", "maroon ", "golden ", "cyan ", "peach " }.
