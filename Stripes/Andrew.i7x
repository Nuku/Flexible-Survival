...
[		say "TEST:[line break]";
		...
		say "     Andrew's ears perk up at your suggestion and he dashes out of the booth. While you wait for him to return you remove your clothes, stripping down naked and sitting on the edge the booth, idly stroking your [cock of Player] [if Cock Count of Player > 1]cocks[else]shaft[end if]. After a bit you hear some excited chatter as Andrew comes back in, trailing behind him four other males. Looking at them you see that he brought a rather mixed group, and ready to go, judging by the bulges in their clothes. You beckon them closer and watch them strip off their clothes, eagerly getting naked to join the fun.";
		...
		if Player consents:
			...
			say "     As you fuck the wolf over the table, a few others around take notice for a little while but clearly aren't surprised or upset by it. Clearly a regular appearance, especially from the black wolf, they don't interrupt your fun together. A few other couples around do start up soon after though, adding to the experience. You pound him vigorously while stroking him off, your hand very slick from the copious amounts of precum running down his dick and pooling on the table. His inner walls rub over your sensitive shaft, moving and gripping around you to eventually drive you to a powerful orgasm that sends your hot seed deep into the gay wolf's asshole. Feeling your hot load filling him[if ball size of Player > 16] more and more as your oversized balls drain[else if ball size of Player > 8] as your large balls drain[end if], he howls in pleasure and cums hard, shooting his sticky load across the table and the back of the booth in another messy display. As his last shots are firing, he starts lapping up a big puddle of it within reach. After you pull out, he gives you a slobbery kiss that's rich with the taste of his semen and pats your ass in thanks for the nice fuck.";
			now lastfuck of Andrew is turns;
			andrewinfect;
		else:
