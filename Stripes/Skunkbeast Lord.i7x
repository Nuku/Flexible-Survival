...
when play ends:
	if skunkbeaststatus is 2:		[defeated by skunkbeast lord and made into slut slave]
		...
		stop the action;
	otherwise if skunkbeaststatus is 1 and bodyname of player is "Skunkbeast Lord":
		if humanity of player < 10:		[SUCCUMB]
			...
			if cocks of player > 0 and cunts of player is 0:	[MALE]
				...
				otherwise if ( franksex > 2 or frankmalesex > 2 ) and franksex >= frankmalesex:
			...
			otherwise if cocks of player > 0 and cunts of player > 0:	[HERM]
				...
				otherwise if ( franksex > 2 or frankmalesex > 2 ) and franksex > frankmalesex:
					say "     Having vague memories of another skunk you once knew in the city, you form a plan to capture him.  Coupling your bestial cunning with what you remember of his habits, you and several skunk girls lay a trap for him using soda and comics.  Once ensnared, the girls eagerly complete their work of turning him into another skunk girl for your harem.  Becoming a large, Rubenesque skunk, she is the best breeder in your harem, birthing larger litters and more often than any other.  Francine's mind does not fade away completely, but embraces her new life as a breeder slut.  Being too bloated to move from pregnancy most of the time, she spends most of her free time reading the comics you have the others collect for your favourite breeder.";
			otherwise if cocks of player is 0 and cunts of player > 0:	[FEMALE]
				...
				if franksex > 2 or frankmalesex > 2:
					say "     Having vague memories of another skunk you once knew in the city, you form a plan to capture him.  Coupling your bestial cunning with what you remember of his habits, you and several skunk girls lay a trap for him using soda and comics.  Once ensnared, the girls are eager to complete their work of turning him into another skunk girl, but you have other plans.  Following your instincts, you manage to transform him into a large, pudgy skunkbeast, who eagerly pounces and mates the buxom sluts.  He becomes your lieutenant and loyal mate, ensuring you maintain a long rule.  Among the skunkbeasts, the plump fellow is your favorite, allowing him to fill your womb with his hot seed often to breed more skunkbeasts.";
			otherwise:		[NEUTER]
				say "     Being a genderless skunkbeast lord, you act as guardian for the other skunkbeasts as they work to expand your numbers.  Following some hidden instincts, you are able to transform some of your favourites among the female sluts into new skunkbeasts.  Your numbers grow even further when the military try to move through the city.  Your might is capable of dealing with anything they throw at you and you always enjoy the spoils of your victories, creating many more sexy skunks from their fallen soldiers.  As overpopulation starts to become an issue, some of the other skunkbeasts break off with their harems of girls to leave the city and spread the glories of skunkdom to the rest of the world.";
				if franksex > 2 or frankmalesex > 2:
			...
			if franksex > 2 or frankmalesex > 2:
				...
				otherwise if cocks of player is 0 and cunts of player > 0:	[FEMALE]
					if franksex > 2 or frankmalesex > 2:
						say "     Over the course of the next few days of breeding, Frank gains a more feral skunk form.  While not fully a skunkbeast, he does pick up several of their traits and becomes a rather pudgy skunkbeast man.  Between rounds of fucking the girls, you have him mount you and breed you with more skunkbeasts in your womb.  Frank stays by your side, becoming a much desired lover for the skunk girls who come visit.  These girls soon learn to bring gifts of comics for the plump skunkbeast to earn his affections and Frank's new comic collect swells.";
					if skunk kit is tamed:
						say "     As your skunk kit matures into a skunkbeast, you allow it repeatedly, pumping you full of its hot seed and breeding more skunkbeasts in you.  The skunk girls adore it as well and he is among the most desirable of the skunkbeasts to be had.";
				otherwise:		[NEUTER]
					if franksex > 2 or frankmalesex > 2:
	...
	otherwise if cunts of player > 0 and ( franksex > 2 or frankmalesex > 2 ) and ( bodyname of player is "Skunk" or bodyname of player is "Skunk Taur" ):
	...
	otherwise if cunts of player is 0 and frankmalesex > 2 and ( bodyname of player is "Skunk" or bodyname of player is "Skunk Taur" ):
		let skunknumber be 1;			[Skunk]
		if bodyname of player is "Skunk Taur", now skunknumber is 2;
		if humanity of player < 10:
	...
	otherwise if skunk kit is tamed:
		if bodyname of player is "Skunk":
			...
			otherwise:
				if cunts of player > 0:
					say "     After your rescue, you manage to smuggle the little skunk kit out of the city with you. Its presence a constant comfort to you as you settle into your new life outside the city.  Eventually though like all kits will, it grows larger and stronger, and you have to work harder to hide it as you try to live life in the outside world.  Eventually though, when its size is close to that of the skunk beasts in the city, you realize its presence seems to be triggering something within you. Where before its presence triggered strong protective impulses, now its presence only serves to excite your body, a fact that seems to interest it more and more, until one day you find yourself panting in need when you catch his scent, and realize his presence has triggered your body to go into heat.  Seeing the skunk you raised in an entirely new manner, you crawl before him, and he sates himself on your eager body, instinct guiding him in how best to dominate you.  As you moan underneath the new skunkbeast, you know the roles have changed in your life for good now, and you are now the pet, while he is the master.  While at first no one can tell the difference, you soon buy yourself a proper collar to show your new status, and begin to plan ways to help your new master acquire more pets.  You just know they will love bearing skunk kittens just like you will...";
				otherwise:
		...
		otherwise if bodyname of player is "Skunk Taur":
			...
			otherwise:
				say "     After your rescue, you manage to smuggle the little skunk kit out of the city with you.  Your conjoined partner is wholeheartedly on board with this plan and helps you distract the military with her unusual nature, but refrains from too much sexual urging to keep them from worrying you're too infected to leave.  Your unusual body does prompt them to keep you for study longer than most, but eventually they have to release you to deal with more pressing problems.";
