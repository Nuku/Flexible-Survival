...
to say beattherodeoclown:
	if cocks of player > 0:
		...
		if libido of player > 25:
			...
			say "     Your hands move from her shoulders to her tits, stroking and teasing her large nipples. You play with them lightly at first, but after she squeezes her hands over yours, you play roughly with breasts, squeezing them hard and pinching her nipples firmly. The rough treatment excites her all the more and soon milk's squirting from her nipples as if you were milking a cow. As streams of her milk sprays onto you both, her cock throbs and starts spurting its thicker, white fluid across her body. The sight of all this, after the hard pounding you've been giving her wet pussy pushes you over the edge and you unleash your hot cum into her a few thrusts later with a groan of ecstasy[if cock width of player > 12]. Your over-sized balls pump their hot load into her, bloating her tummy delightfully full and plump with your semen[end if]. When you finally come down from your powerful orgasm, you release her and get up, leaving the exhausted herm in a messy puddle of fluids.";
		else:
...
when play ends:
	if bodyname of player is "Rodeo Clown":
		if humanity of player < 10:
			...
			say "     Aside from flings with many of your adoring fans, you find yourself becoming rather attached to a big, strong [if cunts of player > 0]bull man[else]cow woman[end if]. There's just something special about [if cunts of player > 0]him[else]her[end if] that just satisfies you like no other. You spend much of your time [if T is 1]between films[else if T is 2]in the off season[else]between tours[end if] with your bovine lover. When you finally get hitched, [if cunts of player > 0]he[else]she[end if] moves into your ranch house, keeping occupied with your small herd of cattle and a collection of lovers of [if cunts of player > 0]his[else]her[end if] own while you're away. And you're always welcoming you back with a powerful hug on your return.";
