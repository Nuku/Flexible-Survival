...
When Play begins:
	...
	now cock change entry is "it reforms into the shape of a human penis. It is very smooth and evenly pink, in a tone that's almost right, but a little too bright for normal flesh";
	now str entry is 12;
	now dex entry is 20;
	now sta entry is 16;
	now per entry is 14;
	...
	now CumItem entry is "rodeo clown cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
This is the Rodeo Clown Infection rule:
	if Player has a body of "Rodeo Clown":
		...
		if humanity of Player < 10:
			...
			say "     After being freed from the infected city by the military, you try a couple of mundane jobs, but they just don't hold the excitement you crave. Feeling the need to do something more daring, you [if T is 1]join up with a movie company as a stunt man. While you need some make-up and costume work to act as a stunt double, there are a few infected actors you can double for fairly well. You get most of your work from stunt driving and from playing the thug who gets thrown across the room in action scenes. A couple of the people you work with get pretty good at disguising you so you're not always the same, though you do get some fans who watch for your scenes. With your malleable body able to take the blows and cartwheel around in a room or from a wreck without serious injury, you are always able to make the hits you take seem all the more powerful, making for a far better show[else if T is 2]join up with a small rodeo, seeming almost a natural choice. You work hard to become a good rodeo clown, helping the thrown riders get to safety and making a fun show for the audience. And if you get hit... well, you can take it. Your body is quite resilient and flexible, able to take the rough blows from the angry bulls. The announcer is always there on hand to tell the folks in the audience that you're especially tough and can take it when you're hit. You get such big cheers from the crowd after you get back up after a big slam or stomping and head right back to your post, ready for more. And the show's just not the same if you don't get to take at least one good hit[else]start doing motorcycle stunts. You start with simple jumps for local events. But when you get better at it, you push it further and further. With your durable body, you have little fear aside from possible burns, and even those you seem to grow more resistant to over time. You push your daredevil stunts further and further, going for elaborate jumps and big spectacles to keep the fans coming back. You do well at this and are always considerate to play up your crashes a little, giving those watching the right balance of sympathy and hope for your recovery from such a devastating crash that... 'oh, will you ever ride again?' feeling. And then, after a nice, long recovery with some sexy nurses, you're back again for your triumphant comeback[end if].";
			say "     Aside from flings with many of your adoring fans, you find yourself becoming rather attached to a big, strong [if Player is maleinterested and (Player is female or Player is not femaleinterested)]bull man. There's just something special about him[else]cow woman. There's just something special about her[end if] that just satisfies you like no other. You spend much of your time [if T is 1]between films[else if T is 2]in the off season[else]between tours[end if] with your bovine lover. When you finally get hitched, [if Player is maleinterested and (Player is female or Player is not femaleinterested)]he[else]she[end if] moves into your ranch house, keeping occupied with your small herd of cattle and a collection of lovers of [if Player is maleinterested and (Player is female or Player is not femaleinterested)]his[else]her[end if] own while you're away, and always welcoming you back with a powerful hug on your return.";
