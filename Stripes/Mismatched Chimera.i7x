...
When Play begins:
	...
	add "Mismatched Chimera" to infections of BluntCockList;
	add "Mismatched Chimera" to infections of SheathedCockList;
	add "Mismatched Chimera" to infections of QuadrupedalList;
	add "Mismatched Chimera" to infections of FeralmindList;
	add "Mismatched Chimera" to infections of TailList;
	now Name entry is "Mismatched Chimera";
	...
	now face entry is "canine, rabbit-eared head"; [ Face description, format as "Your face is [Face of Player]." ]
	now body entry is "feline in form with bony spines protruding from your back"; [ Body Description, format as "Your Body is [Body of Player]." ]
	...
	now face change entry is "it becomes that of a dog, but with long rabbit ears"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
	now body change entry is "it becomes that of a humanoid feline with saurian back spines"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	now skin change entry is "it is covered in green scales over your body, but long white fur over your limbs"; [ Skin change text, format as "Your skin feels funny as [skin change entry]." ]
	now ass change entry is "a wet appendage starts to grow from it, shaping itself into an octopod's tentacle. It wiggles around behind you, largely beyond your control"; [ Ass/tail change text, format as "Your ass feels funny as [ass change entry]." ]
