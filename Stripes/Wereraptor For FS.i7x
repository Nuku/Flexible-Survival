...
When Play begins:
	...
	now skin entry is "deep blue and [if cocks of player > 0 and cunts of player > 0]dark crimson[else if cunts of player > 0]black[else if cocks of player > 0]green[else]pale gray[end if] scales";
	...
	now skin change entry is "scales spread across your skin, deep blue across your limbs and the front of your torso and [if cocks of player > 0 and cunts of player > 0]dark crimson[else if cunts of player > 0]black[else if cocks of player > 0]green[else]pale gray[end if] over your head and back";
