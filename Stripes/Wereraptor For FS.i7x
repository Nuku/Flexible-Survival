...
Instead of resolving a Paleontology Professor:
	...
	otherwise:
		...
		otherwise:
			...
			say "     You check the door and find it locked, but a scratchy voice responds to your presence.  'Help!  Trapped.  So weak,' it moans, faintly scratching at the wooden door from the inside.  It seems someone's become trapped.  Concerned that they may starve or dehydrate before rescue finally arrives, you should probably help them out.  Shall you let them out?";
			if the player consents:
...
to say losetowereraptor:
	if bodyname of player is "Wereraptor":
		...
		otherwise:
			...
			otherwise if anallevel > 1 and a random chance of 2 in 3 succeeds and cunts of player is 0:
