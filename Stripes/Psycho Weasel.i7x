...
When Play begins:
	...
	now Species Name entry is "Weasel"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now MilkItem entry is "psycho weasel milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "psycho weasel cum"; [ Item to be given to the player if they have this infection and jerk off. ]
