		...
		if humanity of Player < 10:
			...
			if FaceName of Player is "Cerberus":
				...
				if Player is impreg_ok:
					say "     Your large, canine body draws the interest of several infected canines and lupines and soon you have a collection of lovers and mates. You [if Player is male and Player is impreg_ok]sire and give birth to several large, canine pups over the years from[else if Player is male]sire a variety of large, canine pups with[else]give birth to several large, canine pups over the yours for[end if] various lovers and breeds. And while you sometimes feel as if something is missing, your large family and numerous lovers help fill that longing for companionship.";
