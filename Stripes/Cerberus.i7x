...
to say losetocerberus:
	setmonster "Cerberus";
	say "     [if HP of Player > 0]Drawn in by this herm canine's exotic body, you give in to her and offer yourself for her amusement. She runs her paws over her body and releases a chuckle that is partially a howl from all three heads. She takes you into her arms and runs her paws over your body, groping and fondling you as she slips off your clothes and backpack to better see what her new bitch has brought her to play with[else]Beaten by the strange, three-headed dog-beast, you are knocked to the ground. The three snarling heads sniff and nuzzle over you, inspecting their prize. You try to resist as those maws drool onto you, showing three vicious sets of teeth. The hermaphrodite canine pushes your legs apart with her large paws and sniffs at your crotch[end if].";
	if Player is herm:		[HERM]
		say "     The trio of heads bark happily at having found another herm to play with. They start licking at your face happily and she eagerly picks you up and starts rubbing her hard cock against you. Pushing you onto all fours, the three-headed beast mounts you and drives her large, canine cock into your pussy without delay. The dog heads howls happily and she takes your [Cock of Player] penis in one paw while fucking you like an animal. The central head bites down on the back of your neck while the other two take your upper arms, keeping you trapped beneath them while she fucks you with her cock-ended tail. Not that you could resist anyhow, with that wonderful cock pumping inside you and that doggy knot swelling and locking you like a bitch to the big dog creature atop you. Lost in the lustful pleasure of the wild fucking, you cum hard as the Cerberus herm pumps her seed into your womb, fully claiming you as her bitch. Your cum paints the ground beneath you as you're bred by your powerful lover.";
		...
		if HP of Player > 0:		[male submit]
			...
			CreatureSexAftermath "Player" receives "OralCock" from "Cerberus";
		else:				[male beaten]
...
to say beatthecerberus:
	...
	if FaceName of Player is "Cerberus":
		...
		if Libido of Player < libido entry:
			...
			raise Player Libido by ( libido entry - Libido of Player ) / 3;
		now godoggygo is true;
		...
		say "[line break]     [bold type]Shall you satisfy your lusts on her wondrous body?[roman type][line break]";
	...
	if godoggygo is true:
		...
		if Cock Count of Player > 2 and Cock Length of Player > 5:		[3+ COCKS ORAL]
			...
			say "[line break]     [bold type]Shall you have your three-headed bitch service your cocks with her many muzzles?[roman type][line break]";
			say "     ([link]Y[as]y[end link]) - Yes.";
			say "     ([link]N[as]n[end link]) - No.";
			if Player consents:
				LineBreak;
		...
		if Player is herm:			[HERM]
			say "[line break]     [bold type]Being dual-equipped yourself, would you prefer to slake your urges by fucking her or riding that hard cock between her legs?[roman type][line break]";
			...
			say "[line break]     [bold type]Do you want to slake your urges by fucking her or riding that hard cock between her legs?[roman type][line break]";
			say "     ([link]Y[as]y[end link]) - Fuck her.";
			say "     ([link]N[as]n[end link]) - Ride her cock.";
			if Player consents:
				LineBreak;
			...
			say "[line break]     [bold type]Do you want to slake your urges by having those slobbery dog tongues in your cunt[sfn] or do you want her meatier cock to fill you?[roman type][line break]";
...
to say cerberusride:
	let cerberusarousal be 0;
	if Player is male:
		if CockName of Player is "Cerberus":
			now cerberusarousal is 2;
		else if Libido of Player > 55:
			now cerberusarousal is 1;
...
to say cerberusdesc:
	...
	if BodyName of Player is "Anime Babe":
		say "     Your anime girl body, particularly vulnerable to tentacle attack, is entranced by the Cerberus's tail and cocktip, so like a tentacle eager to fill you. You moan and squeal in barely suppressed pleasure as that tail sways, quickly draining your resistance.";
...
When Play begins:
	...
	now skin entry is "[if looknow is true]a coat of short, coarse fur. It is as black as coal, covering your dark, rough[else][one of]dark[or]furred[or]black furred[at random][end if]";
	...
	now face change entry is "your neck and shoulders erupt into intense feelings of numbness and pinpricks. These feelings quickly shift into a burning fire as the impossible happens. Your upper shoulders actually widen as two lumps form at either side of your neck, growing and bubbling like a stew of flesh. You hear bones cracking and you find that you can't move your head as it is changing as well, becoming that of a broad-muzzled canine. Something brushes your cheeks as the lumps grow, [cerberusfacetf]";
	now body change entry is "your chest erupts into intense pain all of a sudden. You hear bones cracking and [cerberusbodytf]";
	...
	now MilkItem entry is "cerberus milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "cerberus cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
this is the cerberus rule:
	...
	if cerbmaulcount is 3:				[tries special attack every third time]
		...
		if monsterhit is true:
			choose row MonsterID from the Table of Random Critters;
			now cmdmg is ( wdam entry times a random number from ( 80 - ( peppereyes * 4 ) ) to 120 ) / 133; [dmg/hit at 75%]
			if HardMode is true and a random chance of 1 in ( 10 + peppereyes ) succeeds:
				now cmdmg is (cmdmg * 150) divided by 100;
				say "[italic type]Critical Hit![roman type] ";
...
This is the Cerberus Infection rule:
	if Player has a body of "Cerberus":
		...
		if humanity of Player < 10:
			...
			if FaceName of Player is "Cerberus":
				say "     With the help of your two other heads, you make your way back to the Museum and follow the scents down the halls to find a service door down into the basement. Tracking those scents easily with your three noses, you made your way down and find the Cerberus den, joining the others of your kind. You receive a very lustful welcome from the other three-headed dog people, who share triple-kisses with you. Soon enough, you are rolling around with them, mating one another. You [if Player is herm]take turns mounting them and being mounted, sometimes enjoying one bitch's pussy while another takes you as her bitch with her tailcock[else if Player is male]take turns mounting several of them, filling their hot pussies. You don't seem as popular as the fully herm Cerberuses that make up the bulk of the pack, but you still have plenty of sex[else]are taken as a bitch by most of the pack, filling your hot puss[yfn] over and over again. You don't seem as popular as the fully herm Cerberuses that make up the bulk of the pack, but you are still bred often[end if].";
			...
			if FaceName of Player is "Cerberus":
				...
				if Player is not neuter and Player is not sterile:
					say "     Your large, canine body draws the interest of several infected canines and lupines and soon you have a collection of lovers and mates. You [if Player is male and (Player is female or Player is mpreg_ok)]sire and give birth to several large, canine pups over the years from various lovers and breeds[else if Player is male]sire a variety of large, canine pups with various lovers and breeds[else]give birth to several large, canine pups over the yours for various lovers and breeds[end if]. And while you sometimes feel as if something is missing, your large family and numerous lovers help fill that longing for companionship.";
	else if FaceName of Player is "Cerberus" and Player has no body of "Hydra Beast":
		say "     [if humanity of Player < 10]As you succumb to the infection, your two silent heads start taking over more. But they have succumb as well to your changing instincts and seek to follow their lustful urges as well. You still remain the primary leader, but the others take control more often, usually when an idea for sex crosses their minds. Not that you really mind, as you share the enjoyment of their plans with them, often pleasantly surprised by the varied, kinky desires of the left one and by the wild, lustful urges of the right one. Thanks to them, your existence is a much more varied and pleasurable one than it may have else been[else]Your trio of heads draw some interest from the scientists who are working with the army. You are put through a series of psychological and awareness tests before the military personnel stop the research when they notice that it has ceased to be of worthwhile military application. It does have the benefit of helping you come to a greater understanding with your companion heads, increasing your cooperation. Better able to share your body with the mute, dependent pair, you are able to get on with your life with only the occasional interruption of control when one of them is feeling particularly strongly about something, which is usually sex of some kind[end if].";
