...
[	otherwise if hp of Zigor < 8:	]
	otherwise:
		...
		if hp of Zigor is 6 or ( hp of Zigor is 7 and a random chance of anallevel in 5 succeeds ):	[hp of 5 - buttplug training]
