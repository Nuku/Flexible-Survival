...
When Play begins:
	...
	now Species Name entry is "Quilled Tousky"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	add "Quilled Tousky" to infections of SheathedCockList;
	add "Quilled Tousky" to infections of BipedalList;
	add "Quilled Tousky" to infections of TailList;
	add "Quilled Tousky" to infections of TailweaponList;
	now Name entry is "Quilled Tousky";
	...
	now MilkItem entry is "quilled tousky milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "quilled tousky cum"; [ Item to be given to the player if they have this infection and jerk off. ]
