...
"Mall Rat"	"[PrepCombat_Mall Rat]"

to say PrepCombat_Mall Rat:
	setmongender 4;]
...
When Play begins:
	...
	now face entry is "that of a cute looking rat with a long, narrow muzzle and twitching whiskers. You've found a few rings and hoops to hang from your large, round ears. You find words like 'cool', 'rad', 'awesome', 'dude' and 'like' slipping into your vocabulary a lot more"; [ Face description, format as "Your face is [Face of Player]." ]
	now body entry is "that of a slender mall rat, with nicely trimmed [if Player is female]and painted [end if]nails on the end of your rat-like fingers. You find your body very cool looking and you want to totally find the trendiest new clothes to help show it off"; [ Body description, format as "Your body is [Body of Player]." ]
	...
	now MilkItem entry is "mall rat milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "mall rat cum"; [ Item to be given to the player if they have this infection and jerk off. ]
