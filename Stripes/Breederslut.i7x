...
"Breederslut"	"[PrepCombat_Breederslut]"

to say PrepCombat_Breederslut:
	setmongender 4;]
...
When Play begins:
	...
	now Species Name entry is "Breederslut"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Breederslut" to infections of CanineList;
	add "Breederslut" to infections of FurryList;
	add "Breederslut" to infections of NatureList;
	add "Breederslut" to infections of FemaleList;
	add "Breederslut" to infections of TaperedCockList;
	add "Breederslut" to infections of KnottedCockList;
	add "Breederslut" to infections of SheathedCockList;
	add "Breederslut" to infections of BipedalList;
	add "Breederslut" to infections of TailList;
	...
	now cock change entry is "it takes on a markedly canine shape. It keeps a soft, pinkish flesh tone while gaining a sheath as well. And while strangely appealing to you, you feel no immediate desire to put your new doggy dong to the test";
	now str entry is 8;
	now dex entry is 8;
	now sta entry is 8;
	now per entry is 8;
	...
	now MilkItem entry is "breederslut milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "breederslut cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
to say bsheat_trigger:
	say "You feel a growing warmth in your lower belly that makes you moan. As it grows stronger, you drop to your knees, feeling your pussy quiver and clench. Your crotch grows damp with pussy juices[if Cunt Depth of Player < 8 or Cunt Tightness of Player < 6] as it stretches and swells wider[end if] with a desire to breed. Thoughts of [if HP of Dominick > 3 and HP of Dominick < 60]Dominick[else]some studly canine you can't quite picture[end if] pounding you full of puppies fill your idle thoughts as you go into heat.";
