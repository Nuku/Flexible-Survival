...
When Play begins:
	...
	now body entry is "quite short, not even five feet tall, and with a cute, feminine build.  As a Shiba Inu, you've got an overall canine frame and, while bipedal, are quite comfortable moving down onto all fours (for presenting yourself).  You limbs are short and end in partially paw-like hands";
	...
	now body change entry is "you start to transform.  Shivers of pleasure run through you as your body is changed, becoming small and canine.  By the time it's done, you've become an cute and feminine Shiba Inu anthro";
