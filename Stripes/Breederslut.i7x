...
to say bsheat_trigger:
	say "     You feel a growing warmth in your lower belly that makes you moan. As it grows stronger, you drop to your knees, feeling your pussy quiver and clench. Your crotch grows damp with pussy juices[if Cunt Depth of Player < 8 or Cunt Tightness of Player < 6] as it stretches and swells wider[end if] with a desire to breed. Thoughts of [if HP of Dominick > 0]Dominick[else]some studly canine you can't quite picture[end if] pounding you full of puppies fill your idle thoughts as you go into heat.";
