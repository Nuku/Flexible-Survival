...
"Vulpogryph"	"[PrepCombat_Vulpogryph]"
...
When Play begins:
	...
	now Species Name entry is "Vulpogryph"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now defeated entry is "[NonCombatError]"; [beatthevulpogryph][ Text when monster loses. ]
	now victory entry is "[NonCombatError]"; [losetovulpogryph][ Text when monster wins. ]
	now desc entry is "[NonCombatError]"; [vulpogryphdesc][ Description of the creature when you encounter it. ]
	...
	now MilkItem entry is "vulpogryph milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "vulpogryph cum"; [ Item to be given to the player if they have this infection and jerk off. ]
