...
to say ResolveEvent Another Researcher:
	...
	if BodyName of Player is "Human" and the Player is pure:
		say "     'Hey there. I didn't think I'd come across another unchanged person out here. How are you making out? Pretty crazy out here, huh?' he asks cheerfully. You start to ask him what that was all about. 'Oh, I almost forgot. That's what I get for letting you distract me. One sec.' He pulls out a device from his pocket and pours a sample of the canine's semen into it. 'Good. That's another sample gathered and registered.'";
	else:
		say "     'Hey there. When I first saw you, I thought you might be another creature waiting its turn, but then I realized you weren't quite at that point yet. Pretty crazy out here, huh?' he asks cheerfully. You start to ask him what that was all about. 'Oh, I almost forgot. That's what I get for letting you distract me. One sec.' He pulls out a device from his pocket and pours a sample of the canine's semen into it. 'Good. That's another sample gathered and registered.'";
...
the scent of Mini-Lab is "     The basement [if HP of Sam is not 100]housing the research station smells strongly of dust and mildew, as well as dying traces of older smells from when the local teens would come here to drink[else]has a wet, musky scent hanging in the air. There are scents you recognize faintly as being from creatures you've encountered before, but the whole of that is largely buried beneath smells of sex and arousal[end if].".
...
to say minilabdesc:
	if HP of Sam <= 4:
		...
		if "cot" is listed in invent of Mini-Lab:
			say "     The basement itself isn't much to look at, having several broken bottles and lots of graffiti from having been used as a hang-out for the local kids. It looks like Sam's made some effort to clean it up, but mainly in the form of sweeping the trash into a few corners. Near the work area, there are two sleeping bags and some supplies, the second probably belonging to his now absent partner.";
		else:
			say "     The basement itself isn't much to look at, having several broken bottles and lots of graffiti from having been used as a hang-out for the local kids. It looks like Sam's made some effort to clean it up, but mainly in the form of sweeping the trash into a few corners. Near the work area, there is a sleeping bag and some supplies.";
	else:
...
to say samscent:
	...
	else if HP of Sam >= 10 and HP of Sam <= 12:
	...
	else if HP of Sam >= 30 and HP of Sam <= 32:
	...
	else if HP of Sam >= 50 and HP of Sam <= 52:
...
to say SamTalk:
	if HP of Sam is 1:
		...
		say "[line break]     [bold type]Shall you try slipping it to him or leave well enough alone?[roman type][line break]";
		...
		if Player consents:
			...
			say "     'What is this? What're you trying to slip me?' he asks, getting upset. 'This is from a nanite vial, isn't it?' he growls. Afraid he'll throw it away and you'll lose your chance, you grab the bottle from him. You try to force it to his mouth, insisting it's for his own good, but he growls and pushes you away[if number of collected people > 2]. The others move away, uncertain what's taking place and not yet prepared to take sides in the escalating fight[else if number of collected people is 2]. The other person moves away, uncertain what's taking place and not yet prepared to take sides in the escalating fight[end if]. You cap the bottle just in time before the enraged dragontaur charges.";
			WaitLineBreak;
		...
		say "[line break]     [bold type]Shall you try slipping it to her or leave well enough alone?[roman type][line break]";
		...
		if Player consents:
			...
			say "     'What is this? What're you trying to slip me?' she asks, getting suspicious. 'This is from a nanite vial, isn't it?' she yips. Afraid she'll throw it away and you'll lose your chance, you grab the bottle from her. You try to force it to her mouth, insisting it's for her own good, but she growls and pushes you away[if number of collected people > 2]. The others move away, uncertain what's taking place and not yet prepared to take sides in the escalating fight[else if number of collected people is 2]. The other person moves away, uncertain what's taking place and not yet prepared to take sides in the escalating fight[end if]. You cap the bottle just in time before the enraged vixentaur charges.";
			WaitLineBreak;
		...
		if a random chance of 1 in 3 succeeds and samformtalk is false:
			...
			say "     [one of]'I don't need to worry about feeding me. I can take care of myself,' the sexy vixen purrs.[or]'I'm much preferring this new body of mine. I wonder why I ever resisted changing in the first place.'[or]'I'm looking forward to finding some more males out there to breed kits in me,' she giggles.[or]'I managed to find that dog you saw me with that first day. Having him mount and fuck my vixen pussy was so much better than last time,' she giggles.[or][if number of collected people > 3]'I've already gathered samples from the others here,' she says. 'Not like that, silly!' she adds with a giggle. 'Just refined from blood samples they gave.'[else]'If you happen to rescue any others who've been transformed, I'll take samples from them as well.'[end if][or]'My resistance treatment still seems to be holding out despite my big change. That means I can have all the fun I like and still stay a sexy vixen taur.'[or]She runs a hand along your body. 'You should have some more fun with the horny vixen beast soon. [if Player is male]I can tell you want to stuff your cock inside me again[else]You just need to find yourself a cock and you can get to mounting me properly[end if],' she moans, pressing her furry melons against you while giving you a hug.[or]'There's a lot of sexy beasts out there. You should let a few more of them have their way with you. Then you can come back here and have your way with me, too. That way, we both get to enjoy it.'[or]'I think I'm in the mood to find a [if a random chance of 1 in 2 succeeds]male[else if a random chance of 1 in 2 succeeds]female[else]herm[end if] next time. Hopefully there's one around that I haven't tried before.'[or]'I make a pretty sexy Samantha, don't I?' she asks with a giggle, stretching her arms behind her head to show off her lovely breasts and perky, rosy nipples.[at random]";
...
Chapter 4 - Confrontation at the Mini-Lab
...
to assaultonminilab:
	...
	say "[line break]     [link]Help Sam (1)[as]1[end link], [link]watch the show (2)[as]2[end link], [link]steal supplies (3)[as]3[end link] or just [link]leave (4)[as]4[end link]?";
	now calcnumber is 0;
	...
	if calcnumber is 1:
		...
		[	say "     Realizing what he means, you turn to the overturned mess of his work area, trying to locate unbroken vials among the sticky mess without getting caught in it yourself. You are only able to find two intact in a during a quick search and grab them with a scrap of Sam's torn clothes. They are labelled as '[link]#143 - Dragon - Male[as]Y[end link]' and '[link]#039 - Pink Vixen - Female[as]N[end link]'. You've only got a moment to decide. Which one will you give him - the dragon (Y) or the vixen (N)?";
			...
			if Player is not neuter:
				say "     You cum several times as well, the wild show and the heady scent of musky sex exciting you greatly[if Player is male]. You stroke your pulsing meat, splattering your seed across the dirty floor as you drain your [Ball Size Adjective of Player] balls[end if][if Cunt Count of Player is 1]. With several fingers pumping into your wanton pussy, you finger yourself through repeated climaxes[else if Cunt Count of Player > 1]. With several fingers pumping into your wanton pussies, you finger yourself through repeated climaxes[end if]. As you see Rick finally finishing up, she dismounts from Sam, who's already starting to become visibly pregnant as her hyper-sexualized body rushes into action. The tigertaur purrs at this and rubs the swelling belly, turning to give you a rather predatory look as she pants to regain her breath. Rather than waiting to give her a chance to do the same to you, you grab your gear and make a break for it, leaving the two horny felines to enjoy their new life together. You make your way back to the library feeling very sexually satisfied and with your thoughts obsessing over the idea of becoming a horny sex monster like them. ";
			else:
				say "     As you see Rick finally finishing up, she dismounts from Sam, who's already starting to become visibly pregnant as her hyper-sexualized body rushes into action. The tigertaur purrs at this and rubs the swelling belly, turning to give you a rather predatory look as she pants to regain her breath. Rather than waiting to give her a chance to do the same to you, you grab your gear and make a break for it, leaving the two horny felines to enjoy their new life together. You make your way back to the library with your thoughts obsessing over the idea of becoming a horny sex monster like them. ";
			if Player is kinky:
				say "The scene you've just witnessed has left you feeling quite pleased and aroused at having indulged your kinky urges. After what you've seen, part of you longs to just accept becoming a horny creature of lust like them.";
				increase morale of Player by 3;
				raise Player Libido by 25;
			else:
				say "The scene you've just witnessed has left you feeling a little bad about being unable to help, but also aroused by the scene you just witnessed. After what you've seen, part of you longs to just accept becoming a horny creature of lust like them.";
		...
		if humanity of Player < 50 or Libido of Player > 50 or Player is kinky or Player is submissive:
			...
			say "[line break]     [bold type]Should give in to the tigertaur and have her claim you as a pet as well?[roman type][line break]";
			say "     ([link]Y[as]y[end link]) - Surrender.";
			say "     ([link]N[as]n[end link]) - Retreat.";
			if Player consents:
				LineBreak;
				say "     Wanting to be a part of the forming feline coalition, you shuck out of your clothes and then obediently head over to the tigertaur, your head cast down to show your submission. Grinning like mad, the tigertaur moves away from her new pet, reassuringly the other with a lick across her new snout, before stalking over to you with a smug air surrounding hirself. 'Well,' the tigertaur begins slowly as she walks around you. 'I think I can find room for you in my new streak, little one. Though first I think you and Sammie over there should become more [italic type]acquainted[roman type] with one another, if you catch my drift.' Looking up and nodding at your new mistress you eagerly head over to where Sammy is watching the both of you, the newly made hybrid busily rubbing her squirming stomach with one of her new paws. A feline smile crossing her face...";
				now surrender is true;
				wait for any key;
				...
				LineBreak;
				say "     Shaking your head as you wonder if you're losing your mind, which might very well have happened has you given in. Rather than waiting to give her a chance to do the same to you, you grab your gear and make a break for it, leaving the two horny felines to enjoy their new life together. You make your way back to the library with your thoughts obsessing over the idea of becoming a horny sex monster like them. ";
		else:
			say "     Rather than waiting to give her a chance to do the same to you, you grab your gear and make a break for it, leaving the two horny felines to enjoy their new life together. You make your way back to the library with your thoughts obsessing over the idea of becoming a horny sex monster like them. ";
		if surrender is false:
			if Player is kinky:
				...
				say "The scene you've just witnessed has left you feeling a little bad about letting that happen, but also aroused by the scene you just witnessed. After what you've seen, part of you longs to just accept becoming a horny creature of lust like them.";
				raise Player Libido by 10;
...
to say sexwithSam:
	if HP of Sam >= 1 and HP of Sam <= 4:
		...
		say "[if Player is male][samvixenfirsttime][else][samvixenoral][end if]";
		now HP of Sam is 32;
		now lastfuck of Sam is turns;
	else if HP of Sam is 32:
		say "[samvixenoral]";
		...
		if a random chance of 3 in 5 succeeds and BodyName of Player is listed in infections of TaurList: [taur]
			if Player is herm:
				say "[one of][samDVtaurfuck_top][or][samDVtaurfuck_bottom][purely at random]";
			...
			if Player is herm:
				say "[one of][samDVfuck_top][or][samDVfuck_bottom][purely at random]";
			else if Player is male:
				if ( anallevel > 1 and a random chance of 1 in 4 succeeds ) or ( anallevel is 3 and a random chance of 1 in 3 succeeds ):
					say "[samDVfuck_top]";
				else:
				...
				if Player consents:
					...
					if title entry is:
						...
						-- "Receive fellatio":
							say "[samDVoral2]";
						-- "Fuck Sammie":
							say "[one of][samDVfuck_bottom][or][samDVfuck2_bottom][purely at random]";
						-- "Fucked by Sammie":
						...
						-- "Mounted by Sammie":
							say "[samDVtaurfuck_top]";
						-- "Shrinking Shroom Oral":
							say "[SamShroomOral]";
						-- "Shrinking Shroom Anal":
							say "[SamShroomAnal]";
						-- "Shrinking Shroom Unbirth":
							say "[SamShroomUnbirth]";
						-- "Shrinking Shroom Cock":
							say "[SamShroomCock]";
			else:
				say "Invalid Option. Pick between 1 and [the number of filled rows in the table of fucking options].";

Section 2 - Dragon Sex
...
to say samdragonfuck:
	...
	WaitLineBreak;
	say "     You wrap your arms around his chest, pulling yourself down onto his cock again and again as he thrusts into you. 'Mmm... look at you... such a slut for a dragon cock. Wanting a proper fucking until you're stuffed full of my hot seed[if Player is female] and bred full of my whelps[end if],' he rumbles with a chuckle. You kiss and lick at his azure scales, lavishing attention on this sexy beast who's mating you. Lost in a haze of arousal, you can't help but agree with the dragontaur, your body lusting for the wondrous pleasure that you feel only his draconic cock can bring. Soon you're thrashing in [if Player is not neuter]orgasm beneath him, cumming over and over again as he drives his meat into you[else]delight beneath him, your body aching to feel his release since your genderless body cannot have one of its own[end if]. Your [if Player is male]spurting cock rubs against his smooth, firm scales, loving the feel of them pressed against you as your seed soaks you both[end if][if Player is female]pussy clenches and tugs at his cock, milking at it in wanton need as you orgasm repeatedly[else]tight hole clenches and tugs at his cock, squeezing firmly around it as you're awash with ecstasy[end if]. Your [bodytype of Player] body is sent into pleasure overload as the big taur drives hard into you one last time and releases his hot seed, blasting heavy spurts of thick semen into your [if Player is female]womb in an attempt to breed you[else]bowels, bloating your belly with his virile load[end if].[ovichance]";
	WaitLineBreak;
...
to say samdragontaurfuck:
	...
	say "     Lost in a haze of arousal, you can't help but agree with the dragontaur, your [bodydesc of Player] form lusting for the lustful pleasure of having the dragontaur mounting you like some beast. Soon you're grinding your hindquarters back against him [if Player is not neuter]as your orgasm washes through you, cumming over and over again as he drives his meat into you[else]in delight, your body aching to feel his release since your genderless body cannot have one of its own[end if]. Your [if Player is male]spurting cock spreads your seed across the ground beneath you in large, white splotches[end if][if Player is female]pussy clenches and tugs at his cock, milking at it in wanton need as you orgasm repeatedly[else]tight hole clenches and tugs at his cock, squeezing firmly around it as you're awash with ecstasy[end if]. Your [bodytype of Player] body is sent into pleasure overload as the big taur drives hard into you one last time and releases his hot seed, blasting heavy spurts of thick semen into your [if Player is female]womb in an attempt to breed you[else]bowels, bloating your belly with his virile load[end if].[ovichance]";
	WaitLineBreak;
...
to say samDVfirsttime:
	if Player is male:
		...
		say "     Sammie grins at your offer and takes a hold of you in his big, strong arms. 'Mmm... I've been looking forward to this since we got here.' She kisses you as best she can with her dracovixen muzzle, letting her tongue play across your lips before diving into your mouth. As her tongue explores your palate, she lowers you onto one of the cots. Her front paws knead over your [bodytype of Player] chest as she moves to climb atop you, murring in pleasure as she breaks the kiss to move into position. Her large, draconic cock is ready and waiting, dribbling precum across your loins as she climbs onto the strained cot. Placing her forepaws on your shoulders, she grips you firmly and lines his cock up before thrusting it slowly into you.";
...
to say samDVfuck_top:
	...
	WaitLineBreak;
	say "     You wrap your arms around her chest, pulling yourself down onto her cock again and again as she thrusts into you. 'Mmm... you look so sexy like that, riding my throbbing cock for all its worth. Wanting a proper fucking until you're stuffed full of my hot seed[if Player is female] and kits[end if],' she rumbles with a smile. You kiss and lick at her furry body, lavishing attention on this sexy beast who's mating you. Lost in a haze of arousal, you can't help but agree with the dragontaur, your body lusting for the wondrous pleasure that you feel only her hybrid cock can bring. Soon you're thrashing in [if Player is not neuter]orgasm beneath her, cumming over and over again as she drives her meat into you[else]delight beneath her, your body aching to feel her release since your genderless body cannot have one of its own[end if]. Your [if Player is male]spurting cock rubs against her fluffy fur, loving the feel of it sliding against you as your seed soaks you both[end if][if Player is female]pussy clenches and tugs at her cock, milking at it in wanton need as you orgasm repeatedly[else]tight hole clenches and tugs at her cock, squeezing firmly around it as you're awash with ecstasy[end if]. Your [bodytype of Player] body is sent into pleasure overload as the big taur drives hard into you one last time, pushing her thick knot into you. Once tied with you, she releases her hot seed, blasting heavy spurts of thick semen into your [if Player is female]womb in an attempt to breed you[else]bowels, bloating your belly with her virile load[end if].[DVimpregchance]";
	WaitLineBreak;
...
to say samDVtaurfuck_top:
	...
	say "     Lost in a haze of arousal, you can't help but agree with the dragontaur, your [bodydesc of Player] form lusting for the lustful pleasure of having the dragonvixentaur mounting you like some beast. Soon you're grinding your hindquarters back against her [if Player is not neuter]as your orgasm washes through you, cumming over and over again as she drives her meat into you[else]in delight, your body aching to feel her release since your genderless body cannot have one of its own[end if][if Player is male]spurting cock spreads your seed across the ground beneath you in large, white splotches[end if]. Your [if Player is female]pussy clenches and tugs at her cock, milking at it in wanton need as you orgasm repeatedly[else]tight hole clenches and tugs at her cock, squeezing firmly around it as you're awash with ecstasy[end if]. Your [bodytype of Player] body is sent into pleasure overload as the big taur drives hard into you one last time, tying her knot inside you and releases her hot seed, blasting heavy spurts of thick semen into your [if Player is female]womb in an attempt to breed you[else]bowels, bloating your belly with her virile load[end if].[DVimpregchance]";
	WaitLineBreak;
...
to say samDVfuck54:
	if Player is herm:
		...
		say "[line break]     [bold type]Shall you [link]fuck her (Y)[as]y[end link] or let her [link]fuck you (N)[as]n[end link]?[roman type][line break]";
...
Chapter 6 - Shrinking Shroom Content
...
to say SamShroom:
	if hunger of Sam is 0:	[First talk with Sam about shrinking shrooms]
		if MushroomCaveVisited is 1:	[Had visited the shrinking shroom site]
			say "     Sam waves a hand over the vials scattered around the shed. 'As you can see here, I've been busy collecting more samples, but I must admit that it's getting harder to find more unique specimens. If you happen to find anything interesting during your explorations, please let me know.'Recalling the miniaturized landscape that you found earlier, you tell Sam about it, which swiftly grabs the [if HP of Sam < 30]dragontaur's[else if HP of Sam < 50]vixentaur's[else]dracovixentaur's[end if] attention. 'Fascinating,' Sam responds. 'And you believe that this shrunken area has something to do with nanites and radiation? This is definitely something that I need to look into. You wouldn't happen to have brought back a sample from that area, would you?'";
			if glowing mushroom is owned:
				say "[line break]     [bold type]Do you give a glowing mushroom to Sam?[roman type][line break]";
			...
			say "     Sam waves a hand over the vials scattered around the shed. 'As you can see here, I've been busy collecting more samples, but I must admit that it's getting harder to find more unique specimens. If you happen to find anything interesting during your explorations, please let me know.'You tell the scientist that you'll keep an eye out for anything of interest.";
...
to vixentaur_active:
	if "Vixentaur" is a Name listed in Table of Random Critters:
		now non-infectious entry is false;
		now area entry is "Outside";

to dragontaur_active:
	if "Dragontaur" is a Name listed in Table of Random Critters:
		now non-infectious entry is false;
		now area entry is "Outside";

to DVtaur_active:
	if "Dracovixentaur" is a Name listed in Table of Random Critters:
		now non-infectious entry is false;
		now area entry is "Outside";
...
to SamUBBind:
	...
	while Trixieexit is false:
		...
		if humanity of Player < 1:
			...
			say "Sanity: [humanity of Player]/100  Lust: [lustatt]/100  Hunger: [hunger of Player]  Thirst: [thirst of Player]  Struggle: < [bracket]-[if struggleatt > 0]X[else]-[end if][close bracket]";
...
to SamCockBind:
	...
	while Trixieexit is false:
		...
		if humanity of Player < 1:
			...
			now enduring is false;
			say "     You're within one of Sam's balls. [one of]Musky taur cum covers every inch of you, making your head swim with lust[or]You can hear the taur moan happily from how you're filling them so delightfully[or]'I know that I've probably said this more than a few times, but it feels so good having you inside of me,' Sam says[at random]. You can [bold type]S[roman type]truggle to let Sam know that you want to be let out, [if obliging is true][bold type]O[roman type]blige[else][bold type]A[roman type]bide[end if] to Sam's ball, [if boundrecover is true][bold type]R[roman type]ecover from[else][bold type]E[roman type]ndure[end if] to try and stay inside of the taur for as long as you can.";
			say "[bold type]1[roman type] - [link]Struggle[as]1[end link][line break]";
			say "[bold type]2[roman type] - [link][if obliging is true]Oblige[else]Abide[end if][as]2[end link][line break]";
			say "[bold type]3[roman type] - [link][if boundrecover is false]Endure[else]Recover[end if][as]3[end link][line break]";
			say "Sanity: [humanity of Player]/100  Lust: [lustatt]/100  Hunger: [hunger of Player]  Thirst: [thirst of Player]  Struggle: < [bracket]-[if struggleatt > 0]X[else]-[end if][close bracket]";
...
This is the Rick's Lil Playthings rule:
	if ending "Rick's Lil Playthings" is triggered:
		say "     Having given yourself over to Rick, you and Sammie are made into lovely hybrid feline hexataurs for the dominant tigertaur to use and whelp whenever she chooses to do so, which she does quite a lot given that she's made the former lab into her new den. Very rarely does either your or Sammie's bellies stay flat as the lustful tigertaur spends many a day filling the two of you with her cubs, all of whom grow up into being exotic hybrid felinetaurs like their [']mothers[']. And having two conjoined taur bodies, each with a womb of its own, you breed and whelp quite the pride of sexy kittens.";
