Version 1 of Masturbate by Stripes begins here.
...
instead of using porn collection:
	...
	otherwise:
		...
		if the player consents:
			say "[simplemast]";
		otherwise:
			say "     You settle yourself down to really enjoy some personal time and relieve your excess arousal.  You pull out a selection of the hard core magazines and begin playing with yourself[if breast size of player > 8].  You start by rubbing over your [bodyname of player] body and playing with your nipples and teasing your huge breasts, running your fingers over their sensitive flesh[otherwise if breast size of player > 5].  You start by rubbing over your [bodyname of player] body and playing with your nipples and teasing your large breasts, running your fingers over their sensitive flesh[otherwise if breast size of player > 2].  You start by rubbing over your [bodyname of player] body and playing with your nipples and teasing your large breasts, running your fingers over their sensitve flesh[otherwise].  You start by rubbing over your [bodyname of player] body and teasing your nipples[end if][if breasts of player > 2].  You lavish attention upon each pair in turn, helping to get yourself wound up for a bigger release[end if].";
			...
			otherwise if cocks of player > 0:
				say "     You take hold of your [if cocks of player is 1]cocks and start playing with them[otherwise]cock and start playing with it[end if].  You stroke your [cock size desc of player] [cock of player] [if cocks of player is 1]shaft[otherwise] slowly at first, pleasing yourself as only you can, knowing just what feels right.  Precum dribbles down your meat to get spread over it as you stroke yourself.  You move a hand away from time to time to rub your [ball size], feeling the pressure build up in them.";
				if companion of player is mouse girl:
					say "     As you continue to play with yourself, your mind wanders to thinking of sexy mice and all the fun things you could do with them.  Glancing over, you spot Rachel sitting nearby, playing with herself as she watches you.  She grins at you knowingly as fresh images of you surrounded by horny mice fill your mind.  Moaning, you become even more aroused and play with yourself even more vigorously.  You even start to share in the mouse girl's sensations as well.";
