...
to say ebheat_mtrigger:
	say "     A euphoric warmth in your lower belly makes you moan in pleasure and drop to your knees.  You can feel an empty yearning in your ass.  Your anus and rectum shifts and relaxes as it becomes more accommodating in preparation.  Thoughts of romping bunnies[if ovipreglevel > 1] and colourful eggs[end if] fill your idle thoughts as you go into a strange male heat.";
...
to say ebheat:
	...
	otherwise if ebheat_egg > 9 and ebheat_msg is true and Micaela is visible and ( lastfuck of Micaela - turns ) >= 9 and a random chance of libido of player in 150 succeeds:
		setmonster "Easter Bunny";
		choose row monster from the table of random critters;
		say "[line break]";
