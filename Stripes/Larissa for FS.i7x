...
to say Larissasex_taurMF:
	...
	if cock length of Larissa > ( ( cunt length of player * 2 ) + cunt width of player + 2 ):			[super-big]
		say "     [possadj_cap of Larissa] [cock size desc of Larissa] [cock of Larissa] penis is too large [if cunt length of player >= 12]even [end if]for your [cunt size desc of player] pussy, so [subjpro of Larissa] satisfies [objpro of Larissa]self by rubbing [possadj of Larissa] maleness down against you, grinding it across your juicy folds[if cocks of player > 0], throbbing shaft[smn] and tauric backside[otherwise] and tauric backside[end if][if breast size of player > 0].  [subjpro_cap of Larissa] moves [possadj of Larissa] hands to your breasts, cupping your [short breast size desc of player] bosom, caressing and teasing your breasts and nipples[end if].  Turning your head to the side, you press your lips to [posspro of larissa] in a kiss while moaning in pleasure while [subpro of larissa] works that [cock of Larissa] manhood against you.  You feel spurts of [possadj of Larissa] precum leak out onto you and kiss [objpro of Larissa] all the more excitedly.";
	...
	otherwise if cock length of larissa > ( cunt length of player + cunt width of player + 2 ):			[large]
		say "     [possadj_cap of Larissa] [cock size desc of Larissa] [cock of Larissa] penis is quite large compared to your [cunt size desc of player] pussy, necessitating that [subjpro of Larissa] start slowly as [subjpro of Larissa] thrusts into those wet folds of yours, making a visible bump in your underbelly from having [possadj of larissa] [cock size desc of Larissa] rod stuffed in you[if breast size of player > 0].  [subjpro_cap of Larissa] moves [possadj of Larissa] hands to your breasts, cupping your [short breast size desc of player] bosom, caressing and teasing your breasts and nipples[end if].  Turning your head to the side, you press your lips to [posspro of larissa] in a kiss while moaning in pleasure while [subpro of larissa] works that [cock of Larissa] manhood further into you.  Once you've loosened up enough, you push back into her thrusts and urge [objpro of larissa] to fuck you faster and harder between kisses.
