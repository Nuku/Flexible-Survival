...
instead of conversing Larissa:
	...
	otherwise if hp of Larissa is 0 and hp of doctor matt is not 17:
		...
		if zephyrtask is 0:
			...
			otherwise if girl is not banned:
				say "     She flips through a few papers on her desk, trying to find something.  'We've also been experiencing a bit of a pest problem.  Some of those city sprite creatures have been harrassing us.'  She holds a photo of a cluster of fairy-winged girls hovering in the air.  Several of them are sticking out their tongues or otherwise making faces at the camera.  'The guards are able drive them off easily enough, but it does upset the other customers.  We're in the business of helping you, but we'll need some help to do that.  If you could go beat up some of them around here, it might discourage them from coming around again.  We'd appreciate your assistance and will reward you for the completion of the task.'";
				now zephyrtask is 3;
				now zephyrpests is 0;
...
to say Larissasex_FM:
	...
	otherwise if cock length of larissa > ( cunt length of player + cunt width of player + 2 ):			[large]
		say "     [possadj_cap of Larissa] [cock size desc of Larissa] [cock of Larissa] penis is quite large compared to your [cunt size desc of player] pussy, necessitating that [subjpro of Larissa] start slowly as [subjpro of Larissa] thrusts into those wet folds of yours, making a visible bump in your belly from having [possadj of larissa] [cock size desc of Larissa] rod stuffed in you[if breast size of Larissa > 0 and breasts of Larissa > 0].  You move your hands up to [possadj of Larissa] lovely [breast size desc of Larissa] breasts, caressing them and teasing [possadj of Larissa] nipples[otherwise].  You move your hands up to [possadj of Larissa] lovely [bodytype of Larissa] body, caressing [possadj of Larissa] [bodytype of Larissa] form[end if].  Pressing [possadj of Larissa] [mouth of Larissa] to your lips, [subjpro of Larissa] kisses you with a soft moan of pleasure.  Once you've loosened up enough, you slide a hand down to rub [possadj of larissa] [Larissaballs] and urge [objpro of larissa] to fuck you faster and harder between kisses.";
	...
	otherwise:		[compatible size - normal]
		say "     [subjpro_cap of larissa] slides [possadj of Larissa] [cock size desc of Larissa] [cock of Larissa] penis into your [cunt size desc of player] pussy, enjoying the wonderful sensation of you squeezing down around [possadj of Larissa] maleness[if breast size of Larissa > 0 and breasts of Larissa > 0].  You move your hands up to [possadj of Larissa] lovely [breast size desc of Larissa] breasts, caressing them and teasing [possadj of Larissa] nipples[otherwise].  You move your hands up to [possadj of Larissa] lovely [bodytype of Larissa] body, caressing [possadj of Larissa] [bodytype of Larissa] form[end if].  Pressing [possadj of Larissa] [mouth of Larissa] to your lips, [subjpro of Larissa] kisses you with a soft moan of pleasure.  As [subjpro of Larissa] fucks you, you slide a hand down to rub [possadj of larissa] [Larissaballs] and urge [objpro of larissa] to fuck you faster and harder between kisses.";
...
to say Larissa post-tf:
	...
	if cocks of player > 0 or cunts of player > 0:
		...
		now lastfuck of Larissa is turns;
	otherwise:
		say "     You get [objpro of Larissa] to lie back on the cot while you run your hands over [possadj of Larissa] new [form of Larissa] body.  Still very aroused from her transformation, she's soon moaning in pleasure as you help acquaint [objpro of Larissa] with [possadj of Larissa] body's changes[if breast size of Larissa > 0 and breasts of Larissa > 2].  You bring your lips to her bosom and start kissing her numerous breasts and sucking on her nipples[otherwise if breast size of Larissa > 0].  You bring your lips to her bosom and start kissing her breasts and sucking on her nipples[otherwise].  You bring your lips to her [mouth of Larissa] and kiss her, welcoming her [form of Larissa] tongue into your mouth.";
		if cunts of larissa > 0 and cocks of Larissa > 0:
			say "     Meanwhile, your hands have made their way down to her [cock size desc of Larissa] [cock of Larissa] cock and [cunt size desc of Larissa] pussy.  You slide your fingers over them both, stroking, pumping and fingering until she cums with a load moan of delight[if cock width of Larissa >= 40].  Her excessive load makes a considerable[otherwise if cock width of Larissa >= 20].  Her large load makes a big[otherwise].  Her spurting shaft makes a sticky[end if] mess which you both have fun cleaning up before she heads back out front to show off her new body to her coworkers before returning to her desk.";
		otherwise if cunts of Larissa > 0:
			say "     Meanwhile, your hand make their way down to her [cunt size desc of Larissa] [bodytype of Larissa] pussy.  You slide your fingers over dripping folds, pumping into them and fingering her until she cums with a load moan of delight[if cunt length of Larissa + cunt width of Larissa >= 40].  Her gushing juices soak both of your lower bodies in a tasty[otherwise if cunt length of Larissa + cunt width of Larissa >= 20].  Her flowing juices soak her crotch and your arm in a tasty[otherwise].  Her hot juices soak her crotch as your hand in a tasty[end if] mess which you both have fun cleaning up before she heads back out front to show off her new body to her coworkers before returning to her desk.";
		otherwise if cocks of Larissa > 0:
			say "     Meanwhile, your hands have made their way down to his [cock size desc of Larissa] [cock of Larissa] cock.  You slide your fingers over it, stroking and pumping until he cums with a load moan of delight[if cock width of Larissa >= 40].  His excessive load makes a considerable[otherwise if cock width of Larissa >= 20].  His large load makes a big[otherwise].  His spurting shaft makes a sticky[end if] mess which you both have fun cleaning up before he heads back out front to show off his new body to his coworkers before returning to his desk.";
		otherwise:
...
This is the Larissa cockdesc rule:
	...
	otherwise if cock length of Larissa is less than 13:
