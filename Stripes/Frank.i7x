...
Instead of resolving a Mephitness:
	...
	say "     They all seem quite distracted and haven't spotted you.  And that backpack is just sitting there.  Given how much he's already changed, there may not be much point in trying to help him and it may be best to get the supplies.  Do you take this opportunity to charge to the [link]rescue (Y)[as]y[end link] or do you grab the [link]backpack (N)[as]n[end link] and make a run for it?";
	if player consents:
...
to say sexwithFrank:
	...
	otherwise if cunts of player is 0 and cocks of player > 0:
		say "[Frank_MM_sex00]";
	otherwise if lastfuck of Frank - turns is less than 8:
...
to say Frank_MF_sex00:
	...
	if remainder after dividing franksex by 3 is 1:
		...
		otherwise if specskunkstate is 2:			[Skunkbeast Lord]
