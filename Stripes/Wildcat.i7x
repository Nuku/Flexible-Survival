...
to say losetowildcat:
	...
	if Player is female and Cunt Depth of Player > 7 and a random chance of 1 in 2 succeeds:
	...
	else if (scalevalue of Player > 2 or player is twistcapped) and ((Player is female and anallevel is 3) or Player is not female) and ((anallevel is 3 and a random chance of 1 in 2 succeeds) or (anallevel is 2 and a random chance of 1 in 4 succeeds)):
		...
		if Libido of Player > 45 and Player is not neuter:
			say "     [if showlocale is true and scalevalue of Player < 5]Car loudly creaking against[else]Frame ground firmly against the earth as it abides[end if] the feline's rising fervor, [if scalevalue of Player < 3]the ponderous scale of her dick bulges visibly from your tiny frame[else if scalevalue of Player is 3]you can barely contain the ponderous scale of her dick[else]her dick's soft barbs torment you further[end if] as she continues to pound your stuffed tailpipe. [if HP of Player < 1 and Player is not submissive]Howling in wanton passion, you writhe impotently against her tightening hold, compelling within you a fear that you might suffocate. This persistent, wild abuse[else]Nursing from her impressive offerings, her tainted, rust-tinged cream only compels your wanton desire further. This persistent, wild sex[end if] continues for some measure of time before you cry out in bliss, [if Player is male]your own, [cock size desc of Player] cock[smn] staining her soft fur with your wasted seed[else][cunt size desc of Player] cunt[sfn] oozing your spent honey, staining her soft fur[end if], and compelling your [if HP of Player < 1 and Player is not submissive]captor[else]mate[end if] to follow suit, bowels rapidly flooded with a torrent of the beast's thick, virile cum.";
		else:
			say "     [if showlocale is true and scalevalue of Player < 5]Car loudly creaking against[else]Frame ground firmly against the earth as it abides[end if] the feline's rising fervor, [if scalevalue of Player < 3]the ponderous scale of her dick bulges visibly from your tiny frame[else if scalevalue of Player is 3]you can barely contain the ponderous scale of her dick[else]her dick's soft barbs torment you further[end if] as she continues to pound your stuffed tailpipe. [if HP of Player < 1 and Player is not submissive]Howling in wanton passion, you writhe impotently against her tightening hold, compelling within you a fear that you might suffocate. This persistent, wild abuse continues for some measure of time before your captor[else]Nursing from her impressive offerings, her tainted, rust-tinged cream only compels your wanton desire further. This persistent, wild sex continues for some measure of time before your mate[end if] moans out in bliss, bowels rapidly flooded with a torrent of the beast's thick, virile cum[if Player is male], compelling you to soon follow suit, your own, [cock size desc of Player] cock[smn] staining her soft fur with your wasted seed[else if Player is female], compelling you to soon follow suit, [cunt size desc of Player] cunt[sfn] oozing your spent honey, staining her soft fur[else], tormenting you with your own, barely satiable need[end if].";
		...
		if HP of Player > 0 or Player is submissive:
			say "     Shifting to sit atop you[if showlocale is true and scalevalue of Player < 5], the car sags further under the burden of her weight as[end if] you are offered up a much more intimate presentation of the feline's impressive tool, already oozing beads of her thick fluids in excitement. [if scalevalue of Player < 4]The thing is rather intimidating for someone of your size, but your caution is only brief before you're[else]Proud rod offered before you, you're almost immediately[end if] compelled to caress along its throbbing length with your tongue, beast offering up a soft purr as regard for your wanton affection. Eventually, you're compelled to envelop the dick's head within your lips [if scalevalue of Player > 3]with much[else if scalevalue of Player is 3]with some[else]without[end if] difficulty, tainted, heady musk compelling [if Player is not neuter]you into arousal[else]your own, insatiable lust[end if].";
		else:
			say "     Shifting to sit atop you[if showlocale is true and scalevalue of Player < 5], the car sags further under the burden of her weight as[end if] you are offered up a much more intimate presentation of the feline's impressive tool, already oozing beads of her thick fluids in excitement. Instinctively, you try to push your free of her oppressive weight, compelling your captor to pull your head firmly against you, sharp talons tracing the back of your neck in illustration of what might follow should you fail to comply. Eventually, you're forced to envelop the dick's head within your lips [if scalevalue of Player > 3]with much[else if scalevalue of Player is 3]with some[else]without[end if] difficulty, tainted, heady musk compelling [if Player is not neuter]you into arousal[else]your own, insatiable lust[end if].";
...
When Play begins:
	...
	now Species Name entry is "Wildcat";
	add "Wildcat" to infections of FelineList;
	add "Wildcat" to infections of FurryList;
	add "Wildcat" to infections of NatureList;
	add "Wildcat" to infections of HermList;
	add "Wildcat" to infections of BarbedCockList;
	add "Wildcat" to infections of SheathedCockList;
	add "Wildcat" to infections of BipedalList;
	add "Wildcat" to infections of TailList;
	now Name entry is "Wildcat"; [ Infection/Creature name. Capitalized. ]
	now enemy title entry is "Giant Wildcat";
	...
	now defeated entry is "     Managing several strong hits on the armored feline, you force her back. She growls makes to swing at you again, but then pounces ten feet up onto a pile of junk, then leaps off somewhere on the other side, making her escape.[line break]";
	now victory entry is "[losetowildcat]";
	now desc entry is "     [if showlocale is true]Emerging from a pile of junk, rises[else]You are suddenly ambushed by[end if] a looming, feline form. This gigantic feline is over seven feet tall and about five wide at the shoulders, [if scalevalue of Player < 4]it towers over your smaller form[else if scalevalue of Player > 4]it's clearly the largest thing around here, smaller to you as it may be[else]it approximately matches your own size[end if]. Her head is shaped much like a housecat's, but much larger and more feral. She has some striped markings and [one of]a notched ear[or]a scarred muzzle[or]a scratched nose[or]is using a Buick hood ornament as an eyepatch[at random]. The big kitty has loose pieces of junk, mostly car panels, parts and hubcaps strapped on to act as both camouflage and armor over her brown and rust-colored fur. She has warped and bent a car hood into a chestplate, covering her large breasts and midriff. Given the marks on it and the size of her massive paws, she probably did it by hand. Looking down further, you spot another bulging plate between her legs. Given you experience with creatures in this city, you don't need to see underneath it to know what's waiting there for you if this wildcat has her way.[line break]";
	...
	now cock change entry is "it shifts and turns a rust red color as it takes on a feline shape and gains soft, stimulating barbs";
	now str entry is 22;
	now dex entry is 18;
	now sta entry is 18;
	now per entry is 14;
	...
	now MilkItem entry is "wildcat milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "wildcat cum"; [ Item to be given to the player if they have this infection and jerk off. ]
