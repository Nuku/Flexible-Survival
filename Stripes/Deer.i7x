...
instead of conversing the Susan:
	...
	if hp of Susan < 2:
		...
		otherwise if deerconsent is 1:
			...
			say "     [line break]";
			say "     ([link]Y[as]y[end link]) - You do agre to be the little herm's mate.";
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if player consents:
				...
				if nam is "Fuck Susan":
					say "[SusanSex1]";
				otherwise if nam is "Fuck Susan with your small penis":
					say "[SusanSex2]";
				otherwise if nam is "Hyper fuck":
					say "[SusanSex3]";
				otherwise if nam is "Hyper fun":
					say "[SusanSex4]";
