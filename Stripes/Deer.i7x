...
when play ends:
	if bodyname of player is "Deer":
		if humanity of player < 10:
			...
			if Susan is in primary lab:
				if cocks of player > 0 and "Sterile" is not listed in feats of player:
