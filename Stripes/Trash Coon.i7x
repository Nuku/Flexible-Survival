...
to say losetotrashcoon:
	...
	if Player is male:
		...
		CreatureSexAftermath "Trash Coon" receives "OralPussy" from "Player";
...
When Play begins:
	...
	now ass change entry is "your hips grow wide and your ass becomes a plump and padded booty. There is a pulsing throb from your tailbone as it reshapes itself, growing out into an unkempt raccoon tail"; [ Ass/Tail TF text, format as "Your ass tingles as [tail change entry]." ]
	...
	now MilkItem entry is "trash coon milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "trash coon cum"; [ Item to be given to the player if they have this infection and jerk off. ]
