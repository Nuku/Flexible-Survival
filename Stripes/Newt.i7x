	...
	if Player is male:
		...
		if a random chance of 1 in 3 succeeds:
			...
			if a random chance of 1 in 2 succeeds:
				...
				say "     After the first few blasts, Anastasia pulls back, letting your cum splatter across her beak and fiery feathers. Moving over, she lets Newt have a turn [if ball size of Player > 16]under the fountain of semen[else]receiving a few splatters as well[end if]. Draining your [ball size] across the two of them, the phoenix takes the final lick while the salamander's long, slimy tongue sets to work cleaning their faces. This turns into sloppy kisses between the two fiery females while you finger them both to moaning orgasms.";
	else:
