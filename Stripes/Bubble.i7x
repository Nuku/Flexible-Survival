...
to say bubblesex01:
	if Libido of Bubble is 0:
		...
		say "     Cushioned by her padded body, you're supported easily by her inflatable form. Feeling her pressed beneath you, her buxom breasts rub against your [if Breast Size of Player > 0]own[else]chest[end if]. Your weight doesn't seem to bother her, her balloon-like body simply compressing or swelling to accommodate your movements. Her embrace conforms to you, ensuring you are always comfortable as you rail into that juicy pussy of hers.";
	...
	NPCSexAftermath Bubble receives "PussyFuck" from Player;
...
to say bubblesex08:
	...
	if Player is male:
		...
		NPCSexAftermath Bubble receives "DildoPussyFuck" from Player;
...
to say bubblesex12:
	...
	decrease Ball Size of Player by Ball Size of Player / 5;
