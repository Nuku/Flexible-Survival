...
to say bubblesex08:
	...
	if cocks of player > 0:
		...
		say "     By the time she's a buxom, rounded vixen, she's crying out in orgasmic delight. With her latex cunny squeezing and quivering around your fingers, you push a few final big lungfuls of air into her. Panting a feeling a little woozy from your efforts, you pinch off the air nozzle and seal it up before any air can leak out. After you slide your fingers free and stand back up, she turns around and [if cunts of player > 0]licks your pussy to a dizzying orgasm of your own[else]gives your bare crotch a thorough licking in return[end if]. She bounds to her feet so she can look over her new, rounded figure. 'Ooo! Now there's more of me to love,' she giggles, giving you a big hug and a sloppy kiss before bounding off [if the number of booked people + the number of bunkered people > 2]to show the others[else]to have some fun[end if].";
...
to say bubblesex12:
	...
	if cocks of player > 0:
		...
		say "     With both of you squeezing your body and rubbing your oversensitive latex hide, you're gradually deflated. Your ass returns to a cute bubble butt and your belly slims down[if breast size of player > 1]. The extra buoyancy in your breasts is also removed through a lot of playful rubbing, squeezing and licking of them[end if]. By the time your [if cunts of player > 0]hourglass figure[else]slender physique[end if] is restored, you're crying out in [if cunts of player > 0]orgasmic release, feeling the last of the over-inflation passing from your body into your tail even as your cunt spasms in delight[else]unfocused release, feeling the last of the over-inflation passing from your body into your tail[end if]. Crying out with her own release, she sags down atop out, pressing your tail between the two of you. This forces out the last of the excess gas still in it. 'Ooo! Don't you look sexy now,' she says before licking your air nozzle and closing it up for you.";
