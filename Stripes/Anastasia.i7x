...
to say Anastasiasex05a:		[basalt dildo - female/herm]
	...
	NPCSexAftermath Player receives "DildoPussyFuck" from Anastasia;
...
to say Anastasiasex05b:		[basalt dildo - male/neuter]
	...
	if Player consents:
		...
		NPCSexAftermath Player receives "DildoAssFuck" from Anastasia;
	else:
		...
		NPCSexAftermath Anastasia receives "DildoPussyFuck" from Player;
