...
to say ResolveEvent Captured Bird:
	...
	say "[line break]     [bold type]Will you save the bird?[roman type][line break]";
...
to say ResolveEvent FireAndIce:
	...
	WaitLineBreak;
	say "     The giant lizard is more like a wingless dragon. Ground to shoulder, it was as tall as a man, even while on all fours. Its claws dig into the street with each step as its glowing yellow eyes look towards you with an animalistic hunger. Between the creature's legs, as you would expect by now, is a fully erect, footlong draconic cock, dripping with desire. His white and blue scaled body moves with grace and power as he looks over you. 'I had hoped... you would be... more of a challenge, my prey,' the frost drake speaks softly as it places a claw gently against your chest, making you feel a new surge of that unnatural cold.";
...
after going up from Volcanic Cave:
	try looking;
...
an everyturn rule:
	if HP of Anastasia is 4 and lastfuck of Anastasia - turns >= 16 and player is not in the Volcanic Cave and the player is not in the Volcanic Crater:
		say "[line break]You recall the phoenix egg you left at the volcanic crater and remind yourself to go and check on it soon.";
...
Description of Anastasia is "     The phoenix reborn looks much as she did in her last incarnation, fully avian in form and as tall as a normal human being when upright. She has rich red and golden plumage over her hawk-like body. The edges of her wings tail feathers dance with a softly glowing flame. Her golden eyes look towards you[if loyalty of Anastasia is 2], happy to see you[else if loyalty of Anastasia is 3] lovingly[else] with curiosity[end if].[line break]".
...
instead of conversing the Anastasia:
	project Figure of Anastasia_icon;
	if HP of Anastasia < 5:
...
to say Anastasiasex00:		[first time]
	...
	if Player is male:
		...
		if Ball Size of Player < 7 and "Modest Organs" is not listed in feats of Player:
		...
		NPCSexAftermath Anastasia receives "PussyFuck" from Player;
	else:
...
to say Anastasiasex05a:		[basalt dildo - female/herm]
	say "     Deciding to have some more fun with the firebird, you run your hands across her body, scritching her to get her excited. She nuzzles her large head against yours as you set aside your clothes and gear. 'Mmmm... I [if HP of Anastasia is 8]have a special treat for you. I made it myself and it's quite nice,' she chirps with a grin. Her footclaw reaches over and picks up a rather phallic black spire from behind a rock. It seems quite smooth and well-formed to fill a wanton hole attached to a larger section suitable for the bird's talons to grip. 'I think it will fit quite nicely,' she adds with a grin in her voice. You are a little reluctant to give the basalt dildo a try, but are too aroused to say no to the eager phoenix at this point[else]think we should break out my little toy again,' she says with a playful chirp. Her footclaw reaches over and picks up the basalt dildo. It is very smooth, shiny, and (as you know) well-formed to fill a wanton hole. There is a larger section suitable for the bird's talons to grip. Having already experienced the pleasure of the phoenix's personal toy, you have no reservations about enjoying it once more[end if].";
	...
	NPCSexAftermath Player receives "PussyDildoFuck" from Anastasia;

to say Anastasiasex05b:		[basalt dildo - male/neuter]
	say "     Deciding to have some more fun with the firebird, you run your hands across her body, scritching her to get her excited. She nuzzles her large head against yours as you set aside your clothes and gear. 'Mmmm... I [if HP of Anastasia is 8]have a special treat for you. I made it myself and it's quite nice,' she chirps with a grin. Her footclaw reaches over and picks up a rather phallic black spire from behind a rock. It seems quite smooth and well-formed to fill a wanton hole attached to a larger section suitable for the bird's talons to grip. 'I thought you might like to give it a try,' she says with a grin in her voice. Realizing that she must have in mind, you are a little reluctant to give the basalt dildo a try, but are also quite aroused and part of you finds the phallic spire quite tempting at this point[else]think we should break out my little toy again,' she says with a playful chirp. Her footclaw reaches over and picks up the basalt dildo. It is very smooth, shiny, and (as you know) well-formed to fill a wanton hole. There is a larger section suitable for the bird's talons to grip. Having already seen it in action, you are less reluctant to play with it again[end if].";
	...
	if Player consents:
		...
		NPCSexAftermath Player receives "AssDildoFuck" from Anastasia;
	else:
		LineBreak;
		...
		NPCSexAftermath Anastasia receives "PussyDildoFuck" from Player;
...
to say Anastasiasex06c:		[volcano - basalt dildo]
	if Player is female:
		...
		say "[line break]     [bold type]Shall you let her use it on you this time?[roman type][line break]";
		say "     ([link]Y[as]y[end link]) - Yes.";
		say "     ([link]N[as]n[end link]) - No.";
		if Player consents:
			LineBreak;
...
to say Anastasiasex06d:		[volcano - 69]
	...
	NPCSexAftermath Anastasia receives "Oral[if Player is male]Cock[else]Pussy[end if]" from Player;
	NPCSexAftermath Player receives "OralPussy" from Anastasia;
...
to say Anastasiasex08:		[dommy fuck]
	...
	NPCSexAftermath Anastasia receives "PussyFuck" from Player;
	if "Modest Organs" is not listed in feats of Player, BallsGrow Player by 1;
	...
	if fightoutcome >= 10 and fightoutcome <= 19:
		...
		if fightoutcome >= 10 and fightoutcome <= 19:
			...
			if fightoutcome >= 10 and fightoutcome <= 19:
				...
				say "[line break]     [bold type]Shall you bring her inside the cave or toss her over the rim of the crater for her people to reclaim?[roman type][line break]";
...
to Anastasiasexchange:
	...
	if Player is FemalePreferred:
		...
		if (Cunt Depth of Player < Cunt Depth entry or Cock Length of Player < Cock Length entry) and scenario is not "Researcher", follow the sex change rule;
	else:
