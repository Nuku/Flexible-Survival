...
Instead of conversing the Yolanda:
	...
	otherwise if yolandaqytat is false and a random chance of 1 in 3 succeeds and Yolanda is in Raven Nest:
	...
	otherwise if jbfound < 2 and Jewelry Box is unresolved and a random chance of 1 in 3 succeeds:
		...
		now jbfound is 1;
	otherwise if ( hp of Yolanda is 3 or hp of Yolanda is 4 or hp of Yolanda is 5 ) and a random chance of 1 in 4 succeeds:
		say "[movingYolanda]";
	otherwise if hp of Yolanda < 6:
...
to say movingYolanda:
	...
	if hp of Yolanda is 3:
		say "     'So where're you holing up when you're not wandering around, perving on mutants?  I'm sure you've got some safe hidey hole to rest and stash your stuff.'  You assure her that you're quite safe, having actually found an old fallout shelter for you[if the number of bunkered people + the number of booked people > 1] and your friends[otherwise if the number of bunkered people + the number of booked people is 1] and your friend[end if].  She seems momentarily impressed, but then waves it off with a snarky comment that it's probably some rusty old dump of a place.  You assure her that it's in good shape and actually under a library, so it's quite comfortable and has plenty of space.";
	otherwise:
		say "     'So how are things at this [']library shelter['] of yours?' she asks.  'Anyone new there?  [if hp of Yolanda is 5]Still working on collecting that[otherwise]Collecting a[end if] little harem of pervy mutants for yourself, maybe?'";
...
to say sexwithYolanda:
	...
	otherwise if lastfuck of Yolanda - turns < 6:
		say "     'More already?  If you're going to go sex crazy, run along and do it somewhere else,' she says, flapping her wing dismissively towards the [if hp of Yolanda >= 6]stairwell back to the ground floor[otherwise]door[end if].";
	otherwise:
		...
		while sextablerun is 0:
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if player consents:
					...
					otherwise if nam is "3some w/Dom Icarus - 1":
...
to say yolandasex03:
	...
	say "     Allowing her to tie you up, she uses her oft-hidden talon hands to secure your wrists to the old radiator using some leather straps.  A spreader bar is attached to your ankles before being connected to a concealed D-ring in the floor.  And with a few adjustments, you're secured spread eagle across [if hp of Yolanda < 6]her apartment floor[otherwise]the library floor[end if]";
	if hp of Yolanda < 3:
...
to say yolanda+domicarus01:
	...
	say "     '[if avpred is true]Is our subby predator looking for a proper fucking?' he asks teasingly.  Rather than wait for a response, he grinds his hard cock against you and nips down hard on your neck.  'Time for you to show us what a slutty hen you are again.'  With that, he shoves you over onto all fours and moves to mount you[otherwise]Is our subby plaything looking for a proper fucking?' he asks teasingly.  Rather than wait for a response, he grinds his hard cock against you and gives your shoulder a nip.  'Time for you to show us what a slutty hen you can be.'  With that, he guides you over onto all fours and moves to mount you[end if].  As he thrusts into your [if cunts of player > 0]juicy cunny[otherwise]tight ass[end if], Yolanda is there to guide the passarine's cock into you while watching eagerly.  And once in, the horny songbird fucks you gently at first.";
...
to say yolanda+domicarus02:
	...
	say "     But before you can see what she's got planned, the small songbird presses his avian foot down onto your face.  'Well what have we here?' he chirps with amusement.  '[if avpred is true]It seems our predator plaything needs a double-teaming to satisfy [temppronoun] - what a slut.'  He grinds his foot down onto your beak firmly.  'Lick it, my slutty hen,' he orders and you comply, opening your beak and running your tongue across those scaled toes of his[otherwise]It seems our plaything needs a double-teaming to satisfy [temppronoun].  This should be fun.'  He presses his foot down onto your face.  'Lick it, you slut,' he orders and you comply, parting your lips and running your tongue across those scaled toes of his[end if].";
	say "     Taking his bird foot in hand, you start to caress it while tonguing his toes when you feel Yolanda's taloned hands grip your hips.  Boosting you up, you feel her feathery hips slide between your legs as she spreads them.  'Mmmm... now that's quite the sight.  While you keep our plaything in [if cunts of player > 0]her[otherwise]his[end if] place, I'll get [temppronoun] warmed up on this end for you,' she says.  You feel the cool touch of a [if cunts of player > 0]strap-on brush against your wet folds[otherwise]lubed strap-on brush against your tight pucker[end if].  You moan around the taloned toe you're presently sucking on when she thrusts that toy into you, its subtle ridges making your hips quiver and your arousal climb higher.";
	say "     Icarus chuckles and starts stroking his stiff little cock as he watches the show.  And any time your tonguework wanes because of the skillful fucking you're receiving, he [if avpred is true]grips your beak in his talons and presses down on your head firmly[otherwise]presses his foot down as a firm reminder[end if].  With the two dominant avians amusing themselves with your body, you can't help but be turned on, enjoying feeling like the subby slut they proclaim you are.  This drives you to work harder to please them, moaning for Icarus to give you his other foot to clean even as you push back into Yolanda's thrusts.  It eventually gets to be too much and you end up cumming, [if cocks of player > 0]spraying your hot load across yourself[otherwise]crying out[end if] as your [if cunts of player > 0]hot juices soak the thrusting dildo inside you[otherwise]asshole clenches and squeezes around the thrusting dildo inside you[end if].  She rides you hard through your orgasm until you're left panting and weak.";
	attempttowait;
	say "     It's at this point that she pulls out and switches with Icarus.  The blue passarine takes his position between your legs and drives his long-ready cock into your [if cunts of player > 0]slick and stretched[otherwise]stretched[end if] hole.  He plunges in easily and starts pounding you.  The strap-on Yolanda's used was comparable to his size, so it sheathes nicely into your readied [if cunts of player > 0]cunny[otherwise]ass[end if].  He is [if avpred is true]considerably [end if]less gentle than Yolanda was, but since you just came recently, the added vigour helps to get you worked up again in short order.";
...
instead of going up from Grey Abbey Library while ( Icarus is in Grey Abbey Library and hp of Icarus >= 3 and hp of Icarus < 50 ) and ( Yolanda is in Grey Abbey 2F and hp of Yolanda is 7 ) and lastfuck of Yolanda is not turns and lastfuck of Icarus is not turns and ( cocks of player > 0 ):
	...
	if the player consents:
		...
		say "     Beside the pegging pair now, you reach under the blue bird to fondle his erect member while the raven continues thrusting into him.  Pleased to see how hard Icarus is at the treatment he's getting and the prospect of fun with the two of you, you give his small manhood a few strokes.  Yolanda moves off of him, slowly easing the dildo from his rear, ceding the position to you[if avpred is false] while applying some fresh lube to the toy[otherwise] after giving him another harsh nip[end if].  You move atop him, taking her place and filling his readied hole with your [cock of player] cock.";
		say "     You give the masochistic songbird a [if avpred is true]firm bite on his shoulder[otherwise]firm swat on his rear[end if] as you drive your [cock size desc of player] cock into his well-prepared hole.  After a few warm-up thrusts, you grab his ass with both hands and drive [if avpred is true]hard[otherwise]firmly[end if] into him[if cock length of player > 30].  Your pulsing rod throbs inside the little guy, stuffing him so delightfully full that you're making a big bulge of ruffled feathers from your oversized phallus plowing into him[otherwise if cock length of player > 20].  Your pulsing rod throbs inside the little guy, stuffing him so full that you're giving him a small bulge of puffed feathers from your enlarged phallus inside him[end if].  You [if avpred is true]taunt[otherwise]tease[end if] him about what a little cock slut he is, even raising his tail for a strap-on.  From the wiggle his but gives, you can tell the tied-up bird's enjoying this mistreatment at both your hands.";
		say "     You ride him until you feel your climax approaching and then switch off with Yolanda.  The raven, having enjoyed the show, eagerly retakes her position atop the blue songbird and resumes pegging him[if cock length of player > 20].  She makes up for the size difference between her toy and your [cock size desc of player] schlong through skillful thrusting and experienced manipulation of the straps and harnesses on the bird[otherwise].  She takes a different approach, using more skillful thrusting and experienced manipulation of the harnesses on the bird[end if].  You and Yolanda continue to switch in and out, having your way with Icarus repeatedly.  It is hard to tell which of his [if avpred is true]rough [end if][']studs['] he enjoys more from his muffled noises and attempts to push back into your thrusting.";
		say "     Eventually you grow tired of holding back and drive yourself fully into him with an orgasmic [if avpred is true]shriek while digging your talons in[otherwise]cry while gripping his feathery bottom tightly[end if].  Icarus shivers beneath you in a mix of terror and excitement, his tight tailhole tensing around you, increasing your lust to stuff it[if cock width of player > 35].  And stuff him you do, pumping the whole of your [cum load size of player] load into the poor songbird, overfilling him to the point that some of your semen leaks messily from the breathing holes in the mask.  His body is left rounded like a feathery balloon from it all[otherwise if cock width of player > 25].  And stuff him you do, pumping the whole of your [cum load size of player] load into the poor songbird.  You leave him so overfilled that his body is left rounded like a feathery balloon from it all[otherwise if cock width of player > 15].  And stuff him you do, pumping the whole of your [cum load size of player] load into the poor songbird.  This leaves him so full that he's left somewhat chubbier looking than before, his belly stuffed quite full with your seed[otherwise].  You pump your [cum load size of player] load into the poor songbird, painting his insides with your seed[end if].  But it is not over for the abused birdie, for Yolanda moves in to stuff his creamy hole with her strap-on, pushing herself to a second and stronger orgasm as she messily pounds your [if avpred is true]mutual prey plaything's[otherwise]shared plaything's[end if] cum-filled ass.  Once she's done, she swaps the dildo in his rear for a [if cock length of player > 20]large [end if]buttplug and leaves him tied up like that.  Knowing that she'll let him go... eventually, you give his achingly abused bottom a [if avpred is true]final swat[otherwise]playful squeeze[end if] before heading off, leaving him to enjoy his bound and filled state.";
...
an everyturn rule:
	if player is in Grey Abbey Library and ( Icarus is in Grey Abbey Library and hp of Icarus >= 51 ) and ( Yolanda is in Grey Abbey 2F and hp of Yolanda is 7 ) and lastfuck of Yolanda is not turns and lastfuck of Icarus is not turns and ( cocks of player > 0 or cunts of player > 0 ) and skipturnblocker is 0:
		...
		if bodyname of player is listed in infections of Avianpredlist and facename of player is listed in infections of Avianpredlist:
			now avpred is true;
		say "     Hearing some soft rustling from the rafters, you glance up to see Icarus and Yolanda - who've been squabbling of late - conspiratorially close.  From the cold, avian stares they're giving you, you can tell they're planning something for you.  If dealing with the two of them at once seems like too much, you'd best leave now.  Shall you [link]stay (Y)[as]y[end link] and see what these dominant birds have in mind or shall you [link]escape (N)[as]n[end link] back into the bunker until they turn their attention elsewhere?";
		if the player consents:
			...
			otherwise:
				...
				say "     Eventually though, Icarus has had enough and [if avpred is true]sinks his talons into your hips as he keeps going until his release[otherwise]grabs your hips roughly as he keeps going until his release[end if].  This is finally enough to push you over the top and you give a muffled cry of ecstasy, splattering your seed onto the floor as you cum hard.  You can feel shot after shot of avian seed being pumped into you even as the bird moans about what a [if avpred is true]cock-slut hen[otherwise]horny cock-slut[end if] you really are.  He continues thrusting for another minute after he's spent, nipping at you and calling you his slutty plaything.[movichance]";
