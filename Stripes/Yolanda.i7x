...
to say yolandasex01_b:
	...
	if HP of Yolanda < 3:
		say "     'Rather trusting, aren't you? Letting a strange mutant tie you up. What's to stop me from leaving you like this? Or sharing you with those annoying gryphons until you're as feather-brained as them?' She brushes her wingtip teasingly down your chest and over your crotch[if Player is male]. Your cock[smn] twitch[esmv] and stiffen[smv] further and your puss[yfn] grow[sfv] all the wetter[else]. Your puss[yfn] grow[sfv] all the wetter in response[end if], though you start to have second thoughts. You give your bonds a tug to test them, but you're secured tightly. She gives a chuckling caw at your struggle and fingers you once again to show she's the one in control.";
...
to say yolandasex02_b:	[bondage anal]
	...
	if HP of Yolanda < 3:
		say "     Grabbing the handcuffs, she pulls your arms under your chest and down between your legs, leaving your ass in the air and your face pressed to the floor. She then locks both the cuffs and the spreader bar together and tosses the key aside. 'Rather trusting, aren't you? Letting a strange mutant tie you up. What's to stop me from leaving you like this? Or sharing you with those annoying gryphons until you're as feather-brained as them?' She brushes her wingtip teasingly across your raised ass and down to your crotch[if Player is herm]. Your cock[smn] twitch[esmv] and stiffen[smv] further and your puss[yfn] grow[sfv] all the wetter[else if Player is male]. Your cock[smn] twitch[esmv] and grow[smv] harder in response[else]. Your puss[yfn] grow[sfv] all the wetter in response[end if], though you start to have second thoughts. You give your bonds a tug to test them, but you're secured tightly.";
...
to say yolandasex03:
	...
	if HP of Yolanda < 3:
		...
		say "     'Rather trusting, aren't you? Letting a strange mutant tie you up. What's to stop me from leaving you like this? Or sharing you with those annoying gryphons until you're as feather-brained as them?' She brushes her wingtip teasingly down your chest to your groin[if Player is herm]. Your cock[smn] twitch[esmv] and stiffen[smv] further and your puss[yfn] grow[sfv] all the wetter[else if Player is male]. Your cock[smn] twitch[esmv] and grow[smv] harder in response[else]. Your puss[yfn] grow[sfv] all the wetter in response[end if], though you start to have second thoughts. You give your bonds a tug to test them, but you're secured tightly.";
		...
		say "     'And now I've got you tied up and all to myself again,' she says with a chuckling caw. She brushes her wingtip teasingly down your chest to your groin[if Player is herm]. Your cock[smn] twitch[esmv] and stiffen[smv] further and your puss[yfn] grow[sfv] all the wetter[else if Player is male]. Your cock[smn] twitch[esmv] and grow[smv] harder in response[else]. Your puss[yfn] grow[sfv] all the wetter in response[end if], excited at the prospect of what's to come. You give your bonds a playful tug, finding them quite secure.";
