...
Description of Raven Nest is "     The apartment is [if HP of Yolanda < 6]occupied, but in a bit of disarray, as it has been rearranged to meet the needs of a feral occupant - a human-sized raven. Much of the furniture's been removed, instead replaced by two large L-shaped sofas arranged to form a square. The interior of it is filled with a multitude of cushions and pillows, plundered from who knows where, forming a rather comfy nest for the avian. When you come in, she's [one of]pecking at her food supplies[or]adjusting the blankets of her nest[or]reading a book[or]poking through her collection of shiny gewgaws[cycling][else]empty, now that Yolanda's gone. She's taken everything of any value with her, so thee's nothing left for you to loot either[end if].[line break]".
...
instead of conversing the Yolanda:
	project Figure of Yolanda_icon;
	if HP of Yolanda is 0:
		...
		now jbfound is 1;
	else if HP of Yolanda > 2 and HP of Yolanda < 6 and a random chance of 1 in 4 succeeds:
		...
		if HP of Yolanda is 3:
			say "     'So where're you holing up when you're not wandering around, perving on mutants? I'm sure you've got some safe hidey hole to rest and stash your stuff.' You assure her that you're quite safe, having actually found an old fallout shelter for you[if number of collected people > 1] and your friends[else if number of collected people is 1] and your friend[end if]. She seems momentarily impressed, but then waves it off with a snarky comment that it's probably some rusty old dump of a place. You assure her that it's in good shape and actually under a library, so it's quite comfortable and has plenty of space.";
		else:
		...
		say "[line break]     [bold type]Offer to bring Yolanda to the safety of the library?[roman type][line break]";
		say "     ([link]Y[as]y[end link]) - Yes.";
		say "     ([link]N[as]n[end link]) - No.";
		if Player consents:
			LineBreak;
			if icaruscheck is true:
				if number of collected people > 3:
					...
					say "     'Well, that sounds like quite the harem you're building up,' she teases. 'It'd be nice to have some company, so I guess I can come along and check it out with you, see if it's really like you've said. Having [if HP of Icarus < 50]a subby songbird around sounds like it could be fun. I'm sure a perv like you wouldn't mind sharing[else]another dommy bird around sounds like it could be fun. I'm sure a perv like you wouldn't mind being shared around[end if] a little. You just better not be making it all up so you can get me all alone at your sex den; I'll peck out your eyes if you are.'";
				else:
					say "     You [if HP of Yolanda is 5]again [end if]pitch that Yolanda move to the library as being a safer place for her and her collection since the place draws little interest from the other creatures roaming around. She's skeptical at first, suspecting that you only want her there so you can perv on her without having to come see her. She does start to gain interest when you mention [if HP of Icarus < 50]that there's a subby bird boy there already[else]that there's a dommy bird guy already there[end if].";
					say "     'Well, that songbird of yours does sound interesting. I wouldn't mind getting to know him better,' she teases. 'Having [if HP of Icarus < 50]a subby bird boy around sounds like it could be fun. I'm sure a perv like you wouldn't mind sharing[else]another dommy bird around sounds like it could be fun. I'm sure a perv like you wouldn't mind being shared around[end if] a little. It'd be nice to have some company, so I guess I can come along and check it out with you, see if it's really like you've said. You just better not be making it all up so you can get me all alone at your sex den; I'll peck out your eyes if you are.'";
			else if number of collected people > 3:
			...
			if icaruscheck is true or number of collected people > 3:
...
to say sexwithYolanda:
	...
	if HP of Yolanda is 0:
		...
		[]
		if HP of Yolanda >= 9 and Icarus is in Garden View and lastfuck of Icarus is not turns:
			if HP of Icarus >= 51:
				choose a blank row in table of fucking options;
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if Player consents:
					...
					if title entry is:
						...
						-- "3some w/Dom Icarus - 1":
							say "[yolanda+domicarus01]";
						-- "3some w/Dom Icarus - 2":
							say "[yolanda+domicarus02]";
						-- "3some w/Dom Icarus - 3":
							say "[yolanda+domicarus03]";
			else:
				say "Invalid Option. Pick between 1 and [the number of filled rows in the table of fucking options].";
		if HP of Yolanda is 1 or HP of Yolanda is 6: [interacted w/since move to Library]
			increase HP of Yolanda by 1;
...
to say yolandasex01:
	if ( ( Player is kinky and a random chance of 1 in 5 succeeds ) or ( Player is submissive and a random chance of 1 in 5 succeeds ) or a random chance of 1 in 3 succeeds ) and HP of Yolanda < 3:
		...
		say "     'Yeah, take it, you perv. Getting fucked by a girl, fucked by a bird,' she caws, nipping at your shoulders with her beak. She's right, you find; there is something strangely arousing about getting fucked by a woman/bird wearing a strap-on. The thought of you being so horny you'd settle for being screwed with a dildo becomes exciting in and of itself, enhancing your pleasure. And that's on top of the raven's clear experience with the role, working that phallus with practiced skill and ease to sexually satisfy you both with a powerful orgasm. You cry out with much-needed release as the bird caws in orgasmic delight through your mutual climaxes. Finished, she pulls the sex toy out of you with a wet slurp[if Player is kinky or Player is submissive] and struts around to your front, getting to lick it clean of your own juices before removing and storing it[else], wipes it clean and stores it back in the box with the others[end if].";
...
to say yolandasex01_b:
	...
	say "     After gently nuzzling your cunny with the curve of her beak, she grabs an appropriately [if Cunt Depth of Player < 5]small[else if Cunt Depth of Player < 10]sized[else if Cunt Depth of Player < 15]large[else]huge[end if] dildo from her collection with one of her feet. The toy is a textured with [one of]ridges[or]bumps[or]ticklers[or]a spiral pattern[at random] to increase the sensual stimulation. Taking a moment to tease your juicy pussy with the tip of the dong and give your side a playful nip that causes you to squirm ineffectually in your restraints, she affixes the toy into a [one of]black[or]red[or]pink[as decreasingly likely outcomes] harness and dons the strap-on. Taking a moment to adjust the fit and making sure you get a good look at the phallus that'll soon be filling you, she struts around your prone form.";
	if HP of Yolanda < 3:
		say "     'Rather trusting, aren't you? Letting a strange mutant tie you up. What's to stop me from leaving you like this? Or sharing you with those annoying gryphons until you're as feather-brained as them?' She brushes her wingtip teasingly down your chest and over your crotch. Your [if Player is male]cock[smn] twitch[esmv] and stiffen[smv] further and your puss[yfn] grow[sfv] all the wetter[else]puss[yfn] grow[sfv] all the wetter in response[end if], though you start to have second thoughts. You give your bonds a tug to test them, but you're secured tightly. She gives a chuckling caw at your struggle and fingers you once again to show she's the one in control.";
		say "     'Mmm, yes. Feel that. You're so hot and juicy,' she says with a sensual rumble as she pumps her digits inside you, making your cunt quiver. She gives you a nip with her beak as she adjusts herself over you. Her soft feathers brush over your chest[if Breast Size of Player > 0 and Player is male], tickling sensually at your breasts even as your stiff manhood is nestled into the ebon plumage between you. The textured dildo then pushes into you, causing you to moan from these myriad pleasures[else if Player is male] and your stiff manhood is nestled into the ebon plumage between you. The textured dildo then pushes into you, causing you to moan with pleasure[else if Nipple Count of Player > 0], tickling sensually at your nipples as the textured dildo pushes into you, causing you to moan in dual pleasure[end if]. Returning to a more avian posture, she seats herself atop you and starts rocking her hips. The lower position means she can only take slower thrusts, but she doesn't seem to mind as this lets her draw it out all the longer.";
		say "     'Getting fucked by a girl, fucked by a bird - such a perv,' she caws, nipping at your shoulders with her beak. She's right, you find; there is something strangely arousing about letting yourself get tied up and then fucked by a woman/bird wearing a strap-on. This turns you on all the more and you try to push up into her thrusts, but your bonds don't allow it well, giving you an additional reminder of your kinky predicament. This leaves the bird to set the pace, drawing it out for her own amusement. The raven's clearly had plenty of experience with the role, only letting you achieve small orgasms that leave you wanting more rather than properly satisfying you[if Cunt Count of Player > 1]. She even takes pauses to swap from one cunt to another, both ensuring you're thoroughly fucked and building your need all the higher[end if]. Yours is by no means the first pussy she's stuffed, working that stimulating phallus with practiced skill and ease to ride you to the sexually edge while she savors her prize before finally bringing it to a head with a powerful orgasm from both of you. You cry out with much-needed release as the bird caws in orgasmic delight through your mutual climaxes.";
		say "     Finished, she pulls the sex toy out of you with a wet slurp[if Player is kinky or Player is submissive] and struts around to your front, getting to lick it clean of your own juices before removing and storing it[else], wipes it clean and stores it back in the box with the others[end if]. While you're left basking in the afterglow, Yolanda leaves you tied up as she straightens up her collection. This makes you wonder if she's intent on keeping you like this and, in your blissed-out state, makes this a kinky prospect that has a certain appeal. She does eventually release you, allowing you to stretch out your stiff limbs on her pillowy nest while cuddled up beside your feathery lover.";
	else:
		say "     And so you are spread out on your back on her floor, restrained and at her mercy - though she's kind enough to have put a blanket between you and the hard floor. A light tug at your bonds proves you to be securely trapped and barely able to move. 'And here you are again, tied up and on display. Ripe and ready to be fucked. Just another plaything of mine,' she says with obvious amusement while [if Player is male]fondling your stiff erection before fingering your puss[yfn]. You moan and your cock[smn] throb[smv] while your cunt[sfn] get[sfv] all the wetter[else]rubbing your clit[sfn] and fingering your puss[yfn]. You moan and your cunt[sfn] get[sfv] all the wetter[end if], excited at the prospect of what's to come.";
		say "     The raven nestles herself atop you with a caw, gliding the [if Cunt Depth of Player < 5]small[else if Cunt Depth of Player < 10]phallic[else if Cunt Depth of Player < 15]large[else]huge[end if] dildo between your thighs. Her soft feathers brush across your chest[if Player is male] and around your throbbing cock[smn] as the hard dildo pushes into you, causing you to moan in dual pleasure. Returning to a more avian posture, she seats herself atop you and starts rocking her hips. The lower position means she can only take slower thrusts, but she doesn't seem to mind as this lets her draw it out all the longer.";
		say "     'Yeah, take it, you perv. Letting yourself get tied up and screwed senseless by a mutant bird girl. Such a kinky slut,' she caws, nipping at your shoulder with her beak as she grinds her feathered hips hard against you, pressing the dildo deep inside you. You can't help but agree, feeling like quite the slut for having allowed a bird/woman to tie you up and then stuff your pussy with a strap-on. This turns you on all the more and you try to push up into her thrusts, but your bonds don't allow it well, giving you an additional reminder of your kinky predicament. This leaves the bird to set the pace and play with your body as she will for her own amusement. She draws it out by alternating between thrusting into you, grinding down on your crotch, fondling your junk and pausing for light, feathery caresses[if Cunt Count of Player > 1]. She even alternates the textured toy from one cunt to another, both ensuring you're thoroughly fucked and building your need all the higher[end if] - all while only allowing you minor orgasms that make you all the hornier while she has her fun with her tied up [']plaything['].";
		say "     After a long, drawn out session, she grinds her hips and works that stimulating dildo back and forth inside you in quick, short motions that finally build you up to a powerful orgasm. You cry out with much-needed release as the bird caws in orgasmic delight through your mutual climaxes. Finished, she pulls the sex toy out of you with a wet slurp[if Player is kinky or Player is submissive] and struts around to your front, getting to lick it clean of your own juices before removing and storing it[else], wipes it clean and stores it back in the box with the others[end if]. Yolanda releases you from your bonds for some post-sex snuggles while you both bask in the afterglow. You're still stiff from the bondage, so the feathery cuddling in her cushion nest is the perfect way for your sore muscles to relax and recover.";
...
to say yolandasex02:
	if ( ( Player is kinky and a random chance of 1 in 5 succeeds ) or ( Player is submissive and a random chance of 1 in 5 succeeds ) or a random chance of 1 in 3 succeeds ) and HP of Yolanda < 3:
		...
		say "     'Yeah, take it, you perv. Bending over and taking it up the ass from a girl, and a bird at that. You slut,' she caws, nipping at your shoulder with her beak as she grinds her feathered hips hard against you, pressing the dildo [if Player is male]against your prostate[else]deep inside you[end if]. You can't help but agree, feeling like quite the slut for having allowed a bird/woman to fuck you in the ass with a strap-on. The thought of you being so horny you'd settle for being screwed with a dildo becomes exciting in and of itself, enhancing your pleasure. And that's on top of the raven's clear experience with the role. Yours is by no means the first ass she's filled, working that phallus with practiced skill and ease to sexually satisfy you both with a powerful orgasm. You cry out with much-needed release as the bird caws in orgasmic delight through your mutual climaxes. Finished, she rises off of you and slips the sex toy out of your tingling anus with a wet slurp. [if Player is kinky or Player is submissive]After wiping it across each ass cheek, she wipes it clean[else]Removing it, she cleans it with a wet wipe[end if] and stores it back in the box with the others.";
...
to say yolandasex02_b:	[bondage anal]
	...
	if HP of Yolanda < 3:
		say "     Grabbing the handcuffs, she pulls your arms under your chest and down between your legs, leaving your ass in the air and your face pressed to the floor. She then locks both the cuffs and the spreader bar together and tosses the key aside. 'Rather trusting, aren't you? Letting a strange mutant tie you up. What's to stop me from leaving you like this? Or sharing you with those annoying gryphons until you're as feather-brained as them?' She brushes her wingtip teasingly across your raised ass and down to your crotch. Your [if Player is herm]cock[smn] twitch[esmv] and stiffen[smv] further and your puss[yfn] grow[sfv] all the wetter[else if Player is male]cock[smn] twitch[esmv] and grow[smv] harder in response[else]puss[yfn] grow[sfv] all the wetter in response[end if], though you start to have second thoughts. You give your bonds a tug to test them, but you're secured tightly.";
		...
		say "     'Yeah, take it, you perv. Bending over and taking it up the ass from a girl, and a bird at that. You slut,' she caws, nipping at your shoulder with her beak as she grinds her feathered hips hard against you, pressing the dildo [if Player is male]against your prostate[else]deep inside you[end if]. You can't help but agree, feeling like quite the slut for having allowed a bird/woman to tie you up and then fuck you in the ass with a strap-on. This turns you on all the more and you try to push back into her thrusts, but your bonds don't allow it, giving you an additional reminder of your kinky predicament. This leaves the bird to set the pace, drawing it out for her own amusement. The raven's clearly had plenty of experience with the role, pausing when needed to keep you from coming. Yours is by no means the first ass she's filled, working that phallus with practiced skill and ease to keep you on sexual edge while she savors her prize before finally bringing it to a head with a powerful orgasm from both of you. You cry out with much-needed release as the bird caws in orgasmic delight through your mutual climaxes.";
		say "     Finished, she rises off of you and slips the sex toy out of your tingling anus with a wet slurp. [if Player is kinky or Player is submissive]After wiping it across each ass cheek, she wipes it clean[else]Removing it, she cleans it with a wet wipe[end if] and stores it back in the box with the others.";
		say "     While you're left basking in the afterglow, Yolanda leaves you tied up as she straightens up her collection. This makes you wonder if she's intent on keeping you like this and, in your blissed-out state, makes this a kinky prospect that has a certain appeal. She does eventually release you, allowing you to stretch out your stiff limbs on her pillowy nest while cuddled up beside your feathery lover.";
	else:
		say "     Pulling your arms down between your legs again leaves your ass in the air and your face pressed to the floor - though this time she's kind enough to leave you a cushion to rest your head on. She again locks the cuffs and the spreader bar together and sets the key aside. A light tug at your bonds proves you to be securely trapped and at the raven's mercy. 'And here you are again, ass in the air. Ripe and ready to be pounded. Just another toy for my collection,' she says with obvious amusement while [if Player is male]fondling your stiff erection. You moan and your cock[smn] throb[smv][else]rubbing your clit. You moan and your puss[yfn] grow[sfv] all the wetter[end if], excited at the prospect of what's to come.";
		...
		say "     After a long, drawn out session, she pounds you vigorously with the strap-on while masturbating you to a powerful orgasm. You cry out with much-needed release as the bird caws in orgasmic delight through your mutual climaxes. Finished, she rises off of you and slips the sex toy out of your tingling anus with a wet slurp. [if Player is kinky or Player is submissive]After wiping it across each ass cheek, she wipes it clean[else]Removing it, she cleans it with a wet wipe[end if] and stores it back in the box with the others. Yolanda releases you from your bonds for some post-sex snuggles while you both bask in the afterglow. You're still stiff from the bondage, so the feathery cuddling in her cushion nest is the perfect way for your sore muscles to relax and recover.";
	if HP of Yolanda < 3, now HP of Yolanda is 3;
...
to say yolandasex03:
	...
	if HP of Yolanda < 3:
		...
		say "     'Rather trusting, aren't you? Letting a strange mutant tie you up. What's to stop me from leaving you like this? Or sharing you with those annoying gryphons until you're as feather-brained as them?' She brushes her wingtip teasingly down your chest to your groin. Your [if Player is herm]cock[smn] twitch[esmv] and stiffen[smv] further and your puss[yfn] grow[sfv] all the wetter[else if Player is male]cock[smn] twitch[esmv] and grow[smv] harder in response[else]puss[yfn] grow[sfv] all the wetter in response[end if], though you start to have second thoughts. You give your bonds a tug to test them, but you're secured tightly.";
		say "     'Ah-ah-ah!' she teases with another feathery touch while slamming her foot down onto the spreader bar. 'No backing out now. Though I do think I'd rather keep you all to myself.' And with that, she turns around and sits herself atop you like a bird, burying you in the darkness of her tailfeathers. She grinds her hips back, pressing her cloaca to your face, urging you to start licking. The stuffy heat surrounding you only makes the musky scent of her arousal all the stronger in your nose. Your tongue darts out to get a taste of it and soon you're delving into her dripping cunny. And true to her word, she [if Player is male]begins stroking your throbbing cock[smn][else]fingers your wet snatch[esfn][end if] after giving your crotch a beak nuzzle.";
	else:
		say " once again. The raven struts around your nude form, looking you over with amusement.";
		say "     'And now I've got you tied up and all to myself again,' she says with a chuckling caw. She brushes her wingtip teasingly down your chest to your groin. Your [if Player is herm]cock[smn] twitch[esmv] and stiffen[smv] further and your puss[yfn] grow[sfv] all the wetter[else if Player is male]cock[smn] twitch[esmv] and grow[smv] harder in response[else]puss[yfn] grow[sfv] all the wetter in response[end if], excited at the prospect of what's to come. You give your bonds a playful tug, finding them quite secure.";
	...
	if a random chance of anallevel in 12 succeeds and anallevel > 1:
		...
		if Player consents:
			...
			if CockName of Player is listed in infections of InternalCockList:
				say "     Yolanda has an excited grin at the corners of her beak as she moves in with the cockring. She wraps the [if Cock Length of Player > 18]large[else]small[end if] leather band around the base of your cock and clips it snugly onto you. It squeezes around your shaft, constricting the blood flow to keep you hard. With you fully engorged, she eyes your [cock size desc of Player] [Cock of Player] pole with lustful hunger while spreading some lube into the false vagina. She slides it slowly onto your manhood, letting your increasingly sensitive shaft feel every ridge and tickler inside it[if Cock Length of Player >= 18]. It also proves to be remarkably stretchy, expanding to accommodate your [cock size desc of Player] penis[end if].";
			else:
				say "     Yolanda has an excited grin at the corners of her beak as she moves in with the cockring. She wraps a section of the [if Cock Length of Player > 18]large[else]small[end if] leather band around the base of your cock and another around your scrotum and clips it snugly onto you. It squeezes around your shaft, constricting the blood flow to keep you hard. With you fully engorged, she eyes your [cock size desc of Player] [Cock of Player] pole with lustful hunger while spreading some lube into the false vagina. She slides it slowly onto your manhood, letting your increasingly sensitive shaft feel every ridge and tickler inside it[if Cock Length of Player >= 18]. It also proves to be remarkably stretchy, expanding to accommodate your [cock size desc of Player] penis[end if].";
			...
			if Ball Size of Player < 7 and ("Modest Organs" is not listed in feats of Player or Ball Size of Player < 5):
				BallsGrow Player by 1;
		else:
			LineBreak;
			say "[yolandasex04_default]";
	else if a random chance of 1 in 2 succeeds:
		say "     The raven struts around you, giving you an avian, sidelong stare. 'Mmm... now don't you look like a fine treat. All strung up for a peckish raven,' she says, giving your side a sharp nip. 'But how shall I have this piece of fine meat?' she muses aloud, turning back to her box of toys. She rummages through it with one taloned foot, sifting through the contents. 'Perhaps this... or this? Ahhh! Just the thing!' she exclaims, pulling a bright red dildo shaped like a canine cock, complete with knot and pointed glans.";
		say "[line break]     [bold type]Shall you let her use that doggy dong on you or shall you ask for something else a little less wild?[roman type][line break]";
		say "     ([link]Y[as]y[end link]) - Use the doggy dong.";
		say "     ([link]N[as]n[end link]) - Something a little less wild.";
		if Player consents:
			LineBreak;
			say "     Securing the canine-shaped toy to her harness and then attaching it around her waist, she stands upright for a change, putting herself on display with the faux doggy cock. 'I always knew that quiet guy upstairs was a perv, but I didn't know how much of one until I raided his closet and found this puppy,' she says while [if Player is female]stroking the canine prick a few times[else]spreading some lube over the canine prick[end if]. After her preparation, she takes hold of your thighs[if Player is not female] from behind[end if], raising and spreading your legs so she can get the doggy dong lined up with your [if Player is female]juicy snatch[else]tight pucker[end if]. She teases your unprotected hole with a slow rub of the pointed tip around it, making you whimper a little with need. Something about your perilous position, tied up and exposed, has turned you on considerably and you're eager for the raven to bury that bone in you. She thankfully doesn't leave you waiting for too long, just long enough to enjoy your frustration and give you a few extra nips with her beak before finally driving the red latex toy into your needy [if Player is female]cunt[else]ass[end if].";
			if Player is female:
		...
		say "     The raven struts around you, giving you an avian, sidelong stare. 'Mmm... now don't you look like a fine treat. All strung up for a peckish raven,' she says, giving your side a sharp nip. 'But how shall I have this piece of fine meat?' she muses aloud, turning back to her box of toys. She rummages through it with one taloned foot, sifting through the contents. 'Perhaps this... or this? Ahhh! Just the thing!' she exclaims, pulling a large equine-shaped dildo out and giving it a slap across the floor. The floppy toy quivers as it bounces and wobbles in her grip. 'This big guy is called [']The Burro['] and I'm thinking I'll have it burrow into you,' she caws, staring at you with a sidelong glance. It looks like you're in for a [if Player is female]stuffing[else]reaming[end if] by that donkey dick dildo unless you stop her now.";
		say "[line break]     [bold type]Will you take the donkey dildo?[roman type][line break]";
		say "     ([link]Y[as]y[end link]) - Yes.";
		say "     ([link]N[as]n[end link]) - No.";
		if Player consents:
			LineBreak;
			say "     Yolanda takes the big, floppy donkey dick in her beak and slaps your ass with it a few times. Given how you're tied up, all you can do is groan and squirm a little to the raven's amusement. Taking the large toy in hand next, she adjusts to stand mostly upright, slapping it in her other palm. [if Player is female]Rubbing it across your juicy folds, she teases your pussy with it before getting to[else]Spreading copious amounts of lube over the toy, she gets it ready for[end if] the main event. She even pushes a pair of slick digits into your [if Player is female]hot cunny[else]tight hole[end if] in advance of the long dong.";
			say "     Spreading your [if Player is female]folds[else]cheeks[end if], she presses the flat crown of the equine phallus against your waiting hole. You give a soft groan as the toy is pushed into you, stretching [if Player is female]your cunny around it[else]your bowels to take it[end if]. It proves to be quite enjoyable as she slides inch after inch of it into you, making your [if Player is female]hips buck[else]ass wriggle[end if] as you're filled with latex cock.";
			if Player is female:
				...
				say "     While Yolanda may start off slow, she rapidly picks up the pace as soon as your back door can take it. This has you panting and moaning throughout the fucking, your lustful body responding with increasing arousal. As is the raven, it seems, savoring your reaction and altering her motions to get you even more worked up. You start to wonder how the real thing might compare. Given the state of the city, you may very well find some suitable critter to scratch that itch, your nanite-confused mind finding the idea very appealing right now.";
				...
				say "     With Yolanda's donkey toy pounding at your prostate like that, it doesn't take too long for her to have you revving up for a big orgasm. Seeing it coming, she drives the footlong animal dildo fully into your stretched hole, [if scalevalue of Player < 3]completely [end if]stuffing your bowels with it. You cry out and cum hard, blasting your [Cum Load Size of Player] load into her waiting beak. She swallows [if Ball Size of Player > 4]as much of it as she can manage[else]it down[end if] with a satisfied 'Mmmm' while fingering her pussy wildly. She is overcome with a tail-shakingly good climax that has her caw with delight.";
...
to say yolandasex04_default:
	say "     'A little too much for you, is it? Alright then,' she says with disappointment as she reaches in for something else. 'We'll go with something more basic.' In her talons is a clear purple dildo filled with glitter and a [one of]black[or]red[or]pink[as decreasingly likely outcomes] strap-on harness. Once connected and strapped around her waist, the raven rises to stand more upright and moves in on you. Putting her hidden hands on your legs, she lifts and spreads them while bringing the latex phallus to your [if Player is female]pussy after a light feather teasing of your folds[else]anus after applying a little lube[end if]. With a firm grip on your thighs, she drives the false penis into your [if Player is female]juicy[else]tight[end if] hole.";
	say "     She takes it slow for the first few thrusts, but quickly picks up the pace. She's raised you up to just the right height to be able to lift you up and then let you slip back down onto the toy. She nips at you with her beak while fucking you, pecking at your neck, sides and nipples. You're given a good, long ride on the thrusting toy, Yolanda switching positions and pace a few times to make sure you both are thoroughly satisfied. By the time she's ready for a final, strong orgasm, she bounces you hard and fast pushing you over the edge into a much-needed climax of your own. Your [if Player is female]quivering cunt clenches and squeezes around the false penis as pant and moan with sexual delight[else]well-fucked rectum clenches and spasms around the false penis as you pant and moan with sexual release[end if]. [if Player is herm]The pleasure overload from your vagina soon extends to your penis[esmn] and you blast gooey streaks of your seed both across her black feathers and your [bodytype of Player] chest. In addition, your well-fucked cunny gushes with juices, soaking both your crotch and the bird's strap-on[else if Player is male]The feel of it pressing against your prostate sends waves of pleasure through your cock[smn] and you blast gooey streaks of your seed both across her black feathers and your [bodytype of Player] chest[else]Your well-fucked vagina gushes with juices, soaking both your crotch and the bird's strap-on[end if].";
	say "     After the orgasm, Yolanda needs a few moments to recover before lowering you back to the floor and undoing the restraints holding you. You ache from being suspended up like that for so long, but it's a good kind of ache, one shared by your thoroughly pounded hole[if Player is male] and spent shaft[smn][end if]. She lazily cleans the toy she used on you[if Player is female], first by licking it clean before giving it a proper clean-up[else], taking her time to do a good job so it's ready for the next time she wants to use it[end if].";
...
to say yolandaspecial03:
	...
	if Player is male:
		say "     The raven motions with one wing for you to get down on the cushions. You toss aside your gear and flop out on the bird's plush nest. This gives you a good view between her legs as she strides overtop of you, her dark-skinned pussy nestled in her feathers. Using one of her avian feet, she takes hold of your cock and gives it a few strokes to make sure it's good and hard for her before lining herself over it. As she settles atop you, you bring your hands to her feathered body even, holding her as she sinks down onto your [Cock of Player] shaft. [if Cock Length of Player > 24]Given your immense size, she's quite tight and she takes her time settling[else if Cock Length of Player > 12]Given your large size, she's quite snug and she eases herself[else]She slides easily[end if] into place on your throbbing roost with a caw of delight.";
...
instead of going up from Grey Abbey Library while Icarus is in Garden View and HP of Icarus >= 3 and HP of Icarus < 50 and Yolanda is in Darkened Alcove and HP of Yolanda is 7 and lastfuck of Yolanda is not turns and lastfuck of Icarus is not turns and Player is male:
	...
	say "[line break]     [bold type]Giving him a firm nip on the neck, she pauses, as if waiting to see if you'll come join them or leave.[roman type][line break]";
...
an everyturn rule:
	if Player is in Grey Abbey Library and Icarus is in Garden View and HP of Icarus >= 51 and Yolanda is in Darkened Alcove and HP of Yolanda is 7 and lastfuck of Yolanda is not turns and lastfuck of Icarus is not turns and Player is not neuter and skipturnblocker is 0:
		...
		say "[line break]     [bold type]Shall you stay and see what these dominant birds have in mind or shall you escape back into the bunker until they turn their attention elsewhere?[roman type][line break]";
		...
		if Player consents:
			...
			if Player is female:
				...
				say "     When you feel the touch of feathers at your crotch again, things are different. The feathers are a little rougher, that phallus touching you is harder and cooler, and its penetration more skillful. You give a moan as what must be one of Yolanda's toys is thrust into you, the raven now taking her turn topping you. Your asshole squeezes and pulls around the strap-on, not knowing the difference and only wanting to be fucked and filled. The aggressive passerine doesn't sit things out while the raven fucks you either, rubbing his erect member against your [if avpred is true]masked face and giving it a few meaty slaps[else]blindered face, drooling precum onto you[end if].";
