...
to say yolandasex03:
	...
	if HP of Yolanda < 3:
		...
		say "     'Rather trusting, aren't you? Letting a strange mutant tie you up. What's to stop me from leaving you like this? Or sharing you with those annoying gryphons until you're as feather-brained as them?' She brushes her wingtip teasingly down your chest to your groin[if player is herm]. Your cock[smn] twitch[esmv] and stiffens[smv] further and your puss[yfn] grow[sfv] all the wetter[else if cocks of player > 0]. Your cock[smn] twitch[esmv] and grow[smv] harder in response[else]. Your puss[yfn] grow[sfv] all the wetter in response[end if], though you start to have second thoughts. You give your bonds a tug to test them, but you're secured tightly.";
		...
		say "     'And now I've got you tied up and all to myself again,' she says with a chuckling caw. She brushes her wingtip teasingly down your chest to your groin[if player is herm]. Your cock[smn] twitch[esmv] and stiffens[smv] further and your puss[yfn] grow[sfv] all the wetter[else if cocks of player > 0]. Your cock[smn] twitch[esmv] and grow[smv] harder in response[else]. Your puss[yfn] grow[sfv] all the wetter in response[end if], excited at the prospect of what's to come. You give your bonds a playful tug, finding them quite secure.";
