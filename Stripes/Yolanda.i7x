...
to say yolandasex01_b:
	...
	if HP of Yolanda < 3:
		...
		say "     The raven nestles herself atop you with a caw, gliding the [if Cunt Length of Player < 5]small[else if Cunt Length of Player < 10]phallic[else if Cunt Length of Player < 15]large[else]huge[end if] dildo between your thighs. Her soft feathers brush across your chest[if Player is male] and around your throbbing cock[smn] as the hard dildo pushes into you, causing you to moan in dual pleasure. Returning to a more avian posture, she seats herself atop you and starts rocking her hips. The lower position means she can only take slower thrusts, but she doesn't seem to mind as this lets her draw it out all the longer.";
...
to say yolandasex04_B:
	...
	say "     Eventually Yolanda relents and pops the snaps on the cockring. A long groan issues from your throat as your long-awaited orgasm can occur freely. Your backed up balls send blast after blast of thick seed into the depths of the false cunny[if ball size of Player > 15], filling it to overflowing[end if]. Your orgasm is even better for the enforced delay, your head spinning from the strength of it. And by the time it comes to an end, you're left dazed, but awash in warm ecstasy all over.";
	...
	if ball size of Player < 45:
		increase ball size of Player by 1 + ( ball size of Player / 15 );
		if ball size of Player > 45, now ball size of Player is 45;
...
to say yolandasex04_D:
	...
	if Player is female:
		...
		say "     With Yolanda's donkey toy pounding at your prostate like that, it doesn't take too long for her to have you revving up for a big orgasm. Seeing it coming, she drives the foot-long animal dildo fully into your stretched hole, [if scalevalue of Player < 3]completely [end if]stuffing your bowels with it. You cry out and cum hard, blasting your [Cum Load Size of Player] load into her waiting beak. She swallows [if ball size of Player > 15]as much of it as she can manage[else]it down[end if] with a satisfied 'Mmmm' while fingering her pussy wildly. She is overcome with a tail-shakingly good climax that has her caw with delight.";
