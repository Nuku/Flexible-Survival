...
When Play begins:
	...
	now face entry is "a [if cunts of player > 0]feminine[otherwise]masculine[end if] version of your human face, but flat and expressionless.  Your eyes glow with a [if playermetalskin is 1]yellow[otherwise if playermetalskin is 2]blue[otherwise if playermetalskin is 3]green[otherwise if playermetalskin is 4]red[end if] light";
	...
	now face change entry is "your head shifts and changes, becoming a [if cunts of player > 0]feminine[otherwise]masculine[end if] version of your old, human face, but stiff and expressionless with [if playermetalskin is 1]amber[otherwise if playermetalskin is 2]blue[otherwise if playermetalskin is 3]green[otherwise if playermetalskin is 4]red[end if], glowing eyes";
