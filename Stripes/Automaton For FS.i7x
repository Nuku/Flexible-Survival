...
to say losetoautomaton:
	if autogender is 1:
		...
		if cunts of player > 0 and a random chance of 3 in 4 succeeds:
			...
			say "     He grabs you and pins you down beneath him, moving mechanically, but with clear intent. Pushing you onto all fours, the metal man moves atop you and sinks his stiff, metal cock into your ass. His rod is quite hard and is cool at first, but warms up quickly as he thrusts into you with mechanical motion over and over. His rhythm is steady and soon has you moaning beneath him as he drives his [if metalskin is 1]bronze[else if metalskin is 2]aluminium[else if metalskin is 3]cobalt[else if metalskin is 4]steel[end if] shaft into you until [if cocks of player > 0]you cum. As you orgasm beneath him, [end if]you feel the hot pulse of his silvery seed shooting into you. This mercurial semen flows into you, claiming your ass as the metal man empties his balls into you. Once he's been drained, he gets up and moves off, searching for a new partner to mount and infect.[mimpregchance]";
		else:
