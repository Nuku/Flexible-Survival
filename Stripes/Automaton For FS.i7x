...
to say beattheautomaton:
	say "     Having beaten the metal [if autogender is 1]man[otherwise]woman[end if], the lights in its eyes go out and it crumples to the ground like an unpowered toy.  There's a faint electrical hum from it, soft but slowly growing, as if it's working to charge itself up again."; 
...
When Play begins:
	...
	now attack entry is "[one of][if a random chance of 1 in 3 succeeds]The automaton[otherwise if autogender is 1]He[otherwise]She[end if] strikes you with a metal fist![or][if a random chance of 1 in 3 succeeds]The automaton[otherwise if autogender is 1]He[otherwise]She[end if] squeezes your wrist in its painfully strong grip![or][if a random chance of 1 in 3 succeeds]The automaton[otherwise if autogender is 1]He[otherwise]She[end if] batters you hard blows![or][if a random chance of 1 in 3 succeeds]The automaton[otherwise if autogender is 1]He[otherwise]She[end if] knees you in the gut with its metal leg![at random]";
	...
	now face entry is "a [if cunts of player > 0]feminine[otherwise]masculine[end if] version of your human face, but flat and expressionless.  Your eyes glow with a [if playermetalskin is 1]golden[otherwise if playermetalskin is 2]blue[otherwise if playermetalskin is 3]green[otherwise if playermetalskin is 4]red[end if] light";
	...
	now skin entry is "[if playermetalskin is 1]bronze[otherwise if playermetalskin is 2]aluminium[otherwise if playermetalskin is 3]cobalt with a faint blue tint[otherwise if playermetalskin is 4]steel[end if]";
	now tail entry is "";	[ Tail desc., written as a full sentence or left blank for none. ] 
	now cock entry is "[one of]metallic[or][if playermetalskin is 1]bronze[otherwise if playermetalskin is 2]aluminium[otherwise if playermetalskin is 3]cobalt[otherwise if playermetalskin is 4]steel[end if][or]human-shaped[at random]";
	now face change entry is "your head shifts and changes, becoming a [if cunts of player > 0]feminine[otherwise]masculine[end if] version of your old, human face, but stiff and expressionless with [if playermetalskin is 1]golden[otherwise if playermetalskin is 2]blue[otherwise if playermetalskin is 3]green[otherwise if playermetalskin is 4]red[end if], glowing eyes";
	...
	now cock change entry is "throbs and pulses, spurting silvery white semen as your flesh becomes metallic [if playermetalskin is 1]bronze[otherwise if playermetalskin is 2]aluminium[otherwise if playermetalskin is 3]cobalt[otherwise if playermetalskin is 4]steel[end if]";
...
to say autoskinchange:
	...
	say "grows hard and metallic, stiffening into a shifting, flexing skin made of [if playermetalskin is 1]bronze[otherwise if playermetalskin is 2]aluminium[otherwise if playermetalskin is 3]cobalt[otherwise if playermetalskin is 4]steel[end if]";
