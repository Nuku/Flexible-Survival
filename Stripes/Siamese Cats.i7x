...
When Play begins:
	...
	now skin entry is "smooth, creamy fur which grows darker at the ends of your limbs to cover your"; [ skin Description, format as "Your body is covered in (your text) skin"]
