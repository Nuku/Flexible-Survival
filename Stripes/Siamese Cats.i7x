Version 1 of Siamese Cats by Stripes begins here.
[Version 1]
...
When Play begins:
   ...
   now face entry is "feline head with large ears and a darker area over your muzzle and"; [ Face description, format as the text "You have a (your text) face."]
   ...
   now skin entry is "smooth, creamy fur which grows darker at the ends of your limbs."; [ skin Description, format as the text "You have (your text) skin"]
	...
	if bodyname of player is "Siamese Cat":
		if humanity of player is less than 10:
			...
			if tailname of player is "Siamese Cat":
				say "     Drawn by some strange need, you wrap your arms around one another, licking and kissing.  Your tails slowly intertwine and, as the tips touch, you can feel them start to fuse together.  The pleasure of this causes you both to orgasm violently.  You can feel yourself becoming linked to the new kitty, sharing some sensation with them, as well as a deep, emotional bonding.  You two are individuals, but also one, partners and lovers meant to be together and now inseparable.";
			otherwise:
				say "     Drawn by some strange need, you wrap your arms around one another, licking and kissing.  The Siamese felines run their paws over your body and play with themselves, wiping their juices across your rear, coaxing you to grow a Siamese cat tail.  Your tail slowly intertwines with the single feline and, as the tips touch, you can feel them start to fuse together.  The pleasure of this causes you both to orgasm violently.  You can feel yourself becoming linked to the new kitty, sharing some sensation with them, as well as a deep, emotional bonding.  You two are individuals, but also one, partners and lovers meant to be together and now inseparable.";
			say "     Joined together, you are able to enjoy one another's sensations and orgasms, often going off simultaneously.  As well, sharing in one another, you both shift to become alike, complementary twins and resistant to more changes as each is maintained by the other.  The twins who first changed you become frequent lovers when you're not on the prowl for others to make into paired felines.";
		otherwise:
