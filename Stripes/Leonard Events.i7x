...
to say leomidcoitus:
	say "     Arriving at the den, you're greeted by the sounds and smells of leonine sex before even entering. It gets you [if player is herm]hard and wet[else if cocks of player > 0]hard[else if cunts of player > 0]wet[else]aroused[end if] and you move quickly ";
