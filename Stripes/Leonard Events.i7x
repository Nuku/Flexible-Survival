...
to say leodenspecial2:
	...
	say "     You'd been aware before that Leonard had been keeping tabs on the area, but you'd not known the details or the extent of it until now. Having learned about this odd, secret member of the pride has left you with a new-found respect for your mate's resourcefulness. You've also learned a lot of information which could be helpful to you in the future when dealing with these creatures.";
	if player is felinebodied:
		infect "Feline";
	else:
		felinebodyshift;
