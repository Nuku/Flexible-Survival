...
to say leodenscene5:
	...
	if the player is bodily human and the player is facially human and the player is skintone human and tail of Player is "" and ( Breast Size of Player < 10 and Cock Length of Player < 16 and ball size of Player < 16 ) and Nipple Count of Player <= 2 and ( Breast Size of Player < 2 or ( Cock Length of Player < 7 and ball size of Player < 7 ) ):
	...
	say "     Leonard, as suave and gentlemanly as ever, smiles to the young man. 'Don't worry, soldier. My name is Leonard and you're safe here in my den. We mean you no harm. You hurt yourself rather badly when you almost crashed into my mate here.' He indicates to you and you smile, keeping a polite distance for the moment. '[if Player is female]She[else]He[end if] says you seemed quite agitated and were perhaps fleeing something? What happened to your unit?' he asks in a concerned manner.";
...
to say leomidcoitus:
	say "     Arriving at the den, you're greeted by the sounds and smells of leonine sex before even entering. It gets you [if Player is herm]hard and wet[else if Player is male]hard[else if Player is female]wet[else]aroused[end if] and you move quickly ";
