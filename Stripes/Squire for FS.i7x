...
to say squirewins_ride:
	...
	say "     Aiming your erection to his puckered hole, he lowers himself with [if cock length of player > 15]a groaning effort[else if cock length of player >= 10]a slow moan[else if cock length of player > 5]a soft moan[else]ease[end if] down onto your [cock size desc of player] shaft. It's clear the young man has had his asshole stretched more than a few times. That does not mean he's loose by any means; his inner muscles and anal rings are quite practised and squeezing and pulling at your [cock of player] rod even as he rides you.";
	say "     'It is a squire's duty to serve his knight - not that a [if kpstatus is 3]brigand[else]monster[end if] like you would understand duty or honour. But regardless, I shall train hard to I might slake my knight's needs like a proper and loyal squire,' he pants as he grinds down harder. His pace quickens as he relaxes further, taking you hard and deep with increasing lustful zeal.";
	WaitLineBreak;
