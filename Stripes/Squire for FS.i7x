...
to say squirewins_anal_shift:
	...
	if cocks of player is 0 and cunts of player is 0:
		say "     The smaller guy gets you down on your back and slides your ass up into his lap.  Your genderless crotch gives him momentary pause and he's drawn to rub across your nullpatch.  'What kind of knight has neither sword nor scabbard?  No wonder you're unworthy to be a knight and [if hp of player > 0]surrendered so easily[otherwise]lost[end if].  You're clearly undeserving of your title,' he says before pushing a few spit-slick fingers into your asshole to stretch you out.  After this brief preparation, he gets his erection lined up with your asshole and pushes his dribbling cock into your rear with one confident motion.";
	otherwise:
		say "     The smaller guy gets you down on your back and slides your ass up into his lap.  'What kind of a knight cannot stand up to a squire?  You're clearly unworthy to be a knight for [if hp of player > 0]surrendering so easily[otherwise]losing[end if] to a squire.  You're clearly undeserving of your title,' he says before pushing a few spit-slick fingers into your asshole to stretch you out.  After this brief preparation, he gets his erection lined up with your asshole and pushes his dribbling cock into your rear with one confident motion.";
	say "     As the young man sets himself to fucking you, he does so with some skill.  And while more familiar with being on the receiving end, he has clearly learnt much about how an ass should be fucked.  And his skills seem to grow as he pounds into you, thrusting with increasing confidence.  As his assertiveness increases, he [if cocks of player > 0]takes hold of your [cock of player] cock and starts jerking you off as he buggers you[otherwise]puts a hand on your barren crotch and rubs at it while buggering you[end if].  This arouses your further, adding to the stimulation from having his pistoning rod in your back passage.";
	attempttowait;
...
to say squirewins_ride:
	say "     The aroused squire pushes you down onto his back and pulls down his pants.  Straddling you, he grinds his rear down onto your [cock size desc of player] cock.  '[if cock length of player > 15]My master will surely be impressed when I tell him of your formidable size[otherwise if cock length of player >= 10]My master will be quite impressed when I tell him of your size[otherwise if cock length of player > 5]Not quite as grand as my lord's, but it'll still make for a good training session[otherwise]You don't have much to show for yourself, but at least it can be a warm-up to get me limber before a proper training session[end if], [if kpstatus is 3]rogue[otherwise]beast[end if].'";
	say "     Aiming your erection to his puckered hole, he lowers himself with [if cock length of player > 15]a groaning effort[otherwise if cock length of player >= 10]a slow moan[otherwise if cock length of player > 5]a soft moan[otherwise]ease[end if] down onto your [cock size desc of player] shaft.  It's clear the young man has had his asshole stretched more than a few times.  That does not mean he's loose by any means; his inner muscles and anal rings are quite practised and squeezing and pulling at your [cock of player] rod even as he rides you.";
	say "     'It is a squire's duty to serve his knight - not that a [if kpstatus is 3]brigand[otherwise]monster[end if] like you would understand duty or honour.  But regardless, I shall train hard to I might slake my knight's needs like a proper and loyal squire,' he pants as he grinds down harder.  His pace quickens as he relaxes further, taking you hard and deep with increasing lustful zeal.";
	attempttowait;
	say "     The horny squire certainly seems to be enjoying his [']training['], probably looking forward to the next time he might show off his growing skills to his knight.  And you grow increasingly aroused as well, the young man's talents working you quickly towards your peak until you cannot hold back and unleash your [cum load size of player] load into him, [if cock width of player > 25]bloating his belly[otherwise if cock width of player > 15]flooding his bowels[otherwise]painting his prostate[end if] with your seed.  He rides you through your orgasm and pulls off you once you're done.  Grabbing your head, he presses it to his pulsing cock.  Giving himself a few final strokes is all it takes before he cums messily, splattering your face with his sticky semen.";
	say "     'There, [if kpstatus is 3]bandit[otherwise]beast[end if], let that be a reminder to you of the bold young warrior who bested you.  Now go and cease your [if kpstatus is 3]thievery[otherwise]rampage[end if].'  Spent and sticky, you see little point in trying to correct the delusional lad and instead take your leave while you can.";

to say squirewins_vaginal:
	say "     The aroused squire slips his hand between your legs and runs his fingers over your wet slit[if hp of player > 0].  The[otherwise].  Despite your attempts to resist, the[end if] touch of the handsome young man is quite arousing and you feel yourself growing flush from it.";
	if kpstatus is 2:
		say "     'It's rare for a lass to be a knight's squire[if cocks of player > 0]... though I see you have a sword as well as a scabbard,' he adds, letting his fingers tease your [cock of player] cock momentarily before returning to your pussy[otherwise],' he says as he fingers your increasingly wet pussy[end if].  'And as the victor, it is my duty to play the knight and assist in training the weaker squire,' he says with a leer.  As he pulls down his pants to reveal his seven inch penis to be hard and ready to perform this task.";
	otherwise:
	...
	otherwise:
		say "     'And there you are, [if kpstatus is 3]brigand[otherwise]beast[end if].  Perhaps that will leave a reminder of the bold young warrior who bested you.  Now go and cease your [if kpstatus is 3]thievery[otherwise]rampage[end if].'  Spent and sticky, you see little point in trying to correct the delusional lad and instead take your leave while you can.";
...
to say squirewins_anal_n:
	...
	otherwise:
		say "     'What kind of a [if kpstatus is 3]rogue[otherwise]creature[end if] are you, having neither sword nor scabbard?' he asks in surprise as he feels up your barren crotch.  'Very well then.  If I am to teach you a lesson for your [if kpstatus is 3]thieving[otherwise]rampaging[end if] ways, it shall have to be this way,' he adds, fingering your asshole as he pushes you over onto your front.  After giving your nullpatch another curious rub while teasing his drooling cocktip against your pucker, he eases his seven inch shaft into your precum-slickened hole.";
	say "     As the young man sets himself to fucking you, he does so with some skill.  And while more familiar with being on the receiving end, he has clearly learnt much about how an ass should be fucked.  And so, while this [']lesson['] is a little rough at the start, it quickly becomes enjoyable for you as well.  The pistoning of his rod into your back passage provides some stimulation for your growing arousal.";
	attempttowait;
	say "     As his pace quickens towards climax, you push your ass back into his thrusts, eager to have him seed you, hoping that may provide some outlet for your lustful need.  And as if sensing this need, he quickens his pace and drives hard into you for a few last thrusts.  Each shot of gooey cum that shoots into your bowels is accompanied by the young lad rubbing at your sexless groin in an effort to provide his [if kpstatus is 2]fellow squire[otherwise]poor opponent[end if] at least some relief and added stimulation.  You moan and cry out, your asshole squeezing and pulling at his cock as waves of unfocused pleasure run through you.  This false orgasm leaves you more worn than satisfied, but it does at least slake your need for the moment.";
	if kpstatus is 2:
...
to say beatthesquire:
	...
	if kpstatus is 1:
		say ".  'You are indeed a brave and powerful knight.  Perhaps you should face off against my master in honourable combat.  He would surely best even you,' he proclaims as he recovers his sword and departs quickly.";
	otherwise if kpstatus is 2:
