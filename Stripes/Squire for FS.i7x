...
to say squirewins_ride:
	say "     The aroused squire pushes you down onto his back and pulls down his pants. Straddling you, he grinds his rear down onto your [cock size desc of player] cock. '[if cock length of player > 15]My master will surely be impressed when I tell him of your formidable size[else if cock length of player >= 10]My master will be quite impressed when I tell him of your size[else if cock length of player > 5]Not quite as grand as my lord's, but it'll still make for a good training session[otherwise]You don't have much to show for yourself, but at least it can be a warm-up to get me limber before a proper training session[end if], [if kpstatus is 3]rogue[otherwise]beast[end if].'";
	say "     Aiming your erection to his puckered hole, he lowers himself with [if cock length of player > 15]a groaning effort[else if cock length of player >= 10]a slow moan[else if cock length of player > 5]a soft moan[otherwise]ease[end if] down onto your [cock size desc of player] shaft. It's clear the young man has had his asshole stretched more than a few times. That does not mean he's loose by any means; his inner muscles and anal rings are quite practised and squeezing and pulling at your [cock of player] rod even as he rides you.";
	...
	WaitLineBreak;
	say "     The horny squire certainly seems to be enjoying his [']training['], probably looking forward to the next time he might show off his growing skills to his knight. And you grow increasingly aroused as well, the young man's talents working you quickly towards your peak until you cannot hold back and unleash your [cum load size of player] load into him, [if cock width of player > 25]bloating his belly[else if cock width of player > 15]flooding his bowels[otherwise]painting his prostate[end if] with your seed. He rides you through your orgasm and pulls off you once you're done. Grabbing your head, he presses it to his pulsing cock. Giving himself a few final strokes is all it takes before he cums messily, splattering your face with his sticky semen.";
