...
to HyenaMatBoundSex:
	if bsextimer > 5 and a random chance of bsextimer in 18 succeeds or (hunger of player > 59 or thirst of player > 59):
		if a random chance of 1 in 2 succeeds:
			...
			say "     When the wave of musky fluids come to an end, you let your head fall back onto the floor. Dazed by the heady scent of hyena sex flooding your senses and the arousing situations that you were subjected to, your lust is at a boiling point, and you [if cocks of player > 0]jerk yourself off[else if cunts of player > 0]play with your clit[else]desperately rub your crotch[end if]. In your aroused state, it doesn't take much before you achieve your own climax, and Gina giggles while your body spasms under her. Exhausted by your orgasm and having to service two hyenas, you barely budge when the furry globes rise off of you, nor do you have the strength to do much when the matriarch picks you up and quickly wolfs you down, returning you to her stomach.";
		now bsextimer is 1;
		now struggleatt is 0;
