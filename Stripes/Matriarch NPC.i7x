	...
	otherwise:
		...
		if cocks of player > 0 or cunts of player is 0:
			...
			if T is 1:
				...
				say "[hyenamatnosex1]";
			otherwise if T is 2:
				say " before grabbing your head and burying your face in her crotch.";
				attempttowait;
				say "[hyenamatnosex2]";
			otherwise if T is 3:
		...
		otherwise if cunts of player > 0:
			...
			if Z < 55:			[no-sex variations]
				...
				decrease humanity of player by 5;
				now lastfuck of Matriarch is turns;
			otherwise if Z < 105:	[sex variations]
				say ".";
				let T be a random number between 1 and 3;
				if T is 1:
					say "[hyenamatsex1]";
				...
				now lastfuck of Matriarch is turns;
			otherwise:			[special sex variations]
				say ".";
...
to say hyenamatsex1:
	...
	attempttowait;
	say "     Her hard cock pulses and throbs inside you, making you feel so good.  You're glad you lost to her.  You were meant to lose.  You meant to lose from the very beginning.  All so you could feel the joy of being her sexy girl and get bred with her pups.  When she thrusts hard into you one last time, driving her thick knot inside you and tying with you, you cry out in ecstacy, your whole body feeling the rush of your orgasm as you recieve her virile gift of semen as she seeks to breed you.  'Oh, you are my good girl,' she rumbles.  'Take it.  Take it all!' she growls as she cums.  When she's done with you, you're left feeling bloated and full with her heavy load, loving its hot warmth inside you and hoping it takes root.[impregchance]";
