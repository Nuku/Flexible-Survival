...
Instead of conversing the Garrett:
	...
	if hp of Garrett is 0:
		...
		say "     As it stands, I was thinking it might be time to try a different kind of [']milk['].  But for that, I could use a bit of a hand,' he adds with a grin, rubbing his bulging sheath meaningfully.  The tip of his thick, blue penis starts to poke free of its fuzzy housing.  'How do you feel about helping a working guy work one out?'";
		now Gryphon Milkman is resolved;
		now Free Milk is resolved;
		now Abandoned Milk is resolved;
...
to say sexwithGarrett:
	...
	otherwise if lastfuck of Garrett - turns < 6:
		say "     'That sounds like fun, but I could use a bit of time to reload,' he says, rubbing his recently emptied balss.  'Besides, the semen we've already collected needs some time to be processed.'";
