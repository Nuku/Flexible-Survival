...
to say ResolveEvent Goblin Trap:
	if dexterity of player < 15 minus Resolution of Goblin Trap: [Dex check to see if player notices the trap]
		...
		say "[line break]     [bold type]Do you want to crawl into the car for the bag, or just ignore it and leave?[roman type][line break]";
		...
		say "     As you're traveling through the cluttered junkyard, trying to ignore the moldy smell of the area, you somehow notice a junk-filled car with its driver side tilted up onto another, as well as what looks like a small bag with water and food that someone has tried to hide amongst the junk, badly. You slowly approach the car keeping a lookout in case the owner of the hidden items return. As you get closer to the car you see that you could crawl through the passenger side door to reach the bag. However, you also notice what looks like a net hung above the passenger seat. It's a trap! With extra caution, you examine your surroundings in more detail looking to see if the trapper is still around. As you're doing so you notice slight movement amongst the junk in the back seats of the car, and upon closer examination, you see a small creature that you believe to be a goblin. You could try to [bold type]ambush the goblin[roman type], trigger the trap and [bold type]get caught on purpose[roman type], or ignore the loot and [bold type]leave.[roman type][line break]";
...
to say Goblin Trap Escape: [Player tries escaping]
	if strength of player > 13: [Player tries escaping, is strong enough to do so]
		say "     Deciding that you don't want to see what the goblin has in store for you, you start struggling against your bonds to free yourself. The goblin, not liking your idea, yells out 'Hey! Stop that, I caught you fair and square!' You ignore it and continue struggling and in return you feel the netting start breaking one strand at a time, right as you give the final push to break the rest the goblin slaps you on the rear again only to flail backwards and land on their rear when it sees you breaking free. The goblin rushes back to it's feet, yelling out 'Stupid meanie! You broke my net!', before charging you with an attack!";
...
to say Goblin Trap Outcomes:
	if a random chance of 1 in 2 succeeds:
		...
		now gobgender is 2;
	if a random chance of 1 in 2 succeeds or MaleList is banned or MaleList is warded: [Goblin trap gang rape always has at least 2 males, so if males are banned the goblin trap raped outcome is used instead]
...
to say Goblin Trap Raped: [Goblin rapes the player]
	if gobgender is 2: [Goblin is male]
		if Player is female: [Goblin is male, Player is female/herm]
			...
			say "     Embarrassingly, the feeling of getting fucked while having your ass toyed with is enough for you to start moaning in earnest. You eventually decide to just enjoy the unplanned sex and start moving your hips back and forth with the goblin[if Cock Count of Player > 1], which also causes your [cock size desc of Player] cocks to start swinging back and forth under you[else if Player is male], which also causes your [cock size desc of Player] cock to swing back and forth under you[end if]. Repaying your enthusiasm, the goblin starts pumping two of his fingers in and out of your ass, and uses his other hand to reach down and [if Cock Count of Player > 1]grab one your cocks and start jerking you off[else if Player is male]grab your cock to start jerking you off[else if Cunt Count of Player > 2] start rubbing one of your other cunts[else if Cunt Count of Player is 2]start rubbing your other cunt[else if Player is female]start caressing your clit[end if]. After a minute of your combined teamwork, you can tell that you're both close to finishing and hasten your movements, which quickly leads to the goblin's climax as he grabs your hips and pulls you close so he can shoot his cum deep into you. With that sending you over the edge your cunt tightens around his dick as you cum[if Cock Count of Player > 1] with your cocks impotently pumping their [Cum Load Size of Player] loads onto the ground[else if Player is male] with your cock impotently pumping its [Cum Load Size of Player] load onto the ground[end if]. After taking a second to catch his breath the goblin releases you and slowly pulls his cock from your cunt. He takes a step back and uses both hands to spread your cunt, letting some of his load flow out onto the ground[if Player is male] to mix with your own[end if].";
...
to say Goblin Trap Finish:
	if Resolution of Goblin Trap < 5:
		...
		say "[line break]     [bold type]You've encountered the goblin trap enough times that if you want you can choose to ignore the trap completely if you encounter anymore.[roman type][line break]";
...
to say ResolveEvent Raiding Party:
	...
	say "[line break]     [bold type]Shall you stay and wait for them to see what's going on or shall you make your escape while you can?[roman type][line break]";
...
to say ResolveEvent Scattered Trash:
	...
	if bonus + dice > 15:
		...
		infect "[one of]Trash Coon[or]Pit Bull[purely at random]";
...
to say ResolveEvent Stray Cat:
	...
	if dirty water is owned or water bottle is owned:
		say "     On a search through the scrapyard, you find your path blocked by a sweaty and panting snow leopard. It seems he wandered in here and has gotten lost. Startled to see you there, he gives a dry mrowl that cracks in his dry throat before stalking towards you quickly. You have some water in your pack which may satisfy him long enough to make your escape.";
		say "[line break]     [bold type]Shall you toss him some water?[roman type][line break]";
		say "     ([link]Y[as]y[end link]) - Yes.";
		say "     ([link]N[as]n[end link]) - No.";
		if Player consents:
			LineBreak;
			if dirty water is owned and water bottle is owned:
				say "     You have both [link]dirty water (Y)[as]y[end link] and [link]fresh water (N)[as]n[end link]. Which will you give him?";
				if Player consents:
					LineBreak;
					say "[dirtysnow]";
		...
		say "     On a search through the scrapyard, you find your path blocked by a sweaty and panting snow leopard. It seems he wandered in here and has gotten lost. Startled to see you there, he gives a dry mrowl that cracks in his dry throat before stalking towards you quickly. You have but a short moment before the feline is upon you and attacking.";
...
to say dirtysnow:
	...
	if "Snow Bat" is a Name listed in Table of Random Critters:
