	...
	if dexterity of player < (15 - Resolution of Goblin Trap): [Dex check to see if player notices the trap]
		...
		if player consents: [Failed dex check, Player goes for the bait and is trapped]
			...
			if player consents: [Failed dex check, player was trapped and tries to escape]
				...
				LineBreak;
				say "     You feel like you could indulge yourself with whatever fun the goblin has in mind for you. The goblin, noticing your lack of struggling, says 'Wow, you're one of the smart ones, not many like you! The dummies all try to escape!' before they start to amuse themselves by groping your butt. Playing along, you adjust yourself on your knees, pushing your ass back, to give the goblin better access. The goblin decides too move on to the fun stuff and pulls down any clothing from your lower half, revealing your ass[if player is herm], erect cock, and dripping cunt[else if cunts of player > 1 and cocks of player > 1], erect cocks, and dripping cunts[else if cunts of player > 0 and cocks of player > 1], erect cocks, and dripping cunt[else if cunts of player > 1 and cocks of player > 0], erect cock, and dripping cunts[else if player is female] and dripping cunt[else if player is male] and erect cock[else][end if]. ";
		...
		if calcnumber is 1: [Passed dex check, player notices trap, ambushes the goblin]
			say "     Deciding to take advantage of the goblin being distracted by keeping watch on it's trap, you carefully sneak up to the back of the car where the goblin is hiding. ";
			LineBreak;
			now goblinfight is 3;
			challenge "Goblin";
			if goblinfight is 1: [Passed dex check, player notices trap, ambushes the goblin, wins]
				say "     Having beaten the goblin, you take a minute to catch your breath before going back to the trapped car and taking the bag of food and water. You also take the time to examine the trap so you'll hopefully be able to recognize more of it's type in the future.";
				increase score by 1;
				ItemGain food by 1;
				ItemGain water bottle by 1;
			else if goblinfight is 2: [Passed dex check, player notices trap, ambushes the goblin, loses]
				say "     Even though you had the advantage due to your ambush, you still ended up used by the goblin after losing in battle. The goblin grabs the food and water from the car, presumably bait for future traps, before running away leaving you to recover on your own. After a few minutes of doing such, you rise to your feet and examine the trap so you'll hopefully be able to recognize more of it's type in the future.";
			else: [Passed dex check, player notices trap, ambushes the goblin, flees]
				say "     Deciding you've had enough of this, you dodge the goblin's charge before running off into the maze-like junkyard. The goblin tries giving chase, but ends up cursing about his prize getting away as you lose him. After you run far enough to feel safe, you take a minute to catch your breath, and to try and remember as much as you can about the trap so you can regonnize more of it's type in the future.";
		else if calcnumber is 2: [Passed dex check, player notices trap, caught in trap on purpose]
			LineBreak;
			say "     While watching the goblin you come with a idea that will let you have some naughty fun, hopefully. Abandoning all pretenses of stealth, you confidently walk up to the car and start crawling across the passenger seat. Part way across the seat the net slams onto your back forcing onto your knees with your upper body being forced into the passenger seat. You hear the junk inthe back seat being shifted around and crane your head to see the goblin crawling it's way out of the passenger rear window. You hear it say 'He heh, yes! I got [if scalevalue of Player > 3]a real big one[else if scalevalue of Player is 3]me a big one[else]one[end if]!' before you feel it's hand slap your ass cheeks. [bold type]Now that you've let yourself get caught, do you want to wait and see what the goblin has planned for you, or have you changed your mind and want to try to escape?[roman type][line break] ";
			LineBreak;
			...
			if player consents: [Passed dex check, player notices trap, caught in trap on purpose, doesn't try to escape]
				LineBreak;
				say "     Like planned, you're going to indulge yourself with whatever fun the goblin has in mind for you. The goblin, noticing your lack of struggling, says 'Wow, you're one of the smart ones, not many like you! The dummies all try to escape!' before they start to amuse themselves by groping your butt. Playing along, you adjust yourself on your knees, pushing your ass back, to give the goblin better access. The goblin decides too move on to the fun stuff and pulls down any clothing from your lower half, revealing your ass[if cocks of player is 1 and cunts of player is 1], erect cock, and dripping cunt[else if cunts of player > 1 and cocks of player > 1], erect cocks, and dripping cunts[else if cunts of player is 1 and cocks of player > 1], erect cocks, and dripping cunt[else if cunts of player > 1 and cocks of player is 1], erect cock, and dripping cunts[else if player is female] and dripping cunt[else if player is male] and erect cock[end if]. ";
				say "[Goblin Trap Outcomes]";
			...
			LineBreak;
			say "     Deciding that the loot isn't worth the trouble, and that you don't want to see what the goblin has in mind with it's trap, you start carefully leaving the area. While doing this you try to remember what the the trap looks like so you can regonnize more of it's type in the future. ";
...
to say Goblin Trap Escape: [Player tries escaping]
	...
	if strength of player > 13: [Player tries escaping, is strong enough to do so]
		say "feel the netting start breaking one strand at a time, right as you give the final push to break the rest the goblin slaps you on the rear again only to flail backwards and land on it's own rear when it sees you breaking free. The goblin rushes back to it's feet, yelling out 'Stupid meanie! You broke my net!', before charging you with an attack!";
		...
		if goblinfight is 1: [Player tries escaping, is strong enough to do so, fights the goblin and wins]
			...
			say "     Even though you managed to escape the goblin's trap, you still ended up being used by it after losing in battle. The goblin grabs the food and water from the car, presumably bait for future traps, before it runs away leaving you to recover on your own. After a few minutes of doing such, you rise to your feet, and examine the trap so you'll hopefully be able to recognize more of it's type in the future. ";
		...
		say "only get the netting to uncomfortably dig into your skin, before getting a harsher slap on the rear from the goblin who says 'I told you to stop! You won't get out, I'm best net builder!' Realizing that you're stuck in this situation, you resign yourself to your fate at the hands of the goblin. You feel the hands of the goblin groping your butt, before they start grabing your legs and positioning you so that your ass sticks out. The goblin decides too move on to the fun stuff and pulls down any clothing from your lower half, revealing your ass[if cocks of player is 1 and cunts of player is 1], erect cock, and dripping cunt[else if cunts of player > 1 and cocks of player > 1], erect cocks, and dripping cunts[else if cunts of player is 1 and cocks of player > 1], erect cocks, and dripping cunt[else if cunts of player > 1 and cocks of player is 1], erect cock, and dripping cunts[else if player is female] and dripping cunt[else if player is male] and erect cock[end if].";
		say "[Goblin Trap Outcomes]";

to say Goblin Trap Outcomes:
	let gobgender be a random number from 1 to 2;
	if gobgender is 2 and girl is banned:
		now gobgender is 1;
	if gobgender is 1 and guy is banned:
		now gobgender is 2;
...
to say Goblin Trap Raped: [Goblin rapes the player]
	if gobgender is 2: [Goblin is male]
		if player is female: [Goblin is male, player is female/herm]
			say "     The goblin starts groping your butt again, before you feel it shove several fingers into [if cunts of player is 1]your cunt[else]one of your cunts[end if]. Considering your relative statures, the fingers of the goblin [if scalevalue of Player > 3]barely feel like an intrusion[else if scalevalue of Player is 3]only feel like a small intrusion[else]feel large enough to stretch you out some[end if]. As the goblin is pumping it's fingers into your cunt, your starting to wonder how they plan to use you when they take their fingers out and you feel the insertion of what is clearly his dick[if scalevalue of Player > 3] even though it's so small[else if scalevalue of Player is 3] even though it's on the smaller end[end if]. He starts pumping his dick into you surprisingly fast, and despite being one of the smaller dicks you've taken the feeling is enough to make you let out a moan. The goblin seems to notice this, as he says 'Hah! You're liking this aren't you?' Seemingly emboldened, he grab your cheeks and shoves his thumbs into your ass, using them to stretch it out. ";
			LineBreak;
			say "     Embarrassingly, the feeling of getting fucked while having your ass toyed with is enough for you to start moaning in ernest. You eventually decide to just enjoy the unplanned sex and start moving your hips back and forth with the goblin[if cocks of player > 1], which also causes your [cock size desc of Player] cocks to start swinging back and forth under you[else if cocks of player is 1], which alo causes your [cock size desc of Player] cock to swing back and forth under you[end if]. Repaying your enthusiasm, the goblin starts pumping two of his fingers in and out of your ass, and uses his other hand to reach down and [if cocks of player > 1]grab one your cocks and start jerking you off[else if cocks of player is 1]grab your cock to start jerking you off[else if cunts of player > 2] start rubbing one of your other cunts[else if cunts of player is 2]start rubbing your other cunt[else if cunts of player is 1]start carressing your clit[end if]. After a minute of your combined teamwork, you can tell that you're both close to finishing and hasten your movements, which quickly leads to the goblin's climax as he grabs your hips and pulls you close so he can shoot his cum deep into you. With that sending you over the edge your cunt tighents around his dick as you cum[if cocks of player > 1] with your own cocks impotently pumping their [cum load size of player] loads onto the ground[else if cocks of player is 1] with your own cock impotently pumping it's [cum load size of player] load onto the ground[end if]. After taking a second to catch his breath the goblin releases you and slowly pulls his cock from your cunt. He takes a step back and uses both hands to spread your cunt, letting some of his load flow out onto the ground[if player is male] to mix with your own[end if]. ";
			say "     Pleased with the sight, the goblin laughs and says 'That was fun, yeah? Make sure to come back and we can have some more fun like that, he he.' The goblin takes a minute to gather some items, along with the food and water that acted as bait, before he does something outside your view that leaves the net on top of you loosening, before he runs away. It still takes you a minute to get out from under the net and by the time you do there is no sight of the goblin. Before leaving you take some time to examine the goblin's trap so you may be able recognize it in the future. ";
			CreatureSexAftermath "Player" receives "PussyFuck" from "Goblin";
		else: [Goblin is male, player is male/neuter]
			say "     The goblin starts groping your butt again, before you feel it shove several fingers into your ass. Considering your relative statures, the fingers of the goblin [if scalevalue of Player > 3]barely feel like an intrusion[else if scalevalue of Player is 3]only feel like a small intrusion[else]feel large enough to stretch you out some[end if]. As the goblin is pumping it's fingers into your ass, your starting to wonder how they plan to use you when they take their fingers out and you feel him insert what is clearly his dick[if scalevalue of Player > 3] even though it's so small[else if scalevalue of Player is 3] even though it's on the smaller end[end if]. He starts pumping his dick into you surprisingly fast, and despite being one of the smaller dicks you've taken the feeling is enough to make you let out a moan. The goblin seems to notice this, as he says 'Hah! You're liking this aren't you?' Seemingly emboldened, he[if cocks of player > 1] reaches around and starts stroking one of your cocks[else if player is male] reaches around and starts stroking your cock[else] starts groping and massaging your butt again[end if]. ";
			LineBreak;
			say "     Embarrassingly, the feeling of getting fucked while having [if cocks of player > 1]one of your cocks[else if player is male]your cock[else]your cheeks[end if] toyed with is enough for you to start moaning in ernest. You eventually decide to just enjoy the unplanned sex and start moving your hips back and forth with the goblin[if cocks of player > 2], which also causes your untouched cocks to start swinging back and forth under you[else if cocks of player is 2], which also causes your untouched cock to start swinging back and forth under you[end if]. Repaying your enthusiasm, the goblin [if player is male]puts more enthusiasm into jerking off your cock[else]strengthens his grip on your ass to put more enthusiasm in each of his thrusts[end if]. After a minute of your combined teamwork, you can tell that you're both close to finishing and hasten your movements, which quickly leads to the goblin's climax as he grabs your hips and pulls you close so he can shoot his cum deep into you. With that sending you over the edge your ass tighents around his dick as you cum[if cocks of player > 1] with your own cocks impotently pumping their [cum load size of player] loads onto the ground[else if cocks of player is 1] with your own cock impotently pumping it's [cum load size of player] load onto the ground[end if]. After taking a second to catch his breath the goblin releases you and slowly pulls his cock from your ass. He takes a step back and uses both hands to spread you, letting some of his load flow out onto the ground[if player is male] to mix with your own[end if]. ";
			say "     Pleased with the sight, the goblin laughs and says 'That was fun, yeah? Make sure to come back and we can have some more fun like that, he he.' The goblin takes a minute to gather some items, along with the food and water that acted as bait, before he does something outside your view that leaves the net on top of you loosening, before he runs away. It still takes you a minute to get out from under the net and by the time you do there is no sight of the goblin. Before leaving you take some time to examine the goblin's trap so you may be able recognize it in the future. ";
			CreatureSexAftermath "Player" receives "AssFuck" from "Goblin";
	else: [goblin is female]
		say "     The goblin starts groping your butt again, before you feel it shove several fingers into your ass. Considering your relative statures, the fingers of the goblin [if scalevalue of Player > 3]barely feel like an intrusion[else if scalevalue of Player is 3]only feel like a small intrusion[else]feel large enough to stretch you out some[end if]. As the goblin is pumping it's fingers into your ass, your starting to wonder how they plan to use you when they take their fingers out and you hear them move away, you hear rusting in the back of the car and manage to crane your head to see the goblin. The goblin, a girl you realize after being able to see her, crawls through the back of the car stopping near your head. You let out a hiss as she grabs your hair and makes you look up at her before she says 'Play nice and I'll let you go after we're done, ok? If not, I can leave you here for someone else to find.' ";
		LineBreak;
		say "     You glare at her, but she takes your lack of agressive action as a yes. She pulls her tattered loincloth to the side, revealing her small slit that she starts rubbing. She keeps masturbating herself infront of you for a moment before she repositions herself in front of your face, grabbing your hair again and shoving your face into her cunt. She actually rubs herself up and down your face, covering it in her femcum. It only takes a few seconds of that before she gets serious and shoves her cunt against your mouth and gives you a command, 'Lick.' Deciding to not find out if she was serious with her previous threat, [if player is submissive]you obey her command[else]you do as she says[end if] and start using your tongue to probe the depths of her wet slit. She grins and grinds into your mouth some before saying 'Your pretty good at this, ya know? It's not often I get to have fun[if player is female] with a good girl[else if player is male] with a good boy[else] with someone[end if][if scalevalue of player > 3] as big as you[else if scalevalue of player < 3] that's my size[else] like you[end if].' ";
		say "     You keep lapping at her pussy but also start giving some attention to her clit, which is enough to get her moaning and twitching. It only takes a couple minutes before she starts grinding against your mouth with extra enthusiasm. Your suspicion that's she is about to cum is proven right when she roughly grabs you head with both hands and feel her walls tighten around your [if scalevalue of player > 3]massive tongue[else if scalevalue of player is 3]large tongue[else]tongue[end if]. After a minute to catch her breath, the goblin starts crawling through the car again before exiting it. You're anxious that she's going to go against her promise to free you, when you feel her groping your ass again. It seems that there is more she is wanting, but you're confused aboutw what that would be, since you've already gotten her off. ";
		LineBreak;
		if player is female: [Goblin is female, player is female/herm]
			say "     She answers your questions with what she says next, 'Don't worry, I was thinking that since you played so nice, I would go ahead and help you out. Not that you have a choice, he he.' She once again shoves her fingers into your ass, immediately pumping them in and out like she had earlier. Though that's not all she has planned it seems, as you feel her [if scalevalue of player > 3]tiny tongue[else if scalevalue of player is 3]small tongue[else]tongue[end if] licking your cunt. It only takes a moment for you to start moaning from her ministrations, which apparently encourages her, if the use of her other hand starting to [if cocks of player > 1]jerk one of your cocks[if player is male]jerk your cock[else]rub your clit[end if] is anything to go by. With all of that, you're quickly brought to your own climax, leaving you moaning and trying to shove your ass in her face. Now finally finished, she gathers the food and water used as bait before doing something you can't see that leaves the net on you loose. It still takes you a minute to get out from under the net and by the time you do there is no sight of the goblin. Before leaving you take some time to examine the goblin's trap so you may be able recognize it in the future. ";
			...
			say "     She answers your questions with what she says next, 'Don't worry, I was thinking that since you played so nice, I would go ahead and help you out. Not that you have a choice, he he.' She once again shoves her fingers into your ass, immediately pumping them in and out like she had earlier. Though that's not all she has planned it seems, she uses her other hand to position your legs before lying on her back and squeezing underneath you so that she can start sucking [if cocks of player > 1]one of your cocks[else]your cock[end if], keeping her fingers going in and out of your ass the whole time. Though once she starts using her fingers to start massaging your prostate, it doesn't take long for you to start cumming straight into her mouth. ";
			say "     [if scalevalue of player > 3]Even though she can't fit your comparatively massive cock that far into her mouth, she tries to swallow all of your [cum load size of player] load, even though some still ends up covering her[else if scalevalue of player is 3]She barely manages to get your comparatively large cock into her throat, letting most of your [cum load size of player] load go straight into her stomach[else]She swallows most of your cock, leaving you shooting your [cum load size of player] load straight into her stomach[end if]. After trying to suck any remaing cum out of you for another couple seconds, she pulls her fingers from your ass and gets out from under you. Now finally finished, she gathers the food and water used as bait before doing something you can't see that leaves the net on you loose. It still takes you a minute to get out from under the net and by the time you do there is no sight of the goblin. Before leaving you take some time to examine the goblin's trap so you may be able recognize it in the future. ";
			CreatureSexAftermath "Player" receives "OralPussy" from "Goblin";
			CreatureSexAftermath "Goblin" receives "OralCock" from "Player";
		else: [Goblin is female, player is neuter]
			say "     She answers your questions with what she says next, 'Don't worry, I was going to help you out since you played so nice with me, but you don't really have anything for me to help with, do you? Such a shame.' Though she says that, she keeps groping you, seemingly having fun playing with your ass. After a couple more moments she seems to satisfy her urge to play with your cheeks and gives you a couple gentle pats on the rear. Now finally finished, she gathers the food and water used as bait before doing something you can't see that leaves the net on you loose. It still takes you a minute to get out from under the net and by the time you do there is no sight of the goblin. Before leaving you take some time to examine the goblin's trap so you may be able recognize it in the future. ";
			CreatureSexAftermath "Player" receives "OralPussy" from "Goblin";
...
to say Goblin Trap Gang Raped: [Goblin gathers other goblins to gang rape the player]
	if gobgender is 2: [3 Goblin males]
		if player is female: [3 Goblin males, female/herm player]
			...
			LineBreak;
			say "     With his piece said the first goblin gives you another slap on the ass before using his hands to spread your cunt open and pressing the tip of his dick against your entrace. He then wastes no time slamming his entire length inside you[if scalevalue of player > 3], which is barely anything, considering your differences in size[else if scalevalue of player is 3], which really isn't much, considering your differences in size[else]which is enough to fill you up, even though it's on the smaller end of cocks you've taken before[end if]. You hear what you believe to be the second goblin proclaim 'Dibs on the ass!' before feeling something [if scalevalue of player > 3]tiny [else if scalevalue of player is 3]small [end if]climbing up onto your back. You're surprised that the first goblin is able to keep thrusting in and out of your cunt with the no doubt awkard positioning, though you aren't able to focus on that for long before the second uses his thumbs to stretch your asshole, spitting on it as he does, before pressing the tip of his head against you. He takes his time slowly inserting himself before bottoming out[if scalevalue of player > 3], though you can barely feel it[else if scalevalue of player is 3], though it is also pretty small[end if]. ";
			say "     You hear one of them grumble something, though you can't tell which, before feeling another goblin climbing up you, but this one continues to climb on top of you up to your head. He positions himself infront of you before grabbing your hair and saying 'No biting, bitch!' After saying his piece, he uses his other hand to pry open your mouth before shoving his [if scalevalue of palyer > 3]tiny [else if scalevalue of player is 3]small [end if]cock in, not wasting any time before starting to facefuck you. The two goblins fucking your lower holes seem to have set a rythm together, with one pulling out of your cunt while the other is ramming into your ass. The one fucking your ass uses both hands to grab your hair to use as handles, while the other reaches below you to [if cocks of player > 1]grab one your cocks and start jerking you off[else if cocks of player is 1]grab your cock and start jerking you off[else if cunts of player > 2] start rubbing one of your other cunts[else if cunts of player is 2]start rubbing your other cunt[else if cunts of player is 1]start carressing your clit[end if]. ";
			LineBreak;
			say "     Feeling the rythmatic fucking you are receiving from the three goblins is enough for you to start moaning in pleasure, with your [if cocks of player is 1 and cunts of player is 1]cunt and cock[else if cunts of player > 1 and cocks of player > 1]cunts and cocks all[else if cunts of player is 1 and cocks of player > 1]cunt and cocks[else if cunts of player > 1 and cocks of player is 1]cunts and cock[else if player is female]cunt[else if player is male]cock[end if] drooling below you. The goblin facefucking you seems to be a bit of a quickshot compared to his friends, as he is the first to shoot his load, grabbing your head and shoving his cock as deep into your mouth as he can, with all of his load[if scalevalue of palyer > 3] shooting into your mouth, forcing you to swallow it[else if scalevalue of player is 3] barely shooting into your throat[else] shooting straight down your through[end if] . The goblin fucking your ass isn't far behind though, as he roughly grabs your waist and gives a few more enthusiastic thrusts, driving his cock deep into your ass as he starts cumming.";
			say "     Feeling the second load shooting into you is enough to send you over the edge into your own climax, causing you to moan around the cock still in your mouth. Your orgasm causes your pusssy to clench around the dick pounding it, trying to milk it for all the cum stored in the goblins balls[if cocks of player > 1] while your own [cum load size of player] load is impotently shot from your cocks onto the ground[else if player is male] while your own [cum load size of player] load is impotently shot from your cock onto the ground[end if]. Your efforts pay off as he grabs your ass and hilts himself into your wet cunt, shooting his load as deep as he can. The goblins all take a moment to rest before getting ready to leave. The one buried in your ass just pulls out and gives a rough slap to your ass before leaving without waiting for the other two, the goblin in your mouth pulls out and uses your hair to clean his cock off, before climbing over you to get out of the car. Finally, after slowly pulling out from your pussy, the goblin that was fucking it uses his hands to spread your pussy, letting some of the cum he left in it leak onto the ground[if player is male], joining your own load[end if]. ";
			LineBreak;
			say "     He then says to the remaining goblin 'See, I told you my traps would work! If I can make them better we can have more fun like this!', he then grabs your ass again before saying to you 'I'm glad you were such a good girl, make sure to caught again and we can have some more fun!' After that he lets go of your ass and moves to get the food and water he used as bait before doing something you can't see which leaves the net on top of you loosening. You hear him run off, but his friend seems to want to get the last word in, as he slaps your ass and says 'Get caught again soon! I want to fuck your ass next time!', before also running off. It still takes you a minute to get out from under the net and by the time you do there is no sight of the goblins. Before leaving you take some time to examine the goblin's trap so you may be able recognize it in the future. ";
			CreatureSexAftermath "Player" receives "PussyFuck" from "Goblin";
			CreatureSexAftermath "Player" receives "AssFuck" from "Goblin";
			...
			LineBreak;
			say "     With his piece said the first goblin gives you another slap on the ass before using his hands to stretch your ass open and pressing the tip of his dick against your hole, using some spit as lube. He then wastes no time slamming his entire length inside you[if scalevalue of player > 3], which is barely anything, considering your differences in size[else if scalevalue of player is 3], which really isn't much, considering your differences in size[else]which is enough to stretch you a little, even though it's on the smaller end of cocks you've taken before[end if]. You hear what you believe to be the second goblin proclaim 'I'm gonna fuck his face!' before feeling a goblin climbing up onto your back, continuing up to your head. He positions himself infront of your face before grabbing your hair and saying 'No biting, bitch!' After saying his piece, he uses his other hand to pry open your mouth before shoving his [if scalevalue of palyer > 3]tiny [else if scalevalue of player is 3]small [end if]cock in, not wasting any time before starting to facefuck you. ";
			say "     You hear the last say 'Wait, then what am I supposed to fuck!?' The goblin fucking your ass gives an annoyed sigh before telling him 'There's [if scalevalue of player > 3]plenty of[else if scalevalue of player is 3]still[else]some[end if] room in their ass for you to get in here with me.' The other doesn't sound happy with the suggesting, saying 'With you?! Ugh... Fine, whatever.' You then feel something [if scalevalue of player > 3]tiny [else if scalevalue of player is 3]small [end if]climbing up onto your back. You're surprised that the first goblin is able to keep thrusting in and out of your ass with the no doubt awkard positioning, though you aren't able to focus on that for long before the second uses his thumbs to spread your asshole open even more, before pressing the tip of his head against you. Even though the other is still pounding your ass, he takes his time slowly inserting himself before bottoming out[if scalevalue of player > 3], the two cocks together being big enough for you to start feeling them[else if scalevalue of player is 3], the two cocks together being enough to stretch you out a little[else], the two cocks together being enough to stretch your ass wide[end if]. The second goblin starts pounding your ass as well, and after a few moments get's into a rythm with the other, with one pulling out while the other is ramming in. ";
			LineBreak;
			say "     The one on top of your ass uses his hands to grab your hair for use as handles, while the one behind reaches below you to [if cocks of player > 1]grab one your cocks and start jerking you off[else if cocks of player is 1]grab your cock and start jerking you off[end if]. Feeling the rythmatic fucking you are receiving from the three goblins is enough for you to start moaning in pleasure, with your [if cocks of player > 1]cocks[else if player is male]cock[end if] drooling below you. The goblin facefucking you seems to be a bit of a quickshot compared to his friends, as he is the first to shoot his load, grabbing your head and shoving his cock as deep into your mouth as he can, with all of his load[if scalevalue of palyer > 3] shooting into your mouth, forcing you to swallow it[else if scalevalue of player is 3] barely shooting into your throat[else] shooting straight down your through[end if]. The second goblin fucking your ass isn't far behind though, as he roughly grabs your waist and gives a few more enthusiastic thrusts, driving his cock deep into your ass as he starts cumming. ";
		...
		if player is female: [2 Goblin males, 1 goblin female, female/herm player]
			...
			LineBreak;
			say "     With her piece said the first goblin gives you another slap on the ass before you feel them climbing up and over top of your back to your head. She positions herself infront of you before grabbing your hair and saying 'Play nice sweetie, and I'll let you go after we finish with you.' After which, she pulls her tattered loincloth to the side, revealing her small slit that she starts rubbing. She keeps masturbating herself infront of you for a moment before she repositions herself in front of your face, grabbing your hair again and shoving your face into her cunt. She actually rubs herself up and down your face, covering it in her femcum. It only takes a few seconds of that before she gets serious and shoves her cunt against your mouth and gives you a command, 'Lick.' [if player is submissive]You obey her command[else]You do as she says[end if] and start using your tongue to probe the depths of her wet slit, making sure to also pay attention to her clit. ";
			say "     You hear what you believe to be the second goblin proclaim 'Dibs on the ass!' before feeling something [if scalevalue of player > 3]tiny [else if scalevalue of player is 3]small [end if]climbing up onto your back. You're distracted from your care of the goblin in front of you as the second uses his thumbs to stretch your asshole, spitting on it as he does, before pressing the tip of his head against you. He takes his time slowly inserting himself before bottoming out[if scalevalue of player > 3], though you can barely feel it[else if scalevalue of player is 3], though it is pretty small[end if]. The final goblin approaches and says 'Nice, I get to fuck her cunt then.', before using his hands to spread your cunt open and pressing the tip of his dick against your entrace. He then wastes no time slamming his entire length inside you[if scalevalue of player > 3], which is barely anything, considering your differences in size[else if scalevalue of player is 3], which really isn't much, considering your differences in size[else]which is enough to fill you up, even though it's on the smaller end of cocks you've taken before[end if]. ";
			LineBreak;
			say "     As the two goblins start fucking your lower holes, the one with her pussy in your face seems to get upset at your lack of attention, saying 'Hey, I didn't say you could stop. Get back to work or I'll bring some more friends to play with you!' You give your attention back to the pussy in front of you, licking and sucking at it. Soon after, the two fucking you seem to have set a rythm together, with one pulling out of your cunt while the other is ramming into your ass. The one fucking your ass uses both hands to grab your hair for use as handles, while the other reaches below you to [if cocks of player > 1]grab one your cocks and start jerking you off[else if cocks of player is 1]grab your cock and start jerking you off[else if cunts of player > 2] start rubbing one of your other cunts[else if cunts of player is 2]start rubbing your other cunt[else if cunts of player is 1]start carressing your clit[end if]. ";
			say "     Feeling the rythmatic fucking you are receiving from the two goblins is enough for you to start moaning in pleasure, with your [if cocks of player is 1 and cunts of player is 1]cunt and cock[else if cunts of player > 1 and cocks of player > 1]cunts and cocks all[else if cunts of player is 1 and cocks of player > 1]cunt and cocks[else if cunts of player > 1 and cocks of player is 1]cunts and cock[else if player is female]cunt[else if player is male]cock[end if] drooling below you. The goblin ass fucking you seems to be a bit of a quickshot compared to his friend, as he is the first to shoot his load, grabbing your waist and shoving his cock as deep into your ass as he can, with all of his load[if scalevalue of palyer > 3] shooting into your bowels[else if scalevalue of player is 3] shooting deep into your bowels[else] flooding into the depths of your bowels[end if]. The goblin your eating out seems to find it exciting that her friend is currently pumping a load into your ass, as she cums soon afterwards as well, grabbing your head and grinding her cunt into your face. ";
			LineBreak;
			say "     Feeling a load shooting into your ass along with the smell of arousal from the pussy in front of you is enough to send you over the edge into your own climax, causing you to moan into her pussy. Your orgasm causeing your own pusssy to clench around the dick pounding it, trying to milk it for all the cum stored in his balls,[if cocks of player > 1] while your own [cum load size of player] load is impotently shot from your cocks onto the ground[else if player is male] while your own [cum load size of player] load is impotently shot from your cock onto the ground[end if]. Your efforts pay off as he grabs your ass and hilts himself into your wet cunt, shooting his load as deep as he can. The goblins all take a moment to rest before getting ready to leave. The one buried in your ass just pulls out and gives your ass a slap before leaving without waiting for the others. After slowly pulling out from your pussy, the goblin that was fucking it uses his hands to spread your pussy, letting some of the cum he left in it leak onto the ground[if player is male], joining your own load[end if]. Finally, the goblin in front of you pulls away, before giving you a kiss on the forehead and climbing over you out of the car. ";
			say "     She then says to the remaining goblin 'See, I told you my traps would work! If I can make them better we can have more fun like this!', she then grabs your ass again before saying to you 'I'm glad you were such a good girl, make sure to caught again and we can have some more fun!' After that she lets go of your ass and moves to get the food and water she used as bait before doing something you can't see which leaves the net on top of you loosening. You hear her run off, but her friend seems to want to get the last word in, as he slaps your ass and says 'Get caught again soon! I already want to fuck your ass again!', before also running off. It still takes you a minute to get out from under the net and by the time you do there is no sight of the goblins. Before leaving you take some time to examine the goblin's trap so you may be able recognize it in the future. ";
			CreatureSexAftermath "Player" receives "PussyFuck" from "Goblin";
			CreatureSexAftermath "Player" receives "AssFuck" from "Goblin";
			CreatureSexAftermath "Player" receives "OralPussy" from "Goblin";
...
to say Goblin Trap Finish:
	...
	else if Resolution of Goblin Trap is 5:
		LineBreak;
		say "     [bold type]You've encountered the goblin trap enough times that if you want you can choose to ignore the trap completely if you encounter anymore.[roman type][line break] ";
