...
to say darkelfF:
	if Player is female:
		say "     Stooping over your prone form, the shadowy elf examines your [if Cunt Count of Player > 1]multiple cunts[else]cunt[end if] and smiles lewdly. With a practiced motion, she swiftly runs one of her hands into your depths and begins thrusting her [if Cunt Length of Player < 6]fingers[else if Cunt Length of Player < 12]hand[else]entire forearm[end if] inside of you, expertly hitting both your clit and your internal G-spot. Dimly, you are aware that the dark elf is also fingering her own breasts and seems to be on the verge of orgasm. Then you crash over into an incredible orgasm.";
	if Player is male:
