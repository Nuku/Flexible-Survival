...
darkelf_dresscolor is a text that varies.[@Tag:NotSaved]
...
to say losetodarkelf:
	...
	if Player is neuter and Breast Size of Player is 0:
		say "     After pulling off your clothes and gear, the ebon skinned elf looks you over and snarls. 'You are WORTHLESS to me. In every way.' As you lie defeated before her, she spits in your face, and then kicks you in your head, knocking you out.";
	else:
		say "     After pulling off your clothes and gear, the ebon skinned elf looks you over and smiles. It is not a nice smile. 'You'll do, pet.' She leans over and kisses you on the lips, and you feel and unwilling arousal flood through you.";
		if Breast Size of Player > 0 and a random chance of 1 in 2 succeeds:
			...
			say "     Still holding your neck with one hand, she begins to massage your breasts, building [if HP of Player > 0]your arousal to unexpected heights. Having submitted to the dark maiden's touch, you moan in pleasure at receiving such unbridled pleasure from her touch[else]an unwanted and terrifying arousal within you. Soon, however, you find the lust eating into your thoughts, causing you to lose your desire to resist, your desire to flee[end if]. Eventually, the Dark Elf releases your neck, and uses her other hand to fondle her own massive mammary. Soon, a massive orgasm, from only breast stimulation, floods through your mind, robbing your legs of strength, and you fall to the ground.";
		else:
			...
			if Breast Size of Player > 2:
				...
				CreatureSexAftermath "Player" receives "TitFuck" from "Dark Elf";
			else:
				...
				CreatureSexAftermath "Player" receives "OralCock" from "Dark Elf";
...
to say darkelfM:
	if Player is female:
		...
		CreatureSexAftermath "Player" receives "PussyFuck" from "Dark Elf";
	else:
	...
	CreatureSexAftermath "Player" receives "AssFuck" from "Dark Elf";
...
to say darkelfF:
	if Player is female:
		...
		CreatureSexAftermath "Player" receives "PussyDildoFuck" from "Dark Elf";
	if Player is male:
		...
		CreatureSexAftermath "Dark Elf" receives "PussyFuck" from "Player";
	else:
	...
	CreatureSexAftermath "Player" receives "Stroking" from "Dark Elf";
...
to say beatthedarkelf:
	...
	if Player is male and Libido of Player > 20:
		...
		say "[line break]     [bold type]Shall you give in to this impulse?[roman type][line break]";
...
When Play begins:
	...
	now Species Name entry is "Dark Elf"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now cock change entry is "it becomes smooth and uncircumcised flesh. It takes on a very dark skin tone, but it looks quite human in shape";
	...
	now CumItem entry is "dark elf cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
"Dark Elf Infection"	"Infection"	""	Dark Elf Infection rule	1000	false

This is the Dark Elf Infection rule:
	if Player has a body of "Dark Elf":
		trigger ending "Dark Elf Infection"; [Here it states, that the ending has been played.]
