...
When Play begins:
	...
	now skin entry is "soft fur of a [if cocks of player > 0 and cunts of player > 0]pretty pink[else if cocks of player > 0]coral blue[else if cunts of player > 0]sunshine yellow[else]pastel orange[end if] color over your sensitive";
