...
to say ebheat_trigger:
	say "     A euphoric warmth in your lower belly makes you moan in pleasure and drop to your knees. You can feel a growing dampness to your pussy [if Cunt Length of Player < 8 or Cunt Tightness of Player < 5]as it stretches and swells wider [end if]in preparation. Thoughts of romping bunnies[if ovipreglevel > 1] and colorful eggs[end if] fill your idle thoughts as you go into heat.";
