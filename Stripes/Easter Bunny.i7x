...
When Play begins:
	...
	now defeated entry is "[NonCombatError]"; [beateasterbunny]
	now victory entry is "[NonCombatError]"; [losetoeasterbunny]
	now desc entry is "[NonCombatError]"; [easterbunnydesc]
	...
	now CumItem entry is "easter bunny cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
"Easter Bunny"	400	400	"[ebheat_trigger]"	"swollen and sweet-smelling bunny cunny"	"[ebheat_start]"	"[ebheat_end]"	"[ebheat]"	true	true	"A euphoric warmth in your lower belly makes you moan in pleasure and drop to your knees. You can feel an empty yearning in your ass. Your anus and rectum shifts and relaxes as it becomes more accommodating in preparation. Thoughts of romping bunnies[if ovipreglevel > 1] and colorful eggs[end if] fill your idle thoughts as you go into a strange male heat.[line break]"
...
to say ebheat:
	...
	if ebheat_egg > 6 and ebheat_msg is false:
		say "[line break]You feel a shifting in your lower belly as a small weight becomes noticeable inside you. It feels... pleasant... You rub your tummy, sighing happily.";
		...
		if Player is female:
			if ( "Litter Bearer" is listed in feats of Player and a random chance of 1 in 4 succeeds ) or a random chance of 1 in 8 succeeds:
				...
				say "[line break]     That pleasant weight you've been feeling in your lower belly has grown, resting heavily in your womb. Your bunny cunny quivers and warm juices soak your thighs as the hard lumps inside you shift about with a few clicks. You moan and stagger to someplace to sit. Your uterine walls push at the hard lumps inside you, guiding the first down into your vagina, which continues to push it out. Shivers of delight rock through you even as the candy-shelled egg crowns, building to an orgasmic climax as you manage to push it free.";
			...
			if ( "Litter Bearer" is listed in feats of Player and a random chance of 1 in 4 succeeds ) or a random chance of 1 in 8 succeeds:
				...
				say "[line break]     That small weight you've been feeling in your lower belly has grown, resting heavily in your hidden womb. Your bunny womb trembles and your asshole starts to relax as it shifts inside you. You moan and stagger to someplace to sit. Your uterine walls push at the hard lump inside you, guiding it down into your bowels, which continue to push it out. Shivers of delight rock through you even as the candy-shelled egg crowns from your anus, building to an orgasmic climax as you manage to push it free. You're left panting and drained, yet erotically satisfied after the strange experience. Taking the colorful Easter egg, you stow it away.";
				ItemGain Easter egg by 1;
				increase hunger of Player by 4;
		now ebheat_msg is false;
		now ebheat_egg is 0;
