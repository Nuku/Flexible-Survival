...
gshepmood is a number that varies.
...
Instead of resolving a Canine Patrol:
	...
	if gshepsquad is 1:
		...
		if the player consents:
			...
			say "     'That's a good girl,' the officer you were speaking to says, his own cock rising from its sheath as he rubs it. 'You're free to go, citizen. We'll take it from here,' he says in conclusion, turning momentarily back to you. [if gshepmood is 2]While a part of you wants to join in, you're[else]You're[end if] overall a little stunned by the odd turn of events and decide to head off for the moment.";
			now gshepsquad is 2;
		else:
...
to say k9vansdesc:
	if gshepsquad < 4:
		...
		say "     'Hey! I'm glad you came. Sorry for all the questions earlier, but the fact that you even came shows me that you're [if gshepmood is 2]a good dog[else if gshepmood is 1]an alright person[else]an alright person despite that feline taint you've picked up[end if],' he says, getting up and offering you his paw for a shake. 'Now, you were talking about wanting to get some help, but as you can see, we're not in much position to help out right now. We're cops and good dogs though, so we do our best.'";
...
to say sexwithBuster:
	gshepmoodcheck;
	if debugactive is 1:
		say "DEBUG -> gshepsquad: [gshepsquad], HP: [HP of Buster], gshepmood: [gshepmood], Msg 1: [if busterstory1 is true]Y[else]N[end if], Msg 2: [if busterstory2 is true]Y[else]N[end if] <- DEBUG[line break]";
	if gshepsquad < 5:
...
to say bustersex01:		[Fuck him]
	...
	say "     With your climax approaching, you grip his firm buttock with one hand and drive yourself hard and fast into the panting shepherd. He takes it with an excited bark as his ballsack tightens up, his cock throbs and moments later his runny seed is splattering onto the mat, adding fresh stains to it. His tail-hole squeezes and milks at your [cock of player] rod, sending you over the edge a few thrusts later. You cry out in orgasmic release, painting his insides with your [cum load size of player] load[if cockname of player is listed in infections of knotlist]. You remain tied and buried in his butt until your knot goes down, sharing licks and nuzzles as your sticky load rests warmly in his belly[end if]. When you dismount, [one of]he remains with his ass in the air until his tail-hole's recovered enough to clamp shut to keep your creamy load inside him[or]he lets some of your sticky load leak out and run down his thighs as he fingers his well-used hole[or]he motions for another of his dogs to come in and lick the dribbling excess of your load from his well-used hole[or]he gets one of the other dogs to toss him a butt plug, which he stuffs in his hole to keep your load locked inside[in random order].";
...
[if gshepmood is 2][else if gshepmood is 1][else][end if]
