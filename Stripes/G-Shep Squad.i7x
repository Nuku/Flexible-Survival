...
Instead of resolving a Canine Patrol:
	...
	otherwise if gshepsquad is 0:
		...
		say "     Shall you go [link]talk (Y)[as]y[end link] to these K9 officers or make a discrete [link]exit (N)[as]n[end link] while you can?";
