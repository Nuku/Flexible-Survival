...
Instead of resolving a Canine Patrol:
	...
	if gshepsquad is 1:
		...
		if the player consents:
			say "     As you approach the police dogs, one turns to face you while the other tends to the woman. He's wearing a policeman's cap, jacket, a pair of mirrored sunglasses and no pants. 'Are you [if gshepmood is 2]here to help?' he asks with a wag of his tail upon noticing your canine features[else if gshepmood is 1]a witness to this attempted assault?' he asks[otherwise]an accomplice to this attempted assault?' he barks upon noticing your feline features[end if]. You explain that you'd just arrived on scene and were about to help when they appeared[if gshepmood is 2]. 'Good dog,' he says with another wag, 'but it's best to leave the police work to us.' [else if gshepmood is 1]. 'I see,' he says, looking you over. [otherwise]. 'A likely story, cat,' he growls. [end if]He gets your statement and only has a few basic questions for you.";
...
to say k9vansdesc:
	if gshepsquad < 4:
		...
		say "     'Hey! I'm glad you came. Sorry for all the questions earlier, but the fact that you even came shows me that you're [if gshepmood is 2]a good dog[else if gshepmood is 1]an alright person[otherwise]an alright person despite that feline taint you've picked up[end if],' he says, getting up and offering you his paw for a shake. 'Now, you were talking about wanting to get some help, but as you can see, we're not in much position to help out right now. We're cops and good dogs though, so we do our best.'";
...
to say bustersex01:		[Fuck him]
	...
	say "     With your climax approaching, you grip his firm buttock with one hand and drive yourself hard and fast into the panting shepherd. He takes it with an excited bark as his ballsac tightens up, his cock throbs and moments later his runny seed is splattering onto the mat, adding fresh stains to it. His tailhole squeezes and milks at your [cock of player] rod, sending you over the edge a few thrusts later. You cry out in orgasmic release, painting his insides with your [cum load size of player] load[if cockname of player is listed in infections of knotlist]. You remain tied and buried in his butt until your knot goes down, sharing licks and nuzzles as your sticky load rests warmly in his belly[end if]. When you dismount, [one of]he remains with his ass in the air until his tailhole's recovered enough to clamp shut to keep your creamy load inside him[or]he lets some of your sticky load leak out and run down his thighs as he fingers his well-used hole[or]he motions for another of his dogs to come in and lick the dribbling excess of your load from his well-used hole[or]he gets one of the other dogs to toss him a butt plug, which he stuffs in his hole to keep your load locked inside[in random order].";
...
[if gshepmood is 2][else if gshepmood is 1][otherwise][end if]
