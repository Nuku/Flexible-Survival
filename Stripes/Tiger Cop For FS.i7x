...
Instead of resolving a Policeman:
	...
	if mqstatus is 0:
		...
		say "     'Well, it sounds like you've been able to take care of yourself fairly well to this point.  I've been continuin[apostrophe] my patrols, but this city's pretty much gone to the dogs.  Quite literally with a lot of people.  I been tryin[apostrophe] to keep some order by knockin[apostrophe] a few heads.  Takin[apostrophe] a few liberties, as well,' he adds with a smug smirk.";
		if scenario is "Researcher":
			say "     'Now, since you seem like a competent [if cunts of player > 0]gal[otherwise]guy[end if], I think I can see myself bein[apostrophe] able to overlook your...' he taps his nightstick of your backpack, '...sample gatherin[apostrophe].  That is, providin[apostrophe] you'd be willin[apostrophe] to do your civic duty and help a police officer.'";
		otherwise:
		...
		if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
		say "     'There's this small pack of tigresses that have been showing up in the seedy part of town, peddling themselves and infecting others[if stiffedpayment is 1].  I can smell their scent on you.  It don't pay to try to stiff a whore on her pay, my friend.  Perhaps you'd like a little payback?'[line break][otherwise if tigresswinner is 1].  I can smell some of their scent on you.  It seems like you've already put one in hir place.'[otherwise if tigressfucked is 1].  I can smell some of their scent on you.  It seems shi's had hir way with you.  Perhaps you'd like a little payback?'[line break][otherwise if tigressclient is 1].  I can smell their scent on you.  It seems you've already sampled their services.  You won't need to worry about [apostrophe]em taking your stuff if you'd be willin[apostrophe] to help me out.'[otherwise].'[end if]";
		say "     'I want to, you know, get [apostrophe]em under control before things get out of hand.  They seem to be based in a cheap motel in that part of town.  I could use a bit more muscle to deal with [apostrophe]em.  If I'm goin[apostrophe] to clear the place out, I need to be able to get in and lay down the law.  If you can get some more keys for their motel, I'll be able to deal with [apostrophe]em properly.  I want a handful more so I can access all the rooms and get the whole lot of [apostrophe]em.'";
		if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
		say "     'So, you tell me:  Have I found a concerned citizen who's willin[apostrophe] to help the police or another punk looter?' he asks, slapping his nightstick in his paw meaningfully. (Y/N - Do you agree to help the tiger cop?)";
...
to say givekeys:
	...
	delete motel key;
	delete motel key;
	say "     You dig into your bag, fishing out the motel keys from where they've settled at the bottom.  He flips through them, checking the room numbers.  He stuffs them into one of his pockets and smiles to you.  'Good goin[apostrophe], deputy,' he jokes with a firm punch on your shoulder.  'That covers all the rooms now.  They can't keep us out anymore.'";
...
The icon of Sgt Marks is SgtMarks_icon.
...
to say THending_helper:
	...
	say "     A few weeks after you've cleared from quarantine, you are contacted by Sgt Marks.  He lets you know he's got the girls [apostrophe]well under control[apostrophe] and invites you to come by in way of thanks for all your help.  He has set them up in a private brothel in a new city, protected by some corrupt contacts.  You don't ask for details, instead enjoying the company of his girls from time to time, quite discretely.";
...
to say THendingB:		[visibly pure Tigress Hooker survive w/helper or fled]
	say "     Once you've cleared the military cordon and are declared non-infectious, you set forth on your plan, inspired to ambition by the tiger you met.  You trade on your small fame as the [apostrophe]bunker survivor[apostrophe] and carefully embellish your tale to leave out a few [apostrophe]minor details[apostrophe] to make you look all the better.  Your lovely, pure [if cunts of player > 0]tigress [otherwise]tiger [end if]form and white fur make you an attractive hero for the media.";
