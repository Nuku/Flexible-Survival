...
Instead of resolving a Policeman:
	...
	if mqstatus is 0:
		...
		if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
		say "     'So, you tell me: Have I found a concerned citizen who's willin['] to help the police or another punk looter?' he asks, slapping his nightstick in his paw meaningfully. (Y/N - Do you agree to help the tiger cop?)";
