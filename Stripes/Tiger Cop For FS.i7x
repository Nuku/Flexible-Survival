...
to say givekeys:
	...
	say "     'Us?' you ask the big tiger as he motions for you to follow him.  'Yeah, now come along.  I've got somethin['] for ya,' he says as he goes turns a corner.  He talks with you as you both weave through the city for several blocks.  'Like I was sayin['], you've been right helpful on this and I[']m willing to cut you in on a little of the action if you[']re up for one last tussle with those pussies.  I want to go in and deal with [']em, teach [']em who[']s boss around here.  And cleaning that place up[']d be a lot easier with some extra muscle.'";
...
Instead of conversing the Sgt Marks:
	if sgtmarkstalk is 0:
		...
		say "     'Well, we never even made it there.  This accident happened as a pack of those creatures poured out from that nightclub over there.  Cats 'n dogs mostly, I think.  We didn[']t know what was goin['] on, so my partner got out to help while I was tryin['] to call it in.  Poor guy didn't know any better.  One of those tigresses pounced him.  Shi popped off pretty fast, probably well riled up by the orgy goin['] on outside.  Some of it got on me, but he took most of it and started changing fast.'";
...
to say motelquest:
	say "     Having agreed to join him, you follow the tiger cop across the city, traveling to the motel where the tigress hookers are holed up.  On the way, he doesn[apostrophe]t talk much, just telling you that there are quite a few of them, but they[apostrophe]re never all at the motel at once.  There are always some on duty, as it were.  You both will split the rooms, taking care of any tigresses in there and then you two can deal with the others as they return home.";
...
to say BTchangeover:
	...
	if cunts of player > 0:
		...
		now face of player is "feminine tiger face and long, flowing hair.  Your hair is raven black and curls lightly at the ends as it drapes across your shoulders, framing your pretty";
	...
	otherwise:
		...
		now tail of player is "From your muscled rear emerges a long, white tail with black stripes banding the fur.  It flicks behind you with excitement.";
		now face of player is "male tiger head with a strong jaw and a predatory gaze.  With a fully feline head, you have fur, stripes and whiskers cover your";
		now skin of player is "ivory white fur streaked with tiger stripes that covers your";
