...
to say sexwithBrooke:
	...
	if HP of Brooke is 0:
	...
	else if HP of Brooke is 1:		[first time scene]
		say "     Deciding to take the dancing otter up on his offer, you exit the dance floor with him. He ends up leading you into the washroom hallway and makes out with in the shadowy cul-de-sac at the end. While by no means private, it's a lot less public than out on the dance floor. And to guess from the strong scent of sex around you, you'd say this spot's been a popular choice. Catching quite a bit of otter in the mix of musky scents, you can guess you're by no means the first guy he's taken back here.";
		...
		if HP of Brooke >= 3:
			...
			[]
			if HP of Andrew >= 3 and lastfuck of Andrew - turns >= 6:
				choose a blank row in table of fucking options;
