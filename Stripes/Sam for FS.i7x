...
to say sexwithSam:
	...
	otherwise if hp of Sam is 54:
		...
		otherwise:
			...
			otherwise:
				say "[samDVoral]";
	otherwise if hp of Sam is 55 or hp of Sam is 56:
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if player consents:
					...
					if title entry is "Give fellatio":
						say "[samDVoral1]";
					otherwise if title entry is "Give cunnilingus":
						say "[samDVoral3]";
					otherwise if title entry is "Receive fellatio":
						say "[samDVoral2]";
					otherwise if title entry is "Fuck Sammie":
						if a random chance of 1 in 2 succeeds:
							say "[samDVfuck_bottom]";
						otherwise:
							say "[samDVfuck2_bottom]";
					otherwise if title entry is "Fucked by Sammie":
						if cunts of player > 0 and a random chance of 1 in 2 succeeds:
							say "[samDVfuck2_top]";
						otherwise:
							say "[samDVfuck_top]";
					otherwise if title entry is "Mount Sammie":
						say "[samDVtaurfuck_bottom]";
					otherwise if title entry is "Mounted by Sammie":
						say "[samDVtaurfuck_top]";
			otherwise:
				say "Invalid Option.";
...
to say samDVfuck54:
	if cocks of player > 0 and cunts of player > 0:
		...
		say "     Shall you [link]fuck her (Y)[as]y[end link] or let her [link]fuck you (N)[as]n[end link]?";
		if the player consents:
			say "[samDVfuck2_bottom]";
		otherwise:
			say "[samDVfuck2_top]";
