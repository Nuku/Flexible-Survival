...
Instead of conversing the Sam:
	...
	otherwise if hp of Sam is 15:
		...
		if the player consents:
			...
			if fightoutcome >= 10 and fightoutcome <= 19:
				...
				[activates Vixentaur monster - once available]
	...
	otherwise if hp of Sam is 50:		[Dracovixentaur form - INCOMPLETE - NOT FOR RELEASE YET]
	...
	if a random chance of 1 in 2 succeeds:
		...
		repeat with y running from 1 to number of filled rows in table of random critters:
			...
			if name entry is "Dragontaur":
				...
				break;
	otherwise:
		[puts Vixentaur as lead monster in case of impregnation]
		repeat with y running from 1 to number of filled rows in table of random critters:
			choose row y in table of random critters;
			if name entry is "Vixentaur":
				now monster is y;
