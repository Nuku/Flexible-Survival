...
Instead of conversing the Sam:
	if hp of Sam is 1:
		...
		if carried of cheetah milk < 2 or carried of rhino cum < 2:
			...
			delete rhino cum;
			delete rhino cum;
			say "     Sam takes the samples you've brought and sets them on the table. 'Wonderful, [if cunts of player > 0]babe[else]man[end if]. This is a big help. I'm going to get started on these tests right away. Next stuff I'm going to need is some gel from those jelly-people in the Red Light District of town. There's three different kinds of them - pink, blue and purple - and I'll need a sample from each of them. Got to analyze what makes them different. And here, take this stuff as a reward for helping me out,' he adds, handing you some dried food and another bottle of water.";
...
to say samdragontaurfuck:
	...
	say "     Lost in a haze of arousal, you can't help but agree with the dragontaur, your [bodydesc of player] form lusting for the lustful pleasure of having the dragontaur mounting you like some beast[if cocks of player > 0 or cunts of player > 0]. Soon you're grinding your hindquarters back against him as your orgasm washes through you, cumming over and over again as he drives his meat into you[else]. Soon you're grinding your hindquarters back against him in delight, your body aching to feel his release since your genderless body cannot have one of its own[end if][if cocks of player > 0]. Your spurting cock spreads your seed across the ground beneath you in large, white splotches[end if][if cunts of player > 0]. Your pussy clenches and tugs at his cock, milking at it in wanton need as you orgasm repeatedly[else]. Your tight hole clenches and tugs at his cock, squeezing firmly around it as you're awash with ecstasy[end if]. Your [bodytype of player] body is sent into pleasure overload as the big taur drives hard into you one last time and releases his hot seed, blasting heavy spurts of thick semen into your [if cunts of player > 0]womb in an attempt to breed you[else]bowels, bloating your belly with his virile load[end if].[ovichance]";
	WaitLineBreak;
...
to say samDVtaurfuck_top:
	...
	say "     Lost in a haze of arousal, you can't help but agree with the dragontaur, your [bodydesc of player] form lusting for the lustful pleasure of having the dragonvixentaur mounting you like some beast[if cocks of player > 0 or cunts of player > 0]. Soon you're grinding your hindquarters back against her as your orgasm washes through you, cumming over and over again as she drives her meat into you[else]. Soon you're grinding your hindquarters back against her in delight, your body aching to feel her release since your genderless body cannot have one of its own[end if][if cocks of player > 0]. Your spurting cock spreads your seed across the ground beneath you in large, white splotches[end if][if cunts of player > 0]. Your pussy clenches and tugs at her cock, milking at it in wanton need as you orgasm repeatedly[else]. Your tight hole clenches and tugs at her cock, squeezing firmly around it as you're awash with ecstasy[end if]. Your [bodytype of player] body is sent into pleasure overload as the big taur drives hard into you one last time, tying her knot inside you and releases her hot seed, blasting heavy spurts of thick semen into your [if cunts of player > 0]womb in an attempt to breed you[else]bowels, bloating your belly with her virile load[end if].[DVimpregchance]";
	WaitLineBreak;
