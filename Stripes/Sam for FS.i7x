...
Instead of resolving Another Researcher:
	...
	otherwise:
		say "     You start asking him why he's not turning into a dog right now, but he grins.  'Immunization resistance.  The university that's paying me's got a sponsorship deal with RSX, so they gave me some treatment to make me resistant.  Not a hundred percent guaranteed, you know, but it's held up for now.  Let's me work on this project and gather samples,' he says, holding up a small vial disgorged from his handheld device.  'Concentrated nanites courtesy of my erstwhile lover back there.  I must say, I wouldn't have gone for that sort of thing in the past, but I'm starting to like playing around with those sexy beasts,' he says, rubbing his recently fucked ass.  'Oh, I hope that's not a bad sign,' he jokes.";
...
to say minilabdesc:
	if hp of Sam <= 4:
		say "     Tucked into the corner of basement in the long-abandoned home, Sam has set up his mini-lab.  Here the researcher stores and analyzes the nanite and samples he's gathered out in the city.  His equipment's been set up on a small table with a dented folding chair for him to sit on.  There are numerous racks of labelled test tubes shaped vials on the table and more on a small bookshelf behind it.  The collection of vials seems quite impressive, with several marked with creatures you've not even seen yet.";
...
to say samscent:
	...
	otherwise if hp of Sam >= 33 and hp of Sam <= 49:
	...
	otherwise if hp of Sam is 50 or hp of Sam is 51 or hp of Sam is 52:
		say "Samantha has an arousing mix of spicy and perfumed scents coming from her dracovixen body.";
	otherwise if hp of Sam >= 53 and hp of Sam <= 69:
...
to say samdesc:
	...
	otherwise if hp of Sam >= 10 and hp of Sam <= 29:
...
Instead of conversing the Sam:
	...
	otherwise if hp of Sam is 13 or hp of Sam is 14 or hp of Sam is 16:
	...
	otherwise if hp of Sam is 15:
		...
		say "     Your thoughts have you recall that you hung onto that other vial.  You pull it out from a pocket of your pack and look it over.  The label is marked as [']#039 - Pink Vixen - Female['].  That certainly sounds safer and friendlier than a powerful dragontaur.  It might curb his aggressive nature before he goes over the edge and becomes feral.  That'd be especially bad if he did it while in the bunker.  Shall you try slipping it to him (Y) or leave well enough alone (N)?";
		if the player consents:
			...
			if fightoutcome >= 10 and fightoutcome <= 19:
				...
				otherwise:
					...
					say "     You slide your free hand across her belly and cup the nearest of her lower breasts, drawing a low moan from her as you tease its nipple.  She has three rows of breasts along her underbelly and, from the extent of her reaction, they're quite sensitive.  You slip a third finger into her vagina and pump the digits faster, using your thumb to rub over her clit, resulting in her pussy quivering aorund your fingers at this new delight.  You grin and work her wet vulpine cunt all the faster, soon driving her to her first female orgasm.  The cock throbs and twitches against her belly, spraying her seed across herself moments later.";
				attempttowait;
	...
	otherwise if hp of Sam is 33 or hp of Sam is 34:
		if a random chance of 1 in 3 succeeds and samformtalk is false:
			say "     'Rick was the one who'd found the pink vixen somewhere.  From the way he talked about it, she was a whole lot of fun and I was a bit jealous he'd met her.'  She runs her paws over her shapely body.  'But now that I am one, it's even better since I get to have all the fun SHE was having.  And more, cause I'm a hot taur as well,' she says with a giggle.";
			now samformtalk is true;
		otherwise:
	...
	otherwise if hp of Sam is 35:
		...
		if the player consents:
			...
			if fightoutcome >= 10 and fightoutcome <= 19:
				...
				say "     Sam's armoured body continues to change.  What was once hard plates at his chest and underbelly become plush with lilac fur and small breasts begin to swell up with hard lavender nipples, the same shade that the changing dragontaur's scales have become.  As Sam's gender begins to change, gaining a damp pussy behind her furred sheath and ballsac.  She moans and reaches back to stroke the growing cock, with is tapered and ridged, but knotted as well.";
				attempttowait;
	...
	otherwise if hp of Sam is 50:		[Dracovixentaur form]
		...
		now hp of Sam is 51;
	otherwise if hp of Sam is 51:
		say "     [one of]'I managed to save most of my supplies, but I'll need the rest for myself.  This big body of mine's got a big appetite.  But at least you don't have to worry about feeding me.'[or]'I'm enjoying this new body of mine.  I feels so much better than my plain old one.  I wonder why I ever resisted changing in the first place.'[or]'I'm looking forward to finding some males out there breed a few kits in me.  Just to see what it's like,' she adds with a grin.[or]'I'm looking forward to breeding a few whelps in those females out there.'[or]'I'm going to have even more fun out there now that I'm a sexy herm taur.  There's so many sexy possibilities open to me now,' she says as she runs her paws over her hybrid body.[or]'I should see if I can find that dog you saw me with and see how different he'll feel in my cunny.  And maybe I'll [']return the favour['] while I'm at it,' she says with a sly grin.[or][if number of bunkered people + number of booked people > 3]'I've already gathered samples from the others here,' she says.  'Not like that, silly' she adds with a giggle.  'Just refined from blood samples they gave.'[otherwise]'If you happen to rescue any others who've been transformed, I'll take samples from them as well.'[end if][or]'My resistance treatment still seems to be holding out despite my accident.  That means I can have all the fun I like and still stay a sexy hybrid taur.'[or]She runs a hand along your body.  'You should try having a little fun with the horny herm beast some time.  I promise this hot bod of mine will have you howling in ecstacy with me,' she moans, pressing her furry melons against you while giving you a hug.[or]'There's a lot of sexy beasts out there.  You should let a few more of them have their way with you.  Then you can come back here and have your way with me, too.  That way, we both get to enjoy it.'[or]'I think I'm in the mood to find a [if a random chance of 1 in 2 succeeds]herm[otherwise if a random chance of 1 in 2 succeeds]female[otherwise]male[end if] next time.  Hopefully there's one around that I haven't tried before.'[or]'I'm glad you weren't kidding about having enough space for me.  This is a pretty sweet setup you have here,' she says, looking around the fortified bunker.[or]'I guess I'll have to get used to being Sammie now,' she says with a giggle.[at random]";
	otherwise if hp of Sam is 52:
	...
	otherwise if hp of Sam is 53 or hp of Sam is 54:
		say "     [one of]'You don't have to worry about feeding me.  I can take care of myself,' the dracovixen rumbles.[or]'I think this new body of mine is much better.  Thanks for insisting I take them both.'[or]'I'm looking forward to breeding a few more litters in those females out there.'[or]'I'm looking forward to finding more males out there breed kits in me,' she says with a grin.[or][if number of bunkered people + number of booked people > 2]'I've already gathered samples from the others here,' she says.  'Not like that,' she adds quickly, 'just refined from blood samples they gave.'[otherwise]'If you happen to rescue any others who've been transformed, I'll take samples from them as well.'[end if][or]'My resistance treatment still seems to be holding out despite my big changes.  That means I can have all the fun I like and still stay a sexy dracovixen taur.'[or][or]She runs a hand along your body[if cocks of player > 0].  'You should have some more fun with the horny dracovixen beast soon.  I can tell you want to stuff your cock inside me[otherwise].  'You should try letting the sexy dracovixen beast mount you.  I can tell your body wants this ridged beast I'm packing inside you,' she rumbles, giving your ass a squeeze[end if] as she presses her furry melons against you while giving you a hug.[or][or]She runs a hand along your body[if cocks of player > 0].  'You should have some more fun with the horny dracovixen beast soon.  I can tell you want to stuff your cock inside me[otherwise].  'You should try letting the sexy dracovixen beast mount you.  I can tell your body wants this ridged beast I'm packing inside you,' she rumbles, giving your ass a squeeze[end if] as she presses her furry melons against you while giving you a hug.[or]'There's a lot of sexy beasts out there.  You should let a few more of them have their way with you.  Then you can come back here so I can have my way with you too.  That way, we both get to enjoy it.'[or]'I think I'm in the mood to find a [if a random chance of 1 in 2 succeeds]herm[otherwise if a random chance of 1 in 2 succeeds]female[otherwise]male[end if] next time.  Hopefully there's one around that I haven't tried before.'[or]'My new look as Sammie's pretty sexy, isn't it?' she asks with a grin, stretching her arms behind her head to show off her lovely breasts and perky, purple nipples.[at random]";
	otherwise if hp of Sam is 55 or hp of Sam is 56:		[***to be replaced later]
		say "     [one of]'You don't have to worry about feeding me.  I can take care of myself,' the dracovixen rumbles.[or]'I think this new body of mine is much better.  Thanks for insisting I take them both.'[or]'I'm looking forward to breeding a few more litters in those females out there.'[or]'I'm looking forward to finding more males out there breed kits in me,' she says with a grin.[or][if number of bunkered people + number of booked people > 2]'I've already gathered samples from the others here,' she says.  'Not like that,' she adds quickly, 'just refined from blood samples they gave.'[otherwise]'If you happen to rescue any others who've been transformed, I'll take samples from them as well.'[end if][or]'My resistance treatment still seems to be holding out despite my big changes.  That means I can have all the fun I like and still stay a sexy dracovixen taur.'[or][or]She runs a hand along your body[if cocks of player > 0].  'You should have some more fun with the horny dracovixen beast soon.  I can tell you want to stuff your cock inside me[otherwise].  'You should try letting the sexy dracovixen beast mount you.  I can tell your body wants this ridged beast I'm packing inside you,' she rumbles, giving your ass a squeeze[end if] as she presses her furry melons against you while giving you a hug.[or]'I'm looking forward to fucking you again.  Another romp with a sexy herm like me is definitely what that horny body of your needs to satisfy it,' he rumbles, licking your cheek slowly with his forked tongue.[or]'There's a lot of sexy beasts out there.  You should let a few more of them have their way with you.  Then you can come back here so I can have my way with you too.  That way, we both get to enjoy it.'[or]'I think I'm in the mood to find a [if a random chance of 1 in 2 succeeds]herm[otherwise if a random chance of 1 in 2 succeeds]female[otherwise]male[end if] next time.  Hopefully there's one around that I haven't tried before.'[or]'My new look as Sammie's pretty sexy, isn't it?' she asks with a grin, stretching her arms behind her head to show off her lovely breasts and perky, purple nipples.[at random]";
	otherwise:
		say "ERROR-Sam-[hp of Sam]L: You should not be able to find me!";
...
instead of fucking the Sam:
	...
	otherwise if hp of Sam is 12:
		...
		now hp of Sam is 13;
		now lastfuck of Sam is turns;
	otherwise if hp of Sam is 13 or hp of Sam is 14 or hp of Sam is 15 or hp of Sam is 16:
		if a random chance of 3 in 5 succeeds and ( bodyname of player is listed in infections of Taurlist or ( bodyname of player is "Skunkbeast Lord" and skrp is 1 ) ):						[taur]
	...
	otherwise if hp of Sam is 32:
		...
		now lastfuck of Sam is turns;
	otherwise if hp of Sam >= 33 and hp of Sam <= 36:
		if a random chance of 3 in 5 succeeds and ( bodyname of player is listed in infections of Taurlist or ( bodyname of player is "Skunkbeast Lord" and skrp is 1 ) ) and cocks of player > 0:		[male/herm taur]
			say "[samvixentaurfuck]";
		otherwise if a random chance of 3 in 5 succeeds and cocks of player > 0:
			say "[samvixenfuck]";
		otherwise:
			say "[samvixenoral]";
		now lastfuck of Sam is turns;
	...
	otherwise if hp of Sam is 52:
		...
		now lastfuck of Sam is turns;
		now hp of Sam is 53;
	otherwise if hp of Sam is 53 or hp of Sam is 54 or hp of Sam is 55:
		if a random chance of 3 in 5 succeeds and ( bodyname of player is listed in infections of Taurlist or ( bodyname of player is "Skunkbeast Lord" and skrp is 1 ) ):						[taur]
			...
			otherwise if cocks of player > 0:
				if ( "Less Anal" is not listed in feats of player and a random chance of 1 in 4 succeeds ) or ( "More Anal" is listed in feats of player and a random chance of 1 in 3 succeeds ):
					say "[samDVtaurfuck_top]";
				otherwise:
					say "[samDVtaurfuck_bottom]";
			otherwise:
...
to say samDVfirsttime:
	...
	otherwise:
		...
		say "     Her slender, pointed tip slips into your [if cunts of player > 0]vagina[otherwise]anus[end if] easily, but her cock thickens as that delightlyfully ribbed shaft starts spreading you open.  You moan and pant beneath her as she grins down at you, pleased to see you squirming in delight beneath her powerful form.  'That's it... take that big hybrid cock,' she rumbles, pounding you harder and faster as you stretch to accommodate the big taur's large shaft and loving every moment of it.";
		attempttowait;
		say "     Her forepaws keep a firm grip on you, pinning you down onto the cot so she can drive her strong hips forward.  Again and again, she thursts her large cock into you, fucking you like some wild beast.  The ridges along her shaft rub and stimulate your [if cunts of player > 0]vaginal walls, sliding against your clit[otherwise if cocks of player > 0]anal passage, pressing past your prostate[otherwise]anal passage[end if] to your continued delight.  Pressing your face to the nearest of her many breasts, you wrap your lips around the lavender nipple.  Eventually the frantic fucking becomes too much for Sammie and she drives hard into you one last time and tying her swelling knot in your cunt.  As the hybrid herm ties with you, her cock pulses and her hot seed to flood your [if cunts of player > 0]womb[otherwise]belly[end if][if cunts of player > 0 or cocks of player > 0], driving you to orgasm as well[end if].  You roar together and grip your lover's lower body tightly, relishing the hot, creamy feeling of his virile load being pumped into you while the hot juices from her cunny leak down onto you.[DVimpregchance]";
...
to say samDVoral:
	...
	otherwise if a random chance of 3 in 5 succeeds and cocks of player > 0:
		...
		attempttowait;
		say "     As she returns to your cock, you decide press her muzzle down onto your maleness, pushing it into her silky mouth.  She moans softly at this treatment and starts sucking and licking at your penis excitedly.  Clearly what she wanted all along, you drive your cock into her hot muzzle again and again, loving the feel of her sucking down on you.  Her teeth, which you'd except to be sharp in a dragon-like muzzle, are actually quite smooth and slide across your cock in a way that only further stimulates you.  Her agile tongue, soft palate and gripping throat feel wonderful as well.  The whole of her muzzle feels like a hot cunt around your cock with the added pleasure of her delightful tongue.  The sexy dracovixen's muzzle is clearly designed to give a wonderful blowjob and you eagerly take advantage of the opportunity to enjoy it.  And from the wet moans and muffled yips of pleasure from Sammie's stuffed muzzle, she's certainly savouring it as well.  When you finally cum and blast your hot load down her throat, she eagerly swallows it all down and cums herself, soaking her thighs and underbelly without even touching herself.";
	otherwise:
		...
		attempttowait;
		say "     She moans and yips as your tongue plays across her sensitive folds, then finds its way to her clit.  As you slide your tongue across it over and over, her hips quiver and she shifts from paw to paw.  'Mmm... right there, hon.  Your poor foxy needs that so badly.'  You slip a few fingers into her vagina, pumping them in and out and rubbing along her inner walls while moving your free hand across her belly to stroke her throbbing cock.  You do your best to pleasure the horny dracovixen, wanting her to enjoy her new herm body as much as possible.  And enjoy it she does as you tease her through several small orgasms before finally going wild in her juicy muff until you drive her to a loud, powerful orgasm that leaves your face soaked in her juices and the very satisfied hybrid panting and moaning in a puddle of her own semen on the floor.  She stretches out and fondles her upper bosom while you, lustfully aroused by the taste and scent of her all over your face, [if cocks of player > 0]jerk yourself off onto her lower breasts while she watches you get off as well[otherwise if cunts of player > 0]finger yourself to a powerful orgasm of your own while she watches you get off as well[otherwise]lick up as much as you can and wipe it up with your hands to lick it off your fingers while the pleased taur watches you enjoy her musky juices[end if].";


to say samDVfuck_top:
	say "     Sammie rumbles lustfully and presses you down onto your back on one of the bunks, moving to climb atop you again.  'Mmm... I was hoping you'd be back for more.  I'd say you need a good fucking and a hot dose of dracovixen cum,' she rumbles with a grin.  Her powerful body pins you down and grinds down against your [bodydesc of player] body, wedging her stiff meat [if cocks of player > 0]against your own[otherwise]between you both[end if].  Moving back, she gets her tapered glans lined up with your [if cunts of player > 0]wet vulva[otherwise]tight pucker[end if] and pushes it into you.  Her cock, made for spreading open her lovers, dribbles precum along your passage as her muscled hips push forward, driving her increasingly thicker shaft into you.  You moan beneath her as each of those stimulating ridges pops into you.  Soon you're panting and squirming beneath her in ecstacy as she fucks you with that exquisite cock of hers in strong, hard thrusts.";
	attempttowait;
	say "     You wrap your arms around her chest, pulling yourself down onto her cock again and again as she thrusts into you.  'Mmm... you look so sexy like that, riding my throbbing cock for all its worth.  Wanting a proper fucking until you're stuffed full of my hot seed[if cunts of player > 0] and kits[end if],' she rumbles with a smile.  You kiss and lick at her furry body, lavishing attention on this sexy beast who's mating you.  Lost in a haze of arousal, you can't help but agree with the dragontaur, your body lusting for the wonderous pleasure that you feel only her hybrid cock can bring[if cocks of player > 0 or cunts of player > 0].  Soon you're thrashing in orgasm beneath her, cumming over and over again as she drives her meat into you[otherwise].  Soon you're thrashing in delight beneath her, your body aching to feel her release since your genderless body cannot have one of its own[end if][if cocks of player > 0].  Your spurting cock rubs against her fluffy fur, loving the feel of it sliding against you as your seed soaks you both[end if][if cunts of player > 0].  Your pussy clenches and tugs at her cock, milking at it in wanton need as you orgasm repeatedly[otherwise].  Your tight hole clenches and tugs at her cock, squeezing firmly around it as you're awash with ecstacy[end if].  Your [bodytype of player] body is sent into pleasure overload as the big taur drives hard into you one last time, pushing her thick knot into you.  Once tied with you, she releases her hot seed, blasting heavy spurts of thick semen into your [if cunts of player > 0]womb in an attempt to breed you[otherwise]bowels, bloating your belly with her virile load[end if].[DVimpregchance]";
	attempttowait;
...
to say samDVtaurfuck_top:
	say "     Sammie rumbles lustfully as she looks your [bodytype of player] over.  'Mmm... now this is a fine body you've got here.  A sexy taur just ripe for mounting,' she rumbles appreciatively.  'I'd say that hot [bodyname of player] body of yours needs a good fucking and a hot dose of dracovixen cum.'  Her powerful body moves around behind you and climbs atop you, mounting your hindquarters like a beast.  Her stiff meat rubs against your rump, spitting precum onto you as it moves into position.  With her tapered glans lined up with your [if cunts of player > 0]wet cunt[otherwise]tight pucker[end if], she pushes himself further onto you, sinking it into you with a strong thrust.  Her cock, made for spreading open her lovers, dribbles precum along your passage as her muscled hips push forward, driving her increasingly thicker shaft into you.  You moan beneath her in delight as each of those stimulating ridges pops into you.  Soon you're panting and squirming beneath her in ecstacy as she fucks you with that exquisite cock of hers in strong, hard thrusts.";
	attempttowait;
	say "     With her tauric lower body atop yours, her humanoid top half presses against your back, letting her wrap his arms around you.  She hugs you like this and nips at your neck and shoulder she thrusts into you again and again.  'Mmm... you make for such a sexy taur.  That big cock stuffing you feels good, doesn't it?  Taurs are made for mounting,' she rumbles as she rubs her breasts against your back[if cunts of player > 0].  'Mmm... let's breed some kits in that hot taur body of yours, my dear,' she adds[end if][if breast size of player > 1].  Her hands move to your bosom, groping your breasts and teasing your nipples, drawing more cries of pleasure from you[end if].";
	say "     Lost in a haze of arousal, you can't help but agree with the dragontaur, your [bodydesc of player] form lusting for the lustful pleasure of having the dragonvixentaur mounting you like some beast[if cocks of player > 0 or cunts of player > 0].  Soon you're grinding your hindquarters back against her as your orgasm washes through you, cumming over and over again as she drives her meat into you[otherwise].  Soon you're grinding your hindquarters back against her in delight, your body aching to feel her release since your genderless body cannot have one of its own[end if][if cocks of player > 0].  Your spurting cock spreads your seed across the ground beneath you in large, white splotches[end if][if cunts of player > 0].  Your pussy clenches and tugs at her cock, milking at it in wanton need as you orgasm repeatedly[otherwise].  Your tight hole clenches and tugs at her cock, squeezing firmly around it as you're awash with ecstacy[end if].  Your [bodytype of player] body is sent into pleasure overload as the big taur drives hard into you one last time, tying her knot inside you and releases her hot seed, blasting heavy spurts of thick semen into your [if cunts of player > 0]womb in an attempt to breed you[otherwise]bowels, bloating your belly with her virile load[end if].[DVimpregchance]";
	attempttowait;
...
when play ends:
	if bodyname of player is not "Vixentaur" and bodyname of player is not "Dragontaur" and bodyname of player is not "Dracovixentaur":
		...
		otherwise:
			...
			otherwise if hp of Sam >= 30 and hp of Sam <= 49:		[Vixentaur - survival]
			...
			otherwise if hp of Sam >= 50 and hp of Sam <= 69:		[Dracovixentaur - survival]
