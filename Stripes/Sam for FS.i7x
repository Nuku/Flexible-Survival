...
to say samdragonfirsttime:
	...
	if baby is 0 and gestation of child is not 0:
		now facename of child is "Dragontaur";
		now bodyname of child is "Dragontaur";
		now skinname of child is "Dragontaur";
...
to say samdragontaurfuck:
	...
	attempttowait;
	say "     Once he's finished up, he steps back and slides his cock from your tauric body, sending echoes of delight through you as those ridges slip free one another another.  It twitches as it pops out, spraying a few last spurts across your hindquarters to mark you as bred by him.  Feeling sated for the moment, you slump to the floor and rest on your side, enjoying the warm, full feeling he's left inside your lower belly.  'You look so sexy as a well-fucked taur,' he rumbles with a grin as a runs a paw along your side.  'It is a nice look for you.  Maybe you should go out into the city and share it with others.  Find a few other taurs to mount you as well.  Then you can come back to me to have that new taur body mounted as well,' he rumbles while rubbing a forepaw at your creamy hole, making you shiver in delight.  As you rest and recover from the wild mating, you find yourself thinking about finding some taurs to submit to out in the city.";
	if baby is 0 and gestation of child is not 0:
		now facename of child is "Dragontaur";
		now bodyname of child is "Dragontaur";
		now skinname of child is "Dragontaur";
...
[ 3 - gave first items		]
[ 4 - gave second items		]
[ 10 - dragontaur - no talk	]
[ 11 - dragontaur - talked	]
[ 12 - dragontaur - sex once	]
[ 13 - dragontaur - sex 2+	]
[ 30 - vixentaur - no talk	]
[ 31 - vixentaur - talked	]
[ 32 - vixentaur - sex once	]
[ 33 - vixentaur - sex + fuck	]
[ 100 - did not save		]
