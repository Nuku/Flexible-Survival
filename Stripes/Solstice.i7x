...
an everyturn rule:
	if ( HP of Solstice is 3 or HP of Solstice is 4 ) and Solstice is in Makeshift Rec Room and the player is in the Grey Abbey Library:
		...
		say "     You also don't recall telling her where you've been staying and, as if sensing your upcoming question, the vulpogryph grins. 'Oh, I was just keeping an eye on you and followed you back to your clubhouse. You should be a little more careful about that. And I can certainly be of help to you as well, sweetie. Being a professional treasure hunter, I'm very good at finding stuff. I could give you some tips... for a price.' She continues running her paw over you. 'A little playtime with my special sweetie sounds fair. Though, if you want to skip the [bold type][link]lesson[as]Solstice lesson[end link][roman type] and get straight to the fun, that'd be even better,' she says with a grin at the corner of her long beak.";
