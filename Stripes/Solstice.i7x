...
Instead of resolving Adventurer:
	...
	otherwise if hp of Solstice is 2:
...
to say solsticesex:
	...
	otherwise:
		...
		otherwise if the remainder after dividing solsticemsex by 3 is 1:		[Solstice on bottom]
...
when play ends:
	if hp of Solstice >= 5:
		...
		otherwise:
			...
			otherwise:
				say "     As the soldiers are moving into the city to rescue those they can, Solstice comes up and tells you that she'll need to split.  As an 'adventurer', she explains, some people in authority may not take to kindly to her track record with certain international governments or legal technicalities.  You catch a glimpse of something gold inside her backpack and suspect she's gathered quite a few precious items from around the city.  The vulpogryph gives to a tight hug and nuzzles you with her beak, saying she'd really wished it'd worked out better with you[if diegochanged < 2], but also that she's met a cute, sneaky coyote who's promised to help her trick her way past the authorities on her expeditions from now on[otherwise], but that she's got plans to snag a sexy archeologist she knows into being her mate and adventuring partner[end if].";
