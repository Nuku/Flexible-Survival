...
Instead of conversing the Gwen:
	if HP of Gwen < 3:
		...
		say "     [one of]'Momma's so smart.'[or]'It's nice to be a kid again, at least for a bit. Or should I say [']foal[']?' she adds with a giggle.[or]'Momma takes such good care of me.'[or]'I love being a cute horsey,' she says, cantering around[if HP of Gwen < 10] a little unsteadily[end if].[or]Gwen is hugging Mare's waist while nursing from the researcher's breast. The centaur [']mother['] smiles down at her filly and strokes her red hair.[or]'Auntie Vanessa's so big and strong.'[or]'I never knew science could be so much fun.'[or]Gwen's resting atop her bunk, happily scribbling with some crayons. A lot of her colorful doodles seem to be of centaurs, though there's some of the other creatures you've seen among them all well.[or]'You should help Momma have lots more foals so I can have some brothers and sisters.'[or][if Coleen is not bunkered]'I hope the other girls from the squad are having as much fun as I am. You should look for them.'[else if Coleenslut > 0 or Coleenalpha > 0 or Coleencollared > 0]'Coleen makes such a cute doggy!'[else if sarahslut > 0]'You should totally help Coleen be a doggy. I'm sure she'd love it.'[else]'Momma says Coleen can't play with us right now. You need to find her a friend so she can have someone to play with. And then she can play with us too!'[end if][cycling]";
	else if HP of Gwen <= 35:
