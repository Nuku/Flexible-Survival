...
When Play begins:
	...
	now Species Name entry is "Cougar"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Cougar" to infections of FelineList;
	add "Cougar" to infections of FurryList;
	add "Cougar" to infections of NatureList;
	add "Cougar" to infections of HermList;
	add "Cougar" to infections of BarbedCockList;
	add "Cougar" to infections of SheathedCockList;
	...
	now MilkItem entry is "cougar milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "cougar cum"; [ Item to be given to the player if they have this infection and jerk off. ]
