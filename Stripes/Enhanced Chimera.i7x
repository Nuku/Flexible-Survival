...
to say enhancedchimeradesc:
	...
	say "     The creature's face and muzzle are [headdata]-like, but with a leonine mane that cascades over her broad shoulders and the horns of a [horndata]. Her chest is armoured with thick, scaly hide that follows the curves of her big breasts to preserve their buxom form and show off her perky nipples. The remainder of her body and limbs are covered in [furdata] fur, save for some armoured plates on the exterior of the arms and legs. Her paw-like hands and feet have plated digits ending in claws and thicker tufts of fur at the wrists and ankles. Growing from the base of her spine is a thick tail with scale and spiny ridges. Protruding from her sheath and resting above her plump ballsack is her big, meaty cock. It is blood red in colour, with a spaded tip and several firm ridges along its shaft. There's a faint swelling at the base, signs of a knot as well. Thick precum leaks down the monstrous prick as she eyes you with arousal, moving closer. ";
...
to say ec_sex:
	...
	if cunts of player > 0 and a random chance of 3 in 5 succeeds:
		...
		if hospquest >= 19:
			...
			say "     [randomfimpreg]";
	else if anallevel > 1 and ( cunts of player is 0 or anallevel is 3 ) and ( ( a random chance of anallevel in 5 succeeds and cocks of player is 0 ) or ( a random chance of anallevel in 7 succeeds and cocks of player > 0 ) ):
