...
to say enhancedchimeradesc:
	...
	say "     [if showlocale is true]As you're snooping around in the hospital, you're[otherwise]You[end if] are come across by one of those enhanced chimeras of Dr. Mouse's.  The hybrid herm could be one of those from the photos it she might be an offspring of theirs.  This one is [if lev entry < 13]a little over eight feet tall[otherwise if lev entry < 15]roughly eight and a half feet tall[otherwise]almost nine feet tall[end if] with a powerful and imposing body typical of the designed infection.";
	...
	if bodyname of player is "Enhanced Chimera" or facename of player is "Enhanced Chimera":
		say ".";
		say "     The creature looks over your chimera form and gives a soft, lustful rumble.  She moves towards you slowly, sniffing the air and purring softly.  Not seeming aggressive, you allow her to approach.  She nuzzles your cheek and runs her big paws along your body with a surprisingly gentle touch.  She's clearly looking for some affection.  Shall you have a romp with the horny herm?";
...
When Play begins:
	...
	now body change entry is "it goes through several shifts.  As these progress, you become a large and buff creature.  Your shoulders broaden and your muscles firm up, powerful while not bulging.  You stand around 9 fight tall and have a well-built frame designed for the rigours of post-apocalyptic combat";
