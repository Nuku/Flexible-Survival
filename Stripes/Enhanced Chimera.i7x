...
to say ec_sex:
	...
	if Player is female and a random chance of 3 in 5 succeeds:
		...
		if hospquest >= 19:
			...
			say "[randomfimpreg]";
	else if anallevel > 1 and ( Player is not female or anallevel is 3 ) and ( ( a random chance of anallevel in 5 succeeds and ( Player is not male or Player is mpreg_ok ) ) or ( a random chance of anallevel in 7 succeeds and Player is male ) ):
