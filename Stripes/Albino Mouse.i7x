...
When Play begins:
   ...
   now face entry is "mouse-like head with large ears and cute whiskers on your"; [ Face description, format as the text "You have a (your text) face."]
   ...
   now skin entry is "pure white fur over your"; [ skin Description, format as the text "You have (your text) skin"]
