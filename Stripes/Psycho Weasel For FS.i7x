...
to say losetopsychoweasel:
	...
	otherwise:
		say ".  It's clear that he's going to have his way with you, one way or another.  Will you quickly start sucking his cock or move into position to let him mount you?";
...
to say beatthepsychoweasel:
	say "     Having knocked down the weasel with your final blow, he curls up in a ball and starts rocking in place, mumbling about the bad [bodyname of player].  He wraps one cloth-covered paw around his throbbing cock and gnaws intermittantly at the other";
...
When Play begins:
	...
	now face change entry is "strange noises fill your ears as they change, becoming small and furry.  Your face shifts, refoming into a cartoonishly-shaped weasel head.  You can hear [one of]voices in your head[or]radio waves picked up by your braces[or]whispers from someone you can't see[at random] as you continue to change, only realizing that you were hearing yourself babbling as the changes subside";
...
when play ends:
	if bodyname of player is "Psycho Weasel":
		...
		otherwise:
			...
			otherwise if humanity of player > 50:
			...
			otherwise if humanity of player > 30:
