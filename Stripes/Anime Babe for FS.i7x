...
[	if animeclubfight is true:
	...
	else if cocks of player > 0 and cockname of player is "Parasitic Plant":		]
	if cocks of player > 0 and cockname of player is "Parasitic Plant":
	...
	else if cocks of player > 0 and cockname of player is "Tentacle Horror":
	...
	else if cocks of player > 0 and tailname of player is "Cerberus":
		...
		if libido of player > 100, now libido of player is 100;
		infect "Squid";
	else if cocks of player > 0 and cockname of player is "Squid":
...
When Play begins:
	...
	now face entry is "fairly large in proportion to your body, with long, bright blue hair, a near invisibly small nose, and gargantuan shining eyes."; [ Face description, format as the text "Your face is (your text)."]
