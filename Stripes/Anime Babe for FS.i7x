		...
		if humanity of player < 10:
			if player is pure:
				if cunts of player > 0:
					...
					say "     With this collective realization, you all get a flashy (and revealing) transformation sequence where you magically don a skimpy outfit, each in your favourite color. After giggling happily, you rush into battle in your girly outfits while waving sparkly wands and spouting meaningless Japanese catch phrases. And you are leading the charge as the cutest of the anime babes, flush with the protection of your main character field and the bonus power that always seems to come right after a new transformation sequence.";
