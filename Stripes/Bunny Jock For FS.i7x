...
to say beatthebunnyjock:
	say "     Beaten, the big bunny jock stumbles back and falls onto his rump[if cunts of player > 0]. 'Hey, baby. I just wanted to show you a little bunny love,' the rabbit complains[else]. 'Not cool, dude. I was just horsing around,' the rabbit complains[end if]. ";
	if bunnyjocknosex > 2:
