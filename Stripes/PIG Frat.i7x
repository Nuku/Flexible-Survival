...
a postimport rule:
	if Frat House is resolved:
		change North exit of Greek Street to Phi Iota Gamma;
		change South exit of Phi Iota Gamma to Greek Street;
...
to say phiiotagammadesc:
	if piginitiation is 0:
		...
		if BodyName of Player is not "Messy Pig" and BodyName of Player is not "Piggy" and FaceName of Player is not "Messy Pig" and FaceName of Player is not "Piggy":
			...
			say "[line break]     [bold type]Shall you tell him that you're looking to join up or just let it go and leave?[roman type][line break]";
		...
		say "[line break]     [bold type]Shall you ask to join the frat or take the hint and leave?[roman type][line break]";
...
to say pig_fratinitiation:
	...
	if Player is male:
		say "     Like the beer, you get passed around between several boars[if FemaleList is not banned and (Player is femaleinterested or Player is not maleinterested)] and sows[end if]. Over the course of it, you have sex with several of them while everyone gets well and truly inebriated and thoroughly fucked. You quickly lose track of how many times you've been cum in or on and how many hot holes you've filled. Throughout it all, you become increasingly porcine, transformed by the raucous partygoers into another messy frat pig.";
	else:
	...
	if wslevel is 3:
		...
		say "     'Time for you to be anointed as one of our brotherhood, piglet. All hail the mighty Phi Iota Gamma!' he oinks. As they all start oinking and grunting, they release their bladders, full and heavy with the spoils of drinking. Their hot piss rains down upon you, washing off the mud even as they mark you as one of their own. When the big gatekeeper's flow passes across your face, you grin up at him and make a show of opening your mouth wide, welcoming his hot, acrid urine into your mouth. Drinking it down reminds your bladder that it's similarly overfilled and you start pissing yourself[if Player is male], adding your piss to the streams shooting onto your belly[else], soaking your thighs as your piss arcs from your peehole into the wallow[end if]. When they're all done, you're pulled from the mud, the scent of your whole frat clinging to you.";
	else:
	...
	if humanity of Player < 10:
		say "     The party continues on from there with plenty more sex and drinking, though many adjourn to their rooms for more private romps or to pass out. You get dragged up to the doorkeeper's room along with [if Player is not female and FemaleList is not banned and (Player is femaleinterested or Player is not maleinterested)]some sows for some added fun. You have a lot of wild, piggish sex with him and the girls over the next several hours. Eventually you all end up passing out. When you wake up, the girls[else]a few other members for some added fun. You have a lot of wild, piggish sex with them over the next several hours. Eventually you all end up passing out. When you wake up, others[end if] are gone, but your new roommate is still there. And like a good roommate and freshman member should, you take his cock into your snout and wake him up with a good-morning blowjob.";
		wait for any key;
		...
		while sextablerun is 0:
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if Player consents:
					...
					if title entry is:
						-- "Get fucked by one of the boars":
							say "[fratmembersex01]";
						-- "Suck some boar cock":
							say "[fratmembersex02]";
						[-- "Fuck one of the sows":
							say "[fratmembersex03]";]
			else:
