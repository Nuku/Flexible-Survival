	...
	if Player is male:
		...
		if Breast Size of Player > 2 and lastmilking - turns > 7:
			...
			if Breast Size of Player > 8 or Nipple Count of Player > 4:
				say "     Your ample bosom provides much milk to the thirsty feline, and he climaxes several times in you as reward, pumping his thick seed into you again and again. You can feel his hot cum spray inside you and flow up into your waiting womb, causing your belly to swell with the very volume his virile balls yield.[if a random chance of 1 in 2 succeeds][impregchance][end if]"; [additional 50% chance of impreg]
...
to say snowmeow_vsex01:
	...
	CreatureSexAftermath "Snow Leopard" receives "AssFuck" from "Player";
...
to say snowmeow_vsex04:
	...
	say "     With a loud mrowl, he buries himself deep inside you and unleashes shot after shot of feline-tainted semen. The lustful feline even reaches around for your [Cock of Player] cock, stroking you off as he creams your ass. As your orgasm's ending, the snowmeow's grip on your cock wanes and his final thrust is quite feeble. With a moaning sigh, his eyes roll back in his head and he topples off of you, collapsing of heat exhaustion with a big grin on his muzzle.[if a random chance of 1 in 2 succeeds][mimpregchance][end if]"; [additional 50% chance of m-impreg]
	CreatureSexAftermath "Player" receives "AssFuck" from "Snow Leopard";
...
When Play begins:
	...
	now Species Name entry is "Snow Leopard"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now MilkItem entry is "snow leopard milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "snow leopard cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
This is the Snow Leopard Infection rule:
	if Player has a body of "Snow Leopard":
		...
		if humanity of Player < 10 and HP of Sven is 54:		[Special: Snow Leopard + Svetlana]
			say "     As the city's oppressive heat beats down on you, you feel the last of your humanity boiling away. You moan in a mix of lust and thirst as you set off into the city, roaming in search of something to wet your throat and slake your lusts. After ravaging a few of those panthers for their milk, you remember another sexy snow leopard and stumble your way to Lisa's Porn Shop. When you come in, Svetlana greets you happily, moaning lustfully under your playful groping all the way to the back room. After a long, wild rut with her pet, Lisa makes sure you get a satisfying drink of her mouse-milk. You become another snowmeow pet[if Player is female] for her to enjoy with her first feline pet[else] for her, using you to mount her first pet, as she has no interest in your fully male body[end if]. Becoming a pet after succumbing leaves you with a rather simple mind, so you have trouble following exactly what your mistress does with her new group of friends, though it is clear that she is someone important. You and Svetlana are always well taken care of and protected. Lisa always makes sure to care for your needs, treating you with loving kindness[if Player is male]. Svetlana, despite having several other playmates, will only mate with you, letting you breed her exclusively when her heats come[end if].";
