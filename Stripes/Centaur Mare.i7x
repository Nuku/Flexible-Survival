...
When Play begins:
	...
	add "Centaur Mare" to infections of EquineList;
	...
	now MilkItem entry is "centaur mare milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	...
	now Cross-Infection entry is "Centaur Stallion"; [ Infection that this infection will give the player when they lose; can be left empty if they infect with the monster's own strain. ]
