...
When Play begins:
	...
	now skin entry is "brown, darker across the head and neck. The [if cocks of player > 0]strong, [end if]musky scent of [if player is herm]rut and estrus[else if cunts of player > 0]estrus[else]unfocused arousal[end if] clings to your";
