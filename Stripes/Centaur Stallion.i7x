...
to say losetocentaurstallion:
	...
	if wslevel is 3 and ( ( Player is not female and a random chance of 1 in 5 succeeds ) or a random chance of 1 in 4 succeeds ):
		...
		if Player is female:
			...
			say "     [if Cunt Tightness of Player < 6]You can feel his enlarged, flared glans pressing at your labia, trying to spread open your entrance for him until they finally give in and allow him entry, giving you a mix of pain and pleasure as it[else]Due to your size, he finds no problem pressing his flared glans against your labia to spread open your entrance for him. They easily give in and allow him entry, giving you delightful pleasure as he[end if] continues to push in deeper. With [if Cunt Depth of Player < 28]one thrust, he drives as much of his huge cock inside you as he can, your pussy being too small to accommodate his entire length, but the centaur is keen on making it work, at least for him[else]a single thrust, he buries his huge cock completely inside your enormous pussy, sending a surge of bliss through you as he makes an excited grunt, having found a mare big enough to take his entire length[end if]. He then continues to pound you, pushing in and out of you, grunting in a near bestial manner he fucks you with that gigantic rod, thrusting over and over. With a sound almost like a neigh, he drives deep inside you and cums powerfully, filling you with copious amounts of centaur spunk. His huge balls throb and expel cup after cup of virile, equine seed into you until finally you are left bloated and panting on the ground.";
			WaitLineBreak;
		...
		else if (Player is submissive or "MPreg" is listed in feats of Player) and anallevel > 1 and a random chance of 1 in 2 succeeds:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if Player consents:
				...
				if title entry is:
					...
					-- "Get your pussy pounded":
						say "[CentaurFucksFemalePlayer]";
					-- "Get rimmed by the centaur":
						say "[CentaurRimsPlayer]";
					-- "Suck the centaur's cock":
						say "[SuckCentaurCock]";
					-- "Get the centaur to suck your dick":
...
to say SuckCentaurCock:
	...
	WaitLineBreak;
	say "     There's a startled moment for you as you wake up. You expect to be surrounded, tied up, or taken to some far off camp, but you realize you're still resting against the warm body of the centaur from before. His cock is still half hard, but his human half seems to have dozed off. You quickly move to gather your things, ignoring the dried cum across most of your body, and then you head off towards a new adventure.";
	CreatureSexAftermath "Player" receives "OralCock" from "Centaur Stallion";
...
to say CentaurSucksPlayerCock:
	...
	say "     Now satisfied and feeling empowered, you decide to gather your things and turn around to walk away, leaving the embarrassed centaur behind, to head off towards somewhere new.";
...
When Play begins:
	...
	now Name entry is "Centaur Stallion";
	...
	now Cross-Infection entry is "Centaur Mare"; [ Infection that this infection will give the player when they lose; can be left empty if they infect with the monster's own strain. ]
...
This is the Centaur Stallion Infection rule:
	if Player has a body of "Centaur Stallion" or Player has a body of "Centaur Mare":
		...
		if humanity of Player < 10:
			say "     As your infection spreads within you, you find yourself drawn back to the open plains at the edge of the city. There, you seek out the other centaurs and join their herd. As a [if Player is herm]herm centaur, you are popular among the other members of the herd and are often mounted by the stallions and sought out by the mares in heat. You happily have sex with them all, whinnying lustfully as you mate with them[else if Player is male]male centaur, you help to guard the territory. When they come into season, you are sought out by several of the mares in heat looking for you to give them a foal[else]female centaur, you help gather food and tend to the young foals. When the time comes and you go into heat, you are mounted often by the stallions, ensuring you bear the herd a foal[end if].";
			if centaurmate > 0:
