...
to say losetoredoni:
	if HP of Hayato is 97:		[doing Oni Lair challenges]
		...
		if Player is female and a random chance of 2 in 3 succeeds:
			...
			CreatureSexAftermath "Player" receives "AssFuck" from "Red Oni";
		else:
...
When Play begins:
	...
	now Species Name entry is "Red Oni"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Red Oni" to infections of DemonList;
	add "Red Oni" to infections of MythologicalList;
	add "Red Oni" to infections of MaleList;
	add "Red Oni" to infections of BipedalList;
	...
	now MilkItem entry is "red oni milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "red oni cum"; [ Item to be given to the player if they have this infection and jerk off. ]
