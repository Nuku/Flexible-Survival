...
to say blanchedesc:
	...
	otherwise if hp of Blanche is 5:
	...
	otherwise if hp of Blanche is 6:
	...
	otherwise if hp of Blanche is 7:
		...
		say "[blanche_pups_intro]";
	otherwise if hp of Blanche is 8 or hp of Blanche is 11 or hp of Blanche is 14:
		say "     Blanche is an anthropomorphic female wolf with white fur.  She has a shapely, womanly body with plump breasts and wide hips, giving her a sexy bottom beneath her fluffy tail.  She doesn't bother to wear anything now, not caring to wear clothes anymore.  While she has gotten a little fuller-figured after having had [if hp of Blanche is 7 or hp of Blanche is 8]her litter[otherwise if hp of Blanche is 11]a couple of litters[otherwise]several litters[end if], she's just as sexy and has become quite the MILF.  She also seems much happier and less frightened now that she has her loyal pack to keep her company and protect her.  The white-furred wolf usually lounges around while [if hp of Blanche is 7 or hp of Blanche is 8]directing the others as to[otherwise]teaching the younger pups about[end if] hunting and supply gathering.";
	otherwise if hp of Blanche is 9 or hp of Blanche is 10:
		say "     Blanche is an anthropomorphic female wolf with white fur.  She has a shapely, womanly body with plump breasts and wide hips, giving her a sexy bottom beneath her fluffy tail.  She doesn't bother to wear anything now, not caring to wear clothes anymore.  While she has gotten a little fuller-figured after having had her litter, [if hp of Blanche is 9]you can still tell she's got another on the way thanks to the swell in her tummy[otherwise if hp of Blanche is 10]her belly is once again round and heavy with a rapidly-advancing pregnancy[end if].  She seems quite happy these days, especially with another litter of pups on the way and with her loyal pack to keep her company and to protect her.  The white-furred wolf usually lounges on her mattress while directing the others as to hunting and supply gathering.";
	otherwise:
...
Instead of conversing the Blanche:
	...
	if hp of Blanche is 0:
		...
		now Wolfrape is resolved;
		now Office Den is known;
	otherwise if hp of Blanche is 1:
	...
	otherwise if hp of Blanche is 5 or hp of Blanche is 6:
	...
	otherwise if hp of Blanche >= 9 and blanchetalk2 is false and a random chance of 1 in 3 succeeds:
	...
	otherwise if hp of Blanche is 12 or hp of Blanche is 13:
...
to say sexwithBlanche:
	...
	otherwise if hp of Blanche is 7:
		...
		say "[blanche_pups_intro]";
	otherwise:
		say "     Approaching the sexy white wolf, you run a hand along her side and down to her rear.  She smiles at you and wags her tail a little in response.  She knows you're looking for some intimate fun and the [if Blanche is pregnant]pregnant[otherwise]lovely[end if] MILF is more than happy to provide.";
		blanchesexmenu;
...
to say sexwithBlanche01:
	...
	otherwise if cock width of player >= 20:
	...
	say ".  She gives you a big hug and an even bigger kiss before stretching out on her [if hp of Blanche is 4]mat[otherwise if hp of Blanche is 8]mattress[otherwise]bed[end if].  'Be sure to come back and breed me like that again soon,' she rumbles.";
	if hp of Blanche is 4 or ( hp of Blanche > 7 and Blanche is not pregnant and a random chance of 2 in 3 succeeds ):
		say "     Blanche remains resting on her [if hp of Blanche is 4]mat[otherwise if hp of Blanche is 8]mattress[otherwise]bed[end if] for a while, smiling happily as she caresses her belly.  You think nothing of it at first, but after a while you realize that [if cock width of player >= 20]the bulge from your semen's not fully disappeared[otherwise]her tummy's showing a small bulge now[end if].  You've knocked up the white wolf[if hp of Blanche > 4] again[end if]!";
