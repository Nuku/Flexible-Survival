...
When Play begins:
	...
	now Species Name entry is "Pool Toy"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now attack entry is "[if a random chance of 1 in 2 succeeds][one of]The sea lion[or]The purple inflatable[or]The plump male[at random] [one of]bumps against one of your legs[or]noses firmly at your groin[or]presses his large body against your legs[or]grabs onto your hips with his flippers and humps your leg with his inflated penis[at random][else][one of]The orca[or]The magenta inflatable[or]The floating female[at random] [one of]bumps against your shoulder[or]noses firmly at your chest[or]presses her large body against your torso[or]turns quickly and slaps the white underside of her tail into your face[at random][end if], making you stumble on the unsteady footing of the padded floor.";
	now defeated entry is "     Your blows to the duo of inflatable toys is finally enough to weaken them to the point that they've both sprung leaks and deflated enough to flop down on the ground. Unable to keep fighting, they squirm over to one another for comfort while their hides mend and they reinflate. Successful, you're free to move on.[line break]"; [ Text when monster loses. ]
	now victory entry is "     [if HP of Player > 0]Not wanting to resist the pair any further, you allow them to press you to the padded floor beneath them[else]Battered by their soft, but insistent, blows, you are knocked off your feet onto the padded floor. They quickly flop down atop you, pinning you down[end if].[line break]"; [ Text when monster wins. ]
	now desc entry is "     You find yourself facing off against two inflatable sea animals at once, a male sea lion and a female orca. The former is an opaque purple in color and the latter is a translucent magenta. The sea lion gives a squeezing bark which is answered by a trill from the orca, at which point they both rush you from opposite sides. They are attacking you together, the male striking from the ground and trying to trip up your legs while the female floats in the air, trying to push your body over from the other direction. Either on their own [if level of Player > 6]wouldn't be more than an annoyance, but together they're a bit of a hassle[else if level of Player > 3]wouldn't be much trouble, but together they're more effective than some of the other inflatables you've seen[else]would be a bit of a hassle, but together they're much more of a threat[end if].[line break]"; [ Description of the creature when you encounter it. ]
...
this is the slaodoubleteam rule:		[struck by both at once for increased dmg]
	...
	let dam be ( wdam entry times a random number from ( 80 - ( peppereyes * 4 ) ) to 120 ) / 66; [+50% dmg]
