...
to say koballoondesc:
	if koballoonmet is 0:
		...
		say "     The small lizard-like creatures are each only about three feet tall, but sit upon their inflated ballsacks. Their scrotums are so big their three-toed feet barely touch the ground when leaning in one direction to do so. They hardly do though, seeming to prefer to remain bouncing in place rather than stay still. And from the way their big cocks keep slapping pleasurably against those air-filled orbs with every bounce, it's easy to see why.";
