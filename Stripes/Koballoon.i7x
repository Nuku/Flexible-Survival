...
to say losetokoballoon:
	...
	if cocks of player > 0:
		...
		if ( bodyname of player is listed in infections of LatexList or skinname of player is listed in infections of LatexList ) and a random chance of 2 in 5 succeeds:
			...
			say "     The one beneath you cums first, though not by a great margin. His inflated balls, mashed beneath those of the other, are forced to give up their seed - forcing it all into you. As you [if scalevalue of player > 3]fill[otherwise]swell[end if] from the mighty output, the one atop you blasts a torrent of cum into your ass as well. Between the two of them, your belly and womb are [if scalevalue of player > 4]overstuffed with hot, gooey spunk[else if scalevalue of player > 1]overloaded with hot, gooey spunk[otherwise]bloated and rounded until they can take no more and the rest overflows from your mouth, cunt and ass[end if]. In the end, you can only moan and groan as this vigorous fucking and filling pushes you over the top. You cum repeatedly through the process as your fall into a daze of orgasmic bliss. This shameful display is made all the lewder as the other surrounding kobolds masturbate messily onto the rocking trio. You're bathed in sloppy streams of their seed, left sore, sticky and sated by the fuckfest. They leave you there for now, exhausted[if scalevalue of player < 3] and ballooned out by all the semen filling your once [body size of player] body[else if scalevalue of player < 5]and rounded by all the semen stuffed into your well-fucked holes[otherwise]and plumped by all the semen stuffed into your well-fucked holes[end if].";
	else:		[***temporary]
