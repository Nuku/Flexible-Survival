...
to say losetogiant:
	...
	if bodyname of player is "Giant" and facename of player is "Giant":
		...
		if cunts of player > 0 and cunt length of player > 25 and cunt width of player > 20 and a random chance of 2 in 3 succeeds:
			say "     Forced to lay on your back, the bigger giant moves over you, getting his earth-shaking cock lined up with your [cunt size desc of player] pussy.  Despite the large size of your cunt, it is a unquestionably a tight fit, but he makes a game effort of it.  While somewhat uncomfortable at first, you soon start to moan and squirm beneath him as at first your cunt and then your body starts to stretch to accommodate his massive girth.  And while he's only able to get part of it in you, even that much feels wonderful inside you, making you moan and pant beneath him.  And when he cums, he unleashes a veritable torrent of cum into your womb, flooding your insides as your belly swells and bulges to accommodate it all.";
			say "     Grinning, he pulls out of you with a wet plop, unleasing the flood gates and causing a massive flow of his seed to leak out of you and pool on the ground between your splayed legs.  Your giant body does manage to keep a surprising amount of it inside as well.  Too weak to get up, you ";
			if a random chance of 1 in 3 succeeds and inasituation is false:
				say "can't resist as he picks you up and carries you off, a thick finger buried in your pussy, teasing your creamy, leaking and stretched hole.  He takes you back to the gift shop and pushing you inside roughly.  'Okay, breaktime's over.  Time to get your uniform on and get back to work,' he says, turning and head off.[fimpregchance]";
		...
		otherwise:
			...
			say "     After the initial surprise and discomfort fades, you realize that your giant mouth and throat have stretched wide to accommodate his enormous meat.  It's hard for you to do more than be a tight, wet fuckhole for him, but you lick and squeeze around his meat as best you can.  Thankfully he doesn't hold out for very long and unleashes a veritable torrent of cum down your throat and into your stomach, flooding your insides as your belly swells and bulges to acccommodate it all.";
			say "     Grinning, he pulls out of you with a wet plop, unleasing the flood gates and causing a massive flow of his seed to gurgle up out of your mouth and pool on the ground in front of you.  Your giant body does manage to keep a surprising amount of it inside as well.  Too weak to get up, you ";
			if a random chance of 1 in 3 succeeds and inasituation is false:
	...
	otherwise:
		...
		say "     You can't help but grow aroused yourself as the scent of his manhood covers you and soon enough, your rubbing, licking and kissing at his cock as best you can.  You press your lips to his giant, gaping urethra, gulping down mouthfuls of his precum and diving your tongue into it.  Heedless of the consequences, you keep this up even as his excitement continues to grow to the boiling point and he finally cums loudly, spraying his hot seed all over your face, much of it being forced down into your mouth by the blast, filling you [if scalevalue of player < 4]to the point that your bloated and rounded from it[otherwise]until you're stuffed and have to push away[end if], unable to take any more.  He continues to cum in massive arcs across the zoo, leaving huge streaks of white that sends the critters who'd gathered to watch fleeing.";
...
When Play begins:
	...
	now body entry is "a normal human body, just grown to gigantic proportions.  You have a strong, muscled body to help support your great height.  At around fifteen feet tall, its quite difficult for you to get in and out, requiring you find (or make) alternate entrances or squirm your way through doorways and move on all fours while exploring.  Probably best to stick to open areas";
	now skin entry is "human";
	now tail entry is "Your ass is gigantic!";
	now cock entry is "human";
	now face change entry is "your head becomes human-like[if scalevalue of player is 4], but grown larger in size[otherwise if scalevalue of player > 4], but grown to a significantly larger size[end if].  You look much like your old self, though with a bigger head";
