...
to say coonpetsex11:		[f paw him off]
	...
	say "     You nibble his ears and stroke him harder and faster, his penis beginning to give the occasional throb while drooling and spurting his sticky preseed, the raccoon releasing cute, effeminate moans as he occasionally bucks his hips. His fingers, while inexperienced, are quite nimble and suited for the task. He slides a pair of digits into you and teases your pussy's wet lips with the others. When his cock throbs in your grip and he moans loudly in relief, the sight of his pink cum splattering onto his cute outfit is enough to push you over the edge. Your pussy clamps down onto the raccoon's fingers and your hot juices soak his paw[if cocks of player > 0]. Your cock, primed and ready, blasts your seed onto his pink uniform as well[end if]. As you get back to what you were doing, you can see him licking his paw curiously.";
	now libido of player is ( libido of player + 1 ) / 2;
...
instead of navigating Gray Abbey Library while (Candy is in the Bunker and HP of Candy < 1):
...
instead of navigating Gray Abbey Library while (Candy is in the Bunker and HP of Candy > 0 and HP of Candy < 2):
	say "[NavCheck Gray Abbey Library]";
	if NavCheckReturn is false, stop the action;
	move player to Gray Abbey Library;
	if debugactive is 1:
...
instead of navigating Gray Abbey Library while (Candy is in the Bunker and HP of Candy > 1 and HP of Candy < 3 and LastCandyWalkin - turns > 1 and a random chance of 1 in 2 succeeds):
	say "[NavCheck Gray Abbey Library]";
	if NavCheckReturn is false, stop the action;
	move player to Gray Abbey Library;
	if debugactive is 1:
...
instead of navigating Gray Abbey Library while (Candy is in the Bunker and Lust of Carl > 0 and Lust of Carl < 100 and Carl is in Gray Abbey 2F and LastCandyWalkin - turns > 8 and a random chance of 1 in 3 succeeds):
	say "[NavCheck Gray Abbey Library]";
	if NavCheckReturn is false, stop the action;
	move player to Gray Abbey Library;
	if debugactive is 1:
...
instead of navigating Gray Abbey Library while (Candy is in the Bunker and HP of Candy >= 0 and Sarah is in the bunker and sarahslut < 4 and daytimer is night and LastCandyWalkin - turns > 8 and a random chance of 1 in 2 succeeds):
	say "[NavCheck Gray Abbey Library]";
	if NavCheckReturn is false, stop the action;
	move player to Gray Abbey Library;
	if debugactive is 1:
...
after going to Gray Abbey 2F while (Candy is in the Bunker and CandyUrikInteraction > 0 and CandyUrikInteraction < 100 and lastfuck of Urik - turns > 6 and LastCandyWalkin - turns > 8 and a random chance of 1 in 3 succeeds):
	if debugactive is 1:
...
instead of navigating Gray Abbey Library while (Candy is in the Bunker and HP of Fang is 3 or HP of Fang is 4 and HP of Candy > 0 and LastCandyWalkin - turns > 8 and a random chance of 1 in 3 succeeds):
	say "[NavCheck Gray Abbey Library]";
	if NavCheckReturn is false, stop the action;
	move player to Gray Abbey Library;
	if debugactive is 1:
...
instead of navigating Gray Abbey Library while (Candy is in the Bunker and HP of Fang is 3 or HP of Fang is 4 and HP of Candy > 2 and HP of Candy < 100 and LastCandyWalkin - turns > 8 and a random chance of 1 in 3 succeeds):
	say "[NavCheck Gray Abbey Library]";
	if NavCheckReturn is false, stop the action;
	move player to Gray Abbey Library;
	if debugactive is 1:
...
instead of navigating Gray Abbey Library while (Candy is in the Bunker and HP of Candy > 0 and HP of Candy < 3 and Gryphoness is tamed and LastCandyWalkin - turns > 8 and a random chance of 1 in 3 succeeds):
	say "[NavCheck Gray Abbey Library]";
	if NavCheckReturn is false, stop the action;
	move player to Gray Abbey Library;
	if debugactive is 1:
...
instead of navigating Gray Abbey Library while (Candy is in the Bunker and HP of Candy > 0 and HP of Candy < 3 and HP of Alexandra > 0 and HP of Alexandra < 50 and LastCandyWalkin - turns > 8 and a random chance of 1 in 3 succeeds):
	say "[NavCheck Gray Abbey Library]";
	if NavCheckReturn is false, stop the action;
	move player to Gray Abbey Library;
	if debugactive is 1:
...
instead of navigating Gray Abbey Library while (Candy is in the Bunker and HP of Candy > 2 and HP of Candy < 100 and HP of Alexandra > 0 and HP of Alexandra < 50 and LastCandyWalkin - turns > 8 and a random chance of 1 in 3 succeeds):
	say "[NavCheck Gray Abbey Library]";
	if NavCheckReturn is false, stop the action;
	move player to Gray Abbey Library;
	if debugactive is 1:
	...
	if bodyname of player is "Raccoon":
		if humanity of player < 10:
			...
			if coonstatus is 0:				[w/o coon friend]
				...
				if coonstatus is 101:			[w/coon pet]
					...
					say "     The two of you remain [if cocks of player > 0]vigorous lovers[else]good friends[end if], but you can't help but notice that the raccoon's self-control is almost legendary in comparison to his past behaviors, refusing to so much as touch a soldier even if they express interest. When you question him about it, he claims that 'It'd be... wrong. I'd rather not risk infecting anyone if I can help it. Johnathan wouldn't have wanted that.' [if cocks of player > 0]This doesn't stop him from playing with you every night, of course...[end if]";
		...
		if humanity of player < 10:
			...
			if Candy is in the bunker:
				...
				say "     When you are leaving the compound, you grin as you notice that several of the soldiers are starting to get a little more effeminate themselves and you suspect there'll be a few more girly coons running around the base soon enough. Your suspicions are later confirmed when you catch the coon on the phone talking to one of them. He merrily tells you he got phone numbers from his lovers on the base and maintains phone contact with them. The army quickly finds itself with a platoon of horny, girly raccoons in a rainbow of colors in their ranks[if cocks of player > 0]. When not entertaining his many soldier lovers, the coon is always willing to enjoy your company and you fill his willing muzzle or ass on several occasions, but preferring to do so in the shower to clean and groom your messy fur afterwards. It never manages to stay that way for long, but you appreciate the effort[end if].";
			else if coonstatus is 101:
				...
				say "     When the military arrives to rescue survivors, you and Candy are both taken to one of the military's many camps. Candy and you search for any sign of his brother, but according to everyone you ask, Johnathan seems to have simply... disappeared, just before the rescue efforts began. Candy is distraught, but resolves to continue his new, saner life, if only to honor his brother's memory.";
				say "     The two of you remain [if cocks of player > 0]vigorous lovers[else]good friends[end if], but you can't help but notice that the raccoon's self-control is almost legendary in comparison to his past behaviors, refusing to so much as touch a soldier even if they express interest. When you question him about it, he claims that 'It'd be... wrong. I'd rather not risk infecting anyone if I can help it. Johnathan wouldn't have wanted that.' This doesn't stop him from covering for your nightly excursions, [if cocks of player > 0]and playing with you every night,[end if] of course...";
		...
		if humanity of the player < 10:
			if cocks of player > 0 and (HP of Candy > 0 and HP of Candy < 3) or HP of Candy >= 100:
			...
			say "     The two of you spend plenty of time together, mostly engaged in non-sexual pursuits in a shared attempt to ensure nothing goes too far. Candy's restraint is remarkable, even surrounded by such specimens of masculinity. When the two of you leave, Candy decides he 'needs room to think', getting a small apartment all by himself. [if cocks of player > 0]You visit him a few times each week, enjoying each other's company and some lovemaking.[else]You remain good friends, occasionally getting together to enjoy each other's company.[end if]";
		else:
			...
			say "     When you are leaving the compound, you can't help but notice that they were starting to get a little more effeminate themselves and you suspect there'll be a few more girly coons running around the base soon enough. Your suspicions are later confirmed when you catch the coon on the phone talking to one of them. It seems he got phone numbers from his lovers on the base and maintains phone contact with them. The army quickly finds itself with a platoon of horny, girly raccoons in a rainbow of colors in their ranks[if cocks of player > 0]. When not entertaining his many soldier lovers, the coon is always willing to enjoy your company and you fill his willing muzzle or ass on several occasions[end if].";
