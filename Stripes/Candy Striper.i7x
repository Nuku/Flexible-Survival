	...
	if bodyname of player is "Raccoon":
		...
		otherwise:							[coon player survives]
			...
			otherwise:
				...
				say "     After a few bouts of sex with you both, you start to notice the soldiers becoming more effeminate and gaining small, coonish traits they keep concealed under their uniforms.  They are not at all dismayed by this, only becoming more eager to play with you both.  Before leaving the compound after being processed, you[if coonstatus is 1] and Candy[end if] make sure you've gotten numbers from all of them and you are soon setting up meetings with them on their off hours.";
				say "     Despite being rendered non-infectious before getting discharged from the internment camp, playing with the infected soldiers reactivates your strain, allowing you to continue to change them.  When their traits start becoming too noticeable to hide any longer, you arrange for a special orgy with all of them at once.  You and [if coonstatus is 1]Candy[otherwise]your pet coon[end if] have a long romp with them, completing their change into a rainbow collection of coon bois for you.";
...
when play ends:								[coon pet / Candy - interactions]
	if humanity of player > 9:
		if coonstatus is 1:						[coon saved]
			...
			otherwise if timothymated < 3 and Gryphoness is tamed:	[coon pet + gryphon pet]
				if bodyname of player is "Hermaphrodite Gryphon":
					say "     Candy is probably your band's number one fan, running and moderating the band's web forums in his off hours.  Being bright pink, you easily spot him dancing happily with your groupies whenever you have a show in town.  You aren't at all surprised when you spot start spotting a few fans with colourful raccoon tails in the audience.";
				otherwise:
		...
		otherwise if coonstatus is -1:				[coon pet]
			...
			if pigfucked is 1:
				say "     Your raccoon pet seems jealous of the affection you give Philip.  He mopes quietly if he sees you with him or notices the boar's strong scent on you after you've had sex with him.  He steadfastly refuses to play with the pig, though will happily enjoy any other lover you share with him";
				if cocks of player is 0 and cunts of player > 0:
					say ".  When the coon gets even more sullen after the move to the pig farm and your oncoming litter, Philip has had enough.  The next time the coon hisses at him when he strokes your pregnant belly, he grabs the little boitoy and takes him right then and there, with much squealing from the boar and moans from the coon.  From that point on, he's much more affectionate with the boar and seems to like it best when the pig is rough and dirty with him.  The raccoon does pick up some bad habits though.  When once he was always well-groomed and clean, he becomes a scruffy and dirty raccoon, often rummaging around in the garbage or even taunting the pig to fuck him in the dumpster.";
				otherwise:
					say ".";
