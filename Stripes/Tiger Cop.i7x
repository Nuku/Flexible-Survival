...
to say ResolveEvent Policeman:
	...
	if mqstatus is 0:
		...
		if scenario is "Researcher":
			say "     'Now, since you seem like a competent [if Player is female]gal[else]guy[end if], I think I can see myself bein['] able to overlook your...' he taps his nightstick on your backpack, '...sample gatherin[']. That is, providin['] you'd be willin['] to do your civic duty and help a police officer.'";
		else:
...
Instead of conversing the Sgt Marks:
	...
	if sgtmarkstalk is 0:
		...
		say "     'Well, we never even made it there. This accident happened as a pack of those creatures poured out from that nightclub over there. Cats [']n dogs mostly, I think. We didn't know what was goin['] on, so my partner got out to help while I was tryin['] to call it in. Poor guy didn't know any better. One of those tigresses pounced him. She popped off pretty fast, probably well riled up by the orgy goin['] on outside. Some of it got on me, but Jack took most of it and started changing fast.'";
...
to say motelquest:
	...
	if "Stealthy" is listed in feats of Player:
		say "     You tell him that you can jump the first guard by surprise if he'll help deal with her after that. Using your Stealth abilities, you stick to the shadows and go at the building from behind. You slink with your back to the wall until you move around behind the tigress. Pouncing her, you cover her muzzle to keep her quiet while the cop rushes out to help you subdue her. Once she's out cold, you stash her around the corner and he motions for you to head up the stairs.";
		...
		if fightoutcome < 20: [player won]
			say "     You manage to subdue the tigress on guard and take a look at the rooms and a quick glance up the stairs. No one seems to have noticed the disturbance. There's some noise coming from the first ground floor room where your ally has gone in, but it's hard to tell if it's fighting or sex. With two randy tiger creatures in there, you can't really be sure.";
...
to say mqranaway:
	...
	say "     They tease and grope him as they drag him up the stairs, several of them jerking off onto him in their excitement at a new playmate. The final door on that floor opens and you see a large, powerful tigress pull him in. She gropes the new breasts that are starting to form on his chest. You are quite sure there will be another cute tigress turning tricks in the alleys quite soon.";
...
to say MQvictory:						[Victory]
	if Player is herm:		[herm]
		...
		say "     You push your next tigress to lie back on the bed and you straddle her cock, taking it deep inside you. You ride her hard and fast while stroking both yourself and another feline's cock to cum all over your current playmate. Your fast pace makes her cum with a loud mrowl of delight, filling you with her hot cum.";
		...
		say "     When you're done with your first pair, you push them aside and pull another up from the bed. You press her to the wall and pound into her tight cunt. Her inner walls grip and squeeze around you like a pro, building you back to climax quickly. Not wanting to let her take control that way, you pull out of her and sink into her tailhole. She mrowls in surprise and cums heavily onto the wall before you fill her butt with your seed and move on to the next one. She is made to mate with another tigress on the bed beneath her, driving your cock into the middle one and forcing her to thrust into the one below.";
		say "     Through the night this orgy continues, always welcoming any returning girls in kind. You and Marks fuck them over and over to assert your dominance. Somehow you both seem to have boundless stamina that night, fueled by your lust and ignited by your infection.";
	else:						[female]
...
to say BTpostchange:						[New BT form]
	if Player is herm:		[herm]
		...
		say "     As the orgy continues, your form changes to best suit your new role with these fine girls and your boss. Your body becomes that of a strong, male tiger. You are muscled and virile to keep all these girls in line. With your strength, you can easily pin down any recalcitrant girl and fuck her with your hard cock into lustful obedience. Your white fur is like the snow and its stripes like the night. You are much larger now, almost as big as your boss, Marks.";
		say "     The girls look to you for protection as their guard now while he is out making arrangements for when you will all leave this shabby motel behind and move to greener pastures out of the city.";
	else:								[female]
...
When Play begins:
	...
	now MilkItem entry is "malayan tiger male milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "malayan tiger male cum"; [ Item to be given to the player if they have this infection and jerk off. ]
