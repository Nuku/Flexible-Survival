...
Section 2 - Doctor Utah the Wereraptor
...
to say sexwithDrUtah:
	if nightmaretf > 0 or HellHoundlevel > 0 or wrcursestatus is 100:
		...
		if BodyName of Player is not "Wereraptor" or the player is not pure:
			say "     The other wereraptor grins at your offer and slides his tongue along his muzzle before leaning in to nip at your neck. He runs his taloned hands over your [bodydesc of Player] body and hisses in disappointment. 'It seems your body has not had an opportunity to revert to its proper, saurian form. It looks like we'll need to help it along.' He presses you against the wall and kisses you while rubbing his hand across his cock and gathering up his leaking precum. He then rubs his musky pre across your body while nibbling along your neck and shoulder. He smears his preseminal fluids anywhere you're not a sexy wereraptor.";
			say "     As his juices seep into your skin, you can feel the rush of excitement as you transform back";
			wrcurserestore;
			say "     Now fully restored to your saurian glory, Dr. Utah grinds himself up against you and growls lustfully. His taloned hands grip your rear, pressing their pointed claws against your scales. His tail swishes and twitches with excitement, knocking a few things aside in the now cramped office.";
		else:
			say "     The other wereraptor grins at your offer and slides his tongue along his muzzle before leaning in to nip at your neck. He runs his taloned hands over your [bodydesc of Player] body and growls lustfully. His taloned hands grip your rear, pressing their pointed claws against your scales. His tail swishes and twitches with excitement, knocking a few things aside in the now cramped office.";
		if Player is female:
			if Player is impreg_able:
				...
				say "     When his climax comes, it is wild and feral as well. He bites down on your neck and digs his claws into your shoulders, causing you to clamp down around him. Your cry is one of lustful ecstasy, the pain nothing compared to the pleasure of being fucked like a wild beast. You cum hard, your pussy quivering and milking at that 16 inch shaft in an effort to pull out very shot of saurian seed you can milk from it for your eggs. The thought of you (and many others) being bred full of wereraptor eggs extends your climax until you've gotten every last drop. Your uterus feels full and warm with his virile load by the time the transformed doctor dismounts.";
				NPCSexAftermath Doctor Utah receives "OralPussy" from Player;
				NPCSexAftermath Player receives "PussyFuck" from Doctor Utah;
				...
				NPCSexAftermath Player receives "OralCock" from Doctor Utah;
		else:
		...
		project Figure of Wereraptor_female_icon;
		if BodyName of Player is not "Wereraptor" or the player is not pure:
			say "     The other wereraptor grins at your offer and slides her tongue along her muzzle before leaning in to nip at your neck. She runs her taloned hands over your [bodydesc of Player] body and hisses in disappointment. 'It seems your body has not had an opportunity to revert to its proper, saurian form. It looks like we'll need to help it along.' She presses you against the wall and kisses you while rubbing her palm between her legs, getting it soaked in her hot juices. She then starts rubbing them over your body while nibbling along your neck and shoulder. She smears her feminine juices anywhere you're not a sexy wereraptor.";
			say "     As her juices seep into your skin, you can feel the rush of excitement as you transform back";
			wrcurserestore;
			say "     Now fully restored to your saurian glory, Dr. Utah rubs herself up against you and growls lustfully. Her taloned hands grip your rear, pressing their pointed claws against your scales. Her tail swishes and twitches upwards with excitement, knocking a few things aside in the now cramped office.";
		else:
			say "     The other wereraptor grins at your offer and slides her tongue along her muzzle before leaning in to nip at your neck. She runs her taloned hands over your [bodydesc of Player] body and growls lustfully. Her taloned hands grip your rear, pressing their pointed claws against your scales. Her tail swishes and twitches upwards with excitement, knocking a few things aside in the now cramped office.";
		if Player is male:
			if HP of Doctor Utah is even:
				...
				if a random chance of Ball Size of Player in 100 succeeds, increase lust of Doctor Utah by 1;
			else:
			...
			NPCSexAftermath Doctor Utah receives "PussyFuck" from Player;
		else:
			say "     You can smell the female's heated excitement as she gives a hiss of need and turns around. Raising her tail and spreading her legs, she offers her juicy cunt to you. You nuzzle you saurian head under her tail and give her a sniff, taking in her sexy scent before licking across her wet vent. The taste is wild and exciting, much like the wereraptor herself and it sends your lust to greater heights. Feeling your feral needs rising, you plunge your tongue into her twat and lap up her juices.";
			...
			NPCSexAftermath Doctor Utah receives "OralPussy" from Player;
		NPCSexAftermath Player receives "OralPussy" from Doctor Utah;

an everyturn rule:
	if lust of Doctor Utah > 0:
		increase lust of Doctor Utah by 1;
		if lust of Doctor Utah >= 24 and skipturnblocker is 0:
			say "[line break]By some unknown, feral instinct, you know that more of your offspring have entered this world. Your wereraptor nature urges you to return to Dr. Utah... perhaps to breed her with more eggs.";
