...
to say gshep_inactive_scene:
	...
	if Player consents:
		...
		if the player is not lonely and gshep is not listed in companionList of Player:
			...
			remove entry 1 from companionList of Player;
		AddCompanionFunction "gshep";
...
to say conf_Korvin_sex01:
	...
	say "     Feeling your release coming, you hasten your pace and thrust energetically. He'd mostly been able to stifle his moans and panting before this, but with you driving your meat hard and fast into him, he can no longer restrain himself. He chews his lip a little and manages to hold back his own orgasm until your own. As your hot cum floods his ass, he responds by cumming hard as well. His ass practically milks at your cock with every hard spurt of canine seed he shoots out onto the floor. You end up leaving your studly dog [if Ball Size of Player > 6]with a bloated belly of your cum by the time you're done and pull out[else if Ball Size of Player > 5]with a visible tummy bump because of all your cum by the time you pull out[else if Ball Size of Player > 3]stuffed and leaking your hot cum by the you're done and pull out[else]panting and sticky by the time you pull out[end if]. You make sure to pet his head and thank him for being such a good dog and such a good fuck. He can't help but smile and give a tail wag.";
