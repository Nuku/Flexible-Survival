...
to say gshep_sexargue:				[Sex role argument]
	...
	if Player consents:
		...
		if Player is male:
			...
			say "     With his [if ball size of Player > 30]belly bloated by your [Cum Load Size of Player] output[else if ball size of Player > 20]belly visibly plumped by your [Cum Load Size of Player] output[else if ball size of Player > 11]bowels stuffed by your [Cum Load Size of Player] output[else]bowels marked by your sticky output[end if], you pull out and use his fluffy tail to wipe your dick off. Your semen [if ball size of Player > 16]flows[else]leaks[end if] from his well-fucked hole, sticking to the fur of his thighs. Getting off him, you pull Korvin to his knees. His doggy dick is rock hard and drooling precum steadily after the rough and rapid fucking he's received.";
...
to say gshep_bedcrumbs:
	...
	if Player consents:
		...
		if Player consents:
			...
			if Player is male:
				say "aim your cock[smn] down at him and [if ball size of Player > 24]hose him down with your copious seed[else if ball size of Player > 12]spray your load across his head and upper body[else]spray your load across his face and muzzle[end if]. He's left on the messy floor, sticking with your cum and littered with spilt dog treats - several of which have now been flavored by your semen.";
			else:
			...
			if Player is male:
				say "pushing him back with your foot. You aim your cock[smn] down at him and [if ball size of Player > 24]hose him down with your copious seed[else if ball size of Player > 12]spray your load across his head and upper body[else]spray your load across his face and muzzle[end if]. He's left on the messy floor, sticking with your cum and littered with spilt dog treats - several of which have now been flavored by your semen.";
			else:
		...
		if Player is male:
			...
			say "     After shooting your load into his clenching hole, he's left sticky with cum both on his front and his behind and your bunk is even more the mess. Giving his rope collar a tug, you order him to clean up the mess he's made of your bed when he's recovered. 'And no more getting crumbs on my bed. When I want to fuck you, you'll know it, you slut,' you add with a light slap to his well-pounded rear. Korvin climbs out of the bed and obediently cleans up your bunk and the floor around it without delay or backtalk[if ball size of Player > 24]. For a while he ends up making more mess on the floor behind himself than he's cleaning up, as he leaves frequent dribbles of your semen behind himself as he goes[else if ball size of Player > 12], though he does have to go over some spots twice as he leaks semen from his well-used bottom for a time[end if].";
		else:
...
to say gsd_collar_scene:
	...
	if ( gshep_postfight + gshep_sexscene + gshep_bed_scene + gshep_inactive ) >= 5:
		...
		if Player is male:
			...
			say "     'Good boy,' you say with a victorious smile. 'And good boys get to cum.' Taking his cock in hand, you pump it while pounding him. You're both pushed to a powerful orgasm that leaves him [if ball size of Player > 30]bloated with an outpouring of his virile alpha's seed[else if ball size of Player > 20]stuffed and leaking his alpha's plentiful seed[else]gooey with his alpha's seed slowly leaking from his rear[end if].";
		else:
		...
		if Player is male:
			...
			say "     At this point, he's beyond trying to act aloof. 'So good, Alpha. Nggg... gotta cum,' he moans. True to his word, his asshole clamps down around your meat, practically milking at it as his balls draw up repeatedly and his shaft pulses. With each pulse, comes a powerful blast of canine semen that splatters across the ground beneath him. Having his hot hole squeezing your rod while the scent of doggy cum fills the air is more than enough to put you over the top and you cum hard into him. In the end, he's left [if ball size of Player > 30]bloated with an outpouring of his virile alpha's seed[else if ball size of Player > 20]stuffed and leaking his alpha's plentiful seed[else]gooey with his alpha's seed slowly leaking from his rear[end if] and obviously pleased with himself.";
		else:
			say ".";
...
to say conf_Korvin_sex01:
	...
	say "     Feeling your release coming, you hasten your pace and thrust energetically. He'd mostly been able to stifle his moans and panting before this, but with you driving your meat hard and fast into him, he can no longer restrain himself. He chews his lip a little and manages to hold back his own orgasm until your own. As your hot cum floods his ass, he responds by cumming hard as well. His ass practically milks at your cock with every hard spurt of canine seed he shoots out onto the floor. You end up leaving your studly dog [if ball size of Player > 30]with a bloated belly of your cum by the time you're done and pull out[else if ball size of Player > 20]with a visible tummy bump because of all your cum by the time you pull out[else if ball size of Player > 11]stuffed and leaking your hot cum by the you're done and pull out[else]panting and sticky by the time you pull out[end if]. You make sure to pet his head and thank him for being such a good dog and such a good fuck. He can't help but smile and give a tail wag.";
...
to say conf_Korvin_sex08:
	...
	if a random chance of 3 in 5 succeeds:
		say ". Your penis pulses hard with every shot, [if ball size of Player > 30]blasting your [Cum Load Size of Player] load down his throat and bulging that toned tummy of his [else if ball size of Player > 20]blasting your [Cum Load Size of Player] load down his throat to fill his stomach with a feast of your rich, hot semen[else if ball size of Player > 11]firing your [Cum Load Size of Player] load down his throat and providing him with a nice, hot meal of your semen[else]pumping the tasty treat of your hot load down his throat[end if]. He gulps it all down, releasing muffled moans while his tail wags wildly[if Cock Count of Player > 2] and your other dicks hose him down with white streaks[else if Cock Count of Player is 2] and your other dick hoses him down with white streaks[end if].";
	else:
		say ". After the first few shots of semen go down his throat, he pulls his muzzle off your [cock size desc of Player] cock and pumps your shaft with his paw[if Cock Length of Player > 16]s[end if]. Your penis[esmn] fire[smv] your remaining cum across his face and muzzle, [if ball size of Player > 30]plastering him in a coating[else if ball size of Player > 20]plastering him with wads[else if ball size of Player > 11]streaking him with large ribbons[else]streaking him with several more strands[end if] of sticky white goo.";
	say "     Once done, he licks his chops and grins up at you. '[one of]I hope that was good enough for you, ya big fag,' he teases[or]Not bad, alpha, but next time you should try mine,' he says[or][if ball size of Player > 20]Hmmph! Pretty impressive[else]Tasty[end if],' he says[or]My Alpha,' he states with a nod[or]That better be all. I got stuff to do,' he states, trying to recover some dignity[at random]. You let him get on his way while you take a moment to enjoy the blissful afterglow.";
...
to say subby_Korvin_sexmenu:
	if Player is male:
		...
		WaitLineBreak;
		say "     You have your fun with him, thrusting into that clenching hole of his. After a few thrusts, he's grinding back into you with need, so you reach around and fondle his junk. This serves to encourage more of this kind of behavior from him in the future. And after a good fuck session, you're both more than ready to pop, so you slam [if Cock Length of Player > 16]fully[else]hard[end if] and unload[if ball size of Player > 30]. Your [Cum Load Size of Player] load stuffs him so full his toned abdomen swells with your output[else if ball size of Player > 20]. Your [Cum Load Size of Player] load stuffs him so full his toned abdomen bulges with your output[else if ball size of Player > 11]. Your [Cum Load Size of Player] load fills his bowels with your sticky semen[else]. Your load fires into his bowels, once again stacking your claim on him as yours[end if]. Feeling this, your trained subby puppy stops holding back and cums as well, expending his virile seed onto the ground all while milking you for more or your own. Once done, you pull out, pat his messy ass and tell him what a good dog he is, much to your pet's pleasure before leaving him to recover.";
	else:
