...
to say gshep_bedcrumbs:
	...
	if player consents:
		...
		if player consents:
			...
			if cocks of player > 0:
				say "aim your cock[smn] down at him and [if cock width of player > 24]hose him down with your copious seed[else if cock width of player > 12]spray your load across his head and upper body[otherwise]spray your load across his face and muzzle[end if]. He's left on the messy floor, sticking with your cum and littered with spilt dog treats - several of which have now been flavoured by your semen.";
			else:
...
to say gsd_collar_scene:
	...
	if ( gshep_postfight + gshep_sexscene + gshep_bed_scene + gshep_inactive ) >= 5:
		...
		if cocks of player > 0:
			...
			say "     'Good boy,' you say with a victorious smile. 'And good boys get to cum.'  Taking his cock in hand, you pump it while pounding him. You're both pushed to a powerful orgasm that leaves him [if cock width of player > 30]bloated with an outpouring of his virile alpha's seed[else if cock width of player > 20]stuffed and leaking his alpha's plentiful seed[otherwise]gooey with his alpha's seed slowly leaking from his rear[end if].";
		else:
			...
			say "     'And what are you?' you ask, reaching back to grope his balls while grinding down onto his meaty shaft with your [if cunt width of player > 18]ample[else if cunt width of player > 6]wet[otherwise]tight[end if] snatch.";
			say "     'I'm your subby puppy,' he moans. 'Please fuck your puppy, [if cunts of player > 0]Mistress[otherwise]Master[end if].'";
		...
		if cocks of player > 0:
			...
			say "     At this point, he's beyond trying to act aloof. 'So good, Alpha. Nggg... gotta cum,' he moans. True to his word, his asshole clamps down around your meat, practically milking at it as his balls draw up repeatedly and his shaft pulses. With each pulse, comes a powerful blast of canine semen that splatters across the ground beneath him. Having his hot hole squeezing your rod while the scent of doggy cum fills the air is more than enough to put you over the top and you cum hard into him. In the end, he's left [if cock width of player > 30]bloated with an outpouring of his virile alpha's seed[else if cock width of player > 20]stuffed and leaking his alpha's plentiful seed[otherwise]gooey with his alpha's seed slowly leaking from his rear[end if] and obviously pleased with himself.";
		else:
			say ".";
...
to say conf_Korvin_sex01:
	...
	say "     Feeling your release coming, you hasten your pace and thrust energetically. He'd mostly been able to stifle his moans and panting before this, but with you driving your meat hard and fast into him, he can no longer restrain himself. He chews his lip a little and manages to hold back his own orgasm until your own. As your hot cum floods his ass, he responds by cumming hard as well. His ass practically milks at your cock with every hard spurt of canine seed he shoots out onto the floor. You end up leaving your studly dog [if cock width of player > 30]with a bloated belly of your cum by the time you're done and pull out[else if cock width of player > 20]with a visible tummy bump because of all your cum by the time you pull out[else if cock width of player > 11]stuffed and leaking your hot cum by the you're done and pull out[otherwise]panting and sticky by the time you pull out[end if]. You make sure to pet his head and thank him for being such a good dog and such a good fuck. He can't help but smile and give a tail wag.";
...
to say conf_Korvin_sex08:
	...
	if a random chance of 3 in 5 succeeds:
		say ". Your penis pulses hard with every shot, [if cock width of player > 30]blasting your [cum load size of player] load down his throat and bulging that toned tummy of his [else if cock width of player > 20]blasting your [cum load size of player] load down his throat to fill his stomach with a feast of your rich, hot semen[else if cock width of player > 11]firing your [cum load size of player] load down his throat and providing him with a nice, hot meal of your semen[otherwise]pumping the tasty treat of your hot load down his throat[end if]. He gulps it all down, releasing muffled moans while his tail wags wildly[if cocks of player > 2] and your other dicks hose him down with white streaks[else if cocks of player is 2] and your other dick hoses him down with white streaks[end if].";
	else:
		say ". After the first few shots of semen go down his throat, he pulls his muzzle off your [cock size desc of player] cock and pumps your shaft with his paw[if cock length of player > 16]s[end if]. Your penis[esmn] fire[smv] your remaining cum across his face and muzzle, [if cock width of player > 30]plastering him in a coating[else if cock width of player > 20]plastering him with wads[else if cock width of player > 11]streaking him with large ribbons[otherwise]streaking him with several more strands[end if] of sticky white goo.";
...
to say subby_Korvin_sexmenu:
	if cocks of player > 0:
		...
		WaitLineBreak;
		say "     You have your fun with him, thrusting into that clenching hole of his. After a few thrusts, he's grinding back into you with need, so you reach around and fondle his junk. This serves to encourage more of this kind of behaviour from him in the future. And after a good fuck session, you're both more than ready to pop, so you slam [if cock length of player > 16]fully[otherwise]hard[end if] and unload[if cock width of player > 30]. Your [cum load size of player] load stuffs him so full his toned abdomen swells with your output[else if cock width of player > 20]. Your [cum load size of player] load stuffs him so full his toned abdomen bulges with your output[else if cock width of player > 11]. Your [cum load size of player] load fills his bowels with your sticky semen[otherwise]. Your load fires into his bowels, once again stacking your claim on him as yours[end if]. Feeling this, your trained subby puppy stops holding back and cums as well, expending his virile seed onto the ground all while milking you for more or your own. Once done, you pull out, pat his messy ass and tell him what a good dog he is, much to your pet's pleasure before leaving him to recover.";
	else:
