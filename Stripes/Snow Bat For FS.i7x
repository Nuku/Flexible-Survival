...
to say losetosnowbat:
	...
	if scalevalue of player > 0 and ( cunts of player > 0 or "More Anal" is listed in feats of player or "MPreg" is listed in feats of player ) and daytimer is night and a random chance of 2 in 5 succeeds:
		...
		If cunts of player > 0:
			...
			say "     Overwhelmed, [if cocks of player > 1]your cocks fire off their load into the air, causing you to pass out[else if cocks of player > 0]your cock fires off its load into the air, causing you to pass out[else]you pass out[end if]; eventually, you awake. Back on the ground, exhausted, and thirsty, you gather yourself before slowly going back on your way.";
	else if ( cunts of player > 0 or "Less Anal" is not listed in feats of player or "MPreg" is listed in feats of player ) and a random chance of 3 in 5 succeeds:
		...
		say "     Overwhelmed, [if cocks of player > 1]your cocks fire off their load into the dirt, causing you to pass out[else if cocks of player > 0]your cock fires off its load into the dirt, causing you to pass out[else]you pass out[end if]; eventually, you awake. Now abandoned, exhausted, and thirsty, you gather yourself before slowly going back on your way.";
	else:
...
when play ends:
	if bodyname of player is "Snow Bat":
		if humanity of player < 10 and HP of Sven is 54 and cocks of player > 0:	[Special: Male/Herm Snow Bat + Svetlana]
			...
			if HP of Sven > 0 and HP of Sven < 10:
				...
				say "     You head off to your true goal. While part of your memories are hazy, you do recall a male snow leopard waiting to see you again and make your way there one evening. Standing in the shadows outside, you purr softly and wait for him to notice you. Hearing you, he is drawn out and into your arms. You guide him to the ground and slide atop him, stroking and caressing his body as you kiss and nip at his neck[if cunts of player > 0]. As you sink down onto his cock, you sink your fangs into his neck and start drinking as you ride his erection until he cums for you[else]. As you give his ass a squeeze, you sink your fangs into his neck and start drinking[end if]. After he passes out, you kiss his neck as Candy pokes his head out of the bunker to look for the snowmeow.";
