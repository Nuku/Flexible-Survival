	...
	if scalevalue of player > 0 and ( cunts of player > 0 or "More Anal" is listed in feats of player or "MPreg" is listed in feats of player ) and daytimer is night and a random chance of 2 in 5 succeeds:
		...
		If cunts of player > 0:
			...
			If scalevalue of player > 3:
				say "     His endeavor is clearly impeded by your disparate size, and he continues to feed himself for a while longer before he briefly relinquishes you, crawling down to treat you proper. You quickly feel his cock drives into [if cunts of player > 1]one of your cunts[else]your cunt[end if].";
			else:
