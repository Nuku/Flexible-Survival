...
to say snowbatdesc:
	...
	say "     Swooping from the sky is a hybrid snow bat, a cross between a snow leopard and a bat.  The bat wings which allow this snowmeow to fly are covered in an even grey fur, lacking the spots and markings of his feline body.  His feline face is distorted into the sharper and more pointed shape of a bat's, with an upturned nose, pointed muzzle, fangs and large ears.  His footpaws have been reshaped for perching as well as grasping its prey.  He's got a sizeable sheath and large balls between his legs and may be hoping to use them on you[if nightcheck is 0].  With the bright daytime sun out, his sensitive eyes water as he tries to shield them from the light[otherwise].  In dark of the night, the bat-hybrid has a definite advantage with its echolocation[end if].";
