...
to say losetobluechaffinch:
	...
	if cunts of player > 0:
		...
		say "     You grow increasingly aroused as the mating continues, his soft feathers rubbing against your hips, thighs and pussy lips as he thrusts into you[if hp of player > 0].  As you're not resisting his advances[otherwise].  As you're no longer resisting his advances[end if], he lets his taloned hands roam over your [bodytype of player] body and leans gently overtop you, letting his fluffy chest rub against your back.  Between the soft feathers rubbing against you and the hard cock pumping inside you until finally you both cum loudly[if facename of player is name entry], your mating song joining in with his[otherwise] with him chirping and moaning[end if] as his hot seed pumps into your cunt and flows into your womb.[ovichance]";
...
to say beatthebluechaffinch:
	...
	otherwise if cocks of player > 0 and formcheck is 2:	[feline]
		if nobluechaffinchsex > 2:
