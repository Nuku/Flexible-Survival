...
"Inflatable Vulpine"	"[PrepCombat_Inflatable Vulpine]"

to say PrepCombat_Inflatable Vulpine:
	setmongender 4;]
...
When Play begins:
	...
	now Species Name entry is "Inflatable Vulpine"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	add "Inflatable Vulpine" to infections of FemaleList;
	add "Inflatable Vulpine" to infections of KnottedCockList;
	add "Inflatable Vulpine" to infections of SheathedCockList;
	add "Inflatable Vulpine" to infections of BipedalList;
	add "Inflatable Vulpine" to infections of TailList;
	...
	now defeated entry is "[NonCombatError]"; [beattheinfvulp]
	now victory entry is "[NonCombatError]"; [losetoinfvulp]
	now desc entry is "[NonCombatError]"; [infvulpdesc]
	...
	now MilkItem entry is "inflatable vulpine milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "inflatable vulpine cum"; [ Item to be given to the player if they have this infection and jerk off. ]
