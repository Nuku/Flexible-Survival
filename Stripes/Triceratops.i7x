...
to say losetotric:
	...
	else if Player is male and (CockName of Player is "Triceratops" or CockName of Player is "Triceratops Male"):
...
When Play begins:
	...
	now Species Name entry is "Triceratops"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Triceratops" to infections of ReptileList;
	add "Triceratops" to infections of FurryList;
	add "Triceratops" to infections of HistoricalList;
	add "Triceratops" to infections of NatureList;
	add "Triceratops" to infections of FemaleList;
	add "Triceratops" to infections of TaperedCockList;
	add "Triceratops" to infections of InternalCockList;
	add "Triceratops" to infections of InternalBallsList;
	...
	now MilkItem entry is "triceratops milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "triceratops cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
This is the Triceratops Infection rule:
	if Player has a body of "Triceratops":
		...
		if humanity of Player < 10:
			...
			else if (Player is female or "MPreg" is listed in feats of Player) and Player is not sterile: [F-BREEDABLE]
