...
Instead of resolving a Insect Hive:
	say "     Searching through the high rise district, you start along a shadowy alley between two towers.  You slow as you spot something unusual here.  Scattered in clusters along the side are sticky orbs.  They have a rather gellatinous appearance and are split open with trails of sticky slime leading from them further into the alley.  All of this gives you strong reason to pause, unsure if you want to continue forward.";
	say "[bracket]Extreme content warning.  Shall you proceed?[close bracket][line break]";
	...
	if insectlarva is true and skipturnblocker is 0:
		...
		otherwise if larvaegg is 1 and gestation of child is 0:
			...
			if larvacounter >= ( 12 + larvalaid ) and gestation of child is 0:
				if humanity of player - libido of player > 40:
...
to say losetoblackwasp:
	...
	if larvaegg is 1 and gestation of child is 0:
		...
		now larvaegg is 2;
	otherwise:
		say ".  Your [if cunts of player > 0]womb[otherwise]belly[end if] is filled with a satisfying warmth as its seed flows into you, causing the larva inside you to squirm excitely.";
...
When Play begins:
	...
	now ass change entry is "a growing protruberance begins to form, turning into a large, segmented bulge.  As it continues to mature, it forms into an abdomen like that of a wasp";
