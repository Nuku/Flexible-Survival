...
to say losetomathteacher:
	if cunts of player > 0:
		...
		if a random chance of 1 in 3 succeeds:
			say "     You hear the faint sound of clothing crumpling to the floor.  With the clacking of heels against the ground, the teacher walks in front of you. With her skirt and panties gone, you are treated to the sight of her eight-inch penis bobbing erect in front of your face.  'Now, you need to make up for interrupting the class,' she barks.  You obediently take the cock into your mout and start to bob your head, still wincing from your spanking.  After a few moments, the cock suddenly is pulled from your mouth and paints your face white with math teacher spunk.  'Now, go clean yourself up and [one of]finish your homework next time[or]don't be late for class again[or]don't let me catch you cheating again[at random].'  With that, the deluded teacher walks away, a slight annoyance evident in her pace.";
		otherwise:
			say "     You hear the faint sound of clothing crumpling to the floor shortly before you feel something hard pressing against your tender bottom.  'Well, I guess [one of]you need to be taught to pay more attention in class[or]I'll need to perform some long division between your legs[or]I will have to show you how to properly use a slide rule[at random],' she says before thrusting her cock into you without further delay.  You moan at the sudden penetration and the slap of her thighs against your tender ass.  Soon she's pounding away at you while making very precise comments about the size of your cunt and its viscocity as well as the frequency of her thrusts.  After a fucking that leaves your head dizzy with numbers, she thrusts fully into you and cums hard, pumping her hot load into you.  After she pulls out, she orders you to report back for remedial lessons before heading off, heels clacking as she goes.[impregchance]";
	otherwise if cocks of player > 0:
		if "Less Anal" is not listed in feats of player and ( a random chance of 2 in 5 succeeds or ( "More Anal" is listed in feats of player and a random chance of 1 in 3 succeeds ) ):
...
to say beatthemathteacher:
	...
	otherwise if cocks of player > 0:
		say ".  Shall you have some fun with her?  You could [link]fuck her (Y)[as]y[end link] or just [link]let her go (N)[as]n[end link].";
		if the player consents:
			say "[mathteachsex1]";
		otherwise:
			say "     Not interested in more fun, you give her a few final swats before sending her on her way.  She grumbles something about unruly students and walks away as quickly as her sore ass will let her, heels clacking all the way.";
	otherwise if cunts of player > 0:
		say ".  Shall you have some more fun with her?  You could [link]ride her cock (Y)[as]y[end link] or [link]let her go (N)[as]n[end link].";
		if the player consents:
			say "[mathteachsex2]";
		otherwise:
			say "     Not interested in more fun, you give her a few final swats before sending her on her way.  She grumbles something about unruly students and walks away as quickly as her sore ass will let her, heels clacking all the way.";
...
When Play begins:
	...
	now attack entry is "[one of]The teacher swats you painfully with her ruler![or]The professor bashes you with her textbook, making numbers swirl around in your eyes temporarily![or]The math teacher confuses you by asking you a math question that derails your brain.  When you can't answer in time, she screams that you get an F and clubs you with her textbook![or]She runs her hands over her [if a random chance of 2 in 3 succeeds]D-cup breasts[otherwise]plump ass cheeks[end if] while making sexy comments about their area, volume, density, elasticity and other numerical attributes, ending by summarizing them as [if a random chance of 1 in 3 succeeds]a 10 out of 10[otherwise if a random chance of 1 in 2 succeeds]an A+[otherwise]worth 10 bonus points[end if].  While unusual, this wanton display wears down your resistance to her advances![at random]";
