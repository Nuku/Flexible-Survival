...
to say darkelfF:
	if cunts of player > 0:
		say "     Stooping over your prone form, the shadowy elf examines your [if cunts of player > 1]multiple cunts[otherwise]cunt[end if] and smiles lewdly.  With a practised motion, she swiftly runs one of her hands into your depths and begins thrusting her [if cunt length of player < 6]fingers[otherwise if cunt length of player < 12]hand[otherwise]entire forearm[end if] inside of you, expertly hitting both your clit and your internal G-spot.  Dimly, you are aware that the dark elf is also fingering her own breasts and seems to be on the verge of orgasm.  Then you crash over into an incredible orgasm.";
	if cocks of player > 0:	
		say "     The dark elf looks at your [if cocks of player > 1]multiple cocks[otherwise]cock[end if] and [if cock length of player < 10]says '...pitiful.'  She sniffs in disdain at your apparently inadequate endowment.  Her smile grows wicked.  'But it will have to do.'  She mounts your inadequate manhood, your insignificant prick drowning in the vastness of her gaping snatch[otherwise if cock length of player < 16]says, 'Acceptable.' She seems satisfied with the size of your endowment, but is obviously used to larger tools.  She mounts your cock, her slick wetness seeming loose inside of her hungry slit[otherwise if cock length of player < 21]smiles in a way that seems to bode you no good.  'How nice to finally find an outsider with adequate endowment.'  She slips herself upon your manhood, the tight confines of her pussy gripping and clenching at your erect tool[otherwise]smile in a way that seems to bode you no good.  'Ohhh.  A challenge.  How nice.'  She slides her wet, tight pussy over your cock, and you feel the head of your tool stretch her to her limits.  She gasps in pleasure as you bottom out, her cervix tight against the head of your cock.";
...
to say beatthedarkelf:
	if cocks of player > 0 and libido of player > 20:
		say "     Defeated, the dark elf collapses to the ground.  She struggles to rise, but is unable to do so and can only glare up at you angrily.  Her dress is torn and you can see her large bosom, hefty cock and oversized cunt.  Looking her over, you find yourself tempted to celebrate your victory and fuck the dark elf.  Shall you give into this impulse?";
