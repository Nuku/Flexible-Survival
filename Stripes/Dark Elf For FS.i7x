...
to say darkelfF:
	if cunts of player > 0:
		say "     Stooping over your prone form, the shadowy elf examines your [if cunts of player > 1]multiple cunts[otherwise]cunt[end if] and smiles lewdly.  With a practiced motion, she swiftly runs one of her hands into your depths and begins thrusting her [if cunt length of player < 6]fingers[otherwise if cunt length of player < 12]hand[otherwise]entire forearm[end if] inside of you, expertly hitting both your clit and your internal G-spot.  Dimly, you are aware that the dark elf is also fingering her own breasts and seems to be on the verge of orgasm.  Then you crash over into an incredible orgasm.";
