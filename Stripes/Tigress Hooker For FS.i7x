...
to say losetotigress:
	...
	if hp of player > 0:									[DID THE PLAYER SUBMIT? - YES]
		...
		if cunts of player > 0 and cocks of player > 0:				[Yes = HERM Identified!]
			say "     Shi presses you down onto the mattress looks hir client over with a predatory rumble, particularly pleased at the prospects of servicing you, both john and jane in one.  Shi lowers hirself onto the mattress atop you and rubbing hir body against yours.  Hir soft striped fur running along you body, shi moves to licking and nibbling along your neck.  You can feel hir sharp, feline fangs along your skin, but shi is very careful and only gives you the lightest nips, which feel exquisite.  You can feel the warm bulge of hir sheath and the wet touch of hir emerging cock as it bumps against yours.  Shi moves a paw down to stroke your [cockname of player] [if cocks of player is 1]cock [otherwise]cocks [end if]as shi nibbles and nuzzles hir way down your chest and belly.  As shi slides down, hir paw drifts over your balls and to your wet slit, diving into it.";
