...
When Play begins:
	...
	now Name entry is "Math Teacher";
	...
	now MilkItem entry is "math teacher milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "math teacher cum"; [ Item to be given to the player if they have this infection and jerk off. ]
