	...
	if the player consents:
		...
		if girl is not banned:
			...
			if "Automatic Survival" is listed in feats of player:
				say "     [special-style-1]NOTE:[roman type] [bold type]Automatic Surival detected:[roman type] Your hunger will not increase and you'll instead be given a base chance of 25% for vore before other factors.";
