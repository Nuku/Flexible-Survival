...
instead of going west from Beach Plaza when ( hp of Cindy is 4 and a random chance of 2 in 3 succeeds ) and ( cocks of player > 0 or cunts of player > 0 ):
	...
	say "     If you're going to do something, you'd best do it soon.  Shall you rush up to [link]try to help (Y)[as]y[end link] the restauranteure or [link]clear out (N)[as]n[end link] like the other beachgoers are trying to do?";
	if the player consents:
		...
		if cocks of player > 0:
			say "     'But despite what you may have heard, I don't hate all men.  I didn't really bring you in here to talk, after all.  How about, as thanks for coming to my aid, I show you just how much I can [']not hate['] a man I like?' she purrs, rubbing a hand over your crotch.";
			if the player consents:
				say "     With her offer accepted, she takes your throbbing manhood in hand and strokes it vigorously.  '[if cock length of player > 20]Impressive,[otherwise if cock length of player > 10]Very nice,[otherwise if cock length of player > 4]Mmm...[run paragraph on][otherwise]A tad small, comparatively, but that's fine,[end if]' she says.  After some manual stimulation gets you fully hard, she straddles your lap.  She makes a sexy show of sliding aside her bikini bottom to reveal her pussy.  She's neatly trimmed and clearly wet with excitement.  Giving you a kiss, she sinks herself down onto your [cock size desc of player] shaft[if cock length of player > 20].  Despite her normal appearance, the woman has no problem taking your colossal member.  As if by magic, her cunt and belly adjust to provide a full, snug fit for your enlarged manhood[otherwise if cock length of player > 10].  Despite her normal appearance, the woman has no problem taking your mighty member.  As if by magic, her cunt and belly adjust to provide a full, snug fit for your enlarged manhood[otherwise if cock length of player > 4].  Her cunt squeezes down around you, providing an amazingly perfect, snug fit for your manhood[otherwise].  Despite your diminutive size, her cunt seems to adjust to provide a full, snug fit for your small manhood[end if].";
		...
		otherwise:
			say "     'But that doesn't really matter right now.  While I've enjoyed the company of plenty of men in my time, there's something to be said for the passion of a fine woman as well.  What do you think?' she asks with a sultry smile.  'I didn't really bring you in here to talk, after all.  What do you say to a little [']reward['] as thanks for coming to my aid?' she purrs sensually, moving a hand to caress your side.";
			if the player consents:
...
instead of conversing Circe:
	...
	if hp of Cindy is 6 and a random chance of 1 in 3 succeeds:
		...
		increase hp of Cindy by 1;
	otherwise if hp of Cindy is 7 and a random chance of 1 in 3 succeeds:
		...
		increase hp of Cindy by 1;
	otherwise if hp of Cindy is 8 and a random chance of 1 in 3 succeeds:
...
to say sexwithcirce:
	...
	otherwise if lastfuck of Circe - turns < 6:
	...
	otherwise:
		...
		otherwise if cocks of player > 0:	[M/F player ridden]
