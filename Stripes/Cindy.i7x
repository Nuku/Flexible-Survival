...
Description of Sunny Snacks is "     Built onto a shelf of rock on the cliffside, this small building is located partway between the sandy beach below and the plaza above. Aside from likely providing some protection from the tides and storms, it also provides an excellent view of the beachgoers. The shop itself is a mix between a restaurant and a concession stand, having a wide window and counter with a few stools in front and the shopkeeper behind. There's also a couple of patio tables with parasols set out on the small plateau in front of it. The building is white with sky-blue trim while the sign above the window declares the place to be 'Sunny Snacks' and has a bright sun rising above the words. To either side of the service counter are the [link]menu[as]look menu[end link]. The person inside running the place is a surprisingly human woman, a definite oddity these days, especially for one so out in the open.[line break]".
...
to say nosexwithcindy:
	cindycheck;
	if HP of Cindy is 0:
		say "     You go up to the human woman and start putting the moves on her, saying you'll to rock her world. She [if Player is male]gives you a snort and tosses her half-finished soda in your face. 'What kind of a pig comes up and asks a woman for sex without even introducing themselves? Why I should...' she pauses, glancing at the other customers watching the confrontation and takes a deep breath. 'Look. I'm feeling generous, but you better watch your step[else]just laughs. 'I think [']my world['] is more than you can handle. You're cute, but it's rude to make such an offer to someone you've not even met[end if].'";
		now HP of Cindy is 1;
	else:
		say "     [if Player is male][one of]Cindy does not seem particularly impressed at your suggestion of going into the back for sex. She probably gets a lot of offers like that[or]You try to chat up the restauranteur, but she rebukes your attentions rather harshly. 'Don't go getting any funny ideas. I'm not in the mood right now, you pig. Besides - I'm way out of your league,' she says curtly[at random][else]You try to chat up the restauranteur, but she rebukes your attentions rather harshly. 'Look. You're kinda cute, but I've got plenty of [']friends['] out there on the beach for that already. Besides - I'm way out of your league,' she adds[end if].";
...
instead of going west from Beach Plaza when HP of Cindy is 4 and a random chance of 2 in 3 succeeds and Player is not neuter:
	...
	say "[line break]     [bold type]Shall you rush up to try to help the restauranteur or clear out like the other beachgoers are trying to do?[roman type][line break]";
	...
	if Player consents:
		...
		if Player is male:
			say "[line break]     [bold type]'But despite what you may have heard, I don't hate all men. I didn't really bring you in here to talk, after all. How about, as thanks for coming to my aid, I show you just how much I can [']not hate['] a man I like?' she purrs, rubbing a hand over your crotch.[roman type][line break]";
			say "     ([link]Y[as]y[end link]) - Yes.";
			say "     ([link]N[as]n[end link]) - No.";
			if Player consents:
				LineBreak;
				say "     With her offer accepted, she takes your throbbing manhood in hand and strokes it vigorously. [if Cock Length of Player > 20]'Impressive,' [else if Cock Length of Player > 10]'Very nice,' [else if Cock Length of Player > 4]'Mmm...' [else]'A tad small, comparatively, but that's fine,' [end if]she says. After some manual stimulation gets you fully hard, she straddles your lap. She makes a sexy show of sliding aside her bikini bottom to reveal her pussy. She's neatly trimmed and clearly wet with excitement. Giving you a kiss, she sinks herself down onto your [cock size desc of Player] shaft. [if Cock Length of Player > 20]Despite her normal appearance, the woman has no problem taking your colossal member. As if by magic, her cunt and belly adjust to provide a full, snug fit for your enlarged[else if Cock Length of Player > 10]Despite her normal appearance, the woman has no problem taking your mighty member. As if by magic, her cunt and belly adjust to provide a full, snug fit for your enlarged[else if Cock Length of Player > 4]Her cunt squeezes down around you, providing an amazingly perfect, snug fit for your[else]Despite your diminutive size, her cunt seems to adjust to provide a full, snug fit for your small[end if] manhood.";
			...
			say "[line break]     [bold type]What do you say to a little [']reward['] as thanks for coming to my aid?' she purrs sensually, moving a hand to caress your side.[roman type][line break]";
			say "     ([link]Y[as]y[end link]) - Yes.";
			say "     ([link]N[as]n[end link]) - No.";
			if Player consents:
				LineBreak;
...
to say sexwithcirce:
	...
	if Player is neuter:
		...
		if Player is male and BodyName of Player is listed in infections of CanineList and CockName of Player is listed in infections of CanineList and a random chance of 2 in 3 succeeds:	[M/F doggy player gets doggy style]
			...
			say "     You fuck Circe energetically and she takes it with equal enthusiasm. Her cunt squeezes and milks at your cock with every thrust. You make wild, rough love to the sexy sorceress. And you do so like the beast she urges you to be, licking and nipping at her neck and shoulders, growling lustfully and panting heavily. When [if Player is knotted]you finally drive your knot fully into the woman and tie with her[else]your climax hits and you drive your pulsing shaft fully into the woman[end if], she cries out in ecstasy and clamps down tight around it. You cum hard, pumping your canine-tainted seed into her wanton womb.";
			...
			say "     You end up in a 69 with Circe, laying opposite each other on the plush divan. You run your hands over each other, teasing and caressing as you settle into position. Your head finds its way between her thighs and you set to eating out that juicy cunny of hers. You lick and kiss across her labia and at her clit, drawing soft moans from the woman. Her fingers continue to [if phumanbody is false]explore across your [bodytype of Player] body, taking sensual interest in your altered form before fully turning[else]play sensually across your body, bringing you a myriad of delights before she turns[end if] her attention to your pussy.";
