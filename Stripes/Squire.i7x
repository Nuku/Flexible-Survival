...
squirefeature is a number that varies.[@Tag:NotSaved] squirefeature is usually 1.
...
to say losetosquire:
	...
	if kpstatus is 1:
		say "     [if HP of Player > 0]When you submit to the bold squire, he gives a nervous laugh before growing boastful once the surprise has passed. 'Not much of a knight at all, are you? You would surrender to a lowly squire? Clearly I am more a knight than you,' he adds as he stands taller and sheathes his small sword. 'It looks like you need some more training, and I'm just the brave warrior to do it,' he says[else]The battle ends with a wild swing from the squire that manages to knock you off your feet. He gives a wild laugh as he pants to catch his breath. 'I... I beat you? A knight?' he says in shocked amazement. Standing taller, he sheathes his small sword and approaches you. 'Not much of a knight all then, are you? Perhaps I'd make for a better knight and you should go back to being a lowly squire,' he muses[end if], grabbing you in a surprisingly strong grip. Tugging down his breeches, he reveals his stiff member. His seven incher stands proud, hard and ready, as he pushes aside your garb, ready to finally take his turn on top.";
		WaitLineBreak;
		if Player is female:
			if Player is herm:
				say "     The smaller guy gets you down on your back and slides your ass up into his lap. Lifting your [cock size desc of Player] cock[if CockName of Player is not listed in infections of InternalCockList] and balls[end if], he smiles as he confirms the presence of your juicy pussy. 'This encounter gets better and better. This fallen knight has a scabbard as well as a sword. But what kind of a knight cannot stand up to a squire? You're unworthy to be a knight for [if HP of Player > 0]surrendering so easily[else]losing[end if] to a squire. You're clearly undeserving of your title,' he says as he pushes a few fingers into your cunt eagerly. He clumsily gropes and teases your cunny, relishing this opportunity with a female. After his inexperienced exploration, he gets his erection lined up with your wet folds and pushes his dribbling cock into your vagina with one confident motion.";
			else:
				say "     The smaller guy gets you down on your back and slides your ass up into his lap. With a fine view of your juicy pussy, he smiles eagerly. 'This encounter gets better and better; this fallen knight has a scabbard for my sword. But what kind of a knight cannot stand up to a squire? You're unworthy to be a knight for [if HP of Player > 0]surrendering so easily[else]losing[end if] to a squire. You're clearly undeserving of your title,' he says as he pushes a few fingers into your cunt eagerly. He clumsily gropes and teases your cunny, relishing this opportunity with a female. After his inexperienced exploration, he gets his erection lined up with your wet folds and pushes his dribbling cock into your vagina with one confident motion.";
		...
		say "     [if HP of Player > 0]Rather than fight further, you submit to the eager squire. He's laughs a little when you submit to him. 'That's right. My lord knight can defeat your master, and you know it[else]His last blow is followed by a leg trip that drops you to the ground, leaving you down in the dirt. He gives a mirthful laugh as he pants to catch his breath. 'Well fought, but it is clear who has received the better training[end if],' he boasts proudly. That said, he sheathes his small sword and approaches you. 'And now, with the matter of the victor decided, let us have some fun. It's clear you need more training,' he says as he rolls you onto the ground. 'And I'd be happy to help a fellow squire out,' he says, tugging down his breeches to reveal his stiff member. His seven incher stands proud, hard and ready, as he pushes aside your garb.";
		WaitLineBreak;
		if Player is female:
			...
			if kpstatus is 2:
				...
				say "     'And there you are, strange [if kpstatus is 3]brigand. Perhaps that will satisfy that which drives you to villainy[else]beast. Perhaps that will slake your monstrous rampage[end if].' Sticky, sore and aching a little, but also flush with the warm of his seed in your rear, you see little point in trying to correct the delusional lad and instead take your leave while you can.";
		...
		if kpstatus is 3:
			say "     [if HP of Player > 0]Rather than fight further, you submit to the eager squire. He's momentarily surprised by your submission before giving a soft laugh in relief. 'That's right, brigand. Better you submit than face a true knight's protege,' he says proudly. After taking a moment to catch his breath, he approaches you. '[one of]My master will be so proud of me when he hears that I've defeated you, bandit,' the squire says[or]And so the young squire routed the villainous bandit,' the lad narrates as he raises his sword proudly[or]You were right to give up. You don't compare to the foes my lord knight has defeated, bandit,' the squire proclaims[or]At this rate, I shall surely prove myself worthy to my knightly master,' the squire states[or]That's right, bandit. My master would strike you down if you opposed me,' the young man brags[at random][else]His last blow is followed by a solid punch to the side of the head, dazing you to the point of falling to your knees. And while the hardworking nanites quickly seal the wounds, you're still quite hurt and unable to keep fighting. The victorious lad pants to catch his breath before standing tall and approaching you. '[one of]My master will be so proud of me when he hears that I've defeated you, brigand,' the squire says[or]And so the young squire defeated the rowdy bandit,' the lad narrates as he raises his sword proudly[or]You don't compare to the foes my lord knight has defeated, bandit,' the squire proclaims[or]At this rate, I shall surely prove myself worthy to my knightly master,' the squire states[at random][end if].";
		else:
			say "     [if HP of Player > 0]Rather than fight further, you submit to the eager squire. He's momentarily surprised by your submission before giving a soft laugh in relief. 'That's right, beast. Better you submit than face a true knight's protege,' he says proudly. After taking a moment to catch his breath, he approaches you. '[one of]My master will be so proud of me when he hears that I've defeated you, creature,' the squire says[or]And so the young squire quelled the foul beast,' the lad narrates as he raises his sword proudly[or]You were right to give up. You don't compare to the beasts my lord knight has defeated, creature,' the squire proclaims[or]At this rate, I shall surely prove myself worthy to my knightly master,' the squire states[at random][else]His last blow knocks you on the side of the head, dazing you to the point of falling to your knees. And while the hardworking nanites quickly seal the wounds, you're still quite hurt and unable to keep fighting. The victorious lad pants to catch his breath before standing tall and approaching you. '[one of]My master will be so proud of me when he hears that I've defeated you, creature,' the squire says[or]And so the young squire defeated the foul beast,' the lad narrates as he raises his sword proudly[or]You don't compare to the beasts my lord knight has defeated, creature,' the squire proclaims[or]At this rate, I shall surely prove myself worthy to my knightly master,' the squire states[at random][end if].";
		WaitLineBreak;
		...
		if Player is male and ( a random chance of anallevel in 100 succeeds or Player is not female ):
			say "[squirewins_ride]";
...
to say stateknightcrest_new:
	if knightcrestnum is:
		-- 1: say "an ejaculating cock ringed by ivy";
		-- 2: say "a horse carnally riding a knight";
		-- 3: say "a sword between two dangling dicks";
		-- 4: say "a charging knight with a butt-plug-tipped lance";
		-- 5: say "two downward-pointing dildos on a yellow field";
		-- 6: say "a set of anal beads";
		-- 7: say "a pair of tits between crossed sword and mace";
		-- 8: say "a passant guardant hound with visible cock";
		-- 9: say "twin maidens dancing nude together";
		-- 10: say "a radiant pussy dribbling juices into a golden bowl";
...
to say PrepCombat_Squire:
	...
	if BodyName of Player is "Knight":
		...
		now kpstatus is 2;
	else if Player is bodily human and player is facially human and player is skintone human and tail of Player is empty:
		now kpstatus is 3;
	else:
		now kpstatus is 4;
	now knightcrestnum is a random number between 1 and 10;
	if kpstatus is 2 and knightcrestnum is playercrestnum:
		if knightcrestnum < 10:
			increase knightcrestnum by 1;
		else:
			now knightcrestnum is 1;
...
When Play begins:
	...
	now defeated entry is "     Sending his sword skittering away and knocking him to his knees, you are victorious over the squire. He scrambles backwards and back to his feet. 'You [if kpstatus is 1]are indeed a brave and powerful knight. Perhaps you should face off against my master in honorable combat. He would surely best even you,' he proclaims as he recovers his sword and departs quickly[else if kpstatus is 2]are quite strong for a squire. Clearly I must train harder,' he says dejectedly as he recovers his sword. 'But the bold knight I serve could still best yours,' he adds with a laugh as he dashes off[else if kpstatus is 3]may have defeated me, brigand,' he says angrily, 'but my master shall deal with you and all the rest of you thieving bandits.' He recovers his sword and makes his escape quickly, perhaps to find this knight of whom he speaks[else]are a more powerful beast than I anticipated. But my master is a bold and brave knight. When he finds you, you will fall,' he declares as he snatches up his sword. He turns quickly and then dashes off, perhaps to find this knight of whom he speaks[end if].[line break]"; [ Text when monster loses. ]
	...
	now MilkItem entry is "squire milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "squire cum"; [ Item to be given to the player if they have this infection and jerk off. ]
