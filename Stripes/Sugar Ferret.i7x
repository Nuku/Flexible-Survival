...
to say losetosugarferret:
	say "     [if HP of Player > 0]Unwilling to keep fighting, you give yourself over to the manic ferrets. Cheering, they bounce onto you, grabbing your limbs[else]As your strength wanes, you are tackled by several of the ferrets at once. They grab onto your arms, legs[end if] and body, pulling you down by sheer numbers. Even as you're going down, you're groped and fondled by several of the over-excited ferrets while others pull off your backpack.";
	if soda is owned:
...
When Play begins:
	...
	now Species Name entry is "Ferret"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now body entry is "[if caffeinehigh of Player > 0]short, slender and elongated. You are filled with excitement and energy barely controlled at times. You have short arms and legs that end in little paws with large, sharp claws. Your ferret-like body is always in motion, twitching from the caffeine-high[else]short, slender, elongated and filled with bouncy energy. You have short arms that end in cute, nimble paws with small claws at their tips. You have short legs that make your flexible body bound and sway whenever you run[end if]"; [ Body description, format as "Your body is [Body of Player]." ]
	...
	now MilkItem entry is "sugar ferret milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "sugar ferret cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	...
	if Player has a body of "Sugar Ferret":
		...
		if humanity of Player < 10:
			...
			if alexbrunch >= 4:
				...
				say "     Once you're released, you do your best to settle down into a new life. Luckily, you meet a cute [if Player is male and (Player is femaleinterested or Player is not maleinterested)]jill[else]hob[end if] among your release group and soon become their lover. In time, you move in together and have wild, over-caffeinated romps nearly every week-end. While your lover doesn't gain your reaction to cola and pop, they do develop quite the sweet tooth.";
