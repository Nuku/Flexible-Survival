...
to say hdmale_sex04:
	...
	WaitLineBreak;
	if Player is herm:
		say "     Largely dropping the pretense of an exam, he throws himself into stuffing your dripping cunny with one hand and pumping your [cock of Player] cock with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon soaking your crotch with your feminine juices as your [ball size] tighten up. Your [cock size desc of Player] penis throbs in the canine doctor's paw as he watches[if ball size of Player < 24], stunned and impressed by[else if ball size of Player > 15], definitely impressed by[else if ball size of Player > 10], seemingly pleased by[else if ball size of Player > 5] with mild disapproval at[else], clearly disappointed with[end if] your [Cum Load Size of Player] output. Grabbing his stiff canine dong, he pumps it quickly, splattering a gooey mess of his own seed onto you, making you all the stickier";
		...
		say "     Largely dropping the pretense of an exam, he throws himself into stroking your [cock of Player] cock with one hand and pumping a few fingers into your asshole with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon feeling your [ball size] tighten up even as your anus clutches around his thrusting digits. Your [cock size desc of Player] penis throbs in the canine doctor's paw as he watches[if ball size of Player < 24], stunned and impressed by[else if ball size of Player > 15], definitely impressed by[else if ball size of Player > 10], seemingly pleased by[else if ball size of Player > 5] with mild disapproval at[else], clearly disappointed with[end if] your [Cum Load Size of Player] output. Grabbing his stiff canine dong, he pumps it quickly, splattering a gooey mess of his own seed onto you, making you all the stickier";
	else if Player is male:
		say "     Largely dropping the pretense of an exam, he throws himself into stroking your [cock of Player] cock with one hand and [if Breast Size of Player > 0]groping one of your breasts[else]grabbing your ass[end if] with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon feeling your [ball size] tighten up. Your [cock size desc of Player] penis throbs in the canine doctor's paw as he watches[if ball size of Player < 24], stunned and impressed by[else if ball size of Player > 15], definitely impressed by[else if ball size of Player > 10], seemingly pleased by[else if ball size of Player > 5] with mild disapproval at[else], clearly disappointed with[end if] your [Cum Load Size of Player] output. Grabbing his stiff canine dong, he pumps it quickly, splattering a gooey mess of his own seed onto you, making you all the stickier";
...
to say hdfemale_sex04:
	...
	WaitLineBreak;
	if Player is herm:
		say "     Largely dropping the pretense of an exam, she throws herself into stuffing your dripping cunny with one hand and pumping your [cock of Player] cock with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon soaking your crotch with your feminine juices as your [ball size] tighten up. Your [cock size desc of Player] penis throbs in the canine doctor's paw as she watches[if ball size of Player < 24], stunned and impressed by[else if ball size of Player > 15], definitely impressed by[else if ball size of Player > 10], seemingly pleased by[else if ball size of Player > 5] with mild disapproval at[else], clearly disappointed with[end if] your [Cum Load Size of Player] output. Stuffing a few fingers into her own cunny, she works herself up to a barking climax and wipes her stick fingers off onto you";
	else if Player is female and anallevel is 3:
		...
		say "     Largely dropping the pretense of an exam, she throws herself into stroking your [cock of Player] cock with one hand and pumping a few fingers into your asshole with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon feeling your [ball size] tighten up even as your anus clutches around her thrusting digits. Your [cock size desc of Player] penis throbs in the canine doctor's paw as she watches[if ball size of Player < 24], stunned and impressed by[else if ball size of Player > 15], definitely impressed by[else if ball size of Player > 10], seemingly pleased by[else if ball size of Player > 5] with mild disapproval at[else], clearly disappointed with[end if] your [Cum Load Size of Player] output. Stuffing a few fingers into her own cunny, she works herself up to a barking climax and wipes her stick fingers off onto you";
	else if Player is male:
		say "     Largely dropping the pretense of an exam, she throws herself into stroking your [cock of Player] cock with one hand and [if Breast Size of Player > 0]groping one of your breasts[else]grabbing your ass[end if] with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon feeling your [ball size] tighten up. Your [cock size desc of Player] penis throbs in the canine doctor's paw as she watches[if ball size of Player < 24], stunned and impressed by[else if ball size of Player > 15], definitely impressed by[else if ball size of Player > 10], seemingly pleased by[else if ball size of Player > 5] with mild disapproval at[else], clearly disappointed with[end if] your [Cum Load Size of Player] output. Stuffing a few fingers into her own cunny, she works herself up to a barking climax and wipes her stick fingers off onto you";
	else if anallevel is 3:
...
[one of]presses [if hdmode is 1]his[else]her[end if] stethoscope against your groin. BRrr! That's cold![or]gropes you lustfully while grinding [if hdmode is 1]his[else]her[end if] crotch against your leg[or]strikes your hard on the temple, making your ear ring.[or]seems to know just where to grab and grope you to turn you on.[or]gives you a hard punch to the solar plexus.[or]manages to slip behind you and grab your ass with one paw while fondling you with the other.[at random]";
	...
	now Ball Size entry is 9; [ Cock width, more commonly used for ball size. ]
