...
to say hdmale_sex04:
	...
	if player is herm:
		...
		say "     Largely dropping the pretense of an exam, he throws himself into stuffing your dripping cunny with one hand and [if breasts of player > 0]groping one of your breasts[else]grabbing your ass[end if] with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon soaking your crotch with your feminine juices as your vagina quivers around his thrusting digits. Your [cunt size desc of player] cunt gushes with juices as you climax. Grabbing his stiff canine dong, he pumps it quickly, splattering a gooey mess of his own seed onto you, making you all the stickier";
...
to say hdfemale_sex04:
	...
	if player is female:
		say "     Burying her nose between your thighs, she nuzzles at your pussy before giving it a quick lick. This is then followed by a pair of digits slipping their way into your vagina and rubbing along your inner walls[if cunt width of player > 12]. Eventually two fingers moves up to three and then four before she ends up fisting you to pound away at your gaping cunny. As she stuffs[else if cunt width of player > 8]. Eventually two fingers moves up to three and then four as she continues to pound away at your spacious cunny. As she fingerfucks[else if cunt width of player > 5]. Eventually two fingers moves up to three as she continues to pound away at your widened cunny. As she fingerfucks[else]. As she fingerfucks[end if] your wet pussy, her other paw rubs across your outer folds, both teasing you and allowing her to examine your cunny in detail. There's something embarrassingly exciting about her scrutiny, especially when her fingertips move to your clit and start playing with it. You're left dripping with juices by the time she's finished the gynecological exam.";
	WaitLineBreak;
	if player is herm:
