...
to say hdmale_sex01:
	say "     With the doctor's canine bone buried inside you, he starts thrusting while panting in your ear. His tongue plays across your neck and ears as he pounds away at you, humping you wildly like the dog he is[if Nipple Count of Player > 0 and Breast Size of Player > 0]. His paws reach around to fondle your tits, playing with your nipples in what's certainly more than a normal breast exam[end if]. You start to pant and bark alongside him as he fucks you, his canine cock and swelling knot feeling great inside [if inheat is true]your heat-stricken hole[else]you[end if]. This goes on for several minutes before he finally pops that knot of his fully into you and ties inside your cunt. A few locked thrusts are all he has left before his semen starts spurting into you, filling your needy hole[if inheat is true] in an attempt to breed you[end if]. You feel spurt after spurt of canine cum filling your womb as you cry out in climactic bliss yourself, soaking the edge of the gurney with your [if Player is male]cum and [end if]juices. Once the doctor's done with your [']treatment['], he slips his shrinking knot from your cunt with a wet pop and sends you on your way. Still in a bit of a daze after the hard fucking, you stumble off, canine cum running down your legs.";
	CreatureSexAftermath "Player" receives "PussyFuck" from "Horny Doctor";

to say hdmale_sex02:
	say "     With the doctor's canine bone buried inside you, he starts thrusting while panting in your ear. His tongue plays across your neck and ears as he pounds away at you, humping you wildly like the dog he is[if Nipple Count of Player > 0 and Breast Size of Player > 0]. His paws reach around to fondle your tits, playing with your nipples in what's certainly more than a normal breast exam[end if]. You start to pant and bark alongside him as he fucks you, his canine cock and swelling knot feeling great inside [if inheat is true]your heat-stricken hole[else]you[end if]. This goes on for several minutes before he finally pops that knot of his fully into your ass and ties inside you. A few locked thrusts are all he has left before his semen starts spurting into you, filling your needy hole[if inheat is true] in an attempt to breed you[end if]. You feel spurt after spurt of canine cum filling your rectum as you cry out in climactic bliss yourself[if Player is male], soaking the edge of the gurney with your cum[end if]. Once the doctor's done with your [']treatment['], he slips his shrinking knot from your anus with a wet pop and sends you on your way. Still in a bit of a daze after the hard fucking, you stumble off, canine cum running down your legs.";
	CreatureSexAftermath "Player" receives "AssFuck" from "Horny Doctor";
...
to say hdmale_sex03:
	...
	CreatureSexAftermath "Player" receives "OralCock" from "Horny Doctor";
...
to say hdmale_sex04:
	...
	if Player is herm:
		...
		CreatureSexAftermath "Player" receives "PussyDildoFuck" from "Horny Doctor";
		CreatureSexAftermath "Player" receives "AssDildoFuck" from "Horny Doctor";
		...
		say "     Largely dropping the pretense of an exam, he throws himself into stroking your [Cock of Player] cock with one hand and pumping a few fingers into your asshole with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon feeling your [Ball Size Adjective of Player] [Balls] tighten up even as your anus clutches around his thrusting digits. Your [cock size desc of Player] penis throbs in the canine doctor's paw as he watches[if Ball Size of Player > 5], stunned and impressed by[else if Ball Size of Player > 4], definitely impressed by[else if Ball Size of Player > 3], seemingly pleased by[else if Ball Size of Player > 2] with mild disapproval at[else], clearly disappointed with[end if] your [Cum Load Size of Player] output. Grabbing his stiff canine dong, he pumps it quickly, splattering a gooey mess of his own seed onto you, making you all the stickier. ";
		CreatureSexAftermath "Player" receives "AssDildoFuck" from "Horny Doctor";
	else if Player is male:
		say "     Largely dropping the pretense of an exam, he throws himself into stroking your [Cock of Player] cock with one hand and [if Breast Size of Player > 0]groping one of your breasts[else]grabbing your ass[end if] with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon feeling your [Ball Size Adjective of Player] [Balls] tighten up. Your [cock size desc of Player] penis throbs in the canine doctor's paw as he watches[if Ball Size of Player > 5], stunned and impressed by[else if Ball Size of Player > 4], definitely impressed by[else if Ball Size of Player > 3], seemingly pleased by[else if Ball Size of Player > 2] with mild disapproval at[else], clearly disappointed with[end if] your [Cum Load Size of Player] output. Grabbing his stiff canine dong, he pumps it quickly, splattering a gooey mess of his own seed onto you, making you all the stickier. ";
	else if anallevel > 1:
...
to say hdfemale_sex04:
	...
	if Player is herm:
		...
		say "     Largely dropping the pretense of an exam, she throws herself into stroking your [Cock of Player] cock with one hand and pumping a few fingers into your asshole with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon feeling your [Ball Size Adjective of Player] [Balls] tighten up even as your anus clutches around her thrusting digits. Your [cock size desc of Player] penis throbs in the canine doctor's paw as she watches[if Ball Size of Player > 5], stunned and impressed by[else if Ball Size of Player > 4], definitely impressed by[else if Ball Size of Player > 3], seemingly pleased by[else if Ball Size of Player > 2] with mild disapproval at[else], clearly disappointed with[end if] your [Cum Load Size of Player] output. Stuffing a few fingers into her own cunny, she works herself up to a barking climax and wipes her sticky fingers off onto you. ";
		CreatureSexAftermath "Player" receives "AssDildoFuck" from "Horny Doctor";
	else if Player is male:
		say "     Largely dropping the pretense of an exam, she throws herself into stroking your [Cock of Player] cock with one hand and [if Breast Size of Player > 0]groping one of your breasts[else]grabbing your ass[end if] with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon feeling your [Ball Size Adjective of Player] [Balls] tighten up. Your [cock size desc of Player] penis throbs in the canine doctor's paw as she watches[if Ball Size of Player > 5], stunned and impressed by[else if Ball Size of Player > 4], definitely impressed by[else if Ball Size of Player > 3], seemingly pleased by[else if Ball Size of Player > 2] with mild disapproval at[else], clearly disappointed with[end if] your [Cum Load Size of Player] output. Stuffing a few fingers into her own cunny, she works herself up to a barking climax and wipes her sticky fingers off onto you. ";
	else if anallevel > 1:
		say "     Largely dropping the pretense of an exam, she throws herself into pumping a few fingers into your asshole with one hand and [if Breast Size of Player > 0]groping one of your breasts[else]grabbing your ass[end if] with the other. Already very worked up by the constant teasing without proper release, you don't last for much longer, soon feeling your [bodydesc of Player] body quivering in undirected release even as your anus clutches around her thrusting digits. Clearly disappointed by your lack of genitals, she stuffs a few fingers into her own cunny, works herself up to a barking climax and then wipes her sticky fingers off across your bare groin. ";
		CreatureSexAftermath "Player" receives "AssDildoFuck" from "Horny Doctor";
...
[one of]presses [if hdmode is 1]his[else]her[end if] stethoscope against your groin. BRrr! That's cold![or]gropes you lustfully while grinding [if hdmode is 1]his[else]her[end if] crotch against your leg.[or]strikes you hard on the temple, making your ear ring.[or]seems to know just where to grab and grope you to turn you on.[or]gives you a hard punch to the solar plexus.[or]manages to slip behind you and grab your ass with one paw while fondling you with the other.[at random]";
	...
	now CumItem entry is "horny doctor cum"; [ Item to be given to the player if they have this infection and jerk off. ]
