...
Instead of conversing the Leonard:
	...
	otherwise if hp of Leonard is 5 and "violin" is listed in invent of player:
		...
		say "     As the strong male continues to make love to you, you knead your hands at his chestfur, moaning and mewling like a lustful kitty, his lustful kitty.  His sizable member throbs and pulses inside you, making you feel so good, so fulfilled at having pleased your loving master.  You have passing thought about what you could do next to please him, but those ideas are bumped away by another hard thrust of his hips sending waves of pleasure through you.  His paws slide across your body, caressing at every erogenous zone they can find, showing you how pleased his is with your gift.";
...
instead of fucking the Leonard:
	...
	if hp of Leonard is 16:
		say "(Note: New sex scenes for Leonard and the matronly player will be coming at a later date.)[line break]";
	if hp of Leonard is 0:
	...
	otherwise if hp of Leonard >= 3 and Feline_attached > 0 and feline_status is 0 and ( a random chance of 1 in 2 succeeds or hp of Leonard is 7 ):
		...
		otherwise:
			...
			if libido of player > 100, now libido of player is 100;
			decrease feline_meow by 2;
			if feline_meow < 0, now feline_meow is 0;
		now feline_status is 2;
		decrease humanity of player by 8;
		follow the turnpass rule;
		if hp of Leonard is 7, increase libido of Leonard by 1;
...
to say leonardrivalfight:
	...
	otherwise if fightoutcome >= 20 and fightoutcome <= 29:
		say "     After the male has beaten and fucked you, he grabs you roughly by both strong paws and hefts you over his head.  You moan weakly, still bloated with his cum, as he hurls you over the edge moments after Leonard knocks out his oppenent, sending you crashing into your lover.  Struck down by your defeated, cum-stained body of his pride favourite is a terrible blow to the exhausted lion.  This crushes him body and soul, leaving him open to the final alpha lion's attack and he is quickly dispatched.  You mewl and moan weakly from the ground beside this quick and brutal fight as your master is beaten and made to service the victor.";
