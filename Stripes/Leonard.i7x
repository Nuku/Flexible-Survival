...
instead of fucking the Leonard:
	...
	repeat with y running from 1 to number of filled rows in table of random critters:
		...
		if name entry is "Feline":
			now monster is y;
			break;
	if Feline_attached > 0 and feline_status is 0 and hp of Leonard is 7, now lastfuck of leonard is 255;		[resets Leonard for immediate fun if the player has a new kitty girl while hunting girls]
	if hp of Leonard is 0:
