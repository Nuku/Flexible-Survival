...
Instead of conversing the Leonard:
	if hp of Leonard is 0:
		...
		if the player is felinecocked and inheat is true:		[Feline heat]
...
instead of fucking the Leonard:
	...
	otherwise if hp of Leonard is 1:
		...
		if cunts of player > 0 or bodyname of player is "Feline":
			...
			if inheat is true and the player is felinecocked:
		...
		otherwise:
			...
			decrease humanity of player by 4;
	otherwise if hp of Leonard >= 3 and inheat is true and player is felinecocked and feline_status is 0 and a random chance of 1 in 2 succeeds:
	...
	otherwise if hp of Leonard >= 3 and inheat is true and player is felinecocked:
