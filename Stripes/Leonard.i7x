			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if Player consents:
					...
					if title entry is "Fellatio":
						...
						say "[Leonardmaidsex1]";
					else if title entry is "Maid fuck":
						say "[Leonardmaidsex2]";
