...
to say beatthedobie2:			[mid-lust cop player victory]
	...
	if cocks of player > 0 or cunts of player > 0:
		...
		say "     [link](1)[as]1[end link] - [if cocks of player > 0]Fuck[else]Finger[end if] that juicy cunt of hers.";
		say "     [link](2)[as]2[end link] - [if cocks of player > 0]Give her a titty-fuck[else]Get the doggy tongue of hers to please you[end if].";
