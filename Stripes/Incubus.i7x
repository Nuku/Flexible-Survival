...
to say losetoincubus:
	...
	else if Player is submissive and ( ( Player is female and a random chance of 3 in 5 succeeds ) or ( Player is not male and a random chance of anallevel in 5 succeeds ) ):
...
to IncubusNormalDefeat:
	if BodyName of Player is "Incubus" or BodyName of Player is "Succubus":
		if Player is male:
			...
			say "[line break]     [bold type]Shall you?[roman type][line break]";
		...
		say "[line break]     [bold type]Shall you take your prize and make the sex demon blow you, or will you refuse this final temptation?[roman type][line break]";
