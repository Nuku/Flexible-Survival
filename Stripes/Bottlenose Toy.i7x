...
to say dolphinflatabledesc:
	...
	else:	[feral dolphin toy in castle]
...
to say losetodolphinflatable:
	...
	if dolphinmode is 1:			[lose to girl form]
		if dolinfloss > 2: [BluB]
			now dolinfloss is 0; [resets, attempted every 3 losses]
			let dolescape be 0;
			say "     The bottlenose girl giggles again as she wraps her towel around your neck and wrists. It squeezes around your forearms, binding them tightly behind your back. Pushing you to the sandy ground, she climbs atop you, always keeping in contact with the towel, which rebonds to her wherever she's holding it so she always knows where her towel is. Once on the ground, she stretches her towel further, almost painfully so to partially bind your legs as well.";
			...
			say "[line break]     [bold type]Shall you try to resist? You could probably escape afterwards, but you imagine it won't be easy...[roman type][line break]";
			...
			if Player consents:
				...
				if a random number between 1 and 3 is:
					...
					-- 3:
						...
						if Playernum >= dolphinnum:
							say "     As she tries to move the head portion overtop of your face, you struggle to fight with all your might, trying to tear free of your bonds. The weak dolphin girl struggles to hold you down, even bound as you are. As you flex your muscles, you can feel the rubbery towel stretch and start to give way. By the time she manages to get you down again, you can feel that you've made some headway in getting out of this predicament.";
							now dolescape is 1;
						else:
							say "     As she tries to move the head portion overtop of your face, you struggle to fight with all your might, trying to tear free of your bonds. The dolphin girl fights against your attempt to break free and ends up gripping the towel for support. This seems to keep its grip taut around your limbs and prevents you from forcing your way free.";
				...
				if Playernum >= dolphinnum:
					say "     She runs her fin-like hands down your body and gropes you while she reaches to slide the rest of it over you. As the material is stretched over you, it feels very good and quite arousing, seeming to squeeze and rub against you almost with a life of its own. You manage to block out the pleasure that comes from the rubbery material rubbing and sliding against you and remain focused on trying to free yourself.";
					increase dolescape by 1;
				else:
					say "     She runs her fin-like hands down your body and gropes you while she reaches to slide the rest of it over you. As the material is stretched over you, it feels very good and quite arousing, seeming to squeeze and rub against you almost with a life of its own. The pleasure you feel as the rubbery material rubs and slides against you becomes quite distracting and you can't help but weakly moan in pleasure, momentarily lost in the sensation.";
				if dolescape is 2:
					...
					if a random chance of 1 in 2 succeeds:
						...
						let dolphinnum be a random number between 1 and str entry;
						if Playernum >= dolphinnum:
							say "     As she's putting it on, it seems to stretch and adjust itself to be just the right shape and size to contain you. You can feel a slick lubricant coating its inside, letting it slide easily over your flesh. You continue to try and squirm free, using your remaining strength to try and stretch the vinyl towel with a final burst of strength. Feeling that material stretch, you squirm and pull, working yourself closer to freedom.";
							increase dolescape by 1;
						else:
							say "     As she's putting it on, it seems to stretch and adjust itself to be just the right shape and size to contain you. You can feel a slick lubricant coating its inside, letting it slide easily over your flesh. You continue to try and squirm free, using your remaining strength to try and stretch the vinyl towel with a final burst of strength. You flex and try to move your bound arms against your bonds, but fail to make any headway, too worn out from your struggle.";
					else:
						...
						if Playernum >= dolphinnum:
							say "     As she's putting it on, it seems to stretch and adjust itself to be just the right shape and size to contain you. You can feel a slick lubricant coating its inside, letting it slide easily over your flesh. You continue to try and pull free, shifting your position and trying to push against the material as long as you can to by you the time to free yourself. Holding out as long as you can, you push against the stretchy material, trying to keep the girl from pulling it onto you. You twist and pull your arms while struggling and eventually she's forced to grab your legs in both arms, leaving only her tail to [']hold['] the red towel, weakening its ability to hold you for a few moments.";
							increase dolescape by 1;
						else:
							say "     As she's putting it on, it seems to stretch and adjust itself to be just the right shape and size to contain you. You can feel a slick lubricant coating its inside, letting it slide easily over your flesh. You continue to try and pull free, shifting your position and trying to push against the material as long as you can to by you the time to free yourself. You hold out for a little while, but eventually you tire and can't keep the material from sliding further over you.";
					if dolescape is 2:
...
to say beatthedolphinflatable:
	if dolphinmode is 1:			[defeat girl form]
		...
		if Libido of Player > 45 and dolphinmode is not 3:
			...
			say "[line break]     [bold type]Will you play with the toy before continuing on your way?[roman type][line break]";
			say "     ([link]Y[as]y[end link]) - Yes.";
			say "     ([link]N[as]n[end link]) - No.";
			if Player consents:
				LineBreak;
...
to bottleboundstate:
	...
	while Trixieexit is false:
		...
		if struggleatt < 3:
			now partialengulf is false; [player is fully engulfed]
		else:
			now partialengulf is true; [player is partially engulfed]
		if humanity of Player < 1:
			...
			say "Sanity: [humanity of Player]/100  Lust: [lustatt]/100  Struggle: [if boundmod > 1]}[end if][if boundmod > 0]}[end if] [close bracket][if struggleatt is 3]X[else]-[end if][if struggleatt > 1]X[else]-[end if][if struggleatt > 0]X[else]-[end if][bracket] [if boundmod > 0]{[end if][if boundmod > 1]{[end if][line break]";
			...
			if keychar is "s" or keychar is "1" or keychar is "return" or keychar in lower case matches the text "struggle":
				if struggleatt < 3:
					...
					if struggleatt is 3:
						say ". You finally manage to wrench the suit free of you, but it still manages to partially cling to your form, hellbent on keeping a hold on you and maintaining its toxic influence[first time]. The dolphin lady appears to have run off, ensuring this situation doesn't become even more difficult for you[only]";
					say ".";
				else:
...
When Play begins:
	...
	now Species Name entry is "Bottlenose Toy"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Bottlenose Toy" to infections of AquaticList;
	add "Bottlenose Toy" to infections of CetaceanList;
	...
	now face entry is "the cute face of a cartoonishly rounded dolphin, like some kind of inflatable pooltoy. You have big, flat eyes and a wide grin drawn on your bottlenose snout. Both your eyes and mouth seem to work fine and your head feels hollow and empty, bending like a balloon when you touch it";
	now body entry is "that of an anthropomorphic dolphin, strangely somehow empty and filled with air. There is even a flappy little inflated fin at your back that you have press to one side when wearing your backpack. Your body is covered in a PVC imitation of [SkinSpeciesName of Player in lower case] flesh, complete with seams. Your body is able to bend and reshape itself to move instead of having any actual bones or muscles. The scent of fresh plastic lingers around you. Your nipples have been replaced with small inflation nozzles, but are just as sensitive as normal nipples, if not more";
	...
