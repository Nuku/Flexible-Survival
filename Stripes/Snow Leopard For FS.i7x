...
When Play begins:
	...
	now skin entry is "thick, fluffy fur. It is a snowy white and ash gray in colour, with a leopard-like pattern across it. Your thick coat does not help with the southern sun as your pelt warms your"; [ Skin desc., format as the text "Your body is covered in (your text) skin."  Note: the word 'skin' is automatically included at the end. ]
