...
instead of fucking Knott:	[Same as conversing, but works when the player says "Fuck Knott" in Knott's presence.]
	if lastfuck of Knott - turns < 6:
		...
		project Figure of Knott_robes_icon;
		say "     'I am not in the mood for that right now, I have other things on my mind.' Knott isn't going to budge until you resolve the Elusive Book quest; try [if Elusive Book is active]checking the High Rise District[else]asking Giving[end if].";
	else:
