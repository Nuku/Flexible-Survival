...
instead of conversing Teas:
	...
	if Teas_Gab_Choice is:
		...
		-- "What happened to Weasel?":
			say "     'Sigh, to be frank, my little friend, there's a reason why you don't see many people around him- even before the apocalypse he wasn't the sort of crowd you wanted to be around.' He puts a firm hand on your shoulder. 'I know you want to help, but he isn't someone you can help by feeding their desires.' In concern, you ask him to elaborate. 'Well, since there isn't exactly [']HIPAA['] in an apocalypse, I'll just give the bare minimum: he's going to grab his [']fix['] with someone who was formerly a firbolg here, an orc hybrid named Geimheal. You're a strong one, but I will say if you do go looking for them please, whatever you do, DO NOT engage him. He's something I need to handle, and he is someone who will use any dirty trick in the book to get the advantage. He won't fight fair in any sense, leaving you to possibly be taken by the infected or worse.'";
