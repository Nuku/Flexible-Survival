...
The description of Old Hall is "a hallway that looks like it should be condemned[line break][if corgitalk is greater than 1]Max[otherwise]The angry corgi[end if] stormed down the eastern passage.[line break]you can also hear sounds of an orgy coming from the north".
