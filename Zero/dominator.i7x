...
When Play begins:
	...
	now face entry is "that of a wolf's with a pair of pointed wolf ears covered in [skin of player], a metal chain wrapped around your neck"; [ Face description, format as "Your face is (your text)."]
