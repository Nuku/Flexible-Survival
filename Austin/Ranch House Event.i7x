...
to say RanchHouse_Choice1_Point:
	...
	while calcnumber < 1 or calcnumber > 4:
		...
		if calcnumber < 1 or calcnumber > 4:
			say "Invalid choice. Type [link]1[end link] to go inside the barn, [link]2[end link] to approach one of the windows and look inside, [link]3[end link] to walk away and never return or [link]4[end link] to avoid this place for now.";
	LineBreak;
	if calcnumber is 1: [Go straight in]
		...
		while calcnumber < 1 or calcnumber > 3:
			...
			if calcnumber < 1 or calcnumber > 3:
				say "Invalid choice. Type [link]1[end link] to free her, [link]2[end link] to take advantage of the situation or [link]3[end link] to leave the place not worrying about how she is left.";
		LineBreak;
		if calcnumber is 1:
