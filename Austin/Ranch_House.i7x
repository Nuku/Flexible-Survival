Ranch House by Austin begins here.
...
to say RanchHouse_Choice1_Point:
	...
	say "     [link](3)[as]3[end link] - Walk away and avoid this place.";
	say "     [link](4)[as]4[end link] - Avoid this place for now, but remember it to return in the future.";
	now calcnumber is 0;
	while calcnumber < 1 or calcnumber > 4:
		...
		if calcnumber is 1 or calcnumber is 2 or calcnumber is 3 or calcnumber is 4:
			...
			say "Invalid choice. Type [link]1[end link] Go inside the barn and see who is inside., [link]2[end link] Cautiously approach one of the window and look inside. [link]3[end link] Walk away and avoid this place, or [link]4[end link] Avoid this place for now, but remember it to return in the future.";
	if calcnumber is 1: [Go straight in]
		...
		LineBreak;
		say "     Leave and avoid returning to the ranch.";
...
to say RanchHouse_Choice2: [Cautiously approach one of the windows and look inside]
	...
	if calcnumber is 1:
		LineBreak;
		say "     In the center of the room you see a mare laying on her back with her legs spread while a centaur is over her the two of them going roughly almost as if they are on heat by the look of it. Next to them you see a small centaur alone giving himself a blowjob thanks to the position you notice a sparkle in his butt most probably a butt plug. In a corner you see three-way of males the first one laying on his belly while the second is on top of him on his knees and lastly the third one is fully standing letting the whole speed go by the movements of the middle one. Beside some hay bales, two mares are in each other's embrace, lips locked and fingers caressing their partner's breasts. Meanwhile, at the end of the stalls you see one door open and a line of centaurs seemingly excited for their turn to get inside. After you watch them and are about to leave, a twink centaur stallion stops you and asks, 'You know, if you had fun watching, maybe next time you could join and I can show you a good time myself.' He seductively walks around teasing you, moving his hips and giving you a generous view of his ass while also slapping his horse cock against his under-belly letting you know what he means.";
