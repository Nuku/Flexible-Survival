...
Sarea of Giant Tree Ascension is "Forest".
...
to say TreeAscention4_Fight:
	...
	if fightoutcome < 20: [player won]
		...
		say "     Having defeated you, the alpha wolf pounces on you, closing his jaws around your neck, not strong enough to actually harm you, but definitely strong enough to send a message. Having no choice, you drop your weapon and surrender to him, to the delight of the excited submissives who all seem overjoyed to have a new pack member.";
