...
To say butterfly attack:
	...
	if ButterflyRaped is 1 or ButterflyRaped is 2:
		...
		say "The butterfly climbs off and rummages through the bag she was carrying emerging with a large strap-on. As she hovers towards you she attaches the strap-on to her groin and then with surprising show of strength grabs your leg and flips your body over. Knowing what[']s coming you try to resist, but her makeshift dong finds its target and punctures your anus painfully. As she rides you like an animal, she slaps your behind hard. 'Hurt me will you? You[']re my bitch now.' By the time she[']s done with you you[']re lying naked face down in the mud with a gaping and swollen rectum. You[']d be cold if it wasn't for the heat of the nanites busy working away at your body.[line break]";
...
instead of sniffing damaged negligee:
	say "The damaged negligee smells of sex. You take a whiff and almost collapse as a wave of the butterfly[']s scent, pheromones and sexual fluids fills you.";
...
instead of sniffing lingerie store:
	say "The store has a somewhat musty smell as the air conditioning hasn[']t been turned on for some time. The product however smells fresh and newly manufactured.";
