...
func _ready() -> void:
	...
	"""
	NOTE:
		this passes the current child node as a parameter. location processor doesn't need this since
		it keeps track of it's own children. however, this parameter is meant to be replaced by
