...
"Male Latex Mouse"	"[PrepCombat_Male Latex Mouse]"

to say PrepCombat_Male Latex Mouse:
	say "";
...
When Play begins:
	...
	now face change entry is "[LatexMouseFaceChange]"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
	now body change entry is "[LatexMouseBodyChange]"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	now skin change entry is "[LatexMouseSkinChange]"; [ Skin change text, format as "Your skin feels funny as [skin change entry]." ]
	now ass change entry is "[LatexMouseAssChange]"; [ Ass/tail change text, format as "Your ass feels funny as [ass change entry]." ]
