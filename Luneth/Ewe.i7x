...
to say ewe attack:
	if Player is male:
		...
		CreatureSexAftermath "Ewe" receives "PussyFuck" from "Player";
	else:
...
When Play begins:
	...
	now desc entry is "     Traveling through the streets of the city, you come across a strange sheep-like person wandering around without aim, absently running her hands over her soft, fleece-covered body as she looks around. Before you can do more than wonder what a ewe is doing out here all alone, the female sheep spots you and bleats eagerly before charging right at you, her slightly-crazed eyes full of lust.[line break]";
			...
			if humanity of Player < 10:
				if Player is female:
					...
					if lust of Leon < 2:
						...
						say "     Eventually the military come through the city, and your flock sells some of the soldiers some basic equipment and items, and even arranges for some basic resupply from outside the city to fill the shelves back up again. While the soldiers suggest you should probably evacuate several times, Leon is more than happy with his new life here in the changed city. A viewpoint you are able to help your ram entice some of the visiting soldiers with, adding them to the flock when they won't be missed. As a ewe-like male, you make for an enticing trap, luring in candidates for Leon to mount while you get sucked off. The flock grows slowly and steadily to become the largest flock in the city.";
					else:
				...
				if Player is female:
					...
					if lust of Leon < 2:
						...
						say "     The outlet store becomes an additional means of recruiting ewes through various means. The occasional tainted garment gets slipped to an appealing customer. Would-be shoplifters are detained in Leon's new breaking room. Your personal favorite is to let an overconfident client [']lure['] you into a changing room for some fun, only to turn the tables on them with your cock. Once they've blown you, they're ready for Leon to finish training them to be a loyal, hard-working ewe for the flock. Over time, more and more people in the area become flock members themselves. Eventually, the whole town is sheep-run with Leon in charge.";
				[else:
					if lust of Leon < 2:
