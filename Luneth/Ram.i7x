...
to say subramsex1: [Fuck him]
	...
	if Player is dominant:
		...
		WaitLineBreak;
		say "     Getting a good grip on his hips, you start to pound his wooly ass hard and fast[if CockName of Player is not listed in infections of InternalCockList], your balls slapping against his own each time you hilt inside of him[end if]. It takes little to no time at all before he starts moaning and bleating loudly, pushing back against you needily just like you've trained him to. Soon, you feel yourself drawing close to the edge and fuck him in earnest before exploding in a powerful orgasm, [if Ball Size of Player > 5]filling him with your bountiful seed[else]coating his insides with your cum[end if]. After catching your breath, you pull out and [if anallevel is 3 and Libido of Player > 50]spread his cheeks with your hands so you can lap at your own seed spilling out of your slut's worn hole[else]slap your meat against his worn hole[end if] before moving back a little and stroking the ram's [one of]well-bred[or]cum-dripping[or]freshly fucked[at random] rump, telling him what a good little slut he is.";
	else:
		say "     Grinning, you gesture for the submissive ram to get on his knees. Eagerly, he drops onto them and reaches for your cock[if Cock Count of Player > 1]s, taking one in each hand[end if] and starts to stroke [itthemm] to fullness. Chuckling at his initiative, you tease the broken-in male about how much he clearly likes being the ewe in the relationship. He bleats out what might be a complaint, but given the expert handjob he's currently giving you, you just give a little laugh as you thrust into his hoof-like hands eagerly. Satisfied with the foreplay, you smile as you ask the ram if he's in the mood to get fucked.";
		...
		WaitLineBreak;
		say "     Getting a good grip on his hips, you start to pound his wooly ass hard and fast[if CockName of Player is not listed in infections of InternalCockList], your balls slapping against his own each time you hilt inside of him[end if]. It takes little to no time at all before he starts moaning and bleating loudly, pushing back against you needily just like you've come to expect of him. Soon, you feel yourself drawing close to the edge and fuck him in earnest before exploding in a powerful orgasm, [if Ball Size of Player > 5]filling him with your bountiful seed[else]coating his insides with your cum[end if]. After catching your breath, you pull out and [if anallevel is 3 and Libido of Player > 50]spread his cheeks with your hands so you can lap at your own seed spilling out of the ram's worn hole[else]slap your meat against his worn hole[end if] before moving back a little and stroking the ram's [one of]well-bred[or]cum-dripping[or]freshly fucked[at random] rump, telling him what a good lay he is.";
	CreatureSexAftermath "Ram" receives "AssFuck" from "Player";
...
to say subramsex2: [Get blown]
	if rambjvirg is true: [First time]
		...
		if Player is dominant:
			...
			say "     Sensing your intent, the ram turns to face you and drops to his knees as you approach. Looking up at you with hooded eyes, the desire to suck your cock is painted on the ram's face, patently obvious in the way he licks and bites his lips. It seems you made an eager cumslut out of him, and he's just too proud to ask for it. You're more than happy to oblige his need, so you run your hand along his jawline tenderly and let him suck sensually on your fingers for a moment, stroking at the soft wool on his head in encouragement. Satisfied with the foreplay, you pull your hand back with a wet pop and grab your [cock size desc of Player] cock, dangling it in front of his lips.";
			say "     Without hesitation, he gets to lapping along the length of your cock, moaning and bleating softly as he worships your meat. Not needing to be prompted this time, he opens his muzzle and starts to take your cock into [if Cock Length of Player > 6]his throat[else]his maw[end if], hollowing out his cheeks and starting to suck you off in earnest. Running your hands through the soft wool of his head, you whisper sweet nothings to your ram as he does his best to pleasure you. Moaning, [if CockName of Player is not listed in infections of InternalCockList]you feel him start to massage your balls reverentially[else]you feel his hoof-like hands clutch at your ass, pulling you closer[end if] as he takes you deep into [if Cock Length of Player < 7]his mouth[else]his throat[end if].";
			WaitLineBreak;
...
When Play begins:
	...
	add "Ram" to infections of BovineList;
	add "Ram" to infections of FurryList;
	add "Ram" to infections of NatureList;
	add "Ram" to infections of MaleList;
	add "Ram" to infections of TaperedCockList;
	add "Ram" to infections of SheathedCockList;
	add "Ram" to infections of BipedalList;
	add "Ram" to infections of TailList;
	...
	now MilkItem entry is "ram milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "ram cum"; [ Item to be given to the player if they have this infection and jerk off. ]
