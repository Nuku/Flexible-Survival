...
"Ferret"	"[PrepCombat_Ferret]"

to say PrepCombat_Ferret:
	say "";
...
When Play begins:
	...
	now face entry is "that of an adorable mustelid with darting eyes that search for shinies. You have a cute, pink nose with plentiful whiskers on your ferrety muzzle"; [ Face description, format as "Your face is [Face of Player]." ]
	now body entry is "the slender and flexible form of a ferret. You constantly have the urge to weave and bob about playfully as you move"; [ Body description, format as "Your body is [Body of Player]." ]
	...
	now MilkItem entry is "ferret milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
...
When Play begins:
	...
	now Head Description entry is "that of an adorable ferret with [Head Color of Player] fur"; [partial sentence that fits in "Your face and head resemble that of [Head Description of Player]. You have [Eye Adjective of Player], [Eye Color of Player] eyes and an overall [Gender Adjective of Player] appearance."]
	...
	now Head Color entry is "white"; [single word color adjective for the dominant color of the skin/fur/feathers/scales]
	...
	now Back Color entry is "white"; [single word color adjective for the dominant color of the skin/fur/feathers/scales]
	...
	now Ass Color entry is "white"; [single word color adjective for the dominant color of the skin/fur/feathers/scales]
	...
	now Tail Color entry is "white"; [single word color adjective for the dominant color of the skin/fur/feathers/scales]
	...
	now Cock Description entry is "is [Cock Color of Player] and has a pointy tip, as well as a sheath to protect it when not erect"; [partial sentence to fit: "You have a [Cock Girth Adjective of Player], [Cock Length of Player]-inch-long [Cock Adjective of Player] [one of]cock[or]penis[or]shaft[or]maleness[at random] that [cock Description of Player]."]
	...
	now Cunt Description entry is "is [Cunt Color of Player]-colored and shaped like that of a mustelid, with delicate nether lips and the clit at the top"; [partial sentence to fit: "You have a [Cunt Tightness Adjective of Player] [one of]cunt[or]pussy[or]vagina[or]cleft[at random] that [Cunt Description of Player]."]
...
"ferret milk"	"A plastic water bottle filled with what is clearly milk. One could think it was a regular cow's milk, if someone hadn't written 'Ferret Milk' across the label on the bottle. You [italic type]could[roman type] drink it to quench your thirst, or you maybe just do it for fun. Who knows what else it might do to you though..."	1	ferret milk
...
ferret cum is a grab object.
ferret cum is cum.
ferret cum is infectious.
Strain of ferret cum is "Ferret".
