...
to say pussy spreader cream use:
	...
	if Player is female: [and "Modest Organs" is not listed in feats of Player:]
		...
		say "You groan as your [if Cunt Count of Player > 1]vaginas spread open, leaving you with[else]vagina spreads open, leaving you with a[end if] [Cunt Tightness Adjective of Player] puss[yfn].";
		LibidoBoost 10;
		if debugactive is 1:
...
to say rightntight cream use:
	...
	if Player is female: [and "One Way" is not listed in feats of Player:]
		...
		if Cunt Tightness of Player is 2:
			...
			say "You groan as your [if Cunt Count of Player > 1]vaginas tighten up, leaving you with[else]vagina tightens up, leaving you with a[end if] [Cunt Tightness Adjective of Player] puss[yfn].";
		LibidoBoost 20;
		if debugactive is 1:
			say "DEBUG -> After-Use: Cunt Count of Player: [Cunt Count of Player]; Cunt Tightness of Player: [Cunt Tightness of Player][line break]";
	else:
...
to say tits inflator pump use:
	...
	say "     You [SelfStripChest], and attach the suction cups over your nipples and then press the button on top of the canister. A sudden spray of liquid comes out of the suction cups, covering your nipples and the area around them. Other than a slight tingling sensation, you don't really notice any ";
	if Breast Size of Player < 26: [and "Passing Grade Chest" is not listed in feats of Player and "Flat Chested" is not listed in feats of Player:]
		say "big differences at first, that is until you realize that the fluid is being absorbed into your tits, making them grow larger.";
...
to say tits deflator pump use:
	if Breast Size of Player > 0:
		...
		say "big differences at first, that is until you realize that the fluid is being absorbed into your tits, making them shrink down and become smaller.";
