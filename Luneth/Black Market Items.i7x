...
to say breeder serum use:
	...
	if Player is male:
		if Ball Size of Player < 7: [or ("Modest Organs" is listed in feats of Player and Ball Size of Player < 4)]
			BallsGrow Player by 1;
			say "     You pop open the lid of the energy style drink and begin to chug it. There's a slight bitter taste to it, but you forget that as it quickly gets to work. Soon, you're feeling hot and aroused, your libido climbing rapidly. You groan as your testicles increase in size, leaving you with [Ball Size Adjective of Player] balls.";
		else:
			say "     You pop open the lid of the energy style drink and begin to chug it. There's a slight bitter taste to it, but you forget that as it quickly gets to work. Soon, you're feeling hot and aroused, your libido climbing rapidly. You groan as your testicles pulse and throb, but don't get any bigger. Seems you've reached your maximum.";
		LibidoBoost 10;
		if debugactive is 1:
...
to say cock remover use:
	...
	if Player is male: [and "One Way" is not listed in feats of Player and "Always Cocky" is not listed in feats of Player]
		say "     You take the pill and pop it into your mouth... At first, you don't feel any different, that is until the head of your cock[smn] start[smv] to tingle. You [SelfStripCrotch], inspecting yourself and seeing your dick[smn] begin to shrink and shrivel away until there is no evidence that [if Cock Count of Player > 1]they were[else]it was[end if] even there in the first place.";
		now Cock Count of Player is 0;
		LibidoLoss 10;
		if debugactive is 1:
			say "DEBUG -> After-Use: Cock Count of Player: [Cock Count of Player][line break]";
	else:
		say "     You take the pill and pop it into your mouth... At first, you don't feel any different, that is until you start to cramp up. The shooting pain in your abdomen is almost crippling, but thankfully, after a few moments, it passes.";
		LibidoLoss 20;
...
to say sissifier gel use:
	if debugactive is 1:
		say "DEBUG -> Pre-Use: Cock Count of Player: [Cock Count of Player]; Cock Length of Player: [Cock Length of Player][line break]";
	say "     You [SelfStripCrotch], then slowly smear the pink goo over your cock[smn], making sure that [if Cock Count of Player > 1]they are[else]it is[end if] completely coated. After applying the bubble-gum scented slime, you start to feel your dick[smn] heat up, leaving you feeling hot and aroused, your libido climbing rapidly.";
	if Player is male: [and "One Way" is not listed in feats of Player]
...
to say trap serum use:
	...
	if Player is male: [and "One Way" is not listed in feats of Player]
		if Ball Size of Player > 1:
			...
			say "[line break]You groan as your testicles decrease in size, leaving you with [Ball Size Adjective of Player] balls.";
		else:
...
to say pussy spreader cream use:
	...
	if Player is female: [and "Modest Organs" is not listed in feats of Player]
		say "     You [SelfStripCrotch], then slowly smear the purple cream over your puss[yfn], making sure that [if Cunt Count of Player > 1]they are[else]it is[end if] completely coated. After applying the lavender-scented goop, you start to feel your cunt[sfn] heat up, leaving you feeling hot and aroused, your libido climbing rapidly.";
		increase Cunt Tightness of Player by a random number from 1 to 3;
		say "[line break]You groan as your [if Cunt Count of Player > 1]vaginas spread open, leaving you with[else]vagina spreads open, leaving you with a[end if] [Cunt Tightness Adjective of Player] puss[yfn].";
		LibidoBoost 10;
		if debugactive is 1:
...
to say cunt remover use:
	...
	if Player is female: [and "One Way" is not listed in feats of Player and "Always A Pussy" is not listed in feats of Player]
...
to say rightntight cream use:
	...
	if Player is female: [and "One Way" is not listed in feats of Player]
		say "     You [SelfStripCrotch], then slowly smear the white cream over your puss[yfn], making sure that [if Cunt Count of Player > 1]they are[else]it is[end if] completely coated. After applying the vanilla-scented goop, you start to feel your cunt[sfn] heat up, leaving you feeling hot and aroused, your libido climbing rapidly.";
		if Cunt Tightness of Player is 2:
			decrease Cunt Tightness of Player by 1;
		else if Cunt Tightness of Player > 2:
			decrease Cunt Tightness of Player by 2;
			say "[line break]You groan as your [if Cunt Count of Player > 1]vaginas tighten up, leaving you with[else]vagina tightens up, leaving you with a[end if] [Cunt Tightness Adjective of Player] puss[yfn].";
		LibidoBoost 20;
		if debugactive is 1:
			say "DEBUG -> After-Use: Cunt Count of Player: [Cunt Count of Player]; Cunt Tightness of Player: [Cunt Tightness of Player][line break]";
	else:
		say "     You rub the white cream onto your [if Player is male]cock[smn][else if Player is female]puss[yfn][else]mound[end if], however once it is applied, you start to experience intense itching. While you attempt to ease the irritation, you only manage to make your flesh sore, but eventually, the reaction to your body seems to die down.";
		LibidoLoss 10;
...
to say cervix smasher upgrade use:
	...
	if Player is female:
		...
		if Cunt Depth of Player is 2:
			decrease Cunt Depth of Player by 1;
		else if Cunt Depth of Player > 2:
...
to say tits inflator pump use:
	...
	if Breast Size of Player < 26: [and "Passing Grade Chest" is not listed in feats of Player and "Flat Chested" is not listed in feats of Player]
		say "     You [SelfStripChest], and attach the suction cups over your nipples and then press the button on top of the canister. A sudden spray of liquid comes out of the suction cups, covering your nipples and the area around them. Other than a slight tingling sensation, you don't really notice any big differences at first, that is until you realize that the fluid is being absorbed into your tits, making them grow larger.";
...
to say tits deflator pump use:
	if Breast Size of Player > 0:
		[if "One Way" is not listed in feats of Player and ("Passing Grade Chest" is not listed in feats of Player or Breast Size of Player > 4)]
...
Section 13 - Tits Multiplier Injection
