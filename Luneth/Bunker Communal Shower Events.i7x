...
Description of Bunker Shower Knob is "[BunkerShowerKnobDesc]".
...
to say EricShower_OrcCock:
	...
	say "     Casually, Eric's left arm reaches up, and he rests his palm against the wall right behind you. Looking at his face, you notice it distort into an expression that you are not accustomed to seeing on the normally friendly young man's face, one of cocky arrogance. With lightning speed, he leans into your personal space and getting himself soaking wet as well. At first, it seems like he's only breathing on your neck, but eventually you also feel his soft tongue start to glide across your throat. 'Mmmm, you smell like you'd make a good li'l breeder slut, baby.' You gasp in shock at what Eric just said, seeing as that just doesn't seem like something he would normally say, well besides the [']baby['] endearment at least.";
	WaitLineBreak;
	...
	say "     [bold type]Will you submit to the orc-human hybrid?[roman type][line break]";
	LineBreak;
