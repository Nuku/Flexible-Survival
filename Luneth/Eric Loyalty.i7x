...
to say EricTalk21:
	...
	say "[line break]     [bold type]Do you want to offer Eric an orc pill?[roman type][line break]";
	...
	while calcnumber < 1 or calcnumber > 3:
		...
		if calcnumber < 1 or calcnumber > 3:
			say "Invalid choice. Type [link]1[end link] to ask him, [link]2[end link] to dose him or [link]3[end link] to refuse.";
	LineBreak;
	if calcnumber is 1:
		...
		if Loyalty of Eric < 10: [he doesn't trust you yet]
			...
			say "[line break]     [bold type]How should you handle this though?[roman type][line break]";
			say "     ([link]Y[as]y[end link]) - Attempt to be romantic. (Warning: Long Scene)[line break]";
			...
			if Player consents: [romantic]
				...
				if anallevel is 3: [rimjob]
					...
					WaitLineBreak;
					say "     You decide to up the ante and pleasure the athlete as much as you can. With your free hand, you point his cock straight up and then slide your mouth down as far as you can. Effectively deepthroating your lover, you begin to hum in the back of your throat, causing vibrations to assault his cock, accompanied by the slick suction of your mouth. Now that the redhead is properly relaxed and enjoying his blowjob, you begin to pump your finger in and out of his hole faster, with each thrust making Eric squeal in pleasure, urging you on. With a second finger joining the first inside of him, you quickly continue to pump both digits as fast as you can, making sure that you hit his prostate as often as possible[if HP of Eric is 21 or HP of Eric is 22]. The flared head of his horse prick is now spewing forth so much precum that if it hadn't been down your throat, you doubt that you would have swallowed it fast enough to keep up[else if HP of Eric is 31 or HP of Eric is 32]. Paying special attention to his furry balls, you begin to roll them in your hands as you continue to suck him off[else if HP of Eric is 41 or HP of Eric is 42]. Dipping your tongue inside of his pulled back foreskin, you attempt to reach the parts of his cockhead that are rarely touched[end if].";
...
to impregEricChance with (x - text):
	if debugactive is 1:
		...
		say "Father: [x][line break]";
		if EricPregTimer > 0:
			say "     ERROR - Already pregnant!";
	[let EricPregChance be 4; [40% base chance]]
	if "Contraception" is not listed in Traits of Eric and EricPregTimer is 0 and a random chance of 4 in 10 succeeds:
		if debugactive is 1:
		...
		if debugactive is 1:
			say "     Impregnation fail! A chance of 4 in 10 didn't succeed.";
