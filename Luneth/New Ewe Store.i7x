...
to say ResolveEvent New Ewe Store:
	if NESProgress is 0:
		...
		say "[line break]     [bold type]Do you try to convince them to let you in?[roman type][line break]";
		...
		if Player consents:
			...
			say "You roll 1d20([diceroll])[if bonus >= 0]+[end if][bonus] = [special-style-1][diceroll + bonus][roman type] vs [special-style-2]11[roman type] (Charisma Check):[line break]";
		...
		if a random chance of 3 in 5 succeeds:
			...
			let bonus be ( Charisma of Player minus 10 ) divided by 2;
			let diceroll be a random number from 1 to 20;
			say "[line break]You roll 1d20([diceroll])[if bonus >= 0]+[end if][bonus] = [special-style-1][diceroll + bonus][roman type] vs [special-style-2]13[roman type] (Charisma Check):[line break]";
			increase diceroll by bonus;
			if diceroll > 12:
