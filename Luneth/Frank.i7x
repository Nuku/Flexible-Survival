...
to say ResolveEvent Mephitness:
	...
	if Player consents:
		if BodyName of Player is "Skunkbeast Lord":
			...
			if Player is male:
				say "     Picking one of the girls, you get her to lie on her back. Lining up your cock, you drive it into her wet pussy and fuck her. Her cries of pleasure are lustful and loud as you pound into her with an animalist need[if skrp is 1]. The skunk head joined to you happily French kisses the girl as you drive your leaking shaft into her muff[end if][if Player is female]. The other girls lavish attention upon your pussy and balls, licking your dripping folds and stroking your cum-filled orbs[else]. The other girls lavish attention upon your balls, rubbing your cum-filled orbs[end if].";
				WaitLineBreak;
		...
		while sextablerun is 0:
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if Player consents:
					...
					else if nam is "Fuck him standing":
						say "[Frank_MM_fbottom_01]";
					else if nam is "Fuck him lying":
						say "[Frank_MM_fbottom_03]";
					else if nam is "Receive oral":
						say "[Frank_MM_fbottom_02]";
					else if nam is "Get fucked lying":
						say "[Frank_MM_ftop_01]";
					else if nam is "Get fucked standing":
						say "[Frank_MM_ftop_03]";
...
to say Frank_MM_fbottom_02:
	say "     The big skunk grins and strokes his stiffening member at the prospect of more fun with you. With his paws going to your crotch, he's quickly on his knees and nuzzling at your throbbing cock[smn]. He teases you with some light licks here and there while taking in your scent[one of][if CockName of Player is listed in infections of InternalCockList]. Next, he buries his nose at the base of your shaft[smn], getting you moaning as he licks and nips at that sensitive spot[else]. Next, he spends quite some time licking and sucking on your balls, getting you moaning as they pulse with readiness[end if][or]. Next, he runs his tongue up and down the underside of your [Cock of Player] cock[smn] until you're throbbing with need[or]. Next, he twirls his tongue over your glans, slathering [itthemm] with his saliva until [if Cock Count of Player > 1]they're [else]it's [end if]drooling precum for him to sample[in random order]. Quite worked up by this point, you take his head a little more firmly in hand and guide [if Cock Count of Player > 1]one of [end if]your [cock size desc of Player] shaft[smn] into his muzzle.";
...
to say Frank_MM_fswitch_01:
	say "     The big skunk grins and strokes his stiffening member at the prospect of more fun with you. With his paws going to your crotch, he's quickly on his knees and nuzzling at your throbbing cock[smn] to get things started. He teases you with some light licks here and there while taking in your scent[one of][if CockName of Player is listed in infections of InternalCockList]. Next, he buries his nose at the base of your shaft[smn], getting you moaning as he licks and nips at that sensitive spot[else]. Next, he spends quite some time licking and sucking on your balls, getting you moaning as they pulse with readiness[end if][or]. Next, he runs his tongue up and down the underside of your [Cock of Player] cock[smn] until you're throbbing with need[or]. Next, he twirls his tongue over your glans, slathering [itthemm] with his saliva until [if Cock Count of Player > 1]they're [else]it's [end if]drooling precum for him to sample[in random order]. Quite worked up by this point, you caress his head and tell him to lay down so you can get at his cock as well.";
