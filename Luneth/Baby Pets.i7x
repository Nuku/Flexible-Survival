...
icon of little fox is Figure of Dash_icon.
...
The summondesc of little fox is "     [if Dash is visible]Going up to Dash, you crouch down and gently rub his ears. After showing your little fox kit some love, he gets super excited and begins to jump all over the place. Once he has calmed down a bit, he scrambles into your pack ready for a brand new journey![else]Wriggling his way out of your pack, Dash looks around the area before sitting down and staring at you with its bright shining eyes, eager to explore.[end if][line break]".
...
Scent of the little fox is "     The fox's smell reminds you of the woods, full of nature and pine. Although there is also has another scent you can't quite place, the only thing that pops into your mind is a... well [italic type]baby[roman type] smell.".
...
to say DismissDash:
	...
	say "     Opening your bag, [if Player is not in Computer Lab]Dash makes a beeline for it, only to trip over his paws and tumbling inside. You quickly check over him afterwards, only to find he decided it was nap time[else]you notice Dash is fast asleep. Trying your best to be gentle, you reach inside and take him out and him in his little box bed. Reaching over you give him a soft little kiss on the head, gaining you a happy little purr from the tiny vulpine[end if].";
...
icon of Dash is Figure of Dash_icon.
Scent of Dash is "     The fox's smell reminds you of the woods, full of nature and pine. Although there is also has another scent you can't quite place, the only thing that pops into your mind is a... well [italic type]baby[roman type] smell.".
[the linkaction of Dash is "Possible Actions: [link]talk[as]talk Dash[end link], [link]smell[as]smell Dash[end link][line break]".]
	...
	if Player consents:
		...
		if food is owned:
			...
			if the player consents:
				LineBreak;
				say "     Unable to bear hearing the poor things cries going unanswered, you carefully kneel down and pull out some food, cautiously at first, then with increasing enthusiasm the half starved fox kit tears at the food, ripping and playing with it until it is all gone. You smile at the cute sight before standing up and getting ready to leave, though you haven't gone more than a few steps when you hear something behind you. Turning round, you see the fox kit you helped is valiantly trying to keep up with you, its large vulpine eyes staring at you adoringly. Trying to shoo it back to the empty den seems pointless, and the cute little fox seems to have taken a strong fancy to you now, shrugging you give in and let it come with you. The little fox kit bouncing along in your wake and occasionally darting off to pounce on and threaten one of the nearby leaves on the ground.";
...
Chapter 4 - Fox Kit Scenes

Section 1 - Dash/Omega Fang
...
after going to Computer Lab while HP of Fang is 2 and Fang is Male and Dash is booked and FangDashRel is 0:
	...
	say "     [bold type]Do you want to try and get the fox kit to [link]become more social (Y)[as]y[end link]? Or do you want to [link]keep Fang away (N)[as]n[end link] from Dash?[roman type][line break]";
	if Player consents:
		LineBreak;
...
after going to Computer Lab while ( HP of Fang is 3 or HP of Fang is 4 ) and Fang is Male and Dash is booked and FangDashRel is 0:
	...
	say "     [bold type]Do you want to allow Fang to [link]work with Dash (Y)[as]y[end link]? Or do you want to [link]keep Fang away (N)[as]n[end link] from Dash?[roman type][line break]";
	if Player consents:
		LineBreak;
...
after going to Computer Lab while HP of Fang is 5 and Fang is Male and Dash is booked and FangDashRel is 0:
	...
	say "     [bold type]Do you want to allow Fang to [link]work with Dash (Y)[as]y[end link]? Or do you want to attempt to [link]keep Fang away (N)[as]n[end link] from Dash?[roman type][line break]";
	if Player consents:
		LineBreak;
...
Section 4 - Dash/Gentle Alpha Fang

after going to Computer Lab while HP of Fang is 6 and Fang is Male and Dash is booked and FangDashRel is 0:
	project Figure of Dash_icon;
	say "     Walking into the computer lab you're surprised to find Fang inside, sniffing around the small cubicle that Dash has claimed for himself. After a few moments the large wolf lets out a soft bark at the little fox's den and Dash pokes his head out to see who is disturbing him. He is greeted by the intimidating visage of your alpha and begins to retreat again, but Fang's slowly wagging tail and relaxed posture seems to sooth him enough that he remains peeking around the corner of the wall, nose twitching slightly as he takes in the wolf's scent. 'Come out little one, I shall not harm you,' Fang softly. Dash, looks hesitant until he sees you, at which point he charges past the startled wolf and [if legsname of player is not listed in infections of SerpentineList and legsname of player is not listed in infections of SlidingList]presses himself up against your legs[else]hides behind you[end if]. Sensing that Fang was sincere in his desire to converse with the baby fox, you approach the lupine and enquire about his sudden interest in Dash.";
	say "     Fang's luminescent eyes seem sad as he looks up at you. 'The pup needs more role models. You are a good parent, but often busy. I wish to show him that there are others who care about him[if HP of Lux > 0]. Our children view him as their brother. I want to be part of his life too[end if].' A fit of coughing interrupts his explanation, perhaps due to how much he has been talking. Nonetheless, he continues, 'He must learn to defend himself. I can do this when you are not with him.' By this time, Dash has summoned the courage to approach Fang, snuffling at his paw before continuing his investigation from snout to tail, the wolf remaining still throughout so as not to frighten the fox again. To his delight, Dash gives his nose a quick lick once he has finished sniffing at him. You don't see any reason to interfere when it looks like the two of them will get on well, especially when Fang didn't force his way to become alpha.";
	WaitLineBreak;
	say "     You smile at how well the two of them seem to be bonding, especially after how shaky their initial meeting was. Having finished sniffing each other, Dash and Fang seem at a loss as to what to do, until the fox playfully bows to him in an attempt to initiate a game. 'I am larger than you, little one and-', the wolf begins before Dash interrupts with a pleading yap. 'Fine, but only for a minute.' The fox streaks off around one of the desks, followed by Fang who has to be a lot more careful not to cause any damage. He isn't entirely successful, as you watch several chairs tumble over as he lollops past, the restrictive space hindering his usually fairly graceful movement. You chuckle to yourself at how the small fox has, at least momentarily, made the wolf forget his duties and relax. You just hope that this won't cause too much damage[if HP of Lux is 2]. Hearing the commotion, Lux and Umbra join in too, excitedly barking as they pursue their father and adopted sibling[else if HP of Lux > 2]. Hearing the commotion, Lux and Umbra peer into the room and you are sure that you see them smile before they disappear from view again. Whether or not your children will mention this to their father, you do not know[end if].";
	say "     Eventually, [if HP of Lux is 2]they[else]the two of them[end if] come to a stop beside you again. Dash smiling wildly[if HP of lux is 2], Lux and Umbra bearing similar expressions[end if], and Fang allowing his tongue to spill from the side of his mouth from enjoyment. Fang seems to have a good bond with Dash, especially after that, and you don't feel you have much right to deny them contact with each other, so there seems little reason not to let him teach Dash to be part of your pack, or more importantly show him that he is part of a family. Seeing your approval, Fang gives a grateful nod and gives Dash one last lick before padding out the door, followed by the [if HP of Lux is 2]twin wolves as well as their adoptive brother, the fox kit attempting[else]fox kit who attempts[end if] to walk underneath the larger male, the wolf adapting his gait to allow him to do so. Considering Fang thought bonding with Dash was more important than guard duty, you are confident that the fox is in safe paws.";
	now FangDashRel is 4;

Chapter 5 - Fox Kit Ending
...
The summondesc of skunk kit is "     [if Peppy is visible]Walking up and lightly scratching behind Peppy's ears, causing a loud churring sound from within. Giving a nod towards the door, the little skunk is quick to wobble outside. Apparently deciding that if he's going on this journey, then he is going to be the one leading it[else]You call out for the little skunk you rescued to come help you out, and it comes trotting up from where it was following you, ready and eager to assist his friend, the smell of skunk filling the area around you[end if].[line break]".
...
Scent of the skunk kit is "     The little guy smells of skunk, but that doesn't seem to bother you much at all.".
...
to say DismissPeppy:
	...
	say "     [if Player is not in Computer Lab]You crouch down and attempt to explain to Peppy that he needs to stick close, but that he doesn't have to fight anymore, leaving him free to explore. Churring happily, the young mephit decides to check out everything he can[else]Explaining to Peppy that he has had enough adventures for now, the little skunk rolls up into a ball, covering his face with his tail. He has apparently decided that a nap sounds great right about now[end if].";
...
Scent of Peppy is "     The little guy smells of skunk, but that doesn't seem to bother you much at all.".
[the linkaction of Peppy is "Possible Actions: [link]talk[as]talk Peppy[end link], [link]smell[as]smell Peppy[end link][line break]".]
...
Chapter 3 - Skunk Kit Event

littlelostskunk is a number that varies.

a postimport rule: [bugfixing rules for players that import savegames]
	if Resolution of Lost Skunk Kit is 0 and Lost Skunk Kit is resolved:
		if "Tamed" is listed in Traits of skunk kit:
			...
			if BodyName of Player is "Skunk Male" or BodyName of Player is "Skunk Female" or BodyName of Player is "Skunk Taur" or BodyName of Player is "Skunkbeast Lord":
				...
				if Player consents:
					...
					if skunkbeaststatus is 1:
						...
						infect "Skunk Female";
					say "[line break]     (Peppy the skunk kit is now a possible ally! You can make him your active ally by typing [link][bold type]ally Peppy[roman type][end link] or [link][bold type]ally skunk kit[roman type][end link]. You can see all the allies you have with the [link][bold type]allies[roman type][end link] command. Allies will lower the XP you gain from battle, but can gain levels themselves to be more useful in a scrap. Want to get rid of an ally? Use [link][bold type]ally dismiss[roman type][end link], or just [link][bold type]dismiss[roman type][end link].)";
					now Resolution of Lost skunk kit is 1; [adopted the skunk]
				else:
					LineBreak;
