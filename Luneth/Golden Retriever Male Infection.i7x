...
"Golden Retriever Male"	"[PrepCombat_Golden Retriever Male]"

to say PrepCombat_Golden Retriever Male:
	setmongender 3;]
...
When Play begins:
	...
	now enemy title entry is "Golden Retriever";
	...
	now MilkItem entry is "golden retriever male milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "golden retriever male cum"; [ Item to be given to the player if they have this infection and jerk off. ]
