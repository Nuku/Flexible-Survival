Version 1 of Goat Janitor by Luneth begins here.
[Original by McRabid]
[Version 1 - moved to Luneth for expansion]

[ Version 1.1 - Added Fur infection item - Fenekku]
...
to say LoseToGoatJanitor:
	...
	if Player is male: [male/herm]
		say "     The goat janitor snorts as he looks down at you on your knees. 'You some kinda dandy, like that silly [']coon? Got to yer knees awful fast,' he sneers down at you, grabbing the back of your head and shoving it forward into the crotch of his dirty coveralls. 'This what you want?' Your answer is muted by the bulge in your face. You can't help but whimper again as you hear the sound of the goat lowering the zipper of his coveralls.";
...
When Play begins:
	...
	now Species Name entry is "Anthro Goat"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Anthro Goat" to infections of BovineList;
	add "Anthro Goat" to infections of FurryList;
	add "Anthro Goat" to infections of NatureList;
	add "Anthro Goat" to infections of MaleList;
	add "Anthro Goat" to infections of TaperedCockList;
	add "Anthro Goat" to infections of SheathedCockList;
	add "Anthro Goat" to infections of BipedalList;
	add "Anthro Goat" to infections of TailList;
	...
	now libido entry is 35;
	now loot entry is "Anthro Goat fur";
	now lootchance entry is 0;
	now MilkItem entry is "anthro goat milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "anthro goat cum"; [ Item to be given to the player if they have this infection and jerk off. ]
