...
When Play begins:
	...
	now Species Name entry is "Retriever Female"; [name of the overall species of the infection, used for children, ...]
	...
	now enemy title entry is "Male Retriever"; [name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name]
