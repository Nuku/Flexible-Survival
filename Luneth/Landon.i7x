...
Cunt Depth of Landon is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Description of Landon is "     The tall and muscled golden retriever jock is decked out in some baggy cream-colored shorts, a black tank top, and a red lettermen jacket with the name [']Landon['] on the back. His fur is the normal golden-yellow color, which compliments his warm honey-brown eyes.[line break]".
...
after going to Athletic Street while Resolution of HypnoGeeks > 0 and Resolution of HypnoGeeks < 98 and HP of Landon is 0: [intro event]
	...
	if Player consents: [encounter Landon]
		...
		WaitLineBreak;
		say "     With his parting words, the retriever jock gets up off of the ground and readjusts his letterman jacket before starting to jog away. Before he gets too far away though, he stops and turns around, waving back at you with a smile on his muzzle. Then with a cocky wink, he turns back around and resumes his run. As you watch him fade into the distance, you can't help but wonder what is really going on between Landon, Arsene and Alcippe[if Stamina of Landon is 1]. Or how what happened with the mice could be connected...[else].[end if]";
		now HP of Landon is 1;
	else: [don't encounter Landon]
		LineBreak;
		say "     You decide that no matter what is going on over there, more than likely, it has nothing to do with you. You slide back along the wall that you have been using as a hiding spot, using the cover to leave without disturbing whatever it is that they are fighting about. As you continue on your walk, the sounds of the yelling from the two males become fainter, until they finally disappear completely.";
...
after going to Athletic Street while HP of Landon is 1 and "Placement Event Done" is not listed in Traits of Landon: [placement event]
	...
	if Player is barecrotch and Player is barechest: [Naked]
		if Player is male and Breast Size of Player is 0:
