	...
	if noncon is not banned:
		if anal is not banned:
			...
			if a random chance of 1 in 3 succeeds:
				...
				say "     You are tugged this way and taht as pricks mash up against your face to smother you in slick sacs and throbbing manmeat. More grind in against your sides, and your asscheeks are parted as not one, but two pricks take the sloppy seconds and slam their slick shafts home. Their cocks grind together inside of you, an internal frot of aching need. Your mouth is breached by one of the face-grinders, the tips ot two others hungrily smearing against your stretched lips, occasionally dipping in to share your mouth with the throat-thrusting brother. Every portion of your body is ground up against by hard bodies and twitching pricks or brushed along by slick balls. The army of arousal reigns over your body, and as hot ropes of seed stretch over your body, fresh pricks move in to take the places of the spent.";
...
When Play begins:
	...
	now skin change entry is "your flesh thickens even as it indents, sculpting against your figure to suss out the shapes of your muscles and accentuate them. Hardening, the indentations split as your skin forms into chitinous plates, segmented and articulated to give you a sculpted, chiseled appearance with the hunter green shell patterned with army camoflauge designs";
	now ass change entry is "the base of your spine swells, a fresh growth forming just above your buttocks. The bulb of meat swells out, ballooning and elongating into an oblong eliptoid. The flesh toughens, thickening into a hard shell that sports a polished gleam, and where the new, insectile abdomen has formed from the base of your spine, it segments, pivotable and a heavy counterbalance";
	now cock change entry is "heat spills through your loins, pinpricks crawling over the flesh like an army of insects dragging fiery brands all across the length. A seering seam splits open, the flesh plating and segmenting around the newly-formed pocket as your crotch forms a rigid, glistening cock within the cavity, nested with your nuts. The seam to the pocket tightens, the plates sealing together, and your crotch now sports an internalized, retractable dick";
	now str entry is 14;
	now dex entry is 13;
	now sta entry is 14;
	now per entry is 13;
	...
	now Ball Size entry is 30; [ Cock width, more commonly used for ball size. ]
