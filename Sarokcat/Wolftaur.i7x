...
To say Wolftaur loss:
	...
	if diceroll > 15:
		...
		say "     Now that you've caught yourself a not so little male wolftaur, what do you do with him? [link]Have some fun (Y)[as]y[end link] with the wolfie or [link]let him go (N)[as]n[end link] with a warning?";
		if Player consents:
			LineBreak;
			...
			if Player is male: [male + herm]
				say "     What would you like to do now with this horny wolftaur stretched out before you? You could [link]ride that canine shaft (Y)[as]y[end link] of his, or alternatively [link]take his tight hole (N)[as]n[end link] yourself?";
				if Player consents:
					LineBreak;
					if Player is herm:
						say "     As a herm, you have the choice which hole you want to sink down on his hard canine shaft. Which shall it be? (Y=Pussy, N=Ass)[line break]";
						if Player consents:
							LineBreak;
				...
				say "     What would you like to do now with this horny wolftaur stretched out before you? You could [link]ride that canine shaft (Y)[as]y[end link] of his, or make him [link]lick your pussy (N)[as]n[end link]?";
				if Player consents:
					LineBreak;
					say "     [WolftaurRidingPussy]";
				else:
...
When Play begins:
	...
	now Species Name entry is "Wolftaur"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now MilkItem entry is "wolftaur milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "wolftaur cum"; [ Item to be given to the player if they have this infection and jerk off. ]
		...
		if level of Lindsey > 3:
			if humanity of Player < 10:
				if Player is female:
					...
					say "     Your mind filling with images of the handsome alpha wolftaur you encountered in the zoo, you are unable to resist your needs any longer. Running back to the zoo on your four swift canine paws, your new canine muzzle sniffs the air eagerly hoping to catch a hint of that strong male musk your body knows so well. You catch his scent just as you reach the bathroom area, and turn to see Lindsey there waiting for you with a grin on his lupine face, as if he had no doubt as to the fact that you would submit. '[if LindseyMPregDetected is false]I supposed you would come back here instead of trying to start up your own pack, my little pet,' the more dominant wolftaur says with a soft smirk on his canine face. 'Don't worry, I saved a place in my pack for a special submissive male like yourself,' he adds, moving to mount you. 'That's right. I can smell that womb of yours, even over the stink of this place, and I'm going to enjoy putting my pups in it[else]Don't worry, I saved a place in my pack for my special he-bitch breeder like I promised,' he adds, moving to mount you. 'And your alpha also promises that his strong and virile cum'll put pups even in your male belly[end if].'";
