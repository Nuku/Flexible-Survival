...
PALOMINO Dance Club is southeast of Private club room.
...
Description of Janice is "     Lying back on one of the comfortable couches in the area, you see a rather striking looking foxy lady. The white furred vixen is eyeing you with amusement as you look over her soft furred form, your eyes drawn to her rather striking curves, and her obviously comfortably state of nakedness. The vixen being clad only in her soft and tempting looking snowy white fur, as her long bushy tailtip twitches from side to side in amusement.[line break]".
...
the linkaction of Janice is "Possible Actions: [link]talk[as]talk Janice[end link], [link]smell[as]smell Janice[end link], [link]fuck[as]fuck Janice[end link][if janicetalk >= 4], [link]pose[as]pose for Janice[end link][end if][line break]".

Section 3 - Conversation

instead of conversing the Janice:
	project Figure of Janice_icon;
	if debugactive is 1:
	...
	if Janicetalk is 0: [first time you encounter the NPC text]
		...
		if Player is male:
			say "     Soon her paw finds its way to your manhood, stroking your cock to erection and getting it dribbling with pre. As she strokes your [cock size desc of Player] cock, she nuzzles along your neck. She gives you small nips and nibbles while rubbing her softly furred fur against your [bodydesc of Player] body. Her touch is sensual and her scent is intense with arousal. The handjob eventually has you cum hard, emptying your [Cum Load Size of Player] load across your chest and hers. 'Mmm... you did very well, my dear. If all goes well, I should be able to see my dear friend again soon,' she grins as licks her paw clean, then moves on to grooming her fluffy fur.";
		...
		if Player is male:
			if CockName of Player is "Arctic Fox":
				if a random chance of 1 in 3 succeeds:
					...
					MultiInfect "Arctic Fox" repeats 2;
			else:
...
Understand "Learn from/-- Jance/janice" as Vixenposing.
...
carry out Vixenposing:
	if lastVixenposing - turns < 6:
		...
		say "[line break]You roll 1d20([diceroll])[if bonus >= 0]+[end if][bonus] = [special-style-1][diceroll + bonus][roman type] vs [special-style-2]17[roman type] (Dexterity Check):[line break]";
...
Janice's blouse is a grab object. It is not temporary.
...
to say Kristen-giveblouse:
	if kristenmsg4 is false:
		say "     Even as you pull out the blouse, Kristen recognizes it right away and quickly takes it from you. She holds it up to look it over carefully before clutching it to her chest. 'Oh, this is Janice's. I'd recognize it anywhere. Where did you get it?'";
		...
		say "     Even as you pull out the blouse, Kristen recognizes it right away and quickly takes it from you. She holds it up to look it over carefully before clutching it to her chest. 'Oh, this is Janice's. I'd recognize it anywhere. That means it's really her.'";
