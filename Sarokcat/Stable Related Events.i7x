...
Instead of Resolving a Equineguardpost:
	if onyxkeys is 1:
		...
		otherwise:
			...
			stop the action;
	otherwise:
		say "Wandering through the dimly lit halls of the hotel, you hear some racous laughter coming from up ahead. Moving cautiously you look into the room ahead, only to spy a couple of horsemen hanging out and laughing while they drink some sort of barely fermented brew. You spend a second to glance around the crude guardpost, but seeing nothing worth the fight with the horse guards, you slip away quietly and continue your trip through the quiet halls of the building.";
...
Section 6- findinghardware [fancy quest part 2]
			...
			if lost is 0:
				...
				if lost is 0:
					...
					otherwise:
						...
						stop the action;		
				otherwise:
					say "Driven back by the creatures, when the horsemen arrive they find the store lot to be full of a decent sized group of various creatures currently in possession of the junkyard fort, and the head horseman glares at you as he stares at the well defended location, and evaulates matters. Sighing he gestures for his men to keep on moving, though before he leaves he glances down at you derisively, 'If Fancy didn[apostrophe]t have her eye on you for some reason I[apostrophe]d be tempted to take you back with us for training just so this trip wouldn[apostrophe]t be a total loss...' He says with a snort before continuing on his way, leaving you feeling rather embarrassed as you lie there trying to recover before heading back to the library.";
	...
	if provingstallionhood is 2:
		...
		if player consents:
			...
			otherwise:	
				...
				decrease humanity of player by 150;
