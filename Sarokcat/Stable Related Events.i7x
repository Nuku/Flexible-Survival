...
Instead of Resolving a A Stabled Situation:
	...
	if Stablesearchstatus is 1:
		...
		say "You follow the horsemen and their captives at a discrete distance as they make their way through the dangerous streets of the city, sometimes having to duck down dark alleyways not to be noticed. Finally after what seems like forever the long nervewracking trip comes to an end near the red light district, as the horsemen lead their captives through the side entrance of what appears to be an old hotel complex. The building looks like it was built sometime around the turn of the twentieth century, and has certainly seen better days. The large building seems more like an an insane asylum than a luxury hotel now with its large multi story main building and the two slightly shorter wings which appear to have been added at some later date. Flanking the entrance are two more of the horsemen obviously there to keep out the riffraff, though with only two of them, perhaps you could try to bribe your way inside? Do you try to gain entrance to the building?";
		If player consents :
