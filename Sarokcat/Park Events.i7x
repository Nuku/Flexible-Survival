...
to say ResolveEvent Poppy Field:
	...
	if Player consents:
		...
		now Resolution of Poppy Field is 2; [avoid]
...
to say ResolveEvent Felinoid Lair:
	if lairconsent is 0:
		...
		if Player consents:
			...
			ItemGain food by 1;
			now lairconsent is 1;
			MultiInfect "Felinoid" repeats 2;
		...
		if Player consents:
			...
			ItemGain water bottle by 1;
			ItemGain food by 1;
			now lairconsent is 2;
			MultiInfect "Felinoid" repeats 3;
