...
Instead of Resolving a Felinoid lair:
	if lairconsent is 0:
		say "While traveling through the park, you come across a small hollow set into one of the hillsides, from the looks of the surrounding area, something might have passed this way not to long ago, though it doesn[']t appear anything is nearby now.  There is an intriguing scent teasing at the edges of your consciousness that seems to be coming from within the cave, and there could be something useful left inside, though you would have to almost crawl to enter the low cave. Do you decide to look inside?";
		if player consents:
	...
	otherwise if lairconsent is 2:
		...
		otherwise:
			say "You realize that you can[']t stay here any longer, even as you can feel your body changing from the musk, changing you to be a better mate for the strong masculine beast who[']s lair this is, you find yourself moaning at that thought before you manage to snap yourself out of it. You crawl outside desperately gasping for some air not scented by his powerful and dominating scent, that makes you want to moan and lift your body up for his strong touch. Groaning you realize your mind was once more back on being nothing more than the fucktoy of the lair's owner, submitting to him again and again in a wonderfully pleasurable night of bestial sex. Yowling out with need, you manage to drag yourself further away, until you can start to think somewhat clearly again, you know you need to get out of here quickly before the caves owner returns.  Even as you leave you find your mind returning to the thought of waiting helplessly for the caves owner having him take you again and again, and know that you can[']t afford to come back here again, not unless you want to be reduced to just another animal.  Still you realize that deep down the experience has changed you already, made you less human and more bestial on some level, and you really aren[']t sure if you regret the change either.";
