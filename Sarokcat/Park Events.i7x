...
Instead of Resolving a Poppies field:
	...
	If player consents:
		say "Yawning you stop to sit in the field of flowers for a minute, and find your eyes drifting shut, you arent sure just how much time has passed, when all of a sudden something knocks you awake! Shaking off the damage and some plants that strangely seem to have settled on you, you begin to fight!.";
...
Instead of Resolving a Poke trap:
	...
	if player consents:
		...
		if player consents:
			say "As you draw closer, you are almost within touching range of the little beast when it straightens up and turns around, and you recognize it as one of those Chinchilla women that have been running around the park.  Apparently it got ahold of some type of yellow paint or dye, and made itself up to look like most kids favorite pokemon, most likely as bait... which you just fell for!  Before you can finish taking this all in, you realize the crackling sound is from some sort of taser that the little beast has managed to get its hands on... and proceeds to shock you with!  As you jerk and twitch from the electricity several more of the little beasts burst from cover to come pounce on you while your weakened!";
