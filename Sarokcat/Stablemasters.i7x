...
Body Definition of Slutslave is 5. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
Androginity of Slutslave is 3. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
SleepRhythm of Slutslave is 0. [0 - awake at all times, 1 - day active, 2 - night active]
Mouth Length of Slutslave is 6. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Slutslave is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Slutslave is 6. [length in inches]
Cock Count of Slutslave is 0. [number of cocks]
Cock Girth of Slutslave is 0. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Slutslave is 0. [length in inches]
Ball Size of Slutslave is 0. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
Ball Count of Slutslave is 0. [allowed numbers: 1 (uniball), 2 or 4]
Cunt Count of Slutslave is 1. [number of cunts]
Cunt Depth of Slutslave is 12. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
Cunt Tightness of Slutslave is 6. [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
Clit Size of Slutslave is 1. [size 1-5, very small/small/average/large/very large]
Asshole Depth of Slutslave is 12. [inches deep for anal fucking]
Asshole Tightness of Slutslave is 2. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Nipple Count of Slutslave is 2. [count of nipples]
Breast Size of Slutslave is 4. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
...
check Slavelearning:
	...
	if LastSlutslavelearned minus turns < 10:
		say "     Your slave glances down at the ground sadly, and shakes her head slightly apologetically. 'Your Slut is truly sorry master, but she doesn't think either of us are ready for another training session so soon... maybe her gorgeous master should come back a little later? And maybe even punish their slut for not being ready sooner?' she says in a rather sad tone, though you can see from the slight dampness on her black thighs that the idea of being punished has already made your little pet hot and needy..." instead;

carry out Slavelearning:
	project Figure of Slutslave_icon;
	setmonster "Nightmare"; [puts Nightmare as lead monster for comparison]
	choose row MonsterID from Table of Random Critters;
	let Tc be a list of numbers;
	if strength of Player < str entry, add 1 to Tc;
	if dexterity of Player < dex entry, add 2 to Tc;
	if stamina of Player < sta entry, add 3 to Tc;
	if perception of Player < per entry, add 4 to Tc;
	if intelligence of Player < int entry, add 5 to Tc;
	if charisma of Player < cha entry, add 6 to Tc;
	[now all numbers in Tc refer to a stat that can be increased]
	if Tc is empty: [until someone writes a scene for no stat being eligible for a raise, choose one at random]
		add a random number between 1 and 6 to Tc;
	sort Tc in random order;
	if entry 1 of Tc is:
		-- 1:
