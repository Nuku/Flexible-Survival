...
Scent of the Felinoid companion is "     Klauz smells strong and masculine[if Player is female or Player is mpreg_ok]. It is quite arousing[end if].".

to say SummonKlauz:
	project the Figure of Klauz_face_icon;
	say "     [if Klauz is visible]Walking up to the big cat, you give him a few scritches on the head and behind his ears. Klauz[else]Turning to look around, you spot the large felinoid from the park lurking quite a ways behind you, obviously keeping an eye on you from a distance. Feeling a smile tugging at your face, you gesture several times for him to approach, and after a minute, Klauz seems to get the idea as he pads forward and[end if] rubs up against you in greeting, obviously looking forward to exploring with you.";
...
[Conversation of Klauz is { "Meow!" }.]
fuckscene of Klauz is "[sexwithfelinoidpet]".
Scent of Klauz is "     Klauz smells strong and masculine[if Player is female or Player is mpreg_ok]. It is quite arousing[end if].".
...
An everyturn rule:
	if felinoid companion is listed in companionList of Player and skipturnblocker is 0 and a random chance of 1 in 4 succeeds and lastfuck of felinoid companion - turns >= 8:
...
to say sexwithfelinoidpet:
	...
	if lastfuck of felinoid companion - turns < 4:
		...
		NPCSexAftermath Player receives "[if Player is female]Pussy[else]Ass[end if]Fuck" from Klauz;
		...
		if Player is female:
			...
			if Libido of Player < 50:
				say "     The great feline beside you gently nudges against you a few times, then nuzzles upwards into your groin, teasing at a [cock size desc of Player] [Cock of Player] shaft. A rough tongue flicks out across sensitive flesh, taking special care to get up under spines and tease the sensitive flesh under the head of the feline cock. Do you really have time to spend indulging the cat's lusts? Well that does feel really damn nice. Maybe...";
				if Player consents:
					LineBreak;
				...
				say "     The great feline beside you gently nudges against you a few times, then nuzzles upwards into your groin, teasing at a [cock size desc of Player] [Cock of Player] shaft. A rough tongue flicks out across sensitive flesh, taking special care to get up under spines and tease the sensitive flesh under the head of the feline cock. Already feeling quite aroused, the thought of pushing him away does not even enter your mind.";
				say "[felinoidpet_purem]";
...
[				else if HP of Sven >= 30 and HP of Sven < 50:
				...
				if (HP of Fang is 3 or HP of Fang is 4) and Fang is Male:	[felinoid player w/companion and Fang]
					if Player is female:
						...
						say "     Fang is made to accept his place beneath the powerful felinoid as well after a short struggle. With you as his felinoid mate, the big cat is clearly the victor between the two and he celebrates by forcing himself onto the defeated wolf and fucking him as well. As you watch, Fang [if HermList is not banned]gains a wet, bitch pussy to go along with his cock and balls and is then bred by the victorious felinoid. The felinoid trains the wolf well, breeding cubs in both your bellies. Fang may still be your alpha wolf, but Klauz[else]is fucked repeatedly until he's made submissive to the stronger cat. The felinoid trains the wolf well, always making sure the wolf knows his place beneath him. Fang may still be your alpha wolf, but the felinoid[end if] owns you both now.";
						...
						say "     During one of these stops, Fang is made to accept his place beneath the powerful felinoid as well after a short struggle. With you as his felinoid mate, the big cat is clearly the victor between the two and he celebrates by forcing himself onto the defeated wolf and fucking him as well. As you watch, Fang [if HermList is not banned]gains a wet, bitch pussy to go along with his cock and balls and is then bred by the victorious felinoid. Klauz trains the wolf well, breeding cubs in both your bellies. Fang may still be your alpha wolf, but the felinoid[else]is fucked repeatedly until he's made submissive to the stronger cat. Klauz trains the wolf well, always making sure the wolf knows his place beneath him. Fang may still be your alpha wolf, but the felinoid[end if] owns you both now.";
