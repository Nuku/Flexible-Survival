...
to say panda attack:
	if medeapanda is true:
		say "     [if HP of Player > 0]Rather than fight a pregnant woman about to go into labor, you decide to just give up and let her have her way[else]You end up getting beaten rather than giving your all to fight a pregnant woman about to go into labor[end if].";
		now the non-infectious corresponding to a Name of "Panda" in Table of Random Critters is true;
...
to say panda appears:
	if medeapanda is true:
		...
		say "     Traveling down the zoo paths, you are startled to see a black and white patterned humanoid bear charge through the landscaping and end up right in front of you, panting from the exertion of running around like mad, her modest breasts heave with every breath as she scans the area. The panda-like woman's eyes fix on you, [if Player is male]and then drop down to your [Cock of Player] cock. 'Ooooh a male!' she exclaims. [one of]'Please fuck me now!' [or]'Did you know pandas are an endangered species?' she asks slyly. 'Want to help me repopulate?' [or]'Yes! Take me now!' [or]'Finally I can get laid!' [or]'You're mine!' [or]'Finally I found a man!' [or]'You would make a handsome panda!' [at random]the pandawoman says lustily. Not waiting to see your response, she charges forward clearly intent on getting laid[else]scanning over your female form, and seeming disappointed at what they find. 'Another woman?' the panda cries out in exasperation. [one of]'We don't need any more competition for mates around here!' [or]'You won't get the men while I'm around!' [or]'Maybe we can MAKE you a man!' [or]'You must have hidden the men for yourself! I'll beat their location out of you!' [or]'I needed someone to vent my frustration on anyways,' [at random]she says with a growl of pure frustration. Not bothering to let you respond, she charges forward, fire in her eyes[end if].";
...
When Play begins:
	...
	add "Panda" to infections of MaleList;
	add "Panda" to infections of SheathedCockList;
	...
	now defeated entry is "     [if medeapanda is true]Despite fighting with added care and holding back some of your strength due to your foe's gravid state, you're still more than a match for the panda and are able to wear her down to the point that she's no longer trying to fight[else]You knock the already tired pandawoman back on her furry ass. She sits there for a minute, a slightly puzzled look on her face, before her eyes roll up in her head and she passes out, the fight on top of the chase obviously too much for her. Her body collapses back on the zoo path, sprawled out bonelessly, you check to make sure she is still alive, and find that she is just deeply asleep. Sighing in relief, you decide to continue on your way while you can, leaving the sex crazed panda to sleep it off behind you[end if].[line break]";
	...
	now body change entry is "your shoulders widen, and your legs seem to shrink. Your chest and body rounds out into a more bearlike build, as sharp claws grow out of your hands and feet"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	...
	now MilkItem entry is "panda milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "panda cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
"Panda Infection"	"Infection"	""	Panda Infection rule	1000	false
