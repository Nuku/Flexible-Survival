...
Instead of Resolving a Military presence:
	if mtp is 0:
		...
		if diceroll > 10:
			...
			say "     You swiftly begin running across the street to the building, hoping to arrive in time to help whoever is on the roof. Drawing close to the building, you can hear the signs of a struggle from the roof. However as you arrive at the building, you can hear the sounds from above go silent for a minute, before moans and other sounds of a more intimate nature begin coming from above. Hoping there might still be something left to talk to up above, you quickly search around the building for a way up, eventually finding a fire escape ladder within easy reach of the ground. After climbing up the fire escape, with the moans and squealing getting louder with every step, you prepare yourself for combat as you peek up onto the rooftop. Just as you do, there is a loud beating of wings as two gryphons take off from the roof, dancing and flirting with each other in the air as they take off for parts unknown.";
...
Instead of Resolving a Twisted grove:
	say "Exploring the park trails, you hear muffled sounds from a distance. Deciding to investigate you creep up over a small hill only to stare in astonishment as what seems to be a small grove of animated plants continue to violate a skunk-like woman, holding her suspended off the ground like some obscene fruit. As you watch more and more cum drips off her onto the ground, as she is pounded by several vines into orgasm again and again. Your eye is quickly drawn to the patch of grass where some of the cum fell as the grass seems to writhe and twitch and start to grow in obscene shapes as well. As there is nothing you can do for the skunkwoman against the growing grove of twisted plants, you decide to move on quickly before you end up joining her.";
