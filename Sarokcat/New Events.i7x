...
Instead of Resolving a Hyena Gang:
	...
	if hyg is 2:
		...
		otherwise:
			say ”'Membership comes with some benefits, though you might end up with a few changes as well' the hyena says as shi looks you up and down, 'But trust me they are all for the better, and you might as well join while the offer is open, since soon we might not be offering such a good deal for long.”;
			If player consents:
				say “'Great! I[apostrophe]ll, just go and let the others know to keep an eye out for you!  You should come back in a little bit' Shi says, with a toothy smile, looking you over again, 'But first I think you will need to fit in a bit more.' Shi says, right before she pulls your startled body into her arms for a crushing hug, causing you to open your mouth to protest, only to find yourself being sloppily kissed as her rough tounge darts into your mouth, her sharp teeth brushing up against your face. Before you can react shi puts you back down and gives you a big grin, before heading back towards the hyena territory.  Glancing over her shoulder she calls back, 'Just a little something to remember me by!  I look forward to seeing how the changes look on you!' before vanishing around the corner, your body shuddering as it begins to change.”;
				hyenaify;
				hyenaify;
				Now hyena gang is resolved;
			otherwise:
...
Instead of resolving a squatters den:
	say “exploring the sewers underneath the mall, you find signs of a recent struggle.  Investigating more closely you see where something came across what appears to be a recently inhabited squatters den, piles of junk and blankets and even an old shopping cart have been dragged down here and set up in a small alcove.  From the looks of the recent struggle the den isn't inhabited any longer, carefully picking through the piles of junk looking for anything that might be of use.  Finding some food and a bottle of none to clean water, you head on about your buisness.“;
	Add “dirty water” to invent of player;
	Add “food” to invent of player;
...
Instead of resolving a leaking pipe:
	say “as you travel the sewers and utility corridors under the mall, you hear a steady trickling noise coming from down one of the passageways, the sound grows louder as you move closer, eventually discovering a leaking water pipe. You apparently aren't the only person to have discovered this source of water though, as someone has set up a couple small containers under the steady leak.  As the containers are definitely overflowing whoever set them up obviously hasn't been back in a while. Sensing an opprotunity you quickly gather up a couple of the full containers and place them in your pack, you then hurry along before someone comes looking for them. “;
	Add “dirty water” to invent of player;
	Add “dirty water” to invent of player;
