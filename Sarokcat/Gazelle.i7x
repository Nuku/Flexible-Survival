...
To say gazelle loss:
	...
	if the remainder after dividing gazellesbeaten by 3 is 0:
		if Libido of Player > 75:		[no choice]
			if Player is male and (Player is not impreg_ok or a random chance of 3 in 4 succeeds):
				say "     As the gazelle cries out in pain from your last blow, you manage to knock her down. As she starts to scramble away, having bought time for the rest of the herd to flee, you grab this one before she can get away. Feeling a predatory rush of excitement, you look her over, trying to decide what you'd like to do with this gazelle person. In your highly aroused state, you decide right away to give her a good, hard fucking.";
				say "[gazellefuck]";
			else:
				say "     As the gazelle cries out in pain from your last blow, you manage to knock her down. As she starts to scramble away, having bought time for the rest of the herd to flee, you grab this one before she can get away. Feeling a predatory rush of excitement, you look her over, trying to decide what you'd like to do with this gazelle person. In your highly aroused state, you decide right away to get her cock inside you.";
				say "[gazelleride]";
			now Libido of Player is ( Libido of Player + Libido of Player + 30 ) / 3;
		else:
			if Player is male:
				say "     As the gazelle cries out in pain from your last blow, you manage to knock her down. As she starts to scramble away, having bought time for the rest of the herd to flee, you grab this one before she can get away. Feeling a predatory rush of excitement, you look her over, trying to decide what you'd like to do with this gazelle person. Drawn to her dual-gendered groin, you wonder if you should fuck her [link](1)[as]1[end link], get her cock inside you [link](2)[as]2[end link] or just let her go [link](3)[as]3[end link].";
				now calcnumber is 0;
				...
				say "     As the gazelle cries out in pain from your last blow, you manage to knock her down. As she starts to scramble away, having bought time for the rest of the herd to flee, you grab this one before she can get away. Feeling a predatory rush of excitement, you look her over, trying to decide what you'd like to do with this gazelle person. You consider getting a [link]ride on that cock (Y)[as]y[end link] of hers or just [link]letting her go (N)[as]n[end link].";
				if Player consents:
					LineBreak;
					say "[gazelleride]";
				else:
...
to say gazelleride:
	...
	CreatureSexAftermath "Player" receives "[if Player is female]Pussy[else]Ass[end if]Fuck" from "Gazelle";
...
When Play begins:
	...
	now desc entry is "     Wandering down the zoo paths, you come across a small group of rather human-like gazelles. Their short muzzles and sharp horns move happily as they graze on the topiary with thin cocks sprouting from between their legs, above their obviously female openings, with soft pert breasts resting on their chests. Spotting you they immediately freeze. Before you can even open your mouth to speak, most of them bolt in different directions, although one of them charges right at you, intent on protecting the rest of the herd! You have no choice but to brace yourself for battle![line break]";
	...
	now MilkItem entry is "gazelle milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "gazelle cum"; [ Item to be given to the player if they have this infection and jerk off. ]
