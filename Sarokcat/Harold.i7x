...
Body Weight of Harold is 5. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Harold is 5. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
Androginity of Harold is 2. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
SleepRhythm of Harold is 0. [0 - awake at all times, 1 - day active, 2 - night active]
Mouth Length of Harold is 7. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Harold is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Harold is 7. [length in inches]
Cock Count of Harold is 1. [number of cocks]
Cock Girth of Harold is 4. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Harold is 10. [length in inches]
Ball Size of Harold is 4. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
Ball Count of Harold is 2. [allowed numbers: 1 (uniball), 2 or 4]
Cunt Count of Harold is 0. [number of cunts]
Cunt Depth of Harold is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
Cunt Tightness of Harold is 0. [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
Clit Size of Harold is 0. [size 1-5, very small/small/average/large/very large]
Asshole Depth of Harold is 12. [inches deep for anal fucking]
Asshole Tightness of Harold is 3. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Nipple Count of Harold is 2. [count of nipples]
Breast Size of Harold is 0. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
		...
		if a random chance of 1 in 3 succeeds and lastrandomharold - turns >= 8 and LastDrinkserved is not 250:
			...
			if Player consents:
				...
				if T < 3: [1-2]
					...
					WaitLineBreak;
					say "     Harold yelps as he catches you with his muscular arms, however, the horned equine is not at all prepared for you to kiss, lick, nip, bite and all out chew on his throat as you quickly find yourself [italic type]hungry[roman type] for the sweet tasting mythic beast. It takes the other almost two minutes to pry your [BodyType of Player] form away from him, but when he does Harold has no time to try and calm you down because you quickly pass out seconds later. In the dim fog of black unconsciousness, you could almost swear that you heard someone say [']WAY too strong['], but you're not sure.'";
					unicornify;
				else: [8]
...
to say haroldfemalesex:
			...
			NPCSexAftermath Player receives "PussyFuck" from Harold;
...
to say haroldmalesex:
	if Libido of harold is 0:
		...
		NPCSexAftermath Player receives "OralCock" from Harold;
		...
		say "     Harold gives you a wonderful, thorough fucking before finally cumming hard while pumping his hand over your dick. As the stallion's thick, ample load is pumped into you, you feel a rush of pleasure and cum hard as well. You can hear your seed splashing into an ice bucket, possibly to be made into another of the unicorn's strange drink concoctions. As Harold pulls out of you, there's some teasing and solicitations from the others, but he threatens to cut them off from drinks and they give up pretty quick.";
		NPCSexAftermath Player receives "AssFuck" from Harold;
		...
		if Libido of harold is even:
			...
			if Playernum >= haroldnum:		[player wins]
				...
				say "Lose!";
				say "     You and Harold start taking drinks together while balancing the shot glasses on the back of your hands. It's a little tricky, but you manage to keep them steady. As the contest progresses, it gets harder for you. Even though the nanites help you deal with the alcohol, you're dumping a lot of it in quickly and you get you progressively unsteadier. Your [BodySpeciesName of Player in lower case] hand ends up wobbling too much as you try to bring it to your mouth and the small glass tumbles off. With the drink spilled and Harold smiling at you with his gleaming equine teeth, you've lost and have ended up being the unicorn's ride again.";
...
to say dc_fuckharold:
	...
	NPCSexAftermath Harold receives "AssFuck" from Player;
	increase score by 5;
	increase morale of Player by 1;
	now Libido of Player is ( Libido of Player + Libido of Player + 50 ) / 3;
...
to say dc_fuckedbyharold:
	...
	say "     The fucking you receive from him is wilder and rougher than usual, but is nothing but bliss all the same. The stallion pumps frantically at your cock as well, getting you to empty your balls into one of his buckets. Feeling your ass clenching and squeezing around him as you cum is enough to set him off and you're treated to the hot rush of his thick semen claiming your ass again. You're suffused with a rush of pleasure and start cumming all over again. You collapse onto the bar with a soft moan as your stallion stud pulls out. There's a few teasing comments thrown around, mainly directed at the loser, including many requests to have sloppy seconds. You smile at these, but are too worn out for more right now.";
	NPCSexAftermath Player receives "AssFuck" from Harold;
	now Libido of Player is ( Libido of Player + Libido of Player + 50 ) / 3;
...
carry out Chaserdrinking:
	...
	MultiInfect "Cheetah Woman" repeats 2;
	SanLoss 5;
	PlayerDrink 5;
	now LastDrinkserved is turns;
...
carry out Delightdrinking:
	...
	MultiInfect "Succubus" repeats 2;
	SanLoss 5;
	PlayerDrink 5;
	now LastDrinkserved is turns;
...
carry out Gryphondrinking:
	...
	MultiInfect "Blue Gryphon Herm" repeats 2;
	SanLoss 5;
	PlayerDrink 5;
	now LastDrinkserved is turns;
...
carry out Lagerdrinking:
	...
	MultiInfect "Jaguar Male" repeats 2;
	SanLoss 5;
	PlayerDrink 5;
	now LastDrinkserved is turns;
...
carry out Sabredrinking:
	...
	MultiInfect "Sabretooth" repeats 2;
	SanLoss 5;
	PlayerDrink 5;
	now LastDrinkserved is turns;
...
carry out Rumdrinking:
	...
	MultiInfect "Chocolate Lab" repeats 2;
	SanLoss 5;
	PlayerDrink 5;
	now LastDrinkserved is turns;
...
carry out Vodkadrinking:
	...
	MultiInfect "Zebra Stallion" repeats 2;
	SanLoss 5;
	PlayerDrink 5;
	now LastDrinkserved is turns;
...
carry out Tequiladrinking:
	...
	MultiInfect "Malayan Tiger Herm" repeats 2;
	SanLoss 5;
	PlayerDrink 5;
	now LastDrinkserved is turns;
