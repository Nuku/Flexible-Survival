...
instead of conversing the Harold:
	...
	otherwise if level of player >= 9 and hp of Joanna is 92 and joannaharoldtalk is 0:
...
to say haroldmalesex:
	...
	otherwise if remainder after dividing libido of harold by 3 is 0:	[oral]
...
carry out Aledrinking:
	...
	otherwise:
		say "     Harold nods at you as you place your order, pulling a couple of bottles out from behind the bar and mixing your drink with an expert's touch.  It isn't long before he sets a glass of dark black ale in front of you. Raising your glass to Harold, you take a long drink, the smooth ale going down easily as its rich taste fills your mouth.  Draining the glass, you smack your lips in appreciation of the fine brew.  Setting the glass back down on the bar, you grin with amusement as as you note that the canny bartender already has another glass set out on the bar for you.  Saluting him again with your glass, you drink some more of the rich, dark ale as you enjoy the sights of the busy club.  A pleasant buzz starts to set in, even as you realize that your body is beginning to change slightly.  Though, in your mildly inebriated state, it is hard to think why that would be a problem.";
