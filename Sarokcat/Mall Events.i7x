...
Instead of resolving a Captive rat:
	...
	if player consents:
		...
		challenge “Slut Rat”;
		say “after that last fight, you definitely have more questions then answers, maybe you should ask rod or ronda back in the mall about the strange demon[apostrophe]s seed.”;
		stop the action;
	otherwise:
...
Instead of resolving a Strange symbol:
	say “Moving through the sewers, you notice a strange white symbol painted on the wall.  Moving closer to investigate, you note that the symbol almost seems to writhe and move out of the corner of your eyes. Finally getting to where you can stand in front of the symbol, you find you still cant seem to make heads or tails of the strange pattern, though the longer you stare at it the more it seems like you are just on the edge of figuring it out. You blink as you realize your eyes have gone heavy, and your brain feels somewhat fuzzy as well, you can almost swear that you hear dark whispers in the shadows surrounding you. You quickly realize that the strange symbol is doing something to you, and manage to drag yourself away from its fascinating lines and stumble away, feeling much less human then when you started.“;
