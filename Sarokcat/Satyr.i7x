...
to say Satyr attack:
	...
	otherwise if ( "Submissive" is listed in feats of player and a random chance of 1 in 2 succeeds ) or ( "MPreg" is listed in feats of player and a random chance of 1 in 3 succeeds ) or ( "More Anal" is listed in feats of player and a random chance of 1 in 3 succeeds ):
