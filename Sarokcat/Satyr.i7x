...
to say Satyr attack:
	...
	else if ( "Submissive" is listed in feats of player and a random chance of 1 in 2 succeeds and anallevel is not 1) or ( "MPreg" is listed in feats of player and a random chance of 1 in 3 succeeds ) or ( anallevel is 3 and a random chance of 1 in 3 succeeds ):
...
When Play begins:
	...
	now face entry is "rough mostly human-like face, though the goat-like beard, goat horns, and the lusty look filling your eyes show it to truly be a satyr's";[ Face description, format as the text "You have a (your text) face."]
