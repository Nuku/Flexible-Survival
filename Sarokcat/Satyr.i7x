...
to say Satyr attack:
	...
	otherwise if ( "Submissive" is listed in feats of player and a random chance of 1 in 2 succeeds and anallevel is not 1) or ( "MPreg" is listed in feats of player and a random chance of 1 in 3 succeeds ) or ( anallevel is 3 and a random chance of 1 in 3 succeeds ):
