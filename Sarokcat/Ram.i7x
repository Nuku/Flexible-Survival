...
to say subramsex1: [Fuck him]
	...
	if player is dominant:
		...
		say "     Bleating happily, the ram gets into position and presents his ass to you[if anallevel is 3], spreading his wooly cheeks apart for you to see his winking pucker begging to be filled[end if]. You can't help but take a moment to relish in what the once-proud ram has turned into - your ever-loyal bottom boy, desperate to be filled by your seed. With a cheeky grin, you press your cockhead against his tail-hole, putting just enough pressure against it to feel the panting ram's anal ring yielding. Leaning over his prone figure, you ask him how badly he needs your cock, grinning broadly as the only answer is a needy whimper that has him squirming against you. Continuing on like this, you tease the submissive anthro mercilessly, just a hair's breadth away from sinking your length into him, until he is absolutely desperate and begging for you to fuck him. Relenting with a satisfied grunt, you finally plunge into his [if cock length of player > 24]incredibly tight[else if cock length of player > 12]tight[else]loose[end if] backdoor in one swift motion.";
		WaitLineBreak;
		say "     Getting a good grip on his hips, you start to pound his wooly ass hard and fast[if cockname of player is not listed in infections of internallist], your balls slapping against his own each time you hilt inside of him[end if]. It takes little to no time at all before he starts moaning and bleating loudly, pushing back against you needily just like you've come to expect of him. Soon, you feel yourself drawing close to the edge and fucking him in earnest before exploding in a powerful orgasm, [if cock width of player > 20]filling him with your bountiful seed[else]coating his insides with your cum[end if]. After catching your breath, you pull out and [if anallevel is 3 and libido of player > 50]spread his cheeks with your hands so you can lap at your own seed spilling out of the ram's worn hole[else]slap your meat against his worn hole[end if] before moving back a little and stroking the ram's [one of]well-bred[or]cum-dripping[or]freshly fucked[at random] rump, telling him what a good lay he is.";
...
to say subramsex2: [Get blown]
	if rambjvirg is true: [First time]
		...
		if player is dominant:
			...
			say "     Without hesitation, he gets to lapping along the length of your manhood, moaning and bleating softly as he worships your meat. Not needing to be prompted this time, he opens his muzzle and starts to take your cock into [if cock length of player > 7]his throat[else]his maw[end if], hollowing out his cheeks and starting to suck you off in earnest. Unwilling to hold back, you grab onto his horns and start to pull his head down as you fuck his mouth roughly. Moaning, [if cockname of player is not listed in infections of internallist]you feel him start to massage your balls reverentially[else]you feel his hoof-like hands clutch at your ass, pulling you closer[end if] as he takes you deep into [if cock length of player < 7]his mouth[else]his throat[end if].";
			WaitLineBreak;
			say "     Feeling your orgasm closing in, you grip his horns tighter and pull his muzzle flat against you before shooting your [cum load size of player] load down his throat with a loud groan. Satisfied, you pull out of [if cock length of player < 7]his mouth[else]his throat[end if] with a loud slurp. Grinning smugly, you look down at the look of pure bliss on the ram's face and can't help but feel proud at what a good little cocksucker he's turned into.";
		else:
