...
to say Hawkman wins:
	...
	if Player is female or ( anallevel is 3 and a random chance of 2 in 5 succeeds ) or ( player is mpreg_ok and a random chance of 2 in 5 succeeds ):
		if Player is not female and a random chance of 3 in 5 succeeds:
			...
			CreatureSexAftermath "Player" receives "AssFuck" from "Hawkman";
		else:
			...
			CreatureSexAftermath "Player" receives "[if player is female]PussyFuck[else]AssFuck[end if]" from "Hawkman";
		infect "Hawkman Male";
	else:
...
to say HawkmanAssfuck:
	if hawkmanbeaten is odd:
		...
		CreatureSexAftermath "Hawkman" receives "AssFuck" from "Player";
	else:
