...
to say shark attack:
	...
	else if ( ( anallevel is 3 or "MPreg" is listed in feats of Player ) and a random chance of 1 in 2 succeeds ) or Player is not male:
...
When Play begins:
	...
	now cock change entry is "it changes and draws up into your body, tucking itself inside your new protective slit; teasing it out for a minute, you can see it has split into a more forked and prehensile like member, much like a shark's"; [ cock change text. format as "Your cock feels funny as (your text)." ]
	now str entry is 19;
	now dex entry is 13;
	now sta entry is 18;
	now per entry is 12;
	...
	now MilkItem entry is "shark herm milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "shark herm cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
This is the Shark Herm Infection rule:
	if Player has a body of "Shark Herm":
		trigger ending "Shark Herm Infection"; [Here it states, that the ending has been played.]
		if treasurefound is 1:
