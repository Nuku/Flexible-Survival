...
When Play begins:
	...
	now face entry is "beautiful female face, with lovely golden eyes and long flowing hair, the only thing marking it is as different from a normal womans, is the near perfection of your nymph-like";[ Face description, format as the text "Your have a (your text) face."] 
	...
	now cock change entry is "it seems to realize it doesn[apostrophe]t belong on this nymph-like body."; [ cock change text. format as "Your cock feels funny as (your text)" ]
	now str entry is 14;
	now dex entry is 20;
	now sta entry is 14;					
	now per entry is 12;
