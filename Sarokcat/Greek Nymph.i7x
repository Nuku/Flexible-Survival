...
When Play begins:
	...
	now Species Name entry is "Nymph"; [name of the overall species of the infection, used for children, ...]
	...
	now skin entry is "[one of]nymph-like[or]soft and sleek[or]beautiful[at random]"; [ skin Description, format as "Looking at yourself, your body is covered in (your text) skin"]
