...
to say Greek Nymph attack:
	if Player is male:
		...
		if MaleList is not banned, setmonster "Satyr";
	else:
...
When Play begins:
	...
	now Species Name entry is "Nymph"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now face change entry is "it seems to smooth out, and all the tiny, little imperfections vanish, leaving you with a pretty nymph-like countenance and a strange desire to giggle and play"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
	now body change entry is "you become more slim and nimble, your legs lengthening and your body acquiring more feminine curves. You find yourself skipping and dancing along as you move around on your new, slender legs"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	now skin change entry is "any imperfections and changes slowly vanish, leaving you with the soft and rosy skin of a beautiful nymph"; [ Skin change text, format as "Your skin feels funny as [skin change entry]." ]
	now ass change entry is "it tightens up, becoming pleasantly grabbable and tight"; [ Ass/tail change text, format as "Your ass feels funny as [ass change entry]." ]
	...
	now MilkItem entry is "greek nymph milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "greek nymph cum"; [ Item to be given to the player if they have this infection and jerk off. ]
