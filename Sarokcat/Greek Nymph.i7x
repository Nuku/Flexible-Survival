...
When Play begins:
	...
	now face entry is "that of a beautiful female face, with lovely golden eyes and long flowing hair, the only thing marking it is as different from a normal woman's, is the near perfection of your nymph-like";[ Face description, format as the text "You have a (your text) face."]
