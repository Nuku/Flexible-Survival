...
Instead of conversing the Lisa while borisquest is 3:
	say "'Your looking for a what?' Lisa says in surprise, 'Um I don't think we have that brand of condom right now, would another brand suffice?' [line break]";
	say "You explain that you aren't sure if another brand would work the same way, since you aren't sure why or how this brand seems to work to begin with.  'Thats a strange comment,' Lisa says, the mousetaur obviously puzzled, 'Work for what? No look why don't you explain exactly what you need to happen, and I'll see what I can do to help'[line break]";
