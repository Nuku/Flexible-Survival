...
Instead of Resolving a Pachyderm predicament:
	say "Wandering through the zoo, you hear some shouting in the distance, moving closer you find one of the zoo employees, that obviously hasn't succumbed fully to the changes yet. Unfortunately he is stranded in the middle of one of the more open enclosures, on a rock in what appears to be a lake of cum. You blink at the sheer amount of the stuff coating the area, but are distracted by some rough slapping sounds underneath the hoarse cries of the trapped employee. Looking around you are shocked to spot two massive mounds of grey flesh going at it not far away, their sheer size making it hard to recognize them as human-like herm elephants instead of say, small buildings. You find yourself gaping at the ridiculous size of the one on the bottom's cock, then clap your hands to your ears as they both trumpet, the one on top erupting into the one on bottom, and the one on bottom erupting everywhere. The trapped employee moans, as the lake of seed around him rises even higher, the elephant herms take a minute to rest, before switching positions and starting up again. Sadly, you really don't see any way you could reach the employee to help with anything short of a helicopter, and you certainly aren't up to taking on two large foes that size. Shaking your head you move off into the zoo, trying not to shudder at the soon to be elephantine employees cries.";
