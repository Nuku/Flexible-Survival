...
Instead of Resolving a Panda parade:
	say "     Traveling through the zoo, you stop as you see a bearlike, white and black coloured ursine. Tottering down one of the other paths, a zookeeper's hat still sits jauntily atop the very well-endowed panda's head. You back off out of sight of the panda as it trots past, seemingly intent on moving as fast as it can down the path.";
