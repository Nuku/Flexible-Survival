...
Instead of Resolving a Missing lamp:
	say "Wandering the museum hallways, you come across a display showing an ancient cave full of treasure, with a old arabian style lamp displayed in the center.  The strange thing is, someone seems to have broken into the display and taken the lamp instead of the rest of the treasure, you don[']t suppose they believe in the old tale of a genies lamp do you?";
