...
Scent of Museum Foyer is "     The museum smells of ancient things come to life once more.".
...
Description of Museum North Hallway is "     The hallway to the north leads to the northern section of the museum, ending in a hub further ahead. The decoration in this corridor is, up to some point, merely cosmetic, and there is the occasional tapping or creaking sound coming from inside the walls, which is somewhat upsetting. Sometimes, you can see paintings of mythological creatures on the walls, or, at least, of strange and unique animals that probably existed long ago.[line break]".
Scent of Museum North Hallway is "     It smells of old and ancient, still.".
...
Description of Museum East Hallway is "     The hallway to the east leads to the eastern section of the museum, ending in a hub further ahead. It looks severely more empty than the other sections in the museum, and the only sound you can hear is a systematic ticking, resembling that of a large clock, from somewhere unknown. The stillness of the air demands for caution as you walk by.[line break]".
Scent of Museum East Hallway is "     It smells of old and ancient, still.".
...
Description of Museum Greenery is "     South of the Museum Foyer lies this outside section, which includes the entrance to the building upon walking up some large stairs in front of it. In your immediate proximity, you can still see the outside of the eastern and western wings of the museum stretching ahead, and surrounding this area, there is a lot of green due to the natural landscape, untouched by any sort of human construction, and a garden that welcomes any eager visitor who arrives at the front. It all feels quite peaceful, causing a lingering, pleasant temptation to just stay here for a longer while, but you know better than to give in to apparent comfort in times like these.[line break]".
Scent of Museum Greenery is "     This area smells like fresh and clean air, the outside section of the museum feeling much lighter and pleasant on your nostrils.".
...
linkaction of Valerie is "Possible Actions: [link]talk[as]talk Valerie[end link], [link]smell[as]smell Valerie[end link], [link]fuck[as]fuck Valerie[end link][if valtalk > 0], [link]riddle[as]riddle Valerie[end link][end if][if riddlewin > 2], [link]museum rounds[end link][end if][line break]".
Scent of valerie is "     She smells like a sphinx, inscrutable and cryptic.".
...
instead of conversing the Valerie:
	project Figure of Valerie_icon;
	if valtalk is 0:
...
understand "answer riddles/riddle/valerie/sphinx" as riddlesphinxing.
understand "riddle valerie/sphinx" as riddlesphinxing.
understand "play riddles/riddle" as riddlesphinxing.
understand "try riddles/riddle" as riddlesphinxing.
...
carry out riddlesphinxing:
	...
	if diceroll > 15:
		...
		if there is a loot entry and loot entry is not empty and lootchance entry > 0:
