...
When Play begins:
	...
	now face entry is "sexy vulpine face. Your slim, narrow muzzle and bright eyes look perfectly suited to your body, and your pointed canid ears twitch idly at every sound, even as you find yourself grinning happily, enjoying the feeling of your new sexy self";[ Face description, format as the text "Your face is (your text)."]
	now body entry is "sexy and lithe, with small paws and rather dainty claw-tipped hands. Your new vulpine form seems to burn with energy and arousal";[ Body Description, format as the text "Your Body is (your text)"]
	now skin entry is "[one of]pure, white fur that covers your[or]white fur that covers your[or]arctic fox fur that covers your[or]soft fur that covers your[or]thick, white fur that covers your[at random]";[ skin Description, format as the text "You have (your text) skin"]
