...
to say ResolveEvent Strange Wave:
	...
	say "[line break]     [bold type]You should...[roman type][line break]";
...
to say ResolveEvent Dragon Voyeurism:
	...
	say "[line break]     [bold type]It is clearly far too late to intervene, so you're left with options to...[roman type][line break]";
	...
	if Dragon_Voyeurism_Choice is:
		-- "Watch. Live dragon porn is hot!":
			...
			MultiInfect "Feral Sea Dragon" repeats 3;
