...
Instead of resolving a Tainted yacht:
	...
	if player consents:
		...
		say "Searching the ship further could be dangerous, as not all of the creatures may have abandonded ship fully, still you decide to check to see if the boat still runs.   Unfortunately something seems to have flooded the engines, rendering them currently inoperable, moving forward to open the hatchway leading to the engines, you are overcome with the strong scent of musk and sex, making your skin twitch with the first signs of impending change.  Quickly slamming the door shut you realize that an orgy seems to have taken place near the engine room, and whatever the engine is flooded with, trying to clean it out would most likely result in you turning into whatever creature these people became. Quickly abandoning that idea, you go check the food supplies only to find that they like everything else on the ship, are tainted with the results of the boats occupants long orgy. Sighing, you go about gathering up some of the least tainted of the water supplies before heading back to shore, only slightly changed by your experience.";
		add "dirty water" to invent of player;
		add "dirty water" to invent of player;
		add "dirty water" to invent of player;
		infect "sewer gator";
