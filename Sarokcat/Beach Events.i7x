...
to say ResolveEvent Strange Wave:
	...
	say "     [bold type]You should...[roman type]";
...
to say ResolveEvent Dragon Voyeurism:
	...
	say "     [bold type]It is clearly far too late to intervene, so you're left with options to...[roman type]";
