...
To say Tiger loss:
	say "You are superior to the nonexistant random tiger!.'";
...
When Play begins:
	...
	now face entry is "beautiful tigerlike face, its short muzzle and feline eyes giving your features an exotic predatory cast, and your slightly rounded tiger ears complete the look, making it seem like almost the perfect blend of tiger features and human features combined in your ";[Your have a (your text) face."] 
	now body entry is "lean and lined with corded muscle, giving you a somewhat exotic look, as you balance easily on your digigrade tiger paws, your human like hands with their tigerlike claws tipping your fingers complete the look."; [Your Body is (your text)"] 
	...
	now tail entry is "You have a long tigerlike tail extending from just above your ass, lashing back and forth in excitement with every movment.";[ Tail description, write a whole Sentence or leave blank. ] 
