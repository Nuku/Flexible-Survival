...
When Play begins:
	...
	now body entry is "lean and lined with corded muscle, giving you a somewhat exotic look, as you balance easily on your digigrade tiger paws, your human like hands with their tiger-like claws tipping your fingers complete the look."; [Your Body is (your text)"] 
	...
	if bodyname of player is "Tiger":
		...
		otherwise:
			...
			otherwise if "MPreg" is listed in feats of player and lust of Chase > 0:
				...
				say "When your belly starts to swell and you know his seed has caught, he finds it all too easy to convince you to move in with him, and become his tiger slut on a more permanent basis. Soon you are happier then you ever thought possible, as you work hard to please your mate, and to prepare for the cubs that are sure to come soon, and hopefully many more of his strong tiger cubs after that....";
			otherwise:
