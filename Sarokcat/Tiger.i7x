...
"Tiger"	"[PrepCombat_Tiger]"

to say PrepCombat_Tiger:
	setmongender 3;]
...
When Play begins:
	...
	add "Tiger" to infections of FelineList;
	add "Tiger" to infections of FurryList;
	add "Tiger" to infections of NatureList;
	add "Tiger" to infections of MaleList;
	add "Tiger" to infections of BarbedCockList;
	add "Tiger" to infections of SheathedCockList;
	add "Tiger" to infections of BipedalList;
	add "Tiger" to infections of TailList;
	...
	now MilkItem entry is "tiger milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "tiger cum"; [ Item to be given to the player if they have this infection and jerk off. ]
