...
Body Weight of Kara is 3. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Kara is 2. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
Androginity of Kara is 8. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
SleepRhythm of Kara is 0. [0 - awake at all times, 1 - day active, 2 - night active]
Mouth Length of Kara is 5. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Kara is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Kara is 5. [length in inches]
Cock Count of Kara is 1. [number of cocks]
Cock Girth of Kara is 3. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Kara is 8. [length in inches]
...
Asshole Tightness of Kara is 2. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Nipple Count of Kara is 2. [count of nipples]
Breast Size of Kara is 2. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
...
Description of Kara is "     The sexy looking hyena herm you rescued seems to have found a leather jacket somewhere, and a pair of leather boots she has obviously had to customize to fit her new hyena paws. Her mobile hyena ears have a small array of silver and gold hoops and studs in them, and she has several smaller piercings spaced rather sexily across her muzzle. Her soft hyena patterned fur also has several visible designs in it along the arms and her thighs, the ink of her tattoos seeming to have colored the hyena fur as it grew in. Catching you looking at her, the new hyena herm eyes you back curiously, and with not a little bit of lust...[line break]".
...
[	else if matriarchowned is 1:
		...
		if Player is male:
			...
			NPCSexAftermath Kara receives "PussyFuck" from Player;
		else:
			...
			say "     Feeling that she's ready to go now, you climb into the chair atop her, lining up your pussy with her pulsing cock and sinking down onto it. She moans and yips with lustful need, rocking her hips up to thrust into you even as you ride her hard and fast. You grope and squeeze her breasts, pinching her pierced nipples[if Nipple Count of Player > 0 and Breast Size of Player > 0] while her studded tongue laps across yours[end if]. Her pulsing, piercing-studded rod feels wonderful inside you, adding extra stimulation to the already wonderful pleasure a hyena cock can bring. It's good to have a sexy, submissive hyena to use as you'd like - a welcome change from her much more arrogant brethren. Pushing down hard, you force her knot into you [if Cunt Tightness of Player < 4]with some discomfort[else if Cunt Tightness of Player < 7]with a little difficulty[else]easily enough[end if] and clamp down tightly around it. This is enough to send Kara over the edge, pumping her hot load into you and you ride her until she's drained. Once her knot's gone down enough, you pull free and leave her there, panting and reeking of sex.";
			NPCSexAftermath Player receives "PussyFuck" from Kara;
		infect "Hyena Herm";
		now lastfuck of Kara is turns;
...
understand "get Tattoo/Tattooed" as Tattooplayer.
...
carry out Tattooplayer:
	if tatstatus is 0:
		...
		say "     'Hey, back again? Liking your tattoo?' Kara says with a feral grin as she glances at your brightly colored tat. 'I mean, if you want me to remove it, I have the materials to do so, but the scar from doing so would mean you couldn't get another until it healed, and that takes forever...' Kara shrugs slightly before stroking some of her patterned, colorful fur absently. 'So what do you say, happy with your tat? Or do you want it off?' Get your tattoo removed?";
		if Player consents:
			LineBreak;
			now tatsave is 0;
...
understand "get piercing/pierced" as Pierceplayer.
...
An everyturn rule:
	if "NippleandChain Piercing" is listed in feats of Player:
		...
		if a random chance of 1 in 4 succeeds:
			say "[line break]You feel increasingly bestial and aroused due to your sexy piercing. Your nipples and genitals are teased more and more with each step, reminding you of just what a slutty, submissive creature you really are deep down.";
	...
	if "Hyena Tattoo" is listed in feats of Player:
		if a random chance of 1 in 4 succeeds:
			say "[line break]You feel a warm heat spread throughout your body from the strange hyena tattoo Kara gave you. You grin almost ferally, feeling both powerful and horny as increasingly hyena-like instincts and thoughts invade you heat-filled mind.";
