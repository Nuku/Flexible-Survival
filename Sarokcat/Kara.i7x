...
Karaarroused is a number that varies.
...
instead of conversing the Kara:
	if Karatalk is 0:[first time you encounter the npc text]
		...
		stop the action;
	if Karatalk is 1:[Normal short messages the npc will say each time you talk to them]
...
Instead of fucking the Kara:
	if lastKarafucked - turns is less than 6:
		...
		stop the action;
	if Karaarroused is greater than 0:
