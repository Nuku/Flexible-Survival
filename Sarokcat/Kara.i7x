...
Cunt Tightness of Kara is 6. [ Inches circumference. 3:extremely tight, 5:tight, 7:receptive, 10:open, 11+ gaping ]
...
An everyturn rule:
	if "NippleandChain Piercing" is listed in feats of Player:
		...
		if a random number between one and 20 < 6:
			say "You feel increasingly bestial and aroused due to your sexy piercing. Your nipples and genitals are teased more and more with each step, reminding you of just what a slutty, submissive creature you really are deep down.";
