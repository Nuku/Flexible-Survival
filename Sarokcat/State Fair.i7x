...
instead of fucking boris:
	...
	if borisquest is 0:
		...
		stop the action;
	if borisquest is 1:
		say "Sorry, I am still kinda ill equipped for that kinda activity' he says sadly. He seems to perk up however when you tell him about the scene you witnessed in the fair, and thinks about the possibilities.  'Well that sounds interesting,' He says thoughtfully, 'I kinda wondered what was going on there you know, its not like we gave away anatomically correct plush toys either...  Tell you what, if you can help find me something similar I definitely think it would be worth giving it a shot, it sounds like it might hurt a bit, but I[apostrophe]m willing to take the risk, and I would definitely owe you big time.";
		now boristalk is 2;
		stop the action;
	if borisquest is 2:
