...
When Play begins:
	...
	now skin entry is "[one of]leopard spotted[or]leopard furred[or]Black and yellow spotted[or]soft furred[or]short fur covered[at random]"; [ skin Description, format as "You have (your text) skin"]
