...
to say Alpha Husky attack:
	...
	otherwise:
		...
		if hp of player is greater than 1 and sex entry is "Male":
			...
			say "     'I think,' he says as he draws back to the pointed tip, then drives the thick knot of his member into you, 'that I will keep you like this.' The words stop, replaced with a howl of release as he begins to fill your body with hot gushes of seed. Your grasp of your old self feels weak for a moment as strange new adoration for this husky tries to displace it and your body is hit with a powerful climax. By the time you can even see again, the Alpha has departed, leaving you sticky with a reminder of how much better it could be the next time.";
		...
		otherwise if sex entry is "Female":
			...
			say "     'That's right.' He draws away and slides down, lifting one of your [bodytype of player] legs up and sliding up between. His already rock-hard shaft presses up against your back door without preparation. Despite this, he enters as smooth as silk and begins to mate with you in slow, deep motions, rocking you against the ground with soft growls of affection and ownership.";
			...
			say "     Soft but firm paws rub slowly at you, in varying circles that seem to enhance the pressure and pleasure of his dick pressing deep into your bowels, driving you ever faster towards climax as he tenses. The sensations are too intense, as if you should have already cum, but simply cannot, waiting for some que. He locks to you, motions becoming faster, but shorter, as the tight ring of your ass holds firm to his knot, allowing him precious little motion to jerk back and forth. Each pull flashes stars before your eyes in the ever-building intensity.";
			if "Male Preferred" is listed in feats of player:
				say "     He explodes powerfully into you, and your body unwinds along with your mind. Everything melts away as you are washed away in the pleasure of it, unloading yourself entirely in his caring grasp. This time he waits for you and kisses you once before he departs. 'Just think how much nicer it'll be once you've properly accepted your place as my needy [if cocks of player > 0]male[otherwise]neuter[end if] bitch.'";
			otherwise:
...
To say Alpha Husky loss:
	...
	otherwise:
		if losttoalphahusky >= 2:	[lost at least twice]
			say "     Having been beaten and abused by these male huskies a few times in the past, you growl as you beat him and push him down before he can get away.  He makes some snaps at you and tries to pull free, but you've got him.  Shall you take this opportunity to get a little payback?";
			caughtthealphahusky;
...
When Play begins:
	...
	now tail entry is "You have a [if latexhuskymode is true]curved husky tail made of smooth latex[otherwise]long and fluffy husky tail swaying happily behind you[end if].";
	...
	now body change entry is "[if latexhuskymode is true]your arms and legs grow malleable and turn into doggy legs for your increasingly canine body.  Soon enough you're back to the quadrupedal husky form you had earlier.  It will be a struggle to stand or use your hands now, but being a doggy feels so much better anyhow[otherwise]it vibrates with increasing pleasure, your legs bending and twisting into a proper digitigrade form with soft snapping sounds as the bones flow and change. You look down to see your feet becoming entirely paw-like, even as your hands shift and change as well to become almost as paw-like, barely able to still handle your equipment[end if]";
