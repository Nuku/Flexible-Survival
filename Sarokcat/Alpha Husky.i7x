...
to say Alpha Husky Desc:
	if Resolution of MtFHuskyAlpha < 99 and Player is not MalePreferred and a random chance of 4 in 10 succeeds:
		...
		if MtFHuskyAlphaActive is true, now MtFHuskyAlphaActive is false;

to say Alpha Husky attack:
	project the Figure of HuskyAlpha_hard_icon;
	if MtFHuskyAlphaActive is true and Resolution of MtFHuskyAlpha < 99:
		...
		if inafight is 1, increase losttoalphahusky by 1;
		if Player is female:
			...
			if HP of Player > 1: [submits]
				say "     The alpha stands over you as you cower before him in submission, falling to your knees and leaving yourself to whatever fate he decides. 'What, you're giving up? Or what...' he then begins to wonder to himself as he sees you all so eager to do anything for him. 'You're not suited to be a bitch, but then again... [if Player is MalePreferred][italic type]I don't really mind a good boy.[roman type] You might just become my favorite little bitch male[else]I don't think that has to be a problem. There are ways to fix that[end if].'";
				WaitLineBreak;
				if a random chance of 1 in 2 succeeds: [for now, there are only 2 possible scenes. This is one, oral+anal]
					...
					WaitLineBreak;
					say "     As he holds you close like that, everything begins to melt away as you are washed in the pleasure of it all, letting yourself be taken into his caring grasp. The husky turns to kiss you once, then lick your face another time, as his stubborn knot takes its time to shrink. 'Mmh... Just think how much nicer [if Player is MalePreferred]it'll be once you've properly accepted your place as my little male bitch. Taking care of your alpha's needs and earning yourself all the appreciation only a good boy like you deserves[else]it will be once you give in and be a proper bitch for me. A beautiful husky bitch to take care of her alpha's needs, in return earning a fill of hot and warm seed... We could keep doing it all day... Everyday[end if]...'";
				...
				if inafight is 1:
					...
					if humanity of Player < 10:
						...
						if "Strong Psyche" is listed in feats of Player: [total sanity recovery]
							say "     [if Player is MalePreferred]Truly he would not have minded to keep you around despite your sex, but you do mind being completely subservient. You easily shrug off any of the mind effects the husky has had on[else]Much less having him completely change your gender to meet the [']suitable requirements['] to become his bitch. Well, infections work in twisted aways, but at least when it comes to your mind, you still have it all in[end if] you.";
							SanBoost 5;
						else if "Weak Psyche" is listed in feats of Player: [faster decline]
							say "     Nah, stop tricking yourself. You definitely want more of that. Where is he now? Oh, he seems to have disappeared already... Damn it! Your mind aches for more... more of those sweet words, that throbbing cock in you, more of that seed filling you up. The heat... it is so exhilarating, so ecstatic... You are left craving to [if Player is MalePreferred]become his special, favorite male bitch, his good little boy, just like he said[else]let him turn you into his perfect bitch, there to serve him in every time of need, bearing his pups[end if]... But now it is too late, so you are left with no other option but to come to terms with your still barely retained freedom and make the most of it while it lasts.";
							SanLoss 5;
						else: [no further sanity changes]
							say "     But how bad would it be to give in [']just a little[']? [if Player is MalePreferred]He said you could be his favorite little male bitch, because nobody takes that spot. It would be only yours[else]Maybe it would not be so bad to let him do all those things to your body, turn you into the perfect bitch[end if] and... And that is absurd! You cannot do this. This... may require some distancing. You proceed to ready yourself to carry on with your doings and avoid thinking on the subject, at least as much.";
				...
				if inafight is 1, now infectbypass is true;
	...
	if fightoutcome >= 10 and fightoutcome <= 19:
		...
		if Player is not submissive:
			...
			if humanity of Player > 60 or Libido of Player < 50:
				...
				if Player is male:
					say "     [if Cock Count of Player > 1]Your multiple hanging wangs draw two of the huskies. They go for them directly, licking and slurping at them like they were a fine treat. Those wet tongues tease and excite you, barely allowing you to even see your crotch because of their eager snouts pressed against you. Behind them, their tails are wagging fiercely with delight. Another husky, looking left out, circles about[else]You feel a nuzzling at your groin and see a husky softly shoving his snout between your thighs. His wet tongue trails out across your [Cock of Player] member, admiring its [cock size desc of Player] girth and stature. His cold nose brushes against your [Ball Size Adjective of Player] nuts, and you jump, just in time for another husky to circle around[end if] you.";
				else:
...
to say alpha huskypack lost:
	if HP of Player < 1:
		say "     The pack laughs and cheers as you submit to their superior numbers. They push you over, and suddenly, your mouth is full of dog cock as one sits down on you, shoving his member into you and starting to rut eagerly with reckless abandon[if number of owned temporary grab objects > 0]. You feel another husky rifling through your pockets. Are they mugging you? It seems so, as one gives a delighted bark and dashes off with something of yours, bringing it to the alpha husky to admire[end if]. You try to voice complaint, but can only get out a muffled whine around the cock filling you. The horny dog straddling your face howls, filling you with salty dog cum and forcing himself forward. Your jaw hurts as the knot is forced past it, leaving you tied to the lusty canine.";
		...
		CreatureSexAftermath "Player" receives "OralCock" from "Husky Alpha";
		if number of owned temporary grab objects > 0:
			let z be a random owned temporary grab object;
			ItemLoss z by 1;
		...
		if Player is female:
			say "     A wet, slippery, canine tongue delves up into your cunt, lapping at your [bodytype of Player] sex as they tease at your clit with claw tips carefully. Your sex sings with forced pleasure as the dogs work diligently to bring you to delirious heights.";
		...
		if Player is female:
			CreatureSexAftermath "Husky Alpha" receives "OralPussy" from "Player";
...
to say Alpha Husky loss:
	if SarahSlut > 3:
		...
		say "[line break]     [bold type]Do you take him up on his offer?[roman type][line break]";
		...
		if Player consents:
			...
			MultiInfect "Husky Alpha" repeats 2;
	...
	if bradfordBountyNum is 4:
		if bradfordbounty > 0:
			...
			say "[line break]     This encounter reminds you of your deal with bounty hunter Bradford. You should go see him about getting your share of the reward.";
...
to say AlphaHuskyRidden:
	...
	CreatureSexAftermath "Player" receives "[if Player is female]Pussy[else]AssFuck" from "Husky Alpha";
...
Section 2 - MtF-Focused Husky Alpha variant
...
to HuskyAlphaMtF1Continued:
	...
	say "     'This is what a real male is like... Owning bitches like you and fucking their brains out...' The alpha male then surprises you as he takes hold of your [Cock of Player] cock, dangling hard under you and between your legs, squeezing it tight and making you flinch in reflex [if Cock Length of Player >= 7 and Cock Length of Player <= 10]. 'And look at this... not a bad one, if you knew how to use it. But you're just not made to be like me. Might as well have a clit in its place, right? You have no need for a cock unless it's inside you... hehe[else if Cock Length of Player > 10]. 'And have a look at this! Quite an impressive meat... Almost makes me feel bad for getting rid of it, but then again... it's such a waste on a bitch like you. You could never hope to know how to use it... It's just not in you, right? You'd rather actually have it [italic type]in[roman type] you... hehe[else if Cock Length of Player < 7]. 'And what's this? Guess you were already half-way there to go full female with a cock this tiny. More like a clit, by now. It's adorable, even... Look at how hard it throbbed when I called it a clit... It really wants to be one, eh? Don't worry, it's doing a good job, so far[end if]...' As the husky taunts you, he continues to thrust into you, fucking you deep, but slowly, at first.";
	WaitLineBreak;
...
to say HuskyAlphaMtF2: [subsequent times]
	say "     [if HP of Player > 1]Seeing this alpha male in front of you, there is no way you can resist him. You immediately drop to your knees as he approaches you[else]You attempted to resist him this time, but he is just too powerful. He takes you down without breaking a sweat, unfazed by your futile attempt at fighting back[end if]...";
	say "     'Hey there, slut. Missed me?' he asks, with the biggest grin on his muzzle, standing in front of you with a raging hard-on that keeps on throbbing every other second. 'Hope you haven't been fooling around with that other husky dude. You belong to this alpha only. Now... show me how that body's going,' he commands, and you have no other choice but to obey him...";
	WaitLineBreak;
	if Player is male:
...
to say PrepCombat_Husky Alpha:
	...
	now MtFHuskyAlphaActive is false;
	remove "Husky Alpha" from infections of VoreExclusion, if present;
	remove "Husky Alpha" from infections of HardVoreExclusion, if present;
...
Scent of husky alpha fur is "The fur has a pleasing, not too strong, animal-like scent.".
