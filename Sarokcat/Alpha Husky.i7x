		...
		if Player is female:
			...
			if HP of Player > 1: [submits]
				...
				if Player is MalePreferred:
					say "... I [italic type]don't really mind a good boy.[roman type] You might just become my favorite little bitch male.' [line break]";
				else:
...
to say Alpha Husky Desc:
	if Player is male and Player is not female and Resolution of MtFHuskyAlpha is 0 and Player is not MalePreferred and a random chance of 4 in 10 succeeds: [fully male, not herm, 1st time]
		now MtFHuskyAlphaActive is true;
		say "[HuskyAlphaMtFdesc1]";
	else if Resolution of MtFHuskyAlpha > 0 and Resolution of MtFHuskyAlpha < 99 and Player is not MalePreferred and a random chance of 4 in 10 succeeds: [fully male, not herm, subsequent times]
		now MtFHuskyAlphaActive is true;
