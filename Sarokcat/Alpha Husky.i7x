...
When Play begins:
	...
	now body entry is "[if latexhuskymode is true]that of a quadrupedal dog with paw-like feet and hands[else]that of a bipedal canine, very much resembling that of a male husky, with digitigrade legs ending in soft powerful paws, and extremely paw-like hands[end if]";
	now skin entry is "[if latexhuskymode is true]smooth and shiny latex of black and white for[else][one of]soft furred[or]husky furred[at random][end if]";
	...
	now face change entry is "[if latexhuskymode is true]it reflows into the smooth, husky head you had before. Your long, rubbery tongue hangs from your mouth, dripping with oily drool[else]it tingles and draws forward, pushing out into a proper canine muzzle, your newly elongated tongue slipping free of your new lips and lolling wetly in the air for a minute[end if]";
	now body change entry is "[if latexhuskymode is true]your arms and legs grow malleable and turn into doggy legs for your increasingly canine body. Soon enough you're back to the quadrupedal husky form you had earlier. It will be a struggle to stand or use your hands now, but being a doggy feels so much better anyhow[else]it vibrates with increasing pleasure, your legs bending and twisting into a proper digitigrade form with soft snapping sounds as the bones flow and change. You look down to see your feet becoming entirely paw-like, even as your hands shift and change as well to become almost as paw-like, barely able to still handle your equipment[end if]";
	now skin change entry is "[if latexhuskymode is true]your skin flows, turning a glossy black and white, flowing around as it becomes a layer of latex in a husky pattern[else]it vibrates with odd pleasure as your skin prickles from your head to your toes as fur begins to push through from underneath, soon covering you in a soft, almost comforting, layer of fluffy white husky fur[end if]";
	now ass change entry is "[if latexhuskymode is true]a long, inflated tail balloons from your behind. It curves and wags, perpetually raised to show off your groin and butt[else]your ass vibrates with sensual pleasure as a long tail canine tail pushes out from your spine, lifting up in a stiff curve as it begins to sway slowly behind you without any conscious input[end if]";
