...
to say Alpha Husky attack:
	...
	otherwise:
		...
		if hp of player is greater than 1 and sex entry is "Male":
			...
			say "     'I think,' He says as he draws back to the pointed tip, then drives the thick knot of his member into you, 'That I will keep you like this.' The words stop, replaced with a howl of release as he begins to fill your body with hot gushes of seed. Your grasp of your old self feels weak for a moment as strange new adoration for this husky tries to displace it and your body is with a powerful climax. By the time you can even see again, the Alpha has departed, leaving you sticky with a reminder of how much better it could be the next time.";
