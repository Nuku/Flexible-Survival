	...
	otherwise:
		...
		otherwise:
			...
			if player consents:
				...
				attempttowait;
				say "     Following Mary into the dimly lit building, you realize someone has gone to some effort to keep it looking abandoned, but out of sight of the front windows it has actually been furnished as a nice little hideaway.  Mary is standing there blushing again as she admits 'I found this place a while back, and I cleaned it up for when i needed to get away from the rest of the flock. You[apostrophe]re the only other person who knows about it now.' Before you can respond to her surprising statement, she reaches up and kisses you again, taking her time to rub her sheep-like muzzle along your [facename of player] face, and exploring your mouth with her tongue.";
...
Instead of fucking the Leon:
	...
	say "     Leon looks up from what he was doing as you approach and smiles, 'I can tell what you want, just head on back to the back room and I'll be right there' he says as he calls over one of the other ewe's to finish what he was doing.  Shuddering in anticipation you find yourself heading through the doorway as your ram suggested, unable to disobey.";
	attempttowait;
		...
		otherwise:
			...
			if the player consents:
				...
				if ( lust of leon / 2 ) is odd:
					...
					say "     Leon grabs your chin roughly and squeezes it firmly.  'You're being too loud.  Do you want the rest of the staff to know you're being disciplined?'  And while there is a kinky rush of excitement at the thought of all the other ewes knowing you're getting punished, Leon doesn't give you a chance to respond, instead forcing a ball gag into your mouth.  It proves to be quite effective when he gives you a hard lashing with the leather paddle across your back.  Satisfied that you're cries are muffled, he strides around you, letting the paddle drag across your [bodytype of player] body, striking you from time to time on various parts of your person.";
					attempttowait;
				...
				otherwise:
					...
					say "     As the powerful ram drives his cock into your mouth again and again, he's constantly reminding you that you're place is here as one of his ewes.  And you respond to your punishment like a good ewe by sucking at his cock all the harder, eventually earning your reward as he cums with a loud bleat, blasting shot after shot of hot, musky semen into your mouth and down your throat.  As you swallow it all down, the excitement of it all sends you over the edge as well, your [cock of player] penis releasing your load even as Leon lashes your ass all the harder for it.";
