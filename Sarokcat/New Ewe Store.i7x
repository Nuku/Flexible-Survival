Version 2 of New Ewe Store by Sarokcat begins here.
[Version 2 - Better tracking for saving, events open/close as needed]
...
Instead of resolving Littlelostlamb:
	If nes is 2:
		...
		if diceroll is greater than 14:
			...
			if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
			say "'You did it! Thank you so much!' Mary exclaims exuberantly.  She quickly grabs you in her excitement and plants a big kiss on your lips in thanks, before backing up slightly, her muzzle heating up slightly as she blushes in embarrassment. 'Um. Well, sorry about that...  I know the way from here and um, thank you very much again.' She stammers slightly as she reaches for her bag, pausing for a second she pulls out a few cans of soda and puts them down.  'Um, Here. Just a small way of expressing my gratitude for your help. You should really stop by the store sometime though, so I can thank you properly' Her woolly face hot with embarrassment she then flees before you can respond.  Touching your lips slightly and thinking about the kiss, you think stopping by the store again might not be such a bad idea after all....";
			increase nes by 1;
