...
to say pimp attack:
	if ( HP of Player > 0 or Player is submissive ) and Player is female and a random chance of 3 in 5 succeeds:		[vaginal - submit/sub only]
		...
		CreatureSexAftermath "Player" receives "OralCock" from "Human Hybrid";
	else:		[oral - any]
