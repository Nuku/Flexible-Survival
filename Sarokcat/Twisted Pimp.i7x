...
When Play begins:
	...
	now tail entry is "You have a short nub of a tail, which isn[apostrophe]t directly obvious until someone examines your fine ass closely, your tail almost seeming to change shape and length slightly the more you are around certain types of beasts, almost as if inviting them to come use your sexy ass... ";[ Tail description, write a whole Sentence or leave blank. ] 
	...
	now body change entry is "it seems to shift and change, becoming thinner and sexier by the second, small beastial traits appearing on your new humanlike form, which only seem to make you look sexier and more exotic as your body finishes changing."; [ body change text. format as "Your body feels funny as (your text)" ]
	now skin change entry is "it seems to shift and change, smoothing out into soft and sensitive human skin, but still seeming slightly beastial, as your body hair takes on the appearance of soft fur, and a few small patches of shimmering white scales catch the light teasingly"; [ skin change text. format as "Your skin feels funny as (your text)" ]
