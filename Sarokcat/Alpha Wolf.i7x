...
[ Version 2.3 - Added inasituation skips to the file - Gherod]
		...
		while sextablerun is 0:
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if Player consents:
					...
					if a random chance of AlphaWolfBeaten in 20 succeeds, now AlphaWolfReplaced is true;
				else:
...
to say AlphaWolfSex2: [ride the wolf]
	...
	CreatureSexAftermath "Player" receives "[if Player is female]Pussy[else]Ass[end if]Fuck" from "Alpha Wolf";
	let targetnum be 16;
	if Ball Size of Player > 3, decrease targetnum by Ball Size of Player - 3;
	if a random chance of AlphaWolfBeaten in targetnum succeeds, now AlphaWolfReplaced is true;
	LibidoLoss 15;

to say AlphaWolfSex3:
	...
	if Player is herm:
		...
		say "     After a very enjoyable blowjob from the beaten male, you grip his head firmly and shove your cock fully into his maw. You cum hard with a groan of pleasure, blasting your thick seed down his throat[if Ball Size of Player >= 5]. Your large load fills his muzzle and overflows from it even as much of it is forced into his belly[end if]. After your first several shots, you pull out, letting the rest of your load spray across his face and muzzle. Looking down, you can see the wolf's cock is hard and leaking from arousal at what he's been made to do, and you make certain to tease the wolf about that as well.";
		CreatureSexAftermath "Alpha Wolf" receives "OralCock" from "Player";
	else:
...
When Play begins:
	...
	add "Alpha Wolf" to infections of MaleList;
	add "Alpha Wolf" to infections of TaperedCockList;
	add "Alpha Wolf" to infections of KnottedCockList;
	add "Alpha Wolf" to infections of SheathedCockList;
	...
	now face change entry is "it stretches out into a large lupine muzzle, new scents filling your mind as your nose works overtime, especially hoping to catch the scent of the strong alpha who changed you"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
...
Scent of alpha wolf fur is "The fur has a pleasing, not too strong, animal-like scent.".
