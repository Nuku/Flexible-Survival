...
to say AngieSex3:  [herm sex with Angie]
	...
	otherwise if AngieAroused is 50:   [Midnight present]
		...
		if player consents:
			...
			say "     The herm panther woman yowls in pleasure and runs her hands over the panther under her, even pulling Midnight's muzzle to her own for a deep kiss as she moves eagerly between the two of you. The sight of the formerly reluctant zookeeper giving herself over so completely to the pleasures of her new form only excites you even more, and you groan as you thrust into her body with increased vigor. Lust fills your mind as Angie writhes between your bodies, her soft fur pressing up against your chest even as her tail rubs up against your side and her tight pussy gripping your cock tightly with every wonderful thrust into the pantheress's body.";
			say "     [WaitLineBreak]";
...
to say AngiePTFun:
	...
	if AngieAroused is 50:  [midnight is there]
		...
		if cocks of player is greater than 0:
			...
			say "     [WaitLineBreak]";
			say "     Midnight, not to be outdone, begins to pull you back more urgently as he grinds his sheath against your rump, tail arched up over his back as he pistons gracefully in time with your withdrawals from Angie, pushing you between being surrounded by wet heat and having the feral beast's firmness sunk deep inside your sensitive body. It starts to feel like too much, the tension growing higher and higher before it breaks like a dam before the flood. You fill Angie's waiting cunt with seed as your cock barbs dig into the sensitive flesh, holding you still for a moment. The sensation of your fluttering passage around Midnight's shaft pushes him to the edge and his teeth find your back, nipping harshly even as he buries to the hilt and begins to fill you with thick blasts of his feline cream.[impregchance]";
