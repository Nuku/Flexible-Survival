...
When Play begins:
	...
	now skin entry is "[one of]black furred[or]black fur with purple tints covers your[or]dark-furred[or]panther-like[at random]"; [ skin Description, format as "Your body is covered in (your text) skin"]
