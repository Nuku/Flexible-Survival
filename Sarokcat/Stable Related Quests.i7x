		...
		if Recoveredhardware is 1:
			...
			if lost is 0:
				...
				if lost is 0:
					...
					challenge "Hermaphrodite Gryphon";
					if lost is 0:
						say "Looking around after the aerial assault is over, you realize that the horsemen have rather efficiently finished their looting, and are waiting there to head out with hand carts piled high with tools and equipment, and several horsemen rather enthusiastically (if poorly) driving some heavily laden forklifts, at least one of which seems to be loaded with a massive generator of some kind. As you look over the situation and find the leader of the horsemen looking at you, you certainly realize that they can[']t actually fight themselves while so heavily laden with equipment, and it is up to you once again to deal with the creatures outside and lead them off while the equines make their way back to the Stables with their new loot. Sighing slightly, you patch your wounds the best you can, and prepare to lead the creatures off, only to be stopped by the head of the horsemen as he grasps your elbow and hands you a rather well balanced sledgehammer, 'Found this in there, and thought you could probably use it better than we could, and you[']ve been doing a pretty impressive job so far I have to admit, I can see why Fancy likes you,' He says with an awkward smile and a slap on your back before he goes back to organizing the rest of the horses. You find yourself smiling and feeling a bit more confident as you take a few swings of your new weapon, before tucking it through one of the straps on your pack, and dropping down outside of the fort to lead the remaining creatures away.";
						let bonus be (( the Dexterity of the player minus 10 ) divided by 2);
						let diceroll be a random number from 1 to 20;
						say "You roll 1d20([diceroll])+[bonus]: [diceroll + bonus], ";
						increase diceroll by bonus;
