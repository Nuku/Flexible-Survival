...
to say Plush Lion attack:
	...
	if scalevalue of Player <= 3 and vorelevel is not 1 and a random chance of 1 in 4 succeeds:
		...
		if Player is not neuter:
			CreatureSexAftermath "Plush Lion" receives "[if Player is herm and a random chance of 1 in 2 succeeds]OralPussy[else if Player is herm]OralCock[else if Player is female]OralPussy[else]OralCock[end if]" from "Player";
		plushlionvored;
