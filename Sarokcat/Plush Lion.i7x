...
When Play begins:
	...
	now body entry is "Sleek and soft, you have a the body of a soft plush lioness, its sleek enticing lines advertising your readiness to one and all, your arms and legs are more pawlike and lionlike then human at this point, and walking on two legs can only be accomplished with some effort, for some reason that seems ok though as being on all fours seems to excite you and make you feel even more like a submissive lioness."; [Your Body is (your text)"] 
	...
	if bodyname of player is "Plush lion":
		if humanity of player is less than 10:
			if hp of Sven > 7 and hp of Sven < 50:
				...
				if hp of Sven is 10:
					say "     Candy is not idle during these times, chasing after the lovely skiers on the slopes and dignified gentry in the towns, skillfully enticing them into some fun with the pink coon.  He spends many a night cuddling up to you, describing his exploits of the day, telling you of every quick blowjob or fuck in a shadowy corner he's had in graphic detail and fully rated against the others.  You get to enjoy particularly good shows when he manages to bring a few guys back to the room to play with the sexy, colourful raccoon and snowmeow.  The three of you live a wonderfully decadent lifestyle of sex and priviledge, spreading your three infections across Europe as countless travellers and hotel workers are infected and turned into more sexy lovers.";
