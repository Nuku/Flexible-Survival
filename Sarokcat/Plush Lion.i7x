...
to say Plush Lion attack:
	...
	if scalevalue of Player <= 3 and vorelevel is not 1 and a random chance of 1 in 4 succeeds:
		...
		if Player is female and (Player is not male or a random chance of 1 in 2 succeeds):
		...
		if humanity of Player >= 10 or inasituation is true:
			...
			turn the Player into a "Plush Lion" silently;
...
To say Plush Lion loss:
	...
	if plionvic < 3 or Player is neuter:
		...
		if Player is male:
			...
			now description entry is "Get a plush blowjob";
		[]
		if Player is female:
			[
			choose a blank row in table of fucking options;
...
When Play begins:
	...
	now Species Name entry is "Plushie"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now face change entry is "you feel it push forward into a soft lioness muzzle, you can feel your thoughts grow fuzzy as your head and face fill up with soft fluff, most of your remaining thoughts focused on seeing the strong male lion toy again"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
	now body change entry is "it shifts and changes, your insides churning as they become mostly unnecessary as your body fills up with soft stuffing. Your legs drawing up under your body even as your hands seem to flatten out into large plush paws, making you realize you would feel almost more comfortable on four feet now than on two feet, just like a proper lioness should be"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	now skin change entry is "your flesh tingles as it is covered in soft golden fabric fur"; [ Skin change text, format as "Your skin feels funny as [skin change entry]." ]
	now ass change entry is "a long lioness tail slowly extends from your rear, the strange pleasant sensations of the new limb causing you to lash it back and forth as it grows in; moaning a bit at the feel of a soft tuft of fur growing at the end signals your new fabric attachment is complete"; [ Ass/tail change text, format as "Your ass feels funny as [ass change entry]." ]
	now cock change entry is "it shifts and seems to draw up closer to your belly as a sheath attaches itself to your body, drawing your new barbed cock up into it"; [ cock change text. format as "Your cock feels funny as (your text)." ]
	now str entry is 20;
	now dex entry is 17;
	now sta entry is 15;
	now per entry is 14;
	...
	now MilkItem entry is "plush lion milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "plush lion cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	...
	if Player has a body of "Plush Lion":
		...
		if humanity of Player < 10:
			if HP of Sven > 7 and HP of Sven < 30:
				...
				say "     Upon his release, [if HP of Sven is 10]Sven and Candy travel[else]Sven travels[end if] back to Europe. His family, rather well-to-do and unpleased by what has become of a son they've never shown much attention to in the past, set Sven up with a sizable trust fund so that he may do what he pleases as long as it's somewhere else. Sven takes to traveling across Northern Europe, enjoying the majestic landscape and cold climate[if HP of Sven is 10]. Candy joins him on this life of freedom and lack of responsibilities[end if]. Under your guidance[if HP of Sven is 10] and Candy's encouragement[end if], he enjoys sharing his bed with as many sexy people, both men and women, that he can entice into his bed with his alluring, sexy body. You get to enjoy watching all of these shows, silently enjoying your pet's lustful escapades and then using his body once they have left. Sometimes you even join them on the bed, slaking your lusts on the surprised lover and turning them into another plush lion or lioness, who will then be left in the hotel room or somewhere else for some unsuspecting soul to find. You imagine so many scenes of people these plush lions and lionesses will enjoy. Such as the maid service being mounted by a plush lion they found left in the room. Or a guest waking in the middle of the night to find themselves making love to the plush kitty they thought merely another decoration in the chalet. Or someone receiving a giant plush sent from their lover only to discover that it is their lover, now transformed into a lusty feline sextoy[if Player is male and Player is not sterile]. The very best of them are made into plush lionesses and kept at Sven's personal chalet for you to mate with between your travels, breeding more soft, plushtoy life in their wombs[end if].";
				if HP of Sven is 10:
			...
			[else if HP of Sven >= 30 and HP of Sven < 50:
				...
				say "     Finally your mind snaps, and you find yourself giving in to what you know is just so right. You quickly run off into the night, and before you know it you have found your way back to the stuffed lion who changed your life with his magnificent dominance. You are worried at first, finding him surrounded by several other stuffed lionesses, but your worries are soon put to rest as he welcomes you into his plush pride, taking you in front of the others and filling your belly with his offspring immediately. You are happy to be accepted, and soon realize that any plush beast this magnificent obviously needs a large pride to serve his every need and slake his powerful lusts, and as one of his lionesses it is obviously your job to help him acquire it. So once he has led you safely outside the city, you and the other lionesses go about ensuring that his pride grows ever larger, ambushing unsuspecting people and dragging them off to your pride leader for induction into the plush pride[if Player is not sterile]. During your time in the pride you soon become one of the wonderful lion's favorites, and you bear him many plush little children, the females joining the pride eventually. While the males are sent out while they are still small, cute, and fluffy to grow up with human children as their toy companions, and to eventually start prides of their own with their former human companions turned into submissive plush lionesses[end if].";
			else:
			...
			say "     Rescued with your mind intact, your strange changed body makes many people nervous, eventually though you find a job that suits your new form and your new strong maternal instincts the lion toy instilled into you. You end up making a wonderful kindergarten teacher, playing with and teaching the little children, although you sometimes find yourself thinking of them as cubs instead. You love it when they hug your plush stuffing filled form, and they seem to love doing so. The children work hard to please you, making it a rewarding life[if HP of Sven > 7 and HP of Sven < 50]. One day, you do hear about a strange pride of plush lion animals out to the west and briefly wonder about going to look for yourself, but you have your sexy snowmeow pet at home to keep you company[else], although one day you hear about a strange pride of plush lion animals out to the west, and wonder about going to look for yourself[end if].";
