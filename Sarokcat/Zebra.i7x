...
When Play begins:
	...
	now face entry is "Long zebralike muzzle on your otherwise mostly humanioid face, your ears have lengthend and swivel constantly above your head as they search for danger. Your eyes still stare with human emotion out of your partially zebra "; [Your have a (your text) face."] 
	...
	now tail entry is "You have a whiplike zebra tail hanging off your tight powerful ass, long coarse black hairs extending from part of the sides of the tail, and from the tip, extending its length almost to the ground as it swishes behind you.";[ Tail description, write a whole Sentence or leave blank. ] 
	...
	now face change entry is "you feel it stretch forward into a proper zebralike muzzle, your teeth flattening and your nose expanding to take in the new scents around you, your ears stretch painfully as they are tugged upwards to rest on top of your head, and your skin shortens and draws back into a black zebralike mane.  Soon the only difference between your face and that of a normal zebra, is a slightly humanlike cast to your features, and your strangely human eyes staring out at the world through a new face."; [ face change text. format as "Your face feels funny as (your text)" ]
	now body change entry is "Your chest thickens and stretches into a more zebra like barrel, as your legs shift and thicken into a more digigrade stance, your feet rounding out into rough hooves underneath you. Your arms thicken with new muscle, as your fingers seem to flow and merge, leaving you with only 3 fingers and a thumb on each hand, their tips covered in thick black nails, giving your hands a strong hooflike appearance.."; [ body change text. format as "Your body feels funny as (your text)" ]
	...
	now ass change entry is "your ass firms up, and you feel a sharp stretching sensation as a thin whiplike zebra tail pushes its way out from above your ass, and a sharp short shock of pain as strands of thick zebra hair explode out of the sides and the tip."; [ ass/tail change text. format as "Your ass feels funny as (your text)" ]
