	...
	if Player is not in Garden View: [regular summoning]
		...
		if ( tempnum is 0 or tempnum is 1 ) and T is 1:
			...
			if T is 0:
				...
				say "     [if GryphonessKnowpreg is 1]As Denise rubs her body against yours, you can't help but notice that her pregnant belly is gone. Back to her more slender self, she does have a larger pair of breasts. They are filled with milk for the cute gryphlet you see landing moments after. She comes running up to you both, joining in the hug. Your herm gryphon child is a cute version of Denise in miniature, with blue feathers and golden fur. She has a pretty face and a happy smile, just like her mother. You can't help but feel happy and proud at the sight of her[else]Moments after Denise lands, a small gryphon child lands nearby. She is much like the other gryphons you've seen, but much younger in appearance. You are put on your guard, but Denise only smiles and hugs you before running up and gathering the child into her arms and bringing her to you. It seems you'd knocked up the gryphoness and she went through her pregnancy and had her child in the short time you two were separated[end if].";
			else if T is 1:
				increase weapon damage of gryphoness by 1;
				say "     [if GryphonessKnowpreg is 1]As Denise rubs her body against yours, you can't help but notice that her pregnant belly is gone. Back to her more slender self again, you look over and spot a second gryphlet landing alongside her older sibling. The pair of them run over, joining in the hug. This second herm gryphon child is again Denise in miniature, roughly the size of the first one at her age. She has a pretty face and a happy smile, just like her mother. You can't help but feel happy and proud at the sight of her[else]Moments after Denise lands, your maturing gryphon child lands alongside another, younger one. It seems that Denise had another child while you were separated. She is a cute, younger version of her sister. The two herm siblings come up and hug their parents[end if].";
			else if T is 2:
				increase dexterity of gryphoness by 1;
				say "     [if GryphonessKnowpreg is 1]As Denise rubs her body against yours, you can't help but notice that her pregnant belly is gone. Back to her more slender self again, you look over and spot a trio of young gryphons landing nearby. They run over, joining in the hug. The new child looks much like her siblings did at that age, a cute version of Denise in miniature[else]Moments after Denise lands, your gryphon children land nearby accompanied by another new sibling. The new gryphlet looks much like her siblings did at that age, a younger version of Denise. It seems that Denise had another child while you were separated. She is a cute, younger version of her sister. With a happy squawk, the herm siblings run over, joining in their parents['] hug[end if]. The eldest sibling, now almost fully adult, snugs you all tightly and nuzzles before heading off into the city to seek her fortune and a loving mate of her own.";
			else:
				say "     [if GryphonessKnowpreg is 1]As Denise rubs her body against yours, you can't help but notice that her pregnant belly is gone. Back to her more slender self again, you look over and spot a trio young gryphons landing nearby. They run over, joining in the hug. The new child looks much like her siblings did at that age, a cute version of Denise in miniature[else]Moments after Denise lands, your gryphon children land nearby accompanied by another new sibling. The new gryphlet looks much like her siblings did at that age, a younger version of Denise. It seems that Denise had another child while you were separated. She is a cute, younger version of her sister. The two youngest siblings run over and join in their parents['] hug[end if]. As before, the eldest sibling, now almost an adult herself, snugs you all tightly and nuzzles before heading off into the city in search of a loving mate of her own.";
...
to say dismissgryphoness:
	...
	say "     Pulling Denise the gryphoness close, you give her another deep kiss, then [if Player is not in Garden View]send her off on her own. With a happy, 'See you later, my love,' she swings herself into the air, flying off with strong beats of her large feathered wings[else]tell her she should stay home for now. With a happy, 'See you later, my love,' she strides over to her nest, then climbs into the comfortable and warm refuge[end if].";
...
instead of sniffing Gryphoness:
	if the remainder after dividing Libido of gryphoness by 4 is:
		-- 0: say "     Denise smells like a herm gryphoness, aroused and in heat.";
		-- 1: say "     Denise smells like an aroused herm gryphoness.";
		-- 2: say "     Denise smells like a pregnant herm gryphoness.";
		-- 3: say "ERROR-Denise-3S: You should not be able to smell her right now.";
...
to say sexwithgryphoness:
	...
	if lastfuck of gryphoness - turns < 4:
		...
		if Player is male and (Player is not female or a random chance of 1 in 2 succeeds): [Player Pussyfucks Denise]
			if a random number between one and five is:
				...
				-- 5:
					if a random number between one and five is:
						-- 1:
							say "     You gryphon companion edges closer and closer as the two of you wander down the streets of the city together, until finally she is right next to you before you realize it, rubbing up against you eagerly even as your body grows hot and needy in response.";
						-- 2:
							say "     The scent of your companion's female heat washes over you, making you pant eagerly in desire, even as your talons begin to stroke your cock absently. Before you know it, you are crying out in pleasure, your seed spilling out over your talons, as you realize you have just spent several minutes masturbating and thinking about your hot gryphoness companion...";
						-- 3:
							say "     Stopping to take a break, Denise rubs her full breasts, before staring at you with a grin, the gryphoness coming over and offering you a refreshing drink of her milk right from the source. With her female scent filling your head with lustful thoughts, you are unable to refuse as you find yourself lapping and nibbling at her breasts eagerly, even as she moans in pleasure.";
							if "Iron Stomach" is not listed in feats of Player, infect "Blue Gryphon Herm";
						-- 4:
							say "     As you continue to explore, you are startled when your companion suddenly reaches out and pulls you into a small alcove, you start to ask why, only to moan as she begins to rub herself up against you eagerly, her cock rubbing up against your own as she rubs up against you teasingly. Unable to resist, you quickly give in to the urge to play with your lustful companion, and the two of you are soon panting and gasping in pleasure as you fuck each other up against the walls of the alcove, before eventually returning to your trip through the city, her soft fur covered thighs covered in your fertile seed, even as she rubs her well-fucked passage happily.";
							NPCSexAftermath Denise receives "PussyFuck" from Player;
							deniseimpreg;
						-- 5:
							say "     Pausing in your travels, you notice a small rock that will make a good spot to sit, and rest your feet for a minute, your companion obviously has other ideas, as she is soon on her knees between your legs, her flexible tongue licking over your cock, as she runs the edge of her flexible beak over it teasingly, causing you to moan in pleasure and run your talons through her feathers eagerly. Her expert tongue wrapping around your cock, even as her talons massage your balls lightly, eager for your tasty seed. Soon you are rewarding her efforts with an explosion of your fertile cream, which the happy gryphoness eagerly licks up before helping you to stand back up on your now even shakier legs a soft grin spreading across your lips at how eagerly Denise is fitting into the role of a gryphoness pet...";
							NPCSexAftermath Denise receives "OralCock" from Player;
				...
				-- 5:
					if a random number between one and five is:
						-- 1:
							say "     You gryphon companion edges closer and closer as the two of you wander down the streets of the city together, until finally she is right next to you before you realize it, rubbing up against you eagerly even as your body grows hot and needy in response.";
						-- 2:
							say "     The scent of your companion's potent musk washes over you, making you pant eagerly in desire, even as your talons begin to wander over your body eagerly. Before you know it, you have spent several minutes just rubbing yourself and staring off into the distance, your mind empty of anything but pleasure and potent musk...";
						-- 3:
							say "     Stopping to take a break, Denise rubs her full breasts, before staring at you with a grin, the gryphoness coming over and offering you a refreshing drink of her milk right from the source. With her musk filling your head with lustful thoughts, you are unable to refuse as you find yourself lapping and nibbling at her breasts eagerly, even as she moans in pleasure.";
						-- 4:
							say "     As you continue to explore, you are startled when your companion suddenly reaches out and pulls you into a small alcove, you start to ask why, only to moan as she begins to rub herself up against you eagerly, her cock probing your needy entrance teasingly. Unable to resist, the two of you are soon panting and gasping in pleasure as you fuck each other up against the walls of the alcove, before eventually returning to your trip through the city, her soft juices dripping down your thighs and making you feel like such a proper happy slut with every step.";
							NPCSexAftermath Player receives "PussyFuck" from Denise;
						-- 5:
							say "     Pausing in your travels, you notice a small rock that will make a good spot to sit, and rest your feet for a minute, your companion obviously has other ideas, as she is soon on her knees between your legs, her flexible tongue licking your pussy eagerly as you moan and run your talons through her feathers eagerly. Her expert tongue teases all your most sensitive inner spots, and soon you are rewarding her efforts with an explosion of your hot juices, which the happy gryphoness eagerly licks up before helping you to stand back up on your now even shakier legs.";
							NPCSexAftermath Denise receives "OralPussy" from Player;
...
to deniseimpreg:
	if the remainder after dividing Libido of gryphoness by 4 is 0 and a random chance of 1 in 3 succeeds:
		say "[line break]Denise rubs her belly, enjoying the warmth of your cum inside her.";
		increase Libido of gryphoness by 1;
	...
	if tempnum is 1 or tempnum is 2: [early pregnancy or visible pregnancy]
		...
		if lust of gryphoness is 0: [time for the birth]
			...
			if Gryphoness is listed in companionList of Player: [Denise is along as a pet]
				...
				say "[line break]You find your mind wandering to Denise, thinking about her and [if GryphonessKnowpreg is 1]her pregnancy[else]missing her for some reason[end if]. Perhaps you should check on her.";
			increase score by 5;
		else if lust of gryphoness is 16: [belly shows after 1 day]
			if (Gryphoness is listed in companionList of Player or (Player is in Garden View and Denise is in Garden View)) and GryphonessKnowpreg is 0:
...
to say ResolveEvent Lonely Gryphoness:
	...
	if Player consents:
		...
		if BodyName of Player is "Blue Gryphon Herm":
			say "     The sight of one of the changed gryphons singing such a lonely song is rather startling, and you almost can't help but move forward for a closer look. The song cuts off mid note as you slide forward, as the gryphon apparently notices you and whirls around in surprise. Looking down at your own gryphon-like body, the singing gryphon seems almost embarrassed for a minute, though when you open your mouth to speak, she darts towards you instead. Blinking in anticipation of a fight, you find her arms going around you in a soft hug, and hear her sweet voice whisper 'You're very cute,' in your ear. Before you can actually respond to this, the gryphon lets you go and turns and launches herself from the rooftop, shooting occasional wistful glances back at you as [bold type]she vanishes in the direction of the beach[roman type].";
			infect "Blue Gryphon Herm";
			...
			say "     The sight of one of the changed gryphons singing such a lonely song is rather startling, and you almost can't help but move forward for a closer look. The song cuts off mid note as you slide forward, as the gryphon apparently notices you and whirls around in surprise. The strange gryphon's eyes seem to fill up with panic as she stares at you, slowly backing away towards the edge of the roof and safety, obviously worried about what you might do. Do you try to convince her you mean no harm?";
			if Player consents:
				LineBreak;
				...
				say "[line break]You roll 1d20([diceroll])[if bonus >= 0]+[end if][bonus] = [special-style-1][diceroll + bonus][roman type] vs [special-style-2]15[roman type] (Charisma Check):[line break]";
