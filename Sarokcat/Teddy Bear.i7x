...
When Play begins:
	...
	now skin entry is "[one of]brown furred[or]softly furred[or]fake furred[or]strangely plush[at random]"; [ skin Description, format as "Your body is covered in (your text) skin"]
