...
to say teddybear69:
	...
	say "     Playing with her hot tunnel with your tongue and fingers gets her really worked up and she runs her tongue all over your loins in response. With her soft whiskers tickling your thighs, her padded muzzle [if cocks of player > 0]squeezes and sucks on your cock until you're pushed to orgasm, shooting your [cum load size of player] load down her throat to fill her plush tummy[else]presses against your wet folds and her tongue laps into your cunt until you're pushed to orgasm, covering her plush face in your feminine juices[end if].";
...
When Play begins:
	...
	now face entry is "large teddy bear like face, with a short muzzle and rosy cheeks. Your big black eyes seem comical and cute, and your mouth is pulled upwards by your muzzle, so it seems as if you are always smiling goofily";[ Face description, format as the text "Your face is (your text)."]
