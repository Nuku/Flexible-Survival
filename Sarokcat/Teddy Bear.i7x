...
When Play begins:
	...
	now body entry is "Rounded in the middle, with somewhat round arms and legs, and plump plush pawlike hands, your body almost feels like it is full of some sort of strange stuffing that moves around as you walk, poking yourself you can see your clawed paw sink deeply into your stuffed side with almost no pain whatsoever";[ Body Description, format as the text "Your Body is (your text)"] 
	now skin entry is "[one of] brown furred[or]softly furred[or]fake furred[or]strange plushlike[at random]";[ skin Description, format as the text "You have (your text) skin"] 
