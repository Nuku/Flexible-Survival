...
to say teddy bear attack:
	...
	if scalevalue of Player <= 3 and vorelevel is not 1 and a random chance of 2 in 5 succeeds:
		...
		CreatureSexAftermath "Teddy Bear" receives "OralPussy" from "Player";

To say teddy bear loss:
	if noteddybearsex > 2:
		say "     The strange plush animal whimpers as your last blow knocks it over. It lands with a soft, padded thump onto its back and waves its limbs in the air, having difficulty getting back up. As you've done in the past with them, you ignore its struggles and leave it there. With it temporarily indisposed, you're free to return to what you were doing before it got in your way.";
		...
		say "     The strange plush animal whimpers as your last blow knocks it over. It lands with a soft, padded thump onto its back and waves its limbs in the air, having difficulty getting back up. With it temporarily indisposed, you're free to return to what you were doing before it got in your way.";
...
When Play begins:
	...
	now face change entry is "your face balloons outwards as your head seems to swell up, your cheeks stretching out and a cute little muzzle forming as your face becomes that of a happy giant teddy bear"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
	now body change entry is "it shifts and plumps outwards, your hands and feet becoming fatter and rounder, making it hard to balance as you seem to become much more like a children's toy"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	...
	now ass change entry is "it plumps up, making you feel like you are sitting on some sort of padding, looking behind you, find your new fabric like ass has also sprouted a short little bear tail, which you find yourself wiggling a few times, surprised at how well the bit of fabric responds"; [ Ass/tail change text, format as "Your ass feels funny as [ass change entry]." ]
	...
	now MilkItem entry is "teddy bear milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "teddy bear cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	...
	if Player has a body of "Teddy Bear":
		...
		if humanity of Player < 10:
			if the Player is pure:
				...
				if Player is herm and (Player is maleinterested or Player is not femaleinterested):
