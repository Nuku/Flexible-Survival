...
to say ResolveEvent Stabled Situation:
	if Stablesearchstatus is 0:
		...
		say "[line break]     [bold type]Do you try to gain entrance to the building?[roman type][line break]";
		...
		say "     You note that the building and grounds still seem to be guarded by a couple of those powerful horsemen as you look things over again to see if you missed anything the last time you were here. Sighing as you investigate the area, you realize that the only way in appears to be the one the horses are guarding, and that if the numbers you saw heading into here earlier are any indication, fighting the guards will only get you overwhelmed by more of the horsemen, even if not at first, then on subsequent visits. Looking at the large building speculatively, you realize that if you want to get in, you will have to find some way to bribe the guards into looking the other way each time you visit.";
		say "[line break]     [bold type]Do you try bribing the guards?[roman type][line break]";
		say "     ([link]Y[as]y[end link]) - Try to convince the guards to let you in.";
		say "     ([link]N[as]n[end link]) - Don't risk dealing with the horses.";
		if Player consents:
			LineBreak;
...
Description of Hotel Stalls is "     This room appears to be the small lobby to one of the guest wings, and while it looks like the main part of the building is still mostly boarded up, this part appears to have been repaired recently, and halls to the north and south appear to have been refurbished for use. Strangely enough, someone seems to have hung a sign in this area, labeling this particular area 'The Stalls'.[line break]".
Scent of Hotel Stalls is "     This lobby area smells strongly of equine sex coming from the nearby rooms.".
...
Description of Employee Access is "     This long narrow hallway curves north and has several doors along the sides, eventually ending in a pair of large closed double doors labeled 'Master's Stable'. Unfortunately, most of the doors are sealed tight, and you will need to find the keys or some other way to open them before you can go any further in this direction.[line break]".
Scent of Employee Access is "     This area smells particularly strong of the dominant, equine scents beyond.".

Section 3 - Trying the Horsefood
