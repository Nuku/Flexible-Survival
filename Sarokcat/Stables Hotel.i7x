	...
	otherwise if Stablesearchstatus is 1:
		...
		If player consents:
			...
			if chips is owned and soda is owned:
				say "     Searching through your pack, while the two horsemen eye you curiously, you pull out several items to see how they react, only to be disappointed each time as they continue to watch you with suspicion. Finally your pack is almost empty by the time you pull out some chips and soda, and notice the horsemen lick their lips and shift on their hoof-like feet as they seem to realize just how hungry guard duty has made them.";
				say "     Grinning you offer the snack food to the guards, only to pull it back when one of them reaches for it, gesturing at the closed door between the two guards you give them a questioning look. The horsemen sigh as they glance at each other for a minute, before nodding at you, and one of them waves you on inside as you hand them the junk food to share. As you enter you hope they will pass the word to the next group of guards as well, since you would rather not have to go through that every time you come here.";
				delete chips;
				delete soda;
