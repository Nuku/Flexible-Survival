...
to say ebwhelpvic:
	...
	if tempnum is 2:
		...
		say "     Your[if HP of player < 1] forced[end if] attendance is eventually rewarded when the whelp cries out, searing rod bulging significantly and your insides are doused with successive barrages of the monsters over-sized load. It seems likely so much that you're not rightly sure how the little thing could even carry it all, stomach [if scalevalue of player < 3]visibly bulging[else]aching painfully[end if] with the glowing precum.";
