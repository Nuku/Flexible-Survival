Version 5 of Yamato Dragon For FS by Blue Bishop begins here.
	...
	if vorelevel is 3 and (a random chance of 1 in 3 succeeds or ("Kinky" is listed in feats of player and a random chance of 1 in 3 succeeds)):
		...
		if "Touched by Madness" is listed in feats of player and cocks of player > 0 and cock length of player < 20 and (("Kinky" is listed in feats of player and a random chance of 1 in 2 succeeds) or ("Kinky" is not listed in feats of player and a random chance of 1 in 5 succeeds)):
			...
			if anallevel is not 1 and (cunts of player is 0 or anallevel is 3) and (a random chance of 1 in 3 succeeds or (anallevel is 3 and a random chance of 1 in 4 succeeds)):
				...
				else if ("less anal" is not listed in feats of player and a random chance of 1 in 2 succeeds) or "more anal" is listed in feats of player:
			...
			if anallevel is not 1 and (cunts of player is 0 or anallevel is 3) and (a random chance of 1 in 3 succeeds or (anallevel is 3 and a random chance of 2 in 3 succeeds)):
				...
				say "     '[one of]Yes, yes[or]Take it[or]N-nghn[at random]! [one of]Take every last inch[or]You will sleeve the whole of me[or]Take all of it[at random]!' Lust-laden cries echoing through the [if showlocale is true]park[else]area[end if], his torment drives you into arousal, [if cocks of player is 0 and cunts of player is 0]much in spite your lack of outlet[else if HP of player < 1 and player is not submissive]much in spite your better judgment[else]forcing you to moan under the intense weight of his wanton fury[end if].";
				...
				if libido of player > 33:
					...
					say "     The dragon loudly announcing his bliss with a roar, you watch on, exhausted, as the dick's once-defined outline is quickly rounded off in the wake of his release, hot seed [if scalevalue of player < 5]quickly flooding you until it's forced to sputter from your stuffed cunt[else]gradually flooding you until you're absolutely bloated with the stuff[end if]. In the wake of this you cry out, wracked by the strained throes of your own orgasm, [cunt size desc of player] hole weakly squeezing against its [if cunt width of player < 20]oversized [end if]invader[if cocks of player > 0] as your own cock[smn] waste[smv] your [cum load size of player] load against you and the creature's crotch[end if].";
...
to say ydskinchange:
	...
	say "you find yourself suddenly forced to abide the growth of large, smooth [if ydcolour is 0]red[else if ydcolour is 1]blue[else]green[end if] scales grow upon your back, smaller, coarser yellow scales quickly adorning your front and underside";
...
to say YamatM_6: [Oral Giving Cock]
	...
	if player consents:
		...
		if player consents:
			...
			say "     Unable to hold yourself back in the wake of this display, you're quickly wracked with your own bliss, [if cocks of player > 0]staining him your own, [cum load size of player] load[else if cunts of player > 0]staining him with your own honey[else]writhing in an insatiable need[end if]. Once your fervour dies down, you pull away and observe the end results of your little adventure. Though you managed to avoid getting completely drenched, you're still a mess of the monster's sticky precum. He seems amused by you.";
