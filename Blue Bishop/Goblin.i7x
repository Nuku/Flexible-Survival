...
to say losetogob_m:
	...
	if anallevel > 1 and Player is male and Cock Length of Player < 15 and a random chance of 1 in 6 succeeds:
		...
		if Player is male:
			say "he moves a hand to stroke [if Cock Count of Player > 1]one of [end if]your [cock size desc of Player] cock[smn], supplementing his teasing with more direct affections until you're [if HP of Player > 0]driven[else]forcibly made[end if] hard";
		else:
		...
		if Cunt Depth of Player > 15:
			...
			if Player is male:
				...
				say ". He continues to fondle your unattended cunt[if Cunt Count of Player > 3]s, eventually forcing a finger past two of them[else if Cunt Count of Player > 2]s, eventually forcing a finger past both of them[else], eventually forcing a finger into its depths[end if]. Quite the tenacious goblin, [if HP of Player > 0]you can't help but credit him for his[else]he's certainly not lacking in[end if] ability to multitask, at least";
			else if Breast Size of Player > 0:
...
to say fgob_vicsex2:	[f-gob anal sex]
	...
	if scalevalue of Player > 4:
		say "the small creature, stroking [if Cock Count of Player > 1]one of your now-exposed dicks[else]your now-exposed dick[end if] before driving your hardened cock into her hole.";
	else:
		say "her by her sides and grind [if Cock Count of Player < 1]one of your now-exposed dicks[else]your now-exposed dick[end if] between her asscheeks before driving your hardened cock into her hole.";
...
to say fgob_vicsex3:	[f-gob oral sex]
	...
	if Player is male and (Cunt Count of Player is 0 or a random chance of 1 in 2 succeeds):
		say "[fgob_vicsex3_m]";
	else:
		say "[fgob_vicsex3_f]";
...
to say fgob_vicsex3_m:
	...
	if Cock Length of Player >= 18:
		...
		say "     At first she appears a bit sheepish to the concept of contending with your [cock size desc of Player] tool[smn], but it only takes a moment of forceful coaxing before she's compliant. Grabbing [if Cock Count of Player > 2]two of them[else if Cock Count of Player > 1]both of them[else]the organ[end if] with both hands, her tongue moves to caress the length of [if Cock Count of Player > 1]one of them[else]the shaft[end if]. She's clearly quite dexterous and seems innately adept at this performance.";
		WaitLineBreak;
		if Cock Count of Player is 1:
...
to say fgob_vicsex3_f:
	...
	say "     At first she appears a bit sheepish to the concept of contending with [if Cunt Count of Player > 1]one of [end if]your hole[sfn], but it only takes a moment of forceful coaxing before she's compliant. Fingers teasing [if Cunt Count of Player > 2]the soft lips of two of them[else if Cunt Count of Player > 1]the soft lips of both of them[else]its soft lips[end if], her tongue moves to caress [if Cunt Count of Player > 1]one of their[else]its[end if] clit[sfn], invariably tasting your emergent feminine fluids. She's clearly quite dexterous and seems innately adept at this performance.";
	...
	if Libido of Player > 50:
		say "[if Cock Count of Player > 1]your cocks erupting with their load against you as the goblin briefly contends[else if Cock Count of Player is 1]your cock erupting with its load against you as the goblin briefly contends[else]the goblin briefly contending[end if] with your gushing portal. You get up, leaving her free to scramble to the safety of a narrow tunnel within one of the nearby mounds.";
	else:
...
to say mgob_vicsex1:	[m-gob vaginal sex]
	...
	if Player is male:
		if scalevalue of Player > 4:
			say "     The small creature eclipsed under your form, your hands move to stroke your hardening cock[smn]. [if Cock Count of Player > 2]Two of them in your grasp[else if Cock Count of Player > 1]Both of them in your grasp[else]With your [cock size desc of Player] tool in your grasp[end if], you're not about to let your beleaguered companion be the sole progenitor of your pleasure. So small compared to you, he at least gets the small mercy of your organ aimed well over him, [if Ball Size of Player >= 5]though you could only imagine this sentiment as he's buried under your [Ball Size Adjective of Player] [Balls][else]though he is perhaps more distracted by having to contend with your troubling weight[end if].";
		else if scalevalue of Player is 4:
			say "     The small creature eclipsed under your form, your hands move to stroke your hardening cock[smn]. [if Cock Count of Player > 2]Two of them in your grasp[else if Cock Count of Player > 1]Both of them in your grasp[else]Your [cock size desc of Player] tool in your grasp[end if], you're not about to let your beleaguered companion be the sole progenitor of your pleasure, his expression a lust-addled horror while he contends with the fact that [if Cock Count of Player > 1]they're[else]it's[end if] aimed directly at him, [if Ball Size of Player >= 6]and with one look at the load you're packing it's clear that the end result will be quite a mess[else]and you might find his desire to remain clean of your fluids meritable if his face wasn't already quite unkempt[end if].";
		else:
			say "     Moving his hands to fondle your [if Breast Size of Player > 0][breast size desc of Player] breasts[else]torso[end if], your own shift to stroke your hardening cock[smn]. [if Cock Count of Player > 2]Two of them in your grasp[else if Cock Count of Player > 1]Both of them in your grasp[else]Your [cock size desc of Player] tool in your grasp[end if], you're not about to let your beleaguered companion be the sole progenitor of your pleasure, his expression a lust-addled horror while he contends with the fact that [if Cock Count of Player > 1]they're[else]it's[end if] aimed directly at him, [if Ball Size of Player >= 6]and with one look at the load you're packing it's clear that the end result will be quite a mess[else]and you might find his desire to remain clean of your fluids meritable if he wasn't already quite dirty[end if].";
	say "     Riding his cock, it's not long before your irreverent hold on him elicits his release, [if scalevalue of Player > 3]the subsequent flood of his fluids barely registering against your larger frame[else]the warmth of his fluids flooding your depths[end if]";
	if scalevalue of Player > 4 and Player is male:
		say ", wracking you with the throes of your own subsequent release. Cock[smn] shooting [if Cock Count of Player > 1]their[else]its[end if] load clear across the open air, you unleash a [Cum Load Size of Player] load that makes a [if Ball Size of Player >= 6]considerable[else]fair[end if] mess of the surrounding scenery, milking him of every last drop before you finally relent.";
	else if Player is male:
		say ", wracking you with the throes of your own subsequent release. Cock[smn] firing [if Cock Count of Player > 1]their[else]its[end if] load straight into the goblin's exposed face, you unleash a [Cum Load Size of Player] load that makes a [if Ball Size of Player >= 6]considerable[else]fair[end if] mess of the [if scalevalue of Player > 2]diminutive [end if]creature's face, milking him of every last drop before you finally relent.";
...
to say mgob_vicsex3_m:	[m-gob oral m-player]
	say "cock[smn].";
	if Cock Length of Player >= 18:
		say "     At first he's a bit apprehensive, clearly unsure about how he'd go about pleasuring such [if Cock Count of Player is 1]a [end if][cock size desc of Player] tool[smn], but he's inevitably coaxed into improvising with a little forceful encouragement. Grabbing [if Cock Count of Player > 2]two of them[else if Cock Count of Player > 1]both of them[else]the organ[end if] with both hands, his tongue moves to caress the length of [if Cock Count of Player > 1]one of them[else]the shaft[end if]. He's clearly quite dexterous and seems to perform fairly well in spite the circumstances, driving you into arousal with desired expedience.";
		WaitLineBreak;
		if Cock Count of Player is 1:
		...
		say "     At first he appears a bit sheepish to the concept of contending with your [cock size desc of Player] tool[smn], but it only takes a moment of forceful coaxing before he's compliant. Grabbing [if Cock Count of Player > 2]two of them[else if Cock Count of Player > 1]both of them[else]the organ[end if] with both hands, his tongue moves to caress the length of [if Cock Count of Player > 1]one of them[else]the shaft[end if]. He's clearly quite dexterous and seems innately adept at this performance.";
		WaitLineBreak;
		if Cock Count of Player is 1:
...
to say mgob_vicsex3_f:	[m-gob oral f-player]
	say "[cunt size desc of Player] cunt[sfn].";
	say "     At first he appears a bit sheepish to the concept of contending with [if Cunt Count of Player > 1]one of [end if]your hole[sfn], but it only takes a moment of forceful coaxing before he's compliant. Fingers teasing [if Cunt Count of Player > 2]the soft lips of two of them[else if Cunt Count of Player > 1]the soft lips of both of them[else]its soft lips[end if], his tongue moves to caress [if Cunt Count of Player > 1]one of their[else]its[end if] clit[sfn], invariably tasting your emergent feminine fluids. He's clearly quite dexterous and seems innately adept at this performance.";
	if Cunt Count of Player is 1:
		WaitLineBreak;
	...
	if Libido of Player > 50:
		say "[if Cock Count of Player > 1]your cocks erupting with their load against you as the goblin briefly contends[else if Cock Count of Player is 1]your cock erupting with its load against you as the goblin briefly contends[else]the goblin briefly contending[end if] with your gushing portal. You get up, leaving him free to scramble to the safety of a narrow tunnel within one of the nearby mounds.";
	else:
...
to say mgob_vicsex4:	[m-gob urethral sex]
	...
	say "     Gradually, you move to fuck his dick proper, each subsequent thrust met with tremors of sharp pleasure. As you build up pace, the creature - obliging as he may be to this lewd ritual - is nonetheless dug into the dirt by your elevating fervor";
...
When Play begins:
	...
	now attack entry is "The [one of]cackling goblin bites you[or]vicious goblin scratches at you with [if gobgender is 1]her[else]his[end if] sharp claws[or]little goblin jabs you in the leg with a small knife[or]goblin scrambles onto your back, clawing and scratching as [if gobgender is 1]she[else]he[end if] does[or]goblin manages to grab your throat with [if gobgender is 1]her[else]his[end if] surprisingly strong hands and tries to choke you[at random]!";
