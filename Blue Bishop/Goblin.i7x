...
to say mgob_vicsex4:	[m-gob urethral sex]
	...
	If libido of player > 49:
		...
		say "     Eventually you're able to recover from the ordeal, pulling your dick free of the goblin's. He slowly pulls himself to his feet, cock dripping cum. [if cock width of player >= 24]His struggles to retreat whilst contending with such an awkwardly large sack is a rather amusing sight to behold[else]His endeavors to retreat are slightly hindered by his sore and somewhat bloated sack[end if]. Watching him stagger his way to a goblin tunnel in one of the nearby junk piles, he scrables to safety, leaving you free to go on your merry way.";
