...
gobgender is a number that varies.[@Tag:NotSaved]
gobdem is a truth state that varies.[@Tag:NotSaved] gobdem is usually false.
	...
	if gobgender is 1:	[female goblin]
		...
		if Player is male and Cock Length of Player < 14 and a random chance of 1 in 2 succeeds:
			if scalevalue of Player > 3:
				say "She moves a hand to grab [if Cock Count of Player > 1]one of [end if]your cock[smn], stroking it as she shifts closer, her tongue lewdly caressing the [cock size desc of Player] tool until you are[if HP of Player < 1] forcibly[end if] made hard[if Cock Count of Player > 2], its brothers soon following thereafter[else if Cock Count of Player is 2], its brother soon following thereafter[end if]. You can't refuse to admit to yourself that it's a little embarrassing when such a small [if HP of Player > 0]creature[else]assailant[end if] is forced to scale your sizable, [bodytype of Player] form to position herself over you. The spry lady shifting her tattered loincloth over so that it won't get in the way of impaling herself with your throbbing organ, she grinds her shapely ass along its length.";
			else:
				say "She moves a hand to grab [if Cock Count of Player > 1]one of [end if]your cock[smn], stroking it as she shifts closer, her tongue lewdly caressing the [cock size desc of Player] tool until you are[if HP of Player < 1] forcibly[end if] made hard[if Cock Count of Player > 2], its brothers soon following thereafter[else if Cock Count of Player is 2], its brother soon following thereafter[end if]. Satisfied, she scrambles to position herself on top of your [bodytype of Player] form. The spry lady shifting her tattered loincloth over so that it won't get in the way of impaling herself with your throbbing organ, she grinds her shapely ass along its length.";
			WaitLineBreak;
			...
			if gobdem is true:
				say "     '[if Cock Length of Player > 8][one of]Nng, big, BIG, ah[or]Oof, ah, nng[or]Oh, ouch, ah[at random][else][one of]Ah, ha, nng[or]Hm, ah, oh[or]Heh, nng, MINE, ah[at random][end if]!' Hands stroking your [bodydesc of Player] torso as she builds up a motion, she's quick to illustrate a manic fervor in pumping herself against your hardened organ[if scalevalue of Player > 3]; though such a diminutive creature barely registers against your substantially larger form, her sickeningly rapid motion against your member nonetheless has an effect on you[else], her dizzying motions pushing you back and forth with sickening rapidity[end if][if Cock Count of Player > 3]. In her endeavors, she instinctively grabs two of your free dicks, pumping them wildly in her wanton fury[else if Cock Count of Player is 3]. In her endeavors, she instinctively grabs both of your free dicks, pumping them wildly in her wanton fury[else if Cock Count of Player is 2]. In her endeavors, she instinctively grabs your free dick, pumping it wildly in her wanton fury[end if].";
			else:
				say "     '[if Cock Length of Player > 8][one of]Nng, this is going to be a challenge[or]Ah, oh, don't think I can't handle you[or]Ah, ooh, this is going to take a bit of work[at random][else][one of]Oh, this'll be a fun ride[or]Ah, I couldn't resist taking this bad boy out for a ride[or]Ooh, the fun's just started here[at random][end if]!' Hands stroking your [bodydesc of Player] torso as she builds up a motion, she's quick to illustrate a manic fervor in pumping herself against your hardened organ[if scalevalue of Player > 3]; though such a diminutive creature barely registers against your substantially larger form, her sickeningly rapid motion against your member nonetheless has an effect on you[else], her dizzying motions pushing you back and forth with sickening rapidity[end if][if Cock Count of Player > 3]. In her endeavors, she instinctively grabs two of your free dicks, pumping them wildly in her wanton fury[else if Cock Count of Player is 3]. In her endeavors, she instinctively grabs both of your free dicks, pumping them wildly in her wanton fury[else if Cock Count of Player is 2]. In her endeavors, she instinctively grabs your free dick, pumping it wildly in her wanton fury[end if].";
			WaitLineBreak;
			if Ball Size of Player > 5:
				say "     The wet sound of her continued motion filling the air for but a few short minutes later, she finally cries out in ecstasy, [if Player is knotted]tying with you as her cunt tightens[else]her cunt tightening[end if] further around your cock until you're [if HP of Player > 0]compelled[else]forced[end if] to find bliss as well, pumping her voracious womb with your [Cum Load Size of Player] spurts of cum[if Cock Count of Player > 2]. Not so lost in lust as to relent in humiliating you further, she aims both free tools in her hold to your face, spraying you with your own seed[else if Cock Count of Player is 2]. Not so lost in lust as to relent in humiliating you further, she aims the free tool in her hold to your face, spraying you with your own seed[end if]. Her moans becoming weak and disoriented, she wasn't at all prepared for how much you'd unload into her. Her quickly beleaguered belly is bloating with your immense sexual fluids until each successive spurt shoots out from the lips of her stuffed hole[if Cock Count of Player > 1]. You're not spared any shame either, your front getting absolutely drenched in your own cum[end if].";
				say "     '[if gobdem is true][one of]Nng, uhh, too much[or]Ooh, urg, hoo[or]Ah, m-mine, so much mine[at random][else][one of]Uegh, I think I bit off more than I could chew[or]Oh, am I going to be sore now[or]Urgh, I'm not going to get anywhere with all this[at random][end if]...' She eventually pulls herself free of your organ, a trail of seed in its wake, before she [if scalevalue of Player > 3]makes the slow descent[else]climbs[end if] off of you. Still disoriented from lust, it takes a while for her to readjust her paltry attire before she dizzily wanders off, leaving a trail of seed in her wake. You eventually manage to pull yourself to your feet, [if Cock Count of Player > 1]taking a moment to clean yourself of your own sexual fluids[else]taking a moment to clean yourself of the mix of sexual fluids[end if] as best you can before leaving this place as well before the scent of sex draw others near.";
			else:
				say "     The wet sound of her continued motion filling the air for but a few short minutes later, she finally cries out in ecstasy, [if Player is knotted]tying with you as her cunt tightens[else]her cunt tightening[end if] further around your cock until you're [if HP of Player > 0]compelled[else]forced[end if] to find bliss as well, pumping her voracious womb with your [Cum Load Size of Player] spurts of cum[if Cock Count of Player > 2]. Not so lost in lust as to relent in humiliating you further, she aims both free tools in her hold to your face, spraying you with your own seed[else if Cock Count of Player is 2]. Not so lost in lust as to relent in humiliating you further, she aims the free tool in her hold to your face, spraying you with your own seed[end if]. Approving moans escaping her lips, her tight hole milks you of every last drop you have to offer. Still on the high of her own lust, she continues to ride you until you're too soft to sate her needs any further.";
				say "     '[if gobdem is true][one of]Ah, m-mine, ah[or]Ah, whew, hm[or]Ah, ha, mine[at random][else][one of]Whew, nothing I couldn't handle[or]Oh, that was some ride[or]Ah, I just need a second to catch my breath[at random][end if]...' She eventually pulls herself free of your organ, a trail of seed in its wake, before she [if scalevalue of Player > 3]makes the slow descent[else]climbs[end if] off of you. Still disoriented from lust, it takes a while for her to readjust her paltry attire before she dizzily wanders off, abandoning you. You eventually manage to pull yourself to your feet, [if Cock Count of Player > 1]taking a moment to clean yourself of your own sexual fluids[else]taking a moment to clean yourself of the mix of sexual fluids[end if] as best you can before leaving this place as well before the scent of sex draw others near.";
			CreatureSexAftermath "Goblin" receives "PussyFuck" from "Player";
		else:
			if Player is submissive or HP of Player > 0:
				say "Tugging at you towards her crotch, it's clear she intends to have you satisfy her orally, and you are [if Player is submissive]compelled by your submissive inclinations[else]quickly compelled[end if] to oblige. [if scalevalue of Player > 4]Thrusting your head between the diminutive creature's thighs, you practically lift her off her feet, the goblin quickly scrambling to ensure she doesn't fall back. Perhaps a bit too forward in your actions, your intent is clarified when your tongue moves to pleasure the folds of her cunt from under the cover of a scant loincloth[else if scalevalue of Player is 4]Thrusting your head between the diminutive creature's thighs, she looks visibly amused at such a large beast's compliance with something so small as her. Not one to keep the girl waiting, your tongue soon moves to pleasure the folds of her cunt from under the cover of a scant loincloth[else]She unobstructs your view of her cunt by parting her scant loincloth, forcing her crotch against your face until you oblige her whims, your tongue soon probing the folds of her flesh[end if].";
				WaitLineBreak;
				if gobdem is true:
					say "     '[one of]Slut - good slut - ha[or]Yes - yes good - mm[or]Mine, my slut, MINE[at random]!' Moaning audibly in approval, the creature grinds her crotch against your slick organ's irreverent probing. [if scalevalue of Player > 4]The appendage is much too large to fit, but that doesn't stop you from grinding your tongue against the entrance of her diminutive portal[else]She writhes in pleasure as the appendage slowly floods the depths of her hole, your tongue's raid rewarded with a taste of her sexual fluids[end if]. Her motions become increasingly erratic by the rising fervor in her sexual drive, and your affections are soon met with a flood of the goblin's release. She lingers for a moment, panting, until she finds herself sufficiently recovered before pulling herself free from you.";
				else:
					say "     '[if scalevalue of Player > 3][one of]Oh, I think my new big friend likes eating pussy[or]Ha, what a massive slut[or]Hm, what a big toy[at random][else][one of]Oh, it looks like someone enjoys eating pussy[or]Ha, look at that slut go[or]I think you're a natural at being a toy[at random][end if]!' Moaning audibly in approval, the creature grinds her crotch against your slick organ's irreverent probing. [if scalevalue of Player > 4]The appendage is much too large to fit, but that doesn't stop you from grinding your tongue against the entrance of her diminutive portal[else]She writhes in pleasure as the appendage slowly floods the depths of her hole, your tongue's raid rewarded with a taste of her sexual fluids[end if]. Her motions become increasingly erratic by the rising fervor in her sexual drive, and your affections are soon met with a flood of the goblin's release. She lingers for a moment, panting, until she finds herself sufficiently recovered before pulling herself free from you.";
			else:
				say "Tugging at you towards her crotch, it's clear she intends to have you satisfy her orally, [if scalevalue of Player > 4]though it would appear that you are too large and non-complicit to oblige her endeavors; defeating you as she may have, she's not strong enough to pull you along. Eventually, she concedes to just sitting on your face until you're forced to humor her, the scent of her eager snatch flooding your nostrils. This treatment soon has you increasingly eager to sate her obvious need as you are driven[else if scalevalue of Player is 4]and though you are much larger than the goblin, she eventually situates you to properly pleasure her hole. Ill-inclined to humor her, she coaxes you into compliance by pressing her now-exposed snatch against your face. The scent of her arousal floods your nostrils until you're driven by your own emergent lust[else]eventually situating you to properly pleasure her hole. Ill-inclined to humor her, she coaxes you into compliance by pressing her now-exposed snatch against your face. The scent of her arousal floods your nostrils until you're driven by your own emergent lust[end if] to comply.";
				WaitLineBreak;
				if gobdem is true:
					say "     '[one of]Naughty, naughty[or]Ha, ha - good - ha[or]Mine, MINE, yes[at random]!' Moaning audibly in approval, the creature grinds her crotch against your slick organ's irreverent probing. [if scalevalue of Player > 4]The appendage is much too large to fit, but that doesn't stop you from grinding your tongue against the entrance of her diminutive portal[else]She writhes in pleasure as the appendage slowly floods the depths of her hole, your tongue's raid rewarded with a taste of her sexual fluids[end if]. Her motions become increasingly erratic by the rising fervor in her sexual drive, and your affections are soon met with a flood of the goblin's release. She lingers for a moment, panting, until she finds herself sufficiently recovered before pulling herself free from you.";
				else:
					say "     '[if scalevalue of Player > 3][one of]There we go, keep playing nice now, big one[or]That's right, be a good big slut[or]There we go, the big one knows their place[at random][else][one of]There we go, keep playing nice[or]That's right, be a good little slut[or]There we go, someone knows their place now[at random][end if]!' Moaning audibly in approval, the creature grinds her crotch against your slick organ's irreverent probing. [if scalevalue of Player > 4]The appendage is much too large to fit, but that doesn't stop you from grinding your tongue against the entrance of her diminutive portal[else]She writhes in pleasure as the appendage slowly floods the depths of her hole, your tongue's raid rewarded with a taste of her sexual fluids[end if]. Her motions become increasingly erratic by the rising fervor in her sexual drive, and your affections are soon met with a flood of the goblin's release. She lingers for a moment, panting, until she finds herself sufficiently recovered before pulling herself free from you.";
			if gobdem is true:
				say "     '[one of]Ha, ha, yes, bye[or]Bye, mine, heh[or]Good, good[at random].' [if scalevalue of Player > 4]She pats you teasingly on the top of your head[else]She gives you a playful swat on your behind[end if] before departing, the creature finding a tiny tunnel in the junk before descending within it. Now free, you suppose you could be worse for wear, though you are somewhat disoriented by the influence of her infection. You stagger off, wanting to get some distance before the scent of sex draws others.";
			else:
				say "     '[if HP of Player > 0 or Player is submissive][one of]Not half bad, I've certainly had worse[or]That was some nice, quick fun[or]Ah, it's good to get some proper satisfaction around here[at random][else][one of]Not half bad, once you learned your place[or]See? That wasn't all that bad[or]Maybe next time would give me less trouble[at random][end if].' [if scalevalue of Player > 4]She pats you teasingly on the top of your head[else]She gives you a playful swat on your behind[end if] before departing, the creature finding a tiny tunnel in the junk before descending within it. Now free, you suppose you could be worse for wear, though you are somewhat disoriented by the influence of her infection. You stagger off, wanting to get some distance before the scent of sex draws others.";
		...
		if anallevel > 1 and Player is male and Cock Length of Player < 15 and a random chance of 1 in 6 succeeds:
			if scalevalue of Player > 3:
				say "He moves a hand to grab [if Cock Count of Player > 1]one of [end if]your cock[smn], stroking it as he shifts closer, his tongue lewdly caressing the [cock size desc of Player] tool until you are[if HP of Player < 1] forcibly[end if] made hard[if Cock Count of Player > 2], its brothers soon following thereafter[else if Cock Count of Player is 2], its brother soon following thereafter[end if]. You can't refuse to admit to yourself that it's a little embarrassing when such a small [if HP of Player > 0]creature[else]assailant[end if] is forced to scale your sizable, [bodytype of Player] form to position himself over you, the spry lad shifting his tattered loincloth over so that it won't get in the way of impaling himself with your throbbing organ, his own standing proudly to attention as he grinds his shapely ass along its length. Apparently, this particular goblin is rather fond of going on a ride.";
			else:
				say "He moves a hand to grab [if Cock Count of Player > 1]one of [end if]your cock[smn], stroking it as he shifts closer, his tongue lewdly caressing the [cock size desc of Player] tool until you are[if HP of Player < 1] forcibly[end if] made hard[if Cock Count of Player > 2], its brothers soon following thereafter[else if Cock Count of Player is 2], its brother soon following thereafter[end if]. Satisfied, he scrambles to position himself on top of your [bodytype of Player] form, the spry lad shifting his tattered loincloth over so that it won't get in the way of impaling himself with your throbbing organ, his own standing proudly to attention as he grinds his shapely ass along its length. Apparently, this particular goblin is rather fond of going on a ride.";
			...
			WaitLineBreak;
			if gobdem is true:
				say "     '[if Cock Length of Player > 8][one of]Nng, big, BIG, ah[or]Oof, ah, nng[or]Oh, ouch, ah[at random][else][one of]Ah, ha, nng[or]Hm, ah, oh[or]Heh, nng, MINE, ah[at random][end if]!' Hands stroking your [bodydesc of Player] torso as he builds up a motion, he's quick to illustrate a manic fervor in pumping himself against your hardened organ[if scalevalue of Player > 3]; though such a diminutive creature barely registers against your substantially larger form, his sickeningly rapid motion against your member nonetheless has an effect on you[else], his dizzying motions pushing you back and forth with sickening rapidity[end if][if Cock Count of Player > 3]. In his endeavors, he instinctively grabs two of your free dicks, frotting them wildly against his own in wanton fury[else if Cock Count of Player is 3]. In his endeavors, he instinctively grabs both of your free dicks, frotting them wildly against his own in wanton fury[else if Cock Count of Player is 2]. In his endeavors, he instinctively grabs your free dick, frotting it wildly against his own in wanton fury[end if].";
			else:
				say "     '[if Cock Length of Player > 8][one of]Nng, this is going to be a challenge[or]Ah, oh, don't think I can't handle you[or]Ah, ooh, this is going to take a bit of work[at random][else][one of]Oh, this'll be a fun ride[or]Ah, I couldn't resist taking this bad boy out for a ride[or]Ooh, the fun's just started here[at random][end if]!' Hands stroking your [bodydesc of Player] torso as he builds up a motion, he's quick to illustrate a manic fervor in pumping himself against your hardened organ[if scalevalue of Player > 3]; though such a diminutive creature barely registers against your substantially larger form, his sickeningly rapid motion against your member nonetheless has an effect on you[else], his dizzying motions pushing you back and forth with sickening rapidity[end if][if Cock Count of Player > 3]. In his endeavors, he instinctively grabs two of your free dicks, frotting them wildly against his own in wanton fury[else if Cock Count of Player is 3]. In his endeavors, he instinctively grabs both of your free dicks, frotting them wildly against his own in wanton fury[else if Cock Count of Player is 2]. In his endeavors, he instinctively grabs your free dick, frotting it wildly against his own in wanton fury[end if].";
			if Ball Size of Player > 5:
				say "     The wet sound of his continued motion filling the air for but a few short minutes later, he finally cries out in ecstasy, [if Player is knotted]tying with you as his ass tightens[else]his ass tightening[end if] further around your cock until you're [if HP of Player > 0]compelled[else]forced[end if] to find bliss as well, pumping his taut bowels with your [Cum Load Size of Player] spurts of cum. Not so lost in lust as to relent in humiliating you further, he aims [if Cock Count of Player > 2]both free tools in his hold to your face, spraying you with your seed, along with his own[else if Cock Count of Player is 2]the free tool in his hold to your face, spraying you with your seed, along with his own[else]his tool to spray you with his own seed[end if]. His moans becoming weak and disoriented, he wasn't at all prepared for how much you'd unload into him. His quickly beleaguered belly is bloating with your immense sexual fluids until each successive spurt shoots out from the lip of his stuffed hole[if Cock Count of Player > 1]. You're not spared any shame either, your front getting absolutely drenched in your own cum[end if].";
				say "     '[if gobdem is true][one of]Nng, uhh, too much[or]Ooh, urg, hoo[or]Ah, m-mine, so much mine[at random][else][one of]Uegh, I think I bit off more than I could chew[or]Oh, am I going to be sore now[or]Urgh, I'm not going to get anywhere with all this[at random][end if]...' He eventually pulls himself free of your organ, a trail of seed in its wake, before he [if scalevalue of Player > 3]makes the slow descent[else]climbs[end if] off of you. Still disoriented from lust, it takes a while for him to readjust his paltry attire before he dizzily wanders off, leaving a trail of seed in his wake. You eventually manage to pull yourself to your feet, taking a moment to clean yourself of the mix of sexual fluids as best you can before leaving this place as well before the scent of sex draws others near.";
			else:
				say "     The wet sound of his continued motion filling the air for but a few short minutes later, he finally cries out in ecstasy, [if Player is knotted]tying with you as his ass tightens[else]his ass tightening[end if] further around your cock until you're [if HP of Player > 0]compelled[else]forced[end if] to find bliss as well, pumping his taut bowels with your [Cum Load Size of Player] spurts of cum. Not so lost in lust as to relent in humiliating you further, he aims [if Cock Count of Player > 2]both free tools in his hold to your face, spraying you with your seed, along with his own[else if Cock Count of Player is 2]the free tool in his hold to your face, spraying you with your seed, along with his own[else]his tool to spray you with his own seed[end if]. Approving moans escaping his lips, his tight hole milks you of every last drop you have to offer. Still on the high of his own lust, he continues to ride you until you're too soft to sate his needs any further.";
				say "     '[if gobdem is true][one of]Ah, m-mine, ah[or]Ah, whew, hm[or]Ah, ha, mine[at random][else][one of]Whew, nothing I couldn't handle[or]Oh, that was some ride[or]Ah, I just need a second to catch my breath[at random][end if]...' He eventually pulls himself free of your organ, a trail of seed in its wake, before he [if scalevalue of Player > 3]makes the slow descent[else]climbs[end if] off of you. Still disoriented from lust, it takes a while for him to readjust his paltry attire before he dizzily wanders off, abandoning you. You eventually manage to pull yourself to your feet, taking a moment to clean yourself of the mix of sexual fluids as best you can before leaving this place as well before the scent of sex draws others near.";
			...
			WaitLineBreak;
			if Player is male:
				say "     Grinding the length of his oozing - admittedly fairly average, though you suppose it's quite impressive to a creature of his size - tool against your exposed behind, he moves a hand to stroke [if Cock Count of Player > 1]one of [end if]your [cock size desc of Player] cock[smn], supplementing his teasing with more direct affections until you're [if HP of Player > 0]driven[else]forcibly made[end if] hard. Soon thereafter, you feel the head of his eager organ shove its way past your supple ring, ";
			else:
				say "     Grinding the length of his oozing - admittedly fairly average, though you suppose it's quite impressive to a creature of his size - tool against your exposed behind, [if Cunt Count of Player > 1]he moves a hand to stroke one of your cunts, supplementing his imminent intrusion with another as you feel his fingers sink into the feminine portal[else if Player is female]he moves a hand to stroke your cunt, supplementing his imminent intrusion with another as you feel his fingers sink into the feminine portal[else]he briefly teases your [bodytype of Player] tailpipe before its appropriate use[end if]. Soon thereafter, you feel the head of his eager organ shove its way past your supple ring, ";
			if scalevalue of Player > 3:
				say "his prick barely registering for you and your sizable hole. He doesn't seem to regard this, though, perhaps all the more excuse to be more reckless in his [if HP of Player < 1]ab[end if]use.";
			else:
				say "[if HP of Player > 0]eliciting a moan from you in[else]forcing a moan from your lips in involuntary[end if] response against the irreverent intrusion. He [if HP of Player > 0]at least spares you a moment of gentle reservation before his wanton need takes precedence[else]spares you little reprieve, eager to enforce his wanton dominion[end if].";
			if gobdem is true:
				say "     '[one of][if scalevalue of Player > 3]Ass, big ass, MINE, mine[else]Ass, ass, MINE, ass[end if][or]Mine, MINE, ha ha[or]Fuck, fuck, fuck, ass[at random]!' Slowly building up a pace of fucking you proper, ";
			else:
				say "     '[if scalevalue of Player > 3][one of]F-fuck, there's so much here[or]I bet you can't feel a thing[or]I could lose myself in a hole this big[at random][else if HP of Player > 0][one of]Oh, a nice fit[or]I bet you want to see me do my magic[or]Oh, this is going to be a fun ride[at random][else][one of]Don't tense up so much, it'll only be harder for you[or]Oh, calm down and let me work my magic[or]Oh, what a squirming ride[at random][end if]!' Slowly building up a pace of fucking you proper, ";
			if scalevalue of Player > 3:
				if Player is male:
					say "his intrusion is not enough to effectively pleasure you[if HP of Player > 0] - not that this is really a pressing issue you for you right now -[else],[end if] a shortcoming he [if Cock Count of Player > 2]attempts to compensate for by the additional attention he confers to your dicks, freeing both hands to rapidly pump two of them[else if Cock Count of Player is 2]attempts to compensate for by the additional attention he confers to your dicks, freeing both hands to rapidly pump the two of them[else]compensates for by the additional attention he confers to your dick, freeing a hand to rapidly pump along its length[end if]. You can imagine the whole affair is a bit awkward for the diminutive goblin, barely able to ride and hold onto you at the same time, though he's certainly not lacking in tenacity.";
				else if Player is female:
					say "his intrusion is not enough to effectively pleasure you[if HP of Player > 0] - not that this is really a pressing issue you for you right now -[else],[end if] a shortcoming he compensates for by the additional attention he confers to[if Cunt Count of Player > 2] two of[else if Cunt Count of Player is 2] both of[end if] your cunt[sfn], freeing [if Cunt Count of Player > 2]both hands to rapidly finger two of them[else if Cunt Count of Player is 2]both hands to rapidly finger both of them[else]a hand to rapidly finger its depths[end if]. You can imagine the whole affair is a bit awkward for the diminutive goblin, barely able to ride and hold onto you at the same time, though he's certainly not lacking in tenacity.";
				else:
					say "his intrusion is not enough to effectively pleasure you[if HP of Player > 0] - not that this is really a pressing issue you for you right now -[else],[end if] not that he seems to regard this, more than content to abuse your hole. Inevitably, you're forced to watch him go rigid, followed by the faint sensation of his cum flooding your depths.";
			else:
				if Player is male:
					say "he starts causing you to tremble in[if HP of Player < 1] forcibly imposed[end if] pleasure as he abuses your hole[if Cock Count of Player > 2]. He continues to stroke your dicks, now using both hands to pump two of them[else if Cock Count of Player is 2]. He continues to stroke your dicks, now using both hands to pump the two of them[else], further exacerbating your arousal as he continues to pump your dick[end if]. Quite the tenacious goblin, [if HP of Player > 0]you can't help but credit him for his[else]he's certainly not lacking in[end if] ability to multitask, at least.";
				else:
					say "he starts causing you to tremble in[if HP of Player < 1] forcibly imposed[end if] pleasure as he abuses your hole[if Cunt Count of Player > 2]. He continues to fondle your cunts, eventually forcing a finger past two of them[else if Cunt Count of Player is 2]. He continues to fondle your cunts, eventually forcing a finger past both of them[else if Player is female], further exacerbating your arousal as he forces a finger past your cunt's supple fold[else], much in spite of your genderless form[end if], his thrusts becoming increasingly erratic, illustrative of his imminent release, the creature's lustful endeavors [if HP of Player < 1]forcing[else]driving[end if] you closer to your own bliss.";
				if Player is neuter:
					WaitLineBreak;
			...
			if Player is male:
				...
				if gobdem is true:
					say "     '[one of]Ah, ha, ha[or]Oh, heh, ah[or]Heh, mine, ah[at random]...' Taking a moment to catch his breath, the creature eventually pulls himself free from you, casually wiping his spent tool clean against your behind before he crawls back into the hole from whence he came, regarding you with a sly grin as he departs, allowing you to recover and go about your business once more.";
				else:
					say "     '[if scalevalue of Player > 3][one of]Whew, ah, what a ride[or]Ah, give me a second, big one[or]Heh, I still have the magic touch, even with someone so large[at random][else][one of]Oh, you've gone and made a mess of yourself[or]Whew, I'm going to need a second[or]Ho boy, what a ride[at random][end if]...' Taking a moment to catch his breath, the creature eventually pulls himself free from you, casually wiping his spent tool clean against your behind before he crawls back into the hole from whence he came, regarding you with a sly grin as he departs, allowing you to recover and go about your business once more.";
			else if Player is female:
				WaitLineBreak;
				...
				if gobdem is true:
					...
					say "     '[if scalevalue of Player > 3][one of]Whew, ah, what a ride[or]Ah, give me a second, big one[or]Heh, shame my big new friend had nothing else for me to play with[at random][else][one of]Heh, shame my new friend had nothing else for me to play with[or]Whew, I'm going to need a second[or]Ho boy, what a ride[at random][end if]...' Taking a moment to catch his breath, the creature eventually pulls himself free from you, casually wiping his spent tool clean against your behind before he crawls back into the hole from whence he came, regarding you with a sly grin as he departs, allowing you to recover and go about your business once more.";
			CreatureSexAftermath "Player" receives "AssFuck" from "Goblin";
		else if Player is female and a random chance of 2 in 3 succeeds:
			say "[if scalevalue of Player > 3]He circles around you for a moment, deciding how best to handle a beast of your scale. Coming to a fairly straightforward conclusion, he starts kicking you to compel you onto your back until you comply[else]Toothy grin wide, he forces you onto your back[end if]. The goblin begins to lewdly fondle your exposed, [bodydesc of Player] form[if HP of Player < 1], much in spite of any protest you might offer[end if]. He's certainly going to enjoy the fun he has planned for you, given how jovially he goes about this preparation. Your legs pulled to spread for him, you're given a clear view of his blatantly erect dick, forced from hiding behind the paltry cover of his loincloth.";
			WaitLineBreak;
			if Player is male:
				say "     Grinding the length of his oozing - admittedly fairly average, though you suppose it's quite impressive to a creature of his size - tool against your exposed cunt, he moves a hand to stroke [if Cock Count of Player > 1]one of [end if]your [cock size desc of Player] cock[smn], supplementing his teasing with more direct affections until you're [if HP of Player > 0]driven[else]forcibly made[end if] hard. Soon thereafter, you feel the head of his eager organ shove its way past the supple folds of your flesh, ";
			else:
				say "     Grinding the length of his oozing - admittedly fairly average, though you suppose it's quite impressive to a creature of his size - tool against your exposed cunt, he briefly teases your [cunt size desc of Player] portal[sfn] before [if Cunt Count of Player > 1]their[else]its[end if] appropriate use. Soon thereafter, you feel the head of his eager organ shove its way past the supple folds of your flesh, ";
			if Cunt Depth of Player > 15:
				say "his prick barely registering for you and your sizable hole. He doesn't seem to regard this, though, perhaps all the more excuse to be more reckless in his [if HP of Player > 0]use[else]abuse[end if].";
			else:
				say "[if HP of Player > 0]eliciting a moan from you in[else]forcing a moan from your lips in involuntary[end if] response against the irreverent intrusion. He [if HP of Player > 0]at least spares you a moment of gentle reservation before his wanton need takes precedence[else]spares you little reprieve, eager to enforce his wanton dominion[end if].";
			if gobdem is true:
				say "     '[one of][if scalevalue of Player > 3]Ass, big ass, MINE, mine[else]Ass, ass, MINE, ass[end if][or]Mine, MINE, ha ha[or]Fuck, fuck, fuck, ass[at random]!' Slowly building up a pace of fucking you proper, ";
			...
			if Cunt Depth of Player > 15:
				if Player is male:
					...
					say "his intrusion is not enough to effectively pleasure you[if HP of Player > 0] - not that this is really a pressing issue you for you right now -[else],[end if] a shortcoming he compensates for by the additional attention he confers to[if Cunt Count of Player > 3] two of[else if Cunt Count of Player is 3] both of[end if] your spare cunt[if Cunt Count of Player > 2]s, freeing both hands to rapidly finger both of them[else], freeing a hand to rapidly finger along its depths[end if]. You can imagine the whole affair is a bit awkward for the diminutive goblin, barely able to ride and hold onto you at the same time, though he's certainly not lacking in tenacity.";
				else if Breast Size of Player > 0:
					say "his intrusion is not enough to effectively pleasure you[if HP of Player > 0] - not that this is really a pressing issue you for you right now -[else],[end if] [if scalevalue of Player > 3]a shortcoming he partially compensates for by leaning overtop of you to grope at your breasts. He teases your nipples and plays with your [breast size desc of Player] tits as best he can from within his limited reach[else]a shortcoming he makes some effort to compensate for by leaning overtop you to kiss, lick and suck at your breasts. He teases your nipples and plays with your [breast size desc of Player] tits[end if]. You can imagine the whole affair is a bit awkward for the diminutive goblin, barely able to ride and hold onto you at the same time, though he's certainly not lacking in tenacity.";
				else:
					say "his intrusion is not enough to effectively pleasure you[if HP of Player > 0] - not that this is really a pressing issue you for you right now -[else],[end if] not that he seems to regard this, more than content to abuse your hole. Inevitably, you're forced to watch him go rigid, followed by the faint sensation of his cum flooding your womb.";
					if gobdem is true:
						say "     '[one of]Ah, ha, ha[or]Oh, heh, ah[or]Heh, mine, ah[at random]...' Taking a moment to catch his breath, the creature eventually pulls himself free from you, casually wiping his spent tool clean against your behind before he crawls back into the hole from whence he came, regarding you with a sly grin as he departs, allowing you to recover and go about your business once more.";
					else:
						say "     '[if scalevalue of Player > 3][one of]Whew, ah, what a ride[or]Ah, give me a second, big one[or]Heh, shame my big new friend had nothing else for me to play with[at random][else][one of]Heh, shame my new friend had nothing else for me to play with[or]Whew, I'm going to need a second[or]Ho boy, what a ride[at random][end if]...' Taking a moment to catch his breath, the creature eventually pulls himself free from you, casually wiping his spent tool clean against your behind before he crawls back into the hole from whence he came, regarding you with a sly grin as he departs, allowing you to recover and go about your business once more.";
				...
				if Player is male:
					say "he starts causing you to tremble in[if HP of Player < 1] forcibly imposed[end if] pleasure as he abuses your hole[if Cock Count of Player > 2]. He continues to stroke your dicks, now using both hands to pump two of them[else if Cock Count of Player is 2]. He continues to stroke your dicks, now using both hands to pump the two of them[else], further exacerbating your arousal as he continues to pump your dick[end if]. Quite the tenacious goblin, [if HP of Player > 0]you can't help but credit him for his[else]he's certainly not lacking in[end if] ability to multitask, at least, his thrusts becoming increasingly erratic, illustrative of his imminent release, the creature's lustful endeavors [if HP of Player < 1]forcing[else]driving[end if] you closer to your own bliss.";
				else if Cunt Count of Player > 1:
					say "he starts causing you to tremble in[if HP of Player < 1] forcibly imposed[end if] pleasure as he abuses your hole. He continues to fondle your unattended cunt[if Cunt Count of Player > 3]s, eventually forcing a finger past two of them[else if Cunt Count of Player is 3]s, eventually forcing a finger past both of them[else], eventually forcing a finger into its depths[end if]. Quite the tenacious goblin, [if HP of Player > 0]you can't help but credit him for his[else]he's certainly not lacking in[end if] ability to multitask, at least, his thrusts becoming increasingly erratic, illustrative of his imminent release, the creature's lustful endeavors [if HP of Player < 1]forcing[else]driving[end if] you closer to your own bliss.";
				else if Breast Size of Player > 0:
					say "he starts causing you to tremble in[if HP of Player < 1] forcibly imposed[end if] pleasure as he abuses your hole. He chooses to lean [if scalevalue of Player > 3]overtop of you to grope at your breasts. He teases your nipples and plays with your [breast size desc of Player] tits as best he can from within his limited reach[else]overtop you to kiss, lick and suck at your breasts. He teases your nipples and plays with your [breast size desc of Player] tits[end if]. Quite the tenacious goblin, [if HP of Player > 0]you can't help but credit him for his[else]he's certainly not lacking in[end if] ability to multitask, at least, his thrusts becoming increasingly erratic, illustrative of his imminent release, the creature's lustful endeavors [if HP of Player < 1]forcing[else]driving[end if] you closer to your own bliss.";
				else:
					say "he starts causing you to tremble in[if HP of Player < 1] forcibly imposed[end if] pleasure as he abuses your hole. His grip tightens against your [bodydesc of Player] form, idling fondling you as he continues to pound you, his thrusts becoming increasingly erratic, illustrative of his imminent release, the creature's lustful endeavors [if HP of Player < 1]forcing[else]driving[end if] you closer to your own bliss.";
			if Player is male:
				WaitLineBreak;
			...
			if Player is submissive or HP of Player > 0:
				...
				if gobdem is true:
					say "     '[one of]Slut - good slut - ha[or]Yes - yes good - mm[or]Mine, my slut, MINE[at random]!' Quickly building a motion of thrusting wildly against you, you're made to taste his heady sexual fluids in the wake of his sexual fervor. [if scalevalue of Player < 4]Relentless as he is, you feel like you're about to pass out from lack of oxygen until you suddenly feel your throat flooded with the goblin's tainted seed. He inevitably pushes you free, no doubt amused as you gasp for air, eventually wiping[else]His thrusts become increasingly erratic until your maw is finally flooded with the goblin's tainted seed, the creature rigid against your maw as he attains blissful release. It takes him a bit, but he eventually pulls free of your lips, no doubt amused with himself as he wipes[end if] his cock clean against the side of your face.";
				else:
					say "     '[if scalevalue of Player > 3][one of]Oh, I think my new big friend likes sucking dick[or]Ha, what a massive slut[or]Hm, what a big cum dumpster[at random][else][one of]Oh, it looks like someone enjoys sucking dick[or]Ha, look at that slut go[or]I think you're a natural at being a cum dumpster[at random][end if]!' Quickly building a motion of thrusting wildly against you, you're made to taste his heady sexual fluids in the wake of his sexual fervor. [if scalevalue of Player < 4]Relentless as he is, you feel like you're about to pass out from lack of oxygen until you suddenly feel your throat flooded with the goblin's tainted seed. He inevitably pushes you free, no doubt amused as you gasp for air, eventually wiping[else]His thrusts become increasingly erratic until your maw is finally flooded with the goblin's tainted seed, the creature rigid against your maw as he attains blissful release. It takes him a bit, but he eventually pulls free of your lips, no doubt amused with himself as he wipes[end if] his cock clean against the side of your face.";
			else:
				...
				if gobdem is true:
					say "     '[one of]Naughty, naughty[or]Ha, ha - good - ha[or]Mine, MINE, yes[at random]!' Quickly building a motion of thrusting wildly against you, you're made to taste his heady sexual fluids in the wake of his sexual fervor. [if scalevalue of Player < 4]Relentless as he is, you feel like you're about to pass out from lack of oxygen until you suddenly feel your throat flooded with the goblin's tainted seed. He inevitably pushes you free, no doubt amused as you gasp for air, eventually wiping[else]His thrusts become increasingly erratic until your maw is finally flooded with the goblin's tainted seed, the creature rigid against your maw as he attains blissful release. It takes him a bit, but he eventually pulls free of your lips, no doubt amused with himself as he wipes[end if] his cock clean against the side of your face.";
				else:
					say "     '[if scalevalue of Player > 3][one of]There we go, keep playing nice now, big one[or]That's right, be a good big slut[or]There we go, the big one knows their place[at random][else][one of]There we go, keep playing nice[or]That's right, be a good little slut[or]There we go, someone knows their place now[at random][end if]!' Quickly building a motion of thrusting wildly against you, you're made to taste his heady sexual fluids in the wake of his sexual fervor. [if scalevalue of Player < 4]Relentless as he is, you feel like you're about to pass out from lack of oxygen until you suddenly feel your throat flooded with the goblin's tainted seed. He inevitably pushes you free, no doubt amused as you gasp for air, eventually wiping[else]His thrusts become increasingly erratic until your maw is finally flooded with the goblin's tainted seed, the creature rigid against your maw as he attains blissful release. It takes him a bit, but he eventually pulls free of your lips, no doubt amused with himself as he wipes[end if] his cock clean against the side of your face.";
			if gobdem is true:
				say "     '[one of]Ha, ha, yes, bye[or]Bye, mine, heh[or]Good, good[at random].' Satisfied, he runs off back from whence he hid. It takes you a moment to recover, and you find yourself a little disoriented and lust-addled by his sexual fluid's infectious influence.";
			else:
				say "     '[if HP of Player > 0][one of]Not half bad, I've certainly had worse[or]That was some nice, quick fun[or]Ah, it's good to get some proper satisfaction around here[at random][else][one of]Not half bad, once you learned your place[or]See? That wasn't all that bad[or]Maybe next time would give me less trouble[at random][end if].' Satisfied, he runs off back from whence he hid. It takes you a moment to recover, and you find yourself a little disoriented and lust-addled by his sexual fluid's infectious influence.";
			CreatureSexAftermath "Player" receives "OralCock" from "Goblin";

to say beatthegoblin:
	if Player is neuter:
		say "     Driven back by your final blow, the goblin lands doubled over on the dirt. [gche] scrambles away fearfully and makes a run for it, diving through a tight tunnel in one of the mounds of junk. Even if you could squeeze through there, you don't feel it would be worth it to try and decide to let [ghim] go.";
	else:
...
to say fgob_vicsex2:	[f-gob anal sex]
	if scalevalue of Player > 4:
		say "     Approaching her, you immediately rip free her tattered loincloth, leaving her diminutive behind naked in the middle of the open air. [if scalevalue of Player > 3]You can see her visibly tremble, clearly not sure what to expect from someone as large as you[else]Perhaps too weak to contend your assault, she doesn't give you any trouble when you assess your inevitable angle of descent[end if]. Freeing yourself of any bindings, you grab the small creature, stroking [if Cock Count of Player > 1]one of [end if]your now-exposed dick[smn] before driving your hardened cock into her hole.";
	else:
		say "     Approaching her, you immediately rip free her tattered loincloth, leaving her diminutive behind naked in the middle of the open air. [if scalevalue of Player > 3]You can see her visibly tremble, clearly not sure what to expect from someone as large as you[else]Perhaps too weak to contend your assault, she doesn't give you any trouble when you assess your inevitable angle of descent[end if]. Freeing yourself of any bindings, you grab her by her sides and grind [if Cock Count of Player > 1]one of [end if]your now-exposed dick[smn] between her asscheeks before driving your hardened cock into her hole.";
	say "     She [if Cock Length of Player > 8]immediately cries out in protest, her tight ring giving you a fair amount of resistance, but with a bit of work her passage inevitably abides your invading flesh, regardless of your victim's compliance[else]flinches and struggles against the sensation of your invading flesh, her anal passage tight and ill-suited to abide even a reasonable intrusion, a resistance - as it may be - quickly diminished with a bit of force[end if]. [if scalevalue of Player > 3]She's dragged across the ground with each successive thrust, trying in vain to anchor herself against the overwhelming storm of your rising fervor[else]Gripping at the ground, she can barely hold herself in place as your thrusting reaches a feverish pace[end if], until you find blissful relief.";
	WaitLineBreak;
	if Ball Size of Player >= 6:
		say "     [if Cock Length of Player > 8]Your [cock size desc of Player] intrusion triggering her own orgasm, you[else]You[end if] begin pumping an unholy amount of cum into her beleaguered hole, bloating her almost immediately until each successive spurt finds escape by squirting out around your cock[if Cock Count of Player > 2], your exposed members firing impotently until the goblin is practically swimming in a puddle of your sexual fluids[else if Cock Count of Player is 2], your exposed member firing impotently until the goblin is practically swimming in a puddle of your sexual fluids[end if].";
	else:
		say "     [if Cock Length of Player > 8]Your [cock size desc of Player] intrusion triggering her own orgasm, you[else]You[end if] pump the poor beast full of your cum, [if Cock Count of Player > 2]your exposed members firing impotently against the goblin, further cementing her humiliation as you make a mess of her ragged attire[else if Cock Count of Player is 2]your exposed member firing impotently against the goblin, further cementing her humiliation as you make a mess of her ragged attire[else]forcing the goblin to writhe impotently against the earth as your warmth floods her bowels[end if].";
...
to say fgob_vicsex3:	[f-gob oral sex]
	if Player is male and (Player is not female or a random chance of 1 in 2 succeeds):
		...
		if Cock Length of Player >= 18:
			...
			say "     Her involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, the [if Ball Size of Player >= 6]poor goblin getting absolutely drenched in your torrential release. You get up, letting the cum-coated creature[else]goblin snorting in slight surprise before relinquishing her lips['] hold to cough free some of your cum. You get up, letting her[end if] free and watch her scramble away to a small tunnel in one of the nearby junk mounds. With her gone, you can turn your attention back to other matters.";
		else:
			say "     At first she appears a bit sheepish to the concept of contending with your [cock size desc of Player] tool[smn], but it only takes a moment of forceful coaxing before she's compliant. Grabbing [if Cock Count of Player > 2]two of them[else if Cock Count of Player is 2]both of them[else]the organ[end if] with both hands, her tongue moves to caress the length of [if Cock Count of Player > 1]one of them[else]the shaft[end if]. She's clearly quite dexterous and seems innately adept at this performance.";
			WaitLineBreak;
			if Cock Count of Player is 1:
			...
			say "     Her involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, the [if Ball Size of Player >= 6]poor goblin getting absolutely drenched in your torrential release. You get up, letting the cum-coated creature[else]goblin briefly and audibly gagging before she complicity swallows your subsequent load. You get up, letting her[end if] free and watch her scramble away to a small tunnel in one of the nearby junk mounds. With her gone, you can turn your attention back to other matters.";
		CreatureSexAftermath "Goblin" receives "OralCock" from "Player";
	else:
		say "     Grinning, [if scalevalue of Player > 4]you set yourself down, pulling the creature to your massive form[else]you set yourself down, relinquishing yourself of any attire that might get in the way and pulling the creature to you[end if]. Clarifying her already quite apparent mission, you gesture down to your [cunt size desc of Player] cunt[sfn].";
		say "     At first she appears a bit sheepish to the concept of contending with [if Cunt Count of Player > 1]one of [end if]your hole[sfn], but it only takes a moment of forceful coaxing before she's compliant. Fingers teasing [if Cunt Count of Player > 2]the soft lips of two of them[else if Cunt Count of Player is 2]the soft lips of both of them[else]its soft lips[end if], her tongue moves to caress [if Cunt Count of Player > 1]one of their[else]its[end if] clit[sfn], invariably tasting your emergent feminine fluids. She's clearly quite dexterous and seems innately adept at this performance.";
		if Cunt Count of Player is 1:
			say "     [if Cock Count of Player > 1]Main hand kept busy, she shifts her offhand to assault one of your hardening cocks, gently stroking it in turn as she continues her main endeavors. [else if Player is male]Main hand kept busy, she shifts her offhand to assault your exposed cock, gently stroking it in turn as she continues her main endeavors. [else if anallevel > 1]Main hand kept busy, she shifts her offhand to assault your exposed anal ring, lightly teasing it in turn as she continues her main endeavors. [end if]Her tongue moves to aid her digits as they flood the depths of your cunt. The efficacy of her endeavors is quickly apparent as each successive thrust of her tongue sends bolts of pleasure through your [if scalevalue of Player > 3]massive [end if]frame.";
		if Libido of Player > 50:
			say "     Her involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, [if Cock Count of Player > 1]your cocks erupting with their load against you as the goblin briefly contends[else if Player is male]your cock erupting with its load against you as the goblin briefly contends[else]the goblin briefly contending[end if] with your gushing portal. You get up, leaving her free to scramble to the safety of a narrow tunnel within one of the nearby mounds.";
		else:
			say "     Her involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, the goblin briefly contending with your gushing portal. You get up, leaving her free to scramble to the safety of a narrow tunnel within one of the nearby mounds.";
...
to say mgob_vicsex1:	[m-gob vaginal sex]
	...
	say "     You inevitably move to mount him, your affections sufficient enough to drive the goblin to arousal. [if scalevalue of Player > 3]He'd doubtlessly be more obliging towards these turn of events if you didn't tower over him as much as you do now, perhaps quick to fear you'd crush him under the weight of your [Body Size Adjective of Player], [bodydesc of Player] body[else]He can probably live with his loss if it leads to something like this, encouraging your use of his tool by stroking your [bodydesc of Player] form with his free hands[end if]. You moan in approval as his cock sinks into the depths of [if Cunt Count of Player > 1]one of [end if]your [cunt size desc of Player] cunt[sfn], [if Cunt Depth of Player > 12]and though his tool is too small to easily pleasure yourself, that isn't going to stop you from making full use of him[else]his rod gradually enveloped by the folds of your flesh[end if].";
	WaitLineBreak;
	if Player is male:
		if scalevalue of Player > 4:
			say "     The small creature eclipsed under your form, your hands move to stroke your hardening cock[smn]. [if Cock Count of Player > 2]Two of them in your grasp[else if Cock Count of Player is 2]Both of them in your grasp[else]With your [cock size desc of Player] tool in your grasp[end if], you're not about to let your beleaguered companion be the sole progenitor of your pleasure. So small compared to you, he at least gets the small mercy of your organ aimed well over him, [if Ball Size of Player >= 5]though you could only imagine this sentiment as he's buried under your [Ball Size Adjective of Player] [Balls][else]though he is perhaps more distracted by having to contend with your troubling weight[end if].";
			say "     Riding his cock, it's not long before your irreverent hold on him elicits his release, the warmth of his fluids flooding your depths, wracking you with the throes of your own subsequent release. Cock[smn] shooting [itstheirm] load clear across the open air, you unleash a [Cum Load Size of Player] load that makes a [if Ball Size of Player >= 6]considerable[else]fair[end if] mess of the surrounding scenery, milking him of every last drop before you finally relent.";
		else if scalevalue of Player is 4:
			say "     The small creature eclipsed under your form, your hands move to stroke your hardening cock[smn]. [if Cock Count of Player > 2]Two of them in your grasp[else if Cock Count of Player is 2]Both of them in your grasp[else]Your [cock size desc of Player] tool in your grasp[end if], you're not about to let your beleaguered companion be the sole progenitor of your pleasure, his expression a lust-addled horror while he contends with the fact that [if Cock Count of Player > 1]they're[else]it's[end if] aimed directly at him, [if Ball Size of Player >= 6]and with one look at the load you're packing it's clear that the end result will be quite a mess[else]and you might find his desire to remain clean of your fluids meritable if his face wasn't already quite unkempt[end if].";
			say "     Riding his cock, it's not long before your irreverent hold on him elicits his release, the warmth of his fluids flooding your depths, wracking you with the throes of your own subsequent release. Cock[smn] firing [itstheirm] load straight into the goblin's exposed face, you unleash a [Cum Load Size of Player] load that makes a [if Ball Size of Player >= 6]considerable[else]fair[end if] mess of the diminutive creature's face, milking him of every last drop before you finally relent.";
		else:
			say "     Moving his hands to fondle your [if Breast Size of Player > 0][breast size desc of Player] breasts[else]torso[end if], your own shift to stroke your hardening cock[smn]. [if Cock Count of Player > 2]Two of them in your grasp[else if Cock Count of Player is 2]Both of them in your grasp[else]Your [cock size desc of Player] tool in your grasp[end if], you're not about to let your beleaguered companion be the sole progenitor of your pleasure, his expression a lust-addled horror while he contends with the fact that [if Cock Count of Player > 1]they're[else]it's[end if] aimed directly at him, [if Ball Size of Player >= 6]and with one look at the load you're packing it's clear that the end result will be quite a mess[else]and you might find his desire to remain clean of your fluids meritable if he wasn't already quite dirty[end if].";
			say "     Riding his cock, it's not long before your irreverent hold on him elicits his release, [if scalevalue of Player > 3]the subsequent flood of his fluids barely registering against your larger frame[else]the warmth of his fluids flooding your depths[end if], wracking you with the throes of your own subsequent release. Cock[smn] firing [itstheirm] load straight into the goblin's exposed face, you unleash a [Cum Load Size of Player] load that makes a [if Ball Size of Player >= 6]considerable[else]fair[end if] mess of the [if scalevalue of Player > 2]diminutive [end if]creature's face, milking him of every last drop before you finally relent.";
	else if Cunt Depth of Player > 12:
		say "     Riding his cock, it's not long before your irreverent hold on him elicits his release, [if scalevalue of Player > 3]the subsequent flood of his fluids barely registering against your larger frame[else]the warmth of his fluids flooding your depths[end if]; however, this isn't nearly enough to get yourself off, forcing the [if scalevalue of Player > 2]diminutive [end if]goblin to endure your persistent abuse, forcing him to orgasm a number of additional times before you achieve your bliss, milking the poor creature dry before you finally relent.";
	else:
		say "     Riding his cock, it's not long before your irreverent hold on him elicits his release, [if scalevalue of Player > 3]the subsequent flood of his fluids barely registering against your larger frame[else]the warmth of his fluids flooding your depths[end if], wracking you with the throes of your own subsequent release. [if scalevalue of Player > 3]Straining the goblin even further as you more firmly pin him down[else]Tightening your grip around the goblin[end if], your greedy hole milks the creature of his seed [']til naught remains before you finally relent.";
...
to say mgob_vicsex2:	[m-gob anal sex]
	if scalevalue of Player > 4:
		say "     Approaching him, you immediately rip free his tattered loincloth, leaving his diminutive behind naked in the middle of the open air. [if scalevalue of Player > 3]You can see him visibly tremble, clearly not sure what to expect from someone as large as you[else]Perhaps too weak to contend your assault, he doesn't give you any trouble when you assess your inevitable angle of descent[end if]. Freeing yourself of any bindings, you grab the small creature, stroking [if Cock Count of Player > 1]one of [end if]your now-exposed dick[smn] before driving your hardened cock into his hole.";
	else:
		say "     Approaching him, you immediately rip free his tattered loincloth, leaving his diminutive behind naked in the middle of the open air. [if scalevalue of Player > 3]You can see him visibly tremble, clearly not sure what to expect from someone as large as you[else]Perhaps too weak to contend your assault, he doesn't give you any trouble when you assess your inevitable angle of descent[end if]. Freeing yourself of any bindings, you grab him by his sides and grind [if Cock Count of Player > 1]one of [end if]your now-exposed dick[smn] between his asscheeks before driving your hardened cock into his hole.";
	...
	WaitLineBreak;
	if Ball Size of Player >= 6:
		say "     [if Cock Length of Player >= 9]Your [cock size desc of Player] intrusion triggering his own orgasm, you[else]You[end if] begin pumping an unholy amount of cum into his beleaguered hole, bloating him almost immediately until each successive spurt finds escape by squirting out around your cock[if Cock Count of Player > 2], your exposed members firing impotently until the goblin is practically swimming in a puddle of your sexual fluids[else if Cock Count of Player is 2], your exposed member firing impotently until the goblin is practically swimming in a puddle of your sexual fluids[end if].";
	else:
		say "     [if Cock Length of Player >= 9]Your [cock size desc of Player] intrusion triggering his own orgasm, you[else]You[end if] pump the poor beast full of your cum, [if Cock Count of Player > 2]your exposed members firing impotently against the goblin, further cementing his humiliation as you make a mess of his ragged attire[else if Cock Count of Player is 2]your exposed member firing impotently against the goblin, further cementing his humiliation as you make a mess of his ragged attire[else]forcing the goblin to writhe impotently against the earth as your warmth floods his bowels[end if].";
...
to say mgob_vicsex3:	[m-gob oral sex]
	if Player is male and (Player is not female or a random chance of 1 in 2 succeeds):
		say "     Grinning, [if scalevalue of Player > 4]you set yourself down, pulling the creature to your massive form[else]you set yourself down, relinquishing yourself of any attire that might get in the way and pulling the creature to you[end if]. Clarifying his already quite apparent mission, you gesture down to your cock[smn].";
		if Cock Length of Player >= 18:
			say "     At first he's a bit apprehensive, clearly unsure about how he'd go about pleasuring such [if Cock Count of Player is 1]a [end if][cock size desc of Player] tool[smn], but he's inevitably coaxed into improvising with a little forceful encouragement. Grabbing [if Cock Count of Player > 2]two of them[else if Cock Count of Player is 2]both of them[else]the organ[end if] with both hands, his tongue moves to caress the length of [if Cock Count of Player > 1]one of them[else]the shaft[end if]. He's clearly quite dexterous and seems to perform fairly well in spite the circumstances, driving you into arousal with desired expedience.";
			WaitLineBreak;
			if Cock Count of Player is 1:
			...
			say "     His involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, the [if Ball Size of Player >= 6]poor goblin getting absolutely drenched in your torrential release. You get up, letting the cum-coated creature[else]goblin snorting in slight surprise before relinquishing his lips['] hold to cough free some of your cum. You get up, letting him[end if] free and watch him scramble away to a small tunnel in one of the nearby junk mounds. With him gone, you can turn your attention back to other matters.";
		else:
			say "     At first he appears a bit sheepish to the concept of contending with your [cock size desc of Player] tool[smn], but it only takes a moment of forceful coaxing before he's compliant. Grabbing [if Cock Count of Player > 2]two of them[else if Cock Count of Player is 2]both of them[else]the organ[end if] with both hands, his tongue moves to caress the length of [if Cock Count of Player > 1]one of them[else]the shaft[end if]. He's clearly quite dexterous and seems innately adept at this performance.";
			WaitLineBreak;
			if Cock Count of Player is 1:
			...
			say "     His involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, the [if Ball Size of Player >= 6]poor goblin getting absolutely drenched in your torrential release. You get up, letting the cum-coated creature[else]goblin briefly and audibly gagging before he complicity swallows your subsequently load. You get up, letting him[end if] free and watch him scramble away to a small tunnel in one of the nearby junk mounds. With him gone, you can turn your attention back to other matters.";
		CreatureSexAftermath "Goblin" receives "OralCock" from "Player";
	else:
		say "     Grinning, [if scalevalue of Player > 4]you set yourself down, pulling the creature to your massive form[else]you set yourself down, relinquishing yourself of any attire that might get in the way and pulling the creature to you[end if]. Clarifying his already quite apparent mission, you gesture down to your [cunt size desc of Player] cunt[sfn].";
		say "     At first he appears a bit sheepish to the concept of contending with [if Cunt Count of Player > 1]one of [end if]your hole[sfn], but it only takes a moment of forceful coaxing before he's compliant. Fingers teasing [if Cunt Count of Player > 2]the soft lips of two of them[else if Cunt Count of Player is 2]the soft lips of both of them[else]its soft lips[end if], his tongue moves to caress [if Cunt Count of Player > 1]one of their[else]its[end if] clit[sfn], invariably tasting your emergent feminine fluids. He's clearly quite dexterous and seems innately adept at this performance.";
		if Cunt Count of Player is 1:
			WaitLineBreak;
			say "     [if Cock Count of Player > 1]Main hand kept busy, he shifts his offhand to assault one of your hardening cocks, gently stroking it in turn as he continues his main endeavors. [else if Player is male]Main hand kept busy, he shifts his offhand to assault your exposed cock, gently stroking it in turn as he continues his main endeavors. [else if anallevel > 1]Main hand kept busy, he shifts his offhand to assault your exposed anal ring, lightly teasing it in turn as he continues his main endeavors. [end if]His tongue moves to aid his digits as they flood the depths of your cunt. The efficacy of his endeavors becomes quickly apparent as each successive thrust of his tongue sends bolts of pleasure through your [if scalevalue of Player > 3]massive [end if]frame.";
		if Libido of Player > 50:
			say "     His involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, [if Player is male]your cock[smn] erupting with [itstheirm] load against you as the goblin briefly contends[else]the goblin briefly contending[end if] with your gushing portal. You get up, leaving him free to scramble to the safety of a narrow tunnel within one of the nearby mounds.";
		else:
			say "     His involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, the goblin briefly contending with your gushing portal. You get up, leaving him free to scramble to the safety of a narrow tunnel within one of the nearby mounds.";
		CreatureSexAftermath "Goblin" receives "OralPussy" from "Player";

to say mgob_vicsex4:	[m-gob urethral sex]
	say "     Holding [if Cock Count of Player > 1]one of [end if]your [cock size desc of Player] tool[smn] before the creature, his jaw is agape. That thing is not going to fit anywhere on him! Knowing this, however, you soon make it clear that you have something even more perverse in store for him.";
	...
	say "     Gradually, you move to fuck his dick proper, each subsequent thrust met with tremors of sharp pleasure. As you build up pace, the creature - obliging as he may be to this lewd ritual - is nonetheless dug into the dirt by your elevating fervor, and your endeavors are expediently rewarded as [if Libido of Player > 49]soon you cry[else]your victim soon cries[end if] out in blissful release.";
	WaitLineBreak;
	if Libido of Player > 49:
		say "     No doubt this entire bout has been of little detriment to your victim up to this point, but that's quick to change when his cock is assaulted with a flood of your cum. Dick firmly hilted into his crotch, the subsequent path of least resistance is apparent when your sexual fluids are pumped into the goblin. Now writhing in twisted pleasure, his conflict is immediately visualized when his balls are [if Ball Size of Player >= 5]profusely inflated with your massive[else]inflated with your[end if] load, quickly forcing him to orgasm himself.";
		say "     Your tapering flow is suddenly reversed when your victim counters with his own, now-augmented load, and you can't help but gasp as your own wanton discharge is returned to you in spades, your [Ball Size Adjective of Player] [Balls][if Ball Size of Player >= 5], however, barely expanding to accommodate his paltry contribution[else] expanding to accommodate his contribution[end if].";
		...
		say "     Like a bolt of lightning you feel his load fire through your urethra, all the way down to your [Ball Size Adjective of Player] [Balls], your package [if Ball Size of Player >= 5]barely bloating with his comparatively unimpressive release. His orgasm is certainly enough to trigger your own, so you set off to show him a -real- load[else]bloating visibly from his release. His orgasm is more than enough to trigger your own, granting you blissful retribution for his assault[end if].";
...
to say goblindesc:
	...
	say "     '[if gobdem is true][one of]Ha, you mine - MINE[or]No, no, bad, mine[or]Agh, you, bad - PUNISH[at random][else][one of]Eh, watch where you're going, this here is my turf[or]Oh, I'm going to have some fun with you[or]Looks like someone needs a lesson in not sticking their nose where it doesn't belong[at random][end if]!' The creature's devious grin exposing [ghis] sharp teeth, it's clear [ghe] has something else entirely in store for you.";
[ original desc:
...
When Play begins:
	...
	now attack entry is "The [one of]cackling goblin bites you[or]vicious goblin scratches at you with [ghis] sharp claws[or]little goblin jabs you in the leg with a small knife[or]goblin scrambles onto your back, clawing and scratching as [ghe] does[or]goblin manages to grab your throat with [ghis] surprisingly strong hands and tries to choke you[at random]!";
	...
	now skin change entry is "green flows across it like spilled paint until you're covered in leathery green skin. Your shoulders, feet and the tips of your ears are a brownish-green color";
	now ass change entry is "it becomes small and bony"; [ Ass/Tail TF text, format as "Your ass tingles as [tail change entry]." ]
	now cock change entry is "it becomes green in color and has a slightly more pointed shape";
	...
	now CumItem entry is "goblin cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
This is the Goblin Infection rule:
	if Player has a body of "Goblin":
		...
		say "     [if humanity of Player < 10]As your goblin body's instincts take over, you cackle to yourself and scamper off through the city. You are drawn back to the large junkyard at the edge of town. After some scurrying away from the bigger creatures there, you run into a goblin patrol. They welcome you before leading you through the junkpiles to their hidden warren. There are several warrens built into mounds across the junkyard. Inside, the goblins tinker with trash or scuffle with one another before sating their lusts. Joining the workers, you set to making traps from the trash. When the soldiers enter the city, your people are ready with traps scattered around the junkyard to help deal with those who manage to get past its larger defenders. Those caught in goblin snares are dragged back to the warrens to be raped and converted into more goblins[else]After your rescue and release, your stunted and warped body makes you somewhat of an outcast. Bitter about this, you start coming up with ideas for little traps to hurt or infect those who have slighted you. After making a small collection of these, you realize that your snares and traps can be sold to others. With the concern over thieves or assassins with infection-enhanced abilities growing in the minds of the populace, you set up a business installing security systems, traps and defenses for homes. You focus your clever and cruel thoughts into your work, using it as an outlet for your darker goblin instincts, letting you live a happier life. That and the money you charge rich people to help secure their homes from threats[end if].";
