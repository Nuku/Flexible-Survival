	...
	if Player is male and Cock Length of Player < 14 and a random chance of 1 in 2 succeeds:
		...
		if Player is submissive or HP of Player > 0:
			...
			if gobdem is true:
				...
				say "     '[if scalevalue of Player > 3][one of]Oh, I think my new big friend likes eating pussy[or]Ha, what a massive slut[or]Hm, what a big toy[at random][else][one of]Oh, it looks like someone enjoys eating pussy[or]Ha, look at that slut go[or]I think you're a natural at being a toy[at random][end if]";
		else:
	...
	if anallevel > 1 and Player is male and Cock Length of Player < 15 and a random chance of 1 in 6 succeeds:
		...
		if Cunt Depth of Player > 15:
			...
			if Player is male:
				...
				say "!' Slowly building up a pace of fucking you proper, he starts causing you to tremble in[if HP of Player < 1] forcibly imposed[end if] pleasure as he abuses your hole. He continues to fondle your unattended cunt[if Cunt Count of Player > 3]s, eventually forcing a finger past two of them[else if Cunt Count of Player is 3]s, eventually forcing a finger past both of them[else], eventually forcing a finger into its depths[end if]. Quite the tenacious goblin, [if HP of Player > 0]you can't help but credit him for his[else]he's certainly not lacking in[end if] ability to multitask, at least";
			else if Breast Size of Player > 0:
				...
				say "!' Slowly building up a pace of fucking you proper, he starts causing you to tremble in[if HP of Player < 1] forcibly imposed[end if] pleasure as he abuses your hole. His grip tightens against your [bodydesc of Player] form, idling fondling you as he continues to pound you";
		...
		if Player is submissive or HP of Player > 0:
			...
			if gobdem is true:
				...
				say "     '[if scalevalue of Player > 3][one of]Oh, I think my new big friend likes sucking dick[or]Ha, what a massive slut[or]Hm, what a big cum dumpster[at random][else][one of]Oh, it looks like someone enjoys sucking dick[or]Ha, look at that slut go[or]I think you're a natural at being a cum dumpster[at random][end if]";
		else:
...
to say fgob_vicsex3_m:
	if Cock Length of Player >= 18:
		...
		say "     Her involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, [if Ball Size of Player >= 6]the poor goblin getting absolutely drenched in your torrential release[else]the goblin snorting in slight surprise before relinquishing her lips['] hold to cough free some of your cum[end if]. You get up, letting [if Ball Size of Player >= 6]the cum-coated creature[else]her[end if] free and watch her scramble away to a small tunnel in one of the nearby junk mounds. With her gone, you can turn your attention back to other matters.";
	else:
		...
		say "     Her involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, [if Ball Size of Player >= 6]the poor goblin getting absolutely drenched in your torrential release[else] the goblin briefly and audibly gagging before she complicity swallows your subsequent load[end if]. You get up, letting [if Ball Size of Player >= 6]the cum-coated creature[else]her[end if] free and watch her scramble away to a small tunnel in one of the nearby junk mounds. With her gone, you can turn your attention back to other matters.";
...
to say mgob_vicsex1:	[m-gob vaginal sex]
	...
	if Player is male:
		if scalevalue of Player > 4:
			...
			say "     Riding his cock, it's not long before your irreverent hold on him elicits his release, the warmth of his fluids flooding your depths, wracking you with the throes of your own subsequent release. Cock[smn] shooting [if Cock Count of Player > 1]their[else]its[end if] load clear across the open air, you unleash a [Cum Load Size of Player] load that makes a [if Ball Size of Player >= 6]considerable[else]fair[end if] mess of the surrounding scenery, milking him of every last drop before you finally relent.";
			...
			say "     Riding his cock, it's not long before your irreverent hold on him elicits his release, the warmth of his fluids flooding your depths, wracking you with the throes of your own subsequent release. Cock[smn] firing [if Cock Count of Player > 1]their[else]its[end if] load straight into the goblin's exposed face, you unleash a [Cum Load Size of Player] load that makes a [if Ball Size of Player >= 6]considerable[else]fair[end if] mess of the diminutive creature's face, milking him of every last drop before you finally relent.";
		else:
...
to say mgob_vicsex3_m:	[m-gob oral m-player]
	if Cock Length of Player >= 18:
		...
		say "     His involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, [if Ball Size of Player >= 6]the poor goblin getting absolutely drenched in your torrential release[else]the goblin snorting in slight surprise before relinquishing his lips['] hold to cough free some of your cum[end if]. You get up, letting [if Ball Size of Player >= 6]the cum-coated creature[else]him[end if] free and watch him scramble away to a small tunnel in one of the nearby junk mounds. With him gone, you can turn your attention back to other matters.";
	else:
...
to say mgob_vicsex3_f:	[m-gob oral f-player]
	...
	if Libido of Player > 50:
		say "     His involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, [if Cock Count of Player > 1]your cocks erupting with their load against you as the goblin briefly contends[else if Player is male]your cock erupting with its load against you as the goblin briefly contends[else]the goblin briefly contending[end if] with your gushing portal. You get up, leaving him free to scramble to the safety of a narrow tunnel within one of the nearby mounds.";
	else:
...
When Play begins:
	...
	now skin change entry is "green flows across your skin like spilled paint until you're covered in leathery, green skin. Your shoulders, feet and the tips of your ears are a brownish-green color";
