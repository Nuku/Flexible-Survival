	...
	if anallevel > 1 and player is male and cock length of player < 15 and a random chance of 1 in 6 succeeds:
		...
		If scalevalue of player > 3:
			...
			if player is neuter:
				...
				say "     Unable to hold back for any longer, your cock[smn] erupt[smv], [if cock width of player > 24]your exposed face and upper torso immediately getting hosed with your [cum load size of player] load[else if cock width of player > 12]firing its [cum load size of player] load impotently against your torso and face[else]firing its [cum load size of player] load impotently against your torso[end if]. The tightening of your [if HP of player > 0]greedy[else]assailed[end if] ring forcing the goblin to climax himself, his own seed flooding your fleshy abyss.";
				if gobdem is true:
					say "[one of]Ah, ha, ha[or]Oh, heh, ah[or]Heh, mine, ah[at random]";
				else:
					say "[if scalevalue of player > 3][one of]Whew, ah, what a ride[or]Ah, give me a second, big one[or]Heh, I still have the magic touch, even with someone so large[at random][else][one of]Oh, you've gone and made a mess of yourself[or]Whew, I'm going to need a second[or]Ho boy, what a ride[at random][end if]";
...
to say fgob_vicsex3_m:
	...
	if cock length of player >= 18:
		...
		say "     Her involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, [if cock width of player >= 24]the poor goblin getting absolutely drenched in your torrential release[else]the goblin snorting in slight surprise before relinquishing her lip's hold to cough free some of your cum[end if]. You get up, letting [if cock width of player >= 24]the cum-coated creature[else]her[end if] free and watch her scramble away to a small tunnel in one of the nearby junk mounds. With her gone, you can turn your attention back to other matters.";
	else:
		...
		say "     Her involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, [if cock width of player >= 24]the poor goblin getting absolutely drenched in your torrential release[else] the goblin briefly and audibly gagging before she complicity swallows your subsequently load[end if]. You get up, letting [if cock width of player >= 24]the cum-coated creature[else]her[end if] free and watch her scramble away to a small tunnel in one of the nearby junk mounds. With her gone, you can turn your attention back to other matters.";
...
to say mgob_vicsex3_m:	[m-gob oral m-player]
	...
	if cock length of player >= 18:
		...
		say "     His involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, [if cock width of player >= 24]the poor goblin getting absolutely drenched in your torrential release[else] the goblin snorting in slight surprise before relinquishing his lip's hold to cough free some of your cum[end if]. You get up, letting [if cock width of player >= 24]the cum-coated creature[else]him[end if] free and watch him scramble away to a small tunnel in one of the nearby junk mounds. With him gone, you can turn your attention back to other matters.";
	else:
		...
		say "     His involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, [if cock width of player >= 24]the poor goblin getting absolutely drenched in your torrential release[else]the goblin briefly and audibly gagging before he complicity swallows your subsequently load[end if]. You get up, letting [if cock width of player >= 24]the cum-coated creature[else]him[end if] free and watch him scramble away to a small tunnel in one of the nearby junk mounds. With him gone, you can turn your attention back to other matters.";
...
to say mgob_vicsex4:	[m-gob urethral sex]
	...
	If libido of player > 49:
		...
		say "     Your tapering flow is suddenly reversed when your victim counters with his own, now-augmented load, and you can't help but gasp as your own wanton discharge is returned to you in spades, your [ball size][if cock width of player >= 24], however, barely expand to accommodate his paltry contribution[else] expanding to accommodate his contribution[end if].";
