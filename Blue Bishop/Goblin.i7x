...
to say losetogob_m:
	...
	if anallevel > 1 and player is male and Cock Length of Player < 15 and a random chance of 1 in 6 succeeds:
		...
		if gobdem is true:
			...
			say "[if Cock Length of Player > 8][one of]Nng, this is going to be a challenge[or]Ah, oh, don't think I can't handle you[or]Ah, ooh, this is going to take a bit of work[at random][else][one of]Oh, this'll be a fun ride[or]Ah, I couldn't resist taking this bad boy out for a ride[or]Ooh, the fun's just started here[at random][end if]";
		say "!' Hands stroking your [bodydesc of Player] torso as he builds up a motion, he's quick to illustrate a manic fervor in pumping himself against your hardened organ, [if scalevalue of Player > 3]though such a diminutive creature barely registers against your substantially larger form, his sickeningly rapid motion against your member nonetheless has an effect on you[else]his dizzying motions pushing you back and forth with sickening rapidity[end if][if Cock Count of Player > 3]. In his endeavors, he instinctually grabs two of your free dicks, frotting them wildly against his own in wanton fury[else if Cock Count of Player is 3]. In his endeavors, he instinctually grabs both of your free dicks, frotting them wildly against his own in wanton fury[else if Cock Count of Player is 2]. In his endeavors, he instinctually grabs your free dick, frotting it wildly against his own in wanton fury[end if].";
		...
		if scalevalue of Player > 3:
			...
			if Player is neuter:
				...
				say "     Unable to hold back for any longer, your cock[smn] erupt[smv], [if ball size of Player > 24]your exposed face and upper torso immediately getting hosed with your [Cum Load Size of Player] load[else if ball size of Player > 12]firing its [Cum Load Size of Player] load impotently against your torso and face[else]firing its [Cum Load Size of Player] load impotently against your torso[end if]. The tightening of your [if HP of Player > 0]greedy[else]assailed[end if] ring forcing the goblin to climax himself, his own seed flooding your fleshy abyss.";
				if gobdem is true:
					say "[one of]Ah, ha, ha[or]Oh, heh, ah[or]Heh, mine, ah[at random]";
				else:
					say "[if scalevalue of Player > 3][one of]Whew, ah, what a ride[or]Ah, give me a second, big one[or]Heh, I still have the magic touch, even with someone so large[at random][else][one of]Oh, you've gone and made a mess of yourself[or]Whew, I'm going to need a second[or]Ho boy, what a ride[at random][end if]";
		...
		if Cunt Length of Player > 15:
			...
			if Cunt Length of Player > 15:
				...
				if Player is male:
					say "     Unable to hold back for any longer, your [if Cock Count of Player > 1]cocks erupt[else]cock erupts[end if], [if ball size of Player > 24]your exposed face and upper torso immediately getting hosed with your [Cum Load Size of Player] load[else if ball size of Player > 12]firing its [Cum Load Size of Player] load impotently against your torso and face[else]firing its [Cum Load Size of Player] load impotently against your torso[end if]. The tightening of your [if HP of Player > 0]greedy[else]assailed[end if] lips forcing the goblin to climax himself, his own seed flooding your womb.";
					if gobdem is true:
						say "[one of]Ah, ha, ha[or]Oh, heh, ah[or]Heh, mine, ah[at random]";
					else:
						say "[if scalevalue of Player > 3][one of]Whew, ah, what a ride[or]Ah, give me a second, big one[or]Heh, I still have the magic touch, even with someone so large[at random][else][one of]Oh, you've gone and made a mess of yourself[or]Whew, I'm going to need a second[or]Ho boy, what a ride[at random][end if]";
...
to say fgob_vicsex3_m:
	...
	if Cock Length of Player >= 18:
		...
		say "     Her involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, [if ball size of Player >= 24]the poor goblin getting absolutely drenched in your torrential release[else]the goblin snorting in slight surprise before relinquishing her lip's hold to cough free some of your cum[end if]. You get up, letting [if ball size of Player >= 24]the cum-coated creature[else]her[end if] free and watch her scramble away to a small tunnel in one of the nearby junk mounds. With her gone, you can turn your attention back to other matters.";
	else:
		...
		say "     Her involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, [if ball size of Player >= 24]the poor goblin getting absolutely drenched in your torrential release[else] the goblin briefly and audibly gagging before she complicity swallows your subsequently load[end if]. You get up, letting [if ball size of Player >= 24]the cum-coated creature[else]her[end if] free and watch her scramble away to a small tunnel in one of the nearby junk mounds. With her gone, you can turn your attention back to other matters.";
...
to say mgob_vicsex3_m:	[m-gob oral m-player]
	...
	if Cock Length of Player >= 18:
		...
		say "     His involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, [if ball size of Player >= 24]the poor goblin getting absolutely drenched in your torrential release[else] the goblin snorting in slight surprise before relinquishing his lip's hold to cough free some of your cum[end if]. You get up, letting [if ball size of Player >= 24]the cum-coated creature[else]him[end if] free and watch him scramble away to a small tunnel in one of the nearby junk mounds. With him gone, you can turn your attention back to other matters.";
	else:
		...
		say "     His involuntary endeavors are sweetly rewarded, a moan escaping your lips in celebration of your release, [if ball size of Player >= 24]the poor goblin getting absolutely drenched in your torrential release[else]the goblin briefly and audibly gagging before he complicity swallows your subsequently load[end if]. You get up, letting [if ball size of Player >= 24]the cum-coated creature[else]him[end if] free and watch him scramble away to a small tunnel in one of the nearby junk mounds. With him gone, you can turn your attention back to other matters.";
...
to say mgob_vicsex4:	[m-gob urethral sex]
	...
	if Libido of Player > 49:
		...
		say "     No doubt this entire bout has been of little detriment to your victim up to this point, but that's quick to change when his cock is assaulted with a flood of your cum. Dick firmly hilted into his crotch, the subsequent path of least resistance is apparent when your sexual fluids are pumped into the goblin. Now writhing in twisted pleasure, his conflict is immediately visualized when his balls are [if ball size of Player >= 24]profusely inflated with your massive[else]inflated with your[end if] load, quickly forcing him to orgasm himself.";
		say "     Your tapering flow is suddenly reversed when your victim counters with his own, now-augmented load, and you can't help but gasp as your own wanton discharge is returned to you in spades, your [ball size][if ball size of Player >= 24], however, barely expand to accommodate his paltry contribution[else] expanding to accommodate his contribution[end if].";
