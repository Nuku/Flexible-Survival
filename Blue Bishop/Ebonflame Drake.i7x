...
to say ebdrakevic:
	...
	if anallevel > 1 and (Player is not female or anallevel is 3) and (a random chance of 1 in 2 succeeds or (anallevel is 3 and a random chance of 1 in 3 succeeds)):
		...
		say "     Her plans become clear when you feel the tip of one of her talons caress along the crevice of your sore behind, teasing you before the razor sharp thing forces its way through[if Cunt Count of Player > 1] one of[end if] your cunt[sfn]. She cackles as you tremble against her digit so casually shaming you.";
		say "     '[one of]Such a soft hole, I'm going to take great joy in ravaging it[or]I'm going to love tearing you in half[or]Oh, don't worry, you're not going to feel a thing... After I'm done with you[at random]!' Finally pulling the talon free, it's apparent she wanted to humiliate you more than prepare, [if scalevalue of Player > 3]climbing on top of[else]positioning herself behind[end if] you before the pointed tip of the reptile's savage dick briefly presses against your supple lips. Immediately, she plunges the massive thing as far in as she can, grunting as she forces what remains with successive thrusts. Not only is it apparent that she doesn't care to prepare you, but she actively enjoys hearing you howl in pain as her sharp barbs dig into your tender flesh, laughing and mocking you all along the way.";
		WaitLineBreak;
		...
		say "     The dragoness circles around your [if scalevalue of Player > 3]larger, [bodytype of Player] form, wrapping both[else][bodytype of Player] form, wrapping one[end if] of her scaled hands around your neck, pulling your head forward until you're forced to stare down her glowing eyes.";
		...
		say "     '[one of]Satisfy my need[or]Pay the tribute[or]Suck me off[at random], [one of]whelp[or]fool[or]plaything[at random], [one of]and maybe I'll let you off[or]and perhaps you'll live to see another day[or]or I'll be sure to prolong your suffering[at random]!' Guided by her forceful grip, the pointed tip of her draconic dick is plunged between your lips, taste flooded with the intense sensation of her molten, glowing seed. Forced to bob against the organ, its barbs do nothing but make your efforts more difficult, though she's dead set on making sure you don't slow down.";
		WaitLineBreak;
		...
		say "     You feel like you briefly black out from the intense sensation. When you regain your thoughts, it seems she had pushed you off of her and left you abandoned, a faint memory of her mocking laughter and the intense pain of being full with her molten seed all she's left you with. Once the discomfort subsides and your head clears, you're able to scramble off someplace safe.";
...
When Play begins:
	...
	now attack entry is "[one of]The drake[or]The terrifying reptile[or]She[or]The dragoness[at random] [one of]lets out a savage howl and charges at you, raking you with one of her savage talons and sending you reeling[or]grabs your [if scalevalue of Player > 4]larger, [bodytype of Player] form, displaying her superior strength as she lifts you into the air before slamming you against the ground, causing the earth to tremble under your heavy impact[else][bodytype of Player] form, easily lifting you into the air before slamming you against the ground with an audible thud[end if][or]pounces you and assaults you with a barrage of tooth and claw, until you finally push her off and back away[or]manages to lash you with her powerful tail, singing through the air before assaulting you with a sharp and terrible pain[at random].";
	now defeated entry is "[ebdrakedef]";
	now victory entry is "[ebdrakevic]";
	now desc entry is "[ebdrakedesc]";
	now face entry is "of a distinctly draconic head, a pair of horns sprouting from its sides, curving back such that the tips nearly connect behind you. A set of faintly glowing, fiery eyes match the fierce set of teeth arraying your face";
	now body entry is "tall and powerful. Your hands wield a fearsome set of claws, though they can be sheathed to not obstruct your articulation, and a similar set adorn your now digitigrade feet. A set of underdeveloped wings also adorn your back";
	now skin entry is "[if looknow is true]an array of [one of]deeply[or]abyssally[at random] dark purple scales for[else][one of]deeply[or]abyssally[at random] dark purple-scaled[end if]";
	...
	now face change entry is "a searing pain wracks your face. You cry out as bone and skin crack and stretch to accommodate a new shape. Once the pain subsides, your head is revealed to have taken on the reptilian form of an ebonflame drake, elongated snout adorned with an array of razor-sharp teeth and a pair of glowing, fire-red eyes. A long pair of horns seem to have erupted from the back of your head, curving such that the tips almost touch";
	now body change entry is "it suddenly becomes engulfed in a terrible, burning pain. Falling to your knees, you nearly pass out from the intense sensation as limbs both old and new undergo a very aggressive transformation. When you recover, you find that you've taken on a tall, humanoid form, hands and feet transformed into fierce talons that take you a while to acclimate to. Additionally, you appear to have grown a set of wings on your back, but they seem underdeveloped and you're too inexperienced to really make much use of them";
...
This is the Ebonflame Drake Infection rule:
	if Player has a body of "Ebonflame Drake":
		...
		if humanity of Player < 10:
			say "     Overcome by your powerful, draconic infection, you're pulled inexorably towards your kin, informed by your dark, fiery strain on how you must act. [if Player is submissive]However, you are twisted by your submissive inclinations to serve your sisters as their plaything, often abused when there's no proper victim to take your place. You take a deep thrill in being subjugated by your own kind[else]You are forced to fight with your sisters until you prove your worth, soon joining them afterwards to sate your need on the many remaining victims in the city[end if].";
