	...
	if Player has a body of "Ebonflame Drake":
		...
		if humanity of Player < 10:
			...
			if Player is submissive and Player is kinky:
				...
				say "     Eventually, everything blurs into a haze of constant sex, you never even learn what dark powers compelled you, or if they achieved whatever it was that they sought...";
		else:
