...
to say Yamato Dragon attack:
	...
	if vorelevel is 3 and (a random chance of 1 in 3 succeeds or (player is kinky and a random chance of 1 in 3 succeeds)):
		...
		if "Touched by Madness" is listed in feats of player and cocks of player > 0 and cock length of player < 20 and ((player is kinky and a random chance of 1 in 2 succeeds) or (player is not kinky and a random chance of 1 in 5 succeeds)):
			...
			if anallevel > 1 and (cunts of player is 0 or anallevel is 3) and (a random chance of 1 in 3 succeeds or (anallevel is 3 and a random chance of 1 in 4 succeeds)):
				...
				if MYDGM is 0:
					say ". It appears he commands some otherworldly attribute, able to impale you with his organ in spite your [if cunt width of player < 10]very apparent[else]prior[end if] limitations[if cunt width of player < 20], parting your vulnerable cunt to a degree beyond any prior comprehension[end if]";
					now MYDGM is 1;
				else:
				...
				if "Modest Organs" is not listed in feats of player and (cunt length of player < 24 or cunt width of player < 15):
					...
					if "Microwaved" is listed in feats of player:
						...
						if player consents:
							...
							else if cunt width of player < 15:
								increase cunt width of player by 1;
							follow the cunt descr rule;
							say "You can see your [if cunts of player is 1][one of]cunt[or]pussy[or]vagina[or]cleft[at random] [one of]engorges[or]swells[or]throbs[at random][else][one of]cunts[or]pussies[or]vaginas[or]clefts[at random] [one of]engorge[or]swell[or]throb[at random][end if] as [if cunts of player is 1]it grows[else]they grow[end if] deeper into your body, becoming [descr]!";
						else:
				...
				if cocks of player > 0 or cunts of player > 0:
					say "[if cocks of player > 2]s, gripping two of your now-hardening, [cock size desc of player] cocks, putting you in an even more vulnerable position now that his sole hold on you is by your most sensitive organs[else if cocks of player is 2]s, gripping both of your now-hardening, [cock size desc of player] cocks, putting you in an even more vulnerable position now that his sole hold on you is by your most sensitive organs[else if cocks of player is 1]'s grip, latched onto your now-hardening, [cock size desc of player] cock, the other holding your similarly serpentine torso in place[else if cunts of player > 1]'s grip on your diminutive frame, freeing one to briefly tease one of your exposed cunts[else]'s grip on your diminutive frame, freeing one to briefly tease your exposed cunt[end if]. Eclipsing you in size, you can't help but shudder at the overwhelming sensation of his own tongue's reciprocation across [if cocks of player > 1]one of your cock's length[else if cocks of player is 1]the length of your cock[else]your [bodytype of player] form[end if].";
					say "     Massive, ridged organ inviting you to continue, your lips envelope the head of the dragon's dick and, in turn, he rewards your attendance with his own, draconic maw embracing [if cocks of player > 2]one of your own organs, pumping one of its exposed brothers[else if cocks of player is 2]one of your own organs, pumping its exposed brother[else if cocks of player > 0]your organ[else if cunts of player > 1]the one of your cunts[else if cunts of player > 0]your cunt[end if]. The [if HP of player < 1 and player is not submissive]victim[else]smaller[end if] half of this twisted ouroboros, ";
					if libido of player > 33:
						say "a muffled cry is quickly forced from your stuffed lips in blissful release, your subjugator[if cocks of player > 0] relentless in swallowing down your gushing, [cum load size of player] flood of sexual fluids[else]'s tongue relentless in pounding your gushing pussy[end if], [if cocks of player > 2]though gravity decides not to spare you when you're elongated torso is stained with the seed of your unengulfed cocks[else if cocks of player is 2]though gravity decides not to spare you when you're elongated torso is stained with the seed of your unengulfed cock[else if cocks of player > 0]greedily milking you of every last drop[else]driving you wild in throes of ecstasy[end if]. In the wake of this, you feel his talons push your head firm against his massive rod, lengthy frame abused to hilt the impressive organ entirely inside you, and subsequently forcing you to take the full brunt of the ensuing flood of his thick, virile seed.";
					else:
			...
			if anallevel > 1 and (cunts of player is 0 or anallevel is 3) and (a random chance of 1 in 3 succeeds or (anallevel is 3 and a random chance of 2 in 3 succeeds)):
				...
				if MYDAM is 0 and player is not twistcapped:
					...
					say "     Deep rumbles of tainted need escaping the dragon's lips, he sinks each progressive inch with at an foreboding diligence, the overwhelming sensation of such an intense violation rising at a seemingly endless pace until you abide his cock's head, now with substantial ease, given your overexposure. Pulling you back, against his rough frame, you're forced to watch yourself as he plunges ever-deeper, belly [if scalevalue of player is 3]already[else]quickly[end if] bulging with his overwhelming intrusion.";
				else if MYDAM is 3 or player is twistcapped:
				...
				if MYDAM is 0 and player is not twistcapped:
					say "     Beleaguered cries ripped from your lips, [if cocks of player > 0]your own, strained cock[smn] spending your [cum load size of player] load across your torso and the dragon's scales in the wake of his release[else if cunts of player > 0]cunt[sfn] dripping down across your crotch and the dragon's scales in the wake of his release[else]your weakened protests left disregarded[end if], his sexual fluids [if scalevalue of player is 3]immediately[else]quickly[end if] begins to sputter from your excessively stuffed hole, drenching your immensely sore backside until he finally subsides.";
					...
					say "     Beleaguered cries ripped from your lips, [if cocks of player > 0]your own, strained cock[smn] spending their [cum load size of player] load across your torso and the dragon's scales in the wake of his release[else if cunts of player > 0]cunt[sfn] dripping down across your crotch and the dragon's scales in the wake of his release[else]your weakened protests left disregarded[end if], his sexual fluids [if scalevalue of player is 3]quickly[else]eventually[end if] begins to sputter from your excessive stuffed hole, drenching your sore backside until he finally subsides.";
					say "     Finally wrenching his softening cock from your abused, [bodytype of player] form, the loud, wet sound of its departure filling the air, he casually drops you back onto the earth, causing you to fall to the ground once more, splashing into a pool of the dragon's still-hot spunk, made all the deeper by your leaking hole. The beast can't help but laugh at you in your pitiful state before he flies off. You don't nearly take as long to recover this time -- though you'll still be walking funny for a while -- and gather your things, departing from this tiring circumstance.[mimpregchance]";
				else if MYDAM is 2 and player is not twistcapped:
					say "     Beleaguered cries pulled from your lips, [if cocks of player > 0]your own, strained cock[smn] eagerly spending your [cum load size of player] load across your torso and the dragon's scales in the wake of his release[else if cunts of player > 0]cunt[sfn] eagerly dripping down across your crotch and the dragon's scales in the wake of his release[else]your protests muffled by your own tainted lust[end if], his sexual fluids [if scalevalue of player is 3]eventually[else]slowly[end if] begins to sputter from your excessively stuffed hole, painting your sore backside until he finally subsides.";
					...
					say "     Wanton moans squeezed from your lips, [if cocks of player > 0] your own, strained cock[smn] eagerly spending your [cum load size of player] load across your torso and the dragon's scales in the wake of his release[else if cunts of player > 0]cunt[sfn] eagerly dripping down across your crotch and the dragon's scales in the wake of his release[else]elicited by your tainted lust[end if], belly [if scalevalue of player is 3]quickly[else]gradually[end if] bloating as you take every last drop of his release, and losing yourself in a stupor of twisted hunger.";
				...
				say "     [if HP of player < 1 and player is not submissive]Making a final attempt to crawl free, you only encourage the over-sized reptile to pull you back by one of[else]Forced to gawk at the over-sized reptile, he offers you a twisted grin as he begins pulling you closer by[end if] your legs. Your front exposed, he buries his [if scalevalue of player < 5]massive[else]large[end if] snout between your thighs. Coarse scales grinding against you vulnerable, [bodytype of player] frame, you must abide his thick tongue's shameless attention, firmly caressing your [cunt size desc of player] cunt[sfn]. In the distance, forced to watch the crotch of his own serpentine form, you see his massive cock slowly growing hard against the open air.";
				if MYDGM is 0:
				...
				say " you of his slick appendage's influence, fore-talons replaced by hind as he lines the towering rod with [if cunts of player > 1]one of your exposed, saliva-slicked portals[else]your exposed, saliva-slicked portal[end if]. You're force to watch on as, slowly, his dick's pointed tip sinks past your hole's supple lips, spreading the beleaguered thing with such a persistent dedication, even as you [if cunt width of player > 20]gradually[else]quickly[end if] begins to be stretched to your absolute limits.";
				...
				if libido of player > 33:
					...
					say "     The dragon loudly announcing his bliss with a roar, you watch on, exhausted, as the dick's once-defined outline is quickly rounded off in the wake of his release, hot seed [if scalevalue of player < 5]quickly flooding you until it's forced to sputter from your stuffed cunt[else]gradually flooding you until you're absolutely bloated with the stuff[end if]. In the wake of this you cry out, wracked by the strained throes of your own orgasm, [cunt size desc of player] hole weakly squeezing against its [if cunt width of player < 20]over-sized [end if]invader[if cocks of player > 0] as your own cock[smn] waste[smv] your [cum load size of player] load against you and the creature's crotch[end if].";
				...
				if "Modest Organs" is not listed in feats of player and cock length of player < 24:
					...
					if "Microwaved" is listed in feats of player:
						...
						if player consents:
							...
							follow the cock descr rule;
							say "You can see your [if cocks of player is 1][one of]cock[or]penis[or]shaft[or]maleness[at random][else][one of]cocks[or]penises[or]shafts[or]malenesses[at random][end if] [one of]engorge[or]swell[or]throb[at random][smv] as [if cocks of player > 1]they gain[else]it gains[end if] in length, becoming [descr]!";
					else:
						if cock length of player < 18:
							increase cock length of player by 2;
						else:
...
to say YamatM_1: [Anal Pitching]
	...
	if cock length of player < 20 and cocks of player > 1:
		say "     Given how large he is, you figure you could fit [if cocks of player is 2]both[else]two[end if] of your cocks down his hole, shall you try?";
		if player consents:
			now tempnum2 is 1;
		else:
			now tempnum2 is 0;
	say "     Ready to take the plunge, you expose[if cocks of player is 2 and tempnum2 is 1] both of[else if tempnum2 is 1] two of[else if cocks of player > 1] one of[end if] your [cock size desc of player], half-aroused dick[smn]. Grinding [if tempnum2 is 1]them[else]it[end if] against the eager vent, the dragon faintly moans against your touch, [if tempnum is 1]his own rod oozing against the open air[else]slowly becoming aroused by the tease[end if], before you slowly sink the[if cockname of player is listed in infections of bluntlist] blunt[end if] head[if tempnum2 is 1]s[end if] past its scaled lips.";
	...
	if player consents:
		...
		say "     Putting all your energy into one final thrust, you [if cockname of player is listed in infections of knotlist]finally tie[else]hilt[end if] yourself with the dragon before crying out, your cock[smn] exploding with your [cum load size of player] load, flooding his bowels with your thick cum";
		if cocks of player > 1:
			...
			else if (tempnum2 is 1 and cocks of player > 2) or tempnum2 is 0:
				say " while [if tempnum2 is 1]their[else]its[end if] exposed brothers stain his coarse undercarriage";
...
to say YamatM_2: [Oral Receiving Cock]
	...
	if player consents:
		say "     His grip on you is fairly tight, practically pinning you to a tree, but you manage to order him off just before you cry out, aiming your now free, saliva-slicked dick[smn] at the dragon as you fire off your [cum load size of player] load, [if cock width of player > 24]utterly soaking[else]painting[end if] his snout with your thick cum. His brief confusion allows you to spend your entire load on him.";
...
to say YamatM_3: [Oral Receiving Cunt]
	say "     Making your decision, the dragon looms closely over your [if scalevalue of player < 5]significantly[else]slightly[end if] smaller, [bodytype of player] form, carefully helping you to reveal your assets before him until your [cunt size desc of player], partially aroused dick[if cunts of player > 1]s are[else] is[end if] exposed before his piercing gaze.";
	say "     '[one of]Hm[or]Yes[or]Very well[at random], [one of]this should be simple[or]such a paltry task[or]I hope this will satisfy you[at random]...' Large, thick tongue escaping his lips as he speaks, the slick, flexible thing has no trouble engulfing your crotch, puss[yfn] completely buried under the writhing, deep red flesh.";
	say "     His constant, unblinking gaze fixated on you, your [if scalevalue of player < 4]entire body[else]torso[end if] is bathed in his steamy breath, lower half disappearing under his scaled snout as his lips hilt against your crotch. As large as the serpent is, he seems extraordinarily dextrous with his tongue, able to squeeze and worm his way into your hole[sfn] with [if cunt length of player > 19]considerable[else]relative[end if] ease.";
	if cocks of player > 0:
		say "     His skillful work filling the air with the wet sounds of his tongue's efforts, it doesn't need long before you're brought to your very limit! Shall you pull out at the last second and shame him? Else, you'll reward the creature's diligence.";
		if player consents:
			say "     His grip on you is fairly tight, practically pinning you to a tree, but you manage to order him off just before you cry out, aiming your previously unattended, saliva-slicked dick[smn] at the dragon as you fire off your [cum load size of player] load, [if cock width of player > 24]utterly soaking[else]painting[end if] his snout with your thick cum. His brief confusion allows you to spend your entire load on him.";
			say "     '[one of]Hmpf[or]Well[at random], [one of]I think you have had your fun[or]I hope you are sufficiently amused[or]I suppose whatever suits your need[at random]...' Thick tongue licking clean his snout, he's clearly trying to hide his embarrassment behind a terse expression. Once the both of you are clean, the serpent flies off into the distance, leaving you to go about your business once more.";
		else:
...
to say YamatM_4: [Cunt Catching]
	if MYDGM is 0:
		say "     Eyeing the dragon up lewdly, [if scalevalue of player > 4]it's clear that, even at your size, he probably wouldn't fit.[run paragraph on][else]it's apparent that there's no chance he'd ever fit![run paragraph on][end if] He seems to pick up on your desire and grins darkly at you.";
		...
		say "     Eyeing the dragon up lewdly, you consider the prospect of riding his over-sized dick. He grins darkly at you once you make your request.";
	...
	if cunt length of player < 13:
		...
		if player consents:
			say "     Your words strained by the overwhelming intrusion, your over-sized companion eventually picks up on your plea.";
			...
			say "     Ever the tenacious -- or perhaps foolish -- you make the [if scalevalue of player > 3]slow[else]tremendous[end if] effort of pulling yourself up along your over-sized companion's overwhelming intrusion.";
		...
		if player consents:
			say "     Your words[if scalevalue of player > 3] slightly[end if] strained by the overwhelming intrusion, your over-sized companion eventually picks up on your plea.";
			say "     '[one of]Oh[or]Hmm[or]What[at random]? [one of]I thought you wanted to be in control[or]Seems someone bit off more than they could chew[or]Not so arrogant now, I imagine[at random]!' Teasing you as the dragon does, he does at least oblige your request, talons wrapping around you a second time. Gradually raising you up the rod, you can feel each ridge leave you, air already heavy with the scent of sex, loud with the organ's wet departure.";
			...
			say "     Ever the tenacious, you make the [if scalevalue of player > 3]slow[else]tremendous[end if] endeavor of pulling yourself up along your over-sized companion's overwhelming intrusion.";
		...
		if player consents:
			...
			say "     Ever the tenacious, you make the[if scalevalue of player < 5] slow[end if] endeavor of pulling yourself up along your over-sized companion's overwhelming intrusion.";
			...
			if player consents:
				...
				say "     Once you can't take it anymore you firmly hilt with him one last time. More than enough to set you off, [if cocks of player > 0]cock[smn] painting the dragon with your [cum load size of player] load[else]cunt firmly squeezing against the dragon's overwhelming intrusion[end if].";
...
to say YamatM_5: [Anal Catching]
	...
	if MYDAM is 0 and player is not twistcapped:
		...
		if player consents:
			...
			say "     At around the halfway point, he harshly plunges you back down on the briefly exposed length, loudly slapping against the serpent's scaled underbelly. Hit with a single, hard gout of precum sputtering from your strained hole, you immediately and unceremoniously orgasm, [if cocks of player > 0]cock[smn] painting the dragon with your [cum load size of player] load[else if cunts of player > 0]cunt[sfn] gushing and staining the dragon[else]much in spite your lack of proper outlet[end if]. The beast can't help but laugh at how you've clearly bit off more than you can chew.";
		...
		if player consents:
			say "     Your words[if scalevalue of player > 3] slightly[end if] strained by the overwhelming intrusion, your over-sized companion eventually picks up on your plea.";
			say "     '[one of]Oh[or]Hmm[or]What[at random]? [one of]I thought you wanted to be in control[or]Seems someone bit off more than they could chew[or]Not so arrogant now, I imagine[at random]!' Teasing you as the dragon does, he does at least oblige your request, talons wrapping around you a second time. Gradually raising you up the rod, you can feel each ridge leave you, air already heavy with the scent of sex, loud with the organ's wet departure.";
			say "     At around the halfway point, he harshly plunges you back down on the briefly exposed length, loudly slapping against the serpent's scaled underbelly, before repeating this ritual. With each successive, hard gout of precum sputtering from your strained hole, it becomes more and more difficult for you to restrain your orgasm. You put up a decent fight for a while, before you finally succumb, [if cocks of player > 0]cock[smn] painting the dragon with your [cum load size of player] load[else if cunts of player > 0]cunt[sfn] gushing and staining the dragon[else]much in spite your lack of proper outlet[end if]. The beast chuckles lowly at you.";
			...
			say "     '[one of]This should be fun to watch[or]Good luck[or]Take all the time you need[at random]...' Forcing yourself past each crevice is an ordeal in of itself, but you eventually manage to work something of a slow and methodical pace, building a humble motion against his rod. Occasional gouts of precum sputtering from your hole, it's a challenge to restrain your quickly rising bliss. Shall you give in? Otherwise, you'll try to keep your pace.";
			if player consents:
				say "     Firmly hilting with the dragon one last time, it's more than enough to set you off, [if cocks of player > 0]cock[smn] painting the dragon with your [cum load size of player] load[else if cunts of player > 0]cunt[sfn] gushing and staining the dragon[else]much in spite your lack of proper outlet[end if]. The beast chuckles lowly at you. You imagine he's going to try and take charge from here, but your will is strong enough to make a run for it. Shall you pull yourself free?";
				if player consents:
					say "     Eager to deny the serpent of his own bliss, or perhaps wanting to avoid any further abuse, you manage to push yourself free of his throbbing tool with your legs, a flood of precum leaking from your terribly stretched hole, before stumbling off the dragon and out of his reach. He appears briefly amused before becoming annoyed.";
					say "     '[one of]Tsk[or]Hmpf[or]Ha[at random], [one of]such arrogance[or]you sneaky little whelp[or]I should have known[at random]!' It's a challenge to put some distance between you and him, but he doesn't seem to pursue you, eventually deciding to take to the air once and depart, perhaps to find someone else to sate his lingering lust. It takes you a while to catch your breath, and a bit longer to walk normally...";
				else:
				...
				say "     You make an effort to keep things as slow as possible for yourself. The dragon seems a little impatient with you, but your ponderous endeavors do seem to gradually win him over, his dick gushing more and more with each motion. You're soon dizzy and exhausted with this continued endeavor, becoming more difficult with each passing second before you finally can't take it anymore.";
				say "     '[one of]N-nng[or]H-hmpf[or]O-oh[at random], [one of]y-you[or]I w-will not[or]d-do not think[at random] -- !' The dragon's taunt interrupted by his bliss, you use the last of your energy to pick up the pace for just a little longer, the sudden spike thankfully enough to set him off along with you. The force of each, powerful gout of his overwhelming load is almost enough to launch you off his throbbing tool, forcing you to weakly push yourself down against it. Lost in the haze of your own bliss, [if cocks of player > 0]your cock[smn] paint the dragon with your [cum load size of player] load[else if cunts of player > 0]your cunt[sfn] gush and stain the dragon further[else]you writhe in an insatiable need[end if].";
				say "     Once the flow subsides and you're able to pull yourself free of the serpent's softening organ, you manage to climb off him and take a moment to catch your breath.";
		...
		if player consents:
			...
			if player consents:
				...
				if player consents:
					say "     You call upon the beast's massive head to close in, embracing his scaled lips in a gentle kiss. Eager to oblige your ruse, the additional affection distracts him long enough to pull yourself free of his monolithic rod, needing only to attend it for a sparse few seconds before he finally roars out in ecstasy.";
					say "     Aiming his own dick straight for the dragon, he immediately gets doused by his own, immense load. Grinding against the throbbing organ, you quickly follow suit, [if cocks of player > 0]your cock[smn] painting the dragon's face with your [cum load size of player] load as well[else if cunts of player > 0]your cunt[sfn] gushing and staining the dragon further[else]causing you writhe with an insatiable need[end if]. Briefly dazed by bliss, he does eventually wrench himself free of your hold and seems to appear quite upset, somewhere under that blanket of cum...";
					say "     '[one of]Hmpf[or]Aagh[or]Oh[at random], [one of]I will not stand for the indignity[or]absolutely no respect for your betters[or]I have obliged your need far enough[at random].' Getting off him, the embarrassed and exhausted beast eventually concedes to taking to the air, grumbling loudly as he flies off into the distance and starts cleaning himself off. Satisfied with your little prank, you take a brief while to recover and gather your things before heading off on your merry way.";
				else:
					say "     '[one of]N-nng[or]H-hmpf[or]O-oh[at random], [one of]do not think I w-will not outlast[or]impressive b-but[or]I can only a-abide this torment for so long[at random] -- !' The dragon makes a considerable effort to hold back his bliss, but it's inevitable that he finally succumbs. Roaring out loudly, the force of each, powerful gout of his overwhelming load is almost enough to launch you off his throbbing tool, forcing you to firmly push yourself down against it. More than enough to set you off as well, [if cocks of player > 0]your cock[smn] paint the dragon with your [cum load size of player] load[else if cunts of player > 0]your cunt[sfn] gush and stain the dragon further[else]you writhe in an insatiable need[end if].";
					say "     Once the flow subsides and you're able to pull yourself free of the serpent's softening organ, you manage to climb off him and take a moment to catch your breath.";
