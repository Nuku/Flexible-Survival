	...
	if vorelevel is 3 and (a random chance of 1 in 3 succeeds or (player is kinky and a random chance of 1 in 3 succeeds)):
		...
		if "Touched by Madness" is listed in feats of Player and player is male and Cock Length of Player < 20 and ((player is kinky and a random chance of 1 in 2 succeeds) or (player is not kinky and a random chance of 1 in 5 succeeds)):
			...
			if Libido of Player > 33:
				say "     You can't hold back any longer, crying out as your [Cum Load Size of Player] load floods serpent's urethra, each throb pumping more into his tight, slick depths, [if ball size of Player > 20]so much of it that it immediately triggers the dragon's backlash[else]the dragon's backlash quickly following in its wake[end if]. Hilting the massive organ against your crotch, your orgasm works against you as each successive wave now sends a mix of your own seed and that of the beast's right back, [if Player is internal]belly rapidly bloating to abide this overwhelming flood[else if ball size of Player > 24]Already-[ball size] gradually swelling to abide this overwhelming flood[else][ball size] quickly swelling to unmanageable sizes[end if], each continued gout by the dragon inflating you further.";
			else:
				say "     In due time, the serpent's continued diligence eventually causes him to roar out, almost immediately hit with the intense sensation of his massive load forcing its way into you. So intense is the sensation that it causes you to fire off as well, though this only ends up working against you as each successive pulse now sends a mix of your own seed and that of the beast's right back at you, [if Player is internal]belly rapidly bloating to abide this overwhelming flood[else if ball size of Player > 24]Already-[ball size] gradually swelling to abide this overwhelming flood[else][ball size] quickly swelling to unmanageable sizes[end if], each following gout by the dragon inflating your further.";
...
to say YamatM_2: [Oral Receiving Cock]
	...
	if Player consents:
		say "     His grip on you is fairly tight, practically pinning you to a tree, but you manage to order him off just before you cry out, aiming your now free, saliva-slicked dick[smn] at the dragon as you fire off your [Cum Load Size of Player] load, [if ball size of Player > 24]utterly soaking[else]painting[end if] his snout with your thick cum. His brief confusion allows you to spend your entire load on him.";
		...
		say "     Practically pinning you to a tree with his snout, he appears fully prepared for when you finally cry out, methodical tongue squeezing you with every gout of your [Cum Load Size of Player] load[if ball size of Player > 24], seemingly unphased by its sheer volume[end if]. He makes every effort to prolong your orgasm as much as possible before finally pulling free.";
...
to say YamatM_3: [Oral Receiving Cunt]
	...
	if Player is male:
		say "     His skillful work filling the air with the wet sounds of his tongue's efforts, it doesn't need long before you're brought to your very limit! Shall you pull out at the last second and shame him? Otherwise, you'll reward the creature's diligence.";
		if Player consents:
			say "     His grip on you is fairly tight, practically pinning you to a tree, but you manage to order him off just before you cry out, aiming your previously unattended, saliva-slicked dick[smn] at the dragon as you fire off your [Cum Load Size of Player] load, [if ball size of Player > 24]utterly soaking[else]painting[end if] his snout with your thick cum. His brief confusion allows you to spend your entire load on him.";
			say "     '[one of]Hmpf[or]Well[at random], [one of]I think you have had your fun[or]I hope you are sufficiently amused[or]I suppose whatever suits your need[at random]...' Thick tongue licking clean his snout, he's clearly trying to hide his embarrassment behind a terse expression. Once the both of you are clean, the serpent flies off into the distance, leaving you to go about your business once more.";
		else:
