...
to say YamatM_2: [Oral Receiving Cock]
	...
	say "     His constant, unblinking gaze fixated on you, your [if scalevalue of player < 4]entire body[else]torso[end if] is bathed in his steamy breath, lower half disappearing under his scaled snout as his lips hilt against your crotch[if cock length of player > 19], utterly unphased by your size[end if]. As large as the serpent is, he seems extraordinarily dexterous with his tongue, able to squeeze and writhe against[if cocks of player > 1] and between[end if] your rod[smn] with considerable ease.";
