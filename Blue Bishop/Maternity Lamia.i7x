...
When Play begins:
	...
	now Species Name entry is "Lamia"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now face entry is "rather attractive and hulooking, though sporting reptilian eyes and a snake's tongue"; [ Face description, format as "Your face is [Face of Player]." ]
	...
	now cock change entry is "it succumbs to some transformative effect. Checking yourself, it appears distinctly hulooking"; [ Cock TF text, format as "Your groin tingles as [cock change entry]." ]
	...
	now MilkItem entry is "Lamia Milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "Lamia Cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
"Lamia cum"	"A plastic water bottle containing a moderate amount of milky white fluid. Almost could be mistaken for some sort of buttermilk, if someone hadn't written 'Lamia Cum' across the label on the bottle. You [italic type]could[roman type] drink it to quench your thirst, or you maybe just do it for fun. Who knows what else it might do to you though..."	1	Lamia cum

Lamia cum is a grab object.
Lamia cum is cum.
Lamia cum is infectious.
Strain of Lamia cum is "Husky Bitch".
...
instead of sniffing Lamia cum:
	say "You open the lid for a moment and take a sniff. Doesn't smell too bad actually, just kinda nutty.";

Table of Game Objects (continued)
name	desc	weight	object
"Lamia milk"	"A plastic water bottle filled with what is clearly milk. One could think it was a regular cow's milk, if someone hadn't written 'Lamia Milk' across the label on the bottle. You [italic type]could[roman type] drink it to quench your thirst. Who knows what else it might do to you though..."	1	Lamia milk

Lamia milk is a grab object.
Lamia milk is milky.
Purified of Lamia milk is "distilled milk".
Lamia milk is infectious.
Strain of Lamia milk is "Lamia".
Usedesc of Lamia milk is "[Lamia milk use]";

to say Lamia milk use:
	say "Lifting the plastic bottle to your mouth, you take a drink from it, letting the ophidian milk run over your tongue and down your throat. Tastes rich and animal-like. Swishing it around in your mouth a little, you finish the bottle off, then stuff it back into your collection of 'empties'.";
	PlayerDrink 15;

instead of sniffing Lamia milk:
