...
When Play begins:
	...
	now MilkItem entry is "Pewter Consort Man-Milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
...
"Pewter Consort cum"	"A plastic water bottle containing a moderate amount of milky white fluid. Almost could be mistaken for some sort of buttermilk, if someone hadn't written 'Pewter Consort Cum' across the label on the bottle. You [italic type]could[roman type] drink it to quench your thirst, or you maybe just do it for fun. Who knows what else it might do to you though..."	1	Pewter Consort cum

Pewter Consort cum is a grab object.
Pewter Consort cum is cum.
Pewter Consort cum is infectious.
Strain of Pewter Consort cum is "Husky Bitch".
...
instead of sniffing Pewter Consort cum:
	say "You open the lid for a moment and take a sniff. Doesn't smell too bad actually, just a little metallic.";

Table of Game Objects (continued)
name	desc	weight	object
"Pewter Consort man-milk"	"A plastic water bottle filled with what is clearly milk. One could think it was a regular cow's milk, if someone hadn't written 'Pewter Consort Man-Milk' across the label on the bottle. You [italic type]could[roman type] drink it to quench your thirst. Who knows what else it might do to you though..."	1	Pewter Consort man-milk

Pewter Consort man-milk is a grab object.
Pewter Consort man-milk is milky.
Purified of Pewter Consort man-milk is "distilled milk".
Pewter Consort man-milk is infectious.
Strain of Pewter Consort man-milk is "Pewter Consort".
Usedesc of Pewter Consort man-milk is "[Pewter Consort man-milk use]";

to say Pewter Consort man-milk use:
...
instead of sniffing Pewter Consort man-milk:
