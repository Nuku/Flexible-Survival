...
to say ResolveEvent Ebonflame Nest:
	...
	if bonus + dice > target:
		...
		say "[line break]     [bold type]Descend upon the whelps?[roman type][line break]";
		...
		let dice be a random number from 1 to 20;
		if bonus + dice > target:
			say "     Upon your travels across this blasted part of the city, you suddenly feel off-balance as the cracked asphalt below you begins to crumble. Using your quick reflexes, you immediately roll away from the crumbling pavement, which collapses in on itself in your wake. Dusting yourself off, you move to see what your poor luck might have had in store for you.";
			...
			if HP of Player > 0:
				say "     Upon your travels across this blasted part of the city, you suddenly feel off-balance as the cracked asphalt below you begins to crumble. Too slow to react, the pavement gives way, you following in its wake as you descend into a shallow cave, landing on the broken earth with an audible thud.";
