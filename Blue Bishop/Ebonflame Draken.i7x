...
to say ebdrakenvic:
	...
	if anallevel is not 1 and (cunts of player is 0 or anallevel is 3) and (a random chance of 1 in 2 succeeds or (anallevel is 3 and a random chance of 1 in 3 succeeds)):
		...
		say "     '[one of]Such a soft hole, I'm going to take great joy in ravaging it[or]I'm going to love tearing you in half[or]Oh, don't worry, you're not going to feel a thing... After I'm done with you[at random]!' Finally pulling the talon free, it's apparent she wanted to humiliate you more than prepare, [if scalevalue of player > 3]climbing on top of[otherwise]positioning herself behind[end if] you before the pointed tip of the reptile's savage dick briefly presses against you quivering hole. Immediately, she plunges the massive thing as far in as she can, grunting as she forces what remains with successive thrusts. Not only is it apparent that she doesn't care to prepare you, but she actively enjoys hearing you howl in pain as her sharp barbs dig into your supple flesh, laughing and mocking you all along the way.";
	...
	otherwise if cunts of player > 0 and a random chance of 2 in 3 succeeds:
		...
		say "     '[one of]Such a soft hole, I'm going to take great joy in ravaging it[or]I'm going to love tearing you in half[or]Oh, don't worry, you're not going to feel a thing... After I'm done with you[at random]!' Finally pulling the talon free, it's apparent she wanted to humiliate you more than prepare, [if scalevalue of player > 3]climbing on top of[otherwise]positioning herself behind[end if] you before the pointed tip of the reptile's savage dick briefly presses against you supple lips. Immediately, she plunges the massive thing as far in as she can, grunting as she forces what remains with successive thrusts. Not only is it apparent that she doesn't care to prepare you, but she actively enjoys hearing you howl in pain as her sharp barbs dig into your tender flesh, laughing and mocking you all along the way.";
		...
		otherwise:
			...
			say "     Thankfully, as you finally find a place to catch your breath, the ordeal doesn't leave you with any lasting damage, but you imagine you're going to have some trouble walking for a couple hours...";
	otherwise:
		say "     The dragoness circles around your[if scalevalue of player > 3] larger,[end if] [bodytype of player] form, she wraps [if scalevalue of player > 3]both[otherwise]one[end if] of her scaled hands around your neck, pulling your head forward until you're forced to stare down her glowing eyes.";
...
to say ebdrakendesc:
	...
	otherwise:
		say "     In the ash-filled haze, you see [if scalevalue of player < 4]a towering[otherwise]an imposing[end if], dragon-humanoid in the distance. [one of]You're barely given a chance to react before it notices you as well[or]Already the subject of its pursuit[stopping], it turns to amble towards you slowly. Covered in an impenetrably dark shade of purple scales, she's almost naught but a silhouette against the[if daytimer is night] night's[end if] surroundings, save for her fiery eyes and the occasional strings of the hermaphrodite's glowing, molten precum oozing from her terrifying, barbed cock.";
	...
	if bodyname of player is "Ebonflame Draken":
		...
		otherwise:
			...
			if player is submissive or “Strong Psyche” is listed in feats of player:
				say ". It's hard to keep everything together, but ultimately your [if player is submissive]submissive tendencies allow[otherwise]strong will allows[end if] you to endure until you're finally freed back into civilized society.";
