...
to say ebgatorvic:
	...
	if anallevel > 1 and (Cunt Count of Player is 0 or anallevel is 3) and (a random chance of 1 in 2 succeeds or (anallevel is 3 and a random chance of 1 in 3 succeeds) or (Cunt Count of Player is 0 and impregnatevalid is true)):
		...
		CreatureSexAftermath "Player" receives "AssFuck" from "Ebonflame Dragator";
		...
		if impregnatevalid is true:
			...
			say "     Abandoning your battered, bruised, and bloated form with a low hiss, you're forced to crawl away and recover from the consequences of the ordeal.";
		CreatureSexAftermath "Player" receives "PussyFuck" from "Ebonflame Dragator";
	else:
...
When Play begins:
	...
	now MilkItem entry is "Ebonflame Drake Milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "Ebonflame Drake Cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
"Ebonflame Dragator cum"	"A plastic water bottle containing a moderate amount of milky white fluid. Almost could be mistaken for some sort of buttermilk, if someone hadn't written 'Dragator Cum' across the label on the bottle. You [italic type]could[roman type] drink it to quench your thirst, or you maybe just do it for fun. Who knows what else it might do to you though..."	1	Ebonflame Dragator cum

Ebonflame Dragator cum is a grab object.
Ebonflame Dragator cum is cum.
Purified of Ebonflame Dragator Cum is "distilled cum".
...
Table of Game Objects (continued)
name	desc	weight	object
"Ebonflame Dragator man-milk"	"A plastic water bottle filled with what is clearly milk. One could think it was a regular cow's milk, if someone hadn't written 'Ebonflame Dragator Man-Milk' across the label on the bottle. You [italic type]could[roman type] drink it to quench your thirst. Who knows what else it might do to you though..."	1	Ebonflame Dragator man-milk

Ebonflame Dragator man-milk is a grab object.
Ebonflame Dragator man-milk is milky.
Purified of Ebonflame Dragator man-milk is "distilled milk".
Ebonflame Dragator man-milk is infectious.
Strain of Ebonflame Dragator man-milk is "Ebonflame Dragator".
Usedesc of Ebonflame Dragator man-milk is "[Ebonflame Dragator man-milk use]";

to say Ebonflame Dragator man-milk use:
	say "Lifting the plastic bottle to your mouth, you take a drink from it, letting the dragator man-milk run over your tongue and down your throat. Tastes rich and animal-like. Swishing it around in your mouth a little, you finish the bottle off, then stuff it back into your collection of 'empties'.";
	PlayerDrink 15;

instead of sniffing Ebonflame Dragator man-milk:
