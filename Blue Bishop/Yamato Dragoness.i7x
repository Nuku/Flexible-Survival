	...
	if vorelevel is 3 and (a random chance of 1 in 3 succeeds or (player is kinky and a random chance of 1 in 3 succeeds)):
		...
		if "Touched by Madness" is listed in feats of player and ((player is kinky and a random chance of 1 in 2 succeeds) or (player is not kinky and a random chance of 1 in 4 succeeds)):
			...
			if cocks of player > 0 and a random chance of 1 in 2 succeeds:
				...
				say "     Shared fatigue the anchor that pulls you once more to the ground, she finally frees you from her grip, slowly rising once more into the air to depart in silence. Gradually catching your breath, you're left to gradually recover from the creature's powerful influence, [if cock length of player < 24 and FYDM is 0]checking over your exceedingly sore cock[smn] to find that they seem slightly enlarged from the ordeal, though you're not rightly sure if it'll have any lingering effects[else if cock length of player < 24]checking over your exceedingly sore cock[smn] to see that it does indeed appear larger from the ordeal.[run paragraph on].[run paragraph on][else]your over-sized cock[smn] feeling extremely sore from the ordeal[end if].";
...
to say YamatF_1: [cunt pitching]
	...
	if player consents:
		...
		say "     '[one of]Oh[or]Ah[or]Yes[at random], [one of]do not stop[or]I can take more[or]you tease me so[at random]...' Oozing, throbbing portal aching ahainst your endeavor, you imagine this bit of foreplay won't be all that effective at stretching her out, given how tight she is. Pulling your limb free, you think everything should be good to go.";
		now tempnum is 1;
	else:
		now tempnum is 0;
