...
to say YamatF_3: [oral receiving cock]
	...
	say "     Her constant, unblinking gaze fixated on you, your [if scalevalue of player < 4]entire body[else]torso[end if] is bathed in her steamy breath, lower half disappearing under her scaled snout as her lips hilt against your crotch[if cock length of player > 19], utterly unphased by your size[end if]. As large as the serpent is, she seems extraordinarily dexterous with her tongue, able to squeeze and writhe against[if cocks of player > 1] and between[end if] your rod[smn] with considerable ease.";
