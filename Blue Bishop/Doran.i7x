...
to say beatdoran:
	...
	otherwise:
		...
		say "     'Very well; however, if things change for my victor, I'm always available.' He goes on to explain where he resides. Apparently there's a cave within a not-too-distant rocky outcropping, and his instructions are clear enough that you should have no issue getting there, 'Doran's the name, by the way.'";
...
to say dorvic_1: [fuck the dragon]
	...
	say "     'I rather enjoyed that, victor! Perhaps they would be interested in another go sometimes down the line?' He goes on to explain where he resides. Apparently there's a cave within rocky outcropping not far from here, and his instructions are clear enough that you should have no issue getting there. 'Doran's the name, by the way.'";
...
to say dorvic_2: [oral cock]
	...
	say "     'Alright, I certainly hope my victor was pleased...' It takes him a moment to recover, cleaning himself off and regaining what composure might have slipped from him prior. 'That was satisfying! Perhaps you would be interested in another go sometimes down the line?' He goes on to explain where he resides. Apparently there's a cave within rocky outcropping not far from here, and his instructions are clear enough that you should have no issue getting there. 'Doran's the name, by the way.'";
...
to say dorvic_3: [oral cunt]
	...
	say "     'Alright, I certainly hope my victor was pleased...' It takes him a moment to recover, cleaning himself off and regaining what composure might have slipped from him prior. 'That was satisfying! Perhaps my victor would be interested in another go sometime down the line?' He goes on to explain where he resides. Apparently there's a cave within rocky outcropping not far from here, and his instructions are clear enough that you should have no issue getting there. 'Doran's the name, by the way.'";
	say "     Finished, he turns to depart in that direction, scaled and well-toned ass waving at you in his departure, as though to entice you to follow.";
...
to say dorvic_4: [cunt sex]
	...
	if player consents:
		...
		say "     'Oh, how very naughty, making a mess of me like that!' He feigns insult, taking a moment to regain his posture. 'That was satisfying! Perhaps my victor would be interested in another go sometimes down the line?' He goes on to explain where he resides. Apparently there's a cave within rocky outcropping not far from here, and his instructions are clear enough that you should have no issue getting there. 'Doran's the name, by the way.'";
	otherwise:
		...
		say "     'Oh, my victor is quite impressive at being able to take me.' He offers his praise
before getting back up, taking a moment to regain his posture. 'That was satisfying! Perhaps they would be interested in another go sometimes down the line?' He goes on to explain where he resides. Apparently there's a cave within rocky outcropping not far from here, and his instructions are clear enough that you should have no issue getting there. 'Doran's the name, by the way.'";
	say "     Finished, he turns to depart in that direction, scaled and well-toned ass waving at you in his departure, as though to entice you to follow.";
...
to say dorvic_5: [anal sex]
	...
	otherwise:
		...
		say "     Eventually, you pull yourself free of the dragon's now-softened organ, stepping off of him.";
		say "     'Oh, my victor quite impressive at being able to take me.' He offers his praise
before getting back up, taking a moment to regain his posture. 'That was satisfying! Perhaps they would be interested in another go sometimes down the line?' He goes on to explain where he resides. Apparently there's a cave within rocky outcropping not far from here, and his instructions are clear enough that you should have no issue getting there. 'Doran's the name, by the way.'";
	say "     Finished, he turns to depart in that direction, scaled and well-toned ass waving at you in his departure, as though to entice you to follow.";
...
to say dorvic_snub: [turn down]
	...
	say "     'Very well; however, if my victor changes their mind, I'm always available.' He goes on to explain where he resides. Apparently there's a cave within a not-too-distant rocky outcropping, and his instructions are clear enough that you should have no issue getting there, 'Doran's the name, by the way.'";
	say "     Once he's done, he makes to leave in that direction, scaled and well-toned ass waving at you in his departure, as though to entice you to follow.";
