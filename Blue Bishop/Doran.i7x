...
[ Version 1.3 - Expansion Patch; two submissive Doran scenes, neutral demeanour, and one roleplay session added ]
		...
		while trixieexit is 0:
			...
			otherwise if calcnumber is 3:
				...
				otherwise:
					...
					now trixieexit is 1;
			otherwise if calcnumber is 4:
				if cunts of player is 0 or cunt length of player < 7:
					say "[bracket]Invalid interaction: You don't meet the criteria[close bracket][line break]";
				otherwise:
			...
			otherwise if calcnumber is 6:
				say "[dorsub_6]"; [New! Rimjob Scene]
				now trixieexit is 1;
			otherwise if calcnumber is 7:
				say "[dorsub_7]"; [New! Oral Giving Scene]
				now trixieexit is 1;
			otherwise:
...
to say dorsub_6: [New! Rimjob scene]
	...
	otherwise:
		...
		otherwise:
			if dornpbb is 1, now dornpbb is 2;
			say "     Revelling in this lewd ritual, the dragon's oozing rod bobs unattended before you, though he is [if dorroleint is 4]obedient[otherwise]obliging[end if] enough to remain unfettered by a need to deal with it this very moment, each irreverent twitch of his invading appendage expertly making you twist and writhe in pleasure. His talons soon move your stroke [if cocks of player > 1]one of your unattended cocks[otherwise if cocks of player is 1]your unattended cock[otherwise if cunts of player > 1]one of your unattended portals[otherwise]your unattended portal[end if] in additional attention, exacerbating your already rapidly approaching bliss.";
...
to say dorsub_7: [New! Oral Giving scene]
...
to say dorcus_1: [Of One's Past]
	...
	otherwise:
		say ".' Instinctively";
	say ", you ask him why.";
	say "     'My past is entirely unimportant, and one wouldn't benefit from its knowledge; quite the contrary, it'd be more of a hinderance--[dorgr], do they know of context";
				...
				if calcnumber is 1:
					...
					while dorcusexit2 is 0:
						...
						otherwise if calcnumber is 2:
							...
							now dorcusexit is 1;
		otherwise if calcnumber is 4:
			say "     'Understand that I garner no joy from keeping secrets, but I do ask that [dorgr] gain some solace in the assurance that I will never lie to them, and that my past is not of some signifcance that their lack of knowledge would harm them down the line.' He decides to conclude the topic at that, leaving you to go about your business[if charisma of player > 14], though you remain a fair bit unsure as to his assurance of honesty[end if].";
			now trixieexit is 1;
...
to say dorcus_2: [Of Hobbies and Imagination]
	...
	say "     'A-ah, [dorgr], I didn't hear them come in. Um, er...' Apparently he managed to find a number of childrens toys and he's been playing with them. Embarrassment streaks his face, red hot with the reveal of this peculiar pastime.";
