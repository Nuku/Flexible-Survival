...
to flotprogress: [passable]
	if flotintense is 2:
		...
		say "     Your better judgment is blaring at you from the back of your head to pull out while you still can, [one of]there's no telling how far this goes[or]you're running out of time[at random]!";
...
to say flotbinddesc: [passable]
	if flotintense < 2:
		...
		say "     [one of]Now forced[or]Forced[at random] to ride the inflatable dolphin, [one of]it creaks loudly against you[or]it squeaks against your hard motion[or]it buckles under the weight of your constant motions[or]its motions are intensely exaggerated by the waves[at random], ";
		if player is male:
