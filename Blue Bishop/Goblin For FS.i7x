...
to say losetogob_f:
	say "     The creature emits a gleeful giggle when [if hp of player > 0]her victim surrenders[otherwise]she fells you in combat[end if]. The little goblin pushing you to the ground, forcing you to relinquish any attire you might have.";
	say "     '";
	if gobdem is true:
		say "[if scalevalue of player > 3][one of]He he, big--BIG, ha ha[or]Ah, ah--s-so big[or]Big, big, HA, big[at random][otherwise][one of]He he, mine, MINE[or]Y-yes, mine, ME, mine[or]Mine, mine, not yours, mine[at random][end if]";
	otherwise:
		say "[if scalevalue of player > 3 and hp of player > 0][one of]Oh, this is embarrassing, submitting to little ol' me[or]Hm, I wouldn't imagine so large as a bottom[or]I see my charm can fell even those so large[at random][otherwise if scalevalue of player > 3][one of]What a shame, I figured someone your size would put up a better fight[or]Clearly you underestimated me, don't let my size fool you[or]I'd steal my new trophy away, but clearly you won't fit in my hole[at random][otherwise if hp of player > 0][one of]Oh, if everyone just gave up as quickly as you[or]Clearly you couldn't resist my charm[or]I think my friend wants to play a little game[at random][otherwise][one of]Shouldn't've underestimated me, bub[or]Should've ran when you could[or]That's what ya get for trespassing my turf[at random][end if]";
	if cocks of player > 0 and cock length of player < 14 and a random chance of 1 in 2 succeeds:
		...
		If scalevalue of player > 3:
			say ". You can't refuse to admit to yourself that it's a little embarrassing when such a small [if hp of player > 0]creature[otherwise]assailant[end if] is forced to scale your sizeable, [bodytype of player] form to position herself over you";
		otherwise:
		...
		say "     Now ready for you, the creature slowly sinks [if cocks of player > 2]one of your cocks within the folds of her cunt, your remaining organs left neglected in the open air[otherwise if cocks of player is 2]one of your cocks within the folds of her cunt, the remaining organ left neglected in the open air[otherwise] your cock within the folds of her cunt[end if]. She moans loudly in satisfaction, savouring the[if hp of player < 1] forced[end if] intrusion upon her wanton hole, inching it deeper in until it becomes fully engulfed[if cockname of player is listed in infections of knotlist] save for the knot[end if][if cock length of player > 8], no doubt strained by its comparatively large size[end if]. The goblin's revels in this lewd ceremony remain fairly brief, however, as she soon shifts gears to using you properly.";
		say "     '";
		if gobdem is true:
			say "[if cock length of player > 8][one of]Nng, big, BIG, ah[or]Oof, ah, nng[or]Oh, ouch, ah[at random][otherwise][one of]Ah, ha, nng[or]Hm, ah, oh[or]Heh, nng, MINE, ah[at random][end if]";
		otherwise:
			say "[if cock length of player > 8][one of]Nng, this is going to be a challenge[or]Ah, oh, don't think I can't handle you[or]Ah, ooh, this is going to take a bit of work[at random][otherwise][one of]Oh, this'll be a fun ride[or]Ah, I couldn't resist taking this bad boy out for a ride[or]Ooh, the fun's just started here[at random][end if]";
		say "!' Hands stroking your [bodydesc of player] torso as she builds up a motion, she's quick to illustrate a manic fervour in pumping himself against your hardened organ, [if scalevalue of player > 3]though such a diminutive creature barely registers against your substantially larger form, her sickeningly rapid motion against your member nonetheless has an effect on you[otherwise]her dizzying motions pushing you back and forth with sickening rapidity[end if][if cocks of player > 3]. In her endeavours, she instinctually grabs two of your free dicks, pumping them wildly in her wanton fury[otherwise if cocks of player is 3]. In her endeavours, she instinctually grabs both of your free dicks, pumping them wildly in her wanton fury[otherwise if cocks of player is 2]. In her endeavours, she instinctually grabs your free dick, pumping it wildly in her wanton fury[end if].";
		say "     The wet sound of her continued motion filling the air for but a few short minutes later, she finally cries out in ecstasy, [if cockname of player is listed in infections of knotlist]tying with you as her cunt tightens[otherwise]her cunt tightening[end if] further around your cock until you're [if hp of player > 0]compelled[otherwise]forced[end if] to find bliss as well, pumping her voracious womb with your [cum load size of player] cum[if cocks of player > 2]. Not so lost in lust as to relent in humiliating you further, she aims both free tools in her hold to your face, spraying you with your own seed[otherwise if cocks of player is 2]. Not so lost in lust as to relent in humiliating you further, she aims the free tool in her hold to your face, spraying you with your own seed[end if]";
	...
	otherwise:
		...
		If player is submissive or hp of player > 0:
			...
			otherwise:
				say "[if scalevalue of player > 3][one of]Oh, I think my new big friend likes eating pussy[or]Ha, what a massive slut[or]Hm, what a big toy[at random][otherwise][one of]Oh, it looks like someone enjoys eating pussy[or]Ha, it look at that slut go[or]I think you're a natural at being a toy[at random][end if]";
		otherwise:
			...
			otherwise:
				say "[if scalevalue of player > 3][one of]There we go, keep playing nice now, big one[or]That's right, be a good big slut[or]There we go, the big one knows their place[at random][otherwise][one of]There we go, keep playing nice[or]That's right, be a good little slut[or]There we go, someone knows their place now[at random][end if]";
		...
		otherwise:
			say "[if hp of player > 0 or player is submissive][one of]Not half bad, I've certainly had worse[or]That was some nice, quick fun[or]Ah, it's good to get some proper satisfaction around here[at random][otherwise][one of]Not half bad, once you learned your place[or]See? That wasn't all that bad[or]Maybe next time would give me less trouble[at random][end if]";
		say ".' [if scalevalue of player > 4]She pats you teasingly on the top of your head[otherwise]She gives you a playful swat on your behind[end if] before departing, the creature finding a tiny tunnel in the junk before descending within it. Now free, you suppose you could be worse for wear, though you are somewhat disoriented by the influence of her infection.  You stagger off, wanting to get some distance before the scent of sex draws others.";


to say losetogob_m:
	say "     The creature emits a sinister cackle when [if hp of player > 0]his victim surrenders[otherwise]he fells you in combat[end if]. The little goblin pushing you to the ground, forcing you to relinquish any attire you might have.";
	say "     '";
	if gobdem is true:
		say "[if scalevalue of player > 3][one of]He he, big--BIG, ha ha[or]Ah, ah--s-so big[or]Big, big, HA, big[at random][otherwise][one of]He he, mine, MINE[or]Y-yes, mine, ME, mine[or]Mine, mine, not yours, mine[at random][end if]";
	otherwise:
	...
	if anallevel is not 1 and cocks of player > 0 and cock length of player < 15 and a random chance of 1 in 6 succeeds:
		...
		say "     Quickly in position, the creature slowly sinks [if cocks of player > 2]one of your cocks past his supple anal ring, your remaining organs left neglected in the open air[otherwise if cocks of player is 2]one of your cocks past his supple anal ring, the remaining organ left neglected in the open air[otherwise]your cock past his supple anal ring[end if]. He moans loudly in satisfaction, savouring the[if hp of player < 1] forced[end if] intrusion upon his wanton hole, inching it deeper in until it becomes fully engulfed[if cockname of player is listed in infections of knotlist] save for the knot[end if][if cock length of player > 8], no doubt strained by its comparatively large size[end if]. The goblin's revels in this lewd ceremony remain fairly brief, however, as he soon shifts gears to using you properly.";
		say "     '";
		if gobdem is true:
			say "[if cock length of player > 8][one of]Nng, big, BIG, ah[or]Oof, ah, nng[or]Oh, ouch, ah[at random][otherwise][one of]Ah, ha, nng[or]Hm, ah, oh[or]Heh, nng, MINE, ah[at random][end if]";
		otherwise:
			say "[if cock length of player > 8][one of]Nng, this is going to be a challenge[or]Ah, oh, don't think I can't handle you[or]Ah, ooh, this is going to take a bit of work[at random][otherwise][one of]Oh, this'll be a fun ride[or]Ah, I couldn't resist taking this bad boy out for a ride[or]Ooh, the fun's just started here[at random][end if]";
		say "!' Hands stroking your [bodydesc of player] torso as he builds up a motion, he's quick to illustrate a manic fervour in pumping himself against your hardened organ, [if scalevalue of player > 3]though such a diminutive creature barely registers against your substantially larger form, his sickeningly rapid motion against your member nonetheless has an effect on you[otherwise]his dizzying motions pushing you back and forth with sickening rapidity[end if][if cocks of player > 3]. In his endeavours, he instinctually grabs two of your free dicks, frotting them wildly against his own in wanton fury[otherwise if cocks of player is 3]. In his endeavours, he instinctually grabs both of your free dicks, frotting them wildly against his own in wanton fury[otherwise if cocks of player is 2]. In his endeavours, he instinctually grabs your free dick, frotting it wildly against his own in wanton fury[end if].";
		say "     The wet sound of his continued motion filling the air for but a few short minutes later, he finally cries out in ecstasy, [if cockname of player is listed in infections of knotlist]tying with you as his ass tightens[otherwise]his ass tightening[end if] further around your cock until you're [if hp of player > 0]compelled[otherwise]forced[end if] to find bliss as well, pumping his taut bowels with your [cum load size of player] cum. Not so lost in lust as to relent in humiliating you further, he aims [if cocks of player > 2]both free tools in his hold to your face, spraying you with your seed, along with his own[otherwise if cocks of player is 2]the free tool in his hold to your face, spraying you with your seed, along with his own[otherwise]his tool to spray you with his own seed[end if]";
		if cock width of player > 19:
	...
	otherwise if anallevel is not 1 and (Cunts of player is 0 or anallevel is 3) and (a random chance of 1 in 3 succeeds or (anallevel is 3 and a random chance of 1 in 3 succeeds)):
		...
		if cocks of player > 0:
			say "he moves a hand to stroke [if cocks of player > 1]one of your [cock size desc of player] cocks[otherwise]your [cock size desc of player] cock[end if], supplementing his teasing with more direct affections until you're [if hp of player > 0]driven[otherwise]forcibly made[end if] hard";
		otherwise:
			say "[if cunts of player > 1], he moves a hand to stroke one of your cunts, supplementing his imminent intrusion with another as you feel his fingers sink into the feminine portal[otherwise if cunts of player > 0], he moves a hand to stroke your cunt, supplementing his imminent intrusion with another as you feel his fingers sink into the feminine portal[otherwise], he briefly teases your [bodytype of player] tailpipe before its appropriate use[end if]";
		say ". Soon thereafter, You feel the head of his eager organ shove its way past your supple ring,";
		if scalevalue of player > 3:
			say "his prick barely registering against for you and your sizeable hole.  He doesn't seem to regard this, though; perhaps all the more excuse to be more reckless in his [if hp of player > 0]use[otherwise]abuse[end if].";
		otherwise:
			say "[if hp of player > 0]eliciting a moan from you in[otherwise]forcing a moan from your lips in involuntary[end if] response against the irreverent intrusion. He [if hp of player > 0]at least spares you a moment of gentle reservation before his wanton need takes precedent[otherwise]spares you little reprieve, eager to enforce his wanton dominion[end if].";
		say "     '";
		if gobdem is true:
			say "[one of][if scalevalue of player > 3]Ass, big ass, MINE, mine[otherwise]Ass, ass, MINE, ass[end if][or]Mine, MINE, ha ha[or]Fuck, fuck, fuck, ass[at random]";
		otherwise:
			say "[if scalevalue of player > 3][one of]F-fuck, there's so much here[or]I bet you can't feel a thing[or]I could lose myself in a hole this big[at random][otherwise if hp of player > 0][one of]Oh, a nice fit[or]I bet you want to see me do my magic[or]Oh, this is going to be a fun ride[at random][otherwise][one of]Don't tense up so much, it'll only be harder for you[or]Oh, calm down and let me work my magic[or]Oh, what a squirming ride[at random][end if]";
		If scalevalue of player > 3:
			say "!' Slowly building up a pace of fucking you proper, his intrusion is not enough to effectively pleasure you[if hp of player > 0] -- not that this is really a pressing issue you for you right now --[otherwise],[end if] ";
			If cocks of player > 0:
				say "[if cocks of player > 2]a shortcoming he attempts to compensate for by the additional attention he confers to your dicks, freeing both hands to rapidly pump two of them[otherwise if cocks of player > 1]a shortcoming he attempts to compensate for by the additional attention he confers to your dicks, freeing both hands to rapidly pump the two of them[otherwise], a shortcoming he compensates for by the additional attention he confers to your dick, freeing a hand to rapidly pump along its length[end if]. You can imagine the whole affair is a bit awkward for the diminutive goblin, barely able to ride and hold onto you at the same time, though he's certainly not lacking in tenacity.";
			Otherwise If cunts of player > 0:
				say "a shortcoming he compensates for by the additional attention he confers to[if cunts of player > 2] two of[otherwise if cunts of player is 2] both of[end if] your cunt[sfn], freeing [if cunts of player > 2]both hands to rapidly finger two of them[otherwise if cunts of player is 2]both hands to rapidly finger both of them[otherwise]a hand to rapidly finger its depths[end if]. You can imagine the whole affair is a bit awkward for the diminutive goblin, barely able to ride and hold onto you at the same time, though he's certainly not lacking in tenacity.";
			Otherwise:
				...
				otherwise:
					say "[if scalevalue of player > 3][one of]Whew, ah, what a ride[or]Ah, give me a second, big one[or]Heh, shame my big new friend had nothing else for me to play with[at random][otherwise][one of]Heh, shame my new friend had nothing else for me to play with[or]Whew, I'm going to need a second[or]Ho boy, what a ride[at random][end if]";
		...
		Otherwise:
			...
			If cocks of player > 0:
				say "[if cocks of player > 2].  He continues to stroke your dicks, now using both hands to pump two of them[otherwise if cocks of player > 1].  He continues to stroke your dicks, now using both hands to pump the two of them[otherwise], further exacerbating your arousal as he continues to pump your dick[end if].  Quite the tenacious goblin, [if hp of player > 0]you can't help but credit him for his[otherwise]he's certainly not lacking in[end if] ability to multitask, at least.";
			Otherwise:
				say "[if cunts of player > 2]. He continues to fondle you cunts, eventually forcing a finger past two of them[otherwise if cunts of player > 1]. He continues to fondle you cunts, eventually forcing a finger past both of them[otherwise if cunts of player is 1], further exacerbating your arousal as he forces a finger past your cunt's supple fold[otherwise], much in spite of your genderless form[end if].  His thrusts becoming increasingly erratic, illustrative of his imminent release, the creature's lustful endeavours [if hp of player < 1]forcing[otherwise]driving[end if] you closer to your own bliss.";
			if cocks of player is 0 and cunts of player is 0:
				...
				if gobdem is true:
					say "[one of]Ah, ha, ha[or]Oh, heh, ah[or]Heh, mine, ah[at random]";
				otherwise:
					say "[if scalevalue of player > 3][one of]Whew, ah, what a ride[or]Ah, give me a second, big one[or]Heh, I still have the magic touch, even with someone so large[at random][otherwise][one of]Oh, you've gone and made a mess of yourself[or]Whew, I'm going to need a second[or]Ho boy, what a ride[at random][end if]";
				say "...' Taking a moment to catch his breath, creature eventually pulls himself free from you, casually wiping his spent tool clean against your behind before he crawls back into the hole from whence he came, regarding you with a sly grin as he departs, allowing you to recover and go about your business once more.[mimpregchance]";
			otherwise if cocks of player > 0:
				say "     Unable to hold back for any longer, your [if cocks of player > 1]cocks erupt[otherwise]cock erupts[end if], [if cock width of player > 24]your exposed face and upper torso immediately getting hosed with your [cum load size of player] load[otherwise if cock width of player > 12]firing its [cum load size of player] load impotently against your torso and face[otherwise]firing its [cum load size of player] load impotently against your torso[end if].  The tightening of your [if hp of player > 0]greedy[otherwise]assailed[end if] ring forcing the goblin to climax himself, his own seed flooding your fleshy abyss.";
				if gobdem is true:
					say "[one of]Ah, ha, ha[or]Oh, heh, ah[or]Heh, mine, ah[at random]";
				otherwise:
					say "[if scalevalue of player > 3][one of]Whew, ah, what a ride[or]Ah, give me a second, big one[or]Heh, I still have the magic touch, even with someone so large[at random][otherwise][one of]Oh, you've gone and made a mess of yourself[or]Whew, I'm going to need a second[or]Ho boy, what a ride[at random][end if]";
	...
	otherwise if cunts of player > 0 and a random chance of 2 in 3 succeeds:
		...
		if cocks of player > 0:
			say "he moves a hand to stroke [if cocks of player > 1]one of your [cock size desc of player] cocks[otherwise]your [cock size desc of player] cock[end if], supplementing his teasing with more direct affections until you're [if hp of player > 0]driven[otherwise]forcibly made[end if] hard";
		otherwise:
			say "he briefly teases your [cunt size desc of player] portal[sfn] before [if cunts of player > 1]their[otherwise]its[end if] appropriate use";
		...
		otherwise:
			...
			If cunt length of player > 15:
				...
				Otherwise If cunts of player > 1:
					say "a shortcoming he compensates for by the additional attention he confers to[if cunts of player > 3] two of[otherwise if cunts of player is 3] both of[end if] your spare cunts, freeing [if cunts of player > 2]both hands to rapidly finger both of them[otherwise]a hand to rapidly finger along its depths[end if].  You can imagine the whole affair is a bit awkward for the diminutive goblin, barely able to ride and hold onto you at the same time, though he's certainly not lacking in tenacity.";
				otherwise if breast size of player > 0:
					say " [if scalevalue of player > 3]a shortcoming he partially compensates for by leaning overtop of you to grope at your breasts. He teases your nipples and plays with your [breast size desc of player] tits as best he can from within his limited reach[otherwise]a shortcoming he makes some effort to compensate for by leaning overtop you to kiss, lick and suck at your breasts. He teases your nipples and plays with your [breast size desc of player] tits[end if].  You can imagine the whole affair is a bit awkward for the diminutive goblin, barely able to ride and hold onto you at the same time, though he's certainly not lacking in tenacity.";
				Otherwise:
			...
			Otherwise:
				...
				If cocks of player > 0:
					say "[if cocks of player > 2].  He continues to stroke your dicks, now using both hands to pump two of them[otherwise if cocks of player > 1].  He continues to stroke your dicks, now using both hands to pump the two of them[otherwise], further exacerbating your arousal as he continues to pump your dick[end if]. Quite the tenacious goblin, [if hp of player > 0]you can't help but credit him for his[otherwise]he's certainly not lacking in[end if] ability to multitask, at least";
				Otherwise if cunts of player > 1:
					say "[if cunts of player > 3].  He continues to fondle your unattended cunts, eventually forcing a finger past two of them[otherwise if cunts of player > 2].  He continues to fondle your unattended cunts, eventually forcing a finger past both of them[otherwise]. He continues to fondle you unattended cunt, eventually forcing a finger into its depths[end if]. Quite the tenacious goblin, [if hp of player > 0]you can't help but credit him for his[otherwise]he's certainly not lacking in[end if] ability to multitask, at least";
				otherwise if breast size of player > 0:
					say ". He chooses to lean [if scalevalue of player > 3]overtop of you to grope at your breasts. He teases your nipples and plays with your [breast size desc of player] tits as best he can from within his limited reach[otherwise]overtop you to kiss, lick and suck at your breasts. He teases your nipples and plays with your [breast size desc of player] tits[end if]. Quite the tenacious goblin, [if hp of player > 0]you can't help but credit him for his[otherwise]he's certainly not lacking in[end if] ability to multitask, at least";
				otherwise:
					say ". His grip tightens against your [bodydesc of player] form, idling fondling you as he continues to pound you";
				say ". His thrusts becoming increasingly erratic, illustrative of his imminent release, the creature's lustful endeavours [if hp of player < 1]forcing[otherwise]driving[end if] you closer to your own bliss.";
				If cocks of player > 0:
					say "     Unable to hold back for any longer, your [if cocks of player > 1]cocks erupt[otherwise]cock erupts[end if], [if cock width of player > 24]your exposed face and upper torso immediately getting hosed with your [cum load size of player] load[otherwise if cock width of player > 12]firing its [cum load size of player] load impotently against your torso and face[otherwise]firing its [cum load size of player] load impotently against your torso[end if].  The tightening of your [if hp of player > 0]greedy[otherwise]assailed[end if] lips forcing the goblin to climax himself, his own seed flooding your womb.";
					if gobdem is true:
						say "[one of]Ah, ha, ha[or]Oh, heh, ah[or]Heh, mine, ah[at random]";
					otherwise:
						say "[if scalevalue of player > 3][one of]Whew, ah, what a ride[or]Ah, give me a second, big one[or]Heh, I still have the magic touch, even with someone so large[at random][otherwise][one of]Oh, you've gone and made a mess of yourself[or]Whew, I'm going to need a second[or]Ho boy, what a ride[at random][end if]";
					say "...' Taking a moment to catch his breath, creature eventually pulls himself free from you, casually wiping his spent tool clean against your behind before he crawls back into the hole from whence he came, regarding you with a sly grin as he departs, allowing you to recover and go about your business once more.[impregchance]";
				Otherwise if (cunt length of player > 15 and (cunts of player > 1 or breast size of player > 0)) or cunt length of player < 16:
	...
	otherwise:                        [oral]
		...
		If player is submissive or hp of player > 0:
			...
			if gobdem is true:
				say "[one of]Slut -- good slut -- ha[or]Yes -- yes good -- mm[or]Mine, my slut, MINE[at random]";
			otherwise:
				say "[if scalevalue of player > 3][one of]Oh, I think my new big friend likes sucking dick[or]Ha, what a massive slut[or]Hm, what a big cum dumpster[at random][otherwise][one of]Oh, it looks like someone enjoys sucking dick[or]Ha, it look at that slut go[or]I think you're a natural at being a cum dumpster[at random][end if]";
		otherwise:
			say "     [if scalevalue of player > 4]You're quick to respond with a grin--weak as you may be, you've still got enough in you to ward him off, exposing your teeth to the diminutive creature.  He's briefly taken aback, but ultimately responds by thwacking you with a wrench a couple times until you're forced into complying; big as you may be, he still has the upper hand here and eventually you allow him to bury his rod into the confines of your large maw[otherwise]You find yourself unwilling to humor his needs, but that only incurs his further wrath when he smacks you around a bit until you agree to satisfy his urges. You open your mouth to oblige him, only to have the goblin thrust the entirety of his rod into your hole, much in spite any complaints you could offer up against this shameless abuse[end if].";
			if gobdem is true:
				say "[one of]Naughty, naughty[or]Ha, ha -- good -- ha[or]Mine, MINE, yes[at random]";
			otherwise:
				say "[if scalevalue of player > 3][one of]There we go, keep playing nice now, big one[or]That's right, be a good big slut[or]There we go, the big one knows their place[at random][otherwise][one of]There we go, keep playing nice[or]That's right, be a good little slut[or]There we go, someone knows their place now[at random][end if]";
		say "!' Quickly building a motion of thrusting wildly against you, you're made to taste his heady sexual fluids in the wake of his sexual fervour[if scalevalue of player < 4].  Relentless as he his, you feel like you're about to pass out from lack of oxygen until you suddenly feel your throat flooded with the goblin's tainted seed.  He inevitably pushes you free, no doubt amused as you gasp for air, eventually wiping[otherwise].  His thrusts become increasingly erratic until your maw is finally flooded with the goblin's tainted seed, the creature rigid against your maw as he attains blissful release. It takes him a bit, but he eventually pulls free of your lips, no doubt amused with himself as he wipes[end if] his cock clean against the side of your face.";
		say "     '";
		if gobdem is true:
			say "[one of]Ha, ha, yes, bye[or]Bye, mine, heh[or]Good, good[at random]";
		otherwise:
			say "[if hp of player > 0][one of]Not half bad, I've certainly had worse[or]That was some nice, quick fun[or]Ah, it's good to get some proper satisfaction around here[at random][otherwise][one of]Not half bad, once you learned your place[or]See? That wasn't all that bad[or]Maybe next time would give me less trouble[at random][end if]";
...
to say fgob_vicsex2:	[f-gob anal sex]
	say "     Approaching her, you immediately rip free her tattered loincloth, leaving her diminutive behind naked in the middle of the open air. [if scalevalue of player > 3]You can see her visibly tremble, clearly not sure what to expect from someone as large as you[otherwise]Perhaps too weak to contend your assault, she doesn't give you any trouble when you assess your inevitable angle of descent[end if]. Freeing yourself of any bindings, you grab ";
	If scalevalue of player > 4:
		say "the small creature, stroking [if cocks of player > 1]one of your now-exposed dicks[otherwise]your now-exposed dick[end if]";
	otherwise:
		say "her by her sides and grind [if cocks of player < 1]one of your now-exposed dicks[otherwise]your now-exposed dick[end if] between her asscheeks";
	say "before driving your hardened cock into her hole.";
	say "     She [if cock length of player > 8]immediately cries out in protest, her tight ring giving you a fair amount of resistance, but with a bit of work her passage inevitably abides your invading flesh, regardless of your victim's compliance[otherwise]flinches and struggles against the sensation of your invading flesh, her anal passage tight and ill-suited to abide even a reasonable intrusion, a resistance--as it may be--quickly diminished with a bit of force[end if]. [if scalevalue of player > 3]She's dragged across the ground with each successive thrust, trying in vain to anchor herself against the overwhelming storm of your rising fervor[otherwise]Gripping at the ground, she can barely hold herself in place as your thrusting's pace reaches a feverish pace[end if], until you find blissful relief.";
