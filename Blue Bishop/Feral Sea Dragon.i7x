			...
			if cunts of player > 0 and cunt length of player > 11:
				...
				if anallevel is not 1 and (a random chance of 1 in 4 succeeds or (anallevel is 3 and a random chance of 1 in 3 succeeds)) and (cunts of player is 0 or "More Anal" is listed in feats of player):
					...
					if cunts of player > 0:
						...
						say "     You writhe limply under the beast's girth, mind ahaze in pleasure.  It's as though this creature's cock was made just for you, your needy ring constricting against its rigid mass out of a carnal need to have it in you, its motion no doubt lubricated in its endeavours by his own sexual fluids.";
