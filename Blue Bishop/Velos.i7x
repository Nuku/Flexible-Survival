	...
	if HP of Velos is 0 or HP of Velos is 1:
		...
		if Player is not male_vacant and (insectlarva is false or (insectlarva is true and larvaegg is 2)):
			...
			if anallevel is 1:
				...
				say "     His particular request is clearly incongruous with your general desires. [link]Make him the exception (Y)[as]y[end link] or [link]rightfully decline (N)[as]n[end link]?";
			else:
				...
				say "     You're not going to get a straight answer out of this creature, you could [link]agree to his request (Y)[as]y[end link] or [link]decline it outright (N)[as]n[end link].";
			if Player consents:
				LineBreak;
...
to say velosdesc:
	...
	if level of Velos > 0:
		say "[line break][italic type]Demeanor-wise, he [if level of Velos is 1]doesn't seem to regard you all that well, and is otherwise a little belligerent towards you[else if level of Velos is 2]seems to regard you fairly well, and is a bit less perturbed by having himself be summoned before you[else if level of Velos is 3]seems to put you in high regard, more than happy to be on the receiving end of your attention[end if].[roman type][line break]";
...
Instead of conversing the Velos:
	...
	if player is in Grey Abbey Garden:
		...
		else if -3 is listed in velospostmusings:		[remove if unused and doesn't apply]
...
to say ResolveEvent Odd Green Patches:
	...
	LineBreak;
	say "     [bold type]You suppose you could always just let him in before you go, unless you would rather have him stay in there.[roman type][line break]";
...
carry out muselisting:
	...
	if the number of entries in L is 0:
		...
		repeat with q running through L:
			say "[link][Q][as]muse [Q][end link][line break]";
...
to say sgtalexmusing:
	say "     You're just about certain that this will be the dumbest thing you've ever done, but Alexander might be more 'open-minded' of the military fare around here. Looking around, you check to see if no one else is watching before you conjure Velos from his confines. The sergeant, well, um...[paragraph break]";
	...
	say "     'One of our top scientist in the area. I believe Padgett said it was Dr. Garcia... Er... Dr. Diego Garcia - that was it. Weren't you brief- forget I said that.' The serpent requires a moment to really calculate what has transpired here and, well, um...[paragraph break]";
...
to say drmoffattmusing:
	say "     Drawing Velos out from his place of hiding, Moffatt is a bit taken aback by this particular sight from behind her desk before she regards this turn of events with slight amusement.[paragraph break]";
...
to say drmousemusing:
	say "     You call out Velos [if level of Velos < 3]- at least part of you hoping the doctor might be able to help you deal with him - [end if]and with a moment of slight fidgeting, you present him to Doctor Mouse. Keeping his distance, he seems to ponder the creature for a moment.[paragraph break]";
...
to say frankmusing:
	say "     Calling Velos out from his confines, Frank is immediately pinned to a nearby wall, struck by his own shock.[paragraph break]";
...
to say valeriemusing:
	say "     You elicit Velos's attention, drawing him out before Valerie. The sphinx is briefly taken aback by this but calms down when you make it clear that there's no danger.[paragraph break]";
...
to say fangmusing:
	if HP of Fang is 1 or HP of Fang is 2:		[Omega or Vanilla Fang]
		say "     Calling Velos before your lupine watchdog, Fang can't help but lower his head in apparent bafflement at the scene which transpires before him, exacerbated when your passenger speaks.[paragraph break]";
...
to say haroldmusing:
	say "     Looking around to ensure that nobody's looking at you, you summon Velos before Harold. You can imagine his endeavors to clean a glass are a bit impeded when he's distracted with the sight of the serpent.[paragraph break]";
...
to say hadiyamusing:
	say "     Hadiya regards you with an appropriately cross expression until you summon Velos, eliciting a frown of slight disdain, mixed with a dash of confusion.[paragraph break]";
...
to say philipmusing:
	say "     Conjuring Velos from his confines, he immediately seems to regard the situation with a measure of disdain.[paragraph break]";
...
to say sandramusing:
	say "     Going over to Sandra you coax Velos from hiding and show her him, doubtlessly taking her a bit by surprise.[paragraph break]";
...
to say diegomusing:
	say "     Conjuring Velos from his confines, Diego is only briefly taken aback, but soon finds [if Diegochanged > 0]she[else]he[end if] can't help but laugh a bit at the circumstances at play.[paragraph break]";
	...
	say "     'Which is?'";
	say "     'Causing all sorts of trouble, it's in my nature! Oh boy, I can't wait to see your face when you see what I have planned for the military.' The snake is struck silent, his expression now wholly baffled, and he apparently requires a moment to really take in that statement. With a jolt, however, he suddenly reverts to normal.[paragraph break]";
...
to say lisamusing:
	say "     Conjuring Velos before the mouse-taur, Lisa's expression is one of slight bemusement. The serpent opens the dialogue.[paragraph break]";
...
to say beverlymusing:
	say "     You decide to conjure up your friend from hiding, calling Beverly over. The second she sees Velos coming from you, as he does, her eyes immediately go wide and she screams out.[paragraph break]";
...
to say Christymusing:
	...
	If dragontype > 0:
		...
		say "     'Oh, that's so very naughty, maybe I could borrow him for a- no, no! Never mind what I said.' The serpent can't help but furrow his brow at the dragoness's presently conflicted state.";
		say "     'You're quite the twisted lady, perhaps you should consider a hobby? Knitting, maybe? I'm sure we could find some rope and a pair of street lamps...?'";
...
to say nerminemusing:
	say "     Calling Nermine over, you prod yourself until Velos concedes to your request. The jackal is obviously a little disturbed by the serpent, but isn't particularly surprised.[paragraph break]";
	...
	say "     'INFESTATION? Lady, I'm standing right here! Well, okay, admittedly our friend is standing for me...' She waves off Velos's complaints, and begins to list off various strange afflictions, none of which seem to really match the circumstances you're currently subject to, Velos's grumbling discontent made apparent throughout until she's at odds with finding anything else that might be remotely related before she's hit with a possible revelation.[paragraph break]";
...
to say onyxmusing:
	say "     Summoning Velos, Onyx is - reasonably so - a bit displeased by this revelation, though he is at least a bit restrained in expressing it.[paragraph break]";
...
to say borismusing:
	say "     Moving over to Boris, you summon Velos from his confines, and bit of adjustment and fidgeting on your part, the faux lion is sent reeling back.[paragraph break]";
...
to say Anastasiamusing:
	say "     'Where have you brought me? This place is sweltering! Is... is that lava? Why are we even here?' Velos's line of enquiry elicited by his summoning; he seems a little more distressed by the apparent scenery and is doubtlessly a bit surprised when Anastasia approaches.[paragraph break]";
...
to say drmattmusing:
	...
	say "     'I don't know, if I turned my friend into me that'd make my occupancy rather ill-fitting..[no line break][if scalevalue of Player < 3]. I mean, more than it already is now[end if].'";
...
to postmuse (x - a number):
	if x is:
		-- -4:		[***Establish combat boon (Requires high favor)]
		...
		-- -1:		[***if Player has Reg. parasite in cunt:]
		...
		-- 14:		[Diego]
			say "     'I'm still right steamed over that coyote. Who does he think he is? You know...' his expression shifts into something more sullen, 'I sometimes wonder if just rotting in that sewer was the better thing to do. Maybe he's right, and I'm in no position to condemn him? Bah, never mind me...'";
		-- 15:		[Leonard]
	...
	remove x from velospostmusings, if present;
