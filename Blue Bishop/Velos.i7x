...
to say fangmusing:
	if HP of Fang is 1 or HP of Fang is 2:		[Omega or Vanilla Fang]
	...
	else if HP of Fang is 6: [Gentle Alpha Fang]
		say "     [if fangvelos1 is true]Once more[else]Reluctantly[end if], you conjure up Velos from his confines, Fang raising an eyebrow at his appearance[if fangvelos1 is false]. You find it strange that he would be so fine with his presence but decide that perhaps he already knew the snake was in there, or maybe he was just keeping his composure[end if]. 'Oh, hello[if fangvelos1 is true] again[end if], little doggie. Who's a cute pooch? You are!' Velos's attempt at condescension is met with a disinterested glance. [if fangvelos1 is true]Oh, what's this? You were frightened by me a while ago. Have you undergone some manner of change when I wasn't looking[else]Oh, you're a lot braver than I thought you would be, or perhaps you lack the cognitive capacity to understand what I could do to you while you're having your [']fun['][end if]?";
		...
		say "     [if fangvelos1 is true]Once more[else]Reluctantly[end if], you conjure up Velos from his confines, Fang snorting a little at his appearance[if fangvelos1 is false]. You find it strange that he would be so fine with his presence but decide that perhaps he already knew the snake was in there, or maybe he was just keeping his composure[end if]. 'Oh, hello[if fangvelos1 is true] again[end if], little doggie. Who's a cute pooch? You are!' Velos's attempt at condescension is met with a low growl in discontent. '[if fangvelos1 is true]Oh, what's this? You were frightened by me a while ago. Has your courage increased with your size[else]Oh, you're quite the brute aren't you? Did no one ever tell you that size isn't everything[end if]?'";
		say "     'Talk too much.' Velos is a bit at odds with the wolf's curt response, but ultimately attempts to coax more out of him. 'Oh, that's right rude! Surely you could offer me a more elaborate response? I wouldn't want to make you too uncomfortable, and we're all frie-' Velos['] retort is cut short as he rapidly recedes back into the safety of your bowels due to Fang advancing with his teeth bared and hackles raised. You can hardly blame him, witty banter is a poor defense against imminent violence. Your alpha eyes your ass with irritation, angry that he can't get at Velos in there. Part of you wonders what Velos thinks of the wolf's hyperfied cock...";
