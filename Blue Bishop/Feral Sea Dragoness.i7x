...
to say fsdfeeding:
	if fsdfeedmemory is 0:
		...
		say "     You're--rightfully so--taken off guard when you feel your bowels flood with her ill-conceived meal, [if scalevalue of player < 4]your beleaguered hole quickly strained under the excessive flow as you belly quickly bulges with her contents. She's a bit more liberal with feeding you this time, perhaps to teach you a lesson for trying to avoid getting fed, though you can at least take comfort in not having to taste its foul contents this time[else]though you're at least large enough to handle the rather lewd assault; however, her lack of familiarity with this tactic shines through when the beast apparently assumes she's underfed you, and only proceeds to unload more and more of the fish through your beleaguered hole, to the point where your belly bulges blatantly with her goods[end if].";
