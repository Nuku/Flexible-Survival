...
to say FSDF_1: [Cunt Pitching]
	say "     It doesn't take much before the[if scalevalue of player < 4] massive[end if] beast obliges your endeavor to expose her undercarriage, churring eagerly at you. You see her cunt as clear as day, shall you stretch her out a bit before proceeding? Else, you'll get straight to the point.";
	if player consents:
...
to say FSDF_2: [Anal Pitching]
	say "     It doesn't take much before the[if scalevalue of player < 4] massive[end if] beast obliges your endeavor to expose her undercarriage, churring eagerly at you. You see her hole as clear as day, shall you stretch her out a bit before proceeding? Else, you'll get straight to the point.";
	if player consents:
