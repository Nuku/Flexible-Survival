...
to say fsdf attack:
	...
	if vorelevel is 3 and scalevalue of Player < 4 and (a random chance of 1 in 4 succeeds or (Player is kinky and a random chance of 1 in 3 succeeds)):
		if HP of Player > 0:
			...
			say "     Having enough of this fight, her head lunges towards you, maw wide open!";
			now struggleatt is 1;
		if a random chance of 1 in 2 succeeds:
			say "     Before you can react, you're engulfed in darkness, the sea dragoness's slick, supple flesh enveloping you. Awash in the beast's acrid breath, she pulls you into the air by her lips, allowing gravity to aid her as she audibly gulps you down, powerful muscles plunging you down her slick depths.";
			...
			say "     Before you can react, you're engulfed in darkness, the sea dragoness's slick, supple flesh enveloping you. Awash in the beast's acrid breath, she pulls you into the air by her lips. Her motion so fast, she sends you spinning in the air before immediately catching you by your feet, exposing you to the[if daytimer is night] night[end if] light once more, your access to the fresh, salt air is made brief as the monster uses gravity to aid her as she audibly gulps you down.";
			say "     Allowed one final glimpse of the outside world before it's eclipsed by the monster's toothy maw, her powerful muscles plunge you down her slick depths. Hot tube constricting against you tightly, the beast's elongated gullet bulges visibly with your occupancy. Given the length of the trip, you're not yet wholly consumed by the sea dragoness. You might be able to pull yourself out of here before it's too late!";
			now tempnum2 is 0;
		wait for any key;
			...
			if Player is submissive:
				if a random chance of fsddom in 9 succeeds:
					if Player is male and a random chance of 1 in 2 succeeds:
						...
						say "     Tightly pressing her hole against you, you immediately explore her depths with your slick organ, its soft folds parting to accommodate your writhing intrusion. Tasting her emergent juices, you too can't help but be aroused, [if Player is female]aching cunt[sfn] left unattended[else if Player is male]throbbing, [cock size desc of Player] dick[smn] left unattended[else]body aching with insatiable need[end if]. All the while the beast groans and mocks you for your embarrassing need, often nipping you into working harder, until the rate of your slippery affections rises to a feverish pace, singing lowly as you're driven by an overwhelming desire to pleasure this aquatic mistress.";
						WaitLineBreak;
				...
				if Player is male:
					say "     She seems particularly affectionate to one of her own kind, and inevitably pulls away. Facing away from you, you hear her softly sing, coaxing you into overtaking her. Driven by your increasingly feral mind[if HP of Player < 1] and too exhausted to fight for control[end if], you slowly pull yourself on top of the dragoness, much to the beast's cooing approval. You thrust impotently against her scaled haunch before you're sufficiently hard, carefully moving to guide[if Cock Count of Player > 1] one of[end if] your [cock size desc of Player] cock[smn] into her hungry cunt.";
					WaitLineBreak;
					say "     [one of]You're initially gentle in forcing it in, the dragoness cooing softly as your rod slowly descends[or]Flared by a tinge of feral-charged aggression, you show your dominion by thrusting into her with sudden and reckless abandon; she wails softly in such abrasive pleasure as you drill your rod deep[at random] into the folds of her flesh. Your pace rapidly ascends as you fuck the dragoness, each thrust forcing an ecstatic wail out from the beast's lips, eager hole squeezing tightly around your[if Cock Length of Player > 15] substantial,[end if] throbbing organ.";
			...
			if "Touched by Madness" is listed in feats of Player and ((Player is kinky and a random chance of 1 in 3 succeeds) or a random chance of 1 in 4 succeeds) and scalevalue of Player < 4 and FSDOPEN < 2 and inasituation is false:
				...
				if (Player is kinky and a random chance of 1 in 3 succeeds) or a random chance of 1 in 4 succeeds:
					...
					if a random chance of 1 in 2 succeeds and MaleList is not banned:
						say "     After what seems like forever, you can see the familiar light of the outside coming through the translucent walls of your prison, compelling you to finally break free, and once you acclimate to the open air it's made very clear -why- you were forced within those confines longer than natural. A male sea dragon is before you; looking at his somewhat tired and lust-addled form, it's clear that he happened upon your egg and was compelled to use it for his own sexual gratification - much to your expense.";
						if (Player is kinky and a random chance of 3 in 8 succeeds) or a random chance of 1 in 5 succeeds:
							...
							if Player consents:
								...
								say "     You roll 1d20([dice])[if bonus >= 0]+[end if][bonus] = [special-style-1][dice + bonus][roman type] vs [special-style-2][target][roman type] (Dexterity Check): ";
						...
						say "     After what seems like forever, you can see the familiar light of the outside coming through the translucent walls of your prison, compelling you to finally break free, and once you acclimate to the open air it's made very clear -why- you were forced within those confines longer than natural. Another sea dragoness is before you, [one of]though you instinctively know that it's[or]fairly certain that it's not[at random] the same one that first trapped you. Looking at her somewhat tired and lust-addled form, it's clear that she was compelled to use your egg for her own sexual gratification - much to your expense.";
						if (Player is kinky and a random chance of 3 in 8 succeeds) or a random chance of 1 in 5 succeeds:
							...
							if Player consents:
								...
								LineBreak;
								say "     You decide the best thing to do is just let her have her way with you, the eager sea dragoness soon pinning you against the [if showlocale is true]sand[else]ground[end if], ready to subject you to her desire.";
								if HP of Player < 1, now HP of Player is 1;
								now FSDOPEN is 1; [This will deflect the opening submit/lose line, check will need to be added for it]
								say "[fsdf attack]";
						else:
				...
				WaitLineBreak;
				say "     Your vision is obviously obscured by the beast's expansive girth, though your sense of touch is more than sufficient a guide as you feel her cunt descend upon [if Cock Count of Player > 1]one of [end if]your [cock size desc of Player], throbbing tool[smn], an act that barely seems to phase her as she manages to envelop the impressive thing with little to no effort. Cooing softly in a show of approval [if scalevalue of Player < 4]down to[else]towards[end if] you, she relents only briefly before her massive form slowly begins to bob against its length.";
				say "     Eager to show off her tainted talent, the dragoness's bestial vent squeezes and massages along your cock's length with twisted determination, each descent of her body pounding you deeper into the sand. Driven by her wanton fervor she breaks out into song, the strange, auditory assault seemingly having the effect of intensifying your arousal, until you quickly cry out in bliss, your [Cum Load Size of Player] load flooding her hole[if Cock Count of Player > 2] while its brothers spill theirs impotently against her side[else if Cock Count of Player is 2] while its brother spills its own impotently against her side[end if].";
				WaitLineBreak;
				...
				if Player is male:
					...
					say "     She turns to depart. Not completely exhausted and driven into a lustful frenzy by the creature's influence, you try to crawl after her only for the beast to dive back into the water's depths. You collapse from exhaustion, and it takes you a while to get back up and clean the mess of bodily fluids the dragoness left in her wake.";
					CreatureSexAftermath "Player" receives "AssDildoFuck" from "Feral Sea Dragoness";
				else:
					say "[fsdfeeding]";
			else:
				say "[fsdfeeding]";
...
to say fsdfeeding:
	if fsdfeedmemory is 0:
		say "     Nosing your stomach briefly, she suddenly lifts her head and starts to clench her body in a strange way, making a slightly unsettling sound before her head descends once again to meet your face. Strangely silent and making a subtly odd expression, you shrug at her, not exactly sure what she wants from you.";
		...
		say "     Much to your relief, she inevitably finishes, chirping cutely at you. You find you can only scowl at the dragoness, an expression which is entirely lost on her as she regards you with immense pride before departing back into the waters. Right about now you'd be willing to subject yourself to even the most horrifying eldritch monstrosities if for just a shot of mouthwash.";
		now fsdfeedmemory is 1;
		...
		say "     Her maw descends upon your [bodytype of Player] face, the devious portal engulfing it as she presses your awful smelling meal against your tightly-shut lips. You can't hold your breath forever and you inevitably gasp for air, only to be rewarded with an additional helping of the beast's grotesque meal. Oddly enough, it doesn't seem that bad this time. Perhaps you're acclimating to it, or her infection is driving you to accommodate her whims. In either case, she seems ever so cheerful that her friend is fed, and gives you a wet lick before she descends back into the water's depths.";
		if a random chance of 1 in 3 succeeds, now fsdfeedmemory is 2;
		...
		say "     She lets out a muffled, perturbed rumble, you are victorious! Or so you initially think, as while she stares at you facing the ground she comes up with another plan. You're not sure what to do when she remains quiet for a short while, but her clever plan is quickly illuminated when you suddenly feel the dragoness's snout pressed firmly against your behind.";
		WaitLineBreak;
		...
		say "     Finishing, she sings happily, hobbling about in a strange, self-congratulatory dance. Oh yeah, you bet she thinks she's so clever for outsmarting you; you'd try to ruin such a bright mood if you weren't so unbelievably embarrassed by this turn of events. Finally, she hops off, happy as she ever can be. [if scalevalue of Player < 4]Struggling to return to your feet[else]It takes your bloated self to properly pull yourself to your feet. Inevitably[end if], you gather your things and pull your overstuffed form along. Nobody must know what happened here.";
		now fsdfeedmemory is 3;
	else:
	...
	if "Iron Stomach" is not listed in feats of Player or fsdfeedmemory is 3: [additional infection]
		if MaleList is banned or (Player is FemalePreferred and FemaleList is not banned):
			...
			infect "Feral Sea Dragon";
		if fsdfeedmemory is 3, now fsdfeedmemory is 4;
...
To say fsdf loss:
	...
	if Player is not submissive and ( Libido of Player - humanity of Player > 45 or ( Libido of Player - humanity of Player > 60 and "Dominant" is listed in feats of Player ) ) and ( BodyName of Player is "Feral Sea Dragon" or BodyName of Player is "Feral Sea Dragoness" ) and Player is male:
		say "     Just as you drive the dragoness back, the creature lets out a powerful cry that compels your twisted psyche to yield. Turning away from you, you hear her softly sing, coaxing you into overtaking her. Driven by your increasingly feral mind you slowly pull yourself on top of the dragoness, much to the beast's cooing approval. You thrust impotently against her scaled haunch before you're sufficiently hard, carefully moving to guide[if Cock Count of Player > 1] one of[end if] your [cock size desc of Player] cock[smn] into her hungry cunt.";
		say "     [one of]You're initially gentle in forcing it in, the dragoness cooing softly as your rod slowly descends[or]Flared by a tinge of feral-charged aggression, you show your dominion by thrusting into her with sudden and reckless abandon; she wails softly in such abrasive pleasure as you drill your rod deep[at random] into the folds of her flesh. Your pace rapidly ascends as you fuck the dragoness, each thrust forcing an ecstatic wail out from the beast's lips, eager hole squeezing tightly around your[if Cock Length of Player > 15] substantial,[end if] throbbing organ.";
		WaitLineBreak;
		...
		if Libido of Player < 40 and "Dominant" is not listed in feats of Player:
			say "     Before you can land the final blow, the dragoness suddenly backs away and concedes to you. Having asserted your dominance, it's clear she intends to offer herself to you. In no mood to humor her need, you send her off, slowly retreating back into the water's depths. You go about your business once more, now that the matter has been attended to.";
		else:
			say "     Before you can land the final blow, the dragoness suddenly backs away and concedes to you. Having asserted your dominance, it's clear she intends to offer herself to you. Shall you oblige her desire? Otherwise, you'll shoo her off.";
			if Player consents:
				LineBreak;
				fsdfvicmenu;
				now boundmod is 0;
...
to say FSDF_1: [Cunt Pitching]
	...
	if Player consents:
		...
		say "     Her bestial pussy easily obliges this intrusion, [if scalevalue of Player < 4]even as you begin to[else]and only begins to really show any resistance when you start to[end if] use your entire hand. Eager to be abused so, the monster's overtaken by her own lust, bestial cunt quickly dripping against your limb's persistent pounding. Eventually satisfied, you pull your arm free and get to the task at hand.";
		WaitLineBreak;
	else:
		LineBreak;
		now tempnum is 0;
	...
	if tempnum2 is not 2:
		...
		say "     Exposing your [cock size desc of Player] dick[smn] to the open air, [if tempnum is 1]your prior bit of fun has already left you hard, quickly sinking[else]it takes a little work to get you fully hard before slowly sinking[end if] the head of one of them into the monster's[if Cock Length of Player > 18] tight[end if] hole, [if Cock Count of Player > 2]another[else]the other[end if] down her ass. ";
	if tempnum is 1:
	...
	say "     Churring and moaning loudly, the[if scalevalue of Player < 4] massive[end if] beast revels in being railed, her stuffed, [if tempnum2 is 2]twin holes squeezing eagerly against their invaders, slicking them with[else if tempnum2 is 1]eager cunt squeezing greedily around its twin invaders, slicked by[else]eager cunt squeezing greedily around its invader, slicked by[end if] her juices. Blatantly submissive sea dragoness reveling in being fucked so, she sings loudly[if scalevalue of Player < 4] down[end if] at you in her lustful haze, [bodytype of Player] form trembling with each[if scalevalue of Player > 3] powerful[end if] thrust.";
	WaitLineBreak;
	say "     As time passes, your grip along the thick girth of the beast tightens, drawing ever closer to bliss. Monster twisting and pressing against you, she can't get enough of your cock[if tempnum2 > 0]s[end if]. Shall you pull out at the last second?";
	if Player consents:
		LineBreak;
		say "     Just at the cusp of ecstasy, you wrench your tool[if tempnum2 > 0]s[end if] free of the sea dragoness's tight hole[if tempnum2 is 2]s[end if], grinding against her hide until you're set off, firing your [Cum Load Size of Player] load against her underside, [if Ball Size of Player > 5]utterly drenching it[else]making an embarrassing mess of it[end if]. It doesn't seem to be enough to set her off, her abused [if tempnum2 is not 2]cunt[else]holes[end if] dribbling against the open air. Should you help her out?";
		if Player consents:
			LineBreak;
			...
			if Player consents:
				...
				CreatureSexAftermath "Player" receives "OralPussy" from "Feral Sea Dragoness";
				WaitLineBreak;
			say "     Stepping away, satisfied, you wipe yourself clean against her slick hide and depart, contending with the cum-stained monster's insistence on you remaining before she finally drags herself back into the sea, no doubt eager to be used by you again, some day...";
		else:
			LineBreak;
			say "     Stepping away, satisfied, you wipe yourself clean against her slick hide and depart, contending with the cum-stained monster's insistence on you remaining before she finally drags herself back into the sea, her lust left unsated, and no doubt eager to attend you again, some day...";
	else:
		LineBreak;
		say "     In one final thrust, you [if Player is knotted]tie[else]hilt[end if] your tool[if tempnum2 > 0]s[end if] within the sea dragoness's tight hole[if tempnum2 is 2]s[end if], crying out as you're set off, flooding her womb [if tempnum2 is 2]and bowels [end if]with your [Cum Load Size of Player] load[if Ball Size of Player > 5] and quickly beginning to sputter from her[end if]. This is more than enough to set the beast off, singing out weakly as her cunt squeezes and milks you of all you have to offer her.";
...
to say FSDF_2: [Anal Pitching]
	...
	if tempnum2 is not 2:
		...
		say "     Exposing your [cock size desc of Player] dick[smn] to the open air, [if tempnum is 1]your prior bit of fun has already left you hard, quickly sinking[else]it takes a little work to get you fully hard before slowly sinking[end if] the head of one of them into the monster's[if Cock Length of Player > 18] tight[end if] asshole, [if Cock Count of Player > 2]another[else]the other[end if] down her cunt. ";
	if tempnum is 1:
		say "[if Cock Length of Player > 18 or tempnum2 is 1]Giving you no resistance, your earlier work seems to have made inching yourself in deeper a fair bit easier[else]She gives you virtually no resistance, given your earlier work[end if], especially given her clear enjoyment from it.";
	else:
		say "[if Cock Length of Player > 18 or tempnum2 is 1]Giving you only slight resistance, even though she wasn't prepared for you, she certainly wants it[else]She gives you barely any resistance, clearly wanting it even if she hasn't received any preparation[end if].";
	say "     Churring and moaning loudly, the[if scalevalue of Player < 4] massive[end if] beast revels in being railed, her [if tempnum2 is 2]stuffed, twin holes squeezing eagerly against their invaders, slicking them with her juices[else if tempnum2 is 1]unattended cunt aching for attention as it drips to stain the sand, anal ring squeezing tightly around its twin invaders[else]unattended cunt aching for attention as it drips to stain the sand, anal ring squeezing tightly around its invader[end if]. Blatantly submissive sea dragoness reveling in being fucked so, she sings loudly[if scalevalue of Player < 4] down[end if] at you in her lustful haze, [bodytype of Player] form trembling with each[if scalevalue of Player > 3] powerful[end if] thrust.";
	WaitLineBreak;
	say "     As time passes, your grip along the thick girth of the beast tightens, drawing ever closer to bliss. Monster twisting and pressing against you, she can't get enough of your cock[if tempnum2 > 0]s[end if]. Shall you pull out at the last second?";
	if Player consents:
		LineBreak;
		...
		if Player consents:
			...
			if Player consents:
				LineBreak;
				say "     Stained by a mix of her juices and your own seed, you thrust a digit between her supple folds. Whining deeply, the needy sea dragoness doesn't need long before your attendance gives her reprieve, honey dripping between your tightly clenched fingers, staining the sand and further making an embarrassing mess of herself.";
			else:
				LineBreak;
			...
			LineBreak;
			say "     Stepping away, satisfied, you wipe yourself clean against her slick hide and depart, contending with the cum-stained monster's insistence on you remaining before she finally drags herself back into the sea, her lust left unsated, and no doubt eager to be used by you again, some day...";
	else:
		LineBreak;
		say "     In one final thrust, you [if Player is knotted]tie[else]hilt[end if] your tool[if tempnum2 > 0]s[end if] within the sea dragoness's tight hole[if tempnum2 is 2]s[end if], crying out as you're set off, unleashing your [Cum Load Size of Player] load into her supple bowels[if tempnum2 is 2] and womb[end if][if Ball Size of Player > 5] and quickly beginning to sputter from her[end if]. This is more than enough to set the beast off, singing out weakly as her [if tempnum2 is 2]abused[else]unattended[end if] cunt stains her underside and the sandy floor with her honey, further making an embarrassing mess of herself.";
		say "     Wrenching yourself free, satisfied, you wipe yourself clean against her slick hide and depart, contending with the cum-stained monster's insistence on you remaining before she finally drags herself back into the sea, no doubt eager to attend you again, some day...";
		if tempnum2 is 2:
			CreatureSexAftermath "Feral Sea Dragoness" receives "PussyFuck" from "Player";
		CreatureSexAftermath "Feral Sea Dragoness" receives "AssFuck" from "Player";
...
to say FSDF_3: [Oral Receiving Cock]
	...
	if Player consents:
		LineBreak;
		say "     Immediately, you wrench your dick free of her lips, strings of precum and saliva trailing from the creature's maw. A couple seconds of grinding against her snout, and you cry out, unleashing your [Cum Load Size of Player] load against the beast's obliging and lust-hazed visage. Whining softly, the beast idly licks at her face as she's shamed like this.";
	else:
		LineBreak;
		say "     It's not long before you finally cry out in bliss, firing your [Cum Load Size of Player] load into the creature's obliging maw. Whining softly, she gulps audibly in an eager desire to swallow your cum[if Ball Size of Player > 5], the sheer volume of which quickly causing it to ooze from her lips[end if].";
	say "     Satisfied, you step away from the dragoness, writhing against the sand with a need to satisfy her own, lingering lust in the wake of your task. No doubt the beast will have to attend to her own need after you turn and depart.";
	CreatureSexAftermath "Feral Sea Dragoness" receives "OralCock" from "Player";
...
to say FSDF_4: [Oral Receiving Cunt]
	...
	if Player consents:
		...
		LineBreak;
		now tempnum is 0;
	say "     [if tempnum is 1]Eager to begin[else if tempnum is 2]Eager and drooling to begin[else]With little effort[end if], she obliges your need, scaled lips parting to envelop [if Cunt Count of Player > 1]one of [end if]your puss[yfn] within its embrace. Thick tongue slathering along its supple entrance, [if Cunt Depth of Player > 17]she easily thrusts the slick, writhing organ into your pliable depths[else]she thrusts the slick, writhing organ into your depths, quickly straining you with its impressive size[end if]. The touch of her saliva[if tempnum is 2], along with that lingering in your maw,[end if] [one of]seeming to intensify[or]intensifying[stopping] your arousal, you can't help but press against her snout, the dragoness churring in approval.";
	if Player is male:
		say "     Writhing against the beast's touch, happily making you twitch and gasp with each motion of her worming appendage, you find it difficult to keep a clear head as you rapidly approach ecstasy. You don't think you'll be able to hold back for any longer, dick[smn] drooling against the open air. Shall you pull off at the last second and shame the sea dragoness with your cum? Otherwise, you'll spare her the humiliation.";
		if Player consents:
			LineBreak;
			say "     Immediately, you wrench yourself free of her tongue, strings of saliva trailing from the creature's maw following the organ's loud departure. A couple seconds of grinding your throbbing, [cock size desc of Player] cock[smn] against her snout and you finally cry out, unleashing your [Cum Load Size of Player] load against the beast's obliging and lust-hazed visage. Whining softly, the beast idly licks at her face as she's shamed like this.";
		else:
			LineBreak;
		...
		say "     Writhing against the beast's touch, happily making you twitch and gasp with each motion of her worming appendage, you find it difficult to keep a clear head as you rapidly approach ecstasy. Lost in a haze of your need, you cling tightly to the beast, driving her to attend you ever-harder.";
		WaitLineBreak;
	...
	say "     Satisfied, you finally step away from the dragoness, writhing against the sand with a need to satisfy her own, lingering lust in the wake of your task. No doubt the beast will have to attend to her own need after you turn and depart.";
	CreatureSexAftermath "Feral Sea Dragoness" receives "OralPussy" from "Player";
...
to say FSDF_5: [Oral Giving Cunt]
	...
	if Player is not neuter:
		...
		if Player consents:
			LineBreak;
			say "     Eagerly, the sea dragoness's thick tongue [if Cock Count of Player > 1]wraps around one of your dicks, throbbing[else if Player is male]wraps around your dick, throbbing[else if Cunt Count of Player > 1]caresses one of your cunts, aching[else]caresses your cunt, aching[end if] needily against the slick, writhing organ's touch. The dragoness's breath becomes increasingly shallow, your crotch awash in her hot breath with each powerful exhale, [if tempnum is 1]hole now slick with a mix of saliva and sex[else if tempnum is 2]her stuffed holes aching against you[else]her hole's oozing becoming more substantial with each passing second[end if], indicating her imminent bliss.";
			now tempnum2 is 1;
		else:
			LineBreak;
			say "     Swatting the sea dragoness away, she's left to be the only one on the receiving end of any affection, [if Cock Count of Player > 1]your own, unattended dicks throbbing[else if Player is male]your own, unattended dick throbbing[else if Cunt Count of Player > 1]your unattended cunts aching[else]your unattended cunt aching[end if] against the open air. The dragoness's breath becomes increasingly shallow, body trembling with each powerful exhale, [if tempnum is 1]hole now slick with a mix of saliva and sex[else if tempnum is 2]her stuffed holes aching against you[else]her hole's oozing becoming more substantial with each passing second[end if], indicating her imminent bliss.";
			now tempnum2 is 0;
	else:
		say "     Your continued attention quickly picks up in pace, fueled by your own insatiable lust. The dragoness's breath becomes increasingly shallow, body trembling with each powerful exhale, [if tempnum is 1]hole now slick with a mix of saliva and sex[else if tempnum is 2]her stuffed holes aching against you[else]her hole's oozing becoming more substantial with each passing second[end if], indicating her imminent bliss.";
		now tempnum2 is 0;
	say "     Continuing to work on her, you eventually manage to set the beast off, air filled with the sound of her loud singing as her [if tempnum is 2]twin holes tighten around your intrusions[else]her cunt tightens around your intrusion[end if]. [if tempnum is 1]Your maw is quickly flooded with her juices, quickly overwhelming you[else]Your hands are rapidly drenched in her juices[end if]";
	if tempnum2 is 1:
		say ". The whole [if tempnum is 1]ordeal[else]sight[end if], combined with the sea dragoness's own attendance, is more than enough to set you off, your [if Player is male][Cum Load Size of Player] load flooding her maw as it encircles your tool[else] cunt aching against her tongue's slathering affection[end if]";
	say ".";
	...
	if tempnum is 1:
		CreatureSexAftermath "Player" receives "OralPussy" from "Feral Sea Dragoness";
	if tempnum2 is 1:
		CreatureSexAftermath "Feral Sea Dragoness" receives "Oral[if Player is male]Cock[else]Pussy[end if]" from "Player";
...
When Play begins:
	...
	now Species Name entry is "Feral Sea Dragon"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	add "Feral Sea Dragoness" to infections of TaperedCockList;
	add "Feral Sea Dragoness" to infections of InternalCockList;
	add "Feral Sea Dragoness" to infections of InternalBallsList;
	...
	add "Feral Sea Dragoness" to infections of FeralmindList;
	...
	now Cross-Infection entry is "Feral Sea Dragon"; [ Infection that this infection will give the player when they lose; can be left empty if they infect with the monster's own strain. ] [ Is this a non-infectious, non-shiftable creature? True/False (usually false) ]
...
to fsdfvore:
	...
	while Trixieexit is false:
		...
		if lustatt > 99:
			if Player is male:
				say "     Finding yourself overtaken by lust, you are given no choice but to furiously jerk yourself off, writhing and twisting in these dark, damp confines until you finally find reprieve,unloading your [Cum Load Size of Player] load against the supple flesh[if Ball Size of Player > 5]. This wasn't a particularly wise task, as you're now made to swim in a pool of your own seed, though it thankfully diminishes over time[end if]. Panting to catch your breath, your mental faculties eventually return to you, leaving you to assess the matter at hand.[paragraph break]";
			else:
				say "     Finding yourself overtaken by lust, you are given no choice but to furiously fondle yourself, writhing and twisting in these dark, damp confines until you finally find reprieve, [if Player is female]cunt throbbing firmly against the supple flesh[else]a particularly trying task given your lack of outlet[end if]. Panting to catch your breath, your mental faculties eventually return to you, leaving you to assess the matter at hand.[paragraph break]";
		...
		if humanity of Player < 1:
			...
			if boundsegment is 1:
				...
				say "     Submerged in a churning mass of flesh, you're utterly lost in the sea dragoness's stomach, the whole affair a disorienting mess as you feel yourself getting slowly drained. [one of]The prison smells of fish and seawater, making it hard to focus[or]The beast churrs lowly, clearly enjoying how her meal writhes around[or]Your captor happily swims about, deliberately exacerbating your situation[at random]. You imagine your only active option is to [bold type]S[roman type]truggle enough until she lets you go, else you can [if obliging is true][bold type]O[roman type]blige[else][bold type]A[roman type]bide[end if] her or [if boundrecover is true][bold type]R[roman type]ecover from[else][bold type]E[roman type]ndure[end if] these questionable circumstances.";
			...
			if keychar is "s" or keychar is "1" or keychar is "return" or keychar in lower case matches the text "struggle":
				...
				if boundsegment is 2:
					...
					if struggleatt < 3:
						...
						if tempnum2 is 4:
							say "     Unable to keep you down any longer, the sea dragoness groans and spits you out into the waters with an audible splash. The sudden shock of light and cool waters stuns you for a moment, but eventually you swim back up to the surface. Whining at you, annoyed, your captor isn't about to let her once-meal off so easily. You'll have to swim back to the beach before she can catch up with you!";
							now boundcounter is 0;
							now boundsegment is 2;
							now struggleatt is 0;
						else:
							say "     Unable to keep you down any longer, the sea dragoness groans and spits you out onto the sandy beach, your impact punctuated with a puff of sand. The sudden shock of light and firm earth briefly stuns you, but you eventually stumble to your feet and get a sense of what's going on. Whining at you, annoyed, your captor isn't about to let her once-meal off so easy, and you're forced to retreat further inland, where she can't reach you.";
					...
					if struggleatt < 3:
						...
						if boundmod2 is not 1:
							say "     Body finally churning, it can no longer take your protests, constricting around you as it squeezes you back up the sea dragoness's gullet. Whining lowly in discontent, the beast has little interest in letting you go so easy, even if it's a struggle for her to keep you down. You still have a ways to go!";
							now boundsegment is 1;
							now struggleatt is 1;
						else:
				...
				if obliging is true:
					if boundsegment is 2:
						say "     Overtaken by the desire to return, you submit to your fate, the sea dragoness immediately catching up on you. Maw agape to scoop you up from the water, you're engulfed in darkness, the sea dragoness's slick, supple flesh enveloping you once more. Awash in the beast's now-familiar, acrid breath, she pulls you into the air with her maw, allowing gravity to aid her as she audibly gulps you down, powerful muscles plunging you down her slick depths. Hot tube constricting against you tightly, the monster's elongated gullet bulges visibly with your occupancy.";
...
to say fsdheatstart:
	if heatform is 0:	[female heat has added effects]
		choose row with Name of "Feral Sea Dragoness" from Table of Random Critters;
...
to say fsdheatend:
	say "As your heat passes, your needy draconic [if Player is female]cunt[else]asshole[end if] becomes a little less prominent and swollen.";
	...
	if heatturnskipper is true:
		...
		if a random chance of fsdchance in 250 succeeds:
			if location of Player is fasttravel and location of Player is not Beach Plaza and location of Player is not Bouncy Castle:
				...
				decrease humanity of Player by 3;
				raise Player Libido by 2;
			else if location of Player is Shallow Bay or location of Player is BeachEnd or location of Player is Rock Arch or location of Player is Open Ocean or location of Player is Sunken Ship:
				...
				say "     [if Player is female]Your puss[yfn] quiver[sfv] and clench[esfv] in waves as your heat continues unabated. Mmm... waves washing over you... lapping at your wet folds[else if Player is male]Your dick[smn] throb[smv] and spurt[smv] in waves as your heat continues unabated. Mmm... waves washing over you... lapping at your slick, [cock size desc of Player] cock[smn][else]Your body trembles in waves as your heat continues unabated. Mmm... waves washing over you... lapping at your slick undercarriage[end if]... cool, soothing waves... Your mind wanders to thoughts of the sea and you find yourself desiring to head there.";
