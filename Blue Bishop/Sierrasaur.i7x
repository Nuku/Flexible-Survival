...
to sierrasex:
	...
	else if anallevel is not 1 and (cunts of player is 0 or anallevel is 3) and a random chance of 1 in 8 succeeds:
	...
	if bodyname of player is "Sierrasaur":
		if humanity of player < 10:
			if voreloss is true:
				...
				else if (cunts of player > 0 or "Mpreg" is listed in feats of player) and "Sterile" is not listed in feats of player:
					say "to sire your children";
				else:
