...
Purified of Sierrasaur cum is "distilled cum".
...
Table of Game Objects (continued)
name	desc	weight	object
"Sierrasaur milk"	"A plastic water bottle filled with what is clearly milk. One could think it was a regular cow's milk, if someone hadn't written 'Sierrasaur milk' across the label on the bottle. You [italic type]could[roman type] drink it to quench your thirst. Who knows what else it might do to you though..."	1	Sierrasaur milk

Sierrasaur milk is a grab object.
Sierrasaur milk is milky.
Purified of Sierrasaur milk is "distilled milk".
...
to say Sierrasaur milk use:
	say "Lifting the plastic bottle to your mouth, you take a drink from it, letting the dinosaur milk run over your tongue and down your throat. Tastes rich and animal-like. Swishing it around in your mouth a little, you finish the bottle off, then stuff it back into your collection of 'empties'.";
	PlayerDrink 15;
...
[This item can't drop. Replaced by Sierrasaur Cum. Keeping to prevent import shenanigans. To do: delete this object from the game including all mentions in other files.]
