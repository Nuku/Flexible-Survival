...
when play begins:
	...
	add One flew into the Cuckoos Nest to BadSpots of CuckList;
...
when play begins:
	...
	add Two crash into the Cuckoos Nest to BadSpots of FurryList;
	add Two crash into the Cuckoos Nest to BadSpots of CuckList;
...
to say ResolveEvent Two crash into the Cuckoos Nest:
	...
	if Player consents:
		...
		LineBreak;
		say "     Deciding against the idea you start to turn around and walk back down the path. You come across Izzy walking with a studly male deer. It seems neither of the campfire cooks are going to win today's bet.";
...
when play begins:
	...
	add Avian Tent to BadSpots of FurryList;
	add Avian Tent to BadSpots of CuckList;
...
to say ResolveEvent Avian Tent:
	...
	if Player consents:
		LineBreak;
		say "     You're very interested in seeing how this will play out, so you hide behind a bush that has been quite a popular hiding spot based on the variety of foot or paw-prints surrounding it. Meanwhile, the burly osprey's hands start to cup the sultry femme's perky C cup breasts, and he proclaims in a confident air, 'Girls like you always turn to putty in a real man's grasp.' Then he wraps one hand around her neck while the other rubs the clit, saying in her ear-hole, 'Admit it, a needy slut like you want to be dominated.' Shuddering, the female nods and breathlessly utters, 'Yes. I want it... no, I need it!' The dominant raptor grips Izzy's neck tighter and growls, 'You forgot to say sir.' Gasping from the pain and pleasure, the woman says between short breaths, 'Sorry sir! Please forgive me sir!' Smirking, the dom yields his grip and orders the sultry cuckoo to worship his cock.";
		say "     The now-submissive cuckooess hops off his lap and turns around giving you a very good view of her pussy, slick with her juices. Next she starts to lick the tapered tip of the pilot's impressive rod. In between licks the subby birdy teasingly says, 'How are you able to fit inside a cockpit when you're packing something like this sir? Having a giant joystick to deal with is probably why you crashed.' Grabbing the back of her head the sea hawk responds, 'You talk too much,' and pushes her head forward so that the mouthy femme can take his dick all the way to the enlarged base. 'I know a better use for that mouth of yours,' the forceful osprey says next. With the tapered tip of the pilot's phallus reaching the back of her throat, the woman can only manage to utter a very garbled, 'Yes sir.'";
		WaitLineBreak;
		say "     Izzy's eyes start to widen as she is kept deep-throating the shaft for a couple seconds longer than is comfortable. Releasing his grip, the osprey allows the cuckooess's beak to get off his cock and lies down on his back and states, 'Now how about you ride me in reverse cowgirl position.' Taking a couple of seconds to catch her breath the exhausted woman nods and gets ready to move into place. Guiding the thick raptor's rod between her nether lips the cuckoess grunts as it slides into her. Meanwhile, having had to listen to his girlfriend being taken by someone he hasn't even seen yet, Gray's slightly undersized dick starts to leak precum. Noticing this the sea hawk gives a sudden and forceful thrust of his hips causing the adulterous femme to sharply cry out.";
		say "     Oozing with bravado, the raptor says, 'Bet you've never made her cry out like that before have you boy?' Meekly, the diminutive cuckoo male shakes his head and says, 'No sir...' With a wry smile, the fighter jet pilot caresses the curves of the stuffed woman's curvaceous booty then says, 'Now I want you to use your hips to ride my dick, I'm not gonna do any thrusting, if you want to cum you have to earn it.' Turning her head to look at the face of the commanding male the woman winks one eye and energetically replies, 'Sir yes sir!' She then places her arms on the burly osprey's broad shoulders and starts to thrust her hips up and down to ride the large shaft. Picking up the pace she goes faster and fast coming ever closer to a climax.";
		WaitLineBreak;
...
when play begins:
	...
	add Thief's Punishment to BadSpots of FurryList;
...
when play begins:
	...
	add Thief's Reformation to BadSpots of FurryList;
...
to say ResolveEvent Thief's Reformation:
	...
	if Player consents:
		...
		LineBreak;
		say "     You decide to play it safe and let the two jocks fight their own battle. Wishing them the best of luck, you quickly dash into the forest on the opposite side of the clearing to the lizard gang-members. Behind you, there are sounds of a tough scuffle.";
