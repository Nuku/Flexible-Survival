...
to say ResolveEvent Hang Ten:
	...
	say "[line break]     [bold type]Are you interested in her body or is it just her skills with the board that got your notice?[roman type][line break]";
...
when play begins:
	add Parasol Nap to BadSpots of MaleList;
	add Parasol Nap to BadSpots of FemaleList;
	add Parasol Nap to BadSpots of FurryList;
