...
to say felinoid wins:
	if HP of Player > 0:
		...
		if ( Player is female and Cunt Depth of Player > 7 ) or ( a random chance of mchance in 12 succeeds and Player is not female ):
			...
			increase catnum by 1;
			CreatureSexAftermath "Felinoid" receives "OralPussy" from "Player";
		else:
		...
		if Player is female:
			...
			WaitLineBreak;
			say "     Deeper and faster, the barbs on his cock cause the growing friction to alternate between agony and bliss as they scrape and then soothe sensitive parts deep within you. You are panting heavily, unsure if you can take much more. After a few more blissful seconds, he thrusts deep once more and roars above you, finally deigning it the right time to clamp his jaws down on your neck, extending your own orgasm as his seed floods into you.";
...
When Play begins:
	...
	now Species Name entry is "Felinoid"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Felinoid" to infections of FelineList;
	add "Felinoid" to infections of FurryList;
	add "Felinoid" to infections of FeralList;
	add "Felinoid" to infections of NatureList;
	add "Felinoid" to infections of MaleList;
	add "Felinoid" to infections of BarbedCockList;
	...
	now skin entry is "[if looknow is true]a thick pelt of coarse yellow-gold fur covering your thick, pliable[else]yellow-gold fur-covered[end if]"; [ skin Description, format as "Your body is covered in (your text) skin."]
	...
	now face change entry is "it draws forward into a short, feline muzzle, even as your ears perk upwards to perch, rounded, atop your leonine head. Scents burn in your new nose and you find yourself turning in place, trying to catch [italic type]his[roman type] scent"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
	now body change entry is "power builds in every muscle, making you feel more alive than ever before. Somehow you just know that you would be just as comfortable on all fours now as on two legs"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	now skin change entry is "a light gold fur spreads down it, covering it in a thick pelt"; [ Skin change text, format as "Your skin feels funny as [skin change entry]." ]
	now ass change entry is "the muscles under the skin change, modifying for leaping and catching prey"; [ Ass/tail change text, format as "Your ass feels funny as [ass change entry]." ]
	...
	now MilkItem entry is "felinoid milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "felinoid cum"; [ Item to be given to the player if they have this infection and jerk off. ]
