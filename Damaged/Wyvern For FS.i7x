...
When Play begins:
	...
	now body descriptor entry is "[one of]slender[or]snake-like[or]flexible[or]winged[at random]";
	now type entry is "wyvern";		[ one-word creature type. Ex: feline, canine, lupine, robotic, human... Use [one of] to vary ]
