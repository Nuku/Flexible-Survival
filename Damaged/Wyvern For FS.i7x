...
When Play begins:
	...
	now skin entry is "[if looknow is 1]scaled[otherwise]mottled like a snakes scales, you can't help but admire your[end if]";[ skin Description, format as the text "You have (your text) skin"] 
