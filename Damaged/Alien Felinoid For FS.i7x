Version 7 of Alien Felinoid For FS by Damaged begins here. 
...
When Play begins:
	...
	now skin entry is "[if looknow is 1]a thick matt of course yellow-gold fur covering your thick, pliable[otherwise]yellow-gold fur covered[end if]";[ skin Description, format as the text "You have (your text) skin"] 
	...
	now skin change entry is "a light gold fur spreads down it, covering it in a thick matt."; [ skin change text. format as "Your skin feels funny as (your text)" ]
