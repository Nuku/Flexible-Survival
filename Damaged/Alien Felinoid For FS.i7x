...
to say felinoid attack:
	if hp of player > 0:
		...
		if ( cunts of player > 0 and cunt length of player > 7 ) or ( a random chance of mchance in 12 succeeds and cunts of player is 0 ):
			...
			say "     Those thoughts [if cunts of player > 0 or cocks of player > 0]push you over the edge, causing you to cry out again as you climax[otherwise]fill your mind as the big kitty continues to plow into you, dominantly fucking you[end if][if cunts of player > 0], squeezing your cunt down around his pulsing rod[otherwise if cocks of player > 0], spraying your unneeded seed across the ground as your anus clamps down aorund his pulsing rod[end if].  The beast continues to pound into you[if cunts of player > 0 or cocks of player > 0] while you cum[end if] before finally sinking his shaft fully inside you and unleashing his hot load with a triumphant growl.  As his hot seed floods your [if cunts of player > 0]womb[otherwise]bowels[end if], you feel wonderful to have been claimed by such a powerful male stud.[impregchance][impregchance]";
			say "     Spent, the feline pulls his cock from your [if cunts of player > 0]creamy pussy[otherwise]abused anus[end if] and releases you.  He nuzzles at your neck and purrs softly, nudging you to get up and leave now that he's done with you for now.  Still feeling the effects of his musk and the fucking, you are reluctant to leave, but you obediently gather your things and head on your way, hoping you might let him, or another of these great cats, take you again soon.";
