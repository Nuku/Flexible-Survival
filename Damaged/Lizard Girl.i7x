...
to say lizgirl check angry:
	if lizgirlangry is 1 and HP of Player < 11 and inafight is 1:
		now dam is 0;
		now fightoutcome is 19;
		say "[line break]The lizard girl draws away from the fight. 'Useless useless useless, your blood is weak and tainted!' she screams. With a final sigh she regains her composure and paces away.[no line break][combat abort]";

to say lizgirl attack:
	if lizgirlangry is 1 and combat abort is 0:
		...
		if Player is not male:
			...
			if lizgirlimpreg is 0:
				...
				say "     'Now be a good dear, and don't fight it anymore,' she says over her shoulder as she sashays away.[lizgirl female]";
				CreatureSexAftermath "Lizard Girl" receives "PussyFuck" from "Player";
				now lizgirlimpreg is 1;
			else:
...
to say lizgirl desc:
	if Player is MalePreferred or Player is HermPreferred or Player is FemalePreferred or Player is sterile or "One Way" is listed in feats of Player or "Always Cocky" is listed in feats of Player or Player is neuter:
...
When Play begins:
	...
	now Species Name entry is "Lizard"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Lizard Girl" to infections of ReptileList;
	add "Lizard Girl" to infections of FurryList;
	add "Lizard Girl" to infections of NatureList;
	add "Lizard Girl" to infections of FemaleList;
	add "Lizard Girl" to infections of InternalCockList;
	add "Lizard Girl" to infections of InternalBallsList;
	...
	now face change entry is "it draws forward a little, a reptilian muzzle forming as your teeth reshape into delicate sharp points"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
	now body change entry is "you can feel the tingling radiate outwards, muscles, bones and organs shifting and rearranging"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	now skin change entry is "a wave of scales of seemingly random colors pours over you. Yet as they thicken and interlock, you notice a strangely beautiful pattern emerge"; [ Skin change text, format as "Your skin feels funny as [skin change entry]." ]
	now ass change entry is "your cheeks are pulled in and tight. A lizard tail grows out, strong and muscled, but shaped to nicely cover your tight bottom"; [ Ass/tail change text, format as "Your ass feels funny as [ass change entry]." ]
