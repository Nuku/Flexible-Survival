...
when play ends:
	if bodyname of player is "Feline":
		if humanity of player is less than 10:
			...
			otherwise:
				...
				if cunts of player > 0:
					...
					if cocks of player > 0:
						say ".";
						say "     Being equipped with a cock as well, you become the alpha female of the pride.  When others of your pride disobey you, you work out your fustration and deepen familial bonds by fucking them until they submit in a puddle of pleasured fluids.  You end up siring several cubs of your own.";
		...
		otherwise:
			say "     You survive and are taken to the military's holding facility.  Many of the soldiers treat you like a little girl and not like an adult.  This allows you a few priveleges you wouldn't otherwise have.  And if you get caught roaming around the base to meet up with another feline there for a little fun, you simply act like you got lost and you're off the hook.";
			...
			otherwise if cocks of player is 0:
				say ".  You are a lustful little cat girl though, seeking out as many felines of any species as you can get, as long as they have a hard cock to fill yoou.  And while lions may be your favorite, nothing says you can't enjoy the others as well.  You eventually move in with a sexy male lion who indulges your girlish playing around and is happy to let you play with the other kitties as long as he can get his fair share of your hot pussy.";
			otherwise:
				say ".  Lacking a gender of your own, but still remaining a lustful little cat girl, you seek out as many feline playmates of any species as you can find.  You seek to pleasure them in any way they desire, pleasing them orally, suckingling their breasts, offering up your ass or even using toys to make up for your lack of equipment.  You are an eager playtoy for them, submitting to any desire they may have.  You eventually move in with an eight-foot tall, over-endowed herm lioness who is as happy to stuff your tight ass as to have you do her with a giant strap-on.";
