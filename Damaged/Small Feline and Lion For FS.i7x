...
this is the leoninelust rule:		[continuous lustful weakening of player]
	if Feline_type is 2 or Feline_type is 4:		[lion man only]
		...
		if dam > 0:
			...
			if hp of Leonard >= 7:
				decrease libido by a random number between 0 and 1;
			if hp of Leonard >= 14:
				decrease libido by a random number between 0 and 1;
