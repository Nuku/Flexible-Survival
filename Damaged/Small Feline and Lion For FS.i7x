Version 11 of Small Feline and Lion For FS by Damaged begins here.
...
to say cat def:
	...
	if libido of player >= 40:
		if cocks of player > 0:
			say "     Deciding to make use of the pesky catgirl, you push the small, curvy feline to the ground and pounce her.  She mewls softly, but doesn't pull away as you line up your [cock of player] cock and drive it into her[if cock length of player > 20].  Your massive cock makes a huge bulge in the little feline and she moans and mewls uncontrollably, rubbing her paws over her swollen tummy[otherwise if cock length of player > 12].  Your big cock makes an appreciable bump in the little feline's belly and she rubs it, moaning and mewling happily[otherwise].  Your cock stuffs the little feline, cramming her full of throbbing meat, making her moan and mewl happily[end if].  Her pussy quivers around your shaft and her B-cup breasts sway as you pound into her curvy body.  When finally you cum, you pump your thick seed into her, leaving her [if cock width of player > 15]hugely bloated as your ample cum stuffs her small body, flowing out her overstuffed pussy[otherwise if cock width of player > 8]tummy a little plump and her pussy leaking your seed[otherwise]her pussy stuffed full of your semen and slowly leaking cum[end if].  She purrs softly, passed out after getting fucked good and hard.";
			now z is 1;
	...
	otherwise if ( hp of Leonard >= 16 and hp of Leonard < 100 ) and Feline_attached is 0 and bodyname of player is "Feline":
		if Feline_meow is 0, increase Feline_meow by 1;
...
to say lion def:
	...
	if hp of Leonard >= 15 and hp of Leonard < 100 and bodyname of player is "Feline":
		say ".  Knocked down and beaten, the leonine man is lying on the ground, his cock still mostly hard after being denied release.  Eying it, you wonder if perhaps you might risk having a little fun with him to teach him better respect for Leonard's pride.  You certainly wouldn't mind sampling that feline meat[if cocks of player > 0 and Feline_meow < 8] or even that tawny ass[end if] of his now that he's subdued.  Do you want to have some fun with him?";
		now z is 1;
	otherwise if libido of player + ( Feline_meow * 3 ) > 50:
		say ".  Knocked down and beaten, the leonine man is lying on the ground, his cock still mostly hard after being denied release.  Eying it, you find yourself wondering if you could risk having a little fun with that feline meat[if cocks of player > 0 and Feline_meow < 8] or even that tawny ass[end if] now that he's subdued.  Do you want to have some fun with him?";
		now z is 1;
	if z is 1:
...
to say cat vict:
	...
	otherwise if hp of Leonard >= 15 and hp of Leonard < 100 and bodyname of player is "Feline":
...
to say feline att:
	if Feline_type is 1:
		say "[cat att]";
	otherwise if Feline_type is 2 or Feline_type is 4:
		say "[lion att]";
	otherwise:
		say "[huntpride att]";
...
to say feline desc:
	...
	if Feline_type is 3:			[forced hunting pride fight]
		...
		now int entry is 16;
		now cha entry is 20;
	otherwise if Feline_type is 4:	[forced male lion fight w/usurper]
...
When Play begins:
	...
	now face entry is "[if hp of Leonard >= 15 and hp of Leonard < 100]that of a proud and beautiful lioness[otherwise]the cute head of a small lioness[end if]";[ Face description, format as the text "Your face is (your text)."] 
	now body entry is "[if hp of Leonard >= 15 and hp of Leonard < 100]that of a sexy lioness woman.  Being full height and full-figured, you are a matronly pride mother now.  Your nipples are visible and black, begging to be sucked on, leaking a constant stream of thick cream that runs down your body if it isn't being constantly drunk[otherwise if breast size of player > 2]a female lioness.  You are only about four feet tall, though you have huge breasts for your height and your exposed sex is swollen and dripping with need. Your nipples are visible and black, begging to be sucked on, leaking a constant stream of thick cream that runs down into your fur if it isn't being drunk constantly[otherwise]a female lioness.  You are only about four feet tall, though your exposed sex is swollen and dripping with need.  Your nipples are visible and black, begging to be sucked on.  Despite the smaller size of your breasts, they are often leaking a stream of thick cream that runs down into your fur if it isn't being drunk constantly[end if]";[ Body Description, format as the text "Your Body is (your text)."] 
	...
	now face change entry is "[if hp of Leonard >= 15 and hp of Leonard < 100]your head shifts and becomes that of a lovely lioness, proud and matronly in appearance[otherwise]your head shrinks and, as you gasp, you notice your voice has lightened, gaining you the face of a small female feline. For some reason, the scents of the groins of all around you become enticing and you can feel arousal building[end if]"; [ face change text. format as "Your face feels funny as (your text)." ]
	...
	if feline_attached > 0:
		...
		otherwise if bodyname of player is "Feline":
			...
			otherwise if hp of Leonard >= 15 and hp of Leonard < 100 and bodyname of player is "Feline":
				...
				decrease humanity of player by 2;
			otherwise if libido of player is less than humanity of player:
				increase Feline_meow by 1;
...
when play ends:
	if bodyname of player is "Feline":
		if humanity of player is less than 10:
			...
			otherwise if hp of Leonard >= 3 and hp of Leonard < 10:	[w/Leonard]
			...
			otherwise if hp of Leonard >= 10 and hp of Leonard <= 14:	[succumbed during rivalry period]
				...
				otherwise:
					...
					if cunts of player > 0:
						say "     You quickly begin to regard this strong and clever male as your new leonine master and submit to him, letting him mount and breed you as he sees fit.  His pride of lionesses, you among them, go out into the park to seek out more feline victims to bring back for him to add to the pride.  And it's not just felines who get your attention, the arriving soldiers become your prey as well.  Many of your pride sisters fall, but new ones are added from those you capture and your master manages to maintain his hold over the park.";
						say "     Over time, the once well-decorated tunnel cave becomes a shambles as art and furniture are destroyed during your lover's wild rages and even wilder lusts.  Eventually even the bed, torn and soiled by sexual fluids, becomes unusable and must be removed.  It sometimes feels like a hard life with your leonine lover, though you can't really tell why, as you are happy being one of the many girls in his pride[if hp of Leonard is 12 or hp of Leonard is 13].  You are second only to his black-haired favourite, who takes particular pleasure in using you both as her enforcer and as her plaything[end if].";
					if cocks of player > 0 and cunts of player is 0:
						say "     As another male lion, you are eventually driven out of the pride after he's fucked you repeatedly, leaving you to struggle to form a pride of your own as you become a larger, male lion.  But having been bested and used by the strongest in the park has you only able to claim only a few feline girls of your own.  Fearful of the clever lion and his powerful pride, you are eventually forced to leave city with your pride, undertaking a perilous plan to escape that succeeds mostly out of desperation.  Your band makes it to a small village and takes over, infecting the populace.  The success does much to heal your bruised ego, but you remain a cautious leader and make little attempt to expand beyond your minor territory, content to keep your pride safe and satisfied.";
			otherwise if hp of Leonard is 100:
				say "     After the orgy that ensues after the battle, you and many other lioness girls join the clever lion's pride as he takes up residence in the tunnel cave.  The victorious male takes particular pleasure in fucking you and his three favourite new horny girls on the large bed inside, thoroughly coating the plush mattress and soft sheets in his virile scent.";
				if cunts of player > 0:
					say "     You quickly begin to regard this strong and clever male as your new leonine master and submit to him, letting him mount and breed you as he sees fit.  His pride of lionesses, you among them, go out into the park to seek out more feline victims to bring back for him to add to the pride.  And it's not just felines who get your attention, the arriving soldiers become your prey as well.  Many of your pride sisters fall, but new ones are added from those you capture and your master manages to maintain his hold over the park.";
					say "     Over time, the once well-decorated tunnel cave becomes a shambles as art and furniture are destroyed during your lover's wild rages and even wilder lusts.  Eventually even the bed, torn and soiled by sexual fluids, becomes unusable and must be removed.  It sometimes feels like a hard life with your leonine lover, though you can't really tell why, as you are happy being one of the many girls in his pride.  You are second only to his black-haired favourite, who takes particular pleasure in using you both as her enforcer and as her plaything.";
				if cocks of player > 0 and cunts of player is 0:
					say "     As another male lion, you are eventually driven out of the pride after he's fucked you repeatedly, leaving you to struggle to form a pride of your own as you become a larger, male lion.  But having been bested and used by the strongest in the park has you only able to claim only a few feline girls of your own.  Fearful of the clever lion and his powerful pride, you are eventually forced to leave city with your pride, undertaking a perilous plan to escape that succeeds mostly out of desperation.  Your band makes it to a small village and takes over, infecting the populace.  The success does much to heal your bruised ego, but you remain a cautious leader and make little attempt to expand beyond your minor territory, content to keep your pride safe and satisfied.";
			otherwise if hp of Leonard is 15:
		...
		otherwise:
			...
			otherwise if cocks of player > 0 and cunts of player > 0:	[HERM]
				say ".  You are a lustful little cat girl though, seeking out lovers of all genders and from all forms of felines.  And while lions may be your favourite, nothing says you can't enjoy the others as well.  You eventually move in with a sexy male lion who indulges your girlish playing around and is happy to let you play with the other kitties as long as he can get his fair share of your hot pussy.";
			otherwise if cocks of player is 0:
				say ".  You are a lustful little cat girl though, seeking out as many felines of any species as you can get, as long as they have a hard cock to fill you.  And while lions may be your favourite, nothing says you can't enjoy the others as well.  You eventually move in with a sexy male lion who indulges your girlish playing around and is happy to let you play with the other kitties as long as he can get his fair share of your hot pussy.";
			otherwise:
