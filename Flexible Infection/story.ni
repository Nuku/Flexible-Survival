...
Every turn while the player is in Apartment roof:
	...
	if dragoncounter is 1:
		...
		say "[bold type]((You feel like you could just 'grab' people up! Note, you cannot do this while pregnant ))[roman type][line break]";
...
Food	"There are some things that are very tasty. If you see such an object and wish to partake, don't hesitate to [bold type]eat[roman type] it.[line break]Example: [bold type]eat egg[roman type][line break]"
...
Items	"If you see an object you want to have [bold type]get[roman type] it. You can carry as much as you want.[line break]Example: [bold type]get pants[roman type][line break]"
Killing	"Sometimes the best defense is a good offense. You can attack and slay creatures and people if you want. Killing a person who is not a monster brands you as dangerous however, and people will react accordingly, running away or attacking you as proper. If you are entirely infected (purity 0), attacking a person will infect them instead of killing them.[line break]Example: [bold type]kill person[roman type][line break]"
Observation	"Looking around is a good idea to know what you are dealing with. You can even [bold type]look at me[roman type] to see yourself, or what you've become.[line break]Example: [bold type]look at person[roman type][line break]"
Idling	"Just want time to pass? Use the wait command. Try wait ten minutes or wait an hour."
Movement	"Movement is one of the most basic actions of the game. To move, type the name of the direction you want to go.[line break]Example: [bold type]north[roman type][line break]"
