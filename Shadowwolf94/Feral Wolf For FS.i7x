...
[Version 4.3 - Small Feral Wolf victory scene tweaks - Blue Bishop and Stripes]
	...
	otherwise:
		if a random chance of 2 in 3 succeeds:	[In the mood to top]
			...
			otherwise:
				...
				say "     It's not long until you feel his thick knot being rammed against your tight ring.  You start to struggle with all that's left in you, begging the wolf not to try and force it in.  All you get for your actions is a mean swipe from his claws and an even more powerful thrust against your hole, making you're mouth gape open, speechless and gasping for breath as the wolf uses all his strength to spread you wide open and pop his knot in.  He leans forward as far as he can and starts to pound your ass with all his strength, you tight ring quickly bringing him to climax as he howls out, filling you up with his seed.[mimpregchance]";
				say "     He doesn't wait for his knot to deflate and just pulls it out, making you yelp in pain.  You lie there on the ground, shivering from the hard fucking the wolf gave you.  You look as you see him position himself above you.  You begin to think that he must want your mouth next when he starts to empty his bladder all over your torso and face[if cunts of player is 0]. Giving you a dark growl that you easily interpret at meaning he was annoyed by your lack of female equipment.  You shiver and hope that if you do meet him again, you won't make him angry by not having what he wants[otherwise].  Offering you a dark growl as a parting remark, you shiver at what ill intent he might have in store for you should you meet him again[end if].";
		otherwise:						[Opts to mark player]
