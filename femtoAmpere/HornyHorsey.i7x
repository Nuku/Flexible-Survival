...
Instead of conversing Ammy:
	if lastevent of Ammy is not turns:
		if affection of Ammy is:
			...
			-- otherwise:
				say "[if lastfuck of Ammy is not turns][one of]     'Ooh there you are again lovely!! What are you up to? Having something 'special' in mind?' Ammy asks you with one of her eyebrows raised.[or]     The white equine falls into you, arms embracing your body while giving your forehead a kiss with her muzzle, 'Where have you been? I was missing you!'[or][ammy_idletalk][at random][else if affection of Ammy > 4][one of]     If you want me to dance for you again you can always always ask me to sweetheart.[or][ammy_idletalk][at random][else][ammy_idletalk][end if]";
	else:
		say "[ammy_idletalk]";
...
to say ammy_desc:
	if affection of Ammy <= 2:
		say "     Looking around you spot a curvy figure laying there on one of the cherry-red leather couches. She's an anthropomorphic horse... well, for the most part at least. Lights are reflecting fuzzily from her silky white fur that covers her whole form. Her neck is long and strong, a soft equine head on top of it. In a row two curly white horns standing out from her forehead. Fine hairs form the equine's mane, deep purple in hue. Her tail's got the same purple hue, reaching down long legs tipped with hooves that support her sensually curved body.[line break]     She's wearing a skimpy black bra surrounding her ample breasts and tight black panties around her wide hips. Slowly getting a view of her crotch you also notice the sizable bulge in her panties, making you wonder how much of a female she actually is... as suddenly you notice that she spotted you eying her body, looking back into your direction with her blue eyes, smiling widely.";
...
to say ammy_lapdance:
	...
	say "     Will you grab her hips and possibly continue further or rather back up?[line break]     (Yes = Grab them, No = back up)";
	if the player consents:
