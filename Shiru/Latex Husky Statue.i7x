...
to say ResolveEvent Container Follow Up:
	if Resolution of Container Follow Up is 0: [First time statue TF]
		say "     As you explore the ruined landscape, you come across a sight familiar to you. A knocked-over semi truck and its loose shipping container are strewn across the road, still in the same place you last saw them. You remember this as the site you were sent sprawling by those boxes full of little husky figurines after cracking open the container yourself, and you can still vividly remember the transformation that took place quickly after... the feeling of warm latex goo clinging to your form and exploring your orifices, taking you over and turning you into one of them. Albeit, one that was quite a lot larger...";
		say "     There are a lot less boxes strewn around the truck now, a fair amount having been taken or moved, and those that are left are tattered, covering the dirty street with squished bits of cardboard and tossed-around figurines. You are about to move on and explore elsewhere, but something catches your eye at the last second... what with the container being a lot less full now, you can see that there is something strapped to the bottom of it! It is some kind of large, thin rectangular box, about twice the width of a typical person and quite a lot longer. Having been totally concealed underneath all of the tacky merchandise before, it makes sense that you hadn't seen it... but now you are curious. Clearing the rest of the boxes out of the way, you undo the straps that hold the box securely down and give it a firm tug, pulling the heavy package slowly out of the container and down onto the ground below. Hastening to see what is inside, you rip open the cardboard covering the thing to find... some kind of stand? That's it?";
		WaitLineBreak;
		say "     It seems to be nothing more than some sort of latex rectangle, about a foot thick and seemingly made entirely out of supple, squishable rubber... so much for a usable haul! You feel frustrated at how much time you wasted lugging that thing free of the container for no gain, what with how heavy it was... still, looking over the thing - something in the back of your mind is compelling you to stand on top of the latex. Maybe it's just to feel how squishy it is underneath your feet, or maybe it's just for fun, or out of frustration at how useless this big thing is... you can't quite tell.";
		say "[line break]     [bold type]Step onto the latex stand?[roman type][line break]";
		say "     ([link]Y[as]y[end link]) - Yes.";
		say "     ([link]N[as]n[end link]) - No.";
		if Player consents:
			LineBreak;
			if MaleList is banned and FemaleList is banned:
				say "     You step on the pedestal, but nothing happens. You remember there being a note written on the next page of the shipping manifest stating: [']Contents locked by simultaneous use of both guy and girl flags.['] Maybe some other time.";
				now Resolution of Container Follow Up is 98; [banned]
			else:
				say "     Following the nagging feeling in the back of your head, you step up onto the latex and look down at it. Nothing seems to be happening... why did you think anything would come of this? You are just about to step backwards and down off of the stand in order to resume your travels, but... you find that you can't! You pull your legs upward, tugging with increasing strength as you try to get free of this strange rubbery pedestal, but... after just a few seconds, your feet seem stuck fast where they are! The only solution you can think of is to try and pull even harder... but after readying yourself and attempting to lurch upward with all of your strength, you only succeed in throwing yourself off balance! Wobbling forwards, you counter the momentum with a thrust of your body backward, and then have to do the same forwards... but that last one was too much, and you find yourself falling face first forwards towards the sticky stand! Reacting quickly, you throw your arms forwards to catch yourself... realizing a second or two too late what that would mean for you.";
				say "     While you had avoided your body and face from colliding with the strange sticky stuff, your hands were now stuck firmly to the front of the pedestal, holding you down on all fours. You are panicking pretty hard, what with having no usage of any of your main limbs anymore, but just as you're thinking of calling out for help... the surface of the stand beneath your hands and feet seems to shift and soften up, causing you to look down - and notice that familiar, shiny latex-y goo creeping up your limbs much like the first time you were here!";
				WaitLineBreak;
				if BodyName of Player is listed in infections of CanineList:
					say "     The latex is warm and thick, coating your paws all over and thickening them up until they're properly mascot-worthy! It was a nice shiny white, and it thickened out your legs with a sizable layer of goopy rubber as it climbed up your body. Reaching your underbelly, it began completely coating it in that lovely warm goo... the feeling alone made you want to stop struggling so much and just let it cover you! It didn't seem to be changing you much, instead forming more of a layer over the top of you and seeping into your fur. Your mouth gently hung open and your tongue lolled out as the creeping rubber pressed against your rear, beginning to slowly flow into you and stretch your hole wide[if Cock Count of Player > 1]. As it spread over your groin, it pinned your growing shafts up against your belly and coated them in a nullifying bulge, leaving you needy and whimpering at the fact you couldn't touch yourself or get off despite how good it felt... that was, if you'd even be able to touch yourself at all[else if Player is male]. As it spread over your groin, it pinned your growing shaft up against your belly and coated it in a nullifying bulge, leaving you needy and whimpering at the fact you couldn't touch yourself or get off despite how good it felt... that was, if you'd even be able to touch yourself at all[end if][if Cunt Count of Player > 1]. The goop then flows into your cunts, filling them full to bursting before sealing over the openings in a smooth, featureless layer of latex[else if Player is female]. The goop then flows into your cunt, filling it full to bursting before sealing over the opening in a smooth, featureless layer of latex[end if].";
			...
			LineBreak;
			say "     You decide that now isn't the time to be doing silly things like taking out your annoyance on slabs of rubber.";
		...
		say "     Exploring the dirty streets, you come across a familiar sight once more... an overturned truck, a fallen container... and a solitary latex pedestal, still exactly where you left it last time. Seemingly, it hasn't been touched or moved, and still looks as shiny as ever. Memories of what happened last time come back to you, of your stiffening transformation into a latex-husky statue after you stood on top of it... you were fortunate that you managed to get out of that last time! It [italic type]had[roman type] felt really good, and a large part of you wants to step back onto that stand for another go, but... you have a feeling that you might not be so [']lucky['] this time, if you chose to go through with this.";
		say "[line break]     [bold type]Step onto the latex stand once more?[roman type][line break]";
		say "     ([link]Y[as]y[end link]) - Yes.";
		say "     ([link]N[as]n[end link]) - No.";
		if Player consents:
			LineBreak;
