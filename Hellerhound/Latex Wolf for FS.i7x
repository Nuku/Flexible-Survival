...
When Play begins:
	...
	now desc entry is "You are startled when you hear a rubbery, skidding noise [if a random chance of 1 in 2 succeeds]from behind you[otherwise if a random chance of 1 in 2 succeeds]to your left[otherwise]to your right.  Turning to face the noise, you spot a black and white latex wolf whipping around the corner.";[ Description of the creature when you encounter it.]
