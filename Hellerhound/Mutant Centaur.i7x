...
This is the Mutant Centaur Infection rule:
	if Player has a body of "Mutant Centaur":
		...
		if humanity of Player < 10:
			...
			[Rewrote part of the male variabled ending. So the if player was male bit.I may have touched up and edited some words here and there with the endings as well.]

Mutant Centaur ends here.
