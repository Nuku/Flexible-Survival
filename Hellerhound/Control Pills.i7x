...
"birth control pillx"	"A small red pill, supposed to prevent accidental conception. It says 'lasts for 30 days', but with the nanites around, it's probably more like 3..."	1	birth control pillx
"fertile pill"	"A small blue pill, with the words 'Fertile 9h' on it. You've never seen the like before."	1	fertile pill



birth control pillx is a grab object. It is a part of the player. The usedesc of birth control pillx is "You pop the pill into your mouth, and swallow.[controlpilluse]".
...
[
the scent of birth control pillx is "";
the scent of fertile pill is "";
]


understand "Control" and "Birth" and "Pill" as birth control pillx.
...
the invent of Porn Store is {"birth control pillx", "birth control pillx", "fertile pill", "fertile pill"}.
