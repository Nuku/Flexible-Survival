...
instead of resolving a Secure Area:
	...
	if furry is banned or hermaphrodite is banned or guy is banned:
		say "There is a large sign on the fence surrounding the facility which reads: [']Please be advised: This facility is not closed due to a lack of guy/hermaphrodite/furry content.[']";
