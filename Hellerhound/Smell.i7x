...
the scent of Trevor Labs Lobby is "The air is better in here[if orthasstart > 2], with Orthas's aroused scent in the room[otherwise], without the excess scents of sex and arousal of the city[end if].";
