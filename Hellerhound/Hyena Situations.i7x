...
to say ResolveEvent Intact Fountain:
	...
	if a random chance of one in three succeeds:
		...
		else if S is 4 and TransList is not banned and FurryList is not banned:
		...
		else if S is 6 and HermList is not banned and FurryList is not banned:
