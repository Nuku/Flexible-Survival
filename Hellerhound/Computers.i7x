Version 2 of Computers by Hellerhound begins here.

"Computer hardware and software, including search engines and email programs, modified to work with FS."
...
A computer mouse is a kind of selection device. A computer mouse is part of every desktop computer. The description of a computer mouse is usually "Just the ordinary wired variety."
...
"Computer" has two subordinate kinds, "laptop" and "desktop computer". A laptop may be opened or closed (synonymous with switching it on and off, for simplicity) and has a trackpad. A desktop computer is by default fixed in place and has a computer mouse.

For non-standard configurations of computer, such as an ATM with a modified keyboard and no computer mouse/trackpad, we would fall back on the base "computer" kind and add the desired components by hand.
