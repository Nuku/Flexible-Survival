...
when play ends:
	if the bodyname of the player is "Feral Cheetah":
		...
		otherwise if cheetahmate > 0 and cheetah_mpreg is true and cunts of player is 0:
			...
			otherwise:
				say "     Rescued by the military, your semi-animal state leaves you with difficulty dealing with society.  It is sometimes hard to have a normal life when you feel more natural moving on all fours.  Still, you manage to figure out some ways to get by.  You mind is drawn back to the cheetah you'd bonded with in the city.  It's usually an occasional thought from time to time, especially when you're alone, but it is especially strong when you feel a heated need to mate within your hidden womb.";
