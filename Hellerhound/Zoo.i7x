...
[Version 4 - All rooms rewritten - by Wahn]

Zoo Entrance is a room. It is fasttravel. "This area is the grand entrance to the zoo, with wrought iron gates and a fence surrounding the zoo grounds. A number of booths stand ready to accomodate large groups of visitors, although they're of course empty now. A large sign that looks as if it was just put up a short while ago says 'free admission'. You know from experience that the tall fence extends all the way around the whole zoo, so it's very likely that most of the animals (and transformed visitors) are still inside. The zoo's gift shop is west of your position, to the southwest lies a parking area and in the south, you can go back out into the city along the road leading here.".
...
the scent of Cheetah Habitat is "A very stong scent of aroused cheetah hangs in the air here. Just standing here and breathing it in makes you excited and weak in the knees.";
...
Main Path 2 is a room. "You're on the cobbled main path of the zoo, in between many different exhibits. In this section, there's the snake house in the north and in the south you can see the enormous web canopy of the bird endclosure arching over a moderately large forest area. If you want to go in and check it out, the bird house forming the entry is to the west of you. Further east, the path widens onto a small plaza.". Main Path 2 is east of Main Path 1.
...
Zoo Rest Area is a room. "This plaza in the midst of the zoo was meant to serve as a rest area for the visitors. Surrounding a bronze statue of a tiger in the middle, there are benches, several picknick tables and a number of food stands - thoroughly looted now, and one even has been completely flattened. Even those stands that sold non-edible goods were ransacked, the shreds of white fluff scattered about them attesting to the gruesome end of quite a few stuffed toys. Seeing this scene of devastation reminds you strongly that this isn't a safe and peaceful place anymore. Clearly, there are wild beasts out and roaming the area and you should take care if you want to explore any of the many paths leading off in all directions. It might just be a good idea to go back west towards to the entrance.". Zoo Rest Area is east of Main Path 2. 
...
Bird House is a room. "You're in the bird house, which contains informative plaques and signs explaining lots of facts about all the feathered creatures Main Path 1. Then there is a door to the back area of the zookeepers caring for the birds, which you assume contains supplies and all kinds of stuff - sadly, it's locked, and with a pretty sturdy lock too. And finally, there is a kind of airlock, consiting of two doors and a bit of hallway in between that leads into the bird enclosure itself. Back north is the exit to the main zoo pathway.". Bird House is south of Main Path 1.
...
To say cheetah victory:
	...
	otherwise if cheetahmate > 0:
		if cunts of player > 0:
			...
			say "His cock slides out with much pleasure and dripping of seed, and you lick-kiss him in the cheek for doing you suck a service.";
		otherwise:
			say "     Giving a pleased rumble that he's gotten the upper hand over his mate this time, your handsome cougar gives you a kiss. Though as he bends his head to your crotch and notices the abnormal features you currently posess there, he forms the words 'What happened to you, my love?' He licks your crotch sadly, and you share his sadness, hoping that soon there will be something more natural for him to enjoy there.";
	infect "Feral Cheetah";			
