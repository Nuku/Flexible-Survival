...
Main Path is a room. "The main path of the zoo, it runs along the exhibits. The maintenance men used to use this. It looks like they are taking a break in the guardhouse to the northeast. This path is grey and white gravel. to the south is the bird house, and the roundabout is east of here." Main Path is northeast of entryway.
Guardhouse is a room. "The guardhouse is grey and forbidding, daring any to commit crimes nearby. On a hangar inside are the keys to the exhibits. They have drawings on them and are color coded for their door. The guards are nowhere to be seen. Odd.". Guardhouse is northeast of main path.
