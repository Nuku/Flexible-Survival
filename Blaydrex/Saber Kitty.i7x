...
to say saber loss:
	if cocks of player is greater than 0:
		...
		if player consents:
			...
			infect;
		otherwise:
			say "You realize she might have some ulterior motive and push her away. She frowns and sighs. 'Alright, maybe next time, love,' she says before sauntering off, leaving a trail of her dripping juices on the floor.";
	otherwise:
		say "She smiles, realizing you are not male. Something about this just doesn't seem right. 'Don't worry, love. You're already on your way to becoming a sexy saber kitty slut like me. Have fun,' she says before sauntering off leaving a trail of her dripping juices on the floor";
