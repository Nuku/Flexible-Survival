...
to say saber_wins:
	if Player is male:
		...
		say "     The saber kitty swipes at you one more time, ripping your clothes and knocking you down onto your butt. When you stay down she smiles that toothy smile, drawing extra attention to those pearly white fangs of hers. 'Mmmmmmmmm. A pussy for the pussy,' she says as she reaches down and begins to finger your cunt. 'Too bad you won't get to use it, slut,' she says before forcing your face against her drooling cunt. It doesn't take long before your entire face is covered in her juices. The scent of her overpowering heat begins to fog your mind and your cunt begins to throb with intense need.";
...
When Play begins:
	...
	now body entry is "feminine, with curves that are to die for and some sexy abs. Your arms have muscles that barely show, but show enough to see that you are indeed stronger than it would seem and end in clawed paws that still can grip things. Your legs have strong thighs for leaping and pouncing on your prey but are shapely and attractive as well as muscled and end in digitigrade feet";
	now skin entry is "[if looknow is true]a soft beige fur, turning white on the front of your torso and the inside of your ass cheeks, over your[else]soft, beige-furred[end if]";
	now tail entry is "You have a short saber kitty tail that is covered in fur. It is adorable and seems to wag like a dog's tail when you get too excited."; [ Tail description, write a whole Sentence or leave blank. ]
	...
	now MilkItem entry is "saber kitty milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "saber kitty cum";
...
This is the Saber Kitty Infection rule:
	if Player has a body of "Saber Kitty":
		...
		if humanity of Player < 10:
			say "     You can't hold back the urges of your feline need anymore. You go in search for a powerful virile male, preferable another Smilodon. Every male you come across you can't help but want to show the pleasures of being a sexy saber kitty, as well as females. Whenever you run across a fellow Smilodon you can't help but submit and play around[if Player is not sterile]. Your belly is almost always full of an oncoming litter, otherwise you suffer a never-ending heat[end if].";
		else:
			say "     You manage to make it out of the city, but something isn't right. There is always a scratching feeling in the back of your mind. Each passing heat the scratching grows worse and worse. You spend your days trying to get by, living in this new society, but everything seems wrong. You need a male saber and need a pack. It doesn't take long before you find a sexy tiger and seduce him. You don't know how, but you manage to turn him into a Smilodon. This simple act causes you to lose to your infection. Your new mate spends the next day rutting you[if Player is not sterile] until you are sure to be with his litter[end if]. After that you and he begin to start raping anyone in sight, turning them into saber kitties like yourself, with only your mate as the only male. Within 24 hours the whole city is nothing but Smilodons. The city is then quarantined[if Player is not sterile]. You spend the rest of your days doing nothing but breeding, always having a litter growing in you or being in heat[end if].";
