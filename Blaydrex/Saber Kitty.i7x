...
to say saber_wins:
	...
	if Player is male:
		...
		CreatureSexAftermath "Saber Kitty" receives "OralCock" from "Player";
...
When Play begins:
	...
	now MilkItem entry is "Smilodon Milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
...
Table of Game Objects (continued)
name	desc	weight	object
"Smilodon Milk"	"A plastic water bottle filled with what is clearly milk. One could think it was a regular cow's milk, if someone hadn't written 'Smilodon Milk' across the label on the bottle. You [italic type]could[roman type] drink it to quench your thirst. Who knows what else it might do to you though..."	1	Smilodon Milk

Smilodon Milk is a grab object.
Smilodon Milk is milky.
Purified of Smilodon Milk is "distilled milk".
Smilodon Milk is infectious.
Strain of Smilodon Milk is "Saber Kitty".
Usedesc of Smilodon Milk is "[Smilodon Milk use]";

to say Smilodon Milk use:
	say "Lifting the plastic bottle to your mouth, you take a drink from it, letting the feline milk run over your tongue and down your throat. Tastes rich and animal-like. Swishing it around in your mouth a little, you finish the bottle off, then stuff it back into your collection of 'empties'.";
	PlayerDrink 15;

instead of sniffing Smilodon Milk:
