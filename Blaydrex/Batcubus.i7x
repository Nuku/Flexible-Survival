...
to say Batcubus attack:
	if Player is female and ( Cock Count of Player is 0 or a random chance of 2 in 3 succeeds ):
		...
		[CreatureSexAftermath  receives "" from ;] [Player drinks batcubus milk from teats]
		...
		[CreatureSexAftermath PLayer receives "" from Batcubus;][Player drinks batcubus milk from teats]
	...
	if Player consents:
		if Player is male:
			...
			if Cock Length of Player > 17 or Ball Size of Player > 3:
				...
				CreatureSexAftermath "Batcubus" receives "PussyFuck" from "Player";
				[CreatureSexAftermath Player receives "" from Batcubus;][Player drinks batcubus milk from teat]
			else:
			...
			if Cunt Tightness of Player < 3 or Cunt Depth of Player < 6:
				...
				CreatureSexAftermath "Player" receives "PussyFuck" from "Batcubus";[Used for impregchance from batcubus milk]
			else:
