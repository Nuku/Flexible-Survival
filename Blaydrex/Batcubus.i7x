...
to say Batcubus_wins:
	if Player is female and ( Player is not male or a random chance of 2 in 3 succeeds ):
...
to say Batcubus_loses:
	...
	if Player consents:
		...
		if Player is male:
			...
			if ( Cock Length of Player > 17 and Ball Size of Player > 2 ) or ( Cock Length of Player > 9 and Ball Size of Player > 3 ):
...
When Play begins:
	...
	now Species Name entry is "Batcubus"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now face change entry is "you feel something weird on your lips. You lick them just to find they taste sweet and your mouth and groin quickly fill with lust-filled warmth. They are coated in the batcubus's purple lipstick. You can't help but lick your lips over and over, each lick making you more and more horny and advancing your transformation further. Your face pulls forward into a bat muzzle and your ears extend into triangles and pull to the top of your head. You soon finish your transformation, with your face resembling that of a beautiful bat. You lick your lips once again"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
	now body change entry is "your body begins to slender out, becoming beautiful and elegant. Your hands are covered in white gloves. Your legs end up covered in purple high-heeled boots that go all the way up your legs. A strange red fur covers your torso, making it look like you are wearing a red corset, even though you are actually naked"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	now skin change entry is "it is covered in beautiful white fur"; [ Skin change text, format as "Your skin feels funny as [skin change entry]." ]
	now ass change entry is "you bend over, panting in lust. Your ass and hips fill out, making you look oh so fuckable and fertile in your position"; [ Ass/tail change text, format as "Your ass feels funny as [ass change entry]." ]
...
This is the Batcubus Infection rule:
	if Player has a body of "Batcubus" and matriarchdefeated is 0 and matriarchowned is 0:
		...
		if humanity of Player < 10:
			...
			say "     Life as a batcubus proves fun. Every time you find someone you enjoy all you have to do is kiss them and they are putty in your hands. Thanks to this you have a good life, letting you have everything you want, never needing to work a day in your life[if Player is herm]. You spend your days fighting the urge to lick your lips. Being one gender or the other would allow you to instinctively lick them safely, but the combined lust of your female and male sex organs would be too much. A single lick could send you into a sexual fury. Last time it happened you tried to turn a whole town into batcubuses. Hopefully one day someone can find out how to get this lipstick off you.[else if Player is male]. You find that having a cock isn't as fun as having a slavering cunt like most other batcubuses, but you make do. Your cock is insatiable, no matter how much you cum and fuck. One day you find a tigress hooker, who takes an interest in you. She wastes no time in raping you and dominating you until you submit to her. She claims you as her own and she is actually able to keep up with your sex drive, so it works out. You spend the rest of your days happily mated to her.[else]...[end if]";
