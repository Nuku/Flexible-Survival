...
to say losetocaveman:
	...
	otherwise:
		...
		if cunts of player > 0:
			...
			say "     Caring nothing for your pleasure he rams in and out of you, his hairy ballsac smacking against you roughly. You are thankful that it doesn't take very long until the massive club of a caveman cock begins to fire off inside of you, hot cromagnon spunk filling you up in a voluminous quantity.";
...
When Play begins:
	...
	now name entry is "Caveman";      [The creature's name as displayed and used in naming descriptions]
	...
	now defeated entry is "[beatthecaveman]";            [ Text when monster loses.  Change 'template' as above. ]
	now victory entry is "[losetocaveman]";               [ Text when monster wins.  Change 'template' as above. ]
	now desc entry is "[cavemandesc]";                  [ Description of the creature when you encounter it. ]
	...
	now body entry is "that of a caveman, strongly muscled, with massive, overly long arms";   [ Body Description, format as the text "Your body is (your text)." ]
	...
	now cock entry is "prehistoric caveman";                  [ Cock desc., format as "You have a 'size' (your text) cock." ]
	...
	now sta entry is 17;              [ These values may be used as part of alternate combat.]
	now per entry is 9;
	now int entry is 9;
	now cha entry is 8;
