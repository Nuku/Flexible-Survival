...
When Play begins:
	...
	now victory entry is  "You sink to your knees, wounded badly. The Whelp chirps in triumph and approaches you slowly...";
	now desc entry is "A squealing ball of needle sharp teeth plummets from the sky, clumsily wobbling through the air. The Ash Dragon Whelp’s total size is the mass of an average humanoid torso, the dirty [one of]black-red speckled[or]dark ash grey[at random] scales, [one of]white[or]black[or]grey[at random] eyes, add to its fearsome appareance. A lava-like glow emanates from its core and the light seeps between its scales. Between its legs is a small pouch housing its minor genitals. The Ash Whelp appraises your [bodyname of player] carefully for a time, then finally musters the courage to fly directly towards you!";
