...
to say dragator attack:
	if a random chance of 2 in 3 suceeds and dragatordefeat is 1:
		if cunts of player > 0:
			...
			if cunt width < 14, increase cunt width of player by 4;
			if cunt length < 16, increase cunt length of player by 1;
		otherwise:
...
When Play begins:
	...
	now attack entry is "[one of]The croc lunges forth, and with a snap of its jaws clamps its horrible teeth down on your leg. He yanks you back and forth, your badly injured by the time you pry yourself free.[or]The Dragator lets out a primordial roar, energies and chemicals in its belly light up the inside of his mouth. A bright red fireball is spat out at you.[or]The Dragator lands a vicious bite on you, then pulls back quickly.[at random]";
