...
to say Yamato Dragon attack:
	...
	if "Touched by Madness" is listed in feats of player and cocks of player > 0 and cock length of player < 20 and (("Kinky" is listed in feats of player and a random chance of 1 in 2 succeeds) or ("Kinky" is not listed in feats of player and a random chance of 1 in 5 succeeds)):
		If MYDTBMM is 0:
			say "     Before he would set himself upon you, you observe on as he's suddenly stopped by what would appear to be some manner of irreverent thought. Forced to rethink over this circumstance, he would contest with himself internally before he appears to come to some conclusion, demented grin across his draconic lips.";
			say "     'N-no... I have something different in store for you...' His foreboding remark offered up, he would pull you closer, thighs suddenly engulfed by his wanton, scaled lips. Forced to abide his slick tongues immediate and irreverent affection, you are driven aroused, much to the dragon's satisfaction.";
			say "     From here, he would move upwards, hindquarters revealed to exposed his already-erect and dripping cock before you, his imminent plot doubtlessly quite exciting to him. Talons gripping [if cocks of player > 1]one of your [cock size desc of player] cocks[otherwise]your [cock size desc of player] cock[end if], he would line it up with his own. Plan revealed, you are offered no time to react before he plunges it into the depths of his eager dickhole.";
		...
		say "     It would go on for what seems like forever, [if cocks of player > 2]exposed cocks unable to offer reprieve against the dragon's grip until[otherwise if cocks of player is 2]exposed cock unable to offer reprieve against the dragon's grip until[otherwise]too dazed by this circumstance to fully appreciate when[end if] his flow finally dies down. His dick would remain hard against you, however, as to ensure that you retain his load; often, you would orgasm, the attempt rebuked and having your load sent back to you, [if cockname of player is listed in infections of Internallist]pinned downed by the weight of your bloated frame[otherwise]weighed down by your painfully overstuffed sack[end if].";
		if waiterhater is 0, wait for any key;
		if "Horny Bastard" is listed in feats of player:
			say "     You think that he might be done, but this brief rest is enough time for him to be stricken by another otherworldly influence. He would push you to the ground, prior exhaustion dissipating in the wake of a renewed, manic need.";
			say "     '[one of]I-it's not enough[or]More, more[or]No[at random]! [one of]I'm not done with you yet[or]You need more[or]You thought we were done? Ha[at random]!' He would retort, mad with lust, his thrusting motion commencing one more. So sensitive, as you are, your orgasm almost immediately, but it is ultimately for naught, as your confines have grown tight once more--so much so that little might escape.";
	...
	otherwise if bodyname of player is "Yamato Dragon" or bodyname of player is "Yamato Dragoness":
		if ("More Anal" is listed in feats of player and a random chance of 2 in 3 succeeds) or ((cunts of player is 0 and "Less anal" is not listed in feats of player) and a random chance of 1 in 3 succeeds):
			say "     Grip wrapped around your serpentine frame, he would pull you up into the air, dragging through the wake of his ascent. [if hp of player < 1 and player is not submissive]Though you might instinctively protest his hold, it's soon made apparent that your other choice is to play victim to gravity, a notion none too promising given your increasing altitude[otherwise]At the mercy of this beast, you are compelled to watch on as the earth below you becomes increasingly distant, driving you to hold onto him in turn, lest he--by some surge of sadistic amusement--drops you[end if]. Entirely exposed before him as you are, he would carry you to his growing arousal, forced to abide his hardening cock as he grinds it between your legs.";
			if MYDAM is 0:
	...
	otherwise:
		if (("More Anal" is listed in feats of player and a random chance of 2 in 3 succeeds) or ((cunts of player is 0 and "Less anal" is not listed in feats of player) and a random chance of 1 in 3 succeeds)) and scalevalue of player > 2:
			...
			if MYDAM < 3, increase MYDAM by 1;
		otherwise if cunts of player > 0 and a random chance of 1 in 2 succeeds:
			say "     [if hp of player < 1 and player is not submissive]Compelled to crawl free, you only encourage your reptilian assailant to pull you back by one of[otherwise]Forced to gawk at your new friend, he would offer up a twisted grin, pulling you closer by[end if] your legs. Front exposed before him, he would bury his [if scalevalue of player < 5]massive[otherwise]large[end if] snout between your thighs. Coarse scales scraping you vulnerable frame, you must abide his thick tongue's tainted affection, twisted caress of your exposed cunt[sfn]. In the distance, you might see the crotch of his own serpentine form, massive cock growing hard against the open air.";
			if MYDGM is 0:
			...
			otherwise:
				say "     You're doubtlessly a little sheepish to endure this beast's twisted wrath again; massive, ribbed thing eager to plunge into your ill-equipped depths. In due time, he would free";
