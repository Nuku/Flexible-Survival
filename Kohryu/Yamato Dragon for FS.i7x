Version 3 of Yamato Dragon For FS by Kohryu begins here.
[ Version 3 - Proper cross-contamination w/Yamato Dragoness]
...
to say Yamato Dragon attack:
	...
	if cunts of player is greater than 0:
		Say "After he finishes sniffing you he starts to speak, though he doesn't open his mouth so you're not sure how he is speaking.  'A woman, good.  My body has been...needy, lately.'  He then breathes a plume of blue fire over you, it doesn't burn or hurt, but your clothing disintegrates, revealing all of your [bodydesc of player] body for him to see.  The male dragon then grabs you and lifts you into the air as he stands up on his hind legs.  You look down to see what the dragon has in store for you, and your gaze is met by a massively huge dragon cock, pulsing with it's engorgement.  There's no way you could possibly take that monster of a cock...could you?";
		if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
		if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
		if cunt width of player is less than 10:
			say "The dragon lowers you toward his huge cock and you brace yourself for the pain, but as the cock enters your [cunt size desc of player] cunt is quickly stretched to its limit, and the head of the cock is barely more then half in.  The dragon can see that you're just not big enough for him, and he knows that forcing it would tear you in half.  With a sigh the dragon puts you down as his cock slips back into his body.  Without a word the dragon flies away to look for another victim, leaving you relieved that you didn't die by dragon rape today.";
		otherwise if scalevalue of player is greater than 3:
			Say "Your rather impressive physical size is enough to take the dragon's expansive rod, the head clearing your [cunt size desc of player] vaginal passage without any immediate difficulty. The dragon gives a sinister growl of approval, and instead opts to shift you onto the ground. There's no doubt that someone large enough to contain his girth is a rare occasion and he exploits the opportunity to get comfortable.";
			Say "Asserting his dominant hold on you, you find the serpentine creature partially coil around your [bodytype of player] form. He continues his assault on your rear, slowly easing more of his draconic cock into your depths. He groans in a sickeningly pleased manner, betraying his otherwise dignified composure for this rare opportunity. Even you'll admit that a creature able to match your size is quite uncommon as his shaft hilts itself into your depths, barely hitting the cervix. He savors this experience only briefly before he begins his assault on repeatedly ramming your cunt with his rod.";
...
to say yamato dragon desc:
	...
	say "As you're walking through the park you look up and notice a serpent-like creature flying and coiling it's way through the sky.  As you try to figure out how it's flying with no wings the creature spots you staring at it and within an instant it flies to and lands in front of you.  The massive serpent-like dragon looks down upon you with piercing eyes and you suddenly wish you were anywhere but here.";
...
"dragon scale"	"A green, slightly shimmering dragon scale."	2	dragon scale
"dragon hair"	"Some strands of silvery that shimmer slightly in the light."	1	dragon scale
...
the scent of dragon scale is "The green scale smells strange and otherworldly.";
The usedesc of dragon scale is "[applydragonscale]";

to say applydragonscale:
	choose row monster from table of random critters;
	...
	if "Female Preferred" is listed in feats of player and girl is not banned:
		now the strain of dragon scale is "Yamato Dragoness";				[change target to Yamato Dragoness and infection]
		setmonster "Yamato Dragoness";
		now sex entry is "Female";								[adjusts Yamato Dragoness sex entry if needed]
	otherwise:
		now the strain of dragon scale is "Yamato Dragon";				[change target to Yamato Dragoness and infection]	
		setmonster "Yamato Dragon";
		if "Herm Preferred" is listed in feats of player:				[adjusts Yamato Dragoness sex entry if needed]
			now sex entry is "Both";
		otherwise:
			now sex entry is "Male";


dragon hair is a grab object. It is a part of the player. dragon hair is infectious. The strain of dragon hair is "Yamato Dragon".
the scent of dragon hair is "The silvery hair smells of exotic, otherworldly scents.";
The usedesc of dragon hair is "[applydragonhair]";

to say applydragonhair:
	choose row monster from table of random critters;
	...
	if "Male Preferred" is listed in feats of player and guy is not banned:
		now the strain of dragon hair is "Yamato Dragon";				[change target to Yamato Dragon and infection]
		setmonster "Yamato Dragon";
