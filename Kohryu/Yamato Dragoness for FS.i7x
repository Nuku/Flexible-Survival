Version 5 of Yamato Dragoness For FS by Kohryu begins here.
...
to say YamatF_1: [cunt pitching]
	...
	say "     '[one of]Very well[or]If that is what you desire[or]I will bow to your need[or]Your wish is my command[at random]...' Lengthy frame shifting around, the dragoness exposes her hindquarters, leaving her bestial, scaled vent before you. [if scalevalue of player < 4]Given how small you are relative to her, she lays on her back so you can scale her and properly position yourself[otherwise]It takes a bit of work to position yourself proper, given how massive she is, but she's at least compliant enough to not make the matter more difficult for you than need be[end if]. Curiously fondling her taut, coarse cleft, it takes a bit of work for your prying digits to penetrate its surface, exposing your touch to her supple, slick inner-flesh. Shall you engage in a bit of foreplay? Else you'll get straight to the matter at hand.";
	if player consents:
		say "     Caressing her exceedingly tight inner-walls, the dragoness doesn't seem affected by it, [if scalevalue of player < 4]perhaps too small for it to really register[otherwise]in spite of your adequate size[end if], inviting you to plunge the whole of your fist down its depths. It doesn't take long for the serpent's libido to finally take effect, your intrusion increasingly slicked by her tainted honey.";
		say "     '[one of]Oh[or]Ah[or]Yes[at random], [one of]do not stop[or]I can take more[or]you tease me so[at random]...' Oozing, throbbing portal aching ahainst your endeavour, you imagine this bit of foreplay won't be all that effective at stretching her out, given how tight she is. Pulling your limb free, you think everything should be good to go.";
		now tempnum is 1;
	otherwise:
		now tempnum is 0;
	if cunt length of player < 22 and cocks of player > 1:
		say "     Given how large she is, you figure you could fit [if cocks of player is 2]both[otherwise]two[end if] of your cocks down into her, shall you try?";
		if player consents:
			say "     Very well, shall it be down both her holes? Else you'll only go for her vaginal passage.";
			if player consents:
				now tempnum2 is 2;
			otherwise:
				now tempnum2 is 1;
	...
	otherwise if cocks of player > 1:
		say "     Given how large she is, you figure you could fit [if cocks of player is 2]both[otherwise]two[end if] of your cocks down both of her holes, shall you try?";
		if player consents:
			now tempnum2 is 2;
		otherwise:
			now tempnum2 is 0;
	otherwise:
		now tempnum2 is 0;
	say "     Ready to take the plunge, you expose[if cocks of player is 2 and tempnum2 > 0] both of[otherwise if tempnum2 > 0] two of[otherwise if cocks of player > 1] one of[end if] your [cock size desc of player], half-aroused dick[smn]. Grinding [if tempnum2 > 0]them[otherwise]it[end if] against the eager vent, the dragoness faintly moans against your touch, [if tempnum is 1]your motion slicked by her eager juices[otherwise]slowly becoming aroused by the tease[end if], before you slowly sink the[if cockname of player is listed in infections of bluntlist] blunt[end if] head[if tempnum2 > 0]s[end if] past its scaled lips.";
	...
	say "     '[one of]Ha[or]Hmpf[or]Oh[at random], [one of]I allowed you to ride me, but I didn't say I would make it easy[or]if you want my hole so badly, prove your convictions[or]it would be a shame for you to fail this close to your goal[at random]!' Mocking you in your struggles, you're forced to steel yourself for the fight to inch deeper down the beast's [if tempnum2 is 2]twin passages[otherwise]cunt[end if], its vice-like hold giving you difficulty all the way[if cock length of player < 12] even with assets that she should have no problem taking[end if]. Several minutes of sweat and grunts eventually allows you to engulf your cock[if tempnum2 is 1]s[end if] all the way[if cockname of player is listed in infections of knotlist] -- to the knot --[end if] down her powerful vent.";
	say "     After taking a moment to try and stretch out the serpentine creature's hole a bit more, you begin to fuck her proper. Even though she was teasing you before, she can't help but succumb once more to her baser desires, lowly moaning as she's railed by her[if scalevalue of player < 5] much[end if] smaller companion. You seem to have no difficulty causing her to writhe in pleasure against your touch, which in turn makes her grip on you a little less tight and easier for you to work with. Her slick, throbbing cave[if tempnum2 is 2]s[end if] ache and squeeze against [if tempnum2 is 2]their[otherwise]its[end if] invader[if tempnum2 > 0]s[end if], it's nearly incessant gushing making a bit of a mess of you.";
	...
	if player consents:
		say "     You call the dragoness['] face down to meet you, too lost in a wanton haze to see anything wrong in this, just before you wrench your dick[if tempnum2 > 0]s free from their[otherwise] free from its[end if] tight confines, stroking yourself past the final inch to bliss. Cock[smn] firing off your [cum load size of player] load, it quickly paints the monster with your thick cum, who can only wallow is being shamed so.";
	...
	otherwise:
		say "     Putting all your energy into one final thrust, you [if cockname of player is listed in infections of knotlist]finally tie[otherwise]hilt[end if] yourself with the dragoness before crying out, your cock[smn] exploding with your [cum load size of player] load, flooding her womb[if tempnum2 is 2] and bowels[end if] with your thick cum";
		if cocks of player > 1:
			if (tempnum2 > 0 and cocks of player > 3) or (tempnum2 is 0 and cocks of player > 2):
				say " while [if tempnum2 > 0]their[otherwise]its[end if] exposed brothers stain her coarse undercarriage";
			otherwise if (tempnum2 > 0 and cocks of player > 2) or tempnum2 is 0:
				say " while [if tempnum2 > 0]their[otherwise]its[end if] exposed brothers stain her coarse undercarriage";
		...
		say "     '[one of]Hmm[or]Well[or]Yes[at random], [one of]I hope you got what you wanted[or]I've satisfied my task[or]It seems you have no more need of me[at random]...' Allowing you to get off her before she takes to the air, flying off into the distance. She'd look more majestic if not for her[if cock width of player > 24] considerably[end if] leaking hole. You take a moment to catch your breath before you gather your things and go back to where you started.";
...
to say YamatF_2: [anal pitching]
	...
	otherwise:
		now tempnum is 0;
	if cock length of player < 22 and cocks of player > 1:
		say "     Given how large she is, you figure you could fit [if cocks of player is 2]both[otherwise]two[end if] of your cocks down into her, shall you try?";
		if player consents:
			say "     Very well, shall it be down both her holes? Else you'll only go for her ass.";
			if player consents:
				now tempnum2 is 2;
			otherwise:
				now tempnum2 is 1;
	...
	say "     Ready to take the plunge, you expose[if cocks of player is 2 and tempnum2 > 0] both of[otherwise if tempnum2 > 0] two of[otherwise if cocks of player > 1] one of[end if] your [cock size desc of player], half-aroused dick[smn]. Grinding [if tempnum2 > 0]them[otherwise]it[end if] against the eager vent, the dragoness faintly moans against your touch, [if tempnum is 1]your motion slicked by her eager juices[otherwise]slowly becoming aroused by the tease[end if], before you slowly sink the[if cockname of player is listed in infections of bluntlist] blunt[end if] head[if tempnum2 > 0]s[end if] past its scaled lips.";
	say "     It quickly becomes a struggle to force yourself deeper, the hole exceedingly tight[if tempnum is 1] in spite of your prior preparations[end if][if tempnum2 > 0], made worse by having both in there[otherwise if cock length of player > 20], made worse by your impressive size[end if]. The dragoness grins slightly down at you.";
	say "     '[one of]Ha[or]Hmpf[or]Oh[at random], [one of]I allowed you to ride me, but I didn't say I would make it easy[or]if you want my hole so badly, prove your convictions[or]it would be a shame for you to fail this close to your goal[at random]!' Mocking you in your struggles, you're forced to steel yourself for the fight to inch deeper down the beast's [if tempnum2 is 2]twin passages[otherwise]bowels[end if], its vice-like hold giving you difficulty all the way[if cock length of player < 12] even with assets that she should have no problem taking[end if]. Several minutes of sweat and grunts eventually allows you to engulf your cock[if tempnum2 is 1]s[end if] all the way[if cockname of player is listed in infections of knotlist] -- to the knot --[end if] down her powerful vent.";
	say "     After taking a moment to try and stretch out the serpentine creature's hole a bit more, you begin to fuck her proper. Even though she was teasing you before, she can't help but succumb once more to her baser desires, lowly moaning as she's railed by her[if scalevalue of player < 5] much[end if] smaller companion. You seem to have no difficulty causing her to writhe in pleasure against your touch, which in turn makes her grip on you a little less tight and easier for you to work with. Her slick, throbbing cave[if tempnum2 is 2]s[end if] ache and squeeze against [if tempnum2 is 2]their[otherwise]its[end if] invader[if tempnum2 > 0]s[end if], it's nearly incessant gushing making a bit of a mess of you.";
	say "     Continuing to pound the dragoness, it soon becomes clear you won't be able to hold back for much longer! You figure she's compliant enough in her lustful state to oblige bringing her head closer. Perhaps you should pull out and shame her? Otherwise, you'll keep doing what you're doing.";
	if player consents:
		say "     You call the dragoness['] face down to meet you, too lost in a wanton haze to see anything wrong in this, just before you wrench your dick[if tempnum2 > 0]s free from their[otherwise] free from its[end if] tight confines, stroking yourself past the final inch to bliss. Cock[smn] firing off your [cum load size of player] load, it quickly paints the monster with your thick cum, who can only wallow is being shamed so.";
	...
	otherwise:
		say "     Putting all your energy into one final thrust, you [if cockname of player is listed in infections of knotlist]finally tie[otherwise]hilt[end if] yourself with the dragoness before crying out, your cock[smn] exploding with your [cum load size of player] load, flooding her bowels[if tempnum2 is 2] and womb[end if] with your thick cum";
		if cocks of player > 1:
			if (tempnum2 > 0 and cocks of player > 3) or (tempnum2 is 0 and cocks of player > 2):
				say " while [if tempnum2 > 0]their[otherwise]its[end if] exposed brothers stain her coarse undercarriage";
			otherwise if (tempnum2 > 0 and cocks of player > 2) or tempnum2 is 0:
...
to say YamatF_3: [oral receiving cock]
	say "     Making your decision, the dragoness looms closely over your [if scalevalue of player < 5]significantly[otherwise]slightly[end if] smaller, [bodytype of player] form, carefully helping you to expose your assets before her until your [cock size desc of player], partially aroused dick[if cocks of player > 1]s lay[otherwise] lays[end if] before her piercing gaze.";
	say "     '[one of]Hm[or]Yes[or]Very well[at random], [one of]this should be simple[or]such a paltry task[or]I hope this will satisfy you[at random]...' Large, thick tongue escaping her lips as she speaks, the slick, flexible thing has no trouble wrapping around [if cocks of player > 2]all of them at once[otherwise if cocks of player is 2]both of them at once[otherwise]it[end if], practically buried under the writhing, pink flesh.";
	say "     Her constant, unblinking gaze fixated on you, your [if scalevalue of player < 4]entire body[otherwise]torso[end if] is bathed in her steamy breath, lower half disappearing under her scaled snout as her lips hilt against your crotch[if cock length of player > 19], utterly unphased by your size[end if]. As large as the serpent is, she seems extraordinarily dextrous with her tongue, able to squeeze and writhe against[if cocks of player > 1] and between[end if] your rod[smn] with considerable ease.";
	...
	if player consents:
		say "     Her grip on you is fairly tight, practically pinning you to a tree, but you manage to order her off just before you cry out, aiming your now free, saliva-slicked dick[smn] at the dragoness as you fire off your [cum load size of player] load, [if cock width of player > 24]utterly soaking[otherwise]painting[end if] her snout with your thick cum. Her brief confusion allows you to spend your entire load on her.";
	...
	otherwise:
		say "     Practically pinning you to a tree with her snout, she appears fully prepared for when you finally cry out, methodical tongue squeezing you with every gout of your [cum load size of player] load[if cock width of player > 24], seemingly unphased by its sheer volume[end if]. She makes every effort to prolong your orgasm as much as possible before finally pulling free.";
...
to say YamatF_4: [oral receiving cunt]
	say "     Making your decision, the dragoness looms closely over your [if scalevalue of player < 5]significantly[otherwise]slightly[end if] smaller, [bodytype of player] form, carefully helping you to reveal your assets before her until your [cunt size desc of player], partially aroused dick[if cunts of player > 1]s are[otherwise] is[end if] exposed before her piercing gaze.";
	say "     '[one of]Hm[or]Yes[or]Very well[at random], [one of]this should be simple[or]such a paltry task[or]I hope this will satisfy you[at random]...' Large, thick tongue escaping her lips as she speaks, the slick, flexible thing has no trouble engulfing your crotch, puss[yfn] completely buried under the writhing, pink flesh.";
	say "     Her constant, unblinking gaze fixated on you, your [if scalevalue of player < 4]entire body[otherwise]torso[end if] is bathed in her steamy breath, lower half disappearing under her scaled snout as her lips hilt against your crotch. As large as the serpent is, she seems extraordinarily dextrous with her tongue, able to squeeze and worm her way into your hole[sfn] with [if cunt length of player > 19]considerable[otherwise]relative[end if] ease.";
	if cocks of player > 0:
		say "     Her skillful work filling the air with the wet sounds of her tongue's efforts, it doesn't need long before you're brought to your very limit! Shall you pull out at the last second and shame her? Else, you'll reward the creature's diligence.";
		if player consents:
			say "     Her grip on you is fairly tight, practically pinning you to a tree, but you manage to order her off just before you cry out, aiming your previously unattended, saliva-slicked dick[smn] at the dragoness as you fire off your [cum load size of player] load, [if cock width of player > 24]utterly soaking[otherwise]painting[end if] her snout with your thick cum. Her brief confusion allows you to spend your entire load on her.";
			say "     '[one of]Hmpf[or]Well[at random], [one of]I think you have had your fun[or]I hope you are sufficiently amused[or]I suppose whatever suits your need[at random]...' Thick tongue licking clean her snout, she's clearly trying to hide her embarrassment behind a terse expression. Once the both of you are clean, the serpent flies off into the distance, leaving you to go about your business once more.";
		otherwise:
...
to say YamatF_5: [Oral Giving Cunt]
	...
	if player consents:
		...
		if player consents:
			say "     Tightening your grip, you wrap your lips around the monster's gushing nethers just before she's no longer able to hold back. [if scalevalue of player < 3]You maybe only last a few seconds before you're completely[otherwise if scalevalue of player is 3]You put up a fair effort before you're eventually[otherwise]It's a struggle to keep up with her, just shy of being[end if] overwhelmed by the flood, senses utterly flooded with the sweet taste of her abundant honey.";
			say "     Completely overtaken by a primal need, it's not long before your [bodytype of player] body, grinding against the dragoness['], is wracked with bliss, [if cocks of player > 0]staining her your own, [cum load size of player] load[otherwise if cunts of player > 0]staining her with your own sexual fluids[otherwise]writhing in an insatiable need[end if]. Once your fervour dies down, you pull away and survey the carnage, utterly drenched in the monster's substantial sex. she seems amused by you.";
		...
		otherwise:
			...
			say "     Unable to hold yourself back in the wake of this display, you're quickly wracked with your own bliss, [if cocks of player > 0]staining her your own, [cum load size of player] load[otherwise if cunts of player > 0]staining her with your own honey[otherwise]writhing in an insatiable need[end if]. Once your fervour dies down, you pull away and observe the end results of your little adventure. Though you managed to avoid getting completely drenched, you're still a mess of the monster's sticky sex. she seems amused by you.";
	...
	otherwise:
		...
		say "     You continue this for some while until it's glaringly apparent that the monster is on the brink... The dragon's laying entirely on her back by this point, looping around such that her head is fairly close to you. Perhaps you could shame her with her own bliss? Else, you'll spare her the embarrassment.";
		if player consents:
