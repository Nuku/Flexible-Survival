...
to say Yamato Dragoness attack:
	...
	if "Touched by Madness" is listed in feats of player and (("Kinky" is listed in feats of player and a random chance of 1 in 2 succeeds) or ("Kinky" is not listed in feats of player and a random chance of 1 in 4 succeeds)):
		...
		if ("Kinky" is listed in feats of player and a random chance of 1 in 3 succeeds) or ("Horny Bastard" is listed in feats of player and a random chance of 1 in 3 succeeds) or a random chance of 1 in 6 succeeds:
			say "You are gradually roused from the feel of something slick and scaled writhing against your form, given only a moment to realize your occupancy within an egg before the more immediate issue is made clear. Another, much smaller";
	...
	otherwise if bodyname of player is "Yamato Dragon" or bodyname of player is "Yamato Dragoness":
		if cocks of player > 0 and a random chance of 1 in 2 succeeds:
			...
			if libido of player > 33:
				...
				say ". It's more than enough to compel her own bliss, her powerful form tight as a noose around your beleaguered frame; she would squeeze you of every last drop.";
			otherwise:
			...
			say "Twin fatigue the anchor that pulls you once more to the ground, she would finally relinquish you from her hold, rising once more into the air to depart in silence. Her influence has doubtlessly left an impression on you, though as you gather your things you do imagine that the more literal impression will fade once the soreness subsides.";
		otherwise:
