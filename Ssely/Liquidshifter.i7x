...
to say losetoLiquidshifter:
	...
	if cocks of player > 0:
		...
		WaitLineBreak;
		say "     'Thaaat's a good girl... You're so delicious,' it teasingly chuckles out - the weird sensation of having your fluids soaked up through the goo that covers you making you whimper in need. Slowly though, the liquidshifter begins to slide off your form, the sound seeming to pop out, plug disappearing into a mass of goo before you. Before long, you find that the creature simply forms back into its original state, walking away with a large grin.";
