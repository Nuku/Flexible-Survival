	...
	if player consents:
		...
		if player consents:
			if cocks of player > 0:
				...
				say "     It seems to you that the dominant species in this impromptu orgy are the hyena and wyvern - while the ram has been pushed to the floor, the hyena's cock pulsing inside of him and marking the former soldier as a bottom-boy now. Across from them lie the gryphon and wyvern - their grunts and humping indicating that the gryphon is having a great time being fucked. Of course you stay to watch even more, and start getting some ideas about that damn otter - showing off to you with his femmy, slim body matching his partly-mustelid features so very well. However, you resist the temptation - standing up right now would be a bit difficult without flashing your cock to all those who pass the side corridor, for now oblivious to the things going on in there. Nah, you'll restrain yourself to just wanking off on the down-low right now...";
				WaitLineBreak;
			...
			else if cunts of player > 0: [intended to only allow /pure/ females through]
...
instead of resolving OtterBoi Meeting:
	...
	[ now XXX is not resolved;   [enable followup events as needed]]
