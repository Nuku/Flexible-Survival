...
to say Moth attack:
	...
	otherwise:
		...
		otherwise: [ Prefer female action]
			...
			otherwise if cock length of player is greater than 7:
...
to say mothgirl defeat:
	...
	if cocks of player > 0 and cock length of player < 8:
		say "The mothgirl comes over to your crotch and starts to suck on your [cock size desc of player] cock, and using her nipples changing them to be points pokes your penis with one of them. She squeezes her breast slightly, introducing a special mixture into your cock that makes it grow. It doesn't take you long to explode inside her mouth, in which afterwards she leaves you with your bigger penis.";
		increase cock length of player by 2;
