		...
		if a random chance of 2 in 3 succeeds: [ Prefer male action]
			if cunts of player > 0:
				if cunt length of player is less than 15 or cunt width of player is less than 10:
					...
					increase libido of player by 45;
...
When Play begins:
	...
	now cock entry is "Above Average";[ Cock Description, format as you have a 'size' (your text) cock] 
...
"Fairy Dust"	"This dust is kept in a small pouch and is yellow in color"	1	fairy dust

fairy dust is a grab object.

the usedesc of fairy dust is "[fairy dust use]";

to say fairy dust use:
	say "You open the fairy dust pouch, and dump it onto your head";
