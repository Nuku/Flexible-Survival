...
to say ResolveEvent Atropis:
	...
	if food is owned, ItemLoss food by 1;
	WaitLineBreak;
	say "     Just as you are about to ask the little one if she's sure, a cough from behind you makes you turn your head back. What you find at your back just so happens to be a buxom looking panther woman dressed in a flowing black gown staring you down with a cocksure grin on her stunning feline face. 'She's sure because I'm right here, darling.' In front of you the little kitten meows happily as she runs around your left side to rush over to the much taller black cat. 'I appreciate you trying to look out for Lachesis here, but it's not necessary.' Gaping slightly you cautiously nod to the unnamed pantheress.";
	say "     Watching as the little kitten hugs herself into her [']sister's['] leg, you try not to let your mind wander as you look between the two in astonishment. Not having a reason to doubt the sincerity of the pantheress though, especially when the younger feline begins to talk animatedly to the older female, you prepare to head off on your way without a word. However, before you can you find yourself being stopped when the woman grunts into her throat again.";
	WaitLineBreak;
	say "     'Clotho wanted me to give you this.' The pantheress then hands you a pink box wrapped up in silver string. Hesitantly thanking the other for the gift you ask her who Clotho is. 'My other little sister.' And with that the pantheress turns to walk away with the little kitten standing next to her following at her side. Before the two get too far away you watch as the feline in black takes the kitten's hand, something to which the smaller feline beams in joy over.";
	say "     Not sure what that was on about, you reach up to scratch at your head before shrugging all the same. Just as you are about to move yourself along you find yourself nearly dropping the pink box in between your hands, having almost completely forgotten about the thing. Moving your [BodySpeciesName of Player in lower case] fingers over the silver twine keeping the package closed you remove the material, open the container... and then blush hotly as you find yourself looking at a stunningly beautiful silver dress looking back up at you. A single card with your name, height and other measurements written down onto the front is the only proof that this piece of apparel is really meant for you.";
	WaitLineBreak;
...
Taur-compatible of red cap is true.
