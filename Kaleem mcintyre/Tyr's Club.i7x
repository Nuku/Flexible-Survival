...
Instead of fucking the Tyr:
	...
	otherwise:
		...
		otherwise if cunts of player > 0:
			...
			now non-infectious entry is true;	
			now lastTyrfucked is turns;
		otherwise if cocks of player > 0 and cunts of player is 0 and ( a random chance of 1 in 3 succeeds or ( "More Anal" is listed in feats of player and a random chance of 1 in 3 succeeds ) ):
