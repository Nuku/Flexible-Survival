		...
		if lastfuck of Kenaz - turns < 8:
			...
			if cunts of player > 0:			[female or herm]
				...
				if player consents:
					...
					say "     Panting and gasping while sighing in euphoric bliss you hug Kenaz closer into you before kissing the firefighter across his spotted neck. 'T-That...was real good.' Kenaz whispers and you can only nod before telling the other man how warm and comfortable his tail-hole feels still gripped around you. A blush covers Kenaz's muzzle but you can't see it from as the Dal boy buries his face into his sticky covers, however, you do note that the firefighter's tail is wagging happily across your chest again.[line break]";
					infect "Dalmatian";
					infect "Dalmatian";
					now lastfuck of Kenaz is turns;
				else:
				...
				if player consents:
					...
					if cunt length of player < 14 or cunt width of player < 4:
						...
						if player consents:
							...
							say "     Whimpering to the firefighter to let the other know of your feeling Kenaz slowly pulls himself up out of you. Just as you think the moment is over with you get a big surprise when a cool, moist nose buries itself in between your legs. While your Dalmatian lover might not have been able to fuck you the way he might have liked Kenaz is not to let you go without unsatisfied. Raising your legs up and then burying his face into your snatch Kenaz hungrily rolls his tongue throughout your pussy. The former subby firefighter shows no hesitation as he slides his tongue into your cervix only to pull out to lay tender kisses along your labia seconds later. When familiar digits return back inside of your tail-star to begin fingering your prostate you find yourself smiling loving back at Kenaz.";
							WaitLineBreak;
