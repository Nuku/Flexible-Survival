		...
		if lastfuck of Kenaz - turns < 8:
			...
			if player is female:			[female or herm]
				...
				if player consents:
					...
					say "     Before long, you are being jackhammered so hard into the Dal boy's lap that [if cocks of player > 1]your cocks are[else]your cock is[end if] now twitching and shuddering with gushes of precum oozing down your legs. A slightly painful knocking at your backdoor signals that Kenaz is almost ready to lose himself as the Dal boy's fully bloated knot pounds more intently at your rump. When the fangs locked tight onto your neck are suddenly removed, you yelp as the bulb slips up into your tender insides and then locks you together with your lover. The fire hose of the Dalmatian's cock doesn't waste any time in flooding your rump with Kenaz's sticky load and upon being thrust down hard once more onto the firefighter's groin, you don't have much of a choice except to take the milky seed up into your guts.";
					WaitLineBreak;
