...
To say aidKenaz1:
	...
	If carried of food >= 10:
		...
		WaitLineBreak;
		say "     By the thick sheath and heavy balls swaying between the former human woman's legs, it would seem that Kenaz wasn't just whistling Dixie here. A grunt from Othala makes your eyes snap up and you blush just in time to see the former female winking coyly at you. 'Hey.' Kenaz's voice has your [facename of Player] face snapping back around to look at the other man. 'If you wouldn't mind, could you go find this feral Dalmatian and bring it back here?' Immediately, you ask Kenaz why he would want the thing brought here of all places.";
	...
	if Player is neuter:
		...
		if lastfuck of Kenaz - turns < 8:
			...
			if Player is female:			[female or herm]
				...
				if Player consents:
					say "     You shrug to the other and then tell him that it's fine with you. The excited Dalmatian barks once and then howls for the others to come around. In a few moments, you are swiftly dropped onto the ground and then snatched out of your clothes as eager muzzles and tongues lick across your [bodyname of Player] body. Feeling your arousal growing as a steadily building heat surges through your pussy, you shiver and shudder along the cool floor while looking at the half dozen or so muzzles around you. Not sure what you should do in this situation, you don't have enough time to think before three tongues are buried inside of your cunt. Gasping and then howling with all the passion you can muster up out of your [bodyname of Player] lungs, you spread your legs to let the other Dal boys eat you out with their oh-so-wonderful tongues.";
					WaitLineBreak;
		...
		if lastfuck of Kenaz - turns < 6:
			...
			if Player is herm:		[herm]
				...
				if Player consents:
					...
					WaitLineBreak;
					say "     'Now I think you're ready.' Kenaz grumbles as he leans himself down to lick you across your [facename of Player] face once again and then removes his fingers from inside your musky, but clean, ass. The loving look in his eyes is almost enough to make your heart melt, but that's right before you hiss as the Dalmatian sinks himself further inside of you.";
					if Cunt Length of Player < 14 or Cunt Tightness of Player < 4:
