...
Instead of sniffing Firehouse:
	Say "The firehouse smells [if kto < 1]like a clean, but lonesome building[otherwise if kto is 1]like wet Dalmatian mixed with cum[otherwise if kto is 2] like a well maintained building that's being kept up to code[end if]."; 
...
instead of conversing the Kenaz:
	...
	otherwise if Kenaztalk is 1: [Normal short messages the npc will say each time you talk to them]
		...
		otherwise:
			say "'Please try and [bold type]assist[roman type] me any way you can, if you can.' Kenaz looks at you somewhat helplessly after saying this. Maybe you should try to help the other man out? If you can spare some time, that is.";
	otherwise if Kenaztalk is 2:
...
to say aidKenaz8:
	...
	if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
	if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
	say "Not sure what to say to this you ask Kenaz what he wants to do, if he had a say so about the situation. 'I'd keep this firehouse open instead of closing it down and shipping others across the state. I'd wring the neck of the chief if he even so much as hinted about trying to do otherwise and the mayor...well I've never liked that guy anyway.' The growl coming from Kenaz's throat makes you take a few steps back from the incensed Dalmatian.";
	...
	if KTO is 2: 
		...
		otherwise:
			...
			otherwise if cunts of player > 0 and cocks of player < 0:
				...
				if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
				if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
				say "When the first brush of Kenaz's tongue touches your clit you find yourself shivering slightly from the pleasure of the warm organ as it rolls itself across your feminine folds. Not to be outdone you lift your head up to where the Dalmatian herms fat sheath is slowly parting to release his black canine cock and then lift Kenaz's heavy white furred orbs out of the way to see the drooling slit of the other man. Pink and perfect like a flower in bloom, you move your nose over to the firefighter's vagina and then begin to lap your tongue out across the divide while sniffing at the heady scent of mixed male and female wafting from in between Kenaz's legs.";
				if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
				if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
				...
				if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
				if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
				say "When you cum you don't just orgasm, instead you shoot your honeyed juices with the kind of force that nearly drowns Kenaz as you flood the Dalmatian's snout with your honey. White hot sparks of bliss trail throughout your body turning you into a livewire as you thrust and yowl and pump yourself into the firefighter like bull fighting to unsaddle a rider. Consequently this causes your fingers to tense and your tongue to dig on up inside of Kenaz which forces the Dal's climax and sends the herm canine right off the edge of the map. Lifting his head slightly to let out a ferocious bark, Kenaz rains his cum down onto your face, drenching you the same as you did to him.[line break][line break]";
