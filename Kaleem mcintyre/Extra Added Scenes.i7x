...
to say ResolveEvent Loving Bond:
	say "     The sounds of someone speaking make you slow down from your jogging as you try to look around for the speaker. You realize that this is a dumb thing to do as you could possibly be putting yourself into danger by doing something like this, but a strange feeling wells up inside of your chest and suddenly you find yourself coming to a full stop in the middle of the empty road. Turning your head this way and that you finally have to look up as you notice two figures, a black canine of some variety and a white sandy brown vulpine of another, two stories above you conversing with each other while music is playing in the background. And though you can't hear what they are saying exactly you do note that the song they are playing seems awfully familiar for some reason. You try and ponder why though, and when it finally hits you as to what's going on your eyes light up like fireworks as everything clicks into place. The reason why the song being played is so familiar is because it is the melody that's usually played at weddings! Not sure how that could be right considering that the high rise area is nowhere near a church, you scratch at your head as you continue to stare as the two figures, both being male from what you can see because of the lack of any breasts, exchange rings with one another. Placing the small bands around the middle finger on each other's right hands you blush furiously when the two give each other a passionate kiss, the likes of which could fog up a glass window, before the two newlyweds begin to grope and fondle each other lustfully. The music in the background soon changes to something more of an erotic beat and flushing slightly you decide to hurry on about your way, especially when the black canine hefts his new mate up, bridal style, and then takes the giggling fox back into their loft apartment. Who knew that love could find a way to prosper in this mad town? Guess the saying is true that love conquers all.";
	increase score by 1;
...
to say ResolveEvent Challenge of the Alphas:
	...
	say "[line break]     This could be quite entertaining to [bold type]watch[roman type], if you would indulge yourself in such. Alternatively, you could [bold type]approach them[roman type], for whatever good that will do for you. Or you could simply [bold type]leave[roman type] these two to whatever matters they have to resolve between one another, matters that almost certainly do not concern you.";
	...
	if calcnumber is 1:
		...
		say "     Their fur bristles so much that both look like aggravated porcupines. You stand there watching the two canines bark, growl and drool down the sides of their muzzles as they lose themselves further to their inner animals. Perhaps you should intervene by [bold type]helping out one of them[roman type]? It seems like neither is willing to give up on a fight without knowing for sure they do not stand a chance.";
		...
		if Player consents:
			...
			if fightoutcome < 20: [won]
				...
				say "     But, suddenly, you feel the breath of the Alpha Wolf behind you as he comes up to sniff at your rump. Freezing slightly, you begin to wonder if you have not made a big mistake by aiding this shaggy furred mutt. You have nothing worry about, however, as he simply nods at you in a sign of respect. 'Well well... I'd make you my new chew toy if you weren't so helpful back there,' he says as he approaches you even closer from behind, placing a hand over your right shoulder as you begin to feel something [italic type]else[roman type] poking at your rear. 'I've got something here to reward you for your generosity.' Just when you think he is talking about something rather physical, as his other arm hugs your left side, he presents you with a can of food in his paw-like hand right before your eyes.";
				WaitLineBreak;
			...
			if fightoutcome < 20: [won]
				...
				say "     And, well, you did try your best at fighting off the Wolf, but your attempt was, at best, pathetic. The Wolf reacts quickly enough to subdue you and manages to get his arms around yours, effectively immobilizing you between the two alphas. The Husky seems only confused at your sudden intervention, but does not recognize your efforts at helping him. Now, they even seem to have forgotten about their fight as a newly added problem just presented itself: You.";
				WaitLineBreak;
				ChallengeOfTheAlphasLoss;
			else if fightoutcome is 30: [fled]
				say "     You regret your decision and, thus, decide to get out of the fight and run away as fast as you can. They do not chase you. Maybe they are even glad you have stopped interfering... Whatever, you only really care about getting out of here, and you do so, leaving the fighting Wolf and Husky behind.";
...
to ChallengeOfTheAlphasLoss: [sex scene for loss]
	...
	CreatureSexAftermath "Player" receives "[if Player is female]Pussy[else]Ass[end if]Fuck" from "Husky Alpha";
	infect "Alpha Wolf";
	infect "Husky Alpha";
