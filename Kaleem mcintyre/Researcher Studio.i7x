...
The invent of Researcher Studio is { "water bottle" ,  "water bottle" , "peach" , "food" }; 
...
The invent of MainRoom is { "food" , "water bottle" , "chips" };
...
instead of linkactioning Omio:
	say "Possible Actions: [link]talk[as]talk Omio[end link], [link]smell[as]smell Omio[end link], [link]fuck[as]fuck Omio[end link][link]tea[as]Omio tea[end link][line break]";

instead of sniffing Omio:
	say "Omio smells of a hard driven researcher, though a heavy haze of smoke and herbs wafts around the female giving Omio a slightly strange scent. A strong female odor clings to the red head, but underneath that is...something else. Something...male?";

Instead of fucking the Omio:
...
carry out Omioteatime:
	if lastOmioteatime - turns is less than 4:
		say "'Sorry about this, but I'm afraid that I'm going to have to ration the tea for now, at least until I feel like making some more from the herbs I have outside. Do be a dear and wait until later, ok?' Omio says with a shy wink.";
	otherwise:
		let T be a random number between 1 and 5:
		if T is 1:
			say "Omio nearly starts to dance around the living room in joy as you ask for some tea. Quickly going into her kitchen the red head puts on a pot just as you settle down onto Omio's comfy sofa in wait for the tea to boil. Almost ten minutes later Omio returns with two small cups of steaming brew settled on top of a large silver tray with a smile gracing her face. 'I hope you like my homemade brand of mixed ginger, chamomile and honey.' Graciously thanking the red head for her kind offer you wait for your hostess to sit next to you, placing the tray on her lap, before grabbing one of the ceramic cups and then casually blowing across the surface steaming amber liquid. Once you are certain that the heat won't scald your tongue you tip the porcelain up to your lips to taste the herbal liquid.[line break]";
			say "The pleasant taste of herbs mixed with the spicy tang of ginger has you murring contently as you let the lukewarm tea flow soothingly down your throat. Settling yourself back further into the sofa you sigh happily as you find your thoughts all but fading away as you let the cool wind of the plains blow in from the open window. Omio quietly sits beside you sipping her own tea. Her fond gaze slips right by your notice.[line break]";
			decrease libido of player by 5;
			if libido of player < 0, now libido of player is 0;
			increase humanity of player by 8;
			if humanity of player > 100, now humanity of player is 100;
			increase score by 1;
		if T is 2:
			say "Omio seems to be in somewhat of a sour mood, but that doesn't stop the red head from smiling at you as she walks off to make that requested tea. Sitting back onto the red head's plush sofa you wait quietly for the tea to be ready, silently you hope that the red head will be in better spirits when she returns. When the smell of brewing herbs starts to waft throughout the air you find yourself humming pleasurably as the scent flows into you. When the red head returns to the living room it's with two cups placed carefully onto a small tray perched in between her tanned hands. 'This is a mixed blend of peppermint and jasmine and sugar. I hope you like.' There's something in the red head's words that make you nod somewhat hesitantly, before taking one of the twin porcelain cups.[line break]";
			say "Sniffing the brew and then blowing over the steaming liquid you carefully lift the cup up to your lips and then take a sip. Though slightly bitter you find yourself not minding in the least as the sweet taste of the sugar that follows makes up for it. Omio chuckles when you smack your lips in delight of the sweet aftertaste. When you turn to regard the red head you blush slightly when you notice her golden eyes gazing at you fondly. 'Thank you for having tea with me right now, I really appreciate the company.' Omio whispers before taking a swallow of her own teal colored drink.[line break]";
			decrease libido of player by 5;
			if libido of player < 0, now libido of player is 0;
			increase humanity of player by 9;
			if humanity of player > 100, now humanity of player is 100;
			increase score by 1;
		if T is 3:
			say "Omio nods to you and then goes to fix the tea, though curiously enough, she does so very, very quietly. Not sure of what has happen to upset the red head you cautiously sit down onto her couch and then settle back while waiting for the tea to be made. The sounds of bubbling and hissing coming from the kitchen helps your senses to calm down a little bit, but it's only when Omio returns with a smile onto her face that you know that all is well. Or close enough to it. 'I hope you like this combination of peach and lemon mixed with a touch of vanilla. I used the fruits from my garden to make this particular blend.' Omio blushes at that and you nod in gratefulness before accepting the cup she hands you. [line break]";
			say "Breathing in the warm vapors you let your mind drift for a moment before blowing over the tea to cool it off. Once you are sure you won't burn your tongue on the liquid you tip the porcelain up to your lips and then begin drinking your offered beverage. The warmth of the tea mixed with the sweetness of fruit and honey has you chuckling as your insides feel like they're receiving a tender massage. Omio decorously smiles over at you from where she has sat herself onto the sofa, but you don't take much notice at the moment as you hum quietly into your drink.[line break]";
			...
			increase score by 1;
 		if T is 4:
			say "Omio chuckles at you somewhat playfully before skipping her way into the kitchen to fix you your tea. Feeling slightly embarrassed by the girlishly way the other is behaving you drop yourself down onto the sofa and then hum to yourself in wonder. It's not but a few minutes later when Omio returns with two cups placed on a silver tray and goofy grin held tightly onto her face. 'Please enjoy this offered cup of chamomile, strawberry, pineapple mixed with rock sugar crystals.' You cautiously smile to the red head and then carefully take one of the cups of tea. [line break]"; 
			say "Seeing Omio's bright golden eyes shining down at you from where she stands you flip your eyes to the steaming orangey colored liquid and then blow over it to cool it off. Opening your mouth and then flipping the ceramic cup upwards you swallow down the tea...and to your surprise you find that the taste is wonderful! The fruity taste mixed with the saccharine sweetness of the rock sugar has you chuckling despite not exactly feeling so giddy just a moment ago. Omio giggles herself and then sits down besides you with her own cup. Before long the two of your are snickering like two children sharing a secret as you look back and forth at each other from over the rims of your respective cups.[line break]";
			decrease libido of player by 10;
			if libido of player < 0, now libido of player is 0;
			increase humanity of player by 13;
			if humanity of player > 100, now humanity of player is 100;
			increase score by 1;
		if T is 5:
			say "Omio hums into the back of her throat as she goes to the kitchen to fix you your tea. Settling yourself down onto the red head's couch you silently wonder what's going through the Omio's mind at the moment as her silence is somewhat...unusual. It takes barely ten minutes before the tea is done, but that proves just enough time for you to fall close to sleep as you let the billowing wind coming in from the open patio door caress over and across your [facename of player] face. Sighing in pleasant harmony you barely notice it when Omio comes over to place a cup of steaming tea into your face. However, the warm scents of cloves, honey, jasmine and raspberries all mixed together wafting underneath your nose has you blinking as you suddenly come back to earth. [line break]";
			say " Turning you look up at Omio and then down to the offered cup you thank the red head for her the beverage and the take the ceramic drinking utensil into hand. Blowing over the surface of the crimson liquid you smile when the warm scent seeps down into your chest. Looking to Omio and thanking her once again with your eyes instead of your lips you pour the tea down into your throat and then let the warm drink pool into your belly. The taste is almost divine and licking inside of the inner dimension of the ceramic cup you find yourself blushing slightly when you unexpectedly hear a playful giggle echo next to you. Not even having to look up to know that the red head is laughing at you, you finish off your tea and then turn your head away from Omio to look out at the wind rolling across the grass of the open plains.[line break]";
			decrease libido of player by 5;
			if libido of player < 0, now libido of player is 0;
...
The description of Nightstand is "A small nightstand sits idly against the left side of the room. From the looks of the crafted wood the stand both looks and feels old…very old.";
...
Carry out unlocknightstand:
	say "Going over to pull open the topmost drawer of the nightstand you find that it is locked. Tugging on the handle does you little good as the drawer holds fast against your attempts to get into it. Grunting in disappointment you try to open the next drawer down, yet a grunting cough stops you from doing so seconds before your fingers touch the second drawer's handle. Turning your head towards the door you look up just in time to see Omio staring at you with a dark glower creasing her tanned face. Trying to laugh away your mortification at being caught you are you are not ready to receive a tea pot to the face.[line break]";
	say "Falling back onto the hardwood of the floor you twitch in pain as a growing lump begins to rise on your head. 'And that's what you get for snooping through a girl's thing!' Omio says before stomping off in a huff. Amazingly enough the tea pot rolls away after the red head to follow Omio, however, you're currently too dazed to take notice.";
	decrease hp of player by 20;

West of MainRoom is Kitchen.
Kitchen is a room.

The description of Kitchen is "Omio's kitchenette is made up of ashen walls with a white tiled floor housing a modern style stove and refrigerator with a single chrome sink resting next to said refrigerator. Large wooden cabinets sit on both the top and bottom sides of refrigerator and stove. More than likely the cupboards house a plentiful storage of food for Omio to cook with, yet from the lingering smells filling the area it would seem that the red head prepares a lot more tea in here than food. Over by the side of the backdoor leading into the plains there stands a large dining table and two comfortable looking chairs with a Chinese styled tea set sitting atop the surface of the table.";
...
invent of Kitchen is { "water bottle" , "food" , "chips" , "peach" }; 

Up of MainRoom is VacantUpstairs.
VacantUpstairs is a room.

The description of VacantUpstairs is "Nothing occupies the large space that once looked to have been a very large guest room. The hardwood floors have not a single speck of dust on them so Omio must use this area for something, though what this might be is unknown at the time. A single window looking out into the world at the end of the room lets the light from the[if daytime is day] warm sunlight[otherwise] glowing stars and shining moon[end if]. ";
...
Instead of Resolving a To the Future:
	say "Navigating your way across the plains you come across an unfamiliar sight that has you pausing somewhat in surprise. Tilting your head to the side, in a vain hope that maybe altering your perception will somehow change the scene happening in front of you, you come to find that, nope, you are indeed witnessing a completely human looking woman talking to a beast of a centaur stallion. Not quite sure what's going on you find yourself pulling your head back into its rightful position and then charging over to the pair when you notice the centaur suddenly rear up at the woman. You barely take notice of the woman's somewhat calm demeanor as she stands there while looking somewhat unimpressed by the other as you prepare yourself for the fight to come.[line break]";
	challenge "Centaur Stallion";
	if player lost is 0:
		say "Driving off the hybrid human/horse you pant slightly from the exertion before turning worriedly to look at the woman you just [']saved[']. What you come to find is an unimpressed strawberry red head glowering at you in disapproval. 'Thanks a lot, whoever you are, you just managed to ruin the first lucky break I had at trying to talk one of those asses.' The red head sighs before shaking her head in mild frustration and you quickly begin to wonder if saving this broad was the right move to make.[line break]"; 
		say "'Oh well,' the red headed woman says as she lifts her face to look at you with the most stunning honey colored eyes you've seen before smiling impishly at you. 'I can understand what you were trying to do so I suppose I should thank you.' You wait for a second to hear this verbal show of gratitude, but it never comes. You give the woman, who looks about to be somewhere in her mid-twenties, a slightly questioning look. 'What?!' She says hotly. 'I already said [italic type]thank you[roman type]. What more do you want?'[line break]";
		say "Realizing that you've got a real piece of work on your hands you turn in preparation to go about your way when a hand grabs your shoulder in an effort to stop you. 'Waitwaitwait. That came out wrong. I'm sorry.' You turn to watch as the red head takes a step back and then flushes while twiddling her fingers together in front of her face. 'Let me try again. My name is Omio and I am very pleased that you helped to save me from the [']danger['] I was in. In a show of gratitude I would like to invite you over to my humble abode just over by the way for some tea.[line break]";
		say "Omio takes a small bow after she finishes speaking and then lifts herself up to smile nervously at you. You sense that the woman is sincere about her apology, but something about her just seems off to you. You flippantly tell the red head that you [italic type]might[roman type] come by later, if you find the time. 'That's fine. I live just over by the small pond just north of here.' Omio points to someplace you can't see, but you get the general feel for the direction as you squint slightly. 'Anytime you can come by would be fine. And again, thank you.'[line break]";
		say " After picking up a pack that you hadn't seen hiding in some of the knee tall grass behind her, you watch as the red head goes about her way in silent grace. Taking care to watch her until this [']Omio['] becomes a small dot shrinking into the distance you find yourself wondering if you should take the red head up on her offer for tea. She doesn't seem too bad, if just somewhat ill mannered, so maybe it might be worth the trouble after all? Also, there are some budding questions filling up your mind as you wonder how such a person has survived unchanged for so long. Maybe there is something to be learned from this woman?[line break]";
		now Researcher Studio is known;
		now For the Future is resolved;
		increase score by 15;
	otherwise:
		say "Having lost to the centaur stallion and been [']seeded['] by the mutated horse-like creature you find yourself slightly annoyed as you start wipe off from the sticky centaur cum flowing down your[if cunts of player > 0]slightly puffy pussy[otherwise]chest[end if]. An out of nowhere shriek makes your head up just in time to see the woman you had tried to save coming over to you with a small opened jar in her hands. 'Don't move a muscle,' she says excitedly and for some reason you comply by going still as she starts to scoop the white cum up from off of your[if cunts of player > 0]weeping cunt[otherwise]torso[end if].[line break]";
		say "'This is [italic type]exactly[roman type] what I need.' The red headed woman collects the centaur stallion's seed and then caps the jar only to hurried put the near full container away into a bag sitting at her feet. 'Thank you so much!' The red head smiles to you in an unexpectedly chipper manner and you slowly find yourself cautiously backing up from the oddball woman. Did she not just see you get owned by a lust drunk centaur and then subsequently[if cunts of player > 0]fucked right up the cunt like a mare[otherwise]creamed across the chest as though you were a hand towel[end if]? Or maybe the more important questions to be asked are - why did she collect the stallion's cum and what is she gonna use is it for latter?[line break]";
		say "You nod to the strange red head and then watch as her brightly lit golden eyes twinkle at you with almost childlike jubilation. 'You have got to come to my studio now! There's no way that I could let someone as resourceful as you get away from me!' The red headed is almost fanatically adamant about this as, once she grabs her backpack from off of the ground, she quickly takes you by the hand and then starts to pull on you towards the northern area of the plains. You struggle against the woman's [']impressive['] grip while asking, in a rather loud and boisterous voice, if she's got some sort of mental problem before successfully ripping your hand away from the red head.[line break]";
		say "'No am I not crazy!' The woman shouts after she turns to face you and then stomps one foot across the ground as if that will help prove her point. You then ask her why in the name of all that is holy would she try and drag you off against your will without so much as giving you her name. 'Oh! I didn't tell you who I was?' You shake your head at the other and then cautiously take a few steps back from the other. 'Oops. Sorry 'bout that.' The red head takes a small bow and then gives you her name. 'My name is Omio. And I'm a...researcher, per say, working out here for the betterment of mankind.' You give the red head a dubious look at that.[line break]";
		say "'Look, I could go into m whole spiel here, but if you just come to my studio then I'll explain everything. It's over by the northern end of the plains.' Omio hikes a thumb behind herself and then chuckles for some unknown reason. 'If you come I'll even share some tea with you and then tell you the whole story.[line break]";
		say "Not sure what to say you tell Omio that you [italic type]might[roman type] think about it if you can find some time later on. 'That's fine, I can accept that promise.' The strawberry red head turns away from you and then begins to off on her, however, before she can leave completely you sudden call out to her to ask what she plans to do with that centaur stallion cum you managed to [italic type]acquire[roman type] for her. Omio stops and then shakes her head before turning to regard you. 'Come to my place and I'll tell you.' A snicker from the woman has you shuddering slightly as Omio turns to go off about her way, leaving you with your thoughts.[line break]";
		now Researcher Studio is known;
		now For the Future is resolved;
		increase score by 15;
