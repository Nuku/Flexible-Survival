...
instead of conversing the Omio:
	if Omiotalk is 0:
		say "[bold type]If you don't want to hear this conversation because you've heard it before then select Y after the choice comes up![roman type] (Y=skip Convo, N=hear Convo)[line break]";
		If player consents:
	...
	otherwise if Omiotalk is 1:
		say "Omio looks at you somewhat curiously as you step up to her. Her golden eyes blink twice before the redhead finds the will to speak. 'Oh, have you decided to help me out or did you come to just say hi?' There is a polite tease in her words, but her posture speaks of something altogether serious.(Y=Help out, N=Just passing through)";
		if player consents:
