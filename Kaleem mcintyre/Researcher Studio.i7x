...
Omio is a woman.
The description of Omio is "Humming to herself while puttering around the main room of her home is the strawberry redhead you met on the plains earlier. Five foot five inches tall, with golden eyes and wearing a blue Chinese-like dress that covers her frame from neck down to her feet, the human-like woman mutters to herself while walking around in circles. Her skin is tanned giving her the appearance of someone who is probably native to a southern island somewhere below the equator. Her face is somewhat sharp with clearly defined angles, yet instead of making her seem manly these lines make her more...cute in a girlish like way.";
The conversation of Omio is { "Research and Development!" }.

instead of linkactioning Omio:
	say "Possible Actions: [link]talk[as]talk Omio[end link], [link]smell[as]smell Omio[end link], [link]fuck[as]fuck Omio[end link][if omiotalk > 0], [link]tea[as]Omio tea[end link][end if][line break]";
[	say "Possible Actions: [link]talk[as]talk Omio[end link], [link]smell[as]smell Omio[end link], [link]fuck[as]fuck Omio[end link][if omiotalk > 0], [link]tea[as]Omio tea[end link][end if][if omiotalk > 1], [link]quest[as]Oquests[end link][end if][line break]";	]
