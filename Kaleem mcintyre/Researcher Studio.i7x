...
Lastomioteatime is a number that varies.

Check Omioteatime:
	If Omio is not visible, say "Excuse me?" instead;

carry out Omioteatime:
	if lastOmioteatime - turns < 4:
...
The invent of Kitchen is { "water bottle" , "food" , "chips" , "peach" }; 
