...
to say ResolveEvent Birthing Time:
	...
	say "[line break]     [bold type]Should you really go over and see about it, knowing that there could be danger waiting in the unknown?[roman type][line break]";
...
to say ResolveEvent Girl Time:
	...
	challenge "[one of]Alpha Wolf[or]Husky Alpha[or]Smooth Collie Shemale[at random]";
...
to say ResolveEvent Spiritual Love:
	...
	say "[line break]     [bold type]You feel retreating may be the wisest course, but shall you press on?[roman type][line break]";
	say "     ([link]Y[as]y[end link]) - Yes.";
	say "     ([link]N[as]n[end link]) - No.";
	if Player consents:
		LineBreak;
		...
		say "[line break]     [bold type]Is it worth it?[roman type][line break]";
		say "     ([link]Y[as]y[end link]) - Yes.";
		say "     ([link]N[as]n[end link]) - No.";
		if Player consents:
			LineBreak;
