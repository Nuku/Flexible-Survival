...
Instead of resolving DogHouse:
	...
	if fin is 2:
		...
		otherwise:
			...
			if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
			if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
			say "The mixed gendered Dal doesn't try to fight, though whether that was because shi couldn't or didn't want to you can't be too sure of, but nonetheless soon the other is being rolled over onto hir back and then straddled one of the horny females. As you take a moment to watch as some of the other bitches begin to lick and pant while drooling along the sides of the Dal herm's groin and underside, your find your own c[if cocks of player > 0]ock begins to grow stiff[otherwise]unt begins to moisten[end if]between your legs. When the shouting of an enrage male catches your attention you flip your head over to the other side of the holding area to see as a floppy, spotted eared human grabbing at the bars of the cage and barking with all the force he can muster up out of his lungs.[line break]";
