	...
	if fin is 1:
		...
		if player consents:
			...
			if player consents:
				...
				say "Seeing that this is your chance you slowly sneak down the side of the bleachers and then head off so that you can look around for Birch. Hopefully, the missing firefighter still has some of his mind left, else... You shake your head as you try not to even think about.[line break][line break]";
