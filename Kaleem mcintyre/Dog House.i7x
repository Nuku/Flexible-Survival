		...
		if Tyraffection is 1:
			...
			if fightoutcome >= 10 and fightoutcome <= 19:
				...
				if fightoutcome >= 10 and fightoutcome <= 19:
					...
					WaitLineBreak;
					say "     Turning your head to regard the others Tyr nods and then uses the keys, which he still has, just dangling off of his tail end instead of placed inside of the pants he now has on, and then goes to unlock the cell doors. You are hardly surprised when none of the others make a move to escape, not even Birch who is shivering from excitement inside of your hold. When Tyr comes over to whisper something into your ear you find yourself blinking at the incredulity of what's of what the Doberman says. 'I think they'll leave when they've had enough, but currently that's not our biggest issue right now. What is, is [italic type]us[roman type] getting out of here. So let's move it!'";
			...
			WaitLineBreak;
			say "     The mixed gendered Dal doesn't try to fight, though whether that was because shi couldn't or didn't want to you can't be too sure of, but nonetheless soon the other is being rolled over onto hir back and then straddled by one of the horny females. As you take a moment to watch as some of the other bitches begin to lick and pant while drooling along the sides of the Dal herm's groin and underside, you find your own [if player is male]cock begins to grow stiff[else]cunt begins to moisten[end if] between your legs. When the shouting of an enraged male catches your attention you flip your head over to the other side of the holding area to see as a floppy, spotted eared human grabbing at the bars of the cage and barking with all the force he can muster up out of his lungs.";
