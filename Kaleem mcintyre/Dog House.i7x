		...
		otherwise:
			...
			if fightoutcome >= 10 and fightoutcome <= 19:
				...
				if fightoutcome >= 10 and fightoutcome <= 19:
					...
					say "'Alright, I understand. And hey, thanks.' Nodding to the other you watch as the Dal eared man and his herm girlfriend take hands before running off towards the city. The fact that they are naked and both have cum dripping from off of their rears breaks up whatever kind of Kodak moment this was going to turn out to be.";
					if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
					if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more'] 
