...
Instead of resolving a The Dorms Part Three:
	...
	if player consents:
		...
		if diceroll is greater than 10:
			say "You duck out of the way just in time to miss getting splattered by a Alpha Husky pumping his cock while masturbating in the middle of the tilted bathroom.  The wet and sticky cum that now lines the wall behind you is thick with the pungent musk of dominant canine.  Upon lifting your head to blink at the male dog, you wonder why in the hell is his beating off in front of the doorway.  You have to gape slightly at what you see happening around you."; 
		otherwise:
