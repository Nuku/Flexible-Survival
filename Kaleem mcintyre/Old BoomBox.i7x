...
to say R&Bfriends:
	If Fang is in the Grey Abbey Library:
		if HP of Fang is 3 or HP of Fang is 4:
			...
			say "     Fang moves over towards you before plopping [ReflexProCap of Fang] down to listen to the R&B melody wafting from out of the speakers of the boombox. By the slow wag of [PosPro of Fang] tail, you can see that the feral creature likes the music very much.";
	If Colleen is in the bunker:
...
to say RockandRollfriends:
	...
	If Fang is in the Grey Abbey Library:
		if HP of Fang is 3 or HP of Fang is 4:
			...
			say "     Fang doesn't seem to care for this particular type of music as [SubjectPro of Fang] pops [PosPro of Fang] head into the Bunker and then pops [ReflexProCap of Fang] back out to return to [PosPro of Fang] post.";
	if Alexandra is booked:
...
to say Oceanfriends:
	...
	If Fang is in the Grey Abbey Library:
		if HP of Fang is 3 or HP of Fang is 4:
			say "     Fang slowly comes over to where you are and then curls [ReflexProCap of Fang] up at your head. Panting softly, the big [if thirst of player is 0]male [else]female [end if]has no problem whimpering at the sounds of the music and then drifting off to sleep as [SubjectPro of Fang] listens to the music with you.";
		else:
			say "     Fang sleepy pads [ReflexProCap of Fang] over to you and then curls up to go to sleep. No muss, no fuss. Just a large bundle of sleepy wolf curling [ReflexProCap of Fang] up next to your head.";
	If Colleen is in the bunker:
