...
Instead of Resolving a Old Record Store:
	...
	say "When nothing happens after several seconds you feel your nerves start to calm and your muscles unclench as a sense of safety washes over you. Not knowing what's going on here you find yourself wondering if you should take a chance and go into the darkened storefront. Should you go in? (Y=Yes, N=No)";
	if player consents: 
		...
		say "Grunting in annoyance you shake your head, wanting desperately to forget that noise ever happened, before you see a flicker from the back room that draws your attention. Not knowing what to do you find yourself at the crossroads of yet another decision. Should you go in or should you turn tail and flee? (Y=Yes, N=No)";
		if player consents:
...
This is the musiclisten rule:
	...
	if title entry is "Jazz":
		now musicmessage is "     Looking over the old jam machine you press the [italic type]jazz[roman type] button. Slowly you find the soft sounds of trumpets and bass guitars and pianos rushing out at you in a soothing, almost laid back kind of rhythm. Without you noticing them doing so your feet begin tapping in time with the smooth music as you bob your head while imagining yourself sitting back on a sofa and watching the sun set with a glass of wine in your hands. [line break][line break][jazzfriends]";
		follow the turnpass rule;
	otherwise if title entry is "Tango":
...
to say R&Bfriends:
	If Fang is in the Grey Abbey Library:
		if hp of Fang is 3 or hp of Fang is 4:
			say "    Fang over to you and then lays its head down onto your lap.  The music seems to have gotten to the other in a strange way as you could almost swear that tears are in his eyes.  Maybe this canine has more soul than you think as you lay a hand down to stroke him across his rugged mane of fur.  Neither of you speak as you just listen to the tunes. You find that words have no place here now.";
		otherwise:
	...
	if Sarah is in the bunker:
		if sarahslut is 0:
			say "     When a firm husky arm snakes its way out around your waist to hold you close you jump a little before noticing that Sarah is snuggling herself up into you. Smiling down at the medic you lay your head on top of hers as you let the music simply wash away all of your thoughts. There is no here or now, there is only this moment where you are connected to everything around you by invisible threads. Perhaps especially so to the husky woman next to you.";
		otherwise:
	...
	if Gryphoness is tamed:
		say "     Denise seems somewhat perturbs by this form of music which seems to rival her own voice, however, upon listening to the tunes more and for longer Denise seems to calm down and then quietly whisper in time with the melody.  Soon enough the gyphoness is almost mimicking the melody perfectly as she closes her eyes while singing in time with song coming from out of the boom box.  You realize that you actually like the blue female's voice just a little more than the music as Denise seems to possess a strange, if not haunting echo to her warbling voice.";
	if skunk kit is tamed:
		say "    The little skunk you saved earlier comes over to you and quickly curls itself up by your leg as it falls to sleep because of the music.  Obviously the intensity of the music is too much for the mind of the young mephit.  You snicker somewhat as you watch the little skunk whimper and then kick around in its sleep.  Young or not though, you see that something is getting through that skull of the young one.";
	if Candy is in the bunker:
		say "     Candy seems somewhat put off by this music as he snorts and then goes off somewhere to go bounce up and down someplace else.";
...
to say RockandRollfriends:
	if Sarah is in the bunker:
		say "     You find yourself getting down with Sarah as you and she dance together while shaking your tails in time with each other. Listening to the other bark and then whip her head around as though caught in a frenzy you have to laugh as you notice the once, somewhat uptight female letting herself go as she released all of her inhibitions."; 
		say "     Brushing up beside her to feel Sarah's furry body rolling against your own you suddenly wish that both of you were in a normal bar doing this while getting drunk off of a shared vodka and rum while dance lights flash around both your bodies. Maybe when all of this is over you and she could have your own private dance session together. Whether that will be with the husky female dancing on your lap or in your bed, well the jury is out on that one.";
		if sarahpups is greater than 0:
...
to say Oceanfriends:
	...
	if felinoid is tamed:
		say "     Your felinoid companion is quick to go over and curl up at the back of your back.  Purring distinctively inside of your ears you chuckle some as its whiskers tickle you softly.";
	if Candy is in bunker:
		say "     Candy seems to be somewhat offset by this kinda of soothing music as the other seems to slink away out of the room.  Maybe he doesn't feel like taking a nap?";
	if Sven is in bunker:
		say "     The snow leopard seems put off by this music but can't from yawning as the ocean sounds have caught him good. Coming over to you [if felinoid is tamed]and moving over your felinoid companion to settle himself at your back alongside the other feline[otherwise]and just plopping down at your back[end if]. Sven nuzzles up to you and then goes right to sleep. His arms do come around you to hold you somewhat close/possessively though.";
	if little fox is tamed:
		say "     The cute little vulpine swiftly bound over to you and then curls himself up at the underside of your chin[if Fang is in the Grey Abbey Library].  Fang moves the fox over to lay it next to however, the other growling somewhat fatherly at the little kit when the vulpine tries to move away[end if].";
	if skunk kit is tamed:
