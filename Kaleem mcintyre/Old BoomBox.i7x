...
to say ResolveEvent Old Record Store:
	...
	if Player consents:
		...
		if Player consents:
			...
			say "     Listening very hard, you almost have to strain to hear anything as the volume on the old boombox quickly silences itself. Pulling back to tilt your head in befuddlement, a scowl soon covers your [FaceSpeciesName of Player in lower case] face as you promise that you're going to make whoever is pulling this joke off on you pay when you find them. Whirling away from the jam machine, you head back over to the other side of the room to replace the cassettes that you have in hand. Just as you are about to set the twin tapes back, the boombox suddenly pumps up the volume loud enough that you nearly jump up onto the ceiling.";
			WaitLineBreak;
...
To say jazzfriends:
	...
	if Fang is in the Grey Abbey Library:
		say "     Fang[if HP of Fang is 3 or HP of Fang is 4 or HP of Fang is 6 or HP of Fang is 7] seems quite interested in the music as [SubjectPro of Fang] comes over to lay by your leg while listening to it. Grumbling softly into the back of [PosPro of Fang] throat, the wolf nuzzles close to you while curling up into a large ball of fur and muscle. You do happen to notice, however, that the wolf's ears are ever tuned towards the door of the bunker. The lupine, no matter how relaxed, is ever vigilant towards [PosPro of Fang] duty to protect [PosPro of Fang] new home[else], not used to hearing music too often, seems a little intrigued by the noise coming from the boombox. Slowly, the feral wolf comes over and then lays down beside your cot to listen to the soft sounds coming from the unfamiliar machine[end if].";
	...
	if Elijah is in the Bunker and (HP of Elijah is 3 or HP of Elijah is 4):
...
to say tangofriends:
	...
	if Sven is in the bunker and HP of Sven < 30:
...
to say R&Bfriends:
	if Fang is in the Grey Abbey Library:
		say "     Fang [if HP of Fang is 3 or HP of Fang is 4 or HP of Fang is 7]pads over to you and then lays [PosPro of Fang] head down onto your lap. The music seems to have gotten to the other in a strange way as you could almost swear that tears are in [PosPro of Fang] eyes. Maybe this lupine has more soul than you think as you lay a hand down to stroke [ObjectPro of Fang] across [PosPro of Fang] rugged mane of fur. Neither of you speak as you just listen to the tunes. You find that words have no place here now[else]moves over towards you before plopping [ReflexPro of Fang] down to listen to the R&B melody wafting from out of the speakers of the boombox. By the slow wag of [PosPro of Fang] tail, you can see that the feral creature likes the music very much[end if].";
	if Colleen is in the bunker:
	...
	if Elijah is in the Bunker and (HP of Elijah is 3 or HP of Elijah is 4):
		say "     Your white winged angel seems to find mild amusement in the soft croons playing on the boombox as he comes over to sit beside you while encircling one of his wings around your [BodyType of Player] form.";
	if Alexandra is booked:
...
to say RockandRollfriends:
	...
	if Fang is in the Grey Abbey Library:
		say "     Fang [if HP of Fang is 3 or HP of Fang is 4 or HP of Fang is 7]seems to have woken up from [PosPro of Fang] inopportune nap as the wolf rises onto [PosPro of Fang] feet and then pads over into your direction. Seeing that [SubjectPro of Fang] is not quite happy about being so rudely interrupted by the annoying sounds, you have to block [ObjectPro of Fang] off from the boombox as you can clearly see that [SubjectPro of Fang] wants to destroy the machine. It takes some bit of struggling before the lupine relents and then goes off somewhere else to not have to listen to the noise. You sigh softly at this. After all, a win is a win in your book by any accounts[else]doesn't seem to care for this particular type of music as [SubjectPro of Fang] pops [PosPro of Fang] head into the bunker and then pops [ReflexPro of Fang] back out to return to [PosPro of Fang] post[end if].";
	if Alexandra is booked:
...
to say Oceanfriends:
	...
	if Sven is in Bunker and HP of Sven < 30:
