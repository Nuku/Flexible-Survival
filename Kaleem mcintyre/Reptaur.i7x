	...
	if Player is male:
		...
		if a random chance of 1 in 2 succeeds:[Player is pussy fucked by Reptaur]
			...
			if BodyName of Player is not "Reptaur":[Bitten by Reptaur]
				...
				say "     The warmth of the Reptaur's breath onto your shoulder coupled with the feel of his oozing cock juicing your pussy makes a heavy flush stain across your face as your body goes into overload. Grunting and then gasping in rapture you nuzzle your [FaceSpeciesName of Player in lower case] head back into the reptile's throat just as you feel your climax about to overtake you. As your tight nethers slap close around the Reptaur the scaly beast roars out his orgasm as he thrust into you powerfully once and then twice before going still.";
				WaitLineBreak;
			...
			if Player is female:
				...
				if Player consents:
					...
					if Player consents:
						...
						LineBreak;
						say "     Wanting the beast's ass more than its cunt you slap the Reptaur onto the rump, forcing a hiss and then yelp out of the other, before reaching two of your digits up to your [FaceSpeciesName of Player in lower case] face to spit onto your fingertips. The quick turn of the reptile's head back towards you does nothing to phase your confidence as you work to slip your lubed fingers into the scaly mutant's tailstar. This action makes the Reptaur moan like the wanton beast it is as its large tail moves up around the side of your neck to hold itself steady just as the creature shuffles its hips from side to side while pushing its rump back into you.";
...
When Play begins:
	...
	now Species Name entry is "Reptaur"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	add "Reptaur" to infections of InternalBallsList;
	...
	now MilkItem entry is "reptaur milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "reptaur cum"; [ Item to be given to the player if they have this infection and jerk off. ]
