					...
					if fightoutcome >= 10 and fightoutcome <= 19:
						...
						if fightoutcome >= 10 and fightoutcome <= 19:
							...
							if fightoutcome >= 10 and fightoutcome <= 19:
								...
								say "     Trying to run away, you find yourself getting swiftly tossed outside of the apartment onto your head. Grunting from the impact you mutter a few choice curses before tiredly getting up to shake yourself off. The sounds of yowls and cries that come from out of the now shut condo door break your heart but when you try to beat at the wood barrier to get inside again you find yourself getting burned when a strange crest appears on the doorframe. Maybe you should come back later to check on Dagaz?";
								now AptAid is 3;
								increase score by 2;
								WaitLineBreak;
						else if fightoutcome >= 20 and fightoutcome <= 29:
