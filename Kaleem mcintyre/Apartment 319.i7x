...
to say ResolveEvent Apartment 319:
	if AptAid is 0:
		...
		if MaleList is banned or DemonList is banned or FurryList is banned or HermList is banned:
			...
			if Player consents:
				LineBreak;
				say "     Making the decision that whatever's going on with Dagaz is going to [italic type]be[roman type] your problem as of now. You make plans to come back later on in the evening to check up on the anthro man. Whatever is going on, it's mighty suspicious!";
				now AptAid is 2;
						...
						if fightoutcome >= 10 and fightoutcome <= 19:
							...
							if fightoutcome >= 10 and fightoutcome <= 19:
								...
								if fightoutcome >= 10 and fightoutcome <= 19:
									...
									say "     'Just so you know, Dagaz here made a contract with our company for the current services that he's being treated to. So, don't think we were doing this out of malice or spite,' the mutant explains, and you have to ask him what he's on about. 'Well, you see, currently the company I work for takes on BDSM contracts and then works with the client, or clients, in question to bring about their wild little fantasies. With the city the way it is now, we are hoping to open a branch here in order to expand further out to this side of the country. Dagaz was to be our first customer in this region and has been taken care of quite well... until tonight that is.' You don't show any apology for having trounced the canine as you stand somewhat defiantly in front of the unknown mutant.";
									WaitLineBreak;
									say "     'I can tell you don't care so I'll be moving along now.' The mutant turns towards the bound Dalmatian and then hisses at him. 'Next time you make a contract...[italic type]tell your friends[roman type] before they show up to trounce my guys! My company is not in the habit of dealing with domestic disturbances and little happenings like this will get you banned from our patrons list if this should ever happen again, understand?' Dagaz can only moan as he nods his head while seeming to slip in and out of consciousness. 'Ugh... the things I have to go through.' The mutant shakes his head before moving past you on his way out the door. When you call him back to ask about the sling...";
