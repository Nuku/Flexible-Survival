...
Instead of resolving a Apartment 319:
	...
	otherwise if AptAid is 1:
		...
		if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
		if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
		say "Now out of all the odd things you've seen in the city as of late...that had to have been the oddest thing of all[if intelligence of player > 15]. [']Knowing['] that something is seriously wrong here you go over what you've just seen and heard several times before nodding to the now closed door in front of you[otherwise]. If you didn't know any better you could almost swear that the other man is hiding something[end if]. Dagaz looked as though somewhat was bothering him...and that mark on his butt...it kind of looked like a brand or something... Quickly you find yourself wondering if maybe you should come back later on in the evening to try and see if you can learn anything more about what's going on with the other man. Though you were told it was none of your business, can you really turn a blind eye on this one?(Y=Come back later, N=Don't come back)";
		if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
		if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
		if player consents:
	...
	if AptAid is 2: 
		...
		if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
		if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
		say "The three hyenas have wooden paddles in their hands, and smugly look ready to use them on both you and the bound Dalmatian, the two demons have a whip and belt, respectively, wrapped tightly into their clawed fingertips, and the last person is just sitting while looking somewhat bored at the whole thing. The fact that there are numerous candles around the apartment, glowing almost dimly in the darkness of the condo, makes this entire setting somewhat...eerie, if not out all creepy. In any other given situation you sure that you might have started to freak out, however, now you're just too worried about the Dagaz to find the energy to be frightened.";
	...
	if AptAid is 3:
		...
		say "'Anyway, thanks for the assist and don't go running your trap off to anybody about this, okay?' A slow and unsure nod has the firefighter smiling at you. A quick lick across your [facename of player] cheek and Dagaz is pulling back to blush somewhat unsurely at you. 'Thank you, friend.' And with that that Dalmatian walks backwards into his home and then quietly closes his door leaving you standing in confusion as you look at the now sealed doorway.";
		if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
		if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
