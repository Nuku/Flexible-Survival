...
carry out omioquesting:
	...
	otherwise if omq is 3:
		say "[omioquest3]";
	otherwise if omq is 4:
		say "[omioquest4]";
	otherwise if omq is 5:
		say "[omioquest5]";
	otherwise if omq is 6:
		say "[omioquest6]";
	otherwise if omq is 7:
		say "[omioquest7]";
	otherwise if omq is 8:
		say "[omioquest8]"; 
	otherwise if omq is 9:
		say "[omioquest9]"; 
	otherwise if omq is 10:
		say "[omioquest10]";
	otherwise if omq is 11:
		say "[omioquest11]";
	otherwise if omq is 12:
		say "[omioquest12]";
	otherwise if omq is 13:
		say "[omioquest13]";
	otherwise if omq is 14:
		say "[omioquest14]";	
	otherwise if omq is 15:
		say "'Thank you so much for helping me, but I don't have any more quests you can take on.' Omio says silently. 'I hope you'll come by for tea later on when you have some time though.' Omio goes back to what she was doing at that point, leaving you with your thoughts.";
...
to say omioquest3:
	...
	challenge "Prairie Dog";
	challenge "Prairie Dog";
	say "When the lasts of the little furry pests are gone you walk over to Omio to check on the red head to.";
	if the facename of player is "Prairie Dog":
		say "Turning to have a look at you Omio screams from where she is on her knees checking over her herbs and vegetables. Trying to reassure the red head that you are you and not a feral prairie dog, despite your [facename of player] face staring at her, Omio seems not to believe you as she swiftly sends a savage uppercut towards your chin."; 
...
to say omioquest4:
	say "Try to get Omio's attention you find that the red head researcher is almost completely ignoring you as she resolutely taps her fingers along the keyboard of her computer while going over whatever work she's doing at the moment. 'Hold on, I'm looking for something.' Figuring that the red head is not about to give you the attention you desire you head over to her sofa and then flop down onto the beige cushions in order to make yourself comfortable. Cuddling up to your backpack and looking out to the open patio door allowing the warm winds of the plains to flow into the room you find yourself slowly closing your eyes.";
	say "'And so I need you to make sure that these samples arrive into the hands of the director as soon as possible, is that understood?' Omio's voice reaches out to you in your haze of sleep. You want to rise and ask what's going on, but you're suddenly just too tired to fight off the need to sleep. 'And what of this one?' Another voice, this one unfamiliar to you, asks[if cocks of player > 0]. 'He's my pet project. He's not to be touched or harmed by any of your operatives, otherwise they deal with me personally[otherwise if cunts of player > 0]. 'She's my pet project. She's not to be touched or harmed by any of your operatives, otherwise they deal with me personally[end if]. Am I clear, Siegfried?' Omio growls with a rumble strong enough that small fixtures tremble around inside of the room while she taps her foot impatiently across the floor.";
	say "Crystal.' The last you hear of the other, before darkness and unconsciousness takes you back into its embrace, is the sounds of shoes stepping off from the hardwood floor and then crunching onto grass before. When next you wake Omio is typing away on her computer with the same focused intensity she had been using before you fell asleep. Trying to converse with to the red head only nets a grunt of mild irritation from the female.";
...
to say omioquest6:		
	...
	if "lumpy box" is listed in invent of player:
		...
		say "You'll never know how grateful I am for all of this, but I do so seriously appreciate all you have done for me! Those chemicals will keep me going for a long while to come and my reports will be perfectly documented and written now that I have the parts to upgrade my laptop with! 'Omio cheerfully smiles at you and you can't help, but not passively at the other woman. 'What's wrong? You seem kinda beat.' Giving the red head a [italic type]look[roman type] you recap your adventure with the blonde and the two lizards. 'Really? That's...peculiar.'";
...
to say omioquest7:
	...
	say "You find yourself nodding and turning to fetch what the other had just asked for, but before you can take too many steps you stop dead as you go over what Omio said. Whipping back around you ask the red head how she knew about the bunker where Trixie and your pets are currently being safely kept out of harm's way, you find Omio waving you off somewhat impassively. 'I know everything there is to know about the people I deal with. I couldn't be a successful researcher any other way.' The flippant air coming from off of Omio has you narrowing your eyes at the red head. Again, that strange feeling that you need to be careful around the woman surges up throughout you.";
...
to say omioquest8:
	...
	if gatherspottedfur is 1 and gathertaintedwool is 1:		[complete]
		...
		otherwise:
			...
			say "Looking to the large clump of material dripping dry on the wooden ladle Omio is holding up you feel as though you should ask her something, but what exactly? (Y=About the past, N=About the future)";
			if player consents:
				...
				say "You ask Omio which part of the world this unknown testing happened at some unknown time ago. You're not prepared for the red head's answer, 'Which world are you talking about because there were more than a few that got...[bold type]genetically modified[roman type] in the past.";
	...
	otherwise:
		...
		if gatherspottedfur is 0:
			if spottedfurfound is 0:
				say "'Remember, [']spotted fur['] in the high rise district. Fix it into your memory. A little ditty about both will help if all else fails. What do you know that rhymes with fur?' Omio asks honestly while tilting her head to the side.";
			otherwise:
...
to say omioquest11:
	say "Today you find Omio sitting at her desk and going over something on her computer. Nothing unusual there, however, when the red head suddenly jumps up out of the blue and then dashes off towards her room you find yourself somewhat perplexed by the strangeness of the golden eyed woman's antics. Blinking and then looking as the red head returns with something bundled into her hands you have little time to think over what said thing is before Omio is stuffing the item in question into your arms.";
	say "'Get this to the warehouse district and into the arms of one Captain Red-eyes, please and thank you.' Omio says without a hint of explanation. Trying to ask the red head what exactly is going on Omio rapidly shakes her head from side to side as her lips tighten into a scowling frown all of a sudden. 'Please, just get this to Red-Eyes down at the warehouse. It's a [bold type]Special Delivery[roman type] that the other is waiting for. And you can't miss him, he's a giant blue hydra with two heads who'll, knowing him, be barking orders along the south dock area of the warehouse district at one of his workers.'";
...
to say omioquest14:
	if "flotsam club" is listed in invent of player:
		...
		if player consents:
			...
			say "While she had been stirring the contents of her pot Omio had been systematically pouring in chemicals and reagents into the mix. From what you could see it would appear that the red head had just been mixing and matching things at will, and by some of the looks that crossed her face Omio probably had been, but the final result was something you hadn't expected at all. When the red head finished brewing her out of the cauldron came a long and shining piece of metal. How that had happened...you're still not sure, but at seeing the evidence being hauled into Omio's hand, via a large pink kitten paw pot holder, you cannot deny the result of this new experiment.";
...
Instead of resolving a Dream of a Unicorn:
	...
	otherwise:
		...
		say "'Now, time for the next portion of the testing. [bold type]Are you ready?[roman type]'[line break]";
		if player consents:
