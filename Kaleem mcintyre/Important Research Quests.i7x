...
Instead of resolving Important Treasure:
	...
	if opcl is 2:
		...
		stop the action;
	if opcl is 3:
		say "Walking through the seedier portion of town you find yourself bumping into someone who suddenly comes flying out of an opened doorway. Grunting from the impact of your two bodies colliding together you stagger for a moment before catching yourself. Once you are settled you look to find the face of the four armed iguana gazing up at you with a slightly punch-drunk look plastered onto his scaly face. 'Hey! I know you!' The bleary eyed reptile slurs while blinking owlishly up at you. 'You're that suspect I'm supposed to question!' The uniformed iguana chuckles playfully before grabbing you into a strong bear hug and then nuzzling the underside of your [face of player] neck.[line break]"; 
		say "The smell of something rancid coming off from the other man makes you want to retch. Just how much did the officer have to drink? 'I'm so happy I found you, now I can tell Greg that I did a good job and get a pat on the head from him.'  At this point you're about totally lost, but seeing how inebriated the other is you start to open your mouth to ask the cop a question. However, before you can several rugged looking mutants come out of the building the iguana had just flown from with angry looks plastered onto their muzzles.[line break]";
		say "The group of five quickly surround you and your drunken companion and then go to growling and hissing like mad which makes you narrow your eyes in wariness. 'H-hey, back off you guys. I-I'ma police officer!' The iguana drunkenly states, but his words only succeed in making the rowdy looking group chuckle as some of them begin to leer at the vulnerable reptile. 'We know, we've been looking to do our [']civic duty['] for a while now, haven't we guys?' The rest of the mutants all nod together while rubbing their growing hard ons. 'Why don't you leave the lizard here, friend? We'll take [italic type]real[roman type] good care of this lightweight.'[line break]";
		say "Seeing the vulnerable officer quivering while holding tightly onto your [bodyname of player] chest you wonder if it would really be alright to just leave the iguana alone with these mutants. While they don't look like they'd kill him, after what the group might put him through you're not sure the [italic type]iguana[roman type] will remain an iguana once the assembled males surrounding you both get finished with his ass and tail. But is putting yourself at risk for an unknown stranger really worth the trouble?[line break]";
		say "Hearing a fretful whimper coming from the reptile in the uniform you realize that leaving the other is out of the question, especially when pitiful greenish-yellow orbs gaze up at you in unrequited fear and helplessness. Easy to see that a badge and a uniform do not make one invincible, even when drunk, as the reptile shivers while hugging himself closer into you. Looking around for the other's partner you wonder where in the hell the raptor hybrid could be. 'Well, what's it gonna be? You handing him over or not?' The lead mutant questions, somewhat irately.[line break]";
	...
	if opcl is 5:
		...
		say "Confusion rips through your mind as you try and figure out what you are being asked. It's not like you're actually friends with the two reptiles, right? So why should you go see about two grown men who can probably well enough take care of themselves? You find your answer coming, not from a sudden epiphany, but from the human woman as she glares cool ice blue eyes at you pointedly.[line break]";
		say "Smiling nervously you ask the other where the two would be at the moment. 'They're warehouse district . You may want to get there as soon as possible.' The words are cryptic, but seem to hold the weight of deadly seriousness. You sigh painstakingly at all the trouble that you seem to be coming across lately before bowing your head as you think to yourself the quickest way to get to the warehouse area of the city.[line break]";
		now Warehouse is known;
		Move the player to Warehouse;
...
Tpfs is a number that varies.
The sarea of Friendship's Proof is "Boardwalk";

Instead of resolving a Friendship's Proof:
	if tpfs  is 0:
		say "Walking through the warehouse district you find yourself catching the sounds of a heated argument occuring between two scalies standing together off to the side of a currently empty street. Stopping as you hear one of them, a green and black male iguana with fours arms wearing a police officer's uniform, shouting up at a taller sleepy eyed orange and yellow raptor/komodo dragon hybrid wearing a trench coat[if daytimer is day]with shades on[otherwise]with shades hanging down onto the collar of his shirt[end if] you wonder what the two are arguing over. A strong feeling of discomfort coils through your stomach as you watch the iguana tackle the older male and then start to wail on him with his four fists.[line break]";
		say "Not understanding what's happening, but knowing that its...wrong for some reason you go over to try and stop the two. However, before you can get too close the raptor makes a move to pin the iguana down onto his front and then sets about holding the other male onto the ground with a single orange and yellow mottled arm. The fours arms of the iguana are all but useless at the moment as they are held fast underneath the bulk of their owner. Bucking and struggling while hissing and screeching the iguana seems to let out all of his frustrations in a single burst of sound and emotion before unexpectedly going still.[line break]";
		say "The taller raptor leans himself down to croon something into the other's ear and even though you're not able to hear exactly what it is, you can see that its having a positive effect on the shorter reptile as the iguana is all but placid right about now. The raptor soon gets up off of his uniformed counterpart and then sighs when he notices that he's broken his shades. Tossing the eyewear off to the side the bigger male helps the smaller up and then dusts the now sobbing iguana down. In a flash the iguana has all four of his arms wrapped tightly around the other male and is nuzzling him almost desperately.[line break]";
		say "Seeing that everything is alright, at least partially so given the spectacle that just occurred, you decide to walk away from this odd pairing be as quickly and quietly as you can. Turning on your heel and walking away you miss out on the passionate flicking of tongue the raptor showers over the smaller male.[line break]";
		now tpfs is 1;
		increase score by 5;
		stop the action;
	if tpfs is 1:
		say "Coming across a familiar area of the warehouse district you find the trench coat wearing raptor from before sitting with his arms full of a slumbering iguana cop[if daytimer is day]. The light from the sun seems to almost gleam off of the scales of the two mutants as they rest quietly onto the steps of an abandoned warehouse. Out of the blue a teasing orange and yellow tail tip comes up to play at the end of the iguana's nose. Unsuprisingly, the slightly irritating appendage quickly gets batted away by an unamused dark green hand[otherwise]. The moon shines brightly down on the two as the bigger raptor strokes a scaled hand over the darker jaw line of his shorter companion. Resting side-by-side as they are against the ramshackle fishery behind them, both men seem almost picturesque underneath the white sphere dancing in the pitch black sky[end if].[line break]"; 
		say "Watching as the four armed green and black mottled lizard hugs himself into the bulk of his bigger companion when a stray breeze sweeps across the two of them you can't help but chuckle wistfully at how easily the taller male falls into the role of [']guardian/protector['] as he hugs the squirming bundle in his lap without complaint. Seeing that there is no need to come into contact with these two men you back away slowly, so as not to break the mood surrounding the pair, and then quietly go off about your way.[line break]";
		now tpfs is 2;
		increase score by 5;
		stop the action;
	if tpfs is 2:
		say "An arm shoots out of a darkened building and snatches you up before you can think to react. Landing on your butt, after being dragged inside of the warehouse you had been walking in front of, you grunt from impact only to gasp when something constricts itself around your throat. Clawing at the smooth, yet unknown thing choking just enough air from your lungs to threaten you with unconsciousness, you growl in primal fear for your life before fingers decorated with sharpened claws grab the back of your skull. 'Don't say a word, just yes and shake your head no, understand? [line break]";
		say "Not having much choice you find yourself nodding without having to think to hard over the situation. 'Good. Now then, are you following those two lizards I twice caught you standing in front of?'[line break]";
		say "Shaking your head in the negative you find the thing wrapped around you uncoiling just a little. 'Next question, did anyone send you down here to look for a man name Greg?'[line break]";
		say "Shaking your head in the negative once again you find the thing wrapped around you uncoiling itself just a little more. 'Final question, do you know anyone by the name of Natasha?'[line break]";
		say "A final shake of your head and the thing around your neck releases you completely just as the claws at the back of your head move away from you vulnerable cranium. The sound of running feet moving away from you catches the end of your hearing, but at the moment you are too glad for air to care about the strangeness of what just happened to you.[line break]";
		now tpfs is 3; 
		increase score by 4;
		stop the action; 
	if tpfs is 3:
		say "Walking down the silent streets of the warehouse district finds you coming across a familiar orange and yellow raptor wearing his detective styled trench coat. Standing off to the side of a vacant building as he is you might have missed the other, despite his brightly colored scaled hide, had you not caught the tip of his tail snapping in frustration out the side of your peripheral. Taking a moment to stop in order to look carefully survey the surrounding area you find yourself wondering where the other's [']shadow['] could be. That is, right before you become aware of the fact that unnamed reptile gazing at you. Somewhat intensely, at that.[line break]";
		say "With his shades hanging down from off the collar of his shirt you find yourself becoming transfixed by the most frigid gold-green eyes that you could hope never to see. Gazing into those darkening orbs you barely notice as the world around you growing darker and darker and darker...  Shaking your head when the reptile blinks you come back to yourself, but with a small headache suddenly pounding against the inside of your skull.[line break]"; 
		say "Watching as the trench coat wearing lizard turns to regard his panting partner running up to him you wonder what that was all about. When nothing resembling and answer makes a move to come up out of your now now aching brain you simply decide to shrug and then head off about your way before anything else weird can happen - like before back at the warehouse. A small part of you still wonders who the heck that was that had tried to literally choke information out of you. Narrowing your eyes as you think about the long reptilian tail of the orange and yellow raptor you wonder...could it have been him?[line break]";
		now tpfs is 4;
		increase score by 3;
		stop the action;
	if tpfs is 4:
		say "Coming across the familiar orange and yellow raptor from before you find yourself stopping to nod to the other in quiet deference. The raptor does nothing in return, save for flick his long and thin tongue out in your direction. Knowing that it's time to move on, before something creepy can happen again, you prepare to take a step away from the other when the sudden prevading scent of fresh blood slips its way across your [facename of player] nose. Snapping your head around to look over the raptor your eyes wander up and down the trench coat wearing lizard until you find large splotches of something red and sticky looking covering at the ends of the reptile's coat.[line break]"; 
		say "From what you can see the other doesn't appear to be hurt anywhere, so that begs the question of - where did the blood come from? A dark chuckle makes you shiver as your eyes lift up to focus on the[if daytimer is day]unseen orbs of the raptor hidden behind his shades[otherwise]golden-green slit orbs of the raptor[end if] as a almost maniacal smile spreads across the reptile's lips.[line break]";
		say "Taking a cautious step away from the other you decide not to stick around to figure this one out as you swiftly turn to go off about your business. A fleeting hope inside of your heart transforms into a small prayer that the blood hadn't come from the emotional iguana with the four arms you had seen the other with thrice before. Surely the other man wasn't [italic type]that[roman type] kind of a sadistic son of a bitch. Was he?[line break]";
		increase score by 2;
		stop the action;
	if tpfs is 5:
		say "Running as fast as you can you search around with fervent determination to find the two lizards you come across several times before. Not exactly knowing where they would be at the moment, considering the severity of whatever's probably taking place between them, something you're still somewhat unsure about, you find yourself moving to the most likely of places where someone would want to be alone at a time like this. The sounds of shouting and struggling catch onto the edge of your field of hearing and darting around the corner of an empty building you find yourself just in time to see Greg and Dan going at it. From the looks of things the bigger raptor seems to be getting tired, but the iguana isn't pressing into the advantage he has in front of him.[line break]";
		say "'Why don't you just take it?' Greg says while holding something in one of his hands. 'You said you don't want to be a freak anymore, right?' The raptor seems to be trying to push the thing he got from the blonde off on the iguana, but at the desperate shake of the uniformed reptile's head it would see that Dan doesn't want it. Wait...did he just say... 'It's because...because I don't want to!' While not the most mature answer one could give, the fire behind the four armed male's words are hot enough to brand his determined conviction into your mind.[line break]";
		say "'Danny stop being so damn stubborn and just take this medicine!' Greg said while hissing and growling at the other lizard. 'No. I rather be like [']this['] then go back to being the old me.' The iguana points two of his arms down at himself. 'At least this way I can actually be useful to you...not like how I was before.' Greg seems to take a pause as he lowers his head to think over this. 'But...you'll never be anything more than what you are now if or when we get out of here. You're always going to be a four armed freak of nature like I'm going to be a mutt of a lizard if you stay that way. You really want to go through all that?' Greg lifts his head to stare pointedly at his partner.[line break]";
	...
	if tpfs is 6:
		...
		say "Nodding to the trench coat wearing raptor you get the specifics of the loft's whereabouts and then wave to the others as they go off on about their way. Watching the strange twosome go off on their way with their long reptilian tails wrapped comfortably around one another you realize that it won't be long before the two are off rutting somewhere, especially if the two hands straying down to the bottom of Greg's ass are anything to go by. Maybe it would be a good idea to see the two scalies sooner rather later for some [']recreational['] stress relief?[line break]";
		increase score by 20;
...
instead of resolving a Ouroboros:
	...
	otherwise if mdl is 2:
		...
		if player consents:
			...
			if lost is 0:
				say "Pushing the defeated, and coincidently enough, sleeping, wolverine out of the way you walk up to the glass case and then remove the heavy barrier off and away from your well deserved prize. Grabbing the medallion you turn the bronze artifact over into your hands while wondering why Omio needs such an old looking thing. There's no way that this thing could be an energy conduit, could it? And a better question, why didn't Omio just teleport the thing seeing as how she already knew where it was?[line break]"; 
				if perception of player > 15 and intelligence of player > 15:
					say "A faint memory from some other time and place reminds you that ancient people once used items like these in alchemic experiments or to represent concepts of eternity and equilibrium. Maybe Omio is going to turn some of the material she has back at her studio into gold? Then again, knowing the red head, she'd probably come up with something more conventional like[one of] a previously unheard-of fuel[or]a new fabric[or]a medical reagent[at random] in an effort to help others more than just herself. A chuckle worms its way from your throat at that thought.[line break]"; 
		...
		otherwise:
			...
			if the bodyname of player is "Wolverine Guard" and the facename of player is "Wolverine Guard":
				say "Telling the other that you've come to take over active duty you watch as the wolverine gives you a strong nod before tiredly walking his way down the hall towards, what you can only assume is, a rest area. Taking several seconds to watch to make sure that the burly guardsman is going off and not coming back, you sigh in relief when the last you see of the other is a tightly clad brown furred rump disappearing into an open doorway. When said door quietly shuts you turn your rugged face over to look at the glass case futilely protecting the artifact you've come to [']liberate['].[line break]";
				say "Picking up the case and then gently setting it down you grab at the medallion and then turn it over into your hands to have a better look at it. Taking a moment to speculate on why Omio would need such a thing, as it doesn't look anything like what you'd expect a researcher of her caliber to be interested in, you try and think up why the red head would send you after such an old babble. And a better question, why didn't Omio just teleport the thing seeing as she knew where it was?[line break]";
				if perception of player > 15 and intelligence of player > 15:
...
Instead of resolving a Special Delivery:
	...
	otherwise:
		...
		if diceroll is greater than 14:
			...
			say "'It's not about whatcha want,' The red eyed hydra says quietly. Both of its mouths speak at the same time which, extraordinarily enough, give the hydra a somewhat echoing tenor to his words. 'it's about what the other person wants and how they plan to go about getting it. Your job, my little friend, is to know how to deal with the outcome of the situation if words can't dissuade a conflict from becoming paramount.'[line break]";
			say "Cocking your head in bewilderment you try and ask the sea serpent what in the hell he's talking about. 'Never mind. If you don't get it, then you don't need such wisdom right now.' The red eyed hydra chuckles before holding out one of his long clawed hands at you. 'Anyway, do you have my package?' You nod and then fish out the case Omio had given to you and then set it down onto the floor between you and the other man. You find the scalie chuckling some more when you scoot it over to him, by means of a tentative kick to the back of the case.[line break]";
			say "'Smart of you not to trust a man you've just fought against. I think you'll do just fine,' And with that the twin headed hydra steps over to pick up his case, turns it over as if to survey the container and then goes off about his way below the deck of the ships, but before he is gone completely you hear a voice call out to you. [bold type]'Oh and one more thing, make sure to go back to the lass and tell her that you delivered me package.'[roman type] And then the other man is gone. You look on where the other went for several seconds before shaking your head and then going off about your way.[line break]";
		...
		otherwise:
			...
			say "'If you can keep up that attitude then you'll go far.' The scalie kneels to picks up the case and then gives to parcel a few test rattles before nodding. [bold type]'Make sure to go back to the lass and tell her that you delivered me package.'[roman type] Sending one final look your way the hydra quickly turns on his heel and then disappears down into the lower deck of the ship. Throwing the rag the other had given you away off to the side you look up at the [if daytimer is day]sky[otherwise]moon [end if] and then silently wonder.[line break]";
			delete undisclosed case;
			decrease libido of player by 4;
			if libido of player < 0, now libido of player is 0;
			increase score by 3;
