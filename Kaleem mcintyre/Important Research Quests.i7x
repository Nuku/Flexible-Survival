...
Instead of resolving a Friendship's Proof:
	...
	otherwise if tpfs is 2:
		...
		if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
		if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more']
		say "Not having much choice you find yourself nodding without having to think too hard over the situation. 'Good. Now then, are you following those two lizards I twice caught you standing in front of?' (Y=yes, N=No)[line break]";
		if player consents:
