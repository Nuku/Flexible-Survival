...
Instead of resolving Important Treasure say:
	if opcl is 0:
	...
	if opcl is 1:
		...
		say "Going over to the other you open your mouth to speak, but soon clamp your muzzle shut when the woman quickly cloaks her hood over her face and then takes off like a shot in the opposite direction you had just come from. Not understanding what just happened you reach up to scratch your head in confusion. That is, right up until you hear someone calling out behind you. 'Hey you over!' Turning around you find yourself jumping back in bewilderment as the scaly face of a four armed green and black mottled iguana wearing a police officer's uniform marches directly up to you. 'What are you doing out here? Are you friends with that woman? Do you know where she's going? Hey, I'm talking to you here!'[line break]";
		...
		otherwise:
			...
			say "'So what do we do about him, then?' The four armed iguana asks while hiking a thumb at you. The older raptor looks at his partner, then at you, and then shrugs. 'Not much we can do. This model citizen was just going about his way doing a favor for someone. What can we do with? Book him for doing a friend a favor? That'd look nice on a report, which I assure you, I'd make you write up.' The iguana blanches at that and then seems to all but deflate. A chuckle from his partner has you turning your head between the two men to regard them curiously.[line break]";
...
Instead of resolving a Friendship's Proof:
	...
	if tpfs is 2;
		...
		say "'Next question, did anyone send you down here to look for a man name Greg?' shaking your head in the negative you find the tail wrapped around you uncoiling itself just a little more.[line break]";
			...
			otherwise: 
				say "You shake your head no. 'Alright,' A little pressure relieves itself from around your neck allowing you some extra added air. 'Next question, did anyone send you down here to look for a man name Greg?'[line break]";
	...
	if tpfs is 3:
		...
		increase score by 3;
	if tpfs is 4:
		say "Coming across the familiar orange and yellow raptor from before you find yourself nodding to the other in quiet deference. The raptor does nothing in return, save for flick his long and thin tongue out in your direction. Thinking that it's time to move on you prepare to take a step away from the other when the sudden intense scent of fresh blood slips its way across your nose. Snapping your head around to look over the raptor your eyes wander up and down the trench coat wearing lizard until you find large spots of sticky red stains covering at the ends of the reptile's trench coat.[line break]"; 
		say "From what you can see the other doesn't appear to be hurt anywhere, so then where did the blood come from? A dark chuckle makes you shiver as your eyes lift up to focus on the[if daytimer is day]unseen orbs of the raptor hidden behind his shades[or]golden-green slit orbs of the raptor[end if] as a almost maniacal smile parts the reptile's lips.[line break]";
	...
	otherwise if omq is 8:
		...
		if player consents:
			...
			if lost is 0:
				...
				if perception of player > 15 and if intelligence of player > 15:
		...
		otherwise:
			...
			if the bodyname of player is "Wolverine Guard" and if the facename of player is "Wolverine Guard":
...
Instead of resolving a Special Delivery:
	...
	otherwise:
		...
		if diceroll is greater than 14:
			...
			delete undisclosed case from invent of player;
