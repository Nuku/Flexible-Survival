...
Instead of resolving Important Treasure:
	if opcl is 0:
		...
		say "Searching around the red light district you stumble across a beautiful blonde woman standing roughly five and a half feet tall who fits the description Omio had given to you almost to a [']T[']. With an over-sized white coat draped over her slim body, a stitched up scar cutting a path over the front of her nose, and black pair of jeans on the woman should have stuck like a sore thumb in the middle of the city's more ill repute area. And yet, for some reason or another, the blonde seems to possess an all-encompassing autonomy about herself that make her almost invisible to naked eye.";
		WaitLineBreak;
...
Instead of resolving a Special Delivery:
	if undisclosed case is not owned:
		...
		if diceroll > 14:
			...
			say "Being that Omio was the one who set this whole thing up you find yourself not too bothered by the weirdness of one of the redhead's [']friend[']. After all, who wouldn't be crazy after ten minutes of knowing her? But then, what does that say about you?[line break]";
			increase score by 2;
		else:
