...
instead of conversing the Homaru:
	if Homarutalk is 0:
		...
		Otherwise:
			...
			say "Asking Homaru exactly where [']there['] is you watch as the information collector squirms about in his seat and then blushes before chuckling offhandedly as he answers you. 'Oh, sorry, there is a gloomy looking warehouse down at the warehouse district. If you go there and knock three times and then say you're there for the [bold type]DogHouse[roman type] special and the guard will let you in. How you go about rescuing the firefighter, well, you're on your own on that one, but I'll give you some information on how to go about it if you like?'(Y=yes, N=No)[line break]";
			if player consents:
...
Carry out Homarusearching:
	...
	Otherwise if Homarusearch is 5:
		Say "[findfirefighter5]";
	Otherwise if Homarusearch is 6:
