...
to say ResolveEvent Informant:
	if smf is 0:
		...
		say "     Crossing through the streets of the high rise district, you come across the sight of a black clad figure surrounded by two burly looking mutants. Both mutants seem to be somewhat eager to get at the unknown figure and upon seeing one of them aiming their cock at the person, you decide that maybe it's time to do your good deed for the day. Shouting to draw the mutants' attention, you rush them before they have time to react.";
		challenge "Smooth Collie Shemale";
		challenge "Leopardman";
		say "     After taking care of those miscreants, you find the black clad figure stepping out from behind an overturned dumpster with slow and nervous movements. 'Jeez, I know things are getting bad, but come on. Really?' The other person sighs before pulling their hoodie down from off their head. A shock of chestnut-colored hair fluffs out from the other's head and upon seeing this, you can't help but chuckle. The other person, who proves to be a man by both looks as well as voice, looks like a rooster with part of his hair sticking up in a spiky sort of way. When the other turns to face you, the first thing you notice are the Prussian blue eyes staring at you gratefully.";
		say "     'Hey man, thanks a lot for the assist. I think I'd be even more of a mutant than I already am if you hadn't come to my rescue.' Looking at the captivatingly human face of the other man, you silently begin to wonder just what part of the black coat-wearing individual has been mutated. 'Trust me, you don't want to know.' The long suffering sigh tells you that you probably don't want to pry. 'Anyway, if you need my help just ask, I happen to be something of an information dealer here in the city. My name's Homaru by the way, and I live over behind the deli just around the block.' The chestnut-haired man hikes a thumb over his shoulder.";
		WaitLineBreak;
...
Cunt Depth of Homaru is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
instead of conversing the Homaru:
	if Homarutalk is 0:
		if MaleList is banned or FurryList is banned or FemaleList is banned:
			...
			WaitLineBreak;
			say "     'Well, uhm, let's just say that there is a place down at the Warehouse district where some of the, shall we say, less [']upstanding['] members of society have gathered to host full on sex shows with [']regular['] people and some of the [']furries['] there are outside.' At this, you can actually hear part of your brain explode. 'Trust me on this - there are strange people out there who would pay to see such a thing. And if you are going to ask why... even I don't have enough information to understand that. All I can say that your missing firefighter is probably there.'";
			say "     Asking Homaru exactly where [']there['] is, you watch as the information collector squirms about in his seat and then blushes before chuckling offhandedly as he answers you. 'Oh, sorry, there is a gloomy looking warehouse down at the warehouse district. If you go there and knock three times and then say you're there for the [bold type]DogHouse[roman type] special, the guard should let you in.'";
			say "[line break]     [bold type]'How you go about rescuing the firefighter, well, you're on your own on that one, but I'll give you some information on how to go about it if you like?'[roman type][line break]";
			say "     ([link]Y[as]y[end link]) - Yes.";
			say "     ([link]N[as]n[end link]) - No.";
			if Player consents:
				LineBreak;
				say "     'Alright. Once you get into the place, you'll be shown to a viewer's area to watch the live sex shows. Now it's during this time that you'll need to sneak away and then head downstairs to where they keep both the mutants and [']people['] locked up. From what I have gathered so far from my contacts around the city, the man you are looking for - Birch, if I remember correctly - he's one of the few that haven't changed completely. I'm not sure exactly why, but because of this, he has become something of a celebrity there. If I remember correctly, Birch has dark brown hair, a strong jaw line and almond brown eyes,' Homaru says while placing his hand onto his head and tapping a finger against his brow.";
				say "     'You may be able to sneak him out if you've got the skills for that clandestine sort of espionage, or you can just fight the guards there and bust him out. Whichever you decide to do, if you go, go well prepared because getting caught might find you in a cage along with the others, and trust me on this, [italic type] you don't want that[roman type].' Homaru's words are dire enough that you actually shiver some from the intensity he puts behind them. Asking Homaru why he hasn't done a thing about this illicit sex ring if he's already known about it, the spiky brown-haired informant simply shrugs his shoulders at you.";
				WaitLineBreak;
				say "     'I'm an information dealer. I collect intelligence from certain places and then make a profit off of it. I'm not in the business of helping people out who I have no use for or ties to.' Homaru gives you a somewhat bored look after saying that. 'Anyway, you can go anytime you want to, but I would suggest that you do so soon, because if the military rolls in then Birch and the rest of the imprisoned [italic type]people[roman type] there might get shipped away before you can help the firefighter.'";
				say "     At this point, it would probably be best for you to hurry on about your way, but you hold up when Homaru calls out your name to get your attention. 'You know, if you're going to actually go and do this, then I could help you out by slowing down the military for you.' Asking the other man what he's talking about, you find Homaru smiling at you somewhat mischievously.";
				WaitLineBreak;
				say "     'I can [bold type]delay[roman type] the military by spreading some false information out to them. However, these are some serious people we're talking about here, at least as far as things go when it comes to information and handing down orders. If you can trust me to help, I'll do what I can to get you some extra time for your little adventure. However,' the spiky-headed informant says, looking at you a little nervously before continuing, 'I'm still a man after all, so I can make mistakes.'";
				say "     Homaru doesn't say anything else as he sits back down to look at you somewhat helplessly. You get the feeling that the information dealer is trying to be helpful, but at the same time he just seems so... You shake your head and then tell Homaru that you will think about it. At that, the other man nods to you.";
			else:
				LineBreak;
				say "     'You know, if you're going to actually go and do this, then I could help you out by slowing down the military for you.' Asking the other man what he's talking about, you find Homaru smiling at you somewhat mischievously.";
				say "     'I can [bold type]delay[roman type] the military by spreading some false information out to them. However, these are some serious people we're talking about here, at least as far as things go when it comes to information and handing down orders. If you can trust me to help, I'll do what I can to get you some extra time for your little adventure. However,' the spiky headed informant says, looking a little nervous before continuing, 'I'm still a man after all, so I can make mistakes.'";
				say "     Homaru doesn't say anything else as he sits back down to look at you somewhat helplessly. You get the feeling that the information dealer is trying to be helpful, but at the same time he just seems so... You shake your head and then tell Homaru that you will think about it. At that, the other man nods to you.";
		...
		say "     [if homarusearch < 6 and a random chance of 2 in 5 succeeds]'When you're ready for more information on the firefighters, just ask and I'll do what I can to help you [bold type]find firefighters[roman type].'[else][one of]'Hey, welcome back.'[or]'I hope things are going well for you.'[or]'Have any new information I can play with?'[or]Homaru is busy eating a sandwich and simply nods to you.[or]'I wish someone strong and daring would figure out a way to infiltrate the military ranks and gather some intel for me.' Homaru looks to you while saying this.[or]'Have you seen a blonde in a white coat running around here lately?'[or]'That blonde woman... just who is she?'[or]Homaru is nibbling on a pen cap while going through something on his computer.[or]'I hope you manage to keep yourself from falling victim to the virus running around. It'd be a shame to lose a contact such as you.'[or]Homaru is working on a crossword puzzle.[or]'Where in the world is Carmen Sandiego when I need a good thief/spy?'[or]'Maybe I should think about retiring and settling down with a big Labr...' Homaru shakes his head while shuffling around uncomfortably in his seat.[or]'I can't offer much, but you can spend some time here if you'd like.'[or]'Please don't bother the turtles, they're kind of shy.'[or]'Man, what I wouldn't give for a nice thick d...' Homaru shakes his head and then blushes somewhat awkwardly.[or]'What I wouldn't give to have some chocolate milk right about now,' Homaru sighs wistfully.[or]'It'd be nice if I had a nice dil... uhm, Dill Pickle right about now! Yeah!' Homaru chuckles nervously at you.[at random][end if]";
...
carry out delaymilitary:
	...
	if a random number between 1 and 7 is:
		...
		-- 5:
			...
			extend game by 4;
		-- 6:
			say "     'I think I better learn to quit while I'm ahead,' Homaru says while nursing his head in between his hands. 'One of the guys I tried to bargain with roughed me up a little before tossing me out on my head. I think they are going to be more cautious about me from now on. Oh, and they sped up their evacuation time a little.' Homaru says the last a bit off handedly.";
			extend game by -4;
		-- 7:
...
understand "search for the/-- firefighters/firemen" as Homarusearching.
understand "locate the/-- firefighters/firemen" as Homarusearching.
understand "find the/-- firefighters/firemen" as Homarusearching.
