...
Instead of resolving a Informant:
	...
	if smf is 1:
		...
		WaitLineBreak;
		say "     Stopping the other man before he can turn to run off you ask Homaru if he knows anything about the firemen from station 86. 'Why would you ask me about them?' Homaru seems honestly curious and so you explain to him the situation with Kenaz. 'Ahhh, okay. Well I thought that I had heard a rumor like that. Heh, nice to know that even shady information can sometimes even be trusted. The laughter that comes from the other man makes your [skin of player] crawl as you feel something foreboding about the outburst.";
		say "     'Sorry about that. Anyway, if you'll come with me to my shop underneath the Bakery then I'll be happy to trade some information with you.' Not seeing anything else you can do at the moment, you nod to your new cohort and then begin to follow him back to his abode.";
