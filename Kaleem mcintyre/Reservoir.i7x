...
Instead of Resolving ThreeDoors:
	If resevquest is 4:
		...
		say "However, you have to pick one to move forward. But which one? Trying to recall your memories of the Technical manual you glanced through before coming up this way you find yourself coming to a blank as to which path to take. That being the case, and knowing that  its down you know that you can't you really can't go back and ask one of the creatures here for help, well not and expect to get a useful answer anyway, you have something of a dilemma on your hands.";
		say "[doorcheck]";
...
It has a weapon "[one of]frozen blades of cold[or]whispering twins of water and ice[or]thin, but sharp blades[at random]". The weapon damage of icicle knives is 16. The weapon type of icicle knives is "Melee". It is not temporary. 
