...
to say ResolveEvent Cosplay:
	say "     'No, I am not going to wear either that jacket or that tacky red scarf. So just forget about it!' You find yourself stopping as these words enter into your ears just as you pass an open store front. Peeking inside you find a large gray wolf standing on the balls of his hind feet offering up something in the way of clothing to a smaller orange and white fox. 'Come on already. It's just for today,' the wolf growls. By the tone of the other's voice you can tell the wolf is male, the same as his foxy companion. 'And besides, you'd look kinda cute with this on!' The wolf's tail is wagging a mile a minute as he rumbles a murr out from his throat while looking at the sexy looking vulpine.";
...
to say ResolveEvent Fantasy:
	say "     When a large red wolf runs past you on all fours with a blue furred feline that's carrying a spear across its shoulder right on its tail, you can almost swear that you've seen those two somewhere before. Not really sure where you simply shrug before going about your way. That is, right before you end up coming across a massive beast of a collie standing at about twelve feet in height. The horny shemale growls happily as it looks to you and suddenly you realize what the other pair was running away from.";
...
to say ResolveEvent Dr Feel Good:
	...
	if Player consents:
		...
		if fightoutcome >= 20:		[lose/run]
			...
			WaitLineBreak;
			say "     When next you wake up, you find yourself lying on the bed the fennec boy had been on, the other being nowhere in sight, with some confusion as to what's going on. Slowly the memories return to you and you grunt in vexation before trying to rise up off of the stiff mattress underneath your [BodySpeciesName of Player in lower case] back. When you find that all of your motor functions are a little out of whack a slight bit of panic crosses your mind, but soon your body's natural healing factor is kicking into gear to get everything back into order.";
			if Player is not FemalePreferred or (Player is male and "Modest Organs" is not listed in feats of Player):
				say "     Once you are up and about, you look over yourself to see if everything is as it should be before giving yourself a few test pats. Seeing that both your arms and legs are just as they had been before your little clash with the vixens you find yourself calling everything to an immediate halt when you rub your palm over your groin. Blinking as you feel that something is not as it should be you undo your pants and then have a look down. What you see makes your mouth slowly drop open as you look to find that [if Player is not male]you now have a cock dangling between your legs[else]your cock has gotten a little bigger[end if].";
				WaitLineBreak;
