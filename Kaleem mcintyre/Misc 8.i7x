...
to say ResolveEvent Old Tale:
	say "     As you walk through the high-rise district, you come across an unusual pair. A bulky feral wolf with unruly black fur and a cross-shaped scar marring its chest sits, scratching at its left ear with one of its rear paws. Prancing around it with a happy-go-lucky expression on its face, a smaller wolf with fur the color of autumn leaves and a bracelet wound around one of its legs bows as if begging to play. The smaller creature's happiness seems infectious. Before long, the rough-looking wolf's expression matches his, his tail sweeping the sidewalk and his muzzle wrinkling as he shakes himself, planting a long lick over his companion's face and playfully nipping at his companion's muzzle.";
	say "     Pressing his nose against the gnarled wolf's with a yapping bark, the lighter wolf wiggles his rear, turning to present his rump to his stoic companion and letting out a low whine as the darker wolf's nose nuzzles under his tail, followed by an indulgent lick. As you watch, the larger wolf stands, his wolfhood peeking from its sheath as he awkwardly positions himself, then surges forward with a pleased huff once he finds his mark. A bulge appears in the smaller wolf's fluffy stomach, rhythmically expanding with each movement of its companion's hips. You swear, from the size of that bulge, their mating would be ruining the smaller wolf's insides if not for the nanites' influence.";
