...
Instead of resolving a Peace:
	say "Jogging across the plains you come across a large bipedal blue and white furred wolf meditating in the middle of a orangish-yellow patch of grass. From the look of the other, with his imposing physique, strong jawline, rich azure and ivory furry and yellow belt strapped around his waist, the strange wolf seems to be oddly out of place given the normal mutants that roam the plains. Not that there was anything wrong with being odd, especially given the fact that this [']is['] a crossed legged blue and white lupine you're seeing after all.";
...
Instead of resolving a Fantasy:
	say "When a large red wolf runs pass you on all fours with a blue furred feline, carrying a spear across its shoulder, right on its trail you can almost swear that you've seen those two somewhere before. Not really sure where you simply shrug before going about your way. That is, right before you end up coming across a massive beast of a collie standing at about twelve feet in height. The horny shemale growls happily as it looks to you and suddenly you realize what the other pair was running away from.";
...
Instead of resolving a Controversy:
	...
	say "As the weasel hands off the joint he's puffin' on to the black bear you find your head nodding in time to the music that's playing on the bulky looking jam machine. The rhythm of the music is an 80's remix and for some reason you find yourself really getting into it. 'Yo little homie, what's up?' The weasel asks all of a sudden and you can only shake your head at him. 'S'ok. Wanna hit this one time?' Looking at the roach the bear is taking a hit of you wonder if you should. (Y=Hit it, N=Nah)";
	if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
	if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more'] 
	if player consents:
...
Instead of resolving a Dr Feel Good:
	...
	if the player consents:
		...
		Say "'Well nosey, this one came in here not too long ago looking for someone. After politely telling him that the person he was searching for wasn't here anymore he started to raise a fuss, so we had one of the orderlies place him into this room until a doctor could come by to speak to him. Since all of the doctors are busy at the moment we two were sent here to handle this situation.' The nurse not holding the needle replies and you look to the fennec to try and get his side of the story. When the young one looks up at you and then drops his head into his knees you can see that what the vixen had to tell you was the truth.";
		if waiterhater is 0, wait for any key; [skips waiting if it's not wanted]
		if waiterhater is 0 and hypernull is 0, say "[line break]";	[adds a break after the 'more'] 
		...
		if fightoutcome >= 20:		[lose/run]
			...
			if cocks of player is 0:
				...
				now the cock length of player is 3;
				now the cock width of player is 2;
			otherwise:
				increase the cock length of player by 1;
