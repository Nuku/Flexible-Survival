...
use MAX_SYMBOLS of 160000. [increase if "Translating the Source - Failed " and "Compiler finished with code 10" error occurs.]
...
when play begins:
	...
	add { "Drone Wasp", "Goo Girl", "Female Husky", "lizard girl", "Tentacle Horror", "Feline", "Bear", "Skunk", "spidergirl", "Mothgirl", "red kangaroo", "city sprite", "feral sea dragoness", "Bovine", "Wyvern" } to infections of girl;
