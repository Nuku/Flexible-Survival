...
to say boldNestExploration:
	...
	if (a random chance of 3 in chancemodifier succeeds):
		...
		say "     Almost miraculously, nothing blocks your path, or manages to catch up with you, and you barge into the building's staircase unimpended. The nest has not expanded to the upper floors yet, so you allow yourself to relax, and make your way to the last floor.";
		xenoNestWin;
...
to say nestXenoFight:
	...
	if fightoutcome >= 20 and fightoutcome <= 29:
		...
		say "     Your opponent deated, you allow yourself a moment to relax, and let the tension die down. Afterwards, you resume your exploration. You eventually find the door leading to the upperfloor, and leave this strange place.";
		xenoNestWin;
...
to xenoNestBoundState:
	...
	while Trixieexit is 0:
		...
		if humanity of player < 1: [Lost all sanity. Instant game over.]
			...
			end the story saying "Kept prisoner in the xeno nest, you are contantly milked of your sexual fluids, while welcoming new eggs in your body and birthing new creatures. You feel, rather than see, new people being added one-by-one to the nursery, and the nest slowly grows, ready to propagate its strain of mutation throughout the rest of the world.";
			now Trixieexit is 1;
			...
			if keychar in lower case exactly matches the text "s" or keychar in lower case exactly matches the text "1" or keychar in lower case exactly matches the text "return" or keychar in lower case matches the text "struggle": [player picked struggle]
				...
				LineBreak;
				say "     [one of]You grind your hips as much as your encased state allows you, and let the drones work your [body size of player] body, a debilitated smile on your face[or]You bite your lower lip as you hump the drones molesting your body, trying to get closer to your climax[at random].";
				now obliging is true;
...
to xenoNestBoundOrgasm: [Orgasm description. Progresses to next bound segment.]
	say "     You feel a powerful orgasm coming, thanks to relentless efforts of the alien devices, and bulges begin to travel up and down the organic tubes linked to your body, while you exchange fluids and eggs with the nest.[if player is male] Your [cock of player] cock[smn] release[smv] a [cum load size of player] load. To your greatest frustration, it is instantly sucked in by the sond in your urethra, denying any satisfaction on this side.[end if][if breast size of player > 0] The product of the relentless milking of your [short breast size desc of player] is siphoned by your living prison.[end if][if player is female] You puss[yfn] quiver[sfv] violently as the drone pistonning inside you collects every drop of fem-cum [ittheyf] produce. The additional lube helps spheric eggs make their way into your womb, stretching your [cunt size desc of player] cunt[sfn] along the way.[end if][if wslevel is not 3 and player is not male] Even your piss is absorbed through the tendril resting in your urethra, as the climax makes you lose control of your bladder.[end if][if anallevel is not 3] Eggs transit through the organ buried into your ass, each round solid object stretching your sphincter as they slide through in direction of your stomach[end if]. The mask feeds you a bitter sludge through the tentacle buried in your throat, in order to keep you fed and awake through your ordeal.";
...
to say xenoNestBoundDesc: [Displays at the top of the bound screen after every action. Modified by current bound stage.]
	say "     You are solidly encased in one of the flesh walls of the alien nest. Organic material covers your arms and your legs, and you are only able to flex your body, as a number of drone-like creatures are attached to your body, each of them linked to the main structure with thick tubes.[if player is male] An octopus-shaped creature is wrapped around your groin, sucking a massaging your [cock of player] cock[smn], and tugging and squeezing your [ball size], while a straw-like prode is buried in your cock-slit[smn], awaiting to drink your cum[end if] Another, crab-like drone is wrapped around your crotch. [if player is female]It is busy pistonning thick tentacle-shaped organs inside each of your lower orifices, while its tiny mouth sucks and plays with your clit.[else if anallevel is not 3]It is busy pistonning a thick tentacle-shaped organ inside your ass, drilling all the way up to your stomach then back.[end if][if player is female and wslevel is not 3]There is even a small tendril wiggling and twisting inside your urethra.[end if][if breast size of player > 0]Your breasts are trapped under a fleshy breast-plate, which constantly squeezes warm milk into ever-growing, individual reservoirs.[end if] A organic mask blocks your lower face. A thick tentacle extends from it, invading your throat and straining your jaw, air given to you through small slits at nose level.";
	if lustatt < 75:
