...
instead of going south from Milking Facility Operations Room while milkingFactoryPlayerTrap is 1:
	...
	if player is herm:
		say "     As if to confirm your dreadful suspicion, you feel something fix itself on your groin. You look down and see [cocks of player] metallic milker[smn] attached to your cock[smn]. [ittheym] start[smv] pumping air in-and-out, and [itstheirm] inner rubber sheath[esmn] vacuum[smv] against your length[smn]. At the same time, you feel your [cunts of player] cunt[sfn] spread apart by what feels like bull-shaped dildo[sfn]. [ittheyf] start[sfv] jackhammering your puss[yfn], keeping you busy[if breasts of player > 0 and breast size of player > 0]. With a loud [italic type]schlop[roman type], rubber cups attach themselves to your breasts and quickly vacuum, espousing your forms before going to work on you with an insistent [italic type]puff-pfff[roman type] noise[end if].";
	else if player is male:
		say "     As if to confirm your dreadful suspicion, you feel something fix itself on your groin. You look down and see [cocks of player] metallic milker[smn] attached to your cock[smn]. [ittheym] start[smv] pumping air in-and-out, and [itstheirm] inner rubber sheath[esmn] vacuum[smv] against your length[smn][if breasts of player > 0 and breast size of player > 0]. With a loud [italic type]schlop[roman type], rubber cups attach themselves to your breasts and quickly vacuum, espousing your forms before going to work on you with an insistent [italic type]puff-pfff[roman type] noise[end if].";
	else if player is female:
		say "     As if to confirm your dreadful suspicion, you feel something fix itself on your crotch. You feel your [cunts of player] cunt[sfn] spread apart by what feels like bull-shaped dildo[sfn]. [ittheyf] start[sfv] jackhammering your puss[yfn], keeping you busy[if breasts of player > 0 and breast size of player > 0]. With a loud [italic type]schlop[roman type], rubber cups attach themselves to your breasts and quickly vacuum, espousing your forms before going to work on you with an insistent [italic type]puff-pfff[roman type] noise[end if].";
	else if breasts of player > 0 and breast size of player > 0:
...
to milkingCowSuitProgress: [Displays once when entering the next bound segment. 1 does not need to be checked since the bind starts at that value.]
	if milkingCowSuitBindStage is 1:
		...
		if player is herm:
			say "     With perfect timing, the various apparatus return to work on your body. And thus, you have a perfect angle on the milking pump[smn] sliding up and down your [cock size desc of player] cock[smn] and the thick, ox-shaped dildo[sfn] ramming your [cunt size desc of player] cunt[sfn][if breasts of player > 0 and breast size of player > 0], and the milking cups pressing on your breasts in order to extract their contents[end if].";
		else if player is female:
			say "     With perfect timing, the various apparatus return to work on your body. And thus, you have a perfect angle on the thick, ox-shaped dildo[sfn] ramming your [cunt size desc of player] cunt[sfn][if breasts of player > 0 and breast size of player > 0], and the milking cups pressing on your breasts in order to extract their contents[end if].";
		else if player is male:
			say "     With perfect timing, the various apparatus return to work on your body. And thus, you have a perfect angle on the milking pump[smn] sliding up and down your [cock size desc of player] cock[smn][if breasts of player > 0 and breast size of player > 0], and the milking cups pressing on your breasts in order to extract their contents[end if].";
...
to say milkingCowSuitBindDesc: [Displays at the top of the bound screen after every action. Modified by current bound stage.]
	if milkingCowSuitBindStage is 1:
		say "     You are down on your knees, trapped inside a black mass which threatens to engulf you[if player is male]. A milker is hooked to your cock[smn] and pumps slowly. It slurps down a bit of pre-cum here and then, as MOO tries to find the optimal rhythm for your physiology[end if][if player is female]. The fluid matter has formed an almost perfect reproduction of a bull cock, adapted to the size of your [cunt size desc of player] cunt[sfn]. It pushes, inch by inch in your puss[yfn] in an attempt to find your g-spot[sfn][end if][if breasts of player > 0 and breast size of player > 0]. Milking cups are hooked on each of your [breasts of player] breasts and stimulate them in an attempt to draw out milk[end if]. [one of]You turn your head just in time, as the muzzle part of the vinyl slime tried to fit on your [facename of player] head. You push it back with some difficulty.[or]The mass of vinyl tries to stick your hands to the floor. You pull them away just in time, in a brief tug-of-war with the animated goop[or]The vinyl slowly creeps up your neck, trying to find the mask part in order to fuse with it.[purely at random]";
