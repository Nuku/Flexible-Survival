...
Instead of using the rubber sneakers:
	if the rubber sneakers are equipped:
		if Doctor Matt is visible:
			...
			say "     'As much as I would like to help you remove these disgraceful things from your feet, I am a [italic type]psychologist[roman type], not a physician,' Moffatt replies. 'Sorry.'";
			...
			say "       You reach down to your shoes and attempt to remove them. An intense burning sensation makes you stop right away, and repeats with every new try. You realize that you are in trouble, and will need help in order to remove these shoes. [bold type]You need to go to a medical doctor, or a person knowledgeable in this kind of items, and try to remove these rubber sneakers with them around[roman type].";
	else:
