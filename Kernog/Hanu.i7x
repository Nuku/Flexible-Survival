...
Instead of resolving Monkey Duel:
	say "    'About time you showed up[if player is not defaultnamed], [name of player][end if].' a familiar voice calls you out as you pass under a large tree. Hanu, the monkey with whom you meditated with earlier, is sitting leisurly on one of the branches, his long tail waving at you. With surprising agility, Hanu jumps down from his perch and makes a perfect landing just in front of you. 'You seem to have an habit of being late for training, my pupil. But no matter, let us practice our kung fu together.'";
	...
	if player consents:
		LineBreak;
		say "     'The Monkey King? At the Museum?' Hanu remains silent a short moment, before smiling softly. 'What an interesting story you have, my dear pupil. And worrying too.' He puts a hand to his chin, pensive. 'This [']Wukong['] person seems quite the brash ruffian, and violent too. He is completely mis-using his natural talents[if acquaintedWithWukong is 3]. And to top it off, it seems that he encouraged you to follow his ways[else]. And to top it off, it seems that you had to take responsability for his actions instead of me[end if]. You did good to bring the existence of this person to my attention.'";
		say "     'I need to take responsability as well, and bring him to reason. It is time for me to go on a journey to the Museum. [bold type]Will you accompany me?[roman type]'[line break]";
		LineBreak;
		say "     ([link]Y[as]y[end link]) - Yes.";
		say "     ([link]N[as]n[end link]) - No.";
		if player consents:
			...
			if player consents:
				...
				say "'Nnn... Gh. I, I-aaargh!' Another electric discharge makes Hanu writhe on the ground. As he falls on his back, you and Wukong notice something quite embarassing.";
	...
	if player is dominant:
		...
		while sextablerun is 0:
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				say "     Refraining on your pulsions, you let the monkeys help each other up and limper away.";
				now sextablerun is 1;
			else:
				say "Invalid Option. Pick between 0 and [the number of filled rows in the table of fucking options].";
	else:
		say "     They help each other up, but take great care to put some distance between you and them. Eventually, they all limper away, to your satisfation.";
...
to say beatWukongThugs_useAHole:
	...
	if girl is not warded and girl is not banned and genType is 1: [girl variation]
		say "     You need to blow your frustrations out of your system. Litteraly. You pick up the nearest monkey. A girl, who begins to protest meekly as you pull her by the tail. You sit on a nearby bench, forcing her to kneel in front of you. She tries to protest, but you waste no time shutting her down by pushing her face down on your cock. 'What do you think you're dmmmg! Ggkk!' Before she has a chance to fight back, you warn her that you would not want to harm her pretty face more, so she whimpers, trying to find a comfortable position. But you do not care. She will follow [italic type]your[roman type] rhytmn, not the other way around. You facefuck the female thug, enjoying the messy sounds escaping from her throat as she tries to fit your [cock size desc of player] cock inside her mouth. You leave her no pause[if cocks of player > 1], switching between your cocks once you want her to give more attention to the rest of the package[end if].";
		...
		say "     You need to blow your frustrations out of your system. Litteraly. You pick up the nearest monkey. A boy, who begins to protest meekly as you pull him by the tail. You sit on a nearby bench, forcing him to kneel in front of you. He tries to protest, but you waste no time shutting him down by pushing his face down on your cock. 'What do you think you're dmmmg! Ggkk!' Before he has a chance to fight back, you warn him that you would not want to harm his pretty face more, so he whimpers, trying to find a comfortable position. But you do not care. He will follow [italic type]your[roman type] rhytmn, not the other way around. You facefuck the male thug, enjoying the messy sounds escaping from his throat as he tries to fit your [cock size desc of player] cock inside his mouth. You leave him no pause[if cocks of player > 1], switching between your cocks once you want him to give more attention to the rest of the package[end if].";
		...
		WaitLineBreak;
		say "     Eventually, you get a satisfying orgasm, and pump the monkey girl's womb full of seed. You wonder if he has climaxed too; his half-closed eyes and the ropes of thick white cum dangling from his semi-hard, [one of]small[or]average[or]large[or]over-sized[at random] bobbing cock suggest you he did, but you do not care anyway. You push him off from your lap, letting him fall to the ground, your cum escaping from her [if cock length of player > 8]gaping [end if]hole. The rest of the band lets you go, too intimidated and injured to do something against you, and go to tend on your victim instead.";
	else:
		let genType be a random number between 1 and 3;
		if transgender is not banned and transgender is not warded and gentype < 3:
			if genType is 1: [trans-male]
				say "     You need to blow your frustrations out of your system. Litteraly. You pick up the nearest monkey. He looks like a boy, but is geared like a girl down there. It does not matter. He begins to protest meekly as you pull him by the tail. You sit on a nearby bench, forcing him to kneel in front of you. He tries to protest, but you waste no time shutting him down by pushing his face down on your cock. 'What do you think you're dmmmg! Ggkk!' Before he has a chance to fight back, you warn him that you would not want to harm his pretty face more, so he whimpers, trying to find a comfortable position. But you do not care. He will follow [italic type]your[roman type] rhytmn, not the other way around. You facefuck the trans-male thug, enjoying the messy sounds escaping from his throat as he tries to fit your [cock size desc of player] cock inside his mouth. You leave him no pause[if cocks of player > 1], switching between your cocks once you want him to give more attention to the rest of the package[end if].";
				if cocks of player > 1:
				...
				say "     You need to blow your frustrations out of your system. Litteraly. You pick up the nearest monkey. She looks like a girl, but is geared like a boy down there. It does not matter. She begins to protest meekly as you pull her by the tail. You sit on a nearby bench, forcing her to kneel in front of you. She tries to protest, but you waste no time shutting her down by pushing her face down on your cock. 'What do you think you're dmmmg! Ggkk!' Before she has a chance to fight back, you warn her that you would not want to harm her pretty face more, so she whimpers, trying to find a comfortable position. But you do not care. She will follow [italic type]your[roman type] rhytmn, not the other way around. You facefuck the trans-female thug, enjoying the messy sounds escaping from her throat as he tries to fit your [cock size desc of player] cock inside her mouth. You leave her no pause[if cocks of player > 1], switching between your cocks once you want her to give more attention to the rest of the package[end if].";
			...
			say "     You need to blow your frustrations out of your system. Litteraly. You pick up the nearest monkey, a hermaphrodite, who begins to protest meekly as you pull hir by the tail. You sit on a nearby bench, forcing hir to kneel in front of you. He tries to protest, but you waste no time shutting hir down by pushing hir face down on your cock. 'What do you think you're dmmmg! Ggkk!' Before shi has a chance to fight back, you warn hir that you would not want to harm his pretty face more, so shi whimpers, trying to find a comfortable position. But you do not care. Shi will follow [italic type]your[roman type] rhytmn, not the other way around. You facefuck the herm thug, enjoying the messy sounds escaping from hir throat as shi tries to fit your [cock size desc of player] cock inside hir mouth. You leave hir no pause[if cocks of player > 1], switching between your cocks once you want hir to give more attention to the rest of the package[end if].";
			if cocks of player > 1:
...
to say beatWukongThugs_worship:
	...
	say "     You feel tongues and fingers slip against your [bodyname of player] body. Your arms, your legs, your torso, every place is taken care off. And those monkeys are not half-bad at it. You encourage some of them at exploring every nook and crany, by crossing your arms at the back of your head. As you had predicted, the monkey were slowly emboldened by the situation, and soon you feel too soft noses digging at your armpits, followed by tongues. You sigh in pleasure, especially when the simians start to take interest in your sexy bits. They are hesitant at first, and you do watch what they are doing, but you are soon rewarded by many tongues and fingers exploring under your legs. True to your demand, the fingers simply caress and pinch, but it is more than enough. Everything is tended to, [if player is herm]from the tip of your cock to the base of your shaft and your balls, to your now dripping pussy and clit[else if player is male] from the tip of your cock to the base of your shaft and your balls[else] from your aching clit to the inner side of your labia[end if]. Several of them share each of your [breast size desc] breasts, flicking their tongues over your nipples. You even feel a tongue prode around your anus, but by now you are comfortable enough to let it explore your taint.";
	WaitLineBreak;
	say "     Their gender does not matter. Male, female, in-between, you do not care at all as they do an excellent job. They bring you slowly to a powerful orgasm, yet it is one of the softests you had yet experienced. Instead of a big wave of pleasure crashing into you, it feels like a vase slowly overflowing with intense it. Mouths press to take everything you have to give down there, while you grab the nearest piece of monkey fur you can find and hold it as if your life depended on it. Eventually, your orgasm subsides, and you take your leave from the gang, after having them promise that you would not catch them at doing mischief again. A part of you doubt they will actually listen, and another part actually does not mind.";
...
to say losetoWukongThugs:
	...
	if cunts of player > 0:
		...
		if randomnumber is 1:
			...
			say "     Another monkey takes advantage of the confusion and slams a pair of fingers down your [cunt size desc of player] pussy. Two quickly become three, then four, until the primate eventually manages to slip the fvie fingers insde, and form a fist inside of you.";
		else :
		...
		if cunts of player > 1:
			say "Your other pussies are not forgotten, and get fingered in an almost sadistical manner.";
		WaitLineBreak;
	if cocks of player > 0:
		let randomnumber be a random number between 1 and 2;
		if randomnumber is 1:
	...
	if breast size of player > 0:
		let randomnumber be a random number between 1 and 2;
		if randomnumber is 1:
			say "     Despite the space getting cramped, another simian still finds the place to sit on your tummy, and push your [breast size desc of player] breasts together. You feel his cock slip between them, as the monkey gives himself a leisurly tit-fuck.";
		else:
			say "      Despite the space getting cramped, other simians still find the place to gnaw on your breasts, kneading them and play-bitting your nipples, and enjoying the high-pitched grunts escaping from between the legs of the monkey fucking your face.";
		WaitLineBreak;
