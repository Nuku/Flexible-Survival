...
Body Weight of Hanu is 3. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Hanu is 7. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
[Body Adjective is generated out of the body weight and body definition and can be used in scenes - one word descriptive adjective depending on weight and definition groups: low weight group: skinny/slender/lithe; mid weight group: average/fit/muscled; high weight group: pudgy/husky/jacked]
Androginity of Hanu is 2. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Hanu is 6. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Hanu is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Hanu is 6. [length in inches]
Breast Size of Hanu is 0. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Hanu is 2. [count of nipples]
Asshole Depth of Hanu is 8. [inches deep for anal fucking]
Asshole Tightness of Hanu is 1. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Hanu is 1. [number of cocks]
Cock Girth of Hanu is 3. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Hanu is 8. [Length in Inches]
Ball Count of Hanu is 2. [allowed numbers: 1 (uniball), 2 or 4]
Ball Size of Hanu is 3. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
Cunt Count of Hanu is 0. [number of cunts]
Cunt Depth of Hanu is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
Cunt Tightness of Hanu is 0. [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
Clit Size of Hanu is 0. [size 1-5, very small/small/average/large/very large]
...
TwistedCapacity of Hanu is false. [Twisted Characters can take any penetration, no matter the size]
Sterile of Hanu is true. [steriles can't knock people up]
...
to say hanuDesc:
	if Monkey Duel is unresolved:
		say "     Hanu [one of]stands in the middle of the repurposed Training Hall, performing katas. His graceful moves and calm expression make him look like a ballet dancer[or]is sitting in the middle of the Monkey House, meditating in a succession of poses showcasing the simian's remarkable flexibility[at random].";
		...
		say "     Hanu [one of]stands in the middle of the repurposed Training Hall, performing katas. His graceful moves and calm expression make him look like a ballet dancer[or]is sitting in the middle of the Monkey House, meditating in a succession of poses showcasing the simian's remarkable flexibility[or]is sitting in front of his more-or-less willing student as he finishes lecturing him on the importance of mastering one's mind and body. From Wukong's [if humanity of Wukong < 3]exasperated[else]bored[end if] expression, you are not sure if Hanu's message is finding open ears[at random].";
	else:
...
instead of fucking Hanu:
	if Monkey Duel is unresolved:
		say "     The monkey chuckles. 'I am flattered by your proposal, my friend, but I must refuse. My mind fights with the urges that came with this body, and I cannot allow any lapse.'";
	else if Resolution of Monkey Duel is 1:
...
to MonkeyDuel:
	...
	if Player consents:
		...
		if Player consents:
			...
			say "[line break][italic type]Wukong was forced to leave the Museum by Hanu. However, you feel that his threats were not empty.[roman type][line break]";
		else:
			LineBreak;
			...
			say "[line break][italic type]Wukong's thugs should be at the Zoo, by the time you go back.[roman type][line break]";
	else:
		LineBreak;
...
to say beatWukongThugs:
	say "     You eventually knock down the last thug, and the whole band is writhing on the ground, at your feet, groaning and holding their injured body parts. 'Wh-what are you, you freak?' one of them asks. 'That's... cheating,' another says.";
...
to say losetoWukongThugs:
	...
	if Player is not neuter or anallevel > 1:
		...
		if Player is female:
			...
			say "     Another monkey takes advantage of the confusion and [if randomnumber is 1]plunges his shaft inside your [cunt size desc of Player] pussy, jackhammering your cervix with his member[else if randomnumber is 2 and Player is kinky]slams a pair of fingers down your [cunt size desc of Player] pussy. Two quickly become three, then four, until the primate eventually manages to slip the five fingers inside and forms a fist inside of you[else]dives head-first on your [cunt size desc of Player] pussy, nibbling on your clit and licking inside, making a game of getting as far as possible[end if][if Cunt Count of Player > 1]. Your other pussies are not forgotten and get fingered in an almost sadistic manner[end if].";
		if Player is male:
...
"Monkey Thug"	"[PrepCombat_Monkey Thug]"

to say PrepCombat_Monkey Thug:
...
When Play begins:
	...
	now enemy title entry is "Wukong's Thugs"; [ Name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name. ]
	now enemy Name entry is ""; [ Specific name of unique enemy. ]
	now enemy type entry is 0; [ 0 = non unique enemy; 1 = unique (unknown name); 2 = unique (known name) | Used to disqualify unique enemies from Vore/UB and showing the enemy name in encounters. ]
	now attack entry is "[one of]You leave yourself open for one of the thugs to grab your arms, offering a couple of cheap shots to his comrades[or]One of the thugs tackles you, and you fall on your butt. You struggle to get her off of you while her friends kick your body[or]One of the thugs grabs you, forcing you to a standstill while one of his allies delivers a sturdy kick to your ribs[at random].";
	now defeated entry is "[beatWukongThugs]";
	now victory entry is "[losetoWukongThugs]";
	now desc entry is "     As you are walking down the alley, you hear some commotion up ahead, including monkey shouts[first time]. You stumble upon a gang of monkeys of various genders and allures. All of them share the same small build and orange-fur of Wukong. Did he turn them? They are dressed like stereotypical street thugs: cap, large t-shirts, gold-plated jewelry and piercings; oddly, no bottom cloth whatsoever[only]. Wukong's gang is in the middle of [one of]taking turns molesting a zebra[or]defacing one of the zoo's pens[or]harassing a cheetah woman, playing [']tag['] with her by slapping her butt when she's distracted[or]holding a tigertaur down while one of them milks her cock[at random]. They all stop what they are doing the moment they see you. 'Hey, [if Player is male]bro[else]sis[end if], you shouldn't walk around here alone. Why don't you stay with us for a moment?' one of them says. They begin to circle around you in a predatory manner.[line break]";
	now face entry is "like a monkey's, with a small muzzle, big laughing eyes and a mane of fur around it"; [ Face description, format as "Your face is [Face of Player]." ]
	...
	now skin entry is "[if looknow is true]short, golden fur which covers your entire[else]short, golden-furred[end if]"; [ Skin. Format as "Looking at yourself, your body is covered in [Skin of Player] skin." ]
	...
	now face change entry is "you feel your hair grow and surround it. Your nose and your mouth change, forming a small muzzle"; [ Face TF text. Format as "Your face tingles as [face change entry]." ]
	now body change entry is "it loses mass and becomes lither. Your feet tingle as they change form, gaining an opposable thumb and becoming prehensile"; [ Body TF text, format as "Your body tingles as [body change entry]. ]
	...
	now MilkItem entry is "monkey thug milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "monkey thug cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
Section 5 - Monkey House

Table of GameRoomIDs (continued)
Object	Name
Monkey House	"Monkey House"

Monkey house is a room. Monkey house is northwest of Main Path 1.
Monkey house is east of Border Wall.
The earea of Monkey house is "Zoo".
Description of Monkey House is "     The zoo's monkey house [if Resolution of Monkey Duel is 2 or Resolution of Monkey Duel is 3]was originally an exhibit for monkeys and apes, and formerly a makeshift dojo. Now that Wukong has taken over, the house turned into a throne room, with the golden monkey sitting on his cushioned seat, in the middle. His thugs occasionally come to give him reports, and leave with new orders[else]seems to have been repurposed. The glass panels have been removed, and one of the exhibits has been repurposed into a makeshift dojo. A suspended tire is the only artifact of the original place; judging by the cot installed in it, it is Hanu's resting place[end if].[line break]".
