...
Instead of resolving a Husky Gang:
	say "     Player spots a large group of huskies, nine females and one male.";
	if HP of Roman is not 10:
		say "     Player hides and let them pass.";
	else:
		say "     Player remembers Roman's task. Alpha Husky challenges the player";
		now inasituation is true;
		challenge "Alpha Husky";
		now inasituation is false;
		if fightoutcome >= 10 and fightoutcome <= 19:
			say "     Husky lets his girls rape the player";
			infect "Female Husky";
			infect "Female Husky";
			infect "Female Husky";
		else if fightoutcome >= 20 and fightoutcome <= 29:
			say "     Alpha Husky lets the girls go. Says that he will accompany them.";
