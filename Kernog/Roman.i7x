...
to FootballTeamAdditionsQuestLog:
	...
	if HP of Roman is 7:
		say "[bold type]Football team additions[roman type]: Roman asked me to keep an eye open for potential talent to recruit into the team. He would like to recruit some cheerleaders, this time. He told about an [bold type]Alpha Husky[roman type], with whom he has some history.";
	if HP of Roman is 8:
...
Instead of resolving a Orca Volleyball Player:
	...
	if HP of Ronan is not 6:
		say "     You mix yourself with the crowd and watch the match. While all the players play well, the killer whale is undoubtedly the best one. Despite his large body, he manages to cover a lot of ground, and his smashes leave no chance to its opponents. You do not mind the match to be unbalanced, if it means being able to oogle the orca's generous package flopping in his skin-tight swimming trunks. You take your leave at the same time the gorgeous cetacean leaves the field.";
	else:
		...
		say "     You try to use your best arguments in order to convince Willy to join the team. All you manage to do is annoy him [one of]with your babble[or]again[stopping]. 'Stop right there. I said it was not about [quote]being part of something big[quote]. I'm not interested in joining your bunch of pansies.' Insulted, you [one of]reply coarsly that he should stop talking shit and just follow you already. 'Make me, or I'll clean your runny mouth in my own fashion,'[or]insult Willy's relatives. The orca frowns. 'I guess you need another mouth cleaning, asshole,'[stopping] he says while he walks towards you.";
		...
		if fightoutcome >= 10 and fightoutcome <= 19:
			...
			say "     While Willy jogs away, you make a mental note to report back to Roman about your successfuly recruitement.";
