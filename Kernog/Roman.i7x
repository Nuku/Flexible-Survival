...
to say RomanFuck1Blow:
	...
	if cock length of player < 8:
		...
		say "     Roman whines, as you stretch his mouth to the limits with your [cock size desc of player] cock. You have barely pushed the head in, when you already feel his uvula. The gorilla coughs and wheezes, but still does his best. He suckles your tip, and tries to use his tongue. Eventually, you have enough. You pull out, and using Roman's attached legs as lever, you frot your dick against the furry chest. 'Mmf! Wmmf! Nnnf!' Roman whimpers. Your [ball size] pouch smacks him like a metronome, smothering his protests. Eventually, you feel the need to cum, and push back your glans inside Roman for the finale.";
	WaitLineBreak;
	if cock width of player < 12:
		say "     You unload your [cum load size of player] release inside Roman's mouth. The thick male juice trickles down his throat, mixing it with the many already present in his stomach You ensure that Roman has  taken all of your seed, one way or another, then puts back the sock in his mouth, and let the big ape digest his meal.";
	else if cock width of player < 25:
		say "     You block Roman's throat for several seconds, as you empty [cum load size of player] load inside his stomach, filling it to the brim. When you finally pull out, Roman coughs violently, strands of cum escaping his mouth as they have followed your [cock of player] dick on the way out. You ensure that Roman has  taken all of your seed, one way or another, then puts back the sock in his mouth, and let the big ape digest his meal.";
	else:
		say "     You drown Roman with your [cum load size of player] release. His belly bulges more and more, as you overload his belly with your cum. The sheer quantity makes the gorilla throw up cum through his mouth and nose, and after you pull out, each of his coughs is accompanied by a glob of semen. You ensure that Roman has  taken all of your seed, one way or another, then puts back the sock in his mouth, and let the big ape digest his meal.";
