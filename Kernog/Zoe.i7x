...
Cunt Depth of Zoe is 8. [penetratable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
to say ZoeGoodFuckMenu:
	...
	if Loyalty of Zoe is:
		...
		-- 11: say "On the way, Zoe suddenly cuts your chatter. 'I saw a mutant the other day. He had, like, three cocks hanging around. [if Cock Count of Player > 1]And you're the same, too. [end if]I think it would be kind of hot if, you know, you used them all at the same time? Do you want to try it out?'";
...
to say ZoeMolestDP:
	...
	if Zoe is PlayerCumLoadInflates:
		...
		say "     Your cocks squirt their load inside Zoe's womb and ass, joining the many others before you. Letting Zoe recover on the floor of the van, you [SelfDressCrotch] and bang on the door. The wolverine guard opens and lets you out. 'Got her good, huh? Don't worry, she's used to it,' he says nonchalantly while munching on the supplies you gave him. 'Come again soon, and all that.'";
