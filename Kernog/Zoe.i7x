...
Body Weight of Zoe is 5. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Zoe is 4. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
[Body Adjective is generated out of the body weight and body definition and can be used in scenes - one word descriptive adjective depending on weight and definition groups: low weight group: skinny/slender/lithe; mid weight group: average/fit/muscled; high weight group: pudgy/husky/jacked]
Androginity of Zoe is 8. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Zoe is 5. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Zoe is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Zoe is 5. [length in inches]
Breast Size of Zoe is 2. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Zoe is 2. [count of nipples]
Asshole Depth of Zoe is 6. [inches deep for anal fucking]
Asshole Tightness of Zoe is 2. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Zoe is 0. [number of cocks]
Cock Girth of Zoe is 0. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Zoe is 0. [Length in Inches]
Ball Count of Zoe is 0. [allowed numbers: 1 (uniball), 2 or 4]
Ball Size of Zoe is 0. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
Cunt Count of Zoe is 1. [number of cunts]
Cunt Depth of Zoe is 8. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
Cunt Tightness of Zoe is 2. [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
Clit Size of Zoe is 3. [size 1-5, very small/small/average/large/very large]
...
TwistedCapacity of Zoe is false. [Twisted Characters can take any penetration, no matter the size]
Sterile of Zoe is true. [steriles can't knock people up]
MainInfection of Zoe is "".
Description of Zoe is "[ZoeDesc]".
Scent of Zoe is "     Zoe's fur retains the smell of the paint she uses during her getaways.".
...
instead of conversing the Zoe:
	if Resolution of Rabbit Tagger is 2:
		...
		if XP of Zoe is 1:
			say "     You greet Zoe, who replies with a [if Loyalty of Zoe < 5]curt[else]happy[end if] 'Hey.' The rabbit seems [if Loyalty of Zoe < 5]to have something on her mind[else]impatient to tell you her day[end if]. '[one of]Check this out[or]I had an interesting encounter, today[or]You'll never guess what happened to me today[at random]...'";
	...
	if Resolution of Rabbit Tagger is 2: [saved]
		...
		if Loyalty of Zoe < 5:
			...
			if Virgin of Zoe is true: [This branch can only be reached by getting the quest's best outcome]
				...
				say "     You slowly take off each other's clothes. Zoe passes her furry hand on your body. [if Player is purehuman]'It's weird that normal people like you are a rarity now. I guess I'm lucky,'[else if Player is pure]'[BodySpeciesName of Player] huh? In high school, a friend showed me some furry porn, you know? It feels weird that it almost became the norm around here,'[else]'Nothing matches with you. It looks funny... I guess I'm lucky to only have muted into a rabbit,'[end if] she says. You make out with Zoe. Time slows down as everything is deadly quiet around you. Your hand slowly reaches down to grope the rabbit's butt, but she surprises you by reaching your crotch at the same time. Not wanting to be outdone, your fingers continue down Zoe's butt-crack and caress her nethers. You start gasping and moaning as your hands discover each other's intimacy.";
				WaitLineBreak;
				if Player is not male:
					...
					WaitLineBreak;
					say "     'O-Okay, I'm ready. I think...' Zoe says. You make her lie on her back, and lean over her. You cover her beautiful white fur with kisses as you slowly part her legs, and place your cock on top of her mound. You tease her a couple of times, before putting it at the entrance of her vagina, and look at her. Zoe nods, and you begin to slowly push your [Cock of Player] cock inside of her. With a little effort, its head passes in, and the bunny gasp loudly. 'Ah. F-Fuck.' As with your fingers, you wait until Zoe's pussy relents on her vice-tight squeezing of your member before pushing further. You progress slowly, doing several stops, until you feel something warm on your cock. 'Eek. I-I think... Ah...' You kiss her neck while the blood of her hymen quickly stops running, thanks to the nanites, and ask her if she's good to go. 'Y-Yes. It stung a little but... But it's gone.'";
					say "     You eventually bottom out, and once you're done, you lie down on Zoe's warm body and hug her small body while you start going through the motions of sex. Zoe holds you tight, her paws leaving marks on your [BodySpeciesName of Player in lower case] back as her pleasure slowly rises. [if Player is knotted]You take great care not to push in to harshly and keep your knot out of her pussy, but you can feel it bump against her lower lips each time with a wet [italic type]slap[roman type][else if Player is barbed]Zoe winces a little when your barbs eventually brush repeatedly against her inner walls, but her discomfort quickly fades and she moans and pants louder and faster than before[else if Player is blunt]You groan, the flared shape of your cock ensuring that every part of Zoe's vagina is stretched against your cock. Eventually, the bumps against her cervix soften her intimacy enough that your medial ring slips into her, heightening your pleasure[else]You slowly pick up the pace, helped by the fact that Zoe squeezes down on your member as if her pussy was made for it[end if].";
					WaitLineBreak;
			...
			[First time of Zoe with the Player, if the wolverine molested her before - Unused at the moment. I keep it in case I extend the other story branch]
				...
				say "     Zoe remains silent for a moment, and finally says. 'Okay. Follow me, I know a more private place.' You walk with her for at least ten minutes, until she leads you to a small apartment. The walls are covered with paintings. 'This was my home, before everything happened.' Zoe leads you to her bedroom. The bed is gone ('I needed the boards for to nail all the windows shut,' she explains), but the big cot is still there, on the ground. 'Let's take our time. I want to do this well.'";
				say "     Zoe starts to hurriedly take her clothes off, but you stop her. 'What? You don't want to do it anymore?' You explain to her that the both of you need to take your time, that good sex is not immediate gratification, even in these times. You take Zoe in your arms. She starts to recoil, but you do not try to force her into your hug, and she eventually relaxes. Your lips meet her, and you spend a long time with her in a deep kiss. Undressing comes naturally as you fondle and explore each other's body. Eventually, the turn of your bottom clothes comes. [if Player is purehuman]'It's weird that normal people like you are a rarity now. I guess I'm lucky,'[else if Player is pure]'[BodySpeciesName of Player] huh? In high school, a friend showed me some furry porn, you know? It feels weird that it almost became the norm around here,'[else]'Nothing matches with you. It looks funny... I guess I'm lucky to only have muted into a rabbit,'[end if] she says. You make out with Zoe. Time slows down as everything is deadly quiet around you. Your hand slowly reaches down to grope the rabbit's butt, but she surprises you by reaching your crotch at the same time. Not wanting to be outdone, your fingers continue down Zoe's butt-crack and caress her nethers. You start gasping and moaning as your hands discover each other's intimacy.";
				WaitLineBreak;
				if Player is not male:
			...
			if lastfuck of Zoe - turns < 6:
				...
				if Loyalty of Zoe is:
					-- 7: say "     'Good timing. I was feeling... lonely,' the bunny replies your invitation. She walks by you, brushing your body with her furry legs. 'Come on, we go to the usual place.' On your way to Zoe's old hideout, you discuss about what you want to do today. On the way, Zoe suddenly cuts your chatter. 'So, I was thinking... I want to try some butt stuff. I heard that if it's done well, it feels just as good as the old-fashioned way, and I'm curious. [if anallevel is 1]Of course, if anal's not your thing, I'm not forcing you or anything.'[else]Do you want to try it out?'[end if]";
					-- 8: say "     'Good timing. I was feeling... lonely,' the bunny replies your invitation. She walks by you, brushing your body with her furry legs. 'Come on, we go to the usual place.' On your way to Zoe's old hideout, you discuss about what you want to do today. On the way, Zoe suddenly cuts your chatter. 'I was thinking, since last time: How does that feel, as a man? S-Sorry, I know it's a weird question. It's just that, hum, I found that strap-on thing during one of my getaways, and I was curious. Do you want to try it out?";
					-- 9: say "     'Good timing. I was feeling... lonely,' the bunny replies your invitation. She walks by you, brushing your body with her furry legs. 'Come on, we go to the usual place.' On your way to Zoe's old hideout, you discuss about what you want to do today. On the way, Zoe suddenly cuts your chatter. 'Say. I wanted to try something new today. You know, about what happened with this wolverine. It keeps working my brain. I'm thinking that, if we tried some kind of dom/sub scenario, I would be able to... You know, work it out.' [if Player is submissive]You look like the type that would enjoy themselves in this kind of thing[else]I mean, once you feel ready to do some [bold type]submissive[roman type] play, that is[end if].";
					-- 10: say "     'Good timing. I was feeling... lonely,' the bunny replies your invitation. She walks by you, brushing your body with her furry legs. 'Come on, we go to the usual place.' On your way to Zoe's old hideout, you discuss about what you want to do today. On the way, Zoe suddenly cuts your chatter. 'You know, what we did last time? It helped. A lot. And I thought... Since I trust you... I want to roleplay that kind of thing again, but I want to be in control, you know what I mean? Do you want to try it out?' [if Player is dominant]I don't know why, but I feel both safe and excited talking you about it[else]You don't streak me as a [bold type]dominant[roman type] though, so nevermind[end if].";
					-- 11: say "     'Good timing. I was feeling... lonely,' the bunny replies your invitation. She walks by you, brushing your body with her furry legs. 'Come on, we go to the usual place.' On your way to Zoe's old hideout, you discuss about what you want to do today. On the way, Zoe suddenly cuts your chatter. 'I saw a mutant the other day. He had, like, three cocks hanging around. [if Cock Count of Player > 1]And you're the same, too. [end if]I think it would be kind of hot if, you know, you used them all at the same time? Do you want to try it out?'";
					-- otherwise: say "     'Good timing. I was feeling... lonely,' the bunny replies your invitation. She walks by you, brushing your body with her furry legs. 'Come on, we go to the usual place.' On your way to Zoe's old hideout, you discuss about what you want to do today.";
				project the figure of Zoe_face_icon;
				...
				if Loyalty of Zoe >= 7:
					...
					if Loyalty of Zoe >= 8:
						choose a blank row in table of fucking options;
						if Player is female or (Player is male and anallevel > 1):
						...
						if Loyalty of Zoe >= 9:
							...
							if Loyalty of Zoe >= 10:
								...
								if Loyalty of Zoe >= 11:
									choose a blank row in table of fucking options;
									if Cock Count of Player > 2 and Player is kinky:
...
to say ZoeSexRPSub:
	...
	WaitLineBreak;
	if Player is male:
		say "     The bunny grabs your [Cock of Player] cock and starts jerking you off. 'Better than your right hand, isn't it?' she chides you as your penis slowly responds and grows. Satisfied, she sits on your face, trapping your [FaceSpeciesName of Player in lower case] head against her white furred thighs. 'But it's not about you, pig. It's about me. Start licking.' You groan and play hard-to-get. It would not be fun if you gave up so easily, wouldn't it? 'Fine, have it your way,' she says, and she begins to grind her pussy against you. You eventually abide, and services the bunny with your tongue. 'That's it. Yeah!' Zoe moans. She keeps playing with your cock while you please her, so that you stay ready for her.";
		...
		say "     The bunny kneels by your crotch and pushes a finger inside. Then a second. 'Feels good? Wish for a real cock?' she asks snidely while you rapidly wet. Afterwards, she sits on your face, trapping your [FaceSpeciesName of Player in lower case] head against her white furred thighs. 'But it's not about you, bitch. It's about me. Start licking.' You groan and play hard-to-get. It would not be fun if you gave up so easily, wouldn't it? 'Fine, have it your way,' she says, and she begins to grind her pussy against you. You eventually abide, and services the bunny with your tongue. 'That's it. Yeah!' Zoe moans. She keeps playing with your pussy while you please her, so that you stay ready for her.";
...
to say ZoeMolestVag:
	...
	if Zoe is CuntFitsForPlayerCock:
		...
		say "     'N-No, please,' Zoe pleads. 'It's too big.' You answer snidely that you are sure that she has seen and will see bigger while you line your [Cock of Player] cock with her pussy. You push inside, inch by inch, stretching Zoe to her limits and then some. You eventually bottom out. Zoe looks away, not daring to look at the bulge your cock forms on her belly. You start going back and forth inside of her, eliciting groans from your living toy each time you stretch her a little further[if Player is barbed] or your over-sized barbs scratch her pussy[end if]. You eventually feel your orgasm coming, so you decide to push stronger and stronger until she fits all of you. Zoe wiggles and screams while your [Cock of Player] shaft presses dangerously stronger on her cervix. Then, with a hearty hump, you breach that last barrier, and the young girl squeals as you invade her womb, and make the bulge advance several inch further[if Player is knotted]. Your knot starts to grow, but is still outside, so you push even further until it pops in with a sick noise of vaginal muscles rearranging themselves under the effect of the nanites[end if][if wslevel is not 1]. You feel something warm trickle on your crotch as Zoe loses control of her bladder from the sheer size of the insertion. This does not deter you as you make the last few remaining humps[end if].";
	say "     [if Zoe is PlayerCumLoadInflates]The bunny girl's belly slowly fills with your cum with obscene [italic type]glug, glug[roman type] sounds. Zoe is left gasping as her womb is filled to full capacity and beyond, the overfill flowing out of her cunt. When you finally lift your body off her, more of your fluids squirt on the floor as the spasms of her body eject it. Meanwhile, you [SelfDressCrotch] and bang on the door. The wolverine guard opens and appraises the situation. 'Clean your mess before you get out, will ya. The mop's on your left[else]Your cock squirts its load inside Zoe's womb, joining the many others before you. Letting Zoe recover on the floor of the van, you [SelfDressCrotch] and bang on the door. The wolverine guard opens and lets you out. 'Don't worry about [']accidents['], we're keeping her on some special contraceptives an associate of Logan's cooked up,' he says nonchalantly while munching on the supplies you gave him. 'Come again soon, and all that[end if].'";
	NPCSexAftermath Zoe receives "PussyFuck" from Player;
...
to say ZoeMolestDP:
	...
	say "     [if Zoe is PlayerCumLoadInflates]The bunny girl's belly slowly fills with your cum with obscene [italic type]glug, glug[roman type] sounds. Zoe is left gasping as her womb and ass are filled to full capacity and beyond, the overfill flowing out of her cunt and butthole. When you finally lift your body off her, more of your fluids squirt on the floor as the spasms of her body eject it. Meanwhile, you [SelfDressCrotch] and bang on the door. The wolverine guard opens and appraises the situation. 'Clean your mess before you get out, will ya. The mop's on your left[else]Your cocks squirt their load inside Zoe's womb and ass, joining the many others before you. Letting Zoe recover on the floor of the van, you [SelfDressCrotch] and bang on the door. The wolverine guard opens and lets you out. 'Got her good, huh? Don't worry, she's used to it,' he says nonchalantly while munching on the supplies you gave him. 'Come again soon, and all that[end if].'";
	NPCSexAftermath Zoe receives "PussyFuck" from Player;
	NPCSexAftermath Zoe receives "AssFuck" from Player;
...
Scent of Suspicious Van is "     It smells of oil[if Resolution of Rabbit Tagger is 1], and there is a lingering smell of male sweat and cum in the vicinity[end if].".
...
check opening the Suspicious Van:
	if Resolution of Rabbit Tagger is 1, say "The wolverine guard is in the way. 'Wanna have fun inside? Talk to me first.'" instead;

check closing the Suspicious Van:
	if Resolution of Rabbit Tagger is 1, say "'No point closing the door now.'" instead;

instead of going southeast from Smith Haven Mall Lot West while Suspicious Van is open:
	say "     As you start to walk away from the vehicle, the guard stops you. 'Having second thoughts? No refunds, boy!'";
	if Player consents:
		LineBreak;
...
an everyturn rule:
	if Resolution of Rabbit Tagger is 1 and skipturnblocker is 0:
		...
		if Suspicious Van is visible and Suspicious Van is open:
			say "[line break]     Looking at you, the Wolverine Pimp glances down to his wristwatch, then shrugs and closes the door of the van.";
		now Suspicious Van is closed;
	...
	while sextablerun is 0:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if Player consents:
				...
				now sextablerun is 1;
				if title entry is:
					-- "Ask what he'll take in trade":
						say "[WPimp_TradeOptions]";
					-- "Trade him some food for a turn with Zoe":
						say "[WPimp_TradeFood]";
					-- "Trade him some clean water for a turn with Zoe":
						say "[WPimp_TradeWater]";
					-- "Trade him some chips for a turn with Zoe":
						say "[WPimp_TradeChips]";
					-- "Trade him some soda for a turn with Zoe":
						say "[WPimp_TradeSoda]";
		else if calcnumber is 0:
			LineBreak;
			now sextablerun is 1;
...
[Event trigger]
after going to Smith Haven Mall Lot West while a random chance of 1 in 3 succeeds and Rabbit Tagger is not resolved:
	try looking;
	...
	say "[line break]     [bold type]Well, that escalated quickly. What do you want to do now?[roman type][line break]";
