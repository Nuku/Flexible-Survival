...
to say AstroslideFootFielddesc:
	if Astroslide Football Field is unvisited:
		...
		say "     There seems to be a lot going on right now: gorilla and wolfman football players run and tackle each other on the field, while beeing cheered on by a crowd of onlookers hailing from all sorts of species, even some from other parts of the city. They seem to play a strange blend of american football, rugby, and free-for-all sex orgy, but after watching them a little you notice that they follow a somewhat stammering ruleset. As is typical these days, various kinds of sexual activity are being performed in open view too. You are reminded of this fact when you notice, right next to the entrance of the gorilla's locker-room, [one of]a fan-girl giving one grinning football player a blowjob[or]a fan-boy giving one grinning football player a blowjob[or]a football player grunting loudly as he humps a moaning fan-girl[or]a football player grunting loudly as he humps a moaning fan-girl[at random]. Overall, the impression you get is that of a bustling, yet orderly locale. People of all shapes come and go freely and it seems that the only molesting taking place is on the playing field. ";
		WaitLineBreak;
	else:
