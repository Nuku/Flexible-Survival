...
When Play begins:
	...
	now Species Name entry is "Slime Cube"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Slime Cube" to infections of SlimeList;
	add "Slime Cube" to infections of TaperedCockList;
	add "Slime Cube" to infections of NoLegList;
	add "Slime Cube" to infections of SlidingList;
	now Name entry is "Slime Cube";
	now enemy title entry is ""; [ Name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name. ]
	now enemy Name entry is ""; [ Specific name of unique enemy. ]
	now enemy type entry is 0; [ 0 = non unique enemy; 1 = unique (unknown name); 2 = unique (known name) | Used to disqualify unique enemies from Vore/UB and showing the enemy name in encounters. ]
	now attack entry is "The [one of]slime charges ahead and rams into you. You reel back under the impact[or]cube fires a slime ball which lands right into your chest[at random].";
	now defeated entry is "     Mortally wounded, the slime loses its coherency, and dissolves into a pile of smelly goop.[line break]";
	now victory entry is "[slimeCubeVoreScene]";
	now desc entry is "     A big and gooey translucent cube stands in front of you. Despite making you remember the goo girls of the city, its body is completely featureless, save the few boney remnants of previous victims floating inside. It wobbles slowly in your direction, and it seems it will relentlessly do so until it absorbs you into its body.[line break]";
	...
	now MilkItem entry is "slime cube milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "slime cube cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
to say slimeCubeVoreScene:
	say "     [if fightoutcome is 22]You welcome the slime as it rolls in a die-like fashion upon you, and slams down on your waiting body[else]Like a giant die, the slime rolls on the ground until it reaches your knocked-out form, and slams down on you[end if]. Your body pops into the gelatinous body, and slowly floats towards its center. The inside of the slime feels hot on your skin, and you understand that the creature aims to digest you slowly, after making sure that you oppose no more resistance.";
	say "     The slime washes around your body as it attempts to keep you stimulated and placated[if Cunt Count of Player > 1]. It slowly pushes past each of your pussy lips, then suddenly stretches inside, forming thick, slimy limbs before relentlessly pounding each of your wombs[else if Player is female]. It slowly pushes past your pussy lips, then suddenly stretches inside, forming a thick, slimy limb before relentlessly pounding your womb[end if][if Cock Count of Player > 1]. An ever-changing flow wraps around each of your [Cock of Player] shafts, keeping them hard and massaged, experimentally focusing their efforts on your [Cock Count of Player] glans[else if Player is male]. An ever-changing flow wraps around your [Cock of Player] shaft, keeping it hard and massaged, experimentally focusing its efforts on your glans[end if]. The slime does not forget to relentlessly tease every part of your body[if Nipple Count of Player > 1], including your nipples and your [Nipple Count of Player] breasts[end if][if anallevel > 1], and flowing into your ass[end if].";
	say "     Time is of the essence. If you do not struggle out in time, these intense sensations may be the last you will ever experience.";
	wait for any key;
	slimeCubeVore;
...
to slimeCubeVore:
	...
	while Trixieexit is false:
		...
		checkboundrecover;
		if lustatt > 99:
			say "     The sexual stimulation of the slime pushes you past your limits. You cum hard, while the slime patiently absorbs your discharge, as an appetizer. You feel your life force fading away and your mind blank out further, as you come back from your pleasure height.[paragraph break]";
		...
		if humanity of Player < 1:
			...
			say "Sanity: [humanity of Player]/100  Lust: [lustatt]/100  Hunger: [hunger of Player]  Thirst: [thirst of Player]  Struggle: < [bracket][if struggleatt is 0]-----[else if struggleatt is 1]----[bold type]X[roman type][else if struggleatt is 2]---[bold type]XX[roman type][else if struggleatt is 3]--[bold type]XXX[roman type][else]-[bold type]XXXX[roman type][end if][close bracket][line break]";
			...
			if keychar is "s" or keychar is "1" or keychar is "return" or keychar in lower case matches the text "struggle":
				...
				if obliging is true:
					...
					say "     As the slime amps up its ministrations, you grit your teeth and decide to ride the wave of pleasure which wracks your body.";
					increase lustatt by 7 + (lustadjust * 2);
				wyvhumanityroll; [aka humanity loss]
				LineBreak;
				wait for any key;
