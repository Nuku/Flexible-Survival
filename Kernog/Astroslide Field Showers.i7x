...
Astroslide Field Showers is inside Astroslide Field Locker-room.

[Not used as a classic room]
The description of Astroslide Field Locker-room is "".
...
to say astroslideShowersStart:
	say "     You peer into the showers. The room is filled with water vapor, and the laughters and moans of footballers and fans alike. You could use a moment of relaxation, although [bold type]there is a good chance that the water is infectious[roman type]. There are several stalls and spaces to choose.";
	LineBreak;
...
to say astroslideShowers2:
	...
	if player is male:
		say "     You eventually find yourself on your back, the warm water running down on the floor next to you, your [cock descr of player] dick raised in the air. It quickly finds a firm ass to sit on, as one of the other players ride you eagerly. The rest of the group agglutinates around you. A second cock slams inside your partner's ass, wich he reacts to with a lewd moan. The thick gorilla dick grinding along your [cockname of player] shaft hightens the pleasure, and makes you lose focus of the world around you. You feel your hands being guided to new cocks to stroke. Another ape jumps on your chest and wraps his legs around your head. Strong prehensile feet clamp on your skull, and keep you steady as the ape pushes his member into your mouth.";
