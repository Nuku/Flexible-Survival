...
"Adds the Football Field Locker-room, where players can have sex with gorilla footballmen, become part of the team, and conduct business related to them."


[TODO: Expand on basic sex menu in lockers]
[TODO: Expand team member quests]
[TODO: Add female gorilla coach, who wants to export her own brand of "sports" through the city]
[TODO: Add star player NPC, whom the player must face if they want to become a star player]
...
to say FootFieldLockerdesc:
	if Football Field Locker-room is unvisited:
		...
		[Note: Quest for popularizing "Sex football" in future?]
		say "     There seems to be a lot going on right now: gorilla and wolfman football players run and tackle each other on the field, while beeing cheered on by a crowd of onlookers hailing from all sorts of species, even some from other parts of the city. They seem to play a strange blend of american football, rugby, and free-for-all sex orgy, but after watching them a little you notice that they follow a somewhat stammering ruleset. As is typical these days, various kinds of sexual activity are being performed in open view too. You are reminded of this fact when you notice, right next to the entrance of the gorilla's locker-room, [one of]a fan-girl giving one grinning football player a blowjob[or]a fan-boy giving one grinning football player a blowjob[or]a football player grunting loudly as he humps a moaning fan-girl[or]a football player grunting loudly as he humps a moaning fan-girl[at random].";
		WaitLineBreak;
		say "     Overall, the impression you get is that of a bustling, yet orderly locale. People of all shapes come and go freely and it seems that the only molesting taking place is on the playing field. You stop to read a notice, next to the locker-room. Opening with the cute drawing of a toonish gorilla juggling with footballs, the notice announces that the staff and players of the Tenvale Gorillas welcome visitors to Astroslide Field, and invite them to meet the team in the locker-room.[if GorillasMember is 0] You also learn that, due to the disappearance of several people in the chaos that engulfed the city a few weeks ago, the team is looking for new players and supportive staff, and is about to hold tryouts. Recruitement is open to every sex and body type. You decide to check out the place.";
		WaitLineBreak;
...
Gorilla Team-Members is in Football Field Locker-room.
