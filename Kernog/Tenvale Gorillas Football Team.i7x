...
to say GorillaCheck3:
	...
	if diceroll < 16: [fail]
		...
		say "     As you start to grumble about him giving you the finger, the goblin lets go of you and nods. 'You'll be alright then - even if you got a concussion, those little metal thingies we all got in us will patch you up soon-ish. Which means I better use the opportunity now before it's over!' Something about his tone tells you that - yup, he's pulling his loincloth aside, gripping a rapidly hardening dick. 'Start sucking,' comes a command given with a broad grin. Weak as a kitten right now, you've got no options but to plead with him - only to get a throbbing member pushed into your mouth as you open it.";
		WaitLineBreak;
...
to say GorillaLaundryService2:
	...
	say "     Suddenly, someone arrives from behind and grab your [FaceSpeciesName of Player in lower case] head, pressing something against your nose and startling you. As you inhale, a strong smell of sweat reaches your nostrils, making your shudder. 'How's my sniffer buddy doing?' a familiar voice asks.";
	LineBreak;
	...
	if Player consents:
		...
		say "     He does not have to say it twice. You fall on your knees and dive your [FaceSpeciesName of Player in lower case] head into his crotch. 'Ho ho, someone is eager, it seems.' You do not answer, busy basking yourself into the male scents. 'Give them a good tongue bath,' the male orders. You comply, and start licking his heavy ballsack. You worship his balls, coating them in your saliva, and occasionally sucking them in your mouth one by one, before letting them out with a loud pop noise. At the same time, your hands absentmindedly [if Player is male]stroke your [Cock Size Desc of Player] [CockName of Player] [end if][if Player is herm] and[end if][if Player is female]play with your pleasure button[end if]. After several minutes of this, the primate sits on a nearby bench, and point at his rigid cock, which was bobbing up and down over your head for some time now. 'Time to take care of the big boy too,' he asks, grinning.";
...
to say GorillaLaundryService3:
	...
	say "You consider his proposition. [if Libido of Player > 50]You are quite pent-up yourself, so this would be a good way to release some of your own tension. [else if Libido of Player > 10]You do deserve some fun, but would it not be better to wait after you are done? [else]You do not think it would be wise, but... Free sex, right? [end if][bold type]'What is your answer?'[roman type][line break]";
	LineBreak;
