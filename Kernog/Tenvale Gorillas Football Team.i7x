...
to say GorillaLaundryService2:
	...
	if player consents:
		...
		say "   Roman does not have to say it twice. You fall on your kness, and dive your [face of player] into his crotch. 'Ho ho, someone is eager, it seems.' You do not answer, busy basking yourself into the male scents.  'Give them a good tongue bath,' Roman asked. You comply, and start licking his heavy ballsack. You worship his balls, coating them in your saliva, and occasionaly sucking them in your mouth one by one, before letting them out with a loud pop noise. At the same time, your hands absentmindedly [if player is male]stroke your [Cock Size Desc of player] [cockname of player] [end if][if player is herm] and[end if][if player is female]play with your pleasure button[end if]. After several minutes of this, Roman sits on a nearby bench, and point at his rigid cock, which was bobbing up and down over your head for some time now. 'Time to take care of the big boy too,' he asks, grinning.";
		...
		LineBreak;
		say "     In order to give the gorilla some pause, you run your tongue over the shaft, basking in the strong male scent when you press your face against his crotch. After this, you resume your fellatio. You keep assaulting Roman's glans with your tongue, amusing yourself when you feel his thick legs jiggle on each side of your head. You occasionaly take the ape's dick deep in your mouth, going as far as you can, taking a whiff of football player's musk, before pulling out.";
