...
to say FootballTryoutsResults:
	...
	otherwise if TryoutScore > 4: [okay results]
...
to say GorillaLaundryService2:
	...
	LineBreak;
	say "     You recognize Roman's voide, and relax somewhat. 'Yup, it's me,' the ape confirms after you voiced your thought. 'So, fond of my smell?' You take another, bigger breath through the used thong that the captain keeps pressed on your face, groaning in pleasure. Grinning, Roman lowers his other hand towards your crotch and [if player is male]fondles your growing endowment[otherwise]grinds his large fingers against your [cunt size desc of player] pussy[end if].";
	...
	if player consents:
		say "    Instead of voicing an answer, you grind back against Roman. He chuckles, and you chuckle too when you feel his rock-hard cock against your butt. 'You are addicted to the smell, don't you? Wanna get your fix directly where it came from?' You nod eagerly in response. 'Then turn around and get on your knees, my little panty sniffer.'";
		say "   Roman does not have to say it twice. You fall on your kness, and dive your [face of player] into his crotch. 'Ho ho, someone is eager, it seems.' You do not answer, busy basking youself into the male scents.  'Give them a good tongue bath,' Roman asked. You comply, and start licking his heavy ballsack. You worship his balls, coating them in your saliva, and occasionaly sucking them in your mouth one by one, before letting them out with a loud pop noise. At the same time, your hands absentmindedly [if player is male ] stroke your [Cock Size Desc of player] [cockname of player] [end if][if player is herm] and[end if][if player is female] play with your pleasure button[end if]. After several minutes of this, Roman sits on a nearby bench, and point at his rigid cock, which was bobbing up and down over your head for some time now. 'Time to take care of the big boy too,' he asks, grinning.";
		say "     You open your mouth and slip your tongue inside Roman's foreskin, before sucking the rest of the glans in. From the gasp the captain made, he probably loved the gesture.  After having pulled back the foreskin, you roll your tongue around the sensitive flesh. Roman puts his hand on your hair; not to force you to go faster or deeper, but to make you relent. 'Oh, fuck, that tongue! Slow down, champ.'";
		LineBreak;
		say "     In order to give the gorilla some pause, you run your tongue over the shaft, basking in the strong male scent when you press your face against his crotch. After this, you resume your fellatio. You keep assaulting Roman's glans with your tongue, amusing youself when you feel his thick legs jiggle on each side of your head. You occasionaly take the ape's dick deep in your mouth, going as far as you can, taking a whiff of football player's musk, before pulling out.";
		say "     Suddenly, Roman's breath accelerates, and you feel his body tense up. 'Oh shit, here it comes! Here it... Nnng!' Before you can react, Roman's furry legs press on each side of your head, his legs press on your [face of player], and the big team captain seems to attempt to crush you against his crotch. Your nose and windpipe blocked by the massive slab of gorilla meat, your brain overwhelmed with sweaty musk, you tremble and cum hard, while Roman sends several ropes of cum down your gullet.";
		WaitLineBreak;
		let randomnumber be a random number from 1 to 2;
		if randomnumber is:
		-- 1:
			say "     After his powerful orgasm, Roman's muscles seems to turn into jelly, and you immediately pull away, gasping for air. 'D-Damn. Between you and my friend, you're definitely the best sucker,' Roman asserts between two pants. After the both of you recovered, the football player goes to fetch a bag of chips and throws it in your direction. 'As thanks.' You catch it mid-flight, making it grin. 'Nice catch. Once you build some strength, you should talk to me about some promotion. You'd make a good player.' On these words, Roman heads for the exit. 'Good luck with the rest of the laundry,' he wishes you.";
			say "    You say goodbye to Roman, and go back to your duty. Meeting the team captain put you in a good mood, and you manage to handle the rest of the clothes way before the team comes back from training. You are even able to take some time to sit on a bench and take some whiffs at the thong that Roman gave you. It's not the same smell than the other time. Is it his hyena friend's? Your thoughts are interrupted by the hubbub of the team and its groupie escort. After another round of sweaty clothes collection, Roman tells you that you are done for today and free to go.";
			add "chips" to invent of player;
		-- 2:
			say "     After his powerful orgasm, Roman's muscles seems to turn into jelly, and you immediately pull away, gasping for air. 'D-Damn. Between you and my friend, you're definitely the best sucker,' Roman asserts between two pants. After the both of you recovered, the football player goes to fetch a can of soda and throws it in your direction. 'As thanks.' You catch it mid-flight, making it grin. 'Nice catch. Once you build some strength, you should talk to me about some promotion. You'd make a good player.' On these words, Roman heads for the exit. 'Good luck with the rest of the laundry,' he wishes you.";
			say "    You say goodbye to Roman, and go back to your duty. Meeting the team captain put you in a good mood, and you manage to handle the rest of the clothes way before the team comes back from training. You are even able to take some time to sit on a bench and take some whiffs at the thong that Roman gave you. It's not the same smell than the other time. Is it his hyena friend's? Your thoughts are interrupted by the hubbub of the team and its groupie escort. After another round of sweaty clothes collection, Roman tells you that you are done for today and free to go.";
			add "soda" to invent of player;
		increase GorillasRep by 2;
	else:
		LineBreak;
		say "    You explain to Roman, through his big primate hand, that you do not feel up for [italic type]this[roman type] kind of fun.";
		say "    'Really? It's a shame. But hey, I understand. Everyone needs a pause from this 24/7 fuck-fest, from time to time'. The football player gives your neck a mischievous lick, and lets you go, after handing you a bag of chips. 'Good luck with your laundry, then. I'm gonna take over at the training. See you around!";
		say "    You say goodbye to Roman, and go back to your duty. Meeting the team captain put you in a good mood, and you manage to handle the rest of the clothes way before the team comes back from training. You are even able to take some time to sit on a bench and take some whiffs at the thong that Roman gave you. It's not the same smell than the other time. Is it his hyena friend's? Your thoughts are interrupted by the hubbub of the team and its groupie escort. After another round of sweaty clothes collection, Roman tells you that you are done for today and free to go.";
		increase GorillasRep by 1;
...
to say GorillaWater2:
	...
	WaitLineBreak;
	if player is herm:
		say "     The brothers bury their faces against your crotch. Zach [if cunts of player is 1] alternates between giving your clit several powerful suctions, and laping your [Cunt Width of player] pussy[otherwise] explores each of your pussies with his tongue, filling the unused ones with his fingers[end if], while Mike [if cocks of player is 1]gobbles down your [Cock of player] with loud noises of wet slurps, sometimes going for your balls while stroking your [cockname of player] penis with a firm hand[otherwise]takes turn sucking down on each of your shafts, stroking the ones that he is not budy covering in saliva[end if].";
		...
		say "[if cunts of player is 1]Mike and Zach share duties. Mike applies his mouth against your clit and give it a series of powerful sucks, and licks, while Zach explores each of your [Cunt Length] pussy with his tongue,  making sure to let no square inch untouched. [otherwise] The siblings share your [cunts of player] pussies, exploring them with their dextrous tongue. They playfully try to feel each other's tongue inside of your body, which sends you all kind of sensations through your body[end if]";
