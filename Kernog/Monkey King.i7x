...
instead of resolving Crashing the Satyr Party:
	...
	if calcnumber is 1: 
		...
		if fightoutcome >= 10 and fightoutcome <= 19:
			...
			say "     ''Ah, fuck!' the satyr shouted when he felt Wukong picking up the rhytmn inside of him. The rest of the greek assembly had paused their amusements, and was now sitting around the odd pair, masturbating at the uncommon scene. Suddenly, Wukong grits his teeth, and tenses up as he cums inside the saty. 'Yesss...' Feeling the primate's climax flushing his innards, the satyr looked at him.:'P-Please make me cum. I can't hold it anymore.'";
		...
		challenge "Satyr";
		if fightoutcome >= 10 and fightoutcome <= 19:
			say "     You wait until the satyr gets back on his feet, and explain what Wukong had asked you to do. 'Really?' he asks. 'That's low, even for an unsufferable prick like him. Tell you what: go get him, and tell him that you spiked the wine. Once he gets here, my boss and him are going to have an explanation.";
...
instead of resolving Hunt Of Mammoth Proportions: 
	say "     Your walk into the Museum is interrupted by Wukong saltoing in front of you. 'Ah, if it is not my favourite servant!' ";
	if companion of player is nullpet:
		...
		if player consents:
			...
			say "     'I knew you would not refuse a chance for glory!' Wukong replies, beaming with joy. 'To batle, my friend. May we be victorious!' And on these words, Wukong charges towards the mammoth, who looks surprised and mildly inconvenienced by the interruption. You do not any more time and join the battle.";
			now inasituation is true; [ to prevent normal outcomes to pop (?)]
			challenge "Mammoth";
			now inasituation is false;
			if fightoutcome >= 10 and fightoutcome <= 19:
				say "      Extenuated, the deated mamoth falls on her butt. 'We did it!' Wukong exults. 'Look at this beast. It did not stand a chance against the mighty Monkey King. And you, my friend. Now, to celebrate this victory!' Wukong jumps on the mammoth's belly, and swat away her hands as they approached from her massive erection. 'Such a vulgar set of genitals. Let me give them a more proper use.' The monkey lines up his cock with the mammoth's urethra. Under you and the pachyderm's surprised looks, he pushes his dick inside the herm's member, who trumpets her approaval. The monkey king wastes no time beginning to pump in and out the oversized urethra.";
				if cocks of player > 0:
					say "     Not wanting to lose the opportunity of post-victory relief, you lift her huge balls, and thrust into her juicy hole. Her huge cunt, while loose, it still delightfully warm, wet and juicy, and grips around your shaft quite well. You bring your hands back up to keep her balls boosted up. The mammoth is moaning loudly, writhing on the floor as you and Wukong attack her from two sides. The monkey grabs her massive glans with his four limbs and humps like crazy, and you do not let the rhytmn go down either. You hear him cum eventually, but then, as you fuck her, you can feel her balls churn with semen, signalling her approaching peak. You have no time to warn your simian friend before she blasts her ownload across the floor and wall behind her, covering Wukong too with her spunk. Finding the massive display of virility arousing, you cum as well, pumping your load into her, [if cock width of player < 10]invoking some small tremors in response[else if cock width of player < 20]making her moan softly as her cunt ripples over your spurting shaft[else if cock width of player < 30]making her moan loudly as her cunt squeezes down onto your spurting shaft[else]causing her to trumpet again as she cums a second time as you fill her with your huge load, making even her large body bloat noticeably to contain it all[end if].";
				else:
					say "     Not wanting to lose the opportunity of post-victory relief, you climb on her cock and straggle the thick, hard shaft. You move your hips, griding your crotch against the warm skin. The mammoth does not mind at all, and keep stroking herself, while you get along for the ride. You progressively get faster and faster, emboldened by the sensation of the blood flowing under your legs, eventually grabbing the massive rod in your arms for additional leverage. The monkey grabs her massive glans with his four limbs and humps like crazy, and you do not let the rhytmn go down either. The pachyderm cums eventually, around the same time as you, the soft rumble of the cum rushing in her urethra accompanying the quivers of your puss[if cunts of player > 1]ies[else]y[end if]. Wukong, who had cummed a moment prior, is on the receiving end of a shower of cum.";
				...
				say "    'You are skilled, but your moves and your stance are a mess. You need proper lessons in kung fu. Let me give you some tips.' And so, you spend the next hours learnning basic martial art moves under Wukong's tutoring. It is not much, but the experience that you have accumulated over the past days gives you the feeling that they will be extremely useful.";
			...
			LineBreak;
			say "    'How dare you?!' Wukong replies, when you say to his face that he is alone on this. 'Very well, then. I shall vainquish this beasta alone. Begone, you spineless commoner!'";
			say "     You sigh, then leave without further addo. As you quit the prehistory wing, you can hear the noise of battle behind you. Then, very quickly, the defeated whines of Wukong: 'No, don't put me in [italic type]there[roman type]! Don't! Do-mmmmf!' It sounds like you will not see him for a while.";
...
"Wukong's staff"	"An simple yet expertly crafted fighting staff, carved then polished with care to provide maximum efficiency. A golden leaft riveted to the middle of the staff, ornated with detailed figures of various animals, provides your hands with a good grip."	2	wukongStaff
