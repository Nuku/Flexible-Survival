...
instead of resolving Hunt Of Mammoth Proportions:
	...
	if companion of player is nullpet:
		...
		if player consents:
			...
			if fightoutcome >= 10 and fightoutcome <= 19:
				say "     Extenuated, the defeated mammoth falls on her butt. 'We did it!' Wukong exults. 'Look at this beast. It did not stand a chance against the mighty Monkey King. And you, my friend. Now, to celebrate this victory!' Wukong jumps on the mammoth's belly, and swat away her hands as they approached from her massive erection. 'Such a vulgar set of genitals. Let me give them a more proper use.' The monkey lines up his cock with the mammoth's urethra. Under you and the pachyderm's surprised looks, he pushes his dick inside the herm's member, who trumpets her approval. The monkey king wastes no time beginning to pump in and out the over-sized urethra.";
				if cocks of player > 0:
