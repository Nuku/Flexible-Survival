...
to say loseMutatedIslander:
	if scalevalue of Player >= 5:
		...
		if scalevalue of Player is 4:
			...
			say "     Your shoulders, then your chest follow it, with some effort, and your [BodyType of Player] form slowly disappears inside his cock. As your head reaches the base of his shaft, the mutant lets out a shudder which reverberates all the way down your prison. 'Damn, that feels good.' As soon as [if scalevalue of Player is 3]only your ankles pathetically jiggle out[else]your entire body is squished inside[end if], the islander grabs his massive erection with both hands, and resumes his prior jerk off. Each of your panicked struggles only make the man even more aroused and pleasured. Eventually, with a loud moan, he cums hard. A torrent of cum geysers out from his balls and straight into your face. The gallons of cum force their way through your mouth and into your stomach. Your belly bulges out almost comically. Eventually even your body and the nanites cannot keep up, and the pressure pushes you back outside. You crash several meters away, covered from head to toe in thick globs of semen, and your belly filled with the stuff.";
		PlayerEat 5;
		PlayerDrink 10;
		infect "Human Mutant";
...
When Play begins:
	...
	now Species Name entry is "Human Mutant"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Human Mutant" to infections of HumanList;
	add "Human Mutant" to infections of NatureList;
	add "Human Mutant" to infections of MaleList;
	add "Human Mutant" to infections of BipedalList;
	now Name entry is "Human Mutant";
	now enemy title entry is "Mutated Islander"; [ Name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name. ]
	now enemy Name entry is ""; [ Specific name of unique enemy. ]
	now enemy type entry is 0; [ 0 = non unique enemy; 1 = unique (unknown name); 2 = unique (known name) | Used to disqualify unique enemies from Vore/UB and showing the enemy name in encounters. ]
	now attack entry is "[one of][or][or][or][at random]";
	now defeated entry is "     The islander falls heavily on his back.[line break]";
	now victory entry is "[loseMutatedIslander]";
	now desc entry is "     The nearby bushes crack and bristle as a muscular man rushes out at you. He is massive in more than one regard. Not only do you [if scalevalue of Player is 5]get easily matched in height[else if scalevalue of Player is 4]barely reach his neck[else if scalevalue is 3]barely reach his chest[else if scalevalue is 2]barely reach his belly[else]barely reach his groin[end if], his massive girth bounces with each of his steps on his tanned thighs. '[one of]There you are!'[or]Found you!'[or]Fill me, stranger!'[or]My balls feel so empty...'[at random][line break]";
	...
	now CumItem entry is "human mutant cum"; [ Item to be given to the player if they have this infection and jerk off. ]
