...
to say ErinFuckTop:
	...
	if player consents:
		...
		say "[ErinVoyeurKo]";
	WaitLineBreak;
	say "      Erin and you take your time peeling each other clothes, exploring each other's body[if isTwinHere is 1] while Violet, true to her word, sits in a corner, and watches the show with eagerness[end if]. He lets you pass your fingers on his soft, grey-white fur while his own limbs run down your [body of player] back. Your two heads slowly lock with each other in a long and passioned french kiss.[if isTwinHere is 1] You can hear Violet's breath accelerate as her sibling and you get lost in your passions. When you take the time to give her a peripheral look, you notice her hands are already cupping her breasts and her crotch in an absent-minded manner.[end if] The feeling of Erin's member brushing against your [if cocks of player is 1]own [cock of player] erection[else]pack of erected penises[end if] fills you with arousal and anticipation. 'Help me get ready?' he asks softly. You nod[if isTwinHere is 1]; Violet nods as well[end if].";
...
to say ErinFuckBottom:
	say "     Erin smiles warmly at your proposition. 'With pleasure. I will make sure the entire restaurant hears us,' he jokes, affably slapping your shoulder at your [if HP of Erin < 3]embarassed[else]flustered[end if] reaction. The teenager rat points at the storage room behind him. 'Let's make ourselves comfortable.'";
	say "[ErinVoyeurProposal]";
	say "     [bold type]Do you agree to let Violet watch you and Erin make love?[roman type][line break]";
	say "     ([link]Y[as]y[end link]) Sounds hot.";
	say "     ([link]N[as]n[end link]) [if HP of Erin < 3]This would feel awkward[else]Not this time[end if].";
...
to say VioletFuck:
	...
	if player consents:
		...
		say "[VioletVoyeurKo]";
	WaitLineBreak;
	say "      Violet jumps on you as soon as the door is closed and strips your [body of player] body. You peel off her own clothes while she presses against you, enjoying your naked shape, [if isTwinHere is 1] while Erin, true to his word, sits in a corner, and watches the show with eagerness[end if]. You return her hug and feel your arms sink into the soft, grey-white fur. Giving you no time to rest, Violet grabs your neck, and press your [face of player] against hers in a passionate french kiss.[if isTwinHere is 1] Erin scoffs, clearly enjoying his sibling's endaevor. The sound of pants unzipping makes your glance at him for a second, and you catch him already stroking the bulge of his underpants.[end if] The feeling of Violet's bosom brushing against your [Breast Size Desc of player] chest fills you too with arousal and anticipation. 'I can feel [if player is not defaultnamed][name of player] Jr [else]your [cockname of player] cock [end if]down there. Should I take care of it?' she asks, before play-biting your neck. You nod[if isTwinHere is 1]; you can also hear Erin mumble 'Yeah, totally...'.[else].[end if]";
	...
	if cocks of player is 1:
	  ...
	  if cocks of player is 3:
		say "     A twisted idea crosses your mind. you take the opportunity of a pull to line your third cock against the entrance of her pussy, then slam in again. Violet's eyes open wide as her vagina are forced to stretch even more to accomodate the second entry. 'Oh my gawd! Oh fuck! [if player is not defaultnamed]S-Stop, [name of player], this is... [end if]Too much! Ah! Ah! Aaah!' Her shouts only serve to fuel the sexual beast inside of you, as you give Violet a pounding for the ages[if isTwinHere is 1] with her sibling's vocal approval[end if].";
		say "     Several times, you feel her inner muscles contract, and you could swear that she had cummed each of these times, but your own explosive climax would only come after several minutes of intense sex. Your vision flashes white, and you press Violet against the wall so hard that, in a corner of your brain, you worry that you are not squeeshing her. The spasms of your cocks reverberate throughout your entire body, as every single drop of your semen is dutifully taken in by the female rat's womb and ass.";
...
instead of going to Restaurant while HP of Erin > 2 and Rat Twincest is not resolved and a random chance  of 1 in 4 succeeds:
	...
	if player consents:
		...
		say "     They go at it in this fashion for several minutes, with Erin meekly trying to struggle under Violet as she relentlessly sucks on his member. Eventually, she lets it pop out of her muzzle, and being to polish it, making Erin jump under her. 'What's that?' she asks. 'Being embarassed? You? What are you -uhn- embarassed of? Of being dommed by your big sis? Of -oh- letting [if player is not defaultnamed][name of player] [else]our friend [end if]know that you have the hots for me? Is it -f...- because you are ashamed of these big, rat balls of yours?' As she asks this, she lightly squeezes the certainly oversized package of her sibling, who moans loudly in response. 'Or is it because big sis is going to make you cum -ah ahh- and -uhn- swallow it to the l-last drop?'";
...
to say ErinConsolesViolet:
	...
	WaitLineBreak;
	say "     Erin opens the door on Violet stumbling forward. You can see that her naked body has been completley turned into an anthropomorphic rat's. Erin catches her in his arms. 'I'm here, sis.' You can not see Violet's face really well, but you see her entire body trembling violetly. Something drips from between her legs.";
