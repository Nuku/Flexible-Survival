...
to say ratTwincest:
	...
	if player consents:
		...
		say "     They go at it in this fashion for several minutes, with Erin meekly trying to struggle under Violet as she relentlessly sucks on his member. Eventually, she lets it pop out of her muzzle, and being to polish it, making Erin jump under her. 'What's that?' she asks. 'Being embarrassed? You? What are you -uhn- embarrassed of? Of being dommed by your big sis? Of -oh- letting [if player is not defaultnamed][name of player] [else]our friend [end if]know that you have the hots for me? Is it -f...- because you are ashamed of these big, rat balls of yours?' As she asks this, she lightly squeezes the certainly over-sized package of her sibling, who moans loudly in response. 'Or is it because big sis is going to make you cum -ah ahh- and -uhn- swallow it to the l-last drop?'";
