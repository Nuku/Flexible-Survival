...
to RatTwinsQuestLog:
	if HP of Erin is:
		-- 1: say "[bold type]The Rat Adventurers[roman type]: I helped a couple of rats who got into trouble with a gang of sharks, on the beach. They wrote a note for me. It said they would be [bold type]at the Restaurant upstairs[roman type].";
		-- 2: say "[bold type]The Rat Adventurers (COMPLETED)[roman type]: I made acquaintance with Erin and Violet, the rat twins. I should visit them from time to time.";
...
Description of Erin is "     Erin is one half of the pair of adventuring rats whom you saved from the pirate sharks. He looks fairly young, eighteen if you had to guess, and shares a lean and energetic build with his sister. His youthful face seems always alert for some mischief, azure eyes scanning the surroundings and throwing longing looks at his sister whenever their eyes meet. Like his false twin, his fur is mostly snow white, like his hair, with dark gray patches here and there. He wears a pair of army pants but no top, giving him a bad boy look. The backside of his pants have been cut open with scissors, to let his hairless tail wiggle freely behind him. Noticing that you look at him, Erin leans on a table and winks at you while he takes the pose.[line break]".
fuckscene of Erin is "[ErinSexMenu]".
icon of Erin is Figure of Erin_face_icon.
Scent of Erin is "     Erin's fur retains the salty smell coming from the ocean. The rat looks at you quizzically. 'Why are you sniffing like this? Am I smelling?' he asks, a concerned look on his face.".

Part B - Dialogue

instead of conversing Erin:
	project the figure of Erin_face_icon;
	say "     '[one of]We are twins. False twins, to be more precise. Violet was born first, and I followed, like, twenty minutes after. And of course, she can't help but treat me as the little brother[or]The pants? A strange coyote guy threw them at me while I was strolling the streets. He seemed in a hurry to do some kind of trick[or]Me and my sister, we look out for each other since the whole mess started. We helped each other remaining sane. Especially when the heat was starting to take over. But I'm saying too much[or]You like the tail sleeve? I think it looks cool. There's a cat lady holding a clothes shop at the mall. She made it for me[at random].'";
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if Player consents:
					...
					if title entry is:
						-- "Fuck Erin":
							say "[ErinFuckTop]";
							NPCSexAftermath Erin receives "AssFuck" from player;
						-- "Bottom for Erin":
							say "[ErinFuckBottom]";
				now isTwinHere is 0;
				LibidoLoss 50;
...
to say ErinFuckTop:
	...
	say "[line break]     [bold type]Do you agree to let Violet watch you and Erin make love?[roman type][line break]";
	...
	WaitLineBreak;
	say "     You quickly apply the remaining lube on your fingers onto your still hard cock, and stroke your [Cock of Player] member[smn] a little. Once you deem yourself ready, you press yourself against Erin's rump for a moment. [if Cock Count of Player > 1]You let your [Cock Count of Player] cocks grind against the plump behind, tainting the clear fur with your pre, before grabbing one and lining it with the rat's hole[else]You let your [cock size desc of Player] grind against the plump behind, tainting the clear fur with your pre, before grabbing it and lining it with the rat's hole[end if]. You push, slowly. [first time]Erin whines from having his sphincter stretched for the first time. You go in progressively, pushing in then pulling out, until the male is relaxed enough to let your glans slip past his anal ring without protest. [only]Erin lets out a long moan as you slowly dig in his hole and bottom out[if isTwinHere is 1]. Violet startles you as well, letting out a loud shrill as she came from watching her brother being taken. 'S-Sorry,' she pants. 'It-it was too much. So hot.' 'F-fuck, sis...' her twin groans, visibly excited as well[end if].";
	say "     You pump Erin nice and slow, reveling into the calm, peaceful mood of the moment. [if isTwinHere is 1]Even Violet's badly covered moans, as she tries to rile herself for another climax, have eventually become part of the environment, and they do not bother you anymore. They do excite Erin terribly, however. [end if]As the teenager rat is now used to your [cock size desc of Player] [Cock of Player] cock, you pick up the rhythm, and the slaps of your pelvis against Erin's butt joins the concerto of moans coming from you and [if isTwinHere is 1]both twins[else]your partner[end if].";
	WaitLineBreak;
	say "     Erin suddenly grunts. 'Oh. Oooh. [if Player is not defaultnamed][name of Player], [end if]I'm... I'm cumming. Aaah!' His member, that he did not stop to stroke for a single moment since you started, spurts several ropes of semen on the already cum-stained cot. The intense pressure of the tight rodent around your member have you climax in turn, and you throw your own load inside Erin[if Cock Count of Player > 1], his thighs and the cot below[end if][if isTwinHere is 1]. Violet comes for the second time, this time from four of her fingers furiously mashing inside her pussy, while the other frantically flicks her pleasure button, and an impressive gush of fem-cum squirts out from her lower lips[end if].";
...
Description of Violet is "     Violet is one half of the pair of adventuring rats whom you saved from the pirate sharks. She looks fairly young, maybe eighteen if you had to guess, and shares a lean and energetic build with her brother. Her youthful face seems always alert for some mischief, azure eyes scanning the surroundings and throwing longing looks at her brother whenever their eyes meet. Like his false twin, his fur is mostly snow white, like her hair, with dark gray patches here and there. Her hair is made up in unruly dreadlocks, dyed in several neon colors, although the color looks worn out, hair dyes must be rare in these times. Violet wears a black bra and a pair of used denims. She seems also fond of leather accessories: she wears a choker, a spiked wristband, and adorned her tail with bangles made of old leather belts. Noticing that you look at her, Violet grins, then flashes her breasts at you: 'Izzat what you want to see? Ha ha... Perv['].' She winks at you and pulls up her bra.[line break]".
fuckscene of Violet is "[VioletSexMenu]".
icon of Violet is Figure of Violet_face_icon.
Scent of Violet is "     Violet's fur smells of sea salt, despite visibly taking great care of her fur. 'I smell of salt, right?' she asks, guessing your thoughts. 'Goddammit. And I keep taking showers, though.".

Part B - Dialogue

instead of conversing Violet:
	project the figure of Violet_face_icon;
	say "     '[one of]What about my clothes? What's the point anyway: as soon as I find something neat to wear, I get pounced on, and they get destroyed. Do you believe me if I tell you that these ones were originally a barely-used pair of yoga pants?'[or]Daaamn, I'm bored. Nothing to do here except ogle at the beach goers. Then again, this orca lifeguard is one gorgeous piece of fish meat... Why are you looking at me? Did I say something stupid?'[or]Before you ask: no, this is not [']emo[']. I'm going for the punk rat look!'[or]My brother may not look like it, but he has one hell of a pair, under his pants. Probably a rat thing. How do I know that? W-why would you care? Piss off!'[at random]";
...
to say VioletFuck:
	...
	say "[line break]     [bold type]Do you agree to let Erin watch you and Violet make love?[roman type][line break]";
	...
	if Cock Count of Player is 1:
		...
		say "     Violet makes you lean on one of the walls, then drops down to her knees. She spends the next few minutes worshiping your crotch, licking eagerly at your [Ball Size Adjective of Player] [Balls] and your [cock size desc of Player] shafts. Eventually, as her tongue lashes reach one of your sensitive glans, she goes down on you. Her long muzzle allows her to take most of your [cock size desc of Player] without difficulty, and bob up and down, from the tip to the base and back. After a moment, she pops it out and swallows another length. You groan [if isTwinHere is 1]and Erin groans for you as well [end if]under the female rat's relentless assault, especially when she attempts to take several of your cocks at once, and pretty much succeeds thanks to her rodent physiology. At the same time, she prepares her pussy for you, slipping one then several fingers inside and pumping slowly. She uses the lubrication to relax her anus as well, knowing full well that you want to make the most use of your unorthodox package, and so did she. Once she is ready, she rises back up and whispers in your ear: 'I want you to pin me on this wall and spread. My holes. Open. Both of them[if isTwinHere is 1]. I want my brother to see inside my gaping holes once you're done[end if].' Her excitation reaches you, and you promptly oblige her request.";
		WaitLineBreak;
		...
		else if Cock Count of Player >= 4:
	...
	NPCSexAftermath Violet receives "PussyFuck" from Player;
	if Cock Count of Player > 1:
		NPCSexAftermath Violet receives "AssFuck" from Player;
...
to say VioletStrapOn:
	...
	if Cunt Count of Player > 1:
		...
		NPCSexAftermath Player receives "AssDildoFuck" from Violet;
		WaitLineBreak;
	else:
		say "     The rat-girl focuses her efforts on your pussy. She slides her tongue over and between your labia, while her left hand pinches and twists your pleasure button. [if Player is male]Her other hand plays with your male bits, polishing your shaft and squeezing your [Ball Size Adjective of Player] [Balls] on a whim. This turns you wet even faster. [end if]Deeming you ready, Violet stands up, and her small hands slam on your hips. 'Time to pop this cherry!' she says, before pushing her strap-on inside.";
...
to say ResolveEvent Pirate Standoff:
	...
	if Player consents:
		...
		if HermList is banned or HermList is warded:
			say "     'Aaarg! After them, ye pea-brained bastards!' the leader of the sharks shouts angrily. Her goons obey, and run after the young rats, while the captain turns her ire towards yourself. 'Ye freshwater pirate!' the pirate shark says. 'Praise the sea gods that we don't meet again!' And with that, she goes after the siblings as well, leaving you with the pride of having done a good deed. Just as you are about to leave, you notice a crumpled piece of paper where the male rat stood. You pick it up, and read: [italic type]Thks dude. Meet up @ food pl.[roman type]. The message has been hurriedly written, but you suppose that the food place is the restaurant upstairs.";
		else:
			say "     'Aaarg! After them, ye pea-brained bastards!' the leader of the sharks shouts angrily. Her goons obey, and run after the young rats, while the captain turns her ire towards yourself. 'Ye freshwater pirate!' The pirate shark shakes her fist angrily at you, and begins to climb the hill to teach you a lesson.";
...
after going to Restaurant while HP of Erin >= 2:
	[move player to Restaurant;]
	if vorelevel >= 2 and ublevel >= 2 and Strange Island is not resolved:
		if level of Erin is 0:
			...
			say "     [if Inner Predator is resolved]You disclose to the twins your own discoveries about Vohr Island. 'So you found the same clues than us,' Violet says. 'Who would have guessed that the military base was used for such things.'[else]After jogging your memory a little, you remember that Vohr Island is, like its name implies, a small patch of land, a mile or so from the sea shore. You remember the pamphlets of the city's tourist office describing it as a mostly wild place, as a small military base is set there.[end if]";
		...
		say "[line break]     [bold type]Do you peep on the rodent twins?[roman type][line break]";
...
a postimport rule: [bugfixing rules for players that import savegames]
	if Rat Twins Invitation is not resolved:
		now Tied Rat Twins is unresolved;
		now Tied Rat Twins is inactive;
...
Tied Rat Twins is inactive.

when play begins:
	add Tied Rat Twins to BadSpots of FurryList;
	add Tied Rat Twins to BadSpots of MaleList;
	add Tied Rat Twins to BadSpots of FemaleList;
