...
to say ErinFuckBottom:
	...
	if player consents:
		...
		say "[ErinVoyeurKo]";
	WaitLineBreak;
	say "     Erin and you take your time peeling each other clothes, exploring each other's body[if isTwinHere is 1] while Violet, true to her word, sits in a corner, and watches the show eagerly[end if]. He lets you pass your fingers on his soft, grey-white fur while his own limbs run down your [body of player] back. Your two heads slowly lock with each other in a long and passionate french kiss. [if isTwinHere is 1]You can hear Violet's breath accelerate as her sibling and you get lost into your passions. When you take the time to give her a peripheral look, you notice her hands are already cupping her breasts and her crotch in an absent-minded manner. [end if]The feeling of Erin's member brushing against your [if cocks of player is 1]own [cockname of player] erection[else if cocks of player > 1]pack of erected penises[else]stomach[end if] fills you with arousal and anticipation. 'Should I help you get ready?' he asks softly. You nod[if isTwinHere is 1]; Violet nods as well[end if].";
...
to say VioletFuck:
	...
	if player consents:
		...
		say "[VioletVoyeurKo]";
	WaitLineBreak;
	say "     Violet jumps on you as soon as the door is closed and strips your [body of player] body. You peel off her own clothes while she presses against you, enjoying your naked shape[if isTwinHere is 1] while Erin, true to his word, sits in a corner and watches the show eagerly[end if]. You return her hug and feel your arms sink into the soft, grey-white fur. Giving you no time to rest, Violet grabs your neck, and press your [face of player] against hers in a passionate french kiss. [if isTwinHere is 1]Erin scoffs, clearly enjoying his sibling's endeavor. The sound of pants unzipping makes your glance at him for a second, and you catch him already stroking the bulge of his underpants. [end if]The feeling of Violet's bosom brushing against your [Breast Size Desc of player] chest fills you too with arousal and anticipation. 'I can feel [if player is not defaultnamed][name of player] Jr[else]your [cockname of player] cock[end if] down there. Should I take care of it?' she asks, before play-biting your neck. You nod[if isTwinHere is 1]; you can also hear Erin mumble 'Yeah, totally...'[else].[end if]";
