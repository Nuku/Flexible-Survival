...
to say VioletFuck:
	...
	if player consents:
		...
		say "[VioletVoyeurKo]";
	WaitLineBreak;
	say "      Violet jumps on you as soon as the door is closed and strips your [body of player] body. You peel off her own clothes while she presses against you, enjoying your naked shape, [if isTwinHere is 1] while Erin, true to her word, sits in a corner, and watches the show with eagerness[end if]. You return her hug and feel your arms sink into the soft, grey-white fur. Giving you no time to rest, Violet grabs your neck, and press your [face of player] against hers in a passionate french kiss.[if isTwinHere is 1] Erin scoffs, clearly enjoying his sibling's endaevor. The sound of pants unzipping makes your glance at him for a second, and you catch him already stroking the bulge of his underpants.[end if] The feeling of Violet's bosom brushing against your [Breast Size Desc of player] chest fills you too with arousal and anticipation. 'I can feel your [cockname of player] cock down there. Should I take care of it?' she asks, before play-biting your neck. You nod[if isTwinHere is 1]; you can also hear Erin mumble 'Yeah, totally...'.[else].[end if]";
	...
	if cocks of player is 1:
	  ...
	  if cocks of player >= 4:
		say "     A twisted idea crosses your mind. you take the opportunity of a pull to line an additional cock against each entrance, then slam in again. Violet's eyes open wide as her two holes are forced to stretch even more to accommodate the second entry. 'Oh my gawd! Oh fuck! Too much! My ass! So big! Aaaah!' Her shouts only serve to fuel the sexual beast inside of you, as you give Violet a pounding for the ages[if isTwinHere is 1] with her sibling's vocal approval[end if].";
...
instead of going to Restaurant while ratTwinsStatus is 2 and Rat Twincest is not resolved and a random chance  of 1 in 2 succeeds:
	...
	if player consents:
		...
		say "     They go at it in this fashion for several minutes, with Erin meekly trying to struggle under Violet as she relentlessly sucks on his member. Eventually, she lets it pop out of her muzzle, and being to polish it, making Erin jump under her. 'What's that?' she asks. 'Being embarassed? You? What are you -uhn- embarassed of? Of being dommed by your big sis? Of -oh- letting our friend know that you have the hots for me? Is it -f...- because you are ashamed of these big, rat balls of yours?' As she asks this, she lightly squeezes the certainly oversized package of her sibling, who moans loudly in response. 'Or is it because big sis is going to make you cum -ah ahh- and -uhn- swallow it to the l-last drop?'";
