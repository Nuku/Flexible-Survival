	...
	if bodyname of player is "Ashen Breeder":
		if humanity of player < 10:
			...
			if cunts of player > 0 and "They Have Your Eyes" is not listed in feats of player and "Sterile" is not listed in feats of player:
				...
				if T is 3:
					say "a herd of cattle who capture you.  You are mounted and fucked repeatedly by the bulls while fed milk from the cows.  Much to your delight, your womb grows quite full with their young.  These calves gestate quickly and are pure cows like their fathers.  You are bred again and again, birthing numerous calves to add to the growing herd's strength.";
			...
			otherwise:			[F non-breedable]
				if T is 1:
					say "a large wolverine guarding a historic building.  Once the home of a famous writer, the house has been maintained for its historic value and the wolverine has taken to guarding it aggressively.  He captures you and pins you down, fucking you repeatedly.  But instead of driving you off after draining his hefty balls into you, he drags you inside and keeps you in one of the bedrooms, adding you to his fixation.  He is a rambunctious lover, pounding into you hard and deep, much to your delight when not on watch.  Otherwise, he leaves you to yourself to enjoy the lovely home he's given you.  And while you cannot leave, you feel little need to do so, as your guard gives you plenty of sex to satisfy your cravings.";
				if T is 2:
