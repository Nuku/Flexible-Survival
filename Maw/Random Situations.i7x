...
[Instead of resolving Beast's Den:
	if perception of the tribe of player > 80:
		...
		if player consents:
			if Intelligence of the tribe of player > 50:
				say "";
			else:
				say "";
		else:
