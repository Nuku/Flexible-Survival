...
Instead of resolving Nerd's Opinion:
	...
	if tribe of player is gryphons:
		say "The lovely, motherly gryphon strides up to you with quite the smile on her face, 'Hey there chief!' She exclaimed, seeming to be quite excited about something in particular--what that would be though is a mystery to you. She steps foot and stands her ground in-front of you, smirk upon her beak all the while, 'You would not believe what the huntresses have found!' She wiggles in excitement before continuing, 'That crate you brought to me is by far one of the greatest treasures we could have hoped for. Children[apostrophe]s novels! Can you believe it?!' The gryphon woman jumps up with quite a bit of enthusiasm, 'We can now help teach our young morals, and better prepare them for choices in life! We[apostrophe]ll start having people write copies of the books for their future families!'[if  (perception of the tribe of player) is greater than 50] She quickly pulls a familiar book from her lab-coat[apostrophe]s pocket, offering it to you with a warm smile, 'Here, I heard you took interest in this book when the crate was found.' She hands you the small novel entitled, [apostrophe]Of Mice and Men[apostrophe].[end if] She prances away with a skip in her step. Boy--was she excited! Then again, with how motherly she always is, it doesn't come much as a surprise she would be so excited by some books.[line break][line break]";
...
[Instead of resolving Beast's Den:
	if perception of the tribe of player is greater than 80:
		say "Your hunters have informed you of a nearby cave, which they believe is inhabited by a large creature of some sort. They decided that it wouldn[apostrophe]t be a great idea to explore, and was far to risky to attempt.[line break][line break]";
	otherwise:
