				...
				if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
					...
					if player consents:
						...
						if nam is "Strength training":
							say "[strtraining]";
						otherwise if (nam is "Dexterity training"):
							say "[dextraining]";
						otherwise if (nam is "Stamina training"):
							say "[statraining]";
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if player consents:
					...
					if nam is "Naked wrestling":
						say "[wrestlesex]";
					otherwise if (nam is "Shower sex"):
						say "[showersex]";
					otherwise if (nam is "Endurance sex"):
						say "[endurancesex]";
					otherwise if (nam is "Leave"):
						say "You decide not to fuck Randy right now.";	
		
to say strtraining:
	say "     You hand over the freecreds and Randy leads you over to the weight-lifting equipment, directing you to an unused set. He looks you over, formulating your workout in his head. Instructing you on proper form, he gives you a beginner weight to test you out. [if strength of player > 25]You heft it over your head with one hand as easily as if it were made of feathers. Randy gives an awed whistle. 'Alright, now you're just showin['] off.  I doubt you'll get much in the way of trainin['] from this, but for my own curiosity, let me find something more, uh, suited to your abilities.'[otherwise if strength of player > 18]You heft it over your head with little effort. Randy nods appreciatively. 'Not bad. I doubt I'll be able to bulk you up more than that. Still, never a bad idea to keep yerself in top shape, eh?'[otherwise if strength of player > 13] It takes quite a bit of exertion from your part, but you're able to lift the weight... Just barely. Randy gives you an amused snort. 'Well, we'll start here, and work our way up. Definitely some room for improvin'.'[otherwise]Try as you might, you can't even begin to lift the weight. Randy gives a heavy sigh. 'I'll go an['] find somethin' lighter. We've got some work to do...'[end if]";
...
to say dextraining:
	...
	otherwise:
		...
		say "[line break]";
	now lastworkout is turns;
	say "      Randy comes up to you with a smile on his face and you note a slight bulge in his pants. 'Hey, uh...', he says embarassedly, '...You wanna grab a shower? You know, uh, together?'";
	if player consents:
		say "[showersex]";
		if hp of Randy < 2, now hp of Randy is 2;
	otherwise:
...
to say statraining:
	say "     You hand over the freecreds and Randy leads you over to a set of treadmills. He sets you up on one of them, starting you on a walking pace. He continually increases the pace [if stamina of player > 25]and you tackle each speed as easily as if you were taking a walk in the park. By the end of your session, you've practically run a marathon, but you find yourself only slightly winded; Randy practically gives you a standing ovation.[otherwise if stamina of player > 18]and you tackle each speed comptetently, managing to keep your pace on everything but the fastest sprint. You finally yield as you're about to be thrown off the treadmill by the high speed; Randy nods approvingly at your impressive performance.[otherwise if stamina of player > 13]and you try your best to keep pace with the treadmill, huffing and puffing as you push your stamina to the limit. Randy tries to cheer you on, but you have to yield far sooner than you wanted to, gasping for breath.[end if]";
	decrease freecred by workoutprice;
...
to say wrestlesex:
	...
	if player consents:
		if a random chance of wrestlechance in 100 succeeds: 			[success - player tops]
			...
			if player consents:			[Oral]
				...
				otherwise:
					say "You press your asshole down into Randy's muzzle harder, and he obliges, tonguefucking your hole with more force. Sometimes he pulls back to tease your ring before diving his muzzle back between your buttcheeks, penetrating you deeply his his thick tongue. You moan as he drives you to an anal orgasm, your muscles spasming around his thick tongue as your rear blooms with warm pleasure.";
				if waiterhater is 0, wait for any key;
				say "     Randy's hand is flying up and down his cock now, and he cums with a tensing of muscles and a grunt, spurting rhino cum over the both of you. You disentangle your bodies, collapsing on the padded floor side by side, panting after your session. Randy smacks his lips dramatically, cleaning stray juices from his muzzle. [if hp of Randy is 0]'Damn, haven't been fucked like that in a long time!'[otherwise]'Fuck, you're good at that!'[end if], Randy pants. 'Rematch sometime?', he says hopefully as you disentangle your bodies. He finds a towel and you dry off before getting your gear together and leaving.";
				infect "Rhino";
	...
	say " You feel your orgasm rapidly approaching, and you tighten your legs around Randy as he leans over you, increasing the speed and intensity of his thrusts. He hilts himself deep inside you and comes with a great bellow, and you feel your [if cunts of player > 0]womb[otherwise]rectum[end if] fill with hot, thick rhino seed[impregchance]. You're not far behind him, thanks to his stimulation, and you [if cocks of player > 0]shoot your own [cum load size of player] load across your chest[otherwise if cunts of player > 0]cry out as pleasure blossoms in your lower half your cunt clenches around his thick manhood[otherwise]cry out as pleasure blossoms in your lower half and your ass clenches around his thick cock[end if].";
	say "     [if hp of Randy is 0]'Damn, haven't had that good of a fuck in a long time!'[otherwise]'Fuck, you're good at that!'[end if], Randy pants. 'Rematch sometime?', he says hopefully as you disentangle your bodies. He finds a towel and you dry off before getting your gear together and leaving.";
	infect "Rhino";
	now lastfuck of Randy is turns;
...
to say showersex:
	...
	say "     Soon he's groping your rear, his erect cock pressed against your [if cocks of player > 0]own[otherwise]belly[end if] as he gives you a lusty smile. It seems your rhino has lusty intentions for you and is about to make his move. Would you rather suck him off (Y) or have him fuck you (N)?";
	if player consents: 			[give him oral]
		...
		if "Less Anal" is  not listed in the feats of the player:
			say "[line break]";
	...
	otherwise:					[fuckin']
		...
		otherwise:				[pushed facefirst into wall]
			...
			if waiterhater is 0, wait for any key;
			say "     With only the warm water of the shower and Randy's copious precum, he manages to pop the flared head inside your [if cunts of player > 0]cunt[otherwise]ass[end if] as you grunt in unison. He begins with short thrusts, penetrating deeper on each time until his hefty balls come to rest against your bare ass. He leaves himself hilted inside you, and you clench around his thick length while his hands roam your body [if cocks of player > 0]coming to grip your [cock size desc of player] [cock of player] cock, slowly stroking it[otherwise]stroking sensitive spots and tweaking your nipples, making you moan as your horned lover stimulates you inside and out.[end if].";
			if waiterhater is 0, wait for any key;
...
to say endurancesex:
	...
	if cocks of player > 0:	[Males and herms fuck him]
		...
		otherwise:			[Higher libido + stamina = more fuckin' power!]
