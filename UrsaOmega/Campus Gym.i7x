...
to say statraining:
	say "     You hand over the freecred and Randy leads you over to a set of treadmills. He sets you up on one of them, starting you on a walking pace. He continually increases the pace [if stamina of player > 25]and you tackle each speed as easily as if you were taking a walk in the park. By the end of your session, you've practically run a marathon, but you find yourself only slightly winded; Randy practically gives you a standing ovation.[otherwise if stamina of player > 18]and you tackle each speed competently, managing to keep your pace on everything but the fastest sprint. You finally yield as you're about to be thrown off the treadmill by the high speed; Randy nods approvingly at your impressive performance.[otherwise if stamina of player > 13]and you try your best to keep pace with the treadmill, huffing and puffing as you push your stamina to the limit. Randy tries to cheer you on, but you have to yield far sooner than you wanted to, gasping for breath.[end if]";
	decrease freecred by workoutprice;
