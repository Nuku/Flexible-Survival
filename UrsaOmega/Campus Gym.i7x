...
Description of Randy is "A tall, muscular male rhino-man wearing a tank top and track pants. A nametag states his name as simply 'Randy'. From the way he walks around the gym floor helping people, you suspect he's a former (current?) staff member of the gym.".
...
to say wrestlesex:
	...
	if Player consents:
		if a random chance of wrestlechance in 100 succeeds: [success - player tops]
			...
			say "     You work your way down his front, licking and nipping at his tough skin, until you come to his stiff manhood. You take a good whiff of his masculine musk before leaning back to survey his entire body again[if Player is male], your own cock painfully hard[else if Player is female], your cunt wet with arousal[end if], and you find yourself with a choice between using his mouth (Y) or going for his [if Player is male]ass[else]cock[end if] (N).";
			if Player consents:			[Oral]
				say "     You move your body over Randy's prone form, straddling him and presenting him with your [if Player is male][cock size desc of Player] [Cock of Player] cock[else if Player is female]wet cunt[else]asshole[end if]. He licks his lips eagerly before diving in, [if Player is male]licking up your length with his thick tongue[else if Player is female]teasing your labia with his thick tongue[else]teasing your tight anus with his thick tongue[end if]. Soon he's [if Player is male]engulfed your entire length in his muzzle, suckling on it and caressing it with his tongue[else if Player is female]tongue-fucking you while sucking on your clit intensely[else]tongue-fucking your ass enthusiastically[end if].";
				if Player is male:
...
to say showersex:
	...
	say "     Soon he's groping your rear, his erect cock pressed against your [if Player is male]own[else]belly[end if] as he gives you a lusty smile. It seems your rhino has lusty intentions for you and is about to make his move. Would you rather suck him off (Y) or have him fuck you (N)?";
