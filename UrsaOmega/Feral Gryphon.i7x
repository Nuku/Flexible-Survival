...
to say feralgryph_milk01:
	...
	if bodyname of player is "Feral Gryphon" or facename of player is "Feral Gryphon":
		now gryphtype is 2;
	else if bodyname of player is "Hermaphrodite Gryphon" or facename of player is "Hermaphrodite Gryphon":
		now gryphtype is 1;
	...
	if bodyname of player is "Feral Gryphon":
		if humanity of player < 10:
			if player is pure and HP of Garrett >= 7 and cocks of player > 0 and cunts of player is 0:
				...
				if cocks of player > 0 and player is not mpreg_ok:
					...
					say "     Much to your surprise, you come across a handsome male gryphon while out hunting one day. It takes some convincing, but with some fresh meat and a display of your tight, fertile tail-hole you're able to lure him back to your nest; where you begin a very awkward courtship ritual. It concludes with him on top of you, filling your ass with thick gryphon knot and your egg chamber with warm seed. You cuddle with your new mate in your nest, looking forward to laying your clutch of eggs... Then getting filled with another.";
					if gryphoness is tamed:
