...
to say losetoimpalaguy:
	if a random chance of 1 in 4 succeeds and inheat is false:	[occasional oral if player is not in heat]
		say "     [if hp of player > 0]When you give in to the impala's advances, the successful male chuckles and pushes you down onto your knees[otherwise]Worn out from your fight, you cannot resist as the impala man pushes you to your knees[end if].  'I'm going to have a little fun with you, little [if cunts of player > 0]ewe[otherwise]ram[end if],', he says lustily.  He strokes his above-average cock against your cheek, the musky scent filling your nose and making [if player is submissive]your submissive urges well up[otherwise if cunts of player > 0]your pussy wet with its virility[otherwise]your mouth water a little[end if][if hp of player > 0] despite yourself[end if].  Feeling a little light-headed, you part your lips as he brushes his dribbling glans across them.  After a lick to sample his taste, your mouth welcomes it in.";
		say "     The victorious stud chuckles and grabs your head, thrusting into your mouth as you do your best to lick and suck as he does.  Each time he pulls back, he leaves just his tapered glans in your mouth, allowing you a moment to suck on it firmly while your tongue plays across it.  His throbbing manhood drools richly musky pre into your mouth and his crotch fur is heavy with his scent as well.  You're reduced to an eager, cocksucking slut as you lose yourself in the moment.  And when his climax comes, you're fed a gooey load of impala cum that you swallow down with a thirst for more.  But done with you for now, the impala stud pushes you back, leaving you to land on your ass.  'That's enough for now, little [if cunts of player > 0]ewe[otherwise]ram[end if][if player is impreg_ok].  Maybe next time I'll give you the breeding you deserve and put a fawn in your belly[otherwise].  I might not be so generous next time you stray into my territory[end if].'  And with that said, he drives you off with a firm swat on your ass.";
	otherwise if player is impreg_able or ("Submissive" is listed in the feats of the player and cunts of player is 0): [male and female, can be impregnated or submissive]
		say "     [if hp of player > 0]Giving in to the impala's advances, the successful male grabs you in his slender arms[otherwise]Exhausted from your fight, you nearly fall over, but the impala man rushes forward to catch you with his slender arms[end if]. 'You're mine now, little ewe...', he says lustily. The presence of the strong male triggers [run paragraph on]";
		...
		if "Submissive" is listed in feats of the player and cocks of player > 0 and player is not impreg_able:
	...
	otherwise:
		...
		otherwise if cunts of player > 0 and player is not impreg_now: [can't be impregnated, is not currently pregnant and female]
		...
		otherwise if player is impreg_now: [male and female, already pregnant]
	...
	if libido of player > 20:
		...
		if the player consents:
			if cocks of player > 0:							[male+herm]
				...
				otherwise:
					say "     With the impala woman collapsed to her knees in front of you, she pants heavily and looks up at you with desire.  'You... you're so strong.  A stud like you would make a worthy mate,' she moans, moving to sit back, spreading her legs.  Knowing she wants it badly, you set aside your gear and stroke your stiffening cock with one hand.  After bringing it to her muzzle so she can suck and lick your [cock size desc of player] [cock of player] fully hard, you move into position.";
			...
			otherwise:						[neuters get the best victory scene - victory massage+cuddles!]
...
to say beatimpalaguy:
	...
	if libido of player > 20 and (cocks of player > 0 or cunts of player > 0): [non-genderless victory scenes]
		say "Your libido gets the better of you, and you consider showing the impala his place by [if cocks of player > 0]taking his tailhole[otherwise]having him eat your pussy[end if]. Do you want to?";
		if player consents:
			...
			otherwise if cunts of player > 0: [female victory]
	...
	otherwise: [genderless + low libido]
...
When Play begins:
	...
	now attack entry is "[one of]The impala dashes at you, landing a well placed punch![or]The impala rushes you, hitting you with a full-bore headbutt![or]The impala lands a nasty kick from one of its powerful legs![at random]";	[Text used when the monster succeeds on an attack]
