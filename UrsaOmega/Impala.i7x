...
to say losetoimpalaguy:
	if player is impreg_able or ("Submissive" is listed in the feats of the player and cunts of player is 0): [male and female, can be impregnated or submissive]
		say "     Exhausted from your fight, you nearly fall over, but the impala man rushes forward to catch you with his slender arms. 'You're mine now, little ewe...', he says lustily. The presence of the strong male triggers [run paragraph on]";
