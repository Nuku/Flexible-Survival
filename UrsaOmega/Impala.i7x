...
to say losetoimpala:
	if impalamode is 0:
		...
		say "     '[if Player is male]Hrmph. Not a worthy male after all. Looks like I'm going to have to find someone else to father a strong child for me. Still, you could be of some use to me...' she says while advancing on you.[else]Yeah! That'll teach you to come around my territory!' she says, before a smug look crosses her face. 'However, you could still help me out...'[end if]";
		...
		if a random chance of 1 in 4 succeeds and inheat is false:	[occasional oral if Player is not in heat]
		...
		else if Player is impreg_able or (Player is submissive and Player is not female): [male and female, can be impregnated or submissive]
			say "     [if HP of Player > 0]Giving in to the impala's advances, the successful male grabs you in his slender arms[else]Exhausted from your fight, you nearly fall over, but the impala man rushes forward to catch you with his slender arms[end if]. 'You're mine now, little ewe...' he says lustily. The presence of the strong male triggers [if Player is impreg_able]a need to have your womb filled and your belly swell with child[else]your submissive nature[end if] and you feel a little light headed. 'You'd make a fine addition to my herd...' he says huskily into your ear, before leaning in for a kiss. Lost in his musk, you eagerly return the kiss, mashing your own [FaceSpeciesName of Player in lower case] face against his sleek muzzle. He reaches one cloven hand behind you to squeeze and grope your [bodydesc of Player] body. You allow yourself to be guided into all fours, with the impala behind you on his knees, rubbing his growing slender erection against your rear. [if Player is female]He sticks his muzzle between your legs, breathing in your fertile scent. 'Mmm... I love the scent of needy ewes. Don't worry, you're going to feel so good when your belly swells with my fawn...' [else if Player is mpreg_able]He stops for a moment and brings his nose down to your fertile rear end. He smells deeply for a second, then says, 'Hrm... Smells like you have a womb in there. Just need a big ram to come and fill you up. You're going to feel so much better when you have my fawn in your belly.' [else]'You just want a big, strong male to dominate you, don't you? You're just a submissive little ewe. That's alright, I'm gonna take care of you. You'll feel so much better when I fill you up.' [end if]You shudder with need as you feel his erection press against your entrance. He rubs the tip against your [if Player is not female]pucker[else]labia[end if], letting his precum lube it. Consumed by your lust for this strong, lithe impala, you push back on his rod, his narrow glans breaching you with a slight pop. The impala rolls his hips, gently working more of his length into your [if Player is not female]back passage[else]vagina[end if][if Player is male]. You let out a soft moan as his tapered tip brushes past your prostate, making your own painfully hard cock dribble a bit of your own pre. Soon he's fully hilted his slender breeding tool inside you, his balls coming to rest on your own[end if][if Player is female]. He angles his thrusts to maximize the stimulation to your clit, making you moan under him. Soon he's hilted his slender breeding tool inside you, his tapered tip pushing at your cervix[end if].";
			...
			CreatureSexAftermath "Player" receives "[if Player is female]Pussy[else]Ass[end if]Fuck" from "Impala";
		else:
			if player is not impreg_now: [Can't be impregnated, is not currently pregnant]
				say "     The impala man [if Player is male]gives you a violent kick to the ground before saying, 'Next time, don't come around a stronger male's territory!'[else]smells you and frowns, then gives you a violent kick to the ground. 'Hrmph. You're no use to me if I can't put my fawn in you. Come back when you're ready for breeding.'[end if]";
...
to say impaladesc:
	if impalamode is 0:
		say "     You hear the sound of swift footsteps and you turn to see a female figure approaching you in a sort of half prance, half run. She has a thin, lithe body covered in reddish brown fur, with a white patch on her belly. She has perky breasts and her female sex is engorged with need. Her long muzzle is pointed at you, [if Player is male]and her large doe eyes are filled with lust. 'Finally, a male to satisfy me! But are you worthy?' [else if Player is female]locking eyes confrontationally with yours. 'A female in my territory? I'll teach you to not take my males from me!' [else]and her eyes are filled with confusion as she tries to figure out which gender you are. 'What kind of creature are you?' [end if]the impala woman exclaims. She rubs a perky breast with one hoof-like hand while the other reaches down between her legs to play with her engorged sex a bit before charging you!";
	else:
		say "     You hear the sound of swift footsteps and you turn to see a male figure approaching you in a sort of half prance, half run. He has a slender, lithe body covered in reddish brown fur, with a white patch on his belly. Twin twisting horns curve impressively from his head and between his legs hangs a substantial sheath and pendulous balls. His long muzzle is pointed at you, and his eyes are [if Player is male]locked confrontationally with yours. 'Ah, a challenger for my territory!' [else if Player is female]filled with lust at the sight of your feminine form. 'Ah, another female for my harem!' [else]filled with confusion as he tries to figure out which gender you are. 'What kind of creature are you?' [end if]the impala man exclaims. He charges you!";

Section 2 - Creature Insertion

Table of CombatPrep (continued)
name(text)	PrepFunction(text)
"Impala"	"[PrepCombat_Impala]"

to say PrepCombat_Impala:
	...
	if MaleList is banned and FemaleList is banned:		[if both types are banned, the fight is aborted and removed from critter table]
		...
		if MaleList is banned:
			...
			now impalamode is 1;
		else:	[hunting results in 2/3rds chance to get unwarded option]
...
When Play begins:
	...
	now face entry is "that of an impala, with a long graceful neck and deerlike muzzle, and topped with large alert ears[if Player is male]; large, twisty horns jut out of your forehead, displaying your virility[end if]"; [ Face description, format as "Your face is [Face of Player]." ]
