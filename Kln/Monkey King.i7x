...
When Play begins:
	...
	now name entry is "Monkey";      [The creature's name as displayed and used in naming descriptions]
	now attack entry is "[one of]The Monkey King hits you in the head with his staff![or]The agile primate swipes your legs with his weapon. You fall on your ass as the arrogant creature does a backflip and laughs at you.[or]The monkey uses his staff as support and delivers a flying kick in your stomach.[or]The dexterous creature jumps and, with a somersault, lands behind you. As you turn back a furry palm hits you in the face and makes you stagger.[at random]";   [Text used when the monster succeeds on an attack]
	now defeated entry is "[beattheMonkeyKing]";            [ Text when monster loses.  Change 'template' as above. ]
	now victory entry is "[losetoMonkeyKing]";               [ Text when monster wins.  Change 'template' as above. ]
	now desc entry is "[MonkeyKingdesc]";                  [ Description of the creature when you encounter it. ]
