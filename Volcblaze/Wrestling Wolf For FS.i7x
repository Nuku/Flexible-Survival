...
to say beatthewrwolf:
	...
	otherwise:
		...
		if the player consents:
			...
			say "     Caught up in the exhileration of your success, you laugh mockingly like a victorious heel and grab the back of the wolf's trunks, pulling them down to bare his toned ass.  He gives a weak growl and tries to pull free, but you've taken the fight out of him and are easily able to get your cock lined up with his crinkled hole.  After giving yourself a few strokes to leak some precum onto it, you push that tight hole open with a soft moan[if wrwolfanal > 2], which he echoes with his own[otherwise], which he echoes with another growl[end if][if wrwolfanal is 1].  The wolf's tailhole is virginally tight and a delight to feel around your throbbing manhood[otherwise if wrwolfanal < 4].  The wolf's tailhole is quite tight and a delight to feel around your throbbing manhood[otherwise].  Becoming used to this kind of treatment, the wolf's tight tailhole relaxes to allow you entrance before squeezing down with its strong muscles to work over your throbbing manhood[end if].";
