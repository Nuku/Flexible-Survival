Wrestling Wolf For FS by Volcblaze begins here.
...
to say wrestlingwolfattack:
	...
	otherwise:
		if a random chance of 1 in 3 succeeds: [ Prefer female action]
			if cunts of player > 0:
			   ...
			   otherwise:
				...
				say "'There we go. Maybe now you[apostrophe]ll grow a nice little pussy for me,' the wrestler said pulling back up his briefs. He picks you up and tosses you out of his makeshift ring. 'Next time, either get stronger to give me a decent fight or at least grow a pussy for me ta use,' the Wrestler Wolf said eyeing you lustfully as you walked away still a bit sore and covered in his hot seed.";
				increase cunt width of player by 2;
				increase cunt length of player by 1;
		otherwise:
			if cunts of player > 0:
