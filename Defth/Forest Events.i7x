...
Instead of resolving a Small cave:
	if glowing mushroom is owned:
		...
		if player consents:
			LineBreak;
			say "     Eating the shrooms, you shrink in no time, your clothes quickly outgrowing you. Now finally at a stature that can fit in the hole with ease, you can explore what lies inside. The cave is small in nature, but still big enough to hold a nest comfortably. While exploring the place, you hear a small growl from behind you. Turning around you find the denizen of this place, a cougar, this one looking more feral than the others. She even has a sheath, and from what you can see, her cock is more spear-like than a normal human. The herm feline looks at you with curious eyes, like she has never saw someone so small before. The curious animal jumps at you, hunting you down like a cat would do to a mouse, jumping from one position to another as she tries to corner you. You are eventually captured in her paws, and you become her toy for a while, as the feline herm uses you to kill her boredom. She hits you sometimes, encouraging you to keep moving to her amusement.";
			say "     She is a cat, so maybe if you stopped moving, she would get bored of you and continue with what she was doing. She could also devour you, but your other choice is running away with all of your might, but if she did catch you again, who knows what she would do to you.";
