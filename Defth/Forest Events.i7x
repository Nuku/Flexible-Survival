	...
	if glowing mushroom is owned:
		...
		if player consents:
			...
			if vorelevel is 1: [no vore interest by the player]
				...
				say "You are eventually captured in her paws, and you become her toy for a while, as the feline herm uses you to kill her boredom. She hits you sometimes, encouraging you to keep moving to her amusement.";
