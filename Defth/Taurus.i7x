...
to say tauruswon:
	...
	if Player is female:
		...
		WaitLineBreak;
		say "     After a little while, his thrusts come slower, but at the same time, they go deeper inside of you. Every time the horny bull thrusts his enormous cock in and out of you, it's as if your insides are tugged along with it. His attack is more about strength than speed, pushing your body to the ground. Your face is planted on the grass, saliva soaking the ground in front of your eyes. Tears from the pain and pleasure of this encounter roll down your face. With time, you can't even think anymore, your body ravaged by orgasm after orgasm. If feels like electricity is running up your spine and directly to your brain, and you can feel his balls hitting against you now that almost his whole member is buried inside of your pussy. That gives you one small warning of what is about to come.";
		say "     His balls churn and move, and the beast moos to the top of his lungs, letting anyone nearby know that you are his property now. With a final push, he cums directly inside of your womb, and what feels like liters of cum rush inside of you[if Player is fpreg_ok] to become pregnant with his child. And you almost look pregnant now, your stomach inflating rapidly and making you almost throw up from the pressure inside of your body now[end if]. The hulking bull finally pulls his giant penis out of you, and it's followed by a jet of cum flying out of your own sex. You lay on the ground in a pool of cum as the bull goes back to his life of looking for others to impregnate now that he has done his job with you. Resting for a bit, you gather all of your stuff and go back to your adventures.";
...
"Taurus"	"[PrepCombat_Taurus]"

to say PrepCombat_Taurus:
...
When Play begins:
	...
	now MilkItem entry is "taurus milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
