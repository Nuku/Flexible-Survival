		...
		if Player consents:
			...
			if glowing mushroom is owned:
				...
				if Player consents:
					...
					say "     The horny dog's tongue pushes you to the back of his muzzle, brushing you against his teeth, before forcing you into a dark descent. You are crushed by the walls of flesh that surround you. It was difficult to breathe inside his mouth, but now, it's pretty much impossible. Your lungs burn with the lack of oxygen. Your head spins, and your vision is turning darker and darker by the moment. Your muscles scream in pain with the pressure, and your bones almost snap. The travel is almost hellish in nature until you finally drop into the beast's stomach. Now, the hell is fully realized.";
					if Player is male:
				...
				if Player consents:
					...
					WaitLineBreak;
					say "     Your captor finally bites down, holding you against the tight and lubed place. Twitching, tugging, and pulling you deeper towards the belly of the beast, the pain of being penetrated by his teeth destroys any sense of pleasure in this act. You can't see much, except for some snippets of light that shine into his mouth. Your [FaceSpeciesName of Player in lower case] head is chewed while his tongue holds you in place. The slippery sensation keeps pulling you deeper inside the beast's jaws, as it keeps squeezing you with its tightness. The pressure keeps building until your neck snaps, giving you a quick death. But you already knew what was going to happen after that.";
					now battleground is "void";
					the Player was ended by "Shrinking Shrooms eaten alive";
					trigger ending "Player has died";
					end the story saying "You were eaten alive!";
			...
			if Player consents:
				...
				if title entry is:
					-- "Try to find another way in":
						say "[LittleExplorer]";
					-- "Eat one of the mushrooms and enter through the hole":
						say "[LittleShroom]";
	...
	while sextablerun is 0:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if Player consents:
				...
				now sextablerun is 1;
				if title entry is:
					-- "Grab the supplies and run":
						say "[ChineseSupplies]";
					-- "Have fun with the sleeping husky":
						say "[ChineseUB]";
					-- "Go find where the sound is coming from":
						say "[ChineseTrouble]";
		else if calcnumber is 0:
			LineBreak;
			now sextablerun is 1;
...
to say ChineseTrouble:
	...
	say "     A male husky is pounding away at a smaller husky bitch like there is no tomorrow, his toned muscles rippling every time he pounds into the little bitch. Sometimes, she almost is pushed off of the bed by the sheer power in his thrusts, but the dominant dog quickly grabs her any way he can before that happens, even gripping her neck and momentarily choking her. No matter how harshly she is treated, the horny girl under the rutting husky enjoys the treatment, her tongue hanging out of her mouth as she pants loudly. She is drooling at being fucked like this too, making her fur glisten wetly and creating spots on the mattress.";
	WaitLineBreak;
	...
	if a random chance of 1 in 4 succeeds or (Player is maleinterested and Player is not femaleinterested and a random chance of 1 in 2 succeeds):
		...
		now sortorder entry is 2;
		now description entry is "Go back up the same hole you came through";
		[]
		choose a blank row in table of fucking options;
		...
		while sextablerun is 0:
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if Player consents:
					...
					now sextablerun is 1;
					if title entry is:
						-- "Kick him in the stomach (from the inside)":
							say "[AlphaKick]";
						-- "Try to climb out":
							say "[AlphaClimb]";
						-- "Dive down and seek the other exit":
							say "[AlphaDive]";
			else if calcnumber is 0:
				LineBreak;
				now sextablerun is 1;
...
to say AlphaDive:
	if a random chance of 1 in 4 succeeds or (anallevel is 1 and a random chance of 1 in 3 succeeds):
...
to say ResolveEvent Ballsy Hung Horseman:
	if Resolution of Ballsy Hung Horseman is 0: [was never CV'd by him]
		if carried of glowing mushroom < 1: [carrying no shrooms]
			...
			if Player consents:
				LineBreak;
				say "     He mentioned they could be found in a certain [bold type]mushroom cave[roman type]... Where could you find such a place? Perhaps some place [bold type]outside[roman type], who knows? Whatever you decide, you can always look for this [bold type]Ballsy Hung Horseman[roman type] again once you've got what he wants and discover what is so special about him...";
			else:
				LineBreak;
...
to say BHHScene1:
	if Resolution of Ballsy Hung Horseman is 0: [first time]
		...
		if Player consents:
			LineBreak;
			say "     Deciding to trust the equine guy, you let him know that you shall do as he requests, and ingest the glowing mushroom in front of him. 'Oh, good. Its effects should kick in soon.' The mischievous grin in the horseman's face is enough to unsettle you, but he never lied to you. Upon consuming the shroom, you see yourself shrinking before him, [if Player is not naked]slipping through your own clothes and gear, [end if]and as your size continues to decrease, his, in your perspective, just keeps on looking bigger. It does not cease until you are small as a mouse, standing as tall as his ankles, just above his hooves. Now, the horseman is looking over at you, unbuttoning his pants and freeing his massive endowment that comes swinging forward, growing rapidly to a full erection.";
			...
			if Player consents:
				LineBreak;
				say "     You realize that all this is actually turning you on, so there is no need to put on a struggle. Not that you would succeed, anyway. The horseman has you in his hand completely trapped, and all his cock does is continue to suck you in, deeper and deeper into that tight and throbbing flesh tube...";
			else:
				LineBreak;
		...
		if Player consents:
			...
			if "Stubbornly Alive" is listed in Feats of Player:
				...
				say "     ([link]Y[as]y[end link]) - Throw your last energy into maybe making it out after all!";
				say "     ([link]N[as]n[end link]) - Just give up and let yourself melt away.";
				if Player consents: [reform and survive!]
					LineBreak;
					say "     You do not really know how it all happened, the last thing in your memory being whatever sensations you were feeling in that horseman's sack... But you have made it out alive, after all. Your body retains a strange consistency after a while, which returns to normal briefly after. Once you are able to, you quickly look around for your stuff and get ready to continue your adventures. Maybe you should stay away from those mushrooms for a while...";
				else:
					now battleground is "void";
					the Player was ended by "Shrinking Shrooms cock vored";
					trigger ending "Player has died";
...
to say BHHFistCock:
	...
	if scalevalue of Player >= 4:
		...
		WaitLineBreak;
		say "     You do not see a reason to deny his request, and so, you pull your whole arm from his cock and resume the process with just shoving fingers in his slit until everything fits in. Naturally, this time around, it is a lot quicker to get both your hands in it, and as you begin to push, you feel only a slight sign of resistance. 'Ohh... I can already feel that...' he moans as both your palms push past his slit, the massive cock swallowing them past your wrist in only brief seconds, and you are then free to continue pushing them into it. Naturally, this pose feels a little more awkward to you, and you nearly lose your balance trying to thrust into his giant horsecock with your arms. 'You look so cute like that... Mmmh... Keep going...'";
		...
		if Player consents:
			...
			if "Stubbornly Alive" is listed in Feats of Player:
				...
				if Player consents: [reform and survive!]
					LineBreak;
					say "     You do not really know how it all happened, the last thing in your memory being whatever sensations you were feeling in that horseman's sack... But you have made it out alive, after all. Your body retains a strange consistency after a while, which returns to normal briefly after. Once you are able to, you quickly look around for your stuff and get ready to continue your adventures. Maybe you should stay away from that horseman for a while...";
				else:
					now battleground is "void";
					the Player was ended by "Cock Vore by Horseman";
					trigger ending "Player has died";
					end the story saying "You just got melted into cum while stuck inside some very hung horseman's balls.";
			else:
				now battleground is "void";
...
to say BHHFuckCock:
	...
	if scalevalue of Player >= 4:
		...
		say "     With this much action, your body begins to ache, as you have been at this for a long time. The horseman continues to push your physical limits, grunting at every time you stop fucking his cock, threatening you to swallow you up instead. For some reason, every time he says that, your own penis beckons you to continue your job, as if this actually turned you on, one way or another. But, besides this, his precum output is huge, already having managed to coat your legs and waist completely, and is now forming a puddle under your feet. It feels really easy to slip. 'Nngh... C'mon now... Don't stop...' You do not, as you begin to approach the point of no return, the orgasm you seek, so hard-earned, steadily approaching... 'Yeah, let it all out... Cum into my cock.'";
		WaitLineBreak;
...
to BBHFuckCockCV:
	...
	WaitLineBreak;
	say "     He moans to himself, taking a seat against a wall as he watches your feet finally disappearing into the enormous shaft, any traces of you gone out of view and into him. The sticky fluids and high temperatures washing over you are nearly unbearable as this fleshy tunnel throbs and seemingly wiggles you in deeper, forcing you to travel further down the cavernous body until you can finally be dropped into the horseman's nuts. They have grown to accommodate your normal size, but you are forced to curl like a fetus, as his balls provide only enough space for you to be inside them. Your movements are very well-felt by the equine man as you adjust yourself within the tight soft confinements, which would be otherwise empty.";
