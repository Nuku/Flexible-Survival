...
to say BHHFuckCock:
	...
	if scalevalue of Player >= 4:
		...
		say "     With this much action, you body begins to ache, as you have been at this for a long time. The horseman continues to push your physical limits, grunting at every time you stop fucking his cock, threatening you to swallow you up instead. For some reason, every time he says that, you own penis beckons you to continue your job, as if this actually turned you on, one way or another. But, besides this, his precum output is huge, already having managed to coat your legs and waist completely, and is now forming a puddle under your feet. It feels really easy to slip. 'Nngh... C'mon now... Don't stop...' You do not, as you begin to approach the point of no return, the orgasm you seek, so hard-earned, steadily approaching... 'Yeah, let it all out... Cum into my cock.'";
		WaitLineBreak;
...
to BBHFuckCockCV:
	...
	WaitLineBreak;
	say "     He moans to himself, taking a seat against a wall as he watches your feet finally disappearing into the enormous shaft, any traces of you gone out of view and into him. The sticky fluids and high temperatures washing over you are nearly unbearable as this fleshy tunnel throbs and seemingly wiggles you in deeper, forcing you to travel further down the cavernous body until you can finally be dropped into the horseman's nuts. They have grown to accommodate your normal size, but you are forced to curl like a fetus, as his balls provide only enough space for you to be inside them. Your movements are very well-felt by the equine man as you adjust himself within the tight soft confinements, which would be otherwise empty.";
