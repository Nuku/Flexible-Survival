...
to say AlphaDive:
	if a random chance of 1 in 4 succeeds:
		say "     You jump in the acid, ignoring all the pain. It makes your flesh burn at is is eaten away while you try to find any opening deeper into his digestive tract - in vain. Soon, you pass out from the pain and are quickly digested without a trace.";
		WaitLineBreak;
		now battleground is "void";
		now tailname of player is "dead";
		now facename of player is "dead";
...
to say BitchDive:
	if a random chance of 1 in 4 succeeds:
		say "     You jump in the acid, ignoring all the pain. It makes your flesh burn at is is eaten away while you try to find any opening deeper into her digestive tract - in vain. Soon, you pass out from the pain and are quickly digested without a trace.";
		WaitLineBreak;
		now battleground is "void";
		now tailname of player is "dead"; 
		now facename of player is "dead"; 
