...
to TentacleBreed:
	...
	WaitLineBreak;
	say "     The tentacle wandering just around the back of your neck shows itself across your cheek, soaking you in its fluids as it worms around you, and within seconds it begins tickling your lips, its tip oozing the slimy substance that starts to drop down your chin. At the same time, another tentacle finds itself slipping between your buttcheeks, pressing against your pucker and sliding in rather easily thanks to its slippery coating. As the thick tendril enters your ass, a moan is drawn from your mouth, your lips opening just enough so the tentacle by your face can slide inside, rubbing itself against your tongue as your mouth remains wrapped around its length. You feel the juice's sweetness and its sticky texture holding against your taste buds as the tentacle wiggles deeper, towards your throat, and secreting more of its strange fluid, forcing you to swallow it. Its arousing effects slowly spread through your body in the form of a flushing heat.";
	say "     Desire overtakes you as, even if you had the will to struggle, you lose all inhibitions and give yourself into the care of the beast. As the tentacle in your mouth keeps pumping its drug-inducing liquid, the one in your ass keeps pushing, finding its way further inwards, so deep that you eventually lose track of its location inside you. When the tips are exactly where the monster needs them, the tendrils quiver before you can see several pulsing bulges coming through both of them. You already know what to expect once one of the prominences reaches your mouth, nearly dislocating your jaw as you're forced to drop your chin even wider. They're the eggs of the creature, being pushed inside you, slowly and steadily.";
	WaitLineBreak;
...
to say TentaclesFirstEncounter:
	...
	if Player consents:
		...
		CreatureSexAftermath "Player" receives "OralCock" from "Tentacle Horror";
		CreatureSexAftermath "Player" receives "Ass[if Player is not mpreg_ok]Dildo[end if]Fuck" from "Tentacle Horror";
		now TentacleInteractions is 1;
