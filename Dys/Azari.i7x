...
Description of Shag Shack Alley is "     Stepping around the corner, you take in your new surroundings. It's clear that the alley hasn't been touched since the start of all of this mayhem, the dumpster nearly completely empty and the ground surprisingly clutter-free. Despite all this, you can't help but feel slightly unnerved by being here. Something about the dim, narrow space makes you tense up, expecting something to come at you at any moment, despite this being well within the safe area around the mall.[line break]".
...
Azari is a man.
ScaleValue of Azari is 3. [human sized]
Body Weight of Azari is 4. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Azari is 3. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
[Body Adjective is generated out of the body weight and body definition and can be used in scenes - one word descriptive adjective depending on weight and definition groups: low weight group: skinny/slender/lithe; mid weight group: average/fit/muscled; high weight group: pudgy/husky/jacked]
Androginity of Azari is 2. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Azari is 7. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Azari is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Azari is 7. [length in inches]
Breast Size of Azari is 0. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Azari is 0. [count of nipples]
Asshole Depth of Azari is 6. [inches deep for anal fucking]
Asshole Tightness of Azari is 1. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Azari is 1. [number of cocks]
Cock Girth of Azari is 3. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Azari is 6. [Length in Inches]
Ball Count of Azari is 2. [allowed numbers: 1 (uniball), 2 or 4]
Ball Size of Azari is 2. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
Cunt Count of Azari is 0. [number of cunts]
Cunt Depth of Azari is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
Cunt Tightness of Azari is 0. [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
Clit Size of Azari is 0. [size 1-5, very small/small/average/large/very large]
[Basic Interaction states as of game start]
PlayerMet of Azari is false.
PlayerRomanced of Azari is false.
PlayerFriended of Azari is false.
PlayerControlled of Azari is false.
PlayerFucked of Azari is false.
OralVirgin of Azari is true.
Virgin of Azari is true.
AnalVirgin of Azari is true.
PenileVirgin of Azari is false.
SexuallyExperienced of Azari is true.
TwistedCapacity of Azari is true. [Twisted Characters can take any penetration, no matter the size]
Sterile of Azari is false. [steriles can't knock people up]
MainInfection of Azari is "Latex Fox".
...
to say Azari_Sex_SmallPlayer: [Sex scenes for a small player with the fox]
	if Player is kinky:
		...
		say "     Inch after agonizing inch sinks into you, the sex-crazed feral making slow, but steady progress, your insides shifting to make way for his massive tool. Eventually, after much agonizing pain, he manages to press his growing knot against your hole. [if scalevalue of Player < 2]He's so deep inside you now that you're fairly certain that he may be poking up into your chest, as impossible as that may seem[else]His cock is so massive that a pillar of stretched flesh resides where your stomach should be[end if]. You only get a moment of reprieve, however, before the beast pulls his shaft out of you, inch by inch, until only his tip remains. Of course, he gives you no time to get ready for his next thrust. He pushes all the way back in, up to his knot, [if scalevalue of Player < 2]sending waves of agony through you[else]causing pain to shoot through your body[end if].";
		WaitLineBreak;
		say "     He pulls out again, faster this time, before pushing in. Quickly, he picks up the pace, and before long he's rutting into you aggressively, growling possessively as he takes you. [if scalevalue of Player < 2]You can't help but let out a scream of pain from this abuse. [end if]Somehow though, despite the intense agony you're feeling, you're becoming aroused, your cock hardening and dripping pre. The feral vulpine seems to notice this, letting out an amused huff. He continues to fuck you relentlessly, pounding into you harder and faster with each second. Eventually, he switches to shorter, even harder movements, only pulling a few inches out of you before pushing back in. With each time his knot presses against your entrance, you can feel it's been growing. It seems like this crazed feral is intent on tying you to his tool!";
...
to say Azari_Sex_AveragePlayer: [Sex scenes for an average player]
	if a random chance of 1 in 2 succeeds: [No growth / light cum inflation scene]
		...
		if Player is kinky:
			...
			say "     Pushing harder and harder into you, his knot eventually starts to make headway, stretching you rather [if player is twistcapped]uncomfortably[else]painfully[end if] with its girth, despite only a little bit of it slipping in. This doesn't stop the rubber creature, however. He continues to force his knot further in, letting out a possessive growl, before the massive sphere of rubber slides in past its widest point. You feel an intense pleasure as the huge beast finally manages to tie your stubborn hole. Your [Cock of Player] penis throbs as you struggle to cum, the strain his knot is putting on your prostate making it rather difficult. As you finally reach your peak, the fox does as well. He lets out a pleasured growl as his orgasm begins, his entire shaft rippling in waves as he fills you with rubbery fox cum. Very quickly, you begin to feel incredibly stuffed by his cream, but the release shows no signs of slowing down. More and more fertile, twisted cum spews into your bowels, and your belly begins to distend noticeably.";
			WaitLineBreak;
			say "     You begin to think he's done before he starts rutting rapidly against you, still releasing his seed. He keeps thrusting into you while his climax continues. This goes on for what feels like hours before the vulpine finally slows down, his torrent of cum beginning to cease its flow as well. When he's finally done filling you up, your belly is heavily swollen, to the point that you look like you've eaten a whole watermelon. He suddenly begins to jerk backwards, trying to pull his knot from your hole. You let out a yelp of [if player is twistcapped]distress[else]pain[end if] from the tugging, but also pleasure from the feeling of the rubbery liquid sloshing around inside you. Eventually the vulpine manages to pop his tool out, and it's quickly followed by a rush of his virile seed.";
			say "     After he dismounts you, he gives your drenched backside a few licks before he decides to turn around and return to the position you found him in when you entered the room. His body quietly shrinks back to its normal size, and you take that as your cue to exit the room.";
	NPCSexAftermath Player receives "AssFuck" from Azari;
