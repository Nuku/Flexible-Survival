...
to say Azari_Sex_SmallPlayer: [Sex scenes for a small player with the fox]
	if Player is kinky:
		...
		WaitLineBreak;
		say "     Eventually, the flow of cum slows, and you're left feeling decently bloated. The feral, now done with you, begins to tug your hole with his knot, trying to free his shaft. Of course, this is rather painful for you, until he eventually manages to yank it out with a wet pop, a rush of his own seed following it out.[mimpregchance]";
