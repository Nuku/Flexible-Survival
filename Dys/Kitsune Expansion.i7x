	...
	if scalevalue of player > 3: [Small player]
		if player is twistedcapped: [Player is able to take it all.]
			...
			if a random chance of 3 in 4 succeeds:
				...
				say "     It seems that your teasing manages to get to the vulpine as he lets out a low growl before gently thrusting into your mouth. You moan eagerly as his tip prods against your throat, his length retreating only to press in once more. Each thrust grows just a bit faster and a bit deeper, his tip eventually pushing its way into your throat and bulging your neck with his girth. He lets out a pleasured growl as he feels your tight confines rippling around his length, making him near his climax even faster. He places a tail around your head, keeping it in place as his knot pats against your lips, his thrusts shortening, growing harder. He's determined to tie himself to your [if player is MuzzleFaced]muzzle[else]face[end if], clearly desiring to seal every drop of his seed inside you. At first, you don't think he'll succeed, but eventually, his determination beats out your jaw's resistance, his knot slipping past your teeth with a lewd pop.";
				WaitLineBreak;
				say "     You let out a shuddering breath as you feel his cock throbbing and pulsing, his knot swelling to its full size behind your teeth, locking you to him for the full duration of his orgasm. He gives a soft howl of pleasure as he begins to cum, pumping his foxy seed straight down your throat. Rope after rope of rich ejaculate spills into you, slowly and steadily filling your stomach to bulging. It feels like an eternity before his climax comes to an end, your belly packed with his seed. Now you simply wait, attached to his knot until it finally goes down.";
	else:
