...
to RandomizeFeralMutt:
	...
	if randomnumber is:
	-- 1:
		if a random chance of 1 in 2 succeeds: [50% chance]
			now FeralMuttFurColor is "brown";
		else:
			now FeralMuttFurColor is "grey";
	...
	-- 2:
		if a random chance of 1 in 2 succeeds: [50% chance]
			...
			now FeralMuttFurColor is "yellow";
	...
	-- 3:
		if a random chance of 1 in 2 succeeds: [50% chance]
			...
			now FeralMuttFurColor is "black";
	...
	-- 4:
		if a random chance of 1 in 2 succeeds: [50% chance]
			...
			now FeralMuttFurColor is "golden-brown";
	...
	-- 5:
		if a random chance of 1 in 2 succeeds: [50% chance]
			...
			now FeralMuttFurColor is "reddish-brown";
	...
	-- 6:
		if a random chance of 1 in 2 succeeds: [50% chance]
			...
			now FeralMuttFurColor is "white and brown";
