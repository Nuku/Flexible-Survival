...
When Play begins:
	...
	now MilkItem entry is "Feral Mutt Milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "Feral Mutt cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
Table of Game Objects (continued)
name	desc	weight	object
"feral mutt man-milk"	"A plastic water bottle filled with what is clearly milk. One could think it was a regular cow's milk, if someone hadn't written 'feral mutt Man-Milk' across the label on the bottle. You [italic type]could[roman type] drink it to quench your thirst. Who knows what else it might do to you though..."	1	feral mutt man-milk

feral mutt man-milk is a grab object.
