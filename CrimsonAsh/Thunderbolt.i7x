...
when play begins:
	add Campus Thunder to BadSpots of MaleList;
	add Campus Thunder to BadSpots of FurryList;
...
to say ResolveEvent Campus Thunder:
	if ThunderTrackingVariable is 0: [never met]
		...
		if Player consents:
			...
			NPCSexAftermath Player receives "[if Player is female]Pussy[else]Ass[end if]Fuck" from Thunderbolt;
...
Cunt Depth of Thunderbolt is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
instead of fucking Thunderbolt:
	...
	[]
	if Player is female:
		if Ariana is in Thunderbolt's Stable and Eres is in Thunderbolt's Stable:
...
to say ThunderboltSex1:
	...
	NPCSexAftermath Player receives "OralPussy" from Ariana;
	NPCSexAftermath Eres receives "OralPussy" from Player;
...
Cunt Depth of Ariana is 12. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
instead of fucking Ariana:
	...
	blank out the whole of table of fucking options;
	[]
	if Player is female and Eres is in Thunderbolt's Stable:
		choose a blank row in table of fucking options;
		now title entry is "A foursome";
		now sortorder entry is 1;
...
Cunt Depth of Eres is 12. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
instead of fucking Eres:
	...
	blank out the whole of table of fucking options;
	[]
	if Player is female and Ariana is in Thunderbolt's Stable:
		choose a blank row in table of fucking options;
		now title entry is "A foursome";
		now sortorder entry is 1;
