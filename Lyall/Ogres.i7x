	...
	if OgreMeetings is 1: [FIRST ENCOUNTER]
		...
		while fightoutcome < 20 and GroupFightCounter < 3: [runs for 3 times or until the player loses or flees]
			if GroupFightCounter is 0:
				...
				say "     'You might've gotten lucky beating the boss,' the second orgre, 'But you won't get lucky twice.'";
			else if GroupFightCounter is 2:
				say "     The last ogre looks at his fallen bretheren and shakily lifts his bat to give it a swing in your direction. He lets out a nervous scream before attacking.";
		...
		if fightoutcome < 20: [player won]
			if cocks of player > 0:
				...
				if calcnumber is 1: 
					...
					say "     The ogre leader grunts in response to your rough treatment, not at all enjoying to be on the receiving end for once. Bringing a finger to your mouth you suck on it for a few seconds before pulling it out and moving towards his pucker. You brush over his wrinkled opening once or twice, then push the wet digit against his hole, not letting up the pressure until it sinks into his body. The large creature doesn't make a sound, instead griting his teeth and stoically bearing your invasion. You swirl the finger around, noticing that his ass is so tight that it might actually be a virgin. Then you add a second finger, closely followed by a third, all in an effort to help loosen him up before you proceed to fucking the ogre. 'You gonna be done soon? I think you've ridiculed me enough, so why don't you call it quits, eh?' the ogre asks with a grunt. A quick smack on the ass gives him an answer - just not the one he was looking for.";
					WaitLineBreak;
...
When Play begins:
	...
	now attack entry is "[one of]The ogre hits you![or]With a swing of his bat the Ogre smacks you in the stomach knocking the wind out of you! [or] He charges you shoulder first slaming his shoulder into your chin.[at random]";
