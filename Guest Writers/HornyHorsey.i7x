...
Instead of asking Ammy about "take/taking off bra":
	if AmmyAffection is 2:
		...
		say "     'Oh I think I know what you want...' she asks teasingly, then turns her back to you and fondles around the snaps of her bra with her soft hands. You can hear a faint click as you start watching the black silky bra sliding off her body, falling to the ground as she turns around again slowly.";
...
to say ammy_sex_fellatio_receiving:
	...
	if (a random chance of 1 in 2 succeeds and Player is female) or Cock Count of Player < 0:
		...
		NPCSexAftermath Player receives "PussyDildoFuck" from Ammy;
	else:
