Version 1 of HornyHorsey by Guest Writers begins here.
[Original by femtoAmpere]
...
[ v0.21, Jan 2014 ]
[ Version 1.2 - Moved to Guest Writers]
...
AmmyLastEvent is a number that varies. AmmyLastEvent usually is 666.
...
Instead of using ammy's black bra:
	say "     You look over Ammy's bra. The faint scent of her on it is enticing.";
...
Instead of asking Ammy about "DEBUG":
	say "My affection now is [AmmyAffection].";
	say "My last event was at [AmmyLastEvent] turns.";
	say "My last sexevent was at [lastfuck of Ammy] turns!";
...
Instead of conversing Ammy:
	if AmmyLastEvent is not turns:
		if AmmyAffection is:
			...
			-- 4:
				say "     Ammy's ears rise up into your direction as you approach her. Quickly she gets up and hugs you tightly, her naked breasts (un)pleasantly pressing against your [if Breast Size of Player > 0][breast size desc of Player] breasts[else][bodytype of Player] chest[end if] as she starts talking with her soft voice. 'Hey there again sweetheart! How have you been? I've been missing you!'";
				say "     You two sit down and chat a little, obviously getting closer with Ammy. It takes a while and a little pause in the conversation as you slowly realize again how curvy and well formed the body of your company is again - the fact that she's not wearing a top is not making it better! You blush a little as you notice her eyeing her body again, starting to grin and looking at you: 'Hmm, there's no one around at the moment... and usually there won't be for a while at this time. Possibly I could do something more... private for you than last time?'";
...
Instead of asking Ammy about "help":
	say "     'Aww, hope I didn't confuse you! Here are some tips I can give you,' Ammy says, handing you a small notecard with a little heart drawn onto it.[paragraph break]";
...
Instead of fucking Ammy:
	if AmmyAffection <= 4:
		say "     '[if AmmyAffection <= 2]Uhm. I'm flattered by your offer... and I know things tend to go very fast here... but... NO!' the equine states slightly annoyed and pushes you away[else]Oh... oh my, I... I don't know. You're sure kinda cute! But... no, I'm sorry,' Ammy tells you in her sweet voice, obviously being not completely uninterested[end if].";
	else:
		if lastfuck of Ammy is not turns:
...
to say ammy_sex_lap:
	...
	say "     While you were distracted, the herm's soft hands were fondling around your waist, getting rid of whatever you might have worn, revealing your [if Player is male]hard [Cock of Player] cock[else if Player is female]wet folds[end if].";
	...
	if Player consents:
		...
		if Player is not male or a random chance of 1 in 2 succeeds:
			...
			say "     Ammy looks at you happily, moving forward against you, her breasts rubbing at your face... her prick at your [if Breast Size of Player > 0][breast size desc of Player] breasts[else][bodytype of Player] chest[end if]. [if Breast Size of Player > 0]In fact, her long equine cock is quickly finding its way in between your breasts[else]Her long equine prick is drooling precum across your chest[end if] as she kneels above your groin now. Almost painfully slowly starts sliding downwards, until you can feel the tip of your cock entering her wet folds. She slowly moves down further until you are completely engulfed in her accommodating pussy. You hear her groan as she rises again, then falls again on your cock. Ammy's body rubs against yours as she begins to ride you, quickly picking up in pace, steadily fucking you, her surprisingly soft pussy sliding around your cock. Her rhythm reaches the steady beat of the dull beat of the music of the other room.";
			WaitLineBreak;
...
to say ammy_sex_fellatio_receiving:
	say "     With an evil grin on her face, Ammy keeps looking at you as her gaze slowly drifts downwards, eyeing your crotch. While licking her chops she looks back at your face, speaking in a teasing voice, 'Would you like if I'd make you happy down there, hmm?'";
	...
	WaitLineBreak;
	if (a random chance of 1 in 2 succeeds and Player is female) or Player is not male:
		...
		NPCSexAftermath Player receives "PussyFuck" from Ammy;
	else:
...
to say ammy_desc:
	if AmmyAffection <= 2:
		...
		say "     She's wearing a skimpy black bra surrounding her ample breasts and tight black panties around her wide hips. Slowly getting a view of her crotch you also notice the sizable bulge in her panties, making you wonder how much of a female she actually is... as suddenly you notice that she spotted you eyeing her body, looking back into your direction with her blue eyes, smiling widely.";
...
to say ammy_poledance:
	...
	WaitLineBreak;
	say "     Once standing again Ammy turns around, giving you a view of her back... and rear as she starts leaning forward while raising her ass, swaying her hips from side to side, tail dancing to the rhythmic motion. You notice her closing her eyes while nuzzling against the metal pole she's holding onto. The rocking of her hips is getting more and more wild by the minute, the nuzzling more passionate, making you crazy. This sensual movement of those wide hips and great arse is just too hot. A few more seconds pass until you hear the equine moan silently 'Nnngh~' and you notice the bulge in her panties is growing.";
...
to say ammy_lapdance:
	...
	if Player consents:
		...
		LineBreak;
		say "     After letting a few seconds pass in this loving pose Ammy gets up again, rubbing her crotch against your chest and face, then turns around again, stretching her unguligrade legs while touching her hooves with her fingers, giving you another fantastic view of the bulges under her black panties.";
