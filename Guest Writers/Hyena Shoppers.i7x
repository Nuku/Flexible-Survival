...
to say ResolveEvent Hyena Shoppers:
	...
	if Player consents:
		...
		LineBreak;
		say "     [bold type]Do you want to provide them with whatever she is talking about? It'll likely be something weird, and may or may not be sexual...[roman type][line break]";
