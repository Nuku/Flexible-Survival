	...
	if Resolution of Gryphon's Plot is 0 or Resolution of Gryphon's Plot is 1: [first time or repeat after failing to find them]
		...
		if Player consents:
			...
			if diceroll + bonus >= 13:
				...
				say "     Wandering through the debris of buildings, scattered trash-piles and past wrecked cars, you manage to find the right direction and from then on progress fairly quickly, soon finding the scene that all the noise is coming from. Just a short distance before you, three gryphons attack a group of soldiers in a military jeep. From the looks of it, the unlucky men were ambushed, their vehicle boxed in by an abandoned car that has been rolled behind it. The soldiers now stuck and unable to drive away have now been forced to protect themselves from the near-constant aerial bombardment, the gryphons assaulting the men with trash and anything else they can find. The soldiers, still unchanged, grow increasingly desperate judging from the extreme amount of swearing you hear coming from the car. If you wish to interfere, no better time than now.";
				say "[line break]     [bold type]Do you wish to intervene?[roman type][line break]";
				...
				say "     Setting out in search of where the gryphons are, you wander through the deserted streets. Some time later, as you continue trekking through the city's rubble for the source of the noise, all sounds eventually cease. Hm, seems like you won't find that group of gryphons today. Maybe if you were a bit more perceptive, you might have found a quicker way to get to them...";
		...
		say "     As you wander through the streets of the creature-infested city, you stumble upon a group of non-infected human soldiers. Inching forward to take a closer look, something inside your head clicks. You knew they looked familiar - it is the soldiers you saved from the gryphons a while back! One of the men spots you and waves you over, patting a place on the ground beside him.";
		say "[line break]     [bold type]Do you join them?[roman type][line break]";
		...
		if Player consents:
			...
			LineBreak;
			say "     Deciding that you want nothing to do with whatever the men are up to, you turn your back on the soldier's offer. Surprised by your reaction, but not deterred, he grudgingly, but determinedly, returns to his task as you continue along your merry way.";
		...
		if BodyName of Player is "Blue Gryphon Herm" and Player is pure:
			say "[line break]     Being a gryphon yourself, you can't help but feel like the guys might react badly to your presence. Still, do you want to approach them?";
			...
			say "[line break]     [bold type]Do you want to approach them and have a chat?[roman type][line break]";
			say "     ([link]Y[as]y[end link]) - Yes, it would be nice to talk to someone sane for once.";
			say "     ([link]N[as]n[end link]) - No, it's not worth the risk.";
			if Player consents:
				LineBreak;
				if Player is bodily human and Player is facially human:
		...
		if Player consents:
			...
			say "[line break]     [bold type]Do you wish to submit yourself to them?[roman type][line break]";
			...
			if Player consents:
				...
				if fightoutcome < 20: [player won]
					...
					if carried of food > 2 and carried of food >= carried of water bottle:
			...
			say "     With a shrug you turn your back on the group of gryphons and walk off down the street.";
...
to say GryphonAss:
	say "     Lining your cock up with the hermaphrodite gryphon's pucker, you hear the newly transformed man let out a wanton moan. Taking the soldier's sound of need as good of an invitation as any, you proceed to bury yourself balls-deep inside of the tight anus of your temporary fuck toy, to his obvious and verbal enjoyment. Painfully erect inside of the gryphon's softly clenching anal walls, your cock lets out copious amounts of precum, lubricating the soldier's ass for the pounding that is to come. The man, succumbing to the lustful needs of his new form, begins rocking his hips into you in time with your thrusts as you start to earnestly fuck him.";
	say "     Despite trying to look upon the scene with feigned disgust, you notice the other gryphon soldiers looking at your fully erect cock with an aroused interest. Smirking, you wave one over, directing him towards your increasingly full balls. Falling to his knees, the soldier expertly uses his tongue to fulfill his task. The last gryphon, not to be left out, proceeds to bury himself deep into the mouth of his ass pleasing kin.";
	WaitLineBreak;
	say "     Being attended to from all angles, you feel your pleasure start to rise as it shows itself in the form of a pleasant knot, which sits within your stomach. Speeding up your fucking of the soldier whose ass constricts around your cock, you feel yourself nearing a crushing orgasm. The one attending to your heavy cum-filled sacks seems to notice your ever rising pleasure and attacks your balls with renewed vigor. Between the two gryphons pleasing you, it isn't long before you find yourself passing over a pleasurable edge, depositing a studly amount of cum inside of your temporary gryphon fuck toy which leaves no nook and cranny of his previously virgin hole untouched. Bathing in the feeling of your post-orgasmic haze, you vaguely notice as your gryphon fuck buddies reach orgasm themselves. Thoroughly exhausted from the enjoyable fuck, you feel yourself slowly drift into unconsciousness. Waking two hours later, you find the soldiers out cold around you. Making sure everything is in order, you begin to distance yourself from the scene, the recent fuckfest leaving you in a much better mood than before.";
