Version 1 of Whiptail by Guest Writers begins here.
[Original by Vervaine]
...
to say Whiptail VanquishedSex1:			[Two oral scenes for the price of one.]
	...
	say "     [if Cock Length of Player < 6]She makes you feel like you have a horse cock, with the way she's gagging on your dick, and your rod throbs with each choking gasp[else if Cock Length of Player < 12]She can barely fit your cock in her mouth, but she gives it her all, and you moan each time she manages to work another inch of your length into her[else]She only manages to fit your head in her mouth but gives it a good licking, slobbering on as much of your massive head as she can[end if]. Much as you love a good face-fuck, you're hoping her oral skills can be put to better use lower down. Pulling your prick out with an audible pop, you tell the lizard woman that you're going to give her what she wants if she's good. She obediently waits as you strip fully, licking her lips as you sink down to your knees, pussy dripping onto her face below.";
	say "     No guidance necessary, the whiptail is a wizard with her tongue, and it's all you can do to pull back occasionally to give her air. You abandon even that courtesy in time, as the lizard woman brings you to the edge several times, only to stop, depriving you of completion. You grind against her face more insistently, jacking your rod furiously, and she gets the message loud and clear. Finally, the reptilian beauty grants you release, and you cum hard. As the whiptail laps at the femcum that runs down her face, your cock shoots its load over her head, forming a sizable puddle before sinking into the parched earth. You sit there, idly humping her face as you ride out your orgasm, until the last wave fades away. You roll off of her, quickly dressing and gathering your things, and leave her where she lays to continue the everyday struggle to survive in this new world.";
	CreatureSexAftermath "Whiptail" receives "OralPussy" from "Player";
...
to say Whiptail VanquishedSex3:			[She's not great but it's what you wanted.]
	...
	say "     You shift position, bracing your upper body on the ground above her head so your groin is right in line with the lizard woman's face. The whiptail swallows nervously before tentatively opening her mouth wide for you. [if Cock Length of Player < 6]You slam your prick home in her throat, pistoning in and out while chasing your orgasm[else if Cock Length of Player < 12]Knowing her limits, you make smooth, half-strokes into her maw. You can feel the entrance of her throat teasing your head, but you can't quite get it in[else]You make short thrusts, fully withdrawing each time, making the most of her small mouth[end if]. Finally, your wild rutting takes you over the edge, and you cum hard [if Cock Length of Player < 6]down her throat, into her belly[else]into her waiting mouth[end if]. The reptilian beauty gags as you fill her with your seed, but you hold yourself in her until you're finished. You roll off of her, quickly dressing and gathering your things, and leave her where she lays to continue the everyday struggle to survive in this new world.";
	CreatureSexAftermath "Whiptail" receives "OralCock" from "Player";
...
to say Whiptail VanquishedSex6:			[Reciprocation is key.]
	...
	say "     You lose count soon after round two; how many rounds, who 'won', or whether there needed to be another tiebreaker. Thankfully, both of you tap out at the same time, and you roll off of the whiptail with a groan of exhausted contentment. Long minutes pass with the two of you lying side by side on your backs, naked and fulfilled. Reality soon reasserts itself, however, and the two of you dress yourselves, gather your gear, and head your separate ways. You take a last look back as the lizard woman jogs into the distance, disappearing into the tall, unnatural grass.[fimpregchance]";
	CreatureSexAftermath "Whiptail" receives "OralPussy" from "Player";
	CreatureSexAftermath "Player" receives "OralPussy" from "Whiptail";
...
to say Whiptail VanquishedSex8:			[A strange urge overcomes you.]
	...
	say "     [if Player is male]You cum, the first blasts covering the lizard woman's tits in your seed, the rest splashing on your own chest[else if Player is female]You cum, and you feel your juices running down your thighs, chest heaving as you pant[else]An explosion of feeling races from your featureless crotch, and your back arches in ecstasy[end if]. The reptilian beauty pats your cheek and rolls off of you, finding her discarded clothing. As she dresses she says, 'That's the first time someone's been affected so strongly. You might want to work on that; someone might take advantage. She leaves you crumpled in a heap, jogging into the distance.[if Player is female][fimpregchance][else][mimpregchance][end if]";
...
When Play begins:
	...
	add "Whiptail" to infections of InternalCockList;
	add "Whiptail" to infections of InternalBallsList;
	...
	now desc entry is "     As you make your way around a large rock formation, you hear a shout, which startles you. Before you stands a reptilian woman of average height, her belly and throat a pale-blue while her limbs and face are a warm-brown lined with pale stripes. Her tail is the same blue as her front and flicks around in a most unlizard-like manner. She's wearing what looks to be a running outfit; a black spandex sports bra covers modest breasts, and compression shorts hug her muscled body closely. 'You're not getting the best of me.' She crouches before charging you with surprising speed![line break]";
	...
	now MilkItem entry is "whiptail milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "whiptail cum"; [ Item to be given to the player if they have this infection and jerk off. ]
