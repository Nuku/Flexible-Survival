...
to say chinvic:
	...
	otherwise:
		...
		if chindem is false:
			say "     Chittering incomprehensibly, it's clear she requires of her [if hp of player < 1]victim[otherwise]assistant[end if] to go harder, squeezing you tightly until you oblige. Your ";
		otherwise:
			say "     '[one of]A-ah[or]O-oh[or]N-ng[at random], [one of]so g-good[or]h-harder[or][if scalevalue of player < 3]so b-big[otherwise]I need m-more[end if][at random]...!' Squeezing her [if hp of player < 1]victim[otherwise]assistant[end if] tighter until you intensify your endeavour, your ";
		say "arousal becomes increasingly apparent, [if cocks of player > 0]unattended, [cock size desc of player] cock[smn] standing achingly in attention[otherwise if cunts of player > 0]unattended, [cunt size desc of player] cunt[sfn] aching for attention[otherwise]in spite your lack of visible outlet[end if]; however, the rodent is clearly too distracted to regard it, the speed at which she writhes against your irreverent appendage becoming more desperate.";
...
to say chinloss: [Placeholder, player victory scenes expected to be added in later]
	...
	otherwise:
		say "     Eventually, the critter collapses, too exhausted to fight back any further.  With the energetic creature down, you're free to take advantage of the situation if you'd like.  You can see traces of a sexy female figure beneath the little fuzzball's fluffy fur.  Shall you [if cock length of player > 16]have some naughty fun with her[otherwise]fuck her[end if]?";
		if the player consents:
			if cock length of player > 16:
				say "     Giving her diminutive size, especially when compared to your [cock size desc of player] cock, you pass on outright fucking the little cutie and instead go for some other fun.  Having to problem pinning her down, you press your drooling glans to her face and tell her to start licking.  The small fluffball[if chindem is true][one of] grumbles something about how you don't have to so mean about it, but[or] giggles that you should've just said so in the first place.  She[or]'s eyes go wide with desire at the size of your manhood.  With such a prize, she[at random][otherwise][one of] chitters indignantly, but[or] releases a chittering giggle of excitement.  She[or][']s eyes go wide with desire at the size of your manhood.  With such a prize, she[at random][end if] relents and slides her tongue slowly along several inches of cock before twirling it across the tip.  Soon more licks follow along with her fuzzy paws joining in on caressing your [if cock length of player < 30]comparatively [end if]huge penis.";
				say "      With her thus occupied, you slip your hands into her fuzzy fur and start caressing her curvaceous body.  While it's hard to see buried under all that fluff, she's got a sexy (if rather animalistic) body hidden under her fur.  You rub her breasts and tease her hidden nipples, drawing chitters of delight from her.  You then let a hand slide down between her legs and slip [if scalevalue of player < 4]a pair of digits[otherwise]a finger[end if] into her cunt.  Her cunny's quite hot and wet, clearly excited from her fun with your cock.";
				attempttowait;
				say "     You continue to finger and pet the female rodent while she licks and strokes your manhood.  As your excitement grows, your dick drools pre onto her tongue as well as her fuzzy face.  Feeling your orgasm approaching, you grab the back of her head with your free hand and stuff the end of your cock into her little muzzle.  You groan and [if cock width of player > 15]bulge her cheeks out with just the first few blasts[otherwise]shoot several blasts[end if] of your [cum load size of player] load into her mouth before pulling it out.  You pump your cock frantically, spraying the rest of your seed onto her fuzzy fur, making sure she's good and messy.  Even as you're cumming all over her, you finger her to a chittering orgasm.";
				say "     After you get off her, she gets up and [if chindem is true][one of]grumbles about how messy you've gotten her soft coat[or]complains about how her fur is dry-clean only[or]complains about needing a good, long dust-bath now[at random][otherwise]chitters indignantly, clearly upset at having her soft coat soaked in your seed[end if].  She tries her best to wipe it off while shakes her sticky arms as she walks off.  This flings gobs of semen from her little paws onto the ground, though she also licks several gooey globs from them as well.";
			otherwise:
