...
to say Caveman wins:
	if Player is impreg_ok and a random chance of 1 in 3 succeeds:
		say "     The massively muscled beastman swipes your feet out from under you and plants his large hairy feet on either side of your head. He raises his arms above his head in triumph, the oversized biceps bigger than his own head as he roars in victory before bashing you over the head with his club. The blow fills your vision with stars before it all fades to black.";
...
"Caveman"	"[PrepCombat_Caveman]"

to say PrepCombat_Caveman:
...
When Play begins:
	...
	now body change entry is "it becomes human-like, but freakishly proportioned, with huge arms that touch the ground. Hands and feet grow larger and larger to match, and end up becoming massive and powerful. Your muscles increase with new prehistoric size. With creaks and cracks in your back, you hunch over, feeling much more comfortable in that position now";
	now skin change entry is "it becomes thick and leathery, an enormous amount of human hair growing on it, making it seem almost fur-like";
	...
	now MilkItem entry is "caveman milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "caveman cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
This is the Caveman Infection rule:
	if Player has a body of "Caveman":
		...
		say "     You [if humanity of Player < 10]succumb to your caveman infection, your mind regressing to a simpler, devolved state. You find the city confusing and troublesome and run away until you find a comfortable cave deep in the woods, away from everyone else[else]survive, but you can never live a normal life. Most of the other survivors are furry and have started their own community, but you are almost human, but not quite. The only work you can find is as a subject in college lectures about prehistory and evolution, until a construction foreman sees the massive arms and hands on your freakish body and puts them to good use. The work is hard and simple, perfect for your devolved mind[end if].";
