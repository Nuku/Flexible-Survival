...
to say wrestlingwolfattack:
	...
	else if wrestlingwolfdefeat > 1 and Player is not female:		[now open for M/M]
		...
		if HP of Player > 0 or a random chance of 1 in 3 succeeds: 	[impatient - rough fuck]
			if Player is female:
				...
				if Cunt Depth of Player < 20 or Cunt Tightness of Player < 15:
					...
					CreatureSexAftermath "Player" receives "PussyFuck" from "Wrestling Wolf";
				...
				CreatureSexAftermath "Player" receives "AssFuck" from "Wrestling Wolf";
				if wrestlingwolfdefeat is 1, now wrestlingwolfdefeat is 2;
		else:
			if Player is female:
				...
				if Cunt Depth of Player < 20 or Cunt Tightness of Player < 15:
					...
					say "     He wraps his arms around your waist firmly, getting a good hold and keeping you in place as he pulls his length out and thrusts back in. Your whole body is pressed against his rugged furry chest as he continues repeatedly thrusting into you for a good while, slamming his knot against you over and over again, until finally neither of you can hold out anymore and reach your orgasms. His hot seed explodes into you, quickly filling your womb. The force of his orgasm is so great that you're sure that if he wasn't keeping such a strong hold on you, you would've rocketed right off his shaft. Once his orgasm finally tapers to a halt, the Wrestling Wolf collapses beside you and dozes off. Not wanting to disturb him, you carefully remove yourself from his now limp shaft and quietly leave the ring.";
					CreatureSexAftermath "Player" receives "PussyFuck" from "Wrestling Wolf";
			else:
...
to say beatthewrwolf:
	...
	if wrwolfbeaten < 3 or Player is not male:	[currently M/M only]
		...
		if Player consents:
			...
			WaitLineBreak;
			say "     'Now that was quite the match! Quite the finishing move ya got there,' he chuckles. 'You're not too shabby there,' he says as he strides around the ring, almost as if he wasn't hurt at all. 'Heh, maybe next time I won't have ta hold back on ya. So make sure ta come back when you're ready ta have another go,' he calls out to you as you walk away from the ring.";
			CreatureSexAftermath "Wrestling Wolf" receives "AssFuck" from "Player";
		else:
			LineBreak;
...
When Play begins:
	...
	add "Wrestling Wolf" to infections of MaleList;
	add "Wrestling Wolf" to infections of TaperedCockList;
	add "Wrestling Wolf" to infections of KnottedCockList;
	...
	now MilkItem entry is "wrestling wolf milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "wrestling wolf cum"; [ Item to be given to the player if they have this infection and jerk off. ]
