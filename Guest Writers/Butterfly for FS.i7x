...
the scent of racy lingerie is "While always smelling clean and fresh at first, smelling a little longer picks up a faint perfume and the scent of [if player is herm]male and female [otherwise if player is female]female [otherwise if player is male]male [end if]arousal.".
...
to say lingerie store scene:
	...
	if damaged negligee is owned and pristine negligee is not owned and "pristine negligee" is not listed in invent of lingerie store:
		...
		now carried of pristine negligee is 1;
	if perception of player is greater than 15 and butterfly grove is known:
