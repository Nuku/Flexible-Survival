...
didsubmit is a number that varies.[@Tag:NotSaved]
...
When Play begins:
	...
	now Species Name entry is "Parasitic Plant"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now Name entry is "Parasitic Plant";
	...
	now CumItem entry is "parasitic plant cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
This is the Parasitic Plant Infection rule:
	if Player has a body of "Parasitic Plant":
		trigger ending "Parasitic Plant Infection"; [Here it states, that the ending has been played.]
