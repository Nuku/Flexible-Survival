...
to say losetopitbull:
	if pitbullgender is 1: [Female Pit Bull Defeat Scenes]
		...
		else if anallevel > 1 and ( a random chance of 1 in 5 succeeds or ( Player is not female and a random chance of 1 in 5 succeeds ) or ( ( anallevel is 3 or Player is mpreg_ok ) and a random chance of 1 in 5 succeeds ) ): [Player's ass is fucked by Pit]
		...
		else if anallevel > 1 and ( a random chance of 1 in 5 succeeds or ( Player is not female and a random chance of 1 in 5 succeeds ) or ( ( anallevel is 3 or Player is mpreg_ok ) and a random chance of 1 in 5 succeeds ) ):
