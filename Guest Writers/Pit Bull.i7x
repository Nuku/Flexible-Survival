...
pitbullgender is a number that varies.[@Tag:NotSaved]

to say losetopitbull:
	if pitbullgender is 1: [Female Pit Bull Defeat Scenes]
		say "     [if HP of Player > 0]You suddenly call for your surrender; however, the canine doesn't buy it and smacks you down to the ground. She continues to strike at you until you're clearly not retaliating. Satisfied, she moves to enact her punishment, stripping you of any attire you might have[else]The canine throws one final punch, making your head spin as you fall to the ground. Now too weak to contest her will, she forces you free of any clothing you might have been wearing and prepares to have her way with you[end if].";
		if Player is male and Cock Length of Player < 25 and a random chance of 3 in 5 succeeds: [Female Pit riding players cock]
			say "     With a twisted grin - an initial tell of her wanton hunger - she grabs you by [if Cock Count of Player > 1]one of [end if]your [cock size desc of Player] dick[smn], firmly pumping it into arousal, her infectious influence supplementing her harsh treatment of your tool. Her endeavors are only momentary until she is satisfied, pulling off her pants before [if scalevalue of Player > 3]climbing on top of[else]moving over[end if] you and promptly impaling herself with your hardened organ.";
			WaitLineBreak;
			...
			CreatureSexAftermath "Pit Bull" receives "PussyFuck" from "Player";
		else if Player is purefemale and a random chance of 3 in 5 succeeds: [Female Pit scissoring female player]
			say "     Gripping your thighs firmly, you're forced to watch as her tongue begins to assault [if Cunt Count of Player > 1]one of [end if]your exposed, [cunt size desc of Player] cunt[sfn], that slick organ's twisted affection [if Libido of Player > 33]an imposed attempt to alleviate your lingering desire[else]forcing you to twist impotently as your desire rises[end if]. She disengages only briefly to relinquish herself of her pants, dripping portal already slick with her own arousal, before she returns to the task at hand.";
			if scalevalue of Player < 3:
				say "     Pulling the legs of your diminutive form up, forcing you to hang mercilessly in the air as she grinds her snatch against yours with a dizzyingly wanton fervor, exacerbated as you're forced to contend with the blood rushing to your head, it's not long before [if Libido of Player > 33]you cry out in orgasm, her[else]she cries out in orgasm, your[end if] own soon following in its wake, gushing holes dripping down against your beleaguered form. Satisfied, she lets you go, causing you to stumble to the ground, and she doesn't give you much time to gather yourself and your things before she starts booting you out of her territory, forcing you to flee an embarrassed mess as you are.";
			else if scalevalue of Player > 3:
				say "     Holding you once more, her following assault is somewhat awkward - though just as much outwardly satisfying to her ego - by your comparatively large size as she grinds her snatch against yours with such a wanton fervor, lust streaked with shame that you are so mercilessly used by a canine smaller than you. It's not long before [if Libido of Player > 33]you cry out in orgasm, her[else]she cries out in orgasm, your[end if] own soon following in its wake, gushing holes smearing their mess across your exposed crotch. Now satisfied, she pulls free of you, and she doesn't give you much time to gather yourself and your things before she starts booting you out of her territory, forcing you to flee an embarrassed mess as you are.";
			else:
				say "     Pulling your legs closer, she drags you forward that she might grind her snatch against yours with such a wanton fervor, perverse hunger made alight by the fiery need of the harsh canine, quickly overwhelming you. It's not long before [if Libido of Player > 33]you cry out in orgasm, her[else]she cries out in orgasm, your[end if] own soon following in its wake, gushing holes smearing their mess across your exposed crotch and thighs. Now satisfied, she pushes you free of her, and she doesn't give you much time to gather yourself and your things before she starts booting you out of her territory, forcing you to flee an embarrassed mess as you are.";
			CreatureSexAftermath "Player" receives "Other" from "Pit Bull";
		else if FangWS is 1 and (a random chance of 1 in 3 succeeds or (Player is kinky and a random chance of 1 in 4 succeeds)): [watersports-marking]
			...
			if Player is not neuter:
				if Libido of Player > 69:
					if Player is male:
						say "     Cock[smn] driven erect by her influence, [itstheirm] need for attention is left largely disregarded by the canine; rather, she intends to stimulate you purely by force. You feel her knuckles grind against your prostate with a reckless abandon. You almost immediately fire off your [Cum Load Size of Player] load, [if Ball Size of Player > 4]drenching your torso and neck[else]seed wasted against your torso[end if]. She's actually a bit surprised by this, probably not suspecting you to be this pathetically easy to get off. Her clear annoyance is inevitably abated when she seems satisfied in her goal of humiliating you, regardless.";
					else:
						say "     Cunt[sfn] dripping wet with a needy hunger in the wake of her influence, [itstheirf] desire for attention is left largely disregarded by the canine; rather, she intends to stimulate you purely by force. You feel her knuckles grind against your passage with a reckless abandon. You almost immediately cry out in orgasm, your sexual fluids dripping down and only serving to lubricate what thrusts that might follow. She's actually a bit surprised by this, probably not suspecting you to be this pathetically easy to get off. Her clear annoyance is inevitably abated when she seems satisfied in her goal of humiliating you, regardless.";
				else:
					if Player is male:
						say "     Cock[smn] driven erect by her influence, [itstheirm] need for attention is left largely disregarded by the canine; rather, she intends to stimulate you purely by force. You feel her knuckles grind against your prostate with a reckless abandon. [if Libido of Player > 33]It's not long before you[else]It seems like forever until you finally[end if] cry out in orgasm, your cock[smn] firing off [itstheirm] [Cum Load Size of Player] load, [if Ball Size of Player > 4]drenching your torso and neck[else]seed wasted against your torso[end if]. As you eventually recover, it becomes clear that the canine appears satisfied with her endeavors to humiliate you as you are.";
					else:
						say "     Cunt[sfn] dripping wet with a needy hunger in the wake of her influence, [itstheirf] desire for attention is left largely disregarded by the canine; rather, she intends to stimulate you purely by force. You feel her knuckles grind against your passage with a reckless abandon. [if Libido of Player > 33]It's not long before you[else]It seems like forever until you finally[end if] cry out in orgasm, your sexual fluids dripping down and only serving to lubricate what thrusts that might follow. As you eventually recover, it becomes clear that the canine appears satisfied with her endeavors to humiliate you as you are.";
			else:
				say "     Twisted lust gradually overwhelming you, she doesn't appear to regard your genderless state; rather, she intends to stimulate you purely by force. You feel her knuckles grind against your passage with a reckless abandon. It feels like hours before she finally relents, yourself exhausted by this physical assault and that of your unabated lust. The canine appears satisfied in her endeavors to humiliate you.";
			say "     Pulling her fist free of you with an audible, wet sound, she adds further insult to injury by cleaning it against your [if scalevalue of Player > 3]large and [end if]beleaguered frame before she inevitably starts forcing your exhausted and embarrassed form to flee from her territory[if scalevalue of Player < 4 and player is not twistcapped], no doubt relegated to walking funny for the while that follows[end if].";
			CreatureSexAftermath "Player" receives "AssDildoFuck" from "Pit Bull";
		else: [Player gets pussy in face from female Pit]
			say "     Exposed before the pit bull, she - in turn - relinquishes herself of her pants, revealing her already dripping cunt before you, her intent further elucidated when she pulls your [if scalevalue of Player > 3]head[else]form[end if] closer, demanding that you offer up tribute for your trespass. [if HP of Player > 0 or Player is submissive]Implicitly complying[else]After a fair amount of coaxing[end if], your [if scalevalue of Player > 3]large maw engulfs the entirety of her slick portal almost immediately, the aggressive canine taking great joy in demeaning someone as large as you[else]lips caress her slick portal, her strong grip forcing you more firmly against her crotch, relegating you to contend with her hungry pussy more than any better restraint might have compelled you to[end if].";
	...
	else: [Male Pit Bull Defeat Scenes]
		say "     [if HP of Player > 0]You suddenly call for your surrender; however, the canine doesn't buy it and smacks you down to the ground. He continues to strike at you until you're clearly not retaliating. Satisfied, he moves to enact his punishment, stripping you of any attire you might have[else]The canine throws one final punch, making your head spin as you fall to the ground. Now too weak to contest his will, he forces you free of any clothing you might have been wearing and prepares to have his way with you[end if].";
		if Player is female and a random chance of 3 in 5 succeeds: [Player's pussy fucked by male Pit]
			if scalevalue of Player > 3:
				say "     Unbuttoning his pants and pushing you onto your back, he takes a moment to adjust your large frame so that your [cunt size desc of Player] cunt[if Cunt Count of Player > 1]s are[else]is[end if] exposed before him, promptly impaling [if Cunt Count of Player > 1]one of them[else]it[end if] with his hardening dick. [if Cunt Depth of Player > 16]Having little difficulty in penetrating your[else if Cunt Depth of Player > 5]Blatant in his use of your[else]Brief, strained grunts elicited as he contends with your tight[end if] hole, he's fairly reckless in the abusive pursuit of his own personal pleasure, bearing little regard for your own well-being in the matter.";
			else:
				say "     Unbuttoning his pants and pushing you onto your back, he exposes your [cunt size desc of Player] cunt[sfn] before him, promptly impaling [if Cunt Count of Player > 1]one of them[else]it[end if] with his hardening dick. [if Cunt Depth of Player > 16]Having little difficulty in penetrating your[else if Cunt Depth of Player > 5]Blatant in his use of your[else]Brief, strained grunts elicited as he contends with your tight[end if] hole, he's fairly reckless in the abusive pursuit of his own personal pleasure, bearing little regard for your own well-being in the matter.";
			WaitLineBreak;
			if Libido of Player > 40:
				say "     It's not long before you feel his canine knot bang belligerently against your feminine portal, his thrusts becoming increasingly deliberate as he [if Cunt Tightness of Player > 9]forces it in with little effort[else if Cunt Tightness of Player > 5]quickly forces the thick remainder of his meat into you[else]squeezes it in with such painful, abusive force[end if], more than enough to cause you to orgasm in twisted pleasure, [if Player is male]cock[smn] spilling [itstheirm] [Cum Load Size of Player] load impotently into the ground[else]stuffed hole tightening around its belligerent intruder[end if]. Your tightening hole is more than enough to bring him over the edge, and you soon feel his hot seed flood the depths of your womb.";
				decrease Libido of Player by Libido of Player / 8;
			else:
				say "     It's not long before you feel his canine knot bang belligerently against your feminine portal, his thrusts becoming increasingly deliberate as he [if Cunt Tightness of Player > 9]forces it in with little effort[else if Cunt Tightness of Player > 5]quickly forces the thick remainder of his meat into you[else]squeezes it in with such painful, abusive force[end if], his orgasm soon following in its wake, hot seed flooding the depths of your womb.";
			...
			CreatureSexAftermath "Player" receives "PussyFuck" from "Pit Bull";
		else if anallevel > 1 and ( a random chance of 1 in 5 succeeds or ( Player is not female and a random chance of 1 in 5 succeeds ) or ( ( anallevel is 3 or "MPreg" is listed in feats of Player ) and a random chance of 1 in 5 succeeds ) ): [Player's ass is fucked by Pit]
			say "     Unbuttoning his pants and pushing you onto your back, he [if scalevalue of Player > 3]takes a moment to adjust your large frame so that your asshole is exposed before him, promptly impaling it with his hardening dick[else]exposes your asshole before him, promptly impaling it with his hardening dick[end if]. [if scalevalue of Player > 3]Having little difficulty in penetrating your anal ring[else if scalevalue of Player < 3 and player is not twistcapped]Brief, strained grunts elicited as he contends with your tight ring[else]Blatant in his use of your anal ring[end if], he's fairly reckless in the abusive pursuit of his own personal pleasure, bearing little regard for your own well-being in the matter.";
			WaitLineBreak;
			if Libido of Player > 60 and Player is not neuter:
				say "     It's not long before you feel his canine knot bang belligerently against your ass, his thrusts becoming increasingly deliberate as he [if scalevalue of Player > 3]forces it in with little effort[else if scalevalue of Player < 3 and player is not twistcapped]squeezes it in with such painful, abusive force[else]quickly forces the thick remainder of his meat into you[end if], more than enough to cause you to orgasm in twisted pleasure, [if Player is male]cock[smn] spilling [itstheirm] [Cum Load Size of Player] load impotently into the ground[else]stuffed hole throbbing against its belligerent intruder[end if]. Your throbbing ring is more than enough to bring him over the edge, and you soon feel his hot seed flood the depths of your bowels.";
				decrease Libido of Player by Libido of Player / 8;
			else:
				say "     It's not long before you feel his canine knot bang belligerently against your ass, his thrusts becoming increasingly deliberate as he [if scalevalue of Player > 3]forces it in with little effort[else if scalevalue of Player < 3 and player is not twistcapped]squeezes it in with such painful, abusive force[else]quickly forces the thick remainder of his meat into you[end if], his orgasm soon following in its wake, hot seed flooding the depths of your bowels.";
				raise Player Libido by 5;
			say "     Panting behind you for a moment, the pit bull eventually [if scalevalue of Player > 3]pulls himself off you[else]pushes you off of him[end if], giving you little time to gather yourself before forcing you to retreat from his territory.";
			CreatureSexAftermath "Player" receives "AssFuck" from "Pit Bull";
		else if FangWS is 1 and (a random chance of 1 in 3 succeeds or (Player is kinky and a random chance of 1 in 4 succeeds)): [Watersports-marking]
			...
			if Player is submissive:
				say "     You're overwhelmed by your submissive tendencies driven to take the full brunt of his acrid release. The harsh taste of his fluids against your palate, you immerse yourself in the scent of his piss, partially drinking his fluids. Laughing, he offers mocking approval to such an obliging little bitch[if scalevalue of Player > 3], his amusement exacerbated further by how complicit you are in spite your large size[end if]. His flow inevitably diminishes before ceasing altogether, much to your discontent, before he puts his pants back on and leaves you with a harsh swat on the rear, forcing you to gather your things and retreat from his domain.";
				PlayerDrink 5;
				raise Player Libido by 5;
			else:
				say "     You [if HP of Player > 0]reluctantly oblige his abuse, taking[else]try to turn away, but he grabs you by your head, forcing you to face[end if] the full brunt of his acrid release. [if scalevalue of Player > 3]It's a pitiful sight, to see a creature as large as you are pissed on by the comparatively diminutive pit bull, forcing your senses to be[else]You can only silently take his humiliation, senses forcefully[end if] flooded with the taste and smell of his harsh fluids. His flow inevitably diminishes before ceasing altogether, much to your relief, before he puts his pants back on and leaves you with a harsh swat on the rear, forcing you to gather your things and retreat from his domain.";
		else if anallevel > 1 and ( a random chance of 1 in 5 succeeds or ( Player is not female and a random chance of 1 in 5 succeeds ) or ( ( anallevel is 3 or "MPreg" is listed in feats of Player ) and a random chance of 1 in 5 succeeds ) ):
			if scalevalue of Player > 4: [Player's ass fingered by male Pit]
				say "     He laughs, slapping your rear harshly, no doubt amused to have felled a such a massive trespasser. Too embarrassed, you look away as you feel a couple of fingers beginning to penetrate your anal ring. [if HP of Player < 1]Ignoring what protests you may offer up[else]Soft moans of pleasure escaping your lips[end if], your large passage is more than willing to abide his intrusion. With an audible snort, he regards your accommodation as a challenge and shows no restraint in stuffing the whole of his fist down the portal, to little avail.";
			else if scalevalue of Player is 4:
			...
			if Player is not neuter:
				if Libido of Player > 69:
					if Player is male:
						say "     Cock[smn] driven erect by his influence, [itstheirm] need for attention is left largely disregarded by the canine; rather, he intends to stimulate you purely by force. You feel his knuckles grind against your prostate with a reckless abandon. You almost immediately fire off your [Cum Load Size of Player] load, [if Ball Size of Player > 4]drenching your torso and neck[else]seed wasted against your torso[end if]. He's actually a bit surprised by this, probably not suspecting you to be this pathetically easy to get off. His clear annoyance is inevitably abated when he seems satisfied in his goal of humiliating you, regardless.";
					else:
						say "     Cunt[sfn] dripping wet with a needy hunger in the wake of his influence, [itstheirf] desire for attention is left largely disregarded by the canine; rather, he intends to stimulate you purely by force. You feel his knuckles grind against your passage with a reckless abandon. You almost immediately cry out in orgasm, your sexual fluids dripping down and only serving to lubricate what thrusts that might follow. He's actually a bit surprised by this, probably not suspecting you to be this pathetically easy to get off. His clear annoyance is inevitably abated when he seems satisfied in his goal of humiliating you, regardless.";
				else:
					if Player is male:
						say "     Cock[smn] driven erect by his influence, [itstheirm] need for attention is left largely disregarded by the canine; rather, he intends to stimulate you purely by force. You feel his knuckles grind against your prostate with a reckless abandon. [if Libido of Player > 33]It's not long before you[else]It seems like forever until you finally[end if] cry out in orgasm, your cock[smn] [itstheirm] [Cum Load Size of Player] load, [if Ball Size of Player > 4]drenching your torso and neck[else]seed wasted against your torso[end if]. As you eventually recover, it becomes clear that the canine appears satisfied with his endeavors to humiliate you as you are.";
					else:
						say "     Cunt[sfn] dripping wet with a needy hunger in the wake of his influence, [itstheirf] desire for attention is left largely disregarded by the canine; rather, he intends to stimulate you purely by force. You feel his knuckles grind against your passage with a reckless abandon. [if Libido of Player > 33]It's not long before you[else]It seems like forever until you finally[end if] cry out in orgasm, your sexual fluids dripping down and only serving to lubricate what thrusts that might follow. As you eventually recover, it becomes clear that the canine appears satisfied with his endeavors to humiliate you as you are.";
			else:
				say "     Twisted lust gradually overwhelming you, he doesn't appear to regard your genderless state; rather, he intends to stimulate you purely by force. You feel his knuckles grind against your passage with a reckless abandon. It feels like hours before he finally relents, yourself exhausted by this physical assault and that of your unabated lust, the canine appears satisfied in his endeavors to humiliate you.";
...
To say beatthepitbull:
	...
	[]
	if humanity of Player - Libido of Player < 0 and (Player is male or (Player is female and ( HP of Dominick < 10 or HP of Dominick >= 20 or BodyName of Player is not "Breederslut" or FaceName of Player is not "Breederslut"))):
		say "     With one final effort you set upon the canine, who falls under the weight of your superior prowess. Compelled by your lust, you lose your self-control and seek to sate your sexual needs using your fallen foe. You immediately remove what attire might obstruct your tainted endeavor and advance upon [ghim].";
		sort randompitbullchoice in random order;
		if entry 1 of randompitbullchoice is:
			-- 1: say "[pitbull_vsex1]";
			-- 2: say "[pitbull_vsex2]";
			-- 3: say "[pitbull_vsex3]";
			-- 4: say "[pitbull_vsex4]";
			...
			-- 6: say "[pitbull_vsex6]";
			-- 7: say "[pitbull_vsex7]";
	else if Libido of Player >= 30 and Player is not neuter:
		say "     With one final effort you set upon the canine, who falls under the weight of your superior prowess. As [ghe] lies before you this might be an opportune moment to satisfy any lingering need you might possess. Looking over the fallen canine, you quickly weigh your possible options for sexual fun[if HP of Dominick >= 10 and HP of Dominick < 20 and Player is female and ( Player is breederslutbodied or Player is breederslutfaced ) and pitbullgender is 1], including possibly trying to turn this junkyard dog into another pet for Dominick[end if].";
		...
		say "     With one final effort you set upon the canine, who falls under the weight of your superior prowess. Satisfied with your victory, and feeling that you might not require anything further from [ghim], you depart from the beast.";

to say pitbull_vsex1:		[receive fellatio]
	say "     Pulling the pit bull upright, you offer [if Cock Count of Player > 1]one of [end if]your exposed, [Cock of Player] dick[smn] to [ghim]. [if pitbullgender is 2]His expression one of ill-regard to this prospect, you're compelled to grind the hardening, [cock size desc of Player] organ against his face until he obliges you[else]A growl her remark, she looks clearly disinterested in what you're offering her, forcing you to coax her into compliance as you grind the hardening, [cock size desc of Player] thing until she'll reluctantly oblige[end if]. [if Cock Length of Player > 18]Much too massive to abide, the beast is relegated to offering a tongue's lone, imposed affection[else]Tongue's imposed affection offered against its length, the beast follows up with [ghis] lip's embrace[end if], organ now slick with a mix of saliva and pre.";
	say "     [if pitbullgender is 2]Prior restraint slowly dissolved in the wake of his own rising need, he offers up tainted moans[else]Not particularly happy with this arrangement, though too weak to offer up any real protest, she growls[end if] as [ghe] tastes your emergent fluids, [ghis] audible regard vibrating against your length. [if pitbullgender is 2]Stroking himself[else]Perpetual grimace her regard[end if] as [ghe] attends your needs, [if pitbullgender is 2]it's not long before[else]it takes some time until[end if] you reach your bliss, [if Cock Length of Player > 18]dousing the canine with[else]forcing the canine to swallow[end if] your [Cum Load Size of Player] payload.";
	...
	CreatureSexAftermath "Pit Bull" receives "OralCock" from "Player";

to say pitbull_vsex2:		[receive cunnilingus]
	say "     Pulling the pit bull upright, you offer [if Cunt Count of Player > 1]one of [end if]your exposed, [bodytype of Player] cunt[sfn] to [ghim]. [gchis] expression one of ill-regard to this prospect, you're compelled to grind the dripping, [cunt size desc of Player] portal against [ghis] face until [ghe] obliges you. Tongue's imposed affection offered against its supple lips, it inevitably descends upon its depths, portal now slick with a mix of saliva and sexual fluids[if Cock Count of Player > 2], your exposed dicks driven hard for want of attention, forcing your hands to occupy two of them[else if Cock Count of Player is 2], your exposed dicks driven hard for want of attention, forcing your hands to occupy both of them[else if Player is male], your exposed dick driven hard for want of attention, forcing one of your hands to occupy it[end if].";
	say "     Prior restraint slowly dissolved in the wake of [ghis] own rising need, [ghe] offers up tainted moans as [ghe] tastes your wanton honey, [ghis] audible regard vibrating against this yielding hole. [if pitbullgender is 2]Stroking[else]Fondling[end if] [ghim]self as [ghe] attends your needs, it's not long before you reach your bliss, [if Player is male]cock[smn] exploding with gouts of cum, painting the canine[else]dousing the canine's face[end if] with your release.";
	say "     Furiously [if pitbullgender is 2]stroking[else]fondling[end if] [ghim]self in the wake of this, [ghe] spends [ghim]self all over the ground soon thereafter, left in a lustful haze as you inevitably depart, tainted need satisfied.";
	CreatureSexAftermath "Pit Bull" receives "OralPussy" from "Player";

to say pitbull_vsex3:		[give vaginal]
	say "     Pulling the pit bull upright, you offer [if Cock Count of Player > 1]one of [end if]your exposed, [Cock of Player] dick[smn] to her. A growl her remark, she looks clearly disinterested in what you're offering her, forcing you to coax her into compliance as you grind the hardening, [cock size desc of Player] thing until she'll reluctantly oblige. Tongue's imposed affection offered against its length, the beast follows up with her lip's embrace, organ now slick with a mix of saliva and pre.";
	say "     Satisfied with her work, you pull yourself free of the canine before pushing her onto her back. Adjusting her positioning until you might mount her proper, [if Cock Length of Player > 11]she's not particularly happy about the prospect of being impaled by the impressive tool[else]low growl her regard to the plans you have in store for her[end if], not that she has any say in the matter. Slowly, you sink your [Cock of Player] dick into the folds of her supple flesh, frame tense with ill-regard for this intrusion; it takes [if Cock Length of Player >= 12]some time until she's properly loosened up for[else]but a moment before her flesh yields to[end if] your endeavors.";
	WaitLineBreak;
	say "     [if scalevalue of Player > 3]Larger frame eclipsing her own, she rocks[else]Rocking[end if] to-and-fro under your weight as you fuck her proper[if scalevalue of Player > 3], remaining[else]. She remains[end if] unrelenting in her audible disdain for your abuse, even as her stuffed hole slickens with tainted approval in the wake of your rising fervor. Firmly pinned to the ground, your grip gradually tightens until the ponderous weight of your imminent bliss; sweat-slicked form ill-abiding embrace for the canine, it's not long before you cry out, [if Player is knotted]tying the beast as your [Cum Load Size of Player] load floods[else][Cum Load Size of Player] load flooding[end if] her depths[if Cock Count of Player > 2], your exposed members staining her fur[else if Cock Count of Player is 2], your exposed member staining her fur[end if].";
...
to say pitbull_vsex4:		[give anal]
	if Cock Length of Player > 11:
		if pitbullgender is 2:
			say "     The pit bull regards you with a beleaguered growl as you pull his weakened frame to expose his taut and muscled ass before you. Growls diminished into whimpers as you grind [if Cock Count of Player > 1]one of [end if]your [cock size desc of Player], hardening dick[smn] between his exposed cheeks, no doubt intimidated by your impressive size. Readied, you thrust the tip of your [Cock of Player] cock into his ill-abiding pucker. Strained grunts escaping your lips, it takes a measure of work until the tight hole will yield to such an irreverent intrusion, the canine groaning against your tainted endeavor.";
		else:
			say "     The pit bull regards you with a beleaguered growl as you pull her weakened frame to expose her taut and muscled ass before you. Growls growing louder as you grind [if Cock Count of Player > 1]one of [end if]your [cock size desc of Player], hardening dick[smn] between her exposed cheeks, no doubt she challenges the prospect of being impaled by such an impressive thing. Readied, you thrust the tip of your [Cock of Player] cock into her ill-abiding pucker. Strained grunts escaping your lips, it takes a measure of work until the tight hole will yield to such an irreverent intrusion, the canine groaning against your tainted endeavor.";
	else:
		say "     The pit bull regards you with a beleaguered growl as you pull [ghis] weakened frame to expose [ghis] taut and muscled ass before you. Grinding [if Cock Count of Player > 1]one of [end if]your [cock size desc of Player], hardening dick[smn] against [ghis] exposed cheeks, you elucidate upon your tainted plans for the beast, much to [ghis] ill-regard to the prospect. Readied, you thrust the tip of your [Cock of Player] cock into [ghis] pucker. Strained grunts escaping your lips, it takes a measure of work until the tight hole will yield to such an irreverent intrusion, the canine groaning against your tainted endeavor.";
	say "     [if scalevalue of Player > 3]Ground against the earth under your weight[else]Rocking against the earth[end if], you thrust upon the beast with a rising fervor, alight with this twisted compulsion. Lingering [if pitbullgender is 2]whimpers his[else]growls her[end if] regard, [ghe] can't help but be influenced by your endeavors, [ghis] unattended [if pitbullgender is 2]dick grinding against the ground[else]cunt staining the ground with its honey[end if]. Pounding [ghis] ass for a fair measure of time before you find your bliss, [if Player is knotted]tying your knotted[else]hilting your[end if] organ within [ghis] bowels[if Cock Length of Player > 11], [ghis] cries its punctuation when forced to abide the whole of the impressive thing[end if] as you flood [ghis] depths with your [Cum Load Size of Player] load.";
	say "     You require a moment to recover before you audibly pull your rod from the canine's hole, letting [ghim] off, still [if pitbullgender is 2]whimpering[else]grumbling[end if] as [ghe] nurses [ghis] [if Cock Length of Player > 11]very [end if]sore and cum-stained ass before you yourself head on your merry way.";
	CreatureSexAftermath "Pit Bull" receives "AssFuck" from "Player";

to say pitbull_vsex5:		[scissoring]
	say "     Pulling the pit bull upright, you offer [if Cunt Count of Player > 1]one of [end if]your exposed, [bodytype of Player] cunt[sfn] to her. Her expression one of ill-regard to this prospect, you're compelled to grind the dripping, [cunt size desc of Player] portal against her face until she obliges you. Tongue's imposed affection offered against its supple lips, it inevitably descends upon its depths, portal now slick with a mix of saliva and sexual fluids.";
	say "     Not to be too quickly taken over by your wanton need, you free yourself of the canine's slick influence, pushing her onto her back and readjusting your position over the beast, coarse-furred leg pulled entwined with your own[if scalevalue of Player > 4], massive[else if scalevalue of Player is 4], larger[else if scalevalue of Player < 3], smaller[end if] form. Kept in place with one hand, the other assuages your companion, caress of her toned frame and firm breasts inciting moans to escape her muzzle in tainted approval.";
	WaitLineBreak;
	...
	CreatureSexAftermath "Pit Bull" receives "Other" from "Player";

to say pitbull_vsex6:		[receive vaginal]
	say "     Exposing the pit bull's crotch to the open air, you offer a hand in twisted affection, stroking his sheathed tool until it exposes itself before you, whimpering moans the beast's regard for this treatment, his prior aggression melting away under the weight of your tainted endeavor. Sufficiently hard, you position your [if scalevalue of Player > 3]larger [end if]form over him before slowly lowering [if Cunt Count of Player > 1]one of [end if]your cunt[sfn] on the knotted dick, [if Cunt Depth of Player < 8]strained grunts escaping your lips in the wake of this fairly sizable[else]wanton moans your regard for this[end if] intrusion.";
	say "     Organ enveloped within the folds of your [if Cunt Depth of Player < 8]tight[else]supple[end if] flesh, you build a gradually rising pace of rocking against his cock, beast [if scalevalue of Player > 3]grunting loudly with each descent as he's forced to abide your ponderous weight[else]groaning audibly in the wake of his own growing desire[end if]. [if Player is male]As you continue, you busy yourself by stroking your own, hardening dick[smn] before[else]Gripping him firmly, you continue to writhe against the intrusion offered up by[end if] your captive audience, your bliss rapidly on the approach.";
	WaitLineBreak;
	say "     Heady weight of your fiery need radiating against the [if daytimer is night]night [end if]air, scent heavy with sweat and musk, your fervor reaches its wanton punctuation, impaling yourself upon his knot, your [if Player is male]dick[smn] painting the canine's form with your [Cum Load Size of Player] load[else]grip tightening against the canine[end if] as your needy hole works to milk him dry with a tainted determination. Soon thereafter your endeavors are richly rewarded, the beast howling under the strain of your climax as he floods the depths of your womb with his thick, virile seed.";
	say "     It takes you a while to recover from this ordeal, but eventually you do manage to pull the creature's softened dick from your now-leaking portal, departing from him as he lies there, a dazed and exhausted mess of a dog.";
	CreatureSexAftermath "Player" receives "PussyFuck" from "Pit Bull";

to say pitbull_vsex7:		[receive anal]
	say "     Exposing the pit bull's crotch to the open air, you offer a hand in twisted affection, stroking his sheathed tool until it exposes itself before you, whimpering moans the beast's regard for this treatment, his prior aggression melting away under the weight of your tainted endeavor. Sufficiently hard, you position your [if scalevalue of Player > 3]larger [end if]form over him before slowly lowering your asshole onto the knotted dick, [if scalevalue of Player < 3 and player is not twistcapped]strained grunts escaping your lips in the wake of this fairly sizable intrusion[else]wanton moans your regard for this intrusion[end if].";
	say "     Organ enveloped within the [if scalevalue of Player < 3 and player is not twistcapped]tight[else]yielding[end if] flesh of your bowels, you build a gradually rising pace of rocking against his cock, beast [if scalevalue of Player > 3]grunting loudly with each descent as he's forced to abide your ponderous weight[else]groaning audibly in the wake of his own growing desire[end if]. [if Player is male]As you continue, you busy yourself by stroking your own, hardening dick[smn] before[else]Gripping him firmly, you continue to writhe against the intrusion offered up by[end if] your captive audience, your bliss rapidly on the approach.";
	WaitLineBreak;
	say "     Heady weight of your fiery need radiating against the [if daytimer is night]night [end if]air, scent heavy with sweat and musk, your fervor reaches its wanton punctuation, impaling yourself upon his knot, your [if Player is male]dick[smn] painting the canine's form with your [Cum Load Size of Player] load[else]grip tightening against the canine[end if] as your needy pucker works to milk him dry with a tainted determination. Soon thereafter your endeavors are richly rewarded, the beast howling under the strain of your climax as he floods the depths of your bowels with his thick, virile seed.";
	say "     It takes you a while to recover from this ordeal, but eventually you do manage to pull the creature's softened dick from your now-leaking tailpipe, departing from him as he lies there, a dazed and exhausted mess of a dog.";
	CreatureSexAftermath "Player" receives "AssFuck" from "Pit Bull";
...
When Play begins:
	...
	now Species Name entry is "Pit Bull"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now desc entry is "     You run into what looks to be a fairly muscular canine, [ghis] body adorned in dirty and unkempt attire. The [if pitbullgender is 1]female[else]male[end if] growls deeply, making it clear that you've encroached upon [ghis] territory. [gchis] transparently fiery temperament ill-equipped to abide trespassers, [ghe] lunges forward to attack![line break]"; [ Description of the creature when you encounter it.]
	now face entry is "canine, though somewhat compacted, bearing a striking resemblance to a pit bull"; [ Face description, format as "Your face is [Face of Player]." ]
	now body entry is "muscled to fighting form with digitigrade legs ending in paws"; [ Body Description, format as "Your Body is [Body of Player]." ]
	now skin entry is "white fur. You have the occasional black splotch, most notably one on your left eye. It feels soft and pleasurable against your"; [ Skin Description, format as "Looking at yourself, your body is covered in [Skin of Player] skin." ]
	...
	now face change entry is "it becomes more canine, your ears moving towards the top of your head. It flattens a slight bit and you can feel your teeth become sharper. You appear to have the head of a pit bull"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
	now body change entry is "it becomes adapted for fighting. Muscles grow and become lean. Your legs go digitigrade and claws pop out of your feet. Make that paws now. You feel ready to take on the world"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	now skin change entry is "short, white hairs pop out all over, with a few black patches, most notably a splotch on your eye"; [ Skin change text, format as "Your skin feels funny as [skin change entry]." ]
	now ass change entry is "it becomes attractively muscled, and you feel a sharp pop as a small nub of a tail pops out"; [ Ass/tail change text, format as "Your ass feels funny as [ass change entry]." ]
	now cock change entry is "a knot forms on the base while a sheath forms towards the bottom. It shimmers in color before deciding on a deep burgundy color"; [ cock change text. format as "Your cock feels funny as (your text)." ]
	now str entry is 16;
	now dex entry is 16;
	now sta entry is 14;
	now per entry is 10;
	...
	now MilkItem entry is "pit bull milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "pit bull cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
this is the balltit rule:
	...
	if Player is male:			[powerful ball kick]
		...
		say "The [EnemyNameOrTitle] decides to play dirty and drives [ghis] foot into your groin, kicking you square in the nuts! You clutch your aching [Ball Size Adjective of Player] testicles, having taken [special-style-2][dam][roman type] damage!";
	else:					[strong tit punch]
		now multiplier is 110 + ( ( square root of ( Breast Size of Player + 1 ) ) * 6 );
		now dam is ( dam * multiplier ) / 100;
		say "The [EnemyNameOrTitle] decides to fight dirty and punches you hard in the [if Breast Size of Player > 0]tit[else]chest[end if]. Ouch! You have taken [special-style-2][dam][roman type] damage!";
	now damagein is dam;
...
This is the Pit Bull Infection rule:
	if Player has a body of "Pit Bull":
		...
		if humanity of Player < 10:
			if Player is herm and Player is not sterile:		[Succumb - H]
			...
			else if Player is female:	[Succumb - F]
				say "     Losing your mind to the infection, you wander off into the city and are drawn to a run-down neighborhood. There, you find one of the female pit bulls you've seen around guarding a junkyard. She approaches cautiously, but as you get on all fours and offer your wet pussy to her, she relaxes and moves in to welcome you properly. Her tongue dives deep into your pussy until you cum before she gets you to return the favor. You settle down with her. When the military move through, you both hide together among the junk, but do venture out at night to drag away a few more female soldiers to make into horny pit bulls to pleasure your alpha.";
			else if Player is male:	[Succumb - M]
				say "     Losing your mind to the infection, you wander off into the city where you are found by a mostly-unchanged human. She has four enlarged breasts and featureless golden eyes, but no other visible changes. You approach her eagerly, but there is something about her stance and how she looks at you that cuts your charge short. Clearly experienced at handling dogs, she soon has you obediently taking treats and is calling you by pet names. She trains you well over the remaining time in the city, teaching you to be a good dog and rewarding you with treats or handjobs. Your mind slips further and further away during this time until you're nothing but an obedient pet for your mistress.";
				say "     When the military comes through, she is extracted along with you. They briefly have some concern about taking you along, but she's quite persuasive and has you demonstrate what a good doggy you are. Eventually released, she sets up a new life for herself with you as her loyal pet. Having been treated to prevent infection, she now happily takes you into her bed, letting you rut your mistress[if Player is not sterile], eventually filling her with pit bull puppies with lovely, alluring, golden eyes[end if].";
			else:								[Succumb - N]
				say "     Losing your mind to the infection, you wander off into the city. Being neuter, you lack much of the same wild drive as many of the others around you. You are found by an infected wanderer, who cares for you and trains you to be his loyal dog, helping to protect him from the ravages of this strange world.";
		else:		[Survive]
			say "     After leaving the military's quarantine, you eventually get work as a security guard, watching over construction sites and junkyards at night. Your fierce appearance and loyal nature make you a good candidate for the work and you find it suits you fine. You eventually settle down with a sexy Doberman, rutting with your canine lover often.";
