...
"Spidergirl"	"[PrepCombat_Spidergirl]"

to say PrepCombat_Spidergirl:
	setmongender 5;
...
When Play begins:
	...
	now Species Name entry is "Spidertaur"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now MilkItem entry is "spidergirl milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "spidergirl cum"; [ Item to be given to the player if they have this infection and jerk off. ]
