...
to say CollieDesc:
	...
	if inasituation is true:
		...
		if enemy type entry is 1: [unique enemy, player does not know the name]
			say "     An enormously big figure comes walking down the street and looks at you with a grin on her muzzle. The canine beast looks quite a bit like Lassie, if Lassie were nine feet tall, walked upright and had the general shape of an attractive woman. She's wearing a sports bra that only serves to cover two of her eight nipples breasts, with a second and third pair of progressively smaller breasts running down her front to end at two basically flat nipples on her firm abs. A noticable bulge in the front of her jeans allows you the guess that this anthro isn't exactly a regular woman either. On second thought, she doesn't look much like Lassie after all.";
