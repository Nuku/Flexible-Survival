...
to say Shemale Smooth Collie attack:
	...
	else if player is female and ( cunt length of player < 18 or cunt width of player < 6 ):
...
to say Shemale Smooth Collie defeat:
	if inasituation is true:
		...
		if player is female and ( cunt length of player >= 18 and cunt width of player >= 6 ):
			choose a blank row in table of fucking options;
