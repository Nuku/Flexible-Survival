...
to say Shemale Smooth Collie attack:
	...
	if colliedefeat is 0:
		...
		if Cunt Depth of Player < 18 or Cunt Tightness of Player < 6:
...
to say CollieVagRide:
	...
	say "     Your vaginal walls clamp down around the knot, drawing a lustful howl from the collie. You can feel those hot, heavy orbs under your ass pull up and throb a moment before the first of a near-constant stream of doggy cum shoots into you. Her seed gushes into your womb, leaving it swollen in no time. She continues to cum even after your uterus is full, stretching your belly as she pumps more and more of her thick, fertile seed into your [if gestation of child > 0]already occupied womb[else if Player is impreg_able]ready and waiting womb[else]belly[end if]. After what feels like gallons of cum has been stuffed into you, the worn out canine passes out and you're left stuck on her knot. It keeps it all trapped inside you, leaving your belly rounded and your insides feeling warm and tingly, if [if scalevalue of Player < 3]more than a bit uncomfortably stretched as well[else]a bit uncomfortably stretched[end if][if Player is impreg_able] while her cum does its best to knock you up[end if]. When it finally does go down enough to free you, you pull yourself off the flagging doggy dong, drooling a mess of her cum onto the shemale's manhood and down your thighs.[fimpregchance]";
	CreatureSexAftermath "Player" receives "PussyFuck" from "Smooth Collie Shemale";

to say CollieAnalRide:
	setmonster "Smooth Collie Shemale";
	say "     With one hand on the collie's dick and the other on her shoulder, you get her to roll over onto her back for you. She groans, still dazed from the fight, and doesn't notice what you're doing until you're already pressing the dribbling tip of her canine cock against your back door. Your pucker spreads [if scalevalue of Player > 4 or Player is twistcapped]readily[else]slowly[end if] to accept the tapered glans, taking the first few inches of meat into your ass. She groans something [if Player is female]asking why you'd even want it in the butt when you've got a cunt she could be breeding[else]about why you wouldn't just let her fuck you if that's what you wanted[end if], but you cut her off by grabbing her tits and giving her big nipples a squeeze. Spurts of milk fly from them and the canine shemale releases something between a whimper and moan of delight.";
	...
	say "     Your anal muscles clamp down around the base of the knot while your rectal walls squeeze down onto it, drawing a lustful howl from the collie. You can feel those hot, heavy orbs under your ass pull up and throb a moment before the first of a near-constant stream of doggy cum shoots into you. Her seed gushes into your bowels, flooding them [if Player is mpreg_ok]and your hidden womb [end if]with a torrent of virile cum. She continues to cum even after you're full, stretching your belly as she pumps more and more of her thick, fertile seed into your belly. After what feels like gallons of cum has been stuffed into you, the worn out canine passes out and you're left stuck on her knot. It keeps it all trapped inside your ass, leaving your tummy rounded and your insides feeling warm and tingly, if [if scalevalue of Player < 3 and Player is not twistcapped]more than a bit uncomfortably stretched as well[else]a bit uncomfortably stretched[end if][if Player is mpreg_able] while her cum does its best to knock you up[end if]. When it finally does go down enough to free you, you pull yourself off the flagging doggy dong, drooling a mess of her cum onto the shemale's manhood and down your thighs.[mimpregchance]";
	CreatureSexAftermath "Player" receives "AssFuck" from "Smooth Collie Shemale";
...
When Play begins:
	...
	now skin entry is "[if looknow is true]short, soft, dense fur in the sable pattern of a collie, completely covering your[else]short-furred, sable-patterned[end if]"; [ Skin Description, format as "Looking at yourself, your body is covered in [Skin of Player] skin." ]
	...
	now cock entry is "[if looknow is true]bright red canine/human hybrid in shape, complete with a knot and sheath,[else]canine hybrid[end if]"; [ Cock Description, format as you have a 'size' (your text) cock]
	now face change entry is "your skull begins to alter in shape as if made of clay. A sense of pressure here and a bit of stretching there, followed by a burning sensation in your mouth as your teeth are reshaped, you end up with the long, slender muzzle leading into the flat head of a collie"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
	now body change entry is "the change begins, bones cracking and snapping painlessly as they reshape. You can feel your waist drawing in [if Player is MalePreferred]somewhat and your shoulders broadening slightly, your body fat beginning to melt away as your muscles bulk up and become more defined, making you look like a bodybuilder... though with a more feminine figure than you'd like[else]and your shoulder broadening slightly, leaving you with a voluptuous figure that many women would kill to have[end if]. Your spine curves in a way that leaves your chest thrusted out and displayed more prominently. Your legs gain digitigrade form and thick pads form on your feet as they are altered into paws. Your palms burn a bit as thinner pads form there when your hands begin reshaping, leaving you with slender fingers tipped with nails that look slightly more claw-like than a human's";
	...
	now MilkItem entry is "smooth collie shemale milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "smooth collie shemale cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	now TrophyFunction entry is "-"; [ Function to generate a list of optional loot items, of which the player can choose one after victory. ]
	now scale entry is 4; [ Number 1-5, approx size/height of infected PC body: 1=tiny, 3=avg, 5=huge ]
	now body descriptor entry is "[if Player is MalePreferred][one of]muscled[or]strong[or]powerful[at random][else][one of]voluptuous[or]curvaceous[at random]"; [ Ex: "plump" "fat" "muscled" "strong" "slimy" "gelatinous" "slender". Use [one of] to vary ]
...
When Play begins:
	...
	now trigger text entry is "A whimper of need escapes your lips as a rush of heat builds between your legs. Nestled between your thighs your canine spade begins to puff up and swell, engorging and becoming looser for your desired mate. You leak pheromone-laden juices steadily as your body goes into heat. As these sensations grow, your need to be bred increases.[line break]";
		...
		if humanity of Player < 10:
			if Player is female:
				...
				if beauceronmet is true:
					...
					say "     With the help of your new mate, the two of you are able to surround and capture a lone soldier. With some canine milk and plenty of canine encouragement (sex), you turn him into a sexy herm collie to be the willing mate for you both. Together, your family of three (soon to be much more) happily finds a warm den to breed numerous litters of big, strong puppies. And in time, those pups grow up and spread out into the city and beyond in search of mates of their own.";
			else:		[neuter]
				say "     As your collie instincts take over, you find yourself with increasingly strong urges to mate and make more strong, beautiful collie pups. Leaving all else behind, you strike out into the city to satisfy your new instincts. Your search comes to an end when you encounter a large and powerfully built shemale collie, drawn towards each other's scent. Knowing your predicament to be even worse than her own, you spend some time together, relieving her lustful needs while searching for a true mate for her.";
				if beauceronmet is true:
					say "     Shortly after you meet up with her, an equally well-built beauceron comes along, but this canine is a cuntboy. He seems familiar somehow, though your memories from before are getting increasingly fuzzy, so it's hard to know exactly when that was. While he seems to think your friend is his cousin, you cannot be certain, but do smell the scent of heat coming from between his legs. Resolving to help both cousins with their needs for mates, you strike off together with renewed ambition.";
					say "     Helping your new friends, the three of you are able to surround and capture a lone soldier. With some canine milk and plenty of canine encouragement (sex), you turn him into a sexy herm collie to be the willing mate for the both of them. As a quartet of unusually gendered dogs - a shemale, a cuntboy, a herm and a neuter - you head off together as one family and pack of four (though soon to be more). You find a warm den for them to breed numerous litters of big, strong puppies while you take vicarious pleasure in playing with them while they breed and tending to the many puppies. In time, you settle into your new role, no longer feeling the urge to breed yourself (though always loving joining in to help) and instead accepting your place as caregiver to their frequent litters of strong puppies. And in time, those pups grow up and spread out into the city and beyond in search of mates of their own.";
				else:
					say "     Helping your new friend, the two of you are able to surround and capture a lone soldier. With some canine milk and plenty of canine encouragement (sex), you turn him into a sexy herm collie to be the willing mate of the shemale collie. As a trio of unusually gendered dogs - a shemale, a herm and a neuter - you head off together as one family and pack of three (though soon to be more). You find a warm den for them to breed numerous litters of big, strong puppies while you take vicarious pleasure in playing with them while they breed and tending to the many puppies. In time, you settle into your new role, no longer feeling the urge to breed yourself (though always loving joining in to help) and instead accepting your place as caregiver to their frequent litters of strong puppies. And in time, those pups grow up and spread out into the city and beyond in search of mates of their own.";
		else:
			...
			if beauceronmet is true:
				...
				if Player is male:
					if Player is female or "MPreg" is listed in feats of Player:
						...
						say "     Your neighbors take some time to warm up to the new arrivals, but thankfully they're pretty peaceful now that they've each got a mate and lover of their own, rarely leaving you and your neighbor's property. And when the puppies start coming, they're just too adorable to be ignored and are adopted by other families. And as more and more puppies keep coming, eventually everyone in town has a sexy collie, beauceron or collie-beauceron as a pet and mate of their very own.";
				else if Player is female:
