...
to say wolfherm wins:
	if Player is neuter:
		say "     She looks you over, and upon seeing nothing that piques her interest she walks away and leaves you lying on the ground.";
	else:
		if wolfhermdefeat is 0: [first time losing to wolf herm]
			if Player is herm:
				...
				say "     Her nose crushed to your groin, she drags her tongue along your thick, meaty length and nibbles at your plump testicles until a cry of pleasure opens your mouth wide. The motion presents the Painted Wolf Herm with an undeniable opportunity. The creature thrusts her cock forward and into your open maw. With a loud, lewd moan, the Painted Wolf Herm thrusts over and over again, penetrating that open mouth as she cries out in pleasure, slowly locking her knot behind those lips as her own mouth suckles on your [Cock of Player] cock like a blowjob queen. With a final violent shudder, the Painted Wolf Herm cries out in pleasure, dumping a thick, rich splattering of semen inside your maw as you likewise spill your seed into hers.";
			else:
			...
			CreatureSexAftermath "Painted Wolf Herm" receives "Oral[if Player is male]Cock[else]Pussy[end if]" from "Player";
...
to say wolfherm loses:
	...
	if equinoidstatus is 9:
		say "[line break]     You recall your agreement with the equinoids and have defeated a trio of the painted wolves. They should let you approach their camp now.";
...
When Play begins:
	...
	add "Painted Wolf Herm" to infections of FeralList;
	...
	add "Painted Wolf Herm" to infections of PackmindList;
	...
	now body change entry is "it burns as muscles ripple under your flesh, leaving you with the perfectly toned body of an Olympian swimmer. Your arms creak as they tingle with warmth, tiny claws pushing through the tips of your fingers. Your legs ache with pain, slowly growing more muscular, more refined as you shift onto the balls of your wide, broad feet"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	now skin change entry is "it itches, thick, flat fur pushing through your flesh as you writhe, becoming a patchwork portrait of gold, gray, and black fur"; [ Skin change text, format as "Your skin feels funny as [skin change entry]." ]
	now ass change entry is "it shifts with a loud creak, a perfect fluffy tail popping out from the cleft of your butt cheeks"; [ Ass/tail change text, format as "Your ass feels funny as [ass change entry]." ]
	now cock change entry is "it twitches and throbs as it becomes ebony, tapered and swollen at the base, yearning for use"; [ cock change text. format as "Your cock feels funny as (your text)." ]
	now str entry is 18;
	now dex entry is 14;
	now sta entry is 11;
	now per entry is 18;
	...
	now MilkItem entry is "painted wolf herm milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "painted wolf herm cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	...
	if Player has a body of "Painted Wolf Herm":
		...
		if humanity of Player < 10:
			if Player is female:
				...
				say "     Falling prey to the infection, you wander off into the park to sate your lusts. You are drawn there by a faint scent that grows as you track your target. Finding the hermaphrodite wolf who is releasing that rich blend of masculine and feminine scents, you approach her quickly, growling softly with desire. You pounce her and press her down. She struggles, but eventually submits to the eager male atop her, letting you line up with her pussy and take her. You fuck her hard and fast, again and again until your hot seed has filled her womb and the excess is leaking out onto the grass. She moans softly and strokes her full tummy[if Player is not sterile], eagerly anticipating her first litter - the first of many[end if].";
		else:
			say "     After escaping the city, you end up working at a small company that's headed by a trio of other wolves. One is a female maned wolf and the males are a gray wolf and a red wolf. The boss seems to think that there'd be less fighting than with mixed species and the pack mentality would improve teamwork. It certainly seems to be successful, with you taking charge of the others and everyone working well together and with the human employees. Being a poor businessman, it seems to be the only good decision he made.";
