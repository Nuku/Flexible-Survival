	if a random chance of (80 + LootBonus) in 100 succeeds: [common drop]
		add "hyena herm fur" to CombatTrophyList;
	...
	if a random chance of (10 + LootBonus) in 100 succeeds: [rare drop]
		add "switchblade" to CombatTrophyList;
	if a random chance of (10 + LootBonus) in 100 succeeds: [rare drop]
		add "iron knuckles" to CombatTrophyList;
	if a random chance of (10 + LootBonus) in 100 succeeds: [rare drop]
		add "wad of cash" to CombatTrophyList;
	if a random chance of (10 + LootBonus) in 100 succeeds: [rare drop]
		add "bag of wallets" to CombatTrophyList;
...
When Play begins:
	...
	add "Hyena Herm" to infections of FelineList;
	add "Hyena Herm" to infections of FurryList;
	add "Hyena Herm" to infections of NatureList;
	add "Hyena Herm" to infections of HermList;
	add "Hyena Herm" to infections of TaperedCockList;
	add "Hyena Herm" to infections of KnottedCockList;
	add "Hyena Herm" to infections of SheathedCockList;
	add "Hyena Herm" to infections of BipedalList;
	add "Hyena Herm" to infections of TailList;
	now Name entry is "Hyena Herm";
	now enemy title entry is "Herm Hyena"; [ Name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name. ]
	...
	now desc entry is "     You encounter an anthropomorphic hyena. She has bright [one of]brown[or]amber[or]green[at random] eyes and a grinning mouth full of saber-like teeth. Dressed in jeans and an open leather jacket with no shirt whatsoever beneath, her full breasts are left exposed for the world to see. When she spots you, a low chuckling begins to emanate from the woman's throat and her mouth opens into a toothy smile. She begins to run toward you, and as she approaches, it becomes very clear that 'she' is also a he, with a noticeably large bulge shifting in her pants with every step.[line break]";
	now face entry is "[if matriarchowned is 1]that of a strong hyena, with a scruffy streak of dark fur atop your head[else]brown-furred and hyena-like[end if]";
	...
	now face change entry is "[if matriarchowned is 1]it shifts and stretches as a short but powerful muzzle forms at the end of your face, filled with sharp fangs. Your ears move upwards and grow rounded as a scruffy streak of dark fur forms between them as your head settles into that of a hyena[else]it rapidly stretches outward, your mouth suddenly feeling very full as your new teeth settle into place[end if]";
	now body change entry is "[if matriarchowned is 1]it toughens up as it transforms once again, returning to your form as the hyena matriarch[else]you lose any trace of fat you may have had on you, it being replaced with tightly compacted muscle[end if]";
	...
	now ass change entry is "it tightens noticeably and becomes attractively muscled. Given no time to rest, you feel a sharp pain as your tail bone starts to grow out, lengthening out to a more animalistic norm. Pain subsiding you find a freshly grown brown-furred tail; a quick test shows that you have slight control over your new hyena tail";
	...
	now loot entry is "hyena herm fur";
	now lootchance entry is 50; [ Chance of loot dropping 0-100 ]
	now MilkItem entry is "hyena herm milk";
	now CumItem entry is "hyena herm cum";
	now TrophyFunction entry is "[GenerateTrophyList_Hyena_Herm]";
...
"hyena herm fur"	"A tuft of tan fur that looks like it has been pulled out of the coat of a hyena. It's nicely soft."	0	hyena herm fur

hyena herm fur is a grab object.
Usedesc of hyena herm fur is "[HyenaHermFurUse]".
Scent of hyena herm fur is "The fur has a pleasing, not too strong, animal-like scent.".
...
This is the Hyena Herm Infection rule:
	...
	if Player has a body of "Hyena Herm":
		trigger ending "Hyena Herm Infection";
