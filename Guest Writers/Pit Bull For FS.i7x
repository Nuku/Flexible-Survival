...
to say losetopitbull_f:
	...
	if cocks of player > 0 and cock length of player < 25 and a random chance of 3 in 5 succeeds:
	...
	else if FangWS is 1 and (a random chance of 1 in 3 succeeds or ("Kinky" is listed in feats of player and a random chance of 1 in 4 succeeds)):
		...
		If player is submissive:
			...
			say "     [if hp of player > 0]You reluctantly oblige her abuse, taking[else]You try to turn away but she grabs you by your head, forcing you to face[end if] the full brunt of her acrid release. [if scalevalue of player > 3]It's a pitiful sight, to see a creature as large as you are pissed on by this comparatively diminutive pit bull, forcing your senses to be flooded with the taste and smell of her harsh fluids[else]You can only silently take her humiliation, senses forcefully flooded with the taste and smell of her harsh fluids[end if]";
		say ". Her flow inevitably diminishes before ceasing altogether[if player is submissive], much to your discontent[else], much to your relief[end if], before she puts her pants back on and leaves you with a harsh swat on the rear, forcing you to gather your things and retreat from her domain.";
	else if "More Anal" is listed in feats of player and a random chance of 2 in 5 succeeds:
		If scalevalue of player > 4:
			say "     She laughs, slapping your rear harshly, no doubt amused to have felled a such a massive trespasser. Too embarrassed, you look away as you feel a couple of fingers beginning to penetrate your anal ring. [if hp of player <= 0]Much in spite what protests you may offer up[else]Soft moans of pleasure escaping your lips[end if], your large passage is more than willing to abide her intrusion. With an audible snort, she regards your accommodation as a challenge, and shows no restraint in stuffing the whole of her fist down the portal, her harsh treatment determined to leave an impact.";
			...
			say "     Amused, she gives your rear an audible smack and watches you flinch before you watch as She slowly pushes two of her fingers into your exposed anal ring. Writhing in discontent, her irreverent inspection is briefly concluded, only to be replaced by the whole of her fist! [if the player is twistcapped]Thankfully, your infection abides such an intrusion, in spite of its size and belligerence, though this only serves to amuse the rough dog and encourage her to assault you more harshly[else]Sharp pains as your beleaguered hole is stretched so suddenly, your impotent struggles are an endless source of entertainment to the rough dog[end if].";
		say "     [if cocks of player > 1]Cocks driven erect by her influence, their need for attention left largely disregarded by the canine[else if cocks of player > 0]Cock driven erect by her influence, its need for attention left largely disregarded by the canine[else if cunts of player > 1]Cunts dripping wet with a needy hunger in the wake of her influence, their desire for attention left largely disregarded by the canine[else if cunts of player > 1]Cunts dripping wet with a needy hunger in the wake of her influence, their desire for attention left largely disregarded by the canine[else]Twisted lust gradually overwhelming you, she doesn't appear to regard your genderless state[end if]; rather, she would stimulate you purely by force. You feel her knuckles grind against your [if cocks of player > 0]prostate[else]passage[end if] with a reckless abandon";
		if libido of player > 69 and cocks of player > 0:
			say ". You almost immediately fire off your [cum load size of player] load[if cock width of player > 15], drenching your torso and neck[else], seed wasted against your torso[end if]. She's actually a bit surprise by this, probably not suspecting you to be this pathetically easy to get off. Her clear annoyance is inevitably abated when she seems satisfied in her goal of humiliating you, regardless.";
			...
			say ". [If libido of player > 33]It's not long before you[else]It seems like forever until you finally[end if] cry out in orgasm, ";
			if cocks of player > 0:
				say "[if cocks of player > 1]cocks firing off their[else]cock firing of its[end if] [cum load size of player] load[if cock width of player > 15], drenching your torso and neck[else]load, seed wasted against your torso[end if]. As you eventually recover, it becomes clear that the canine appears satisfied with her endeavours to humiliate you as you are.";
			else:
...
to say losetopitbull_m:
	...
	if cunts of player > 0 and a random chance of 3 in 5 succeeds:
		...
		if scalevalue of player > 3:
			...
			say "exposes your [cunt size desc of player] cunt[if cunts of player > 1]s[end if] before him, promptly impaling [if cunts of player > 1]one of them[else]it[end if] with his hardening dick";
	...
	else if "Less Anal" is not listed in feats of player and ( a random chance of 1 in 5 succeeds or ( cunts of player is 0 and a random chance of 1 in 5 succeeds ) or ( ( "More Anal" is listed in feats of player or "MPreg" is listed in feats of player ) and a random chance of 1 in 5 succeeds ) ):
		say "     Unbuttoning his pants and pushing you onto your back, he [if scalevalue of player > 3]takes a moment to adjust your large frame so that your asshole is exposed before him, promptly impaling it with his hardening dick[else]exposes your asshole before him, promptly impaling it with his hardening dick[end if]. [if scalevalue of player > 3]Having little difficulty in penetrating your anal ring[else if scalevalue of player < 3 and the player is twistcapped]Brief, strained grunts elicited as he contends with your tight ring[else]Blatant in his use of your anal ring[end if], he's fairly reckless in the abusive pursuit of his own personal pleasure, bearing little regard for your own well-being in the matter.";
		say "     It's not long before you feel his canine knot bang belligerently against your ass, his thrusts becoming increasingly deliberate as he [if scalevalue of player > 3]forces it in with little effort[else if scalevalue of player < 3 and the player is not twistcapped]squeezes it in with such painful, abusive force[else]quickly forces the thick remainder of his meat into you[end if], ";
		...
		say ". His flow inevitably diminishes before ceasing altogether[if player is submissive], much to your discontent[else], much to your relief[end if], before he puts his pants back on and leaves you with a harsh swat on the rear, forcing you to gather your things and retreat from his domain.";
	else if "Less Anal" is not listed in feats of player and ( a random chance of 1 in 5 succeeds or ( cunts of player is 0 and a random chance of 1 in 5 succeeds ) or ( ( "More Anal" is listed in feats of player or "MPreg" is listed in feats of player ) and a random chance of 1 in 5 succeeds ) ):
		If scalevalue of player > 4:
			say "     He laughs, slapping your rear harshly, no doubt amused to have felled a such a massive trespasser. Too embarrassed, you look away as you feel a couple of fingers beginning to penetrate your anal ring. [if hp of player > 0]Much in spite what protests you may offer up[else]Soft moans of pleasure escaping your lips[end if], your large passage is more than willing to abide his intrusion. With an audible snort, he regards your accommodation as a challenge, and shows no restraint in stuffing the whole of his fist down the portal, much to little avail.";
		else if scalevalue of player is 4:
			...
			say "     Amused, he gives your rear an audible smack and watches you flinch before you watch as he slowly pushes two of his fingers into your exposed anal ring. Writhing in discontent, his irreverent inspection is briefly concluded, only to be replaced by the whole of his fist! [if player is twistcapped]Thankfully, your infection abides such an intrusion, in spite of its size and belligerence, though this only serves to amuse the rough dog and encourage him to assault you more harshly[else]Sharp pains as your beleaguered hole is stretched so suddenly, your impotent struggles are an endless source of entertainment to the rough dog[end if].";
		say "     [if cocks of player > 1]Cocks driven erect by his influence, their need for attention left largely disregarded by the canine[else if cocks of player > 0]Cock driven erect by his influence, its need for attention left largely disregarded by the canine[else if cunts of player > 1]Cunts dripping wet with a needy hunger in the wake of his influence, their desire for attention left largely disregarded by the canine[else if cunts of player > 0]Cunt dripping wet with a needy hunger in the wake of his influence, its desire for attention left largely disregarded by the canine[else]Twisted lust gradually overwhelming you, he doesn't appear to regard your genderless state[end if]; rather, he would stimulate you purely by force. You feel his knuckles grind against your p[if cocks of player > 0]rostat[else]assag[end if]e with a reckless abandon";
		if libido of player > 69 and cocks of player > 0:
			say ". You almost immediately fire off your [cum load size of player] load, [if cock width of player > 15]drenching your torso and neck[else]seed wasted against your torso[end if]. He's actually a bit surprise by this, probably not suspecting you to be this pathetically easy to get off. His clear annoyance is inevitably abated when he seems satisfied in his goal of humiliating you, regardless.";
		else if libido of player > 69 and cunts of player > 0:
			...
			say ". It[if libido of player > 33]'s not long before you[else] seems like forever until you finally[end if] cry out in orgasm, ";
			If cocks of player > 0:
				say "cock[if cocks of player > 1]s firing off their[else] firing of its[end if] [cum load size of player] load, [if cock width of player > 15]drenching your torso and neck[else]seed wasted against your torso[end if]. As you eventually recover, it becomes clear that the canine appears satisfied with his endeavours to humiliate you as you are.";
			else:
		...
		say "     Exposed before the pit bull, he--in turn--relinquishes himself of his pants, revealing his semi-erect cock before you. His intent further elucidated when he pulls your [if scalevalue of player > 3]head[else]form[end if] closer, demanding that offer up tribute for your trespass. [If hp of player > 0 or player is submissive]Implicitly comply[else]After a fair amount of coax[end if]ing, your l[if scalevalue of player > 3]arge maw engulfs the entirety of his emergent dick almost immediately. Even the aggressive canine can't help but be a little ill at ease dealing with such a large victim[else]ips engulf the tip of his emergent dick, his strong grip forcing you more firmly against his crotch, relegating you to consume every growing inch[end if].";
...
to say pitbull_vsex1:		[receive fellatio]
	...
	say "     [if pitbullgender is 2]Prior restraint slowly dissolved in the wake of his own, rising need, he offers up tainted moans as he[else]Not particularly happy with this arrangement, though too weak to offer up any real protest, she growls as she[end if] tastes your emergent fluids, h[if pitbullgender is 2]is[else]er[end if] audible regard vibrating against your length. [if pitbullgender is 2]Stroking himself as [else]Perpetual grimace her regard as s[end if]he attends your needs, it[if pitbullgender is 2]'s not long before[else] takes some time until[end if] you reach your bliss, [if cock length of player > 18]dousing the canine with[else]forcing the canine to swallowd[end if] your [cum load size of player] payload.";
...
to say pitbull_vsex2:		[receive cunnilingus]
	...
	say "     Furiously [if pitbullgender is 2]strok[else]fondl[end if]ing [if pitbullgender is 2]him[else]her[end if]self in the wake of this, [if pitbullgender is 2]he[else]she[end if] spends [if pitbullgender is 2]him[else]her[end if]self all over the ground soon thereafter, left in a lustful haze as you inevitably depart, tainted need satisfied.";
...
to say pitbull_vsex5:		[scissoring]
	...
	say "     Slowly, you start to grind the two of your exposed cunts together, made slick by a mix of saliva and shared sexual fluids, this slick attention intent on fueling this twisted, heated fervor further. Growls of immense pleasure her regard for your endeavours, cementing your lascivious dominion over the beast, though you cannot help but moan in the wake of such sensory delight. [if scalevalue of player > 3]Ponderous w[else]W[end if]eight of your lust bearing down on her, your rising, shared heat radiates out into the [if daytimer is day]day[else]night[end if] sky, the loud, irreverent sounds of your sex its companion.";
	say "     It's not long before the two of you reach the ultimate consummation of your writhing, sweat-slicked endeavours, wracking the two of you with the throes of sapphic bliss. [If scalevalue of player > 3]Larger form c[else]C[end if]rumpling under the weight of exhaustion[if scalevalue of player > 4], you take some care as to not crush her under your weight[end if], eventually recovering enough to pull yourself free. The canine appears to still be too battered and tired to go anywhere, so you choose to leave her to her own business, gathering what you might have put aside and departing.";
...
[
	if pitbullgender is 1:
		...
		else if cocks of player is greater than 0 and cunts of player is 0:
		...
		else if cocks of player is greater than 0 and cunts of player is greater than 0:
		...
		else if cocks of player is 0 and cunts of player is greater than 0:
...
when play ends:
	if bodyname of player is "Pit bull":
		if humanity of player < 10:
			...
			else if cocks of player > 0 and cunts of player > 0:		[Succumb - H]
