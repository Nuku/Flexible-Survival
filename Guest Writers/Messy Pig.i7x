...
to say messypigattack: [Fight loss scenes]
	if anallevel > 1 and a random chance of anallevel in 4 succeeds: [Pig gets her ass tongued by player]
		...
		CreatureSexAftermath "Messy Pig" receives "Other" from "Player";
...
to say beatthepig: [Victory Scene]
	if ( CockName of Player is "Messy Pig" or CockName of Player is "Piggy" ) and Player is male:
		...
		say "[line break]     [bold type]Do you have your way with the female swine?[roman type][line break]";
		...
		if Player consents:
			...
			LineBreak;
			say "     The pig turns tail and waddles away faster than you thought possible. You hear her squeals of terror die down as she leaves your range of hearing. Looks like you win!";
	else:
		say "     The pig, when realizing that the encounter is not going well, turns tail and waddles away faster than you thought possible. You hear her squeals of terror die down as she leaves your range of hearing. Looks like you win!";
...
When Play begins:
	...
	now Species Name entry is "Pig"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Messy Pig" to infections of PorcineList;
	add "Messy Pig" to infections of FurryList;
	add "Messy Pig" to infections of NatureList;
	add "Messy Pig" to infections of FemaleList;
	add "Messy Pig" to infections of BipedalList;
	add "Messy Pig" to infections of TailList;
	now Name entry is "Messy Pig";
	...
	now desc entry is "     You hear a strange snorting sound, and looking around, you see a bizarre creature. It rests on all fours, but its body seems human enough to stand on two legs. It appears to be a large, pinkish humanoid. She's quite fat and has a large pig snout for a face. Floppy pig ears also adorn her head and peak through her oddly human hair. Six breasts in two rows line her underside, and over her large bottom there is a cute and curly pig's tail. Her hands end in cloven hooves, as do her feet. She spots you and looks up at you with hungry eyes! Uh oh![line break]"; [ Description of the creature when you encounter it.]
	now face entry is "pudgy with a large pig's snout and two floppy ears"; [ Face description, format as "Your face is [Face of Player]." ]
	now body entry is "large, with copious amounts of heavy fat. Some would probably like your rotund figure, if it weren't for the wretched stench that it emits"; [ Body Description, format as "Your Body is [Body of Player]." ]
	now skin entry is "pinkish-hued"; [ skin Description]
	...
	now face change entry is "you feel an odd feeling against your nose, as if invisible hands are molding and shaping it, as well as stretching it. Right before your eyes, you see your nose deform, becoming large and snout-like, perfectly matching that of a pig. Your ears can also be felt, changing into large and floppy versions of their former selves"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
	now body change entry is "your stomach gurgles, and your body quickly starts to put on fat! Your frame billows with sudden and heavy fat, completely ruining your figure. There is a mildly unpleasant smell in the air after the change as well, and it does not take long to realize that it's you"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	now skin change entry is "it tingles all over, its color shifting mildly. The change isn't too obvious at first, but you quickly realize that you're much pinker than you used to be"; [ Skin change text, format as "Your skin feels funny as [skin change entry]." ]
	now ass change entry is "it starts to rumble and grow, becoming comically large and fat. As if that weren't bad enough, a pinch of your tail bone signifies the growth of a curly pig tail to call your own"; [ Ass/tail change text, format as "Your ass feels funny as [ass change entry]." ]
	now cock change entry is "it becomes pink and human-like"; [ cock change text. format as "Your cock feels funny as (your text)." ]
	now str entry is 12;
	now dex entry is 12;
	now sta entry is 17;
	now per entry is 12;
	...
	now MilkItem entry is "messy pig milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "messy pig cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
this is the pigpussy rule:
	...
	if HP of Player > 0 and Libido of Player < 110:							[caught and fighting]
...
[			say "     TEST: [playernum] vs [messypignum]:[line break]"; ]
	...
	if messypigcaught is true:
		if HP of Player > 0 and Libido of Player < 110:							[still fighting, damaged]
			...
			decrease HP of Player by dam;
			WaitLineBreak;															[still caught, aroused]
...
[			say "     TEST: [playernum] vs [messypignum]:[line break]"; ]
	...
	if messypigcaught is true:
		...
		[LineBreak;]
		infect "Messy Pig";															[completely caught, infected]
		choose row monstercom from the table of critter combat;
