...
"Butterfly"	"[PrepCombat_Butterfly]"

to say PrepCombat_Butterfly:
	setmongender 4;
...
When Play begins:
	...
	now Species Name entry is "Butterfly"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Butterfly" to infections of InsectList;
	add "Butterfly" to infections of FurryList;
	add "Butterfly" to infections of NatureList;
	add "Butterfly" to infections of FemaleList;
	add "Butterfly" to infections of InternalCockList;
	add "Butterfly" to infections of InternalBallsList;
	add "Butterfly" to infections of BipedalList;
	add "Butterfly" to infections of FlightList;
	now Name entry is "Butterfly";
...
To say butterfly defeat:
	...
	if ButterflyPregnant is True:
		...
		if a random chance of 1 in 3 succeeds or (a random chance of 1 in 3 succeeds and "Fertile" is listed in feats of Player):
	...
	if ButterflyForeplay is False:
		...
		if Player is male:
			...
			if ButterflyCanGetPregnant is True:
				...
				if ButterflyHasNegligee is True:
					say "[line break]     As you go to leave, you notice the butterfly forgot her negligee.";
					if ButterflyNegligeeTorn is False:
			...
			say "     She reaches into the black bag she was carrying and pulls out a strap-on dildo. As she hovers towards you fluttering her wings she attaches the strap-on to her groin. Eager for a deep fucking however it may present itself, you bend over and offer your ass towards her. Her makeshift dong finds its target and plunges deep into [if Cunt Count of Player > 1]one of [end if]your [cunt size desc of Player] cunt[sfn]. She rocks back and forth, energetically hammering your wetness[if Cunt Count of Player > 1]When she's done with your first vagina, she moves on to the next, clearly intending to service every one of your breeding organs[end if]. After much time and much fucking later, you lie there in ecstasy with your hole[sfn] aching in pleasure.";
		...
		if Player is male and a random number from 1 to 100 < Libido of Player:
			...
			say "     The butterfly girl falls down on her back defeated. '[if ButterflyRaped is 0]You didn't need to be so rough!' she protests with tears forming in her eyes. As you approach she fidgets anxiously, worried at what you may do. She ponders escape but still hopes that you may continue where you previously left off[else]Not again!' she shouts in frustration sensing the mood of the moment. As you approach she fidgets anxiously, sure that a repeat of your previous encounter is about to occur. 'You brute,' she murmurs[end if]. As you kneel your [Skin of Player] form down between her legs she uneasily [if ButterflyHasNegligee is True]lifts her negligee up to her waist[else]pulls the leather straps aside[end if], exposing her [one of]beautiful[or]attractive[or]alluring[or]elegant[or]graceful[at random] pussy. The moisture of her [one of]pristine[or]perfect[or]flawless[at random] slit glistens in the light. [if ButterflyNegligeeTorn is False and ButterflyHasNegligee is True]You grab the straps of her negligee and roughly yank them aside tearing the ribbon holding it to her chest and[else if ButterflyHasNegligee is True]Fondling the [ButterflyBreastDesc] breasts protruding through her torn negligee you circle your finger over her textured areola and[else]You slip your hand down her top roughly fondling her [ButterflyBreastDesc] breasts. Dragging them up by the nipples her tits pop free of her leather top and bulge forward prominently as you[end if] then without warning ram three of your fingers in her pussy. As she gasps at the unexpected attack you ramp up the pace and spread her wide. Her eyes well up with tears in pain and she rolls over and tries to pull away. What will you do?";
			if ButterflyHasNegligee is True, now ButterflyNegligeeTorn is True;
			wait for any key;
			let old menu depth be menu depth;
			let ButterflyRapedBefore be ButterflyRaped;
	...
	if ButterflyRaped is 1 or ButterflyRaped is 2:
		...
		if Player is male:
			...
			if "One Way" is not listed in feats of Player:
				...
				else if Cock Count of Player > 1 and a random chance of 1 in 3 succeeds and "All The Things" is not listed in feats of Player:
					say "[line break]     Sudden pleasure runs through one of your doomed [Cock of Player] cocks as it sprays the last of its seed, dwindling down to nothing at all and vanishing, leaving only the powerful orgasm to remember it by.";
			...
			if Cunt Count of Player is not 0 and "One Way" is not listed in feats of Player:
				...
				else if Cunt Count of Player > 1 and a random chance of 1 in 3 succeeds and "All The Things" is not listed in feats of Player:
...
This is the Butterfly Girl Epilogue rule:
	if Player has a body of "Butterfly" and ButterflyLove is true:
		...
		if humanity of Player < 10:
			...
			if Player is male:
				say "     A media frenzy erupts as you rapidly become the poster couple for the infection. Finding she enjoys being in front of the camera your lover takes up fashion modeling, but she's only really comfortable as long as it's you taking the pictures. Together you make a successful team as fashion houses and cosmetics firms worldwide keep you in work and help fund your comfortable lifestyle. You have a very passionate and active sex life, [if Player is sterile]but are unable to have children[else]resulting in a handful of children. They all follow their own path just like normal human children, although their exotic looks make them a magnet for many[end if].";
			else:
				say "     A media frenzy erupts as you rapidly become the poster couple for the infection. You are unable to have children, but the two of you are inseparable all the same living as a happy [if Player is female]lesbian [end if]couple with a very active and passionate sex life. Finding you both enjoy being in front of the camera you take up fashion modeling together. You make a successful team as fashion houses and cosmetics firms worldwide keep you in work, and help fund your comfortable lifestyle.";
...
This is the butterflytreatment choice rule:
	...
	if title entry is "Force her":
		...
		if the_player_consets is True:
			...
			else if ButterflyRaped is 1:		[She's going to be seriously pissed with you and twice as strong]
				choose row with Name of "Butterfly" from Table of Random Critters;
				let debit be 0;
...
This is the ButterflyTummyDesc rule:
	if ButterflyBabyGestation is:
		-- 3: now ButterflyTummy is "She is heavily pregnant, and looks ready to give birth at any time.";
		-- 2: now ButterflyTummy is "Her belly bulges showing the signs of early pregnancy.";
...
the scent of sexy nightie is "The sexy nightie smells like freshly aired linen with a slight hint of perfume.".
Usedesc of sexy nightie is "     You picked that up for Lance's boyfriend. Hmmm... what was his name again?[line break]".
...
check using a testosterone pill:
	if Player is female:
		say "[line break]     As you move to slip the pill in your mouth you feel an uneasy shiver run through your cunt[sfn][if gestation of child > 0]. Your lower belly quivers causing you to feel ill[end if]. Are you sure you still want to use it?";
		if Player consents:
			LineBreak;
			if Player is FemalePreferred or Player is HermPreferred or "One Way" is listed in feats of Player or "Always A Pussy" is listed in feats of Player:
...
to say testosterone pill use:
	if Player is herm:		[HERM]
		...
		say "     With a burst of intense pain the lips of your cunt[sfn] fuse together and flatten. Within seconds nothing remains of your former femininity. [run paragraph on]";
		increase Cock Length of Player by 2;
		follow the cock descr rule;
		say "You can see your [if Cock Count of Player is 1][one of]cock[or]penis[or]shaft[or]maleness[at random][else][one of]cocks[or]malenesses[at random][end if] [one of]engorge[or]swell[or]throb[at random] as [ittheym] gain[smv] in length, becoming [descr]! ";
		if Ball Size of Player < 7:
			BallsGrow Player by 1;
			say "Your [one of]sack[or]balls[or]orbs[or]cum factories[at random] [one of]tingle[or]churn audibly[or]throb[at random] as they grow larger, [Skin of Player] flesh growing taut with the expansion, leaving you with [Ball Size Adjective of Player] [Balls]! ";
...
to say butterfly grove scene:
	...
	if "Sterile" is not listed in feats of Player and ButterflyPregnant is False:
		...
		if a random chance of 1 in 2 succeeds or (a random chance of 1 in 2 succeeds and "Fertile" is listed in feats of Player):
			let ButterflyCanGetPregnant be True;
	say "[run paragraph on]";
	follow the ButterflyTummyDesc rule;
	...
	if ButterflyPregnant is True and Cock Count of Player is 0: [How'd you manage that?]
		...
		say "     You stumble upon the butterfly who appears to have recently given birth and is nursing a child on her breast. At first she's unsure how you'll react, but as you show interest in the child she develops a cautious trust. The nanites rapidly transfer personality and knowledge from you and your partner's genes to the newborn, who is not newborn for long, soon a young adult. They pop free and stand, smiling. With a slow turn, they show off their [HeadName of ButterflyBaby in lower case] head, their [TorsoName of ButterflyBaby in lower case] front and [BackName of ButterflyBaby in lower case] back. Your butterfly baby has [ArmsName of ButterflyBaby in lower case] arms, [LegsName of ButterflyBaby in lower case] legs and a [AssName of ButterflyBaby in lower case] behind. Your child, hungry for knowledge and experience of the world decides to stay with you.";
		ButterFlyChildBirth;
		...
		if pristine negligee is owned:
			...
			if Player consents:
				...
				if Player is male:
					...
					now ButterflyAttire is "She is wearing a white negligee, but you can't help but notice the lack of undergarments through its sheer semi-translucency. The negligee is [if ButterflyNegligeeTorn is True][one of]ripped[or]torn[at random] open at the chest exposing her [ButterflyBreastDesc] breasts and the protruding [one of]ruby[or]scarlet[at random] red nipples that adorn them. Her chest jiggles[else]held together at the bust with a white ribbon. Her build is slight and punctuated with a pair of [ButterflyBreastDesc] breasts jiggling slightly[end if] as her wings flap.";
		...
		if Player_returned_negligee is False and Player is male and ButterflyPregnant is False:
			...
			CreatureSexAftermath "Player" receives "PussyDildoFuck" from "Butterfly";
			infect;
		else if Player_returned_negligee is False and ButterflyPregnant is False:
...
to say lingerie store scene:
	...
	if perception of Player > 15 and butterfly grove is known:
		if ButterflyPantiesFound is False or (cute panties is not owned and a random chance of 1 in 3 succeeds):
			say "[line break]     Out of the corner of your eye you notice something small sticking out from under one of the display racks. You crouch down to take a look, but accidentally bump into one of the racks knocking its contents to the floor.";
	...
	if rlingfound is false:
		say "[line break]     While looking around, you also happen to spot a racy red set of lingerie that you find very appealing. It includes a bustier, bra, panties and stockings. As you look it over, you imagine yourself wearing as much (or as little) of it as you like. [if Player is not female]Before you even realize what you're doing[else]With that appealing thought in mind[end if], you put it into a clothing box and store it in your pack.";
