	...
	if HP of Player > 0:
		...
		if Player is male: [Player has cock or multiple cocks and Kangaroo spears herself on them]
			...
			if Cock Count of Player > 1 and anallevel > 1:
				...
				WaitLineBreak;
				say "     In time, the pleasure of losing yourself in her supple lining becomes too much for you, and you muffle your cries of ecstasy in the thick fur of her nape. Blast after blast of thick, creamy cum stuffs her womb and bowels, your [Cum Load Size of Player] load painting her walls white with your seed";
				...
				say "     Happy to oblige, you release a long exhale of pleasure as you sink [if Cock Count of Player > 1]one of [end if]your [cock size desc of Player] cock[smn] into her warm, sordid pussy. Your lover lets out a hazy purr of delight and pushes back against your lap, loving the feeling of being stuffed and aching for more. As you begin to rut her yearning body, she proves a very active partner, her steady gyrations only seeming to allow you to sink deeper into her gripping cunt as your balls clap rhythmically against her belly with each thrust. Her encouraging motions spur your arousal, and you're soon bucking roughly into the once-proud marsupial, your arms coiled around her fore to hold her steady while you ream her with energetic zeal.";
				WaitLineBreak;
				say "     In time, the pleasure of losing yourself in her supple lining becomes too much for you, and you muffle your cries of ecstasy in the thick fur of her nape. Blast after blast of thick, creamy cum stuffs her cunt and womb, your [Cum Load Size of Player] load painting her walls white with your seed";
		...
		else: [Player does not have cock]
			...
			if Player is female: [player gets their pussy tail fucked]
				...
				say "     You wake up sometime later, feeling groggy, dizzy, and pleasantly exhausted. Wiping your eyes free of sleep, you realize that you can still taste the kangaroo's femcum on your tongue, making you shiver at the memory of your arousing encounter. You shake your head of those impure thoughts and gather your belongings. Even after you depart, your mind keeps drifting back to the pleasant, lingering void in your freshly tail-fucked pussy, a small part of you longing to be floored again for another round beneath the powerful female.";
				CreatureSexAftermath "Player" receives "PussyDildoFuck" from "Red Kangaroo";
			else if anallevel > 1: [player gets ass tail fucked]
				say "     Not wishing to deprive you of some punitive pleasuring, the kangaroo's tail curls to stroke between your inner thighs. After some searching, it slides between the crack of your ass and teases at your unguarded star. You relish the feeling of its tip teasing your sphincter, the gentle pressure as it plucks at your rim making your sexless body quiver with anticipation. However, try as you might, you struggle to relax the taut tunnel, and you're wholly unprepared for the searing bliss of the taper splitting you wide.";
				WaitLineBreak;
				say "     The silky furred intruder wiggles and thrashes to burrow deeper into your ass, burgeoning width spreading your rim in spite of its initial resistance. Forcibly spread open, you struggle to draw a breath, and your next sharp inhale is tainted by the aroma of your lover's damp arousal. The rich, heady fragrance is pungent and exciting, spurring you to mash your face against her plush pink petals and sweep your tongue across those satiny folds. Pleased by your efforts, the kangaroo releases a wavering sigh and begins to rock her hips, a hand reaching below to cup the back of your head for support as you nurse from the nectar of her soft, luxurious flower.";
				...
				WaitLineBreak;
				say "     You wake up sometime later, feeling groggy, dizzy, and pleasantly exhausted. Wiping your eyes free of sleep, you realize that you can still taste the kangaroo's femcum on your tongue, making you shiver at the memory of your arousing encounter. You shake your head of those impure thoughts and gather your belongings. Even after you depart, your mind keeps drifting back to the pleasant, lingering void in your freshly tail-fucked asshole, a small part of you longing to be floored again for another round beneath the powerful female.";
				CreatureSexAftermath "Player" receives "AssDildoFuck" from "Red Kangaroo";
			else: [Player does not get tail fucked]
				say "     Not wishing to deprive you of some punitive pleasuring, the kangaroo's tail curls to stroke between your inner thighs. After some searching, it slides between the crack of your ass and teases at your unguarded star. Your eyes go wide at the unwanted attention, and you squirm and groan beneath your lover in an effort to dissuade her. Thankfully, she gets the hint and obliges your request, shifting the tapered mass to tickle your bare pelvis instead.";
				WaitLineBreak;
				...
				WaitLineBreak;
				say "     You wake up sometime later, feeling groggy, dizzy, and pleasantly exhausted. Wiping your eyes free of sleep, you realize that you can still taste the kangaroo's femcum on your tongue, making you shiver at the memory of your arousing encounter. You shake your head of those impure thoughts and gather your belongings, a small part of you longing to be floored again for another round beneath the powerful female.";
		...
		if Player is male: [Kangaroo spears herself on players cock]
			say "     'Oh, what do we have here?' Her hands start to caress your [bodydesc of Player] body, her fingers tracing down until she reaches your flagging, [Cock of Player] shaft[smn]. 'Perfect,' she whispers. Climbing atop your body, her drooling pussy hovers over [if Cock Count of Player > 1]one of [end if]your maleness[esmn]. Slamming down onto you, a grunt rises from your chest from the force as a moan escapes hers. Bouncing quickly with the help of those powerful legs, she rides you with more force than you're used to, grinding her much larger hips hard against your own while her cunt squeezes tightly, drooling lewdly over your lower half.";
			WaitLineBreak;
			...
			CreatureSexAftermath "Red Kangaroo" receives "PussyFuck" from "Player";
		else: [Player has no cock. Kangaroo rides players face]
	...
	if Player is male:
		...
		if Player consents:
			...
			if Cock Length of Player > 10: [Cock too big - Tittyfuck the Kangaroo instead]
				...
				CreatureSexAftermath "Red Kangaroo" receives "Other" from "Player";
			else: [Fuck the Kangaroo]
...
When Play begins:
	...
	now Species Name entry is "Red Kangaroo"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now Name entry is "Red Kangaroo";
	...
	now body change entry is "your muscles switch, moving lower as your bottom half now becomes a powerful springboard, leaving your upper half reasonably muscled";
	...
	now ass change entry is "a thick, powerful tail erupts from your backside, acting as a counterbalance to your front, acting as a third leg";
	...
	now MilkItem entry is "red kangaroo milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "red kangaroo cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
this is the rookick rule:		[+75% dmg cartoonish double-kick]
	...
	choose row MonsterID from the Table of Random Critters;
	let dam be ( wdam entry times a random number from ( 80 - ( peppereyes * 4 ) ) to 120 ) / 57; [+75% dmg]
...
This is the Red Kangaroo Infection rule:
	if Player has a body of "Red Kangaroo":
		...
		say "     [if humanity of Player < 10]Your mind slips away going into a more peaceful mode, wandering the city for fresh vegetation to eat, quickly bounding away from startling events. You quickly find a place among other kangaroos, becoming a flyer to the dominant male around[else]You quickly adapt to life outside, using the newfound legs to become a track star, getting into the high jumps and long jumps to a very successful career. Your lovers find those legs to have some of the best cowgirl riding moments, with your tail being a great impromptu seat[end if].";
