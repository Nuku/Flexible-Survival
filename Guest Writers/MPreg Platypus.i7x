Version 1 of MPreg Platypus by Guest Writers begins here.
[Original by Sapphire]
...
to say losetoplatypus:
	if gestation of child > 0 and gestation of child < 20:
		...
		if Player is male:
			...
			say "     The rhythmic rocking pleasure builds into a small eternity. He tenses up, holding your hips to his, twitching as he cums into you. With each twitch of his cock, you feel his warm seed begin to flood you. The heat of his potent seed sends you over the edge, your hips twitching and your hands grasping at the sand beneath you. Giving into bliss, you hit orgasm, your sphincter squeezing his shaft tightly, holding on to as much hot cum as you can. The platypus flops onto his back, pulling his cock out of your tight sphincter. 'Wow. I haven't had sex like that in days. I'll have to find you again sometime.' He grunts and stands, staggering a moment with the weight of his egg-filled belly, then starts walking off into the ocean to clean off his fur.";
		if BodyName of Player is "Platypus" and Player is pure and "MPreg" is not listed in feats of Player and player is puremale:
			say "[line break]     You feel something tingling in your belly as it grows warm and put your hands on it in concern. Then a thought clicks suddenly into your head: [bold type]You can now become pregnant through anal sex, much like the platypus who did this to you.[roman type][line break]";
			FeatGain "MPreg";
		CreatureSexAftermath "Player" receives "[if Player is female]Pussy[else]Ass[end if]Fuck" from "Platypus";
		...
		if Player is not neuter:
			...
			if Player consents:
				...
				if Player is male:
					...
					say "     Moving yourself closer to the prone and nude male, you grin, sliding your form over his. Your hands start roaming his belly, feeling the firm eggs shift within, to which the platypus shudders, starting to grow erect, aroused by the feeling of the eggs stretching his belly taut. Squirming underneath of you, his hand starts going to your groin, starting to tease your clit lightly, trying to get you as aroused as he is. The teasing gets more intense, his hands going over your chest, your hands sliding over his hips, until you can't take it anymore and you have to ride his cock. You shift your position to straddle him, guiding his tip to your wet cunt. With a moan of satisfaction, you slowly lower yourself around his shaft, squeezing it tightly as you settle into position.";
					say "     Not wanting to let you do all the work, the platypus puts his hands on your hips and starts to thrust into you as you rock into him, setting a steady pace. The sensation of his rod pumping deep inside you pulls several moans from both you and him as you rub your [if Breast Size of Player > 0]breasts[else]chest[end if] to heighten the pleasure. The pleasurable tension builds up into a small eternity, until suddenly it comes to a crashing release, forcing you to clamp your pussy down on the delicious cock inside you. Holding on to the platypus tightly, you try your best to keep milking for all he's got, and soon your efforts are rewarded. Hot waves of cum start to fill you up.";
					WaitLineBreak;
...
When Play begins:
	...
	now Species Name entry is "Platypus"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	add "Platypus" to infections of OviImpregnatorList;
	...
	now face entry is "now sporting a long black bill, just like a fuzzy duck"; [ Face description, format as "Your face is [Face of Player]." ]
	now body entry is "that of a curvy platypus with a little bit of a belly and wide child-bearing hips"; [ Body description, format as "Your body is [Body of Player]." ]
	now skin entry is "short, coarse brown fur that hides your"; [ Skin. Format as "Looking at yourself, your body is covered in [Skin of Player] skin." ]
	...
	now face change entry is "your lips and nose pinch forward, darkening and hardening as they grow into a bill, coarse creamy fur sprouting from the rest of your face. Your ears recede into your head, making you dizzy for a moment, but you soon regain your bearings"; [ Face TF text. Format as "Your face tingles as [face change entry]." ]
	...
	now ass change entry is "you stumble, your spine elongating. A thin tail grows from above your ass, and as it settles in, it begins to flatten out and grow wider, much like a beaver's"; [ Ass/Tail TF text, format as "Your ass tingles as [tail change entry]." ]
	...
	now MilkItem entry is "platypus milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "platypus cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	...
	if Player has a body of "Platypus":
		...
		if humanity of Player < 10:
			...
			if Player is male: [MALE/HERM]
				say "     The doctors give you all the usual exams: they take some blood for testing, they get the cheek swab for your DNA, and they give your [if Player is mpreg_ok]male womb[else]prostate[end if] a quick examination. A few hours later, they come back with the results of your test. At first, the doctor doesn't say much of anything, just reading the papers on his clipboard. When you ask what's wrong, he laughs and shakes his head. 'Nothing, my dear boy. I just thought it would be funny to keep you waiting.'";
				if Player is mpreg_ok and Player is not female:
