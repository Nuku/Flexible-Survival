...
to say horror victory:
	if (Player is MalePreferred and (Player is female or Player is not mpreg_ok)) or Player is sterile:
		...
		if tentaclerape is 0:
			...
			say "     This tendril, having found a suitable target for the creature's desires in an unlikely location, switches from probing at your anus to pushing its way into it. Lubricated by its slimy coating, the squirming flesh wriggles into your backside. Finding the hidden back entrance to your womb, it smears a spurt of oily gunk across it. As the hormones cause that hidden passage to gradually relax, the tendril withdraws from you, only to be replaced as one twice its size [if HP of Player > 0]presses[else]forces[end if] its way inside of you. Filling your [if Player is twistcapped]capacious rump with ease as your tight passage stretches and expands to provide a tight and enjoyable fit[else if scalevalue of Player > 4]huge rump with ease as your tight passage is forced open by the determined tendril[else if scalevalue of Player > 2]rump with some effort as your tight passage is forced to stretch uncomfortably wide by the determined tendril[else]rump with considerable effort as your [Body Size Adjective of Player] passage is forced far beyond its capacity by the determined tendril[end if]. It pounds within you, battering at that secret passage to your hidden womb before finally gaining entrance[if Cock Count of Player is 1]. A tentacle brings your cock to full arousal, and wraps around it, jerking your member relentlessly. You quickly climax launching seed across the floor below you[end if].";
			...
			CreatureSexAftermath "Player" receives "AssDildoFuck" from "Tentacle Horror";
			WaitLineBreak;
			...
			if HP of Player > 0:
				say "     As you lie down in a clear sign of submission, the creature approaches you excitedly, extending its many tentacles towards you as it does so. The creature wraps you in its slime-coated appendages and flips you over, handling you like a prized possession. Tentacles crawl over your body and under your clothing before pulling away, ripping the garments from your body. A slimy tentacle probes over your body as the creature draws you closer. [if thmpregdetect is false]As the tendril[else]The tendril once again[end if] glides between your ass cheeks, the tentacled monstrosity [if thmpregdetect is false]releases a gurgle of surprised delight upon detecting the secret hidden within your derriere[else]seeking out that fecund asshole of yours once again[end if].";
				now lasttentaclebattleoutcome is 3;
			else:
				say "     You've lost the will to continue your struggle against the horror. Collapsing to your knees on the cold concrete floor, you start to tilt forward. The creature catches you in its slime-coated appendages before you hit the ground. However, you quickly realize this was not out of kindness. Tentacles crawl over your body and under your clothing before pulling away, ripping the garments from your body. A slimy tentacle probes roughly over your body as the creature draws you closer. [if thmpregdetect is false]As the tendril[else]The tendril once again[end if] grinds between your ass cheeks, the tentacled monstrosity [if thmpregdetect is false]releases a gurgle of surprised delight upon detecting the secret hidden within your derriere[else]seeking out that fecund asshole of yours once again[end if].";
				now lasttentaclebattleoutcome is 2;
		...
		if HP of Player > 0:
			...
			if Player is not female:
				say "     A slimy tentacle presses against your lips, pushing itself into your throat as you open your mouth to admit it. Once deftly lodged down your throat, it begins to pump chemicals directly into your stomach, causing your entire body to start tingling. The tingling focuses on your crotch, and a moist opening forms rapidly, a tentacle rubbing against your forming lips, encouraging the growth. You feel a strange pressure inside your abdomen as your womb forms, growing to average size. Without even a chance to process the sudden growth of your new lady bits, a";
			now lasttentaclebattleoutcome is 3;
		else:
			say "     You've lost the will to continue your struggle against the horror. Collapsing to your knees on the cold concrete floor, you start to tilt forward. The creature catches you in its slime-coated appendages before you hit the ground. However, you quickly realize this was not out of kindness. Tentacles crawl over your body and under your clothing before pulling away, ripping the garments from your body.";
			if Player is not female:
				say "     A slimy tentacle forces itself into your mouth and begins to pump chemicals directly into your stomach, causing your entire body to start tingling. The tingling focuses on your crotch, and a moist opening forms rapidly, a tentacle rubbing against your forming lips, encouraging the growth. You feel a strange pressure inside your abdomen as your womb forms, growing to average size. Without even a chance to process the sudden growth of your new lady bits, a";
			now lasttentaclebattleoutcome is 2;
		say "[if Player is female]     A[end if] tentacle twice the size of the others forces its way inside of you, filling you [if Cunt Depth of Player < 15 or Cunt Tightness of Player < 12]far beyond your orifice's capacity and stretching you deeper and wider than your cunt could initially contain[else]to your limit[end if]. It pounds within you, battering your cervix, before finally gaining entrance[if Cunt Count of Player > 2]. Other tentacles thrust relentlessly in and out of all of the cunts the extra large appendage isn't stuffed into[else if Cunt Count of Player is 2]. Another tentacle thrusts relentlessly in and out of the cunt the extra large appendage isn't stuffed into[end if].";
		if Player is male:
			say "     [if Cock Count of Player is 1]A tentacle brings your cock to full arousal and wraps around it, jerking your member relentlessly. You quickly climax, launching seed across the floor below you[else]The tentacles holding you quickly bring your multiple dicks to erection, wrapping around them all and forcing them against each other. The creature's appendages quickly jerk around your members for a few moments, then swap to rubbing your cocks against one another, before returning to jerking your members off again. The sensations from this, in addition to the feeling of the huge tentacle pounding into you, cause you to quickly explode, launching your seed against the floor. The tentacles continue to jerk against your members long after your balls are empty and a puddle of your seed has collected beneath you[end if].";
		WaitLineBreak;
		...
		if eggplanted is 0:
			if HP of Player > 0:
				say "     As you lie down in a clear sign of submission, the creature approaches you excitedly, extending its many tentacles towards you as it does so[if Player is female]. The creature wraps you in its slime-coated appendages and flips you over, handling you like a prized possession. Tentacles crawl over your body and under your clothing before pulling away, ripping the garments from your body[end if].";
				if Player is female:
					now lasttentaclebattleoutcome is 3;
				else:
					now lasttentaclebattleoutcome is 4;
			else:
				say "     You've lost the will to continue your struggle against the horror. Collapsing to your knees on the cold concrete floor, you start to tilt forward. The creature catches you in its slime-coated appendages before you hit the ground[if Player is female]. However, you quickly realize this was not out of kindness. Tentacles crawl over your body and under your clothing before pulling away, ripping the garments from your body[end if].";
				if Player is female:
					now lasttentaclebattleoutcome is 2;
				else:
					now lasttentaclebattleoutcome is 5;
			...
			if Player is neuter: [implanted and genderless!? ZOMG!]
				...
				if HP of Player > 0:
					...
					if Player is not female:
						...
						stop the action;
				if Player is male:
					say ". Ignoring your male genitalia, [if Cunt Count of Player > 1]tentacles find each of your female sexes, their lips glistening with your growing need, and plunge[else]a tentacle finds your female sex, the lips glistening with growing need, and plunges[end if] inside of you.";
				else:
					say ". [if Cunt Count of Player > 1]Tentacles find each of your female sexes, their lips glistening with your growing need, and plunge[else]A tentacle finds your female sex, the lips glistening with growing need, and plunges[end if] inside of you.";
				say "     [if Cunt Count of Player > 1]Each tentacle is quickly joined by two others, and all of the sets of three piston in and out of your pussies[else]It's quickly joined by two others, and all three piston in and out of your pussy[end if] for hours, [if Cunt Depth of Player < 15 or Cunt Tightness of Player < 12]stretching your cunt back to the size it was the last time the horror raped you[else]hardly stretching your [cunt size desc of Player] pussy[end if]. Sexual juices are flowing from around the thrusting tentacles down your legs like a waterfall making an ever growing slick puddle on the floor beneath you.";
				CreatureSexAftermath "Player" receives "PussyDildoFuck" from "Tentacle Horror";
				WaitLineBreak;
				if a random chance of 2 in 5 succeeds: [random assrape! 40% chance]
...
to say horror description:
	if lasttentaclebattleoutcome is:
		-- 0: say "     While stumbling around in the basement of horrors, you hear the sound of something sliding across the ground. It's far too dark to see through the shadows that crowd all around you, and this unseen foe is taking advantage of the cover. Suddenly a slitted orb winks into being directly ahead of you. The eye is joined by twelve more in various places, winking into existence from the shadows directly ahead of you. All the eyes swivel and focus on you, and slime-coated appendages slither in and out of view, defying all attempts to try and count them. The monster is inhuman; you can't imagine anything mutating to this extent in such a brief period of time. Your thoughts are cut short as the creature makes its move...";
		-- 1: say "     You boldly stride through the pitch black basement, memories of your triumph over the horror here last time making you more than a little cocky. You see the eyes of the beast loom out of the darkness and hear the sound of the slime-covered tentacles slithering around, hidden by the deep shadows. You're shocked to see another beast down here in the dark; the idea that there might be more than one of these horrors lurking in the shadows sends a shiver down your spine. However, you ready yourself for the battle hoping that this horror isn't tougher than the last...";
		-- 2: say "     You don't know what you were thinking, coming back down here after what that horror in the dark did to you the last time you faced it. However here you are, looking at thirteen inhuman glowing eyes, listening to the sound of the beast's slime-covered appendages slithering in the shadows. [if eggplanted is 0]You[else]Still feeling the slight bulge where the creature's egg is nestled inside you, you[end if] can only pray you fare better this round...";
		-- 3: say "     You don't know what you were thinking, coming back down here after what that horror in the dark did to you the last time you submitted to it. However here you are, looking at thirteen inhuman glowing eyes, listening to the sound of the beast's slime-covered appendages slithering in the shadows. [if eggplanted is 0]You[else]Still feeling the slight bulge where the creature's egg is nestled inside you, you[end if] somehow feel excited at the prospect of what the creature might do to you this round...";
		-- 4: say "     You don't know what you were thinking, coming back down here after the creature ignored your obvious wantonness the last time you submitted to it. However here you are, looking at thirteen inhuman glowing eyes, listening to the sound of the beast's slime-covered appendages slithering in the shadows. [if eggplanted is 0]You[else]Still feeling the slight bulge where the creature's egg is nestled inside you, you[end if] somehow feel excited at the prospect of what the creature might do to you this round...";
		-- 5: say "     You don't know what you were thinking, coming back down here after that horror in the dark somehow let you go the last time you faced it. However here you are, looking at thirteen inhuman glowing eyes, listening to the sound of the beast's slime-covered appendages slithering in the shadows. [if eggplanted is 0]You[else]Still feeling the slight bulge where the creature's egg is nestled inside you, you[end if] can only pray you fare better this round...";
	if BodyName of Player is "Anime Babe":
		say "[line break]     Your anime girl body, particularly vulnerable to tentacle attack, has trouble resisting the horror's tendrils. You moan and squeal in barely suppressed pleasure as those tentacles squirm around you, quickly draining your resistance.";
...
When Play begins:
	...
	now Species Name entry is "Tentacle Horror"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Tentacle Horror" to infections of ScienceList;
	add "Tentacle Horror" to infections of TentacleCockList;
	add "Tentacle Horror" to infections of NoLegList;
	add "Tentacle Horror" to infections of SlidingList;
	add "Tentacle Horror" to infections of OviImpregnatorList;
	now Name entry is "Tentacle Horror";
	now enemy title entry is ""; [ Name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name. ]
	now enemy Name entry is ""; [ Specific name of unique enemy. ]
	now enemy type entry is 0; [ 0 = non unique enemy; 1 = unique (unknown name); 2 = unique (known name) | Used to disqualify unique enemies from Vore/UB and showing the enemy name in encounters. ]
	now attack entry is "[one of]A bit of gloop detaches from the ceiling and splatters on your shoulder. Taking advantage of the distraction, the beast launches its moist appendages towards you from three different directions, wrapping around your arms and legs and lifting you into the air. New tentacles quickly squirm their way inside of your clothing. The tentacles rub all across your body, leaving damp patches wherever they've touched you, and driving your arousal up a notch. You struggle back to your senses and then out of the creature's grasp. Too bad you were twenty feet in the air when you broke free[or]You feel something tap you on your left shoulder; whipping your head around wildly to the left you see nothing. A second set of taps is felt coming from your right shoulder, and you yank your head around to the right, only to find nothing there again. Turning back towards the creature, you are just in time to receive what feels like a boxer's punch, as four tentacles wrapped around each other slam into your unsuspecting, and unprotected face[or]The creature's appendages erupt with sticky fluids, coating you from all angles. At first you're not concerned in the least; however, you quickly realize that the goop is cutting off your air. Struggling to wipe the gunk from your mouth, you slip and fall, slamming into the unforgiving concrete floor. Thankfully this dislodges enough goo for you to get a breath, but afterwards, you stand up shakily, your head feeling fuzzy. You can't decide if the lightheaded feeling you're fighting is due to your recent deprivation of oxygen, or the mild concussion your good pal the concrete floor gave you. You tell the voices in your head to shut up and prepare to continue your struggle against the monster[at random]."; [Text used when the monster makes an Attack]
	...
	now face entry is "largely human, with the exception of glowing red eyes and slimy prehensile hair"; [ Face description, format as "Your face is [Face of Player]." ]
	now body entry is "studded with random phallic, prehensile appendages that drip slime and make most movements awkward"; [ Body Description, format as "Your Body is [Body of Player]." ]
	now skin entry is "pale, slime-covered"; [ Skin Description, format as "Looking at yourself, your body is covered in [Skin of Player] skin." ]
	now tail entry is ""; [ Tail description, write a whole Sentence or leave blank. ]
	now cock entry is "slime covered, prehensile"; [ Cock Description, format as you have a 'size' (your text) cock]
	now face change entry is "everything seems to get brighter, your eyes beginning to glow red and adjusting for much dimmer environments, while your hair falls out and is replaced by hundreds of slimy, prehensile tendrils"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
	now body change entry is "random portions all over feel an indescribable pressure build beneath your skin. Finally something gives way and you sprout at least 20 prehensile phallic, slime-covered tentacle appendages, all of which are a foot longer than your cock"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	now skin change entry is "you grow paler and your pores begin to leak slime that doubles as a potent aphrodisiac"; [ Skin change text, format as "Your skin feels funny as [skin change entry]." ]
	now ass change entry is "something thick and heavy shifts inside you"; [ Ass/tail change text, format as "Your ass feels funny as [ass change entry]." ]
