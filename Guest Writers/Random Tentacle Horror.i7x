...
When Play begins:
	...
	now face change entry is "everything seems to get brighter, your eyes beginning to glow red and adjusting for much dimmer environments, while your hair falls out and is replaced by a hundreds of slimy, prehensile tendrils"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
	now body change entry is "as random portions all over feel an indescribable pressure build beneath your skin. Finally something gives way and you sprout at least 20 prehensile phallic, slime covered tentacle appendages, all of which are foot longer than your cock"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
