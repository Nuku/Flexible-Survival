...
to say Mothgirl wins: [Player loss scenes]
	...
	if Mothdefeat is 0: [ first time losing to a moth ]
		say "     The mothgirl, grinning at her newfound victim, rubs her hands together, conjuring a mote of light blue dust into her palms before she blows it over your exposed face. Inhaling the dust you feel tipsy and aroused, the girl exploiting your vulnerable state to grind her breasts against your [if Breast Size of Player > 0]own [breast size desc of Player] curvature[else][bodydesc of Player] torso[end if] before sharing a light kiss on your lips, immediately departing thereafter. She leaves you only with the soft whisper of 'enjoy', and as you regain your senses it becomes clear that her ill-meaning affection has had some influence upon you, clouding your mind and leaving you more aroused.";
...
to say Mothgirl loses: [Player Victory Scenes]
	if mothgirlnosex > 2:
		say "     Defeated, the mothgirl stumbles onto the [if showlocale is true]sandy [end if]ground with a soft moan. Her wings hang low and she looks up at you defiantly despite having lost. As you have with her kind before, you decide to let her go. Slowly, she scrambles to her feet and flies off, no doubt to recover from her loss.";
	else:
		say "     Defeated, the mothgirl stumbles onto the [if showlocale is true]sandy [end if]ground with a soft moan. Her wings hang low and she looks up at you defiantly despite having lost. Shall you enact your punishment?";
		if Player consents:
			LineBreak;
			now mothgirlnosex is 0;
			if Player is male and a random chance of 3 in 5 succeeds:
				...
				say "     You waste no time as you begin to ride the mothgirl with an ever increasing pace, her initial protests drowned out by her own lusts as things progress, and in no time you're hit with the throes of your own orgasm. [if Ball Size of Player > 4]The poor girl is nearly rocketed off your member from the sheer scale of your load, but you know well enough to hold her in place, her belly visibly inflated with your cum until the rest is forced to spurt from her stuffed cunt[else]She moans loudly as she feels your [bodytype of Player] load flood her womb, writhing in her own orgasm against your throbbing cock[end if]. Eventually, you pull your [cock size desc of Player] rod from her hole, [if Ball Size of Player > 4]a flood of your copious ejaculate spewing from the abused hole. She's completely knocked out by this point, and you decide to leave her as is[else]the mothgirl fluttering about in dismay as she dizzly falls over. It'll be a while before she gathers her proper senses so you decide to leave her in this state[end if].";
				CreatureSexAftermath "Mothgirl" receives "PussyFuck" from "Player";
			else if Player is not neuter and a random chance of 3 in 5 succeeds:
				if Player is male:
					say "     On her knees, you pull the mothgirl to your crotch, forcing her to suck on your [cock size desc of Player] cock[if Cock Length of Player > 9]. The thing's much too big for her delicate mouth to contain, but she makes every effort she can to please you regardless[else], gradually engulfing it within the confines of her delicate mouth[end if]. Eventually, her involuntary affections bring you to blissful release, [if Ball Size of Player > 4]the subsequent torrent of cum more than she can handle, and subsequently her subtly [']dusty['] aura is doused by your excessive fluids[else]the creature struggling only briefly to swallow your cum as it explodes from your rod[end if]. Sated, you pull yourself free of the creature, [if Ball Size of Player > 4]who has succumbed to an obsession over consuming your excessive release[else]no doubt dazed by the whole affair[end if]. You decide to leave her as-is and go on your way.";
				...
				say "     At this point the mothgirl is bent over, giving you a clear view of her exposed behind, which inspires you to offer her a more [']literal['] punishment. You harshly swat her supple ass before making a more deliberate rhythm of spanking the diminutive creature. Her pleas for reprieve transform into moans as the pain gradually trends into pleasure, so much so that your efforts are enough to cause her to orgasm into the open air. Satisfied with what you have wrought, you let her go. No doubt immensely embarrassed, she hobbles away, rubbing her red ass as she departs.";
				CreatureSexAftermath "Mothgirl" receives "Other" from "Player";
		else:
			LineBreak;
...
When Play begins:
	...
	now Species Name entry is "Moth"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now Name entry is "Mothgirl";
	now enemy title entry is ""; [ Name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name. ]
	now enemy Name entry is ""; [ Specific name of unique enemy. ]
	now enemy type entry is 0; [ 0 = non unique enemy; 1 = unique (unknown name); 2 = unique (known name) | Used to disqualify unique enemies from Vore/UB and showing the enemy name in encounters. ]
	now attack entry is "[one of]She hits you on the cheek with her hand[or]A kick lands upside your face as the mothgirl turns in midair[or]The mothgirl punches you in the gut with her fist[or]The mothgirl rams her butt into your face[at random]."; [Text used when the monster makes an Attack]
	...
	now face change entry is "your face begins to pull in and feel softer"; [ Face change text, format as "Your face feels funny as [face change entry]." ]
	now body change entry is "your back feels odd as two moth wings come out from behind you. Your body also feels like it is shrinking and exhibiting more of a female looking body"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	now skin change entry is "it changes to a grayish tone. You feel majestic as your skin seems to reflect the light slightly"; [ Skin change text, format as "Your skin feels funny as [skin change entry]." ]
	now ass change entry is "your rump changes from what it was to a softer and a better feeling ass where you can sit on anything and not feel discomfort"; [ Ass/tail change text, format as "Your ass feels funny as [ass change entry]." ]
	...
	now MilkItem entry is "mothgirl milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "mothgirl cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
cock pill is a grab object.
Usedesc of cock pill is "[cock pill use]".
Scent of cock pill is "The small pill smells faintly of male pheromones and arousal.".

check using a cock pill:
	if Player is FemalePreferred or ("Modest Organs" is listed in feats of Player and Cock Length of Player > 7):
...
to say cock pill use:
	...
	else if a random chance of 1 in ( 4 + Cock Count of Player ) succeeds and "Just One" is not listed in feats of Player:
		increase Cock Count of Player by 1;
		Follow the cock descr rule;
		say "You feel dizzy, leaning against the nearest support as [if Cock Count of Player > 1]one of [end if]your [Cock of Player] shaft[smn] engorge[smv] painfully, growing larger before splitting, revealing a new shaft.";
	else:
		if "Modest Organs" is not listed in feats of Player or Cock Length of Player < 7:
			increase Cock Length of Player by a random number from 1 to 2;
		else if Cock Length of Player is 7:
			increase Cock Length of Player by 1;
		Follow the cock descr rule;
		say "You groan as you gain more male meat, leaving you with [if Cock Count of Player is 1][a cock size desc of Player][else][cock size desc of Player][end if] [Cock of Player] dick[smn].";
