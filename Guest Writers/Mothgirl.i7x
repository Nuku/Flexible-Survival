...
When Play begins:
	...
	now skin change entry is "your skin feels warm as it changes to a grayish tone. You feel majestic as your skin seems to reflect the light slightly"; [ Skin change text, format as "Your skin feels funny as [skin change entry]." ]
...
to say cock pill use:
	...
	if Player is not male:
		...
		say "You feel dizzy, leaning against the nearest support as your [Cock of Player] shaft[smn] engorge[smv] painfully, growing larger before splitting, revealing a new shaft.";
