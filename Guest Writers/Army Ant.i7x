	...
	if NonconList is not banned:
		if anal is not banned:
			...
			if a random chance of 1 in 3 succeeds:
				...
				say "     The two that have been assailing your ass have been replaced a couple times with fresh intruders, and with the pressing bodies, a third manages to wedge in and obscenely stretch you just that bit more. Your body is bathed in the seed of the army of ants, and their insectile figures continue to crowd. Every bit of you is coated in the nectar-like seed, and as consciousness fades from your senses, you are but a gooey puddle amongst the rest of the goo hard bodies and jizz.";
				SanLoss 10;
		else:
...
When Play begins:
	...
	now Species Name entry is "Ant"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now skin change entry is "your flesh thickens even as it indents, sculpting against your figure to suss out the shapes of your muscles and accentuate them. Hardening, the indentations split as your skin forms into chitinous plates, segmented and articulated to give you a sculpted, chiseled appearance with the hunter green shell patterned with army camouflage designs";
	now ass change entry is "the base of your spine swells, a fresh growth forming just above your buttocks. The bulb of meat swells out, ballooning and elongating into an oblong ellipsoid. The flesh toughens, thickening into a hard shell that sports a polished gleam, and where the new, insectile abdomen has formed from the base of your spine, it segments, pivotable and a heavy counterbalance";
	now cock change entry is "heat spills through your loins, pinpricks crawling over the flesh like an army of insects dragging fiery brands all across the length. A seam splits open, the flesh plating and segmenting around the newly-formed pocket as your crotch forms a rigid, glistening cock within the cavity, nested with your nuts. The seam to the pocket tightens, the plates sealing together, and your crotch now sports an internalized, retractable dick";
	now str entry is 14;
	now dex entry is 13;
	now sta entry is 14;
	now per entry is 13;
	...
	now MilkItem entry is "army ant milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "army ant cum"; [ Item to be given to the player if they have this infection and jerk off. ]
