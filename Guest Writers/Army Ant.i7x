...
to say losetoarmyant:
	if Libido of Player > 29:
		if anallevel > 1 and a random chance of anallevel in 4 succeeds:
			...
			if a random chance of 1 in 3 succeeds and NonconList is not banned:
				WaitLineBreak;
