...
to say chinvic:
	...
	if Player is male and Cock Length of Player < 17 and a random chance of 1 in 2 succeeds:
		...
		if Libido of Player > 30:
			say "     Unable to [if HP of Player < 1]resist[else]hold back[end if] any longer, you finally cry out, pumping your [Cum Load Size of Player] load into the rodent's tight hole[if Cock Count of Player > 2], your exposed, unattended dicks staining your torso and hers[else if Cock Count of Player is 2], your exposed, unattended dick staining your torso and hers[end if], and she's quick to respond with a gleeful screech, [if Player is knotted]tieing with[else]hilting[end if] your tool, its squeezing passage milking you of every last drop[if ball size of Player > 18]. However, quickly underestimating her capacity, she eventually forced free of your cock, the remaining load spilling all over to make a substantial mess[end if].";
		else:
			say "     It's but a few short moments before she cries out in a gleeful screech, [if Player is knotted]tieing with[else]hilting[end if] your tool, its squeezing passage milking you of every last drop. Unable to [if HP of Player < 1]resist[else]hold back[end if] any longer, this act is more than enough to make you cry out, pumping your [Cum Load Size of Player] load into the rodent's greedy hole[if Cock Count of Player > 2], your exposed, unattended dicks staining your torso and hers[else if Cock Count of Player is 2], your exposed, unattended dick staining your torso and hers[end if][if ball size of Player > 18]. Quickly underestimating her capacity, she eventually forced free of your cock, the remaining load spilling all over to make a substantial mess[end if].";
	...
	if Player is not male or ( nochinchillasex > 2 and the remainder after dividing nochinchillasex by 5 is not 0 ):
		...
		if Player consents:
			if Cock Length of Player > 16:
				...
				WaitLineBreak;
				say "     You continue to finger and pet the female rodent while she licks and strokes your manhood. As your excitement grows, your dick drools pre onto her tongue as well as her fuzzy face. Feeling your orgasm approaching, you grab the back of her head with your free hand and stuff the end of your cock into her little muzzle. You groan and [if ball size of Player > 15]bulge her cheeks out with just the first few blasts[else]shoot several blasts[end if] of your [Cum Load Size of Player] load into her mouth before pulling it out. You pump your cock frantically, spraying the rest of your seed onto her fuzzy fur, making sure she's good and messy. Even as you're cumming all over her, you finger her to a chittering orgasm.";
				...
				WaitLineBreak;
				say "     With her snug cunny gripping your [if Cock Length of Player > 10]large [else if Cock Length of Player > 6]relatively large [end if]cock so tightly, you have a great time fucking the soft rodent. Her vaginal walls quiver and squeeze around your shaft through several small orgasms before finally building to a big one as you pound her hard and fast as your own climax approaches. When it arrives, you drill deep into her vagina and unleash your [Cum Load Size of Player] load into her womb[if ball size of Player >= 20]. Your [Cum Load Size of Player] output is such that her belly visibly swells despite her fluffy coat of fur[end if]. By the time you're done and you pull out, a gush of your gooey seed leaks from her stretched petals, soaking her furry thighs.";
...
When Play begins:
	...
	now Nipple Count entry is 4; [ Number of Breasts infection will give you. ]
