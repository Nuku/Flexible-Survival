Version 4 of Hungry Boar Man by hiccup begins here.
...
instead of conversing Philip:
	...
	otherwise if piginitiation is 3 and a random chance of 1 in 3 succeeds and philip is in the bunker and ( cocks of player > 0 or cunts of player > 0 ):
...
to say sexwithphilip:
	...
	if Sandra is bunkered and hp of Philip is 0 and lust of philip - turns >= 16 and lastPhilipfucked < 800:
		...
		continue the action;
	otherwise if Sandra is bunkered and hp of Philip is 2 and a random chance of 1 in 3 succeeds:
	...
	otherwise if pigfucked < 3 or a random chance of 5 in piggymalefun succeeds:
		...
		if breasts of player < 8:
			if "Male Preferred" is not listed in feats of player and "One Pair" is not listed in feats of player:
				...
				now breasts of player is 8;
	otherwise if "Submissive" is listed in feats of player and a random chance of piggymalefun in 25 succeeds and pigfucked >= 3:
