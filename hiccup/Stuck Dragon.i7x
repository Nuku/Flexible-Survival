...
The description of Isolated Street is "The only thing of interest on this street is an old, rundown building that has been around for awhile. Its been condemed for as long as you can remember, so you have no idea what this building was used for.";
...
The description of Back Alley is "You[apostrophe]re standing in an alley behind an old building. It[apostrophe]s the same old building that you found earlier. There is a side entrace to the old building here. Looks like you[apostrophe]ve found the way around the blocked doorway.";
