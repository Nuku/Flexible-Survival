...
[Version 1.3 - M/M anal (player topping)]
...
Instead of conversing the François:
	if hp of François >= 3 and Françoistalk1 is false and a random chance of 2 in 5 succeeds:
...
to say françoissex2:
	...
	if hp of François is 2 or a random chance of 3 in 5 succeeds:
