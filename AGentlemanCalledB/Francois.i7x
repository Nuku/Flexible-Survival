...
Instead of Resolving a Gourmet Treats:
	...
	say "     A bell above the door jingles loudly as you step inside, [if hp of Karen is 1]and the creatures in the back quickly turn their attention to the unexpected intruder[otherwise]and you curse yourself as you spot a group of creatures near the back of the store turning to investigate the source of the noise[end if]. Surveying the scene, you quickly realize you've walked in on a [if T is 1]small pack of huskies[otherwise if T is 2]group of german shepherds[otherwise if T is 3]small pack of Chocolate Labs[otherwise if T is 4]pair of Retrievers[end if] who have captured another creature and are having some fun with their prize in the secluded bakery. As the canines move towards you, there is a weak cry for help from their prisoner, a survivor? Realizing there is more at stake here than you originally expected, you drop your pack and prepare yourself for the approaching [if T is 1]huskies[otherwise if T is 2]german shepherds[otherwise if T is 3]Labs[otherwise if T is 4]Retrievers[end if].";
	attempttowait;
	if T is 1:
		say "[BakeryHusky]";
	if T is 2:
	...
	if fightoutcome >= 20 and fightoutcome <= 29:
		...
		attempttowait;
		say "     You eventually awaken some time later, and you are surprised to find yourself on a makeshift bed made from several smaller pieces of furniture and blankets. As you rise to a sitting position, you glance around nervously, looking for the [if T is 1]huskies[otherwise if T is 2]german shepherds[otherwise if T is 3]Chocolate Labs[otherwise if T is 4]Retrievers[end if] who bested you, expecting them to try and keep you captive as they did the other survivor. Surprisingly, although perhaps for the best, there is no sign of them.";
...
Instead of conversing the François:
	...
	otherwise if a random chance of 1 in 3 succeeds:
		say "     [if daytimer is day]Bonjour[otherwise]Bonsoir[end if], [one of]mon ami[if cunts of player > 0 and cocks of player is 0]e[end if][or]my friend[at random].  [one of]Comment ça va?[or]Comment allez-vous?[or]How are you?[at random]";
	otherwise:
...
to say françoissex3:		[player performs oral]
	if libido of François is 3:
		say "     In the mood to return the favour to the friendly mutt, you let your hands wander downwards and slide them under his apron.  He moans softly as you take a hold of the plump sheath and heavy orbs he keeps hidden behind the white cloth.  Leaning in, you give him an kiss, feeling his cock swelling and sliding further from the kitteny-soft fur and downy feathers of its warm home.  Teasing the pointed tip, you break the kiss and start to move downwards.";
	...
	if "More Anal" is listed in feats of player and a random chance of libido of player in 100 succeeds:
		say "     Wanting to add some extra fun for you both and ensure you get the biggest bang you can from the hybrid mutt, you slip a [if scalevalue of player > 3]finger into your mouth to get it slick before bringing it[otherwise]pair of fingers into your mouth to get them slick before bringing them[end if] around under his tail.  He moans and flips his tail up with a grin and a pant, relaxing his back entrance as you spread your saliva over it, gradually working your way into his asshole.  Fingering him, you pick up the pace with the blow job and rub against his prostate, making his hips quiver.  'Oui, juste là.  J'suis proche,' he pants in French, his paws moving to your shoulders for support as his cock and balls twitch.  Grinning around his cock, you don't let up, working him to a fast and strong climax that has him pumping his flavourful cum down your throat.  You swallow it all down happily and lick your lips when you release his spent shaft";
	...
	otherwise:
		say "     You keep it up, working to please the horny hybrid with your mouth.  Longing for the prize but not wanting to rush it, you do your best to work him up, playing your tongue across his cock while you roll around the warm handful that are his balls.  As his knot swells, you push your mouth fully down onto his cock, working your lips over that swollen, sensitive bulb and sucking down on him hard.  This has him bark in surprise and pleasure, his hips quivering.  'J'veux jouir dans ta bouche,' he pants in French, his paws moving to your shoulders for support as his cock and balls twitch.  Quite certain he's close now, you curl your tongue around his shaft and slide along it, squeezing gently while taking him into your throat.  Driven over the edge by this, he cums hard, sending his rich, flavourful cum into your mouth and down your throat.  You let his cum pool on your tongue, and once he's spent, you release his shaft to show him the creamy mouthful you've got before swallowing it down";
	if libido of François is 3:
...
to say fizz-aux-pommesGet:
	say "     François scratches his chin as he muses, setting the soda, pony cider and crushed candies aside. After gathering a couple other things from behind the counter, François gathers the ingredients and heads to his kitchen, promising to return shortly. Rather than the usual warm aromas of his cooking, you merely hear plenty of mixing and stirring. A few minutes later, François returns with a pitcher full of a fizzing amber liquid and a few glasses.";
...
to say gingerbreadGet:
	...
	otherwise:
		say "     Accepting the cookies from François, he looks quite disappointed as you stash the snack away in your bag. You assure him you'll eat it later and let him know how it was, but he still seems a little saddened that you aren't going to try it right away.";
...
to say boysenberry blossom Use:
	...
	otherwise:
		...
		Follow the cock descr rule;
		say " you savor the fruity pastry as a warm tingling wells up in your belly, slowly spreading across your body. The sensation focuses on your groin, your [if cocks of player is 1][one of]cock[or]penis[or]shaft[or]maleness[at random] [one of]engorging[or]swelling[or]throbbing[at random] as it gains[otherwise][one of]cocks[or]penises[or]shafts[or]malenesses[at random] [one of]engorging[or]swelling[or]throbbing[at random] as they gain[end if] in length, becoming [descr]";
	decrease hunger of player by 5;
	if hunger of player < 0, now hunger of player is 0;
...
to say muffin muffin Use:
	...
	otherwise:
		...
		Follow the cunt descr rule;
		say ". As you swallow the last bite, a warm tingling wells up in your belly, slowly spreading across your body. The sensation focuses on your groin, your [if cunts of player is 1][one of]cunt[or]pussy[or]vagina[or]cleft[at random] [one of]engorging[or]swelling[or]throbbing[at random] as it grows[otherwise][one of]cunts[or]pussies[or]vaginas[or]clefts[at random] [one of]engorging[or]swelling[or]throbbing[at random] as they grow[end if], becoming [descr].";
	decrease hunger of player by 5;
	if hunger of player < 0, now hunger of player is 0;
...
to say cheesecake Use:
	...
	otherwise:
		say "     Pulling the cheesecake from your bag, you carefully unwrap it before savoring the rich strawberry flavour in a few small bites.";
		cheesecakeinfect;
		decrease carried of cheesecake by 1;
		if cheesecakemode is 0 and player is cheesecakebodied:
			say "     Indulging in only a small serving of the rich cheesecake, your belly rumbles as your plump confectionary body slims down to become thin and sexy.";
