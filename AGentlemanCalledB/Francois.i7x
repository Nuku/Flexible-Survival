...
to say ResolveEvent Gourmet Treats:
	let T be { 1, 4 };
	if NonconList is not banned, add 2 to T; [German Shepherd]
	if HumorousList is not banned, add 3 to T; [Chocolate Lab]
	sort T in random order;
	say "     While traveling through the high rise district, you come across [if HP of Karen is 1]what you can only assume is the strange bakery Karen mentioned. While the boarded-up windows prevent you from seeing inside, the large sign above the door makes it clear that this is the place. The weathered sign reads [']Bone-Appetit['] and features a rather plump cartoon canine in a chef's uniform. Eager to follow through with your plan to free yourself from Rex, you reach for the door handle. Slowly pulling the door open a crack, you peer inside the building; noticing some movement and groaning near the back counter, you pause for a moment before steeling yourself and swinging the door open[else]a rather unusual-looking building. While the boarded-up windows prevent you from seeing inside, the large sign above the door proclaims the place to be some sort of pet bakery. The weathered sign reads [']Bone-Appetit['] and features a rather plump cartoon canine in a chef's uniform. With the exception of the boarded-up windows, the exterior of the building appears relatively undamaged; thinking there may still be some useful supplies within, you decide to step inside[end if].";
	WaitLineBreak;
	say "     A bell above the door jingles loudly as you step inside, [if HP of Karen is 1]and the creatures in the back quickly turn their attention to the unexpected intruder[else]and you curse yourself as you spot a group of creatures near the back of the store turning to investigate the source of the noise[end if]. Surveying the scene, you quickly realize you've walked in on a [if entry 1 of T is 1]small pack of huskies[else if entry 1 of T is 2]group of German shepherds[else if entry 1 of T is 3]small pack of Chocolate Labs[else]pair of Retrievers[end if] who have captured another creature and are having some fun with their prize in the secluded bakery. As the canines move towards you, there is a weak cry for help from their prisoner, a survivor? Realizing there is more at stake here than you originally expected, you drop your pack and prepare yourself for the approaching [if entry 1 of T is 1]huskies[else if entry 1 of T is 2]German shepherds[else if entry 1 of T is 3]Labs[else]Retrievers[end if].";
	if entry 1 of T is:
		-- 1: say "[BakeryHusky]";
		-- 2: say "[BakeryGShep]";
		-- 3: say "[BakeryChocLab]";
		-- 4: say "[BakeryRetriever]";
	if fightoutcome >= 20 and fightoutcome <= 29:
		...
		say "     You eventually awaken some time later, and you are surprised to find yourself on a makeshift bed made from several smaller pieces of furniture and blankets. As you rise to a sitting position, you glance around nervously, looking for the [if entry 1 of T is 1]huskies[else if entry 1 of T is 2]German shepherds[else if entry 1 of T is 3]Chocolate Labs[else]Retrievers[end if] who bested you, expecting them to try and keep you captive as they did the other survivor. Surprisingly, although perhaps for the best, there is no sign of them.";
		WaitLineBreak;
		...
		now Resolution of Gourmet Treats is 3; [fought, fled]
...
to say BakeryHusky:
	...
	if fightoutcome >= 10 and fightoutcome <= 19:
		...
		if fightoutcome >= 10 and fightoutcome <= 19:
			...
			say "You roll 1d20([dice])[if bonus >= 0]+[end if][bonus] = [special-style-1][dice + bonus][roman type] vs [special-style-2]16[roman type] (Perception + Dexterity Check):[line break]";
			if bonus + dice > 15:
...
to say BakeryGShep:
	...
	if fightoutcome >= 10 and fightoutcome <= 19:
		...
		if Playernum > shepnum:
			...
			say "     With the first German shepherd dealt with, you survey the room in search of your next opponent, realizing too late that one of the hounds is missing. Suddenly you are grabbed from behind, your arms twisted behind your back by the sneaky canine. You struggle as best you can against the shepherd, trying to break free from his grasp and feel his grip weakening as a result.";
		else:
			say "     With the first German shepherd dealt with, you survey the room in search of your next opponent, realizing too late that one of the hounds is missing. Suddenly you are grabbed from behind, your arms twisted behind your back by the sneaky canine. You struggle as best you can against the shepherd, trying to break free from his grasp, but the shepherd simply chuckles at your effort, twisting your arm painfully as he tightens his grip.";
		WaitLineBreak;
		...
		if Playernum > shepnum:
			say "     Unable to break out of his grip, your canine captor begins licking at the back of your neck and nibbling at your ears as the other two shepherds move towards you. While the two canines begin stripping you of your gear, you continue struggling, desperate to break free, but the effort of your continued struggles begins to weigh on your stamina. Fortunately the same is true of your enemy and you feel his grip slipping[if escape is 1] further[end if] as a result of your efforts.";
			increase escape by 1;
		else:
			say "     Unable to break out of his grip, your canine captor begins licking at the back of your neck and nibbling at your ears as the other two shepherds move towards you. While the two canines begin stripping you of your gear, you continue struggling, desperate to break free, but the effort of your continued struggles begins to weigh on your stamina. Unfortunately the same is not true of your enemy, and despite your best efforts you make no headway.";
		if escape < 2:
		...
		if escape is 2:
			...
			CreatureSexAftermath "Player" receives "[if Player is female]Pussy[else]Ass[end if]Fuck" from "German Shepherd Male";
			CreatureSexAftermath "Player" receives "OralCock" from "German Shepherd Male";
			MultiInfect "German Shepherd Male" repeats 2;
			WaitLineBreak;
...
a postimport rule: [bugfixing rules for players that import savegames]
	FrancoisListCompile; [rebuild recipe list in case bans changed]
...
understand "François" as Francois.
...
OralVirgin of Francois is false.
Virgin of Francois is true.
AnalVirgin of Francois is false.
PenileVirgin of Francois is false.
SexuallyExperienced of Francois is true.
...
Instead of conversing the Francois:
	...
	if HP of Karen is 6 and retriever girl is listed in companionList of Player:
		...
		say "     Realizing that Francois and his bakery must be the place Karen mentioned, you decide to explain your situation to Francois, recounting the entire story that led you to your position with Rex and your plot to escape.";
		...
		if BodyName of Player is listed in the infections of CanineList or FaceName of Player is listed in infections of CanineList or hunger of Player > 60:
			PlayerEat 5;
		ItemGain Dog Treats by 1;
	else if Perception of Rex is 2:
		say "     Realizing that Francois and his bakery must be the place Karen mentioned, you decide to explain your situation to Francois, recounting the entire story that led to your meeting Karen and your intention to help her escape. 'Mon Dieu, poor Karen,' Francois replies solemnly after hearing your tale, 'but at least it is not too late [if Libido of Francois >= 3]for you, mon petit chou[else]to repay mon héro[end if].' Without another word Francois gets to work, gathering a few supplies before starting in earnest. Soon the entire bakery is filled with the warm scents of his work, and you find your mouth watering[if BodyName of Player is not listed in the infections of CanineList and FaceName of Player is not listed in infections of CanineList], despite knowing they are snacks intended for dogs[end if]. Eventually Francois finishes his work and returns with a small paper bag filled with fresh treats. [if BodyName of Player is listed in the infections of CanineList or FaceName of Player is listed in infections of CanineList or hunger of Player > 60]The enticing scent wafting from the bag in your hands proves to be too much, and you eagerly fish a treat out. Francois simply grins at you as he watches you enjoy a sample of his work. Still licking the last few crumbs of your snack from your lips, you[else]You[end if] stow the bag away in your pack and give Francois your regards before deciding on your next move.";
...
to say Francoissex2:		[mounting Francois]
	if Libido of Francois is 2:
		say "     Upon hearing your request, he presses his body to yours, paws running over your [bodydesc of Player] form. 'Oh, I'm very glad to hear you ask me, mon ami. Those others who would find me and use me would show no such courtesy.' As he speaks, he slips his paws down to your groin, taking a hold of your maleness and caressing it. 'It would be my pleasure to have this [if Cock Length of Player < 5]adorable[else if Cock Length of Player < 8]fine[else if Cock Length of Player < 16]impressive[else]mighty[end if] shaft of yours inside me,' he adds while rolling your balls around with his other paw.";
	else:
	...
	if Libido of Francois is 2 or a random chance of 3 in 5 succeeds:
		say "     Rather than delay any longer, he lowers himself in front of you, licking and sniffing as he goes on his way to the prize. 'Let's get this lovely... delicious... cock of yours ready to go, mon ami,' he moans as he slathers his canine tongue all over it, getting you nice and slick while he enjoys the musky taste of your maleness. [if Cock Length of Player > 24]Given the size of your [cock size desc of Player] cock, the mismatched hybrid takes his time, making sure you're nice and slick all over[else if Cock Length of Player > 12]Given the size of your [cock size desc of Player] cock, the mismatched hybrid spends some extra time licking you, making sure you're nice and slick all over[else]The mismatched hybrid, while he's down there, takes the opportunity to stuff your cock in his muzzle so he can lick and suck at you to get you all nice and slick[end if] before [if Libido of Francois is 2 or a random chance of 1 in 3 succeeds]moving into position by leaning against the counter and raising his tail. His furry bottom on display for you, he grins and wiggles his hips. Needing no more invitation, you move in behind the horny guy, pressing your slick shaft against his pucker[else][one of]getting up and leaning over with his paws gripping the back of one of the chairs. He grins back at you as he sways his rear in a sensual display. Not that you need the added enticing, but it certainly gets you atop him all the faster, guiding your slick shaft into position under his feline tail[or]heading over to one of the shorter tables and laying down overtop of it. He grins back at you and swishes his tail while spreading his legs, offering himself up to you. Taking your achingly hard cock in hand, you move into position and rub your slick, dribbling glans across his tailhole[at random][end if].";
		WaitLineBreak;
...
understand "cook with/-- francois/francis" as Francoisbaking.
...
carry out Francoisbaking:
	if Francois_Undiscovered is not empty:
		...
		if 3 is listed in Francois_Undiscovered and blue gel is owned and Awesome Fruit is owned:
			...
			add 6 to Francois_Discovered, if absent;
			...
			add 7 to Francois_Discovered, if absent;
			ItemLoss soda by 1;
			...
			add 8 to Francois_Discovered, if absent;
			...
			add 9 to Francois_Discovered, if absent;
			...
			add 10 to Francois_Discovered, if absent;
...
to say FrancoisBakingMenu:
	...
	while sextablerun is 0:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			choose row calcnumber in table of fucking options;
			say "[title entry in title case]: Would you like to [description entry]?";
			if Player consents:
				LineBreak;
				if title entry is "crème abondante":
					...
					if pink gel is owned and Awesomer Fruit is owned:
						...
						say "     You do not have the required ingredients: pink gel and Awesomer Fruit.";
				...
				else if title entry is "gingerbread":
				...
				else if title entry is "cheesecake":
...
to say boysenberry blossom Use:
	say "     Biting into the boysenberry blossom, you are treated to a lovely fruity filling inside the flaky pastry. Eating the treat in several slow bites you savor the fruity pastry[run paragraph on]";
	if Player is FemalePreferred or (Player is male and "Modest Organs" is listed in feats of Player):
		say ". It tastes great but gives you a belly ache. Clearly your body doesn't agree with something about the treat.";
	else if Player is not male:
		now Cock Count of Player is 1;
		now Cock Length of Player is 5;
		now Ball Size of Player is 2;
		Follow the cock descr rule;
		say " as a warm tingling wells up in your belly, slowly spreading across your body. The sensation focuses on your groin as a [descr] [Cock of Player] [one of]cock[or]penis[or]shaft[or]maleness[at random] erupts from you, spurting a few excited streams of fluid as it settles into place.";
	else:
		increase Cock Length of Player by a random number from 1 to 2;
		Follow the cock descr rule;
		say " as a warm tingling wells up in your belly, slowly spreading across your body. The sensation focuses on your groin, your [if Cock Count of Player is 1][one of]cock[or]penis[or]shaft[or]maleness[at random] [one of]engorging[or]swelling[or]throbbing[at random] as it gains[else][one of]cocks[or]penises[or]shafts[or]malenesses[at random] [one of]engorging[or]swelling[or]throbbing[at random] as they gain[end if] in length, becoming [descr].";
	PlayerEat 5;
...
to say lollicock Use:
	...
	if lollicockDildo is false:
		if CockName of Player is not "candy cock" and Player is not FemalePreferred and a random chance of 1 in 4 succeeds:
			...
			say "     Wrapping your lips around the phallic treat, you begin bobbing up and down its length, savoring its sweet and salty taste as your tongue works over it. As the last of it melts away you are filled with a pleasant warmth, a subtle afterglow filling your body after the tasty treat.";
...
to say dragonmoelleuxuse:
	if inafight is 1:
		...
		say "Quickly swallowing the warm chocolate cake, you feel a growing heat welling up in your belly. Soon you can hold it in no longer and unleash a powerful gout of flame at [if enemy type entry is not 2]the [end if][EnemyNameOrTitle], burning them for [special-style-2][dam][roman type] damage![hydraharming]";
		decrease monsterHP by dam;
		now playerdam is ( playerdam / 3 ) / 10;
		if Playerfireresist is 1:
			now playerdam is playerdam / 2;
		else if Playerfireresist is 2:
			now playerdam is 0;
		if Playerdam > 0:
			say "However, the flame does not leave you unscathed. You suffer [special-style-2][playerdam][roman type] damage!";
			decrease HP of Player by playerdam;
		ItemLoss dragon moelleux by 1 silently;
	else:
...
to say fizz-aux-pommesuse:
	if inafight is 1:
		...
		say "Temporary +3 dodge bonus, +3 hit bonus, +15 libido!";
		increase plhitbonus by 3;
		increase pldodgebonus by 3;
		increase Libido of Player by 15;
		ItemLoss fizz-aux-pommes by 1 silently;
...
to say vin-coeuruse:
	if inafight is 1:
		...
		say "Temporary +2 damage bonus, -1 dodge bonus, -1 hit bonus!";
		increase pldamagebonus by 2;
		decrease pldodgebonus by 1;
		decrease plhitbonus by 1;
		ItemLoss vin-coeur by 1 silently;
		[follow the player attack rule;]
	else:
		say "That's probably not a good idea right now.";
...
to say cheesecake Use:
	if carried of cheesecake > 0: [after eating one, are there any left?]
		...
		if Player consents:
			...
			cheesecakeinfect;
			cheesecakeinfect;
			ItemLoss cheesecake by 1 silently; [eat the second slice]
			if cheesecakemode is 1 and player is cheesecakebodied:
				say "[line break]     After your large serving of the delicious cake, your belly rumbles as your cheesecake body shifts and swells, becoming plump and Rubenesque.";
			now cheesecakemode is 0;
			PlayerEat 6;
			...
			if cheesecakemode is 0 and player is cheesecakebodied:
				say "[line break]     Indulging in only a small serving of the rich cheesecake, your belly rumbles as your plump confectionary body slims down to become thin and sexy.";
