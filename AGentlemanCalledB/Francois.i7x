...
to say dragonmoelleuxGet:
	say "     'I have a good feeling about this, mon ami[if cunts of player > 0 and cocks of player is 0]e[end if], François says, taking the dark scale scale, glowing ember and chocolate milk and heading to his kitchen. A rich chocolaty scent fills the bakery as he works, making your mouth water in anticipation as you wait.";
