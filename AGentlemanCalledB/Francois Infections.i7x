...
to say CheesecakeBodyDesc:
	if cheesecakemode is 1:
		say "slim and [if cunts of player > 0]feminine[otherwise]girlish[end if], with a tight, attractive figure. A gentle prodding reveals your flesh is soft and malleable, like cheesecake. [if breast size of player > 0 and breasts of player > 0 and player is cheesecakeskinned]you have a delicious corset made of flaky pastry crust formed tightly around your torso, boosting your breasts up into full view while doing little to protect your decency[otherwise if player is cheesecakeskinned]you have a delicious corset made of flaky pastry crust formed tightly around your torso[end if]";
	otherwise:
		say "hefty and rubenesque with a luscious [if cunts of player > 0]feminine[otherwise]girlish[end if] figure. A gentle prodding reveals your flesh is soft and malleable, like cheesecake. [if breast size of player > 0 and breasts of player > 0 and player is cheesecakeskinned]You have a delicious corset made of flaky pastry crust formed tightly around your torso, boosting your breasts up into full view while doing little to protect your decency[otherwise if player is cheesecakeskinned]You have a delicious corset made of flaky pastry crust formed tightly around your torso[end if]";

to say CheesecakeBodyTF:
	if cheesecakemode is 1:
		say "it becomes soft and malleable, just like cheesecake, shifting to a slender [if cunts of player > 0]feminine[otherwise]girlish[end if] form. [if breast size of player > 0 and breasts of player > 0 and player is cheesecakeskinned]You feel a sudden tightness forming around your body as a tight corset made of flaky pastry forms around you, boosting your breasts up into full view[otherwise if player is cheesecakeskinned]you feel a sudden tightness forming around your body as a tight corset made of flaky pastry forms around you[end if]";
	otherwise:
		say "it becomes soft and malleable, just like cheesecake. You can't help but moan slightly as your form shifts, becoming plump and curvaceous, leaving you hefty and rubenesque. [if breast size of player > 0 and breasts of player > 0 and player is cheesecakeskinned]you feel a sudden tightness forming around your body as a tight corset made of flaky pastry forms around you, boosting your breasts up into full view[otherwise if player is cheesecakeskinned]you feel a sudden tightness forming around your body as a tight corset made of flaky pastry forms around you[end if]";
...
When Play begins:
	...
	now tail entry is "[if cheesecakemode is 1]Your petite ass is tight and attractive, yet still soft and grabbable.[otherwise]You have a luscious, plump booty.[end if]";	[ Tail desc., written as a full sentence or left blank for none. ]
	...
	now skin change entry is "it becomes soft and blemish free, shifting to a creamy white with rosy red highlights[if breast size of player > 0 and breasts of player > 0 and player is cheesecakebodied]. You feel a sudden tightness forming around your body as a tight corset made of flaky pastry forms around you, boosting your breasts up into full view[otherwise if player is cheesecakebodied]. You feel a sudden tightness forming around your body as a tight corset made of flaky pastry forms around you[end if]";	[ Skin TF text, format as "Your skin feels funny as (your text)." ]
	now ass change entry is "[if cheesecakemode is 1]it becomes tight and firm[otherwise]it becomes plump and luscious[end if]";	[ Ass/Tail TF text, format as "Your ass feels funny as (your text)." ]
	...
	now body descriptor entry is "[if cheesecakemode is 1 and a random chance of 1 in 2 succeeds]slim[otherwise if cheesecakemode is 1]delicate[otherwise if a random chance of 1 in 2 succeeds]plump[otherwise]luscious[end if]";	[ Ex: "plump" "fat" "muscled" "strong" "slimy" "gelatinous" "slender"   Use [one of] to vary ]
...
When Play begins:
	...
	now desc entry is "I am Error! - You should not be able to encounter this creature, please report how you did this.";						[ Description of the creature when you encounter it. ]
	now face entry is "devoid of any human features save for your nose and eyes, which seem to be fully functional despite appearing to be drawn on with [if cocks of player is 0 and cunts of player > 0]pink[otherwise]blue[end if] icing.";		[ Face Description, format as the text "Your face is (your text)." ]
	now body entry is "that of a gingerbread [if cocks of player > 0]man[otherwise if cunts of player > 0]woman[otherwise]person[end if]. Your entire form is strangely flat, with no discernible joints though you are still able to move around normally, if a little stiffly";	[ Body Description, format as the text "Your body is (your text)." ]
