...
When Play begins:
	...
	now ass change entry is "it becomes [if cheesecakemode is 1]tight and firm[otherwise]plump and luscious[end if]";	[ Ass/Tail TF text, format as "Your ass feels funny as (your text)." ]
