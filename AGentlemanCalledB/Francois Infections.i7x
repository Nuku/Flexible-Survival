...
When Play begins:
	...
	now desc entry is "I am Error! - You should not be able to encounter this creature, please report how you did this.";						[ Description of the creature when you encounter it. ]
	now face entry is "devoid of any human features save for you nose and eyes, which seem to be fully functional despite appearing to be drawn on with [if cocks of player is 0 and cunts of player > 0]pink[otherwise]blue[end if] icing.";		[ Face Description, format as the text "Your face is (your text)." ]
