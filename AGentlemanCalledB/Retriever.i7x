...
When Play begins:
	...
	now Species Name entry is "Retriever"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Retriever Female" to infections of CanineList;
	add "Retriever Female" to infections of FurryList;
	add "Retriever Female" to infections of NatureList;
	add "Retriever Female" to infections of FemaleList;
	add "Retriever Female" to infections of TaperedCockList;
	add "Retriever Female" to infections of KnottedCockList;
	add "Retriever Female" to infections of SheathedCockList;
	add "Retriever Female" to infections of BipedalList;
	...
	now face change entry is "you feel an immense pressure build in your head, only to have it release moments later as your face pushes out into a canine muzzle. You are distracted from your changing head when your ears begin to ring painfully; you realize why when you feel them shifting to the top of your head while the rest of your face changes to match a female retriever almost exactly";
	now body change entry is "you stumble and fall to all fours, your legs twisting to a digitigrade configuration with canine paws. The changes continue up your body like a wave, leaving you with a stunning hourglass figure and paw-like hands, much like one of those retriever bitches";
	...
	now MilkItem entry is "retriever milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "retriever cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
When Play begins:
	...
	now NewTypeInfection entry is false;
	now Species Name entry is "Retriever"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	add "Retriever Male" to infections of CanineList;
	add "Retriever Male" to infections of FurryList;
	add "Retriever Male" to infections of NatureList;
	add "Retriever Male" to infections of MaleList;
	add "Retriever Male" to infections of TaperedCockList;
	add "Retriever Male" to infections of KnottedCockList;
	add "Retriever Male" to infections of SheathedCockList;
	add "Retriever Male" to infections of BipedalList;
	add "Retriever Male" to infections of TailList;
	now Name entry is "Retriever Male";
	...
	now loot entry is ""; [ Dropped item, blank for none. Case sensitive. ]
	now lootchance entry is 0; [ Percentage chance of dropping loot, from 0-100. ]
	now MilkItem entry is "retriever man-milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "retriever cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	now TrophyFunction entry is "-"; [ Function to generate a list of optional loot items, of which the player can choose one after victory. ]
	now scale entry is 3; [ Number 1-5, approx size/height of infected PC body: 1=tiny, 3=avg, 5=huge ]
	now body descriptor entry is "[one of]shapely[or]slender[or]delicate[or]curvy[at random]"; [ Ex: "plump" "fat" "muscled" "strong" "slimy" "gelatinous" "slender". Use [one of] to vary ]
...
This is the Retriever Female Infection rule:
	if Player has a body of "Retriever Female":
		trigger ending "Retriever Female Infection";
		if humanity of Player < 10:
			if HP of Rex is 49:
				...
				if HP of Rex is 4:
					say "     You enjoy your time in the city with the other various infected creatures, particularly the other canines, but even they are unable to relieve the burning need in your body the way your wonderful sextoy does.";
			...
			if Retriever Girl is tamed:
				...
				say "     Once the military moves into the city, you are quickly processed through their refugee camp and declared safe so they can move on to more dangerous creatures in the city.";
				if HP of Rex > 5:
