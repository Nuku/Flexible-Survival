	...
	if the player consents:
		...
		if skinname of player is "Sugar Glider" and bodyname of the player is "Sugar Glider":
			...
			if skinname of player is not "Sugar Glider":
				say ", but you discover it now matches the sugar glider's own paw exactly [if cocks of player > 0]except that the thick coat of cotton candy fur that reaches up to your elbow is bright blue[else]with a thick coat of bright pink cotton candy fur reaching up to your elbow[end if][run paragraph on]";
		...
		say "     You groan with disappointment as you are pulled from your cotton candy filled dream and but soon find yourself face to face with your giggling lover once again. [if player is not sugargliderskinned]'You look lovely,' she says with a[else]She stares deep into your large eyes with a loving[end if] smile, before pressing her muzzle to your own in a deep kiss. Her long, agile tongue darts around your mouth with practiced mastery, easily out maneuvering your own and filling your mouth with her deliciously sweet flavour. Meanwhile her dexterous paws are roaming across your body, quickly stripping you of your clothing and gear as she presses you up against the stall wall.";
