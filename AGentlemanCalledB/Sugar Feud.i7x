...
to say ResolveEvent Sugar Shack:
	...
	if Player consents:
		...
		if Player is male:
			...
			say "     She breaks your kiss with a giggle and slowly begins descending down your body, her long slick tongue teasing your [if Nipple Count of Player > 0 and Breast Size of Player > 0]breasts[else if Nipple Count of Player > 0]nipples[else]body[end if] [if Nipple Count of Player > 0 and Breast Size of Player > 0 and player is not sugargliderskinned]as the cotton candy fur creeps over them[else if Nipple Count of Player > 0 and player is not sugargliderskinned]as the cotton candy fur spreads past them[else if Player is not sugargliderskinned]as the cotton candy fur spreads[end if], continuing downwards until her muzzle is buried in your groin. Her dexterous tongue teases your needy puss[yfn], slowly playing along your outer folds and stroking across your clit, sending tingles of pleasure through you. You moan in delight, running your fingers through her thick pink cotton candy fur as her agile tongue presses deeper into you, her cute pink nose rubbing delightfully against your clit as she probes your depths, but before you reach climax, she pulls back suddenly. Her long tongue makes one last slow pass over your [if Player in not sugarglidercocked]now syrupy pink [end if]netherlips before she spreads herself out across the floor. The sugar glider smiles up at you coyly, stroking her own drooling cunts with a pair of fingers as her tail pulls you closer.";
