...
Instead of resolving a Sugar Shack:
	...
	if the player consents:
		...
		otherwise if cunts of player > 0:
			say "     She breaks your kiss with a giggle and slowly begins descending down your body, her long slick tongue teasing your [if breasts of player > 0 and breast size of player > 0]breasts[otherwise if breasts of player > 0]nipples[otherwise]body[end if] [if breasts of player > 0 and breast size of player > 0 and player is not sugargliderskinned]as the cotton candy fur creeps over them[otherwise if breasts of player > 0 and player is not sugargliderskinned]as the cotton candy fur spreads past them[otherwise if player is not sugargliderskinned]as the cotton candy fur spreads[end if], she continues downwards until her muzzle is buried in your groin. Her dexterous tongue teases your needy puss[yfn], slowly playing along your outer folds and stroking across your clit sending tingles of pleasure through you. You moan in delight, running your fingers through the her thick pink cotton candy fur as her agile tongue presses deeper into you, her cute pink nose rubbing delightfully against your clit as she probes your depths, but before you reach climax she pulls back suddenly. He long tongue makes one last slow pass over your [if player in not sugarglidercocked]now syrupy pink[end if] netherlips before spreads herself out across the floor. The sugar glider smiles up at you coyly stroking her own drooling cunts with a pair of fingers as her tail pulls you closer.";
