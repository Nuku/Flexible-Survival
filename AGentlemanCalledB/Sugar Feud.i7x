	...
	if the player consents:
		...
		otherwise:
			...
			if skinname of player is not "Sugar Glider":
				say ", but you discover it now matches the sugar glider's own paw exactly [if cocks of player > 0]except that the thick coat of cotton candy fur that reaches up to your elbow is bright blue[otherwise]with a thick coat of bright pink cotton candy fur reaching up to your elbow[end if] [run paragraph on]";
			say ". Entranced by watching the [if player is not sugargliderskinned]thick fur[otherwise]changes[end if] slowly creep up your arm, you hardly notice the sugar glider shifting to the other side of you, taking hold of you other arm and pulling it into the humming machine, this time all the way up to your shoulder.";
		let sugarface be 1;
		if facename of player is "Sugar Glider", now sugarface is 0;
		let sugarcock be 1;
		if cockname of player is "Sugar Glider", now sugarcock is 0;
		let sugarskin be 1;
		if skinname of player is "Sugar Glider", now sugarskin is 0;
		say "     With your face so close to the sweet smelling candy, your sugar clouded mind struggles to find a reason to resist her advances, and when you feel the sugar glider's free hand at the back of your head you can only giggle in anticipation. [if sugarface is 1]'You're going to be such a cute sugar glider'[otherwise]'this outta help you loosen up'[end if] she whispers into your ear, placing another kiss on your cheek before plunging your head into the whirling candy filled drum. Fully focused on the cotton candy whirling around you, all you can do is open your mouth and try to catch all you can, giggling uncontrollably as the sugary fluff builds up on your face,[run paragraph on]";
		if facename of player is "Sugar Glider":
			say " pressing against your flesh and forming a thick [if cocks of player > 0]blue[otherwise]pink[end if] cotton candy hide on your shifting head. As the changes roll through you[run paragraph on]";
		...
		say "     You groan with disappointment as you are pulled from your cotton candy filled dream and but soon find yourself face to face with your giggling lover once again. [if player is not sugargliderskinned]'You look lovely' she says with a smile[otherwise]She stares deep into your large eyes with a loving smile[end if], before pressing her muzzle to your own in a deep kiss. Her long agile tongue darts around your mouth with practiced mastery, easily out maneuvering your own and filling you mouth with her deliciously sweet flavour. Meanwhile her dexterous paws are roaming across your body, quickly stripping you of your clothing and gear as she presses you up against the stall wall.";
		...
		if cocks of player > 0:
			say "     She breaks your kiss with a giggle and slowly begins descending down your body, her long slick tongue teasing your [if breasts of player > 0 and breast size of player > 0]breasts[otherwise if breasts of player > 0]nipples[otherwise]body[end if][if breasts of player > 0 and breast size of player > 0 and sugarskin is 1]as the cotton candy fur creeps over them[otherwise if breasts of player > 0 and sugarskin is 1]as the cotton candy fur spreads past them[otherwise if sugarskin is 1]as the cotton candy fur spreads[end if], she continues downwards until her muzzle is buried in your groin. Her dexterous tongue slides along your eager cock, wrapping around it and teasing your balls before her muzzle descends down your length. You moan in delight and run your paws