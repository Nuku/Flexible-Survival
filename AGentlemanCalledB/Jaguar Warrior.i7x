...
to say TehuantlandSven:
	say "     As you make your way into the library, hear the heavy bunker door creak open on the far side of the room. Ducking out of sight for a moment, you watch with curious interest as Sven quietly slips out and makes his way towards the stairs to the library's upper level with his nose high in the air. Taking a breath yourself, you realize the scent of Tehuantl's heat still permeates the room.";
	...
	if the player consents:
		say "     As Sven's long snow leopard tail disappears upstairs, you make your way over to the steps quietly, slowly making your way up to see what your feline pets are up to. Peeking over the top of the stairs, you seen Sven lurking down one the the isles of books, wringing his tail nervously as he peers at Tehuantl from between the volumes. Tehuantl meanwhile, apparently well aware of the hidden kitty, is lounging on the couch near the balcony teasing her wet, swollen cunt as she watches the shy snowmeow spying on her.";
...
[		otherwise if TehuantlStatus is 3:
			...
			if TehuantlTimer is 0:
				if player is in grey abby libary or bunker or grey abby 2f:
					say "     You hear Tehuantl moaining []upstairs[or]outside[end if] and rush to check on her.";
