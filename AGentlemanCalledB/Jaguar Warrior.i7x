...
after navigating Grey Abbey Library:
	...
	otherwise if hp of Tehuantl is 12 or hp of Tehuantl is 13 or hp of Tehuantl is 14:
		say "     The air is still thick with the powerful scent of feline arousal. It would seem Tehuantl is still in heat, you can't help but wonder about finding something to help her take the edge off again.";
	otherwise if hp of Tehuantl > 14:
		if TehuantlStatus is 2:
			if a random chance of ( lastfuck of Tehuantl - turns ) in 20 succeeds:
				[say "     Tehuantl Bunker buddy scenes!";
...
to say TehuantlHeatIntro:
	...
	if cocks of player is 0 and cunts of player is 0:
		say "     Lacking any gender of your own, you remain quiet as you watch Tehuantl's fingers sink back into her slick opening. As her moans and mewls begin again she seems to forget you're even there, losing herself once again in her powerful lusts. Taking the opportunity to quietly slip away you carefully make your way back downstairs, leaving the lusty kitty alone for now. As you reach the main floor of the library once again, you find yourself wondering if there may be something out in the city to help the poor feline.";
	otherwise:
