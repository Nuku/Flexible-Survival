...
to say losetoSugarGlider:
	...
	if bodyname of player is "Sugar Ferret" or facename of player is "Sugar Ferret":
		...
		otherwise:		[steal before]
			...
			otherwise if carried of soda > 0:
	...
	otherwise if cocks of player is 1: [Male PC 1 cock]
	...
	if ( bodyname of player is "Sugar Ferret" or facename of player is "Sugar Ferret" ) and hp of player > 0:	[steal after]
		...
		otherwise if carried of soda > 0:
			...
			decrease carried of soda by 1;
		otherwise if a random chance of 1 in 3 succeeds and sugarglidernote is false:
...
to say beattheSugarGlider:
	...
	otherwise if ( cocks of player > 0 or cunts of player > 0 ) and ( libido of player > 40 or bodyname of player is "Sugar Ferret" or facename of player is "Sugar Ferret" or bodyname of player is "Sugar Glider" or facename of player is "Sugar Glider" ):
		...
		if the player consents:
			...
			otherwise: [Female]
				...
				attempttowait;
				say "     Even in the afterglow of your climax, you moan at the delightful shivers the sugar glider's tongue sends through your body as it slowly slides out of your depths, she pulls her muzzle from your cunt with a wet slurp, doing her best to clean your female juices from her matted pink fur as she move over your supine body. As her face reaches your own, the sugar glides presses her muzzle to your lips, her long tongue slipping into your mouth, filling it with the sugary taste of her own saliva mixed with your own musky fluids before she springs to her feet and [one of]skips off into the midway[or]scampers up a nearby light post and glides off over the stalls[or]climbs a nearby stall and bounds off across the rooftops[at random], but not before pulling a [one of]lollipop[or]jaw breaker[or]piece of saltwater taffy[at random] from her pouch and slipping it into your mouth with a smile.";
		otherwise:
...
to say SugarGliderdesc:
	...
	say "     Giggling happily as she spots you, she [one of]pulls the lollipop she's sucking on from her mouth and[or]pulls the jawbreaker she's sucking on from her mouth and[or]blows a large bubble with the gum she's chewing on then[at random] tucks it into the pouch on her belly [if player is sugarbodied or player is sugarfaced]and looks you over. '[one of]All on your own[or]None of your greedy pals around[or]Scouting for more pop on your own[or]Out to swipe more candy on your own[at random], you [one of]soda jerk[or]fizz head[or]carbonated tube rat[or]candy hoarder[or]pop guzzler[at random]? How about you gimme some of your sweet, sweet candy and we can make out.' With that, she bounds towards you[otherwise]before bounding towards you[end if]. Her large breasts bounce distractingly as she runs, and her open arms draw attention the large wing-like flaps of flesh between her arms and legs, stretching like taffy as she rushes towards you. It appears you're facing a literal sugar glider.";
