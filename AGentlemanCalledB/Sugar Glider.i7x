...
to say losetoSugarGlider:
	...
	if BodyName of Player is "Sugar Ferret" or FaceName of Player is "Sugar Ferret":
		...
		say "     [if HP of Player > 0]Giving up on resisting the sweet marsupial, you allow her to push you to the ground in her eagerness[else]Beaten by the giggling marsupial, you are unable to resist as she pushes you to the ground[end if], stripping you of your clothing and gear in the process. ";
	if Player is male:
		if a random chance of 1 in 3 succeeds:	[69]
...
to say beattheSugarGlider:
	if nosugarglidersex > 2:
		...
		if Player consents:
			...
			now nosugarglidersex is 0;
			if Player is male:
				if a random chance of 1 in 3 succeeds:	[fellatio]
...
to say PrepCombat_Sugar Glider:
...
When Play begins:
	...
	now skin entry is "[if looknow is true and Player is male]a short coat of sugary cotton candy-like fur. It is mostly blue, with a pink belly and chest, as well as a pink stripe down your back, over your[else if looknow is true]a short coat of sugary cotton candy-like fur. It is mostly pink, with a light blue belly and chest, as well as a blue stripe down your back, over your[else if Player is male]short blue-furred[else]short pink-furred[end if]"; [ Skin. Format as "Looking at yourself, your body is covered in [Skin of Player] skin." ]
	...
	now skin change entry is "you suppress the urge to giggle, thanks to the tickling sensation of the [if Player is male]blue and pink[else]pink and blue[end if] cotton candy fur spreading over your body"; [ Skin TF text, format as "Your skin tingles as [skin change entry]. ]
