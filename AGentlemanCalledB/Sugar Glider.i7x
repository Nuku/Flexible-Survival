...
When Play begins:
	...
	now MilkItem entry is "Sugar Glider Milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "Sugar Glider Cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
Purified of sugar glider cum is "distilled cum".
...
to say sugar glider cum use:
	say "Lifting the plastic bottle to your mouth, you take a drink from it, letting the creamy cum run over your tongue and down your throat. Tastes sweet and candy-like. Swishing it around in your mouth a little, you finish the bottle off, then stuff it back into your collection of 'empties'.";
	PlayerDrink 5;
	SanLoss 5;

instead of sniffing sugar glider cum:
	say "You open the lid for a moment and take a sniff. Doesn't smell too bad actually, just kinda sugary.";

Table of Game Objects (continued)
name	desc	weight	object
"Sugar Glider milk"	"A plastic water bottle filled with what is clearly milk. One could think it was a regular cow's milk, if someone hadn't written 'Sugar Glider Milk' across the label on the bottle. You [italic type]could[roman type] drink it to quench your thirst. Who knows what else it might do to you though..."	1	sugar glider milk

sugar glider milk is a grab object.
sugar glider milk is milky.
Purified of sugar glider milk is "distilled milk".
...
to say sugar glider milk use:
	say "Lifting the plastic bottle to your mouth, you take a drink from it, letting the marsupial milk run over your tongue and down your throat. Tastes sweet and creamy. Swishing it around in your mouth a little, you finish the bottle off, then stuff it back into your collection of 'empties'.";
	PlayerDrink 15;
