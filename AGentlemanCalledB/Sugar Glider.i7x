...
When Play begins:
	...
	now skin change entry is "you try and suppress the urge to giggle, thanks to the tickling sensation of the [if Player is male]blue and pink[else]pink and blue[end if] cotton candy fur spreading over your body"; [ Skin TF text, format as "Your skin tingles as [skin change entry]. ]
