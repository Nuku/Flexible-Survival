...
"Adds a Mushroom creature with altattacks to Flexible Survivals Wandering Monsters table"
...
this is the swarmattack rule:		[damage bonus based on remaining health]
	...
	say "	The [name entry] [one of]attack[or]swarm[or]rush[at random] you as a group [one of]grabbing at your limbs, trying to drag you down[or]attacking you from all sides[or]groping and teasing your body as they swarm over you[at random]. [if (( monsterhp * 100 ) / hp entry ) > 75]With the group still at full strength the attack easily overwhelms your defenses[otherwise if (( monsterhp * 100 ) / hp entry ) > 50]With the majority of the group still fighting the assault is quite effective[otherwise if (( monsterhp * 100 ) / hp entry ) > 25]With most of their group injured or defeated the attack is only somewhat effective[otherwise] with the majority of the group defeated of the attack is severely weakened[end if],you suffer [special-style-2][dam][roman type] damage.";
	now damagein is dam;
	say "[noshieldabsorbancy]";		[unable to use shield effectivly - attacked from multiple angles]
...
this is the sporecloud rule:      [Spore aura following spore blast attack]
	...
	if SporeCloud > 0:
		...
		otherwise:
			...
			say "	[one of]Breathing heavily as a result of your continued fighting[or]As you try to catch your breath[or]Taking a deep breath[at random] you inhale the lingering airborne spores, causing [one of]a painful fit of coughing[or]a warm tingling in your chest[or]a powerful sneeze[at random].  You suffer [special-style-2][dam][roman type] damage.";
			decrease hp of the player by dam;
...
when play ends:
	if bodyname of player is "Mushroom Men":
		...
		otherwise:
			say "	When rescue finally arrives the military scientists are intrigued by your unusual fungal infection but are forced too rush your through the processing camp once you are deemed safe so they can focus on bigger problems. Due too your size life outside the city is difficult at first, but eventually you find your calling working in a small plant nursery. Working in the soil and tending the plants seems too come naturally to you, and the small business becomes quite prosperous thanks too your efforts.";
			if humanity of player < 30:
				say "	After some time you begin too find small mushrooms growing in the gardens you work most often and find yourself strangely attached to them, transplanting them to a small unused greenhouse at the edge of the property. One evening the nursery's owner sees you sneaking off to the abandoned greenhouse after you shift and quietly follows behind you. When he bursts in on you as you tend to your private mushroom garden you turn just in time too see many of the mushrooms pull themselves out of the soil and tackle your boss too the ground.";
			...
			otherwise:
				say "	The owners of the nursery even give you a small greenhouse of your own on the property to call home. You take too collecting the unusual plants created by the infection in your small garden home, many of them being perfectly suited to sating your body's sexual desires after a long day of working the nursery.";
