...
to say FemaleFireSpriteVicVag:
	say "     Beaten by the fiery sprite, you fall to the ground as she prances around gleefully. Poking and prodding you with small wicks of flame to maneuver you into the position she wants the sprite eventually has you laying on your back, with your throbbing maleness exposed. Teasing you to full erection with a fiery touch that boarders between pleasure and pain the small sprite is soon positioned above you, slowly sinking herself down onto your burning member. With a gleeful giggle she begins bouncing in your lap, riding your cock eagerly. With the heat of her drooling cunt wrapped around your glans, squeezing and clenching you as she bounces the pleasure soon begins to overwhelm you, pushing you to a powerful climax as she soaks your crotch in her steaming juices with an orgasm of her own. A chill runs over you as she pulls herself off your exhausted member, leaving you soaked in her warm honey as she scampers off into the city.";
...
to say FireSpriteCunnilingus:
	say "     Deciding to make use of the beaten sprite, you remove your gear and stretch out on the ground. You press the little sprite's face to your groin, pressing [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] lips to your own damp netherlips. Having little other option, the sprite begins working [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] tongue into your moist passage, reaching deeper and deeper as you press harder against the back of [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] head, partially forcing their face inside you. With the top of [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] nose rubbing against your clit you begin pistoning your hips against the sprite's head, shaking [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] small body roughly as you ride [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] face to a powerful orgasm. Releasing the sprite's head, you lay back on the ground to bask in the afterglow of your climax, allowing [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]him[end if] to pull away from your cunt with a wet slurp and scamper off.";

to say FireSpriteBlowJob:
	say "     Deciding to make use of the beaten sprite, you remove your gear and stretch out on the ground. You press the little sprite's face to your groin, pressing [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] lips to your member. Having little other option, the sprite parts [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] lips, taking your [cock size desc of player] [cock of player] cock into [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] warm, wet mouth. Gripping the back of [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] head, you begin humping the small creature's face, spurts of your pre running down [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] throat as you pound into [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] mouth. Soon the sprite is eagerly sucking and licking at your cock, further pushing you towards a powerful orgasm. You fill the tiny sprite's mouth with your [cum load size of player] load, most of it forced down [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] throat into [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] belly. Sated, you release the sprite's head, allowing the sprite to scamper off into the city as you recover.";

to say FireSpriteInsertion:
	say "     Deciding to make use of the beaten sprite, you remove your gear and stretch out on the ground. After sizing the little creature up, you decide [if FireSpritemode is 0]she[otherwise if FireSpriteMode is 1]he[end if] is just the right size for some...special fun. [if FireSpritemode is 0]Her[otherwise if FireSpriteMode is 1]His[end if] eyes go wide as you push [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] head towards your gaping pussy, pressing [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]his[end if] face against you wanton folds. Pinning the squirming sprite's arms against their waist, you grab hold of their body and press them deeper into your drooling cunt. With an audible slurp, the sprite's entire head slips inside you, sending waves of pleasure through you as you climax powerfully, soaking your little plaything's body in your feminine juices. With the afterglow of your first climax still rolling through you, you begin working the warm sprite deeper into your cunt, fresh waves of pleasure rolling through you with every inch of the little creature that disappears inside you. When you feel the squirming sprite's head pressing against your cervix, you finally stop pushing, and begin pulling the creature's tiny form back out, working [if FireSpritemode is 0]her[otherwise if FireSpriteMode is 1]him[end if] back and forth inside your quivering tunnel like a living dildo. After using the poor creature to pleasure yourself to several more powerful climaxes you finally pull them out with a long wet slurp. Laying back on the ground to recover from your multiple orgasms, you watch the little [if FireSpritemode is 0]gal[otherwise if FireSpriteMode is 1]guy[end if] stumble away, coughing and sputtering up your feminine juices as [if FireSpritemode is 0]she[otherwise if FireSpriteMode is 1]he[end if] goes.";
