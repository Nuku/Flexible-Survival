...
to say DogBoneScene3m:
	...
	say "     As you begin driving the dildo into yourself again, your free hand is drawn to your [if cocks of player > 0]own erect cock, slowly working it's length at the same pace[else]featureless crotch, rubbing against it futilely as you moan in pleasure[end if].";
