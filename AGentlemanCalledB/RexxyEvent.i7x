		...
		if the player consents:
			...
			if fightoutcome >= 10 and fightoutcome <= 19:
				...
				if cocks of player > 0:
					...
					say "     Unable to resist these powerful new urges long, you're soon reaching for the limp canine, and after rolling him onto his back you reach for his thick member, stroking it to full attention as he whimpers at your touch. Stepping over the beaten canine, you begin lowering yourself onto his pointed cock, reaching behind yourself to ensure it's properly aligned with your [if cunts of player > 0]dripping cunt[else]ass[end if]. With a sigh of relief, you slowly lower yourself onto his firm rod, [if cunts of player > 0]your cunt quivering with pleasure as the pointed member spreads you open[else]your cheeks spreading easily for the pointed member[end if]. Rex groans beneath you, clearly beginning to enjoy the feeling despite his displeasure at the situation. When you finally feel the swelling canine knot pressing at your [if cunts of player > 0]pussy lips[else]ass[end if], you pause for a moment, staring into the eyes of the canine below you with a smirk until he looks away. With your dominant position asserted, you eagerly begin riding the thick shaft buried within you, rocking back and forth as you slide up and down the engorged member. Riding him faster and harder, you soon feel Rex's swollen knot pressing deeper into your wanton entrance, and with a howl of ecstasy you throw all your weight into one final thrust, driving the knot into your body as [if cunts of player > 0]you both reach[else]Rex reaches[end if] a powerful climax[impregchance].";
					say "     You brace yourself on Rex's shoulders as [if cunts of player > 0]orgasm wracks your body, delighting in the sensation of Rex's warm seed, trapped by his knot, flowing into your womb while you bask in the afterglow of your own climax[else]you enjoy the sensation of Rex's warm seed surging into your body, trapped deep within you by his knot[end if]";
					if cunts of player > 0:
				...
				say "     Grabbing you roughly by the hips, Rex positions you just as he wants before driving his entire length into your unprepared [if cunts of player > 0]cunt[else]ass[end if] in one sharp motion, causing you to yelp in pain. With his swelling knot pressed against your [if cunts of player > 0]pussy lips[else]cheeks[end if], Rex takes a firm grip of your shoulders, pressing your face down into the bed as he begins fucking you. Despite your efforts to maintain control, your eager body soon begins responding to the dominant canine, and as waves of pleasure begin to cloud your mind, you find your grip slipping.";
...
to say DogBoneScene3m:
	...
	say "     As you begin driving the dildo into yourself again, your free hand is drawn to your [if cocks of player > 0]own erect cock, slowly working its length at the same pace[else]featureless crotch, rubbing against it futilely as you moan in pleasure[end if].";
	...
	say "     With one final, powerful thrust, you push the entire length of the canine shaft into yourself, hilting the handle against your cheeks[if cocks of player > 0] and pushing you over the edge into the ecstasy of orgasm, your own twitching member unleashing your hot, thick seed into the air[end if]. As you bask in the afterglow of your [if cocks of player > 0]climax[else]fun[end if], you feel the warm tingling throughout your body intensify, the retriever infection working rapidly to reshape your body to match your new self image, washing away the last of your concerns about this wonderful bone in the process.";
	attempttowait;
	say "     After you come to your senses some time late,r you can't help but wonder how that other silly bitch could have let this wonderful bone slip from her grasp while you clean up and gather your things. It's definitely the best toy you've ever had, you tell yourself, admiring your perfect new retriever body as you slip the toy back into your bag and head back out into to the city.";
