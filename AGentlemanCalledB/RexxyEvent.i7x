...
instead of conversing the Rex:
	if hp of Karen is 3 and Dog Treats is owned:
		say "	You slowly approach Rex, sliding your bag off your shoulders as you step towards him. As you get close Rex's ears suddenly perk up and he begins sniffing the air around you, 'Is that wonderful scent what I think it is?' Rex asks, eagerly trying too peer into your bag.";
		...
		if the player consents:
			...
			otherwise if fightoutcome >= 20 and fightoutcome <= 29:
				...
				stop the action;
		otherwise:
			say "	Deciding you're not quite ready too follow through with your plans you hide your bag behind your back, playing dumb as best you can in response to Rex's questions about it's contents. Eventually Rex tires of trying to discover the bag's contents and turns to leave you be.";
	...
	otherwise if hp of Rex is 9:
		...
		otherwise:
			...
			now hp of Rex is 6;
			if hp of Karen is 0:
				say ". As Rex walks away dejectedly you realize he probably isn't going to give up on making a proper pet out of you, and with the powerful urges his infection causes you're unsure how long you'll be able to continue resisting his offers. Perhaps you should try and find a way too escape his grasp.";
				say "	Glancing around the room looking for ideas, you Spot the dog bone sex toy that got you into this mess you realize that while you may not have a way to prevent the urges it caused, if you could get your hands on it at least you wouldn't need to see Rex too curb your need. Unfortunately Rex always seams too keep a close eye on the toy, You'll need to find some way to distract him before making your move";
...
Instead of fucking the Rex:
	...
	if lastfuck of Rex - turns < 8:
		if hp of Rex > 10:
			say "     'Oh, my lovely little pet is back for more fun already?' Rex says with his familiar grin, 'I don't know if I'm ready to go again yet, and it certainly wouldn't be fair too Karen if I keep spending all my time with you now would it?'";
		otherwise:
	...
	otherwise:
		...
		if humanity of player < 10:
			attempttowait;
			if hp of Rex > 9:
				say "     Eventually you find the energy too rise from your rest, but you find the that this time the lust induced fog in your mind never fully clears, the last of your concerns in the city begin to fade away, lost in this haze. Finally you realize everything you could ever want is here, in your home with your loving master Rex, why did you ever want to continue wandering that city too begin with?";
			Otherwise:
		...
		otherwise:
			attempttowait;
			if hp of Rex > 9:
				say "Eventually you find the energy too rise from your rest, rubbing the tag of your collar idly as you collect your thoughts and prepare to return to your tasks.";
			otherwise:
...
to say DogBoneScene3m:
	...
	say "     As you begin driving the dildo into yourself again, your free hand is drawn too [if cocks of player > 0]own erect cock, slowly working it's length at the same pace.[otherwise] featureless crotch, rubbing against it futilely as you moan in pleasure[end if].";
...
to say RexTrainHighLustScene:
	if cunts of player > 0:
		...
		say "Eventually Rex's knot has softened enough that he can pull himself free, leaving you whimpering for a moment at the sudden empty feeling. He slowly climbs to his feet, taking a moment too stretch with a low groan before returning to his business, leaving you to finish recovering on your own.[impregchance]";
	otherwise:
...
to say RexPetMedWait1:
	...
	otherwise if cocks of player > 0:
		say "     she pushes the bone into your hands before she turns, exposing her raised tail to you while she begins lick and sucking at your rapidly rising maleness. Needing no further prompting you begin teasing the outer lips of her feminine folds with the pointed tip of the toy, causing her too moan in delight around your hard shaft. The faster you begin working the canine dildo into her dripping slit the more enthusiastically she sucks on your throbbing cock, and before long you've worked each other to the edge of climax. Finally you can't take it anymore, thrusting your hips forward, pushing your shaft deep into Karen's muzzle, fillings her mouth with your warm seed. At the same time you give the bone a final powerful thrust, her howls of pleasure are muffled by your own climax in her mouth, but you know you've struck home when the rush of feminine fluids gushing from her cunt soak your head and torso.";
		attempttowait;
...
to say RexPetScene1:
	say "     Rex surprises you with a big hug from behind, you feel his firm cock pressing into your back as he wraps you in his powerful embrace, [if breasts of player > 0 and breast size of player > 0] he gives your breasts a firm squeeze [otherwise] he scratches your belly softly[end if] while licking and nuzzling your cheek affectionately. By the time he releases you, patting you on the head softly as he walks away, you are left panting with arousal, the familiar warmth once again washing through your body.";

to say RexPetScene2:
	say "     Rex gives you a firm smack on the ass as you walk past, causing you too yip loudly in surprise. When you turn to look at him all you get is a wink and that familiar mischievous smile, you can't help but smile in return while you stare into his eyes for a few moments before returning to what you were doing.";
