...
to say LoseToDragonPoolToy:
	...
	if vorelevel > 1 and scalevalue of Player < 5 and (a random chance of 1 in 4 succeeds or (Player is kinky and a random chance of 1 in 3 succeeds)):	[Oral Vore]
		...
		say "     You spend a long time watching as the toy breeds each of the girls tirelessly before the last one falls, and the toy lets out a triumphant squeak. It walks you both back to the pile you found it in before carelessly spewing you out of its mouth, luckily depositing you onto the soft sand as it lays down to rest, your own aching body tired and sore from the constant thrusting you were made to perform.";
		LibidoBoost 20;
...
"Dragon Pool Toy"	"[PrepCombat_Dragon Pool Toy]"

to say PrepCombat_Dragon Pool Toy:
...
When Play begins:
	...
	add "Dragon Pool Toy" to infections of InternalBallsList;
	...
	now tail entry is "A long, reptilian tail with a fin at the tip adorns your rump. Whenever you aren't paying attention to it, the tail seems to have a mind of its own, either swaying back and forth playfully or raising itself to allow those behind you a look at your rump and sex.";
	...
	now MilkItem entry is "dragon pool toy milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "dragon pool toy cum"; [ Item to be given to the player if they have this infection and jerk off. ]
