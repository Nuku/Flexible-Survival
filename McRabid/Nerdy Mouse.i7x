...
"Adds a Nerdy Mouse creature to Flexible Survivals Wandering Monsters table"
...
[	
	...
	otherwise:
		...
		if calcnumber is 1:		[playful sex]
			...
			otherwise if anallevel > 1 and a random chance of anallevel in 5 succeeds:
		...
		otherwise if calcnumber is 2:	[rough/bully sex]
