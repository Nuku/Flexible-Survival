	...
	if libido of player > 40 and ( cocks of player > 0 or cunts of player > 0 ):
		...
		if the player consents:
			...
			otherwise if cunts of player > 0:									 [female/herm]
				...
				say "     Aiming his swelling shaft upwards, you sink down onto it and start riding him before it's even fully erect.  Not that it stays that was for much longer.  For an old fellow, he's still got quite a bit of pep and he's up and ready for you in seconds.  Keeping a grip one of the horns on his head, you excitedly bounce up and down on the one between his legs.  Playing with his balls, you find him very well hung, each ball the size of lemons in his low-hanging scrotum.";
