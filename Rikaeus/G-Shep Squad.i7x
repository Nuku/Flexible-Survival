...
to say ResolveEvent Canine Patrol:
	...
	if gshepsquad is 1:
		...
		[say "     ";]
		say "[line break]     [bold type]Shall you go talk to these K9 officers or make a discreet exit while you can?[roman type][line break]";
...
The scent of K9 Vans is "     The area smells rather heavily of dogs.".
...
Cunt Depth of Buster is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Description of Buster is "     Buster is a tall, impressive looking German shepherd humanoid. He stands about 6[']2' without including his pointed ears and has a strong, fit build. He has a rich, brown coat with dark black markings and muzzle typical for his breed. He wears a policeman's vest and hat as his only gear, leaving his canine junk on display. He's got a plump, full sheath from which his canine cock often protrudes. Despite being a serious commander, he's got a friendly disposition and is always eager to help out any canine in need or to provide a nice canine injection to any criminal in need of reforming.[line break]".
...
to say bustersex00:
	...
	NPCSexAftermath Player receives "OralCock" from Buster;
...
to say bustersex01:		[Fuck him]
	...
	NPCSexAftermath Buster receives "AssFuck" from Player;
...
to say bustersex04:		[Give a blowjob]
	...
	say "     When it does, Buster manages to ignore his urges to release himself balls deep in your throat and pulls back enough so that his tip is resting on the flat of your tongue. Suddenly your mouth is filled with his hot doggy batter, flooding your tastebuds with a musky taste. You moan out loud, enjoying the experience. At the same time you are suddenly hit with ropes of hot cum from the many German shepherds that were watching you. Once they're done they walk up to you with smiles. [if catdogstate is 0]They reach out to you and smear the cum all over your fur, getting it sticky and matted with their sperm. 'You'll be a good doggy soon,' they all murmur[else]They reach out and help you gather the cum all over you into your mouth, something that you gulp down eagerly[end if]. Buster then gets up and pats you on the head before thanking you for the blowjob.";
	NPCSexAftermath Player receives "OralCock" from Buster;

to say bustersex05:		[Get a blowjob]
	...
	NPCSexAftermath Buster receives "OralCock" from Player;
...
Section 100 - Notes (Not for release)
