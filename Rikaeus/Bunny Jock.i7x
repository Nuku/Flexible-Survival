...
When Play begins:
	...
	add "Bunny Jock" to infections of LeporineList;
	add "Bunny Jock" to infections of FurryList;
	add "Bunny Jock" to infections of NatureList;
	add "Bunny Jock" to infections of MaleList;
	add "Bunny Jock" to infections of TaperedCockList;
	add "Bunny Jock" to infections of SheathedCockList;
	add "Bunny Jock" to infections of BipedalList;
	add "Bunny Jock" to infections of TailList;
	...
	now MilkItem entry is "bunny jock milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "bunny jock cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
This is the Bunny Jock Infection rule:
	if Player has a body of "Bunny Jock":
		...
		if humanity of Player < 10:
			...
			say "     Over time lots of different mutants unite under the team, leading to many finding each other. But the others enjoy hanging around the most with you and your other bunny jock friends.";
