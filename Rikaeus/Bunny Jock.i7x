...
to say beatthebunnyjock:
	say "     Beaten, the big bunny jock stumbles back and falls onto his rump[if cunts of player > 0]. 'Hey baby, wanna take your prize?' He asks wagging his eyebrows at you.[otherwise]. 'You did great dude! How about we have some more fun?' The rabbit asks, gesturing to his crotch[end if]. ";
	if bunnyjocknosex > 2:
