...
a postimport rule: [bugfixing rules for players that import savegames]
	if Leather Daddy Kitty is resolved and (Resolution of Leather Daddy Kitty is 1 or Resolution of Leather Daddy Kitty is 2):
...
Description of Kitty Sex Dungeon is "     The room is a stereotypical sex dungeon. There is a sex bench in the middle of the room, stocks against the wall, sex toys on shelves and so much more. On top of that, the entire place smells of sex and sweat, something that fills you with warmth as you think of the many things that have happened in this area. Interesting enough, there are no items for punishment via pain like flogs or whips. Perhaps Oliver punishes with pleasure rather than pain[if Player is not neuter]? You shudder at the thought of being denied orgasm.[else]?[end if][line break]".
...
Body Weight of Oliver is 7. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Oliver is 3. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
[Body Adjective is generated out of the body weight and body definition and can be used in scenes - one word descriptive adjective depending on weight and definition groups: low weight group: skinny/slender/lithe; mid weight group: average/fit/muscled; high weight group: pudgy/husky/jacked]
Androginity of Oliver is 2. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Oliver is 6. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Oliver is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Oliver is 6. [length in inches]
Breast Size of Oliver is 0. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Oliver is 2. [count of nipples]
Asshole Depth of Oliver is 10. [inches deep for anal fucking]
Asshole Tightness of Oliver is 2. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Oliver is 1. [number of cocks]
Cock Girth of Oliver is 3. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Oliver is 8. [Length in Inches]
...
instead of conversing the Oliver:
	if OliverRelationship < 2: [should not be available yet]
		...
		say "[line break]     What do you want to talk with Oliver about?";
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if Player consents:
					...
					if title entry is:
						...
						-- "Suck Oliver off":
							say "[OliverSex2]";
						-- "Take Oliver's shaft in your ass":
							say "[OliverSex3]";
