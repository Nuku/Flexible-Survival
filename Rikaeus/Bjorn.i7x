...
Body Weight of Bjorn is 6. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Bjorn is 7. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
[Body Adjective is generated out of the body weight and body definition and can be used in scenes - one word descriptive adjective depending on weight and definition groups: low weight group: skinny/slender/lithe; mid weight group: average/fit/muscled; high weight group: pudgy/husky/jacked]
Androginity of Bjorn is 2. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Bjorn is 6. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Bjorn is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Bjorn is 6. [length in inches]
Breast Size of Bjorn is 0. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Bjorn is 2. [count of nipples]
Asshole Depth of Bjorn is 8. [inches deep for anal fucking]
Asshole Tightness of Bjorn is 2. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Bjorn is 1. [number of cocks]
Cock Girth of Bjorn is 3. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Bjorn is 8. [Length in Inches]
...
TwistedCapacity of Bjorn is false. [Twisted Characters can take any penetration, no matter the size]
...
to say BjornSex1:
	...
	NPCSexAftermath Player receives "OralCock" from Bjorn;
...
to say BjornSex2:
	...
	NPCSexAftermath Player receives "AssFuck" from Bjorn;
