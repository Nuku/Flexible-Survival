...
to FifthVikingWarEvent:
	...
	if player consents:
		...
		say "     You take this as a cue to move forward and help support the Spartan-Helot up, making sure his wound is healing correctly. As you do this, you watch as Bjorn dashses forward and clashes weapons with his former fellow Vikings. At first it appears that he's at a disadvantage but you then notice him take a stance that's very familiar to you, one that you've seen the Spartans and Pericles take before. Right as he slides into this form he quickly has advantage over his enemies, disarming and incapacitating them with sheer utter force. When he manages to disarm and knock down the largest of the Vikings, he glares at them all. 'Surrender, now!' He growls, his attitude reminiscent of Pericles when he's in Spartan mode.";
		WaitLineBreak;
