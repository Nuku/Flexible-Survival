...
after going to Pericles' Room while War Declaration is active and War Declaration is not resolved and VikingWar - turns > 1 and PericlesRelationship is 6 and BjornRelationship is 3:
...
after going to Athletic Street while Assault On The Gym is active and Assault On The Gym is not resolved and VikingWar - turns > 0 and VikingSpartanWar is 1:
...
to SecondVikingWarEvent:
	if SatyrFratRichardRelationship is 4:
		...
		say "You roll 1d20([diceroll])[if bonus >= 0]+[end if][bonus] = [special-style-1][diceroll + bonus][roman type] vs [special-style-2]15[roman type] (Strength Check):[line break]";
...
after going to College Fountain while Raid On The Fountain is active and Raid On The Fountain is not resolved and VikingWar - turns > 0 and VikingSpartanWar is 2:
...
to ThirdVikingWarEvent:
	if HP of Sylvia is 4:
		...
		if diceroll + bonus >= 15:
			...
			if WarLossCounter < 3:
				increase WarLossCounter by 1;
			now Resolution of Raid On The Fountain is 3; [lost]
...
after going to College Belltower while Siege Of The Belltower is active and Siege Of The Belltower is not resolved and VikingWar - turns > 0 and VikingSpartanWar is 3:
...
after going to College Campus Entrance while Battle For Tenvale Campus is active and Battle For Tenvale Campus is not resolved and VikingWar - turns > 0 and VikingSpartanWar is 4:
...
to FifthVikingWarEvent:
	...
	say "[line break]     [bold type]Do you take the blow for Bjorn?[roman type][line break]";
...
after going to Tenvale College Library while Peace Between Communities is active and Peace Between Communities is not resolved and VikingWar - turns > 0 and VikingSpartanWar is 5:
	...
	while sextablerun is 0:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if Player consents:
				...
				if title entry is "Fuck the Viking's Mouth":
