...
Description of Palace Near The Sun is "     The inside of the palace of the Sun God Horus is rather tastefully decorated. From what you saw when you took a much closer look at the entranceway, it had various tapestries hung all over the place, but in a decently put manner. However, each of the pieces of textile had the image of a person on it. What was unique though, was that some looked human a few with features like Horus, a lot of them actually looked like some of the mutants that you saw on the streets below, leaving you to wonder who they were. The Throne Room was a lot less decorated in the sense of objects, instead hieroglyphics were carved all over the place along with murals. Despite this though, it didn't make it any less wondrous.[line break]".
...
Cunt Depth of Horus is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
instead of conversing the Horus:
	if HP of Horus < 1: [should be not yet available]
		...
		say "[line break]     What do you wish to talk about with the Sun God?";
...
to say HorusSexMenu:
	...
	else if lastfuck of Horus - turns < 3: [had sex 9 hours ago]
...
to say HorusSex1:
	...
	say "     However, after a few seconds of getting used to the size, it appears Horus can't wait any longer as he begins to bounce you upward, causing you to go off of his cock a bit before slamming back down, making you let out a long moan. The sun deity continues to do this, allowing his big dick to enter and re-enter you repeatedly, as well as causing his balls to slap loudly against your cheeks, the sounds loud enough that you're sure the retainers can hear even outside the room. On top of that, both of you are moaning loudly, your voices mixing with the slapping and the squelching of his cock entering your hole to create a symphony of sexual sounds.";
	WaitLineBreak;
...
Cunt Depth of Zerbo is 0. [Doesn't have a vagina to get stretched]
Cunt Tightness of Zerbo is 0. [Doesn't have a vagina to get stretched]
...
instead of navigating Pediatrics Lobby while HP of Horus is 5:
	...
	move player to Pediatrics Lobby, without printing a room description;
...
When Play begins:
	...
	now Species Name entry is "Mutant"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now body descriptor entry is "blobby";
...
When Play begins:
	Choose a blank row from Table of Random Critters;
	now NewTypeInfection entry is false;
	now Species Name entry is "Gnome"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now loot entry is ""; [ Loot monster drops, usually infective with the monster's _own_ strain (for example if there is a Cross-Infection from sex)]
	now lootchance entry is 0; [ Chance of loot dropping 0-100 ]
	now MilkItem entry is "gnome milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is ""; [ Item to be given to the player if they have this infection and jerk off. ]
	now TrophyFunction entry is "-"; [ Function to generate a list of optional loot items, of which the player can choose one after victory. ]
	now scale entry is 3; [ Number 1-5, approx size/height of infected PC body: 1=tiny, 3=avg, 5=huge ]
	now body descriptor entry is "humanoid";
