...
[Version 4.0 - Restructured the infection and mob so that they arent split idendities but rather an actual pack, changed the looks a tiny bit for the infection. Changed the name]
...
to say AnthroRabbDesc:
	...
	if bodyname of player is "Anthro Rabbit":
		...
		now combat abort is 1; [stops the fight]
		say "     A small humanoid bunny appears in front of you! Less than four foot nine and completely naked, it could pass as a short adult human if it weren't for the rabbit-like qualities it had. [one of]He[or]She[at random] looks almost worshipingly at you, admiring, from where they're staring, your tall stature. 'You[']re such a huge rabbit!' They say in complte awe, probably wondering how you could be your height. Seconds later however, more of the same rabbit come out of various hiding places, all crowding around you and adoring you just like the first one is. Some of them are even reverently touching your hands. The original however steps forward and stutters out a question. 'C-can we help big rabbit somehow?' They say in a way that makes you feel like they're trying to proposition you.";
