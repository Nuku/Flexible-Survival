...
Description of Wolverine Guard Station is "     The guard station is situated within a coffee shop. There are tiny little tables where big wolverines are sat at, working on paperwork their boss more than likely has assigned them. The shop counter has a wolverine sitting there with a lot more work than the others. Although judging by the fact that said male is also the receptionist, he surely must have more patience than the others. All in though, the place seems pretty homey and looks to be where the wolverines have also set up home as you can see a door with a sign that says sleeping quarters.[line break]".
...
Description of Wolverine Lockup is "     The place where they store their criminals seems to be located within a commandeered bank that they have connected to the station. You can tell this by the fact that on one side of the room is a massive vault door that is wide open, showing various security deposit boxes. However, the vault isn't where the suspects are stored, no, you see that they're held within the old cells that held money and other things in the bank. Overall, you think it's a pretty decent setup, and unlikely to fail unless the wolverines decide to hold someone much stronger than them and the bars.[line break]".

check going East from Mall West Wing while JennaRelationship is 3 and MurderMystery < 1:
	if debugactive is 1:
...
Dead Body is a man.
Description of Dead Body is "     The overall look of the dead body is rather gruesome. There are sharp cuts and gashes littering the body and from those spots, blood leaks from. Although because it has been some time since the body... has expired, it has tapered a weak trickle. You desperately wonder who could possibly have murdered this person during what is already a hectic time period.[line break]".
fuckscene of Dead Body is "     'It's a dead body and you're in public. What are you expecting?[line break]".
...
instead of conversing the Dead Body:
	if HP of Dead Body is 0: [should be not yet available]
		...
		say "[line break]     What about the body do you want to examine?";
...
Cunt Depth of Tawnya is 6. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Description of Tawnya is "     The lizard woman is wearing a waitress outfit, that covers up a lot compared to other outfits you've seen. You can't exactly tell what's under the dress and by the look on the lizard woman's face you'd rather not stare much longer. Other than her looks, Tawnya has set herself up in the corner of her cell, just standing there, irritated. When she sees you, you can tell that the woman's not exactly happy to see you.[line break]".
fuckscene of Tawnya is "     'Ahaha, no. You can try better than just asking me to fuck,' she says with a roll of her eyes.[line break]".
...
instead of conversing the Tawnya:
	if HP of Tawnya is 0: [should be not yet available]
		...
		say "[line break]     What do you wish to talk about with the lizard girl?";
		now sextablerun is 0;
		blank out the whole of table of fucking options;
		[]
...
to say TawnyaFurEvidence:
	if TawnyaFurSuspicion is 0: [never talked about it]
		...
		say "[line break]     [bold type]Believe her? She might not be pure lizard...[roman type][line break]";
		...
		say "[line break]     [bold type]Believe her? She might not be a pure lizard...[roman type][line break]";
		say "     ([link]Y[as]y[end link]) - Sure, she seems trustworthy.";
		say "     ([link]N[as]n[end link]) - Nope, it's time to strip!";
		if Player consents:
			LineBreak;
		...
		say "[line break]     [bold type]Get it on with her?[roman type][line break]";
	...
	else: [Says it can't be his fur cause it is black]
...
Cunt Depth of Cane is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
instead of conversing the Cane:
	if HP of Cane is 0: [should be not yet available]
		...
		say "[line break]     What do you wish to talk about with the dog?";
		now sextablerun is 0;
		blank out the whole of table of fucking options;
		[]
...
Cunt Depth of Barry is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Description of Barry is "     The bear is rather big, which is to be expected. But it looks like seventy-five percent of the weight on him is muscle while the other is fat. He has brown fur, brown eyes, and is wearing a simple black shirt with the words 'Doggy Bowl' on it and black jeans. Directing your attention to his face you can see he's a rather happy guy if the wide smile on his face says anything when he notices you looking at him. Overall he looks like someone you'd very much like to get to know.[line break]".
fuckscene of Barry is "     'Nice try! But if you wanna have a fuck with me then you gotta ask elsewhere,' Barry says with a boisterous laugh.[line break]".
...
instead of conversing the Barry:
	if HP of Barry is 0: [should be not yet available]
		...
		say "[line break]     What do you wish to talk about with the bear?";
		now sextablerun is 0;
		blank out the whole of table of fucking options;
		[]
		if BarryFurSuspicion < 2:
			choose a blank row in table of fucking options;
			now title entry is "Fur Suspicion";
			now sortorder entry is 1;
			now description entry is "Try to learn about him and the fur";
...
to say BarryFurEvidence:
	if BarryFurSuspicion is 0: [never talked about it]
		...
		say "[line break]     [bold type]Do you want to have sex with the big ol['] bear?[roman type][line break]";
