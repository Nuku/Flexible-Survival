...
to say ResolveEvent College Hopeful:
	if WallyQuestDenial is 0:
		...
		say "[line break]     [bold type]Do you wish to escort the otter?[roman type][line break]";
...
after going to College Administration Building while Otter Class Sign Up is not resolved and LastCampusWalkin - turns > 0 and HP of Wally is 2 and a random chance of 1 in 3 succeeds:
...
ScaleValue of Wally is 3. [human sized]
Body Weight of Wally is 3. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Wally is 2. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
[Body Adjective is generated out of the body weight and body definition and can be used in scenes - one word descriptive adjective depending on weight and definition groups: low weight group: skinny/slender/lithe; mid weight group: average/fit/muscled; high weight group: pudgy/husky/jacked]
Androginity of Wally is 3. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Wally is 6. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Wally is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Wally is 6. [length in inches]
Breast Size of Wally is 0. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Wally is 2. [count of nipples]
Asshole Depth of Wally is 10. [inches deep for anal fucking]
Asshole Tightness of Wally is 2. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Wally is 1. [number of cocks]
Cock Girth of Wally is 2. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Wally is 6. [Length in Inches]
Ball Count of Wally is 2. [allowed numbers: 1 (uniball), 2 or 4]
Ball Size of Wally is 2. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
Cunt Count of Wally is 0. [number of cunts]
Cunt Depth of Wally is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
Cunt Tightness of Wally is 0. [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
Clit Size of Wally is 0. [size 1-5, very small/small/average/large/very large]
...
instead of conversing the Wally:
	if HP of Wally < 3: [should be not yet available]
		...
		say "[line break]     What do you wish to talk to the otter about?";
