...
Cunt Depth of Gordon is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Description of Gordon is "     The monkey has pitch black fur and hazel eyes. Personally you think the black is really weird because you don't recall ever hearing about monkeys having that color of fur, at least completely covering their body. But after a while you guess that you've probably haven't seen every type of monkey. Besides the fur and his eyes, he's wearing what amounts to a chef outfit, minus the hat. You figure that's his uniform for the Doggy Bowl, which makes complete and total sense, since he's the head chef. The monkey winks at you suggestively when he notices that you're staring at him, which causes you to quickly look away.[line break]".
fuckscene of Gordon is "[GordonSexMenu]".
...
instead of conversing the Gordon:
	if HP of Gordon is 0: [should be not yet available]
		...
		say "[line break]     What do you wish to talk about with the monkey?";
		now sextablerun is 0;
		blank out the whole of table of fucking options;
		[]
		if GordonFurSuspicion < 2:
...
to say GordonFurEvidence:
	if GordonFurSuspicion is 0: [never talked about it]
		...
		say "[line break]     [bold type]Do you want to blow him or take him by his word?[roman type][line break]";
		say "     ([link]Y[as]y[end link]) - Yes, you have to know for sure.";
		say "     ([link]N[as]n[end link]) - No, you'll take him by his word.";
		if Player consents:
			LineBreak;
			say "     With a sigh you tell him that you'll do it. The monkey's face lights up with glee when you do. You turn and ask the guard to leave the two of you alone. The wolverine gives you a questioning look but shrugs his shoulders before leaving, probably now standing outside the door. Gordon quickly pushes his chair back so that his legs are open and not under the table. He quickly unbuttons his pants to show you that he goes commando, his dick out for the world to see, already hardening. You quickly move over to the monkey and kneel in front of his cock, taking a quick glance at it before bringing your mouth to the tip. Your tongue darts out and tastes the cockhead, the flavor something that strikes you as good. With that you start licking all over the cock, from the top to simply dragging it all over it, the musk driving you further and further into your task. It's not long before you decide to engulf the entirety of the cock with your mouth, diving right onto it.";
	...
	else: [Says it's not his due to it being brown]
...
to say GordonSexMenu:
	...
	[else if HP of Gordon is 2:
		...
		if Player is male: [only males and herms can get a blowjob]
			...
			[]
			choose a blank row in table of fucking options;
			now title entry is "Fuck the unrepentant monkey"; [only males and herms can fuck him]
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if Player consents:
					...
					if title entry is:
						...
						-- "Suck Gordon off":
							say "[SonnySex2]";
						-- "Fuck the unrepentant monkey":
							say "[GordonSex3]";
						-- "Take Gordon's shaft in your pussy":
							say "[GordonSex4]";
						-- "Take Gordon's shaft in your ass":
							say "[GordonSex5]";]
			else if calcnumber is 0:
				LineBreak;
				now sextablerun is 1;
