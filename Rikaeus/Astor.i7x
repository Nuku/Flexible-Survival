...
after going to Azure Dragon Culinary Tastes while Loyalty of Astor is 0:
	...
	WaitLineBreak;
	say "     'The food I sell here is pretty special. It'll help keep you strong, though only for a while,' he says, as he flips some burgers before turning his attention to some stirfry on another stove. You ask if there's anything special in it that makes it like that. 'Well, you could say my magic? But honestly, it's just mostly because of how I cook my stuff. It only lasts for a little bit because the body eventually filters the food out,' Astor says with a shrug of his shoulders as he plates the burger he was working on and rings a bell, causing a waitress nearby to grab it and serve it to a customer.";
	say "     You make an aaahing noise and ask him how long the effects last. 'Well, for about a day. As that's how long most food stays in your body anyways. You also can't mix effects of the food; it doesn't quite work like that,' the dragon says, shuffling the stirfry in the pan. You nod and say that you'll definitely have to try some when you can. 'Perfect! I'm always here as I sleep in between moments when there's not many people here, as I don't need much sleep. Also, as currency, I accept fish, two of them per meal,' Astor says, plating the food and ringing the bell again, causing another waitress to come and serve it. You nod and thank him for the information before letting him return to work.";
...
Description of Azure Dragon Culinary Tastes is "     The restaurant is amix with a plethora of wonderful foodsmells from herbs and spices to meats, vegetables and fruits. They blend together perfectly to create a mouthwatering scent that makes you want to step further in and take a seat and order away. The design of the place is fashioned after a diner, which is pretty modern for the ancient city but you believe it fits the owner of the place. The walls are plastered in posters of various famous chefs and has various trophies and medals mounted on the walls. Standing and cooking at the grills and stoves is the familiar face of the owner of the establishment, Astor, who when he sees you waves at you.[line break]".
...
instead of conversing the Astor:
	...
	say "[line break]     What do you want to talk with Astor about?";
...
to say BullsBurgerSale:
	if "Strength of the Bull" is listed in feats of player or "Dexterity of the Kitsune" is listed in feats of player or "Intelligence of the Monkey" is listed in feats of player:
		...
		if carried of tasty fish > 1:
			say "[line break]     [bold type]Aware that you are carrying enough fish, do you want to give it to him?[roman type][line break]";
...
Section 4 - Buff Timers

An everyturn rule:
	if "Strength of the Bull" is listed in feats of player and BullStrengthTimer - turns > 7:
		FeatLoss "Strength of the Bull";
		StatChange "Strength" by -10;
		StatChange "Stamina" by -10;
		say "     Your Bull's Burger has worn off! You might want to go back to Astor's Restauraunt for more food.";
	else if "Dexterity of the Kitsune" is listed in feats of player and KitsuneDexterityTimer - turns > 7:
		FeatLoss "Dexterity of the Kitsune";
		StatChange "Dexterity" by -10;
		StatChange "Charisma" by -10;
		say "     Your Kitsune Stirfry has worn off! You may want to go back to Astor's Restaurant to get some more food!";
	else if "Intelligence of the Monkey" is listed in feats of player and MonkeyIntelligenceTimer - turns > 7:
		FeatLoss "Intelligence of the Monkey";
		StatChange "Intelligence" by -10;
		StatChange "Perception" by -10;
