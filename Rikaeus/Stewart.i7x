...
instead of going south from Tenvale College Dorms while Stewart is not in Stewart's Room:
	...
	if Stewart is in The Clouds or Stewart is in Stewart's Room:
		...
		if player consents:
			...
			if diceroll + bonus >= 18:
				...
				change south exit of Tenvale College Dorms to Stewart's Room;
				change north exit of Stewart's Room to Tenvale College Dorms;
			else:
...
to say StewartSex3:
	...
	say "     When Stewart finally reaches it, he slams into you one last time loosing his load into your hole. You moan at the feeling of being filled with his sperm, enjoying it thoroughly. [if cocks of player > 0 and cunts of player < 1]The sensation sets you off, making you roar in pleasure as you spray your cum all over the two of you.[else if cunts of player > 0]The sensation sets you off, making you moan loudly in pleasure, causing you to spill your juices from your pussy.[end if] Both of you let out sighs of joy, slumping onto the bed. The harpy boy cuddles up to you, letting his dick slip out of your ass. The two of you remain like that for an hour or so before you figure you should get going. When you get up, he smiles at you and thanks you for the fun.";
	now lastfuck of Stewart is turns;
