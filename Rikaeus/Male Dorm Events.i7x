	...
	if randomnumber is:
		...
		-- 4:
			if JustinRelationship is 0:
				...
				say "[MaleDormSlut2]"; [Leads to a repeat of scene one with Justins name replaced in throughout the scene as well as a few sentences changed]
		-- 5:
...
to say CoupleDormFight:
	say "     'Why were you out with him late at night!?' You hear a male voice shout as you walk past an open door. Sneaking so that you aren[']t seen you peer on in and see two male dogs arguing with each other. 'I was just going out for drinks with him, you don[']t need to be so jealous.' the other says, looking somewhat betrayed. 'Then why did you return so late?' His boyfriend asks, suspicion lining his tone. 'Because, the frat boys ended up wrecking the on campus bar,' was the reply that came back. However soon after it was met with a rough kiss as the two shoved each other against a wall and began making out. From how everyone walking by is ignoring this you feel like you can safely believe that this is a common occurence, so you shrug your shoulders and continue on with your ourney.";
...
to say MaleDormSlut2:
	...
	say "     ([link]Y[as]y[end link]) - No, you[']d rather not at the moment.";
	if player consents:
		say "     You come upon a familiar sight. It is Justin, the dorm slut being fucked by the trio from before. Just like last he is currently being fucked by the bunny who is clearly enjoying it just like the other time. At the other end of him was the lizard who was happily fucking the cock hound[']s mouth, balls slapping against his chin. By now though, your... new friend appears to have noticed you but doesn[']t say anything agan, content to deepthroat the cock in his mouth. It didn[']t take long for the lapine to release his load, and instead of in his hole the male ends up spraying it all over the vulpine[']s back.";
		say "     Taking the bunny[']s place is the wolf, while the lizard is still content to take purchase in the Justin[']s mouth. 'Now remember don[']t knot with him, I really don[']t want to be here forever' The one at the front said. The canine rolled his eyes before slamming into the vulpine rather roughly. 'You don[']t need to mention that everytime, it was one time!' You turn your attention to the guy getting fucked and notice he[']s pretty into it, moaning and groaning loudly as they all fuck him, minus the lapine who is simply sitting on a chair, watching it all just like before.";
		WaitLineBreak;
