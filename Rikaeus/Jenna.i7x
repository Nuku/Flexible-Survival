...
Body Weight of Jenna is 5. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Jenna is 7. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
[Body Adjective is generated out of the body weight and body definition and can be used in scenes - one word descriptive adjective depending on weight and definition groups: low weight group: skinny/slender/lithe; mid weight group: average/fit/muscled; high weight group: pudgy/husky/jacked]
Androginity of Jenna is 8. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Jenna is 8. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Jenna is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Jenna is 8. [length in inches]
Breast Size of Jenna is 2. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Jenna is 2. [count of nipples]
Asshole Depth of Jenna is 8. [inches deep for anal fucking]
Asshole Tightness of Jenna is 2. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Jenna is 0. [number of cocks]
Cock Girth of Jenna is 0. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Jenna is 0. [Length in Inches]
Ball Count of Jenna is 0. [allowed numbers: 1 (uniball), 2 or 4]
Ball Size of Jenna is 0. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
Cunt Count of Jenna is 1. [number of cunts]
Cunt Depth of Jenna is 8. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
Cunt Tightness of Jenna is 2. [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
Clit Size of Jenna is 3. [size 1-5, very small/small/average/large/very large]
...
TwistedCapacity of Jenna is false. [Twisted Characters can take any penetration, no matter the size]
Sterile of Jenna is false. [steriles can't knock people up]
MainInfection of Jenna is "Wolverine Guard".
Description of Jenna is "     [if MurderMystery < 4 and Jenna is in Wolverine Guard Station]The female wolverine is wearing a Wolverine Security uniform like all the others. However, hers has the slight difference of big bold letters spelling 'Boss' onto it. Beyond that Jenna looks like a gruff looking person, though that may be due to the frustrated look on her face. To be honest, you can't blame the woman, as the murder has shaken you up as well. She sees you looking at her, which in turn causes Jenna to give you a hopeful look. That reminds you that you still need to solve that case[else if Jenna is in Wolverine Lockup]She is currently wearing her Wolverine Security uniform. The outfit is different than the guards at the cells as it has the word 'Boss' in bold letters on it. The female wolverine is glaring at the suspects in the cells, as if they have personally offended her. Though, they probably have in some way or another by being law breakers or something. However, when she sees you staring at her, Jenna gives you a smile and waves at you. Clearly you haven't pissed her off[else]Jenna is wearing a worn security uniform just like all her subordinates. Her outfit is slightly different from the others as proven by the giant letters that spell 'Boss'. The female wolverine has a soft look on her face, which makes her appear to be the most approachable of all the wolverines in the room. When she sees you, the woman smiles at you and waves at you, clearly happy to see you[end if].[line break]".
fuckscene of Jenna is "     'Get your mind out of the gutter, I don't have time for that,' Jenna says rather brusquely before getting back to work.[line break]".
...
instead of conversing the Jenna:
	if JennaRelationship < 4: [should be not yet available]
		...
		say "[line break]     What do you want to talk with Jenna about?";
		now sextablerun is 0;
		blank out the whole of table of fucking options;
		[]
		if HP of Jenna is 1: [Jenna is in the Station]
			if MurderMystery is 2 or MurderMystery is 3:
				choose a blank row in table of fucking options;
				now title entry is "Lockup";
				now sortorder entry is 1;
				now description entry is "Ask Jenna to take you to see the suspects";
		else if HP of Jenna is 2: [Jenna is in Lockup]
			choose a blank row in table of fucking options;
...
to say JennaTalk3: [Solve the Murder]
	...
	say "[line break]     [bold type]Who do you think is the murderer?[roman type][line break]";
...
after going north from Smith Haven Mall Lot South while LoganCommand is 0:
