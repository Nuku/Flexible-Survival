...
a postimport rule: [bugfixing rules for players that import savegames]
	if Lost Trident is resolved and Resolution of Lost Trident < 2:
...
to say ResolveEvent Lost Trident:
	...
	say "[line break]     [bold type]Maybe you should just toss the thing and continue that run you were trying to go for?[roman type][line break]";
...
Description of Atlantis City Entrance is "     The entrance to the underwater city is rather gorgeous, filled with golden and coral buildings. Behind you are the magical golden gates of the utopian city that create the amazing bubble that prevents the ocean waters from flooding the city. Standing at the entrance are a merman and a mermaid wearing fancy armor and holding spears. However, out of the two of them, only the merman looks approachable. The female appears to be too focused on her job to even notice you. To the [link]west[end link] you see a cobblestone path leading to the center of the city.[line break]".
...
Description of Atlantis City Market is "     Upon entering the market you are met with sounds of people talking and bartering. At a stall selling weapons you hear a Pirate Shark trying to reduce the price of the sword they're attempting to buy but to no avail. Over towards another one you see what you assume to be a mermaid couple wondering whether or not they should have fish for dinner. You're sure that at some point you can find something to buy here as well. To the east is the city center that you arrived from.[line break]".
...
Description of Atlantis City Residential is "     The living area of the city looks nice, just like the rest of the city. The houses are made out of various colors of coral and have a modern yet rustic look to them. Just like the other places in Atlantis there are people wandering around and some even just lounging out in front of their houses or apartment complexes. You're sure that you could meet some people who live here at a point in the future. To the north is the center of the city.[line break]".
...
Description of Royal Palace Entrance is "     The entrance to the royal palace of Atlantis is, in your opinion, the most beautiful thing in the world. It appears to be made of dark blue stone and sapphire gems. The gates to the north are guarded by a couple of mermaid and merman guards, though they appear to be unconcerned about you, as if they were allowing you to go ahead. To the south of the palace is the center of the city.[line break]".
...
Description of Royal Throne Room is "     The throne room of the entire palace is as opulent as the rest of the place, although at the back is a simple sapphire throne, as odd as that sounds. [if Poseidon is in Royal Throne Room]The friendly yet powerful god is sitting on said throne, overlooking the entire area. [end if]Behind it is a large golden trident that is hung on the wall Across the walls are various murals of ocean scenery. To your back is the hallway that leads to the outside, and just like the entrance is guarded by a couple guards[if Poseidon is not in Royal Throne Room and PoseidonRelationship is 2]. It appears that Poseidon is not here, perhaps he is in his room?[else].[end if][line break]".
...
Description of Royal Bed Chambers is "     The room around you seems a bit vague and indistinct, as if the forces that are shaping reality are still undecided what it shall look like.[line break]".
...
check going to Royal Palace Entrance while PoseidonRelationship is 2:
	...
	say "[line break]     [bold type]Do you want to accept the courtship?[roman type][line break]";
...
check going to Atlantis City Center while CenterVisits is 0 or LastAtlantisCenterWalkin - turns < 4:
	if CenterVisits is 0:
	...
	else: [Has been there in the past 12 hours]
...
check going to Atlantis City Market while MarketVisits is 0 or LastMarketWalkin - turns < 4:
	if MarketVisits is 0:
...
Description of Triton is "     Triton is a well built male wearing tight pants covered in a shell-like layer as well as a half-shirt armor piece made out of what looks to be coral. From the muscles you can tell that he probably works out every day, though to be honest swimming as much as the mermen and mermids do is probably enough exercise for one person. He has below shoulder-length hair that is a bright orange that stands out in a crowd. When he sees you looking at him, he smiles at you.[line break]".
fuckscene of Triton is "     The buff male raises a brow at you, not offended by your offer but rather intrigued. 'As much as I would love to, Alana here would murder me if I scampered off to have fun with you,' he says.[line break]".
...
instead of conversing the Triton:
	...
	say "[line break]     What do you wish to talk about with Triton?";
...
Description of Alana is "     The mermaid guard is rather built for the average woman. She has a well-defined six pack that shows from the small bit of stomach that you can see from her chest piece, and on top of that her arms are well muscled, proving that she probably exercises every day, which you guess is expected of someone guarding the gates to the city. Her dark red hair falls down to the small of her back, something that you'd suggest to her would be detrimental to fighting if you weren't sure it'd get you a punch in the face. Of course, she doesn't look to be a violent person to begin with, but it'd be best not to say to a warrior that their hair is a problem. When she sees you staring at her the woman looks at you intently, though an underlying interest lay in her dark brown eyes.[line break]".
fuckscene of Alana is "     The woman glares at you and behind her you can see Triton furiously shaking his head, practically telling you to stop that train of conversation. Perhaps it's best not to talk to her about this.[line break]".
...
instead of conversing the Alana:
	...
	say "[line break]     What do you wish to talk about with Alana?";
	now sextablerun is 0;
	blank out the whole of table of fucking options;
	[]
	choose a blank row in table of fucking options;
