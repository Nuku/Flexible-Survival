Version 4 of Demon Brute For FS by Leo X begins here. [Expansion & Rewriting by Wahn]
[Version 4 - capture a demon, demon pet (male, for now)]
[Todo: Female Brute pussy fingering+fucking, Gender-Switching, Endings]
...
to say DemonBrutePetDesc:
	...
	otherwise if DemonBruteStatus is 1:			
		say "     <Description of a herm demon brute>";
	otherwise if DemonBruteStatus is 2:			
		say "     <Description of a female demon brute>";
	otherwise:
...
to say DemonBruteSex7:    [fuck his ass]
	...
	otherwise if DemonBruteStatus is 2:		[female]
		...
		otherwise:		                            [back into the amulet]
			say "     Pulling out of him, his dark purple pucker immediately closing tight to seal your cum inside, you stand up and have a look at your captive demon. Phew - he really cums out a lot, even as a female, creating a large puddle of femcum. 'Did someone like being fucked after all?' you tease him, and the demon's face turns into an interesting shade of purple before he shakes his head and starts mumbling to himself about grinding up your bones. Sorting away the delightful fact that you made your little demon cum from being fucked, you put your thoughts back on other things - like surviving in this destroyed city - and tell the creature to resume guarding you.";		
	otherwise:
		say "ERROR-Demon Brute-[DemonBruteStatus]C: He isn't in one of the states he should be in! Please report how you got to this message.";
...
When Play begins:
	...
	now face entry is "very inhuman, with a pair of slits for nostrils, sharp teeth, and yellow eyes with red slitted pupils. The top of your head is crowned by three matching pairs of horns, corved and getting smaller front to back";[ Face description, format as the text "Your face is (your text)"] 
