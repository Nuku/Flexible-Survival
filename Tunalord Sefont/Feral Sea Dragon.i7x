...
to say dragon attack:
	...
	if bodyname of player is "feral sea dragon" or bodyname of player is "feral sea dragoness":
		...
		otherwise if scalevalue of player is greater than 3:
			...
			Say “You become limp except for you hind legs as you repeatedly take the draconic cock.  Your depths constrict on it as it feels as if it was, in some perverse way, made for you.  Time seems to stand still as juices run down your thighs, your blissful state coming to an end as he forcefully thrusts one last time and fires his cum deep inside you. In the ecstasy of his sole release he makes a deep throaty roar, and as such you mock a feminine-sounding song to punctuate his dominion over you.";
