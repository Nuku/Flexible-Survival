...
"Adds a Feral Sea Dragon to Flexible Survivals Wandering Monsters table"
...
to say fsdm attack:
	...
	otherwise:
			...
			otherwise:
				...
				if anallevel is not 1 and (a random chance of 1 in 4 succeeds or (anallevel is 3 and a random chance of 1 in 3 succeeds)) and (cunts of player is 0 or "More Anal" is listed in feats of player):
					...
					otherwise:
						...
						say ".  Regardless, your infection's influence can't help but compel gratification from the rough treatment of such a virile male[if hp of player < 1], In spite of your better judgement[end if].";
						...
						say "     Though you would rather he fuck you forever it's inevitable that he concludes with one final thrust, his hilted dick flooding your bowels until they're bloated with his seed[if cocks of player > 1], your own neglected, [cock size desc of player] members wasting their [cum load size of player] load impotently into the sand[otherwise if cocks of player > 0], your own neglected, [cock size desc of player] member wasting its [cum load size of player] load impotently into the sand[otherwise if cunts of player > 0], triggering your own climax in response[otherwise], struggling weakly as you lack the sexual outlet necessary to satisfy yourself[end if][if cunts of player > 0].  Both of you cry out in celebration of this dual orgasm. His a deep throaty roar. Yours a beautifully sounding song.[otherwise if cocks of player > 0].  Both of you cry out in celebration of this dual orgasm. His a deep throaty roar while you feign a feminine-sounding song, driven by your feral-tainted mind to reinforce his more masculine dominion over your lesser male form[otherwise].  In the ecstasy of his sole release he lets out a deep throaty roar, of which you can only abide in frustration and embarrassment[end if]. [mimpregchance][line break]";
						say "     Satisfied, he dismounts you. [if cunts of player > 0]Forcing[otherwise]Wrenching[end if] his cock free of your abused hole with [one of]a moist sucking[or]a wet popping[at random] sound.  Huffing a little, [if cunts of player > 0]he's kind enough to give you a soft, affectionate lick across your side before he dives back into the water's depths,[otherwise]he nips your ass playfully, amused by his little cock sleeve before he dives back into the water's depths,[end if] no doubt waiting for your return";
				otherwise:
					say "     He climbs on top of you, his bulky weight pinning you to the sandy floor.  He's shameless in prodding his proud dick against your snout, and by now your feral-tainted mind cannot resist submitting to this virile beast's needs.  You open your jaws, your thick tongue the only cushion when it's [if cunts of player > 0]firmly[otherwise]harshly[end if] thrusted into the confines of your quickly stuffed maw maw. Gently suckling it, ";
					...
					say " accommodate the sheer span of his masculine organ as he offers [if cunts of player > 0]little[otherwise]no[end if] restraint in burying it entirely within you.";
					say "     Muffled by the obvious obstruction, you can't help but make a soft, song-like sound as your infection drives you to revel in your feral and submissive circumstances, your mind filling with only the desire to please this powerful male. Your tongue caresses its beastial length, his motion picking up a feverish pace as you feel him [if cunts of player > 0]licking[otherwise]nipping[end if] you, compelled by his wanton [if cunts of player > 0]need[otherwise]aggression[end if], only to finally have him roar out, his throbbing cock pumping your with an immense gouts of his thick, heady cum. Pinned, you can't pull away, and your belly is subsequently stuffed with the entire load of his expansive release.";
					say "     He slowly gathers himself and pulls his rod from your maw, your submissive haze driving you to lick it clean. He seems a bit amused by your obedience, [if cunts of player > 0]and regards you with an affectionate nuzzle before he[otherwise]and once he's properly satisfied with making you his little sea dragon bitch he[end if] turns to dive back into the water";
		...
		otherwise:
			...
			otherwise:                            [full lead-in]
				say "     Slightly pinning yourself against the beach, you partially sink into the sand under the[if scalevalue of player < 4] massive[end if] beast's weight, though his underside is at least soft enough to not be a particular strain on you.  You feel his thick tongue begin to probe your more private regions, that sickeningly slick organ having no shame in embarrassing you as much as it can[if cunts of player > 1], illuminating its clearly perverse intent by prodding your vulnerable cunts, perhaps testing their willingness to accommodate its girth before[otherwise if cunts of player > 0], illuminating its clearly perverse intent by prodding your vulnerable cunt, perhaps testing its willingness to accommodate its girth before[otherwise if cocks of player > 0].  He gives brief attention to your [cock size desc of player] cock[smn], certainly enough to make you go right hard, though that doesn't appear to be his main intent. Curiosity sated,[otherwise].  His little exploration only leads him to find your asshole, to which he probes curiously, perhaps more surprised that such a strange, genitalia-devoid creature like yourself could even exist.  Curiosity sated,[end if] he pulls himself free, your exposed and saliva-[if scalevalue of player < 4]drenched[otherwise]sullied[end if] behind chilled by the ocean air.";
			if fsdfeedmemory >= 2 and lastfsdfeeding - turns >= 8 and (("Kinky" is listed in feats of player and a random chance of 1 in 4 succeeds) or (vorelevel is 1 and a random chance of 1 in 4 succeeds) or a random chance of 1 in 3 succeeds) and "Touched by Madness" is listed in feats of player:
				If twistfsdfeedmemory is false:
					...
					say "     Before you can even try to determine the cause of this, he begins to make a hoarse, hacking sound, a sound you've become all-too familiar with by now, though never by a male of this species. Suddenly, you're mouth is assailed by his lips, acrid breath compelling you to gasp for air, only for that now-gaping hole to be flooded with half-eaten fish.";
				...
				infect;
			otherwise if "Touched by Madness" is listed in feats of player and "MPreg" is listed in feats of player and (("Kinky" is listed in feats of player and a random chance of 1 in 3 succeeds) or a random chance of 1 in 4 succeeds) and scalevalue of player < 4 and inasituation is false:
				If MFSDUBM is false:
					...
					say "     Unable to contest this new, severely twisted desire, he begins to grind himself against the sand, his hole tightening against your frame as your lower torso soon follows, pulling you deeper into his slick depths. This overwhelming heat; this hungry, supple abyss, it [if cocks of player > 0 or cunts of player > 0]is more than enough to set you off, almost immediately, fate sealed when this is all that the dragon needs to reach his own climax[otherwise]torments you to no end, your fate soon sealed as the dragon reaches climax[end if], and though your fate may seem grim, you find yourself pulled to a destination alien even to this perverse domain before your vision fades. The dragon would no doubt recover and move on, even after soaking his underbelly with his own cum, the occupancy of his new captive not outwardly apparent to those who might see his large form...";
					now MFSDUBM is true;
				otherwise:
					say "     He pulls off of you, his demeanour shifting into something now all-too familiar. [if hp of player is 0 and player is not submissive]Your better judgement compels you to flee, but this only provokes him into pinning you once more; you will be subject to his perverse verdict regardless. In spite of this assertion, he offers what he doubtlessly now perceives as his twisted offspring plenty of affection, though his thick, fish-smelling tongue's endeavours are dual in nature, preparing you for what is to follow[otherwise]Overwhelmed by his inappropriately maternal pull, he need only turn sideways, exposing his hardening cock and eager hole to you, to compel you forward. Your tongue slathering this hole and cock base with affection as he reciprocates across your frame, now doubtlessly perceiving you as his twisted offspring, what better judgement you might of had deflected by the reality of your lack of choice[end if].";
					say "     Blatantly aroused as you are, his satisfaction is met, [if hp of player is 0 and player is not submissive]forcing himself down on you once more, and you are offered no choice but to accept his aquatic ring's embrace, smaller form quickly disappearing entirely under him[otherwise]compelling you to enter his hungering ring, though you might only comply with your head and torso before he slams himself upright once more, engulfing the remainder of you with ease[end if].";
					say "     The sound of his conflicted mess of song and roar from such tainted need muffled within these confines, his passage tightens against your wholly engulfed frame, pulling you deeper into his slick depths as he seeks reprieve. This overwhelming heat; this hungry, supple abyss, now all too well-known to you, it [if cocks of player > 0 or cunts of player > 0]is but a moment before it sets you off, fate sealed when this is all that the dragon needs to reach his own climax[otherwise]torments you to no end, your fate soon sealed as the dragon reaches climax[end if], pulling you into that familiar, final, and inevitable destination before your vision fades. The Dragon would no doubt recover and move on, even after soaking his underbelly with his own cum, the occupancy of his new captive not outwardly apparent to those who might see his large form, and doubtlessly happy that you are his...";
				attempttowait;
						...
						if (("Kinky" is listed in feats of player and a random chance of 3 in 8 succeeds) or a random chance of 1 in 5 succeeds):
							...
							If the player consents:
								...
								if bonus + dice is greater than target:
									...
									now FSDOPEN is 0;
								otherwise:
									say "     You try to make a run for it, but you stumble and fall onto the [if showlocale is true]sand[otherwise]ground[end if], and in seconds the dragoness is on top of you, ready to subject you to her desire.";
									increase FSDOPEN by 1; [This will deflect the opening submit/lose line]
									say "[fsdf attack]";
							otherwise:
								say "     You decide the best thing to do is just let her have her way with you, the eager dragoness soon pinning you against the [if showlocale is true]sand[otherwise]ground[end if], ready to subject you to her desire.";
						...
						if (("Kinky" is listed in feats of player and a random chance of 3 in 8 succeeds) or a random chance of 1 in 5 succeeds):
							...
							If player consents:
								...
								if bonus + dice is greater than target:
									...
									now FSDOPEN is 0;
								otherwise:
									say "     You try to make a run for it, but you stumble and fall onto the [if showlocale is true]sand[otherwise]ground[end if], and in seconds the sea dragon is on top of you, ready to subject you to his desire.";
									increase FSDOPEN by 1; [This will deflect the opening submit/lose line, check will need to be added for it]
									say "[fsdm attack]";
							otherwise:
								say "     You decide the best thing to do is just let him have his way with you, the eager sea dragon soon pinning you against the [if showlocale is true]sand[otherwise]ground[end if], ready to subject you to his desire.";
								if hp of player < 1, now hp of player is 1;
								increase FSDOPEN by 1; [This will deflect the opening submit/lose line, check will need to be added for it]
								say "[fsdm attack]";
						Otherwise:
				...
				Otherwise:
					...
					infect;
					now FSDOPEN is 0;
			otherwise if cunts of player > 0 and cunt length of player > 11:
				...
				say "     You twitch with every irreverent and jerking thrust, only teasing tests [if cunts of player > 1]for one of[otherwise]of[end if] your [cunt size desc of player] cunt's willingness to accommodate his flared head. Soon your feel him put on the pressure as he slowly squeezes the rigid organ past your entrance, the intense sensation of which grants you inevitable reprieve when you get past its spade-shaped tip.  The beast lets out an airy hiss in his own approval, but only lets you adapt to his girth briefly before he begins fucking you in earnest.";
				...
				say "     [if cocks of player > 0]You orgasm over and over again, sandy ground under you made sticky as your own, [cock size desc of player] cock[smn] make[smv] a repeated mess of things, driving you into a manic and blinding lust-frenzy[otherwise]You orgasm over and over again, driving you into a manic and blinding lust-frenzy[end if]. The powerful beast begins pressing harder against your beleaguered form as he draws closer to his own release, and if you had any working sense of self-preservation you'd worry over your well-being but by now all you can feel is his flesh, his heat envelop you more and more.";
				say "     You feel like you're going to pass out, the immense pleasure of this monster more than you can handle before he suddenly lets out a deafening roar[if scalevalue of player < 4].  Your belly bulges as your womb is almost immediately stuffed to its limits with the dragon's cum, each subsequent and torrential spurt squirting out from your stuffed hole[otherwise].  You begin to feel his massive load firing inside you, your belly slowly bulging further and further with each progressive throb[end if].  Slowly, as he regains himself, he crawls off of you, relinquishing you of his now-softened cock[if scalevalue of player < 4], most of his load gushing out of you as a result[end if].  Still in a lustful haze, you briefly attempt to lick yourself clean of his of his fluids before you collapse from exhaustion. When you come to the dragon's nowhere to be seen, no doubt satisfied with leaving you on this beach exposed and sore as you likely are now.[impregchance]";
			otherwise if anallevel is not 1 and (cunts of player is 0 or anallevel is 3) and (scalevalue of player > 3 or (scalevalue of player is 3 and "Twisted Capacity" is listed in feats of player )) and (a random chance of 1 in 3 succeeds or (anallevel is 3 and a random chance of 1 in 2 succeeds)): [standard anal]
				say "     Finally, and thankfully, you're relinquished of the monster's mass; however, before you can get up you're pinned by his massive bulk a second time, now completely on top of you. He's shifted his weight enough so not to crush you, but now he's in a much better position to impale you with his massive, throbbing dick.";
				say "     You twitch with every irreverent and jerking thrust, only teasing tests of your [bodytype of player] asshole's willingness to accommodate his flared head, [if scalevalue of player is 3]and when it's clear that -- in spite of your small size -- you will easily abide him[otherwise]before[end if] you feel him put on the pressure as he slowly squeezes the rigid organ past your tight ring, the intense sensation of which grants you inevitable reprieve when you get past that spade-shaped tip. The beast lets out an airy hiss in approval, but only lets you acclimate to his girth briefly before he begins fucking you in earnest.";
				say "     His assault quickly becomes relentless in its pace, intent on using you with little regard to your well being. Any protests you might offer up rapidly diminish as you feel his pre incrementally spurt within your depth, what pain and discomfort you might have had driven away in favour of an immense and overwhelming desire to continue to be reamed by this powerful dragon, and soon you are drowning in ecstasy with every forceful thrust.";
				say "     [if cocks of player > 0]You orgasm over and over again, sandy ground under you made sticky as your own, [cock size desc of player] cock[smn] make[smv] a mess of things, driving you into a manic and blinding lust-frenzy[otherwise if cunts of player > 0]You orgasm over and over again, driving you into a manic and blinding lust-frenzy[otherwise]You are driven into a manic and blinding lust-frenzy, exacerbated by the tormenting lack of any way to satiated it[end if].  The powerful beast begins pressing harder against your beleaguered form as he draws closer to his own release, and if you had any working sense of self-preservation you'd worry over your well-being but by now all you can feel is his flesh, his heat envelop you more and more.";
				say "     You feel like you're going to pass out, the immense pleasure of this monster more than you can handle before he suddenly lets out a deafening roar. You begin to feel his massive load firing inside you, your [if scalevalue of player is 3]already-bulging belly quicking expanding[otherwise]belly slowly bulging[end if] further and further with each progressive throb. Slowly, as he recovers, he crawls off of you, relinquishing you of his now-softened cock. Still in a lustful haze, you briefly attempt to lick yourself clean of his of his fluids before you collapse from exhaustion. When you come to the dragon's nowhere to be seen, no doubt satisfied with leaving you on this beach exposed and sore as you likely are now.[mimpregchance]";
			otherwise if "More Anal" is listed in feats of player and (a random chance of 1 in 4 succeeds or ("Kinky" is listed in feats of player and a random chance of 2 in 5 succeeds)): [rimjob]
				say "     Carefully, the beast shifts more of its weight over you.  [if hp of player < 1]Much in spite of what protests you can offer against him, he's simply too heavy for you to make any effort of pushing him off[otherwise]Satisfied with his grip on you, he seems more intent on abusing you rather than fucking you properly, an intent of which he obligingly informs you when you feel his tongue begin to force its way past your anal ring[end if].";
				say "     [if scalevalue of player < 4 and the player is not twistcapped]The slimy organ really puts the strain on you as it's too large to easily fit in that hole, but the beast is diligent if nothing else and in due time you feel it slowly worm its way in.  You're so diminutive relative to his own scale that your behind is easily eclipsed by his toothy maw, making you frightful that the beast may have half a mind to swallow you whole, though for now it only has the effect of coating your lower half in his saliva[otherwise]It's initial efforts are probing, curious as to how pliable your hole might be, before the slimy organ begins to worm its way into the depths of your bowels with little obstruction.  With a huff and a rumble the unengulfed portion of his long frequently buckles and bends prior to its brief re-immersion, the organ making a mess of your [bodytype of player] thighs and groin as he fucks you with his tongue[end if].";
			...
			otherwise:            [oral]
				...
				say "     [if scalevalue of player < 4]Your stomach fills with his hot cum almost immediately and his cock is forced free of your hold, absolutely drenching you in his salty and sticky fluids, not that you mind since, by now, you're driven by a mad lust and can only numbly try to lick the fluids clean from his massive form[otherwise]By now the rods engulfed fairly deep in your gullet, forcing you to let out a muffled moan as your stomach slowly bloats with his thick cum, so much so that your large form nearly displaces the beast from his position of having you pinned down, not that he really cares by now.  Eventually, the flow stops, but you're still driven mad with lust, and can only weakly lick his softening cock as it's pulled from you[end if].  Thankfully, he lets you off without any more trouble, and just leaves you exhausted and half-buried in the sand before he crawls back into the sea from whence he came.";
	if FSDOPEN is 0:
		now tempnum is 1;
		fsdbiasshift;
		now tempnum is 0;
...
to fsdbiasshift:
	if tempnum is 1: [Male]
		...
		otherwise if fsdbias is 3 or fsdbias is 2:
			now fsdbias is 1;
			if bodyname of player is "Feral Sea Dragon" or bodyname of player is "Feral Sea Dragoness":
...
[to fsdpostureshift:
	if tempnum2 is 1:
		...
		otherwise if fsdmposture is 2 or fsdmposture is 3:
			now fsdmposture is 1;
			if bodyname of player is "Feral Sea Dragon" or bodyname of player is "Feral Sea Dragoness":
				say "     [italic type]Your tainted mind echoes with your defeat, revelling in your submission to the beast[if player is dominant], even against your dominant inclinations[end if]. Surely this is a sign of your fate, should you succumb[roman type].";
	otherwise if tempnum2 is 2:
		if fsdmposture is 0:
...
to say FSDM_1: [Anal Pitching]
	...
	otherwise:
		say "     Taking a [if scalevalue of player < 4]considerable[otherwise]fair[end if] amount of work in forcing the beast to expose his undercarriage, he's a very stubborn creature, growling and hissing at you in weak protest";
	...
	if player consents:
		say "     Hand reaching down to fondle along the sea dragon's slick, muscled hide, pinched to subtle cleft, a digit lewdly hooks itself within it's confines, shoving its way into the supple flesh of his bowels. [if boundmod is 1]Groaning loudly, the beast obliges being subjected to this act, pressing against your touch and inviting[otherwise]Though the beast doesn't care for being subjected to this act, growling and writhing in endeavour to free himself of your touch, he does eventually calm down, allowing[end if] another digit to delve into its depths, followed by another...";
		say "     His hole easily obliges this intrusion, [if scalevalue of player < 4]even as you begin to[otherwise]and only begins to really show any resistance when you start to[end if] fist him. [if boundmod is 1]Eager to be abused so, the monster's overtaken[otherwise]As noncompliant as he might be, the monster can't help but be influenced[end if] by his own lust, bestial dick[if boundmod is 1] quickly[end if] growing out from under your limb's persistent pounding. Eventually satisfied, you pull your arm free and get to the task at hand.";
		now tempnum is 1;
	otherwise:
		now tempnum is 0;
	If cocks of player > 1 and cock length of player < 20:
		say "     You could probably force [if cocks of player > 2]two[otherwise]both[end if] of your dicks in there, shall you?";
		if player consents:
			now tempnum2 is 1;
		otherwise:
			now tempnum2 is 0;
	say "     Exposing your [cock size desc of player] dick[smn] to the open air, [if tempnum is 1]your prior bit of fun has already left you hard, quickly sinking[otherwise]it takes a little work to get you fully hard before slowly sinking[end if] [if tempnum2 is 1 and cocks of player > 2]the head of two of them[otherwise if tempnum2 is 1]the head of both of them[otherwise]its head[end if] into the monster's[if cock length of player > 18 or tempnum2 is 1] tight[end if] asshole";
	if boundmod is 1:
		if tempnum is 1:
			say ". [if cock length of player > 18 or tempnum2 is 1]Giving you no resistance, your earlier work seems to have made inching yourself in deeper a fair bit easier[otherwise]He gives you virtually no resistance, given your earlier work[end if], especially given his clear enjoyment from it.";
		otherwise:
			say ". [if cock length of player > 18 or tempnum2 is 1]Giving you only slight resistance; even though he wasn't prepared for it, he certainly wants it[otherwise]He gives you barely any resistance, clearly wanting it even if he hasn't received and preparation[end if].";
	otherwise:
		if tempnum is 1:
	...
	otherwise:
		say "[if tempnum is 0]his clear disinterest betrayed by his own dick, growing out and exposing itself to the open air under yours, bobbing wildly[otherwise]his own dripping dick bobbing wildly in the open air[end if]";
	say ". [if boundmod is 1]Now-submissive sea dragon's relegation to a mere fucktoy all he cares about[otherwise]Once-dominant sea dragon now relegated to a mere fucktoy[end if], he's quickly lost in a haze of lust under your[if scalevalue of player < 4] diminutive[end if] body's weight, [bodytype of player] form trembling with each[if scalevalue of player > 3] powerful[end if] thrust.";
	say "     As time passes, your grip along the thick girth of the beast tightens, drawing ever close to bliss. [if boundmod is 1]Monster twisting and pressing against you, he can't get enough of[otherwise]Tainted mind twisted to acclimate to this new relegation, the monster groans and writhes against[end if] your cock[if tempnum2 is 1]s[end if]. Shall you pull out at the last second?";
	if player consents:
		say "    Just at the cusp of ecstasy, you wrench your tool[if tempnum2 is 1]s[end if] free of the sea dragon's tight hole, grinding against his hide until you're set off, firing your [cum load size of player] against his underside, [if cock width of player > 19]utterly drenching it[otherwise]making an embarrassing mess of it[end if]. It doesn't seem to be enough to set him off, his unattended dick dribbling against the open air. Should you help him out?";
		if player consents:
			say "    Simple handjob? Else you'll suck him off.";
			if player consents:
				say "     Stained by your own seed, you grab his impressive, slick organ, rapidly pumping along its length. [if boundmod is 1]Groaning deeply, the needy[otherwise]Growling deeply, the[end if] sea dragon doesn't take long before your attendance gives him reprieve, quickly sputtering its virile load into the sand and further making an embarrassing mess of himself.";
			otherwise:
				say "     Moving in, your lips embracing along the tapered head of his impressive, slick organ, [if scalevalue of player < 4]your tongue caresses along the tip as your hands pump[otherwise]your head rapidly bobs against it, tongue caressing[end if] along its length.  [if boundmod is 1]Groaning deeply, the needy[otherwise]Growling deeply, the[end if] sea dragon doesn't need long before your affection sets him off, quickly sputtering its virile, overpowering load into your maw[if scalevalue of player < 4], quickly overtaking you and forcing what you cannot swallow to sputter from your lips[otherwise], eagerly swallowing it down[end if].";
			say "     Stepping away, satisfied, you wipe yourself clean against his slick hide and depart, [if boundmod is 1]contending with the cum-stained monster's insistence on your continued abuse before he finally drags[otherwise]leaving the spent and cum-stained monster to eventually drag[end if] himself back into the sea";
			if boundmod is 1:
		...
		otherwise:
			say "     Stepping away, satisfied, you wipe yourself clean against his slick hide and depart, [if boundmod is 1]contending with the cum-stained monster's insistence on your continued abuse before he finally drags[otherwise]leaving the spent and cum-stained monster to eventually drag[end if] himself back into the sea, its lust left unsated";
			if boundmod is 1:
				say ", and no doubt eager to be abused by you again, some day...";
			otherwise:
				say ". You'd imagine he'd be embarrassed by the whole ordeal, but you're not sure as to the long-term implications of such a dominant creature being abused in such a way...";
	otherwise:
		say "     In one final thrust, you [if cockname of player is listed in infections of knotlist]tie[otherwise]hilt[end if] your tool[if tempnum2 is 1]s[end if] within the sea dragon's tight hole, crying out as you're set off, unleashing your [cum load size of player] load into his supple bowels[if cock width of player > 19] and quickly beginning to sputter from him[end if]. This is more than enough to set the beast off, roaring out weakly as his unattended dick wastes its virile load across the sand and his underside, further making an embarrassing mess of himself.";
		say "     Wrenching yourself free, satisfied, you wipe yourself clean against his slick hide and depart, [if boundmod is 1]contending with the cum-stained monster's insistence on your continued abuse before he finally drags[otherwise]leaving the spent and cum-stained monster to eventually drag[end if] himself back into the sea";
		if boundmod is 1:
			say ", no doubt eager to be abused by you again, some day...";
		otherwise:
			say ". You'd imagine he'd be embarrassed by the whole ordeal, but you're not sure as to the long-term implications of such a dominant creature being abused in such a way...";
...
to say FSDM_2: [Oral Receiving Cock]
	...
	if player consents:
		now tempnum is 1;
		say "     Kneeling down to stroke along the seawater-slicked sides of the beast's muzzle, he [if boundmod is 1]presses softly against your touch[otherwise]seems fairly ambivalent towards this gesture[end if]. Your own head moving to caress his, the monsters breath against you is bitter with the odour of saltwater and fish. You could go further, shall you? Else you'll get back on track.";
		if player consents:
			now tempnum is 2;
			say "     [if boundmod is 1]Practically on cue, the dragon's lips part[otherwise]Digits curving along the dragon's lips, you're able to coax them sufficiently agape[end if] to allow your tongue access, taste soon awash in his now familiar scent. [if boundmod is not 1]Not immediately receptive towards this gesture, the beast's will eventually does buckle under his own lust, and shows that he's willing to[otherwise]Immediately receptive towards the gesture, the beast shudders under the weight of his rising lust, more than eager to[end if] reciprocate.";
			say "     His own slick, writhing appendage invading your maw, ";
			if boundmod is 1:
				say "[if scalevalue of player < 4]his size no doubt somewhat overwhelming, though he shows some restraint,[otherwise]you're able to keep up the eager beast with little issue as[end if]";
			otherwise:
				say "[if scalevalue of player < 4]its size easily overwhelms you, the beast no doubt revelling in his superior stance within this ritual as[otherwise]you're able to keep up the impressive beast with little issue,[end if]";
			say " your taste is overwhelmed by his overpowering saliva. Eventually, [if boundmod is 1 or scalevalue of player > 3]you find yourself satisfied with your bit of fun and you[otherwise]the foreplay becomes too much for you and you have to[end if] get back on track.";
	otherwise:
		now tempnum is 0;
	if boundmod is 1:
		say "     [if tempnum is 1]Eager to begin[otherwise if tempnum is 2]Eager and drooling to begin[otherwise]With little effort[end if]";
	otherwise:
		say "     [if tempnum is 1]Having warmed up to you slightly[otherwise if tempnum is 2]Having warmed up to you by a bit now[otherwise]With persistent chastising, along with the cock's persistent prodding against his snout[end if]";
	say ", he obliges your need, scaled lips parting to envelop [if cocks of player > 1]one of your tools[otherwise]your tool[end if] within its depths. Thick tongue slathering along its[if cock length of player > 11] substantive[end if] length, [if cock length of player > 19]the dragon's elongated neck easily handles your impressive organ[otherwise]the dragon shows no difficulty in handling your throbbing organ[end if]. The touch of his saliva[if tempnum is 2], along with that lingering in your maw,[end if] [one of]seeming to intensify[or]intensifying[stopping] your arousal, you can't help but thrust against his snout, the dragon [if boundmod is 1]rumbling in approval[otherwise]snorting in disdain[end if].";
	say "     Writhing against the beast's touch, [if boundmod is 1]happily[otherwise]slowly[end if] [if cock length of player > 14]bobbing along[otherwise]attending to[end if] your organ, you find it difficult to keep a clear head as you rapidly approach ecstasy. You don't think you'll be able to hold back for any longer, shall you pull out at the last second? Otherwise you'll reward the obedient little sea dragon.";
	if player consents:
		say "     Immediately, you wrench your dick free of his lips, strings of precum and saliva trailing from the creature's maw. A couple seconds of grinding against his snout, and you cry out, unleashing your [cum load size of player] against the beast's [if boundmod is 1]obliging and lust-hazed[otherwise]disgruntled[end if] visage. [if boundmod is 1]Whining softly, the beast idly licks at its face as he's[otherwise]Rumbling lowly in detest, the beast can't do anything but oblige being[end if] shamed like this.";
	otherwise:
...
to say FSDM_3: [Oral Receiving Cunt]
	...
	otherwise:
		say "     [if tempnum is 1]Having warmed up to you slightly[otherwise if tempnum is 2]Having warmed up to you by a bit now[otherwise]With persistent chastising, along with the cock's persistent prodding against his snout[end if]";
	say ", he obliges your need, scaled lips parting to envelop [if cocks of player > 1]one of your pussies[otherwise]your pussy[end if] within its embrace. Thick tongue slathering along its  supple entrance, [if cunt length of player > 17]he easily thrusts the slick, writhing organ into your pliable depths[otherwise]he thrusts the slick, writhing organ into your depths, quickly straining you with its impressive size[end if]. The touch of his saliva[if tempnum is 2], along with that lingering in your maw,[end if] [one of]seeming to intensify[or]intensifying[stopping] your arousal, you can't help but press against against his snout, the dragon [if boundmod is 1]rumbling in approval[otherwise]snorting in disdain[end if].";
	say "     Writhing against the beast's touch, [if boundmod is 1]happily[otherwise]slowly[end if] making you twitch and writhe with each motion of his worming appendage, you find it difficult to keep a clear head as you rapidly approach ecstasy";
	if cocks of player > 0:
		...
		if player consents:
			say "     Immediately, you wrench yourself free of his tongue, strings of saliva trailing from the creature's maw following the organ's loud departure. A couple seconds of grinding your throbbing, [cock size desc of player] cock[smn] against his snout and you finally cry out, unleashing your [cum load size of player] against the beast's [if boundmod is 1]obliging and lust-hazed[otherwise]disgruntled[end if] visage. [if boundmod is 1]Whining softly, the beast idly licks at its face as he's[otherwise]Rumbling lowly in detest, the beast can't do anything but oblige being[end if] shamed like this.";
		otherwise:
			say "     It's not long before you finally cry out in bliss, firing your [cum load size of player] load into the open air as your stuffed hole throbs against the creature's[if boundmod is 1] obliging[end if] tongue. [if boundmod is 1]Whining softly, he revels in tasting[otherwise]Rumbling in detest, he can only oblige being forced taste[end if] your juices. After a fair length of time lost in the throes of your lust, your need dies down, allowing you a moment to catch your breath.";
	otherwise:
...
to say FSDM_4: [Cunt Catching]
	...
	say " you as you [if scalevalue of player < 4]crawl[otherwise]climb[end if] on top of his now-exposed underbelly.";
	say "     Genital slit revealed under your prying gaze, you move a hand to caress along its length, the monster [if boundmod is 1]rumbling deeply in wanton need[otherwise]growling lowly in impotent regard[end if] for your touch. [if boundmod is 1]Grown acclimated to this abuse, he easily succumbs to his own, overwhelming lust, your attention immediately[otherwise]As much as he postures about his disdain for you, even he cannot resist his own, overriding lust, your attention[end if] rewarded with the spaded head of his bestial dick peeking from its home and eagerly inviting your touch. Shall your continued preparation be more affectionate? Else, you'll keep your distance.";
	if player consents:
		say "     Head [if scalevalue of player < 4]moving[otherwise]descending[end if] on his carnal offering, your tongue caresses along the length of the sea dragon's impressive, emergent organ. Airy hiss of [if boundmod2 is 1]eager approval from the beast, he easily obliges[otherwise]conflicted approval from the beast, he's hard-pressed to resist[end if] the influence of your continued attendance.";
		say "     As his cock grows to full attention, its full length proves [if scalevalue of player < 4]extremely intimidating, and probably impossible to take if not for your pliable assets[otherwise if scalevalue of player is 4]quite intimidating, though you imagine it won't be too difficult for you[otherwise]rather intimidating, though it's nothing someone of your size can't handle[end if]. It's length streamlined and easy to grip around its girth[if scalevalue of player < 4], even for someone of your size[end if], its head flares out distinctively, dribbling tip inviting you to taste the monster's heady precum.";
		say "     Eventually slick with a mixture of saliva and precum, you move onto the matter of mounting him";
		now tempnum is 1;
	otherwise:
		say "     Continuing to knead along the length the sea dragon's [if scalevalue of player < 4]extremely intimidating[otherwise if scalevalue of player is 4]intimidating[otherwise]impressive[end if], emergent organ, it's not long before your continued attendance brings him to full, drooling attention. Airy hiss escaping the beast's maw, he[if tempnum is 1] eagerly approves your continued[otherwise]'s clearly having a difficult time resisting your[end if] influence.";
		say "     Flared head's now-persistent drooling compelling you to slick his length with precum, he should be ready for you";
		now tempnum is 0;
	say ". [if scalevalue of player < 4]Crawling[otherwise]Moving[end if] over the sea dragon's throbbing rod, you carefully position yourself over its tip before you make your slow descent. Shall you pace yourself out? Else you'll put him through a rough ride.";
	if player consents:
		say "     Slowly forcing the dragon's pointed tip through the folds of[if cunts of player > 1] one of[end if] your cunt's lips, you're [if cunt length of player < 14]fairly[otherwise if cunt length of player < 18]briefly[otherwise]barely[end if] strained as you engulf the beast's flared head. Descent slicked by [if tempnum is 1]your prior attendance[otherwise]his sexual fluids[end if], the sea dragon groans and writhes as each successive inch in engulfed. Once you manage to take the head, the rest of his shaft seems comparatively easy to tackle, your speed slightly rising as you begin to ride the creature proper.";
		say "     [if cocks of player > 0]Dick[smn] waving against the open air, you move to jerk yourself off as[otherwise if cunts of player > 2]Fondling one of your unattended pussies,[otherwise if cunts of player is 2]Fondling your unattended pussy[otherwise]Fondling your stuffed pussy,[end if] your motion starts to pick up its pace, motion slicked by sweat as the beast's increasingly shallow breath intensifies your endeavour, each descent coaxing him free of his breath";
	otherwise:
		say "     Unceremoniously, you force yourself down on the dragon's point tip, squeezed through the folds of[if cunts of player > 1] one of[end if] your cunt's lips as it's quickly engulfed, [if cunt length of player < 14]fairly[otherwise if cunt length of player < 18]briefly[otherwise]barely[end if] strained by the beast's flared head. Descent thankfully slicked by [if tempnum is 1]your prior attendance[otherwise]his sexual fluids[end if], the sea dragon grunts and tenses as you rapidly engulf inch after inch of his flesh. Once you've impaled yourself with the head, the rest is much easier to take, plunging yourself down as you begin to ride the creature proper.";
		say "     [if cocks of player > 0]Dick[smn] quickly bobbing against the open air, you move to furiously jerk yourself off as[otherwise if cunts of player > 2]Unattended pussies aching against the open air, you move to furiously fondle yourself as[otherwise if cunts of player is 2]Unattended pussy aching against the open air, you move to furiously fondle yourself as[otherwise]Furiously fondling your stuffed pussy,[end if] your motion reaches a feverish pace, motion slicked by sweat as the beast's increasingly shallow breath seems to exacerbate your endeavour, each descent forcing his breath from him";
	...
	otherwise:
		now tempnum2 is 0;
		say "     Unable to hold back for any longer, the sea dragon finally roars out in bliss, body wrached with wave after successive wave of thick seeds from his sputtering dick, [if scalevalue of player < 4]blatantly bloating to abide it, until it begins to sputter from your stuffed hole[otherwise][bodytype of player] body visibly bloating to abide it[end if]";
		if cocks of player > 0:
			say ". Your own cock[smn] unleashing your [cum load size of player] load, you [if cock width of player > 19]utterly drench the beast[otherwise]stain the beast[end if] with your cum, who can only rumble and [if boundmod is 1]moan in approval, lost in a haze of[otherwise]groan in disdain, muffled under the throes of his[end if] tainted ecstasy.";
		otherwise:
			say ". Your stuffed cunt throbbing against the powerful intrusion, you stain the beast with your juices, who can only rumble and [if boundmod is 1]moan in approval, lost in a haze of[otherwise]groan in disdain, muffled under the throes of his[end if] tainted ecstasy.";
		say "[impregchance]";
...
to say FSDM_5: [Anal Catching]
	...
	if player consents:
		say "     Head [if scalevalue of player < 4]moving[otherwise]descending[end if] on his carnal offering, your tongue caresses along the length of the sea dragon's impressive, emergent organ. Airy hiss of [if boundmod2 is 1]eager approval from the beast, he easily obliges[otherwise]conflicted approval from the beast, he's hard-pressed to resist[end if] the influence of your continued attendance.";
		say "     As his cock grows to full attention, its full length proves [if scalevalue of player < 4]extremely intimidating, and probably impossible to take if not for your uncanny talent[otherwise if scalevalue of player is 4]quite intimidating, though you imagine it won't be too difficult for you[otherwise]rather intimidating, though it's nothing someone of your size can't handle[end if]. It's length streamlined and easy to grip around its girth[if scalevalue of player < 4], even for someone of your size[end if], its head flares out distinctively, dribbling tip inviting you to taste the monster's heady precum.";
		say "     Eventually slick with a mixture of saliva and precum, you move onto the matter of mounting him";
		now tempnum is 1;
	otherwise:
		say "     Continuing to knead along the length the sea dragon's [if scalevalue of player < 4]extremely intimidating[otherwise if scalevalue of player is 4]intimidating[otherwise]impressive[end if], emergent organ, it's not long before your continued attendance brings him to full, drooling attention. Airy hiss escaping the beast's maw, he[if tempnum is 1] eagerly approves your continued[otherwise]'s clearly having a difficult time resisting your[end if] influence.";
	...
	say ". [if scalevalue of player < 4]Crawling[otherwise]Moving[end if] over the sea dragon's throbbing rod, you carefully position yourself over its tip before you make your slow descent. Shall you pace yourself out? Else you'll put him through a rough ride.";
	if player consents:
		say "     Slowly forcing the dragon's pointed tip through your anal ring, you're [if scalevalue of player < 4]fairly[otherwise if scalevalue of player is 4]briefly[otherwise]barely[end if] strained as you engulf the beast's flared head. Descent slicked by [if tempnum is 1]your prior attendance[otherwise]his sexual fluids[end if], the sea dragon groans and writhes as each successive inch in engulfed. Once you manage to take the head, the rest of his shaft seems comparatively easy to tackle, your speed slightly rising as you begin to ride the creature proper.";
		say "     [if cocks of player > 0]Dick[smn] waving against the open air, you move to jerk yourself off as[otherwise if cunts of player > 0]Cunt[sfn] aching against the open air, you move to fondle yourself as[otherwise]Fondling your genderless form,[end if] your motion starts to pick up its pace, motion slicked by sweat as the beast's increasingly shallow breath intensifies your endeavour, each descent coaxing him free of his breath";
	otherwise:
		say "     Unceremoniously, you force yourself down on the dragon's point tip, squeezed through your anal ring as it's quickly engulfed, [if scalevalue of player < 4]fairly[otherwise if scalevalue of player is 4]briefly[otherwise]barely[end if] strained by the beast's flared head. Descent thankfully slicked by [if tempnum is 1]your prior attendance[otherwise]his sexual fluids[end if], the sea dragon grunts and tenses as you rapidly engulf inch after inch of his flesh. Once you've impaled yourself with the head, the rest is much easier to take, plunging yourself down as you begin to ride the creature proper.";
		say "     [if cocks of player > 0]Dick[smn] quickly bobbing against the open air, you move to furiously jerk yourself off as[otherwise if cunts of player > 0]Cunt[sfn] aching against the open air, you move to furiously fondle yourself as[otherwise]Furiously fondling your genderless form,[end if] your motion reaches a feverish pace, motion slicked by sweat as the beast's increasingly shallow breath seems to exacerbate your endeavour, each descent forcing his breath from him";
	say ". It's clear neither of you can hold back any longer. Shall you pull out at the last second?";
	if player consents:
		say "     Shall you shame the beast with his own release?";
		if player consents:
	...
	otherwise:
		...
		if cocks of player > 0:
			say ". Your own cock[smn] unleashing your [cum load size of player] load, you [if cock width of player > 19]utterly drench the beast[otherwise]stain the beast[end if] with your cum, who can only rumble and [if boundmod is 1]moan in approval, lost in a haze of[otherwise]groan in disdain, muffled under the throes of his[end if] tainted ecstasy.";
		otherwise if cunts of player > 0:
			say ". Your cunt[sfn] aching against the open air, you stain the beast with your juices, who can only rumble and [if boundmod is 1]moan in approval, lost in a haze of[otherwise]groan in disdain, muffled under the throes of his[end if] tainted ecstasy.";
		otherwise:
			say ". Without an outlet, you can only writhe and moan in insatiable need, forcing the dragon to rumble and [if boundmod is 1]moan in approval, lost in a haze of[otherwise]groan in disdain, muffled under the throes of his[end if] tainted ecstasy.";
		say "[mimpregchance]";
...
to say FSDM_6: [Oral Giving Cock]
	say "     Given his [if scalevalue of player < 4]sheer size and weight[otherwise]substantial weight[end if], it takes a bit of work to coax the sea dragon into rolling onto his side[if boundmod is 1], though he seems compliant enough to help you with that endeavour[end if]. Softer underside exposed to your touch, the [if boundmod is 1]creature whimpers submissively[otherwise]lowly growling creature shows little interest[end if] as you fondle around to find his bestial, male vent, [if boundmod is 1]driven by prior influence to oblige your touch, moaning as your digits penetrate his tight hole, easily coaxing[otherwise]though he's too exhausted to contend you as your digits penetrates his tight hole, succumbing to his tainted need as your fingering around is enough to coax[end if] his impressive dick from its housing.";
	say "     Gripping around and casually pumping along its growing length, the monster [if boundmod is 1]can't help but revel in being so shamefully exposed, throbbing organ quickly hard and dribbling pre, staining[otherwise]is clearly torn between discontent with being so shamefully exposed and his rising lust, throbbing organ soon oozing to stain[end if] his torso. Positioning yourself on top of him proper, you have the opportunity to lavish your tongue's affection on him, shall you? Else, you'll keep your distance.";
	if player consents:
		say "     Lowering yourself to the sea dragon's throbbing tool, your scent is flooded with a cocktail of saltwater and his masculine odour, inviting your tongue to caress along its length. Impressive organ [if scalevalue of player < 2]seemingly larger than you are[otherwise if scalevalue of player is 2]nearly as large as you are[otherwise if scalevalue of player is 3]seemingly much too large for you[otherwise]nothing you can't handle[end if], its body is fairly streamlined, punctuated by a distinctly flared, spade-shaped head, its owner letting out an airy hiss of pleasure as your slick, writhing appendage works its way up to the oozing tip.";
		now tempnum is 1;
	otherwise if anallevel is not 1:
		...
		if player consents:
			say "     Shifting a bit to allow a free hand access to the sea dragon's tailpipe, forcing a digit into its tight, supple depths. [if boundmod is not 1]Lowly growling[otherwise]Weakly whimpering[end if] as you assault him so, you show little restraint in forcing another, and another, until you're properly fisting the beast. Writh[if boundmod is 1]ing lustfully[otherwise]e though he may[end if] against your[if scalevalue of player > 3] substantial[end if] intrusion, his [if scalevalue of player < 4]very intimidatingly large[otherwise]impressive[end if] cock sputters pre with each plunge, strained by your persisting abuse.";
			now tempnum is 2;
		otherwise:
			now tempnum is 0;
	otherwise:
	...
	if boundmod is 1 and (cocks of player > 0 or cunts of player > 0):
		...
		if player consents:
			say "     Eagerly, the sea dragon's thick tongue [if cocks of player > 1]wraps around one of your dicks, throbbing[otherwise if cocks of player is 1]wraps around your dick, throbbing[otherwise if cunts of player > 1]caresses one of your cunts, aching[otherwise]caresses your cunt, aching[end if] needily against the slick, writhing organ's touch";
			now tempnum2 is 1;
		otherwise:
			say "     Swatting the sea dragon away, he's left to be the only one on the receiving end of any affection, [if cocks of player > 1]your own, unattended dicks throbbing against the open air[otherwise if cocks of player > 0]your own, unattended dick throbbing against the open air[otherwise if cunts of player > 1]your unattended cunts aching against the open air[otherwise if cunts of player > 0]your unattended cunt aching against the open air[end if]";
			now tempnum2 is 0;
	otherwise:
		say " [if cocks of player > 1]as your own, unattended dicks throb against the open air[otherwise if cocks of player > 0]as your own, unattended dick throbs against the open air[otherwise if cunts of player > 1]as your unattended cunts ache against the open air[otherwise if cunts of player > 0]as your unattended cunt aches against the open air[end if]";
		now tempnum2 is 0;
	say ". The dragon's breath becomes increasingly shallow, [if tempnum2 is 1]crotch awash in his hot breath[otherwise]body trembling[end if] with each powerful exhale, [if tempnum is 1]tool now slick with a mix of saliva and sex[otherwise if tempnum is 2]his stuffed hole aching against you[otherwise]his tool's sputtering becoming more substantial with each passing second[end if], indicating his imminent bliss";
	if tempnum is 1:
		say ". Shall you engulf the head within your mouth at the last second?";
		if player consents:
			now boundsegment is 1;
			say "    [if scalevalue of player > 3]Easily s[otherwise]S[end if]ubmerging the monster's drooling cockhead between your lips[if scalevalue of player < 4], no doubt strained to contain such a impressive tool[end if], it's more than enough";
		otherwise:
	...
	if boundmod is 1:
		if boundsegment is 1:
			say ". [if scalevalue of player < 4][one of]At first, you assume he might overtake you again, but instead his submissive influence seems to diminish and elongate his release, slowing the pace enough for you to keep up[or]Submissive influence diminishing and elongating his release, you're allowed to feast on every last drop of his heady seed[stopping][otherwise]Not that someone of your size needs it, but his submissive influence has diminished and elongated his release, prolonging your persistent milking of his heady seed[end if]";
		otherwise:
			say ". [if boundsegment is 2]Aiming the monster's impressive tool towards his face, he's hailed by a flood of his heady seed, revelling in being made an embarrassing mess of himself[otherwise]Monster's impressive tool throbbing with each gout of heady seed, it quickly makes a bit of a mess, wasted as its spent across the sand[end if]";
		if tempnum2 is 1:
			say ". The whole [if boundsegment is 1]ordeal[otherwise]sight[end if], combined with the sea dragon's own attendance, is more that enough to set you off, your [if cocks of player > 0]own, [cum load size of player] load flooding his maw as it encircles your tool[otherwise] cunt aching against his tongue's slathering affection[end if].";
		otherwise:
			say ".";
		say "     Once everything dies down, you pull yourself free of the monster, a spent and [if boundsegment is 2]shameful[otherwise]exhausted[end if] mess, too weakened and lost in a haze of lingering need to really do anything but lay there now. Satisfied with your work, you choose to leave here[if tempnum2 is 0], a fair bit lust-addled though you may be[end if].";
	otherwise:
		if boundsegment is 1:
			say ". [if scalevalue of player < 4]It's extremely difficult for you to keep up with the ensuing flood of heady seed, quickly sputtering from your maw[otherwise]You're briefly taken aback by the ensuing flood of heady seed, but it's nothing someone of your size can't handle[end if]";
		otherwise:
			say ". [if boundsegment is 2]Aiming the monster's impressive tool towards his face, he's hailed by a flood of his heady seed, quickly making an embarrassing mess of himself[otherwise]Monster's impressive tool throbbing with each gout of heady seed, it quickly makes a bit of a mess, wasted as its spent across the sand[end if]";
		say ". Once his flow dies down, you pull away from the sea dragon, a spent and [if boundsegment is 2]shameful[otherwise]exhausted[end if] mess, too weakened to really do anything but lay there now. Satisfied with your work, you choose to leave here, a fair bit lust-addled though you may be.";
...
to fsdmvore:
	...
	while trixieexit is 0:
		...
		if humanity of player < 1:
			...
			now trixieexit is 1;
			end the game saying "You became a Feral Sea Dragon's meal!";
		otherwise:
			let k be 0;
			...
			if keychar in lower case exactly matches the text "s" or keychar in lower case exactly matches the text "1" or keychar in lower case exactly matches the text "return" or keychar in lower case matches the text "struggle":
				...
				otherwise if boundsegment is 1:
					if struggleatt < 3:
						say "     [if tempnum2 is 2]Properly righting your orientation, y[otherwise]Y[end if]ou writhe and shimmy your way up the beast's gullet, against his muscle's endeavour. You [if struggleatt is 1]don't seem to be getting anywhere[otherwise]think you might be seeing light[end if]...";
				...
				otherwise:
					if struggleatt < 3 and struggleatt is not 0:
						say "     You continue to struggle and protest against these twisted confines, trying to upset the beast's stomach enough to free you. [if struggleatt is 1]You don't seem to make any headway[otherwise]He begins to groan as your prison rumbles[end if]....";
						increase lustatt by 7 + (lustadjust * 2);
						wyvhumanityroll;
						wait for any key;
					otherwise if struggleatt is not 0:
...
to say fsdstrugglebar:
	if boundsegment is 1:
		say "[if tempnum2 is 4][italic type]~--~ [roman type][end if]< [bracket]-[if struggleatt > 1][bold type]X[roman type][otherwise]-[end if][if struggleatt > 0][bold type]X[roman type][otherwise]-[end if][close bracket] [if boundmod > 1]}} [otherwise if boundmod > 0]} [end if][italic type][bracket]---[close bracket][roman type]";
	otherwise if boundsegment is 2:
		say "~-[if struggleatt > 0][bold type]X[roman type][otherwise]-[end if]~ [italic type][bracket]---[close bracket][roman type] [italic type][bracket]---[close bracket][roman type]";
	otherwise:
		say "[if boundmod2 is 0][italic type]~--~[roman type] < [italic type][bracket]---[close bracket][roman type] [end if][bracket]-[if struggleatt > 1][bold type]X[roman type][otherwise]-[end if][if struggleatt > 0][bold type]X[roman type][otherwise]-[end if][close bracket] [if boundmod2 is 1] > [italic type]~--~[roman type][end if]";
			...
			otherwise:
				...
				if fsdbias is 4 or fsdbias is 3:
					...
					if fsddom > 5:
						...
						otherwise:
							...
							otherwise if cunts of player > 0 and ublevel is not 1:
					...
					otherwise if player is submissive:
						...
						if cocks of player > 0:
							say "     You're made to breed with her often, happily obliging her need for offspring, [if guy is banned or guy is warded]and while often tempted to offer yourself to your female kin[otherwise]and though your more dominant male kin often try to take your place,[end if] it's by the dragoness's insistence that you remain her only mate.";
						otherwise:
					...
					otherwise:
						...
						otherwise:
							...
							if ublevel is not 1:
								say "the two of you soon learn a way around when a bout of fun with a trespasser leads to them getting stuffed up [if cunts of player is 0]your mate's cunt[otherwise]one of your cunts[end if], only to be born again as one of your kin. As time would pass, your children would spread to the far corners of the world, until all who fare the sea do so with an ever-present fear of your kin...";
							otherwise:
				...
				otherwise:
					...
					if fsdsub > 5:
						...
						if cocks of player > 0:
							say "[if girl is not banned and girl is not warded]bestial need requiring you to sate a desire for offspring by collecting some females just for you[otherwise]offering you barely a moment of free time[end if]";
						otherwise:
					...
					otherwise:
						if cocks of player > 0:
							...
							say "     Eventually, you're pulled back into the depths with him.  The craven beast keeps you in his home as his own personal fucktoy, [if girl is banned or girl is warded]ravaging you daily without relent until you look forward to his abuse, feeding you in half-eaten fish and his own, thick seed[otherwise]and though he must gather females to satisfy his need for offspring, he's never one to neglect you of his harsh affections.[run paragraph on] He refuses to share any of said females with you; not that you mind, however, as by now you've grown to love his abuse[end if]";
							  if "MPreg" is listed in feats of player:
