...
to say ResolveEvent Returned_Spots:
	...
	if player is male: [Stops after the brief intro if not male, otherwise lets you choose what to do next]
		...
		if Returned_Spots_Choice is:
			-- "Smile and nod your head. You'd love to get railed by this sexy cat!": [gay sex]
				...
				NPCSexAftermath Player receives "AssFuck" from Luke;
				now Resolution of Returned_Spots is 10; [player got fucked]
				now Returned_Spots is resolved;
			-- "Shake your head. You're not up for that right now.": [postpone]
				LineBreak;
			...
			-- "Shake your head and push him away. You have no interest in this guy, now or ever!": [refuse]
				LineBreak;
