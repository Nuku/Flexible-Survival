...
to say luke_intro:
	...
	if player is male:
		if Resolution of Returned_Spots is 1: [previously postponed]
			say "     'The feline lowers his guard and presses his face in close, inhaling your scent deeply. 'Oh! Its you again! Did you decide to take me up on my offer? I'll have to warn you though, I only know one way to give it, and that's rough! What do you think? Want to be my sexy little kitty for a bit?'";
