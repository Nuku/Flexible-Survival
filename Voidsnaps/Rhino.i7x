...
When Play begins:
	...
	now Species Name entry is "Rhino"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now body entry is "large and powerfully built, with broad shoulders and thick arms and legs. Your hands are big and meaty, good for smashing things. Your feet are large and flat to support your heavy gait"; [ Body description, format as "Your body is [Body of Player]." ]
