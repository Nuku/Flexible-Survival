...
to say ResolveEvent Pegged By A Pussycat:
	if Player is not CoA:
		...
		say "     ([link]Y[as]y[end link]) - You're curious. What business could the cat have with Mul?";
		...
		if Player consents:
			...
			NPCSexAftermath Mul receives "Stroking" from Sascha;
		else:
