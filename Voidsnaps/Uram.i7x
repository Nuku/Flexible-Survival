...
When Play begins:
	...
	now MilkItem entry is "orog man-milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
...
to say UramScent:
	say "     Uram smells like masculine musk with a hint of milky sweetness, due to the never-ending leakage from his bare chest.";
