...
[Hunger of Argos: Controls the event structure. Simulates growth.]
[Resolution of first event: Doesn't do anything besides provide an ability to nix the storyline.]
[Lastfuck of Argos controls when he's going to jump you. Don't let him go too long without release!]

an everyturn rule:
	if Argos is visible:
		if LastFuck of Argos - turns > 8:
			say "[ArgosDelayedGratification]";

a postimport rule:
	if Resolution of Grown Up is 1:
		connect Argos's Nest;
...
Argos is a man.
ScaleValue of Argos is 4. [Dire wolf sized]
Body Weight of Argos is 3. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Argos is 7. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
[Body Adjective is generated out of the body weight and body definition and can be used in scenes - one word descriptive adjective depending on weight and definition groups: low weight group: skinny/slender/lithe; mid weight group: average/fit/muscled; high weight group: pudgy/husky/jacked]
Androginity of Argos is 3. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Argos is 5. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Argos is 2. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Argos is 5. [length in inches]
Breast Size of Argos is 0. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Argos is 2. [count of nipples]
Asshole Depth of Argos is 9. [inches deep for anal fucking]
Asshole Tightness of Argos is 2. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Argos is 1. [number of cocks]
Cock Girth of Argos is 4. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Argos is 13. [length in inches]
Ball Count of Argos is 0. [allowed numbers: 1 (uniball), 2 or 4]
Ball Size of Argos is 0. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
Cunt Count of Argos is 0. [number of cunts]
Cunt Depth of Argos is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
Cunt Tightness of Argos is 0. [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
Clit Size of Argos is 0. [size 1-5, very small/small/average/large/very large]
[Basic Interaction states as of game start]
PlayerMet of Argos is false.
PlayerRomanced of Argos is false.
PlayerFriended of Argos is false.
PlayerControlled of Argos is false.
PlayerFucked of Argos is false.
OralVirgin of Argos is false.
Virgin of Argos is false.
AnalVirgin of Argos is false.
PenileVirgin of Argos is true.
...
to say EventConditions_Strange Birth:
	if HP of Doctor Matt is 15 and PewterPet is Resolved and Player is submissive: [list of conditions here]
...
to say EventConditions_Grown Up:
	if Resolution of Strange Birth is 1 and (hunger of Argos - turns > 6): [list of conditions here]
		now CurrentWalkinEvent_ConditionsMet is true;
...
to say ResolveEvent Grown Up:
	...
	if Player is female:
		...
		say "     Groaning aloud, you try to struggle, only to feel sharp claws settle on your lower back, stopping you from squirming away as that tongue vibrates inside you, accompanied by a dominant growl. It appears you'll do what Argos likes, whether you want to or not! Somehow, the idea turns you on, and you can't help the steady drip of your excited cock as his tongue loosens you up with heavy laps, his smooth muzzle grinding from side to side as he seeks all the sensitive spots, coating every inch of your insides with heavy drool.";
		WaitLineBreak;
		...
		say "     Groaning aloud, you try to struggle, only to feel sharp claws settle on your lower back, stopping you from squirming away as that tongue vibrates inside you, accompanied by a dominant growl. It appears you'll do what Argos likes, whether you want to or not! Somehow, the idea turns you on, and you can't help the roll of your hips as his tongue loosens you up with heavy laps, his smooth muzzle grinding from side to side as he seeks all the sensitive spots, coating every inch of your insides with heavy drool.";
		WaitLineBreak;
		...
		say "     Somehow, that revelation brings a blush to your cheeks. A creature that's only been alive for just over a day has claimed you, reducing you to a breeding mount for his passions, and you're enjoying every second of it. As he brutalizes your stretched inner walls with the swollen underside of his heavy cock, you realize with horror- you're about to cum! Again, as though reading your mind, Argos grunts, sheathing himself to the root and pushing his whole weight down on your back. Heat blooms deep within you, and your stomach swells with his spend, your poor innards bathed in thick, gooey heat with every pulse that threatens to overflow you. Those balls aren't for show!";
		WaitLineBreak;
...
to connect Argos's Nest:
	...
	change the northwest exit of Trevor Labs Lobby to Argos's Nest;

Table of GameRoomIDs (continued)
Object	Name
Argos's Nest	"Argos's Nest"

Argos's Nest is a room. It is fasttravel. It is private. It is sleepsafe.
Description of Argos's Nest is "[Argos's Nestdesc]".
the scent of Argos's Nest is "A harsh metallic scent, mixed with masculine musk and the unmistakable scent of a horny male, permeates the trashed room.".


to say Argos's Nestdesc:
	say "     Argos has shredded a blanket in a corner and lined it with half-chewed medical instruments and other metal items (most notably a few mangled dragon scales... You should probably apologize to Orthas.), and the center of it appears consistently damp, with an appearance that leaves little to the imagination. He's certainly a virile boy, isn't he?";
...
NPCObject of Personal Pewter is Argos.
understand "Argos" as Personal Pewter.
IDList of Personal Pewter is { "Argos", "argos", "Personal Pewter Pet", "personal pewter pet" }.
printed name of Personal Pewter is "Argos".
Description of Personal Pewter is "[ArgosDesc]".
Weapon Damage of Personal Pewter is 15.
The level of Personal Pewter is 1.
Dexterity of Personal Pewter is 5.
The summondesc of Personal Pewter is "[SummonArgos]".
The dismissdesc of Personal Pewter is "[DismissArgos]".
The assault of Personal Pewter is "[one of]Opening his jaws, Argos clamps down on your foe's leg, shaking his head and growling.[or]Argos bodychecks your foe, putting his weight to work and knocking them to the ground.[or]Argos whips his tail at your opponent, aiming for their face.[or]Argos claws at your opponent, scratching them with sharp talons![at random]".
the fuckscene of Personal Pewter is "[Argos_Pet_Fuck_Menu]".

to say SummonArgos:
	Project the Figure of Pewter_Consort_icon;
	if Argos is visible: [summoning while standing next to him]
		say "     Whistling for Argos, you smile as he trots to your side, his heavy cock and balls swaying between his legs as he looks up at you curiously. As though catching you staring, he huffs and lifts his leg as though demanding more than just a look, but relents when you promise you'll 'play' with him later, though you feel his nose pressing between your butt cheeks as you turn your back to him, as though he's reminding you who you belong to. Hopefully he behaves himself in public...";
	else: [regular summoning]
		say "     You catch yourself before you start calling for Argos. You doubt he can hear you from this far away, and even if he could, yelling his name is pretty unwise. Who knows what could hear you! [bold type] You should go to Argos's Nest if you want to bring him with you! [roman type]";

to say DismissArgos:
	move Argos to Argos's Nest;
	if Player is not in Grey Abbey Library: [regular dismiss]
		say "     With a huff, Argos looks at you with his smooth, eyeless dome as you attempt to dismiss him, then hops up on you and gives your cheek a long, wet lick, pressing against your front. It's painfully obvious that he's rubbing his half-hard cock all over your front as he shimmies in place, nearly humping you, marking you with his scent until he's satisfied. With something like a smirk, he nips at your ass and noses you, then heads out, no doubt returning to his nest now that he's sure everyone in the library will know you're his breeding bitch.";
	else: [dismissing Argos in the abbey]
		say "     With a huff, Argos flips his tail up at you as you attempt to dismiss him, showing off his masculine appendage as though to say 'Fine, but you'll have to make it up to me later!' Trotting off in the direction of Trevor Labs, he saunters away with a cocky, masculine gait, as though he thinks he's perfectly safe on the streets. You should probably visit him later to make it up to him...";

to say Argos_Pet_Fuck_Menu:
	Project the Figure of Pewter_Consort_icon;
...
[]
	...
	while sextablerun is 0:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			now sextablerun is 1;
			say "     Deciding against having sex with Argos, you pat his head, telling him you can do something together later when you're not so busy. Thankfully, he lets you get away with not fulfilling his needs, huffing and bounding off to explore somewhere close.";
			wait for any key;
		else:
...
to say ArgosDelayedGratification:
	if "Argos Slut" is not listed in traits of Argos:
		...
		if Player consents:
			...
			WaitLineBreak;
			say "     Thankfully for your screaming lungs, Argos finishes in due time, hilting himself to the root and blasting thick jets of seed that would put any breeding stud to shame. Each gut-busting cannon shot swells your stomach into a burgeoning dome. You're sure you'll drown before the last drop drains, but a wet slurp brings salvation as his rapidly softening cock leaves your mouth, allowing much-needed oxygen to feed your air-starved system. With black clouds around the edge of your vision, you swallow the sticky evidence of your submission, sucking in deep breaths of musk-tainted air and leaning against one silvery side for support. As if smirking at your disheveled state, Argos flashes his sharp teeth at you, his slippery tongue rolling along your cheek and then following your lower lip. His meaning is clear- Argos has claimed you, and he wants you to know it. Slightly ashamed and very turned on, you return the affection, patting his cheek as he cleans his mess with long licks. After a copious coating of pewter drool replaces the cum on your face, you grab a spare cloth from your pack, cleaning yourself up as best you can and preparing to move on.";
			...
			if fightoutcome >= 20 and fightoutcome <= 29: [Player lost]
				...
				say "     Scolding Argos as you stand over his worn out, panting, but still obviously horny body, you wait for him to regain his footing. Despite grumbling growls, he seems none the worse for the wear, and though he scents the air and 'stares' intently at you, he doesn't attempt to force himself on you again, though he does refuse to move, lifting his leg and slurping at his unattended cock with his long tongue. Sighing, you leave him to tend to himself, watching as he proves perfectly capable of sucking himself off and realizing that his attitude wasn't out of necessity but a sense of entitlement to your body. You doubt this'll be the last time he'll try this. Maybe next time, you should let him have his way. It'll save some time. Within a few minutes, Argos straightens up, licking his lips and shaking softly from side to side, returning to his usual curious self and bounding off to explore, most likely looking for some tasty silverware for an after-orgasm snack. At least there appear to be no hard feelings!";
				now LastFuck of Argos is turns;
			else: [Player ran.]
