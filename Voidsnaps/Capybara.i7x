...
to say CapybaraLoss:
	...
	if capybara_Fuck_Choice is:
		...
		-- "Ask him to eat you out.":
			...
			CreatureSexAftermath "Player" receives "OralPussy" from "Player";
			[]
