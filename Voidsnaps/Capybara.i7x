...
When Play begins:
	...
	now MilkItem entry is "capybara man-milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
...
to say CapybaraWin:
	...
	CreatureSexAftermath "Player" receives "AssFuck" from "Capybara";
...
to say CapybaraLoss:
	...
	if capybara_Fuck_Choice is:
		...
		-- "Ask him to eat you out.":
			...
			CreatureSexAftermath "Capybara" receives "OralPussy" from "Player";
			[]
