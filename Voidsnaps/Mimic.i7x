...
to say MimicTrapSprung:
	...
	if Player is female:
		...
		CreatureSexAftermath "Player" receives "AssDildoFuck" from "Mimic";
	else:
...
When Play begins:
	...
	now CumItem entry is "mimic cum"; [ Item to be given to the player if they have this infection and jerk off. ]
