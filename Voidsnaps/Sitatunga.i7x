...
When Play begins:
	...
	now MilkItem entry is "Sitatunga Man-milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
...
to say SitatungaBuckLoss:
	...
	if Sitatunga_Buck_Fuck_Choice is:
		...
		-- "Use his cock.":
			say "     Tossing the sitatunga backward on the muddy banks, you click your tongue, looking him over. The cock proudly sticking up from his crotch, bouncing in time with his heartbeat, provides an idea. You'll give him exactly what he wanted, on YOUR terms! Telling him it's his lucky day, you (move to straddle him, letting the pulsing underside of his cock trail along your pussy until the pointed tip kisses your clit./ shrug out of your pants, then pounce on him, mashing his cock against your increasingly slippery sex and pinning him.) The sitatunga buck seems to forget his situation when breeding is on the table, attempting to grab your ass. 'I knew you'd come around, baby. Let me just fuck some fawns into you, and you'll be ready-' With a confused bleat, the sitatunga looks up at you, staring down at the hand on his chest that shoved him back.";
...
to say SitatungaDoeLoss:
	...
	if Sitatunga_Doe_Fuck_Choice is:
		...
		-- "Walk away. She's not your type.":
			say "     Leaving the crying doe to her own devices, you tell her that you're not interested in her. You simply defeated her because she was attacking you. She seems almost disappointed when walk away, but doesn't try to follow you, and soon enough you return to the path, accompanied only by the ever-present cicadasong.";
