...
to say EventConditions_Fever Dreams:
	if Fever Dreams is not resolved and Eric is bunkered and lust of Rhidall > 0 and Player is not CoA and HP of Eric > 9 and HP of Eric < 16: [Eric must be a cuntboy for this to fire.]
		now CurrentWalkinEvent_ConditionsMet is true;
...
to say EventConditions_Night Sweats:
	if Night Sweats is not resolved and David is bunkered and lust of Rhidall > 1 and Player is not CoA and Thirst of David > 4: [list of conditions here]
		now CurrentWalkinEvent_ConditionsMet is true;
