...
When Play begins:
	...
	now area entry is "Swamp"; [ "Outside" "Mall" "Park" "Beach" etc... Check an existing creature in the area. ]
...
to say SweatyBearCunnilingus:
	...
	CreatureSexAftermath "Player" receives "OralPussy" from "Sweaty Bear";
...
to say losetoSweaty Bear:
	...
	if Player consents:
		...
		CreatureSexAftermath "Sweaty Bear" receives "OralCock" from "Player";
		CreatureSexAftermath "Sweaty Bear" receives "OralCock" from "Player";
	else:
