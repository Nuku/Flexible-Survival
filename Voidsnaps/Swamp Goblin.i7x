...
When Play begins:
	...
	now MilkItem entry is "Swamp Goblin man-milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	...
	if Player consents:
		...
		if Swamp_Goblin_Sex_Choice is:
			-- "Punish the thief with your cock.": [Ass fuck.]
				...
				CreatureSexAftermath "Swamp Goblin" receives "AssFuck" from "Player";
			...
			-- "Make him lick your pussy.": [Facesitting.]
				...
				CreatureSexAftermath "Swamp Goblin" receives "OralPussy" from "Player";
				WaitLineBreak;
...
to say Swamp GoblinWin:
	...
	if Cock Length of Player > 9: [OwO notices your bulge.]
		...
		CreatureSexAftermath "Player" receives "OralCock" from "Swamp Goblin";
		WaitLineBreak;
