...
to say Sun_Gator_TouchChoice:
	...
	if Sun_Gator_Choice is:
		-- "Rub the gator down with suntan lotion.":
			...
			NPCSexAftermath Suchos receives "Stroking" from Player;
...
Suchos is a man.
ScaleValue of Suchos is 3. [human sized]
...
PlayerFriended of Suchos is false.
PlayerControlled of Suchos is false.
PlayerFucked of Suchos is false.
OralVirgin of Suchos is false.
Virgin of Suchos is false.
AnalVirgin of Suchos is false.
PenileVirgin of Suchos is false.
SexuallyExperienced of Suchos is true.
TwistedCapacity of Suchos is false. [Twisted Characters can take any penetration, no matter the size]
Sterile of Suchos is false. [steriles can't knock people up]
MainInfection of Suchos is "Sewer Gator".
Description of Suchos is "[SuchosDesc]".
Conversation of Suchos is { "<This is nothing but a placeholder!>" }.
The scent of Suchos is "[SuchosScent]";
...
to say SuchosDesc:
	if debugactive is 1:
		say "DEBUG -> HP: [HP of Suchos] <- DEBUG[line break]";
	say "...";
