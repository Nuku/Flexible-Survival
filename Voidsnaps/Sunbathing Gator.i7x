...
to SunbathingGatorEvent:
	say "     As you trudge past the rocks, away from the bustling beach, you [if PlayerMet of Suchos is false] nearly trip over a thick green tail [else]stumble upon the sunbathing gator in the same place you left him[end if]. Scrambling backward on the sand, you search for its owner, settling on a chubby male gator lying in the sand. [if PlayerMet of Suchos is false]'My, my. What have we here? [else]Hullo there. Fancy meeting you again.' [end if] The crocodilian chuckles at your wary expression, scratching his smooth scales and stretching clawed toes. He's sitting with his legs spread, giving you an impressive view of a sweat-slickened cock and two heavy balls the size of goose eggs. 'Don't look so [if PlayerMet of Suchos is false]terrified[else] surprised[end if], [if player is male]boy[else if player is female]girl[else]kiddo[end if]. [if PlayerMet of Suchos is false]I'm not here ta hurtcha. I'm just catching some sun. [else]I'm here every day. Nothin' much to do these days. Not like I can flick on a TV.' [end if] [line break]";
