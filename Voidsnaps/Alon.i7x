	...
	if Alon is in Overflowing Grotto:
		...
		if OffSpringCount of Alon is 0 and impregtimer of Alon is 0:
			...
			if Player is male:
				...
				say "rolling his tongue along your clit to a curious rhythm that almost vibrates.";
			else:
				say "slurping between your cheeks and teasing your ass.";
			say "[AlonFuckMenu]";
	...
	if ImpregTimer of Alon > 0: [Alon is pregnant]
		...
		if ImpregTimer of Alon is 20 and skipturnblocker is 0: [announcement that birthing time is coming closer]
			...
			if Alon is not visible: [player isn't anywhere near him]
				...
				if Player is male:
					LineBreak;
					say "     Admiring that freshly stretched hole and the exausted dragon's inability to move after his ordeal, you have an idea- [bold type]maybe Alon could use a drink?[roman type][line break]";
