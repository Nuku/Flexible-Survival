...
When Play begins:
	...
	now attack entry is "[one of]Thecoyote attacks you in some abstract manner![or]The coyote leaves you greater understanding, thereby lowering your resistance to it![or]The coyote batters you with examples![or]The coyote firmly makes its point![at random]";	[Text used when the monster succeeds on an attack]
	now defeated entry is "[beatthecoyote]";
	now victory entry is "[losetocoyote]";
	now desc entry is "[coyotedesc]";
	now face entry is "a tan furred canine muzzle full of sharp teeth, your golden eyes survey your surroundings taking in everything around you, your coyote ears twitch as if listening for something. You lips curl back in a wicked grin as you think about all the mischief you will cause";		[ Face Description, format as the text "Your face is (your text)." ]
	now body entry is "well toned, with digigrade legs that end in padded coyote paws, your hands a cross between a human's and a coyote's padded paws. You body shows off your features for all the world to see";	[ Body Description, format as the text "Your body is (your text)." ]
	...
	now tail entry is "You have a bushy tail that sways happily as you move.";	[ Tail desc., written as a full sentence or left blank for none. ] 
	now cock entry is "[one of]canine[or]coyote[or]jcoyote-like[or]knotted[at random]";						[ Cock desc., format as "You have a 'size' (your text) cock." ]
	now face change entry is "as your mouth stretches and pushes forward in a massive yawning motion, the muscles reforming as it pushes out into a sleek tan muzzle, while your eyes blur as they shift in both colour and position, new sounds and smells explode through your enhanced senses as your new coyote muzzle finishes forming and your ears finish shifting into proper canine ears, swiveling around on top of your head like a coyotes's";	[ Face TF text, format as "Your face feels funny as (your text)." ]
	now body change entry is "your shape changes and seems to grow slightly more tones, the muscles moving around under the skin as it becomes sleeker. You can feel your legs shift and change as well, causing you to stumble forward slightly as your heels seem to shift upwards on your legs, shifting your weight forward onto the balls of your changing feet as they shift into a more powerful stance. Soon your feet finish changing and you find yourself balancing easily on your new coyote like paws, as you stand on your new digigrade coyote legs, and flex your new coyote-like hands";	[ Body TF text, format as "Your body feels funny as (your text)." ]
	now skin change entry is "a soft tingling sensation spreads across your skin as soft, sleek, tan coyote fur begins to push its way out of your body, swiftly covering your body in a sexy coat of thick tan fur";	[ Skin TF text, format as "Your skin feels funny as (your text)." ]
	now ass change entry is "a strange tingling sensation seems to come from your rear, as it tightens somewhat, then you can feel a strong pulling sensation as a bushy tan canine tail pushes out from your rear, lengthening until it is down past your knees before your new appendage is finished growing";	[ Ass/Tail TF text, format as "Your ass feels funny as (your text)." ]
	...
	now body descriptor entry is "wiry";	[ Ex: "plump" "fat" "muscled" "strong" "slimy" "gelatinous" "slender"   Use [one of] to vary ]
