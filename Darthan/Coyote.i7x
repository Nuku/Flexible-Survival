...
When Play begins:
	...
	now body entry is "thin and lanky, with digigrade legs that end in padded coyote paws, your hands a cross between a human's and a coyote's padded paws. Your bony body's appear belies its actual strength and agility";	[ Body Description, format as the text "Your body is (your text)." ]
