...
to say losetoHermaid:
	say "     [if HP of Player > 0]Putting up your hands in a sign of surrender, the herm croons joyously at your clear submission. Swimming tantalizingly towards you, you soon find yourself wrapped up in the pretty herm's arms, and you can feel lust building in your body. You find yourself tentatively looking forward to what the herm has in store for you[else]Your attacker lures you into throwing a hit, but quickly counters and lands a punch across your head, sending your head spinning and stopping you from thinking for a few moments. As you recover yourself, you find that the beautiful creature has you wrapped in her arms, stopping you from escaping[end if].";
	if Player is herm:
...
to say beattheHermaid:
	...
	if a random number between 40 and 120 < Libido of Player:
		...
		if Player consents:
			...
			WaitLineBreak;
			if Player is herm:
				say "You can use either your [link]cock (Y)[as]y[end link] or [link]cunt (N)[as]n[end link] for this scene. Which one do you want to use?";
				if Player consents:
					LineBreak;
					say "[HermaidMaleVic]";
				else:
...
When Play begins:
	...
	add "Hermaid" to infections of InternalBallsList;
	...
	now CumItem entry is "hermaid cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
This is the Hermaid Infection rule:
	if Player has a body of "Hermaid":
		...
		say "     [if humanity of Player < 10]Unable and unwilling to resist the call you hear, you soon find yourself on the shores of the Warehouse District, where you first met your Hermaid companions. The sounds and scents of the water is music to your ears; the lapping waves, the caws of the sea birds, the smell of salt water that permeates the air. The call of the sea is even stronger here, and you know that it is time to answer that call. Wading into the water, your legs finally merge into one long tail as you begin swimming out to sea, never again to step foot on land. Your new sisters come to meet you, taking you deep into the depths of the sea, to your new life[else]Soon enough, the military rolls through in an attempt to contain the situation that has arisen. You present yourself to the military patrols, and after a few tense moments with guns pointed in your direction, you eventually convince the soldiers that you are not feral, and are led through quarantine. You pass through quarantine after multitudes of tests, and emerge back into sane society. Quickly putting your picturesque body to use, you find yourself a job as a professional model, and you soon become the newest craze, with people across the world lining up to see you, and millions of people wanting to be you. You live out the remainder of your long live in luxury, happy as you could be[end if].";
...
hermaid kelp is infectious. Strain of hermaid kelp is "Hermaid".
Usedesc of hermaid kelp is "     You run the moist piece of plant through your hands for a few moments, noting the leafy feel and grainy texture. Giving it only a moments thought, you roll up the leaf and pop it into your mouth. Chewing on the leaf, you find that it tastes remarkably like lettuce, but with a slightly salty taste.[line break]".
