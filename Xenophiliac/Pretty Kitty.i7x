...
instead of using the girl's jacket:
	say "[if scalevalue of player > 2]Aside from being too small for you, you[otherwise]You[end if] don't want to risk it getting damaged before giving it to Gobby.  You instead stow it away safely.";
