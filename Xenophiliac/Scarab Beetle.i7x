...
"Scarab Beetle"	"[PrepCombat_Scarab Beetle]"

to say PrepCombat_Scarab Beetle:
	setmongender 3;]
...
When Play begins:
	...
	now face entry is "an almost-exact replica of a Scarab Beetle. The lower half of your head is occupied entirely by your mouthparts; small appendages surround your actual mouth, which is also flanked by a set of thick, jagged mandibles, capable of slicing through flesh and bone. A set of fluffy antennae protrude from your head, twitching wildly as you absorb all the smells and senses around you. Your eyes lie near the upper part of your head, off to the sides. Unlike human eyes, they're now compound insect eyes, entirely pitch black";
	...
	now body change entry is "all of a sudden, your figure begins to reshape itself, bones and tissue changing and elongating as time goes by. Your arms and legs slim down and extend, reshaping into five individual segments, insectoid in nature. Your feet quickly change into an insectile foot, the bottom of it covered in tiny, sensitive hairs and the entire thing terminating in a large set of spiky claws. Soon to follow are your hands, which change in almost the exact same way as your legs, the palm of your hands now covered in tiny hairs, while your fingers have merged into three large digits, ending in a bug-like claw.[line break]Soon after your limbs change, your body follows suit. Your back cracks and extends out quickly; you feel a thick set of protective coverings form from your shoulders, growing down to cover your new, translucent beetle wings. Small nubs form below your arms; these soon grow out into a smaller, but nonetheless deadly, pair of arms. Finally, your body ceases changing, leaving you with the form of a beetle";
	now skin change entry is "it writhes and seethes strangely, ripples coursing through your rapidly changing flesh. It seems to be reshaping into large sections, divided by small indentations into your skin. Soon, it stops moving, but rapidly begins to harden, thickening into a hard carapace. Soon enough, your skin resembles that of an insect; a scarab beetle, to be exact";
	now ass change entry is "odd popping and shifting happens internally"; [?]
	now cock change entry is "it begins to change and writhe wildly, strange feelings accompanying the changes. Your shaft begins to shift into segments; soon enough, five individual segments now make up your cock, covered in a hard chitin. Dull ridges along these segments conclude at your cockhead, sure to provide even more pleasure to any potential mates";
	now str entry is 20;
	now dex entry is 16;
	now sta entry is 20;
	now per entry is 16;
