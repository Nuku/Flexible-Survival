...
Scent of PALOMINO Dance Club is "     The infected dance club smells strongly of aroused males, sweat and sex. Lots of sex.".
...
"Palomino Stallion"	"[PrepCombat_Palomino Stallion]"

to say PrepCombat_Palomino Stallion:
	setmongender 3;]
...
When Play begins:
	...
	add "Palomino Stallion" to infections of NatureList;
	add "Palomino Stallion" to infections of MaleList;
	add "Palomino Stallion" to infections of BluntCockList;
	add "Palomino Stallion" to infections of SheathedCockList;
	add "Palomino Stallion" to infections of BipedalList;
	add "Palomino Stallion" to infections of TailList;
	...
	now MilkItem entry is "palomino stallion milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "palomino stallion cum"; [ Item to be given to the player if they have this infection and jerk off. ]
