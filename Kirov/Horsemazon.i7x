...
When Play begins:
	...
	now cock entry is "[if looknow is true]shaft, surrounded in a tight sheath surrounded by [Skin of Player] skin, protecting the wonderfully sensitive equine";
	...
	now MilkItem entry is "horsemazon milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "horsemazon cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
Scent of horsemazon fur is "The fur has a pleasing, not too strong, animal-like scent, with a hint of grass.".
...
When Play begins:
	...
	now heat start entry is "[horsemazonheatstart]"; [Events that trigger at the start of the Heat, in the female-GSD case it increases the cunt tightness]
	now heat end entry is "[horsemazonheatend]"; [Events that trigger at the end of the Heat, in the female-GSD case it reduces cunt tightness]
