...
The fuckscene of Katherine is "[KatherineSexMenu]".
icon of Katherine is Figure of Katherine_icon.
...
to say KatherineSelf:
	if HP of Katherine < 2:
		...
		if Player consents:		[ Player accepts to continue quest ]
			...
			else if fightoutcome is 30:	[ flee from wyvern ]
...
to say KatherineSexMenu:
	...
	if lastfuck of Katherine - turns < 4:
		...
		say "     Katherine smiles as you approach, [if HP of Katherine is 10 or (HP of Katherine < 10 and a random chance of 1 in 5 succeeds)]recognizing the familiar twinkle in your eye. Your bitch knows you well. Before you can even say anything, she drops down onto all fours and slowly crawls over to you. She paws at your clothes, eager to play with you. 'Does my Alpha want to have some fun with their bitch?' She wags her tail as you stare down at her, deciding how you want to take her. [bold type]What would you like to do[else if HP of Katherine > 49]but there's a look in her eyes quite different from when you first met her, as if her mind is elsewhere. But, like the obedient bitch you've trained her to be, she stays perfectly still, waiting for you approach first. You grin, satisfied with her new attitude. She eagerly awaits your next command. [bold type]What would you like to do[else]recognizing the familiar twinkle in your eye. She saunters over into your personal space, swaying her hips seductively and grabbing you by the waist. 'So,' she whispers in a husky tone. A shudder shoots up your spine in excitement. 'Did you want to have a little fun?' The dog has quickly taken control of the situation, but she's at least giving you the option of how you'd like to pass the time. [bold type]What would you like to do with her[end if]?[roman type][line break]";
		now sextablerun is 0;
		blank out the whole of table of fucking options;
		[]
		if Player is male:
