Version 1 of Valkyrie by Qazarar begins here.
...
to say ValkyrieLoss:
	if inasituation is true: [special event]
		...
		[else if ((ValkyrieScore < 5) or (a random chance of 1 in 3 succeeds)): [player gives oral]
			...
			say "     That premonition very quickly starts to come true, as you can feel something exceptionally large and heavy coming to a rest on top of your cushioned rear, sizable enough that even your wide cheeks don't engulf it. 'You've become quite the catch, and now that you're almost perfect I'll show you what you're really meant for.' The voice of the stallion behind you rings out with a seemingly unquestionable authority, demanding you submit to his will. For a moment you almost falter, but instead you manage to resist and attempt to struggle against your bindings, though that you soon discover how futile your attempts at escaping are. Even as you still struggle, the log sized endowment pulls backwards until the massive flared head rests against your passage, simply awaiting the moment he decides to force you wide open.";
			WaitLineBreak;
			say "     The brief moment of silence is proven to be the calm before the storm as the demonic horse behind you thrusts forward. With an endowment so large you would expect at the very least some discomfort, but perhaps because of his corrupted nature the feeling of your ass being spread open for his cock is nothing but pleasurable. Regardless of your resistance, the flared head starts to drive further inward, easily bypassing your defenses. You let out an involuntary moan at the sensations starting to emanate outwards from your rear, only to hear it echoed back. When you look to your right, you can just barely see that the valkyrie has come down to get a better view of the action, and is furiously pleasuring herself at the sight of you being impaled on the massive horsecock.";
			say "     When the stallion starts to move again, determined to get his satisfaction out of you, any thoughts of what the valkyrie is doing are driven from your mind by the force of the thrusts. Instead, the only thing filling your mind is the same thing filling your entire body—his cock. Even as you struggle to hold on to your resentment and anger at losing to this smug pair, the pleasure suffusing you distracts you from your former rage. Each motion he makes seems to somehow stretch you even further than before, his imposing member showing you that he was absolutely correct when he said this is what you're meant for, as only a true slut could even dream of taking his overwhelming endowment.";
			WaitLineBreak;
			say "     Even as your will is straining under the unrelenting sensations you're being bombarded with, the steed above you starts to push you even further. His thrusts get more powerful, driving more deeply into you even as you're being bumped repeatedly against the stocks holding you. The selfsame position making it so easy for him to penetrate you also makes it impossible for you to look down at yourself, but you know with a deep certainty that if you could you would clearly see how fully his length is sheathed in you. Even with the depth he has reached however, you have not felt the telltale slap of flesh on flesh that you know would be impossible to miss if he had managed to hilt in you, and you cannot help but marvel at the size of him knowing there is still more to go.";
			...
			say "     The pair don't leave you questioning for long, however, as soon the stallion pulls up into a familiar position above you with his massive member right behind. With a simple pressure that carries the weight of his equine strength, he starts to thrust forward. The mighty flare offers some resistance at first with a moment of tension, but soon your passage yields allowing it to enter fully. The rest of the motion follows smoothly from there, until soon your all too welcoming rear contains almost the full length of his shaft, with only a slight amount remaining beyond. You initially expect that more fervent thrusting will follow, but instead you remain in place as the valkyrie gets closer than usual, and you can hear her fiddling with something just out of your sight.";
			WaitLineBreak;
			say "     This following mystery is solved just as quickly as the last when she begins to grab hold of your arms and lift them up, binding them into what you now realize are not decorative additions to the saddle, but rather the perfect place tie something to the saddle—in this case, you. The valkyrie is doing far more than just preparing you to be ridden by the stallion once, and is instead making sure he can wear you on his saddle and ride you all day long, or perhaps even longer. The mere thought is enough to give you a shiver of pleasure, your resistance to the idea of being a mere outlet for his pleasure becoming fainter with each passing moment, and your growing enjoyment only enhanced by the way the mighty cock you're adorning shifts inside you.";
			say "     With the final strap cinched, the entire experience is taken out of your control. You're going to be stuck right under his barrel regardless of your own opinions on the matter, a perverse compliment to the saddle on his back. The sound of the valkyrie's voice from above alerts you to the fact that she is set upon that same saddle. 'Your new toy is prepared for you, my steed. Do with them as you will.' Almost before she's done speaking, you can feel through your entire body the sensation of the stallion starting to move away from your former resting point, and leaving you fully suspended from above. The ground below you is the only thing you can see, leaving you no idea where it is you're going—or rather, where the stallion you're at the mercy of is going. Almost as if sensing your uncertainty, the tainted voice of the equine rings out.'I believe this toy is going to very much enjoy their time serving me, one way or another.'";
			WaitLineBreak;
			say "     Soon the prediction made by the stallion becomes fact, as every step he takes with you attached causes you to bob back and forth along his member, helpless to do anything but take a log of horse meat repeatedly. Even if you were to try and resist the sensations it causes, the constant pleasure barraging you as you're paraded around like a prized possession would be far beyond your ability to ignore. It's so much that with each minute that passes, with each stroke of the shaft in and out without a thought for your desires, each drip of pre seed filling you, only serve to make you fall deeper into the spiraling depths of depravity that you find yourself in. In the act of being treated like a mere sleeve to attach to a saddle, you almost find your own thoughts reduced to that of a toy, with no desires but those that its wearer pours into it.";
			say "     You barely notice as the valkyrie and her steed travel for what must be hours, the stares of the various beings and creatures they pass simply not registering as important to your insensate mind. Your binding to the saddle is put to the test when the pair ride into battle, the forceful jockeying causing you to futilely climax several times without being paid the slightest amount of attention. Following this, they end up fighting several more battles where they emerge victorious to the best of your knowledge, since it's difficult to tell exactly what the outcome was—after all, your only contribution to the effort is as an accessory. Every action they take seems to drive you further than the last, until it all becomes a blur of pleasure and submission that you can't escape from.";
			WaitLineBreak;
			say "     The endless reverie you were in is eventually broken as you find yourself sliding off the cock you've spend a seemingly eternal amount of time impaled on. You feel a flash of panic, expecting to hit the ground, but are instead caught in a pair of strong arms. You blink through bleary eyes to see what just happened, and find the face of the valkyrie looking back at you. She brings you away from where the stallion still stands, and gently lowers you to the ground in a sitting position, and starts unbinding you. 'You're almost ready, you know. My steed provides me aid in exchange for toys just like you, but he's decided not to take you quite yet. I suppose sometimes he's in the mood for a toy that has given in completely, rather than simply breaking them himself. So for now, you're free to go, with a warning that next time he may not be so generous.' For a moment, she simply looks you over, before continuing. 'Somehow though, I think we'll be seeing you again anyway.' The steed in question laughs darkly, completely assured of his eventual claiming of you, as the valkyrie climbs back on and the pair ride off. Deep down, you think that he may be right.";
			[else: [forced]
				say "     A";]
		[else: [bad end]
			say "     A";]

to say ValkyrieVictory:
	if inasituation is true: [special event]
		say ""; [dealt with in the file where the event is described]
	else:
		[say "[FindValkyrieScore]";]
		say "     What do you want to do with your defeated opponents?";
		now sextablerun is 0;
		blank out the whole of table of fucking options;
		[]
		choose a blank row in table of fucking options;
		now title entry is "Use your hands";
		now sortorder entry is 1;
		now description entry is "Give some manual stimulation to the steed";
		[]
		choose a blank row in table of fucking options;
...
to say ValkyrieWin2:[oral]
	...
	WaitLineBreak;
	say "     Your new approach pays off, as you can feel the wide flare slipping further down your throat, stretching you out to be able to take the huge horse cock that you've set your sights on. Each additional inch you swallow brings you more pleasure than the last, both from the physical sensation and the thought of what you're doing to the equine splayed out on the ground. Even as you become more and more of a sleeve for his member, you know that ultimately this is for your own enjoyment as much as his, and revel in it. Eventually you reach down as far as possible, your lips meeting the base of his shaft, and you hum in satisfaction. You could simply rest there, but instead you start to move back and forth slightly, increasing the pace each time until soon you're vigorously massaging his length with your throat.";
...
to say FindValkyrieScore:
	now ValkyrieScore is 0;
	if BodyName of Player is "Valkyrie Boi":
		increase ValkyrieScore by 2;
	if FaceName of Player is "Valkyrie Boi":
		increase ValkyrieScore by 1;
	if TailName of Player is "Valkyrie Boi":
		increase ValkyrieScore by 2;
	if SkinName of Player is "Valkyrie Boi":
		increase ValkyrieScore by 1;
	if CockName of Player is "Valkyrie Boi":
		increase ValkyrieScore by 1;
	if mdasslevel > 3:
		increase ValkyrieScore by 2;
...
When Play begins:
	...
	now Species Name entry is "Valkyrie Boi";
	add "Valkyrie Boi" to infections of MaleList;
	add "Valkyrie Boi" to infections of BipedalList;
	...
	now face entry is "notably reptilian, with impossibly [one of]beatiful[or]pretty[or]gorgeous[at random] feminine features"; [ Face. Format as Your face is [Face of Player]. ]
	now body entry is "as enticing as any model, with curves in all the right places"; [ Body. Format as "Your body is [Body of Player]." ]
	...
	now tail entry is "Your rear end is [one of]huge[or]massive[or]incredibly large[at random] and wobbles with the slightest movement, while a thick spaded tail hangs down behind you."; [ Ass/Tail. Write as a full sentence (with period) or leave blank for none. ]
	now cock entry is "throbbing and demonic [one of]equine[or]stallion[or]horse[at random]"; [ Cock. Format as "You have a 'size' [Cock of Player] cock." ]
	now face change entry is "it elongates slightly, leaving you with a lizardlike face, but one that is undeniably feminine"; [ Face TF text. Format as "Your face tingles as [face change entry]." ]
	now body change entry is "it shifts, leaving you very reptilian and even more feminine"; [ Body TF text, format as "Your body tingles as [body change entry]. ]
	now skin change entry is "it becomes coated in very fine pink scales, almost soft to the touch"; [ Skin TF text, format as "Your skin tingles as [skin change entry]. ]
	now ass change entry is "it expands outward, becoming extremely large and round, with an inviting tail to match"; [ Ass/Tail TF text, format as "Your ass tingles as [tail change entry]." ]
	now cock change entry is "your shaft swells with sudden arousal and twists into a powerful equine member, tinged with demonic corruption"; [ Cock TF text, format as "Your groin tingles as [cock change entry]." ]
	now str entry is 20;
	now dex entry is 12;
	now sta entry is 18;
	now per entry is 12;
	...
	now body descriptor entry is "[one of]feminine[or]thick[or]angelic[at random]";
...
"Valkyrie Boi Infection"	"Infection"	""	Valkyrie Boi Infection rule	1000	false

This is the Valkyrie Boi Infection rule:
	if Player has a body of "Valkyrie Boi":
		trigger ending "Valkyrie Boi Infection"; [Here it states, that the ending has been played.]
