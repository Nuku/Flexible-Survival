...
Cunt Depth of Joey is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
to say JoeyTalkMenu:
	...
	while sextablerun is 0:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			LineBreak;
			now sextablerun is 1;
			say "     You step back from Joey, shaking your head slightly as he gives a questioning look.";
			wait for any key;
		else:
...
when play begins:
	add Stray Catboy to BadSpots of FurryList;
	add Stray Catboy to BadSpots of MaleList;
