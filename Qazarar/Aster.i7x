...
a postimport rule: [bugfixing rules for players that import savegames]
	now Sterile of Aster is false;
	now MainInfection of Aster is "Minotaur";
...
Cunt Depth of Aster is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Sterile of Aster is false. [steriles can't knock people up]
MainInfection of Aster is "Minotaur".
Description of Aster is "[AsterDesc]".
fuckscene of Aster is "[SexWithAster]".
...
to say AsterTalk4: [amulet]
	if SexuallyExperienced of Aster is true:
		...
		WaitLineBreak;
		say "     After several minutes of speaking with the sphinx, Aster returns to his own desk, his newfound confidence even more visible. He smiles broadly, and immediately begins speaking, 'I got the job this time! I guess this thing really does work, and just in time. I was getting kind of antsy about what else I would do if I couldn't work here.' At that, the newly minted minotaur claps a hand down on your shoulder. 'And I couldn't have done it without you. I think I'm going to start getting to work with my newly acquired job, but feel free to drop by anytime, friend!' He then gives you a suggestive look infused with every ounce of his new confidence. 'And if you ever want some repayment, if you know what I mean, my desk is always open.'";
	[else:
		say "     <Sub turn in>";]
