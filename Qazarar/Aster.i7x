...
to say AsterDom1: [oral]
	...
	say "     Soon enough your preperation is cut short, as Aster grows impatient with your delay. He reaches one hand down and starts to gently pull you towards him. Taking the cue, you lean in and put your mouth against the tip of his oversized shaft. From there you start to work the tip into your mouth, pushing forward slowly, acclimating yourself to the size as you go. Finally, the entire head is past your lips, and you're able to begin in earnest. You start moving your head down the cock slowly, until it becomes difficult to advance, and then glide back up until only the head remains. You start to repeat the motion, going slightly deeper, slightly faster, with each attempt.";
	WaitLineBreak;
