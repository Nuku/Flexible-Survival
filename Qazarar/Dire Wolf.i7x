...
to say DireWolfLoss:
	if inasituation is true: [special event]
		...
		if player is female and ((anallevel is 3 and a random chance of 1 in 3 succeeds) or (anallevel < 3 and a random chance of 1 in 2 succeeds)): [vaginal scene]
			...
			fimpregchance;
		else if anallevel is not 1 and (cunts of player is 0 or anallevel is 3) and (a random chance of 1 in 2 succeeds or (anallevel is 3 and a random chance of 1 in 3 succeeds) or ("Mpreg" is listed in feats of player and a random chance of 1 in 5 succeeds)): [anal scene]
			...
			WaitLineBreak;
			say "     You go from soaking in the sensations to drowning in them when the creature begins to move, thrusting its shaft in and out of you. You are assailed on all sides, the joined pleasures of being fucked and [if player is male]frotted[else]scissored[end if] all at once, the wolf's heavy balls slapping against your ass on the peak of each thrust, the bulge in your stomach reaching it's maximum size at the same time, and all the while you have the knot battering against your back door. You start to lose focus, no longer able to perceive any one sensation, but simply to let the combined sensations wash over you. The indistinct blur of pleasure is only slightly disturbed by the sharper sensation of the lower knot finally forcing it's way just a little bit further, and locking you in place.";
			...
			say "     The wolf looming over you nudges you with his muzzle, lifting you onto all fours. Once he has you exactly where he wants you, he steps into position above you, putting his massive canine cocks at eye level, merely inches away from your face. A quick jerk of his pelvis brings them even closer, the twin tips resting against your face. Without waiting at all, the wolf starts to press forward, the tip of the lower dick easily forcing it's way between your lips. The steady pressure pushes the fat shaft even further into your mouth, stretching it wider and wider with its massive size, as the tip of the upper shaft traces a path up your face, leaving a trail of fluid as it goes. Fortunately, this time you're slightly more comfortable taking the over sized member. Finally it comes to a rest, your lips resting against the knot of the lower cock, while you feel the warmth of the remaining shaft lying across your face.";
			...
			say "     The wolf looming over you nudges you with his muzzle, lifting you onto all fours. Once he has you exactly where he wants you, he steps into position above you, putting his massive canine cocks at eye level, merely inches away from your face. A quick jerk of his pelvis brings them even closer, the twin tips resting against your face. Without waiting at all, the wolf starts to press forward, the tip of the lower dick easily forcing it's way between your lips. The steady pressure pushes the fat shaft even further into your mouth, stretching it wider and wider with its massive size, as the tip of the upper shaft traces a path up your face, leaving a trail of fluid as it goes. Finally it comes to a rest, your lips resting against the knot of the lower cock, while you feel the warmth of the remaining shaft lying across your face.";
