...
to say DireWolfNormalLoss: [regular loss scenes]
	...
	if Player is female and ((anallevel is 3 and a random chance of 1 in 3 succeeds) or (anallevel < 3 and a random chance of 1 in 2 succeeds)): [vaginal scene]
		...
		WaitLineBreak;
		say "     You go from soaking in the sensations to drowning in them when the creature begins to move, thrusting its shaft in and out of you. You are assailed on all sides, the joined pleasures of being fucked and [if Player is male]frotted[else]scissored[end if] all at once, the wolf's heavy balls slapping against your ass on the peak of each thrust, the bulge in your stomach reaching it's maximum size at the same time, and all the while you have the knot battering against your back door. You start to lose focus, no longer able to perceive any one sensation, but simply to let the combined sensations wash over you. The indistinct blur of pleasure is only slightly disturbed by the sharper sensation of the lower knot finally forcing its way just a little bit further, and locking you in place.";
		say "     The creature howls as it reaches climax, and at the same time a paired wave of pleasure and cum flow through you. The upper cock sprays a deluge all over your torso and your [if Player is male]own member[else]lower lips[end if], soaking you thoroughly, and leaving you plastered in his release. The other shaft fills you with a matching load, further increasing the distended outline in your stomach. The shape is larger and less distinct from the flooding you have received, leaving you feeling bloated and full. That sensation is enough to cause you to cross that peak as well[if Player is male], your member adding to the sticky painting between the two of you[end if]. There you remain for quite some time, with the dire wolf growling out its dominance over you, until finally the knot recedes enough for it to pull out of your rear passage.";
		CreatureSexAftermath "Player" receives "AssFuck" from "Dire Wolf";
	else if DireWolfOral is 1: [second oral scene]
		say "     The wolf looming over you nudges you with his muzzle, lifting you onto all fours. Once he has you exactly where he wants you, he steps into position above you, putting his massive canine cocks at eye level, merely inches away from your face. A quick jerk of his pelvis brings them even closer, the twin tips resting against your face. Without waiting at all, the wolf starts to press forward, the tip of the lower dick easily forcing its way between your lips. The steady pressure pushes the fat shaft even further into your mouth, stretching it wider and wider with its massive size, as the tip of the upper shaft traces a path up your face, leaving a trail of fluid as it goes. Fortunately, this time you're slightly more comfortable taking the over sized member. Finally it comes to a rest, your lips resting against the knot of the lower cock, while you feel the warmth of the remaining shaft lying across your face.";
		say "     That moment of reprieve is all you have, as the dire wolf starts pumping in and out. He starts gently, pulling his dick in and out of your mouth, the knot lightly pressing against your mouth at the bottom of each stroke. At the same time, the other shaft thrusts up and down across your vision, drooling more pre onto you. Then the dire wolf truly exerts its dominance over you, with one slow and extended thrust, applying constant pressure until his knot finally slides that last bit forward, locking itself into your mouth, and causing his heavy balls to slap against your chin. A shiver runs up your spine at the knowledge that the creature's incredible shaft has knotted your face, leaving you completely helpless to resist him.";
		say "     Now there are only two things occupying your senses, the fat cock buried completely in your throat, and the second cock laying across your face. Your sight, scent, and taste are all concerned with nothing but those huge endowments. All you can do is inhale the masculine scent with what little breath you have. While you're focused on his members, the huge beast makes shallow movements, clearly for no purpose other than to pleasure himself, with no thought for you. Eventually, he brings himself to climax in your mouth and on your face, causing your world to expand to include a third thing - twin torrents of semen, large enough to match his particular blessings. You struggle to swallow the jets in your mouth, as the creature howls out in dominance. You are left a cum-soaked mess, inside and out, waiting for quite some time until the dire wolf's knot deflates, finally allowing it to slip its lower shaft from your mouth, and pad away.";
		CreatureSexAftermath "Player" receives "OralCock" from "Dire Wolf";
	else: [oral scene]
		say "     The wolf looming over you nudges you with his muzzle, lifting you onto all fours. Once he has you exactly where he wants you, he steps into position above you, putting his massive canine cocks at eye level, merely inches away from your face. A quick jerk of his pelvis brings them even closer, the twin tips resting against your face. Without waiting at all, the wolf starts to press forward, the tip of the lower dick easily forcing its way between your lips. The steady pressure pushes the fat shaft even further into your mouth, stretching it wider and wider with its massive size, as the tip of the upper shaft traces a path up your face, leaving a trail of fluid as it goes. Finally it comes to a rest, your lips resting against the knot of the lower cock, while you feel the warmth of the remaining shaft lying across your face.";
...
"Dire Wolf"	"[PrepCombat_Dire Wolf]"

to say PrepCombat_Dire Wolf:
	setmongender 3;
...
When Play begins:
	...
	add "Dire Wolf" to infections of CanineList;
	add "Dire Wolf" to infections of FurryList;
	add "Dire Wolf" to infections of NatureList;
	add "Dire Wolf" to infections of MaleList;
	add "Dire Wolf" to infections of TaperedCockList;
	add "Dire Wolf" to infections of KnottedCockList;
	add "Dire Wolf" to infections of SheathedCockList;
	add "Dire Wolf" to infections of QuadrupedalList;
	add "Dire Wolf" to infections of TailList;
	...
	now body change entry is "your bones creak and crack as they morph into a more suitable form for hunting, leaving you with the strong body of a dire wolf"; [ Body change text, format as "Your body feels funny as [body change entry]." ]
	now skin change entry is "coarse dark fur spreads rapidly over your form, leaving you more capable of enduring the elements"; [ Skin change text, format as "Your skin feels funny as [skin change entry]." ]
	...
	now MilkItem entry is "dire wolf milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
