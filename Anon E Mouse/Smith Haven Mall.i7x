...
Smith Haven Mall Lot North is a room. It is fasttravel.
...
Instead of searching the Mall Foyer entrance:
	say "Through the glass doors, you make out [the other side of the Mall Foyer entrance].";
Instead of searching the Mall Food Court entrance:
...
To say mallnorthlot:
	If daytimer is day:
		say "            Walking into Smith Haven Mall[']s vast north parking lot, you see the devastating results of the infection having run rampant. Dotted about the lot are not only parked vehicles with either open doors, broken windows, or both, but also several wrecked vehicles, either smashed into other vehicles or hung up in planters. Scraps of ripped clothing caked in dried fluids litter the ground around the vehicles and about the lot. To the south you can see the entrance to the mall[']s foyer. Just inside the glass doors you are able to see some activity on the other side of them. Looking to the east and to the west just shows more of the same, though off in the distance of the mall[']s west lot you spot a gas station.";
	Otherwise:
		say "[northlotlights]";
		
To say northlotlights:
	If findwires is 2 and fixedgens is 2:
		say "            Walking into Smith Haven Mall[']s vast north parking lot, with the lot lights illuminating the area you see most of the devastating results of the infection having run rampant. Dotted about the lot are not only parked vehicles with either open doors, broken windows, or both, but also several wrecked vehicles, either smashed into other vehicles or hung up in planters. Scraps of ripped clothing caked in dried fluids litter the ground around the vehicles and about the lot. To the south you can see light coming from the entrance to the mall[']s foyer. Just inside the glass doors you are able to see some activity on the other side of them. Looking to the east and to the west just shows more of the same, though off in the distance of the mall[']s west lot you spot the lights of a gas station.";
	Otherwise:
		say "            By what you can see around you in the dark, you[']re pretty sure you[']re in Smith Haven Mall[']s vast parking lot. The full, pregnant, moon hanging in the night sky brilliantly casts it[']s light upon a good portion of the mall[']s lot. With the stars dancing along with the moon in the night sky and the eerie silence of the abandoned cars you can see, the devastation around you is almost serene. To the east and west you know the parking lot continues and ahead of you is the entrance to the mall[']s foyer.";
...
To say mallsouthlot:
	If daytimer is day:
		say "            You walk along the parking lot[apostrophe]s main access road into the mall[apostrophe]s south lot, peeping into a few of the cars as you go. There isn[apostrophe]t as many cars on the south side of the mall as there is on the north side, but they all still show signs of the owners being assaulted and transformed into the various critters now running around the city. To the north you see the entrance into the food court, flanked on one side by the building for the Regal movie theaters and the other by the building for a super Target.";
	Otherwise:
		say "[southlotlights]";
		
To say southlotlights:
	If findwires is 2 and fixedgens is 2:
		say "            You walk along the parking lot[']s illuminated main access road into the mall[']s south lot, peeping into a few of the cars as you go. There isn[']t as many cars on the south side of the mall as there is on the north side, but they all still show signs of the owners being assaulted and transformed into the various critters now roaming around the city. The signs on the Regal movie theater and Target store are lit and to the north you see light coming from the entrance into the food court.";
	Otherwise:
		say "            You carefully make your way along the dark parking lot[']s main access road, staying alert for any traps or surprises. Of what you can see, there isn['] many cars on this side of the mall as compared to the north side, but there is still signs of the former owners fates. To the north you can just discern the glass door entrance to the mall[']s food court in the low light.";
...
To say mallatrium:
	If findwires is 2 and fixedgens is 2:
		say "            The mall[']s atrium is a large rotunda, four massive columns rising towards the ceiling and seeming to support the large domed roof. The lit dome itself is painted with a picture depicting a scene of Mount Olympus. Three foot tall statues depitcing the twelve Olympian gods sit on a ring running around the upper half of the rotunda and are backlit with random colored lights. Dominating the center of the atrium is a large fountain. You[']ve learned in the past that it[']s a faithful recreation of the Morosini fountain found in a village in Crete. The fountain is now working, though the water is still too dirty to drink, and in the pool of the fountain some [one of]red[or]orange[or]blue[or]green[or]violet[at random] lights are illuminated. To the north is the mall foyer. To the south is the entrance to the food court. To the east and west are the main wings of the mall.";
	Otherwise:
		say "[daycheckatrium]";
		
To say daycheckatrium:
	If daytimer is day:
		say "            Sunlight streams in from the east and west wing skylights, giving enough light to see inisde the atrium. It is a large rotunda, four massive colums rising towards the celiling and seeming to suport the large domed roof. It[']s hard to see into the semi-dark dome, though you are able to just make out statues of the twelve Olympian gods.  Dominating the center of the atrium is a large fountain. You[apostrophe]ve learned in the past that it[apostrophe]s a faithful recreation of the Morosini fountain found in a villiage in Crete. Dirty, standing water partially fills the fountain[']s pool, and with the HVAC sytem down, the light stench of the stagnant water fills the stuffy air around you. To the north is the mall foyer. To the south is the entrance to the food court. To the east and west are the main wings of the mall.";
	Otherwise:
...
Instead of searching the Sewer entrance:
