Brookstone Books by Anon E Mouse begins here.
...
Instead of searching the Brookstone Books entrance:
...
Bevsad is a number that varies.
...
To say afsm:
	...
	Otherwise:
		...
		Otherwise:
			...
			Now survfeat is 1;
To say thab:
	If thabread - turns < 18 and huntfeat is 1:
	...
	Otherwise:
		...
		Otherwise:
			...
			Now huntfeat is 1;
To say myse:
	If myseread - turns < 18 and purfeat is 1:
	...
	Otherwise:
		...
		Otherwise:
			...
			Now purfeat is 1;
To say hfgb:
	If hfgbread - turns < 18 and hagfeat is 1:
