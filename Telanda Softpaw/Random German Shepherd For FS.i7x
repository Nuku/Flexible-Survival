...
to say attk gsd:
	...
	say "[one of]The dog growls, swiping at you with an open paw-like hand, dull claws leaving scratches in your [skin of player] skin.[or]As you extend to strike the German Shepherd he twists and his jaws clamp on your arm before releasing again, leaving a bloody bite.[or]Dodging back the large canine growls before charging forward, using the extra momentum to tackle you knocking you over.[at random]";
...
when play ends:
	...
	otherwise:
		if bodyname of player is "German Shepherd":
			...
			otherwise:
				if cunts of player > 0 and cocks of player > 0:			[HERM]
					say "     As you emerge from the helicopter and set loose on the streets near the military's holding facility, a young man among the mob of reporters rushes up to you and starts asking questions rapidly.  What was it like?  Is having fur half as fun as it looks?  This young internet reporter is a [']furry['] and quite entranced with a sentient dog person, especially a dual-gendered one.  At first, his attentions are quite annoying, but he is quite persistant after your release, even when you bite him once.  Well, a nip, really.  Despite your cold attitude, he does everything he can to be a good friend, helping you find a home and a job and generally being available.  Your anger eventually passes and accept that it's not him you're angry with.  And with it gone, other emotions have a chance to surface.  It's not long before you're sharing more than you ever thought.";
				otherwise if cunts of player is greater than 0:			[FEMALE]
