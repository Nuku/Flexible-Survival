...
[Version 9.1 - GSD victory tweaked by Blue Bishop and Stripes]
...
To say male shepherd rape:
	...
	if sex entry is "Male": [You've been adopted. now you two boys can play ;)]
		...
		if cunts of the player is 0: 
			...
			say "'Next time, don't fight me bitch!  Know your place!'[line break]With a growl he pulls you away from the wall and pushes you down onto all fours.  Mouthing at your neck and shoulder, making sure you can feel the threat of his fangs if you try and fight again, his hot breath washing over your [skin of player] skin. But his mood has shifted; having bested you he now seems eager to enjoy his new toy.";	else if gsd attack is 0:
		...
		now Shepherdslut is 1;
		if cunts of the player is 0 and "Male Preferred" is not listed in feats of player:
		...
		otherwise if cunts of player > 0:
			say "He gives an extra little sniff, taking in your male scent then chuckles as he licks your cheek.[line break]'No juicy pussy for your alpha, but I think I'll have fun making you my bitch all the same.  That said, he presses his muzzles against your lips, canine tongue pressing in as he forces the kiss, paws slipping around to squeeze your rump.  Then satisfied that the 'foreplay' has been accomplished he breaks the embrace and turns you around, gently but firmly pushing you down onto all fours";
			now fuckable is 2;
		else:
