	...
	if HP of Blake is 0:
		...
		if player is not male:
			...
			if calcnumber is 1:
				...
				LineBreak;
				say "     You turn and flee, stumbling out into the open of the parking lot, followed by an amused laugh from Blake. Glancing back, you can't really see him in the dark of the alley, but you just know he's there watching you. Somehow you cant shake the feeling of something oily having touched your mind.";
				[Note: No actual compulsion, just freaking the player out a bit]
