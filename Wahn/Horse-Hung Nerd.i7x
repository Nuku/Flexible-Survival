...
When Play begins:
	...
	add "Horse-Hung Nerd" to infections of HumanList;
	add "Horse-Hung Nerd" to infections of FurryList;
	add "Horse-Hung Nerd" to infections of NatureList;
	add "Horse-Hung Nerd" to infections of MaleList;
	add "Horse-Hung Nerd" to infections of BluntCockList;
	add "Horse-Hung Nerd" to infections of BipedalList;
	add "Horse-Hung Nerd" to infections of SheathedCockList;
