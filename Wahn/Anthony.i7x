...
instead of conversing the Anthony:
	...
	otherwise if calcnumber is 2: [help]
		...
		otherwise if hp of Anthony is 4:
			...
			otherwise: [helped the farmhands]
		...
		otherwise if hp of Anthony is 5:
...
instead of going northwest from Central Farm Square while (hp of Anthony is 0 or hp of Anthony is 1 or hp of Anthony is 3 or hp of Anthony is 4 or hp of Anthony is 5):
	...
	otherwise if hp of Anthony is 4 and hp of Duke > 9:
		...
		otherwise:
			...
			say "     [AnthonyRewardSex]";
		now hp of Anthony is 5;
	otherwise if hp of Anthony is 5 and FinnTrackingProgress > 2:
		if FinnTrackingProgress < 90: [Finn got saved]
			...
			otherwise:
				say "     [line break]";
				say "     [AnthonyRewardSex]";
		otherwise if FinnTrackingProgress is 99: [Finn is dead]
		...
		otherwise if FinnTrackingProgress is 100: [Finn joined the stables]
...
[
	otherwise if hp of Anthony is 5 and hp of Selena is 1 and SelenaDelivery - turns > 16:
		...
		if dice + bonus >= 19:
			say "     ...she seems to be a little uncomfortable, but the kitten does step out from behind Anthony, walking forward towards you. The girl looks down, playing with the hem of her shirt as she stammers out, 'I-I'm Selena. It... it's nice to meet you, [if player is female]Miss[otherwise]Sir[end if].'";
		otherwise:
...
to say AnthonySex4: [player pussy fucked]
	...
	say "     Anthony does his very best to please you, only pulling out from time to time to catch his breath, then getting right back to this unconventional way of having sex. After a quite pleasant little while of doing so, he takes things to an all new level by starting to hum loudly with his muzzle inside you. With all the stimulation already having put you very close to an orgasm, the vibration of Anthony's muzzle is enough to push you over the edge for good. Bucking your hips towards the anteater, you shout out in climax while [if cocks of player > 0 and cunts of player > 0]your cock sends spurts of cum spraying over your chest and your pussy starts gushing femcum, which plasters Anthony's forelock against his muzzle and trickles down all over it.[otherwise if cocks of player > 0]your cock sends spurts of cum spraying over your chest, painting it in white streaks.[otherwise]your pussy starts gushing femcum, which plasters Anthony's forelock against his muzzle and trickles down all over it.[end if]";
	WaitLineBreak;
	say "     Showing dedication to his task, Anthony keeps wiggling his tongue inside your trembling pussy all the way through your orgasm and even after, making sure that your arousal never dips too low even after your [if cocks of player > 0]spurts of cum[otherwise]waves of pleasure[end if] slowly ebb off. Then eventually, he raises his head and flicks that amazing tongue forward to lick up some of the [if cocks of player > 0]cum sticking to your chest[otherwise]femcum glistening on your pubic mound[end if], smiling as he brings it to his mouth and tastes your essence. 'Ready for round two?' the slender male asks next and you give a nod and happy moan as your reply, which prompts Anthony to raise himself up on his knees, then lean over your relaxed form. Looking down at what bumps hotly against your buttocks at that move, you see that his tongue isn't the only thing quite long on this tall anteater - Anthony is hung with a very respectable piece of man-meat, its length standing proudly erect under a small bush of blond pubic hair.";
