...
to say Hunter wins:
	...
	otherwise if bodyname of player is "elf" or bodyname of player is "Elven Hunter":
	...
	[add in other dinosaurs and dragons below as they get added to the game]
	otherwise if ( bodyname of player is "Triceratops" or bodyname of player is "Ash Dragator" or bodyname of player is "Ash Drakenoid" or bodyname of player is "Ash Whelp" or bodyname of player is "Feral Sea Dragon" or bodyname of player is "Feral Sea Dragoness" or bodyname of player is "Yamato Dragon" or bodyname of player is "Yamato Dragoness" or bodyname of player is "Slutty Dragoness" or bodyname of player is "Horny Dragon" ) and ( skinname of player is "Triceratops" or skinname of player is "Ash Dragator" or skinname of player is "Ash Drakenoid" or skinname of player is "Ash Whelp" or skinname of player is "Feral Sea Dragon" or skinname of player is "Feral Sea Dragoness" or skinname of player is "Yamato Dragon" or skinname of player is "Yamato Dragoness" or skinname of player is "Slutty Dragoness" or skinname of player is "Horny Dragon" ):
...
To say Hunter loses:
	...
	if the player consents:
		if cocks of player > 0 and cunts of player > 0: [herms may choose]
			...
			say "     He smiles at you, then says 'I sense this realm's tiny machines have blessed you with both genders. Which would you prefer to claim me with?' (Y for cock, N for pussy)";
			if the player consents:
