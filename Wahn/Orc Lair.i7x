			...
			if fightoutcome is 22:
				...
				if BodyName of Player is "Orc Warrior" and player is pure and Player is male:
					...
					if fightoutcome is 22:
						...
						say "     Phew, the last orc collapses on top of the other two with the meaty thump of flesh on flesh. Looking around, you see the guy who got you into this whole mess - he's a little distance away, having hopped along while still trying to wiggle out of the coils of rope the orcs wrapped around him. Deciding that this isn't the right location to stay to deal with this, you quickly follow him, then [if Scalevalue of Player > 2]throw the fox over your shoulder[else]pull the fox tight against your side[end if] and leave before the orcs get a second wind or something. Before you're fully out of sight of the groaning pile of orcs, an angry shout rings out behind you, proving that it was a good idea to get moving. Even though they're unlikely to catch up, you tightly grip the fox as you storm down the street, dodging past car wrecks and piles of garbage. After some further turns, taking one or two side alleys, then going off in a direction to the side, you come to a stop inside the charred remains of a building. Interestingly, the fox had the presence of mind to keep working on the ropes even while you were fleeing with him, with the coils now just falling loosely off as you look at him again.";
	...
	if Vincent_Raid_Orc_Choice is:
		-- "He's got a deal. You'll claim that ass, then let the three of them have the fox afterwards.": [fuck Vincent, then leave him -> Player is Chris's Father]
			...
			if Player consents: [continue to fuck Vincent]
				...
				say "     Deciding to accept the deal, you [if Scalevalue of Player > 2]throw the fox over your shoulder[else]pull the fox tight against your side[end if] and charge at the two orcs you previously defeated. Even though their bruises have faded, being repaired by the countless nanites swarming through their bodies, they're clearly still exhausted from the fight - and what's more, the two of them were leaning against the walls, dicks in hand and stroking them while wanting to watch you ravage the fox. With the element of surprise on your side, you're past the first before the other can react, and that one you shoulder out of the way without stopping. Angry shouts echo through the streets as they try to chase you, only to be left eating your dust as you make a clean getaway, tightly gripping the fox as you storm over the asphalt, dodging past car wrecks and piles of garbage. After some further turns, taking one or two side alleys, then going off in a direction to the side, you come to a stop inside the charred remains of a building.";
		...
		-- "Beat your chest and insist that the fox belongs to you now! (You can let him go after they're gone, or not...)":
			LineBreak;
			say "     Baring your tusks, you growl at the third orc, demanding ownership of the slave - after all they wouldn't have caught him at all without the fox barreling into you. The orc slaver doesn't like to hear that at all and you can see his fist clenching, so you poke your foot against the bruised side of one of the fallen orcs, making him wince. That reminder of you already having won out against his two siblings makes the orc finally relent with a snarl, and he shoves the tied slave in your direction, to stumble and sprawl at your feet. Quickly leaning down to grab him, you[if Scalevalue of Player > 2]throw the fox over your shoulder[else]pull the fox tight against your side[end if] and leave before the orcs get a second wind or something. Before you're fully out of sight of the three orcs, angry shouts ring out behind you, proving that it was a good idea to get moving. Even though they're unlikely to catch up, you tightly grip the fox as you storm down the street, dodging past car wrecks and piles of garbage. After some further turns, taking one or two side alleys, then going off in a direction to the side, you come to a stop inside the charred remains of a building. Interestingly, the fox had the presence of mind to work on the ropes even while you were fleeing with him, with the coils now just falling loosely off as you look at him again.";
...
to say VincentEscape:
	say "     'I see. O-okay master, I'll be your foxy fucktoy! Let me worship your cock to celebrate the victory over those brutes!' Before you've got more than a second to wonder about this quite rapid turnabout to so eagerly wanting to serve, Vincent is already sinking down from standing straight before you and bending forward, both of which loosen your grip on his shoulder a little bit. His muzzle comes closer and closer to your crotch, and then... he head-butts your cock with all the force he can muster. Stars and spirals of pain dance before your eyes while you choke on a stillborn scream stuck in your throat, and your hand slips from where it was gripping Vincent's shoulder as the slender man twists to the side. With a whimper, you stumble and fall to your knees, reaching to cup your so shockingly violated cock, not that that will do any good after the fact now. Through the haze of pain, you distantly hear, 'I've got enough of people treating me like crap!', followed by running footsteps. So much for your ambitions of having a new slave...";
	TraitGain "Headbutted Player" for Vincent;

to say VincentFirstOrcBJ:
	say "     His nostrils flare as he takes in the musky scent of your pre-cum, then goes in to have a lick at the head of your green-skinned cock. The glistening wetness of pre-cum welling up from your cum-slit touches the fox's tongue, and his eyes go wide at its pleasant, stimulating taste. 'This tastes... pretty nice,' he says, not quite hiding the slight pause he needed to pick some less enthusiastic words than likely first came tom mind. Swallowing his first taste of orc and licking the side of his muzzle, the slender anthro is drawn in by the inevitable desire to taste more of your pre, and that floppy tongue starts to lap again, playing over the tip of your cock eagerly. Soon, he tries something else and closes his muzzle most of the way, just putting the lips at the very tip against your dickhead, and trying to suckle, which doesn't quite work as canine mouths just don't work that way.";
	say "     Pulling off and shaking his head, the fox then falls back to providing a more regular blowjob for you. In joyous haste, Vincent opens wide and slides his whole muzzle over your erection, engulfing the length of your shaft with the broad tongue serving admirably to keep itself interposed between his pointy canines and your hard rod. Between the warm bed of his tongue below, the ribbed roof of his muzzle above, and the red fox's floppy tongue tip half-wrapping around your shaft, Vincent delivers a quite enjoyable blow-job, bobbing up and down on your erect cock and eagerly slurping up what pre you leak into his open mouth. [if Cock Length of Player > 7]He goes as far as taking your erection down his throat too, inhaling it after taking a few deep breaths, then slowly letting the dickhead slide back up again before going for another round[else]He takes your whole length without any trouble, with it easily fitting in his muzzle[end if]";
	WaitLineBreak;
...
to say VincentPostRaid_RegularTalk:
	...
	if Vincent_PostRaid_Choice is:
		...
		-- "Offer him a place to stay with you, safe from brutes such as those three orcs. If he shows his appreciation, of course... (Oral Sex)":
			LineBreak;
			say "     Listening to your words, Vincent raises an eyebrow, and somewhat mocking chuckle bubbles up from his chest. 'Expected as much. Nothing's free, except death, eh? But yeah, you're right - a safe place to get some shut-eye is worth a lot, these days. Laying down with one eye open is sure getting old fast, I can tell you that!' Scratching the underside of his muzzle, he thinks for a few seconds, then nods to you. 'Okay, fine. I'll play ball. But there have to be ground rules - just let me do my thing, and I'll give you what you need. Don't grab me or try to force anything, understand? I'll bite you if you try! Understood?' As you agree to his conditions, the fox pulls off his sleeveless shirt, hanging it on a relatively unscathed piece of surviving furniture before going up to you and sinking into a crouch. Seems he's ready to pay his first rent, right here and now!";
			say "     [if Player is not barecrotch]Vincent's slender fingers dance over your clothes, tugging and pushing them aside to free your crotch, with him leaning in close without any hesitation[else]Vincent seems to appreciate the convenience of you having your crotch already exposed and leans in close without any hesitation[end if]. ";
			if Player is male:
				if CockName of Player is "Orc Warrior": [addiction risk]
					say "[VincentFirstOrcBJ]";
				else: [normal BJ]
					say "The corners of his mouth twitch upwards as he takes in your [Cock of Player] manhood, his tongue slipping out to lick the side of the fox's long muzzle. Taking hold of your shaft, he jerks it in a pleasant speed, not being too rough or rushing, instead seemingly knowing how to handle a man's pride and joy just right. As you harden and stand proudly erect soon enough, the fox takes a deep breath, then starts to lap at your dickhead, with his floppy canine tongue feeling quite nicely as it glides over your sensitive glans. While doing so, Vincent's eyes glance up warily, watching out that you're not getting any ideas of slamming your shaft into his muzzle or anything breaking the rules you agreed upon.";
					WaitLineBreak;
					say "     Slender canine fingers dance over your shaft as he lifts it, running his long tongue over the underside and teasing your girth. Feels like he knows his way around a hard cock, and he has some pleasant little tricks up his sleeve. Ducking his head low, with your erection coming to lay across the top of his muzzle, he spends some time worshiping your balls too, first a few licks with the tip of his tongue, then opening his muzzle wide to take one of your balls into his mouth. He's very careful not to graze it with his canine teeth, even as he lets that very flexible tongue wash over your orb in a quite stimulating tongue-bath, then switches over to do the same to your other dangling cum-factory. You can't help but breathe a bit more heavily as the fox worships your sack, something he immediately notices, with those pointy ears flicking to take in every sound you make. With a grin flickering over Vincent's muzzle at the effect he's having on you, the fox gets back to running his tongue along your shaft, up and up till he reaches your dickhead once more.";
...
to say SubmitToOrcSlavers:
	...
	if SlaveRaidEncounters is 0: [first time]
		...
		if anallevel > 1:
			...
			LineBreak;
			say "     Note: Since you've selected [']less anal['], you won't be dragged off to the orc lair, as the main way of orc reproduction is anal sex. It's all man on man action in there! Should you want to play through this content nevertheless, adjust your anal settings and hunt for the event again.[roman type][line break]";

to say SubmitToOrcRaid:
	say "     As you surrender, one of the orcs looks down on you disparagingly and pokes at you with a large finger. [if OrcSlaverStatus is 2]'Hm, can't do anything but submit and run away when no one is looking. Seems a bit too weak and meek...' [else if OrcSlaverStatus is 3]'Hm, did we already fuck all the will out of this one? Maybe it was too meek in the first place after all.' [else]'Hm, this one looks a bit meek and weak. Doesn't even struggle to get away.' [end if]His buddy steps up and gives your ass a rough squeeze. 'Bah, you worry too much, Yatur - orc seed is strong! [if Player is purefemale]She'll[else]He'll[end if] make a good enough breeder.' With that said, they tie you up and carry you off, lugged over an orc's shoulder. In your position, you see mostly the ground and the orc behind, carrying their other captive, but you think that you recognize the blasted and fire-blackened streets of the capitol district as their goal from what you manage to catch glimpses of around you.";
...
to say SubmitToOrcRaidRepeat:
	say "     As you surrender, one of the orcs looks down on you disparagingly and pokes at you with a large finger. [if OrcSlaverStatus is 2]'Hm, can't do anything but submit and run away when no one is looking. Seems a bit too weak and meek...' [else if OrcSlaverStatus is 3]'Hm, did we already fuck all the will out of this one? Maybe it was too meek in the first place after all.' [else]'Hm, this one looks a bit meek and weak. Doesn't even struggle to get away.' [end if]His buddy steps up and gives your ass a rough squeeze. 'Bah, you worry too much, Yatur - orc seed is strong! [if Player is purefemale]She'll[else]He'll[end if] make a good enough breeder.' With that said, they tie you up and carry you off, lugged over an orc's shoulder. In your position, you see mostly the ground and the orc behind, who gives you lusty looks that promise a hard fucking coming in your future, but you think that you recognize the blasted and fire-blackened streets of the capitol district as their goal from what you manage to catch glimpses of around you.";
...
to say LoseToOrcRaid:
	say "     As you collapse in exhaustion, one of the orcs looks down on you and grins, lust in his eyes. 'You got spunk, [if Player is purefemale]girl[else]boy[end if] - I like it. [if OrcSlaverStatus is 3]Even after being broken in, you're still struggling -you'll bear strong sons.' [else]Try to keep some of it when you become a breeder.' [end if]His buddy steps up and gives your ass a rough squeeze. 'Nice - I bet there'll be fights who gets to fuck that after we've had our fun with you!' With that said, they tie you up and carry you off, lugged over an orc's shoulder.";
...
to say OrcLairBadEnd:
	...
	now TailName of Player is "Communal Orc Fucktoy"; [NOTE: I guess, this could be removed without issues when the GameEndings table is finished (@Stadler#3007)]
...
after going west from Breeder Lockup A:
	...
	if CellDoorStatus is 0 or CellDoorStatus is 2:
		say "     As you enter the cell, the door automatically falls shut again when you let go of it, pushed by a spring at the top. The lock gives a disconcerting click as it locks. [if Cell Key is owned]Good that you have a key, otherwise you might get stuck in here[else]Now you're stuck in here - unless you find a way to [bold type]escape the cell[roman type][end if].";
...
an everyturn rule:
	if Cell Door 1 is locked and CellDoorStatus is 3 or CellDoorStatus is 1:
		now Cell Door 1 is unlocked;
	if Cell Door 2 is locked and CellDoorStatus is 3 or CellDoorStatus is 2:
...
to say OrcGangbang1:
	project the figure of Orc_Brothers_naked_icon;
	if Energy of Player > 6:
		say "     Giving you a hungry look, the biggest of the three orcs grunts in annoyance and says, 'Bah, still drunk off [PosAdj of Player] ass! Forget this, it's boring to fuck a person who's just flopping around uncoordinately!'";
		stop the action;
	if OrcSlaverStatus is 1:
	...
	if Player is submissive: [sub players]
		...
		say "     Chuckling, he shakes his head and says 'Gonna let the others try your mouth out now - and take your ass. Get on the fuckbench, slut!' Being roughly pulled up by your arm, you're given a push towards the sturdy leather-covered bench in the middle of the cell. Stumbling over to it, you're told to lie down on your stomach, with your head hanging over the end. In that position, you quickly find the green erections of Mul and Koghh presented to you, the two of them kneeling next to each other right before you. Eager to get more of the tasty orc precum and cum in your mouth, you reach forward to grab both their erections, jerking on them and alternating in licking and suckling on the cockheads.";
		WaitLineBreak;
...
to say KoghhFuck1:
	project the figure of Koghh_naked_icon;
		...
		if Player is submissive: [sub players]
			...
			if BodyName of Player is "Orc Warrior" and CockName of Player is "Orc Warrior" and Player is male:
				...
				if Player consents:
					...
					NPCSexAftermath Koghh receives "AssFuck" from Player;
					LineBreak;
					infect "Orc Warrior";
					infect "Orc Warrior";
					if Koghhstatus < 2:
...
to say OrcBrotherlyLove1: [Koghh + Yatur]
	...
	if Player consents:
		...
		NPCSexAftermath Koghh receives "AssFuck" from Yatur;
	else:
		LineBreak;
...
instead of conversing the Orc Mob:
	if Cock Count of Player < 1:
		say "     With the gang of horny brutes being who and what they are, there is a definite risk of drawing the wrong kind of attention to yourself if you can't keep up with their testosterone-fueled antics. It really might be best if you at least had a dick before you joined the crowd. A loincloth isn't all that hard to pull to the side, and you've seen several of the guys grab another orc's balls to check who has the biggest nuts. Things might get dicey if you're 'unmasked' as having no dick right here in the hall...";
	else:
		say "     The orcs do look like a pretty rowdy bunch, drinking together, fucking slaves right in front of one another and boasting about their feats. [bold type]Do you really want to join the crowd and get pulled into such behavior?[roman type][line break]";
		if Player consents:
			if HP of Orc Mob is 0: [first time]
				...
				if Player consents: [fuck scene]
					...
					say "     [bold type]Might be worth coming back here sometime soon and joining in for the 'hunt'. Best talk to the orc crowd when you're ready.[roman type][line break]";
					move player to Dark Hallway 1;
				NPCSexAftermath Urik receives "AssFuck" from Toven;
				...
				if Player consents:
					...
					if Player consents:
						...
						if fightoutcome >= 20 and fightoutcome <= 29:[lost]
							...
							if Player consents: [rescue the men]
								...
								CreatureSexAftermath "Human" receives "OralCock" from "Player";
						...
						say "     [bold type]This round is a bust, for you. Still, you could always come back here another time and try another 'hunt'. Best talk to the orc crowd when you're ready.[roman type][line break]";
						now thirst of Orc Mob is 1; [marker for having the soldiers captured]
					now inasituation is false;
					...
					say "     [bold type]This round is a bust, for you. You didn't participate after all. Still, you could always come back here another time and try another 'hunt'. Just talk to the orc crowd when you're ready.[roman type][line break]";
					now thirst of Orc Mob is 1; [marker for having the soldiers captured]
				...
				if Player consents:
					...
					wait for any key;
					now inasituation is true;
					challenge "Football Gorilla Male";
					if fightoutcome >= 20 and fightoutcome <= 29: [lost]
						...
						if Player consents: [warn him]
							...
							say "     [bold type]This round is a bust, for you - at least in the eyes of the orcs, as they assume your goals were the same as theirs. Still, you could always come back here another time and try another 'hunt'. Best talk to the orc crowd when you're ready.[roman type][line break]";
						else: [take him]
							LineBreak;
							...
							CreatureSexAftermath "Football Gorilla Male" receives "AssFuck" from "Player";
							say "     [bold type]That was fun - you feel like you should come back here sometime soon and join in for another 'hunt'. Best talk to the orc crowd when you're ready.[roman type][line break]";
							increase Libido of Orc Mob by 1; [another point for the player]
						now inasituation is false;
				else: [don't join in]
				...
				if Player consents:
					...
					if Player consents:
						...
						LineBreak;
						say "     Nah, it's not like he didn't bring it on himself, stomping through the forest to capture a new sex slave. It's not your responsibility to save his ass. Unfortunately, as you are about to turn and walk away, a fallen branch snaps loudly under your left foot, drawing the attention of the combatants. Everyone's attention is drawn over to you for a second, then the largest of the wolves gives a commanding growl to his companions, followed by the barked words 'finish him'. And with that, the alpha wolf dashes towards you, leaving his subordinates to wrestle down the orc while he takes care of the new prey - you.";
						now inasituation is true;
						challenge "Alpha Wolf";
					if fightoutcome >= 20 and fightoutcome <= 29: [lost]
						...
						say "     [bold type]This round is a bust, for you. Still, you could always come back here another time and try another 'hunt'. Just talk to the orc crowd when you're ready.[roman type][line break]";
					else if fightoutcome >= 30: [fled]
						...
						if Player consents:
							...
							CreatureSexAftermath "Alpha Wolf" receives "AssFuck" from "Player";
							say "     [bold type]A clear victory for you - and what a fun one too. You feel like you should come back here sometime soon and join in for another 'hunt'. Best talk to the orc crowd when you're ready.[roman type][line break]";
							increase Libido of Orc Mob by 1; [another victory for the player]
						else:
							LineBreak;
				...
				if Libido of Orc Mob > 2: [player won - brought in 3-4 slaves]
					...
					say "     [bold type]The big slave hunt is over and you won! Urik, the warrior-turned-breeder, is your rightful prize and property. Additionally, there's now free fun to be had with the communal breeders here in the lair. They're always at your disposal if you want some fun...[roman type][line break]";
					...
					say "     [bold type]The big slave hunt is over now. You didn't win, but that doesn't mean you can't enjoy the communal breeders here in the lair. They're always at your disposal if you want some fun...[roman type][line break]";
