	...
	otherwise:
		...
		if player consents: 
					...
					if player consents:
						...
						otherwise if fightoutcome >= 10 and fightoutcome <= 19:  			[won]
							...
							otherwise: [fuck the men]
								...
								increase libido of Orc Mob by 1;
					otherwise:
			...
			otherwise if hp of Orc Mob is 6:
				say "     <Further hunting expedition stages are still in progress of being written.>";
