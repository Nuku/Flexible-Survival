...
instead of conversing the Orc Mob:
	...
	otherwise:
		say "     The orcs do look like a pretty rowdy bunch, drinking together, fucking slaves right in front of one another and boasting about their feats. Do you really want to join the crowd and get pulled into such behaviour?";
		if player consents: 
			...
			otherwise if hp of Orc Mob is 1: [second time]
				...
				say "     Do you watch Urik losing his anal virginity and Toven's first fuck as an orc warrior (though he seems more like a half-and-half orc right now)?";
			...
			otherwise if hp of Orc Mob is 2: [first chance at the contest]
				say "     Again joining the orc warriors in their reveling, you soon find yourself in their midst with an orc brew in your hand. It seems that most of the conversation centers on Boghrim's breeder capturing contest. As everyone excitedly talks about who has the best chances, you kinda feel the urge to also go out rise inside you. Do you want to follow the throng of orc hunters just preparing to leave and see what happens out there?";
				if player consents:
					...
					say "     [WaitLineBreak]";
					say "     So, you're a big, green-skinned brute of an orc and its hunting-season for new breeders to fuck. How do you want to play this?";
					say "     [link]Y[as]y[end link] - Announce your presence and warn the men off.";
					say "     [link]N[as]n[end link] - Wait for the right moment to rush them and bring some new breeders 'home' to the orc lair.";
					if player consents:
					...
					say "     [line break]";
					say "     Well, that changes things. What will you do now?";
					...
					if player consents:
						...
						otherwise if fightoutcome >= 10 and fightoutcome <= 19:  			[won]
							...
							otherwise: [fuck the men]
								...
								say "     Brian's chocolate-brown ass is already so delightfully bare, making him an inviting target for a hard pounding. With a chuckle, you pull Ike off your dick once more, then line its glistening rod up with the Latino's rear and push in against his pucker. 'Nnnnaarghhh!' Brian groans as you sink into him, losing his virginity to your green pole - but like his friend, the soldier turns out to have a relatively low tolerance, as his wince turns into a moan before he's taken even half your shaft. The fact that you're really turned on by the two of them might have something to do with that... especially with Ike having crawled between your legs and lapping at your balls. Thus, pre-cum is flowing into Brian with quite regular throbs, lubing the man and making him ever more compliant as his body absorbs the potent fluid.";
								say "     [WaitLineBreak]";
			...
			otherwise if hp of Orc Mob is 3 or hp of Orc Mob is 4: [second chance at the contest]
				say "     Again joining the orc warriors in their reveling, you soon find yourself in their midst with an orc brew in your hand. It seems that most of the conversation centers on Boghrim's breeder capturing contest and how much fun the first round of it was. As everyone excitedly talks about who has the best chances, you kinda feel the urge to also go out rise inside you. Do you want to join the throng of orc hunters just preparing to leave and see what happens out there?";
				if player consents:
					...
					otherwise if fightoutcome >= 10 and fightoutcome <= 19:  [won]
						...
						say "     [line break]";
						say "     Phew, finally he has shut up for a second and isn't trying to knock you to the ground. Now that you got the football gorilla's full attention, you tell him:[line break]";
						...
						say "     [link]N[as]n[end link] - That you're here because of a hunting competition among the orcs - and his ass belongs to you now!";
						say "     [line break]";
			...
			otherwise if hp of Orc Mob is 5: [3rd hunt starting]
				...
				say "     [line break]";
				say "     As everyone starts to look around for other orcs to go out with, you kinda feel the urge to also go out rise inside you. Do you want to join the throng of orc hunters pairing up and see what happens out there?";
				if player consents:				
					say "     [line break]";
					...
					say "     [line break]";
					say "     Looks like you actually have good chances of getting the stallion. Raku's already got his lasso ready and he's about to throw - which leaves you to decide what you want to do with your own. From what you can see, there are two options:[line break]";
					...
					otherwise: [trip up Raku]	
						...
						say "     [line break]";
						say "     How do you react?[line break]";
			...
			otherwise if hp of Orc Mob is 6:
				say "     Again joining the orc warriors in their reveling, you soon find yourself in their midst with an orc brew in your hand. It seems that most of the conversation centers on Boghrim's breeder capturing contest and how much fun the last round of it was. Their mention of the orc boss leads you to look over at his raised fuck-pad platform, with its leather sofas and a small private harem lounging on them. The orc breeders are paired up in twos and threes, caressing and touching each other while Boghrim himself is busy pounding into Jason, the one unchanged human he owns. You can barely look away from the rhythmic pumping of the mighty orc's hips against his willing slut, until their coupling culminates in an explosive orgasm, Boghrim's balls throbbing as he pumps Jason full of cum and the human's cock spewing forth a creamy load over the leather couch at the same time. With a satisfied grunt, Boghrim eventually pulls out of Jason, standing up and leaving the blissed-out human lying in a puddle of his own cum.";
				...
				say "     [line break]";
				say "     As the orcs start chatting among themselves about what they'll hunt while moving quickly towards the entrance, you kinda feel the urge to also go out rise inside you. Do you want to join the throng of orc hunters and see what happens out there?";
				if player consents:				
					say "     [line break]";
					...
					otherwise if fightoutcome >= 10 and fightoutcome <= 19: [won]
						...
						say "     [line break]";
						say "     This now leaves you alone in the wood, with a powerful feral beast in your grasp and at your mercy. In short, he's exactly what you need to impress everyone back at the orc lair. Do you want to introduce the canine into his new role as an orcish fuckhole, or maybe just knock him out, leaving the beast to roam free while you go back empty handed?";
						if player consents:
							say "     [line break]";							
			...
			otherwise if hp of Orc Mob is 7: [orc hunt final accounting]
				...
				say "     [WaitLineBreak]";
				say "     Tension rises in the room for a moment as Boghrim lets his gaze wander over the gathered crowd, with several of the big brutes deflating a little as he passes them without calling out that they've won. Then finally, he focuses on someone and gives a wide tusk-baring grin. ";
			...
			otherwise if hp of Orc mob is 8:
				say "     Joining the orc warriors in their reveling, you soon find yourself in their midst with an orc brew in your hand, listening to boastful stories how this one [one of]fucked a minotaur[or]fucked a latex fox till it was ballooned up to a cream-filled sphere[or]made an incubus drink his cum[or]punched out a shaft beast with one hit[or]got sucked off by a weird anime fan-girl[or]humped an orca[at random] or that one [one of]brought down a behemoth[or]had a poodle lap his dick[or]pounded a wyvern into submission[or]used a rubber tigress as a fleshlight[at random]. To fit in, you make up a story about turning [one of]an alpha husky[or]a German Shepherd[or]a hyena[or]a centaur[at random] into your private bitch and get cheers as you finish the imaginary conquest. All in all, you have a pretty good time with the other orcs, then eventually leave them to get back to other matters. But even as you do, the story you invented is still at the forefront of your mind, with your inner orc pushing hard against your will to accept him and put those thoughts into reality.";
				decrease humanity of player by 10;
				decrease thirst of player by 20;
				infect "Orc Warrior";
				if thirst of player < 0:
					now thirst of player is 0;					
		otherwise: [refuse to participate]
