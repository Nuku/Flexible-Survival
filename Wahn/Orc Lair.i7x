...
instead of conversing the Orc Mob:
	...
	otherwise:
		...
		if player consents: 
			...
			otherwise if hp of Orc Mob is 5:
				say "     The orcs seem pretty busy with drinking and fucking the small crowd of communal slaves already. Seems like the next round of the hunt isn't quite ready yet.";
				say "     <Wahn: And it won't be until I write it. This is the end of this quest-chain, as of now.>";
