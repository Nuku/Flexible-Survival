		...
		if anallevel > 1:
			if "Dominant" is listed in feats of player:
				...
				if player consents:
					...
					say "     As you collapse in exhaustion, one of the orcs looks down on you and grins, lust in his eyes. 'You got spunk, [if player is not male and player is female]girl[else]boy[end if] - I like it. Try to keep some of it when you become a breeder.' His buddy steps up and gives your ass a rough squeeze, then says 'Hold your horses, Yatur - this one has that crazy gleam in [if player is not male and player is female]her[else]his[end if] eyes... might be a biter. Remember the maniac squirrel bitch?' At that comment, the first orc crosses his legs with a pained expression, then gives an annoyed grunt and pushes you away from him. He says 'Let's leave this wretched thing and just enjoy the other one' and they unceremoniously turn around and leave, carrying their captive with them.";
					move Val to Slave Cell 1;
					now ValPregCounter is 48;
					now thirst of Val is 1;
					now SlaveRaidEncounters is 2;
...
to say LoseToOrcRaid:
	say "     As you collapse in exhaustion, one of the orcs looks down on you and grins, lust in his eyes. 'You got spunk, [if player is not male and player is female]girl[else]boy[end if] - I like it. [if OrcSlaverStatus is 3]Even after being broken in, you're still struggling -you'll bear strong sons.' [else]Try to keep some of it when you become a breeder.' [end if]His buddy steps up and gives your ass a rough squeeze. 'Nice - I bet there'll be fights who gets to fuck that after we've had our fun with you!' With that said, they tie you up and carry you off, lugged over an orc's shoulder.";
