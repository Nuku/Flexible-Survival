	...
	if player consents:
		...
		if cocks of player > 0:
			...
			otherwise if calcnumber is 3:			[fuck Ares]
				...
				say "     After you don't know how long of an amazing time for the three of you, you can hear the pitch of Xerxes['] moans rise up into a crescendo, sounding through the whole park as he orgasms and sprays his load all over the ground. That creates a bit of a chain reaction, as the feeling of his inner muscles twitching and trembling around his manhood pushes Ares over the edge right with hem. He joins the young man in climax only a moment later, grinding his hips against Xerxes as he fills his asshole with his human seed. And with each blast of cum into Xerxes, Ares['] anal muscles clench and tighten around your own thrusting manhood, a bit as if he was jerking you off inside his ass. The pleasant feelings that gives you can't be denied for very long, and after just a few more deep penetrations, you come, grunting almost incoherently from the force of your orgasm. Spurt after spurt of your load blasts deep into Ares, leaving you panting breathless while leaning against his back.";
				say "     [WaitLineBreak]";
				say "     While his cock and balls twitch with the last spurts of cum into Xerxes, the transformed dog just keeps holding on to him, panting with his head resting against his shoulder. His instincts are telling him that he has a knot and has to wait for it to go down, even though that's no longer the case. You don't really mind that he wants to stay balls deep inside Xerxes['] freshly bred hole for a while, as that gives you time to put your clothes back on and gather up your gear. Some time later, when Ares is soft enough to pop out on his own, you pick up the leash again and call for Xerxes to walk by your side.";	
		otherwise if cunts of player > 0:
			...
			otherwise if lust of Xerxes < 7:
				...
				say "     Xerxes even tries to use him hands a little, rubbing your crotch and pushing a finger into your vagina to stroke it. He's still a little unsure in using him hands, but she's certainly improving now that he's discovered they can be used to pleasure his loving mistress. With his eager attention, your arousal quickly builds up and up and the need to come rises inside you.";
			otherwise:
		...
		otherwise:
			...
			otherwise:
				say ".  With his increased awareness, he's become more responsive and even more eager in his oral play.";
				say "     Xerxes even tries to use him hands a little, rubbing your crotch and stroking the inside of your leg. He's still improving with using his hands, but his attentiveness to your instructions is quickly paying off. With his eager attention, your arousal quickly builds up and up and the need to come rises inside you.";
