...
to say AwesomeXerxesSex1:
	...
	if Player is male:
		...
		say "     Having gotten your permission to eventually get a tattoo and those tasty treats to fill his tummy, he stretches out on his back and rubs his [if Ball Size of Player > 6]bloated[else if Ball Size of Player > 5]stuffed[else]full[end if] belly with a happy grin on his handsome face.";
	else if Player is female:
...
to say AwesomerHelenSex1:
	...
	if Player is male:
		...
		say "     Having gotten your permission to eventually get a tattoo and those tasty treats to fill her tummy, she stretches out on her back and rubs her [if Ball Size of Player > 6]bloated[else if Ball Size of Player > 5]stuffed[else]full[end if] belly with a happy grin on her beautiful face.";
	else if Player is female:
