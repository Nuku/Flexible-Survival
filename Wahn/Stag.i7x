...
to say AresHelenParkMounting:
	...
	if hp of Ares < 3:  [no sex before]
		...
		say "     [line break]";
		say "     If he still was a normal dog, he'd likely have knotted her by now and you'd be powerless to do anything about this. But he isn't, and you doubt he understands that he doesn't have a knot anymore. Do you let Ares continue ([link]Y[as]y[end link]), or pull him off Helen ([link]N[as]n[end link])?";
...
to say AresXerxesParkMounting:
	...
	if hp of Ares < 3:  [no sex before]
		...
		say "     [line break]";
		say "     If he still was a normal dog, he'd likely have knotted Xerxes by now and you'd be powerless to do anything about this. But he isn't, and you doubt he understands that he doesn't have a knot anymore. Do you let Ares continue ([link]Y[as]y[end link]), or pull him off Xerxes ([link]N[as]n[end link])?";
