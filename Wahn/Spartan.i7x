...
[Version 2.2 - Added scene bypass - Gherod]
...
to say Spartan fucked:
	...
	CreatureSexAftermath "Spartan Warrior" receives "AssFuck" from "Player";
...
to say Spartan oral:
	...
	if Player is male:[male + herm]
		...
		CreatureSexAftermath "Spartan Warrior" receives "OralPussy" from "Player";
...
When Play begins:
	...
	now MilkItem entry is "spartan warrior milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "spartan warrior cum"; [ Item to be given to the player if they have this infection and jerk off. ]
					...
					if Player consents:[sex with the slave-servant]
						...
						if Player is male: [males]
							...
							if Player consents: [get blown and cum in his mouth]
								...
								CreatureSexAftermath "Helot Manservant" receives "OralCock" from "Player";
								infect "Spartan Warrior";
								WaitLineBreak;
							...
							if Player consents:[let him get you off orally]
								...
								CreatureSexAftermath "Helot Manservant" receives "OralPussy" from "Player";
								infect "Spartan Warrior";
								WaitLineBreak;
