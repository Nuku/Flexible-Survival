Version 1 of Spartan by Wahn begins here.
...
when play ends:
	if bodyname of player is "Spartan":
		if humanity of player is less than 10:
			say "Battling anyone you come across to get ahead in the 'trial' you think you're in, you establish a respectable position for yourself among the other spartans around in the area. In between fights, you keep yourself busy with training (and fucking) sessions with promising other spartans, and also with fathering the next generation of spartan warriors in all the 'slaves' (anyone not a spartan) out there for your enjoyment.";
			...
			say "Being used to discipline and training, you and your compatriots fit right in... well, except your urges to breed more spartans and the belief that any female should spread her legs and allow you to do so. Being an exceptionally good unit otherwise, the military decides to makes special arrangement, and soon several dozen female huskies from the city are added to your roster to 'help with morale' and keep the men busy.";
		otherwise:
