...
"Coyote"	"[PrepCombat_Coyote]"

to say PrepCombat_Coyote:
	say "";
...
When Play begins:
	...
	now Species Name entry is "Coyote"; [ Name of the overall species of the infection, used so a "male x" and "female x" have "pureblood X" children. ]
	...
	now face entry is "a tan-furred canine muzzle full of sharp teeth, your golden eyes survey your surroundings taking in everything around you, your coyote ears twitch as if listening for something. Your lips curl back in a wicked grin as you think about all the mischief you will cause"; [ Face description, format as "Your face is [Face of Player]." ]
	now body entry is "thin and lanky, with digitigrade legs that end in padded coyote paws, your hands a cross between a human's and a coyote's padded paws. Your bony body's appearance belies its actual strength and agility"; [ Body description, format as "Your body is [Body of Player]." ]
	...
	now MilkItem entry is "coyote milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "coyote cum"; [ Item to be given to the player if they have this infection and jerk off. ]
