...
to say Imp wins:
	...
	say "     'Oh yeah, that's definitely the proper place for a mortal,' the red-skinned humanoid gleefully says as he taps his right hoof on your chest and rubs his crotch. Wearing nothing but a threadbare loincloth, it is painfully obvious that the demon is hard as a rock - his well-sized cock (for the small body-size) standing straight out under the fabric and tenting it. He clearly gets off on ordering others around. With the flick of a clawed hand, your little captor pulls aside the loincloth a moment later, revealing his bright red shaft and starting to jerk it off with gleeful intensity.";
	WaitLineBreak;
	project the figure of Imp_naked_icon;
	WaitLineBreak;
	say "     'You're nothing but a weak little mortal brought down by my might and power, are you? Go on - say it!' he demands from you while beating off, and given your current position you've got little choice but to obey. This arouses the imp even more, prompting him to play with his balls - squeezing them while stroking his shaft faster and faster. Soon, the groans and grunts of his surprisingly deep voice build to a half-shouted roar, and he bucks his hips against the hand gripping his cock, spraying long blasts of cum all over your face. The sheer volume of demonic seed he puts out is almost admirable - but what isn't is the fact that he purposely aims to hit you in inconvenient places like up your nose or in an eye. Thankfully, the little fucker doesn't have good aim, but eventually you're forced to close your eyes tightly as a splashed line of cum covers your cheek up to your forehead.";
...
to say ImpNoSex1:
	...
	if Libido of Skarnoth is 0:
		...
		say "     Even though you've fought off yet another imp, something tells you that this 'Skarnoth' will just keep sending more to harass you. Seems he's quite determined to get his claws on you for some reason. One possible explanation is that you did rescue [bold type]Elijah[roman type] from demonic clutches and made an enemy that way. [bold type]Maybe you should ask the angel about dealing with this sort of problem.[roman type][line break]";
		now Libido of Skarnoth is 3;
	else if Libido of Skarnoth is 4: [player talked to Eli, didn't go through with the attack]
		say "     Even though you've fought off yet another imp, something tells you that this 'Skarnoth' will just keep sending more to harass you. Seems he's quite determined to get his claws on you for some reason. One possible explanation is that you did rescue [bold type]Elijah[roman type] from demonic clutches and made an enemy that way. [bold type]Maybe you should give the angel's idea of a counterattack some thought after all.[roman type][line break]";
...
to say ImpSex2:
	...
	CreatureSexAftermath "Player" receives "PussyDildoFuck" from "Imp Male";
...
to say ImpSex3:
	...
	CreatureSexAftermath "Player" receives "AssDildoFuck" from "Imp Male";
...
"Imp Male"	"[PrepCombat_Imp Male]"

to say PrepCombat_Imp Male:
	setmongender 3;
...
When Play begins:
	...
	now MilkItem entry is "imp male milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "imp male cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
An everyturn rule: [hellhound bad end progress every turn]
	if Libido of Skarnoth is 10: [player got found and marked]
		if ImpPlayerMarkingTurn - turns is 8:
			...
			LineBreak;
			say "     [bold type]The hellhounds are on your trail and are getting closer! Some other prey might have distracted them for now, but you don't doubt that they'll get back to going after you before long. You really should talk to Elijah about a chance at getting out of this impending doom![roman type][line break]";
			...
			LineBreak;
			say "     [bold type]The hellhounds are on your trail and are getting closer! You really should talk to Elijah about a chance at getting out of this impending doom![roman type][line break]";
