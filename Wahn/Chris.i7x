...
to say ChrisDesc:
	...
	otherwise if libido of Chris is 1: [breeder Chris]
	...
	otherwise if libido of Chris is 2: [warrior Chris]
...
instead of navigating Grey Abbey Library while (libido of Chris is 2 and Chris is in Grey Abbey 2F and Dexterity of Chris is 0):
	...
	if player consents:
		...
		say "     [line break]";
		say "     Do you watch Chris fuck Kai ([link]Y[as]y[end link]), or will you pull the zebra out of Chris['] grip and set him free ([link]N[as]n[end link])?";
		if player consents:
			say "     [line break]";
