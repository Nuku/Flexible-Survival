...
When Play begins:
	...
	add "Elven Hunter" to infections of HumanList; [close enough to pass]
	add "Elven Hunter" to infections of MagicalList;
	add "Elven Hunter" to infections of OtherworldlyList;
	add "Elven Hunter" to infections of MaleList;
	add "Elven Hunter" to infections of BipedalList;
