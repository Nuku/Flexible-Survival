...
instead of fucking the Gregory:
	if HP of Gregory is 1: [unconscious]
		...
		else if "GregoryPlans_Offlimits" is listed in Traits of Urik:
			say "     You told Urik that you don't want anyone to mess with Gregory that way, including yourself. Going back on your word and decisions is a quick way to lose respect from those around you. Maybe once the soldier wakes up, you can talk to him about having some fun, but right now that's out of the question, according to your own rules.";
		else:
...
to say GregoryUnconsciousSex_Explore: [groping and feeling up Gregory]
	...
	WaitLineBreak;
	say "     Gregory's wing-membranes are thin, but quite flexible, and do not appear to provide the former soldier with much sensual feedback, as he doesn't stir when you stroke over them, or pull one wing to the side to see its full extent. Folding it back against his side, you switch to checking out the unconscious man's legs next. He's got five clawed toes on his digitigrade feet - which again to not appear to be ticklish, at least right now. Further up, there are nicely developed leg muscles, which you feel and squeeze with both hands as you move along, soon reaching the partially transformed human's crotch. His privates are still in the familiar setup of there being a single cock and a pair of balls, but the shape of his manhood clearly has had some adjustments done to it. Gregory's dickhead has more of a pointy shape to it now, with some interesting-looking ridges along the twelve inch shaft.";
	say "     Cupping the sack of his balls with one hand, you wrap the other around his cock, stroking and fondling the unconscious man. His length lies warm in your grasp, unsurprisingly hardening and filling out given the stimulation you're giving him. From the weight and fullness of his balls, you have little doubt that Gregory is a virile male, and could easily father offspring if used as a stud. You're tempted to continue playing with him and milk a load out of the man, ";
	if Anallevel > 1:
		say "but then tell yourself that you have one more thing to check out. Letting your fingers stray past the balls, you run them up and down along the crack of his ass. With your middle finger brushing over his pucker, you push in a little against it, [if AnalVirgin of Gregory is true]which is met by some resistance as the muscle reflexively contracts, and you can hear Gregory let out a somewhat uncomfortable groan at the same time. Looks like he isn't used to being touched there, and in all likelihood is a virgin[else]which is met by a bit of resistance before your fingertip enters the man's rear. You can hear Gregory let out a slightly uncomfortable groan at the same time. No longer a virgin, as he was when you brought him in, the man still isn't fully used to being touched there[end if]. ";
	else:
...
to say GregoryUnconsciousSex_Fingering:
	...
	say "     You proceed with a double assault on the soldier's pleasure-spots, using one hand (and two fingers of that, by now) to stimulate his asshole, while the other hand is wrapped around his erection, jerking up and down along its length. Gregory's breath starts to come quicker and quicker as you push his body further. Then suddenly, you can feel a shudder go through him, from head to toe, with the man's muscles spasming and his asshole clenching on your invading fingers as Gregory starts to unload. You can feel his shaft throb and pulse in your grasp as it erupts with creamy white cum, creating wet streaks along the cushions his dick is pressed against. Continuing to stimulate and milk him all throughout his orgasm, you glance proudly at your handiwork when the half-wyvern eventually winds down. At that point, you pull the pillows out from under him and fling them aside, then roll the still unconscious man over again, to rest on his back once more.";
