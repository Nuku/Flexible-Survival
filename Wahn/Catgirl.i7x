...
LastCatgirlFuck is a number that varies. LastCatgirlFuck is usually 555.
...
instead of going outside from Bunker while (CatgirlFucked is 3):
	move player to Grey Abbey Library;
	if debugactive is 1:
		say "     DEBUG: FIONA FIRST WALKIN [line break]";
	say "[FionaFirstMeeting]";
...
to say FionaFangSex:
	...
	otherwise:
		say "     The library is filled with yowls, growls and the scratching or claws on the ground as you enter - sounds like Fiona and Fang are at it again... do you want to watch ([link]Y[as]y[end link]), or would you rather leave what will happen to happen and turn your attention elsewhere ([link]N[as]n[end link])?";
		if player consents:
			say "     [line break]";
...
instead of going outside from Bunker while (CatgirlFucked > 3 and FionaCarlStatus is 0 and Carl is in Grey Abbey 2F and (LastCatgirlFuck - Turns) > 10 and hp of Carl is 10):
	move player to Grey Abbey Library;
	if debugactive is 1:
...
to say FionaCarlMeet:
	...
	otherwise:
		say "     [line break]";
		say "     Do you want to watch as they go at it?";
		if player consents:
			say "     [line break]";
...
to say FionaCarlRepeatFuck:
	...
	say "     [line break]";
	say "     Do you want to walk up to them and watch as they go at it?";
	if player consents:
		say "     [line break]";
