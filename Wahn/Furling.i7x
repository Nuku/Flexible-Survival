...
[Version 1 - Infection Texts adjusted]
...
to say Furling wins:
	if (cocks of player > 0): 	[male]
		...
		say "     The thrusting and grinding gets harder and faster until just can't hold out any more. Grunting in satisfaction, you thrust up one last time, then start blowing your load, with spurt after spurt of fertile seed shooting into your larger partner's womb. Then suddenly you hear a crunching sound left and right of your head. Looking over, you realize it's the furling's claws digging into the concrete floor as he holds on too tight when he joins you in his own mind-blowing orgasm. He stays like that for a moment to catch his breath, your hard shaft still inside his pussy. Then the muscled cuntboy pulls off and stands up. Giving you a last look from high above, he says 'Felt good. Nice man.' then stalks off, leaving you lying there.";
	otherwise:  								[female + neuter]
		say "     Pulling off your clothes with barely any regard for not ripping them, the furling exposes your crotch. Looking at your [if cunts of player is 0]nonexistent [end if]genitals, he growls 'Useless!' then gives you a shove, landing you prone on the ground. With an annoyed grunt, the large creature stalks off.";
...
To say Furling loses:
	...
	if cocks of player > 0:			[male+herm]
		...
		otherwise if calcnumber is 2:			[stroking his pussy]
			...
			say "     Pulling your hand out of his pussy, you wipe it dry against the furling's legfur, then stand up. With the large beast still panting softly and mumbling 'Nice. Make me feel good,' you leave him there and walk away.";
		otherwise:												[leave]
...
to say FurlingDesc:
	...
	say "     [line break]";
	say "     While you're still studying his appearance, the furry beast suddenly roars 'You're mine!' and pounces you.";
...
When Play begins:
	...
	now body change entry is "it is reshaped into a tall form with a wide, powerful build. Your arms grow longer and more muscular, with your hands and feet acquiring sharp claws. An improvised loincloth coalescences out of a cloud of nanites around your hips";
