...
to say MelanieTalk3: [ask to meet Mr. B]
	if HP of Melanie is 100:
		...
		say "As for the raw data he requires to prep all the paperwork, ";
		...
		if Player is male:
			...
			if Player consents:
				...
				WaitLineBreak;
				say "     Panting loudly, you grip the edge of his desk hard as the man pushes ever deeper, then let out a lust-filled gurgle as he bottoms out, his cock-head nudging hard against the inner barrier of your womb. 'Told ya you'd love it babe,' he adds in a very satisfied tone, then pulls back a little to ram his prick home with increased force this time. You writhe under the big male as his dickhead pops past your cervix - a strange sensation, but also... very, very good somehow. This can't be natural - but then again, who can tell these days with the nanites everywhere? No matter which, you feel almost delirious in pleasure from being impaled all the way on this muscular crocodile's shaft!";
				...
				CreatureSexAftermath "Player" receives "PussyFuck" from "Gator Herm";
			else:
				LineBreak;
...
instead of going north from Branson & Partner Reception while (HP of Melanie is 4):
	...
	say "     [link](3)[as]3[end link] - Be friendly and offer a courteous greeting.";
	now calcnumber is 0;
