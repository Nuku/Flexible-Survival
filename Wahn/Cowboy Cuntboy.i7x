...
to say Cowboy_Loses:
	...
	if Player is not neuter: [male/female/herm]
		say "[line break]     [bold type]So, do you want to have sex with him?[roman type][line break]";
...
When Play begins:
	...
	now victory entry is "     As you go down, the cowboy gives you a hard kick in the side with his right hoof that drives the air out of your lungs. 'I don't want to see you out here again, do you hear me, fucker?' You can only groan, in answer to which he gives you another kick and walks off.[line break]";
	now desc entry is "     You run into Corbin, the anthro horse cowboy. He doesn't seem at all happy to see you, balling his fists and rushing forward...[line break]";
	...
	now MilkItem entry is "gypsy horse transman milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "gypsy horse transman cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
cowboy milk is a grab object. cowboy milk is milky.
cowboy milk is infectious. Strain of cowboy milk is "Gypsy Horse Transman".
Usedesc of cowboy milk is "[cowboy milk use]".
Scent of cowboy milk is "Smells like good, fresh milk...".

to say cowboy milk use:
	say "     Screwing the cap off the plastic bottle, you put it to your lips and drink its contents with deep swallows of the fresh and tasty milk.";
	PlayerDrink 10;
