	...
	if cocks of player > 0 or cunts of player > 0:   [male/female/herm]
		...
		if player consents:  [fuck him]
			if cocks of player > 0:   [males]
				...
				say "     With your orgasm rapidly approaching, you've got to decide fast... where do you cum? In (Y) or out (N)?";
...
When Play begins:
	...
	now body entry is "large and muscular, with strong digigrade equine legs ending in powerful hooves. Your hands seem to be slightly hoof-like as well, the ends of your fingers tipped with little hooflet like nails. Your crotch has a pair of small, perky breasts, slightly above the genitals";
