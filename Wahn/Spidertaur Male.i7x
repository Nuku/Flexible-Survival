...
When Play begins:
	...
	now MilkItem entry is "spidertaur male milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "spidertaur male cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
Cunt Depth of Aelias is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
