...
[Version 8 - Reaction to Eric, initial threesome with Eric (cuntboy, horse-hung or sub cuntboy)]
...
to say DavidEricTalk:
	...
	otherwise if hp of Eric is 21 or hp of Eric is 22:	[horse hung Eric]
		say "     '...and then, as I was bandaging my arm, I felt this wrenching pain in my gut and passed out. When I came back to I was...' Eric waves a hand at his crotch. 'You know. Different. And when we tried to fix me later, it made me part horse.' David nods in silent understanding and puts a hand on Eric's shoulder. 'I don't believe I can understand what you went through, but... look at it from this point - you're still a human, good-looking guy and above all still have your own mind. You should see some of the infected out there, behaving like beasts. So what if you're different now down below - that's not all that defines you...' Eric gets a thoughful expression, then bites his lip before... whispering something.";
		say "     Standing there, craning your head to maybe catch his words, you suddenly realize how ridiculous you must look - and that it's not a good thing to spy on friends. Not wanting to listen in any more than you already have, you go to the other side of the room and busy yourself by counting and sorting your supplies.";
		say "     [WaitLineBreak]";
		...
		say "     [line break]";
		say "     Being on a bunk with David on one side and Eric on the other makes your thoughts wander a bit, imagining what it would be like to do... other things on a bed together. From what you can see, they like each other and might possibly be down for it... [if lust of David is 0]though you should break David's ass in first. You'll have to get the soldier used to taking it up the rear end, otherwise he'll refuse to even consider Eric's horsemeat. [otherwise if lust of David > 0]with the pleasure you gave him by shafting his ass before, David would surely like it. [end if][if hp of Eric is 21]And Eric - it'd likely be best if you broke in the newly virgin shaft yourself first...[otherwise if hp of Eric is 22]And Eric - with how much he enjoys his giant cock, you're sure he'll jump at the opportunity. You really should talk to him about it.[end if]";
	now lust of Eric is 2;
