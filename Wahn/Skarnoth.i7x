...
Skarnoth is a man.
ScaleValue of Skarnoth is 4. [human sized]
Body Weight of Skarnoth is 5. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Skarnoth is 8. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
[Body Adjective is generated out of the body weight and body definition and can be used in scenes - one word descriptive adjective depending on weight and definition groups: low weight group: skinny/slender/lithe; mid weight group: average/fit/muscled; high weight group: pudgy/husky/jacked]
Androginity of Skarnoth is 2. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Skarnoth is 6. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Skarnoth is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Skarnoth is 6. [length in inches]
Breast Size of Skarnoth is 0. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Skarnoth is 2. [count of nipples]
Asshole Depth of Skarnoth is 12. [inches deep for anal fucking]
Asshole Tightness of Skarnoth is 3. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Skarnoth is 1. [number of cocks]
Cock Girth of Skarnoth is 4. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Skarnoth is 16. [length in inches]
...
PlayerMet of Skarnoth is false.
PlayerRomanced of Skarnoth is false.
PlayerFriended of Skarnoth is false.
PlayerControlled of Skarnoth is false.
PlayerFucked of Skarnoth is false.
OralVirgin of Skarnoth is false.
Virgin of Skarnoth is true.
AnalVirgin of Skarnoth is false.
PenileVirgin of Skarnoth is false.
SexuallyExperienced of Skarnoth is true.
...
to say SkarnothSex3: [massage/foot scene]
	...
	LineBreak;
	say "     The grin on his face suggests that this might be a particularly rough method, one that [italian type]he[roman type] would enjoy, even. Considering his offer, [bold type]would that be something you would be interested in?[roman type][line break]";
	say "     ([link]Y[as]y[end link]) - Let him do what he wants. (Warning - Foot Fetish Content)";
