...
to say SkarnothSex7: [Spank Skarnoth's ass]
	...
	if SkarnothDrugStatus is 2:
		...
		WaitLineBreak;
		say "     Pushing the demon off of you, he limply rolls onto the ground, leaving you sitting in his chair with your lap completely soaked in his own special version of [']milk[']. Standing up, you attempt to clean yourself up as best you can and make your way to leave, however before you get more than a few steps, you look back towards the moaning demon. While you do enjoy milking the slut through his cock, it could be fun to also milk his muscled man-tits. You would just have to figure out a way to get that to work. On the plus side, if you could do it, then then your little cumdump could also be a source of sustenance for yourself and possibly your allies. A surge of desire shoots through your body as you continue to make your way out of the room and back out into the city.";
	else:
