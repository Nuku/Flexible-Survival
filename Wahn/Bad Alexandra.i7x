...
to say BadAlexandraTalkMenu:
	...
	[]
	if Alexandra_Nightmares is not resolved and "Alexandra_Nightmares_Started" is listed in Traits of Alexandra and "NightmareHunt_Postponed" is listed in Traits of Alexandra:
		choose a blank row in table of fucking options;
		now title entry is "Finding her old uniform and its possible connection to her nightmares";
		now sortorder entry is 24;
		now description entry is "Go check out the alley with the dumpster";
	[]
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if Player consents:
				...
				if (nam is "Contraception"):
					...
					say "[A_SpikeTalk]";
				else if (nam is "Finding her old uniform and its possible connection to her nightmares"):
					say "[AlexandraNightmareHunt_ClothedIntro]";
				wait for any key;
...
to say A_SarahTalk:	[Sarah]
	if Alexandra is in Worker Barracks:
		...
		LibidoBoost 10;
	else if SarahCured is 4: [Sarah is on a libido suppressant regimen now]
...
to say badAlexandraSex5: [Blowjob]
		...
		if lust of Alexandra > 0: [Alexandra is pregnant]
			...
			if lust of Alexandra >= 24 and skipturnblocker is 0: [birthing time]
				if Alexandra is not visible: [player isn't anywhere near her]
					...
					say "     From one moment to the next, the expression on your doberwoman bitch's face changes, and she brings a hand to her bulging stomach. 'Nnghh! Someone's definitely getting unruly in there. That was quite a kick!' The former cop opens her muzzle to say something else, but the next thing that comes out of it is just a strangled groan. A glance down makes it fairly obvious what's going on, as Alexandra's jeans suddenly develop a large wet patch that keeps spreading down the insides of her legs: Her water just broke! ";
					...
					if AlexandraPupDaddy is 1: [player's pups]
						...
						say "     Now that the little dogs have grown a little, you do recognize a bit of Isaac in them. They are definitely still dobermen through and through, but there's just something about the way they look and act that makes it more than clear in your mind that the Friesian stud fathered them. Maybe it's something about the shape of their ears and muzzles, or maybe it's the very intense and shiny black of their fur - it's hard to say. Soon having finished with their drinking from Alexandra, first one, then another of the little ones decides to investigate the person who greeted them into the world. You find yourself beset by curious canines, sticking their noses and licking you everywhere they can reach. Even though they are not yours, they seem to have inherited some of the competitiveness of their father, with one or another pushing to the front to sniff you before he is supplanted by another.";
					else if AlexandraPupDaddy is 8: [random farmhand horseman]
...
2	"Alexandra_Nightmares"	Alexandra_Nightmares	"[EventConditions_Alexandra_Nightmares]"	Grey Abbey Library	2500	2	70

Table of WalkInEvents (continued)
Priority	Name	EventObject	EventConditions	EventRoom	LastEncounterTurn	CoolDownTurns	EncounterPercentage
2	"Alexandra_Nightmares"	Alexandra_Nightmares	"[EventConditions_Alexandra_Nightmares]"	Grey Abbey Library	2500	2	70

to say EventConditions_Alexandra_Nightmares:
	if (Alexandra is in Grey Abbey Library and HP of Alexandra > 1 and HP of Alexandra < 50): [list of conditions here]
		now CurrentWalkinEvent_ConditionsMet is true;

Table of GameEventIDs (continued)
Object	Name
Alexandra_Nightmares	"Alexandra_Nightmares"

Alexandra_Nightmares is a situation.
ResolveFunction of Alexandra_Nightmares is "[ResolveEvent Alexandra_Nightmares]".
Sarea of Alexandra_Nightmares is "Nowhere". [standard walkins that cannot be hunted for are Nowhere, but walkin events can also be made huntable as an alternate access way]

to say ResolveEvent Alexandra_Nightmares:
	if debugactive is 1:
		say "     DEBUG: Alexandra's Nightmares[line break]";
	project the figure of Alexandra_face_icon;
	TraitGain "Alexandra_Nightmares_Started" for Alexandra;
	say "[LibraryEntry_NavOrWalk]";
	say "you come in and notice that Alexandra isn't where she usually hangs out at the front of the building. Curious, you look around a little, and find that she appears to have dragged several of the thin mattresses from the cots down below in the bunker up here, creating a bit of a nest for herself in the corner, behind one of the bookshelves. There, the ex-cop is currently lying, asleep but seemingly restless, having kicked off the blanket that covered her revealing her naked form. She twitches and moves a little in her sleep, her fur pretty matted with sweat, a sign of very active dreams.";
	say "     Maybe Alexandra's chasing squirrels in her dreams, being a dog and all that, bubbles up as a joking thought in your mind. Though with her writhing on the mattresses, and letting out momentary growls at one time or another, it could also be some sort of nightmare. While you're still contemplating that, a hint of a scent hits your nose, and you glance down, seeing that the fur between her legs is moist for another reason entirely - her wet and dripping pussy. Those must be some intense scenes playing out behind her closed lids.";
	LineBreak;
	say "     [bold type]How do you react?[roman type][line break]";
	let Alexandra_Initial_Choices be a list of text;
	add "Step up and gently shake her awake." to Alexandra_Initial_Choices;
	add "Move up to her and wake her, quickly and thoroughly." to Alexandra_Initial_Choices;
	add "Have some fun with the bitch. She's right there and wet already, so..." to Alexandra_Initial_Choices;
	let Alexandra_Initial_Choice be what the player chooses from Alexandra_Initial_Choices;
	if Alexandra_Initial_Choice is:
		-- "Step up and gently shake her awake.":
			LineBreak;
			say "     You step up to the makeshift nest, the thin mattresses rustling softly under your approach. Reaching out, your hand comes to rest gently on Alexandra's shoulder, your touch a subtle disruption to her restless slumber, feeling the damp warmth of her matted fur beneath your palm. Her body twitches once more, a low growl rumbling in her throat, a sound deep and primal, before her eyelids flutter open. Her eyes, usually dark and sharp, are momentarily unfocused, squinting against the dim light filtering through the dusty library shelves. A soft moan escapes her lips as she slowly pushes herself up, the movement causing her bare breasts to jiggle gently, their firm curves a stark, alluring sight against her sweat-slicked, muscular torso. She rubs at her temples, trying to chase away the lingering shadows of her dreams.";
			say "     'Hi Boss,' she grumbles, her voice rough with sleep and discomfort. A sigh escapes her, and she shakes her head, dislodging a few stray strands of matted fur. 'Damn nightmares, been having [']em since yesterday. They always start out the same, you know? Me, back on the beat, a good little two-shoes cop, walking my old patrol route. But then I turn a corner, and everything goes... sideways. Weirder, otherworldly. Full-on nightmare fuel.' She pauses, a shiver running through her muscular frame. 'There are fights, against who-knows-what, always changing, and... fucking, too. Look, Boss, I don't mind a good scuffle, and I'm definitely not against a good fuck. But being pushed into it against my will in my own head? That's not exactly my idea of a good time.' She groans, flexing her arms, her bare breasts shifting with the movement. 'It's taken its toll. Haven't had a proper night's sleep in days, so if you maybe got any idea on how to fix that annoying thing, I'm all ears.'";
			WaitLineBreak;
			say "     You consider her words for a moment, the tension in the air a sharp contrast to the logic forming in your mind. The nightmares always start with Alexandra in her cop uniform, a relic of a past life you'd helped her shed. You ask her where that old cop uniform even is, remarking you haven't seen it since she became your bad bitch. Her muscles tense, a flicker of something unreadable in her dark eyes before it's replaced by a familiar grumble. 'Ugh, that old thing?' she mutters, a dismissive flick of her ear. 'Got rid of it in a dumpster, in an alley just down the street. Figured it was just dead weight.'";
		-- "Move up to her and wake her, quickly and thoroughly.":
			LineBreak;
			say "     You stride purposefully toward the makeshift nest, the thin mattresses rustling softly under your firm approach. Reaching out, your hand clamps down on Alexandra's shoulder, a sharp, insistent squeeze designed to cut through her restless slumber. The damp warmth of her matted fur feels taut beneath your palm. Her body jolts, a startled, deep growl rumbling in her throat as her eyes snap open, instantly alert and dark. She blinks, quickly assessing her surroundings, then you, her focus sharpening with a sudden, intense awareness. A sharp groan escapes her lips as she abruptly pushes herself upright, the forceful movement causing her bare breasts to jiggle vigorously, their firm curves a stark sight against her sweat-slicked, muscular torso. She shakes her head once, a quick, efficient motion.";
			say "     'Boss,' she grunts, her voice sharp, stripped of any lingering sleepiness, though still rough with discomfort. A frustrated sigh escapes her, and she runs a paw over her face, dislodging a few stray strands of matted fur. 'Damn nightmares, they've been dogging me since yesterday. Always the same setup, you know? Me, back on the beat, all badge and rulebook, walking my old patrol. But then I hit a corner, and everything goes to hell. Weirder, otherworldly. Pure nightmare fuel.' Her muscular frame shivers, a brief, involuntary tremor. 'There are fights, against who-knows-what, always shifting, and... fucking, too. Look, Boss, I can handle a brawl, and I'm definitely a fan of a good screw. But being forced into it in my own head? That's not my idea of a good time.' She groans again, flexing her arms, her bare breasts shifting with the movement. 'It's taken its toll. Haven't had a proper night's sleep in days, so if you maybe got any idea on how to fix that annoying thing, I'm all ears.'";
			WaitLineBreak;
			say "     You consider her words for a moment, the tension in the air a sharp contrast to the logic forming in your mind. The nightmares always start with Alexandra in her cop uniform, a relic of a past life you'd helped her shed. You ask her where that old cop uniform even is, remarking you haven't seen it since she became your bad bitch. Her muscles tense, a flicker of something unreadable in her dark eyes before it's replaced by a familiar grumble. 'Ugh, that old thing?' she mutters, a dismissive flick of her ear. 'Got rid of it in a dumpster, in an alley just down the street. Figured it was just dead weight.'";
		-- "Have some fun with the bitch. She's right there and wet already, so...":
			LineBreak;
			if Player is not male: [females, neuters]
				say "     You move silently towards the makeshift nest, the thin mattresses barely rustling under your approach. Reaching out, your fingers find the damp warmth of Alexandra's matted fur, tracing a deliberate path down her muscular flank, towards her inner thigh. The lithe but powerful anthro body twitches, and a low, guttural growl rumbles deep in her chest, a sound primal and wild. Her eyelids remain stubbornly closed, yet her breath quickens, catching in ragged gasps. The growl deepens, evolving into a frustrated moan as her powerful hips twist and writhe restlessly against the makeshift nest. Clearly, she is still caught in the throes of her nightmare, a struggle that, even in sleep, is undeniably turning erotic, her form subtly twitching with the internal turmoil.";
				say "     Your fingers delve between her powerful thighs, parting the soft, slick fur around her pussy. It's already surprisingly wet, hot, and swollen, a clear sign of her agitated slumber. Slipping a finger past the matted fur, you find the warm, yielding entrance of her sex. Her breath hitches sharply, a guttural sound torn from her throat. Hips buck harder against your hand, a desperate, unconscious plea for the intensifying sensation that now blends seamlessly with the phantom touch of her nightmare. You push one finger inside, then a second, slow and deliberate, stretching her slick depths, the fur brushing sensuously around your digits. Dream-growls become desperate whimpers, her muscular body arching off the mattress, seeking more of the profound sensation.";
				WaitLineBreak;
				say "     Rhythmically, you stroke deep inside her, fingers pumping and twisting, pushing her closer and closer to the edge. Internal muscles clench around your fingers, a tight, wet grip that heightens your own senses. Moans grow louder, more insistent, her head thrashing against the pillow, sending stray strands of fur flying. Alexandra's tongue darts out, licking at the air, tasting the phantom pleasure of her dream. With each thrust, her hind legs kick out, paws scrambling against the thin mattress, her entire, strong body a coiled spring of escalating desire. Bare breasts bounce with her frantic movements, glistening with sweat, her dark nipples hard points of pure arousal. The growls and whimpers build into a desperate, drawn-out plea, a single, guttural sound torn from her throat, her anthro anatomy fully responding to the internal storm.";
				say "     Suddenly, her body tenses, every powerful muscle locking in a fierce spasm. A raw, guttural scream rips from her lungs, her head snapping back, mouth wide in a silent roar. Hips buck violently, pushing her pussy fiercely against your fingers as a powerful orgasm rocks her entire frame. Internal muscles milk your fingers with shocking intensity, waves of exquisite pleasure forcing themselves from her. Her body shudders uncontrollably, a long, drawn-out tremor that slowly subsides, leaving her gasping and utterly spent, her fur damp, her pussy still twitching around your fingers. Wide and unfocused, her eyes finally flutter open. She meets your gaze, then offers a slight eyeroll. 'Huh? Boss?! You're one kinky motherfucker,' she grumbles, her voice rough, sleep-heavy, but now tinged with profound satisfaction. 'I thought the end of things there felt different than usually.' You ram your fingers back into her one last time, spreading her folds in a clear gesture of who is in charge, then ask what's going on with her.";
				NPCSexAftermath Alexandra receives "Stroking" from Player;
				WaitLineBreak;
				say "     A weary sigh escapes her, and she runs a paw over her face, dislodging a few stray strands of matted fur. 'Damn nightmares,' she begins, her voice still rough, 'they've been dogging me since yesterday, always the same setup. I'm back on the beat, all badge and rulebook, walking my old patrol. But then I hit a corner, and everything goes to hell - weirder, otherworldly, pure nightmare fuel.' Alexandra's muscular frame shivers, a brief, involuntary tremor. 'There are fights, against who-knows-what, always shifting, and... fucking, too. Look, I can handle a brawl, and I'm definitely a fan of a good screw.' Her eyes, now burning with a fierce, unleashed desire, drop to your hand still buried inside her pussy. With a low, rumbling growl, she grinds her crotch against your palm, pushing herself harder onto your fingers. One of her paws reaches down, strong and nimble, pulling your hand tighter against her, a clear, unmistakable invitation for more.";
				say "     'But being pushed into it against my will in my own head?' she continues, her voice now a low purr of anticipation as her hips continue to press against your hand. 'That's not my idea of a good time. What you're doing right now,' she adds, her gaze locking onto yours, 'that's a whole different story. This dream fuckery on the other hand - It's taken its toll. Haven't had a proper night's sleep in days, so if you maybe got any idea on how to fix that annoying thing, I'm all ears.' She groans, stretching her arms above her head, her bare breasts jiggling with the movement as she settles her gaze back on you, a clear question in her dark, hungry eyes.";
				WaitLineBreak;
				say "     You consider her words for a moment, the rhythmic pulsing of her pussy around your fingers a distracting counterpoint to the logic forming in your mind. The nightmares always start with Alexandra in her cop uniform, a relic of a past life you helped her shed. You ask her where that old cop uniform even is, remarking you haven't seen it since she became your bad bitch. Her muscles tense around your fingers, a flicker of something unreadable in her dark eyes before it's replaced by a familiar grumble. 'Ugh, that old thing?' she mutters, a dismissive flick of her ear. 'Got rid of it in a dumpster, in an alley just down the street. Figured it was just dead weight.'";
			else: [anyone with a cock gets to fuck her]
				say "     [if Player is not naked]You quickly strip down, then [else]You move [end if]silently towards the makeshift nest, the thin mattresses barely rustling as you approach. Hands find the damp warmth of Alexandra's matted fur, tracing a deliberate path down her muscular flank, towards her inner thigh. Her body twitches, a low, guttural growl rumbling deep in her chest, a sound primal and wild. Her eyelids remain stubbornly closed, but breath quickens, catching in ragged gasps. The growl deepens, evolving into a frustrated moan as her powerful hips twist and writhe restlessly against the makeshift nest. Clearly, she is still caught in the throes of her nightmare, a struggle that, even in sleep, is undeniably turning erotic, her anthro form subtly twitching with the internal turmoil.";
				say "     Your hands delve between her powerful thighs, pushing them apart with firm, insistent pressure. The move reveals the swollen, wet lips of her sex, surprisingly hot, engorged and glistening, a clear sign of her agitated slumber. [if Player is not naked]Quickly stripping down [else]You [end if]press your hard cock against the warm, yielding entrance. Her breath hitches sharply, a guttural sound torn from her throat. Hips buck harder against your pelvis, a desperate, unconscious plea for the intensifying sensation that now blends seamlessly with the phantom touch of her nightmare. Slowly and deliberately, you slide inside, stretching her slick depths, your shaft pushing past the matted fur and into her tight, wet slit. Still, she does not wake.";
				WaitLineBreak;
				say "     You begin to thrust deep inside your sexy bitch, hips pumping and twisting, burying yourself to the hilt, pushing her closer and closer to the edge. Internal muscles clench around your cock, a tight, wet grip that nearly steals your breath. Moans grow louder, more insistent, her head thrashing against the pillow, sending stray strands of hair flying. Her tongue darts out, licking at the air, tasting the phantom pleasure of her dream. With each powerful plunge, hind legs kick out, paws scrambling against the thin mattress, her entire, strong body a coiled spring of escalating desire. Her bare breasts bounce with her frantic movements, glistening with sweat, her dark nipples hard points of pure arousal. The growls and whimpers build into a desperate, drawn-out plea, a single, guttural sound torn from Alexandra's throat, her anthro anatomy fully responding to the internal storm.";
				say "     Your own climax builds, a powerful surge of heat and pressure. With a final, deep thrust, you bury yourself fully, pumping your hot load deep inside the ex-cop, filling her with a thick creampie that pulses into her waiting womb. Even as your body shudders from the release, you remain balls-deep, your cock buried all the way within her wet heat. Your hand moves, finding her clit, swollen and prominent. You begin to rub, firm and insistent, adding another layer of intense sensation to the deep, lingering penetration. The dobie's entire body responds, arching violently, her guttural cries now a continuous stream of pure, unadulterated pleasure. Her pussy grips your throbbing cock tightly, milking every inch of your shaft as her clit is mercilessly stimulated. She is a whirlwind of furious pleasure, utterly consumed by the sensations, still not fully awake, but fully responsive to the powerful assault on her senses. The climax you're building for her is imminent, a furious storm breaking just beneath the surface of her sleep, your hard cock a constant presence within her.";
				WaitLineBreak;
				say "     Suddenly, her body tenses, every powerful muscle locking in a fierce spasm. A raw, guttural scream rips from her lungs, her head snapping back, mouth wide in a lustful roar. Hips buck violently, pushing her pussy fiercely against your pelvis as a powerful orgasm rocks her entire frame. Internal muscles milk your still-throbbing cock with shocking intensity, waves of exquisite pleasure forcing themselves from her, and you feel another surge of your own cum, thick and hot, pump into her. Her body shudders uncontrollably, a long, drawn-out tremor that slowly subsides, leaving her gasping and utterly spent, her fur damp, her pussy still twitching around your spent cock.";
				say "     Her eyes, wide and unfocused, finally flutter open. She meets your gaze, confusion giving room to a slight eyeroll. 'Huh? Boss?!' Alexandra grumbles, her voice rough, sleep-heavy, but now tinged with profound satisfaction. 'You just climbed on top of me and used me, didn't you? Exactly what I've learned to expect from you, you kinky motherfucker. I thought the end of things there felt different than usually.' Even as she speaks, a strong, deliberate squeeze of her pussy around your still-buried shaft tells you, without a doubt, that she's very much into the sensation and feeling, a silent, powerful affirmation of her enjoyment.";
				now lastdobiemess is 1;
				increase AlexandraCreampieCount by 1;
				impregAlexandraChance with "Player";
				NPCSexAftermath Alexandra receives "PussyFuck" from Player;
				WaitLineBreak;
				say "     A weary sigh escapes her, and she runs a paw over her face, dislodging a few stray strands of matted fur. 'Damn nightmares,' she begins, her voice still rough, 'they've been dogging me since yesterday, always the same setup. I'm back on the beat, all badge and rulebook, walking my old patrol. But then I hit a corner, and everything goes to hell - weirder, otherworldly, pure nightmare fuel.' Alexandra's muscular frame shivers, a brief, involuntary tremor. 'There are fights, against who-knows-what, always shifting, and... fucking, too. Look, I can handle a brawl, and I'm definitely a fan of a good screw.' Her eyes, now burning with a fierce, unleashed desire, drop to your cock still buried inside her pussy. With a low, rumbling growl, she grinds her crotch against your body.";
				say "     'But being pushed into it against my will in my own head?' she continues, her voice now a low purr of anticipation as her hips continue to press against your hand. 'That's not my idea of a good time. What you did a moment ago,' she adds, her gaze locking onto yours, 'that's a whole different story. This dream fuckery on the other hand - It's taken its toll. Haven't had a proper night's sleep in days, so if you maybe got any idea on how to fix that annoying thing, I'm all ears.' She groans, stretching her arms above her head, her bare breasts jiggling with the movement as she settles her gaze back on you, a clear question in her dark, hungry eyes.";
				WaitLineBreak;
				say "     You consider her words for a moment, the rhythmic pulsing of her pussy around your shaft a distracting counterpoint to the logic forming in your mind. The nightmares always start with Alexandra in her cop uniform, a relic of a past life you helped her shed. You ask her where that old cop uniform even is, remarking you haven't seen it since she became your bad bitch. Her muscles tense around you, a flicker of something unreadable in her dark eyes before it's replaced by a familiar grumble. 'Ugh, that old thing?' she mutters, a dismissive flick of her ear. 'Got rid of it in a dumpster, in an alley just down the street. Figured it was just dead weight.'";
	say "     She shrugs, a fluid motion of her powerful shoulders. 'Should still be there, Boss. It's not like anything in the city still works, least of all trash pickups. Why?' Her head tilts, an inquisitive glint in her eyes. 'You wanna go check it out? Could be a fun little scavenger hunt, if you're into that sort of thing.' A wicked grin spreads across her muzzle, a mischievous spark in her gaze.";
	say "     [bold type]Do you want to go there with Alexandra now (Y), or postpone till later (N)?[roman type][line break]";
	if Player consents:
		LineBreak;
		say "[AlexandraNightmareHunt_NudeIntro]";
	else:
		LineBreak;
		say "     You consider her offer for a moment, then tell her that you don't want to go off to some grimy alley right now. A low chuckle rumbles in Alexandra's chest, and she meets your gaze with an amused glint in her dark eyes. 'Fine, Boss, drag your heels,' she drawls, a hint of playful exasperation in her tone. 'I'll just be over here fighting off exhaustion with some well-deserved naps, then. Wake me up when you finally get your act together and decide what you want to do. Just chat me up when it's finally go-time,' she adds, in a challenge that brings a sharp twitch to her ears and a knowing smirk to her muzzle.";
		TraitGain "NightmareHunt_Postponed" for Alexandra;

to say AlexandraNightmareHunt_NudeIntro:
	say "     A decision made, you step back, instructing Alexandra to prepare. Your gaze lingers unashamedly over her shapely, muscular body, eyes devouring the firm curves of her bare breasts, still slightly glistening with sweat from her intense dream, down the flat, taut stomach, and across the powerful lines of her thighs. Her pussy, swollen and slick, twitches enticingly, its matted fur wet and parted, revealing the deep, shadowed folds beneath. A faint, musky scent of arousal, a blend of her natural dog musk and the fresh juices of her recent climax, emanates, pulling at your senses. She catches your lingering stare, a slow, knowing grin spreading across her muzzle, her dark eyes flashing with understanding and challenge.";
	say "     'Oh, looking forward to the show, Boss?' she purrs, a low, husky rumble in her throat as she stretches languidly. Her body arches and flexes, a deliberate provocation that makes her bare breasts jiggle violently, their full weight swaying, nipples hard and dark. 'Don't worry, plenty more where that came from later. All of it, Boss. Every inch.' With a confident sweep, she reaches for her ripped jeans and worn leather jacket, her movements fluid and unhurried. As she pulls the denim up her powerful legs, her ass flexes, a tantalizing display of tightly furred muscle, the deep cleft of her butt disappearing into the denim. She shrugs into her jacket, leaving it unzipped to showcase her bare, heaving chest, then turns to you, a predatory glint in her dark eyes. 'Right then, Boss. Time to hit the mean streets, eh?'";
	say "[AlexandraNightmareHunt_Main]";

to say AlexandraNightmareHunt_ClothedIntro:
	say "     You make the decision to check out the old cop uniform, and say as much to Alexandra. Her dark eyes, sharp and alert, watch your expression, a low growl of impatience rumbling in her chest. Dressed in her ripped jeans and worn leather jacket, she stands poised at the entrance, more than ready for action. Her bare breasts remain proudly exposed, firm and prominent, readily accessible beneath the open jacket. She meets your gaze with an expectant, challenging glint in her dark eyes. 'Finally got your act together, Boss?' she grumbles, her voice a rough purr. 'Took you long enough. Ready to go hunt down some answers?'";
	say "[AlexandraNightmareHunt_Main]";

to say AlexandraNightmareHunt_Main:
	say "     The two of you set out, walking briskly down the dusty, debris-strewn street, Alexandra's powerful stride easily matching yours. The alley she mentioned isn't far, a narrow chasm between two derelict buildings, choked with the refuse of a city brought to its knees. A few overturned dumpsters lie scattered, their contents spilling onto the grimy pavement. Reaching one, Alexandra throws open the lid without hesitation. A cloud of stale, forgotten odors wafts out, but the anthro canine merely sniffs once, then peers inside, her muzzle wrinkling slightly. 'Well, Boss,' Alexandra grumbles, turning to you with a surprised flick of her ears. 'Looks like you might actually be onto something. My uniform's not here.'";
	WaitLineBreak;
	say "     You ask if the dobie bitch can follow the trail, a subtle hint of urgency in your voice. Alexandra drops to all fours, her nose to the grimy pavement, sniffing intently around the base of the dumpster. Her tail twitches, a low hum resonating in her chest as she processes the complex tapestry of scents. After a moment, the ex-cop lifts her head, her dark eyes sharp and focused. 'Thankfully, this stuff wasn't too stinky or masking, Boss,' she comments, a slight shake of her head. 'Yeah, I think I got it. Definitely my scent, even if it's a bit old. But,' your bad bitch's ears flatten slightly, a subtle shift in her expression, 'it's got something odd mixed in. A faint, almost sickly sweet, reptilian scent. Something... scaly.' Her gaze hardens, already anticipating a confrontation.";
	say "     Following the anthro canine's lead, you track the faint, unsettling scent for a block or so, the trail leading you away from the main thoroughfare and deeper into a residential section of the city. The transformed urban landscape feels quieter here, eerily still. The scent finally brings you to a single-family home, its windows dark and boarded up, a desolate shell. The front door hangs ajar, its lock clearly broken, suggesting others have already plundered its meager offerings. You step towards the entrance, but Alexandra shakes her head, a low growl rumbling in her chest, and pulls you back. The cop turned fucktoy silently leads you around the side of the building, her nose still twitching, until she stops at a weathered, slightly raised metal storm cellar door.";
	WaitLineBreak;
	say "     With a cautious, fluid movement, Alexandra pulls the heavy cellar door open. A rush of damp, earthy air, mingled with the faint, cloying scent of beeswax and something vaguely metallic, wafts upwards. Darkness greets you, but a flickering glow from below quickly becomes apparent. Carefully, quietly, the two of you descend the creaking wooden steps, each step a calculated risk against the silence. The basement below is a macabre tableau, a cult's base of operations. The space is dimly lit by the dancing flames of countless candles arranged on makeshift altars, supplemented by the warm, flickering glow of an oil lamp or two. In the center of the room, a weird, pulsing magic circle glows with an ethereal light, its squiggly, incomprehensible symbols shifting and swirling.";
	say "     Poignantly, a mannequin stands starkly in the middle of this arcane display, wearing what appears to be Alexandra's old cop uniform. Its shirt, doesn't quite look like you remember it - with several buttons ripped off from you baring her breasts, and pinning Alexandra down. Instead, it has been meticulously repaired restoring it to almost pristine condition. Along the grimy concrete walls, more clothes are piled. One large heap forms what appears to be a 'discards' section, clothing that the cultists are seemingly 'finished with' and now lying in a hip height untidy pile. On the opposite side, many individual outfits are meticulously folded and stuffed in cheap plastic shopping bags, each a chilling record of what people wore when they underwent their own terrifying metamorphosis.";
	WaitLineBreak;
	say "     There are four cultists here, all four clad in long, black robes that could easily conceal anything beneath. Mismatched limbs often protrude from beneath the hems and sleeves - a scaly foot, a feathered arm, a strangely elongated hand with claws. Two of the cultists sit at a rickety table, needles flashing in the candlelight as they painstakingly stitch torn garments back together, perhaps restoring them enough to allow a connection to the previous owners for their own dark purposes. The other two cultists stand guard around the circle. They're vigilant enough to notice your entry and spin to face you, their voices a discordant chorus, 'Intruders! We shall send them straight to Niflheim!'";
	...
	if fightoutcome < 20: [player won]
		say "     Your final blow connects with brutal force, sending the cultist you've been fighting sprawling backward. They crash against the rickety table with a sickening CRACK, sending one of the oil lamps toppling. The glass shatters on the cold concrete floor, spilling burning oil across the tightly packed plastic sacks of clothing. With a whoosh, the bags ignite, flames leaping greedily, sending a sudden plume of acrid smoke boiling towards the low ceiling. All fighting ceases as everyone turns, eyes wide with alarm, realizing the escalating inferno, the sudden heat washing over their faces. Alexandra, a fierce grin splitting her muzzle, takes advantage of the distraction.";
	else if fightoutcome > 19 and fightoutcome < 30: [lost]
		say "     A sudden, brutal blow sends you stumbling backward. Your heel catches on something unseen, and you fall hard, your body crashing against the rickety table with a sickening *CRACK*. An oil lamp, precariously balanced, topples with you, its glass smashing on the cold concrete floor. Burning oil splashes across the tightly packed plastic sacks of clothing, and with a terrifying *whoosh*, the bags ignite. Flames leap greedily, sending a sudden plume of acrid smoke boiling towards the low ceiling. All fighting ceases as everyone turns, eyes wide with alarm, realizing the escalating inferno, the sudden heat washing over their faces. Even Alexandra, momentarily distracted from her own struggle, casts a surprised glance your way. Then she takes advantage of the opportunity.";
	else if fightoutcome is 30: [fled]
		say "     You turn to flee, a desperate urgency overriding any thought of further combat. Your legs pump, scrambling for the stairs, but a cultist, quicker than you anticipated, trips you with a low sweep of their foot. You stumble, arms flailing, and crash sideways into the rickety table, your body sending an oil lamp skittering. It tumbles to the cold concrete floor, its glass smashing on impact. Burning oil splashes across the tightly packed plastic sacks of clothing, and with a terrifying whoosh, the bags ignite. Flames leap greedily, sending a sudden plume of acrid smoke boiling towards the low ceiling. All fighting ceases as everyone turns, eyes wide with alarm, realizing the escalating inferno, the sudden heat washing over their faces. Even Alexandra, momentarily distracted from her own struggle, casts a surprised glance your way. Then she takes advantage of the distraction.";
	say "     The Doberman bitch snatches a second oil lamp from a nearby altar, her movements swift and decisive. With a powerful, almost gleeful grunt, your bad bitch then hurls the lamp with uncanny accuracy. It sails through the smoky air, smashing directly into the mannequin and her old cop uniform at the center of the magic circle. The uniform and mannequin, now soaked in oil, ignite instantly, a column of flame erupting around the arcane symbols. But her paws don't stop there; with a deft motion, she grabs a heavy backpack she spotted tucked away behind the altar itself, slinging it over one shoulder.";
	WaitLineBreak;
	say "     The cultists, their earlier bravado vanished, scramble for the creaking wooden steps, their mismatched limbs a blur of frantic movement in the flickering light. They shriek in alarm, abandoning their dark rituals for self-preservation. 'Time to go, Boss!' Alexandra barks, already scrambling up the stairs, the additional backpack thumping against her side. The anthro canine doesn't wait, her powerful legs carrying her upwards through the intensifying smoke and heat. You follow close behind, your lungs burning, the roar of the fire now a hungry beast behind you. Scrambling up the last few steps, you burst out into the cool, outside air, gaining some distance so you're out of the column of thick, black smoke pouring from the cellar entrance, the muffled sounds of the inferno raging beneath.";
	say "     No trace of the cultists remains; they made a clean getaway while you were still below. Alexandra leans against the cellar door, her chest heaving, fur singed in places, but a satisfied smirk stretches across her muzzle. 'Well, Boss,' she pants, a triumphant gleam in her dark eyes, 'at least those bastards now know what happens when you fuck with us.' She gives a hard kick to the cellar door, as if to emphasize her point, then reaches for the backpack she snatched. With a grunt, the ex-cop pulls the stolen backpack off her shoulder and rummages inside. Her muzzle wrinkles in surprise, then amusement. She pulls out a handful of slightly sticky, but otherwise intact, chocolate bars, followed by an assortment of colorful candy wrappers.";
	WaitLineBreak;
	say "     'Looks like these Niflheim fanatics had a bit of a sweet tooth,' she grumbles, but her tone is light, a hint of genuine pleasure in her voice. She pulls a few chocolate bars from the pack and stuffs them into her pockets, then offers you the entire bag filled with the remaining sugary loot. 'Here, Boss. As thanks,' she says, her dark eyes softening slightly, 'for actually taking my damn nightmares seriously. Means a lot. Makes me feel like I'm not just some canine eye candy with boobs and a fuckable pussy in your eyes.'";
	say "     The two of you begin the walk back towards the library, the scent of smoke slowly dissipating as you put more distance between yourselves and the burning house. The stolen candy bag, surprisingly heavy, feels like a small victory, a tangible reward after the strange and dangerous excursion. Alexandra chews thoughtfully on a chocolate bar, her powerful jaw working, the earlier weariness still evident in the slump of her shoulders, but now mingled with a quiet contentment. Perhaps, with the uniform and its dark connection to her nightmares now reduced to ash, a period of true rest might finally be within reach for your bad bitch.";
	ItemGain food by 8;
	LineBreak;
	say "[bold type]Note: You can check out the things going on for the echo of Alexandra's sleeping mind in Niflheim at [bold type]www.puppetnightmares.com[roman type]! Bad Alexandra will join the crew of existing FS characters (Nermine, Bastet) appearing in the game beginning mid-November 2025.[roman type]";
	now Alexandra_Nightmares is resolved;
	if "NightmareHunt_Postponed" is listed in Traits of Alexandra:
		remove "NightmareHunt_Postponed" from Traits of Alexandra;
