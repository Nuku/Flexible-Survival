	...
	if Alexandra_Initial_Choice is:
		...
		-- "Have some fun with the bitch. She's right there and wet already, so...":
			...
			if Player is not male: [females, neuters]
				...
				say "     Hands delve between her powerful thighs, pushing them apart with firm, insistent pressure. The soft, move reveals the swollen, wet lips of her sex. They're surprisingly hot, engorged and glistening, a clear sign of her agitated slumber. You press your hard cock against the warm, yielding entrance. Her breath hitches sharply, a guttural sound torn from her throat. Hips buck harder against your pelvis, a desperate, unconscious plea for the intensifying sensation that now blends seamlessly with the phantom touch of her nightmare. Slowly and deliberately, you slide inside, stretching her slick depths, your shaft pushing past the matted fur and into her tight, wet slit. Still, she does not wake.";
				WaitLineBreak;
...
to say AlexandraNightmareHunt_Main:
	...
	say "     Poignantly, a mannequin stands starkly in the middle of this arcane display, wearing what appears to be Alexandra's old cop uniform. Its shirt, however, has been meticulously repaired, several missing buttons replaced and the small tears in the fabric where they once were, now neatly stitched - details you vividly remember from when you first pinned Alexandra down, ripping it open in your fervor. Along the grimy concrete walls, more clothes are piled. One large heap forms a 'discards' section, clothing that the cultists are seemingly 'finished with.' On the opposite side, many individual outfits are meticulously folded and sealed in plastic bags, each a chilling record of what people wore when they underwent their own terrifying metamorphosis.";
	WaitLineBreak;
	say "     Two of the cultists sit at a rickety table, needles flashing in the candlelight as they painstakingly stitch torn garments back together, perhaps restoring them enough to allow a connection to the previous owners for their own dark purposes. The other two cultists, all four clad in long, black robes that could easily conceal anything beneath, stand guard around the circle. Mismatched limbs often protrude from beneath the hems and sleeves - a scaly foot, a feathered arm, a strangely elongated hand with claws. They spin to face you, their voices a discordant chorus, 'Intruders! We shall send you straight to Niflheim!'";
	...
	say "     The Doberman bitch snatches a second oil lamp from a nearby altar, her movements swift and decisive. But her paws don't stop there; with a quick, practiced motion, she grabs a surprisingly heavy backpack tucked away behind the altar itself, slinging it over one shoulder. With a powerful, almost gleeful grunt, your bad bitch then hurls the lamp with uncanny accuracy. It sails through the smoky air, smashing directly into the mannequin and her old cop uniform at the center of the magic circle. The uniform, now soaked in oil, ignites instantly, a column of flame erupting around the arcane symbols.";
	WaitLineBreak;
