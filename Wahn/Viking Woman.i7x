Version 1 of Viking Woman by Wahn begins here.
...
When Play begins:
	...
	add "Viking Woman" to infections of FemaleList;
	add "Viking Woman" to infections of HumanList;
	add "Viking Woman" to infections of HistoricalList;
...
When Play begins:
	...
	now Species Name entry is "Viking";
	now Name entry is "Viking Woman"; [matching infection name to Table of Random Critters]
	...
	now Head Description entry is "an attractive human with pale, somewhat weather-toughened skin"; [partial sentence that fits in "Your face and head resemble that of [Head Description of Player]. You have [Eye Adjective of Player], [Eye Color of Player] eyes and an overall [Gender Adjective of Player] appearance."]
	...
	now Arms Description entry is "that of a human, covered in [one of]tough[or]weather-toughened[or]freckled[at random] skin"; [partial sentence to fit: "Your [Limbs Adjective of Player] arms are [Arms Description of Player]."]
	...
	now Legs Description entry is "that of a human, covered in [one of]tough[or]weather-toughened[or]freckled[at random] skin"; [partial sentence to fit: "As your inspection goes even lower, you come to the two [Body Adjective of Player] legs supporting you. They are [legs description of Player]."]
...
Instead of resolving a Chieftain's Challenge:
	...
	repeat with y running from 1 to number of filled rows in Table of Random Critters:
		...
		if Name entry is "Viking Man":
			now MonsterID is y;
			break;
	choose row MonsterID from the Table of Random Critters; [the chieftain is stronger than Sonya]
	now HP entry is 275;
	now monsterHP is 275;
	now lev entry is 15;
	now wdam entry is 30;
	now lootchance entry is 0;
	challenge "Viking Man";
...
Cock Count of Sonya is 0.
Cock Length of Sonya is 0.
Ball Size of Sonya is 0.
Ball Count of Sonya is 0.
Cunt Count of Sonya is 1.
Cunt Depth of Sonya is 12.
Cunt Tightness of Sonya is 5.
Nipple Count of Sonya is 2. [4 nipples]
