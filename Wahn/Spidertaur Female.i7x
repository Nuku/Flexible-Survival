...
"Spidertaur Female"	"[PrepCombat_Spidertaur Female]"

to say PrepCombat_Spidertaur Female:
	setmongender 4;]
...
When Play begins:
	...
	add "Spidertaur Female" to infections of InternalBallsList;
	add "Spidertaur Female" to infections of OviImpregnatorList;
	now Name entry is "Spidertaur Female";
	now enemy title entry is "Female Spidertaur"; [ Name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name. ]
	...
	now MilkItem entry is "spidertaur female milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "spidertaur female cum"; [ Item to be given to the player if they have this infection and jerk off. ]
