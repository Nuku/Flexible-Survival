...
to SusanTalkMenu: [TODO: Add talk option about sexual orientation]
	...
	while sextablerun is 0:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			now sextablerun is 1;
			say "     You step back from the anthro deer, shaking your head slightly as she gives a questioning look.";
			wait for any key;
		else:
...
to say ResolveEvent M-Herm Susan Transformation End:
	...
	say "     [link](1)[as]1[end link] - No. This is something she needs to choose for herself.";
	say "     [link](2)[as]2[end link] - Wave to get her attention, then give her a thumbs up. Samson does sound neat to you too.";
	say "     [link](3)[as]3[end link] - Wave to get her attention, then shake your head. Susan is a pretty name, after all.";
	now calcnumber is 0;
	while calcnumber < 1 or calcnumber > 3:
		say "Choice? (1-3)>[run paragraph on]";
		get a number;
	...
	if calcnumber is 1:
		LineBreak;
		say "     You keep still, pausing where you are to not draw any attention or distract Susan from the important decision she's trying to make. With both Doctor Matt and yourself patiently waiting to let her mull things over, the anthro deer hems and haws for a little while over what to do. Eventually, when she reflexively tries to brush a strand of hair out of her face, her hand bumps into the base of her antlers. Susan looks up at the front points of the antlers which are just barely in her field of vision, then apparently coming to a decision. 'Yes. This is something I will do. So, Doctor Matt - could you please update my name in your file to Samson?' 'Of course. And congratulations. I hope you will be happy with your decision, Samson!' With that, the suited man holds out his arm to shake the anthro deer's hand, then makes the correction on his clipboard. He walks over to his workstation afterwards, giving you a friendly nod as he notices you in passing. Left behind on the examination table, Samson swings his legs over its side and stands up. Moving closer to join him, you notice that he's at least a foot taller than Susan was, giving him quite an imposing stature at roughly six and a half feet tall.";
		SamsonRenaming;
		now Resolution of M-Herm Susan Transformation End is 1; [let her choose -> Samson]
	else if calcnumber is 2:
		LineBreak;
		say "     Walking forward a little further, you raise an arm and give Susan a little wave, drawing attention to yourself. Her eyes focus on you, then the smile and thumbs-up you're giving her. With a thankful expression, she gives you a relieved nod, then says out loud. 'Yes. This is something I should do. Will do. So, Doctor Matt - could you please update my name in your file to Samson?' 'Of course. And congratulations. I hope you will be happy with your decision, Samson!' With that, the suited man holds out his arm to shake the anthro deer's hand, then makes the correction on his clipboard. He walks over to his workstation afterwards, giving you a friendly nod as he notices you in passing. Left behind on the examination table, Samson swings his legs over its side and stands up. Moving closer to join him, you notice that he's at least a foot taller than Susan was, giving him quite an imposing stature at roughly six and a half feet tall.";
		SamsonRenaming;
...
to say SusanExperimentTalk: [note: no varying texts needed in this, as Samson cannot exist without this being talked about]
	if Loyalty of Susan is 3 or Loyalty of Susan is 4:
		...
		if Loyalty of Susan is 1: [player intends to go the medical route]
			if Affection of Susan > 2:
				say "     Susan smiles as you approach, her long ears flicking a little before she says, 'I overheard what you two discussed. And... uhm, realize what options there are for the doctor's 'controlled exposure'. Thank you for taking it on you to - to be experimented on. I really appreciate everything you've been doing. Showing me compassion when I was out there in the park, and all. Also, I'm kinda afraid what it even would be like to be with someone, like this.' As Susan says those words, she looks down upon herself, running her fingers over the fur of her arm as if hoping it might just rub off to reveal a normal human self. 'Maybe the doctor can find some way to fix me?' Biting her lip, she looks at you shily, and she surely would be blushing if she didn't have fur all over. 'What I mean to say is this: I'm ready when you are. You can tell the doctor that.'";
			else:
				say "     Susan smiles shily as you approach, her long ears flicking a little before she says, 'I overheard what you two discussed. And... uhm, realize what options there are for the doctor's 'controlled exposure'. Are you sure you want to - to be experimented on?' As Susan says those words, she looks down upon herself, running her fingers over the fur of her arm as if hoping it might just rub off to reveal a normal human self. 'Thank you for that. Maybe the doctor can find some way to fix me?' Biting her lip, she looks at you with a somewhat lost and afraid expression. 'What I mean to say is this: I'm ready when you are. You can tell the doctor that.'";
			now Loyalty of Susan is 3; [Susan ready for medical]
		else if Loyalty of Susan is 2: [player wants to lay her]
			if Affection of Susan > 2:
				say "     Susan smiles as you approach, her long ears flicking a little before she says, 'I overheard what you two discussed. And... uhm, the way you want to do the doctor's 'controlled exposure'. I - I think you're brave wanting to touch someone as strange as I turned out to be. Thank you for that, and wanting to make me feel comfortable about it, instead of just a... 'procedure' to be done.' As Susan says those words, she looks down upon herself, running her fingers over the fur of her arm as if hoping it might just rub off to reveal a normal human self. 'Maybe the doctor can find some way to fix me afterwards?' Biting her lip, she looks at you shily, and she surely would be blushing if she didn't have fur all over. 'What I mean to say is this: I'm ready when you are. You can tell the doctor that.'";
			else:
				say "     Susan nervously looks down to the ground as you approach, her long ears flicking a little before she glances up and says, 'I overheard what you two discussed. And... uhm, the way you want to do the doctor's 'controlled exposure'. I - I'm fine with it, I think. It's pretty... direct, since we don't even know each other at all, but... I really hope the doctor can find some way to fix me afterwards!' Biting her lip, she looks at you shily, and she surely would be blushing if she didn't have fur all over. 'What I mean to say is this: I'm ready when you are. You can tell the doctor that.'";
			now Loyalty of Susan is 4; [ready for a fuck]
		else if Loyalty of Susan is 5: [player wants to get her opinion]
			say "     Susan smiles as you approach, her long ears flicking a little before she says, 'I overheard what you two discussed. And... uhm, realize what options there are for the doctor's 'controlled exposure'. Thank you. For... for insisting that I get to have a word in this too. I really appreciate everything you've been doing. Showing me compassion when I was out there in the park, and now keeping to your same kind behavior.' Silence stretches out for a little while, with Susan looking down upon herself, then running her fingers over the fur of her arm as if hoping it might just rub off to reveal a normal human self. 'I - I think I want to go with a medical procedure. Anything else in front of the Doctor would be... awkward. And maybe he can find some way to fix me then?' Biting her lip, she looks at you shily, and she surely would be blushing if she didn't have fur all over. 'What I mean to say is this: I'm ready when you are. You can tell the doctor that.'";
			AffectionGain 1 for Susan;
			now Loyalty of Susan is 3; [Susan ready for medical]
	else if Resolution of Unusual Creature is 4: [fucked her]
		if Loyalty of Susan is 1: [player intends to go the medical route]
			say "     Susan presses her lips together as you approach, her long ears flicking a little before she says, 'I overheard what you two discussed. And... uhm, realize what options there are for the doctor's 'controlled exposure'. So you don't want to... uhm, do what we did in the park again?' The tone of her voice makes you think that she is slightly conflicted about it - on one hand, relieved that someone she barely knows isn't just going to fuck her again, on the other hand... you might possibly having awoken some submissive urges in her when you simply took her as yours before. Silence stretches out for a little while, with Susan looking down upon herself, then running her fingers over the fur of her arm as if hoping it might just rub off to reveal a normal human self. 'Maybe the doctor can find some way to fix me?' Biting her lip, she looks at you shily, and she surely would be blushing if she didn't have fur all over. 'What I mean to say is this: I'm ready when you are. You can tell the doctor that.'";
			now Loyalty of Susan is 3; [Susan ready for medical]
		else if Loyalty of Susan is 2: [player wants to lay her]
			say "     Susan smiles as you approach, her long ears flicking a little before she says, 'I overheard what you two discussed. And... uhm, the way you want to do the doctor's 'controlled exposure'. So you're going to do again what we did before? That's... fine, I guess.' As Susan says those words, she looks down upon herself, running her fingers over the fur of her arm as if hoping it might just rub off to reveal a normal human self. 'Maybe the doctor can find some way to fix me afterwards?' Biting her lip, she looks at you shily, and she surely would be blushing if she didn't have fur all over. 'What I mean to say is this: I'm ready when you are. You can tell the doctor that.'";
			now Loyalty of Susan is 4; [ready for a fuck]
		else if Loyalty of Susan is 5: [player wants to get her opinion]
			say "     Susan smiles as you approach, her long ears flicking a little before she says, 'I overheard what you two discussed. And... uhm, realize what options there are for the doctor's 'controlled exposure'. Thank you. For... for insisting that I get to have a word in this too. I - I'm a little surprised that you don't just want to... do what we did in the park, before. I guess it shows that people have different sides to them, and don't always show the same, hm?' The tone of her voice makes you think that she is slightly conflicted about it - on one hand, relieved that someone she barely knows isn't just going to fuck her again, on the other hand... you might possibly having awoken some submissive urges in her when you simply took her as yours before. Silence stretches out for a little while, with Susan looking down upon herself, then running her fingers over the fur of her arm as if hoping it might just rub off to reveal a normal human self. 'I - I think I want to go with a medical procedure. Anything else in front of the Doctor would be... awkward. And maybe he can find some way to fix me then?' Biting her lip, she looks at you shily, and she surely would be blushing if she didn't have fur all over. 'What I mean to say is this: I'm ready when you are. You can tell the doctor that.'";
...
to say SusanRelationshipTalk:
	...
	say "     [link](4)[as]4[end link] - Offer that she could be the buck, and you could try being equal partners, perhaps switching who's in charge."; [Samson Switch]
	now calcnumber is 0;
...
to say sexwithSusan:
	...
	if lastfuck of Susan - turns < 4:
		...
		say "     You should talk to Dr. Matt first before trying to do that.";
	else if Loyalty of Susan is 4: [ready for experiment fuck]
		SusanSexMenu;
