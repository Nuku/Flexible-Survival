...
to say UrikTalk_Looting:
	if Player is not booked:
		...
		say "     This causes a reaction in the room beyond, as you can see a blanket lying on the couch there stir, followed by a feminine shape raising her head and rubbing sleep-wary eyes. The young woman is of Asian descent and mostly human, if one ignores the double row of nipples down her pale-skinned front, as well as a pair of canine ears on top of her head. As she actually focuses on who's standing just a few steps from her, she lets out a frightened scream and jumps up from the sofa, revealing her fully naked, and very much pregnant, form. 'Oops,' Urik murmurs under his breath and starts walking up to the still screaming woman. He towers immensely over her and growls, 'Will you shut up already?' at which point she seems to freeze into panicked motionlessness. Urik reaches out to grab the woman's shoulder, but before he can actually do so, running steps of naked feet on hardwood floor herald the arrival of another person.";
		WaitLineBreak;
