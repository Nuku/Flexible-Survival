...
Description of Milking Shed Main Room is "[MShedDesc]".
...
Description of Worker Barracks is "[BarracksDesc]".
...
Description of Sheep Meadow SW is "     You're in the southwestern corner of an enormous meadow, still green in contrast to the dry grassland outside the farm. White shapes of sheep trot around in the distance, peacefully grazing.".
...
Description of Sheep Meadow SE is "[MeadowSEDesc]".
...
Description of Sheep Meadow NE is "[MeadowNEDesc]".
...
Description of Sheep Meadow NW is "[MeadowNWDesc]".
...
Description of McDermott Barn is "[BarnDesc]".
