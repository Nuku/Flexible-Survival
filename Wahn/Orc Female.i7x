...
"Orc Female"	"[PrepCombat_Orc Female]"

to say PrepCombat_Orc Female:
	setmongender 4;
...
When Play begins:
	...
	now MilkItem entry is "orc female milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
...
to say KatyaFriendshipPath:
	if HP of Katya is 0: [second visit]
		...
		if carried of food > 1:
			...
			say "     Air-quotes with her fingers make it clear that she saw through your earlier excuse with little difficulty. Still - she is smiling as she closes the tarp and pins it into place. Definitely a good sign. With a spring in your step, you wander back to a more central section of the dry plains.";
			wait for any key;
			move player to Dry Plains;
			ItemLoss food by 1;
			now HP of Katya is 3; [fourth visit completed successfully]
		else if carried of food is 1:
			say "     If only you actually had enough food for the both of you. Seems like you need to go and find some more... ideally of the tasty variant and definitely non-infective foodstuffs only. She might mistrust the offer otherwise.";
			wait for any key;
			move player to Dry Plains;
		else:
			say "     If only you actually had any food at all. Seems like you need to go and find some before you can go on with this plan... ideally of the tasty variant and definitely non-infective foodstuffs only. She might mistrust the offer otherwise.";
			wait for any key;
			move player to Dry Plains;
...
Cunt Depth of Katya is 10. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Conversation of Katya is { "Orc Female" }.
