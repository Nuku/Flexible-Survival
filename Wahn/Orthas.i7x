Version 4 of Orthas by Wahn begins here.
[- Originally Authored By: Nuku Valente, Khabi, Stripes -]
...
to say Orthas_task2_done:
	...
	if Player is male:
		...
		while ( Cunt Count of Player is 0 and calcnumber is 1 ) or ( calcnumber < 1 or calcnumber > 3 ):
...
to say Orthasfuck:
	...
	if HP of Orthas < 2:
		...
		if Player is male and Cunt Count of Player < 1: [ male player ]
		...
		else if Player is female and Cock Count of Player < 1: [ female player]
			let seed be 0;
...
When Play begins:
	...
	now MilkItem entry is "anthro dragoness milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "anthro dragoness cum"; [ Item to be given to the player if they have this infection and jerk off. ]
