...
to say BlissedDariusSex5:
	if AnalVirgin of Darius is true: [first time]
		...
		WaitLineBreak;
		say "     Working your digits in and out of his increasingly wet and slippery hole, you finger Darius for a little while, then finally stretch his opening as far as you can with your fingers and let the lion's share of his cum slide inside. Quickly wrapping your cum-slick fingers around your [cock of player] erection, you give it a few good pumps, then line yourself up with the cream-filled opening and push in against it. Even with all the prep-work, his virgin hole resists your penetration for a second or two, before finally yielding to stretch around your girth. With a satisfied grunt, you push into the strong, passed-out male, revelling in the knowledge that it is his own doggy seed that you can feel squishing around your length as it is driven deep inside. He's tight as only a virgin can be, and you have to pause for a moment several times so you don't blow your load before you're fully inside his vice-like ass.";
