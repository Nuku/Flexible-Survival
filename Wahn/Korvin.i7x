...
to say gsd_recruited:
	...
	if (number of bunkered people + number of booked people > 2): [anyone there besides just Korvin]
		...
		if Fang is booked or Fang is bunkered:
			say "     Fang pads closer, sniffing the air and looking at Korvin, with [PosAdj of Fang] tail raised at attention. Yet as the wolf approaches the German shepherd, Korvin extends one arm, paw-hand ready to push back. 'Oh no, that's enough! Keep your distance, you understand?!' Looking aside to you, Korvin explains, 'I don't really trust those male four-leggers. One moment they seem like proper pets, or even normal folks, the next they try to mount you. Guess once you're not human anymore, all the respect of these critters for their masters went poof!' Fang keeps standing nearby for a moment, looking [if HP of Fang is 2]subdued, and when you don't do anything to refute Korvin's claim, trudges away[else if HP of Fang is 3 or HP of Fang is 4 or HP of Fang is 7]in annoyance at the anthro, then seems to decide that right now isn't the moment to address this and pads off, giving Korvin a hostile stare before turning a corner behind a bookshelf[else if HP of Fang is 5]disapproving. 'And you're better?' [SubjectPro of Fang] mutters under [PosAdj of Fang] breath, before deciding that now isn't the moment to address this and pads off, giving Korvin a hostile stare before turning a corner behind a bookshelf[else if HP of Fang is 6]unimpressed at the anthro's outburst. 'Leg number not as important as personality. But caution understandable,' Fang replies before padding off, giving you a lick in passing and ensuring that Korvin sees[else]confused at the rejection, then eventually pads off[end if]. Korvin watches Fang go with a wary expression on his face.";
			WaitBreakReactions;
		if HP of Fiona > 4:
...
Cunt Depth of Korvin is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
to say conf_Korvin_Talk02: [scar talk]
	...
	if Trucker Bar is not active:
		say "     With your curiosity awakened, you follow up and ask if he remembers the name of the bar, or even just how it looked. 'Hm, no it was - just the bar we usually went to, you know. None of that pretentious crap there - just cheap drinks, pool table, TV with the newest game running on it. A trucker bar, you see? It was... err, somewhere a little off from the center of town, I think?' Hmm, with that description, you'd guess the bar could be in either the outskirts of the downtown/[bold type]high rise[roman type] area, or possibly in the [bold type]warehouse district[roman type]. [bold type]Maybe you should take Korvin there sometime and see if you can find it together?[roman type][line break]";
	...
	if ( gshep_postfight + gshep_sexscene + gshep_bed_scene + gshep_inactive ) >= 5:
		...
		if PlayerFucked of Korvin is true: [fucked around before, so he expects and wants it]
			...
			if Player is male:
				...
				say "     The two of you go at it like this, fucking like horny dogs, until he's about to blow. With an extra[if Cunt Tightness of Player < 6 or Cunt Depth of Player < 6]-strong[end if] push, he pops his thick knot into you and unloads. You can feel every hot blast of the German shepherd's thick seed, loving how it pools warmly inside you, trapped by his knot. By the time meaty bulb has gone down, much of it has been [if gestation of child > 0]absorbed[else]drawn into your womb[end if], though there's still plenty left to leak out and show what a virile dog you have.";
				NPCSexAftermath Player receives "PussyFuck" from Korvin;
			WaitLineBreak;
...
to say Korvin_Relationship_Library03: [Korvin's free game for anyone]
	say "     Addressing Korvin's second question, about the people you've been bringing into the library, you tell him that you're simply saving those that are sane enough to still have any self-control. Not wanting to be a controlling taskmaster or anything, they're free to come to any arrangements that they want with each other. As for himself, well if any of your guests are in need to let off some steam, they're free to make use of your dog. 'Even if it's a guy?!' he asks, and you tell him yes. A slightly sullen expression crosses Korvin's face, then smooths out as he makes a conscious effort to suppress it. Finally, the German shepherd says, 'Oh, okay.' You nod at his acceptance of the role and tell him he's a good dog.";
