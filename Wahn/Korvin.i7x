...
to say KorvinTalk:
	if gsd_pet < 16:
		...
		if Resolution of Trucker Bar is 3 and "KorvinPast_Convinced" is not listed in Traits of Korvin: [the player talked Korvin into staying with them]
			say "     As you approach Korvin in order to talk with him, the German shepherd suddenly looks at you with an intense expression on his face. 'Listen, [K_Boss]. I wanted to talk to you about what happened when we went to track down Eddie's place. Going through that picture album with her was... brutal, but I still felt like I owed it to him, her, them, to try to make it work. Damn, some of those pics just made me [italic type]itch[roman type] in my mind, with no chance to scratch it because I just couldn't remember. And yet, I was really fucking close to go in there with her. So... tempting, to be someone [italic type]real[roman type].' He blows out his breath, scratching the back of his neck. 'But you were right. That idea was doomed to fail. I'd have joined her, tried, but at some point she'd have learned that she invited a street dog inside. Most likely when I pinned her down to fuck her like any other random bitch.'";
...
to say conf_Korvin_Talk_CarlDisagreement:
...
to say conf_Korvin_sex05: [be fucked by Korvin (vaginal)]
	...
	if Player consents:
		...
		say "     Korvin does take a few seconds to buckle the leather band again and goes to carefully set the symbol of both his own status, as well as submission, down on top of your gear. Then suddenly, the muscular dog wirls around, letting out a sharp bark that makes you twitch in surprise. 'What? Did you think I wouldn't smell what's between your legs as you stroll through my turf? [if Breast Size of Player is 0]Might almost look like a dude, with that flat chest and all, but you can't fool the nose! [end if]Damn, I love how needy and stupid you bitches get when you're in heat! Just strolling around and drawing the attention of every horny dude with a nose worth anything!' With that, the anthro dog struts up to you, clamping his paw-hand around your jaw and forcing you to look him in the eyes. 'Can't believe someone else hasn't snatched you up before, and filled that box with his pups! At least you were smart enough to not try to fight, so I [']might['] even let you go after we have some fun!'";
		WaitLineBreak;
...
instead of resolving Trucker Bar:
	if Resolution of Trucker Bar is 0: [first time]
		...
		if calcnumber is 1:
			...
			nor Resolution of Trucker Bar is 99; [postponed]
		else if calcnumber is 3:
			LineBreak;
			say "     With a shake of your head, you put two fingers in your mouth and whistle for Korvin, making the German shepherd trot back over to you and take his usual space. Then you tell him that you don't care to investigate this further, so he should just put it ouf ot his mind. The muscular anthro glances down the street hesitantly, then nods and says, 'As you say, [K_Boss].'";
			nor Resolution of Trucker Bar is 100; [refused]
