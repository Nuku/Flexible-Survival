	...
	while sextablerun is 0:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if Player consents:
				...
				if title entry is:
					-- "Demand some food from him":
						say "[BeatenVikingManLoot]";
					-- "Milk him for some Viking cum":
...
to say VikingManAttacks:
	if VikingRelationship is 9:
		say "[one of]Chief Frithjof swings his axe and lands a hit on you, though you luckily manage to turn away from it in time so it just leaves a bleeding cut and doesn't take your arm off[or]The Viking chieftain slams his shield against your chest, making you stumble backwards dazedly[or]A sudden kick from the Viking Chieftain against the side of your leg leaves you numb and weakened[or]You manage to evade a swing of his axe, but the chieftain slams the hilt of the weapon into your stomach, making you double over in pain[or]Frithjof slams his shield into your chest, driving the air from your lungs[or]Rushing at you with his shield held in front of him, Frithjof slams against you and bowls you over[at random].[no line break]";
	else: [regular male viking attack messages]
		say "[one of]He lands a shallow cut on you. Seems he's not really trying to kill you in earnest, more likely to subjugate you instead...[no line break][or]The Viking man slaps the broad side of his sword against your head, leaving you seeing stars for a moment.[no line break][or]A sudden kick against the side of your leg leaves you numb and weakened.[no line break][or]He slams his shield into your chest, driving the air from your lungs.[no line break][at random]";
...
"Viking Man"	"[PrepCombat_Viking Man]"

to say PrepCombat_Viking Man:
	say "";
...
When Play begins:
	...
	now MilkItem entry is "viking man milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "viking man cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	...
	now Cross-Infection entry is "Viking Woman"; [ Infection that this infection will give the player when they lose; can be left empty if they infect with the monster's own strain. ]
...
Scent of dried cod is "Raising the piece of meat to your nose, you can definitely confirm that it is indeed fish.".
