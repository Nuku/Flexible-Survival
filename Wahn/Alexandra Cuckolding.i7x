...
instead of navigating Grey Abbey Library while ("Cuckold" is listed in feats of Player and Alexandra is in Grey Abbey Library and HP of Alexandra < 50 and (lastfuck of Alexandra - turns >= 8) and demon brute is listed in companionList of Player and (DBCaptureQuestVar is 6 or DBCaptureQuestVar is 7) and DemonBruteStatus < 2 and AlexandraBrutusInteraction < 100 and (AlexandraBrutusInteraction is 0 or (AlexandraBrutusInteraction > 0 and a random chance of 1 in 4 succeeds))) and Player is not CoA:
...
to say AlexandraBrutusCuckScene:
	...
	if Player consents: [they fuck]
		...
		say "     Brutus is big, very big indeed, and it is a good thing that he prepared her for his entry by getting Alexandra off and sopping wet. Even as prepared as her inner muscles got during his fingering and the orgasm she had, it obviously is quite a lot to take, making your disobedient bitch pant and gasp as bit by bit, she is slid down on the thick piece of meat. Thankfully, Brutus seems to know his own size very well, only slowly pushing her onto his prick and often stopping to just hold her so she can get used to it. Finally he bottoms out inside Alexandra, hard shaft buried all the way and creating a visible bulge in her stomach.";
		WaitLineBreak;
		...
		say "     The demon gives a kind of satisfied growl from the depth of his broad chest and keeps fucking her while Alexandra rides out her orgasm, getting even faster than before in his urge to join her. Soon, he reaches his own climax - and with a loud grunt, the demon begins to pump her insides full of his seed. With the head of his shaft pushing open her cervix, he easily fills the canine bitch's womb and vagina, with the remaining cum squirting out around Brutus's thick cock - and that was just the first two heavy spurts! His weighty balls throb rhythmically as they send forth more and more cum to breed the former cop with.";
		WaitLineBreak;
		...
		NPCSexAftermath Alexandra receives "PussyFuck" from Brutus; [Brutus's pet object is called Demon Brute]
...
to say AlexandraKorvinCuckScene1:
	...
	project Figure of Alexandra_face_icon;
	...
	LineBreak;
	say "     Alexandra is about to climb on top of Korvin's lap, putting cuckold's horns on you another time! [bold type]Will you simply let this happen?[roman type][line break]";
	say "     ([link]Y[as]y[end link]) - Endure the humiliation of being a mere bystander at their coupling.";
	...
	if Player consents: [they fuck]
		...
		NPCSexAftermath Alexandra receives "PussyFuck" from Korvin; [Korvin's pet object is called gshep]
...
instead of navigating Grey Abbey Library while ("Cuckold" is listed in feats of Player and Alexandra is in Grey Abbey Library and HP of Alexandra < 50 and (lastfuck of Alexandra - turns >= 8) and gshep is listed in companionList of Player and gsd_pet > 59 and gsd_pet < 100 and AlexandraKorvinInteraction > 0 and AlexandraKorvinInteraction < 100 and a random chance of 1 in 3 succeeds) and Player is not CoA:
	say "[NavCheck Grey Abbey Library]";
	if NavCheckReturn is false, stop the action;
	move player to Grey Abbey Library;
	if debugactive is 1:
...
instead of going up from Grey Abbey Library while ("Cuckold" is listed in feats of Player and Alexandra is in Grey Abbey Library and HP of Alexandra < 50 and (lastfuck of Alexandra - turns >= 8) and Carl is in Grey Abbey 2F and HP of Carl > 9 and HP of Carl < 40 and AlexandraCarlInteraction is 0) and Player is not CoA:
	move player to Grey Abbey Library;
	if debugactive is 1:
...
to say AlexandraCarlOralCuckScene:
	...
	LineBreak;
	say "     [bold type]Will you simply stand back let her give the canine soldier a blowjob?[roman type][line break]";
	...
	if Player consents: [they fuck]
		...
		NPCSexAftermath Alexandra receives "OralCock" from Carl;
