Version 1 of Helot by Wahn begins here.
[Version 1.1 - Female Spartan submit scene added]

"Adds a Male Helot to Flexible Survivals Wandering Monsters table, with impreg chance"
...
to say Helot wins:
	if hp of player > 0:		[player submits]
		...
		if bodyname of player is "Spartan" and facename of player is "Spartan" and cunts of player > 0:			[spartan females + herms]
