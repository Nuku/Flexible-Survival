...
"Doberman Male"	"[PrepCombat_Doberman Male]"

to say PrepCombat_Doberman Male:
	say "";
...
When Play begins:
	...
	now body entry is "fit and toned without a trace of fat anywhere in sight, which results in a lithe and wiry appearance given your slim stature"; [ Body description, format as "Your body is [Body of Player]." ]
	...
	now MilkItem entry is "doberman male milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	...
	now Cross-Infection entry is "Doberman Bitch"; [ Infection that this infection will give the player when they lose; can be left empty if they infect with the monster's own strain. ]
