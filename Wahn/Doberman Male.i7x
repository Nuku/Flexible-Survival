...
When Play begins:
	...
	add "Doberman Male" to infections of KnotList;
...
When Play begins:
	...
	now Torso Description entry is "covered in a short coat of dark brown and black fur"; [partial sentence, fitting in "Looking down at yourself, you appear [Gender Adjective of Player] with a [Body Adjective of Player] build. Your torso is [Torso Description of Player][if Body Hair Length of Player > 1], covered in [Torso Color of Player] skin and [Body Hair Description of Player][else if Body Hair Length of Player is 1], covered in smooth, [Torso Color of Player] skin[end if]."]
