...
instead of going up from Grey Abbey Library while (Carl is in Grey Abbey 2F and HP of Carl > 9 and HP of Carl < 50 and Intelligence of Carl is 0 and gsd_pet >= 60 and gshep is tamed): [Carl present in the library, locked into regular/beta, first time, Korvin tamed and blackcollar]
	move player to Grey Abbey 2F;
	if debugactive is 1:
...
instead of going up from Grey Abbey Library while (Carl is in Grey Abbey 2F and HP of Carl is 10 and Intelligence of Carl is 51 and gsd_pet >= 60 and gshep is tamed and lastCarlKorvinInteraction - turns > 4): [Carl present in the library, locked into regular, had the origin talk before, Korvin tamed and blackcollar, 4+ turns since last encounter]
	...
	say "     As you are halfway up the library stairs, you hear Carl calling out, 'Hey Korvin, come over here for a moment.' Climbing up the remaining steps, the husky comes into sight, standing at his window observation post, with Korvin coming up next to him, a curious expression on his face. The husky soldier's tail wags as he grins at his friend, then turns his gaze to the window, nodding at something beyond. 'Have a look, we got some stuff going on over there!' Curious, the German shepherd steps up besides his buddy, then Carl points at something. ...";
	now Intelligence of Carl is 52; [regular Carl and blackcollar Korvin talked about backgrounds]
	now lastCarlKorvinInteraction is turns;
]

[
regular Carl + Blackcollar Korvin scene 2:
- sitting around, drinking beer, telling stories about sexy Sometimes

regular Carl + Blackcollar Korvin scene 3:
- watching something have sex from the window, Korvin going "so, wanna have a wank?"
