...
When Play begins:
	...
	now Species Name entry is "Anthro Fox";
	add "Anthro Fox" to infections of MaleList;
	add "Anthro Fox" to infections of FurryList;
	add "Anthro Fox" to infections of VulpineList;
