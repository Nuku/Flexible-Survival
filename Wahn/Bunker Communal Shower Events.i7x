...
Description of Bunker Shower Knob is "     A simple metal shower knob that can be pulled outward to [link]shower yourself[as]shower yourself[end link]. In the center of the valve, you can see a piece of plastic that has swirls of blue and red, showing which direction to turn the knob to get your desired temperature.[line break]".
Scent of the Bunker Shower Knob is "     Other than it having a slightly metallic scent, you can also pick up a hint of stale water.".

Showering is an action applying to nothing.
understand "shower yourself/myself/off/me" as Showering.
...
Carry out Showering:
	if Eric is bunkered and HP of Eric > 41 and HP of Eric < 99 and (time is post midnight or time is pre dawn) and Energy of Eric < 49 and lastShowerUse - turns > 1 and a random chance of 1 in 2 succeeds: [Eric present, orc cocked and non virgin, midnight or early morning, not driven away before, 33% chance]
		say "[EricShower_OrcCock]";
	else if lastShowerUse - turns < 3:
		say "     Stepping into the showers again, you think better of it and turn to leave. It's a miracle they work at all right now; the last thing you'd want to deal with is busted plumbing from excessive use.";
...
to say EricShower_OrcCock:
	...
	say "     Casually, Eric's left arm reaches up, and he rests his palm against the wall right behind you. Looking at his face, you notice it distort into an expression that you are not accustomed to seeing on the normally friendly young man's face, one of cocky arrogance. With lightning speed, he leans into your personal space and gets himself soaking wet as well. At first, it seems like he's only breathing on your neck, but eventually you also feel his soft tongue start to glide across your throat. 'Mmmm, you smell like you'd make a good li'l breeder slut, baby.' You gasp in shock at what Eric just said, seeing as that just doesn't seem like something he would normally say, well besides the [']baby['] endearment at least.";
	WaitLineBreak;
	...
	say "[line break]     [bold type]Will you submit to the orc-human hybrid?[roman type][line break]";
	...
	if Player consents:
		...
		say "     You take the opportunity to taste as much of his delicious precum as you can and start to feel strange afterwards, almost as if you've been drugged by his essence on your tongue. 'Alright, baby, you might wanna take a really deep breath.' Heeding his advice, you prepare yourself for whatever he plans next. You can then feel his member begin to push further down your throat, its girth indeed making it harder to get air, but the flavor makes up for that little hindrance. As the speed of the athlete's thrusts increase, you feel the effects of his orc cum becoming stronger and making your whole body want to relax and open up for him in every possible way. 'That's right, slut. Open your throat up to me. I'm gonna fuckin['] flood you with jizz!'";
		WaitLineBreak;
		...
		say "     You turn the water temperature back up, allowing the both of you to warm up. After a few moments under the heated spray, Eric states, 'Thanks. I... I'm just gonna assume that I was sleepwalking or something and go back to bed, alright?' The young man quickly runs from the bathroom, only to come back again to grab his earlier discarded shorts and run away again. You sit there and do your best to try and cope with the strange effects that giving Eric an orc cock seems to have had, telling yourself that you should watch out in times when his conscious mind is distracted and the orcish urges can come through. After a few minutes, Eric returns, this time poking just his head back into the shower room. 'I just wanted to make sure of something real quick. I didn't hurt you or anything... did I?' His voice is barely above a whisper, but you slowly shake your head in the negative. 'Good, I don't think that I would have forgiven myself if I had hurt you.' This time when he leaves, he doesn't come back, and you begin to focus on your breathing as you try to calm down before getting up and dressed to head back out.";
