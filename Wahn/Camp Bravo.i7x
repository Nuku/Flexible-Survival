...
to say CampBravoElaineTTRush:
	if thirst of Elaine < 5:
		...
		otherwise if cocks of player is 0:
			say ".  Not that we'll have a repeat until you're properly equipped for it,' she adds, pointing to your [if cunts of player > 0]female[otherwise]neuter[end if] crotch.";
		otherwise if lastfuck of Elaine is 255:
	...
	otherwise if thirst of Elaine is 5:
...
to say CampBravoFuckTTMale:
	if lust of Tiny Tim is 0:
		...
		say "     'Sorry, [if cunts of player > 0]ma'am... uh... sir[otherwise]sir[end if].  It's just he'll probably take the chance to sneak some fun with the beast if he's not out here.  Mark my words.  God damn queers.  Should never've let [']em in,' he grumbles the last bit under his breath.";
	...
	otherwise:
		...
		say "     Taking Private Orwell from guard duty for another [']special, dangerous mission,['] the two of you head to the hitching post.  Tiny Tim is happy to see you both, giving big, crushing hugs and asking if you're here to fuck again.  'That we are, big guy - if you're up for it,' the soldier responds while rubbing his hands over the minotaur's stiffening erection.";
	...
	now lastfuck of Private Orwell is turns - 4;
...
to say CampBravoFuckTTFemale:
	...
	otherwise:
		...
		say "     You let the minotaur set a pace he's comfortable with once and follow it, and are pleased with how quickly he's back to his usual rapid pounding.  Having had plenty of warm-up time, it's not much longer before your cock pushing against his prostate has him blow.  Wtih a mighty bellow, he blasts shot after shot of hot cum into the ecstatic soldier beneath him.  From the way his anal muscles and glutes are squeezing down around you, you know he's pumping the female soldier's belly full of his virile seed.  Elaine cries out in orgasmic response, wriggling atop the spurting shaft while caressing his muscular chest.  It's difficult to hold back, but you manage to hold on knowing there's lots more fun ahead.";
		attempttowait;
...
Tiny Tim is a man.
The description of Tiny Tim is "     The large minotaur affectionately called 'Tiny Tim' by the soldiers in the camp currently sits on the ground besides the hitching post used in couplings with him. He's a magnificently well-built creature, at least nine feet tall and with large curved horns adoring his bull-like head. His otherwise human upper body shows thick, ropey muscles under bronzed skin. Beginning at the hip downwards, he has dark brown shaggy fur covering strong two-jointed legs that end in hooves. Between his legs dangles a long human-like cock and two large balls. The minotaur almost constantly half-hard, his manhood springing up instantly to its full one and a half feet of erect length every time the creature sees or smells a sexual partner."
...
instead of conversing Tiny Tim:
	...
	otherwise:
		say "[one of]'You fun.  Friend!' he says, giving you a crushing hug.[or]'Alexander is my friend.'[or]'I'm hungry.'[or]'[if thirst of Tiny Tim - turns < 4]Still tired.  Good fun[otherwise]I'm horny. Want to fuck[end if].'[or]'You smell nice.'[or]'Humans are tight. Good.'[or]'Nice place here.'[or]'I like soldiers.'[at random]";
