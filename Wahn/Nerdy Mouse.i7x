...
to say Wesley_First_BJ:
	...
	say "     Almost surprising for his relatively slim build, the young man is sporting a respectably long cock, at least six inches in length (which is comparatively huge, given that he's just four feet tall), if a little more slender than average. Underneath it are two modestly-sized balls in a snug furry sack. Looks like Wesley is somewhat of a sniper in the genital-department. In the end, one doesn't need massive amounts of cum if they deliver their shot right on target, and pretty deep. The slender rodent is holding his breath as you inspect his crotch, almost as if afraid you or someone else might suddenly jump out to laugh, slap his manhood, or the like, and he lets out a pleasantly relieved sigh as you gently take hold of his pink-skinned member, stroking its length up and down. 'T-that's nice. You know, that's the one part that didn't shrink when I transformed. I was so glad about that!' he says with a shy smile, his hips pushing a little forward to get closer to your touch. Wanting to add to his pleasure, you cup his balls and play your fingers over them in massaging movements.";
	WaitLineBreak;
...
to say WesleyForcedSexMenu:
	project Figure of Nerdy Mouse_hard_icon;
	say "     [bold type]<Writer's Note: This content might be subject to some changes and adjustments in the near future, as it still needs editing for tone and consistency.>[roman type][line break]";
