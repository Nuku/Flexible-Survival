...
When Play begins:
	...
	add "Dalmatian Male" to infections of CanineList;
	add "Dalmatian Male" to infections of NatureList;
	add "Dalmatian Male" to infections of FurryList;
	add "Dalmatian Male" to infections of MaleList;
	add "Dalmatian Male" to infections of TaperedCockList;
	add "Dalmatian Male" to infections of KnottedCockList;
	add "Dalmatian Male" to infections of SheathedCockList;
	add "Dalmatian Male" to infections of BipedalList;
	add "Dalmatian Male" to infections of TailList;
	now Name entry is "Dalmatian Male"; [ Infection/Creature name. Capitalized. ]
	now enemy title entry is "Male Dalmatian"; [ Name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name. ]
...
When Play begins:
	...
	now NewTypeInfection entry is false;
	now Species Name entry is "Dalmatian";
	add "Dalmatian Bitch" to infections of CanineList;
	add "Dalmatian Bitch" to infections of NatureList;
	add "Dalmatian Bitch" to infections of FurryList;
	add "Dalmatian Bitch" to infections of FemaleList;
	add "Dalmatian Bitch" to infections of TaperedCockList;
	add "Dalmatian Bitch" to infections of KnottedCockList;
	add "Dalmatian Bitch" to infections of SheathedCockList;
	add "Dalmatian Bitch" to infections of BipedalList;
	add "Dalmatian Bitch" to infections of TailList;
...
"Dalmatian Male Infection"	"Infection"	""	Dalmatian Male Infection rule	1000	false

This is the Dalmatian Male Infection rule:
	if Player has a body of "Dalmatian Male":
		trigger ending "Dalmatian Male Infection"; [Here it states, that the ending has been played.]
