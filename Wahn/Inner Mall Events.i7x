...
to say ResolveEvent Dressing Room Rampage:
	...
	if Player consents:
		...
		if Player consents:
			...
			if Player is male:
				...
				say "present your [BodyName of Player in lower case] [if Player is female]pussy[else]crotch[end if] to the slender twink of an elf. The happily moaning bottom reacts immediately, sticking out his tongue to lick over your [if Player is female]nether lips. The tip of his fleshy appendage circles your clit a few times[else]sensitive skin. The tip of his fleshy appendage seeks out a surprisingly sensitive spot[end if], making sure to stimulate it nice and long to drive you wild. He may just be a small dude, but this little guy sure knows how to please [if Player is female]a woman[else]someone[end if]! You run your fingers through the long and soft strands of his hair, then grab it and use it as a nice handhold, grinding the elf's head up and down against your crotch. Rubbing up against the elfin male, you exchange a broad grin with the polar bear top on the other end.";
				say "     'Quite something, isn't he?' the white-furred man says proudly, half-grunting the words as he pounds the elf's ass with thrust after hard thrust. 'Best ass one can wish for. Such a fucking [italic type]tight[roman type] boy-pussy!' Given the enthusiasm with which the big man is pounding his submissive partner, you're surprised that the little guy can take it all. Maybe Christmas elves are just naturally stretchy, or the bottom is just exceptionally skilled at what he does. The sensation of his slurping tongue and the little teasing nibbles [if Player is female]on your clit[else]he gives you[end if] certainly suggest it, as he eagerly replies to your grinding and even employs some little tricks with his tongue to tease your arousal to ever higher levels.";
				WaitLineBreak;
				...
				NPCSexAftermath Jay receives "OralPussy" from Player;
			WaitLineBreak;
	...
	NPCSexAftermath Jay receives "AssFuck" from Mark;
...
to say SizeEnvy_BJ:
	...
	CreatureSexAftermath "Player" receives "OralCock" from "Clockwork Fox";
	CreatureSexAftermath "Player" receives "OralCock" from "Mall Rat";
	PlayerDrink 20;
	PlayerEat 20;
...
to say AxelBJ:
	...
	CreatureSexAftermath "Player" receives "OralCock" from "Donkeyman";
	PlayerEat 20;
...
to say ResolveEvent Prowling Macho:
	...
	if Player consents:
		...
		if calcnumber is 1:
			LineBreak;
			if Player is male: [male+herm fuck]
				...
				CreatureSexAftermath "Feline" receives "Stroking" from "Player";
