	...
	if calcnumber is 1:
		...
		if calcnumber is 1: [chat]
			...
			if AxelRelationship < 3: [first time]
				...
				if Player is male:
					say "I'm not into dudes, you know. Nope. No, definitely not.' Resting your hand right on the spot where a half-hard shaft snakes its way down his pants-leg and feeling it throb, you have your doubts about that. The young man does protest a bit much about the whole idea too, but for now you just keep silent about that and don't call it out.";
					if Player is dominant:
				...
				if Player is male:
					say "But remember, I'm not [italic type]really[roman type] into dudes. Nope. No, definitely not.' Resting your hand right on the spot where a half-hard shaft snakes its way down his pants-leg and feeling it throb, you have your doubts about that. The young man does protest a bit much about the whole idea too, but for now you just keep silent about that and don't call it out.";
					if Player is dominant:
