...
[ Character A - Candy Interaction: (ElijahChar-A)                      ]
[   0: Nothing happened                                                ]
[   1: Candy-Care-Event done                                           ]
[   2: Candy talked to Virgin Elijah                                   ]
[   3: Candy-Cane gift done                                            ]
[   4: Assfucking Candy done                                           ]
[ Character B - Sarah Interaction: (ElijahChar-B)                      ]
[   0: Nothing happened                                                ]
[   1: Sarah-Care-Event done                                           ]
[   2: Praying with Sarah done                                         ]
[   3: Playing Ball done                                               ]
[   4: Facefucking Sarah done                                          ]
[ Character C - Sven Interaction: (ElijahChar-C)                       ]
[   0: Nothing happened                                                ]
[   1: Sven-Care-Event done                                            ]
[   2: Listening to Sven done                                          ]
[   3: Sexxxings                                                       ]
[ Character D - Felinoid Companion Interaction: (ElijahChar-D)         ]
[   0: Nothing happened                                                ]
[   1: Rubbing up done                                                 ]
[   2: Elijah stroking done (same for HP state 3+4)                    ]
[   4: Assfucking Felinoid done                                        ]
[ Character E - Helper Dog Interaction: (ElijahChar-E)                 ]
[   0: Nothing happened                                                ]
[   1: Keeping company done                                            ]
[   2: Stroking the dog done                                           ]
[   3: Shaking paws done                                               ]
[   4: Failed Transformation done                                      ]
[ Character F - Little Fox Interaction: (ElijahChar-F)                 ]
[   0: Nothing happened                                                ]
[   1: Keeping company done                                            ]
[   2: Sleeping peacefully done                                        ]
[   4: Thrown off the bunk done                                        ]
[ Character G - Denise (gryphoness) Interaction: (ElijahChar-G)        ]
[   0: Nothing happened                                                ]
[   1: Singing company done                                            ]
[   2: Choir done                                                      ]
[   3: Feather grooming done                                           ]
[   4: Denise running off done                                         ]
[ Character H - Crab Pet Interaction: (ElijahChar-H)                   ]
[   0: Nothing happened                                                ]
[   2: Grabbing a wingtip done (same for HP state 3+4)                 ]
[   4: Thrown off the bunk done                                        ]
[ Character I - Fang Interaction: (ElijahChar-I)                       ]
[   0: Nothing happened                                                ]
[   2: Guard duty done                                                 ]
[   3: Stroking Fang done                                              ]
[   4: Husky female done                                               ]
[ Character J - Honey Interaction: (ElijahChar-J)                      ]
[   0: Nothing happened                                                ]
[   1: Frets over Elijah done                                          ]
[   2: Chat done                                                       ]
[   3: Hive prayer done                                                ]
[   4: Grabby Elijah done                                              ]
[ Character K - Unassigned Interaction: (ElijahChar-K)                 ]
[ Character L - Unassigned Interaction: (ElijahChar-L)                 ]
[ Character M - Unassigned Interaction: (ElijahChar-M)                 ]
...
to say ResolveEvent Angel vs Demons:
	if HP of Gabriel is 0:
		...
		now ElijahChar-A is "0";
		now ElijahChar-B is "0";
		now ElijahChar-C is "0";
		now ElijahChar-D is "0";
		now ElijahChar-E is "0";
		now ElijahChar-F is "0";
		now ElijahChar-G is "0";
		now ElijahChar-H is "0";
		now ElijahChar-I is "0";
		now ElijahChar-J is "0";
		now ElijahChar-K is "0";
		...
		repeat with y running from 1 to number of filled rows in Table of Random Critters:
			...
			if Name entry is "Seraphim Warrior":
				now MonsterID is y;
...
Cunt Depth of Elijah is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
ElijahChar-C is a text that varies. ElijahChar-C is normally "0". [Sven]
ElijahChar-D is a text that varies. ElijahChar-D is normally "0". [Felinoid]
ElijahChar-E is a text that varies. ElijahChar-E is normally "0". [Helper Dog]
ElijahChar-F is a text that varies. ElijahChar-F is normally "0". [Little Fox]
ElijahChar-G is a text that varies. ElijahChar-G is normally "0". [Gryphoness]
ElijahChar-H is a text that varies. ElijahChar-H is normally "0". [Cute Crab]
ElijahChar-I is a text that varies. ElijahChar-I is normally "0". [Fang]
ElijahChar-J is a text that varies. ElijahChar-J is normally "0". [Honey]
ElijahChar-K is a text that varies. ElijahChar-K is normally "0". [unassigned]
ElijahChar-L is a text that varies. ElijahChar-L is normally "0". [unassigned]
ElijahChar-M is a text that varies. ElijahChar-M is normally "0". [unassigned]
honeygiven is a truth state that varies. honeygiven is normally false.

to ElijahImageProject:
	if HP of Elijah is 1 or HP of Elijah is 2:
		project the Figure of Elijah_good_naked_icon;
	else if HP of Elijah is 3:
		project the Figure of Elijah_virgin_icon;
	else if HP of Elijah is 4:
		project the Figure of Elijah_good_icon;
	else if HP of Elijah is 99:
		project the Figure of Elijah_evil_icon;
...
to say elijahdesc:
	ElijahImageProject;
	if debugactive is 1:
		say "DEBUG -> HP: [HP of Elijah], Thirst: [thirst of Elijah] <- DEBUG[line break]";
	if (HP of Elijah is 0): [chained up in the chapel]
		say "     The angel has had his armor ripped away and his white tunic is thorn, bloodstained and splattered with cum-stains. Even his once bright halo has suffered, now a pale flickering shadow of its former glory. He looks young, with an unlined face and short brown hair. At the moment, his arms are chained to a wooden cross, the chains being the only thing holding him upwards as he drifts in and out of consciousness. His wings hang limply from his shoulders.";
	if (HP of Elijah is 1) or (HP of Elijah is 2): [wounded + unconscious in the bunker]
		say "     The angel is tall and well-built, looking an early 20 years old. His unlined, very pretty face is topped by a head of short brown hair. At the moment, he's spending most of his time asleep on a bunk in the bunker, opening his azure eyes only rarely to look around tiredly and a bit confused. He's naked under the sheet, and his large white wings poke out over the sides of the bed, reaching almost to the next bunk in line.";
	if (HP of Elijah is 3): [virgin Elijah]
		say "     Elijah is tall and well-built, looking an early 20 years old. His unlined, very pretty face is topped by a head of short brown hair. At the moment, he's spending most of his time sitting quietly on his bunk, hands folded in prayer and observing his surroundings with azure eyes. He's garbed in a simple white shirt and a pair of pants - where those came from, you can only wonder. His large white wings are folded together behind his back.";
	if (HP of Elijah is 4): [good Elijah]
		say "     Elijah is tall and well-built, looking an early 20 years old. He has an unlined, very pretty face with azure eyes, crowned by a head of short brown hair. Lately, he's often up and about, strolling out into the library and the nearer city blocks or having a look around from the air. He's taken up wearing a pair of tight jeans and military boots he found somewhere, leaving his chest bare and showing off some handsomely sculpted abs. His large white wings are folded together behind his back, but tend to spread out a bit and move animatedly when he's talking to you.";
	if (HP of Elijah is 99): [evil Elijah]
...
instead of conversing the Elijah:
	...
	if (HP of Elijah is 0): [chained up in the chapel]
		...
		if FurryList is not banned, now Examination Room is active;
...
instead of going down from the Grey Abbey Library while (Elijah is in the Bunker and HP of Elijah is 99 and thirst of Elijah is 0 and Player is submissive and CuckList is not banned and lastfuck of Elijah - turns > 6):
	move player to Bunker;
	project the figure of Elijah_evil_face_icon;
	...
	if Player consents: [now it's sure the player will get fucked]
		...
		if Player consents: [go into it willingly]
			...
			if Player is female: [female+herm]
				...
				say "     Pulling out till only the tip of his cock remains inside you, then slamming it all the way in again, the green-marked spidertaur has you gasping in lust and squirming in your silken bonds in no time. He takes great pleasure in dominating you, his cock twitching every time you give him an involuntary moan after one of his sudden thrusts. Soon this stimulation overwhelms your ability to hold back and as he bottoms out inside you again, [if Player is male]your own cock starts to throb as spurt after spurt of cum jet from its tip, splattering your naked chest with your own seed[else]you come, gushing femcum all around his hard shaft to run and drip down onto the silken sling under you[end if]. 'So you got off from having me inside you, hm? Your pussy feels amazing with all the little twitches going through your now.' Zephias remarks, then gets back into fucking you hot and hard, even speeding up a bit as his own orgasm approaches. It's not too much longer until he pushes all of his shaft into you one last time and gives a satisfied grunt as he shoots a big load of cum directly into your womb.";
				NPCSexAftermath Player receives "PussyFuck" from Zephias;
				WaitLineBreak;
				...
				say "     Even though you just came, getting fucked - getting taken by a second dominant man in a row - quickly has your lust rising again. The squishy sounds of cum squirting out of you as Elijah slams his cock in your pussy are joined by your moans and pants, then your begging for him to fuck you harder. Thrusting in and out of your cum-filled passage, your angel pimp speeds up more and more, then suddenly lets out a grunt of 'I'm gonna... cum!', accompanied by slamming forward one last time. You can feel his hard shaft pulse against your inner walls as he comes, spurt after spurt of his seed jetting into your insides.";
				NPCSexAftermath Player receives "PussyFuck" from Elijah;
				WaitLineBreak;
				say "     Elijah stays inside you for a while, just letting his slowly softening shaft rest in your hole as he puts a hand on [if Player is male]your hard shaft and jerks you off [else]your crotch and strokes you there. [end if]Grinning, he takes care not to get you off, just to keep you all hot and bothered, aching to come. Some time later, after giving you one last grope, Elijah takes off your bindings and helps your oversexed and trembling form to stand up from the sling. 'You did well, pet. I allow you to get yourself off now.' Your hands fly to your crotch [if Player is male]to grab your incredibly hard erection and jerk it[else]to stroke over your pussy lips and clit[end if]. In no time at all, you get your release, [if Player is male]spraying long strings of cum into the air to splatter[else]gushing femcum from your sex and dripping it onto[end if] the hardwood floor.";
				...
				say "     Pulling out till only the tip of his cock remains inside you, then slamming it all the way in again, the green-marked spidertaur has you gasping in lust and squirming in your silken bonds in no time. He takes great pleasure in dominating you, his cock twitching every time you give him an involuntary moan after one of his sudden thrusts. Soon this stimulation overwhelms your ability to hold back and as he bottoms out inside you again, your [if Player is male]own cock starts to throb as spurt after spurt of cum jet from its tip, splattering your naked chest with your own seed[else]whole body starts to tremble and shake in an amazing orgasm[end if]. 'So you got off from having me inside you, hm? Your ass feels amazing with all the little twitches going through your insides now.' Zephias remarks, then gets back into fucking you hot and hard, even speeding up a bit as his own orgasm approaches. It's not too much longer until he pushes all of his shaft into you one last time and gives a satisfied grunt as he shoots a big load of cum deep inside your ass.";
				NPCSexAftermath Player receives "AssFuck" from Zephias;
				WaitLineBreak;
				...
				say "     Even though you just came, getting fucked - getting taken by a second dominant man in a row - quickly has [if Player is male]your manhood hardening[else]you going[end if] again. The squishy sounds of cum squirting out of you as Elijah slams his cock in your ass are joined by your moans and pants, then your begging for him to fuck you harder. Thrusting in and out of your cum-filled ass, your angel pimp speeds up more and more, then suddenly lets out a grunt of 'I'm gonna... cum!', accompanied by slamming forward one last time. You can feel his hard shaft pulse against your inner walls as he comes, spurt after spurt of his seed jetting into your insides.";
				NPCSexAftermath Player receives "AssFuck" from Elijah;
				WaitLineBreak;
				say "     Elijah stays inside you for a while, just letting his slowly softening shaft rest in your hole as he puts a hand on [if Player is male]your hard shaft and jerks you off[else]your crotch and strokes you there[end if]. Grinning, he takes care not to get you off, just to keep you all hot and bothered, aching to come. Some time later, after giving you one last grope, Elijah takes off your bindings and helps your oversexed and trembling form to stand up from the sling. 'You did well, pet. I allow you to get yourself off now.' Your hands fly to your crotch to [if Player is male]grab your incredibly hard erection and jerk it[else]stroke over the smooth but sensitive spot where your genitals should be, if you had any[end if]. In no time at all, you get your release, [if Player is male]spraying long strings of cum into the air[else]a deep feeling of satisfaction running through your insides[end if].";
				say "     'I need to bring you here more often' the dark angel says with a smile, followed by 'Time to clean up.' He then has you clean up the room - naked as you are - licking up the cum from where it leaked onto the sling and dripped on the smooth hardwood floor. Only when you've done this to his satisfaction does he allow you to dress and leads you back to the library.";
			...
			if Player is female: [female+herm]
				...
				NPCSexAftermath Player receives "PussyFuck" from Elijah;
				WaitLineBreak;
				say "     Elijah stays inside you for a while, just letting his slowly softening shaft rest in your hole as he puts a hand on your [if Player is male]hard shaft and jerks you of[else]crotch and strokes you there[end if]. Grinning, he takes care not to get you off, just to keep you all hot and bothered, aching to come. Some time later, after giving you one last grope, Elijah takes off your bindings and helps your oversexed and trembling form to stand up from the sling. 'You did well, pet. I allow you to get yourself off now.' Your hands fly to your crotch to [if Player is male]grab your incredibly hard erection and jerk it[else]stroke over your pussy lips and clit[end if]. In no time at all, you get your release, [if Player is male]spraying long strings of cum into the air to splatter[else]gushing femcum from your sex and dripping it onto[end if] the hardwood floor.";
...
instead of going down from the Grey Abbey Library while (Elijah is in the Bunker and HP of Elijah is 99 and thirst of Elijah is 1 and Player is submissive and CuckList is not banned and lastfuck of Elijah - turns > 6 and demon brute is tamed and Player is male):
	move player to Bunker;
	project the figure of Elijah_evil_face_icon;
	...
	if DBCaptureQuestVar is 5: [evil Brutus]
		if DemonBruteStatus is 2: [female Brutus]
			...
			NPCSexAftermath Player receives "AssFuck" from Elijah;
			NPCSexAftermath Player receives "AssFuck" from Elijah;
			NPCSexAftermath Player receives "OralPussy" from Brutus;
		else: [herm and male Brutus]
			say "     After spending a moment to take in Brutus's large, muscular and naked body, Elijah calls to your demonic slave 'Aren't you ashamed of yourself to haven been captured by such a weak-willed little man? Having to follow his orders and serve him?' A deep, rumbling growl starts to grow in Brutus's chest as Elijah goads and teases him, and you can see the demon's claws twitching as he strains against the amulet's magic. Elijah wraps an arm around you from behind, making you turn to watch the furious demon and says in a smooth tone, 'Look, your little demon has gotten all riled up. Now, we can't let the poor, stupid beast keep it all bottled up inside him, can we? That's not good for him after all...'";
...
instead of going down from the Grey Abbey Library while (Elijah is in the Bunker and HP of Elijah is 99 and thirst of Elijah is 2 and Player is submissive and CuckList is not banned and lastfuck of Elijah - turns > 6 and demon brute is tamed and Player is male and DemonBruteStatus is 0):
	move player to Bunker;
	project the figure of Elijah_evil_face_icon;
	...
	if (HP of Elijah is 1 or HP of Elijah is 2) and (NPCintCounter - turns > 2) and Player is not CoA:
		if (player is in Bunker):
			if Candy is in Bunker and ElijahChar-A is "0":
				...
				now ElijahChar-A is "1";
				now NPCintCounter is turns;
			else if (Sarah is in Bunker) and ElijahChar-B is "0":
				...
				now ElijahChar-B is "1";
				now NPCintCounter is turns;
			else if (Sven is in Bunker) and ElijahChar-C is "0":
				...
				now ElijahChar-C is "1";
				now NPCintCounter is turns;
			else if (felinoid companion is tamed) and ElijahChar-D is "0":
				...
				now ElijahChar-D is "1";
				now NPCintCounter is turns;
			else if (helper dog is tamed) and ElijahChar-E is "0":
				...
				now ElijahChar-E is "1";
				now NPCintCounter is turns;
			else if (little fox is tamed) and ElijahChar-F is "0":
				...
				now ElijahChar-F is "1";
				now NPCintCounter is turns;
			else if (gryphoness is tamed) and ElijahChar-G is "0":
				...
				now ElijahChar-G is "1";
				now NPCintCounter is turns;
			else if (bee girl is tamed) and ElijahChar-J is "0":
		...
		if (player is in Bunker):
			if Candy is in Bunker and (ElijahChar-A is "0" or ElijahChar-A is "1"):
				...
				now ElijahChar-A is "2";
				now NPCintCounter is turns;
			else if (Sarah is in Bunker) and (ElijahChar-B is "0" or ElijahChar-B is "1"):
				...
				now ElijahChar-B is "2";
				now NPCintCounter is turns;
			else if (Sven is in Bunker) and (ElijahChar-C is "0" or ElijahChar-C is "1"):
				...
				now ElijahChar-C is "2";
				now NPCintCounter is turns;
			else if (felinoid companion is tamed) and (ElijahChar-D is "0" or ElijahChar-D is "1"):
				...
				now ElijahChar-D is "2";
				now NPCintCounter is turns;
			else if (helper dog is tamed) and (ElijahChar-E is "0" or ElijahChar-E is "1"):
				...
				now ElijahChar-E is "2";
				now NPCintCounter is turns;
			else if (little fox is tamed) and (ElijahChar-F is "0" or ElijahChar-F is "1"):
				...
				now ElijahChar-F is "2";
				now NPCintCounter is turns;
			else if (gryphoness is tamed) and (ElijahChar-G is "0" or ElijahChar-G is "1"):
				...
				now ElijahChar-G is "2";
				now NPCintCounter is turns;
			else if (cute crab is tamed) and (ElijahChar-H is "0" or ElijahChar-H is "1"):
				...
				now ElijahChar-H is "2";
				now NPCintCounter is turns;
			else if (bee girl is tamed) and (ElijahChar-J is "0" or ElijahChar-J is "1"):
		...
		if (player is in Bunker):
			if (Candy is in Bunker) and (ElijahChar-A is "0" or ElijahChar-A is "1" or ElijahChar-A is "2"):
				...
				now ElijahChar-A is "3";
				now NPCintCounter is turns;
				NPCSexAftermath Candy receives "AssDildoFuck" from Elijah;
				now lastCandyfucked is turns;
			else if (Sarah is in Bunker) and (ElijahChar-B is "0" or ElijahChar-B is "1" or ElijahChar-B is "2"):
				...
				NPCSexAftermath Sven receives "AssFuck" from Elijah;
				...
				now ElijahChar-C is "3";
				now NPCintCounter is turns;
[			else if (Sven is in Bunker) and (ElijahChar-C is "0" or ElijahChar-C is "1" or ElijahChar-C is "2") and (HP of Sven >= 30 and HP of Sven < 50): [skips if Player is not there to see it]
				...
				now ElijahChar-D is "2";
				now NPCintCounter is turns;
			else if (helper dog is tamed) and (ElijahChar-E is "0" or ElijahChar-E is "1" or ElijahChar-E is "2"):
				...
				now ElijahChar-E is "3";
				now NPCintCounter is turns;
			else if (gryphoness is tamed) and (ElijahChar-G is "0" or ElijahChar-G is "1" or ElijahChar-G is "2"):
				...
				now ElijahChar-G is "3";
				now NPCintCounter is turns;
			else if (cute crab is tamed) and (ElijahChar-H is "0" or ElijahChar-H is "1" or ElijahChar-H is "2"):
				say "     While taking your break before heading back into the city, you see Elijah lying on his bunk reading a book. Then suddenly, his brow scrunches up a bit and he slowly raises a wing from where it was hanging over the side of the bunk. Your cute little crab Snips is dangling off the wingtip, holding on with one of its claws. 'That's not there for you to pull on, little creature,' Elijah says, looking at it. 'You're lonely, aren't you? Here, let's give you something to play with.' With that, he pulls a small toy crab out of thin air and sets it down on the ground, soon followed by the real one. It takes hold of the toy and scampers off.";
				now ElijahChar-H is "3";
				now NPCintCounter is turns;
			else if (bee girl is tamed) and (ElijahChar-J is "0" or ElijahChar-J is "1" or ElijahChar-H is "2"):
		...
		if Player is in Bunker:
			if (Candy is in Bunker) and CuckList is not banned and (ElijahChar-A is "0" or ElijahChar-A is "1" or ElijahChar-A is "2" or ElijahChar-A is "3") and lastfuck of Elijah - turns >= 12:
				...
				say "     Accompanied by gasps, moans and whimpers, Elijah slams in and out of Candy for the next twenty minutes or so until he finally pushes the coon beyond the point of no return. Pink jets of cum shoot from Candy's coon cock all over the wall, filling the room with a sweet, candy-like smell. As Candy's body shakes in the throes of his orgasm, Elijah comes too, jamming his cock as deep as possible into his partner's ass and flooding it with his seed. After resting a moment longer inside Candy, Elijah pulls out his cock and walks past you to his bunk, making sure you see all of his naked glory.";
				NPCSexAftermath Candy receives "AssFuck" from Elijah;
				now ElijahChar-A is "4";
				now NPCintCounter is turns;
				now lastCandyfucked is turns;
			else if (Sarah is in Bunker) and CuckList is not banned and (ElijahChar-B is "0" or ElijahChar-B is "1" or ElijahChar-B is "2" or ElijahChar-B is "3") and lastfuck of Elijah - turns >= 12:
				if SarahSlut > 3:
					...
					NPCSexAftermath Sarah receives "OralCock" from Elijah;
					now ElijahChar-B is "4";
					now NPCintCounter is turns;
			else if (Sven is in Bunker) and CuckList is not banned and (ElijahChar-C is "0" or ElijahChar-C is "1" or ElijahChar-C is "2") and (HP of Sven >= 8 and HP of Sven < 30): [skips if Player is not there to see it]
				...
				NPCSexAftermath Sven receives "OralCock" from Elijah;
				NPCSexAftermath Sven receives "AssFuck" from Elijah;
...
[			else if (Sven is in Bunker) and (ElijahChar-C is "0" or ElijahChar-C is "1" or ElijahChar-C is "2") and (HP of Sven >= 30 and HP of Sven < 50): [skips if Player is not there to see it]
				...
				now lastfuck of Elijah is turns;
				now NPCintCounter is turns;]
			else if (felinoid companion is tamed) and CuckList is not banned and (ElijahChar-D is "0" or ElijahChar-D is "1") and lastfuck of Elijah - turns >= 12:
				...
				say "     Then he throws aside his sheet, revealing the rest of his naked body and a sizable erection. 'But it does make me quite horny, so let's see how tight that furry ass of yours is. Turn around!' he continues. The felinoid hesitates a moment at the forceful command, bringing his head over to Elijah's cock and sniffing it. Then he mews submissively and turns his big body around as Elijah's strong hands grip him. Elijah stands up and steps behind the big cat, groping his furred ass. Smiling demoniacally as he notices you watching, the fallen angel then grabs hold of the feline's tail, pulling it aside as he aligns his hard cock with the pucker below. Then, with one sharp thrust he slams it all in, burying his manhood completely and touching the furry behind in front of him with his hips. The cat roars at the sudden intrusion but calms down quickly as Elijah holds it in an iron grip and starts fucking in and out. Soon his own spined penis hardens and can be seen hanging under his quadrupedal body as the pain of the initial penetration fades and the good feelings begin to outweigh it.";
				WaitLineBreak;
				say "     Accompanied by moans, some growls and a roar or two, Elijah slams in and out of the felinoid for the next twenty minutes or so until suddenly the cat's penis starts spraying cum all over the floor under it. The spasms of its anal muscles accompanying each shot drive its fucker over the edge too, and you hear Elijah moan loudly as he grips two handfuls of fur and fills the feline's ass with his seed. Still balls-deep inside the felinoid, Elijah sinks forward exhaustedly, resting for a moment on its back. Then he gives a short laugh, pulling out and plopping back onto his bunk. Reaching out and pulling the felinoid's head towards him, he says 'Now you know what rubbing against me will get you. Do it again soon.'";
				NPCSexAftermath Klauz receives "AssFuck" from Elijah;
				now ElijahChar-D is "4";
				now NPCintCounter is turns;
			else if (helper dog is tamed) and (ElijahChar-E is "0" or ElijahChar-E is "1" or ElijahChar-E is "2"):
				...
				now ElijahChar-E is "4";
				now NPCintCounter is turns;
			else if (little fox is tamed) and (ElijahChar-F is "0" or ElijahChar-F is "1" or ElijahChar-F is "2"):
				...
				now ElijahChar-F is "4";
				now NPCintCounter is turns;
			else if (gryphoness is tamed) and CuckList is not banned and (ElijahChar-G is "0" or ElijahChar-G is "1" or ElijahChar-G is "2") and lastfuck of Elijah - turns >= 12:
				say "     While taking your break before heading back into the city, you see Elijah propositioning Denise, stepping into her comfort zone and lewdly touching her body. 'You're such a nice little gryphon breeder, so why don't we put some eggs into you,' the fallen angel says, reaching down to finger her pussy as Denise shakes her head and tries to step back. Elijah is making her moan and whimper with his skilled fingers, but she manages to somewhat regain her composure, saying 'I... I - *moan* - I'm taken, you - ooh - can't have me.' Winding herself out of his grasp, she rushes away and throws her arms around you in a tight hug.";
				now ElijahChar-G is "4";
				now NPCintCounter is turns;
			else if (cute crab is tamed) and (ElijahChar-H is "0" or ElijahChar-H is "1" or ElijahChar-H is "2"):
				...
				now ElijahChar-H is "4";
				now NPCintCounter is turns;
			else if (bee girl is tamed) and CuckList is not banned and (ElijahChar-J is "0" or ElijahChar-J is "1" or ElijahChar-J is "2"):
				say "     While tending to some odds and ends, you see Elijah strut over to Honey and grab her. His hands run over the bee girl's body, fondling her pussy and tender abdomen. 'Mmm... I want to get at your honeypot, cutie,' he says with a lecherous grin. The bee girl squirms in his grip and smooshes the honeycomb she was snacking on into his face. She squirms out of his grip as he sputters angrily. 'You're terrible. I'm sorry I ever felt sad that you got hurt,' she screams, tears in her eyes as she yells at him. She takes flight as he makes a grab for her, buzzing over to hide behind him, sobbing loudly. Elijah, meanwhile, is livid, growling about having to get this sticky gunk off his face and that he'll make her pay";
		...
		if Player is in Grey Abbey Library:
			if Fang is in Grey Abbey Library and Fang is Male and (HP of Fang < 5) and (ElijahChar-I is "0" or ElijahChar-I is "1" or ElijahChar-I is "2") and ( lastfuck of Fang - turns >= 8 ) and ( lastfuck of Elijah - turns >= 8 ):
				...
				if FemaleList is not banned:
					...
					CreatureSexAftermath "Husky Bitch" receives "OralCock" from "Elijah";
				else:
					CreatureSexAftermath "Latex Fox" receives "AssFuck" from "Fang";
					CreatureSexAftermath "Latex Fox" receives "OralCock" from "Elijah";
...
after going inside from the Grey Abbey Library while (HP of Elijah is 3 and NPCintCounter - turns > 4) and Player is not CoA: [virgin-mode]
	...
	if Candy is in Bunker and (ElijahChar-A is "0" or ElijahChar-A is "1"):
		say "     As you come down into the bunker, you pass Candy and Elijah going up into the library and catch some of their conversation. Candy says, '...and I even follow some of the rules you guys have. Isn't there something like 'love thy neighbor like yourself'? I sure love to stroke my dick and a hard shaft inside me, so of course I'm happy to do so for other men, too.' Elijah looks a bit puzzled at Candy's logic. Other parts of his anatomy seem to agree with the playful coon though, judging from the slight bulge in his tunic.";
		now ElijahChar-A is "2";
		now NPCintCounter is turns;
	else if (Sarah is in Bunker) and (ElijahChar-B is "0" or ElijahChar-B is "1"):
		if SarahSlut is 0: [mostly human, untouched by the player character]
...
after going inside from the Grey Abbey Library while (HP of Elijah is 99 and NPCintCounter - turns > 4) and Player is not CoA: [evil, very direct sex-fiend]
	...
	if (Candy is in Bunker) and CuckList is not banned and CuckList is not banned and (ElijahChar-A is "0" or ElijahChar-A is "1" or ElijahChar-A is "2" or ElijahChar-A is "3") and lastfuck of Elijah - turns >= 12:
		...
		now NPCintCounter is turns;
		now lastCandyfucked is turns;
	else if (Sarah is in Bunker) and CuckList is not banned and CuckList is not banned and (ElijahChar-B is "0" or ElijahChar-B is "1" or ElijahChar-B is "2" or ElijahChar-B is "3") and lastfuck of Elijah - turns >= 12:
		if SarahSlut > 3:
			...
			now ElijahChar-B is "4";
			now NPCintCounter is turns;
	else if (Sven is in Bunker) and CuckList is not banned and CuckList is not banned and (ElijahChar-C is "0" or ElijahChar-C is "1" or ElijahChar-C is "2") and (HP of Sven >= 8 and HP of Sven < 30): [skips if Player is not there to see it]
...
[	else if (Sven is in Bunker) and (ElijahChar-C is "0" or ElijahChar-C is "1" or ElijahChar-C is "2") and (HP of Sven >= 30 and HP of Sven < 50): [skips if Player is not there to see it]
		...
		now ElijahChar-C is "3";
		now NPCintCounter is turns;]
	else if (felinoid companion is tamed) and CuckList is not banned and CuckList is not banned and (ElijahChar-D is "0" or ElijahChar-D is "1") and lastfuck of Elijah - turns >= 12:
		...
		now ElijahChar-F is "4";
		now NPCintCounter is turns;
	else if (gryphoness is tamed) and CuckList is not banned and CuckList is not banned and (ElijahChar-G is "0" or ElijahChar-G is "1" or ElijahChar-G is "2") and lastfuck of Elijah - turns >= 12:
		...
		now ElijahChar-H is "4";
		now NPCintCounter is turns;
	else if (bee girl is tamed) and CuckList is not banned and CuckList is not banned and (ElijahChar-J is "0" or ElijahChar-J is "1" or ElijahChar-J is "2"):
	...
	if HP of Elijah is 0: [in the chapel, losing him to the demons] [***]
		...
		if Player consents:
			...
			if FemaleList is banned:
				...
				CreatureSexAftermath "Elijah" receives "AssFuck" from "Demon Brute";
				CreatureSexAftermath "Incubus" receives "AssFuck" from "Elijah";
			else:
				...
				CreatureSexAftermath "Elijah" receives "AssFuck" from "Demon Brute";
				CreatureSexAftermath "Succubus" receives "PussyFuck" from "Elijah";
		...
		if BodyName of Player is not listed in the infections of DemonList and BodyName of Player is not "Hellhound":
		...
		if BodyName of Player is listed in the infections of DemonList or BodyName of Player is "Hellhound":
...
to say ElijahSexMenu:
	...
	[]
	if (Player is male) and (ElijahChar-C is "3") and HP of Sven >= 8 and HP of Sven < 30:
		choose a blank row in table of fucking options;
		now title entry is "Threesome with Sven";
		now sortorder entry is 5;
		now description entry is "Share Sven's mouth and ass with Elijah";
	[]
	if (Player is female) and (ElijahChar-C is "3") and HP of Sven >= 8 and HP of Sven < 30:
		choose a blank row in table of fucking options;
...
[	***triggers for scenes w/confident Sven.]
	if (Player is male) and ((ElijahChar-D is "2") or (ElijahChar-D is "4")) and Felinoid companion is tamed:
		choose a blank row in table of fucking options;
		now title entry is "Fuck Elijah and the Felinoid";
		now sortorder entry is 7;
		now description entry is "Take two hot creature's asses.";
	[]
	if (Player is female) and ((ElijahChar-D is "2") or (ElijahChar-D is "4")) and Felinoid companion is tamed:
		choose a blank row in table of fucking options;
		now title entry is "Have Elijah and the Felinoid fuck you";
		now sortorder entry is 8;
		now description entry is "Take two males in your pussy.";
	[]
	if (Player is male) and ((ElijahChar-A is "3") or (ElijahChar-A is "4")) and (Candy is in Bunker):
		choose a blank row in table of fucking options;
	...
	[]
	if (Player is female) and ((ElijahChar-A is "3") or (ElijahChar-A is "4")) and (Candy is in Bunker):
		choose a blank row in table of fucking options;
	...
	if (( ElijahChar-I is "3") or (ElijahChar-I is "4")) and Fang is booked and Fang is Male:
	if (HP of Elijah < 99): [good guy]
		...
		say "     Your mind goes into a kind of lustful haze as your angelic friend fucks you with swift and deep strokes and you're making your soft-furred pet gasp and moan with your mouth and tongue. You can't really say how long the amazing fucking session lasts, but you orgasm several times in its course, your pussy getting dripping wet around Elijah's thrusting cock[if Cock Count of Player is 1] and your own maleness spurting long arches of cum into the air and all over your chest and bunk[else if Cock Count of Player > 1] and your own maleness spurting long arches of cum into the air and all over your chest and bunk[end if]. Then at some point, Elijah's willpower is finally worn out and he can't hold back any longer, grinding his hips against yours to get as deep inside you as possible and burying his hands in the bunk's blanket. You feel his shaft pulse against the inner walls of your pussy as spurt after spurt of fertile seed gets deposited right in your womb.";
		NPCSexAftermath Player receives "PussyFuck" from Elijah;
		LineBreak;
		say "     After the last blast of cum, Elijah sinks down on top of you, taking a deep breath and then giving you a long kiss. You let him rest against you for a moment, then push him softly to the side to lie on your bunk. Time to give your faithful pet his release too - Sven's still standing next to the bunk, a hopeful expression on his face and his feline cock ready to go.";
		say "     [bold type]Where do you let Sven spend his load?[roman type][line break]";
		LineBreak;
		say "     ([link]Y[as]y[end link]) - In your pussy!";
		say "     ([link]N[as]n[end link]) - In your mouth!";
		if Player consents:
			...
			NPCSexAftermath Player receives "PussyFuck" from Sven;
			LineBreak;
			...
			NPCSexAftermath Player receives "OralCock" from Sven;
			LineBreak;
...
to say ElijahSex7: [assfuck Elijah+Felinoid]
	if (HP of Elijah < 99): [good guy]
		say "     You see Elijah sitting on the edge of his bunk, bent over to pet the belly fur of your felinoid pet sprawled out on the ground before him. The large cat is loudly purring and is clearly enjoying itself a whole lot - he even shows a half-hard erection of his feline, spined maleness. That gives you an idea: Going over to sit beside Elijah, you run a hand over his arm then pull his head to your lips. After a heavenly kiss with some playful tongue-wrestling, you say 'I want to be inside you - and let's involve your little friend here too. Look, you got him all worked up and ready for some fun!' You lean down and stroke the felinoid's warm fur, then let your hands wander a bit and brush over his erection.";
		...
		say "     You come upon Elijah and your felinoid companion, with the fallen angel balls deep inside the large feline's ass, pumping his cock in and out. You watch them go at it a moment, then quickly strip off your clothes and step forward to join in. Embracing Elijah from behind, you let your hands roam over his muscled chest and rub your cock against the crack of his ass. Then you pull his head to the side to give him a quick tongue-kiss and tell him to lie down on the furry back of the beast he's fucking. Elijah climbs on top of your felinoid companion and you see the muscles in the large feline's legs flexing as he almost effortlessly takes the angel's weight. With Elijah lying on his stomach on the feline's furry back, his arms wrapped around its chest to hold on, his tight ass is right above the felinoid's. Your cock throbs at the inviting sight of your two friends waiting for you to take them and you stroke its hard length, then place it at Elijah's pucker and push forward.";
...
to say ElijahSex8: [Take Elijah and the Felinoid in your pussy - at the same time]
	if (HP of Elijah < 99): [good guy]
		...
		say "     Soon it's Elijah's turn to cum, driven over the edge by your tightness and the felinoid's hard shaft rubbing against his own. He gasps, pulling you down for a deep kiss as his balls pulse with spurt after spurt of fertile seed that erupts into your womb. The felinoid redoubles his fucking speed as he feels Elijah's angelic cum around his feline cock, trying to get his own sperm into the race for your eggs as fast as possible. After several more deep thrusts, he gives a satisfied roar and you feel forceful blasts of fertile felinoid seed fill your womb, mingling with Elijah's cum.";
		say "     As the two horny males pound into you, your hot juices flow, your submissive urges loving the fact that you're letting yourself be used by the two sexy lovers at once. The fact that one is a hot guy and the other is a wild beast makes it all the better. As you're being stuffed, Elijah talks dirty to you about how sexy you look and what a slut you are for being Fang's fucktoy. In the throes of your submissive urges, his words turn you on all the more, echoing how you feel and loving it. You delight in the sounds of Elijah's grunts as he tries to keep pace with the feral wolf while Fang pants in your ear and nips at your shoulder. You tilt your head back, sharing a slobbery kiss with your lupine alpha before turning and kissing Elijah. Feeling so deliciously full as Fang's knot swells and ties with you, you groan loudly in orgasm, your hot pussies clamping down around the pair of cocks stuffed inside you. The horny males cum shortly afterwards[if a random chance of 1 in 2 succeeds], first Elijah and then Fang[else], first Fang and then Elijah[end if]. The rush of having both their loads pumping into you makes you cum again, pushing you into multi-orgasmic bliss. Once you finally come down, you are left panting and soaked in feminine juices and leaking semen from your well-stuffed holes.[ElijahFangDoubleImpreg]";
...
to say ElijahSex13:[bondage and teasing by evil Elijah]
	if a random chance of 1 in 2 succeeds: [teasing and bondage on the bed]
		...
		if Player is female: [female+herm]
			...
			WaitLineBreak;
			say "     As long as he kept you going with that vibrator, it doesn't take long at all until actually getting fucked now drives you over the edge to orgasm. Giving a loud moan, almost a scream, you squirm around under him, [if Player is male]your own cock throbbing as spurt after spurt of cum jet from its tip, splattering your naked chest with your own seed. [else]your pussy twitching around his thrusting shaft as femcum starts to gush out of it. [end if]Moving in and out of your sopping wet passage, your angel master speeds up more and more, then suddenly lets out a grunt of 'I'm gonna... cum!', accompanied by slamming forward one last time. You can feel his hard shaft pulse against your inner walls as he comes, spurt after spurt of his seed jetting into your insides.";
			NPCSexAftermath Player receives "PussyFuck" from Elijah;
			say "     Elijah stays inside you for a while, just letting his slowly softening shaft rest in your hole. Grinning, he uses his fingers to gather up bit by bit of your [if Player is male]cum[else]femcum[end if] and feeds it to you. Some time later, after you've swallowed it all, he gives you one last grope and then takes off your bindings. 'You did well, pet,' the dark angel says with a smile, followed by 'Time to clean up.' He has you lick off the cum remaining on his manhood, then make the bed with fresh linen and throw out the old into a rubbish bin out on the street - naked as you are, showing off your freshly fucked body to anyone who might be watching. Only when you've done this to his satisfaction does he allow you to dress and leads you back to the library.";
		else: [male+neuter]
			...
			WaitLineBreak;
			say "     As long as he kept you going with that vibrator, it doesn't take long at all until actually getting fucked now drives you over the edge to orgasm. Giving a loud moan, almost a scream, you squirm around under him, [if Player is male]your own cock throbbing as spurt after spurt of cum jet from its tip, splattering your naked chest with your own seed. [else]a tingly feeling of satisfaction filling you or insides, beginning at the crotch. [end if]Moving in and out of your tight asshole, your angel master speeds up more and more, then suddenly lets out a grunt of 'I'm gonna... cum!', accompanied by slamming forward one last time. You can feel his hard shaft pulse against your inner walls as he comes, spurt after spurt of his seed jetting into your rectum.";
			NPCSexAftermath Player receives "AssFuck" from Elijah;
			say "     Elijah stays inside you for a while, just letting his slowly softening shaft rest in your hole. [if Player is male]Grinning, he uses his fingers to gather up bit by bit of your cum and feeds it to you. Some time later, after you've swallowed it all[else]Some time later[end if], he gives you one last grope and then takes off your bindings. 'You did well, pet,' the dark angel says with a smile, followed by 'Time to clean up.' He has you lick off the cum remaining on his manhood, then make the bed with fresh linen and throw out the old into a rubbish bin out on the street - naked as you are, showing off your freshly fucked body to anyone who might be watching. Only when you've done this to his satisfaction does he allow you to dress and leads you back to the library.";
		...
		if Player is female: [female+herm]
			...
			say "     Elijah takes great pleasure in dominating your tied-up form, his cock twitching every time you give him an involuntary moan after one of his sudden thrusts. Soon this stimulation overwhelms your ability to hold back and as he bottoms out inside you again, Soon this stimulation overwhelms your ability to hold back and as he bottoms out inside you again, your [if Player is male]own cock starts to throb as spurt after spurt of cum jet from its tip, splattering your naked chest with your own seed[else]whole body starts to tremble and shake in an amazing orgasm[end if]. 'Did you get off from me fucking you, pet?' Elijah says, then gets back into fucking you hot and hard without waiting for an answer. He soon speeds up a bit more as his own orgasm approaches. It's not too much longer until he pushes all of his shaft into you one last time and gives a satisfied grunt as he shoots a big load of cum deep inside your asshole.";
			NPCSexAftermath Player receives "AssFuck" from Elijah;
			WaitLineBreak;
			say "     Elijah stays inside you for a while, just letting his slowly softening shaft rest in your hole. There is a content look on his face and he says 'I need to bring you here more often' with a smile, followed by 'Time to clean up.' After loosening your restraints, he then has you clean up the room - naked as you are - licking up the cum from where it leaked onto the sling and dripped on the smooth hardwood floor. Only when you've done this to his satisfaction does he allow you to dress and leads you back to the library.";
	decrease humanity of Player by 3; [Additional humanity decrease from evil Elijah]
...
to say ElijahSex15:
	say "     Eager to let Elijah dominate you again, you quickly strip, then";
	if demon brute is listed in companionList of Player:
		say " wave Brutus closer.";
	else:
		say " use your demontooth amulet to summon Brutus.";
	say "The two of you walk up to Elijah, naked as you are, and present yourself for his pleasure. A wide grin spreads on the fallen angel's face as he watches you approach and when you come to stand before him, he says 'That's a fine pet. Couldn't take it any longer without feeling my cock? Good, good. Now then... the two of you, kneel for me.' You and Brutus quickly get down on the floor, slumped at Elijah's feet. Looking up, you can see unholy pleasure at his dominance dance in the dark angel's eyes, and a grin on his face as he opens the button of his pants and pushes them down over his hips. With him not even wearing underwear, you're directly presented with a long and inhumanly perfect cock, dangling half-hard under a small bush of black pubic hair. Grabbing Brutus by the horns to pull his head level with yours, Elijah stands close before the two of you, jerking himself to full hardness in short order.";
	...
	say "     Soon, the sensations drive your arousal over the edge and with a loud moan, your [Cock of Player] shaft sprays cum all over the bed. Your twitching and flexing hole around Brutus's shaft quickly pushes the demon to reach his own climax, giving something like a very deep purr as he does so, his pleasure at serving his master quite obvious. With a loud grunt, he begins to pump your bowels full of his seed, easily filling your asshole and intestines. The remaining cum starts squirting out around the demon's thick cock as he thrusts into you a few more times, creating hot squishing noises and making the warm goop run down the inside of your legs. As he finally removes his cock with a loud *pop*, your stomach looks distended from the sheer amount of cum he has injected into you, with more of it leaking from your hole to create a large wet spot on the bed.";
	say "     Shoving against Brutus and even managing to push the exhausted demon brute to fall into the bed with you, Elijah steps up on the mattress himself, hand flashing rapidly up and down his shaft as he jerks himself off. It's not long at all before the dark angel reaches the point of no return, aiming his cock alternatively at Brutus and your face as he sends spurt after spurt of his seed flying to splat down on you. Soon you and your demon companion's faces are wet with cum, which makes Elijah laugh darkly and say, 'Yeah, that's a good look for you. Two submissive cum-sluts for me to enjoy. Go on, lick it off each other - you know you want to.' And indeed you do - or at least Brutus does, as his long tongue quickly snakes out to start lapping at your face. You quickly join him at cleaning each other up, licking Elijah's still warm cum off the demon brute's face, which quickly leads over to the two of you making out, kissing and caressing each other. Not too interested in watching that, Elijah steps off the bed and walks away to clean himself up, with a noticeable spring in his step.";
	NPCSexAftermath Brutus receives "OralCock" from Elijah;
	NPCSexAftermath Player receives "AssFuck" from Brutus;
	NPCSexAftermath Brutus receives "AssFuck" from Elijah;

to say ElijahSex16: [Brutus and player dominate Elijah]
	say "     Deciding that you want another round of dominating Elijah, you ";
	if demon brute is listed in companionList of Player:
		say "wave Brutus closer";
	else:
		say "use your demontooth amulet to summon Brutus";
	say ", then ask him to grab Elijah for you. His massive cock already getting hard as he thinks back to last time, Brutus quickly moves forward to where Elijah is just crouched down, sorting through some of his gear and grabs him by the shoulder and hip. Elijah only has time to say, 'Oh fuuuuckKK,' as your demonic companion lifts him off his feet to casually throw him on the bed, landing face-first on the crumpled blankets. Brutus is on top of him in a second and hooks one of his sharp claws under the waistband of Elijah's tight pants, effortlessly slicing the black leather apart and pulling the shreds aside to bare his shapely butt. Elijah starts to raise himself up from the bed on all fours and grumbles 'Those were designer pants, you bastard!' - only to find himself pressed back down by the demon's large hand on his back. The start of further grousing by the angel is replaced by a breathless gasp a moment later, when Brutus bends his head down to lick Elijah's asshole. He laps up and down between the firm, perfectly shaped cheeks of the fallen angel's butt, then seeks out the pucker with his long, forked tongue and wiggles its tips in. Getting his ass eaten out, expertly and oh so deeply, with Brutus's long appendage lapping over his prostate, Elijah can't help but moan aloud, his hands gripping the sheets tightly as he writhes in pleasure.";
...
to say de-demonify:
	if BodyName of Player is listed in infections of DemonList or BodyName of Player is "Hellhound":
		now BodyName of Player is "Human";
		now Body of Player is "charmingly human";
	if SkinName of Player is listed in infections of DemonList or SkinName of Player is "Hellhound":
		now SkinName of Player is "Human";
		now Skin of Player is "smooth";
	if CockName of Player is listed in infections of DemonList or CockName of Player is "Hellhound":
		now CockName of Player is "Human";
		now Cock of Player is "";
	if FaceName of Player is listed in infections of DemonList or FaceName of Player is "Hellhound":
		now FaceName of Player is "Human";
		now Face of Player is "charmingly human";
	if TailName of Player is listed in infections of DemonList or TailName of Player is "Hellhound":
			...
			if (humanity of Player < 10):
				...
				if Player is not shifter and (BodyName of Player is listed in the infections of DemonList or Player has a body of "Hellhound"): [can't stand demons]
					...
					if gryphoness is tamed: [Denise pet]
						say "     Elijah becomes great friends with Denise, happily sharing your house - and bed - with her. They're often soaring through the sky near your home together, doing aerial acrobatics that bring fans and spectators from the surrounding areas. With as much time as they're spending together, it doesn't surprise you much to see Denise lay an[if GryphonessKnowpreg > 0]other[end if] egg pretty soon, from which a beautiful little white gryphlet hatches. The proud couple gives her the name Lailah. Not much time later, Elijah can be seen shepherding [if GryphonessKnowpreg is 2]your own two gryphlets from Denise and [else if GryphonessKnowpreg is 1]your own gryphlet from Denise and [end if]his pretty daughter on flying lessons to show [if GryphonessKnowpreg > 0]them[else]her[end if] some tricks.";
