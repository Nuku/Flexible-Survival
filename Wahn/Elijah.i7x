...
to say ElijahSexMenu:
	...
	if (hp of Elijah is 99 and thirst of Elijah is 1 and "Submissive" is listed in feats of player):
		choose a blank row in table of fucking options;
		now title entry is "Submit to bondage with Elijah";
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if player consents:
				...
				otherwise if (nam is "Double-penetration by Elijah and Fang"):
					say "[ElijahSex12]";
				otherwise if (nam is "Submit to bondage with Elijah"):
					say "[ElijahSex13]";
...
to say ElijahSex13:	[bondage and teasing by evil Elijah]
	...
	if cunts of player > 0: [female+herm]
		...
		say "     Elijah stays inside you for a while, just letting his slowly softening shaft rest in your hole. Grinning, he uses his fingers to gather up bit by bit of your [if cocks of player > 0]cum[otherwise]femcum[end if] and feeds it to you. Some time later, after you've swallowed it all, he gives you one last grope and then takes off your bindings. 'You did well, pet.' the dark angel says with a smile, followed by 'Time to clean up.' He then has you clean up the room and him - naked as you are - making the bed with fresh linen and throwing out the old and sucking off the cum remaining on his softening shaft. Only when you've done this to his satisfaction does he allow you to dress and leads you back to the library.";
	otherwise:	[male+neuter]
		...
		say "     Elijah stays inside you for a while, just letting his slowly softening shaft rest in your hole. [if cocks of player > 0]Grinning, he uses his fingers to gather up bit by bit of your cum and feeds it to you. Some time later, after you've swallowed it all, [otherwise]Some time later, [end if]he gives you one last grope and then takes off your bindings. 'You did well, pet.' the dark angel says with a smile, followed by 'Time to clean up.' He then has you clean up the room and him - naked as you are - making the bed with fresh linen and throwing out the old and sucking off the cum remaining on his softening shaft. Only when you've done this to his satisfaction does he allow you to dress and leads you back to the library.";	
	decrease humanity of player by 3;		[Additional humanity decrease from evil Elijah]
	now libido of player is ( libido of player / 2 );
