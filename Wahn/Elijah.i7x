...
[			else if (Sven is in Bunker) and (ElijahChar-C is "0" or ElijahChar-C is "1" or ElijahChar-C is "2") and (HP of Sven >= 30 and HP of Sven < 50): [skips if Player is not there to see it]
		...
		if Player is in Bunker:
			if (Candy is in Bunker) and (ElijahChar-A is "0" or ElijahChar-A is "1" or ElijahChar-A is "2" or ElijahChar-A is "3") and lastfuck of Elijah - turns >= 12:
				...
				now lastfuck of Elijah is turns;
				now lastCandyfucked is turns;
			else if (Sarah is in Bunker) and (ElijahChar-B is "0" or ElijahChar-B is "1" or ElijahChar-B is "2" or ElijahChar-B is "3") and lastfuck of Elijah - turns >= 12:
				if SarahSlut > 3:
...
[			else if (Sven is in Bunker) and (ElijahChar-C is "0" or ElijahChar-C is "1" or ElijahChar-C is "2") and (HP of Sven >= 30 and HP of Sven < 50): [skips if Player is not there to see it]
				...
				now lastfuck of Elijah is turns;
				now NPCintCounter is turns;]
			else if (felinoid companion is tamed) and (ElijahChar-D is "0" or ElijahChar-D is "1") and lastfuck of Elijah - turns >= 12:
				...
				now NPCintCounter is turns;
			else if (gryphoness is tamed) and (ElijahChar-G is "0" or ElijahChar-G is "1" or ElijahChar-G is "2") and lastfuck of Elijah - turns >= 12:
				...
				now NPCintCounter is turns;
			else if (bee girl is tamed) and (ElijahChar-J is "0" or ElijahChar-J is "1" or ElijahChar-J is "2"):
	...
	if Elijah is in the bunker:
		...
		if HP of Elijah is 99: [evil Elijah]
			...
			if (humanity of Player < 10):
				...
				if BodyName of Player is listed in the infections of DemonList or Player has a body of "Hellhound": [can't stand demons]
