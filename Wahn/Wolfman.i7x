...
when play ends:
	if bodyname of player is "Football Wolfman":
		...
		otherwise if hp of Septus >= 7:
			...
			say "     Ahhh, it's a wonderful game!";
		otherwise if hp of Septus is 99:
			say "     When rescue comes, you're poked and prodded a bit in a medical holding facility outside the city, then declared non-infectious and let go.  When you hear word of the 'Shifted American Football League' starting up and that the Wolfmen are going to be one of the star teams, you feel an ache pulling to the nascent sport.  You go all their games, even the road games, travelling across the dangerous wilds of the chaotic nation between the clusters of civilization.  You always pick a seat off at the back to remain unseen, not wanting to be seen by them, conflicted over your urge to play and your shame of being kicked off the team.";
