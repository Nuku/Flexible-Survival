...
To say Septus loses:
	if HP of Septus is 6:
		...
		if bodyname of player is "Football Wolfman":
			say "     Panting, the wolfman steps back from you to catch his breath. With an appreciating nod, Septus says 'Well done, [if cunts of player > 0]sister[else]brother[end if]. We need more players like you.'";
		else:
			say "     Panting, the wolfman steps back from you to catch his breath. With an appreciating nod, Septus says 'Well done, [if cunts of player > 0]girl[else]man[end if]. You're among the best I've tried out today.'";
...
When Play begins:
	...
	now tail entry is "You have a fluffy, mid-length tail growing out of your spine, just above the grabbable buns of your ass.";  [ Tail desc., written as a full sentence or left blank for none. ]
...
Instead of fucking Septus:
	...
	if(lastfuck of Septus - turns < 5):
		...
		if bodyname of player is "Football Wolfman":
			say "     The wolfman gives your furry body an appreciative look as you walk up to him. A smile crosses his muzzle as he asks 'Hey, [if cunts of player > 0]sister[else]brother[end if]. What's up?'";
		else:
...
to say SeptusSex4:[player ass fucked]
	...
	WaitLineBreak;
	say "     Not wasting another breath with talking, Septus starts pounding his hips against yours, his canine cock rubbing sensitive spots all along your inner passage. He goes at it in full throttle, never wavering a moment with his thrusts, but still shows some nice technique, shifting the angle of his entrance every few times. There's definitely something to be said about combining a wolf's tenacity for breeding with human intelligence. Given the wild ride Septus gives you, it's no big wonder that you soon get pretty close to orgasm. Reaching down to grab his furry ass, you squeeze his firm cheeks and pull his hips against you even harder with each of his thrusts. Then you feel it - the soft bulge at the base of Septus cock, his knot - swelling and expanding inside your asshole to tie your bodies together. The delicious feeling of fullness is the last straw to drive you over the edge, making you moan and hold on tight to your handsome wolfman as you ride out an amazing orgasm.";
	say "     [if cocks of player > 0]Spurt after spurt of your cum arc out of your hard cock, splattering your chest with white streaks. [end if]At the same time, Septus gives a long satisfied howl, accompanying his cock spurting a massive load of wolfman seed deep into your hole. After Septus cock stops pulsing with more shots of cum and he gets his breath back, he kisses you and rolls the both of you over to lie on your sides. Still held together by his knot trying to ensure impregnation, he stokes your face softly and says 'You're an amazing lay, baby. Let's do this again - often...'[mimpregchance]";
