...
to say LilithTalk5: 
	if libido of David < 64: 
		...
		say "     [WaitLineBreak]";
		say "     A large drop of precum forms at the tip of Brutus enormous shaft, gleaming in the candlelight, and the purple demon does look at Liam with lust in his eyes, but then he snarls and turns his head away. The changing expressions on his face show his inner turmoil - should he do as Lilith asks, earning happiness with David by damning this man to a fate as a succubus['] plaything, or refuse and never be truly happy? The internal conflict goes back and forth for several minutes, observed by a gleefully watching Lilith, then Brutus eventually looks to you, a pleading look in his eyes.";
		say "     [line break]";
		...
		if calcnumber is 2:          [refuse]
			...
			if libido of David is 62: [refused to Nermine before]
				say "     Meeting the purple demon's eyes, you give a little shake of your head and see him tense, then give a somewhat relieved breath and bow his head to you. 'No. I can not do that, succubus. That... part of me is in the past. You ask to much,' Brutus brings out in a controlled, gravelly voice, though you can see the muscles in his arm tense as he makes a fist, betraying his frustration at having what he so dearly wishes dangle just out of reach. He turns away and punches the nearest wall hard enough to make splintered rock rain to the ground, then quietly adresses you to say, '[if cunts of player > 0 and cocks of player is 0]Mistress [otherwise]Master [end if]- can we go back to the jackaless please? I can't stand being like this much longer.'";
...
to say BrutusLiamFuck:
	...
	say "     [WaitLineBreak]";
	say "     Brutus is rather quiet for a short while after Liam departs, then eventually says, '[if cunts of player > 0 and cocks of player is 0]Mistress [otherwise]Master [end if]- I... it was good to help Liam like this. Get him out of there. Would have been good even if we hadn't fucked.' His massive piece of man-meat throbs at the last word, showing that he did enjoy it quite a lot though. 'I would like to... do more good. Make things better. If you allow it, of course.' The purple giant bows his head to you obediently before he continues, 'Besides just... helping with stuff, Liam's showed me that giving pleasure can also help. Lilith wanted me to break him through sex, but what we shared... it freed him. So please, if there is an opportunity, can I do good again? One way or the other...'";
