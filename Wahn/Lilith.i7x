	...
	if LilithPregCounter is 1:
		...
		if Player is in Sacristy:
			if "Succubus Daughter Wanted" is listed in Traits of Lilith: [Alternate scene for Aerana's birth]
				...
				WaitLineBreak;
				say "     With a satisfied grin on her face, Lilith takes the child and sets her against her breast, feeding her. Before your eyes, the little succubus grows in leaps and bounds, rapidly passing the stages of toddler and little child, soon sitting on Lilith's lap instead of being held by her. Getting to her late teens moments later, your daughter starts putting both hands on her demon mother's breasts, caressing them as she switches off between them, licking over her nipples and drinking more milk.";
				WaitLineBreak;
				...
				WaitLineBreak;
				say "     A satisfied grin on her face, Lilith takes the child and sets him against her breast, feeding him. Before your eyes, the little incubus grows in leaps and bounds, rapidly passing the stages of toddler and little child, soon sitting on Lilith's lap instead of being held by her. Getting to his late teens moments later, your son starts putting both hands on his demon mother's breasts, caressing them as he switches off between them, licking over her nipples and drinking more milk.";
...
to say LilithTalk5:
	if Libido of David < 64:
		...
		WaitLineBreak;
		say "     'Awww, don't make such a long face - it's what demons are meant to do. They're not built for love,' Lilith says with a small shrug before adding, 'Though there may just be a way... let me talk to your pet for a moment.";
		if demon brute is not listed in companionList of Player:
			say " You summon Brutus,";
		else:
			say " You wave to Brutus to step up,";
		...
		say "     'Isn't he just adorable,' the demoness chuckles, then continues, 'I'll have so much fun with him. And that's where you come in, big guy. Training new playthings can be so... tedious, so I like getting them broken in hard right away. But half the time I let one of your brethren have a go, they - you know, actually break [']em. And then they're no fun anymore... just a mess to clean up.' The demoness reaches up to stroke Brutus's chest, putting a hand on his heart, then says, 'Since you're so... compassionate and caring now, I'm sure you'll do an amazing job. A going away bang, then I'll help you with your little problem and you can live happily ever after. Go on, you know you want to - grab the sweet hunk and ravage him. He's a virgin too... just think how tight he'll be.'";
		WaitLineBreak;
		say "     A large drop of precum forms at the tip of Brutus's enormous shaft, gleaming in the candlelight, and the purple demon does look at Liam with lust in his eyes, but then he snarls and turns his head away. The changing expressions on his face show his inner turmoil - should he do as Lilith asks, earning happiness with David by damning this man to a fate as a succubus's plaything, or refuse and never be truly happy? The internal conflict goes back and forth for several minutes, observed by a gleefully watching Lilith, then Brutus eventually looks to you, a pleading look in his eyes.";
		LineBreak;
	...
	if LilithPregnancy is 0 or LilithPregnancy is 4:
		...
		if Player consents:
			if DBCaptureQuestVar is 5:
				...
				increase DemonBruteStatus by 1;
				LineBreak;
				say "     Putting a hand on Brutus's shoulder, you ask if he's alright. He stands up, gingerly touching his changed crotch, then nods to you. 'Yes, master.'";
		else:
	...
	if LilithPregnancy is 4:
		...
		if Player consents:
			...
			if Player is male:
				...
				LineBreak;
				say "     Which shall it be? Get a blowjob from Lilith ([link]Y[as]y[end link]), or butt-fuck her ([link]N[as]n[end link])?";
				if Player consents: [bj from Lilith]
					...
					if Player is female: [herms]
						...
						say "     After a little kiss on your dickhead, the demoness then softly pushes you aside and turns her attention back to the fallen angel under her. Looking down on Elijah, you clearly see the urgent need to cum written in his face - no wonder, with him being balls-deep in Lilith's hot cave all this time and her keeping him just at the edge of sweet release. Lazily circling her hips on his pole, she asks, 'Do you want to cum, my sweet little angel?' - and when Elijah immediately groans out 'Yes!' ...she just stops. 'Beg for it,' Lilith demands, relishing in the power she has over yet another male, getting him to whimper and call her mistress before she finally starts rocking back and forth again and allows him to climax. Elijah shakes and twitches as his load blasts up into the female demon's womb, and he moans loudly while his hands tightly grip the sheets of the bed.";
						say "     When the exhausted dark angel finishes coming, Lilith pulls off his shaft and flops down on the bed herself. Lying on her back, she smiles up at you while her hand moves down to her crotch, a finger running through the slow trickle of angelic cum leaking out of her pussy. Bringing it to her mouth and tasting Elijah's seed, Lilith gives a content sigh and says, 'Wasn't that fun, boys? We'll have to do it again... often.'";
					NPCSexAftermath Lilith receives "OralCock" from Player;
				else: [fuck her ass]
					LineBreak;
					...
					NPCSexAftermath Lilith receives "AssFuck" from Player;
				...
				NPCSexAftermath Lilith receives "OralPussy" from Player;
			move player to Sacristy;
		else:
			LineBreak;
		...
		NPCSexAftermath Lilith receives "PussyFuck" from Elijah;
		...
		if Player consents:
			if Player is male:
				...
				NPCSexAftermath Player receives "OralPussy" from Lilith;
		...
		CreatureSexAftermath "Retriever Female" receives "OralPussy" from "Lilith";
		CreatureSexAftermath "Lilith" receives "OralPussy" from "Retriever Female";
	[
		...
		if Player consents:
			...
			if Player is male:
				...
				WaitLineBreak;
				say "     The incubus vigorously fucks you with an amazingly good technique, instantly reacting to your desires and needs, bumping you in exactly the right spots as only a sex demon can. He holds off on making you reach orgasm, prolonging the intense experience until your hands are tightly gripping the sheets under you and you're literally panting with the need to come. Then finally, he himself can't take it anymore and switches to rapid thrusts, hammering into you hard and deep, and orgasms not long after. The unbelievably handsome demon gives a satisfied grunt as he unloads deep into your asshole, filling you with his fertile seed. Leaning forward to nibble on your earlobe while his cock still twitches in you with more and more cum, Atticus says, 'Let's do this often...'";
				NPCSexAftermath Player receives "AssFuck" from Atticus;
		else:
		...
		CreatureSexAftermath "Lilith" receives "PussyFuck" from "Feral Gryphon";
	else:
		move player to Sacristy;
...
to say LilithSex6: [Spit-Roast her with Brutus]
	...
	WaitLineBreak;
	say "     Filled from both ends and with the two exhausted males who just fucked her panting and trying to catch their breaths, Lilith pulls off Brutus's shaft with a slurp, then puts her soft lips back to his cockhead to suck the last little bit of cum from it. 'Mmmm... tasty!' she sighs after a moment, dropping the demon's softening but still quite large cock to slap against his leg with a meaty thud. Turning her attention to you, she reaches down between her legs and cups your balls, gently fondling them while her inner muscles almost milking every last drop of your load from your manhood. 'I can feel your sperm inside me, filling my womb. Nice work, stud,' she sighs contently, then slowly pulls off your shaft, sinking down on the bed. Spread out on her back in all of a succubus's naked glory, Lilith smiles up at you, stroking the inside of your leg as she moans 'You were amazing, lover. Let's hope it takes. Together we can populate this earth with demons.'";
	NPCSexAftermath Lilith receives "OralCock" from Brutus;
	NPCSexAftermath Lilith receives "PussyFuck" from Player;
	if LilithPregnancy is 0 and Sterile of Player is false: [not already preggers, player not sterile]
		let LilithPregChance be a random number from 1 to 20;
		if LilithPregChance > 5: [75% chance]
...
to say LilithSex8: [Brutus pounds her pussy, you fuck her mouth]
	say "     Lilith watches with interest as you strip down and then step up to the bed with your demonic [if DBCaptureQuestVar is 5]slave[else]companion[end if] by your side, her eyes wandering over your naked bodies with unrestrained lust. 'So the master is going to allow his pet a little treat? Perfect, I'm just in the mood for a threesome,' the succubus says and crawls to the edge of the mattress on all fours, her full breasts swinging attractively as she does so. Then she gives her hindquarters a little wiggle and tells you 'Mount up and fuck me - I'll take care of your boy here', reaching up to take hold of Brutus's massive manhood with one hand as she does so.";
	WaitLineBreak;
	...
	NPCSexAftermath Lilith receives "OralCock" from Player;
	NPCSexAftermath Lilith receives "PussyFuck" from Brutus;
	wait for any key;
...
to say LilithSex9: [sandwich fuck with Brutus]
	...
	NPCSexAftermath Lilith receives "AssFuck" from Brutus;
	NPCSexAftermath Lilith receives "PussyFuck" from Player;
	if LilithPregnancy is 0 and Sterile of Player is false: [not already preggers, player not sterile]
		let LilithPregChance be a random number from 1 to 20;
		if LilithPregChance > 5: [75% chance]
