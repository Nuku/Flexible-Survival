TestCreature8 by Wahn begins here.
[ Version 1.0 - Male TestCreature8 by Kaleem Mcintyre          ]
[ Version 2.0 - Multi Gender TestCreature8s plus Items by Wahn ]
...
When Play begins:
	...
	now Species Name entry is "TestCreature8";
	add "TestCreature8 Male" to infections of CanineList;
	add "TestCreature8 Male" to infections of NatureList;
	add "TestCreature8 Male" to infections of FurryList;
	add "TestCreature8 Male" to infections of MaleList;
	add "TestCreature8 Male" to infections of TaperedCockList;
	add "TestCreature8 Male" to infections of KnottedCockList;
	add "TestCreature8 Male" to infections of SheathedCockList;
	add "TestCreature8 Male" to infections of BipedalList;
	add "TestCreature8 Male" to infections of TailList;
	now Name entry is "TestCreature8 Male"; [ Infection/Creature name. Capitalized. ]
	...
	now face entry is "covered with black spots while long floppy ears hang down the side of your regal-looking head. A black button-nose at the end of a long[if Player is female], delicate[end if] muzzle completes the image of an anthro TestCreature8's head";
...
When Play begins:
	...
	now NewTypeInfection entry is false;
	now Species Name entry is "TestCreature8";
	add "TestCreature8 Bitch" to infections of CanineList;
	add "TestCreature8 Bitch" to infections of NatureList;
	add "TestCreature8 Bitch" to infections of FurryList;
	add "TestCreature8 Bitch" to infections of FemaleList;
	add "TestCreature8 Bitch" to infections of TaperedCockList;
	add "TestCreature8 Bitch" to infections of KnottedCockList;
	add "TestCreature8 Bitch" to infections of SheathedCockList;
	add "TestCreature8 Bitch" to infections of BipedalList;
	add "TestCreature8 Bitch" to infections of TailList;
	now Name entry is "TestCreature8 Bitch"; [ Infection/Creature name. Capitalized. ]
	now enemy title entry is ""; [name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name]
	now enemy Name entry is ""; [specific name of unique enemy]
	now enemy type entry is 0; [0 = non unique enemy; 1 = unique (unknown name); 2 = unique (known name) | Used to disqualify unique enemies from Vore/UB and showing the enemy name in encounters]
	now attack entry is "[NonCombatError]";
...
When Play begins:
	...
	now NewTypeInfection entry is false;
	now Species Name entry is "TestCreature8";
	add "TestCreature8 Herm" to infections of CanineList;
	add "TestCreature8 Herm" to infections of NatureList;
	add "TestCreature8 Herm" to infections of FurryList;
	add "TestCreature8 Herm" to infections of HermList;
	add "TestCreature8 Herm" to infections of TaperedCockList;
	add "TestCreature8 Herm" to infections of KnottedCockList;
	add "TestCreature8 Herm" to infections of SheathedCockList;
	add "TestCreature8 Herm" to infections of BipedalList;
	add "TestCreature8 Herm" to infections of TailList;
	now Name entry is "TestCreature8 Herm"; [ Infection/Creature name. Capitalized. ]
	now enemy title entry is ""; [name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name]
	now enemy Name entry is ""; [specific name of unique enemy]
	now enemy type entry is 0; [0 = non unique enemy; 1 = unique (unknown name); 2 = unique (known name) | Used to disqualify unique enemies from Vore/UB and showing the enemy name in encounters]
	now attack entry is "[NonCombatError]";
...
When Play begins:
	...
	now NewTypeInfection entry is false;
	now Species Name entry is "TestCreature8";
	add "TestCreature8 Transman" to infections of CanineList;
	add "TestCreature8 Transman" to infections of NatureList;
	add "TestCreature8 Transman" to infections of FurryList;
	add "TestCreature8 Transman" to infections of TransList;
	add "TestCreature8 Transman" to infections of TaperedCockList;
	add "TestCreature8 Transman" to infections of KnottedCockList;
	add "TestCreature8 Transman" to infections of SheathedCockList;
	add "TestCreature8 Transman" to infections of BipedalList;
	add "TestCreature8 Transman" to infections of TailList;
	now Name entry is "TestCreature8 Transman"; [ Infection/Creature name. Capitalized. ]
	now enemy title entry is ""; [name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name]
	now enemy Name entry is ""; [specific name of unique enemy]
	now enemy type entry is 0; [0 = non unique enemy; 1 = unique (unknown name); 2 = unique (known name) | Used to disqualify unique enemies from Vore/UB and showing the enemy name in encounters]
	now attack entry is "[NonCombatError]";
	...
	now victory entry is "[NonCombatError]";
	now desc entry is "[NonCombatError]";
	now face entry is "covered with black spots while long floppy ears hang down the side of your regal-looking head. A black button-nose at the end of a long muzzle completes the image of an anthro TestCreature8's head";
...
When Play begins:
	...
	now NewTypeInfection entry is false;
	now Species Name entry is "TestCreature8";
	add "TestCreature8 Transbitch" to infections of CanineList;
	add "TestCreature8 Transbitch" to infections of NatureList;
	add "TestCreature8 Transbitch" to infections of FurryList;
	add "TestCreature8 Transbitch" to infections of TransList;
	add "TestCreature8 Transbitch" to infections of TaperedCockList;
	add "TestCreature8 Transbitch" to infections of KnottedCockList;
	add "TestCreature8 Transbitch" to infections of SheathedCockList;
	add "TestCreature8 Transbitch" to infections of BipedalList;
	add "TestCreature8 Transbitch" to infections of TailList;
	now Name entry is "TestCreature8 Transbitch"; [ Infection/Creature name. Capitalized. ]
	now enemy title entry is ""; [name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name]
	now enemy Name entry is ""; [specific name of unique enemy]
	now enemy type entry is 0; [0 = non unique enemy; 1 = unique (unknown name); 2 = unique (known name) | Used to disqualify unique enemies from Vore/UB and showing the enemy name in encounters]
	now attack entry is "[NonCombatError]";
	...
	now victory entry is "[NonCombatError]";
	now desc entry is "[NonCombatError]";
	now face entry is "covered with black spots while long floppy ears hang down the side of your regal-looking head. A black button-nose at the end of a long, delicate muzzle completes the image of an anthro TestCreature8's head";
...
to SetMonsterRandomDalOffspring:
	...
	if randomnumber is:
		-- 1:
			setmonster "TestCreature8 Male";
		-- 2:
			setmonster "TestCreature8 Bitch";
		-- 3:
			setmonster "TestCreature8 Herm";
		-- 4:
			setmonster "TestCreature8 Transman";
		-- 5:
			setmonster "TestCreature8 Transbitch";

Section 3 - Items

Table of Game Objects (continued)
name	desc	weight	object
"TestCreature8 cum"	"A tiny plastic shampoo bottle as you might find in a motel, filled with something milky white, thick and creamy. If you didn't know where it's from, you'd almost think it to be liquid soap rather than Darius's cum. You could drink it to quench your thirst, but who knows what else it might do to you..."	1	TestCreature8 cum

instead of sniffing TestCreature8 cum:
...
TestCreature8 cum is a grab object. TestCreature8 cum is cum.
the usedesc of TestCreature8 cum is "[TestCreature8 cum use]";

to say TestCreature8 cum use:
	...
	PlayerDrink 6;
	SanLoss 5;
	infect "TestCreature8 Bitch";

Table of Game Objects (continued)
name	desc	weight	object
"TestCreature8 fur"	"A small tuft of white and black fur, held together by a rubber band. You bought it from Darius."	1	TestCreature8 fur

instead of sniffing TestCreature8 fur:
	say "     You sniff at the tuft of fur. It has a definitive smell of dog to it.";

TestCreature8 fur is a grab object.
TestCreature8 fur is temporary.
the usedesc of TestCreature8 fur is "[TestCreature8 fur use]";

to say TestCreature8 fur use:
...
"TestCreature8 Male Infection"	"Infection"	""	TestCreature8 Male Infection rule	1000	false

This is the TestCreature8 Male Infection rule:
	if Player has a body of "TestCreature8 Male":
		trigger ending "TestCreature8 Male Infection"; [Here it states, that the ending has been played.]
		if humanity of Player < 10:
			say "     Giving yourself over to the TestCreature8 infection taking over your body and mind you wander aimlessly about the city until you find yourself stumbling over a slightly familiar looking white and black spotted four legged canine. When the other gets a hold of your scent the TestCreature8 immediately senses something wrong as it turns to look you over. Slowly padding its way over to try and administer comfort onto you, you find yourself whimpering back at the other as the need to rut as well as play overtakes your sensibilities. At the touch of the TestCreature8's cold nose touches your legs you kneel down next to the other Dal and then nuzzle the other four legged canine in turn before whining at it in confusion. Quickly as can be the feral creature barks into your face and then grabs you by your arm with its sharpened teeth to drag you off somewhere.";
			...
			if firefighter coat is owned:
				...
				LineBreak;
				say "     Working with the other TestCreature8s of fire station 86 you and the rest of the team hook up hoses and then spray down the burning building with as much water as you can in order to make the laughing flames receded back into the edifice. All of you are silently thankful that the water to the city is now working again, though no one makes a comment on this as you are all busy working to get the thrashing flames battling against you under some kind of control[if waterworks is 1]. You don't spend time gloating about how you were the one who fought to get the water to the city back on as you literally have bigger fish to fry at the moment[end if].";
				say "     [if kto is 2]Humorously you find yourself chuckling into the back of your heads as you watch how Kenaz literally takes command of the situation as he barks out orders. You do the other TestCreature8 proud by standing your ground and helping them finish up spraying down the building until at last, some thirty minutes later, the fire has finally died out[else]Watching as Othala and Kenaz work together to try and control this situation you chuckle mirthfully as you notice how all of the other TestCreature8s follow the leadership of the former female without question. Othala wastes no time as she barks out orders amongst the pack while having Kenaz stand beside you to help shoulder some of the burden of having you hold onto the gushing hose in between your padded hands. The other male says nothing to you as you and he work together to put out the fire, however, you don't fail to notice the twinkle of pride shining in Kenaz's green orbs as he glances at you when he thinks you're not looking[end if]. Once the hungry flames of the fire have been completely drowned out the TestCreature8s quickly turn to those around you, asking everyone the standard questions that go along with having survived an ordeal like this and giving medical aid to those that they can while waiting for the ambulance to get there.";
				LineBreak;
				if kto is 2:
					say "     When several white trucks pull up you find yourself sighing in relief... that is, right before you turn to notice a very angry TestCreature8 looking down at you. Kenaz seems both pissed and elated that you've survived this trail, even more so at the fact that you actually managed to help out with your unrefined skills and instinctual talents. The herm makes no bones about telling you off though, and you actually pull back some as you try to whether the storm of the other's wrath. However, once the eight foot TestCreature8 has calmed down he tiredly reaches around you to take you into his arms before hugging you tight. No words need be spoken between either of you as you both understand what the other is thinking. Ironically the military shows up to help, late as usual, some minutes later to lead you and everyone else back to one of their campsites.";
