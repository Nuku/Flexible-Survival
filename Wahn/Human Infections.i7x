...
"Human"	"[PrepCombat_Human]"

to say PrepCombat_Human:
	setmongender 3;]
...
[Table of CombatPrep (continued)
name(text)	PrepFunction(text)
"Herm Human"	"[PrepCombat_Human]"

to say PrepCombat_Herm Human:
	setmongender 5;]
...
This is the Herm Human Infection rule:
	if Player has a body of "Herm Human":
		...
		if humanity of Player < 10: [succumbed]
			...
			if Player is impreg_ok: [has a vag or mpreg-able, not sterile]
				say "     [if Player is fpreg_ok]Serving your master in all his desires, your pussy getting bathed daily with his potent seed, it doesn't take long until your belly starts to swell with his child. Being part of[else]Devoted to please your master, you tell him about your changed physiology. The thought eater is immensely satisfied in having something so extraordinary as a slave, immediately ordering you to bend over and get ready for him to fuck you. With his potent seed being shot into your womb several times a day, it's only a question of time until your belly starts to swell with his child. Being a special jewel in[end if] his harem, he just keeps coming back to fuck you, enjoying your body through the days of your pregnancy, then immediately gets to work on knocking you up again after you give birth to his half-human offspring. You're deliriously happy to serve him, over time bearing a whole brood of hybrids in the dark and shadowy underground that is now your home.";
			else:
				say "     [if Player is female]With you being sterile and the thought eater preferring his harem of pregnant slaves, you're only seldom taken into his chamber, though he sometimes has you perform with others, male, female and herm, for his amusement. Mostly, you're just spending your days working, preparing food, sorting through loot and supplies gatherers bring from outside your dark underground home[else if Player is male]As a man, you're added to your master's guards, protecting the entrances to his underground home and escorting the groups he sends out to gather supplies and new slaves. Sometimes, you're also brought in to the inner chambers, with your master telling you to mount selected females as he tries to breed nicer-looking servants[else]Being completely sexless, the thought eater has little interest in you yourself, so you just end up being used as a worker, preparing food, sorting through loot and supplies gatherers bring from outside your dark underground home[end if].";
		else: [sane]
