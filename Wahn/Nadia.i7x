...
NadiaFertilityCounter is a number that varies.				
NadiaChickCounter is a number that varies.				
...
to say NadiaDesc:   [how she looks]
	...
	otherwise:
		if NadiaDescription is 5:               [basic appearance]
		...
		if NadiaChickCounter > 10:               [chick appearance]
...
instead of conversing the Nadia:   [talking to her]
	...
	otherwise:
		if NadiaDescription is 5:  [Matron]
...
Instead of fucking the Nadia:
	...
	otherwise:
		...
		otherwise:
			say "     [NadiaSex4]";  [straight to pussy fucking for now]
	...
	if NadiaPregCounter1 > 0 and NadiaPregVisibility > 1:   [pregnant sex]
		...
		otherwise if NadiaDescription is 3 or NadiaDescription is 4:  [pregnant mother sex]
			...
			otherwise if NadiaPregVisibility is 3 or NadiaPregVisibility is 2:
				...
				say "     Spent and sated, Nadia falls forward off you, landing on the cushions on her side, her feathers damp and glistening with sexual fluids. She lies there for a good long while even after you've gotten back on your feet, staring into space and panting with her tongue hanging out of her beak, and you feel it'd probably be best if you left her alone to recover.";
		otherwise:     [pregnant matriarch sex]
			if NadiaPregVisibility is 5 or NadiaPregVisibility is 4:
...
Instead of resolving a Bird Troubles:
	...
	say "     Face-down on the ground is a bird-woman, her figure thin and scrawny, her hands and feet now talons. Her feathers are a dull, muted shade of various colours, her crimson hair is messy and unkempt, and her tailfeathers are long and sweeping, reaching down to her calves. The wings that jut from between her shoulderblades bent at entirely unnatural angles, much like pictures of pigeon roadkill you've seen. Perhaps in a different time and place she could have been truly beautiful, but right now that's beauty's just broken, not unlike a cracked mirror.";
	say "     [WaitLineBreak]";
