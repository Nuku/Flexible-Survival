...
to say TehuantlDesc:
	if HP of Tehuantl < 50: [female Tehuantl]
		project the Figure of Tehuantl_Female_clothed_icon;
...
to say TehuantlSex:
	if HP of Tehuantl is 11:
		...
		if HP of Tehuantl > 49: [male]
			project the Figure of Tehuantl_Male_clothed_icon;
			say "     Tehuantl rubs himself against you and purrs, but then pulls back a little and says, 'Mmm, as much as I would love my big warrior to make use of [PosAdj of Player] servant again, I need some time to recuperate please.'";
		else: [female]
			project Figure of Tehuantl_Female_clothed_icon;
			say "     Tehuantl rubs herself against you and purrs, but then pulls back a little and says, 'Mmm, as much as I would love my big warrior to make use of [PosAdj of Player] pussycat again, I think it would be nicer for both of us if we took a break.'";
	else:
		if HP of Tehuantl < 50:
			project Figure of Tehuantl_Female_naked_icon;
...
to say TehuantlSex_Ride:
	if Player is female: [female and herm player]
		...
		LineBreak;
		say "     Tehuantl rumbles eagerly and gives you an adoring look from where he lies, sliding a hand over the bumps of his lightly furred abs and gently stroking his cock as he watches your approach. 'Mmmh - master, I'm ready for you,' he mews in a needy tone, hiking his hips up a little before letting it slump down again. A gleaming bead of precum forms at the tip of his shaft, then slowly runs down between the rows of nubby spines along his cock. This nanite apocalypse definitely has its upsides, as you'd never have dreamed of one day have such a sexy little pet before - or not so little, as the submissive jaguar actually is quite a hunk... which makes taking him as yours even more amazing...";
...
Table of GameEventIDs (continued)
Object	Name
Tehuantl_Carl_Encounter1	"Tehuantl_Carl_Encounter1"

Tehuantl_Carl_Encounter1 is a situation.
ResolveFunction of Tehuantl_Carl_Encounter1 is "[ResolveEvent Tehuantl_Carl_Encounter1]".
Sarea of Tehuantl_Carl_Encounter1 is "Nowhere". [standard walkins that cannot be hunted for are Nowhere, but walkin events can also be made huntable as an alternate access way]

to say ResolveEvent Tehuantl_Carl_Encounter1:
	if debugactive is 1:
	...
	if Libido of Tehuantl is 0: [first time]
		...
		say "     Coming to stand at the railing and looking after the jaguarman, just like you yourself did, Carl shakes his head in wonder and asks, 'Err - was he for real? Being your slave and all?' With a smile, you let him know that some cultures just have different customs. This is simply what it took for the jaguarman to stop attacking you every time you met... and you do rather enjoy the arrangement too. Carl's eyebrows rise a little, but then the canine soldier shrugs and admits, 'There are worse ways to end up these days, I guess. No, let me rephrase that - I know there are worse things happening all the time now, with the state of things. So... sounds like I got a new workout partner, eh?' Just as he says this, Tehuantl zips through your line of sight, coming into view as he sprints through the library, then vanishing again behind another bookshelf. 'It'll definitely be an interesting experience, that's for sure.'";
		...
		now Tehuantl_Carl_Encounter1 is resolved;
	now LastTehuantlCarlScene is turns;


Table of WalkInEvents (continued)
Priority	Name	EventObject	EventConditions	EventRoom	LastEncounterTurn	CoolDownTurns	EncounterPercentage
2	"Tehuantl_Korvin_Encounter1"	Tehuantl_Korvin_Encounter1	"[EventConditions_Tehuantl_Korvin_Encounter1]"	Grey Abbey 2F	2500	2	100

to say EventConditions_Tehuantl_Korvin_Encounter1:
	if (LastTehuantlKorvinScene - turns > 6 and (Tehuantl is in Grey Abbey 2F and TehuantlKorvinRelationship is 0 and HP of Tehuantl > 49 and HP of Tehuantl < 100) and (gsd_pet >= 60 and gshep is tamed) and Player is not CoA): [list of conditions here]
		now CurrentWalkinEvent_ConditionsMet is true;

Table of GameEventIDs (continued)
Object	Name
Tehuantl_Korvin_Encounter1	"Tehuantl_Korvin_Encounter1"

Tehuantl_Korvin_Encounter1 is a situation.
ResolveFunction of Tehuantl_Korvin_Encounter1 is "[ResolveEvent Tehuantl_Korvin_Encounter1]".
Sarea of Tehuantl_Korvin_Encounter1 is "Nowhere". [standard walkins that cannot be hunted for are Nowhere, but walkin events can also be made huntable as an alternate access way]

to say ResolveEvent Tehuantl_Korvin_Encounter1: [TODO: Rebuild this scene to match the more complex relationships with Korvin]
	if debugactive is 1:
	...
	say "     From where you're standing, the end result of this scuffle should be fairly clear. Thinking back, you did whup Korvin's ass fairly easily, compared to the trained and experienced Aztec warrior from the museum. The German shepherd definitely bit off more than he can chew this time.";
