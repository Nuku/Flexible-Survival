...
to say ResolveEvent Hidden Sublevel:
	...
	say "     Wiping that off against a corner of the doorway, you have a look at whatever the stuff is. It is transparent mucus, and fairly hard to spot, but now that you know it is there, you crouch down and look closer, spotting tracks through whatever this stuff is. Boots, spaced far apart, as if someone was running out, towards the surface. Layered on top of those are more animalistic, clawed tracks, going in and out and spreading the smears of goop further along the passage to the hidden depths.";
...
"mindshield helmet"	"A shiny silver helmet. It's too light to have its primary use being deflecting blows - but maybe the mesh on the inside could ward off other, less physical, attacks."	1	mindshield helmet
