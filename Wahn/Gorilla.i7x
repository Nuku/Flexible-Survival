	...
	if inasituation is false: [regular scenes]
		...
		if Player is female:
			if Player is submissive:
				...
				WaitLineBreak;
				say "     'Oh yeah! You feel great babe,' the dominant jock grunts deeply, then pushes his upper body almost upright again. He proceeds to fuck you hard in that position, hips pumping his thick cock in and out of you in rapid succession while his long, strong arms hold you by the shoulders. Despite having been forced into this, you can't help but pant and moan as the human-like shaft hits your g-spot again and again. He might be a vainglorious bastard of an ape, but... this gorilla really knows what he's doing when a cock and pussy is involved. With his relentless pounding driving your libido into overdrive, you can't even tell how long you're kept in an aroused haze, with one orgasm rolling over into the next, before the gorilla finally comes close to the limits of his endurance. As the football jock's lust mounts up, his moans and pants become less and less human-like and start to resemble an ape's grunting instead, rising in volume and vehemence with each passing moment. Then finally, it is time - with one mighty thrust, the male buries his whole cock inside you one last time and starts to cum, spurting blast after blast of fertile seed directly into your womb. While his cock is still pulsing deep inside you, the gorilla sinks down on top of you, thankfully holding himself up a bit so he doesn't press against the ground with his muscled mass.";
		else:
			if Player is submissive:
				...
				WaitLineBreak;
				say "     'Oh yeah! You feel great dude,' the dominant jock grunts deeply, then pushes his upper body almost upright again. He proceeds to fuck you hard in that position, hips pumping his thick cock in and out of you in rapid succession while his long, strong arms hold you by the shoulders. Despite having been forced into this, you can't help but pant and moan as the human-like shaft hits your prostate again and again. He might be a vainglorious bastard of an ape, but... this gorilla really knows what he's doing when a cock and butthole are involved. With his relentless pounding driving your libido into overdrive, you can't even tell how long you're kept in an aroused haze, [if Player is male]blasting more than one load into the grass under you[else]all tingly inside[end if], before the gorilla finally comes close to the limits of his endurance. As the football jock's lust mounts up, his moans and pants become less and less human-like and start to resemble an ape's grunting instead, rising in volume and vehemence with each passing moment. Then finally, it is time - with one mighty thrust, the male buries his whole cock inside you one last time and starts to cum, spurting blast after blast of his fertile seed into your inner passage. While his cock is still pulsing deep inside you, the gorilla leans forward to rest against your back with his arms wrapped around you. He's heavy, with all that muscle mass and the burly build, but being on all fours, you have little problem in holding him up beside this.";
		if GorillasMember is 0:
			say "     Some short while later, as his orgasm winds down, the college jock moves his head again to give you another kiss, then murmurs, 'I love taking care of our fans. You can visit us at the [bold type]football field[roman type] any time, sweet-cheeks. I'm more than sure all the guys would wanna 'meet' you[if Astroslide Football Field is unvisited]. You can find the football field [bold type]west of athletic street[roman type] - you can't miss it. Just look for the big sign of our sponsor - [bold type]Astroslide[roman type][end if].' That said, he slowly pulls his cock out of you, then stands up and goes to collect his gear. 'See you later,' he says with a chuckle and a leer at your freshly bred body, then storms off, no doubt to boast about fucking you to anyone he can find.";
		else:
			say "     Some short while later, as his orgasm winds down, the college jock moves his head again to give you another kiss, then murmurs, 'I love taking care of our [if GorillasMember is 1]future [end if]teammates. Since you're here, you should come and visit us at the locker room. It's not good to keep the captain waiting. That said, he slowly pulls his cock out of you, then stands up and goes to collect his gear. 'See you later,' he says with a chuckle and a leer at your freshly bred body, then storms off, no doubt to boast about fucking you to anyone he can find.[fimpregchance]'";
		say "[if Player is female][fimpregchance][else][mimpregchance][end if]";
...
to say Gorilla Loses:
	if inasituation is false: [regular scenes]
		...
		if GorillasMember is 0:
			say "I bet you'd be able to make the team when we next have an opening. For now - you've 'beaten' a member of the Tenvale Gorillas - that's worth a reward.";
		else if GorillasMember is 1:
			say "I'm sure that you will get a spot in our team during the next tryouts. I mean, you've 'beaten' a member of the Tenvale Gorillas - that's something.";
		else if GorillasMember is 3:
			say "With moves like these, you'll progress in the ranks of the team in no time.";
		else:
			say "As expected from one of our star players - I can't blame myself for losing to you. If you wanna... play a different little game with me, I'd be more than alright in my book.'";
...
to say GorillaOral:
	if Player is male: [male + herm]
		...
		WaitLineBreak;
		say "     He does this multiple times, always skirting by closely to sending you over the edge, until you finally can't take it anymore and grab the college athlete's head to fuck his face. Thrusting fast and deep, reveling in the slurping sounds of his lips on your shaft, you let your orgasm build and reach an amazing climax moments later. Gripping the gorilla's head tightly by his short hair, you hold on to him as your balls churn and send out blast after blast of rich semen directly into his stomach. One, two, three, four pulses shoot into the muscled ape's gullet, then you pull back a little bit and cover his tongue with the rest of your load.";
		say "     When you finally pull out and stumble back from him on shaky knees, you notice for the first time that the simian jock has his own shorts pulled down and is jerking off in a frantic pace. Just moments later, he reaches the point of no return and comes, giving somewhat muffled grunts from your cum still held in his mouth. Using a big hand to catch his load, he then brings it up to his face to slurps up the cum with obvious gusto. Sticking out his tongue to show you a white, creamy mixture of your cum, the gorilla then demonstratively swallows it all, smacking his lips after licking them clean.";
		...
		say "     When your orgasm finally winds down a bit and you stumble back from him on shaky knees, you notice for the first time that the simian jock has his own shorts pulled down and is jerking off in a frantic pace. Just moments later, he reaches the point of no return and comes, giving somewhat muffled grunts from your femcum still held in his mouth. Using a big hand to catch his load, he then brings it up to his face to slurp up the cum with obvious gusto. Sticking out his tongue to show you a white, creamy mixture of your femcum and his own cum, the gorilla then demonstratively swallows it all, smacking his lips after licking them clean.";
	else: [neuter]
		...
		say "     When your orgasm finally winds down a bit and you stumble back from him on shaky knees, you notice for the first time that the simian jock has his own shorts pulled down and is jerking off in a frantic pace. Just moments later, he reaches the point of no return and comes, giving loud grunts as he does so. Using a big hand to catch his load, he then brings it up to his face to slurp up the cum with obvious gusto. Sticking out his tongue to show you a white, creamy load of his own cum, the gorilla then demonstratively swallows it all, smacking his lips after licking them clean.";
	say "     'Mmmh - I love [if GorillasMember < 2]finding new candidates for the team[else]playing with teammates[end if],' he hums contently, then gives you a nod. 'See you later. I'll just... catch my breath a bit.' That said, the big ape lays back, resting on the grass and staring at the sky with a goofy grin on his face.";
...
to say Gorilla Desc:
	...
	if inasituation is false: [regular scenes]
		if GorillasMember > 0 and GorillasMember < 3:
			...
			say "     A burly and muscular gorilla steps into your line of sight. He is dressed in football shoulder pads and wears a helmet, both painted in the local team's colors. As the gorilla spots you, a smile spreads over his face and he drops on all fours, using his long arms as support as he quickly rushes towards you. 'Hey [if Player is male]dude[else]girl[end if], nice to meet'cha. Did you finally see that the Tenvale Gorillas are the better team and wanna join our team? Can't go wrong with the Gorillas!' He hits his chest and grunts loudly to honor the team, then gives you another long look - a pretty leering one. 'Always nice to meet prospective recruits. So - wanna have some fun right now, or should I show you some moves first?";
			say "     Looks like this simian jock is fully committed to the idea that you're a member of another team, who can't wait to service him - and that there is little doubt he intends to have sex with you. You don't think there's any chance to convince him of anything else, so you ready yourself for a fight.";
		else:
			say "     A burly and muscular gorilla steps into your line of sight. He is dressed in football shoulder pads and wears a helmet, both painted in the local team's colors. As the gorilla spots you, a smile spreads over his face and he drops on all fours, using his long arms as support as he quickly rushes towards you. 'Hey [if Player is male]dude[else]girl[end if], nice to meet'cha. I was hoping to run into some hotties today - and there you are, lucky enough to meet one of your team's stars. Yup, I'm in the Tenvale Wildcats - well, Tenvale Gorillas now, anything else would be silly. So - wanna have some fun right now, or should I show you some moves first?'";
