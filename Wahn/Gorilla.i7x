...
to say Gorilla Wins:
	if inasituation is false: [regular scenes]
		...
		otherwise:
			...
			now Astroslide Field Lockerroom is known;
	otherwise: [dealing with this on the event side which called for the fight]
		say "";
...
to say Gorilla Desc:
	...
	if inasituation is false: [regular scenes]
		...
		otherwise if bodyname of player is "Football Wolfman" and player is pure:
