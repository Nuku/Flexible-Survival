...
to say EricaSex8_1_Male: [male player]
	...
	if calcnumber is 1: [fuck Erica]
		say "     Getting on the bed between the felinoid's legs, you snake your arms around Erica from behind, caressing the firm pair of breasts she teased you so much with earlier. As the red-headed beauty eagerly leans into your touch, you plant a line of little kisses from her neck up to her right earlobe, playfully nibbling at it before you whisper that you want to fuck her in the ass. The young woman looks back and gives you a smile over her shoulder, then leans forward, stretching her upper body out over the felinoid's furry belly while raising her ass a bit. Who could resist such an alluring display? You're almost twitching with the need and desire to fuck your handsome friend when you take hold of your manhood and line it up with her butt. Moving forward, you press the cockhead against her pucker, first lightly, then a bit harder until it it finally yields to your invading member.";
		say "			[WaitLineBreak]";
...
instead of navigating Grey Abbey Library while (level of Erica is 0 and Felinoid Companion is tamed and (hp of Erica is 1) and (lastfuck of Erica - turns) > 12):
	...
	say "     [line break]";
	say "     Do you want to go after them to see what happens and maybe do something about it (Y), or do you just leave them to it and turn your attention to other things (N)?";
...
instead of going inside from Grey Abbey Library while (Level of Erica > 0 and Level of Erica < 4 and Erica is in Bunker and hp of Erica < 99):
	...
	if player consents: [more felinoid scenes]
		...
		say "     [line break]";
		say "     Do you want to seize the moment for some hot action between the sheets with Erica (Y), or do you just leave her to dwell on those lusty thoughts (N)?";
...
instead of navigating Grey Abbey Library while (XP of Erica is 0 and Fang is in Grey Abbey Library and (hp of Erica is 1) and (lastfuck of Erica - turns) > 12):
	...
	if player consents: [follow]
		...
		if hp of Fang < 3: [Beta Fang can be stopped]
			say "     The sound of ripping cloth as Fang takes Erica's panties between his teeth and wrenches them off her body breaks you out of the stasis in which you watched what has been going on. If you want to stop Fang, now would be the time to do it (Y) - or do you just watch as he mounts Erica (N)?";
			if player consents:
				say "     [line break]";
				...
				say "     [line break]";
				say "     What do you want to do? Sit with her on a comfortable sofa, cuddle and read one of the books she picked together (Y)? Or maybe have sex with her (N), as she's still pretty aroused and it'd certainly make her think of someone else than your wolf pet...";
				if player consents:
					say "     [line break]";
...
instead of going inside from Grey Abbey Library while (XP of Erica > 0 and XP of Erica < 4 and Erica is in Bunker and hp of Erica < 99):
	...
	say "     So, what do you tell her? That there's no shame in having some fun, even without you and with... exotic partners (Y)? Or do you just console her and tell her to avoid Fang in the future (N)?";
