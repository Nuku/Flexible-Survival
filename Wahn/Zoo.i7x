...
after looking while player is in Zoo Entrance:
	project the Figure of Map_Zoo_2_icon;
...
Description of Zoo Parking is "     The zoo has a fairly large parking space, complete with eight spots for buses. There are still a fairly large number of cars on it, so your guess would be that the spreading nanite infection reached the zoo during the opening hours and most owners of those cars are still inside, in whichever form they now have...[line break]".

after looking while player is in Zoo Parking:
	project the Figure of Map_Zoo_1_icon;

Table of GameRoomIDs (continued)
Object	Name
Fence Path	"Fence Path"

Fence Path is a room. Description of Fence Path is "     You're on a path running along the outer edge of the zoo here. It's quite nicely laid out, with a lot of grass and decorative plants on both sides. Behind the bushes, in the [Bold Type]west[roman type], you see the metal border fence, tall and made of wrought iron with spikes on the top. To the [Bold Type]north[roman type], a tall wall looms up some small distance away. As you walk along the path, you see one of the bars has been cut out of the fence of the cheetah exhibit in the [Bold Type]east[roman type]. You could climb into the enclosure through the resulting hole...[line break]".
...
after looking while player is in Fence Path:
	project the Figure of Map_Zoo_4_icon;

Dirty Hose is an object. It is in the fence path. It is fixed in place. Understand "hose" as dirty hose.
Description of dirty hose is "     This old hose was once used to water plants or maybe spray the animals. A faint trickle of water still drips from it. You could [bold type]drink[roman type] it, if you trust the water.[line break]".
...
after looking while player is in Border Wall:
	project the Figure of Map_Zoo_5_icon;

The Cheetah Doors is a door.
Description of Cheetah Doors is "     A pair of double doors leads in and out of the cheetah house.[line break]".
...
Description of Zoo Restrooms is "     You're in the zoo's large public restrooms. Looks like someone went on a rampage in here... the stall doors of all the toilets have been ripped off, and it seems like something used toilet-paper rolls as chew toys, spreading shredded paper all throughout the rooms. Some large muddy paw-prints at the entrance show that it must have been an animal of some kind.[line break]".
...
after looking while player is in Zoo Restrooms:
	project the Figure of Map_Zoo_9_icon;
...
Description of Main Path 1 is "     You're on the cobbled main path of the zoo, in between many different exhibits. In this section, there's the alligator enclosure in the [Bold Type]north[roman type] and a bird house with an enormous web canopy connected to it in the [Bold Type]south[roman type]. Coming from the entrance in the [Bold Type]southwest[roman type], the path continues to the [Bold Type]east[roman type], where it leads deeper into the zoo.[line break]".
...
after looking while player is in Main Path 1:
	project the Figure of Map_Zoo_10_icon;
...
Description of Main Path 2 is "     You're on the cobbled main path of the zoo, in between many different exhibits. In this section, there's the snake house in the [Bold Type]north[roman type], and in the [Bold Type]south[roman type] you can see the enormous web canopy of the bird enclosure arching over a moderately large forest area. If you want to go in and check it out, the bird house forming the entry is to the [Bold Type]west[roman type] of you. Further [Bold Type]east[roman type], the path widens onto a small plaza.[line break]".
...
after looking while player is in Main Path 2:
	project the Figure of Map_Zoo_13_icon;
...
Description of Zoo Rest Area is "     This plaza in the midst of the zoo was meant to serve as a rest area for the visitors. Surrounding a bronze statue of a tiger in the middle, there are benches, several picnic tables and a number of food stands - thoroughly looted now, and one even has been completely flattened. Even those stands that sold non-edible goods were ransacked, the shreds of white fluff scattered about them attesting to the gruesome end of quite a few stuffed toys. Seeing this scene of devastation reminds you strongly that this isn't a safe and peaceful place anymore. Clearly, there are wild beasts out and roaming the area and you should take care if you want to explore any of the many paths leading off in all directions, leading to the expansive grounds of the zoo. It might just be a good idea to go back [Bold Type]west[roman type] towards the entrance.[line break]".
...
to say BirdEnclosureDesc:
	...
	if a random chance of one in three succeeds:
		...
		if a random chance of 1 in 2 succeeds and inafight is not 1:
			...
			say "     A light brown bird more commonly known as a wren flies over and pulls up, headed to the ceiling in front of you. As it does this, it lets loose and hits you full in the chest with a big splatter of bird poop.";
			say "     Disgusting!";
			infect "Harpy";
	else:
		say "     There is an ominous feeling about here, and you feel real uncomfortable.";

after looking while player is in Bird Enclosure:
	project the Figure of Map_Zoo_12_icon;
...
Description of Snake house is "     This house has quite a number of terrariums set into the walls of room after room. They're all empty, which might just be the result of having their glass fronts smashed in. No evidence remains who did this or why, but you can make out where the snakes went from the tracks through all the little glass fragments on the floor. They lead outside, ending at a nearby sewer grate that has been bent and warped, creating an opening big enough to slither through, though not for you to follow. Looks like any snakes are now in the sewers.[line break]".
the scent of Snake House is "     The whole area smells strongly of snakes.".

after looking while player is in Bird Enclosure:
	project the Figure of Map_Zoo_14_icon;
...
Description of Gator Pit is "     This enclosure held alligators once, but it's empty now. Behind a shattered glass wall, there is a pit formed from artificial rock that clearly held water once. In the middle of that is... a footprint? Almost looks like a giant stepped on it - and broke right through, his weight collapsing a section of the alligators['] water pit into the sewer tunnel not far below. Which might just be where the alligators went. The way into the tunnels is still open, if you want to dare climbing down over the rubble and explore the sewers. Although it looks dangerous down there...[line break]".
...
after looking while player is in Bird Enclosure:
	project the Figure of Map_Zoo_11_icon;
...
The marea of Sewer Exploration is "Mall". The Sewer Exploration is open. Description of Sewer Exploration is "     The black hole of the sewer tunnel is accessible through climbing down over the rubble in the gator enclosure. Looks dangerous down there, but nothing ventured, nothing gained, right?[line break]". understand "tunnel" and "hole" as the Sewer Exploration.
