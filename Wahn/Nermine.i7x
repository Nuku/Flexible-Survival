...
to say sexwithnermine:
	...
	if JackalBoyTF is 4:
		...
		say "     Eventually she licks the top of her head a few times with her tongue before pulling herself up off of the mattress and looking back down at you. 'Nermine just knew from the first moment that the eager visitor walked into her store that deep down [SubjectPro] wanted to be a pet. To have someone big and strong take care of [ObjectPro]. Nermine is so happy she was asked for her help in making the happy little jackal [if cunts of player > 0]pet[else]boy[end if] that [SubjectPro] was destined to be. Now Nermine has such an amazing pet to have fun with, and a helper around the store, and the happy pet has Nermine to help and pleasure. Everyone is happy.' She says with a canine grin, then gathers up her clothing before heading out into the shop, leaving her happy jackal pet nodding behind her. You realize just how lucky you are to have such a wonderful and caring owner, and feel happy and eager to become even more the perfect little jackal toy for your mistress...";
		Jackalboyify;
		stop the action;
	if JackalBoyTF is 3: [----------------------]
		now lastfuck of Nermine is turns;
	...
	if JackalBoyTF is 0: [not transformed at all]
		...
		if player consents:
			...
			if guy is banned or furry is banned or girl is banned:
				say "     'Oh, Nermine is seeing now that she looks closer at her visitor that [SubjectPro] will not be able to help her. She is feeling sad to see someone restrict their fun so. Being not so picky would be much more interesting, she thinks.' Saying this, Nermine shakes her jackal head sadly.";
...
To say jackaltotemmagic:
	...
	if wrcursestatus >= 7 and wrcursestatus < 100:
		...
		say "      Rubbing the small totem you wonder just what effects Nermine expects it to have. You are intially disappointed when all that seems to happen is that the totem grows a bit warmer in your hands. You sigh and are about to put the tiny black statue away when suddenly your ass start to tingle and feel strange whike the totem grows ever warmer under your touch. Glancing behind, you are surprised to see your ass seeming to stretch and change, your rear flattening out slightly as a small black jackal-like tail forms behind you. You feel a strange almost pleasant stretching sensation as your new tail grows until its tip is hanging just below your knees.";
