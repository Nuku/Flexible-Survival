		...
		if Player is female: [what the pussy hunt is all about...]
			if (gestation of child > 0): [already pregnant]
				...
				if (Cunt Depth of Player < 4): [far too small]
					...
					CreatureSexAftermath "Player" receives "PussyFuck" from "Hulking Cheerleader";
...
"Hulking Cheerleader"	"[PrepCombat_Hulking Cheerleader]"

to say PrepCombat_Hulking Cheerleader:
...
When Play begins:
	...
	now MilkItem entry is "hulking cheerleader milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "hulking cheerleader cum"; [ Item to be given to the player if they have this infection and jerk off. ]
