...
to say BlueSpeakerSexMenu:
	...
	[]
	if libido of Blue Speaker is 2 and (cocks of player > 0 or cunts of player > 0): [male shape and gendered player]
		choose a blank row in table of fucking options;
