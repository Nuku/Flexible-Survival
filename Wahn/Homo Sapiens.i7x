...
to say losetoHomoSapiens:
	...
	if Player is male:
		...
		WaitLineBreak;
		say "     You shudder in lust as the young man pushes your magic button, leaning back your head and panting with closed eyes as you revel in each brush against your insides. Then suddenly, his fingers are gone again and the tribesman's cockhead nudges your nether lips apart, sliding into you with the help of his precum and your femcum as natural lube. You tremble and shiver in pleasure as he pushes more and more of the hard cock into your body. Soon, you feel the twin orbs of his balls pressing against your crotch as he bottoms out inside you. Stretching himself, the young man gives you an eager kiss on the mouth and whispers some words you don't understand into your ear.";
...
[
		...
		if Player is male:
			...
			CreatureSexAftermath "Homo Sapiens" receives "OralCock" from "Player";
			...
			CreatureSexAftermath "Homo Sapiens" receives "OralPussy" from "Player";
			...
			say "     As you start undoing your own clothes and your bare and sexless crotch is exposed, the tribesman murmurs something in a frightened tone. Before you can even start to explain about your peculiar state, he snatches up his clothes and spear to run, dashing deeper into the museum. Looks like this is one guy who gets a little freaked out by genderless people.";
[
		else:
			LineBreak;
			if Player is male:
...
When Play begins:
	...
	add "Homo Sapiens" to infections of HumanList;
	add "Homo Sapiens" to infections of HistoricalList;
	...
	now MilkItem entry is "homo sapiens milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "homo sapiens cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
mammoth jerky is infectious. Strain of mammoth jerky is "Homo Sapiens".
Usedesc of mammoth jerky is "[mammoth jerky use]".
Scent of mammoth jerky is "The meat smells like... well, meat.".
