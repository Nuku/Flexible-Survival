...
to say cannon wins:
	...
	if Player is FemalePreferred:
		...
		if cclosscount < 3 or cclosscount is even or scalevalue of Player > 4 or vorelevel is 1:
			...
			say "[line break]     [bold type]Having opened itself wide enough to engulf you, and coming closer by the second, you barely have a second to decide that...[roman type][line break]";
			...
			if CockCannon_Loss_Choice is:
				...
				-- "You'll welcome being pulled into it! The thought is pretty hot actually, and it turns you on.":
					...
					say "[line break]     [bold type]The cock cannon seems quite content with having you just residing where you are for now. How do you want to occupy yourself while you're inside its body?[roman type][line break]";
...
When Play begins:
	...
	now CumItem entry is "cock cannon cum"; [ Item to be given to the player if they have this infection and jerk off. ]
