...
When Play begins:
	...
	now Torso Description entry is "larger than a normal human's and with broad shoulders"; [partial sentence, fitting in "Looking down at yourself, you appear [Body Adjective of Player], [Gender Adjective of Player] and your torso is [Torso Description of Player][if Body Hair Length of Player > 0], covered in [Body Hair Adjective of Player] [Hair Color of Player] chest hair[end if]."]
...
When Play begins:
	...
	now Head Description entry is "a handsome humanoid with emerald green skin and a square jaw. Two small tusks protrude from your lower mandible, giving all your expressions a nonhuman, but rather cute undertone and distorting your speech a little"; [partial sentence that fits in "Your face and head resemble that of [Head Description of Player]. You have [Eye Adjective of Player], [Eye Color of Player] eyes and an overall [Gender Adjective of Player] appearance."]
	now Head Adjective entry is "orcish"; [one word descriptive adjective (avian/canine/...)]
	now Head Skin Adjective entry is ""; [one word descriptive adjective]
	...
	now Torso Description entry is "humanoid, with somewhat broad shoulders and rich emerald green skin that is silkily smooth without any body hair at all"; [partial sentence, fitting in "Looking down at yourself, you appear [Body Adjective of Player], [Gender Adjective of Player] and your torso is [Torso Description of Player][if Body Hair Length of Player > 0], covered in [Body Hair Adjective of Player] [Hair Color of Player] chest hair[end if]."]
	now Torso Adjective entry is "orcish"; [one word descriptive adjective (avian/canine/...)]
	now Torso Adornments entry is ""; [(pouch/udders/...); partial sentence to fit: "You take a moment to feel your [torso adornments of Player]."]
	now Torso Skin Adjective entry is ""; [one word adjective (feathered/furred/scaly/...); EMPTY "" for creatures with just skin]
	...
	now Arms Description entry is "covered in emerald green skin and end in hands that are a little bit larger than a normal human's, strong but with nicely soft skin"; [partial sentence to fit: "Your [Limbs Adjective of Player] arms are [Arms Description of Player]."]
	now Arms Skin Adjective entry is ""; [one word adjective (feathered/furred/scaly/...); EMPTY "" for creatures with just skin]
	...
	now Legs Description entry is "covered in emerald green skin and end in two wide feet that are somewhat larger than a normal human's"; [partial sentence to fit: "As your inspection goes even lower, you come to the two [Body Adjective of Player] legs supporting you. They are [legs description of Player]."]
	now Legs Skin Adjective entry is ""; [one word adjective (feathered/furred/scaly/...); EMPTY "" for creatures with just skin]
	...
	now Cock Description entry is "is human in shape. It is covered in moss green skin and even has a stretchy foreskin covering the head"; [partial sentence to fit: "You have a [Cock Girth Adjective of Player], [Cock Length of Player]-inch-long [cock adjective of Player] [one of]cock[or]penis[or]shaft[or]maleness[at random] that [cock description of Player]."]
	now Cock Color entry is "moss green"; [one word color descriptor]
	now Ball Count entry is 2; [allowed numbers: 1 (uniball), 2 or 4]
	...
	now Cunt Description entry is "human in shape, complete with an averagely-sized clit and all of it is moss green in color"; [partial sentence to fit: "You have a [Cunt Tightness Adjective of Player] [one of]cunt[or]pussy[or]vagina[or]cleft[at random] that is [cunt description of Player]."]
	now Cunt Color entry is "moss green"; [one word color descriptor]
