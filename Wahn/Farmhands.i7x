...
Cunt Depth of Farmhand Horsemen is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
to say Farmhand HorsemenSex2: [Gangbang - Ass and Mouth]
	...
	WaitLineBreak;
	say "     What happens next is kind of a blur in your mind afterwards, but you can remember that the gangbang continued until every last one of the little group of horny farmhands came - in or on you. It definitely was a breathtaking experience during which you came two... maybe three more times as they took turns. One thing is clear in your mind even through all that - being bathed in warm, creamy seed is definitely an interesting experience - you really liked being the center of all their attention and the fact that half a dozen strapping hunks got off just because of you. Drenched and dripping you are eventually carried into the communal showers by your original partner.";
	NPCSexAftermath Player receives "OralCock" from Farmhand Horsemen;
