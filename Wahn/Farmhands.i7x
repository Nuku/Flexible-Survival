...
to say FarmhandsSexMenu:
	...
	if Dexterity of Farmhand Horsemen is 1 or Dexterity of Farmhand Horsemen is 10 or Dexterity of Farmhand Horsemen is 11:
		...
		now description entry is "Join [if Dexterity of Farmhand Horsemen is 1 or Dexterity of Farmhand Horsemen is 10] the guy you watched through the window before[otherwise if Dexterity of Farmhand Horsemen is 11]Carlos[end if] in the shower for a sexy time";
	[]
	choose a blank row in table of fucking options;
