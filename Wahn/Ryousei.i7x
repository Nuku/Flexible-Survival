...
to say RyouseiMeetsRane:
	...
	if calcnumber is 1: [don't mess with them]
		...
		WaitLineBreak;
		say "     In response, Rane just gives the tiger a companionable slap on the shoulder, then says, 'Aw, don't worry about it buddy. I totally went with it too because I wanted to see what you'd do. No harm no foul, eh? I'll gladly have you as a drinking buddy.' The two of them smile at each other for a moment, then Rane squeezes Ryousei's shoulder once more before running a hand down the tiger's muscled flank. 'Just so you know... I am interested in more than just knocking back sake too. One thing this oni definitively isn't is monk-ish and celibate, if you get my drift.' With a wink at Ryousei's surprised expression, Rane then gets up and adds, 'It's a standing offer for such a sexy cat as yourself. But now, I am off to re-stock on sake. Something tells me I need more in the future.' Then the blue oni casually vaults over the railing and light-footedly bounces off the tops of one, two, three sturdy bookshelves before jumping onto the floor of the library. With a grin over his shoulder, he vanishes through the main doors soon after.";
