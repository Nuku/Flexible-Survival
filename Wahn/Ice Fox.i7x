...
"Ice Fox"	"[PrepCombat_Ice Fox]"

to say PrepCombat_Ice Fox:
	say "";
...
When Play begins:
	...
	add "Ice Fox" to infections of KnottedCockList;
	add "Ice Fox" to infections of SheathedCockList;
	add "Ice Fox" to infections of TaperedCockList;
	add "Ice Fox" to infections of BipedalList;
	add "Ice Fox" to infections of TailList;
	now Name entry is "Ice Fox";
	now enemy title entry is ""; [ Name of the encountered creature at combat start - Example: "You run into a giant collie." instead of using "Smooth Collie Shemale" infection name. ]
	now enemy Name entry is "Miyuki";
	...
	now face change entry is "your mouth pushes out into a slim muzzle and your ears taper to points and wander steadily upwards. All in all, your whole head seems to stretch and reform into the more triangular visage of a fox, your slim new muzzle full of sharp teeth and your bright shining eyes seeing the world around you in an entirely new, and more sexual light"; [ "Your face feels funny as (your text)." ]
	now body change entry is "your muscles twitch and tremble, and your bones reform, shaping your being into a more slim and streamlined form. A row of scales solidifies in an unbroken band from your throat all the way to your inner thighs, as well as on the back of your forearms and on your shins. Meanwhile, your hands seem to narrow and your fingers grow closer together as soft claws push their way out of your new slightly paw-like hands. Finally, your feet take on a shape more fitting the digitigrade stance and form draconic toe-claws";
	...
	now MilkItem entry is "ice fox milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "ice fox cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
to say ForestCaveEntranceDesc:
	...
	if MiyukiRelationship is 0: [player doesn't know her]
		say "     A single track of delicate paw-prints with surprisingly large claw-marks leads into the cave. There are only tracks from two human-sized paws, so it seems they must belong to an anthro...";
...
instead of going Down from Frozen Cave Tunnel while (Miyuki is in Ice Fox's Den and MiyukiRelationship is 0): [first encounter]
	...
	say "     In the midst of the cave stands what must be the person living here - an anthro fox with snow-white fur, as well as some flexible draconic scales that run in a broad band from her throat, between two shapely breasts and all the way down to the inside of her thighs. She bears more scales on the back of her forearms, as well as on her shins, with them becoming more pronounced further down and ending at the sharp toe-claws that make her paws appear more like a dragon's than a foxes. Finally, there is a grand total of nine flexible fox tails fanned out behind her, swaying gently left and right. All of this is readily visible to you as she doesn't seem to need - or want - to wear clothes. Inevitably, your gaze wanders down between her thighs, where you spot a thin slit between two scale-plates.";
...
Cunt Depth of Miyuki is 9. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Conversation of Miyuki is { "Ice Fox" }.
...
instead of conversing the Miyuki:
	...
	if lust of Miyuki > 2 and HP of Miyuki < 3:
		...
		now description entry is "Get on the sorceress's good side by giving her some assistance";
	[]
...
to say MiyukiSex2: [Miyuki fucks player pussy]
	...
	say "     'Now what a certain someone has woken my little fox, I wonder that I should do with it...' the ice sorceress adds playfully in almost a purr. Seeing the deep need to be fucked in your gaze, she gives an amused yip and licks her muzzle in anticipation. 'About time I sank myself into a sweet pussy again,' she says with a chuckle, then strokes your cheek and beckons to follow you with one of her nine tails as she walks over towards her warm nest. Arriving at the large ring of blankets and pillows just a step behind the fox, you are helped out of your clothes by her eager hands, then climb into her soft camp, lying back in its very comfortable expanse.";
	WaitLineBreak;
...
to say MiyukiSex3: [Miyuki fucks player pussy - doggy style and ovi]
	...
	if Player is female:
		if Cunt Depth of Player > 13: [longer than her cock]
