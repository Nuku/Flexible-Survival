...
instead of going east from Greek Street while "Player Introduced to PAN" is not listed in traits of Richard and SatyrFratPartyStage > 0 and SatyrFratPartyStage < 99: [not introduced yet, Kerr & Talov got in]
	if Daytimer is night:
		...
		if "Richard & Player won scuttler fight" is listed in Traits of Richard or "Player lost scuttler fight" is listed in Traits of Richard:
			...
			say "     The dude looks at you with curiosity for who might be coming to visit the frat house, which is then quickly replaced by a frown appearing on his face as he recognizes you as the person who punched him. 'What the fuck are you doing here? Just strolling up to the frat house after the shit you pulled last time! Being punched out and waking up in the dirt behind our bushes is just what I needed that night, you asshole!' He isn't exactly pleased to see you, but aside from raising his voice, the frat brother doesn't yet seem immediately poised to fight you right now. Him nodding to the side, indicating the several more frat members hanging out in the living room, seems mostly intended as a deterrent meant for you. Given that you only wanted to create a distraction the last time you met, you decide to apologize and come clean. The young man listens to your words, his eyebrows rising a bit as you mention your satyr friends.";
			say "     'Aha, now things start making some sense. You're a bud of K&T and ran interference to get me out of the way? Man, did you have to hit me so fucking hard? I had a headache for hours after. Bah, you're lucky those two are pretty friendly guys who made a big splash when they joined the party. Brought their own booze to share, and they mix some awesome drinks, so we decided they're fine to stay a while. If you're with them... I guess I'll not raise a stink with the guys about it. But you owe me some payback for the pain, capiche?' He keeps his gaze on you until you reluctantly nod, then lets out a grunt and says, 'I'm Richard, by the way.' After you introduce yourself in turn, he waves for you to follow him inside. ";
			now PlayerMet of Richiard is true;
		else if SatyrFratRichardRelationship is 99: [punched him and ran]
			say "     The dude looks at you with curiosity for who might be coming to visit the frat house, which is then quickly replaced by a frown appearing on his face as he recognizes you as the person who punched him. 'What the fuck are you doing here? Just strolling up to the frat house after the shit you pulled last time, then ran off like a chicken! Back to start some more beef? Me and the guys will have show you what's what if you try!' He isn't exactly pleased to see you, but aside from raising his voice a bit, the frat brother doesn't yet seem poised to fight you or anything. Him nodding to the side, indicating the several more frat members hanging out in the living room, is intended as a deterrent meant for you. Given that you didn't really fight him in the first place and only wanted to create a distraction, you decide to apologize and come clean. The young man listens to your words, his eyebrows rising a bit as you mention your satyr friends.";
			say "     'Aha, now things start making some sense. You're a bud of K&T and ran interference to get me out of the way? Mh, you're lucky those two are pretty friendly guys who made a big splash when they joined the party. Brought their own booze to share, and they mix some awesome drinks, so we decided they're fine to stay a while. If you're with them... I guess I'll give you a pass for that punch you threw. You hit like a little girl anyways.' With a grunt, he holds out a hand for you to shake. 'I'm Richard, by the way.' After you introduce yourself in turn, he waves for you to follow him inside. ";
			now PlayerMet of Richiard is true;
		else if SatyrFratRichardRelationship is 2: [Player distracted Richard with sex]
			say "     Richard looks at you with curiosity for who might be coming to visit the frat house, which is then quickly replaced by a smile appearing on his face as he recognizes you. 'Oh hey[if Player is not defaultnamed], [Name of Player][else]there[end if]!' he says, his expression becoming more open and welcoming instantly. 'That was quite some fun we had the other night. Nice to see you again.' Nodding to him and giving a flirty wink, you chat a little with the young man, then eventually swing the conversation over to the pair of friendly satyrs that you ran into earlier that day, who wanted to join the frat party, and ask if they actually did.";
			say "[Richard_Friendly_Introduction]";

to say Richard_Friendly_Introduction:
	say "     'Ah, you know K&T? Yeah, those two just strolled in the front door while we were... busy. Funny timing that, eh?' Raising an eyebrow as he says the last words, you can almost see the wheels in his head turning as he makes the connection between your eventful interaction, and the arrival of the satyrs. He lets out a somewhat amused snort, then shakes his head and smiles at you. 'Come on in, let me introduce you to the guys!' Stepping back to free the doorway for you, he waves for you to follow him into the frat house. [PAN Frat Introduction]";

to say PAN Frat Introduction:
	say "'Hey guys, got a friend of K&T here[if Player is not defaultnamed]. This is [Name of Player].' [else].' [end if]Nodding to you, he then goes through the students currently present, pointing them out one by one at which point they give you a wave. There's River - a quite handsome blond guy who's the Tenvale college swim team captain, Big John - all towering and muscular and an offensive guard on the football team, Nate - who's pretty wiry and apparently a good gymnast, Little John - almost as muscular as Big John, just two foot shorter, and a wrestler, and Paul - making finger guns at you as his name is called, and also a wrestler, but in a much lighter weight class.";
	WaitLineBreak;
	say "     Continuing on into the next room, Richard grins and points at two people lying in a pile on a sofa: It's Kerr and Talov, deep asleep. 'Those two partied till sunrise, I guess they'll be out most of the day, hah! Let us leave them to get their rest...' On the other side of the room, past a pool table, you find two more frat members, busy playing a console fighting game against each other. Richard introduces them as Oliver - another guy with a sleek swimmer's build, and on River's team, and Han - a muscular Asian-American stud with very well-developed legs, and apparently the captain of the college's soccer team. '[']Sup?' Han calls over to you, barely pulling his gaze away from the large flatscreen TV so he doesn't lose momentum in slapping around Oliver's character in the game. Moving on, Richard leads you to a door in the east wall, pausing for a second before he opens it. 'Now, you better be on your best behavior when you meet our next frat brother. If he doesn't like someone, they're out, understand?'";
	say "     After he pulls the door open, you follow Richard into... a stable? No, it's a goat pen! With a very well-cared for African goat with a fairly enormous pair of curved horns on his head. Nodding seriously, Richard grabs a carrot and hands it to you, then waves you forward to approach the divider between the pen and the rest of the room. 'This is Sylvanus, our mascot! Go on, introduce yourself.' As you do so, the goat approaches, focusing an intense gaze of his eyes on you, with his weird nonhuman pupils, like a figure eight lying on its side. After studying you for a moment, Sylvanus lets out a loud 'Baaah!', approaching the divider and allowing you to feed him. 'Looks like you can hang with us,' only half-joking if you read his expression right. After the goat has polished off the carrot, you continue on through the garden and kitchen of the frat house, but encounter no one else there and finally return to the living room. 'We'll let the others know that you're allowed to be here, that was only about a third of the guys in the frat.'";
	WaitLineBreak;
	say "     After his last comment, Richard excuses himself and goes back to what he was doing when you arrived. Looks like the satyr's plan of joining the party - and future parties - in the frat house was a success. And you've got an in now too.";
...
Sterile of Kerr & Talov is false.
