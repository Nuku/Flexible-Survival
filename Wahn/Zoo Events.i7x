...
to say ResolveEvent Cheetah Trade:
	...
	if Player consents:
		...
		if Player is male:
			...
			WaitLineBreak;
			say "     Your feral partner squeezes her inner muscles around your dick, milking you for every last drop of cum before she eventually releases it from her sex and stands up with a mrowl. Stretching herself pleasantly, she turns her head to look at you and comments, 'Good sex toy.' With that judgment of your service given, she lithely climbs back on her tree with only a few steps of run-up, soon arriving at her branch hangout again. A moment later, you're almost hit by the medkit dropping from above and thumping on the ground. Bending down to collect your payment, you leave the feline to her bliss and wander out of the enclosure.";
