...
to say BrennanSoldierTalk3:
	if hp of Major Padgett is 100: [player got banned from Camp Bravo]
		say "     You quietly tell Brennan about what you know goes on in Camp Bravo - a minotaur being there, as well as the acts performed with him. The human survivor gapes as you lay it all out, his eyes going wider with every little detail revealed. 'They do [italic type]WHAT?![roman type] That, that makes no sense at all! I - we - need to do something about this. There must be a way to convince their commander to stop this madness.' His expression hardens and determination sets in - clearly, your friend wants to get to the bottom of the Camp Bravo situation.";
		say "     Before he can get too much more into it, you grab Brennan by the arm and look into his eyes, then say that you already tried that. The major in command of Camp Bravo had you roughed up and thrown out! Your human friend lets out something between a sigh and a groan, followed by the words, 'Well - fuck! Fuck, fuck, fuck! This situation is worse than I had thought. I'll look into it some more on my own, okay? Maybe I can figure out a way to fix it. And - thank you for trying.' He lays his hand on your shoulder, smiling and gives it a companionable squeeze.";
		...
		if player consents:
			...
			LineBreak;
			say "     Brennan looks quite disappointed as you refuse to set out right away. 'Fine,' he says after taking a deep breath, then looks you in the eye. 'Do what you must, but please hurry. When you come back, we can go there together. I believe we'll achieve more as a team than if I just turn up alone. Think of all the innocent young men that are being ordered to get fucked by that beast!'";
			now XP of Brennan is 2; [postponed]
	else if XP of Brennan is 2: [player postponed the trip previously]
		say "     Approaching Brennan and bringing Camp Bravo up again results in him getting quite lively immediately. 'Finally! Let's get going then!' he says, full of elan to deal with the situation around the minotaur.";
		say "     [bold type]Will you show Brennan the way to the army camp?[roman type][line break]";
		LineBreak;
		say "     ([link]Y[as]y[end link]) - Sure, let's go right now.";
		say "     ([link]N[as]n[end link]) - Tell him that right now is a bad time.";
		...
		say "     Approaching Brennan and bringing up Camp Bravo again puts the bearded man into a somber mood. He strokes his chin and says, 'So - now we've been to the place and learned a bit more. Still, it irks me that we couldn't do anything about the matter when we were there. I do know that things aren't as dire as I originally thought, but hell, that still doesn't make it [italic type]right[roman type]. Tiny may be well-liked regardless, but their commanding officer is still basically whoring his men out. That's just... gah!' You put your hand on the man's shoulder and tell him that you understand his frustration, then suggest that some of the ideas Sargent Alexander brought up might lead to a proper reckoning for the major commanding Camp Bravo. The two of you will need some good and solid evidence to show the 'Patient Zero' story built up around Tiny being a hoax.";

to say BrennanCampBravoTrip1:
	say "     After Brennan collects his gear and says goodbye to Romulus and Remus, the two of you set out into the streets of the city. Your way to Camp Bravo leads you through various back alleys, avoiding any open areas that might contain larger numbers of infected creatures. The few singletons that you come across do their best to avoid two such capable-looking survivors out on a mission, so you arrive at the army camp without any trouble. Seeing it from afar, Brennan glances at the cleared perimeter around the place, as well as the cars used as a blockade and cover at the entrance. He gives a nod to himself, as if content that whatever is happening inside the place, the soldiers are at least observing the usual safety precautions.";
	project the Figure of MarcOrwell_icon;
	say "     Without further ado, your companion then strides towards to the entry point, a determined expression on his face, and you go along with him. Before long, Brennan is called upon to stop and identify himself by ";
	if Camp Bravo Entrance is known: [player met Marc before]
		say "a soldier you know: It is Marc Orwell, the slender blond guy with the merman tattoo. Interestingly, his usual partner at standing watch is absent. 'Hey there, [if player is female]miss[else]mister [']secret agent['],' he greets you specifically, the amusement in his voice making it clear that he knows you tricked Private Cooper previously. After you say hello to him in turn, the soldier listens to your introduction of Brennan as a concerned citizen and waves you past with a wink. 'I'll tell you know who that you brought a confidential informant. That'll make sure he won't act like a bitch if he's here the next time you are coming in,' Marc adds with a grin as you walk into the camp.";
	else: [first encounter with Marc]
		say "a tall but slender soldier with blond hair and a merman tattoo on his left arm. As Brennan steps forward to introduce himself and you, the guard lets his gaze wander all over the man's impressive physique, then replies, 'Just two concerned citizens then, eh? Welcome you two, I'm Private Marc Orwell. You seem to be decent people so let me give you this tip: The sorry excuse of a person who usually is at this post together with me is a total shit, so... you'd do well to have a bit more of a reason why we should let you through.' The blond man looks thoughtful for a second, then grins and adds, 'Okay, how about this. You are a secret agent and a confidential informant. Cooper can't say something against that. Now go on in.'";
		now Back at the Camp is resolved;
		now Camp Bravo Entrance is known;
		now HP of Adam is 3; [player got access to the camp]
	WaitLineBreak;
	follow the ngraphics_blank rule;
	say "     As you enter the camp, the hitching post comes into sight, the ground underneath still wet with a puddle of drying cum. Not too far away from it, the minotaur is stretched out on two stacked king-size mattresses, dozing contently. Brennan stares at the mythical beast for a few seconds, then shakes his head in disbelief, losing the last fleeting hope that you might just have been exaggerating. 'Come on, let's end this farce. The commander [italic type]must[roman type] be made to see reason,' the human survivor says, his heated tone showing shock and agitation. Struggling to keep up with his determined steps, you are halfway across the parade ground (or rather 'breeding ground' these days) when a soldier steps into Brennan's path. 'I wouldn't do that if I were you,' the man tells your friend in an earnest tone, raising a hand to stop Brennan from just brushing past him.";
	say "     Frowning, Brennan does indeed stop moving, then glances at the man's name-tag and replies in a somewhat accusatory tone, 'And why not, Sergeant Alexander?' The tough, grizzled soldier simply says, 'Not here. Come, follow me.' After exchanging a surprised look with you, Brennan follows the soldier, as do you. It does not take long for your little group to reach an out of the way tent in the corner of the camp, which Alexander leads you into. Inside, there are quite a lot of boxes, all filled with various kinds of non-edible supplies. The experienced soldier runs a hand through his hair, then leans back against a stack of boxes, crossing his arms. 'Well then, what do you think will happen if you go into that tent and talk to the major?' he asks in a gruff tone, looking at Brennan and raising an eyebrow.";
	WaitLineBreak;
	say "     The human survivor steps forward and starts to explain, 'I'll tell him how fishy that story about that minotaur being 'patient zero' really is - the nanites don't work that way. Everyone would just be minotaurs if it was true. I've seen enough out in the city to know that. And then -' With a single word, Alexander brings him to a halt at that point: 'Bull[italic type]shit[roman type]' Shaking his head, the man steps forward to say, 'Let me take you through what would happen. You go in, say your piece, and he has you thrown out. You've got no proof, and even though what you say makes sense, not even we here in this tent [italic type]know[roman type] if the minotaur thing really is a hoax. And what's more - the major bought the story, and now he is committed to it, no ifs or buts about it. It [italic type]has[roman type] to be true from his viewpoint, because if it's not - he'd be DONE. Sent to the furthest reaches of Alaska to hide the embarrassment, most likely.'";
	say "     'Um, but...' Brennan starts, then pauses and bits his lower lip. He looks visibly deflated at Alexander's harsh words, his gaze wandering through the tent as he mulls over what the soldier just explained. 'So, it's hopeless then?' the muscular man asks, looking first to you, then to Sergeant Alexander again. 'I didn't say that. We just need to get actual proof, not just your best guesses at what the nanites will do. Or are you a scientist or doctor? No? Then we're out of luck unless either of you knows some qualified specialists who could give testimony. Or you could go check out the guy who sold the major this story - doctor Diego Garcia, apparently he was working on something similar at the big hospital downtown? Could try finding him, or his office and papers.' Brennan nods slowly, his previous determination returning. Then he raises the point, 'But that'll still not help all the men and women here in the camp. We can't just leave things as they are.'";
	WaitLineBreak;
	say "     Sergeant Alexander blows out his cheeks and gives a shrug. 'Well, till you get us proof that this whole thing is nothing but a pipe dream - we still got orders to follow. And who knows - all those strapping lads sacrificing their cherries to a bull-man might yet save the world. As weird as the whole situation may be, with the immunity booster shots that we thankfully got a huge delivery of before the radio interference started... I think the men and women will be fine.' The grizzled soldier chuckles as he adds, 'For a nine feet tall mythical beast, Tiny is actually quite amicable. I know a few guys who visit him at night, just on their own accord. He's become more or less a beloved mascot of the camp. That's actually another reason why you shouldn't just try to expose the major flat out. He might snap and try to hurt Tiny or something.'";
	say "     'People like him? Really?' Brennan asks, surprise clearly visible on his face as he goes on to say, 'The minotaurs out in the city that I've seen are quite aggressive.' Alexander chuckles and pats the other man on the arm, 'Come on, you should meet him.' He leads the two of you outside again, then back to the parade ground and up to the dozing minotaur after collecting an apple from a supply crate and handing it to Brennan. Then the tough soldier bends forward and gives the sleeping beast-man a little shake as he says, 'Hey Tiny, got someone here who wants to say hello.' The large creature lets out a deep huff through his nostrils, then opens up his eyes, sitting up in a show of rippling muscles. 'New friend?' he asks his handler, still a bit sleep-drunk, glancing from Alexander to Brennan.";
	WaitLineBreak;
	project the Figure of TinyTim_icon;
	say "     The human survivor doesn't have to be prompted to offer the minotaur his apple, which Tiny accepts right from his hand, chomping down on it in one piece and soon swallowing it down. 'Nice breakfast,' the muscular brute says, smiling at his new acquaintance, then pushes himself up and stands, now towering over Brennan. He leans forward and sniffs at the man, then licks his face and proclaims, 'Friend smells good. Tiny likes new friend.' A throb goes through the massive manhood dangling between his legs and it grows a little bigger. 'Friend want to fuck?' comes the eager request right after, which Brennan hastily refuses with the words, 'Thanks, but not right now!' The minotaur turns his attention to Alexander, who explains to him that more sex isn't planned right now and that he can rest a bit more.";
	say "     After this quite memorable encounter, Sergeant Alexander accompanies Brennan and yourself to the camp entrance, sending you off with best wishes for you to actually find information that exposes she minotaur cum sham. As you make your way back to Brennan's apartment, the man comments, 'Well, that was... educational. Guess I'll have to adjust my preconceptions quite a bit. We can talk about what our next plans are later.'";
...
after going to Survivor Refuge while (Soldier Questions is not resolved and XP of Brennan is 0 and (TimekeepingVar is -2 or TimekeepingVar is -3 or TimekeepingVar is -4 or TimekeepingVar is 6 or TimekeepingVar is 5 or TimekeepingVar is 4) and a random chance of 1 in 2 succeeds): [first time, Brennan awake and in the apartment, 50% chance]
	project the figure of Brennan_face_icon;
	say "     As you enter the main room of the apartment, Brennan comes up to you, a thoughtful expression on his face. 'Listen, I met some soldiers a little while ago that were quite peculiar in their behaviour. The two of them were on the march towards the city containment perimeter from somewhere in the downtown area and acted very... squirrelly when I asked what they were up to.' Rubbing his bearded chin, the human survivor frowns a little as he goes on to say, 'You know, it wasn't the usual 'Please step back sir! We got orders to maintain a quarantine.' No, these guys immediately went beet-red in the face and murmured something about a 'special mission', then hurried along as if trying to shake me off. I kept up with them for a little while and asked more questions, but all I could get out of them was that they came from 'Camp Bravo'. Have you maybe heard of that place? Seems like something weird is going on there and I want to know more!'";
