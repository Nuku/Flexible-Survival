...
carry out PetStoreSearching:
	if SarahSlut is 2:
		...
		now SarahSlut is 3;
	else if SarahCured > 2 and "Collared" is not listed in Traits of Sarah and "Collar ready" is not listed in Traits of Sarah:
		say "     Getting to work, you dig into the piles of random pet-themed items, discarding most of what you find after checking it out for a few seconds. After much effort, you do manage to find a few scattered collars lying under [one of]a cracked transport box for smaller canines[or]a divider for transporting larger dogs safely in a car[or]a pile of shredded chew-toys[or]several empty cans of dog food[at random]. You pick a vibrant yellow one that looks fairly stylish, with some neat stitching along the sides. More of a fashion accessory than a sign of ownership. It doesn't have a leash ring either. Taking one of the blank, rectangular tags scattered all over the floor behind the front counter, you use a mechanical press in the back of the store to punch the word [']Sarah['] onto it. Hopefully she'll appreciate the gift you got for her.";
		TraitGain "Collar ready" for Sarah;
