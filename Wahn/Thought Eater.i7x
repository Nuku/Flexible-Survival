...
to say Thought_Eater_Wins:
	...
	if Player is female: [female+herm]
		...
		CreatureSexAftermath "Player" receives "PussyFuck" from "Thought Eater";
	else: [male+neuter]
		...
		say "     With that, you find yourself picking up your gear and clothes, putting them on and walking through the dark corridors to the entrance of the underground tunnels under the Trevor Labs. As you step outside and the door clicks closed behind you, the last of the strange hybrid's mental influence fades away. He let you go, this time, though you still have the gaping hole in your mind where the thought eater fed upon you.";
		CreatureSexAftermath "Player" receives "AssFuck" from "Thought Eater";
	infect "Herm Human";
...
to say TESlaveSex1: [cock sucked by Lee]
	...
	CreatureSexAftermath "Herm Human" receives "OralCock" from "Player";
	infect "Herm Human";
...
to say TESlaveSex2: [sucking Lee's cock]
	...
	CreatureSexAftermath "Player" receives "OralCock" from "Herm Human";
	infect "Herm Human";
...
to say TESlaveSex3: [cunt licked by Lee]
	...
	CreatureSexAftermath "Herm Human" receives "OralPussy" from "Player";
	infect "Herm Human";
...
to say TESlaveSex4: [Lee's pussy fucked by player]
	...
	CreatureSexAftermath "Herm Human" receives "PussyFuck" from "Player";
	infect "Herm Human";
...
to say TESlaveSex5: [player's pussy fucked by Lee]
	...
	CreatureSexAftermath "Player" receives "PussyFuck" from "Herm Human";
	infect "Herm Human";
...
to say TESlaveSex6: [fucking Lee's ass]
	...
	CreatureSexAftermath "Herm Human" receives "AssFuck" from "Player";
	infect "Herm Human";
...
When Play begins:
	...
	now Species Name entry is "Thought Eater";
	add "Thought Eater" to infections of HybridList;
	add "Thought Eater" to infections of ScienceList;
	add "Thought Eater" to infections of MaleList;
	...
	now MilkItem entry is "thought eater milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "thought eater cum"; [ Item to be given to the player if they have this infection and jerk off. ]
