...
to say SantaTalk2:
	...
	otherwise:
		...
		otherwise if calcnumber is 3:			[rub him]
			...
			say "     Lowering his head to take a good, long sniff of your scent, Santa Claws squeezes your butt, then pulls himself back slightly from the aroused growling and grunting. With a grumbled, 'let's get this stuff off you,' he lowers you to lie flat on your back on the throne. Strong clawed hands work quickly to pull off your gear and clothing, dropping it all on the ground, and soon you're lying naked before the big bear. 'Good,' he growls, running his fingers down your [bodytype of player] form until he reaches your crotch [if cunts of player > 0]and brushes over your nether lips.[otherwise]and pushes your legs apart a little bit to brush over your pucker.[end if]";			
			say "     [WaitLineBreak]";
...
to say SantaTalk3:
	...
	if randomnumber is:
		...
		-- 2:
			say "     The polar bear leans back on his throne, then says in his deep voice, 'Have you stopped by that strange store down in the west wing? Nermine is a perculiar woman - and seems very interested in buying my suit...'";
		-- 3:
