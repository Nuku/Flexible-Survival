...
to say ShagShackSex10: [Feral Male Latex Fox]
	...
	if player consents:
		...
		if scalevalue of player < 3:
			...
			say "    Attempting to use your size to your advantage, you stuggle against the beast. Just as you begin to gain some leverage, however, the fox abruptly grows in size until he's slightly larger than a wolf, his new mass enough to keep you held in place. [LatexFoxAveragePlayerSex]";
