...
to say ShagShackSexMenu:
	...
	if cocks of player > 0:
		choose a blank row in table of fucking options;
		now title entry is "Feral Male Latex Fox";
		now sortorder entry is 7;
		now description entry is "Have some fun with a feral latex fox.";
	[]
	sort the table of fucking options in sortorder order;
	repeat with y running from 1 to number of filled rows in table of fucking options:
		choose row y from the table of fucking options;
...
to say ShagShackSex10: [Feral Male Latex Fox]
	...
	if player consents:
		...
		if scalevalue of player is 1 or scalevalue of player is 2:
			...
			say "    Attempting to use your size to your advantage, you stuggle against the beast. Just as you begin to gain some leverage, however, the fox abruptly grows in size until he's slightly larger than a wolf, his new mass enough to keep you held in place.";
...
to say LatexFoxAveragePlayerSex: [Sex scenes for an average player]
	...
	if randomnumber is:
		-- 1:
			...
			WaitLineBreak;
			say "     The vulpine seems to completely disregard you afterwards, returning to the position he was in when you entered. Collecting yourself, you shakily exit the room.[mimpregchance]";
			WaitLineBreak;
		-- 2:
			say "     Eager to use you, the vulpine grabs you by the arm with his teeth, and yanks you to the side, causing you to roll over. However, this seems to be exactly what he wanted as he lines his erect, drooling cock up with you ass, roughly thrusting against it a few times before his tip sinks inside.";
			say "     With his shaft inside you, he begins to grow both his body, and his cock. You grit your teeth in pain as the intrusion grows, preading your ring out wider. The fox's weight also increases, pressing you into the ground with his mass. By the time he's done expanding, his cock is nearly an inch wider, four inches longer, and his body is close to the size of lion. Despite the increase in size, he's still able to push his rubbery vulpine tool further into your depths, lubricated just enough by his precum. After a lot of work on his part, and pain on yours, he manages to bottom out to his growing knot.";
			WaitLineBreak;
