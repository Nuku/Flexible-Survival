...
Cunt Depth of Hercules is 0. [penetratable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
to say HerculesPersonTalkMenu:
	...
	if "Kilt" is listed in Traits of Hercules:
		...
		now description entry is "Explain to the former mannequin what you're doing";
	[]
	if "Towel" is listed in Traits of Hercules and if "Kilt Obtained" is listed in Traits of Hercules:
		choose a blank row in table of fucking options;
