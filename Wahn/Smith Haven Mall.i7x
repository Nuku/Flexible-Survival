...
To say mfcourt:
	If findwires is 2 and fixedgens is 2:
		...
		say "     Quite a few of the tables are occupied by mallrats and a variety of other infected, talking and laughing loudly while playing a variety of card games. At least the mall rats seem to have food and drinks too, given out at the various franchises that line the large room. Apparently, someone instituted a rationing system here, and several wolverine guards hang out close by to enforce it. It is just for the inhabitants though, but some of them are perfectly willing to trade or even share their rations with guests...";
	otherwise if daytimer is day:
		...
		say "     There are a number of mall-rats and few other infected occupying some of the tables, playing a round of poker or blackjack. At least the mall rats seem to have food and drinks too, given out at the various franchises that line the large room. Apparently, someone instituted a rationing system here, and several wolverine guards hang out close by to enforce it. It is just for the inhabitants though, but some of them are perfectly willing to trade or even share their rations with guests...";
	Otherwise:
