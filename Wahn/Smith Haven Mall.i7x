...
To say mallnorthlot:
	If daytimer is day:
		say "     You walk along the parking lot's main access road into the mall's northern lot, peeping into a few of the cars as you go. There aren't as many cars on the north side of the mall as there is on the south side, but they all still show signs of the owners being assaulted and transformed into the various critters now running around the city. To the [Bold Type]south[roman type] you see the entrance into the mall's foyer, flanked by the wings of the mall stretching [Bold Type]east[roman type] and [Bold Type]west[roman type]. Just across the street to the [Bold Type]north[roman type] is a four story office building, bearing the name 'Branson & Partner Land Management' above the entrance. A big 'Help Wanted' sign has been taped to the inside of the glass door leading into the building.";
	else if findwires is 2 and fixedgens > 2:
		say "     You walk along the parking lot's illuminated main access road into the mall's northern lot, peeping into a few of the cars as you go. There aren't as many cars on the north side of the mall as there is on the south side, but they all still show signs of the owners being assaulted and transformed into the various critters now roaming around the city. To the [Bold Type]south[roman type] you see the entrance into the mall's foyer shining like a beacon in the night, flanked by the likewise illuminated wings of the mall stretching [Bold Type]east[roman type] and [Bold Type]west[roman type]. Just across the street to the [Bold Type]north[roman type] is a four story office building, bearing the name 'Branson & Partner Land Management' above the entrance. Light shines from within, allowing you to read the big 'Help Wanted' sign has been taped to the inside of the glass door leading into the building.";
	else:
		say "     You carefully make your way along the dark parking lot's main access road, staying alert for any traps or surprises. Of what you can see, there aren't as many cars on this side of the mall as compared to the south side, but there they all still show signs of the former owners['] fates. To the [Bold Type]south[roman type] you can just discern the glass door entrance to the mall's foyer in the low light. Just across the street to the [Bold Type]north[roman type], a multi-story office building stretches up and blocks out a patch of the starlit sky.";
...
To say malleastlot:
	If daytimer is day:
		say "     You walk along the parking lot's main access road into the mall's east lot, checking some of the cars for anything useful. When you finally make it, all you can see is even more parked and wrecked cars with their doors opened and ripped clothing, some purses, and shopping bags, strewn about, caked in what you assume is dried cum. There is a big building sitting on the [Bold Type]southeast[roman type] corner of the lot, 24-7 Fitness blazoned across the top of it in red letters. To the [Bold Type]northeast[roman type], another large structure looms over the flat expanse of the parking lot - the sign on its side reads 'Mattress & More Superstore' ...and on closer inspection, you see that someone has sprayed the words 'Shag Shack' in huge letters on the store's glass front. [Bold Type]East[roman type] of where you stand lies the opening of a small alley. You can see trash scattered on the ground within.";
	else if findwires is 2 and fixedgens > 2:
		say "     Being careful of the shadows cast by the parking lot lights, you walk along the lot's main access road into the mall's east lot. When you finally make it, of what you can see, there are even more parked and wrecked cars with their doors opened and ripped clothing strewn about, caked in what you assume is dried cum. The sign on the side of the Sears building is illuminated as well as the sign on the side of the 24-7 Fitness building sitting on the [Bold Type]southeast[roman type] corner of the parking lot. To the [Bold Type]northeast[roman type], another large structure looms over the flat expanse of the parking lot - the glowing sign on its side reads 'Mattress & More Superstore' ...but in the glow of that sign, you can see that someone has sprayed the words 'Shag Shack' in huge letters on the store's glass front too. [Bold Type]East[roman type] of where you stand lies the opening of a small alley. You can see trash scattered on the ground within.";
	else:
		say "     You slowly and carefully make your way along the dark parking lot's main access road, watching all around you for anything that might surprise you. Finally making it to the east lot, you can just make out more of the same destruction that was in the [Bold Type]north[roman type] lot. Remembering that there is supposed to be a gym in the mall's [Bold Type]east[roman type] lot, you continue walking until you are able to just discern a large building to the [Bold Type]southeast[roman type]. Some light shines from the interior of another big structure in the [Bold Type]northeast[roman type]. [Bold Type]East[roman type] of where you stand lies the opening of a small alley. You can see trash scattered on the ground within.";
...
To say mallwestlot:
	If daytimer is day: [daytime]
		say "     You walk along the parking lot's main access road into the mall's west lot, looking through some of the cars for any left over food or water. Finally making it, you look around and find that it's just more of the same, the carnage of rampant sex splattered all over the vehicles. Sitting on the [Bold Type]northwest[roman type] corner of the lot is a large gas station with a convenience store, the lingering scent of gasoline wafting towards you on the breeze. In the [Bold Type]southwest[roman type] part of the lot you can see another building. The sign sitting on the edge of its roof reads as China South Buffet.";
	else if findwires is 2 and fixedgens > 2: [power on]
		say "     With the parking lot lights illuminating the area, you walk along the parking lot's main access road into the mall's west lot. Finally making it, you look around as best as you can and find that it's just more of the same, the carnage of rampant sex splattered all over the vehicles. The sign on the side of the JCPenney's building is lit and all the lights are on at the large gas station sitting on the [Bold Type]northwest[roman type] corner of the lot. When you pause long enough, you can smell the lingering scent of gasoline wafting towards you on the breeze. In the [Bold Type]southwest[roman type] part of the lot you can see another building with some lights on. The illuminated sign sitting on the edge of its roof reads as China South Buffet.";
	else: [night]
		say "     You slowly and carefully make your way along the dark parking lot's main access road, keeping an eye peeled for anything that might try to surprise you. Finally making it to the west lot, it's hard to tell if there is anything much different. You find on the [Bold Type]northwest[roman type] corner of the lot what looks like a large gas station with a convenience store. The lingering scent of gasoline wafting towards you on the breeze confirms it. Curiosity spurning you on, you continue exploring the west lot until spotting a building to the [Bold Type]southwest[roman type], which you know is the China South Buffet.";
...
To say mallsouthlot:
	...
	If daytimer is day:
		say "     Walking into Smith Haven Mall's vast southern parking lot, you see the devastating results of the infection having run rampant. Dotted about the lot are not only parked vehicles with either open doors, broken windows, or both, but also several wrecked vehicles, either smashed into other vehicles or hung up in planters. Scraps of ripped clothing caked in dried fluids litter the ground around the vehicles and about the lot. To the [Bold Type]north[roman type] you can see the entrance to the mall's food court. Just inside the glass doors you are able to see some activity on the other side of them. Looking to the [Bold Type]east[roman type] and to the [Bold Type]west[roman type] just shows more of the same destruction, though off in the distance of the mall's [Bold Type]west[roman type] lot you spot a gas station.";
	else if findwires is 2 and fixedgens > 2:
		say "     Walking into Smith Haven Mall's vast southern parking lot, with the lot lights illuminating the area you see most of the devastating results of the infection having run rampant. Dotted about the lot are not only parked vehicles with either open doors, broken windows, or both, but also several wrecked vehicles, either smashed into other vehicles or hung up in planters. Scraps of ripped clothing caked in dried fluids litter the ground around the vehicles and about the lot. To the [Bold Type]north[roman type] you can see light coming from the entrance to the mall's food court. Just inside the glass doors you are able to see some activity inside the mall. Looking to the [Bold Type]east[roman type] and to the [Bold Type]west[roman type] just shows more of the same destruction, though off in the distance of the mall's [Bold Type]west[roman type] lot you spot the lights of a gas station.";
	else:
		say "     By what you can see around you in the dark, you're pretty sure you're in Smith Haven Mall's vast parking lot. The full, pregnant, moon hanging in the night sky brilliantly casts its light upon a good portion of the mall's lot. With the stars dancing along with the moon in the night sky and the eerie silence of the abandoned cars you can see, the devastation around you is almost serene. To the [Bold Type]east[roman type] and [Bold Type]west[roman type] you know the parking lot continues and [Bold Type]north[roman type] of you is the entrance to the mall's food court.";
...
To say mallatrium:
	If findwires is 2 and fixedgens > 2:
		say "     The mall's atrium is a large rotunda, four massive columns rising towards the ceiling and seeming to support the large domed roof. The lit dome itself is painted with a scene of Mount Olympus. Three foot tall statues depicting the twelve Olympian gods sit on a ring running around the upper half of the rotunda and are backlit with random colored lights. Dominating the center of the atrium is a large fountain. You've learned in the past that it's a faithful recreation of the Morosini fountain found in a village in Crete. The fountain is now working, though the water is not actually suitable for drinking, despite being in motion. In the pool of the fountain some [one of]red[or]orange[or]blue[or]green[or]violet[at random] lights are illuminated. To the [Bold Type]north[roman type] is the mall foyer. To the [Bold Type]south[roman type] is the entrance to the food court. To the [Bold Type]east[roman type] and [Bold Type]west[roman type] are the main wings of the mall.";
	else if daytimer is day:
		say "     Sunlight streams in from the east and west wing skylights, giving enough light to see inside the atrium. It is a large rotunda, four massive columns rising towards the ceiling and seeming to support the large domed roof. It's hard to see into the semi-dark dome, though you are able to just make out statues of the twelve Olympian gods. Dominating the center of the atrium is a large fountain. You've learned in the past that it's a faithful recreation of the Morosini fountain found in a village in Crete. Dirty, standing water partially fills the fountain's pool, and with the HVAC system down, the light stench of the stagnant water fills the stuffy air around you. To the [Bold Type]north[roman type] is the mall foyer. To the [Bold Type]south[roman type] is the entrance to the food court. To the [Bold Type]east[roman type] and [Bold Type]west[roman type] are the main wings of the mall.";
	else:
		say "     The dark, spacious, atrium is barely lit by the few lanterns some rats have set up on the edges of the large fountain sitting in the middle of the rotunda. Their quiet chatter can be heard echoing off the domed roof as they idly sit by the silent fountain, though you don't want to seem rude by eavesdropping on their conversation. With the HVAC system down, the air is stuffy and you can smell the light stench of stagnant water coming from the fountain's pool. To the [Bold Type]north[roman type] is the mall foyer. To the [Bold Type]south[roman type] is the entrance to the food court. To the [Bold Type]east[roman type] and [Bold Type]west[roman type] are the main wings of the mall.";
...
To say mfcourt:
	If findwires is 2 and fixedgens > 2: [power on]
		...
		say "     With it currently dark outside, a few lanterns have been set up in just the center of the food court close to a small fountain. There are a few mallrats occupying a couple of the tables, [one of]talking among themselves[or]playing chess[or]playing poker[at random]. To the [Bold Type]east[roman type] there is a glow of a single lantern coming from the restroom facilities.";
...
To say mallwestwing:
	If findwires is 2 and fixedgens > 2: [power on]
		say "     Most of the lights are on throughout the west wing and you can hear the soft tones of muzak playing. The air is less stuffy and stale with the HVAC system now working. Various planters, spaced evenly apart and continuing the theme of ancient Greece line the middle of the walkway all the way to the end of the west wing. Vendor kiosks, selling everything from sunglasses to cell phone covers, occupy most of the spaces between the planters. To the [Bold Type]west[roman type] lies a former travel agency, its colorful pictures of tropical beaches and serene mountains now under a banner that reads 'Haven Community Center'.";
