		...
		if calcnumber is 1: [talk]
			...
			if fightoutcome < 20: [player won]
				...
				if Player is male:
					...
					NPCSexAftermath Joshiro receives "AssFuck" from Player;
...
to say JoshiroAlleyEating: [for cumsluts, females, etc.]
	...
	NPCSexAftermath Player receives "OralAss" from Joshiro;
...
to say ResolveEvent Jumping The Dobie:
	...
	if Player consents:
		...
		say "     [bold type]You can see where this is going from a mile away. A fight, and then someone's definitely gonna get fucked. Do you want to stay at the window and watch?[roman type][line break]";
		LineBreak;
		...
		CreatureSexAftermath "Joshiro" receives "AssFuck" from "Doberman Male";
	else:
		LineBreak;
...
to say ResolveEvent Sloppy Seconds:
	...
	say "     As he gets pulled through the hole in the fence, Darius calls out, 'Whoa! What's this? Dragging me out here to introduce your new girlfriend, dawg? You've really fallen for this gay shit, didn't you?' Tyke grunts and makes a throwing away gesture. 'Naw man, I'm not gay! It's just this dude! He's something else - try him and you'll see.' Darius ruffles his muzzle and shakes his head, 'You kiddin'? No way I'm gonna stick my dick in a faggot!' 'Yes way! Time for you to learn for yourself what I mean!' Tyke responds, his hand grabbing Darius by the neck and shoving him forward. 'What the fuck?' Darius shouts back, yet his buddy doesn't budge, simply cracking his knuckles and nodding towards the naked man. 'Get yo dick in there, man. You're not leaving before you do! Ya don't have to worry about having fag kids either - I gave him a pill earlier today.' This is delivered in a sarcastic tone, with an eyeroll and begruntled stare at Darius. 'Good for you too, because this is MY boy-bitch to breed!' He adds a rude snort of amusement and adds, 'Go on, you can just let loose and feel that tight hole around your dick! He feels amazing!' 'That's whacked man, I -' Darius starts to reply, but his words stop as Tyke lets out a threatening growl.";
	...
	CreatureSexAftermath "Joshiro" receives "AssFuck" from "Doberman Male";
	NPCSexAftermath Joshiro receives "AssFuck" from Darius;
...
to say JoshiroSex1: [let him blow you]
	...
	NPCSexAftermath Joshiro receives "OralCock" from Player;
...
When Play begins:
	...
	now MilkItem entry is "human martial artist milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
...
Body Weight of Joshiro is 7. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Joshiro is 9. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
[Body Adjective is generated out of the body weight and body definition and can be used in scenes - one word descriptive adjective depending on weight and definition groups: low weight group: skinny/slender/lithe; mid weight group: average/fit/muscled; high weight group: pudgy/husky/jacked]
Androginity of Joshiro is 2. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Joshiro is 5. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Joshiro is 3. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Joshiro is 5. [length in inches]
Breast Size of Joshiro is 0. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Joshiro is 2. [count of nipples]
Asshole Depth of Joshiro is 8. [inches deep for anal fucking]
Asshole Tightness of Joshiro is 2. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Joshiro is 1. [number of cocks]
Cock Girth of Joshiro is 3. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Joshiro is 12. [length in inches]
Ball Count of Joshiro is 2. [allowed numbers: 1 (uniball), 2 or 4]
Ball Size of Joshiro is 3. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
Cunt Count of Joshiro is 0. [number of cunts]
Cunt Depth of Joshiro is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
Cunt Tightness of Joshiro is 0. [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
Clit Size of Joshiro is 0. [size 1-5, very small/small/average/large/very large]
[Basic Interaction states as of game start]
PlayerMet of Joshiro is false.
PlayerRomanced of Joshiro is false.
PlayerFriended of Joshiro is false.
PlayerControlled of Joshiro is false.
PlayerFucked of Joshiro is false.
OralVirgin of Joshiro is false.
Virgin of Joshiro is true.
AnalVirgin of Joshiro is false.
PenileVirgin of Joshiro is false.
SexuallyExperienced of Joshiro is true.
