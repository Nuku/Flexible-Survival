...
to say SatyressFuck2:
	...
	CreatureSexAftermath "Satyress" receives "AssFuck" from "Player";
...
to say SatyressFuck3:
	...
	CreatureSexAftermath "Satyress" receives "OralCock" from "Player";
...
to say SatyressFuck4:
	if Player is female:
		...
		CreatureSexAftermath "Satyress" receives "OralPussy" from "Player";
	else:
...
"Satyress"	"[PrepCombat_Satyress]"

to say PrepCombat_Satyress:
...
When Play begins:
	...
	now face entry is "beautiful and mostly human-like, though with small goat horns sticking up from your forehead. The lusty look filling your eyes betrays the thoughts of sex and arousal that have become part of you"; [ Face description, format as "Your face is [Face of Player]." ]
	...
	now MilkItem entry is "satyress milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "satyress cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
"Satyress Infection"	"Infection"	""	Satyress Infection rule	1000	false

This is the Satyress Infection rule:
	if Player has a body of "Satyress":
		trigger ending "Satyress Infection"; [Here it states, that the ending has been played.]
