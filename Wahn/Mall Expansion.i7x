...
instead of going north from Mall Foodcourt while lastMallInteriorScene - turns > 0 and gshep is listed in companionList of Player and gsd_pet >= 60 and BullTerrierSiblingsVar is 0 and a random chance of 1 in 3 succeeds and Player is not CoA:
	...
	say "[line break]     [bold type]Do you indulge Korvin's impulses and let him stalk the bull terrier bitch?[roman type][line break]";
...
instead of going north from Smith Haven Mall Lot South while lastMallInteriorScene - turns > 0 and findwires is 2 and fixedgens > 2 and AmirRelationship is 0 and lastABEncounter - turns > 10 and a random chance of 1 in 3 succeeds:
	...
	say "[line break]     [bold type]Do you want to stick around close to them and see how this works out?[roman type][line break]";
