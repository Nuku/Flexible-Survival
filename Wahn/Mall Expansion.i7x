...
instead of going north from Smith Haven Mall Lot South while (findwires is 2 and fixedgens is 2 and AmirRelationship is 0 and (lastABEncounter - turns > 10) and a random chance of 1 in 3 succeeds):
	...
	if player consents:
		...
		say "     'That was great. I mean... just wow!' the bison bull gasps out, breathing heavily. 'Can't complain myself, big guy. I think I got a new favourite flavour for my milk,' Byron replies amicably and leans forward to give Amir's balls a last fondle before the bison reaches down and pulls his pants back into place, then zips up. 'Come on, let's get you a bite to eat. Gotta keep up your energy.' With that said, the mall rat takes his bison friend by the hand and leads him back out into the open food court, grinning at you as they pass and wiggling his eyebrows meaningfully. Clearly, he knew you were watching...";
