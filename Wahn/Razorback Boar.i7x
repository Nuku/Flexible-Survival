...
Instead of resolving a Canine Indecision:
	...
	if Player consents:
		...
		say "     And then, the canine teen looks right at you, a hopeful expression on his face. How do you want to influence him in this matter? (This might have far-reaching consequences for him and Garth. Having a companion to take care of might just mellow the tough boar out a bit.)";
		say "     ([link]Y[as]y[end link]) - He should go and join Garth. In his own way, the boar does seem to care for what happens to Andy, and the teen definitively can learn a lot.";
...
[
Event: 2 of Andy's old gang buddies approach him as he is alone on an errand in the forest (player observing unseen). They offer him a chance to get back in the gang if he just helps them rob "that old fart" as proof of loyalty. Initially a little thoughtful, Andy refuses definitively as they start up demeaning talk about Garth (raping /eating him), balling his fist. He punches one guy out, fights the other, then goes "I'll show you!" and fucks the second wolf.
