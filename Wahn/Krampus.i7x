...
to say KrampusBondage3:
	...
	if player is male:
		say "     The wand eventually pushes you past your limits. You moan and thrash in your rubber prison as your own cock spurts its load. You feel it spread under the rubber sheet, staining your lower body[if cock width of player > 8]. Unfortunately, since the mutations made you so productive, it goes on, and on, and on, until your entire body is soaked in your own sexual fluids[end if].";
	else:
...
to say KrampusPunish2: [flogging + bag bj or punishment fuck]
	...
	WaitLineBreak;
	if anallevel is 3 or cunts of player is 0:
		...
		say "     Slowly, agonizingly slowly, Krampus pushes his maleness against your [if cunts of player > 1]main [end if]cunt. You feel your entrance stretch [if cunt length of player < 12]painfully [end if]wide to accommodate the goat's thick cock. Groaning, you try to escape his hard shaft impaling you, but you have no space to maneuver. Krampus chuckles at your futile resistance. 'What's this, [if player is not defaultnamed][name of player][else]fuckpet[end if]? I have not even put all of the head inside yet.' On these words, he pushes further, and you feel his glans being pushing into your pussy[if player is male]. Your prostate is squished, making you start oozing pre all over the floor[end if]. 'That's better. But that is only one naughty thing. Let us go down the list, shall we?' Grunting, Krampus bear hugs your chest, then pulls out and rams his member in with more power.";
