...
Instead of resolving a Rooftop Rumble:
	if hp of Rane is 0:
		...
		if player consents:
			...
			otherwise if fightoutcome >= 10 and fightoutcome <= 19:  			[won]
				say "     You fight off the bloodthirsty leopardman and slam him to the ground, this time definitively too bruised and battered to get up anytime soon. He sputters a few breaths and then you hear him mumble, '...goddamned blue devil...', before he goes out like a light. Looking down upon the fallen opponent, you are left with the open questions of what on earth he meant, let alone what actually transpired here on this roof. In that instant however, you come to be aware of two things. First, the sense of being watched has not abated at all, in fact it is as strong as ever before. Second, you feel a definite presence on the roof, and it is not any of the bodies around you. Whirling around with grim determination to face down who- or whatever else might have shown up, you are greeted with a sight that suddenly makes the words of the fallen assailant ring true.";
	...
	otherwise if hp of Rane is 3 or hp of Rane is 4:
		...
		say "     [line break]";
		say "     Maybe getting involved in this is a mistake... it clearly is quite dangerous. Do you want to stay and look around anyways (Y), or get some distance between yourself and this grisly scene, avoiding the area in the future (N)?";
		if player consents:
			say "     [line break]";
			...
			otherwise if fightoutcome >= 10 and fightoutcome <= 19:  			[won] 
				...
				otherwise if fightoutcome >= 10 and fightoutcome <= 19:  			[won]
					...
					say "     Only the color of blue fills your vision. Standing directly next to you is the 'devil' himself, exactly as you remembered him, though up close and in your face, standing in a defensive posture facing the thugs. 'Hey there. Thought I'd join you for a bit,' he tells you with a sidelong grin, then he calls out louder 'After all, we can't leave our friends here the embarrassment of being taken out by yet another solo fighter. It'll look so much better for their rep if it takes a whole TWO people to beat a group of eight to a pulp.'";
					say "     [WaitLineBreak]";
...
to say MeetRane:
	...
	say "     'Well, that's that,' he says before adding 'Sorry that you got jumped. Usually they're only after me - maybe I hit em a bit too hard in the head last time and knocked a few screws loose.' The man gives a casual shrug as he looks over the unconscious gang-members, then turns back to you. 'I'm Rane, by the way, oni extraordinaire. As you can see, I know how to kick ass... and also how to take it, if you get my drift. And I can do an awesome massage too if I may say so myself. I'd love to give you a demonstration sometime soon - knead all the stress out of those muscles and show you my 'massage rod'. His gaze wanders a bit lower over your body as he says the last bit, then he looks back at your face with an insinuating smile and asks in a charming voice 'What brings such a sexy beast like yourself into this part of the city? You're not one of the low-lives from around here...'";
	say "     [WaitLineBreak]";
	say "     Introducing yourself, you explain your situation - having to survive in the city with all its dangers and also including the fact that Rane almost dropped a leopardman on your head a while ago. The oni grimaces guiltily at that, then apologizes - but not without adding the quip 'Guess I'll have to be more careful when I throw people off buildings in the future.' Though maybe he isn't actually joking. Given just the little bit of his track-record that you know, that could be a common occurrence for him.";
	say "     As you start asking him more about what his deal with the guys he keeps fighting is, Rane suddenly raises a finger to his lips and turns his head a bit, listening intently with his pointy ears. You don't hear anything, but he says 'Some of my earlier playmates are starting to come to again and there might be others on the way, so we'll have to cut this short. Come on, let's get out of here. Enough fighting for today.' With an inviting wave of his hand, Rane takes off, bounding over the asphalt with large steps.";
	say "     [line break]";
...
to say RaneTalk1:   [talk about him]
	...
	if randomnumber is:
		-- 1:	
			say "     Rane shrugs as you ask him about himself, saying 'Nothing much to tell. I'm just your regular, garden variety... dashingly handsome blue-skinned oni.' He gives you a charming smile to go with that. Then he steps up to you, close enough so you can feel the warmth of his skin, and runs a hand enticingly down your side. 'But really - why talk about the past if the present holds so many amazing distractions.' Giving your ass a playful squeeze, he saunters off, though not without giving you a meaningful wink over his shoulder.";
		-- 2:
			say "     Rane shrugs as you ask him about himself, saying 'Nothing much to tell. I'm an oni - a creature from Japanese mythology. One might translate that as 'ogre', 'troll' or 'demon' - though with my dashingly handsome looks, I guess I fall more into the 'sexy devil' category.' He chuckles at that and gives you a knowing wink. 'And before you ask - yes, oni are supposed to have big iron clubs with them everywhere they go, and no - I don't have one. It's a long story.'";
		-- 3:
			say "     Rane shrugs as you ask him about himself, saying 'Nothing much to tell. I'm just the scourge of the 12th street gang... and of a few others. It's fun to beat up those who deserve it - and those guys are a really bad lot. Pretty stupid too - one would think that they'd start running when they see me, but they just send more men, thinking they have a chance.'";

to say RaneTalk2:    [talk about the shrine/mirror]
	say "     Rane explains, 'You seemed such an interesting character that I thought about spending some time with you - but with the kinds of critters roaming the streets, I thought it best to be cautious.' Then he traces a round shape in the air with his hands and continues 'That mirror is a shintai, inhabited by a powerful kami. The spirit can allow you to see the real truth of things in it, which is what I asked of him.' With a friendly grin, the oni sets a hand on your shoulder, then says 'I'm glad you passed so we can enjoy each other's company - and[if hp of Rane < 7] maybe[end if] enjoy each other.' Finishing the sentence, he slides his hand over and down your chest teasingly, trailing off just before reaching your crotch.";

to say RaneTalk3:     [talk about sex]
	let randomnumber be a random number from 1 to 3;
	if randomnumber is:
		-- 1:		
			say "     Rane chuckles 'Ah - my favorite past-time' as you bring up the topic, stepping up close to you and teasingly brushing his hands over your body. 'People keep saying one shouldn't just have sex with anyone who catches your eye - well, fuck them.' His voice lowers to a joyful whisper for a moment as he adds, 'And believe me - I have. More than one. Prudes usually are the loudest when they orgasm.' Rane's eyes take on a faraway expression for a second as he revels in a memory, then he focuses back on talking to - and touching - you. 'Why should anyone deny themselves a pleasure that's a basic part of their existence? Nah - if I see something I like, I go for it.'";
			say "     With that said, he pulls you against his chest, then sets both his hands on your butt and gives it an appreciative squeeze before letting go again. 'Don't misunderstand me - I'm not one of those wild beasts that just forces himself on others. I only play with those who want me to... after all, the chase is half the fun. And in the end, not many can resist this body.' As Rane says that, he moves his hips a bit, making the big bulge in his loincloth brush against you. Then suddenly, he steps back from you and says, 'I'll be waiting for you,' with a salacious wink.";
		-- 2:
			say "     Rane chuckles 'Ah - my favorite past-time' as you bring up the topic, stepping up close to you and teasingly brushing his hands over your body. 'There's so much fun to be had with the right guy or gal - as long as they don't get all clingy afterwards. I mean... why restrict yourself to just one partner and get bored with each other before long?' With a charming grin and a light nudge of his elbow, he adds 'A man needs variety to keep things fresh, you understand? I'm just not the kissy and huggy type. When I wanna fuck, I want to fuck - and not always the same person.'";
			say "     With that said, he pulls you against his chest, then sets both his hands on your butt and gives it an appreciative squeeze before letting go again. 'Don't misunderstand me - I'm not one of those wild beasts that just forces himself on others, then mounts the next person on the street immediately afterwards. But... finding yourself in the arms of someone who just won't let go after you had sex - 'cuddling' - yuck, that gets tedious and annoying. If I'm in bed, I want to fuck or sleep - not have incredibly boring 'sex light'. But enough of that for now. How about we do the real thing instead?' As Rane says that, he moves his hips a bit, making the big bulge in his loincloth brush against you. Then suddenly, he steps back from you and says, 'I'll be waiting for you,' with a salacious wink.";			
		-- 3:
			say "     Rane chuckles 'Ah - my favorite past-time' as you bring up the topic, stepping up close to you and teasingly brushing his hands over your body. 'An oni has pretty intense needs, you know. You wouldn't believe how much your desires build up if you go without for too long.' His eyes wander down over you, shamelessly checking you out, and Rane openly rubs the bulge in his loincloth. 'I just don't want to get blue balls - well, blue-er balls - so I take any opportunity for sex I get.'";
			say "     With that said, he pulls you against his chest, then sets both his hands on your butt and gives it an appreciative squeeze before letting go again. 'Don't misunderstand me - I'm not one of those wild beasts that just forces himself on others, then mounts the next person on the street immediately afterwards. But... if there's someone ready and willing, why shouldn't I have fun with them? But enough of all this talk for now. How about we do the real thing instead?' As Rane says that, he moves his hips a bit, making the big bulge in his loincloth brush against you. Then suddenly, he steps back from you and says, 'I'll be waiting for you,' with a salacious wink.";				

to say RaneTalk4:     [talk about fighting]
	say "     Rane grins widely and says 'I like to fight. It's an amazing feeling to really get this body going, use what strength and speed I have.' Cracking his knuckles and wiggling fingers with sharp nails in the air before you, he continues 'Haven't found anyone yet who was a real challenge, though some guys do their best to try, attacking me in groups. The're wimps alone, but there's at least some fun in it when they team up. Thankfully everyone heals really quickly these days, otherwise I'd run out of enemies. That'd get boring fast...'";
...
to say RaneFirstFuck:
	...
	say "     [WaitLineBreak]";
	say "     Giving you an appreciative look as you pull on the last parts of your clothes and gear, Rane says 'You're an awesome fuck, best I've had in a while, and I like your tenacity in being able to survive out here on the streets without falling prey to anyone yet. I really wouldn't mind having some more fun with you, so how about it? Wanna shack up together somewhere for a while? Or we could just leave it at a one-night stand. Though perhaps we'll run into each other sometime...' His hand wanders down to his crotch, rubbing it through his loincloth as he no doubt imagines fucking you again.";	
	say "     [line break]";
	say "     What do you tell him? Invite him to the library with you (Y), or say your goodbyes (N)? ";
	if player consents:
		say "     [line break]";
