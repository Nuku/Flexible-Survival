...
When Play begins:
	Choose a blank row from Table of Random Critters;
	now NewTypeInfection entry is false;
	now Species Name entry is "Blue Oni";
	add "Blue Oni" to infections of DemonList;
	add "Blue Oni" to infections of MythologicalList;
	add "Blue Oni" to infections of OtherworldlyList;
...
Cunt Depth of Rane is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
to say RaneFirstFuck:
	...
	NPCSexAftermath Player receives "AssFuck" from Rane;
	WaitLineBreak;
...
to say RaneSex1: [player sucks him]
	...
	NPCSexAftermath Player receives "OralCock" from Rane;
...
to say RaneSex2: [he sucks the player]
	...
	NPCSexAftermath Rane receives "OralCock" from Player;
...
to say RaneSex3: [player pussy licked]
	...
	NPCSexAftermath Rane receives "OralPussy" from Player;
...
to say RaneSex4: [player pussy fucked]
	...
	NPCSexAftermath Player receives "PussyFuck" from Rane;
