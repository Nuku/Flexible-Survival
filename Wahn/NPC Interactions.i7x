...
instead of navigating Grey Abbey Library while (Xerxes is in Grey Abbey Library and Snow is in Grey Abbey Library and a random chance of 1 in 10 succeeds):
	say "[NavCheck Grey Abbey Library]";
	if NavCheckReturn is false, stop the action;
	move player to Grey Abbey Library;
	say "[XerxesSnowInteraction]";

instead of going up from Bunker while (Xerxes is in Grey Abbey Library and Snow is in Grey Abbey Library and a random chance of 1 in 10 succeeds):
	move player to Grey Abbey Library;
	say "[XerxesSnowInteraction]";
...
instead of navigating Grey Abbey Library while (Helen is in Grey Abbey Library and Snow is in Grey Abbey Library and a random chance of 1 in 10 succeeds):
	say "[NavCheck Grey Abbey Library]";
	if NavCheckReturn is false, stop the action;
	move player to Grey Abbey Library;
	say "[HelenSnowInteraction]";

instead of going up from Bunker while (Helen is in Grey Abbey Library and Snow is in Grey Abbey Library and a random chance of 1 in 10 succeeds):
	move player to Grey Abbey Library;
	say "[HelenSnowInteraction]";
...
instead of navigating Grey Abbey Library while (Amy is in Grey Abbey Library and HP of Amy > 1 and Snow is in Grey Abbey Library and a random chance of 1 in 10 succeeds):
	say "[NavCheck Grey Abbey Library]";
	if NavCheckReturn is false, stop the action;
	move player to Grey Abbey Library;
	say "[AmySnowInteraction]";

instead of going up from Bunker while (Amy is in Grey Abbey Library and HP of Amy > 1 and Snow is in Grey Abbey Library and a random chance of 1 in 10 succeeds):
	move player to Grey Abbey Library;
	say "[AmySnowInteraction]";
...
instead of navigating Grey Abbey Library while (Amy is in Grey Abbey Library and HP of Amy > 1 and Felinoid companion is tamed and a random chance of 1 in 10 succeeds):
	say "[NavCheck Grey Abbey Library]";
	if NavCheckReturn is false, stop the action;
	move player to Grey Abbey Library;
	say "[AmyFelinoidInteraction]";

instead of going up from Bunker while (Amy is in Grey Abbey Library and HP of Amy > 1 and Felinoid companion is tamed and a random chance of 1 in 10 succeeds):
	move player to Grey Abbey Library;
	say "[AmyFelinoidInteraction]";
