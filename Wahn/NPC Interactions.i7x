...
instead of navigating Grey Abbey Library while (Carl is in Grey Abbey 2F and HP of Carl > 9 and David is in Bunker and a random chance of 1 in 10 succeeds):
	say "[NavCheck Grey Abbey Library]";
	if NavCheckReturn is false, stop the action;
	move player to Grey Abbey Library;
	say "[CarlDavidInteraction]";

instead of going up from Bunker while (Carl is in Grey Abbey 2F and HP of Carl > 9 and David is in Bunker and a random chance of 1 in 10 succeeds):
	move player to Grey Abbey Library;
	say "[CarlDavidInteraction]";
