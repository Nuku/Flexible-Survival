...
"Robed Cultist"	"[PrepCombat_Robed Cultist]"

to say PrepCombat_Robed Cultist:
	say "";
...
When Play begins:
	...
	now MilkItem entry is "robed cultist milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
...
Table of CombatPrep (continued)
name(text)	PrepFunction(text)
"Deep One"	"[PrepCombat_Deep One]"

to say PrepCombat_Deep One:
	say "";
...
When Play begins:
	...
	now loot entry is ""; [ Loot monster drops, usually infective with the monster's _own_ strain (for example if there is a Cross-Infection from sex)]
	now lootchance entry is 0; [ Chance of loot dropping 0-100 ]
	now MilkItem entry is "deep one milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "deep one cum"; [ Item to be given to the player if they have this infection and jerk off. ]
	now TrophyFunction entry is "-"; [ Function to generate a list of optional loot items, of which the player can choose one after victory. ]
	now scale entry is 3; [ Number 1-5, approx size/height of infected PC body: 1=tiny, 3=avg, 5=huge ]
