...
to say Tiger Shark wins:
	if ts_warrior is true:
		...
		say "     The brawler is now onto you, stroking along your belly. You can't say that you were expecting this, but find yourself calming down a bit as he does nothing else but feel along you. He grins at you, as he feels your tension leaving your body. His hands trace down from your chest towards your crotch. ";
...
To say tsw_ride:
	if tsw_fsd is 0:
		...
		if cunts of player > 0:
			...
			say "your prostate gets battered by the shark-like dick. This heavenly fuck goes on long enough that you lose track of time, your world being reduced to your anus being distended over and over again by the slimy manhood. Eventually you hit the point of no return, making you cry out in pleasure as your cock pushes string after string onto the shark, tainting his chest and also face. He doesn't seem too bothered by that, more keen on finishing himself. ";
		else:
...
"Devil's Purse"	"A black casing resembling the egg capsule of a shark. It's empty but it still feels warms despite its slippery touch."	1	Devil's Purse
