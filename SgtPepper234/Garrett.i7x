Version 2 of Garrett by SgtPepper234 begins here.
[ Version 1.2 - More M/M specific sex scenes ]
[ Version 2 - Integration into updated Qytat a'th Lundrues narrative]
...
to say ResolveEvent Abandoned Milk:
	say "     Your search for edible items leads you into a playground and you see near a bench some men's clothing partially torn, as if the wearer had ripped out of them as they changed form. The back of the shirt is badly shredded, almost as if wings or similar had erupted out their back.";
	say "     On the bench you see an empty milk bottle lying on its side. You also see an intact milk bottle standing there - and it's full! Walking over to the bench, you take the bottle; it has a blue silver label with the text [']QaL Dairy[']. The milk is rather cold and smells delicious but there is a faint smell of something almost otherworldly. You wonder what became of the person who drank the other bottle, and hope they are happy however they look now!";
	ItemGain gryphon milk by 1;
...
to say garrettdesc:
	...
	if HP of Garrett is 0:
		say "     Before you is an unusual sight. While the blue gryphon creatures you've seen around have been hermaphroditic, this one is purely male. He's also better built than the others, with a stronger build that comes from constant exercise. In addition, he's wearing a white milkman's cap and there's a wire bottle carrier resting beside him.";
		...
		say "     Garrett is an all-male version of those hermaphrodite gryphons you've seen out in the city. Having the same blue coloration and hybrid anatomy, he lacks any of the female features. If anything, he's more manly with a stronger build from his work spreading gryphon milk around the city. His large chest is well-muscled and his shoulders and wings are strong from flying. He even has big, powerful legs from all his leaps for takeoff. And given he only wears a white milkman's cap as his uniform, all of this is on display. And speaking of things being on display, you're also given a clear view of his heavy furry balls and extra-thick sheath, showing that this hunk's more manly than the others of his kind in that department as well.";

Section 2 - Dialog

Instead of conversing the Garrett:
	project Figure of Garrett_icon;
	...
	else if HP of Garrett >= 2 and a random chance of 1 in 3 succeeds and garrettinfo1 is false:
		say "     'This place is called [']Qytat a'th Lundrues['], the city of the flying. It's been around for a long, long time, but we've only recently been marooned in your world and can't seem to leave. Not sure how that happened. We gryphons live here and it shifts us from place to place. We've been here before... well, not [']here['] here, but here,' he says, gesturing wide. Not understanding, you ask him to explain further in the hopes of discovering more about this wondrous place. 'It's hard to explain, but our flying city can travel between dimensions. We've been in this dimension before, but not to Earth.'";
		say "     'Anyhow, we came here, but there was a <sqwa-ragh>,' he says, making a strange call. 'A... shockwave kinda thing, but for reality... and we got stuck. We are trying to fix the city, but we've become a little distracted with local politics. Gotta rectify ancient wrongs and all that. The elders are pissed but they had it coming, I'm sure. But speaking of political wrangling, how about some sexual wrangling?' he adds, snuggling up close and running his paws over your body.";
		now garrettinfo1 is true;
		now lastfuck of Garrett is turns + 6;
		say "[sexwithGarrett]";
	else:
		say "     '[one of][if HP of Garrett is 1]You should give me a hand with my milking sometime[else]I hope you're up for giving me a hand with my milking again sometime soon[end if].'[or]We didn't used to live like this,' he says sadly while gesturing to the suspended homes in the city square. 'But recent upheavals have [']forced['] the city elders to take a hard line with dissident factions[if HP of Garrett > 1]. Anyway, up for a romp again?'[else].'[end if][or]You would be amazed to see the places this city has been. Worlds beyond imagining...'[or]I expect there are a lot of new single-sexed gryphons out having fun and finding mates because of me.' He grins deviously before continuing, 'They'll be back when we need them.'[or]I think the elders said something about a strange electrical storm that marooned us here. They tried to phase us out to another dimension before it hit us or something. I wonder how the repairs are going.'[or]It's tough work going around and spreading gryphon milk around the city, but it'll be worth it if it grows our ranks and helps us retake our homes.'[or]After all my hard work giving out bottles of our milk, I could use a bit of a break. [if HP of Garrett is 1]Care to help me enjoy my break even more[else if lastfuck of Garrett - turns < 6]Will you help me enjoy my break again once I'm loaded back up[else]I hope you're up to helping me enjoy my break again soon[end if]?' he asks with a smile, tip of his black cock peeking eagerly from its sheath.[or]I've seen quite a bit of this odd city of yours. If we ever get the city moving again, I hope we will return.'[or][if HP of Garrett is 1]Once I've collected enough of my personal [']milk['], I'll be able to provide concentrated bottles of it[else]I'm converting the male gryphon semen I'm collecting to provide concentrated bottles of my new [']milk['][end if] for distribution.'[or][if nongryph is true]You should try some of my milk. I think you'd make[else]You make for[end if] quite the sexy gryphon.'[at random]";
...
to say sexwithGarrett:
	...
	if HP of Garrett is 0:
		say "     You know these blue gryphons are always ready and willing for sex, but you should probably get to know him a little before making such an offer.";
	...
	else if player is puremale and HP of Garrett > 5:		[male players only]
		...
		while sextablerun is 0:
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if Player consents:
					...
					if title entry is:
						-- "Handjob":
							say "[if Player_puregryph is true][garrett_handjob_2][else][garrett_handjob_1][end if]";
						-- "Get fucked":
							say "[if Player_puregryph is true][garrett_analtop_2][else][garrett_analtop_1][end if]";
						-- "Fuck him":
							say "[if Player_puregryph is true][garrett_analbottom_2][else][garrett_analbottom_1][end if]";
						-- "Gryphon 3some":
		...
		if player is puremale and HP of Garrett > 1:		[male players only]
...
to say garrett_handjob_1:
	...
	if Player is male:
		...
		NPCSexAftermath Player receives "Stroking" from Garrett;
	else if Player is female:
		say "     A paw of his finds its way to your [cunt size desc of Player] pussy and strokes across its damp folds. His touch is strong, but gentle, pleasuring you with his taloned fingers. He slips [if Cunt Tightness of Player < 5]one[else if Cunt Tightness of Player < 12]two[else]three[end if] of them into your cunny and pumps away while his remaining digits play across your wet folds. He pumps into you with a steady motion and you fall into a rhythm together, stroking him in time to his fingering. His enthusiasm for playing with your pussy isn't that high, but he's still a horny gryphon and performs adequately. In time, you build towards orgasm and end up crying out as your vaginal walls flutter around his probing digit[if Cunt Tightness of Player >= 5]s[end if]. You're left panting and satisfied by the time he moves his hand away.";
		NPCSexAftermath Player receives "PussyDildoFuck" from Garrett;
	else:
		say "     A paw of his finds its way to your butt and gives it a firm squeeze. His touch is strong, but gentle, as he slips his taloned fingers between your cheeks and probes at your asshole. He breaks the kiss momentarily to lick [if scalevalue of Player > 2 or the player is twistcapped]a pair of fingers before pushing those lubed digits[else]a finger before pushing that lubed digit[end if] into your bottom. He pumps into your clenching butthole, making you moan into those kisses. He pumps into you with a steady motion and you fall into a rhythm together, stroking him in time to his fingering. The attention you're receiving is pleasant and exciting, providing arousing stimulation for your genderless body while you work at stroking the studly male off. Only when he's approaching orgasm does he slip out of your pleasantly tingly and warmed rump.";
	WaitLineBreak;
	...
	if HP of Garrett is 1:
		...
		if XP of garrett < 3:
			...
			say "     'Thanks again for your help with that. It's so much more fun to get a helping hand with that,' he says with a satisfied grin. 'I'm going to need to collect some more before I've got enough to run through the processor again. I hope you'll be willing to help me with that once I'm ready to go again. And if you're a pure gryphon stud by then, you can even help add to the mix.'";
		else:
			say "     'Thanks again for your help with that. It's so much more fun to get a helping hand with that,' he says with a satisfied grin. That should be enough to run it through the processor and get some more of my male gryphon milk ready for market. As thanks for helping out, you can have another bottle,' he says, pushing one into your hands with a grin. 'Let's see if we can't get you to become a sexy gryphon stud so you can help add to the product in a more personal manner.'";
			ItemGain gryphon cum by 1;
			now XP of garrett is 0;
	NPCSexAftermath Garrett receives "Stroking" from Player;
	if HP of Garrett is 1:
		now HP of Garrett is 2;
	else if HP of Garrett is 2 and a random chance of 1 in 2 succeeds:
		now HP of Garrett is 3;

to say garrett_handjob_2:
	say "     'Since you're fully a gryphon stud, why don't we get you in on this?' he says, taking your cock in hand. 'The more, the merrier.' His taloned fingers brush over your manhood, making it throb and stiffen. He smiles and nuzzles you, letting his own erection brush against your fur. You take hold of his black cock and start returning the favor, drawing a pleased rumble from him.";
	...
	WaitLineBreak;
	increase XP of Garrett by 1;
	if Ball Size of Player > 4 or a random chance of 1 in 2 succeeds, increase XP of Garrett by 1;
	if XP of Garrett < 3:
		say "     'Mmmm... good stuff,' he purrs while licking a big gob of your cum from his hand. 'It's definitely more fun and faster having help with the production. I'm going to need to collect some more before I've got enough to run through the processor again. I hope you'll be willing to help me with that once I'm ready to go again.'";
	else:
		say "     'Mmmm... good stuff,' he purrs while licking a big gob of your cum from his hand. 'It's definitely more fun and faster having help with the production. That should be enough to run it through the processor and get some more male gryphon milk ready for market. As thanks for helping out, you can have another bottle,' he says, pushing one into your hands with a grin. 'With you helping now as a gryphon stud, I can make so much more of this stuff.'";
		ItemGain gryphon cum by 1;
		now XP of garrett is 0;
	if HP of Garrett is 2, now HP of Garrett is 3;

to say garrett_analtop_1:
	say "     Garrett strokes his own cock as he gives your ass a playful swat. 'Come on. I'm in the mood to show you just how good having some of my special gryphon milk in you can be,' he says. He nudges you to lean over his wooden chair and grinds his stiff manhood against your rear. Feeling dribbles of his pre wet your ass, you can tell just how he plans on giving you this sample.";
...
to say garrett_analtop_2:
	...
	WaitLineBreak;
	say "     Bending over your leaning back, he [if Breast Size of Player is 0]runs his free hand over your manly chest[else]grips your hip[end if] as he starts thrusting in and out of your back door. The horny milkman nips and nuzzles at your shoulders and neck as he pounds away at you with increasing zeal. All the while, his hand keeps working at your cock and balls, coaxing it to drool and dribble. He spreads your precum across your pulsing shaft, making his stroking grip smoother and slicker, increasing your pleasure.";
	say "     'Mmm... yeah... feels good, doesn't it? Just think, soon we'll have plenty more sexy gryphon studs around to do this with. I can hardly wait,' he rumbles in your ear. He fucks you harder and faster as he talks, building himself up to his release. The pounding at your prostate is soon followed by the wet pop of his knot into you. Hot splashes of the gryphon's copious cum shoot into your ass, finally pushing you over the edge into orgasm yourself. Crying out lustfully, you start unloading your balls in [if Ball Size of Player >= 6]massive[else if Ball Size of Player >= 5]large[else]sticky[end if] spurts while Garrett aims your cock so much of your semen lands in the waiting container. By the time you're done and drained, your lower bowels are warm and wet with the productive gryphon's load sloshing around inside you. He remains inside you for a while, nuzzling at you as he waits for his knot to eventually go down before pulling out. By the time it does, only a little of his seed leaks out, your body keeping the rest so it might be absorbed.";
	NPCSexAftermath Player receives "AssFuck" from Garrett;
	WaitLineBreak;
	if Ball Size of Player > 4 or a random chance of 3 in 4 succeeds, increase XP of Garrett by 1;
	if XP of Garrett < 3:
		say "     'I must say, that's a fine ass you've got there,' he says, caressing your warmth-filled bottom. 'It's nice to have such a sexy and willing helper. That won't quite be enough to run through the processor, but I don't mind giving you some of the raw stuff to help you be a bigger stud. I hope you'll be willing to help me collect even more once I'm ready to go again.'";
	else:
		say "     'I must say, that's a fine ass you've got there,' he says, caressing your warmth-filled bottom. 'It's nice to have such a sexy and willing helper. That should be enough to run it through the processor and get some more male gryphon milk ready for market. As thanks for helping out, you can have another bottle of the processed,' he says, pushing one into your hands with a grin. 'Though you certainly seemed to enjoy your recent dose of the raw materials,' he adds with a caress to your warmth-filled bottom.";
		ItemGain gryphon cum by 1;
		now XP of garrett is 0;
...
to say garrett_analbottom_1:
	...
	say "     When your climax comes, he pushes back into your thrusts, moaning for you to give him your hot seed. And give it to him you do, sinking fully into him and pumping your [Cum Load Size of Player] load into his clenching bowels. The feel of your hot cream and throbbing manhood inside him soon becomes too much for him to hold back any longer. His impressive shaft pulses within your mutual grip, shooting numerous globs of gryphon spunk into the jug resting on the chair's seat. By the time his climax ends, it's over half full and the chair is streaked with overspray.";
	NPCSexAftermath Garrett receives "AssFuck" from Player;
	WaitLineBreak;
	increase XP of Garrett by 1;
	if XP of Garrett < 3:
		say "     Turning his head back, he nuzzles and kisses you before easing himself off your spent shaft. After he does, he clenches his leaky hole to keep your sticky spunk inside while stretching his impressive body and wings out. The studly gryphon runs a paw [if Breast Size of Player is 0]along your side[else]down your chest[end if]. 'That was real fun. And it'll be even better once we've got you as a sexy man-gryphon. The herms are great, but it's just not the same. Taste it and you'll agree,' he says, holding out his cock as it drools out the last dregs of his load. Licking your lips at the sight of it, you get on your knees and slurp up those gooey droplets. You moan softly at the taste of his virile spunk and suck every last drop, part of you eager for the tainted nature of the seed you're accepting into yourself.";
	else:
		say "     Turning his head back, he nuzzles and kisses you before easing himself off your spent shaft. After he does, he clenches his leaky hole to keep your sticky spunk inside while stretching his impressive body and wings out. The studly gryphon runs a paw [if Breast Size of Player is 0]along your side[else]down your chest[end if]. 'That was real fun. And it'll be even better once we've got you as a sexy man-gryphon. The herms are great, but it's just not the same. This'll be enough to top up the processor for another batch, so you should take another bottle. It'll help make you into a gryphon stud faster so you can help me make even more.'";
		ItemGain gryphon cum by 1;
		now XP of garrett is 0;
...
gryphon cum is a grab object. gryphon cum is cum.
the scent of gryphon cum is "The bottle's contents have the tantalizingly arousing scent of male gryphon semen.".
...
This is the Garrett's Epilogue rule:
	...
	if HP of Garrett >= 7 and humanity of Player >= 10:
		...
		say "     Some time after you settle into your new life, you notice a new product on the market - he-gryphon milk. The musky, milky fluid (now microwaved to be non-infectious) is marketed as an exotic drink that temporarily stimulates and enhances male-on-male pleasure in the consumer. It pleases you to see that Garrett's product has become somewhat of a success, especially among the gay community and with guys looking for that little boost to help them try how things are on the fabulous side of the fence[if Player is puremale and Player is maleinterested]. You pick some up on the rare occasion you want to inject a little extra oomph into some hot gay fun you're planning[end if].";
