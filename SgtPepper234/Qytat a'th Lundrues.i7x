				...
				if Player consents:
					...
					while calcnumber < 1 or calcnumber > 3:
						...
						if calcnumber < 1 or calcnumber > 3:
							say "Invalid choice. Type [link]1[end link] to accept the transformation, [link]2[end link] to leave for now or [link]3[end link] to attack the guard.";
					LineBreak;
					if calcnumber is 1:
						GryphonGuardMilkSolution;
					else if calcnumber is 2:
						say "     You're not ready to take such a drastic measure, neither you're willing to fight to find out whatever she's hiding. Respectfully, you decline her offer, but urge her not to worry about you anymore, as you'll be leaving without any further issue. She keeps watching you from a distance as you retreat. There's always the possibility to acquire this full transformation yourself out in the wilds and return, or search for the Gryphon Guard and force your way in by attacking her.";
...
to GryphonGuardMilkSolution:
	say "     Looking at the options you have, you decide to accept her terms by letting her fully turn you into a Blue Gryphon. Noting your interest, she asks you to follow her over to a hidden stash of transformative items. 'Have a few of these and it should do the job. If not, I have more,' she says, as you chug down everything she hands you. It doesn't take long until you start feeling the effects.";
...
to GryphonGuardFight:
	...
	if fightoutcome < 20: [won]
		...
		say "     With all the hostility presented by the gryphon, you decide to run away from conflict, successfully evading the guard. If you ever encounter the herm again, you doubt a diplomatic solution will be possible.";
		now resolution of Gryphon Guard is 2; [locked out of any skip]
...
Bright Alley is a room. "[brightflight]". It is fasttravel.
...
to say brightflight:
	if staircaselocation is 3:
		say "     An alley with a silvery blue glow coming from the deeper reaches. You can faintly see that the back of the alley opens to a small hill. There appears to be a ghostly staircase at the top of the hill past the alley. You would not have spotted it if you didn't know to look. Maybe you could go check it out?";
		AddNavPoint Bright Alley;
	else:
		say "     An alley with a silvery blue glow coming from the deeper reaches. You can faintly see that the back of the alley opens to a small hill. There is nothing else interesting about it at the moment.";
...
an everyturn rule:
	if findablestairs is 1:
		let oldlocation be staircaselocation;
		now staircaselocation is a random number between 1 and 3;
		if shadowy < 4 or (staircaselocation is not oldlocation and ((staircaselocation is 1 and Player is in Red Apartment Rooftop) or (staircaselocation is 2 and Player is in Overgrown Rooftop) or (staircaselocation is 3 and Player is in Bright Alley) or Player is in Staircase Entry)):
...
check going up from Red Apartment Building:
	if staircaselocation is 1:
		say "     You head up the ghostly stairs, finding them more solid than they initially appeared.";
	else:
		say "     You [if findablestairs is 1]scout up on the roof, but the access point the gryphon told you about isn't there[else]check the rooftop quickly, but find nothing of interest at the moment and return to ground level[end if]." instead;

check going up from Overgrown Rooftop:
	if staircaselocation is 2:
		say "     You head up the ghostly stairs, finding them more solid than they initially appeared.";
	else:
		say "     [if findablestairs is 1]You scout for the access point the gryphon told you about, but apparently it isn't there (right now?).[else]Hm, you can't go up - you're on the roof already.[end if]" instead;

check going east from Bright Alley:
	if staircaselocation is 3:
		say "     You head up the ghostly stairs, finding them more solid than they initially appeared.";
	else:
		say "     You check [if findablestairs is 1]the far end of the alley and the hilltop, but the access point the gryphon told you about isn't there right now[else]down the east end of the alley and the small hill, but find nothing of interest at the moment and return to the street[end if]." instead;
...
Staircase Entry is a room. Description of Staircase Entry is "     Now that you stand upon the staircase, you can see it much more clearly and it becomes solid to your eyes. The staircase stands before you, the legendary path to Qytat a'th Lundrues, the city of the flying. It is a blue silver of some higher element, and the stairs are floating, sliding a little with the slight breeze, but maintaining their orderly position. The stairs glow, and the warmth radiating from them makes you comforted and happy. You can feel a faint, unseen wall around them which glows a translucent blue as the steps spiral up into the sky. You have a feeling that this strange material is completely invisible from the outside.[line break]".
Qytat Stairs is above Staircase Entry.
Scent of Staircase Entry is "     There is a strange scent here that you can only describe as the scent of ozone after lightning strikes.".
...
Qytat Stairs is a room. Description of Qytat Stairs is "     The glowing steps extend above and behind you, spiraling upwards. The faint blue material forming the concealing walls provides something to rest your hand against as you traverse the long staircase to the heavens. Looking through it, everything has a faint, bluish glow that makes everything below seem misty and unfocused, as if it is not quite real.[line break]".
Qytat Plaza is above Qytat Stairs.
Scent of Stairs is "     There is a strange scent here that you can only describe as the scent of ozone after lightning strikes.".
...
Plaza Fountain is a room. Description of Plaza Fountain is "     An ornate fountain bedecks the middle of the Plaza with a beautifully carved statue of three gryphons set in the middle of the basin. Upon closer inspection, you see that the three Gryphons are representatives of each sex - hermaphrodites, males and females. The herm has a smug look on her face, which is angled high as if turning her beak up at the male and female, who appear almost cowed beneath her. Set all around the square appear to be informal dwellings, although the bulk of them seem to be off to the [Bold Type]east[roman type] in what looks like a small amphitheater. Above you, in one of the informal dwellings you can hear someone moaning. A ladder leading [Bold Type]up[roman type] to it means you could climb in. To the [Bold Type]northeast[roman type] you can see a few of the strange buildings, although one in particular seems to have more traffic than the others around it. [Bold Type]North[roman type] of the fountain stands a building shaped almost like a narrow inverted pyramid, its odd angled walls covered with ornate carvings you cannot see from here. [Bold Type]West[roman type] of you is a short but wide building. It appears only two floors high when compared to the five-story average of the buildings around it. [Bold Type]Northwest[roman type] of you is a road that heads off into another part of the city.[line break]".
...
Informal Settlement is a room. Description of Informal Settlement is "     A broad oval amphitheater is spread out before you. The pillars are more numerous here, and were likely intended as seating for gryphons in place of the more traditional raised steps. Large oval structures that look like they were woven from vines, rope, wire and other assorted debris are strung up between the pillars set all about the amphitheater. Round openings angled any which way allow entry and exit for their flying inhabitants, through which you see gryphons flying in or out. Others lounge on the ground nearby with tin cups, shaking them at passersby in a pitiable attempt at begging. Upon closer inspection, you can see that milling all about the Plaza are what appear to be only male and female gryphons, with nary a herm in sight. Set in the center of the amphitheater is a large tent around which the other inhabitants seem to have built their ramshackle dwellings. It draws your eye as the focal point of the camp, and you could head [Bold Type]down[roman type] to it if you wished. To the [Bold Type]north[roman type] you see more clearly that a number of the inhabitants of this informal settlement are heading to and from the busiest of the buildings. To the [Bold Type]northwest[roman type] you can see the large building shaped like a narrow inverted pyramid.[line break]".
...
Qytat Tent is a room. Description of Tent is "     This is not so much a tent as it is a refashioned gazebo, built as a temporary dwelling on the main stage of the amphitheater. The canvas walls are lined with drawings and city plans. A large square table occupies the center of the room around which a group of male and female gryphons stand talking amongst themselves. The large gazebo also houses a few makeshift beds as well as various other accumulated household paraphernalia. [if PlayerMet of Quintus is false]A large male gryphon looks up from the documents on the table as you enter, eyeing you suspiciously[else]Quintus looks up from the documents on the table as you enter and nods in brief greeting before returning to his documents[end if].[line break]".
...
Soup Kitchen is a room. Description of Soup Kitchen is "     Although there a number of the avian buildings in this area of the Plaza, one building in particular is seeing [if Daytimer is Day]far [end if]more traffic than the rest. Off to the [Bold Type]west[roman type] you can see the large inverted pyramid-shaped building. [Bold Type]South[roman type] will take you to the informal settlement, and heading to the [Bold Type]southwest[roman type] will return you to the fountain at the center of the Plaza. Heading in through one of the ground floor openings to take a look, you deduce that it must be some manner of [if Daytimer is Day]soup kitchen[else]shelter at night[end if]. Pillars extend up to variable heights in here, although they are not quite as ornate as the ones in the Plaza. These pillars are thinner and clearly made from wood, although they are painted the same otherworldly blue as everything else in this rather bright realm. Set atop them, and in some cases also along the lengths, are platforms[if Daytimer is Day]. There are a number of male and female gryphons sitting upon the platforms, eating from bowls before flying back out of the building, probably to return to the informal settlement. There is a kitchenette on the ground floor level, where a beautiful-looking gryphon is cooking and serving up soup from a large cauldron[else] where a number of male and female gryphons are sleeping. There is a kitchenette area on the ground floor level, where a large cauldron sits empty, likely to be used during the day when this building serves as a soup kitchen[end if].[line break]".
...
Scent of Soup Kitchen is "     The room [if Karisha is present]smells strongly of cooking vegetables. It smells quite appetizing actually[else]doesn't smell of anything[end if].".
...
to say QytatChurch_ObserveMenu:
	...
	say "[line break]     [bold type]What do you want to observe?[roman type][line break]";
...
to say QytatChurch_Observe_Dekkan:
	say "     The old [if time is early morning]gryphon priest is hunched over his pulpit, preaching to the surrounding crowds of gryphons. His sermon seems focused on what sounds like a growing conflict between two groups of gryphons in the flying city. From what you gather there is a class divide being imposed by the hermaphrodite gryphons between them and the male and female gryphons. While you cannot deduce what the minutia of the conflict might be from his sermon, you get the impression that he is advocating for peaceful protest and collaboration with the hermaphodites. He does not feel that violence is the answer to this conflict. Looking at the reactions around the church, you can see that the crowd appears to be divided on whether or not they agree with him[else]priest flies about the church attending to various tasks. He cleans, arranges his scripture or sits at the pulpit researching for his next sermon[end if].";

to say QytatChurch_Observe_General:
	say "     The church is currently [if time is early morning]crowded by a multitude of gryphons, who are listening intently to the old priest's sermon. No one is paying you much attention[else]empty, occupied only by the old priest attending to his various duties. You see a sign near the entrance stating, 'Services daily at dawn'[end if].";

Table of GameRoomIDs (continued)
Object	Name
Market Road	"Market Road"

Market Road is a room. Description of Market Road is "     The spiral pattern continues along between more of the strange open-air buildings in a northwesterly direction, up towards a massive golden archway. Gryphons pass between the pillars and head off towards what, from a distance, appears to be a collection of stalls and shops. Standing between the archway are two armored gryphon guards eyeing you closely. This must be the way to the gryphon marketplace.[line break]".
...
check going northwest from Market Road:
	[if PlayerFriended of Karisha is true and PlayerFriended of Dekkan is true: [both friends]
		...
		if Daytimer is day: [day]
			say "     The guards stop you and mention that Karisha isn't in the upper city; you should go meet her in the Soup Kitchen." instead;
		else: [night]
	...
	say "     The gryphon guards extend their poleaxes, barring your entry. 'Halt, friend. We cannot permit you entry into the city proper unless a respected member of the community can vouch for you.' It looks like you cannot go this way yet." instead;
...
Qytat Tavern is a room. Description of Qytat Tavern is "     Before you sits the squattest building on the square. At only two stories high, it's dwarfed by the buildings alongside it. Going inside you gather that this must be the local watering hole, and deduce that the height limitation on the building is for the safety of the inebriated patrons. You can't imagine it would be too pleasant passing out at a height of four or five stories. Most of the tables here are at ground level, and you could try get a drink if you wanted.[line break]".
