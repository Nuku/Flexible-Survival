...
Instead of resolving a Tidepool Treasure:
	...
	if player consents:
		...
		LineBreak;
		say "     [bold type]You could keep trying to take the bottle, or you could let go and bolt. You also get a twinge of destructive curiosity, you could just let these odd shellfish spring their trap and not fight it.[roman type][line break]";
		say "     [link](1)[as]1[end link] - Grab it and run like hell!";
		say "     [link](2)[as]2[end link] - Screw this, Get outta['] there!";
		...
		if calcnumber is 1:
			...
			if diceroll > 15:
				...
				say "     You pull the bottle out, freeing your wrist at the same time and getting ready to run for it. As you head for dry land you mistime your steps, and one of your legs is dragged out from under you. Stumbling you find your hands and knees planted in the silt, the creatures coil their pinkish tentacles around your limbs. They tear up your clothing and discard the scraps, leaving you butt naked on all fours in the center of the pool. [run paragraph on][tidepoolfail]";
		else if calcnumber is 2:
			LineBreak;
			say "     You leave the bottle behind, taking every precious second you gain by doing so to flee without much trouble";
		else:
			LineBreak;
			say "     You keep your hand on the bottle, waiting as the tentacles slither up under your pants and further up your outstretched arm. Seams split and scraps are discarded, with the slimy limbs dragging you down into the water on all fours. [run paragraph on][tidepoolfail]";
	else:
		LineBreak;
...
to say tidepoolfail:
	if player is male:
		say "One of the tentacles slips between your butt cheeks, having traveled down over your back. It slides back and forth, slicking your backside up with more of that slick, clear gunk. As that stuff touches your tail-hole, you start to relax back there. Each pass it makes through your crack is ever more direct at trying to penetrate you on the way by, prodding at your ass a bit more insistently each time. Eventually, the strange anemone succeeds, and you let out a pained gasp as it rapidly slides several inches of smooth, well-lubricated length into you. Evidently the creatures were ready for that, lashing up from silt-stirred waters and into your open mouth.";
		say "     You're seeing color spots as the venom gets into direct contact with mucous membranes inside you, but you don't feel sick or pained. If anything, you feel a bit tipsy and struggle to keep yourself upright in the pool. The initial shock passes, and you become quite aware of the creature sliding slowly deeper into your bowels. You aren't in any state to count inches, and as it slides back out, pressing down against your prostate, aren't feeling any real reason to care. The tentacle gently fucking your throat tastes musty, salted by the sea as much as by its own nature.";
		WaitLineBreak;
		say "     The creatures release your head long enough for you to notice another odd sea-creature emerging from the pool and latching onto your cock. It slides itself down onto your member, tiny suckers grabbing your crotch around the base and sticking the hot, convulsing mollusc firmly in place. The inside of it squirms and slides over it, and it feels like tiny tendrils are licking at the head of it. It's all too much at this point, and you cum into the small latched-on sea creature, clenching down around the triple-threat of tentacles inside you. The limb in your mouth jerks back, shooting a final load over your back and sliding back down into the water. Finally, the creatures cum into your ass and pull free while the ones grabbing your body slip away, leaving you in the filthy pool with a hungry sea creature stuck to you. ";
	else:
		say "     One of the tentacles slips between your butt cheeks, having slithered across your belly. It slides back and forth, sliding between your nether lips and spreading that special oil into you. Each pass it makes over your snatch is ever more direct at trying to penetrate you on the way by, spreading you open a bit more insistently each time. Eventually, the strange anemone succeeds, and you let out a surprised gasp as it rapidly slides several inches of smooth, well-lubricated length into you. Evidently the creatures were ready for that, lashing up from silt-stirred waters and into your open mouth. You're seeing color spots as the venom gets into direct contact with mucous membranes inside you, but you don't feel sick or pained. If anything, you feel a bit tipsy and struggle to keep yourself upright in the pool. The initial shock passes, and you become quite aware of the creature sliding slowly deeper into your vagina. You aren't in any state to count inches, and as it slides back out, pressing down against your most sensitive spots, aren't feeling any real reason to care. The tentacle gently fucking your throat tastes musty, salted by the sea as much as by its own nature. ";
		WaitLineBreak;
		say "As the creature pistons into your mouth and slit, you can feel yourself getting ever wetter, body fully surrendered to the venomous shellfish. That said, you aren't so drugged up that you don't notice a second tentacle start pressing into your tail-hole. You sure as hell notice when the one in your mouth seems to cum, suddenly pulsating and shooting into the back of your throat to deposit a thick, musky load of seed only to pull out and be replaced by another. The ones in your cunt and ass both cum as well. Both pull back and a fresh one plunges into your tail-hole, while a pair of them start attacking your quivering snatch. While not individually thick, the sensation of so many all wriggling in you is too much, bringing you to an intense orgasm around the creature's unceasing assault.";
		say "     [if cocks of player > 0]The creatures release your head long enough to notice another odd sea-creature emerging from the pool and latching onto your cock. It slides itself down onto your member, tiny suckers grabbing your crotch around the base and sticking the hot, convulsing mollusc firmly in place. The inside of it squirms and slides over it, and it feels like tiny tendrils are licking at the head of it[else]The creatures release your head long enough to see a small creature slither up your leg, but by the time you've seen it you're being fed another eager tentacle. It slides up onto your clit, suckers holding it in place as minuscule tendrils start slithering over it[end if]. Moaning and shaking, you cum again and your limbs give out, dropping over onto your side and remaining trapped in this slimy assault. The creatures never slow their pace, even as they work you into several more blissful, body-wracking climaxes. Eventually, the one in your mouth jerks back, shooting a final load over your body and sliding back down into the water.. Finally, the creatures cum into your ass and pull free while the ones grabbing your body slip away, leaving you in the filthy pool with a hungry sea creature stuck to you.";
	say "The action stirred up so much silt and goop in the pool that you'd never mistake it for the serene, glassy spot it once was. Dragging yourself onto drier sand, you start to work at removing the shellfish latched to you. You manage to get it off, but only after [if cocks of player > 0]it teases your uncomfortably sensitive cock longer than you'd have liked[else]forcing you to cum into your palm as you try to pull it off your clit[end if]. Exhausted but wary, you decide to put some distance between yourself and the pool before sleeping this one off.";
