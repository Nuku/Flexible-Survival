...
a postimport rule: [bugfixing rules for players that import savegames]
	now OralVirgin of Brian is false;
	now PenileVirgin of Brian is false;
	now SexuallyExperienced of Brian is true;
...
OralVirgin of Brian is false.
Virgin of Brian is true.
AnalVirgin of Brian is true.
PenileVirgin of Brian is false.
SexuallyExperienced of Brian is true.
MainInfection of Brian is "Rhino".
...
after going to Border Wall while BrianRelationship < 2:
	if BrianRelationship is 0:
...
to say BrianNPCDesc:
	...
	if WallStanding is 0:
		say "[line break]     You see Brian leaning against the damaged barrier wall, the hole next to him large enough to fit just about any living thing through it.";

Section 2 - Talk

Instead of conversing the Brian:
	project Figure of Brian_icon;
...
to say attemptsexwithbrian:
	...
	if Player is neuter:
	...
	else if BrianRelationship < 2: [Met but not talked to]
	...
	else if XP of Brian is 0: [He has been talked to at the very least]
		if Player is female and Breast Size of Player > 2:
			...
			if Player is male:
				say "[line break]     [bold type]What do you want to do with the rhino now?[roman type][line break]";
			...
			infect "Rhino";
	else: [He's been talked to and fucked at least once]
...
to say briansexmenu:
	say "[line break]     What do you want to do with Brian?";
...
to say sexwithBrian01:		[oral on Brian]
	if BrianOral is 1 or Player is female or Player is not male or Breast Size of Player > 2:
	...
	else: [Initial oral on Brian that opens gay storyline]
		...
		now BrianOral is 1;
	NPCSexAftermath Player receives "OralCock" from Brian;
...
to say sexwithBrian03:		[vaginal on player]
	...
	WaitLineBreak;
	say "     Your rhino stud pants and grunts as his excitement builds and builds. You can feel the heavy slap of his overfull balls and the throb of his triple-sized cock inside you as his climax approaches. And like before, it is a powerful one when it arrives, one thick and potent blast after another until your womb is stuffed and his excess semen overflows around his softening shaft. Somewhere during this heavy breeding, your own orgasm is reached[if Player is male]; you cry out in orgasmic bliss as your cunt milks his manhood for its virile seed and you empty your load onto the grass [else]and you cry out in orgasmic bliss as your cunt milks his manhood for its virile seed[end if]. A spunky mess drools from your well-stuffed cunny once that gray cork is removed, though you're still left feeling deliciously warm and gooey inside from the sheer amount of it he's deposited in you.";
	NPCSexAftermath Player receives "PussyFuck" from Brian;
...
to say sexwithBrian04:		[anal on player]
	...
	WaitLineBreak;
	say "     Your rhino stud pants and grunts as his excitement builds and builds. You can feel the heavy slap of his overfull balls and the throb of his triple-sized cock inside you as his climax approaches. And like before, it is a powerful one when it arrives, one thick and potent blast after another until your belly is stuffed and his excess semen overflows around his softening shaft. Somewhere during this heavy seeding, your own orgasm is reached and you dump your sticky load onto the grass as Brian pumps it out of you. When it's all over, he gives you a little while to recover before pulling out. A spunky mess drools from your well-fucked ass once that gray cork is removed, though you're still left feeling deliciously warm and gooey inside from the sheer amount of it he's deposited in you.";
	NPCSexAftermath Player receives "AssFuck" from Brian;

to say sexwithBrian05_prelim:		[anal on Brian preliminary - not been fucked before]
	say "     [if XP of Brian is 0]When you suggest the rhino take a turn as bottom, he edges back a step. 'Hey now. I don't know about that. I mean, aside from that other rhino, there ain't been nobody in there...' he starts to protest. As you're pondering a way to convince him, he snaps his fingers. 'We'll wrassle for it. That seems fair,' he says with a big smile on his face. Looking at his bulging muscles, you have trouble seeing how that's quite fair. You don't even get a chance to refuse before he's coming at you[else]'Alright,' he says confidently. 'We'll wrassle for it again.' And with that, the rhino adopts a stance to charge[end if].";
	...
	if Playernum > briannum:
		say "[line break]     [special-style-1][playernum][roman type] vs [special-style-2][briannum][roman type]: It is a tough match against your burly opponent, but you eventually manage to get him to the ground beneath you. Pinning him down, he's forced to concede to you. 'Nice going,' he pants. 'I guess that's that, then.' Being a good sport (and quite aroused after the exciting tussle), he seems quite ready to let you claim your victory prize. Quite turned on yourself, you're ready and raring to get to it as well.";
		WaitLineBreak;
		say "[sexwithBrian05]";
	else:
		say "[line break]     [special-style-1][playernum][roman type] vs [special-style-2][briannum][roman type]: Try as you might, you end up pinned beneath the muscly rhino as he uses his great strength against you. With you in such a position and the burly male hard after the exciting tussle, he seems quite ready now to claim his victory prize. And you're too turned on by this point to be that upset about how things turned out. You raise your ass, offering your [if Player is female]juicy pussy[else]crinkled hole[end if] to him.";
		WaitLineBreak;
		if Player is female:
			say "[sexwithBrian03]";
		else:
...
to say sexwithBrian05:		[anal on Brian]
	if XP of Brian < 2 or ( a random chance of 1 in 2 succeeds and XP of Brian > 2 ):
		...
		say "     The big rhino shifts over onto all fours, again accepting his loss with good graces. His thin tail flicks up, providing you with a fine view of his muscular rear and the pinkish-gray ring waiting there for you. Rather than hop right to it, you [if anallevel is 3]grab that firm ass of his and lean in, giving his pucker several long licks. The manly scent of the sweat from his exertion arouses you all the more. You rim the big guy until he's panting and moaning before withdrawing your tongue and moving[else]take a few moments to rub a saliva-slick finger over his tailhole. With that added to the sweat of his exertion to wet his pucker, you move into position[end if] to mount him.";
