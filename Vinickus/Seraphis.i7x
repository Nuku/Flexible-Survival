...
Instead of resolving a Conflict within the Plains:
	if HP of Seraphis is 0: [First interaction]
		say "     Moving through the plains rarely brings much of interest to your eyes, but as you don't have much else to do durin your travel through the grasses, you let your eyes wander far and wide. Surprisingly, you notice a glint of light off to the side. As you focus your gaze that way, it repeats again, and keeps repeating in irregular intervals, drawing your attention to what might be reflecting [if daytimer is day]sun[else]moon[end if]light out here. The sourse definitely seems to be on the move, and after studying another half-dozen flashes, you manage to pin down the direction and speed of your curiosity. Your drive to learn what the object is outweighs any waryness within your mind, so you set out to close the distance.";
		...
		if player consents:
			...
			if calcnumber is 1:
				...
				if calcnumber is 1:
					...
					LineBreak;
					say "     While he is hot, and offly tempting to bend over for, or even use, you decide it's not worth the risks of dealing with someone so...unstable. At least, that is, for now.";
				...
				if calcnumber is 1:
					...
					if bodyname of player is "Human":
						...
						say "well, for the most part, for you definitely lost your old body,' he remarks with some evident disapointment. ";
...
to say DominantSeraphisFirst:
	if gender of player is "Male":
		...
		WaitLineBreak;
		say "     Fully ready, you push back, relaxing your hole as shlocking sounds greet your ears, and the wet, fluid covered cock speers further into you, lubed by the sexual fluids constantly leaking out of it. Of course, more whinnies fill your ears when the flare scrapes your inner walls, the cock burrying itself deeper within, and the hips of the big beast aiding that with infrequent but forceful thrusts. Once past the medial ring, it doesn't take long to find your ass brushing against fur and the male's sheathe, your own testicles feeling a light touch from the heavy testicles of the far bigger male.";
		say "     You begin to pull yourself away, letting his cock slip from your hole inch by inch, but as you do, the centaur beats you to it, pulling back halfway before slamming forwards again, burrying his dick all the way once more. Instinctively tightening your grip on the male's front legs, you keep yourself steady as wet slap after wet slap fills the area, shlocking slurping noises aiding in the orgasmic sound of sex. You find it hard not to enjoy the idea of being used by the powerful beast, and the musk makes any resistance impossible, so you stay braced, relaxing and tightening your anus at the right times to encourage the centaur even more.";
		WaitLineBreak;
