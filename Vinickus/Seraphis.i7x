	...
	if HP of Seraphis is 0: [First interaction]
		...
		if Player consents:
			...
			if calcnumber is 1:
				...
				LineBreak;
				say "     [bold type]Do you give in to his demands and help sate his need, wait it out to see if the effects wear off, or take advantage of the man's current state?[roman type][line break]";
...
to say SubmissiveSeraphisFirst:
	if Player is male:
		...
		say "     As the pleasure tapers off, you lower your head, looking over the expanding and contracting back of the centaur. The pants slow as you stay buried within the male, his hole going lax around you, allowing bits of your semen to flow out around your softening shaft. As more trickles out and covers your crotch in bits of seed, you grip onto the man's hips with both hands, releasing his tail as you pull out while holding him in place[if Player is knotted], your extra-sensitive knot making you shiver as it pops out[end if]. You feel his muscles moving, his body trying to push back as you pull out, but you manage to hold him in place long enough to fully withdraw. Happy with how eager he is, you slap a hand against his flank, the centaur raising his ass back up to almost chest level.";
		WaitLineBreak;
