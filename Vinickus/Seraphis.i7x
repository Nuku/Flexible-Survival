	...
	if HP of Seraphis is 1:
		...
		if Player consents:
			...
			if Player consents:
				...
				LineBreak;
				say "     Seraphis' eyes narrow at you. 'Fine enough, I suppose. It's better than this impudent traitor staying in my presence.' The male possessively strokes a finger across the jackal's back as he speaks. When that very same finger flicks up, several root-like tentacles emerge from the stony ground. Each one of the green appendages stroke over the anubian's body, tracing down his muscular arms and legs. Once they get to his wrists and ankles, they gently curl around the joints, tightening their hold as the more phalic tentacle continues to violate the man. Within moments, the wiggly arms lift the constricted limbs: almost lovingly slow in their new methodical movements. And as you watch the man ascend towards the ceiling of the old ruins, your eyes catch the opening of his new home.";
				...
				say "     'That will be his fate from here on out, or at least for the next decade or so. I guess we'll see how his demeaner is then. You, however, while a bit predictable, are quite a specimen to behold. You could do quite wonderous things in the future. Especially at my humble village.' Seraphis then glows once more, your eyes slamming shut as the light burns through the lids yet again. Your eyes just barely adjust in time to witness him galloping off after his little magic trick. Looking back up at the newly cristened and squirming pod, your nose leads you back to the pool near the center of the ruins. It smells so alluring, like both the perfect lover, and the most delicious meal. You just barely manage to avoid temptation - this time - and turn to leave the ruins.";
				now Plant Ruins Encounters is resolved;
		else:
			LineBreak;
