...
to say Triceratops Male Wins:
	if HP of Player > 0: [player submitted]
		say "     Seeing this big male triceratops has made you feel weak and unable to fight back, so you decide to sink to your knees and submit. He just laughs at you, mocking your apparent feebleness. '[if scalevalue of Player < 3]Heh, I don't judge you. A shorty like you would never be a match for me... but you still get the loser's reward! Hehe...' he says[else]What's this?! A weakling like you dares to waste my time like this? Get up and fight! Heh... unless...' he shouts[end if], walking towards you with clear mischief in his eyes.";
	else:
		say "     Too weak to keep fighting, you lose your strength and collapse on the floor, hurting all over as the sturdy triceratops laughs at you. 'Hah! [if scalevalue of Player < 3]What a puny little thing! Did you really expect to beat me looking that small? Time to teach you a lesson, wimp[else]Can't take any more? Is that all you've got?! Come on, fight[end if]!' he shouts, walking angrily towards you. Due to the beating you took, there is nothing you can do to stop what is coming next...";
	if Player is male and a random chance of 1 in 2 succeeds: [sit on dick]
		say "     Giving you no chance to escape, you see the large male turning around in front of you, then above you, looking over his shoulder with a smirk as his ample rear overshadows you. He grabs his beefy buttcheeks and spreads them open, to show you his donut hole that immediately starts winking at you. It gives you this feeling that it gets used a lot due to how stretchy it looks. 'See this big and tasty asshole right here? How about I sit on the wimp's dick? Would you like that, loser?' he asks, chuckling to himself as he stands up again, reaches over you and makes sure your [Cock of Player] cock is out on display for him. The strong saurian inspects it, [if Cock Length of Player < 8]looking disappointed at what he sees. 'A stupid, tiny little dick on a beta like you... How fucking expected. I'm barely gonna feel this up my big ass, if at all!' He then starts angrily slapping your dick, but that only makes you harder[else if Cock Length of Player < 16]looking quite pleased with what he sees. 'You got a nice one, runt. Shame it's on a fucking beta like you.' He then playfully slaps it around, making you grit your teeth as it only throbs even harder[else]his eyes widening as he sees what he is dealing with. 'Fuck! Big fucking dick! You're a hung little wimp, fucker! My ass is gonna love it...' He then starts playfully rubbing and slapping it around, getting you so hard that it begins to throb consistently[end if]... 'Someone's getting happy... Hehe...'";
		WaitLineBreak;
...
to say TriceratopsMaleVictoryFingering:
	...
	CreatureSexAftermath "Triceratops Male" receives "AssDildoFuck" from "Player";
...
When Play begins:
	...
	now body change entry is "it becomes strong, yet flexible. Your hands and feet change, becoming clawed and saurian in shape, but still nimble and graceful";
...
Scent of triceratops male tooth is "It smells like the inside of a beast's mouth. Not very pleasant.".
