...
to say HellDemon wins:
	say "     Unable to [if HP of Player > 0]resist such a powerful presence, you immediately submit to the demon's will, his eyes following your movements with great satisfaction, as you kneel down in front of him. 'Finally someone who knows their place. That's a good start, but let's see how much you can handle[else]continue fighting the so mighty and powerful demon, you immediately give in to his will, his eyes following your movements with great satisfaction as you're forced to kneel down in front of him. 'You know how to put up a fight! That left me all boned up... Perfect, I was just thinking about testing your holes[end if].' With that said, the hellish creature prepares to use you as he sees fit...";
	if a random chance of 1 in 2 succeeds:
		HellDemonBJForced;
	else if Player is male and (Player is not female or a random chance of 2 in 3 succeeds):
		HellDemonAnalForced;
	else:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if Player consents:
				...
				if title entry is:
					...
					-- "Fuck his muscley ass":
						say "[HellDemonFuck]";
					-- "Offer your ass for his pleasure":
						say "[HellDemonAnal]";
					-- "Sit on his face":
						say "[HellDemonCun]";
					-- "Offer your pussy for his pleasure":
						say "[HellDemonPussy]";
					-- "Worship the demon's feet":
						say "[HellDemonFeet]";
					-- "Double tag him with Xaedihr":
						say "[HellDemonXMale]";
...
to say HellDemonFuck:
	...
	WaitLineBreak;
	say "     Without any further ado, you finally give in to your desires and bring your face to the space between his rock solid cheeks, stretching your tongue over to his hole. He lets his glutes slowly hug your face back as you make out with his anus, hungrily eating it out and leaving it as wet as you can. 'Damn, you wanted it that badly, huh?' he teases you, though you pay no attention to what he says, you just want to press your tongue deeper in his ass and stretch the tasty, moist and hot pucker that's still drawing you in... In your mind, run thoughts about [if Player is dominant]having a powerful demonic creature such as him at your mercy, making him take your dick however you want, having him submit to you... The sheer thought makes you throb harder than before, only wanting to feel your cock in his ass, his insides clenching around your meat as hard as you can fuck him. Only if you had him as your personal slave, satisfying all your whims and needs, such a strong devil at your permanent service, performing this well at all tasks you order him to carry on for you... Only if you could have that, you could keep fucking this demon's ass all you wanted, for as long as you desired[else]the sensation of letting go your own limits, delivering yourself to the pleasure of having such an expert in sex driving you insane with lust... The sheer thought makes you throb harder than before, only wanting to feel your cock in his ass, his insides clenching around your meat as hard as you can fuck him. Only if you could keep having this, surrounded by lust, sex and desire for as long as you wished, as long as you craved it... Only if you could have that, you could keep getting naughty with sexy devils like this demon whenever your heart craved for this kind of thing[end if]...";
...
to say HellDemonAnal:
	...
	WaitLineBreak;
	say "     'Damn, that was good...' he says, still holding you beneath him. 'Feels great, doesn't it? [if Player is submissive]Imagine if you were an everyday's slave at our place... I could come fill you up so good like this... Your days would be filled with constant pleasure, perfect for a true submissive like you to enjoy.' His words surely bring excitement to your soul, and you're already imagining yourself bound, left helpless to be used and abused by any of those hot devilish people[else]See what you've been missing... If you'd just give in, I could probably bring you with me. We'd have a lot of fun either way.' His words manage to get some curiosity going in your mind[end if]. Figuring it's time to get going, the demon stands up and leaves you lying on the ground, still full of his seed. 'Hope we meet again. Maybe next time you won't be able to resist me at all.' With this said, the demon retreats back to the shadows. You're left to wait out until you process enough of his cum, in your mind still running thoughts of debauchery for a good while... There's something [italic type]odd[roman type] about this kind of demon...'";
	CreatureSexAftermath "Player" receives "AssFuck" from "Hellfire Demon";
...
to say HellDemonCun:
	...
	say "[line break]     [bold type]Do you want to finish him off?[roman type][line break]";
...
to say HellDemonPussy:
	...
	WaitLineBreak;
	say "     As you feel your lower lips stretching around his shaft as he keeps pushing, you feel a burning sensation of pleasure taking over you. In the embrace of the devil, you give yourself in completely, letting him handle everything. 'Isn't this way better than fighting? Indulging in the sweet pleasures of life, rather than resisting... One day you'll be craving for it.' Despite his taunts, you can't focus on anything else but the way he fills you so well, burying more of his length inside you which, somehow, you are able to take in. The demon still whispers in your ear, 'Feels great, doesn't it? [if Player is submissive]Imagine if you were an everyday's slave at our place... I could come fill you up so good like this... Your days would be filled with constant pleasure, perfect for a true submissive like you to enjoy.' His words surely bring excitement to your soul, and you're already imagining yourself bound, left helpless to be used and abused by any of those hot devilish people[else]See what you've been missing... If you'd just give in, I could probably bring you with me. We'd have a lot of fun either way.' His words manage to get some curiosity going in your mind[end if]...";
...
to LJockstrapPickup:
	if carried of leather jockstrap < 1:
		...
		if Player consents:
			LineBreak;
			say "     You crouch down to pick up the leather jockstrap and stow it away in your inventory.";
...
Scent of hellfire demon horn shard is "The shard doesn't smell like anything in particular.".
