...
WyvernPatriarchFightOutcome is a number that varies.[@Tag:NotSaved] WyvernPatriarchFightOutcome is usually 0.
[1 - Player submitted]
[2 - Player lost]
...
to say VuukzasqigSexMenu:
	...
	while sextablerun is 0:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if Player consents:
				now sextablerun is 1;
				if title entry is "Threesome with Diavoborg":
...
When Play begins:
	...
	now CumItem entry is "wyvern patriarch cum"; [ Item to be given to the player if they have this infection and jerk off. ]
