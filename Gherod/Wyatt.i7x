...
Cunt Depth of Wyatt is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if Player consents:
				...
				if title entry is:
					...
					-- "Offer to blow him":
						say "[WyattSexBlowjob]";
					-- "Have him lick your pussy":
						say "[WyattSexFemaleCunnilingus]";
					-- "Get some vaginal sex":
						say "[WyattSexFemalePussyFuck]";
					-- "Ask him to dominate you":
						say "[WyattDominantSexFemale]";
					-- "Ask him if he would fuck you":
...
to WyattSexBodyWorshipContinued:
	WaitLineBreak;
	say "     Being given green card to simply feel up the handsome wolfman means you can really just go all out. As you have given his biceps a good amount of rubbing, your hands begin to trail towards his furred chest. His pectoral muscles are quite sizable, not bodybuilder sized but still of a significant measure. They feel solid against your touch, but the soft fur, shorter and brighter in this section, improves this pleasant experience. Every time he breathes in, you feel his chest expand, all while you keep rubbing his pecs. Eventually, you reach out for his nipples, which turn out to be somewhat sensitive to the werewolf. 'There's something you could do...' he speaks as you feel him reaching for the back of your head, slowly pulling you closer to his chest.";
	say "     He does not stop it until your lips collide with the surface of one of his furred pecs, then led to that very same nipple you were teasing just a few moments ago. 'Just helping you free your hands...' The werewolf smiles as you bring your tongue into play, wiggling it across that sensitive nub as you proceed to move your hands across the sides of his torso. As any werewolf brute, he is big[if scalevalue of Player > 3], even for you[end if], due to how well he takes care of his body. All those muscles had a nice mass overall, which you feel up at every corner while your lips remain planted on his pecs. You also give his abs a rub, noticing how popped and rock solid they are, undulating your touch with every bump of muscle.";
	WaitLineBreak;
...
to say WyattSexFemalePussyFuck:
	...
	say "     His kisses are passionate, fiery and intense, his tongue twirling around yours in an almost animalistic manner, and you can only wrap your legs around him as the tip of his cock begins to poke at your wet curls. It throbs, warm and thick, wanting to enter you immediately, but Wyatt seems to hold on for now. He continues to kiss you, then licks around your neck, only allowing his shaft to rub against your pussy. Albeit persistently, the werewolf remains contained in his actions, first taking his time to truly appreciate your body. His mighty physique contrasts with your softness and femininity, and his surprising strength keeps you placed way above the ground and against the wall with seemingly no effort.";
	WaitLineBreak;
...
instead of going to Lair Of The Lupines Common Room while Resolution of WyattRomance is 0 and PlayerFucked of Wyatt is true and daytimer is night and Player is not MalePreferred:
	...
	say "[line break]     [bold type]Shall you let your curiosity take the reins[roman type]? You should find no difficulty in keeping quiet, for now.";
...
to WyattSpecialVoyeurFemaleRoute:
	...
	WaitLineBreak;
	say "     You can tell the male is so aroused that his entire focus shifts towards the insides of your womanhood, quivering around his sizable dick as he continues to fuck you. The lust overtaking you, clouding your every thought and judgment, only drives you towards your orgasm as the werewolf carries on, his manhood throbbing excitedly at the sight of your climax. He looks at you with the happiest smile as you only squirm and quiver in utter bliss, still feeling his hard meat inside you, and you absolutely cannot help it. Your erogenous regions feel so delightfully sensitive that every time he rubs your breasts or his cock gives out a throb and moves a mere inch, you feel overwhelmed with pleasure.";
