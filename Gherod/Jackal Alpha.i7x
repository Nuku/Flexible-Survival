...
to say Alpha Jackal Wins:
	if vorelevel > 1 and JackalAlphaSubmitCount is 6 and BodyName of player is "Jackal Femboy" and Player is pure: [bad end, player is fully assimilated into the jackal's cock]
		...
		WaitLineBreak;
		if Player is male:
			say "[one of][AlphaJWinsCockWorship][or][AlphaJWinsRimming][or][AlphaJWinsFacesitting][purely at random]";
		else:
...
to say AlphaJWinsCV:
	...
	if Player consents:
		...
		SanLoss 10;
	WaitLineBreak;
	say "     And with this feeling of pure ecstasy that assails you at every opportunity, comes change...";
	...
	MultiInfect "Jackal Femboy" repeats 3;
	WaitLineBreak;
...
to say Alpha Jackal Loses:
	say "     With the beating you gave the big alpha jackal, he has no way to make any further attempts at charming you. 'You could have just accepted my gift... I am offering it to you so freely... Why must you reject it?' he asks, and you can tell by the expression in his face that he is deeply offended. Perhaps you could make amends and offer some friendly gesture that would leave him much happier, or just... Use him and his body as you see fit, since you just brought him to the ground, defeated and vulnerable.";
	WaitLineBreak;
	...
	while sextablerun is 0:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if Player consents:
				...
				if title entry is:
					-- "Play with his massive cock":
						say "[AlphaJLosesCockPlay]";
					-- "Gather some cum from the jackal":
...
Scent of jackal alpha fur is "The fur has an intoxicatingly pleasant, hypermasculine animal-like scent.".
...
Scent of jackal alpha cum is "You open the lid for a moment and take a sniff. You almost feel compelled to drink it once its mesmerizing scent gets caught in your nostrils, so you put it back down in that instant.".
