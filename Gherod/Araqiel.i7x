	...
	if HP of Araqiel is 0 or HP of Araqiel is 1 or HP of Araqiel >= 50 or (HP of Araqiel is 2 and Resolution of Purifier Three > 0): [normal cycling event for Pure Araqiel]
		...
		if AraqielTrackerMall is 1:
			...
			if diceroll + bonus >= 10: [player finds Araqiel]
				...
				say "     Quickly, you retreat to a place where you won't be caught, and gladly he just gets past you, disappearing into the shadows. The demons only grunt while they're slowly getting up... or trying to. When the Purifier is gone, you notice that one of his feathers found its way over to your feet. You rush to catch it, and it feels incredibly soft in your hand, making you feel deemed unworthy of even taking hold of one. It simply feels that your mere touch could corrupt its purity, as it even dims a little light that manages to pierce through your fingers. This is something you feel like you should keep.";
	...
	if Libido of Mogdraz > 0 and Libido of Mogdraz < 99:
		...
		if Player consents:
			...
			if Player is male: [frotting]
				...
				say "     The grunting from the group of demons and the fallen seraphim continues as their climaxes keep following in sequence, the smell of demon cum so intense that it makes you feel slightly lightheaded, a sensation that complements the overwhelming state Mogdraz threw you into. Turned on as you both are, it doesn't take long until you begin to hump against each other, bringing your lips together for a rather sloppy tongue-wrestling in each other's mouths. You can feel his powerful and intense heartbeat together with his deep breathing reaching a new level, indicative of a steady approach to his climax. Slipping your hand over his heavy orbs, you know he'll deliver a very messy load, and he really loves when you grope and rub him down there.";
				WaitLineBreak;
				...
				LineBreak;
				say "     You can feel his lust-driven breath tickling your forehead as the towering devil pushes his leather jockstrap down, his erection so rock hard that it jumps right out of its former prison and hitting you quite heavily. You can see how really enormous it is, even by a hellfire demon's standards, and it's pulsing and leaking already. He looks into your eyes, and reflexively, you nod while looking back at his, a second later feeling his hand reaching down for your crotch, all ready to be caressed and brought in for the pleasure. While Mogdraz tugs on his own length, throbbing hard by now, his nimble fingers find a way to slip between your legs, grabbing your [if Player is female]feminine bits gently[else]sensitive areas[end if] and playing around them as he masturbates you both.";
...
Cunt Depth of Araqiel is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
to say AraqielDesc:
	if HP of Araqiel is 3: [Corrupted]
		say "     Araqiel is one of a kind, an extremely powerful Purifier seraphim with features that would cause the other angels to be considered puny in comparison. The towering fallen angel is a heavily muscular man with vast, white feathered wings adorning his back, blonde short hair with crimson eyes, a clear face and a rosy pale skin-tone. Though the one thing that sets him apart from the heavenly creatures is the existence of a sizable cock below his ripped midriff, big even for his overall hulking frame, with a set of already full ostrich-egg sized gonads hanging underneath that seem to fill up even more at the mere sign of slight arousal. He always has a mischievous and inviting smile, enticing anyone, including you, to come very, very close to him.";
...
to say CAraqielTalkXaedihr:
	say "     Since your demonologist companion is already widely known around the Club, you figure it's for the best that you introduce him to Araqiel. Calling the half-demon over, you tell him that you'd like them to get to know each other. Xaedihr chuckles at your request, though he shows himself as a polite gentleman, greeting the fallen angel most appropriately. 'Greetings, my name is Xaedihr. I assume you've already heard of me,' he says, the winged man raising an eyebrow, then nodding as he was listening. 'Xaedihr... Xae... Oh! Aren't you... Aah... a patron! Or was that from the cleaning service? I... I don't remember. Anyway, I'm Araqiel! Very nice to meet you!' The half-demon sighs, looking frustrated, before he whispers to you, 'I'm having second thoughts about this. I thought Mogdraz would leave his intellectual capabilities mostly intact. That or he was never that much mentally bright, to begin with... Probably the latter.'";
...
to say CAraqielSpitroastEranyd:
	...
	WaitLineBreak;
	say "     Unable to wait any further, [if Player is not naked]you whip out your cock[else]you grab your cock[end if] and rub it across the demon's face, whose joy is obvious as soon as your shaft comes in contact with his cheek. The boy is already trying to taste your meat, moaning each time Araqiel pounds him deeper and harder. 'You better get that dick in your mouth before mine starts feeling [italic type]too good[roman type] for you, cunty bitch,' he says, once more teasing Eranyd, who actually rushes to grab your [Cock of Player] shaft and shove it all in his mouth. After a good while worshiping your manhood, he then lets it hit his throat and lets you do the thrusting, in order to enjoy his time being double fucked by two horny and rock hard cocks. Naturally, you use this opportunity to start facefucking the cuntboy.";
	...
	WaitLineBreak;
	say "     'Ready to get a belly full of angel babies, little cunty imp?' The big, muscular angel lets out a grunt of pleasure as he and you reach your climaxes. Burying his entire length in Eranyd's cunt, he cums with you, both cocks shooting all the spunk that has been long begging to leave right inside the incubus, hard. On your end, the cuntboy slurps all of your seed to the last drop, while he takes Araqiel's in his pussy, and by the looks of it, Eranyd shivering and squirming that much can only mean he also had a really good orgasm. 'Fuuuck, my balls sure grew heavy...!' the angel exclaims, as his load lasts for about a minute, until he finally pulls out of the cuntboy's abused vulva. A thick stream of creamy sperm follows Araqiel's cock before it falls down on the floor. Your dick is still getting licked of any traces of your load before you pull away.";
