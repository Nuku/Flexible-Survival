...
to DullahanSummon1Choice1:
	...
	if calcnumber is 1:
		...
		now Ending Reason of TheEnd is "Decapitated by Dullahan";
...
to DullahanSummon1FightSolo:
	...
	if fightoutcome < 20: [won]
		...
		increase carried of dullahan dust by 5;
		WaitLineBreak;
...
to DullahanSummon2Fight:
	...
	now inasituation is false;
	if fightoutcome < 20: [won]
		say "     Moments later, you're both bruised and weakened. The fight you took left you exhausted, but there's still enough energy in you to deliver the final strike. However, you're stopped by the Dullahan as he speaks in your mind once more. 'I admit defeat. You are more capable than I initially thought.' You both return to a neutral stance, facing eachother with your arms low. 'I never had such a formidable opponent. One that wouldn't fall on my first strike... You're impressive. I shall not take your soul, for you have earned my respect.' Once he finishes his speech, you see the dark knight kneeling in front of you, his helmet head facing the ground, as his voice slips into your mind one more time. 'Is there anything I can do as a reward for your victory?'";
...
to DullahanBadEnd:
	...
	WaitLineBreak;
	now battleground is "Void";
	now Ending Reason of TheEnd is "Soul taken away by Dullahan";
	trigger ending "Player has died";
