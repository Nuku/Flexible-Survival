...
when play begins:
	add MeetingDrelgoth to BadSpots of MaleList;
	add MeetingDrelgoth to BadSpots of DemonList;
	...
	if Resolution of MeetingDrelgoth is 0:
		if Player is not in Maintenance Storeroom:
			...
			if humanity of player >= 50 and "Weak Psyche" is not listed in feats of player:
				...
				say "     ([link]Y[as]y[end link]) - Give in to it.";
...
Ball Size of Drelgoth is 3. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
...
fuckscene of Drelgoth is "[SexWithDrelgoth]".
...
instead of conversing Drelgoth:
	...
	say "[line break][DrelgothTalkMenu]";
...
to say DrelgothTalkHisKind:
	...
	if Libido of Drelgoth is 0:
		say "     If it was not obvious, Drelgoth seems clearly keen on taking a more sexual approach with you, if you so wished. But, just to be sure, you should probably talk to him about it and set your conditions. If he is a demon, you should ensure you are getting a good deal out of it, right?";
...
to say DrelgothTalkSexConditions:
	...
	if "Dominant" is listed in traits of Drelgoth or "Submissive" is listed in traits of Drelgoth:
		...
		if Player is submissive:
			...
			say "[line break]     You feel like there is no in-between; these instincts are so untamed that you are forced into one of the sides of the spectrum...";
...
to say DrelgothSexSubBlowjob: [Submissive Route Blowjob]
	...
	if Strength of Drelgoth >= 5 and a random chance of 1 in 2 succeeds:
		...
		WaitLineBreak;
		say "     As he places his hands over the back of your skull, his voice changes. It becomes deep, to an almost distorted tone, something clearly otherworldly. His hand also seems bigger, and the shaft in your mouth keeps throbbing and throbbing, almost as if it was thickening, too. In fact, everything just becomes bigger, from what you can see of his muscular thighs, and as you look up... What was previously a very warm and friendly face, albeit filled with mischief, is now, while still an oddly attractive man, a quite hypermasculine, intimidating, burly and horned brutish demon. His eyes glimmer like fiery, intense flames, as his visage sends chills down your spine. 'Alright, bitch... How about we start getting serious?' his voice booms out to you as he stands ready to ravage your face...";
		...
		say "     Drelgoth remains in the same position observing you, and even helps by sliding his thumb across your cheeks towards your mouth, letting you even suckle on it. Sadly, all good things come to an end, and that goes for him as well. His visage returns to his former self not long after, but you are too distracted to notice until he begins addressing you once more. 'You've been making me feel quite powerful lately... Our arrangement has been proving fruitful. Now, you might wanna get cleaned up before you head outside... I'm sure you'll come back for me later, though,' he says, with the much more familiar young and masculine voice he had.";
...
to say DrelgothSexSubArmpitWorship: [Submissive Route Worship]
	...
	say "     Immediately, you feel a rush of lust taking over you as this masterful kiss continues, and just then, you begin to inhale that sweet demonic scent once again. Your mind gets hazy as your surroundings matter less and less, causing you to focus your senses on the demon before you. He is all that matters to you, that and the lust-inducing pheromones arriving at your nostrils. As Drelgoth pulls back, he places a hand over the back of your skull and immediately guides you down his neck, which you kiss tenderly. 'Mmh... Good... Kiss your way to wherever you like...' he tells you, his masculine, low and delightful voice making your insides rumble together with the anticipation of pleasuring him further.";
	if Strength of Drelgoth >= 5 and a random chance of 1 in 2 succeeds:
		say "     [bold type]Although, something seems to be happening with the demon...[roman type][line break]";
		WaitLineBreak;
		say "     As you inhale that powerful, masculine musk emanating from his body, his voice changes. It becomes deep, to an almost distorted tone, something clearly otherworldly. His muscles also seem bigger, and his cock keeps on throbbing and throbbing, almost as if it was thickening, too. In fact, everything just becomes bigger, from what you can see of his now enormous frame, and as you look up... What was previously a very warm and friendly face, albeit filled with mischief, is now, while still an oddly attractive man, a quite hypermasculine, intimidating, burly and horned brutish demon. His eyes glimmer like fiery, intense flames, as his visage sends chills down your spine. 'What's up, bitch? Didn't you want to make love to my muscles? Let me show you a really good place...' his voice booms out to you as he stands ready to truly dominate you...";
		...
		WaitLineBreak;
