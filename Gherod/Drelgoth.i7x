...
to say DrelgothSexSubFeetWorship:
	...
	if Strength of Drelgoth >= 5 and a random chance of 1 in 2 succeeds:
		...
		say "     You would normally give your best, but this time, something really compels you to give your maximum as your lust for this brutish demon goes up several miles, to the point it is literally the only thing you can think about. His musk has ingrained itself in you, feeling overwhemingly warm as it clouds your mind, locking your attention on the meaty toes you so eagerly twirl your tongue around and continue on sucking. Such sensations are very well felt by Drelgoth himself, who just seems lost in them, rubbing himself all over with one hand always rubbing his large cock, often thrusting in the air instead and making those enlarged balls swing back and forth. 'Fuck yeah!! Think I might serve your reward in a different way...'";
		WaitLineBreak;
