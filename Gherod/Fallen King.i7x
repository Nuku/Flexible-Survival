...
an everyturn rule:
	if Resolution of DarkTyrantQuest >= 2 and Intelligence of Fallen King < 5:
		if lastfuck of Fallen King - turns >= 6 and daytimer is night: [Solved by Embracing, Dark Tyrant appears at Night]
			if Fallen King is not in Hellfire Unknown:
				now Fallen King is in Hellfire Unknown;
		else if Fallen King is in Hellfire Unknown:
...
Cunt Depth of Fallen King is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
Section 1 - Dark Tyrant/Fallen King Talk Menu
...
instead of conversing Fallen King:
	...
	say "[line break][FallenKingTalkMenu]";
...
to say FallenKingTalkEmbrace:
	if Intelligence of Fallen King < 4:
		...
		say "     You feel the giant really struggles to speak, most of the time. [if Intelligence of Fallen King < 3]Perhaps if you continue to interact with him the way you have, he will become smarter over time? You can only try a few couples of times more and then ask him about it again, afterwards.[else]What you have done so far seems insufficient... So, if letting him take you within him bolsters his ability to communicate, perhaps you could suggest a [bold type]deeper connection[roman type]? There has to be more options to perform this sort of dark embrace...[end if]";
	else:
...
Section 2 - Fallen King Sex Menu
...
to DarkTyrantSexMenuContinue:
	say "[line break]     How would you like to proceed?";
	now sextablerun is 0;
	blank out the whole of table of fucking options;
	[]
	if Intelligence of Fallen King < 5:
...
to say DarkTyrantSexEmbrace:
	...
	if Intelligence of Fallen King < 3:
		say "[line break]     [bold type]The Dark Tyrant grows stronger...[roman type][line break]";
		increase Intelligence of Fallen King by 1;
	else if Intelligence of Fallen King is 3:
		say "[line break]     [bold type]The Dark Tyrant is unable to gain any more strength from this...[roman type][line break]";
	now Fallen King is nowhere;
...
to say DarkTyrantSexSymbiosis:
	...
	if "Strong Psyche" is listed in feats of Player:
		...
		SanLoss 15;
	if Intelligence of Fallen King < 4:
		say "[line break]     [bold type]The Dark Tyrant grows stronger, once more.[roman type][line break]";
...
Description of symbiotic darkness is "     The Dark Tyrant holds onto you like an shroud of darkness, looking inconspicuous to the outside if need be. You, however, feel his presence like nobody else can, flowing by and through you like a ghastly shadow looming over your soul. In short, he is not very visible, but you know he is here.[line break]".
...
to say SummonSymbioticDarkness:
	...
	else if level of symbiotic darkness >= 40:
	...
	else if level of symbiotic darkness >= 30:
