...
to YoukaiLairMogdrazPath2:
	...
	say "     Following his warning, Toron, the bartender, appears from behind you, carrying a strange object that seems to be this so called [bold type]visage[roman type] the demon lord has been talking about. He hands it over to you, and you keep it close and safe in your [bold type]special inventory.[roman type][line break]";
	WaitLineBreak;
	say "     [bold type]You have unlocked the Visage of the Red Oni. Use it to navigate certain areas in the Youkai Lair.[roman type][line break]";
	ItemGain visage red oni by 1 silently;
	WaitLineBreak;
