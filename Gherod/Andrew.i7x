...
Ball Size of Andrew is 4. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
...
Instead of conversing the Andrew:
	...
	say "[line break]     After exchanging a few words with the wolf, [bold type]is there anything else in particular you would like to ask?[roman type][line break]";
	say "[AndrewTalkMenu]";
...
to say AndrewTalkMenu:
	...
	now description entry is "Inquire more about his preferences and orientation";
	[]
	if HP of Andrew >= 2:
		choose a blank row in table of fucking options;
...
to say sexwithAndrew:
	...
	if HP of Andrew is 0:
		...
		say "[AndrewSexMenu]";
	else if DBCaptureQuestVar is 5 and ( DemonBruteStatus is 0 or DemonBruteStatus is 1 ) and lust of Andrew is 0 and demon brute is listed in companionList of Player:
		...
		say "[line break]     [bold type]Shall you order your demon slave to fuck Andrew? This decision will immediately lead into some action, and you should keep in mind that the demonic influence within your enslaved brute might be dangerous...[roman type][line break]";
		...
		if Player consents:
			...
			LineBreak;
			if Player is male:
				say "     Deciding it'd probably not be a good idea, you tell Andrew that, adding that you'd be more than happy to have some fun with the wolf if he's up for it. 'Oh, I see how it is. You're just looking to get some of this,' he says, rubbing his large, firm package.";
				say "[AndrewSexMenu]";
			else:
				say "     Deciding it'd probably not be a good idea, you tell Andrew that, adding that he should probably stick to playing with the regular club patrons for his fun. He sighs, but nods in agreement.";
			now lust of Andrew is 1;
	else if DBCaptureQuestVar is 7 and ( DemonBruteStatus is 0 or DemonBruteStatus is 1 ) and lust of Andrew is 0 and demon brute is listed in companionList of Player:
		...
		say "[line break]     [bold type]Shall you give the OK for Brutus to fuck Andrew? This decision will immediately lead into some action...[roman type][line break]";
		say "     ([link]Y[as]y[end link]) - Yes.";
...
to say AndrewSexMenu:
	...
	if HP of Andrew >= 2:
		...
		[]
		if Player is not dominant: [this scene would definitely not fit a dominant player]
			choose a blank row in table of fucking options;
		...
		[]
		if ( DemonBruteStatus is 0 or DemonBruteStatus is 1 ) and lust of Andrew is 1 and demon brute is listed in companionList of Player:
			...
			else if DBCaptureQuestVar is 7:
				choose a blank row in table of fucking options;
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if Player consents:
				...
				if title entry is:
					...
					-- "Suck the wolf's cock":
						say "[AndrewSexGiveBlowjob]";
					-- "Milk him for some cum":
						say "[AndrewSexMilk]";
					-- "Get some anal action":
						say "[AndrewSexAnal]";
					-- "Fuck Andrew with an audience":
						say "[AndrewSexFuck]";
					-- "Get cummed on by Andrew in public":
						say "[AndrewSexCummedOn]";
					-- "Receive a bukkake":
						say "[AndrewSexBukkake]";
					-- "Lend your demon slave to Andrew":
						say "[AndrewDemonShow]";
					-- "Lend Brutus to Andrew":
						say "[AndrewBrutusShow]";
		else if calcnumber is 0:
			LineBreak;
			now sextablerun is 1;
...
to say AndrewSexReceiveBlowjob:
	...
	say "     '[if HP of Andrew is 1]But of course! And since this is our first time together, I think it's appropriate to let me get a taste for[else]You want me to suck you off again? Well, I'm always down for getting a taste of[end if] you...' he says, nipping at your neck. You moan and nod, eager to feel the playful wolf's muzzle and tongue on your dick as he continues to tease you, your erection starting to pop up quickly as his loving touch caresses you deeply and softly all around your neck, slowly and teasingly, making his way down to your chest with soft kissing, all to prepare you for a much more delightful pleasure.";
...
to say AndrewSexGiveBlowjob:
	...
	say "     Unable to resist the tantalizing offer, you bring your lips to his thick shaft and start licking and kissing at it. He moans softly and rubs his hands over your head, gently coaxing you to take it into your mouth. As he stuffs your mouth with his cock and starts thrusting into it, you work your tongue over him, excited by the taste of his precum and musky meat. You grope his heavy, enlarged balls with one hand, longing to taste their contents soon. 'Mmm... good work. Keep that up,' he says in his soft, sultry voice. '[if Player is submissive]You love this, don't you? I bet you'd also love putting on a show for everyone to see how much you love servicing a big cock[else]You're really good at this... I'd love putting on a show for everyone with you sucking my big cock... Bet others would like to join, too[end if]...'";
	WaitLineBreak;
	say "     Awash in your own arousal, you'd [if Player is submissive]voice your agreement with him if your mouth weren't stuffed with delicious wolf-cock, wanting to be as much a man-whore as the sexy wolf you're blowing. You are quite certain others would be eager to use your every hole, and imagining all those different, sexy penises around[else]agree with him if your mouth weren't stuffed with delicious wolf-cock, wanting to encourage the sexy wolf's boldness. You are quite certain others would be eager to join you in the action. Imagining all those different, sexy penises around him and[end if] you, being stroked, rubbing together, filling slick holes, turns you on all the more. You wiggle your rear and suck all the harder, which stimulates his cock to increase its flow of delicious precum. Grabbing his ass with your free hand, you slip a pair of fingers into his tailhole and prod at his prostate. This gets the wolf howling in pure bliss as his orgasm approaches, leaving you with a decision to make.";
...
to say AndrewSexMilk:
	...
	NPCSexAftermath Andrew receives "Stroking" from Player;
...
to say AndrewSexBukkake:
	...
	add slutname to maletype;
	say "[randombodypart]"; [yields 'bodyselector' - male 2]
	while bodyselector is slutname:
		say "[randombodypart]";
	add bodyselector to maletype;
	say "[randomdesc]"; [yields 'slutname' - male 3]
	while slutname is listed in maletype:
		say "[randomdesc]";
	add slutname to maletype;
	say "[randombodypart]"; [yields 'bodyselector' - male 4]
	while bodyselector is listed in maletype:
		say "[randombodypart]";
	add bodyselector to maletype;
	sort randomcolorlist in random order; [fresh randomized set]
	let malec be { "", "", "", "" };
	if a random chance of 1 in 5 succeeds:
		now entry 1 of malec is entry 1 of randomcolorList;
		rotate randomcolorList;
	if a random chance of 1 in 5 succeeds:
		now entry 2 of malec is entry 1 of randomcolorList;
		rotate randomcolorList;
	if a random chance of 1 in 5 succeeds:
		now entry 3 of malec is entry 1 of randomcolorList;
		rotate randomcolorList;
	if a random chance of 1 in 5 succeeds:
		now entry 4 of malec is entry 1 of randomcolorList;
		rotate randomcolorList;
	say "     Andrew grins at your offer and pulls you in for a kiss. He strokes a paw across your face and nibbles at your ear. 'Oh, fuck... you're sure you want that? Because that's a really nice idea...! And I have a few of my own to make that happen, as well...' he says with his faintly feminine voice with considerable eagerness. Clearly the wolf is very turned on by the prospect of getting you nice and sticky, full of cum by numerous other men like that. The gay wolf gives you a kiss on the cheek, whispering, 'I'll be right back... Get ready while I'm gonna grab some guys to join us...' with a teasing tone as he gropes at your crotch, already hardening from the anticipation. Nodding to him, he then dashes out of the booth, committed to giving you a great time.";
	say "     While you wait for him to return, you remove your clothes, stripping down naked and sitting on the edge of the booth, and idly stroke your [Cock of Player] [if Cock Count of Player > 1]cocks[else]shaft[end if], already imagining the scene in your head. After a bit, you hear some excited chatter as Andrew comes back in, trailing behind him four other males. Looking at them you see that he brought a rather mixed group, and ready to go, judging by the bulges in their clothes. You beckon them closer and watch them strip off their clothes, eagerly getting naked to join the fun.";
	WaitLineBreak;
	say "     You see one a little more eager than the others, a rather endowed [entry 1 of malec][entry 1 of maletype] walk up to you and push his leaky cock in your face. Now that one has broken the ice, the others move in closer, a [entry 2 of malec][entry 2 of maletype] rubbing his swollen glans against your cheek. 'Mmm... put that tongue to work. Show us how well a cock-slut like you knows how to please.' Grinning widely, you eagerly start licking and kissing on his cock, slathering it with your tongue and sucking on his tip. Not to be outdone, the [entry 2 of maletype] pushes his shaft against your mouth, making you divide your attention between the two of them. You lick and suck on first one cock, then the other, moaning softly at the taste of their cockflesh and the pre that starts to flow from them. Grabbing them with your hands, you rub and stroke on their cocks when they aren't in your mouth, pleasuring them with skill.";
	say "     After a few minutes, you hear some whispers from Andrew and the other two males. With a quick motion you suddenly have the delicious cocks pulled from your mouth. Now that the [entry 1 of maletype] and [entry 2 of maletype] have been pulled back from blocking your sight, you can see who the others Andrew found are. Standing to the side of the [entry 1 of malec][entry 1 of maletype] is a [entry 3 of malec][entry 3 of maletype], with a big grin on his face and his hand on his friend's shoulder. Between Andrew and the [entry 2 of malec][entry 2 of maletype] is a [entry 4 of malec][entry 4 of maletype] eagerly awaiting his turn. Andrew leans in and licks your cheek, tasting some of the musky pre left there, and murring, 'How about you hop up on the table here, sweetie? Let all of us have a turn at you,' Andrew says in a lust-filled voice, patting one of the cum-stained tables.";
	WaitLineBreak;
	say "     You eagerly agree and spring up on the table, sitting on the edge of it and pulling Andrew in close. You draw him down and give him a kiss, feeling his girthy shaft hot on your [cock size desc of Player] rod[smn], taking his paws in your hands and placing them on your cocks, urging him to explore. Looking up from Andrew you crook your finger at the others, urging them in close. Reaching out you grab the erections of the [entry 3 of maletype] and [entry 4 of maletype] and you begin pumping your hands on them. You let out a moan as Andrew begins stroking his hefty meat against your [Cock of Player] erection[smn], keeping a tight grip on [if Cock Count of Player > 1]all of the[else]both of your[end if] throbbing cocks, frotting against you vigorously.";
	...
	say "     The first one to climax is the [entry 1 of malec][entry 1 of maletype], voicing out a loud moan as his thick cock throbs heavily before starting to soak you and the table in cum, a few shots even hitting the other males. This sets off a chain reaction as hot jizz starts flying onto you, the other three covering your body in their seed and soaking your face and body. You moan and suck and lick on the two spurting cocks in front of you, enjoying the taste of the thick cream.";
	WaitLineBreak;
	...
	say "     After everyone is spent, the [entry 1 of maletype] and [entry 2 of maletype] sit down in a booth of their own, cuddling and snuggling with each other. The other two sit down in the messy booth with you and Andrew, the four of you cuddling and groping one another. Andrew leans in with a smile and licks some of the mixed cum off your cheek. 'That was a lot of fun, sexy. Looks like you've turned into quite the cum-slut,' Andrew says with a smirk. 'We'll have to do this again sometime.'";
	NPCSexAftermath Player receives "OralCock" from Andrew;
...
to say AndrewSexAnal: [standard anal sex w/Andrew]
	say "     Andrew grins at your offer and runs his paws over your [bodydesc of Player] body with obvious lust. 'Mmm... I'm certainly up for some of that, sweetie. Now what exactly did you have in mind?' he says with his slightly feminine voice while walking a paw down to your crotch. 'I'm up for either top or bottom[if Player is female]. But if I top, I'd be taking your back door in, hon,' he says softly to make sure that'd be alright[else], sweetie. What do you feel like?' he asks while nibbling your ear[end if].";
	say "[line break]     [bold type]Do you want to fuck him or get fucked?[roman type][line break]";
	...
	if Player consents:
		...
		say "     As you fuck the wolf over the table, a few others around take notice for a little while but clearly aren't surprised or upset by it. Clearly a regular appearance, especially from the black wolf, they don't interrupt your fun together. A few other couples around do start up soon after though, adding to the experience. You pound him vigorously while stroking him off, your hand very slick from the copious amounts of precum running down his dick and pooling on the table. His inner walls rub over your sensitive shaft, moving and gripping around you to eventually drive you to a powerful orgasm that sends your hot seed deep into the gay wolf's asshole. Feeling your hot load filling him[if Ball Size of Player > 4] more and more as your oversized balls drain[else if Ball Size of Player is 4] as your large balls drain[end if], he howls in pleasure and cums hard, shooting his sticky load across the table and the back of the booth in another messy display. As his last shots are firing, he starts lapping up a big puddle of it within reach. After you pull out, he gives you a slobbery kiss that's rich with the taste of his semen and pats your ass in thanks for the nice fuck.";
		NPCSexAftermath Andrew receives "AssFuck" from Player;
	else:
		LineBreak;
...
to say AndrewDemonShow: [evil Brutus + Andrew]
	...
	say "     Having found a leather belt to use as a collar, you pull on the chain attached to it and bring him center stage, tying him to one of the poles as you quietly order him to obey the wolf, fuck the wolf hard but not to harm him. When you step back, Andrew grabs the demon's hefty orbs and rubs them in his paws before moving to stroke his stiffening rod. His tongue plays across it, licking its ridged, bumped surface before leaning in and sucking lustfully on it. Ever the exhibitionist, the wolf makes sure to position himself so his audience gets a good view of his tonguework and the oversized phallus he's worshiping. Copious amounts of pre leak from the dark, pulsing shaft which either gets lapped up or spread across the rod to get it slick.";
	WaitLineBreak;
...
[ You spot an opening near you if you want to join in on the orgiastic revelry.";
	if Player consents:	]
	WaitLineBreak;
	say "     The [entry 1 of malec][entry 1 of maletype] you approach pulls you into his arms, giving you a wet, sticky kiss that's heavily flavored by the cum of the guy he just finished blowing. You're treated to a slick mouthful of semen as his tongue pushes past your lips to play with yours. He wraps his hand around your [Cock of Player] shaft, stroking it as he pulls you into his lap. Caught up in the rush of the orgy, you eagerly lower yourself onto his prick, moaning in pleasure as it spreads your [if Player is female]pussy[else]ass[end if] open. He's rough and eager in his thrusting, pounding you hard and deep before finally cumming, filling you with his thick load. You push off him quickly and reach over for the pulsing [entry 2 of malec]cock of a nearby [entry 2 of maletype]. Soon you're sucking him off while another unseen male mounts you and fucks your [if Player is not female]creamy [end if]asshole.";
	...
	NPCSexAftermath Andrew receives "OralCock" from Brutus;
	...
	if humanity of Player >= 10:
		say "     The orgy is called to a halt as Harold strides up to you, horn aglow with white light, and shakes you roughly until you come to your senses enough to order the demon away. Andrew, having passed out some time ago, is a mess of sticky cum and reeks of male sex, though he has a grin of blissful pleasure on his muzzle. The debauchery comes to an end fairly quickly once the demon is gone, though several patrons have to be ousted by the bouncers when they won't settle down on their own. After he's wiped down, Andrew's slowly nursed back to his senses by several pints of his favorite black beer.";
...
to say AndrewBrutusShow: [cleansed Brutus + Andrew]
	...
	say "     After getting Brutus's pole well lubed up, Andrew stretches out on a raised platform and orders the demon to fuck him. The large demon, aroused and eager after the oral preparation, lunges atop the wolf, pinning him to the platform with a large hand on his chest and lining up his infernal rod with Andrew's hole. He holds back a second as the tip of his cock stretches Andrew's pucker wide around its girth, not actually wanting to hurt people during sex anymore, then quickly gets over that hesitation as the very experienced wolf takes his manhood without problem and moans for more. Andrew howls in lustful pleasure as the redeemed demon proceeds to take him hard, driving most of his cock into that sexy ass in one go and pushing in the rest on the second thrust. The black wolf's ebon cock throbs and pulses, spurting precum across himself as he's pounded into by your demon companion while a techno remix of Night on Bald Mountain plays.";
	WaitLineBreak;
	...
	say "     With you still standing on the edge of the stage, you get approached by a naked [entry 1 of malec][entry 1 of maletype] who pulls you into his arms, giving you a wet, sticky kiss that's heavily flavored by the cum of the guy he just finished blowing. You're treated to a slick mouthful of semen as his tongue pushes past your lips to play with yours.";
	say "[line break]     [bold type]Do you want to stay in the middle of this little orgy on the stage, or extricate yourself from the grasp of this pretty randy guy and join the crowd to just watch the show?[roman type][line break]";
