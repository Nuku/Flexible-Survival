...
to VRMindConditionCheck:
	if humanity of Player < 75:
		...
		if player is kinky:
			say "     [one of]Your legs refuse to move...[or]You're absentmindedly caressing yourself...[or]Sudden ecstasy is becoming a problem...[or]Your body wants to betray you...[or]You're starting to feel an urge to offer yourself to this place...[or]There is only dark lust in your thoughts...[at random]";
		else:
...
to say VRCreepyVisage: [Oh no.]
	...
	if player consents:
		...
		WaitLineBreak;
		say "     Then you find... Something... Something indescribable. Something that never crossed your imagination. Something... that definitely suggests...";
		WaitLineBreak;
...
to VRTPKinkyLoss:
	if demonologist is listed in companionList of Player: [Xaedihr is there]
		...
		if Player consents: [Both options will lead the player into a bad end, as they are eaten alive by the tendril plants/tentacle abominations]
			...
			if player is male:
				say "     You don't even think twice, grabbing your [cock of player] cock with one hand, which is fully hard and throbbing by now, and begin to rub it across the mushroom's [']shaft['], an exciting frotting that leaves you wanting for more. Unknowingly, you beginning to slowly drag your ass in and take the tip to poke at your pucker, right between your cheeks. It is a very big one, that mushroom you are caressing, and you are not sure you could ever take it in you, but it feels so good that you just want to let yourself go. In fact, the whole warmth and the pulses it makes is enough to send you into a lust frenzy, completely overtaken by the intoxicating scent that fills your nostrils with impossible ecstasy. You grind against it, over and over, as much as you can, non-stop... You feel so full of energy, so pumped up, that you could go for hours without stopping once. Maybe even days... Or weeks...";
			else:
				say "     You don't even think twice before you're rubbing [if player is female]your sex[else]your crotch[end if], which is, figuratively, burning with desire, against that big fat mushroom cock that keeps throbbing at the sight of your arousal, or so you would like to think. It seems to beckon you to get closer, and the sensation is incredible. Unknowingly, you beginning to slowly drag your butt in and take the tip to poke at your [if player is female]pussy, right between your legs[else]pucker, right between your asscheeks[end if]. It is a very big one, that mushroom you are caressing, and you are not sure you could ever take it in you, but it feels so good that you just want to let yourself go. In fact, the whole warmth and the pulses it makes is enough to send you into a lust frenzy, completely overtaken by the intoxicating scent that fills your nostrils with impossible ecstasy. You grind against it, over and over, as much as you can, non-stop... You feel so full of energy, so pumped up, that you could go for hours without stopping once. Maybe even days... Or weeks...";
