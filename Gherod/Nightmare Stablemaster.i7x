...
to NightmarishHorseBusinessStablemaster:
	...
	if Player consents:
		if Player is dominant: [a dominant player would never accept these terms]
			...
			WaitLineBreak;
			say "     Definitely not wanting to disappoint the Stablemaster, you put in your best efforts at pleasing him, continuing to use your hands to stroke him while trying to swallow as much of his cock as you can. Your throat's undulating walls as you pull that meat in are enough to put a smile on the dark horseman's muzzle, and he gives you a pat on the head as an encouraging gesture. 'Look at you now... Unable to think of anything else but my pleasure, ain't that right?' he asks, knowing very well the answer. Your entire focus is on his dick and in how good you can make him feel, and that is made obvious by the way you hungrily suck on that equine rod. 'Yeah, you'll find out that doing what the Stablemaster tells you feels really good... And it's better for everyone.'";
			...
			WaitLineBreak;
			say "     One thing, or rather two, that you see with relative ease is his big pair of balls swinging back and forth along with the momentum of each thrust, full and ready as he continues on skullfucking you. With this much energy, you can barely breathe except for those times he actually lets you, as you are forced to swallow that enormous cock every time it comes to greet your esophagus. Your throat is used like a fleshlight for who knows how long, until you gag on it and even tears run down your eyes... And he just continues, with a huge smile on his muzzle, his pleasure augmented by your struggle. 'This is how mares are handled around here, see? Them and little obedient studs, too. They just gotta ask to be owned by the Stablemaster...'";
...
Cunt Depth of Stablemaster is 0. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
...
to StablemasterSexWorship1: [continue down his legs]
	...
	say "     'Stand still, my slave. Just open your mouth now...' he tells you, as he has you look at him in the eye, which is a task made a bit difficult by the thick horsecock between the two of you. As you keep your mouth open, the horseman lowers his ballsack and pushes what he can of his full nuts in, your tongue doing its best to welcome them as you wrap your lips around their perimeter to the best of your abilities. Maybe you cannot get all of it, but you definitely want to try to get most of his balls worshiped as well. Though, just as you think he only intended to feed you his testicles, you sense his legs closing in around your head, trapping you with no way of getting those balls out of your mouth and face. You are forced to have your mouth wide open and face squished against his cum-filled orbs.";
	WaitLineBreak;
