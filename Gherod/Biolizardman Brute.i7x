...
to say BiolizardmanBruteLosesSitOnFace:
	...
	if Player consents:
		...
		if Player is female:
			CreatureSexAftermath "Biolizardman Brute" receives "OralPussy" from "Player";
		else:
...
to say TravelToCampOfTheSnakeEvent:
	...
	if Player consents:
		...
		if Player consents:
			...
			say "     Well, it is not like you can pull back from your decision now, so you simply decide to go along and allow the lizardman to lead you to the large temple you saw first upon entering the camp. During your way there, all the local lizardmen lay their eyes on you with visible lust. You even try to find one who does not pay attention to you, but every single one of them does, and all with the same kind of interest. Facing this awkward situation, you ask Sevik what is going on, given that every eye is on you at the moment. 'Oh, that just means it's working. Consider yourself lucky to have me on your side, or you would have been absolutely ravaged by now... Well, maybe that wouldn't be such a bad thing for yourself, but that's not what we're here for. Plenty of time to have fun later...!'";
			WaitLineBreak;
			...
			say "     Finally, the way ahead of you is free, so you walk inside with Sevik and... You cannot believe your eyes. What you see is yet another lizardman, but of gigantic proportions, sitting on an equally enormous throne, wearing nothing but golden jewelry adorning his limbs, torso and the very top of his head. This oversized jewelry consists of mostly golden chains, amulets and huge colorful gemstones that are extremely eyecatching, looking almost as radiant as his glowing scales of various colors. As the room is not very illuminated, only by some torches scattered through the side walls and corners, this light show is greatly visible and almost hypnotic, way more than any of the common lizardmen you have seen. Just looking at him is an experience, as your mind struggles to truly comprehend his magnificence with your eyes alone.";
			WaitLineBreak;
			...
			say "     'Ah, you're an explorer who happened to fight one of us, and they felt compelled to show you where we live in hopes to forge an alliance with an outsider. My... I have to commend his initiative. Perhaps a full day on my lap offering me worship... Though it is you I'm interested in at the moment. Why did Sevik take such interest in you as well?' You, quite frankly, have no idea. You did not even know they were so acquainted, to the point of addressing each other with no formalities attached. 'Sevik and I were dating back in the time before the apocalypse. We're in an open relationship. I assume he hasn't told you this?' Sevik coughs an excuse, 'Well, you see, I had to put up an act so this would seem more... credible to the others, right? But yes, that's true. I merely intended to ask Uzi to keep you around.'";
			WaitLineBreak;
