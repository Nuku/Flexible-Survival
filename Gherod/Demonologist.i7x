...
to HellRealmTheGrid:
	...
	if player consents:
		...
		if player consents:
			...
			say "     Glancing around, you also notice an adjacent room with the door open. Cautiously, you walk inside and lay your eyes on an empty machine, like those in the cells, however, this one's different, probably a prototype, even. There's still the straps and the pumpers, but it's hard to ignore the several moving tendrils around them, somewhat thick and moist at their smooth tips, with a fairly phalic shape. They seem to have noticed your presence, whatever they are, but they're not hostile. Instead, they seem to be slowly waving around... As if inviting you to take a seat... to touch them, feel them embracing your body, caressing you in every possible way, as you gave in to an eternity of pleasurable sensations...";
			WaitLineBreak;
...
to HellRealmRubyChamber:
	say "     With another dimensional voyage, you disappointingly land on another section of this Hell realm. He did save your life, however, so it isn't all that bad. The place you end up in is a very odd one, a large rocky corridor where you can see some sort of gem at the end, gleaming with an intense red light, connected to several fleshy stalks resembling neurons that pulse in the rhythm of a heartbeat. Hugging the walls, there are some nasty looking phalic tentacles coming from holes as big as someone of your size. 'I don't know what you did, but you managed to wash out all the security those bastards had put in this chamber, giving me the chance to steal what I came for. We have to be quick about this. With your help, we might be successful.' It doesn't look like he's asking for your assistance. Sounds more like he's demanding it.";
	Linebreak;
...
to HellRealmBadEnd1: [player is fucked by a single demon and wakes up later hooked up in a milking machine for eternity as a demon slave]
	say "     As you drop your guard looking up at the brute, towering over you with his snarky smirk, you know you're going to have a rough time when a powerful hand reaches over the back of your head and pushes you, forcing your lips to meet the already throbbing demonic dong eager to fuck you into submission. You have no choice but to open your mouth as much as you can, nearly dislocating your jaw as the demon's length is shoved past your tongue and straight deep into your throat. The demon says nothing, only grunting confidently as he facefucks you hard, his sizeable balls bouncing back and forth, hitting your chin with every thrust.";
...
to HellRealmBadEnd5: [player is dragged by the tentacle traps and eaten alive]
	...
	WaitLineBreak;
	say "     Though this luxurious treatment doesn't come without a consequence. As you're stripped off your freedom of action and thoughts, reduced to a plaything for a demonic tentacle beast, there's no way to escape your inevitable fate. While you're being pulled deeper into the darkness of Hell, your begin losing your senses. Its members are much wider here, enough for you to fit in. It doesn't take too long as you feel something viscuous and slimy sliding by your head over to your neck, as you're feeling yourself being pulled deeper into one enormous pulsing fleshy tunnel. You struggle to realize what's happening to you as your entire body is taken by the beast, having slurped you down to your torso, then to your legs, until only your feet remained outside.";
...
to say XaedihrHandjob:
	...
	WaitLineBreak;
	say "     'Aah... Keep going...! Fuck yes! I'm cumming!' he almost shouts, his thick foot-long manhood starting to harden to its peak and throbbing with antecipation. You know it's going to be a huge load as you see the significant first signs of cum oozing out of his slit, sliding down to your fingers. 'Fuuuuck yeah! Take it!' he moans, as loud as he's to shoot hard, and within moments, a great deal of jizz lands right on you with surprising force. He keeps going, thick and generous spurts of cum, one after the other, covering your chest and even your face while his long orgasm lasts. He's not even looking, his eyes are closed and he's biting his lips as he unknowingly covers you in his half-demon seed.";
