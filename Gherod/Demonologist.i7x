...
to say XaedihrSexMenu:
	...
	if Player is male and loyalty of Xaedihr > -1 and demon brute is listed in companionList of Player and DemonBruteStatus is 0 and (DBCaptureQuestVar is 6 or DBCaptureQuestVar is 7):
		...
		now sortorder entry is 7;
		now description entry is "Have a three-way with the half-demon and your demon brute companion";
	[]
	sort the table of fucking options in sortorder order;
	repeat with y running from 1 to number of filled rows in table of fucking options:
		choose row y from the table of fucking options;
...
to XSubmitTentacleEdging:
	...
	if player consents: [player begs and gets to cum the good way]
		...
		if player is male:
			...
			say "     But Xaedihr is not stopping. His hand is still caressing your parts, even after you've had your pleasure, and you start getting worried once his touch shifts to focus on your oversensitive clit. 'What's wrong? You didn't ask me to cum, so I figured you weren't satisfied yet...' he teases you with a devilish grin as his fingers rub and torture your pleasure spot, the sensation being so unbearable, making you involuntarily struggle against the tendrils holding you firmly in place, that you're forced to scream at the top of your lungs after a couple of minutes, begging him to stop! It's only when a tear escapes your eyes that he stops abruptly, to your relief.";
		else:
...
instead of navigating Grey Abbey Library while (Xaedihr is in Grey Abbey Library and resolution of Xaedihr Experiments > 0 and resolution of Xaedihr Experiments < 3 and a random chance of 1 in 5 succeeds):
	...
	say "     Maybe it's best to leave him focus on whatever he has discovered thanks to your advice. You simply dismiss yourself and head back to the Library's main area. Xaedihr doesn't even see you go.";
