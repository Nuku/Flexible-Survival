...
When Play begins:
	...
	now HP entry is 1000; [ How many HP has the monster got? She's not too hard- she doesn't want to win so much as not lose]
	now lev entry is 25; [ Level of the Monster, you get this much HP if you win, or this much HP halved if you loose ]
	now wdam entry is 75; [Amount of Damage monster Does when attacking. Claws and massive strength]
