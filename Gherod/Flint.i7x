...
Virgin of Flint is true.
AnalVirgin of Flint is false.
PenileVirgin of Flint is false.
SexuallyExperienced of Flint is true.
TwistedCapacity of Flint is false. [Twisted Characters can take any penetration, no matter the size]
Sterile of Flint is false. [steriles can't knock people up]
MainInfection of Flint is "Cougar".
The description of Flint is "     Whenever you get his attention, his ample ears give out a twitch as they turn towards you, and his amber eyes lock gaze on yours with a smile. Looking at the feline man, you know him to appear as an anthropomorphic cougar with brown fur all around, lightening up to a cream color in the torso and belly areas. He is tall and well-built in a slender but powerful way, sporting a good mix of agility and might like a true feline. During his tasks around the farm, he can be seen wearing his dark blue handyman jumpsuit, which has a hole behind his rear to allow his furred long tail to pass through and wave freely.[line break]".
...
instead of conversing Flint:
	if Flint is in Barn Hayloft:
		...
		say "     When you approach the cougar, he takes a while to notice your presence, quickly turning his face towards yours. Politely, he nods and smiles as if greeting you in silence, while chewing on some food. The feline has manners.";
		...
		if Loyalty of Flint is 1:
			...
			say "     Not even amidst his work is the handyman cougar closed to a conversation. He interrupts his current task for a while to look back at you, greeting you politely. 'Do you need anything? Any help with the machines?' he asks, as his attention remains divided by the mechanism at his hands and you.";
	say "[line break][FlintTalkMenu]";
...
to say FlintTalkMenu:
	...
	if Energy of Flint > 0:
		...
		now description entry is "Inquire about his job";
		[]
		if Energy of Flint > 1 and Flint is in Barn Hayloft:
			choose a blank row in table of fucking options;
			now title entry is "Have a sex talk";
			now sortorder entry is 3;
			now description entry is "Bring up the subject of sex to the cougar";
	[]
...
to say FlintTalkJob:
	if Energy of Flint is 1:
		...
		if Player consents:
			LineBreak;
			say "     The cougar smiles at your response, feeling the excitement in both his expression and voice. 'That's great! Usually I worry about boring people with this stuff... But I'm glad we have that in common. So... whenever you find yourself at the Milking Shed during my shift, I could show you around,' he says, seeming happy for having you here. Perhaps you could pass by during the afternoon and catch him there. Surely he would appreciate your effort.";
...
to say FlintTalkSex:
	if Libido of Flint is 0:
		say "     Now that you are in relative privacy, and after having talked a bit already, you figure this would be a good time to bring the subject of sex to the cougar. He doesn't seem to mind it, albeit you have already noticed he's more reserved than most regarding shared intimacy. The real question is, how open he really is to having sex... to which he has an answer for. 'Not as open as most, I admit. The last time I let my guard down already gave me enough trouble...' he says, hinting at his current appearance to further solidify his position. 'I honestly don't know how I made it out... with that large cougar man pouncing at me... He had me pinned down, then proceeded to violate my ass without mercy, saying he'd make me his...'";
		...
		say "[line break]     [bold type]Do you want to delicately push the subject and perhaps attempt to have him see other ways?[roman type][line break]";
		...
		if Player consents: [Actively help Flint overcome his fears]
			...
			say "[line break]     [bold type]What is your next move?[roman type][line break]";
		...
		say "     Now that you are in relative privacy, you figure this would be a good time to bring the subject of sex to the cougar, after your previous [if Libido of Flint is 1]conversation. 'Still working things out in my mind. I'm not exactly sure what to think, yet... But...' he gives you a hesitating look, before shrugging and shaking his head. 'I... I think I just need a little while longer,' he finishes, with a forced comforting smile, which is actually a bit unsettling. Something is holding him back on this matter, but for now, you don't insist[else]conversations and interactions. 'I actually never thought I'd feel so free... It still bothers me to think about what could have happened if the dude actually fully turned me, but what's done is done. Besides, I think it's way more fun doing it with you...' he replies, chuckling by the end. It seems he's doing well, and actually enjoys your company[end if].";
...
instead of fucking Flint:
	if Libido of Flint is 0:
		...
		say "     Flirtatiously, you give the cougar a suggestive look as you slowly approach him, but sadly, he has to refuse you. 'I'm still worn out from our last time... though I'd be glad to do it another time, again,' he explains, gently patting your shoulder.";
	else:
		...
		say "[line break]     What will you want to do with the farm's handyman?";
		now sextablerun is 0;
		blank out the whole of table of fucking options;
		[]
		choose a blank row in table of fucking options;
		...
		while sextablerun is 0:
			...
			if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
				...
				if Player consents:
					LineBreak;
					now sextablerun is 1;
					if title entry is "Blow the cougar":
...
to say FlintFirstSex:
	...
	NPCSexAftermath Flint receives "Stroking" from Player;
...
an everyturn rule:
	if time is post midnight: [midnight]
		if player is in Barn Hayloft:
			say "     [if PlayerMet of Flint is true]Flint[else]the handsome cougar[end if] seems to be sleeping at this time, in his hay bed. He left his jumpsuit on a short hanger he placed nearby, and has a blanket covering his now naked furred body.";
	else if time is pre dawn: [pre dawn - Flint wakes up]
		if Player is in Barn Hayloft:
	...
	else if time is early morning: [early morning - grabbing breakfast]
	...
	else if time is morning: [mid-morning - starts maintenance on milking shed]
	...
	else if time is afternoon: [noon]
	...
	else if time is evening: [mid afternoon - returns from work]
		if Player is in Milking Shed Main and Flint is in Milking Shed Main:
			say "     [if PlayerMet of Flint is true]Flint[else]The maintenance cougar[end if] is just finishing up his work on the machines. Then, he is seen grabbing his tools and stuff, then takes his leave. The guy must be tired from working all day... Perhaps you'd find him at the hayloft, where he retires at the end of his shift.";
		else if player is in Barn Hayloft:
			if Flint is not in Barn Hayloft:
				say "     [if PlayerMet of Flint is true]Flint seems to have arrived from his workshift, walking past and greeting you with a smile[else]The anthro cougar and handyman of the farm seems to have arrived from his workshift, walking past you and greeting you with a polite nod[end if]. He looks really tired after working all day, given the fact he immediately goes to take a seat on one of the piles of hay, arranged to look like a comfortable couch, and leans back. Finally, there he is, just relaxing with the straps of his jumpsuit taken off his shoulders and hanging freely on the sides.";
			else:
				say "     Inside, you see [if PlayerMet of Flint is true]Flint[else]the handyman anthro cougar[end if] taking some time to relax after a full day of work. He took another dose of canned food to munch on while seeming lost in thought, sitting on a pile of hay that was arranged to serve the purposes of a comfortable couch. It is pretty quiet in here, and he must like the relative peace of this place, judging by how relaxed he looks. Sometimes he closes his eyes and nearly falls asleep.";
		now Flint is in Barn Hayloft;
	else if time is early night: [evening]
		if player is in Barn Hayloft:
			say "     Inside, you see [if PlayerMet of Flint is true]Flint[else]the handyman anthro cougar[end if] taking some time to relax after a full day of work. He took another dose of canned food to munch on while seeming lost in thought, sitting on a pile of hay that was arranged to serve the purposes of a comfortable couch. It is pretty quiet in here, and he must like the relative peace of this place, judging by how relaxed he looks. Sometimes he closes his eyes and nearly falls asleep.";
	else if time is night: [early night]
		if Player is in Barn Hayloft:
			if sleeping of Flint is false:
