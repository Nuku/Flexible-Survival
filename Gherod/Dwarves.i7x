...
to say YogdrakRoamingTalk:
	...
	if player consents:
		LineBreak;
		say "     You share some words with eachother for a while, in all what is a pretty nice conversation. Speaking with a former enemy whom you've just befriended fills you with hope and boosts your sanity by a little.";
		SanBoost 10;
		now combat abort is 1;
	else:
		LineBreak;
