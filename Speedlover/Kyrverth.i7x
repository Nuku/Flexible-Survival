...
to say KyrverthTalk: [Quest turnin check]
	...
	if (SilverToken is 1 and KyrverthStage is 0 and KyrverthQuestGiven is 1): [Quest one end]
		...
		if player consents:
			...
			LineBreak;
			say "     As the roar echoes in the distance and slowly fades into the eerie silence of the old city, Kyrverth lets out a yawn and curls up in his nest to nap - Apparently worn out by his growth.[line break][line break]You pick up your things and quietly leave, treading carefully so you don't wake him up.";
			LineBreak;
...
to say KyrverthNormalChat: [Quest give and normal chat]
	if KyrverthQuestGiven is 0 and (KyrverthTimer - turns >= 6): [Quest give]
		if KyrverthStage is 0:
			...
			say "     'You're willing to help me out again? Awesome! A proper dragon would defeat some [bold type]knights[roman type] and hoard their armor, but they wont come to me and there are some pretty [one of]scary[or]dangerous[at random] monsters between here and there so I can't go to them, could you bring me back [bold type]3 bits of their chainmail?[roman type]'";
		else if KyrverthStage is 2:
...
to say KyrverthMainChat:
	...
	if randomnumber <= 5:
		...
		if ((cocks of player >= 1 and KyrverthMaleBoning is 0) or KyrverthStage is not 3):
			...
			say "     'How's about you and I have some fun?' Kyrverth's hand strays toward his vent and strokes it a few times, showing the tip of his massive cock 'I've been wanting to make some eggs...'";
...
to say KyrverthS5Chat:
	let randomnumber be a random number from 1 to 3;
	if randomnumber is 1:
		say "     'If I catch that fucking thief, [one of]its going to be barbeque time[or]I'm going to get myself some justice[at random].'";
	else if randomnumber is 2:
	...
	if randomnumber is 1:
		say "     Realizing how sad Kyrverth is to have lost his favorite item, you wonder whether you should [bold type]Give the artifact back[roman type].";
...
to ResolveKyrverthItemEvents: [One is completed, this will resolve all four so players cannot get more than one artifact]
