...
to say KyrverthMainChat:
	...
	if randomnumber <= 5:
		...
		if ((cocks of player >= 1 and KyrverthMaleBoning is 0) or KyrverthStage is not 3):
			...
			say "     'Hows about you and I have some fun?' Kyrverths hand strays toward his vent and strokes it a few times, showing the tip of his massive cock 'i've been wanting to make some eggs...'";
...
to say KyrverthS5Chat:
	...
	if randomnumber is 1:
		say "     Realising how sad Kyrverth is to have lost his favorite item, you wonder whether you should [bold type]Give it back[roman type].";
...
to say KyrverthS6Chat:
	...
	if randomnumber <= 5:
		...
		if a random chance of 1 in 5 succeeds:
			say "'I used to be a sculptor. People always made fun of me - my height, my looks, but they never made fun of my sculptures. They were the bees knees for a while, I was one of the top scuptors in the city! I was just delivering a sculpture when this all kicked off, and I think it might have affected me. I'm still myself though, so I have to be thankful for that I suppose.'";
		else:
			say "     'I used to be a sculptor. People always made fun of me - my height, my looks, but they never made fun of my sculptures. I was just delivering a sculpture when this all kicked off, and I think it might have affected me. I'm still myself though, so I have to be thankful for that I suppose.'";
...
carry out KyrverthItemReturn:
	if Racing Horseshoe is owned or Racing Horseshoe is present or Anubis Mask is owned or Anubis Mask is present or Golden Sculpture is owned or Golden Sculpture is present or Tiger Suit is owned or Tiger Suit is present or Black Pearl is owned or Black Pearl is present:
		...
		if player consents:
			say "     'YOU TOOK IT? I thought you were my friend!' He goes as if to hit you, but a quick scream of 'WAIT!' gets you a seconds reprieve. You explain that you took it because of his huge ego, and you are returning it in the hope he can keep his instincts more under control this time. You reach into your pack and manage to pull the [KyrverthItemSay] out without being interrupted this time. His eyes wide Kyrverth grabs it. 'Come back in 24 hours. I will do my best to forgive.' Incredulous at your luck you quickly turn around and leave, walking quickly along the street. A loud roar from behind catches you by surprise and you are saddened by not being able to see the growth this time, but you keep walking.";
			if Kyrverthitemget is 1:
...
to say tigersuituse:
	...
	if player is submissive:
		...
		say "but a strange feeling energy enters the suit and causes it to shiver from it's toes to it's head. Slowly [run paragraph on]";
