...
Description of Bronze Crab is "     The bronze crab is a true giant, effortlessly straddling the street on eight legs that hold it far enough up to comfortably walk underneath - or drive a car through. Studying the shining statue, you are surprised at just how elaborate it is, the metal formed into countless little details on every surface. Small bumps and ridges, and all that. As you are studying it, the colossal crustacean actually moves in turn, slightly shifting its legs and swiveling eyestalks to focus on you. After a few seconds of what seems to be intent studying, it turns its attention back towards the city approach.[line break]".
fuckscene of Bronze Crab is "     Amorous thoughts fill your mind, and you step closer to one of the giant crab's legs to... rub up against it? Climb on it? Whatever it was, you are stopped cold by a huge pincer, closing around your midsection to hold you firm. With carefully meted-out force (to not accidentally snap you in half), the crab picks you up and sets you down outside the plaza, releasing its grasp there. You hear some clicking noises and see it gesture towards the city, although it doesn't seem to mind that you walk back to the plaza - without trying to have sex with it this time.[line break]".
...
Description of Restaurant is "     The restaurant is an interesting combination of high-class and casual that seems to work, at least in your opinion. There are tables scattered throughout the building with some up against the wall and under windows that are open at the moment. In the back end of the food establishment is a bar with stools lined up to allow people to order their alcohol whenever they want it. Overall it's a very nice place.[line break]".
Scent of the Restaurant is "     The restaurant smells of hamburgers, french fries, and many other kinds of foods, something that makes your stomach rumble.".
...
Scent of Public Beach is "     The salt in the air is reminiscent of high tide at the beach.".

after looking while player is in Public Beach:
	project the Figure of Map_Beach_7_icon;

to say PublicBeachDesc:
	say "     Filling the interior of a cliff-flanked bay, the broad public beach of the city is quite pretty, with lightly colored, almost white sand. At the spot you are right now, the cliff face rises sharply and one can see the edge of a wooden platform above, flanked with a broad railing that various people lean on to enjoy the view. A series of stairways snake their way [link]up[end link] the cliff, and along the way is a nice little snack bar, situated in a cave hewn into the rock face. You can reach the snack bar by walking up the first set of stairs in the [link]northeast[end link]. The coast goes on in the [link]southeast[end link], although it looks a bit rocky and less nice that way, and towards the [link]west[end link] one reaches the other end of the bay's bordering cliffs, with the beach curving around to meet them in the [link]southwest[end link]. Just [link]south[end link] is the shallow and calm water of the bay, perfect to bathe in.";
	if daytimer is day:
		say "     There are many people having fun on the beach, having brought with them countless towels and parasols that are scattered all over the place. There is even a volleyball net set up, with a match going on right now! You can't help but chuckle at the sight of all those people in their transformed shapes relaxing in the sun and having a good time. Looks like even in the midst of the nanite apocalypse, everyone can't help but like and enjoy the beach. A small lifeguard's tower is set up in a central position on the beach, from where a large hunk of an orca in red shorts keeps an eye over the situation all around. Sun, beach games and sandcastles - this really looks like a nice place to hang out...";
...
Description of Shallow Bay is "     You're swimming (standing, in some places) in the nice and shallow water close to the public beach of the city. It is a nice area for a relaxing swim, without too many waves, as those mostly break further out to the south, where a series of rocks jut out of the depth. The ocean gets deeper that way fairly quickly, and you don't think it'd be healthy to swim that way on the best of days. So maybe just enjoy your refreshing bath in this part of the bay, before going back on land in the [link]east[end link], [link]north[end link], [link]northwest[end link] or [link]west[end link].[line break]".
earea of Shallow Bay is "Beach".
Scent of the Shallow Bay is "     You sniff around, and since the ocean water is almost sloshing into your nose, there is little wonder that you smell salt.".
...
Description of Dirty Sheds is "     Set a way back from the beach in a narrow ravine, the row of dilapidated sheds were used to store things like lifesaving equipment and other stuff. Now the overlong grass makes it nearly impossible to open the doors, besides big rusty padlocks holding them shut on top of that. One seems to have been broken into, however, the door hanging off its hinges and ransacked interior barely visible. Between two of the sheds there is one oddity: a path [link]north[end link] has been worn into the overlong grass.[line break]".
earea of Dirty Sheds is "Beach".
Scent of the Dirty Sheds is "     The whole place smells of wet wood and moss, not a very appealing scent if you're honest.".
...
Scent of the Rocky Cliff is "     The place smells of the ocean mixed with an earth scent, something that you attribute to the cliffs.".

after looking while player is in Rocky Cliff:
	project the Figure of Map_Beach_12_icon;

to say RockyCliffDesc:
	say "     The western end of the rocky cliffs flanking the beach in this little bay is a lot more jagged and uneven than further [link]east[end link]. They lack the nice flat top too, so there are no buildings on top either. A number of large rocks poke out through the sand as well, breaking up the usable area, and some outcroppings create what almost seem like little caves. To the [link]north[end link], a narrow ravine cuts into the cliff face, and you don't doubt that during storms, water will come pouring out of that, while [link]south[end link] of here, the curving beach and cliff meet and both end together, with nothing but the deeper waters beyond. If you do want to go swimming, the [link]southeast[end link] is much nicer, with its shallow and calm waters.";
...
Description of BeachEnd is "     The sand here curves sharply towards the cliffside, meeting it a little further south, just where the cliff actually ends in the ocean. Beyond, the water gets deeper quickly, and numerous craggy rocks stick out of the ocean, constantly thrashed by crashing waves. That looks like a rather unhealthy area to get into the water - but wait, at one spot, there is a kind of coral-encrusted arch allowing passage through the rocks. Maybe you could brave the ocean after all and swim that way? Of course, if you just want to get wet, why not head [link]east[end link] instead - inside the bay, the waters are shallow and much calmer. Otherwise, you can head [link]northeast[end link] to the public beach or [link]north[end link] to the foot of the rocky cliff where it gets much taller and more jagged.[line break]".
BeachEnd is southwest of Public Beach.
BeachEnd is a room with printed name "End of the Beach".
earea of BeachEnd is "Beach".
Scent of the BeachEnd is "     All you can smell out here is the strong scent of the ocean.".
...
Description of Rock Arch is "     You're in the ocean close to the coast, right where the water gets deeper than the relatively shallow bay closer to the public beach. Jagged cliffs rise up in the north, northwest and west, while a large arch of weathered rock stretches over the sea in the southern directions. It allows passage through the choppy waters and jagged rocks that otherwise cut the bay off from the open ocean. By passing through there, you would be able to move to and from the deeper reaches of the sea. Through the arch and to the [link]south[end link], you can see a shadowy shape beneath the water. Looks like a sunken ship, its broken mast helping you distinguish the shape. There's a [bold type]shipwreck[roman type] to explore! Of course, out there in the open sea, you'd really have to swim against the waves and currents to get to it.[line break]".
Scent of the Rock Arch is "     All you can smell out here is the strong scent of the ocean.".

after looking while player is in Rock Arch:
	project the Figure of Map_Beach_14_icon;

after going to the Rock Arch for the first time:
	try looking;
...
Description of Open Ocean is "     Below you is a large sunken ship, and you can see multiple underwater creatures swimming around the submerged vessel. If you needed to you could go [link]down[end link] there but you would need some way to breathe. Of course, if you decide against that then there is the rock arch to the [link]north[end link]. You could always swim back.[line break]".
...
Description of Sunken Ship is "     A large ship lies sunken and rotting here. From the breaks in the old hull, it seems the ship ran afoul of the rocky waters and went down long ago. It is now an attraction for divers and sea creatures alike. Maybe going here was a bad idea. There is a cloudy mess of thick seed hanging in the water and stuck to part of the ship, tribute to some huge beast. You'd best be careful. Although in the distance to your [link]west[end link] you can see a sparkling sight. From here, you can barely make out the lighter spot in the rocks that is the [bold type]rock arch[roman type] you passed through to get here. You could surface and swim to it if you want to get back to the beach.[line break]".
...
Instead of examining the Church Notice Board:
	say "     Covering the notice board are many scraps of paper, most worse for wear. But at the same time most seem relatively new. Huh? Guess paper is a tad hard to come by. Most of them seem to be personal ads. Should those be on a church notice board?!";
	say "     Anyways, here are a few that catch your attention:[paragraph break]";
	repeat through Table of board entries:
		say "[entry text entry][entry trigger entry][line break]";

There is a Confession Booth in the Church Hall. "Standing against one wall, the dark wood of the large confession booth catches the eye. It has been modified to allow even a large creature such as those Panther Taurs to fit inside.". It is Rooted in place.
Scent of the confession booth is "     It smells faintly of incense and arousal from the various creatures who have been within it.".

instead of examining the confession booth:
	say "     It's quiet and nondescript; perhaps you should try to [link][bold type]enter[roman type][as]enter confession[end link] it and confess, or just talk to whomever is inside?";
			...
			if Player consents:
				...
				if title entry is:
					-- "Ask about the church":
						say "[ChurchQuestion]";
					-- "Confess your sexual needs":
						say "[ChurchLustConfess]";
					-- "Ask about the possibility of freeing a demon of his inner evil":
...
to say ChurchQuestion:
	...
	say "     'This is the place of the Great Mother, the Church of the Maternal Beast. Following her will, we have repurposed this place to try and help those who suffer under the weight of the infection that runs rampant in the city. We try to offer peace and comfort, and to help others learn that while overwhelming, it does not need to control you.'";

to say ChurchLustConfess:
	say "     You hear a soft sigh. 'Indeed, you speak of one of the most dangerous aspects of the infection, for it leads towards losing yourself. Please just listen, and I will attempt to help you overcome its controlling nature.'";
	if lastconfession - 7 > turns:
		...
		lower Player Libido by 15 + a random number from 1 to 10;
		now lastconfession is turns;
	else:
		say "     Unburdening yourself again, you sadly discover it has little effect as you have nothing to add since your last confession.";
