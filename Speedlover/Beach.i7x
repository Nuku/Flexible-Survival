...
to say BeachPlazaDesc:
	say "     Quite different from the dirty, ill-kempt streets of the city you know, the plaza you are standing upon presents itself in a sunny scene. It is fairly large, open and relatively clean, with a boardwalk extending toward the [Bold Type]west[roman type]. You can see a wooden railing in the distance there, with the sea visible beyond that. Remembering the layout of the beach from previous visits, you know that there is a sharp cliff that way, with stairs leading [Bold Type]down[roman type] to the public beach and the rest of the coastline. To the [Bold Type]north[roman type] is a church, its wide doors open and inviting.";
...
to say BoardwalkDesc:
	say "     The broad boardwalk you are standing on extends for a fair bit, starting at the beach plaza to [Bold Type]east[roman type] of your position and leading to the edge of the beachside cliffs just [Bold Type]west[roman type] of here. A wooden railing makes sure no one falls over the edge while they enjoy the view of the open ocean and the beach and coastline at the foot of the cliff. A set of broad stairs lead [Bold Type]down[roman type] to the beach, twisting back and forth as they descend the rock wall. Meanwhile, small stores flank the boardwalk up here, although from what you can see they are almost uniformly closed. Apparently most now house people who are living in them, no doubt fled from the city to this halfway peaceful area.";
...
to say ShallowBayDesc:
	say "     You're swimming (standing, in some places) in the nice and shallow water close to the public beach of the city. It is a nice area for a relaxing swim, without too many waves, as those mostly break further out to the [Bold Type]south[roman type], where a series of rocks juts out of the depth. The ocean gets deeper that way fairly quickly, and you don't think it'd be healthy to swim that way on the best of days. So maybe just enjoy your refreshing bath in this part of the bay, before going back on land in the [Bold Type]east[roman type], [Bold Type]north[roman type], [Bold Type]northwest[roman type] or [Bold Type]west[roman type].";
...
to say WildFringeDesc:
	say "     The [Bold Type]southeastern[roman type] fringe of the public beach gets more and more rocky as one goes along. Seems a bit more exposed too, so you assume that the highes tides in a given month might actually soak the area and send waves slapping against the cliff just behind the strip of sand. Scattered pieces of driftwood and a little plastic trash does support the theory too. Overall, this section of the beach looks a bit dishelved, explaining why many beachgoers tend to avoid coming this way. Further towards the [Bold Type]northeast[roman type], the coastline gets a little bit nicer again, with the cliff getting lower and actual dunes visible between it and the ocean, but that also brings more exposure to wind, explaining why all of the development of the beach is to the [Bold Type]northwest[roman type].";
...
instead of sniffing the Wild Fringe:
	say "     The scent of salty water hangs in the air, although a gust from the [Bold Type]southeast[roman type] has a different undertone. Smells... yeah, like sex.";
...
to say RockyCliffDesc:
	say "     The [Bold Type]western[roman type] end of the rocky cliffs flanking the beach in this little bay is a lot more jagged and uneven than further [Bold Type]east[roman type]. They lack the nice flat top too, so there are no buildings on top either. A number of large rocks poke out through the sand as well, breaking up the usable area, and some outcroppings create what almost seems like little caves. To the [Bold Type]north[roman type], a narrow ravine cuts into the cliff-face, and you don't doubt that during storms, water will come pouring out of that. [Bold Type]south[roman type] of here, the curving beach and cliff meet and both end together, with nothing but the deeper waters beyond. If you do want to go swimming, the [Bold Type]southeast[roman type] is much nicer, with its shallow and calm waters.";
...
to say BeachEndDesc:
	say "     The sand here curves sharply towards the cliff-side, meeting it a little further [Bold Type]south[roman type], just where the cliff actually ends in the ocean. Beyond, the water gets deeper quickly, and numerous craggy rocks stick out of the ocean, constantly thrashed by crashing waves. That looks like a rather unhealthy area to get into the water - but wait, at one spot, there is a kind of coral-encrusted arch allowing passage through the rocks. Maybe you could brave the ocean after all and swim that way? Of course, if you just want to get wet, why not head [Bold Type]east[roman type] instead - inside the bay, the waters are shallow and much calmer. Otherwise, you can head [Bold Type]northeast[roman type] to the public beach or [Bold Type]north[roman type] to the foot of the rocky cliff where it gets much taller and more jagged.";
...
"The Church would like to issue a warning to all roaming the district at night. Strange flickering green light has been seen behind the sheds [Bold Type]north[roman type] of the beach. It is advised no one visit this area."	"[hellhoundtoggle]"
