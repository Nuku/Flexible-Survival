...
to LibrarySexEvent:
	if (demon brute is companion of player and CollegeLibraryBrutusEncounter is 0):
		...
		if randomnumber is:
			-- 1:
				say "      As you wander between the rows of bookshelves, you hear feminine giggles coming from the alley on the other side of the shelf.[Line Break]'Ha ha... S-stop, the-the librarian w-will hear us,' one of them whispers.[Line Break]'She will hear [italic type]you[roman type]. Keep these legs spread.'";
			...
			-- 2:
				say "As you wander between the rows of bookshelves, you hear a pair of female moans coming from the alley on the other side of the shelf.[Line Break]'F-fuck. It feels s-so good.'[Line Break]'Y-yeah. Keep going.'";
				say "      [bold type]Do you wish to investigate?[roman type][line break]";
				LineBreak;
				say "     ([link]Y[as]y[end link]) - Curiosity has not killed you (yet).";
				say "     ([link]N[as]n[end link]) - Lesbian sex is not your thing.";
			...
			-- 3:
				...
				if player consents:
					...
					LineBreak;
					say "     You resume your reading, doing your best to ignore the vibrating noise. Eventually, the student leaves in a hurry, the buzzing going away with [if Girl is banned or Girl is warded]him[otherwise]her[end if] .";
			-- 4:
...
to CollegeLibraryBJ:
	say "You quickly check a nearby bookshelf and take the latest volume of your favorite magazine to the reading table for a read. Taking a seat, you then and find yourself in front of a horse. The equine looks absorbed by his lecture more than one would usually be: his head is lowered on the table, straight on his book, and he is strangley panting. But he is calm, so you open your magazine and start reading.";
...
to BrutusLibraryEvent:
	...
	if player consents:
		...
		if DBCaptureQuestVar is 5:
			say "     You stumble upon Brutus, busy plowing a [if Girl is not banned and Girl is not warded]male[otherwise]female[end if] student from behind. The poor [if Girl is not banned and Girl is not warded]stallion[otherwise]mare[end if]'s feet dangle over the ground, [if Girl is not banned and Girl is not warded]his[otherwise]her[end if] legs balancing with each slam of the demon's package inside of [if Girl is not banned and Girl is not warded]his[otherwise]her[end if]. Brutus holds [if Girl is not banned and Girl is not warded]his[otherwise]her[end if] torso with one arm, while his free hand is pressed against [if Girl is not banned and Girl is not warded]his[otherwise]her[end if] mouth, fingers slipped deep inside her muzzle, and muffling the loud neighs escaping from [if Girl is not banned and Girl is not warded]his[otherwise]her[end if] mouth. 'Dumb slut,' you hear him mumble. 'Told you I'd win.' After an additional minute of thrusting, Brutus's grunts get louder, and he unloads his balls inside the student, [if Girl is not banned and Girl is not warded]his[otherwise]her[end if] belly bulging out visibly from the sheer quantity of demonic sperm.";
			say "     Brutus pulls out, his claws twitching as if to drop [if Girl is not banned and Girl is not warded]him[otherwise]her[end if] like a piece of trash - but the amulet around your neck hums a little and enforces the rule of not hurting anyone without cause that you set for him. With a slightly annoyed grunt, he sets the student on the ground slowly, [if Girl is not banned and Girl is not warded]his[otherwise]her[end if] clothes in tatter. Waving him to the side, you inquire what happened happened and Brutus shows a broad grin, nodding to the cum-dripping young equine. 'Bitch started to get bossy. 'Be quiet! This is a library!' Bla bla bla. Hah - told [if Girl is not banned and Girl is not warded]him[otherwise]her[end if] I would fuck [if Girl is not banned and Girl is not warded]his ass[otherwise]her pussy[end if] and no one would notice and come to help. And I did!' Shaking your head, you pull Brutus with you and get away from the scene as fast as you can.";
		else:
			say "     You stumble upon Brutus, busy plowing a [if Girl is not banned and Girl is not warded]male[otherwise]female[end if] student from behind. He is gently holding the [if Girl is not banned and Girl is not warded]stallion[otherwise]mare[end if] over the ground with both arms, while he pumps inside [if Girl is not banned and Girl is not warded]him[otherwise]her[end if] in a slow, but deep rythmn. The two of them are locked in a deep kiss, partly in order to quell their moans of pleasure. 'We're winning,' Brutus grins. 'You- you're still on this?' the student answers between two stiffled moans. The two go at it for another minute or so, until Brutus's grunts get louder, and he unloads his balls inside the student, [if Girl is not banned and Girl is not warded]his[otherwise]her[end if] belly bulging out visibly from the sheer quantity of demonic sperm.";
			say "     Brutus pulls down the horse gently, letting [if Girl is not banned and Girl is not warded]him[otherwise]her[end if] get [if Girl is not banned and Girl is not warded]his[otherwise]her[end if] bearings back. You enquire about what happened. 'I was too noisy, and this [if Girl is not banned and Girl is not warded]guy[otherwise]girl[end if] came and asked me to be quieter. Then [if Girl is not banned and Girl is not warded]he[otherwise]she[end if] saw... all of me, and was interested. I bet [if Girl is not banned and Girl is not warded]him[otherwise]her[end if] I could do [if Girl is not banned and Girl is not warded]him[otherwise]her[end if] and still be silent enough. And I - we - won.' Smiling, you let Brutus part ways with the equine student and return to the entrance of the library.";
		now CollegeLibraryBrutusEncounter is 1;
	else:
		LineBreak;
		say "      You  quickly walk away, and take the opportunity to think about expanding your own base's collection with the campus. Your constructive train of thoughts is interrupted when Brutus pats you on the shoulder. You look at his cum-covered body, and he returns [if DBCaptureQuestVar is 5]an unapologetic grin[otherwise]a content shrug[end if].";
