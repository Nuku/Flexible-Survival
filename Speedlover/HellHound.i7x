...
to say meetHellhound:
	...
	say "     [if WSlevel is 3]The beast cocks its leg and sends a strong stream of luminescent, yellow urine splashing into the grass before it seems to notice you. The stream falters then stops as[else]It takes a moment for it to notice you, but when it does,[end if] it licks its muzzle and then begins to approach. There is something about the strange monster that tells you it isn't the same as the other infected creatures. A whiff of sulfur hits you as it stalks closer.";
...
to say returntoHellhound:
	...
	if Player consents:
		...
		if maleHound is true:	[if the Player is male]
			...
			say "     You can't make yourself look at the demon. His voice alone make your ears flatten against your skull and fills you with the urge to slink to him on your belly in submission, but your four-legged lovers back happily at his instructions then grunt softly. [if WSLevel is 3]Their piss [else]Another deluge of semen [end if]begins to gush into you, both dogs whining happily as they empty themselves inside you. The tainted and foul liquid causes your muscles to relax as the clawed hand pulls at your collar, drawing you up until both dog cocks pop free with a fetid gush of cum[if WSLevel is 3] and piss[end if]. This flow washes back down onto both hounds, running down your legs and staining your fur.";
			wait for any key;
			end the story saying "Your soul is consumed by your hellish lusts.";
	else:
		LineBreak;
	...
	if isHellhound is true:
		...
		if humanity of Player > 33:	[Initial Hellhound Infection]
			...
			if FaceName of Player is not "Hellhound":
				LineBreak;
				now FaceName of Player is "Hellhound";
				now Face of Player is "that of a yellow-eyed canine, with a leather dog collar around your neck";
	...
	if churchenter is 0:
		...
		if Player consents: [Agree to take down the priestess]
			...
			if maleHound is true:
				...
				say "     Upon your moan of agreement the hellhound fucking you howls in approval, his hips beginning to rut in in earnest as his knot starts to knock at the entrance of your cunt. 'That's a good bitch... We'll reward you nice and good after all of this is over.' Happy that you're on board the second hellhound pads forward, his tongue lolling while his swaying cock slaps against your face, waiting for you to service him. 'After we're done with you here make sure to back at night. And get yourself ready in case anything goes south. She's no real angel, but she's not weak either.' As you open your mouth to reply the other hellhound takes it as an invitation to shove his cock down your throat, effectively spitroasting you. This goes on until they've all had a turn with you, pumping you full of cum [if WSLevel is 3]and piss [end if]before sending you staggering on your way. (Skillchecks ahead!)";
			now churchenter is 3;
		else:
			if maleHound is true:
				say "     The hellhound does not show any sense of disapproval, though you sense that it wasn't what she was expecting to hear. Despite that her hips begin to rock back in earnest, your cock slamming back against her cervix over and over, until you can't hold it any longer and fill her with demonic seed. 'It is regrettable that you wish to turn down such an opportunity. As much as we'd love to take that bitch down a knot we need your help. So whenever you feel like you're able, return to us. In the meantime, I believe you owe us our fill.' The hellhound bitch chuckles, tugging painfully at your knot until with a grunt she pulls free, [if WSLevel is 3]both cum and piss [else]cum [end if]spilling from her gaping hole. Once she gets up another takes her place, taking turns riding you until you pass out and find yourself alone at the steps of the beach.";
			else:
				say "     The hellhound growls with disapproval, possessively biting at your scruff as he begins to rut you harder, pounding you into the dirt with new strength. 'That's not exactly the answer we were hoping for bitch, especially since we wanna take this fake angel down a notch. But we can wait.' The hound growls into your ear[if WSLevel is 3], a fresh dose of piss emptying out into your pussy even [end if]as the hound continues to rut you. 'We can wait until your ready, but I think you owe us in the meantime.' And with that the other hellhound takes its place in front of you, erect cock slapping against your face before it thrusts into your moaning maw. They take turns filling you up until every hole is leaking with their [if WSLevel is 3]piss [end if]and cum, and you awake later to find yourself alone on the steps leading to the beach.";
			LineBreak;
...
to say hellhoundplan:
	...
	now description entry is "use brute strength to charge the priest";
	[]
	choose a blank row in table of fucking options;
	...
	while sextablerun is 0:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			say "     The second plan they had involves you climbing up the roof of the church and entering one of the open windows they have at the top. You'd have to quietly climb back down once you're inside while the hellhounds distract the priestess from the front.";
			say "     Their last plan involves you posing as someone in need of guidance. One of the hellhounds nods towards a ragged cloak they happened across on the beach and suggests you drape it over yourself, though you'd probably need a good amount of charisma to sell your story to the priestess. At least until you can get close enough to pounce on her.";
		else if calcnumber is 99:
			LineBreak;
			say "     At the last moment you shake your head, abruptly asking the hellhounds to call off the plan and wait for a better opportunity. The canines look among themselves obviously disgruntled, but agree that if you don't feel prepared than they should return at a later time.";
			now sextablerun is 1;
		else:
...
to say strength_church_hellhound_route:
	say "     With a nod you agree to charge in while the hellhounds flank. Taking a deep breath you await the hellhounds signal before running up the steps. When you pass the threshold into the church you wince, expecting to feel the sharp pain of the barrier, but instead only a slight tingle runs down your body. From there you throw the doors of the church open and barge inside. You find the priestess kneeling next to the main altar, her body jerking as she stands now alert. Much like before a radiant aura seems to emanate from her being. 'You again!' Her voice booms in your ear before she raises a hand, a bright light shining from it. You don't give her any more time as you charge, trying to close the distance as the ball of light head straight towards you.";
	...
	if Playernum >= monsternum:
		say "     With a painful grunt you muscle through the force of the bright ball, continuing your charge towards a now wide-eyed priestess. Behind her you already see the hellhounds closing in. Arms stretched out you tackle her to the ground, her frail body easily pinned below yours despite her struggles. Smiling you can hear the hellhounds howl in triumph.";
...
to say dexterity_church_hellhound_route:
	...
	if Playernum >= monsternum:
		say "     Once you slip through the open window you can see the priestess below clearly occupied with keeping the hellhounds at bay. Quietly you make your way down, creeping with predatory precision before you pounce on the woman from behind. She only has a moment to cry out in surprise before she's tackled to the ground, her bright aura muck dimmer as she is surrounded by the trio of yipping and howling hellhounds. ";
		say "[church_hellhound_win]";
	else:
		say "     Once you slip through the open window you can see the priestess below clearly occupied with keeping the hellhounds at bay. Quietly you try to make your way down, but as you do your hands slips, sending you sprawling to the church floor with a loud thud. Winded by the fall, you're unable to help the hellhounds as the priestess begins to dispatch them one by one, making them disappear in a puff of smoke before slowly approaching you.";
		say "[church_hellhound_lose]";

to say charisma_church_hellhound_route:
	say "     With a nod you take the large cloak and dawn it over yourself, making sure to hide your face or any distinguishing features that may link you to the hellhounds. The cloak itself has a strong salty smell, enough to possibly mask the taint put upon you by your hellhound compatriots. Slowly you make your way up the steps, wincing as you pass the threshold leading into the churchgrounds, expecting to feel the sharp pain of the barrier that once kept you out. But instead only a slight tingle runs through your body. From there the hellhounds follow quietly behind, making sure to keep a safe distance as you open the doors to the church and step inside.";
...
to say church_hellhound_win:
	...
	if Player consents:
		...
		if maleHound is true:
			...
			WaitLineBreak;
			say "     The priestess has since given up fighting, and you can barely tell if she's still conscious. With a soft sigh you relieve yourself inside her once holy cunt, flooding her completely before popping out and letting the mixed juices pool between her legs. Pulling back the lead hellhound grins down at a dazed angel, now marked and tainted with hellhound fluids. 'You have been of much help to us. We'll take her down to hell to see our master, and eternity of pleasure should have her changing her mind.' Still recovering from your latest climax you watch as a dark portal opens up and the hellhounds drag the unconscious angel through, never to be seen again.";
			now churchenter is 98;
		else:
			say "     The other hellhounds don't waste their time, descending like a murder of crows they tear at her vestments until her body is fully exposed. Her scaled form is a sight to behold, and arguably a sin of its own. Shoving you aside the lead hellhound takes his place between the woman's legs before unceremoniously shoving his canine shaft inside her virgin cunt. A single cry echoes through the church, quickly silenced as another takes its place filling her mouth. The two rut the fall angel mercilessly, panting like dogs as they quickly corrupt the once holy figure. 'She's a bitch like all the rest! So quick to fall.' You are quickly thrown into the festivities as the third noses your clothes off before directing you to get down on your hands and knees. The air is soon filled with the sounds of wet slaps as three knotted cocks ram against their perspective holes.";
			say "     The one in the priestess maw is the first to finish, cumming down her throat as his knot inflates, stretching the poor angel's jaw wide. The one ramming into her cunt is quick to follow, [if WSLevel is 3]both relieving themselves inside her before marking her body down with their rancid piss[else]both filling her with their seed and marking her with inside and out with their rancid scent[end if]. They each take turns, fucking both of you until you're both limp on the ground, barely conscious. As you watch the angel slowly her wings begin to turn blacker, going from pure white to a dark shade of grey. 'We'll take her down to hell to see our master, and eternity of pleasure should have her changing her mind.' Still recovering from your latest climax you watch as a dark portal opens up and the hellhounds drag the unconscious angel through, never to be seen again.";
			now churchenter is 98;
...
This is the Hellhound Curse rule:
	if hellHoundLevel > 0:
		...
		let T be 0;
		if BodyName of Player is "Reindeer" and Player is pure:									[gave into the holiday spirit]
			say "     Having given in to the magic of the holidays, you are freed from the Hellhound's curse.";
		else if BodyName of Player is "Bottlenose Toy" and Player is pure:			[gave into fun in the sun]
			say "     Having become an innocent creature living only for happiness and playtime breaks the Hellhound's curse upon you.";
		else if BodyName of Player is "Wolverine Guard" and Player is pure:		[succumbed to wolverine sex]
		...
		else if BodyName of Player is "Malayan Tiger Herm" and Player is pure:			[claimed at the tigress motel]
			now T is 0; [do nothing statement]
		else if BodyName of Player is "Big Tiger" and Player is pure:							[victory at tigress motel]
			now T is 0; [do nothing statement]
		else if BodyName of Player is "Big Tigress" and Player is pure:					[victory at tigress motel]
			now T is 0; [do nothing statement]
		else if BodyName of Player is "Chocolate Lab" and Player is pure:				[made into Chocolate Lab]
			now T is 0; [do nothing statement]
			...
			if maleHound is true:
				...
				if churchangelprisoner is true:
					say "     During your imprisonment the angel makes sure to keep you fed and nursed, though despite how much you beg and plead you are unable to convince her to let you give into your carnal urges, not even once. When you're not strung up on the cross the priestess summons holy manacles to keep your limbs in check, the radiant power robbing you of your strength as she leads you on walks around the church. Maybe it's just you, but sometimes it seems like she treats you like a misbehaving mutt. It's only in your dreams that you are able to live out your debauchery to an extent, screwing shadowy figures fucking every hole you have to offer, but everyday you wake up to the sight of your wet and dripping cunt, begging to be filled with no way to truly give yourself release.";
					say "     Weeks pass by like this, and one day you find yourself awakening to a bright light and a change of scenery. It almost looks like there are clouds everywhere... A sense of foreboding begins to fill your mind, and your turn your head to see a figure approaching you, surrounded in blinding light.";
