...
when play begins:
	add { "Opossum Sailor" } to infections of FemaleList;
	add { "Opossum Sailor" } to infections of FurryList;
	add { "Opossum Sailor" } to infections of TailweaponList; [usable for Tail Strike feat]
