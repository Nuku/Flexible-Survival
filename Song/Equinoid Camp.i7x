...
to say equinoidcampinvite:
	...
	say "[line break]     [bold type]Shall you take her up on her offer and meet with her herd?[roman type][line break]";
	...
	if Player consents:
		...
		WaitLineBreak;
		say "     'So, Amaryllis, you have found another? Your eagerness to grow the pride is commendable, but is this one truly worthy? Many of the herd are not happy to see [ObjectPro of Player] here after entering our territory and fighting with your herd sisters.'";
...
instead of navigating Equinoid Camp while equinoidstatus is 10:
	...
	if Player is perminfected:
		...
		say "[line break]     [bold type]How do you respond to the tribe leader's offer?[roman type][line break]";
		...
		if Player consents:
			...
			if Player is male:
				...
				say "     Bathed, anointed and having consummated with the equinoids, you rise from the musky waters as one of them. You feel much closer to this strong people. Exiting the large hall, you go out into the compound with a greater appreciation for the simple life they live with nature. While a few of them move away, many greet you as one of them now that you've been properly welcomed into the herd.";
			SanLoss 20;
			turn the Player into a "Black Equinoid";
			WaitLineBreak;
...
Scent of Equinoid Camp is "     The equinoid camp smells strongly of the horse people living there. The scent of long, lush grass and wild flowers hangs in the air.".
...
Scent of Nakoma's Tent is "     Nakoma's tent smells of herbs, scented oil, fur and a hint of equine arousal.".
