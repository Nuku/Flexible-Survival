...
The summondesc of equinoid warrior is "     [if Liliana is visible]You inform Liliana that it's time to head out. She slams her fist into a hoofed hand, showing that she is ready for a fight[else]Liliana strides up to your side with a determined look on her equine face[end if].[line break]".
The dismissdesc of equinoid warrior is "[DismissLiliana]".
The assault of equinoid warrior is "[one of]The equinoid warrior slams your opponent with her fist[or]Liliana throws out a fast, sharp kick with one of her hooves to your foe's midsection[or]The equinoid warrior growls and unleashes a flurry of fast blows[or]Liliana clocks your opponent with the shaft of her spear[or]Your equinoid companion strikes with her spear[at random].".
The fuckscene of equinoid warrior is "[SexWithLiliana]".
Scent of equinoid warrior is "     Liliana smells of the equinoids, reminding you of the herd.".
...
Liliana is a woman.
ScaleValue of Liliana is 4. [human sized]
SleepRhythm of Liliana is 0. [0 - awake at all times, 1 - day active, 2 - night active]
Body Weight of Liliana is 5. [scale of 1-9 for body weight, grouped into low weight (1-3), mid weight (4-6) and high weight (7-9)]
Body Definition of Liliana is 6. [scale of 1-9 for body definition, grouped into low muscle (1-3), mid muscle (4-6), high muscle (7-9)]
[Body Adjective is generated out of the body weight and body definition and can be used in scenes - one word descriptive adjective depending on weight and definition groups: low weight group: skinny/slender/lithe; mid weight group: average/fit/muscled; high weight group: pudgy/husky/jacked]
Androginity of Liliana is 8. [Gender Adjective is generated out of androginity 1-9: hypermasculine/masculine/somewhat effeminate/effeminate/androgynous/feminine butch/tomboyish/feminine/hyperfeminine]
Mouth Length of Liliana is 8. [inches deep for face fucking; maximum possible will be double this number (when deep throating)]
Mouth Circumference of Liliana is 4. [mouth circumference 1-5, "tiny, small, normal, wide, gaping"]
Tongue Length of Liliana is 8. [length in inches]
Breast Size of Liliana is 3. [cup size as number, counting Flat Pecs = 0, A = 1, B = 2, ...]
Nipple Count of Liliana is 2. [count of nipples]
Asshole Depth of Liliana is 12. [inches deep for anal fucking]
Asshole Tightness of Liliana is 2. [asshole tightness 1-5, "extremely tight, tight, receptive, open, gaping"]
Cock Count of Liliana is 1. [number of cocks]
Cock Girth of Liliana is 4. [thickness 1-5, thin/slender/average/thick/monstrous]
Cock Length of Liliana is 12. [Length in Inches]
Ball Count of Liliana is 2. [allowed numbers: 1 (uniball), 2 or 4]
Ball Size of Liliana is 4. [size of balls 1-7: "acorn-sized", "dove egg-sized", "chicken egg-sized" "goose-egg sized", "ostrich-egg sized", "basketball-sized", "beachball-sized"]
Cunt Count of Liliana is 1. [number of cunts]
Cunt Depth of Liliana is 12. [penetrable length in inches; some minor stretching allowed, or more with Twisted Capacity]
Cunt Tightness of Liliana is 3. [size 1-5, generates adjectives of extremely tight/tight/receptive/open/gaping]
Clit Size of Liliana is 3. [size 1-5, very small/small/average/large/very large]
...
TwistedCapacity of Liliana is false. [Twisted Characters can take any penetration, no matter the size]
Sterile of Liliana is false. [steriles can't knock people up]
MainInfection of Liliana is "Black Equinoid".
Description of Liliana is "[LilianaDesc]".
fuckscene of Liliana is "[SexWithLiliana]".
Scent of Liliana is "     Liliana smells of the equinoids, reminding you of the herd.".
...
to say LilianaDesc:
	...
	say "     At the moment, the [if Player is in Courtyard]equinoid warrior is relaxing and just enjoying the courtyard[else]proud warrior is looking around for any hint of trouble[end if].";
...
to say DismissLiliana:
	...
	say "     [if Player is in Courtyard]Rolling her shoulders, Liliana take a seat on the edge of the fountain and awaits your future orders[else]With a curt nod Liliana makes her way back to the library, although the look in her eyes says she would have preferred to stay by your side[end if].";
	...
	while sextablerun is 0:
		...
		if calcnumber > 0 and calcnumber <= the number of filled rows in table of fucking options:
			...
			if Player consents:
				...
				if title entry is "Talk with her":
					say "[LilianaTalk1]";
...
to say LilianaTalk1:
	say "     '[one of]We still have a long way before the painted wolf threat is eliminated...'[or]I'm glad you decided to join the herd. Together we shall show this new world our power!'[at random]";
...
to say LilianaInfectiousFuck: [Runs whenever Liliana is the active pet and the player is not a full Black Equinoid]
	...
	if a random chance of 1 in 3 succeeds:
		...
		if Cock Count of Player > 1:
			...
			if Player is female:
				say ". Her free hand moves a little lower before slipping [if Cunt Count of Player > 1]her fingers into your pussies[else]a finger into your pussy[end if], causing you to moan in response";
		...
		say "     You find yourself growing excited and lower yourself so you can take her cock in hand and guide it to your mouth. She moans softly and runs her hands over your [FaceSpeciesName of Player in lower case] head. You work the throbbing, dribbling meat with your tongue and mouth until she cums, feeding you her thick load. As your body absorbs the tasty treat, you feel more equinoid.";
	infect "Black Equinoid";
	now lastfuck of equinoid warrior is turns;
...
to say eqwarsex4: [Liliana fucks player vaginally]
	...
	say "     Her hoofed hands slide over your body and soon guide you to lie down. She moves atop you, sliding her equine shaft into your juicy cunt so she may fuck you. You kiss and caress one another as she youthful equinoid pounds into you with energetic zeal, cumming hard and sending her hot seed flowing into your womb. After some snuggling, you both get back up and prepare to continue your journey together.[fimpregchance]";
	now Libido of Player is Libido of Player / 2;
...
to say eqwarsex7: [Bath sex scene when standing in Equinoid Camp]
	...
	WaitLineBreak;
	if Player is neuter or (anallevel is 3 and (Player is purefemale or (Player is male and Player is submissive)) and a random chance of 1 in 2 succeeds): [Receiving anal: 100% chance for neuters - 50% chance for pure females with anallevel 3 - 50% chance for bedicked submissives with anallevel 3]
	...
	else if player is puremale or (Player is male and player is dominant) or (Player is herm and a random chance of 1 in 2 succeeds): [Giving vaginal: 100% chance for pure males - 100% chance for dominant bedicked players - 50% chance for herms]
