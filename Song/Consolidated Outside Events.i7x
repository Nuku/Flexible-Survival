...
Instead of resolving Ice Cream Truck:
	...
	if player consents:
		if humanity of player < 10:
			...
			if player is herm:
				say "cram some of the delicious cream into your cunt[sfn], your spare hand taking hold of your hardening [if cocks of player > 1]cocks to stroke and frot them together[else]cock to stroke and pump it slowly[end if]. Your [cock size desc of player] length[smn] throb[smv] and pulse[smv] with excitement as your fingers sink into your cum-sullied depths, spreading and rubbing along your sensitive inner walls";
			else if player is male:
				if anallevel > 1:
					say "cram some of the delicious cream into your asshole, your spare hand taking hold of your hardening [if cocks of player > 1]cocks to stroke and frot them together[else]cock to stroke and pump it slowly[end if]. Your [cock size desc of player] length[smn] throb[smv] and pulse[smv] with excitement as your fingers sink into your cum-sullied rear, spreading and rubbing along your sensitive anal lining";
				else:
					say "take hold of your hardening [if cocks of player > 1]cocks, stroking and frotting them together[else]cock, stroking and pumping it slowly[end if], your [cock size desc of player] length[smn] throbbing and pulsing with excitement as you pleasure yourself";
			...
			if (player is female) or (player is herm and a random chance of 1 in 2 succeeds): [Get fucked]
				...
				say "     You pose no resistance as she hefts you up to your feet, slipping a stumbling a little in the slime of spent fluids. She then pulls you by the wrist with an infectious sense of excited urgency, your cock[sfn] already hard and dribbling by the time you're back outside. Using the street as her runway, your mate takes off into the sky with powerful flaps her wings, and your broken mind has little trouble following her lead, joining her side in the air. You fuck and breed wildly the moment you arrive at her nest, paying no heed to the world around you in the haze of stuffing her pussy over and over again[smn][if player is female], then bending over to have your own fertile passage[smn] violated by your dual-sexed mate[end if].";
			...
			WaitLineBreak;
			now bodyname of player is "Hermaphrodite Gryphon";
