...
to say toystoreloss:
	if player is female: [Females and herms]
		...
		say "     His tenderness doesn't last forever though, those thrusts growing progressively more fervent and excited as his peak draws near. You can feel that swelling knot ramming into your lips with every thrust, the fox's balls slapping against your chin. Eventually his tip makes its way deeper, slipping down your throat, causing your flesh to bulge slightly as your muscles ripple and squeeze around the intruding organ. He continues to rail your body[if cocks of player > 1] while your own cocks are serviced[else if player is male] while your own cock is serviced[end if], gentle pats, slaps, and the occasional squeak resounding through the room. At last, the fox slams home with one final thrust, his knot slipping past your teeth and locking your face to his throbbing dick as he cums into your gullet. [if cocks of player > 1]The rush of heady, intoxicating semen drives you over the edge, your cocks spurting your load down your vulpine attendants['] waiting throats. [else if player is male]The rush of heady, intoxicating semen drives you over the edge, your cock spurting your load down your vulpine attendant's waiting throat. [end if]Rope after rope of his corrupted seed spills into you, and you gurgle wetly, failing to swallow all of that fluid, tasting the strange mix of musk and latex on your tongue even as it spills past your lips and drools down your face in runny rivulets.";
		WaitLineBreak;
