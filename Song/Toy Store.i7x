...
to say ResolveEvent toy store:
	...
	say "[line break]     [bold type]Do you still wish to enter now that you know that someone - or something - is waiting inside the store?[roman type][line break]";
	...
	if Player consents:
		...
		if Libido of Player > 49 and (humanity of Player < 50 or Player is kinky or Player is submissive) and Player is not dominant: [Kinky, Submissive, and low humanity players with 50+ libido are given a chance to submit without violence. Dominant players will never consider this]
			...
			say "[line break]     [bold type]Do you give in to the powerful urge to succumb to your lusts?[roman type][line break]";
...
to say toystorefight:
	...
	while fightoutcome < 20 and GroupFightCounter < 10: [runs for 10 times or until the player loses or flees]
		if GroupFightCounter > 0:
			say "     After knocking one out, the [if GroupFightCounter < 9]others surge[else]final fox surges[end if] forward.";
		challenge "Latex Fox";
...
to say toystoreloss:
	...
	MultiInfect "Latex Fox" repeats 8; [Complete infection after the orgy]
	SanLoss 20;
