	...
	while Trixieexit is false:
		...
		if lustatt > 99: [lustatt is short for 'lust attribute'. When reaching 100, the player orgasms. This check uses > 99 to force orgasm even if lustatt is somehow above 100]
			if orcaintense is 1:
				if Cock Count of Player > 1:
					say "     Finally overtaken by bliss, you buck up against the orca, filling her depths with your [Cum Load Size of Player] load while your extra [if Cock Count of Player > 2]lengths splatter[else]length splatters[end if] your fore in sticky cum.";
				else if Player is male:
					say "     Finally overtaken by bliss, you buck up against the orca, filling her depths with your [Cum Load Size of Player] load.";
				else:
					say "     Finally overtaken by bliss, you writhe beneath the orca[if Player is female], sullying your thighs with squirts of sticky nectar[end if].";
			else if orcaintense is 2:
				if Cock Count of Player > 1:
					say "     Unable to withstand the orca's pleasurable assault, you cum hard into her sordid depths, your extra length[if Cock Count of Player > 2]s[end if] splattering your fore in sticky cum. You groan in ecstasy, the sound muffled against her plastic exterior.";
				else if Player is male:
					say "     Unable to withstand the orca's pleasurable assault, you cum hard into her sordid depths with a groan of lustful ecstasy, the sound muffled against her plastic exterior.";
				else:
					say "     Unable to withstand the orca's pleasurable assault, you bury your face into that smooth and supple chalice, lapping ravenously at her walls[if Player is female]. You cum, hard, further slickening your increasingly cramped confines[end if].";
			else if orcaintense is 3:
				if Cock Count of Player > 1:
					say "     Each climax stronger than the last, you can only groan when another crashing wave of bliss overtakes you. You clumsily wrap your arms around your cetacean captor's form, filling her depths with blast after blast of sticky cum. Your cock twitches and throbs within those squeezing, milking depths, remaining perpetually hard inside her, and your untended extra length[smn] spurt[smv] thick ropes of seed across your chest.";
				else if Player is male:
					say "     Each climax stronger than the last, you can only groan when another crashing wave of bliss overtakes you. You clumsily wrap your arms around your cetacean captor's form, filling her depths with blast after blast of sticky cum. Your cock twitches and throbs within those squeezing, milking depths, remaining perpetually hard inside her.";
				else:
					say "     Each climax stronger than the last, you can only groan when another crashing wave of bliss overtakes you. Your eyes roll back into your head and back arches[if Player is female] as you splatter her underside in sticky femcum[end if], trembling beneath the overwhelming aroma of lust and sex above you.";
			else if orcaintense is 4:
				if Cock Count of Player > 1:
					say "     Overwhelmed by pleasure, you howl your bliss against the sexy cetacean, frantically bucking against her form as climax washes over you. You cum hard into her drenched, sloppily squeezing cunt while your extra length[smn] splatter[smv] your fore in sticky cum, the threat of eternal captivity pushed aside for now as you bask in the powerful warmth of the afterglow.";
				else if Player is male:
					say "     Overwhelmed by pleasure, you howl your bliss against the sexy cetacean, frantically bucking against her form as climax washes over you. You cum hard into her drenched, sloppily squeezing cunt, the threat of eternal captivity pushed aside for now as you bask in the powerful warmth of the afterglow.";
				else:
					say "     Overwhelmed by pleasure, you howl your bliss against the sexy cetacean, frantically bucking against her form as climax washes over you. Motions slicked by your lustful frenzy, you help bring the orca to another messy orgasm of her own. Unable to contain yourself, you reach below to finger your sopping wet slit, ravenously jilling yourself in the hopes of cumming again and again.";
			else: [Followed by bad end by virtue of being fully encased. See above in the file for the text that follows this.]
				if Cock Count of Player > 1:
					say "     The constant onslaught of sex and mind-altering gas growing too much for your weary psyche, you reach a powerful climax that tears the final threads of your sanity asunder. You fill the orca's depths with gout after gout of thick, sticky seed, your untended [if Cock Count of Player > 2]dicks rippling as they further sully[else]dick rippling as it further sullies[end if] the space between you, only to tense all over again and stuff that rippling cetacean snatch with a double-dose of cum. Any form of refractory period withers away, and your happy, bestial trills fill the orca's maw. Pushing down against you, she milks you again and again, cementing your new lease in life as her favorite toy and plaything.";
				else if Player is male:
					say "     The constant onslaught of sex and mind-altering gas growing too much for your weary psyche, you reach a powerful climax that tears the final threads of your sanity asunder. You fill the orca's depths with gout after gout of thick, sticky seed, only to tense all over again and stuff that rippling cetacean snatch with a double-dose of cum. Any form of refractory period withers away, and your happy, bestial trills fill the orca's maw. Pushing down against you, she milks you again and again, cementing your new lease in life as her favorite toy and plaything.";
				else:
					say "     The constant onslaught of sex and mind-altering gas growing too much for your weary psyche, you reach a powerful climax that tears the final threads of your sanity asunder. You eventually sag down beneath the orca, breathing weakly of the gas she continuously feeds you[if Player is female] while grinding her tailfin across your aching cunt[sfn][end if]. The heat, scent, and taste of the cetacean's sex becoming your whole world, your mind empties of all but pleasing this attractive orca, wanting nothing more than to indulge her every wanton whim.";
		...
		if orcaintense < 6: [Hides content to prevent endings colliding]
			if orcaintense < 3:
				...
				now boundsegment is orcaintense;
			if humanity of Player < 1: [Lost all sanity. Instant game over.]
				...
				say "Sanity: [humanity of Player]/100  Lust: [lustatt]/100  Struggle: [orcastrugglebar][line break]";
				...
				if keychar is "s" or keychar is "1" or keychar is "return" or keychar in lower case matches the text "struggle": [player picked struggle]
					...
					if obliging is true: [oblige]
						...
						else if orcaintense < 5:
							if Player is male:
								say "     [one of]Moaning with desire[or]Lust clouding your mind[or]Giving in to these powerful urges[at random], you drive deep into the orca's gripping sex, losing yourself to pleasure of pleasing the ravenous inflatable[if orcaintense is 4], each needy thrust met with an encouraging squeeze around your throbbing, pulsing maleness[end if].";
							else:
								say "     [one of]Moaning with desire[or]Lust clouding your mind[or]Giving in to these powerful urges[at random], you lap greedily along the walls of her sex[if Player is female] while fingering your own soaked cunt[end if], breathing deeply of the strong scent of arousal.";
						else:
						...
						if orcaintense is 1:
							...
							if Player is male:
								say "     You abide the orca's [one of]assault on your senses[or]frantic fucking[at random], shuddering at the feeling of her well-lubed cunt gripping and squeezing at your length as you thrust into her elastic confines.";
							else:
								say "     You abide the orca's [one of]assault on your senses[or]frantic fucking[at random], drawing your tongue in broad sweeps along the smooth, wet walls of her sex[if Player is female] while fingering your cunt[end if].";
						else if orcaintense is 4:
							if Player is male:
								say "     You abide the orca's [one of]assault on your senses[or]frantic fucking[at random], shuddering at the feeling of her soaking wet cunt gripping and squeezing at your length as you thrust into that sinful vise";
							else:
								say "     You abide the orca's [one of]assault on your senses[or]frantic fucking[at random], drawing your tongue in broad sweeps along the smooth, elastic walls of her soaking wet sex, its heady scent filling your lungs and mind[if Player is female] while you finger your own slick cunt[end if].";
						else:
					...
					if boundrecover is true: [recover]
						...
						if orcaintense is 1:
							...
							say "     You try to hold your breath, to refrain from breathing in more of that arousing, mind-numbing gas, but your efforts last only moments before you take another deep inhale of the orca's wonderful gift, lost in your chemical lusts[if Player is male]. All the while, her wonderful pussy continues to squeeze around your achingly hard shaft, urging you to give in, to accept your place beneath her: an eternity of warm, slick, draining release, unbridled by those silly human thoughts and inhibitions. To your eroding mind, the unspoken offer seems more and more appealing[end if].";
						orcalust;
						orcasanitypassive;
					LineBreak;
					wait for any key;
...
to say orcastrugglebar: [Displays struggle bar. The amount of struggle turns necessary to escape is always equal to the bound segment.]
	say "[close bracket][if orcaintense > 4]-[end if]";
	if orcaintense > 3:
...
When Play begins:
	...
	add "Inflatable Orca" to infections of InternalBallsList;
	...
	now desc entry is "     You find yourself at odds with the large, inflatable orca. The two-tone cetacean regards you as little more than a toy for its amusement, trilling playfully as it bounces around with seemingly boundless energy.[line break]"; [ Description of the creature when you encounter it. ]
	...
	now type entry is ""; [ one-word creature type. Ex: feline, canine, lupine, robotic, human... Use [one of] to vary ]
