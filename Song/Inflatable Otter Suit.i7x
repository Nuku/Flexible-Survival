...
Scent of Inflatable Otter Suit is "     The [if HP of Inflatable Otter Suit is 0]pile of plastic smells of saltwater and fresh synthetics, along with a seedier undercurrent of sex[else if HP of Inflatable Otter Suit < 3]inflatable otter suit smells of saltwater and fresh synthetics, along with a seedier undercurrent of sex[else]inflatable otter suit smells of saltwater and fresh synthetics, along with a seedier undercurrent of sex. After experiencing its attempts to molest you earlier, you can detect some of your own scent commingling with the heady aroma[end if].".
	...
	if HP of Inflatable Otter Suit is 0:
		...
		if Player consents:
			...
			if Player is male:
				...
				say "     Do you relax and [link]accept the suit's embrace (Y)[as]y[end link], or do you try to [link]fight its tainted will (N)[as]n[end link]?";
				if Player consents:
					LineBreak;
	...
	if HP of Inflatable Otter Suit < 2:
		...
		if Player consents:
			...
			if Player is male:
				...
				say "     Do you relax and let the suit do [link]as it pleases (Y)[as]y[end link] this time, or do you try to [link]struggle (N)[as]n[end link]?";
				if Player consents:
					LineBreak;
					InflatableOtterSuitSubmit;
				else:
...
to InflatableOtterSuitBind:
	...
	while Trixieexit is false:
		...
		if lustatt > 99: [lustatt is short for 'lust attribute'. When reaching 100, the player orgasms. This check uses > 99 to force orgasm even if lustatt is somehow above 100]
			...
			else: [Hides content to prevent endings colliding]
				now lustatt is Libido of Player;
		...
		if InflatableOtterSuitBindStage < 4: [Hides content to prevent endings colliding]
			...
			if humanity of Player < 1: [Lost all sanity. Instant game over.]
				if InflatableOtterSuitBindStage is 1:
					...
					say "     Unable to [if InflatableOtterSuitBindStage is 2]focus on escape, your mind eventually snaps from the overwhelming pleasure coursing through you. The suit senses your submission and squeezes tightly around your length, pumping and milking you until you reach a second powerful orgasm. You spray your cum across the supple vinyl, bucking and thrashing helplessly as you squeal in absent ecstasy[else]move, much less focus on resistance, your mind eventually snaps from the overwhelming pleasure coursing through you. The suit senses your submission and squeezes tightly around your length, pumping and milking you until you reach a third powerful orgasm. You spray your cum across the supple vinyl, whimpering with desperate need and trembling within the rigid hold of your captor[end if]. The suit absorbs your seed, the fluids merging with the tainted plastic and empowering it further. What isn't consumed washes back over your cock and crotch to serve as sticky lubricant for your continued abuse.";
				...
				if InflatableOtterSuitBindStage is 1:
					...
					say "     You could try to [bold type]S[roman type]truggle to reduce its hold on you, [if obliging is true][bold type]O[roman type]blige[else][bold type]A[roman type]bide[end if] the wanton suit or attempt to [if boundrecover is true][bold type]R[roman type]ecover from[else][bold type]E[roman type]ndure[end if] its arousing motions.";
				else:
				...
				say "Sanity: [humanity of Player]/100  Lust: [lustatt]/100  Struggle: [InflatableOtterSuitStruggleBar][line break]";
				...
				if keychar is "s" or keychar is "1" or keychar is "return" or keychar in lower case matches the text "struggle": [player picked struggle]
					...
					if InflatableOtterSuitBindStage is 3 or struggleatt < boundsegment: [Determines if the cumulative "struggle attribute" < or equal to bound stage. If equal to, the player escapes. Each orgasm will remove struggleatt.]
						say "     [if InflatableOtterSuitBindStage is 1]Alarmed by the strange suit's embrace, you reach for the zipper in an effort to pull it down. Your clumsy mittens struggle to grasp the fly, and the suit attempts to zip back up whenever your grip falters. The supple vise around your length makes it difficult to focus, stroking and squeezing distractingly as you struggle to escape[else if InflatableOtterSuitBindStage is 2]The air filling the suit makes it difficult to reach the zipper, its fly laying flush to the suit's smooth exterior. Finding no success in your efforts to grasp it, you instead push down into the malleable plastic, trying to force the air out of its dual-layered construction[else]The suit's tight embrace makes it almost impossible to move your limbs, the constricting pressure of the air hugging your form leaving your hazy thoughts to drift. The pleasure radiating from your groin melts away your will to resist, making you shiver and moan softly as you try to wiggle free. Despite your best efforts, the suit's hold remains firm, denying you even the faintest hope of escape[end if].";
					LineBreak;
					wait for any key;
					...
					if boundrecover is true: [recover]
						SanBoost InflatableOtterSuitBindStage;
						...
						if InflatableOtterSuitBindStage is 1:
							say "     [one of]Despite the suit's arousing motions, you do your best to ignore its attempts to seduce you. You take several deep, measured breaths and close your eyes, resisting the temptation to reach below and masturbate your vinyl-coated cock. Try as you might, you struggle to block the idea from your mind, only barely catching your mitten-covered hand from straying to your crotch[or]You suck a sharp breath past the gag stuffing your mouth, the potent aroma of tainted vinyl drawn into your lungs. Despite temptation, you try to resist the suit's encouraging contact, keeping your hands at your sides to refrain from touching yourself in any way that might exacerbate your arousal[or]Quieting the urge the moan, you try to stay still as the suit's cock-shaped sheath ripples around your meat. The sensation becomes increasingly pleasurable and distracting over time, making it difficult to focus on enduring - or escape[at random].";
						else if InflatableOtterSuitBindStage is 2:
							say "     [one of]With the suit constricting tighter, you're finding it increasingly difficult to resist the temptation to just give in to its arousing embrace. Your mind's eye is filled with a bevy of disturbing fantasies, and you bite hard around the gag in your mouth to distract yourself from the nagging urge to submit[or]You can't help but moan softly as the suit's supple sheath squeezes and pumps your length, your breath growing troubled as you squirm in its slickened confines. Try as you might to find reprieve from the distracting sensations, you're having a lot of trouble staying focused now, still achingly sensitive after your first draining climax[or]Pleasure lancing through your crotch, you dig your fingers into the castle floor through the suit's puffy mittens, trying to steady yourself and normalize your breathing. Unfortunately, your attempts to resist only last for so long, and you find yourself moaning needily into your gag as your length throbs and twitches in its gripping, squeezing, constantly shifting vise[at random].";
						else:
							say "     [one of]Bound so tight that you can barely move at this point - if at all - you try your best to salvage any kind of hope in spite of the dire circumstances. Your wishful thinking is interrupted by another tight squeeze around your hypersensitized cockflesh, forcefully milking a thick spurt of pre from you. Awash in carnal bliss, your mind begins to wander again, daydreaming of being fucked forever by your wonderful new host[or]You continue to try and resist, to find any semblance of mental clarity. Your efforts are made null when the shifting suit squeezes tightly around your length, your achingly needy cock forced to twitch and throb as it's caressed by the slickly squelching material. You give a soft, lustful sigh and let your eyes flutter closed, feeling your mind give more and more as the lovely suit stimulates every part of you without stop[or]You can scarcely move inside the suit, much less hold on to your mental faculties. The material's smooth inner layer pulls flush to your [Skin of Player] flesh, and the tainted vinyl clenches rhythmically around your pre-spurting cock. You try to resist the suit's teasing, writhing and bucking helplessly, but your thoughts grow muddier as it pleasures you into a drooling stupor[at random].";
					LineBreak;
					wait for any key;
				else:
					say "Invalid action.";
...
to InflatableOtterSuitSanityPassive: [Passively decreases the player's sanity attribute. Higher bound segments increase the per-turn sanity loss.]
	...
	if InflatableOtterSuitBindStage is 1:
		...
		if enduring is false or a random chance of 1 in 2 succeeds:
...
Scent of Stuffed Otter Suit is "     The inflatable otter suit smells of saltwater and fresh synthetics. The heady scent of sex emanates from its undoubtedly sordid interior.".
...
Instead of fucking Stuffed Otter Suit:
	...
	if Player consents:
		LineBreak;
		if Player is female and (Player is not male or a random chance of 1 in 2 succeeds): [female (100%) and herm (50%)]
