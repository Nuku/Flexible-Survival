		...
		if a random chance of 2 in 3 succeeds: [Will mate with females, otherwise oral]
			if Player is female:
				if Cunt Depth of Player < 15 or Cunt Tightness of Player < 10:
					...
					if Player is not MalePreferred and ( "Modest Organs" is not listed in feats of Player and Cunt Depth of Player > 7 ), increase Cunt Depth of Player by 2;
...
to say lucky horseshoe use:
	...
	if a random chance of 1 in 20 succeeds:
		...
		repeat with x running from 1 to the number of rows in Table of Random Critters:
			...
			if loot entry is "" or loot entry is " " or lootchance entry is 0, next;
			let z be loot entry;
