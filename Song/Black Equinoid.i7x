		...
		if a random chance of 2 in 3 succeeds: [Will mate with females, otherwise oral]
			if Player is female:
				if Cunt Depth of Player < 15 or Cunt Tightness of Player < 10:
					...
					if Player is not MalePreferred and "Modest Organs" is not listed in feats of Player:
						if Cunt Depth of Player > 7, increase Cunt Depth of Player by 2;
						if Cunt Tightness of Player > 7, increase Cunt Tightness of Player by 1;
				else:
				...
				CreatureSexAftermath "Player" receives "Facial" from "Black Equinoid";
...
to say beattheequinoid:
	...
	if equinoidstatus is 4:
	...
	else if HP of Team Captain Roman is 8: [Football team recruits quest. Lower priority than Equinoid Camp]
		...
		if diceroll > 15:
			...
			now HP of Team Captain Roman is 9;
		else:
...
When Play begins:
	...
	now desc entry is "     A tall, imposing figure. A horse on two feet, towering over most, with great muscles under dense black fur. She has bright [one of]brown[or]hazel[or]green[at random] eyes and white, flat teeth. She is dressed in a simple sheet, like a toga that wraps around her well-formed body. Her great breasts are tight, as taut as the beefy muscles of her arms and legs. Her hips are round and waist slim, giving a pleasing shape. When she sees you, her lips peel back to expose those teeth. '[one of]Begone from our herd lands![or]Your kind are not welcome here![or]You do not belong here![at random]' she says, charging at you with red in her eyes. In the great motion it becomes clear that she is male as well, a huge sheath wobbling along her belly, her softball-sized nuts swaying as she runs.[line break]";
	...
	now MilkItem entry is "black equinoid milk"; [ Item to be given to the player if they have this infection and milk themselves. ]
	now CumItem entry is "black equinoid cum"; [ Item to be given to the player if they have this infection and jerk off. ]
...
Scent of lucky horseshoe is "The horseshoe smells of earth and old metal.".

to say lucky horseshoe use:
	if a random chance of 1 in 20 succeeds:
		say "     You hurl the horseshoe over your [one of]left[or]right[at random] shoulder and don't look back, hoping for the best. As you walk away, you trip over something!";
		sort Table of Random Critters in random order;
		let z be "dirty water";
		repeat with x running from 1 to the number of rows in Table of Random Critters:
			choose row x in Table of Random Critters;
			if loot entry is not empty and lootchance entry > 0:
				now z is loot entry;
				break;
