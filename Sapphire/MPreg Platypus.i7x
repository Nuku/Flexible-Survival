...
to say losetoplatypus:
	...
	otherwise:
		say "     You fall to your knees under the platypus['] assault. He grins and rubs his belly as he stands over you. [if player is impreg_ok]'Soon enough you'll have a clutch of your own to take care of. But until then, how's about you and I have a little fun?'[otherwise]'Now now... don't let the belly fool you. I can make you feel just as good as any guy out there.' [end if] ";
...
When Play begins:
	...
	now name entry is "Platypus";      [The creature's name as displayed and used in naming descriptions]
	now attack entry is "[one of]The platypus charges you, using the full weight of his belly to knock you down![or]Using his ankle barbs, the platypus kicks at you, poisoning you![or]The platypus nips at you painfully with his bill![or]The platypus claws at you desperately![at random]";   [Text used when the monster succeeds on an attack]
	now defeated entry is "[beattheplatypus]";            [ Text when monster loses.  Change 'template' as above. ]
	now victory entry is "[losetoplatypus]";               [ Text when monster wins.  Change 'template' as above. ]
	now desc entry is "[platypusdesc]";                  [ Description of the creature when you encounter it. ]
	...
	if bodyname of player is "Platypus":
		...
		otherwise:
			...
			if cocks of player > 0:                     [MALE/HERM]
				say "     The doctors give you all the usual exams: they take some blood for testing, they get the cheek swab for your DNA, and they give your [if player is mpreg_able]male womb[otherwise]prostate[end if] a quick examination. A few hours later, they come back with the results of your test. At first, the doctor doesn't say much of anything, he just reads the papers on his clipboard, when you ask what's wrong, he laughs and shakes his head. 'Nothing my dear boy. I just thought it would be funny to keep you waiting.'";
