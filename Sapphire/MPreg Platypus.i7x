		...
		if Player is not neuter:
			...
			if Player consents:
				...
				if Player is male:
					...
					CreatureSexAftermath "Platypus" receives "AssFuck" from "Player";
				else:
					say "     Moving yourself closer to the prone and nude male, you grin, sliding your form over his. Your hands start roaming his belly, feeling the firm eggs shift within, to which the platypus shudders, starting to grow erect, aroused by the feeling of the eggs stretching his belly taut. Squirming underneath of you, his hand starts going to your groin, starting to tease your clit lightly, trying to get you as aroused as he is. The teasing gets more intense, his hands going over your chest, your hands sliding over his hips, until you can't take it any more and you have to ride his cock. You shift your position to straddle him, guiding his tip to your wet cunt. With a moan of satisfaction, you slowly lower yourself around his shaft, squeezing it tightly as you settle into position.";
					say "     Not wanting to let you do all the work, the platypus puts his hands on your hips and starts to thrust into you as you rock into him, setting a steady pace. The sensation of his rod pumping deep inside you pulls several moans from both you and him as you rub your [if Breast Size of Player > 0]breasts[else]chest[end if] to heighten the pleasure. The pleasurable tension builds up into a small eternity, until suddenly it comes to a crashing release, forcing you to clamp your pussy down on the delicious cock inside you. Holding onto the platypus tightly, you try your best to keep milking for all he's got, and soon your efforts are rewarded. Hot waves of cum start to fill you up.[fovichance]";
					...
					CreatureSexAftermath "Platypus" receives "PussyFuck" from "Player";
			else:
...
When Play begins:
	...
	now Species Name entry is "Platypus"; [name of the overall species of the infection, used for children, ...]
	add "Platypus" to infections of HybridList;
	add "Platypus" to infections of FurryList;
	add "Platypus" to infections of NatureList;
